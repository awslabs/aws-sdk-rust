...
pub use crate::operation::list_compute_quotas::_list_compute_quotas_input::ListComputeQuotasInputBuilder;

pub use crate::operation::list_compute_quotas::_list_compute_quotas_output::ListComputeQuotasOutputBuilder;

impl crate::operation::list_compute_quotas::builders::ListComputeQuotasInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_compute_quotas();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `ListComputeQuotas`.
///
/// <p>List the resource allocation definitions.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct ListComputeQuotasFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_compute_quotas::builders::ListComputeQuotasInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_compute_quotas::ListComputeQuotasOutput,
        crate::operation::list_compute_quotas::ListComputeQuotasError,
    > for ListComputeQuotasFluentBuilder
{
    fn send(
        self,
...
impl ListComputeQuotasFluentBuilder {
    /// Creates a new `ListComputeQuotasFluentBuilder`.
    ...
    /// Access the ListComputeQuotas as a reference.
    pub fn as_input(&self) -> &crate::operation::list_compute_quotas::builders::ListComputeQuotasInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_compute_quotas::ListComputeQuotas::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_compute_quotas::paginator::ListComputeQuotasPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_compute_quotas::paginator::ListComputeQuotasPaginator {
        crate::operation::list_compute_quotas::paginator::ListComputeQuotasPaginator::new(self.handle, self.inner)
    }
