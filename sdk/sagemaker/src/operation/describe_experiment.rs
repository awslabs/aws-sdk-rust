...
impl DescribeExperimentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_experiment::ser_describe_experiment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExperiment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_experiment::de_describe_experiment_http_response_with_props(status, headers, body)
        }
    }
}
