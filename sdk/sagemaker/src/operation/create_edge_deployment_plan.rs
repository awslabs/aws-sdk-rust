    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_edge_deployment_plan::CreateEdgeDeploymentPlanError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_edge_deployment_plan::CreateEdgeDeploymentPlanOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateEdgeDeploymentPlanResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateEdgeDeploymentPlanRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_edge_deployment_plan::CreateEdgeDeploymentPlanInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateEdgeDeploymentPlanEndpointParamsInterceptor {
...
pub type CreateEdgeDeploymentPlanErrorKind = CreateEdgeDeploymentPlanError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateEdgeDeploymentPlanError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_edge_deployment_plan::CreateEdgeDeploymentPlanError {
...
impl CreateEdgeDeploymentPlanError {
    ...
    /// Creates the `CreateEdgeDeploymentPlanError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
