...
impl ListCompilationJobsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_compilation_jobs::ser_list_compilation_jobs_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_compilation_jobs::ListCompilationJobs::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_compilation_jobs::ListCompilationJobsError
{
