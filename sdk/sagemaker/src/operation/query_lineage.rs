...
impl QueryLineageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::query_lineage::QueryLineage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_query_lineage::ser_query_lineage_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryLineage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query_lineage::de_query_lineage_http_response_with_props(status, headers, body)
        }
    }
}
