...
impl QueryLineageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::query_lineage::QueryLineage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryLineage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_query_lineage::de_query_lineage_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_query_lineage::de_query_lineage_http_response_with_props(
                status, headers, body,
            )
        }
    }
