...
impl ListSpacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_spaces::ListSpaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_spaces::ser_list_spaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSpaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_spaces::de_list_spaces_http_response_with_props(status, headers, body)
        }
    }
}
