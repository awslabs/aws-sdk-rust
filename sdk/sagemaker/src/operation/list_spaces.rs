...
impl ListSpacesInput {
    /// Consumes the builder and constructs an Operation<[`ListSpaces`](crate::operation::list_spaces::ListSpaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_spaces::ListSpaces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_spaces::ListSpacesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_spaces::ser_list_spaces_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_spaces::ListSpaces::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSpaces", "sagemaker"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListSpaces {
                type Output = std::result::Result<crate::operation::list_spaces::ListSpacesOutput, crate::operation::list_spaces::ListSpacesError>;
