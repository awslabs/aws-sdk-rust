...
impl ImportHubContentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_hub_content::ser_import_hub_content_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportHubContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_hub_content::de_import_hub_content_http_response_with_props(status, headers, body)
        }
    }
}
