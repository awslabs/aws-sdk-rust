...
/// Orchestration and serialization glue logic for `ImportHubContent`.
...
impl ImportHubContent {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::import_hub_content::ImportHubContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_hub_content::ImportHubContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::import_hub_content::ImportHubContentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::import_hub_content::ImportHubContentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportHubContent {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ImportHubContent");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ImportHubContentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ImportHubContentResponseDeserializer));
...
.with_interceptor(ImportHubContentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::import_hub_content::ImportHubContentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::import_hub_content::ImportHubContentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::import_hub_content::ImportHubContentError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_import_hub_content::de_import_hub_content_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ImportHubContentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportHubContentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::import_hub_content::ImportHubContentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::import_hub_content::ImportHubContentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_hub_content::ser_import_hub_content_input(&input)?);
...
#[derive(Debug)]
            struct ImportHubContentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportHubContentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ImportHubContentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ImportHubContentInput>()
                        .ok_or("failed to downcast to ImportHubContentInput")?;
...
/// Error type for the `ImportHubContentError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ImportHubContentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ImportHubContentError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ImportHubContentError {
    /// Creates the `ImportHubContentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ImportHubContentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ImportHubContentError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `ImportHubContentError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `ImportHubContentError::ResourceNotFound`.
    pub fn is_resource_not_found(&self) -> bool {
        matches!(self, Self::ResourceNotFound(_))
    }
}
impl ::std::error::Error for ImportHubContentError {
...
impl ::std::fmt::Display for ImportHubContentError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ImportHubContentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ImportHubContentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ImportHubContentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::import_hub_content::ImportHubContentError {
...
mod _import_hub_content_output;
