...
impl ListContextsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_contexts::ListContexts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_contexts::ser_list_contexts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListContexts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_contexts::de_list_contexts_http_response_with_props(status, headers, body)
        }
    }
}
