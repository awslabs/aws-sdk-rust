...
impl crate::operation::delete_workforce::builders::DeleteWorkforceInputBuilder {
...
impl DeleteWorkforceFluentBuilder {
    /// Creates a new `DeleteWorkforceFluentBuilder`.
