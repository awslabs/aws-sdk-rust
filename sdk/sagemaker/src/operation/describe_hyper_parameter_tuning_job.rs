...
impl DescribeHyperParameterTuningJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_hyper_parameter_tuning_job::DescribeHyperParameterTuningJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHyperParameterTuningJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_hyper_parameter_tuning_job::de_describe_hyper_parameter_tuning_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
