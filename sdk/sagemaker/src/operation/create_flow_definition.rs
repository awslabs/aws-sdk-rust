    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_flow_definition::CreateFlowDefinitionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_flow_definition::CreateFlowDefinitionOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateFlowDefinitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateFlowDefinitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_flow_definition::CreateFlowDefinitionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_flow_definition::ser_create_flow_definition_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateFlowDefinitionEndpointParamsInterceptor {
...
pub type CreateFlowDefinitionErrorKind = CreateFlowDefinitionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateFlowDefinitionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_flow_definition::CreateFlowDefinitionError {
...
impl CreateFlowDefinitionError {
    ...
    /// Creates the `CreateFlowDefinitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
