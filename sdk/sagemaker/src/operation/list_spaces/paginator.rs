...
impl ListSpacesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::SpaceDetails, ::aws_smithy_http::result::SdkError<crate::operation::list_spaces::ListSpacesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_spaces_output_spaces(page).unwrap_or_default().into_iter())
    }
}
