...
impl ListPipelineExecutionStepsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_pipeline_execution_steps::ListPipelineExecutionSteps,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_pipeline_execution_steps::ListPipelineExecutionSteps::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPipelineExecutionSteps {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pipeline_execution_steps::de_list_pipeline_execution_steps_http_response_with_props(
                status, headers, body,
            )
        }
    }
