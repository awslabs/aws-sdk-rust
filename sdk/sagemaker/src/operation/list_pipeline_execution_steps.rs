    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_pipeline_execution_steps::ListPipelineExecutionStepsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_pipeline_execution_steps::ListPipelineExecutionStepsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListPipelineExecutionSteps {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListPipelineExecutionSteps", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListPipelineExecutionSteps")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListPipelineExecutionStepsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListPipelineExecutionStepsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_pipeline_execution_steps::ListPipelineExecutionStepsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListPipelineExecutionStepsEndpointParamsInterceptor {
...
pub type ListPipelineExecutionStepsErrorKind = ListPipelineExecutionStepsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListPipelineExecutionStepsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_pipeline_execution_steps::ListPipelineExecutionStepsError {
...
impl ListPipelineExecutionStepsError {
    ...
    /// Creates the `ListPipelineExecutionStepsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
