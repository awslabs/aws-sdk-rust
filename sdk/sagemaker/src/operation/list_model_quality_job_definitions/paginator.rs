        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitions::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl ListModelQualityJobDefinitionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_model_quality_job_definitions_output_output_job_definition_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
