...
pub use crate::operation::list_model_quality_job_definitions::_list_model_quality_job_definitions_output::ListModelQualityJobDefinitionsOutputBuilder;
...
pub struct ListModelQualityJobDefinitionsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_model_quality_job_definitions::builders::ListModelQualityJobDefinitionsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitionsOutput,
                    crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitionsError,
                > for ListModelQualityJobDefinitionsFluentBuilder
            {
                fn send(
                    self,
...
impl ListModelQualityJobDefinitionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitionsOutput, crate::operation::list_model_quality_job_definitions::ListModelQualityJobDefinitionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_model_quality_job_definitions::paginator::ListModelQualityJobDefinitionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_model_quality_job_definitions::paginator::ListModelQualityJobDefinitionsPaginator {
                                crate::operation::list_model_quality_job_definitions::paginator::ListModelQualityJobDefinitionsPaginator::new(self.handle, self.inner)
                            }
