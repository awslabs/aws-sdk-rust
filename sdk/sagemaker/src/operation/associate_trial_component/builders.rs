...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_trial_component::AssociateTrialComponentOutput,
                    crate::operation::associate_trial_component::AssociateTrialComponentError,
                > for AssociateTrialComponentFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateTrialComponentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_trial_component::AssociateTrialComponentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_trial_component::AssociateTrialComponentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_trial_component::AssociateTrialComponentOutput, crate::operation::associate_trial_component::AssociateTrialComponentError, Self> {
