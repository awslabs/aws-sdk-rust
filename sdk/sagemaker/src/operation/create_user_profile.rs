...
impl CreateUserProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_user_profile::ser_create_user_profile_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUserProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_user_profile::de_create_user_profile_http_response_with_props(status, headers, body)
        }
    }
}
