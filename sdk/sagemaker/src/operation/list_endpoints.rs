...
impl ListEndpointsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_endpoints::ser_list_endpoints_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_endpoints::ListEndpoints::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListEndpoints", "sagemaker"));
