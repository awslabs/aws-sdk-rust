...
impl ListImageVersionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_image_versions::ser_list_image_versions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImageVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_image_versions::de_list_image_versions_http_response_with_props(status, headers, body)
        }
    }
}
