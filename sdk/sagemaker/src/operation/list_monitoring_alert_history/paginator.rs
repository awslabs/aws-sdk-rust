        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_monitoring_alert_history::ListMonitoringAlertHistory::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl ListMonitoringAlertHistoryPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_monitoring_alert_history_output_output_monitoring_alert_history(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
