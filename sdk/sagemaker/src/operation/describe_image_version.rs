    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_image_version::DescribeImageVersionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_image_version::DescribeImageVersionOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeImageVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeImageVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_image_version::DescribeImageVersionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_image_version::ser_describe_image_version_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeImageVersionEndpointParamsInterceptor {
...
pub type DescribeImageVersionErrorKind = DescribeImageVersionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeImageVersionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_image_version::DescribeImageVersionError {
...
impl DescribeImageVersionError {
    ...
    /// Creates the `DescribeImageVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
