...
impl DescribeImageVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_image_version::ser_describe_image_version_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_image_version::DescribeImageVersion::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_image_version::DescribeImageVersionError
{
