...
impl UpdateDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_domain::UpdateDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_domain::de_update_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_domain::de_update_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
