    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_compilation_job::DescribeCompilationJobError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_compilation_job::DescribeCompilationJobOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCompilationJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeCompilationJob", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCompilationJob")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeCompilationJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeCompilationJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_compilation_job::DescribeCompilationJobInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_compilation_job::ser_describe_compilation_job_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeCompilationJobEndpointParamsInterceptor {
...
pub type DescribeCompilationJobErrorKind = DescribeCompilationJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeCompilationJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_compilation_job::DescribeCompilationJobError {
...
impl DescribeCompilationJobError {
    ...
    /// Creates the `DescribeCompilationJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
