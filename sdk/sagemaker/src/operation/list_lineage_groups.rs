...
impl ListLineageGroups {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_lineage_groups::ListLineageGroupsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_lineage_groups::ListLineageGroupsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("sagemaker", "ListLineageGroups", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListLineageGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListLineageGroups", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListLineageGroups")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListLineageGroupsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListLineageGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListLineageGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_lineage_groups::ListLineageGroupsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_lineage_groups::ser_list_lineage_groups_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListLineageGroupsEndpointParamsInterceptor {
...
pub type ListLineageGroupsErrorKind = ListLineageGroupsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListLineageGroupsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_lineage_groups::ListLineageGroupsError {
...
impl ListLineageGroupsError {
    ...
    /// Creates the `ListLineageGroupsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
