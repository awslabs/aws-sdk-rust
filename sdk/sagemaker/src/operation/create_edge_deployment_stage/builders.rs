...
pub use crate::operation::create_edge_deployment_stage::_create_edge_deployment_stage_output::CreateEdgeDeploymentStageOutputBuilder;

pub use crate::operation::create_edge_deployment_stage::_create_edge_deployment_stage_input::CreateEdgeDeploymentStageInputBuilder;
...
impl CreateEdgeDeploymentStageInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.create_edge_deployment_stage();
...
pub struct CreateEdgeDeploymentStageFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_edge_deployment_stage::builders::CreateEdgeDeploymentStageInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStageOutput,
                    crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStageError,
                > for CreateEdgeDeploymentStageFluentBuilder
            {
                fn send(
                    self,
...
impl CreateEdgeDeploymentStageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStage::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStage::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStageOutput, crate::operation::create_edge_deployment_stage::CreateEdgeDeploymentStageError, Self> {
