...
impl BatchDescribeModelPackageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_describe_model_package::BatchDescribeModelPackageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_describe_model_package::BatchDescribeModelPackageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_describe_model_package::BatchDescribeModelPackageOutput, crate::operation::batch_describe_model_package::BatchDescribeModelPackageError, Self> {
