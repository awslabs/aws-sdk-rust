...
impl DeleteWorkteamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_workteam::DeleteWorkteam, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_workteam::ser_delete_workteam_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWorkteam {
    type Output =
        ::std::result::Result<crate::operation::delete_workteam::DeleteWorkteamOutput, crate::operation::delete_workteam::DeleteWorkteamError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_workteam::de_delete_workteam_http_response_with_props(status, headers, body)
        }
    }
}
