...
impl ListClustersPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `cluster_summaries`. Queries to the underlying service
...
impl ListClustersPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_clusters_output_output_cluster_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
