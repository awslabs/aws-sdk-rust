...
impl DeleteAlgorithmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_algorithm::DeleteAlgorithm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_algorithm::ser_delete_algorithm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAlgorithm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_algorithm::de_delete_algorithm_http_response_with_props(status, headers, body)
        }
    }
}
