    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_algorithm::DeleteAlgorithmError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_algorithm::DeleteAlgorithmOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAlgorithm {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAlgorithm")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DeleteAlgorithmEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteAlgorithmResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteAlgorithmRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_algorithm::DeleteAlgorithmInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_algorithm::ser_delete_algorithm_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteAlgorithmEndpointParamsInterceptor {
...
pub type DeleteAlgorithmErrorKind = DeleteAlgorithmError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteAlgorithmError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_algorithm::DeleteAlgorithmError {
...
impl DeleteAlgorithmError {
    ...
    /// Creates the `DeleteAlgorithmError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
