...
impl DescribeWorkteamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_workteam::DescribeWorkteam, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_workteam::ser_describe_workteam_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkteam {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_workteam::de_describe_workteam_http_response_with_props(status, headers, body)
        }
    }
}
