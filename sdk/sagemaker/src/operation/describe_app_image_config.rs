    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_app_image_config::DescribeAppImageConfigError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_app_image_config::DescribeAppImageConfigOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeAppImageConfigResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeAppImageConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_app_image_config::DescribeAppImageConfigInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAppImageConfigEndpointParamsInterceptor {
...
pub type DescribeAppImageConfigErrorKind = DescribeAppImageConfigError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeAppImageConfigError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_app_image_config::DescribeAppImageConfigError {
...
impl DescribeAppImageConfigError {
    ...
    /// Creates the `DescribeAppImageConfigError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
