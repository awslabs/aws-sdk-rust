    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_notebook_instance::CreateNotebookInstanceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_notebook_instance::CreateNotebookInstanceOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateNotebookInstance {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateNotebookInstance", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateNotebookInstance")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateNotebookInstanceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateNotebookInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_notebook_instance::CreateNotebookInstanceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_notebook_instance::ser_create_notebook_instance_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateNotebookInstanceEndpointParamsInterceptor {
...
pub type CreateNotebookInstanceErrorKind = CreateNotebookInstanceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateNotebookInstanceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_notebook_instance::CreateNotebookInstanceError {
...
impl CreateNotebookInstanceError {
    ...
    /// Creates the `CreateNotebookInstanceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
