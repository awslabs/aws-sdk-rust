    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_presigned_domain_url::CreatePresignedDomainUrlError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_presigned_domain_url::CreatePresignedDomainUrlOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreatePresignedDomainUrlResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreatePresignedDomainUrlRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_presigned_domain_url::CreatePresignedDomainUrlInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreatePresignedDomainUrlEndpointParamsInterceptor {
...
pub type CreatePresignedDomainUrlErrorKind = CreatePresignedDomainUrlError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreatePresignedDomainUrlError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_presigned_domain_url::CreatePresignedDomainUrlError {
...
impl CreatePresignedDomainUrlError {
    ...
    /// Creates the `CreatePresignedDomainUrlError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
