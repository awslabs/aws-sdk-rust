...
impl CreatePresignedDomainUrlInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_presigned_domain_url::CreatePresignedDomainUrl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePresignedDomainUrl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_presigned_domain_url::de_create_presigned_domain_url_http_response_with_props(status, headers, body)
        }
    }
}
