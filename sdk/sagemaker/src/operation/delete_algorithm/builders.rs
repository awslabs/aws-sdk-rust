...
impl DeleteAlgorithmFluentBuilder  {
    /// Creates a new `DeleteAlgorithm`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_algorithm::DeleteAlgorithmOutput, aws_smithy_http::result::SdkError<crate::operation::delete_algorithm::DeleteAlgorithmError>>
                     {
