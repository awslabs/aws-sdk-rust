    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_human_task_ui::DescribeHumanTaskUiError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_human_task_ui::DescribeHumanTaskUiOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeHumanTaskUi {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeHumanTaskUi", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeHumanTaskUi")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DescribeHumanTaskUiEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeHumanTaskUiResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeHumanTaskUiRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_human_task_ui::DescribeHumanTaskUiInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_human_task_ui::ser_describe_human_task_ui_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeHumanTaskUiEndpointParamsInterceptor {
...
pub type DescribeHumanTaskUiErrorKind = DescribeHumanTaskUiError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeHumanTaskUiError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_human_task_ui::DescribeHumanTaskUiError {
...
impl DescribeHumanTaskUiError {
    ...
    /// Creates the `DescribeHumanTaskUiError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
