...
impl ListTrialsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_trials::ListTrials::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_trials::de_list_trials_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_trials::de_list_trials_http_response_with_props(
                status, headers, body,
            )
        }
    }
