...
impl ListTrialsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_trials::ListTrials, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_trials::ser_list_trials_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_trials::de_list_trials_http_response_with_props(status, headers, body)
        }
    }
}
