...
impl SendPipelineExecutionStepFailureInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailure::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendPipelineExecutionStepFailure {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_pipeline_execution_step_failure::de_send_pipeline_execution_step_failure_http_response_with_props(
                status, headers, body,
            )
        }
    }
