...
impl CreateImageVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_image_version::CreateImageVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_image_version::CreateImageVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_image_version::CreateImageVersionOutput, crate::operation::create_image_version::CreateImageVersionError, Self> {
