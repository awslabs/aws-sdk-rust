...
/// Paginator for [`ListClusterEvents`](crate::operation::list_cluster_events::ListClusterEvents)
pub struct ListClusterEventsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_cluster_events::builders::ListClusterEventsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListClusterEventsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_cluster_events::paginator::ListClusterEventsPaginatorItems {
        crate::operation::list_cluster_events::paginator::ListClusterEventsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_cluster_events::ListClusterEvents::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_cluster_events_output_output_next_token(resp);
...
/// Flattened paginator for `ListClusterEventsPaginator`
///
/// This is created with [`.items()`](ListClusterEventsPaginator::items)
pub struct ListClusterEventsPaginatorItems(ListClusterEventsPaginator);

impl ListClusterEventsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_cluster_events_output_output_events(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
