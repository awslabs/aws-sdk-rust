...
pub use crate::operation::list_labeling_jobs::_list_labeling_jobs_output::ListLabelingJobsOutputBuilder;

pub use crate::operation::list_labeling_jobs::_list_labeling_jobs_input::ListLabelingJobsInputBuilder;
...
impl ListLabelingJobsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_labeling_jobs();
...
pub struct ListLabelingJobsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_labeling_jobs::builders::ListLabelingJobsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_labeling_jobs::ListLabelingJobsOutput,
                    crate::operation::list_labeling_jobs::ListLabelingJobsError,
                > for ListLabelingJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListLabelingJobsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_labeling_jobs::builders::ListLabelingJobsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_labeling_jobs::ListLabelingJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_labeling_jobs::ListLabelingJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_labeling_jobs::ListLabelingJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_labeling_jobs::ListLabelingJobsOutput, crate::operation::list_labeling_jobs::ListLabelingJobsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_labeling_jobs::paginator::ListLabelingJobsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_labeling_jobs::paginator::ListLabelingJobsPaginator {
                                crate::operation::list_labeling_jobs::paginator::ListLabelingJobsPaginator::new(self.handle, self.inner)
                            }
