...
impl DescribeDataQualityJobDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_data_quality_job_definition::DescribeDataQualityJobDefinition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_data_quality_job_definition::DescribeDataQualityJobDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataQualityJobDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_quality_job_definition::de_describe_data_quality_job_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
