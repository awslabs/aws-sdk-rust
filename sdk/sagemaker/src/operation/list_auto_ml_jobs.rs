...
impl ListAutoMlJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_auto_ml_jobs::ListAutoMLJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_auto_ml_jobs::ser_list_auto_ml_jobs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAutoMLJobs {
    type Output =
        ::std::result::Result<crate::operation::list_auto_ml_jobs::ListAutoMlJobsOutput, crate::operation::list_auto_ml_jobs::ListAutoMLJobsError>;
