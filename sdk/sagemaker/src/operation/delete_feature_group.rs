...
impl DeleteFeatureGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_feature_group::DeleteFeatureGroup,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_feature_group::ser_delete_feature_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFeatureGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_feature_group::de_delete_feature_group_http_response_with_props(status, headers, body)
        }
    }
}
