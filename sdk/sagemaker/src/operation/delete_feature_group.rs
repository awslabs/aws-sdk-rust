...
/// Orchestration and serialization glue logic for `DeleteFeatureGroup`.
...
impl DeleteFeatureGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_feature_group::DeleteFeatureGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_feature_group::DeleteFeatureGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_feature_group::DeleteFeatureGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_feature_group::DeleteFeatureGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_feature_group::DeleteFeatureGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFeatureGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFeatureGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFeatureGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFeatureGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFeatureGroup")
...
.with_interceptor(DeleteFeatureGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_feature_group::DeleteFeatureGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_feature_group::DeleteFeatureGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_feature_group::DeleteFeatureGroupError>::new());
...
#[derive(Debug)]
            struct DeleteFeatureGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFeatureGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_feature_group::de_delete_feature_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_feature_group::de_delete_feature_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFeatureGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFeatureGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_feature_group::DeleteFeatureGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_feature_group::DeleteFeatureGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_feature_group::ser_delete_feature_group_input(&input)?);
...
#[derive(Debug)]
            struct DeleteFeatureGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFeatureGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFeatureGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFeatureGroupInput>()
                        .ok_or("failed to downcast to DeleteFeatureGroupInput")?;
...
/// Error type for the `DeleteFeatureGroupError` operation.
#[non_exhaustive]
...
pub enum DeleteFeatureGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFeatureGroupError) for what information is available for the error.")]
...
impl DeleteFeatureGroupError {
    /// Creates the `DeleteFeatureGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFeatureGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteFeatureGroupError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteFeatureGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFeatureGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_feature_group::DeleteFeatureGroupError {
...
mod _delete_feature_group_output;
