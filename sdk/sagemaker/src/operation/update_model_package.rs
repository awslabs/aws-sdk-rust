...
impl UpdateModelPackageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_model_package::ser_update_model_package_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateModelPackage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_model_package::de_update_model_package_http_response_with_props(status, headers, body)
        }
    }
}
