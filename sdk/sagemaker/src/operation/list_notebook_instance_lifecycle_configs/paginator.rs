...
impl ListNotebookInstanceLifecycleConfigsPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_notebook_instance_lifecycle_configs::ListNotebookInstanceLifecycleConfigs::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_notebook_instance_lifecycle_configs::ListNotebookInstanceLifecycleConfigs::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl ListNotebookInstanceLifecycleConfigsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_notebook_instance_lifecycle_configs_output_output_notebook_instance_lifecycle_configs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
