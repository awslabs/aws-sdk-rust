...
impl CreateHumanTaskUi {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_human_task_ui::CreateHumanTaskUiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_human_task_ui::CreateHumanTaskUiError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_human_task_ui::CreateHumanTaskUiError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_human_task_ui::CreateHumanTaskUiOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateHumanTaskUi {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateHumanTaskUi");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateHumanTaskUiRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateHumanTaskUiResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateHumanTaskUi")
...
.with_interceptor(CreateHumanTaskUiEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_human_task_ui::CreateHumanTaskUiError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_human_task_ui::CreateHumanTaskUiError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_human_task_ui::CreateHumanTaskUiError>::new());
...
#[derive(Debug)]
            struct CreateHumanTaskUiResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateHumanTaskUiResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_human_task_ui::de_create_human_task_ui_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_human_task_ui::de_create_human_task_ui_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateHumanTaskUiRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateHumanTaskUiRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_human_task_ui::CreateHumanTaskUiInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_human_task_ui::CreateHumanTaskUiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_human_task_ui::ser_create_human_task_ui_input(&input)?);
...
#[derive(Debug)]
            struct CreateHumanTaskUiEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateHumanTaskUiEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateHumanTaskUiEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateHumanTaskUiInput>()
                        .ok_or("failed to downcast to CreateHumanTaskUiInput")?;
...
/// Error type for the `CreateHumanTaskUiError` operation.
#[non_exhaustive]
...
pub enum CreateHumanTaskUiError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateHumanTaskUiError) for what information is available for the error.")]
...
impl CreateHumanTaskUiError {
    /// Creates the `CreateHumanTaskUiError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateHumanTaskUiError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateHumanTaskUiError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateHumanTaskUiError::ResourceLimitExceeded`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateHumanTaskUiError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateHumanTaskUiError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_human_task_ui::CreateHumanTaskUiError {
...
mod _create_human_task_ui_output;
