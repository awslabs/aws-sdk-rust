...
impl DeleteModelQualityJobDefinitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_model_quality_job_definition::DeleteModelQualityJobDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteModelQualityJobDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_model_quality_job_definition::de_delete_model_quality_job_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
