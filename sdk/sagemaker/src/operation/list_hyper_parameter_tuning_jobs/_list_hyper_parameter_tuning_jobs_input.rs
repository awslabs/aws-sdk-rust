...
impl ListHyperParameterTuningJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_hyper_parameter_tuning_jobs::ListHyperParameterTuningJobsInput, ::aws_smithy_types::error::operation::BuildError> {
