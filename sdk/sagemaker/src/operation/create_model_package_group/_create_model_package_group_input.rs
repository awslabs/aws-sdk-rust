...
impl CreateModelPackageGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_model_package_group::CreateModelPackageGroupInput, ::aws_smithy_types::error::operation::BuildError> {
