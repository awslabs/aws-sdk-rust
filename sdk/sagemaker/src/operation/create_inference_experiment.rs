    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_inference_experiment::CreateInferenceExperimentError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_inference_experiment::CreateInferenceExperimentOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateInferenceExperiment {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateInferenceExperiment", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateInferenceExperiment")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateInferenceExperimentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateInferenceExperimentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_inference_experiment::CreateInferenceExperimentInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateInferenceExperimentEndpointParamsInterceptor {
...
pub type CreateInferenceExperimentErrorKind = CreateInferenceExperimentError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateInferenceExperimentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_inference_experiment::CreateInferenceExperimentError {
...
impl CreateInferenceExperimentError {
    ...
    /// Creates the `CreateInferenceExperimentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
