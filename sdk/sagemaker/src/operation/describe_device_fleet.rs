    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_device_fleet::DescribeDeviceFleetError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_device_fleet::DescribeDeviceFleetOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDeviceFleet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeDeviceFleet", "sagemaker"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDeviceFleet")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DescribeDeviceFleetEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDeviceFleetResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDeviceFleetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_device_fleet::DescribeDeviceFleetInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_device_fleet::ser_describe_device_fleet_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDeviceFleetEndpointParamsInterceptor {
...
pub type DescribeDeviceFleetErrorKind = DescribeDeviceFleetError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeDeviceFleetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_device_fleet::DescribeDeviceFleetError {
...
impl DescribeDeviceFleetError {
    ...
    /// Creates the `DescribeDeviceFleetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
