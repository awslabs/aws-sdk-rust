...
impl CreateInferenceRecommendationsJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInferenceRecommendationsJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_inference_recommendations_job::de_create_inference_recommendations_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
