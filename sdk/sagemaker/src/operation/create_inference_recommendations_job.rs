...
/// Orchestration and serialization glue logic for `CreateInferenceRecommendationsJob`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateInferenceRecommendationsJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateInferenceRecommendationsJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateInferenceRecommendationsJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateInferenceRecommendationsJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateInferenceRecommendationsJob")
...
.with_interceptor(CreateInferenceRecommendationsJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobError>::new());
...
#[derive(Debug)]
            struct CreateInferenceRecommendationsJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateInferenceRecommendationsJobResponseDeserializer {
...
#[derive(Debug)]
            struct CreateInferenceRecommendationsJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateInferenceRecommendationsJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_inference_recommendations_job::ser_create_inference_recommendations_job_input(&input)?);
...
#[derive(Debug)]
            struct CreateInferenceRecommendationsJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateInferenceRecommendationsJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateInferenceRecommendationsJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateInferenceRecommendationsJobInput>()
                        .ok_or("failed to downcast to CreateInferenceRecommendationsJobInput")?;
...
/// Error type for the `CreateInferenceRecommendationsJobError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateInferenceRecommendationsJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateInferenceRecommendationsJobError) for what information is available for the error.")]
...
impl CreateInferenceRecommendationsJobError {
    /// Creates the `CreateInferenceRecommendationsJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateInferenceRecommendationsJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateInferenceRecommendationsJobError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateInferenceRecommendationsJobError::ResourceLimitExceeded`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateInferenceRecommendationsJobError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateInferenceRecommendationsJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_inference_recommendations_job::CreateInferenceRecommendationsJobError {
...
mod _create_inference_recommendations_job_output;
