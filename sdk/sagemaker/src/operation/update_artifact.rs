...
impl UpdateArtifactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_artifact::UpdateArtifact,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_artifact::UpdateArtifact::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateArtifact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_artifact::de_update_artifact_http_error(
                status, headers, body,
            )
        } else {
