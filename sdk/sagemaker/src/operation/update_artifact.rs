...
impl UpdateArtifactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_artifact::UpdateArtifact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_artifact::ser_update_artifact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateArtifact {
    type Output =
        ::std::result::Result<crate::operation::update_artifact::UpdateArtifactOutput, crate::operation::update_artifact::UpdateArtifactError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_artifact::de_update_artifact_http_response_with_props(status, headers, body)
        }
    }
}
