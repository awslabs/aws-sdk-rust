    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_trial_component::UpdateTrialComponentError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_trial_component::UpdateTrialComponentOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateTrialComponentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateTrialComponentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_trial_component::UpdateTrialComponentInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_trial_component::ser_update_trial_component_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateTrialComponentEndpointParamsInterceptor {
...
pub type UpdateTrialComponentErrorKind = UpdateTrialComponentError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateTrialComponentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_trial_component::UpdateTrialComponentError {
...
impl UpdateTrialComponentError {
    ...
    /// Creates the `UpdateTrialComponentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
