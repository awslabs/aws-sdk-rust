    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_edge_packaging_job::StopEdgePackagingJobError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_edge_packaging_job::StopEdgePackagingJobOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopEdgePackagingJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopEdgePackagingJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_edge_packaging_job::StopEdgePackagingJobInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_edge_packaging_job::ser_stop_edge_packaging_job_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopEdgePackagingJobEndpointParamsInterceptor {
...
pub type StopEdgePackagingJobErrorKind = StopEdgePackagingJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopEdgePackagingJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_edge_packaging_job::StopEdgePackagingJobError {
...
impl StopEdgePackagingJobError {
    ...
    /// Creates the `StopEdgePackagingJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
