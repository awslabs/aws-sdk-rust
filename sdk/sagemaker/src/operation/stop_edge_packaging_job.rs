...
impl StopEdgePackagingJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_edge_packaging_job::StopEdgePackagingJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopEdgePackagingJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_edge_packaging_job::de_stop_edge_packaging_job_http_response_with_props(status, headers, body)
        }
    }
}
