...
impl CreateDataQualityJobDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_data_quality_job_definition::CreateDataQualityJobDefinition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_data_quality_job_definition::CreateDataQualityJobDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataQualityJobDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_data_quality_job_definition::de_create_data_quality_job_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
