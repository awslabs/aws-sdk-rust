...
impl CreateArtifactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_artifact::CreateArtifact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_artifact::ser_create_artifact_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateArtifact {
    type Output =
        ::std::result::Result<crate::operation::create_artifact::CreateArtifactOutput, crate::operation::create_artifact::CreateArtifactError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_artifact::de_create_artifact_http_response_with_props(status, headers, body)
        }
    }
}
