...
///
/// <p>Deletes a job. This operation is idempotent. If the job is currently running, you must stop it before deleting it by calling <code>StopJob</code>.</p>
/// <p>The following operations are related to <code>DeleteJob</code>:</p>
/// <ul>
/// <li>
