...
) -> Result<crate::output::send_pipeline_execution_step_failure_output::Builder, serde_json::Error>
{
...
) -> Result<crate::output::send_pipeline_execution_step_success_output::Builder, serde_json::Error>
{
