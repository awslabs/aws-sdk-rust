...
pub fn ser_update_model_package_input(
    ...
    crate::protocol_serde::shape_update_model_package_input::ser_update_model_package_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_model_package::de_update_model_package(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_model_package::UpdateModelPackageError::unhandled)?;
