...
pub fn de_update_model_package_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_model_package_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_model_package::de_update_model_package(_response_body, output)
            .map_err(crate::operation::update_model_package::UpdateModelPackageError::unhandled)?;
...
pub(crate) fn de_update_model_package(
    value: &[u8],
    mut builder: crate::operation::update_model_package::builders::UpdateModelPackageOutputBuilder,
) -> Result<crate::operation::update_model_package::builders::UpdateModelPackageOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
