...
pub fn ser_update_context_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateContextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
