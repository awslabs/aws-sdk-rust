...
pub fn ser_auto_ml_job_channel(
    ...
    if let Some(var_4) = &input.data_source {
        ...
        crate::protocol_serde::shape_auto_ml_data_source::ser_auto_ml_data_source(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
...
pub(crate) fn de_auto_ml_job_channel<'a, I>(
    ...
    Option<crate::types::AutoMlJobChannel>,
                        ...
                        .as_ref()
                    {
                        "ChannelType" => {
                            builder = builder.set_channel_type(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::AutoMlChannelType::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
