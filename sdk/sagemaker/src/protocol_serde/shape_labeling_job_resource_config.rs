...
pub(crate) fn de_labeling_job_resource_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::LabelingJobResourceConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
