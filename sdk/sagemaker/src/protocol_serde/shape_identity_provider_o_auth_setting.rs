...
pub(crate) fn de_identity_provider_o_auth_setting<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::IdentityProviderOAuthSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_data_source_name(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::DataSourceName::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
