...
pub(crate) fn de_identity_provider_o_auth_setting<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::IdentityProviderOAuthSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::IdentityProviderOAuthSettingBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "DataSourceName" => {
                            builder = builder.set_data_source_name(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::DataSourceName::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Status" => {
