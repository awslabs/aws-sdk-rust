...
pub fn ser_list_auto_ml_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAutoMlJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
