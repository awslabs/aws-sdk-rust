...
pub fn ser_list_model_cards_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_model_cards::ListModelCardsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
