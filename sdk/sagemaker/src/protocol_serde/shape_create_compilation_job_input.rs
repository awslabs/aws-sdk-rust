...
pub fn ser_create_compilation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCompilationJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
