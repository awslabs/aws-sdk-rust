...
) -> Result<Option<crate::types::ProcessingJob>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ProcessingResources" => {
                            builder =
                                builder.set_processing_resources(crate::protocol_serde::shape_processing_resources::de_processing_resources(tokens)?);
                        }
                        "StoppingCondition" => {
                        ...
                        "ProcessingStartTime" => {
                            builder = builder.set_processing_start_time(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
