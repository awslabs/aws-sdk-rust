...
pub fn ser_describe_trial_input(
    ...
    crate::protocol_serde::shape_describe_trial_input::ser_describe_trial_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_trial::DescribeTrialError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::describe_trial::DescribeTrialError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_trial_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_trial::de_describe_trial(_response_body, output)
                .map_err(crate::operation::describe_trial::DescribeTrialError::unhandled)?;
