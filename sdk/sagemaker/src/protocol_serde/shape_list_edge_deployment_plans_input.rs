...
pub fn ser_list_edge_deployment_plans_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEdgeDeploymentPlansInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
