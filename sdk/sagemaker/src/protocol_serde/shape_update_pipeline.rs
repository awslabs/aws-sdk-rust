    ...
    Err(match error_code {
        "ResourceNotFound" => crate::error::UpdatePipelineError::ResourceNotFound({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(response.body().as_ref(), output).map_err(crate::error::UpdatePipelineError::unhandled)?;
