...
pub fn ser_list_training_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTrainingJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
