...
pub fn ser_query_lineage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QueryLineageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
