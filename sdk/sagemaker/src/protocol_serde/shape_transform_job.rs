            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ModelClientConfig" => {
                            builder = builder
                                .set_model_client_config(crate::protocol_serde::shape_model_client_config::de_model_client_config(tokens, _value)?);
                        }
                        "MaxPayloadInMB" => {
                        ...
                        "DataCaptureConfig" => {
                            builder = builder.set_data_capture_config(
                                crate::protocol_serde::shape_batch_data_capture_config::de_batch_data_capture_config(tokens, _value)?,
                            );
                        }
                        "TransformResources" => {
                            builder = builder
