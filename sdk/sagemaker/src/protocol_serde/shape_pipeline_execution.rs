...
pub(crate) fn de_pipeline_execution<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PipelineExecution>, aws_smithy_json::deserialize::error::DeserializeError>
