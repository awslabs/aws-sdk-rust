...
pub fn ser_create_labeling_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLabelingJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
