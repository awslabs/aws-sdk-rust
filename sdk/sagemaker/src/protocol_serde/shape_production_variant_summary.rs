...
pub(crate) fn de_production_variant_summary<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ProductionVariantSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
