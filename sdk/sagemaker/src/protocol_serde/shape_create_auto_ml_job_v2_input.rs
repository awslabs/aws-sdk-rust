...
pub fn ser_create_auto_ml_job_v2_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_auto_ml_job_v2::CreateAutoMlJobV2Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
