...
pub(crate) fn de_user_profile_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UserProfileDetails>, aws_smithy_json::deserialize::error::DeserializeError>
