...
pub(crate) fn de_model_bias_baseline_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ModelBiasBaselineConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
