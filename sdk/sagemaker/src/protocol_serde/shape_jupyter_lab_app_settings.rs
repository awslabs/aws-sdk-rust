...
pub fn ser_jupyter_lab_app_settings(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::JupyterLabAppSettings,
    ...
    if let Some(var_10) = &input.code_repositories {
        let mut array_11 = object.key("CodeRepositories").start_array();
        for item_12 in var_10 {
             {
                #[allow(unused_mut)]
                let mut object_13 = array_11.value().start_object();
                crate::protocol_serde::shape_code_repository::ser_code_repository(&mut object_13, item_12)?;
                object_13.finish();
            }
        }
        array_11.finish();
...
pub(crate) fn de_jupyter_lab_app_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::JupyterLabAppSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::JupyterLabAppSettingsBuilder::default();
            loop {
                match tokens.next().transpose()? {
