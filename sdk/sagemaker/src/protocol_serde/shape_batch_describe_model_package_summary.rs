...
pub(crate) fn de_batch_describe_model_package_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchDescribeModelPackageSummary>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::batch_describe_model_package_summary::Builder::default();
            loop {
                match tokens.next().transpose()? {
