...
pub fn ser_list_human_task_uis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_human_task_uis::ListHumanTaskUisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
