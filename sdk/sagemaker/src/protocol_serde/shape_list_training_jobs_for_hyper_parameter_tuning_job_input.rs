...
pub fn ser_list_training_jobs_for_hyper_parameter_tuning_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTrainingJobsForHyperParameterTuningJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
