...
pub fn ser_create_model_package_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_model_package_group::CreateModelPackageGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
