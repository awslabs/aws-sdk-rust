...
pub fn ser_list_transform_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTransformJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
