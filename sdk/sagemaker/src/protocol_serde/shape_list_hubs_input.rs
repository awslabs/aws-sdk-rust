...
pub fn ser_list_hubs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_hubs::ListHubsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
