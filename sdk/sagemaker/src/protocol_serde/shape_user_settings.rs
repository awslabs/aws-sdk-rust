            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SharingSettings" => {
                            builder = builder.set_sharing_settings(crate::protocol_serde::shape_sharing_settings::de_sharing_settings(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "TensorBoardAppSettings" => {
                            builder = builder.set_tensor_board_app_settings(
                                crate::protocol_serde::shape_tensor_board_app_settings::de_tensor_board_app_settings(tokens, _value, depth + 1)?,
                            );
                        }
                        "RStudioServerProAppSettings" => {
                            builder = builder.set_r_studio_server_pro_app_settings(
                                crate::protocol_serde::shape_r_studio_server_pro_app_settings::de_r_studio_server_pro_app_settings(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "RSessionAppSettings" => {
                            builder = builder.set_r_session_app_settings(
                                crate::protocol_serde::shape_r_session_app_settings::de_r_session_app_settings(tokens, _value, depth + 1)?,
                            );
                        }
                        "CanvasAppSettings" => {
                            builder = builder.set_canvas_app_settings(crate::protocol_serde::shape_canvas_app_settings::de_canvas_app_settings(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "CodeEditorAppSettings" => {
                            builder = builder.set_code_editor_app_settings(
                                crate::protocol_serde::shape_code_editor_app_settings::de_code_editor_app_settings(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "StudioWebPortalSettings" => {
                            builder = builder.set_studio_web_portal_settings(
                                crate::protocol_serde::shape_studio_web_portal_settings::de_studio_web_portal_settings(tokens, _value, depth + 1)?,
                            );
                        }
                        "AutoMountHomeEFS" => {
