...
pub(crate) fn de_processing_s3_input<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ProcessingS3Input>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "S3DataType" => {
                            builder = builder.set_s3_data_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ProcessingS3DataType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "S3InputMode" => {
                        ...
                        "S3CompressionType" => {
                            builder = builder.set_s3_compression_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ProcessingS3CompressionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
