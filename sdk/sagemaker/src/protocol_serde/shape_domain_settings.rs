...
pub fn ser_domain_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_domain_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DomainSettings>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::domain_settings::Builder::default();
            loop {
                match tokens.next().transpose()? {
                                ...
                                builder = builder.set_execution_role_identity_config(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::ExecutionRoleIdentityConfig::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
