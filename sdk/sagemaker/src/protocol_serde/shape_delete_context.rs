...
pub fn ser_delete_context_input(input: &crate::operation::delete_context::DeleteContextInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
