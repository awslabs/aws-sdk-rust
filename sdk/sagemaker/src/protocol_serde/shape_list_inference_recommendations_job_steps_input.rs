...
pub fn ser_list_inference_recommendations_job_steps_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListInferenceRecommendationsJobStepsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
