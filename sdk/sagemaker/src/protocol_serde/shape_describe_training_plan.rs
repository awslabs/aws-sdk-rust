...
pub fn de_describe_training_plan_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_training_plan::DescribeTrainingPlanError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::describe_training_plan::DescribeTrainingPlanError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "ResourceNotFound" => crate::operation::describe_training_plan::DescribeTrainingPlanError::ResourceNotFound({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_training_plan::DescribeTrainingPlanError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_training_plan_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_training_plan::builders::DescribeTrainingPlanOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_training_plan::de_describe_training_plan(_response_body, output)
            .map_err(crate::operation::describe_training_plan::DescribeTrainingPlanError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_training_plan_output_output_correct_errors(output).build()
    })
}

pub fn ser_describe_training_plan_input(
    input: &crate::operation::describe_training_plan::DescribeTrainingPlanInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_describe_training_plan_input::ser_describe_training_plan_input_input(&mut object, input)?;
    object.finish();
