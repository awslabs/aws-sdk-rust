...
pub fn ser_create_processing_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProcessingJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
