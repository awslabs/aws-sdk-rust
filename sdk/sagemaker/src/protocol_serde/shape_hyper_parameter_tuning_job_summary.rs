...
pub(crate) fn de_hyper_parameter_tuning_job_summary<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::HyperParameterTuningJobSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::hyper_parameter_tuning_job_summary_correct_errors(builder).build()))
        }
        _ => {
