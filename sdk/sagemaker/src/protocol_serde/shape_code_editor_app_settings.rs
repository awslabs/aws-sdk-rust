...
pub(crate) fn de_code_editor_app_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CodeEditorAppSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
