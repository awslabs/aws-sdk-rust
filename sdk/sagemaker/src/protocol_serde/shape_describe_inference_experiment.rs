...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_inference_experiment::DescribeInferenceExperimentError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_inference_experiment::de_describe_inference_experiment(_response_body, output)
            .map_err(crate::operation::describe_inference_experiment::DescribeInferenceExperimentError::unhandled)?;
