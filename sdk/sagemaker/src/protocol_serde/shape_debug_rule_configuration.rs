...
pub fn ser_debug_rule_configuration(
    ...
    if let Some(var_6) = &input.volume_size_in_gb {
        object.key("VolumeSizeInGB").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.rule_parameters {
        #[allow(unused_mut)]
        let mut object_8 = object.key("RuleParameters").start_object();
...
pub(crate) fn de_debug_rule_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DebugRuleConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::debug_rule_configuration_correct_errors(builder).build()))
        }
        _ => {
