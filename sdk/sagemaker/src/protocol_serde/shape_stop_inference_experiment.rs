...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_stop_inference_experiment::de_stop_inference_experiment(
...
pub(crate) fn de_stop_inference_experiment(
    value: &[u8],
    mut builder: crate::output::stop_inference_experiment_output::Builder,
) -> Result<
    crate::output::stop_inference_experiment_output::Builder,
