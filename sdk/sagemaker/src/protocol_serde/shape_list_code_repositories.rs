...
pub fn de_list_code_repositories_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_code_repositories_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_list_code_repositories(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "CodeRepositorySummaryList" => {
                    builder = builder.set_code_repository_summary_list(
                        crate::protocol_serde::shape_code_repository_summary_list::de_code_repository_summary_list(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
