...
pub fn ser_create_feature_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFeatureGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
