...
pub fn ser_model_data_quality(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ModelDataQuality) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
