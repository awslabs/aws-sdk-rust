...
pub fn ser_network_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::NetworkConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_network_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::NetworkConfig>, aws_smithy_json::deserialize::error::DeserializeError>
