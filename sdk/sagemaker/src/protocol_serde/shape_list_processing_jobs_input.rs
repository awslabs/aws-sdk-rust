...
pub fn ser_list_processing_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_processing_jobs::ListProcessingJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
