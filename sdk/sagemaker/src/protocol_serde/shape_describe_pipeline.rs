...
pub fn ser_describe_pipeline_input(
    ...
    crate::protocol_serde::shape_describe_pipeline_input::ser_describe_pipeline_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::describe_pipeline::DescribePipelineError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
