...
) -> Result<Option<crate::model::Channel>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "RecordWrapperType" => {
                                builder = builder.set_record_wrapper_type(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::model::RecordWrapper::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            "InputMode" => {
                                builder = builder.set_input_mode(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::model::TrainingInputMode::from(u.as_ref())
                                        })
                                    })
                                    .transpose()?,
                                );
