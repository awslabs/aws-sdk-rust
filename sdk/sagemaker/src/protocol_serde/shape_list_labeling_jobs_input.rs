...
pub fn ser_list_labeling_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_labeling_jobs::ListLabelingJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
