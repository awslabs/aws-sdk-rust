...
pub fn ser_create_notebook_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNotebookInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
