...
pub fn ser_describe_workteam_input(
    ...
    crate::protocol_serde::shape_describe_workteam_input::ser_describe_workteam_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_workteam::de_describe_workteam(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_workteam::DescribeWorkteamError::unhandled)?;
