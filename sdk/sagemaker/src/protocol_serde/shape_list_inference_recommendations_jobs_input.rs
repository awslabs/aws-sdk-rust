...
pub fn ser_list_inference_recommendations_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListInferenceRecommendationsJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
