...
pub fn de_describe_model_package_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_model_package::DescribeModelPackageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_model_package_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_model_package::de_describe_model_package(_response_body, output)
            .map_err(crate::operation::describe_model_package::DescribeModelPackageError::unhandled)?;
...
pub(crate) fn de_describe_model_package(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "SourceAlgorithmSpecification" => {
                    builder = builder.set_source_algorithm_specification(
                        crate::protocol_serde::shape_source_algorithm_specification::de_source_algorithm_specification(tokens, _value, depth + 1)?,
                    );
                }
                ...
                "ModelPackageStatus" => {
                    builder = builder.set_model_package_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ModelPackageStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "ModelPackageStatusDetails" => {
                    builder = builder.set_model_package_status_details(
                        crate::protocol_serde::shape_model_package_status_details::de_model_package_status_details(tokens, _value, depth + 1)?,
                    );
                }
                "CertifyForMarketplace" => {
                    builder = builder.set_certify_for_marketplace(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                "ModelApprovalStatus" => {
                    builder = builder.set_model_approval_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ModelApprovalStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "CreatedBy" => {
                ...
                "ModelMetrics" => {
                    builder = builder.set_model_metrics(crate::protocol_serde::shape_model_metrics::de_model_metrics(tokens, _value, depth + 1)?);
                }
                "LastModifiedTime" => {
                ...
                "CustomerMetadataProperties" => {
                    builder = builder.set_customer_metadata_properties(crate::protocol_serde::shape_customer_metadata_map::de_customer_metadata_map(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "DriftCheckBaselines" => {
                    builder = builder.set_drift_check_baselines(crate::protocol_serde::shape_drift_check_baselines::de_drift_check_baselines(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "SecurityConfig" => {
                    builder = builder.set_security_config(
                        crate::protocol_serde::shape_model_package_security_config::de_model_package_security_config(tokens, _value, depth + 1)?,
                    );
                }
                "ModelCard" => {
