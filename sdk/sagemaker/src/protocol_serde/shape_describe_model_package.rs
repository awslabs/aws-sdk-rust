...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_model_package_input::ser_describe_model_package_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_model_package::de_describe_model_package(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_model_package::DescribeModelPackageError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ModelPackageStatus" => {
                        builder = builder.set_model_package_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::ModelPackageStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "ModelApprovalStatus" => {
                        builder = builder.set_model_approval_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::ModelApprovalStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
