...
pub(crate) fn de_describe_model_package(
    ...
    crate::output::describe_model_package_output::Builder,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ModelPackageStatus" => {
                        builder = builder.set_model_package_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::ModelPackageStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "ModelApprovalStatus" => {
                        builder = builder.set_model_approval_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::ModelApprovalStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
