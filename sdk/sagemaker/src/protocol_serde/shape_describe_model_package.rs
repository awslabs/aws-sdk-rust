...
pub fn de_describe_model_package_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_model_package::DescribeModelPackageOutput, crate::operation::describe_model_package::DescribeModelPackageError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_model_package_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_model_package::DescribeModelPackageOutput, crate::operation::describe_model_package::DescribeModelPackageError> {
    Ok({
        #[allow(unused_mut)]
