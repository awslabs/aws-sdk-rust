...
pub fn ser_describe_model_package_input(input: &crate::input::DescribeModelPackageInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_describe_model_package_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeModelPackageOutput, crate::error::DescribeModelPackageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeModelPackageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_model_package_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeModelPackageOutput, crate::error::DescribeModelPackageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_model_package_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_model_package::de_describe_model_package(response.body().as_ref(), output).map_err(crate::error::DescribeModelPackageError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_model_package(value: &[u8], mut builder: crate::output::describe_model_package_output::Builder) -> Result<crate::output::describe_model_package_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ModelPackageStatus" => {
                        builder = builder.set_model_package_status(
                            aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                s.to_unescaped().map(|u|
                                    crate::model::ModelPackageStatus::from(u.as_ref())
                                )
                            ).transpose()?
                        );
                    }
                    ...
                    "ModelApprovalStatus" => {
                        builder = builder.set_model_approval_status(
                            aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                s.to_unescaped().map(|u|
                                    crate::model::ModelApprovalStatus::from(u.as_ref())
                                )
                            ).transpose()?
                        );
                    }
