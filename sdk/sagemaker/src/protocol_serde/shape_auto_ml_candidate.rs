...
pub(crate) fn de_auto_ml_candidate<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoMlCandidate>, aws_smithy_json::deserialize::error::DeserializeError>
