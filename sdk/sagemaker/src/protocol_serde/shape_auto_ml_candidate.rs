                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CandidateSteps" => {
                                builder = builder.set_candidate_steps(crate::protocol_serde::shape_candidate_steps::de_candidate_steps(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "InferenceContainers" => {
                                builder = builder.set_inference_containers(
                                    crate::protocol_serde::shape_auto_ml_container_definitions::de_auto_ml_container_definitions(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "CandidateProperties" => {
                                builder = builder.set_candidate_properties(
                                    crate::protocol_serde::shape_candidate_properties::de_candidate_properties(tokens, _value, depth + 1)?,
                                );
                            }
