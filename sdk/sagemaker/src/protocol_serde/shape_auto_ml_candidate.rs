...
pub(crate) fn de_auto_ml_candidate<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AutoMlCandidate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "FinalAutoMLJobObjectiveMetric" => {
                            builder = builder.set_final_auto_ml_job_objective_metric(
                                crate::protocol_serde::shape_final_auto_ml_job_objective_metric::de_final_auto_ml_job_objective_metric(
                                    tokens, _value,
                                )?,
                            );
                        }
                        ...
                        "CandidateSteps" => {
                            builder = builder.set_candidate_steps(crate::protocol_serde::shape_candidate_steps::de_candidate_steps(tokens, _value)?);
                        }
                        "CandidateStatus" => {
                        ...
                        "InferenceContainers" => {
                            builder = builder.set_inference_containers(
                                crate::protocol_serde::shape_auto_ml_container_definitions::de_auto_ml_container_definitions(tokens, _value)?,
                            );
                        }
                        "CreationTime" => {
                        ...
                        "CandidateProperties" => {
                            builder = builder.set_candidate_properties(crate::protocol_serde::shape_candidate_properties::de_candidate_properties(
                                tokens, _value,
                            )?);
                        }
