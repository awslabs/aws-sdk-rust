...
pub fn ser_create_flow_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFlowDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
