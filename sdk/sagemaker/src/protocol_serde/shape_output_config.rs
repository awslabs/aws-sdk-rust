...
pub fn ser_output_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutputConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_output_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OutputConfig>, aws_smithy_json::deserialize::error::DeserializeError>
