...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_app_image_config::DescribeAppImageConfigError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_app_image_config::de_describe_app_image_config(_response_body, output)
            .map_err(crate::operation::describe_app_image_config::DescribeAppImageConfigError::unhandled)?;
