...
pub fn de_update_endpoint_weights_and_capacities_http_error(
...
> {
    ...
    Err(match error_code {
        "ResourceLimitExceeded" => {
            crate::operation::update_endpoint_weights_and_capacities::UpdateEndpointWeightsAndCapacitiesError::ResourceLimitExceeded({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_endpoint_weights_and_capacities_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_update_endpoint_weights_and_capacities_input(
    ...
    crate::protocol_serde::shape_update_endpoint_weights_and_capacities_input::ser_update_endpoint_weights_and_capacities_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_update_endpoint_weights_and_capacities(
    value: &[u8],
