...
pub fn ser_create_transform_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTransformJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
