...
pub fn ser_list_optimization_jobs_input_input(
    ...
    if let Some(var_7) = &input.optimization_contains {
        object.key("OptimizationContains").string(var_7.as_str());
    }
    if let Some(var_8) = &input.name_contains {
        object.key("NameContains").string(var_8.as_str());
    }
