...
pub(crate) fn de_monitoring_cluster_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::MonitoringClusterConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
