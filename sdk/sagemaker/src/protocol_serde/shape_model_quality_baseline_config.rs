...
pub fn ser_model_quality_baseline_config(
...
pub(crate) fn de_model_quality_baseline_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ModelQualityBaselineConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ConstraintsResource" => {
                            builder = builder.set_constraints_resource(
                                crate::protocol_serde::shape_monitoring_constraints_resource::de_monitoring_constraints_resource(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
