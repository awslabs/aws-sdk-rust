...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_algorithm_input::ser_describe_algorithm_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_algorithm::de_describe_algorithm(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_algorithm::DescribeAlgorithmError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "AlgorithmStatus" => {
                        builder = builder.set_algorithm_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::AlgorithmStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
