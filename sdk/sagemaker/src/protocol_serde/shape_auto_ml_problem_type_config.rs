...
pub fn ser_auto_ml_problem_type_config(object_9: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AutoMlProblemTypeConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::AutoMlProblemTypeConfig::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("AutoMlProblemTypeConfig"))
    }
    Ok(())
}
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            ...
                            "TimeSeriesForecastingJobConfig" => {
                                Some(crate::types::AutoMlProblemTypeConfig::TimeSeriesForecastingJobConfig(
                                    crate::protocol_serde::shape_time_series_forecasting_job_config::de_time_series_forecasting_job_config(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'TimeSeriesForecastingJobConfig' cannot be null"))?
                                ))
                            }
                            "TabularJobConfig" => {
                                Some(crate::types::AutoMlProblemTypeConfig::TabularJobConfig(
                                    crate::protocol_serde::shape_tabular_job_config::de_tabular_job_config(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'TabularJobConfig' cannot be null"))?
                                ))
                            }
                            "TextGenerationJobConfig" => {
                                Some(crate::types::AutoMlProblemTypeConfig::TextGenerationJobConfig(
                                    crate::protocol_serde::shape_text_generation_job_config::de_text_generation_job_config(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'TextGenerationJobConfig' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
