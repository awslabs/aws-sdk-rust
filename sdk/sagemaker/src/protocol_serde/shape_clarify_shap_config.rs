                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ShapBaselineConfig" => {
                            builder = builder.set_shap_baseline_config(
                                crate::protocol_serde::shape_clarify_shap_baseline_config::de_clarify_shap_baseline_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "TextConfig" => {
                            builder = builder.set_text_config(crate::protocol_serde::shape_clarify_text_config::de_clarify_text_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
