...
) -> Result<Option<crate::types::PipelineExecutionStepMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Model" => {
                            builder = builder.set_model(crate::protocol_serde::shape_model_step_metadata::de_model_step_metadata(tokens)?);
                        }
                        "RegisterModel" => {
                        ...
                        "Condition" => {
                            builder =
                                builder.set_condition(crate::protocol_serde::shape_condition_step_metadata::de_condition_step_metadata(tokens)?);
                        }
                        "Callback" => {
                            builder = builder.set_callback(crate::protocol_serde::shape_callback_step_metadata::de_callback_step_metadata(tokens)?);
                        }
                        "Lambda" => {
