...
pub fn de_describe_model_explainability_job_definition_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError::ResourceNotFound({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(_response_body, output).map_err(
                        crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError::unhandled,
                    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_model_explainability_job_definition_http_response(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_model_explainability_job_definition::de_describe_model_explainability_job_definition(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_model_explainability_job_definition_output_correct_errors(output).build()
    })
}
...
pub fn ser_describe_model_explainability_job_definition_input(
    ...
    crate::protocol_serde::shape_describe_model_explainability_job_definition_input::ser_describe_model_explainability_job_definition_input(
        &mut object,
        input,
    )?;
    object.finish();
