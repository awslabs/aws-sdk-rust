...
pub(crate) fn de_monitoring_network_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::MonitoringNetworkConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
