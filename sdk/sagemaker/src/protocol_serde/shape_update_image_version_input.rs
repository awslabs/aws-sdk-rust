...
pub fn ser_update_image_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateImageVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
