...
pub fn ser_tabular_job_config(
    ...
    if let Some(var_1) = &input.candidate_generation_config {
        ...
        crate::protocol_serde::shape_candidate_generation_config::ser_candidate_generation_config(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
...
pub(crate) fn de_tabular_job_config<'a, I>(
    ...
    Option<crate::types::TabularJobConfig>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Mode" => {
                                builder = builder.set_mode(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::AutoMlMode::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
