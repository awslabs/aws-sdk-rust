...
pub fn ser_list_contexts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_contexts::ListContextsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1) = &input.source_uri {
        object.key("SourceUri").string(var_1.as_str());
    }
    if let Some(var_2) = &input.context_type {
        object.key("ContextType").string(var_2.as_str());
    }
