...
pub fn ser_list_contexts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListContextsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
