...
pub fn ser_create_workteam_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkteamInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
