...
pub fn ser_list_inference_recommendations_job_steps_input(
    ...
    crate::protocol_serde::shape_list_inference_recommendations_job_steps_input::ser_list_inference_recommendations_job_steps_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_list_inference_recommendations_job_steps_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_inference_recommendations_job_steps::ListInferenceRecommendationsJobStepsError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_inference_recommendations_job_steps::ListInferenceRecommendationsJobStepsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::list_inference_recommendations_job_steps::ListInferenceRecommendationsJobStepsError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_inference_recommendations_job_steps_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_inference_recommendations_job_steps::de_list_inference_recommendations_job_steps(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_inference_recommendations_job_steps::ListInferenceRecommendationsJobStepsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Steps" => {
                    builder = builder
                        .set_steps(crate::protocol_serde::shape_inference_recommendations_job_steps::de_inference_recommendations_job_steps(tokens)?);
                }
                "NextToken" => {
