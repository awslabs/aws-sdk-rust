...
pub fn ser_list_compilation_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_compilation_jobs::ListCompilationJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_8) = &input.status_equals {
        object.key("StatusEquals").string(var_8.as_str());
    }
