...
pub fn ser_list_workteams_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListWorkteamsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
