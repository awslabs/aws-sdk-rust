...
pub(crate) fn de_profiler_rule_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ProfilerRuleConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
