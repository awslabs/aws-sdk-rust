                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ScaleInPolicy" => {
                            builder = builder.set_scale_in_policy(
                                    crate::protocol_serde::shape_production_variant_managed_instance_scaling_scale_in_policy::de_production_variant_managed_instance_scaling_scale_in_policy(tokens, _value, depth + 1)?
                                );
                        }
