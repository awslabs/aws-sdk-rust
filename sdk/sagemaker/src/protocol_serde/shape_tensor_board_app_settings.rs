...
pub(crate) fn de_tensor_board_app_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TensorBoardAppSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
