...
pub fn ser_domain_settings_for_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainSettingsForUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
