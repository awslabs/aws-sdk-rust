...
pub fn ser_list_workforces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListWorkforcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
