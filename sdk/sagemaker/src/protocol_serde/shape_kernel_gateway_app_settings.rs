...
pub(crate) fn de_kernel_gateway_app_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::KernelGatewayAppSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
