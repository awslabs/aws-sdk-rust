...
pub fn ser_hyper_parameter_training_job_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HyperParameterTrainingJobDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_hyper_parameter_training_job_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HyperParameterTrainingJobDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::hyper_parameter_training_job_definition::Builder::default();
            loop {
                match tokens.next().transpose()? {
