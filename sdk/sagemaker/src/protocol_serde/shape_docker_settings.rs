...
pub(crate) fn de_docker_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DockerSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
