...
pub fn ser_cluster_instance_storage_config(
    ...
    match input {
        crate::types::ClusterInstanceStorageConfig::EbsVolumeConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_11.key("EbsVolumeConfig").start_object();
...
) -> Result<Option<crate::types::ClusterInstanceStorageConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
