...
pub fn ser_cluster_instance_storage_config(
    ...
    match input {
        crate::types::ClusterInstanceStorageConfig::EbsVolumeConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_14.key("EbsVolumeConfig").start_object();
        ...
        crate::types::ClusterInstanceStorageConfig::FsxLustreConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_14.key("FsxLustreConfig").start_object();
        ...
        crate::types::ClusterInstanceStorageConfig::FsxOpenZfsConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_14.key("FsxOpenZfsConfig").start_object();
