...
pub fn ser_profiler_config_for_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProfilerConfigForUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
