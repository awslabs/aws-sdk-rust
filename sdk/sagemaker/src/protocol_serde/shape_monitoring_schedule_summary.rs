...
pub(crate) fn de_monitoring_schedule_summary<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::MonitoringScheduleSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(crate::serde_util::monitoring_schedule_summary_correct_errors(builder).build()))
        }
