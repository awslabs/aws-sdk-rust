...
pub fn ser_monitoring_baseline_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::MonitoringBaselineConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
