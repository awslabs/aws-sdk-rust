...
pub fn ser_create_job_input_input(
    ...
    if let Some(var_3) = &input.job_category {
        object.key("JobCategory").string(var_3.as_str());
    }
    if let Some(var_4) = &input.job_config_schema_version {
        object.key("JobConfigSchemaVersion").string(var_4.as_str());
    }
    if let Some(var_5) = &input.job_config_document {
        object.key("JobConfigDocument").string(var_5.as_str());
    }
