...
pub fn ser_image_classification_job_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ImageClassificationJobConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_image_classification_job_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ImageClassificationJobConfig>, aws_smithy_json::deserialize::error::DeserializeError>
