...
pub fn ser_delete_image_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_image_version::DeleteImageVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
