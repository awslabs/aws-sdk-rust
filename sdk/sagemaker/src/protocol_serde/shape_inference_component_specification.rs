...
pub fn ser_inference_component_specification(
    ...
    if let Some(var_2) = &input.container {
        ...
        crate::protocol_serde::shape_inference_component_container_specification::ser_inference_component_container_specification(&mut object_3, var_2)?;
        object_3.finish();
    }
    ...
    if let Some(var_6) = &input.compute_resource_requirements {
        ...
        crate::protocol_serde::shape_inference_component_compute_resource_requirements::ser_inference_component_compute_resource_requirements(&mut object_7, var_6)?;
        object_7.finish();
    }
    Ok(())
}
