...
pub fn de_list_model_explainability_job_definitions_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_model_explainability_job_definitions_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_model_explainability_job_definitions::de_list_model_explainability_job_definitions(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_model_explainability_job_definitions::ListModelExplainabilityJobDefinitionsError::unhandled)?;
...
pub fn ser_list_model_explainability_job_definitions_input(
    ...
    crate::protocol_serde::shape_list_model_explainability_job_definitions_input::ser_list_model_explainability_job_definitions_input_input(
        &mut object,
        input,
    )?;
    object.finish();
