...
pub(crate) fn de_model_dashboard_model_card<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ModelDashboardModelCard>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
