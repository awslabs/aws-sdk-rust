...
pub fn ser_delete_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAppInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
