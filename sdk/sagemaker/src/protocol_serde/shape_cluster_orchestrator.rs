                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Eks" => {
                            builder = builder.set_eks(
                                crate::protocol_serde::shape_cluster_orchestrator_eks_config::de_cluster_orchestrator_eks_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "Slurm" => {
                            builder = builder.set_slurm(
                                crate::protocol_serde::shape_cluster_orchestrator_slurm_config::de_cluster_orchestrator_slurm_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
