...
pub fn ser_space_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SpaceSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_space_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::SpaceSettings>, aws_smithy_json::deserialize::error::DeserializeError>
