...
pub(crate) fn de_s3_model_data_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3ModelDataSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "S3DataType" => {
                                builder = builder.set_s3_data_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::S3ModelDataType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "CompressionType" => {
                                builder = builder.set_compression_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ModelCompressionType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "ModelAccessConfig" => {
                                builder = builder.set_model_access_config(
                                    crate::protocol_serde::shape_model_access_config::de_model_access_config(tokens)?
                                );
                            }
