...
pub fn ser_describe_notebook_instance_input(input: &crate::input::DescribeNotebookInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_describe_notebook_instance_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeNotebookInstanceOutput, crate::error::DescribeNotebookInstanceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeNotebookInstanceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_notebook_instance_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeNotebookInstanceOutput, crate::error::DescribeNotebookInstanceError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_notebook_instance_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_notebook_instance::de_describe_notebook_instance(response.body().as_ref(), output).map_err(crate::error::DescribeNotebookInstanceError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_notebook_instance(value: &[u8], mut builder: crate::output::describe_notebook_instance_output::Builder) -> Result<crate::output::describe_notebook_instance_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "DirectInternetAccess" => {
                        builder = builder.set_direct_internet_access(
                            aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                s.to_unescaped().map(|u|
                                    crate::model::DirectInternetAccess::from(u.as_ref())
                                )
                            ).transpose()?
                        );
                    }
                    ...
                    "RootAccess" => {
                        builder = builder.set_root_access(
                            aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                s.to_unescaped().map(|u|
                                    crate::model::RootAccess::from(u.as_ref())
                                )
                            ).transpose()?
                        );
                    }
