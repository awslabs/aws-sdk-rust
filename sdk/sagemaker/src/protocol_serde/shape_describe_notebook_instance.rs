...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_describe_notebook_instance::de_describe_notebook_instance(
...
pub(crate) fn de_describe_notebook_instance(
    ...
    crate::output::describe_notebook_instance_output::Builder,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "NotebookInstanceStatus" => {
                        builder = builder.set_notebook_instance_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::NotebookInstanceStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "DirectInternetAccess" => {
                        builder = builder.set_direct_internet_access(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::DirectInternetAccess::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "RootAccess" => {
                        builder = builder.set_root_access(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::RootAccess::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
