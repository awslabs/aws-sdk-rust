...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_notebook_instance::DescribeNotebookInstanceError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::describe_notebook_instance::DescribeNotebookInstanceError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_notebook_instance::de_describe_notebook_instance(_response_body, output)
            .map_err(crate::operation::describe_notebook_instance::DescribeNotebookInstanceError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "DirectInternetAccess" => {
                    builder = builder.set_direct_internet_access(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::DirectInternetAccess::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "VolumeSizeInGB" => {
                ...
                "RootAccess" => {
                    builder = builder.set_root_access(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::RootAccess::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "PlatformIdentifier" => {
