...
pub fn ser_list_model_card_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListModelCardVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
