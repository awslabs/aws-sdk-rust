...
pub fn ser_processing_cluster_config(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::ProcessingClusterConfig,
...
pub(crate) fn de_processing_cluster_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ProcessingClusterConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::processing_cluster_config_correct_errors(builder).build()))
        }
        _ => {
