...
pub fn ser_create_edge_deployment_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEdgeDeploymentPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
