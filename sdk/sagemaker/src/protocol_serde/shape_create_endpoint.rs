    ...
    Err(match error_code {
        "ResourceLimitExceeded" => crate::error::CreateEndpointError::ResourceLimitExceeded({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_resource_limit_exceeded::de_resource_limit_exceeded_json_err(response.body().as_ref(), output).map_err(crate::error::CreateEndpointError::unhandled)?;
