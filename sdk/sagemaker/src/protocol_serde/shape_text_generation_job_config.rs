...
pub(crate) fn de_text_generation_job_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TextGenerationJobConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
