...
pub fn ser_describe_endpoint_input(
    input: &crate::operation::describe_endpoint::DescribeEndpointInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_describe_endpoint_input::ser_describe_endpoint_input(
        &mut object,
        input,
    )?;
    object.finish();
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ExplainerConfig" => {
                        builder = builder.set_explainer_config(
                            crate::protocol_serde::shape_explainer_config::de_explainer_config(
                                tokens,
                            )?,
                        );
                    }
