...
pub fn de_describe_transform_job_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_transform_job::DescribeTransformJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_transform_job_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_transform_job::de_describe_transform_job(_response_body, output)
            .map_err(crate::operation::describe_transform_job::DescribeTransformJobError::unhandled)?;
...
pub fn ser_describe_transform_job_input(
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ModelClientConfig" => {
                        builder = builder.set_model_client_config(crate::protocol_serde::shape_model_client_config::de_model_client_config(
                            tokens,
                            _value,
                            depth + 1,
                        )?);
                    ...
                    "DataCaptureConfig" => {
                        builder = builder.set_data_capture_config(
                            crate::protocol_serde::shape_batch_data_capture_config::de_batch_data_capture_config(tokens, _value, depth + 1)?,
                        );
                    }
                    "TransformResources" => {
                    ...
                    "DataProcessing" => {
                        builder = builder.set_data_processing(crate::protocol_serde::shape_data_processing::de_data_processing(
                            tokens,
                            _value,
                            depth + 1,
                        )?);
