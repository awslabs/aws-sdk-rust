...
pub fn ser_describe_transform_job_input(input: &crate::input::DescribeTransformJobInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_describe_transform_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeTransformJobOutput, crate::error::DescribeTransformJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeTransformJobError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeTransformJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_transform_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeTransformJobOutput, crate::error::DescribeTransformJobError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_transform_job_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_transform_job::de_describe_transform_job(response.body().as_ref(), output).map_err(crate::error::DescribeTransformJobError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_transform_job(value: &[u8], mut builder: crate::output::describe_transform_job_output::Builder) -> Result<crate::output::describe_transform_job_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "BatchStrategy" => {
                        builder = builder.set_batch_strategy(
                            aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                s.to_unescaped().map(|u|
                                    crate::model::BatchStrategy::from(u.as_ref())
                                )
                            ).transpose()?
                        );
                    }
