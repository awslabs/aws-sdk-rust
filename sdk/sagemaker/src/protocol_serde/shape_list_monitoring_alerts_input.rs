...
pub fn ser_list_monitoring_alerts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListMonitoringAlertsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
