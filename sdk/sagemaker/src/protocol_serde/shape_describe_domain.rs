    ...
    Err(match error_code {
        "ResourceNotFound" => crate::error::DescribeDomainError::ResourceNotFound({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeDomainError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "AppNetworkAccessType" => {
                        builder = builder.set_app_network_access_type(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::AppNetworkAccessType::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                        ...
                        builder = builder.set_app_security_group_management(
                            ...
                            .map(|s| {
                                s.to_unescaped().map(|u| {
                                    crate::model::AppSecurityGroupManagement::from(u.as_ref())
                                })
                            })
                            .transpose()?,
                        );
