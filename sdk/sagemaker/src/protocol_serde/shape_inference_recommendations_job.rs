...
pub(crate) fn de_inference_recommendations_job<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::InferenceRecommendationsJob>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
