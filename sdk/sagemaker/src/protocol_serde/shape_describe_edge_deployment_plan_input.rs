...
pub fn ser_describe_edge_deployment_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEdgeDeploymentPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
