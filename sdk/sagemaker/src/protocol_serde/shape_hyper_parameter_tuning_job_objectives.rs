...
pub(crate) fn de_hyper_parameter_tuning_job_objectives<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::HyperParameterTuningJobObjective>>, aws_smithy_json::deserialize::error::DeserializeError>
