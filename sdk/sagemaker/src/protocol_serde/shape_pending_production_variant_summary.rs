...
pub(crate) fn de_pending_production_variant_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PendingProductionVariantSummary>, aws_smithy_json::deserialize::error::DeserializeError>
