...
pub fn ser_describe_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
