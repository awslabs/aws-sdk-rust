...
pub fn ser_auto_ml_channel(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoMlChannel) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_auto_ml_channel<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoMlChannel>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::auto_ml_channel::Builder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ChannelType" => {
                                builder = builder.set_channel_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::AutoMlChannelType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
