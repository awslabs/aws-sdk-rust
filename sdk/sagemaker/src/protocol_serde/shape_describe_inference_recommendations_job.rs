            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "InputConfig" => {
                    builder = builder.set_input_config(
                        crate::protocol_serde::shape_recommendation_job_input_config::de_recommendation_job_input_config(tokens, _value, depth + 1)?,
                    );
                }
                "StoppingConditions" => {
                ...
                "InferenceRecommendations" => {
                    builder = builder.set_inference_recommendations(
                        crate::protocol_serde::shape_inference_recommendations::de_inference_recommendations(tokens, _value, depth + 1)?,
                    );
                }
