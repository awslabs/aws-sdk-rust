...
pub fn ser_create_studio_lifecycle_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStudioLifecycleConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
