...
pub fn ser_drift_check_model_quality(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DriftCheckModelQuality) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_drift_check_model_quality<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::DriftCheckModelQuality>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DriftCheckModelQualityBuilder::default();
            loop {
                match tokens.next().transpose()? {
