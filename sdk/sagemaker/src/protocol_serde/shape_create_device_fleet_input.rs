...
pub fn ser_create_device_fleet_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_device_fleet::CreateDeviceFleetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
