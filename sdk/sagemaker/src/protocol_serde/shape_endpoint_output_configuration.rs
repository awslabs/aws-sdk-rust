...
pub(crate) fn de_endpoint_output_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EndpointOutputConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
