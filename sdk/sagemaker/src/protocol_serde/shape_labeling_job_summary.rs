...
) -> Result<Option<crate::types::LabelingJobSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "LabelingJobOutput" => {
                            builder =
                                builder.set_labeling_job_output(crate::protocol_serde::shape_labeling_job_output::de_labeling_job_output(tokens)?);
                        }
                        "InputConfig" => {
