...
pub(crate) fn de_final_auto_ml_job_objective_metric<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FinalAutoMlJobObjectiveMetric>, aws_smithy_json::deserialize::error::DeserializeError>
