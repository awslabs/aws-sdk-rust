...
pub fn ser_create_algorithm_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAlgorithmInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
