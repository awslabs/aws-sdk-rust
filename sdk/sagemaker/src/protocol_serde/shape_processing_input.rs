            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "S3Input" => {
                            builder = builder.set_s3_input(crate::protocol_serde::shape_processing_s3_input::de_processing_s3_input(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "DatasetDefinition" => {
                            builder = builder.set_dataset_definition(crate::protocol_serde::shape_dataset_definition::de_dataset_definition(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
