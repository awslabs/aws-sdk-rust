...
pub(crate) fn de_hub_info<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::HubInfo>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "HubStatus" => {
                                builder = builder.set_hub_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::HubStatus::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
