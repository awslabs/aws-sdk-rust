...
pub fn ser_update_workteam_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkteamInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
