...
pub fn ser_list_candidates_for_auto_ml_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCandidatesForAutoMlJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
