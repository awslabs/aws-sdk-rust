...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_trial_component::DescribeTrialComponentError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_trial_component::de_describe_trial_component(_response_body, output)
            .map_err(crate::operation::describe_trial_component::DescribeTrialComponentError::unhandled)?;
