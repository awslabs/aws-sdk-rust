...
pub fn ser_list_model_packages_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListModelPackagesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
