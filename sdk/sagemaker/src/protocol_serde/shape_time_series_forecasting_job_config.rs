...
pub fn ser_time_series_forecasting_job_config(
    ...
    if let Some(var_5) = &input.forecast_horizon {
        object.key("ForecastHorizon").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
...
pub(crate) fn de_time_series_forecasting_job_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TimeSeriesForecastingJobConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ForecastQuantiles" => {
                                builder = builder.set_forecast_quantiles(
                                    crate::protocol_serde::shape_forecast_quantiles::de_forecast_quantiles(tokens)?
                                );
                            }
                            "Transformations" => {
                            ...
                            "TimeSeriesConfig" => {
                                builder = builder.set_time_series_config(
                                    crate::protocol_serde::shape_time_series_config::de_time_series_config(tokens)?
                                );
                            }
                            "HolidayConfig" => {
                                builder = builder.set_holiday_config(
                                    crate::protocol_serde::shape_holiday_config::de_holiday_config(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::time_series_forecasting_job_config_correct_errors(builder).build()))
        }
        _ => {
