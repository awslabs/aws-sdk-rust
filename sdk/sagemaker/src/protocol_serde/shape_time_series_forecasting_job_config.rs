...
pub fn ser_time_series_forecasting_job_config(
    ...
    if let Some(var_9) = &input.transformations {
        ...
        crate::protocol_serde::shape_time_series_transformations::ser_time_series_transformations(
            &mut object_10,
            var_9,
        )?;
        object_10.finish();
    ...
    if let Some(var_11) = &input.time_series_config {
        ...
        crate::protocol_serde::shape_time_series_config::ser_time_series_config(
            &mut object_12,
            var_11,
        )?;
        object_12.finish();
...
pub(crate) fn de_time_series_forecasting_job_config<'a, I>(
    ...
    Option<crate::types::TimeSeriesForecastingJobConfig>,
