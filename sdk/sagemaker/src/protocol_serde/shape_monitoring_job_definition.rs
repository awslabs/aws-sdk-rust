...
pub fn ser_monitoring_job_definition(
    ...
    if let Some(var_1) = &input.baseline_config {
        ...
        crate::protocol_serde::shape_monitoring_baseline_config::ser_monitoring_baseline_config(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
        ...
        for item_5 in var_3 {
            {
                ...
                crate::protocol_serde::shape_monitoring_input::ser_monitoring_input(
                    &mut object_6,
                    item_5,
                )?;
                object_6.finish();
...
pub(crate) fn de_monitoring_job_definition<'a, I>(
    ...
    Option<crate::model::MonitoringJobDefinition>,
