...
pub(crate) fn de_model_card<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ModelCard>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ModelCardStatus" => {
                            builder = builder.set_model_card_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ModelCardStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "SecurityConfig" => {
                            builder = builder.set_security_config(
                                crate::protocol_serde::shape_model_card_security_config::de_model_card_security_config(tokens, _value, depth + 1)?,
                            );
                        }
                        "CreationTime" => {
