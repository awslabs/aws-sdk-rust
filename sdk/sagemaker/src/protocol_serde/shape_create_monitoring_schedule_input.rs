...
pub fn ser_create_monitoring_schedule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_monitoring_schedule::CreateMonitoringScheduleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
