...
pub fn ser_create_context_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateContextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
