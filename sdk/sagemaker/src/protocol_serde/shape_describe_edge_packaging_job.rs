...
pub fn de_describe_edge_packaging_job_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_edge_packaging_job::DescribeEdgePackagingJobError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_edge_packaging_job::DescribeEdgePackagingJobError::unhandled(
                generic,
            ))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_edge_packaging_job_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_edge_packaging_job::de_describe_edge_packaging_job(_response_body, output)
            .map_err(crate::operation::describe_edge_packaging_job::DescribeEdgePackagingJobError::unhandled)?;
...
pub(crate) fn de_describe_edge_packaging_job(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "EdgePackagingJobStatus" => {
                    builder = builder.set_edge_packaging_job_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::EdgePackagingJobStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                ...
                "PresetDeploymentOutput" => {
                    builder = builder.set_preset_deployment_output(
                        crate::protocol_serde::shape_edge_preset_deployment_output::de_edge_preset_deployment_output(tokens, _value, depth + 1)?,
                    );
                }
