                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PayloadConfig" => {
                            builder = builder.set_payload_config(
                                crate::protocol_serde::shape_recommendation_job_payload_config::de_recommendation_job_payload_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "SupportedInstanceTypes" => {
                            builder = builder.set_supported_instance_types(
                                    crate::protocol_serde::shape_recommendation_job_supported_instance_types::de_recommendation_job_supported_instance_types(tokens, _value, depth + 1)?
                                );
                        }
                        ...
                        "SupportedResponseMIMETypes" => {
                            builder = builder.set_supported_response_mime_types(
                                    crate::protocol_serde::shape_recommendation_job_supported_response_mime_types::de_recommendation_job_supported_response_mime_types(tokens, _value, depth + 1)?
                                );
                        }
