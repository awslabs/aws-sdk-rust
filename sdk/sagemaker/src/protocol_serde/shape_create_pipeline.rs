    ...
    Err(match error_code {
        "ResourceLimitExceeded" => crate::error::CreatePipelineError::ResourceLimitExceeded({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_resource_limit_exceeded::de_resource_limit_exceeded_json_err(response.body().as_ref(), output).map_err(crate::error::CreatePipelineError::unhandled)?;
        ...
        "ResourceNotFound" => crate::error::CreatePipelineError::ResourceNotFound({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(response.body().as_ref(), output).map_err(crate::error::CreatePipelineError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
