...
pub(crate) fn de_transform_job_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TransformJobSummary>, aws_smithy_json::deserialize::error::DeserializeError>
