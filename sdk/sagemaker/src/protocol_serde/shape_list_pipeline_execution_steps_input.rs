...
pub fn ser_list_pipeline_execution_steps_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_pipeline_execution_steps::ListPipelineExecutionStepsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
