...
pub fn de_list_devices_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_devices_output_output_correct_errors(output).build()
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "DeviceSummaries" => {
                    builder = builder.set_device_summaries(crate::protocol_serde::shape_device_summaries::de_device_summaries(tokens, _value)?);
                }
                "NextToken" => {
