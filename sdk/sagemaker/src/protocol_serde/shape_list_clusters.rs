...
pub fn de_list_clusters_http_error(
    ...
    Err(crate::operation::list_clusters::ListClustersError::generic(generic))
}
...
pub fn de_list_clusters_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_clusters_output_output_correct_errors(output).build()
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ClusterSummaries" => {
                    builder = builder.set_cluster_summaries(crate::protocol_serde::shape_cluster_summaries::de_cluster_summaries(tokens, _value)?);
                }
