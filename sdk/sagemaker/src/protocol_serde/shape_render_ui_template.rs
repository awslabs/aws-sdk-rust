...
pub fn ser_render_ui_template_input(
    ...
    crate::protocol_serde::shape_render_ui_template_input::ser_render_ui_template_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::render_ui_template::RenderUiTemplateError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_render_ui_template::de_render_ui_template(
            _response_body,
            output,
        )
        .map_err(crate::operation::render_ui_template::RenderUiTemplateError::unhandled)?;
