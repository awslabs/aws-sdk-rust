...
pub fn ser_list_image_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_image_versions::ListImageVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
