...
pub fn ser_list_algorithms_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_algorithms::ListAlgorithmsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
