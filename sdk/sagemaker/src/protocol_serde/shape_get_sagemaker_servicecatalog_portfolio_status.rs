...
pub fn de_get_sagemaker_servicecatalog_portfolio_status_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_sagemaker_servicecatalog_portfolio_status::GetSagemakerServicecatalogPortfolioStatusError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sagemaker_servicecatalog_portfolio_status_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_sagemaker_servicecatalog_portfolio_status::de_get_sagemaker_servicecatalog_portfolio_status(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_sagemaker_servicecatalog_portfolio_status::GetSagemakerServicecatalogPortfolioStatusError::unhandled)?;
...
pub(crate) fn de_get_sagemaker_servicecatalog_portfolio_status(
    value: &[u8],
    mut builder: crate::operation::get_sagemaker_servicecatalog_portfolio_status::builders::GetSagemakerServicecatalogPortfolioStatusOutputBuilder,
) -> Result<
                ...
                "Status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::SagemakerServicecatalogStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
