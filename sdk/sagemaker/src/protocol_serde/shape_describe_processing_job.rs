...
pub fn ser_describe_processing_job_input(input: &crate::input::DescribeProcessingJobInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_describe_processing_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeProcessingJobOutput, crate::error::DescribeProcessingJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeProcessingJobError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeProcessingJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_processing_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeProcessingJobOutput, crate::error::DescribeProcessingJobError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_processing_job_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_processing_job::de_describe_processing_job(response.body().as_ref(), output).map_err(crate::error::DescribeProcessingJobError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_processing_job(value: &[u8], mut builder: crate::output::describe_processing_job_output::Builder) -> Result<crate::output::describe_processing_job_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
