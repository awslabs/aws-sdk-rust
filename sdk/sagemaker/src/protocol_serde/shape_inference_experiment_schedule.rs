...
pub(crate) fn de_inference_experiment_schedule<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::InferenceExperimentSchedule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
