...
pub fn ser_create_model_explainability_job_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_model_explainability_job_definition::CreateModelExplainabilityJobDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_6) = &input.model_explainability_job_input {
        #[allow(unused_mut)]
        let mut object_7 = object.key("ModelExplainabilityJobInput").start_object();
        crate::protocol_serde::shape_model_explainability_job_input::ser_model_explainability_job_input(&mut object_7, var_6)?;
        object_7.finish();
    }
