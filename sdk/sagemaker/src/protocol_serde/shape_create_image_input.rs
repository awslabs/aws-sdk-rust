...
pub fn ser_create_image_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateImageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
