...
pub(crate) fn de_notebook_instance_summary<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::NotebookInstanceSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "NotebookInstanceStatus" => {
                                builder = builder.set_notebook_instance_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| s.to_unescaped().map(|u| crate::types::NotebookInstanceStatus::from(u.as_ref())))
                                        .transpose()?,
                                );
                            }
                            "Url" => {
                            ...
                            "AdditionalCodeRepositories" => {
                                builder = builder.set_additional_code_repositories(
                                    crate::protocol_serde::shape_additional_code_repository_names_or_urls::de_additional_code_repository_names_or_urls(tokens, _value, depth + 1)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::notebook_instance_summary_correct_errors(builder).build()))
        }
