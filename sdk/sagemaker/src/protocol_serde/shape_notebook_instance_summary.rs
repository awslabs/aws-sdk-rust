...
pub(crate) fn de_notebook_instance_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NotebookInstanceSummary>, aws_smithy_json::deserialize::error::DeserializeError>
