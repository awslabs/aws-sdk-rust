...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_model_card_input::ser_describe_model_card_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_model_card::DescribeModelCardError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_model_card::de_describe_model_card(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_model_card::DescribeModelCardError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "ModelCardStatus" => {
                        builder = builder.set_model_card_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::ModelCardStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
