...
pub fn ser_describe_model_card_input(
...
pub fn de_describe_model_card_http_error(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_model_card::DescribeModelCardOutput, crate::operation::describe_model_card::DescribeModelCardError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_model_card_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_model_card::DescribeModelCardOutput, crate::operation::describe_model_card::DescribeModelCardError>
...
) -> Result<crate::operation::describe_model_card::builders::DescribeModelCardOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ModelCardProcessingStatus" => {
                    builder = builder.set_model_card_processing_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ModelCardProcessingStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
