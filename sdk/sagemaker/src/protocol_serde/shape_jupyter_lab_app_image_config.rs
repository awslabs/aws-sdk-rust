...
pub(crate) fn de_jupyter_lab_app_image_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::JupyterLabAppImageConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ContainerConfig" => {
                                builder = builder.set_container_config(
                                    crate::protocol_serde::shape_container_config::de_container_config(tokens)?
                                );
                            }
