...
pub fn ser_update_pipeline_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePipelineExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
