...
pub(crate) fn de_resolved_attributes<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ResolvedAttributes>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AutoMLJobObjective" => {
                            builder = builder.set_auto_ml_job_objective(
                                crate::protocol_serde::shape_auto_ml_job_objective::de_auto_ml_job_objective(tokens, _value, depth + 1)?,
                            );
                        }
                        "ProblemType" => {
