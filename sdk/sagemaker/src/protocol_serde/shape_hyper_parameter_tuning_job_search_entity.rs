...
pub(crate) fn de_hyper_parameter_tuning_job_search_entity<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HyperParameterTuningJobSearchEntity>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::hyper_parameter_tuning_job_search_entity::Builder::default();
            loop {
                match tokens.next().transpose()? {
