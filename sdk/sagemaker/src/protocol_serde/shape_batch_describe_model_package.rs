...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_describe_model_package::BatchDescribeModelPackageError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::batch_describe_model_package::BatchDescribeModelPackageError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_describe_model_package::de_batch_describe_model_package(_response_body, output)
            .map_err(crate::operation::batch_describe_model_package::BatchDescribeModelPackageError::unhandled)?;
