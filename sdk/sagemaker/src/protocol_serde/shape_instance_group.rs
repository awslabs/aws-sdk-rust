...
pub fn ser_instance_group(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceGroup) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
