...
pub fn ser_list_model_package_groups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListModelPackageGroupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
