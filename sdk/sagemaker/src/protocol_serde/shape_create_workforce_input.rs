...
pub fn ser_create_workforce_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkforceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
