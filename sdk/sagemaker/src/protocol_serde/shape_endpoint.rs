                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ProductionVariants" => {
                            builder = builder.set_production_variants(
                                crate::protocol_serde::shape_production_variant_summary_list::de_production_variant_summary_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "MonitoringSchedules" => {
                            builder = builder.set_monitoring_schedules(
                                crate::protocol_serde::shape_monitoring_schedule_list::de_monitoring_schedule_list(tokens, _value, depth + 1)?,
                            );
                        }
                        "Tags" => {
