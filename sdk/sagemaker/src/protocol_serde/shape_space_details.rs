...
pub(crate) fn de_space_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SpaceDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::SpaceDetailsBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SpaceSettingsSummary" => {
                                builder = builder.set_space_settings_summary(
                                    crate::protocol_serde::shape_space_settings_summary::de_space_settings_summary(tokens)?
                                );
                            }
