        ...
        match tokens.next().transpose()? {
            Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "RemoteDebugConfig" => {
                        builder = builder.set_remote_debug_config(
                            crate::protocol_serde::shape_remote_debug_config::de_remote_debug_config(tokens)?
                        );
                    }
                    "InfraCheckConfig" => {
                        builder = builder.set_infra_check_config(
                            crate::protocol_serde::shape_infra_check_config::de_infra_check_config(tokens)?
                        );
                    }
