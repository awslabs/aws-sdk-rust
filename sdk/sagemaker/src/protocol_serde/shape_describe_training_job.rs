...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_training_job_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_training_job::DescribeTrainingJobOutput, crate::operation::describe_training_job::DescribeTrainingJobError> {
    Ok({
        #[allow(unused_mut)]
