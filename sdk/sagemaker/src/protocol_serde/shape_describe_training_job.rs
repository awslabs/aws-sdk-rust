...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_training_job::de_describe_training_job(_response_body, output)
            .map_err(crate::operation::describe_training_job::DescribeTrainingJobError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_training_job_output_correct_errors(output).build()
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "FinalMetricDataList" => {
                    builder =
                        builder.set_final_metric_data_list(crate::protocol_serde::shape_final_metric_data_list::de_final_metric_data_list(tokens)?);
                }
                ...
                "EnableInterContainerTrafficEncryption" => {
                    builder = builder
                        .set_enable_inter_container_traffic_encryption(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                ...
                "ProfilingStatus" => {
                    builder = builder.set_profiling_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ProfilingStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "RetryStrategy" => {
