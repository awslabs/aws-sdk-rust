...
pub(crate) fn de_describe_training_job(
    ...
    crate::output::describe_training_job_output::Builder,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "TrainingJobStatus" => {
                        builder = builder.set_training_job_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::TrainingJobStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    "SecondaryStatus" => {
                        builder = builder.set_secondary_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::SecondaryStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "ProfilingStatus" => {
                        builder = builder.set_profiling_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::model::ProfilingStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
