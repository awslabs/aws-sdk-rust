...
pub fn ser_describe_model_card_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeModelCardInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
