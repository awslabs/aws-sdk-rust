...
pub(crate) fn de_athena_dataset_definition<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AthenaDatasetDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "OutputFormat" => {
                            builder = builder.set_output_format(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AthenaResultFormat::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "OutputCompression" => {
                            builder = builder.set_output_compression(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AthenaResultCompressionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
