...
pub(crate) fn de_space_jupyter_lab_app_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::SpaceJupyterLabAppSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
