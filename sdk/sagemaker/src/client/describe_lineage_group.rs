...
impl super::Client {
    ...
    ///   - [`lineage_group_name(impl ::std::convert::Into<String>)`](crate::operation::describe_lineage_group::builders::DescribeLineageGroupFluentBuilder::lineage_group_name) / [`set_lineage_group_name(Option<String>)`](crate::operation::describe_lineage_group::builders::DescribeLineageGroupFluentBuilder::set_lineage_group_name): <p>The name of the lineage group.</p>
