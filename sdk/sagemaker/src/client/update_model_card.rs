...
impl super::Client {
    ...
    ///   - [`model_card_name(impl Into<String>)`](crate::operation::update_model_card::builders::UpdateModelCardFluentBuilder::model_card_name) / [`set_model_card_name(Option<String>)`](crate::operation::update_model_card::builders::UpdateModelCardFluentBuilder::set_model_card_name): <p>The name or Amazon Resource Name (ARN) of the model card to update.</p>
