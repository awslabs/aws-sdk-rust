...
impl super::Client {
    ...
    ///   - [`model_card_name(impl Into<String>)`](crate::operation::update_model_card::builders::UpdateModelCardFluentBuilder::model_card_name) / [`set_model_card_name(Option<String>)`](crate::operation::update_model_card::builders::UpdateModelCardFluentBuilder::set_model_card_name):<br>required: **true**<br><p>The name or Amazon Resource Name (ARN) of the model card to update.</p><br>
    ///   - [`content(impl Into<String>)`](crate::operation::update_model_card::builders::UpdateModelCardFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::update_model_card::builders::UpdateModelCardFluentBuilder::set_content):<br>required: **false**<br><p>The updated model card content. Content must be in <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/model-cards.html#model-cards-json-schema">model card JSON schema</a> and provided as a string.</p> <p>When updating model card content, be sure to include the full content and not just updated content.</p><br>
