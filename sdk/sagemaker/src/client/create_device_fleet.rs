...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::set_tags): <p>Creates tags for the specified fleet.</p>
