...
impl super::Client {
    ...
    ///   - [`device_fleet_name(impl ::std::convert::Into<String>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::device_fleet_name) / [`set_device_fleet_name(Option<String>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::set_device_fleet_name): <p>The name of the fleet that the device belongs to.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::set_role_arn): <p>The Amazon Resource Name (ARN) that has access to Amazon Web Services Internet of Things (IoT).</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_device_fleet::builders::CreateDeviceFleetFluentBuilder::set_description): <p>A description of the fleet.</p>
