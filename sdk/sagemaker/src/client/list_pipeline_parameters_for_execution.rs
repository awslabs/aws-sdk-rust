...
impl super::Client {
    ...
    pub fn list_pipeline_parameters_for_execution(
        &self,
    ) -> crate::operation::list_pipeline_parameters_for_execution::builders::ListPipelineParametersForExecutionFluentBuilder {
