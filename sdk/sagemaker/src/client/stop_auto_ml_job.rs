...
impl super::Client {
    ...
    ///   - [`auto_ml_job_name(impl Into<String>)`](crate::operation::stop_auto_ml_job::builders::StopAutoMLJobFluentBuilder::auto_ml_job_name) / [`set_auto_ml_job_name(Option<String>)`](crate::operation::stop_auto_ml_job::builders::StopAutoMLJobFluentBuilder::set_auto_ml_job_name):<br>required: **true**<br><p>The name of the object you are requesting.</p><br>
