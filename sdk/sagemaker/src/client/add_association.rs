...
impl super::Client {
    ...
    ///   - [`source_arn(impl Into<String>)`](crate::operation::add_association::builders::AddAssociationFluentBuilder::source_arn) / [`set_source_arn(Option<String>)`](crate::operation::add_association::builders::AddAssociationFluentBuilder::set_source_arn):<br>required: **true**<br><p>The ARN of the source.</p><br>
    ///   - [`destination_arn(impl Into<String>)`](crate::operation::add_association::builders::AddAssociationFluentBuilder::destination_arn) / [`set_destination_arn(Option<String>)`](crate::operation::add_association::builders::AddAssociationFluentBuilder::set_destination_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the destination.</p><br>
