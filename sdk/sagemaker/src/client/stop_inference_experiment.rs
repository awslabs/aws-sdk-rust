...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::stop_inference_experiment::builders::StopInferenceExperimentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::stop_inference_experiment::builders::StopInferenceExperimentFluentBuilder::set_name): <p>The name of the inference experiment to stop.</p>
    ...
    ///   - [`reason(impl ::std::convert::Into<String>)`](crate::operation::stop_inference_experiment::builders::StopInferenceExperimentFluentBuilder::reason) / [`set_reason(Option<String>)`](crate::operation::stop_inference_experiment::builders::StopInferenceExperimentFluentBuilder::set_reason): <p>The reason for stopping the experiment.</p>
