...
impl super::Client {
    ...
    ///   - [`job_definition_name(impl Into<String>)`](crate::operation::describe_model_bias_job_definition::builders::DescribeModelBiasJobDefinitionFluentBuilder::job_definition_name) / [`set_job_definition_name(Option<String>)`](crate::operation::describe_model_bias_job_definition::builders::DescribeModelBiasJobDefinitionFluentBuilder::set_job_definition_name):<br>required: **true**<br><p>The name of the model bias job definition. The name must be unique within an Amazon Web Services Region in the Amazon Web Services account.</p><br>
    ...
    ///   - [`role_arn(Option<String>)`](crate::operation::describe_model_bias_job_definition::DescribeModelBiasJobDefinitionOutput::role_arn): <p>The Amazon Resource Name (ARN) of the IAM role that has read permission to the input data location and write permission to the output data location in Amazon S3.</p>
