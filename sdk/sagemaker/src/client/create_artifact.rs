...
impl super::Client {
    ...
    ///   - [`artifact_name(impl ::std::convert::Into<String>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::artifact_name) / [`set_artifact_name(Option<String>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::set_artifact_name): <p>The name of the artifact. Must be unique to your account in an Amazon Web Services Region.</p>
    ...
    ///   - [`artifact_type(impl ::std::convert::Into<String>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::artifact_type) / [`set_artifact_type(Option<String>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::set_artifact_type): <p>The artifact type.</p>
