...
impl super::Client {
    ...
    ///   - [`properties(impl Into<String>, impl Into<String>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::properties) / [`set_properties(Option<HashMap<String, String>>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::set_properties): <p>A list of properties to add to the artifact.</p>
    ...
    ///   - [`tags(Tag)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_artifact::builders::CreateArtifactFluentBuilder::set_tags): <p>A list of tags to apply to the artifact.</p>
