...
impl super::Client {
    ...
    ///   - [`monitoring_schedule_name(impl Into<String>)`](crate::operation::update_monitoring_schedule::builders::UpdateMonitoringScheduleFluentBuilder::monitoring_schedule_name) / [`set_monitoring_schedule_name(Option<String>)`](crate::operation::update_monitoring_schedule::builders::UpdateMonitoringScheduleFluentBuilder::set_monitoring_schedule_name):<br>required: **true**<br><p>The name of the monitoring schedule. The name must be unique within an Amazon Web Services Region within an Amazon Web Services account.</p><br>
