...
impl super::Client {
    ...
    ///   - [`artifact_arn(impl ::std::convert::Into<String>)`](crate::operation::update_artifact::builders::UpdateArtifactFluentBuilder::artifact_arn) / [`set_artifact_arn(Option<String>)`](crate::operation::update_artifact::builders::UpdateArtifactFluentBuilder::set_artifact_arn): <p>The Amazon Resource Name (ARN) of the artifact to update.</p>
    ///   - [`artifact_name(impl ::std::convert::Into<String>)`](crate::operation::update_artifact::builders::UpdateArtifactFluentBuilder::artifact_name) / [`set_artifact_name(Option<String>)`](crate::operation::update_artifact::builders::UpdateArtifactFluentBuilder::set_artifact_name): <p>The new name for the artifact.</p>
