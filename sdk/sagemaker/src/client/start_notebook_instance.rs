...
impl super::Client {
    ...
    ///   - [`notebook_instance_name(impl Into<String>)`](crate::operation::start_notebook_instance::builders::StartNotebookInstanceFluentBuilder::notebook_instance_name) / [`set_notebook_instance_name(Option<String>)`](crate::operation::start_notebook_instance::builders::StartNotebookInstanceFluentBuilder::set_notebook_instance_name):<br>required: **true**<br><p>The name of the notebook instance to start.</p><br>
