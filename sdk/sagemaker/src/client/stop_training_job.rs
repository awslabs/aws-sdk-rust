...
impl super::Client {
    ...
    ///   - [`training_job_name(impl Into<String>)`](crate::operation::stop_training_job::builders::StopTrainingJobFluentBuilder::training_job_name) / [`set_training_job_name(Option<String>)`](crate::operation::stop_training_job::builders::StopTrainingJobFluentBuilder::set_training_job_name):<br>required: **true**<br><p>The name of the training job to stop.</p><br>
