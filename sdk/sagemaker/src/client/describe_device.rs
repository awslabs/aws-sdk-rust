...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_next_token): <p>Next token of device description.</p>
    ///   - [`device_name(impl ::std::convert::Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::device_name) / [`set_device_name(Option<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_device_name): <p>The unique ID of the device.</p>
    ///   - [`device_fleet_name(impl ::std::convert::Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::device_fleet_name) / [`set_device_fleet_name(Option<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_device_fleet_name): <p>The name of the fleet the devices belong to.</p>
