...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::set_domain_id): <p>The domain ID.</p>
