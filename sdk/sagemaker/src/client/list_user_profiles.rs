...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::set_next_token): <p>If the previous response was truncated, you will receive this token. Use it in your next request to receive the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::set_max_results): <p>The total number of items to return in the response. If the total number of items available is more than the value specified, a <code>NextToken</code> is provided in the response. To resume pagination, provide the <code>NextToken</code> value in the as part of a subsequent call. The default value is 10.</p>
    ...
    ///   - [`domain_id_equals(impl ::std::convert::Into<String>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::domain_id_equals) / [`set_domain_id_equals(Option<String>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::set_domain_id_equals): <p>A parameter by which to filter the results.</p>
    ///   - [`user_profile_name_contains(impl ::std::convert::Into<String>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::user_profile_name_contains) / [`set_user_profile_name_contains(Option<String>)`](crate::operation::list_user_profiles::builders::ListUserProfilesFluentBuilder::set_user_profile_name_contains): <p>A parameter by which to filter the results.</p>
