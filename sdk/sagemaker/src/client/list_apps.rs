...
impl super::Client {
    ...
    ///   - [`sort_by(AppSortKey)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::sort_by) / [`set_sort_by(Option<AppSortKey>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::set_sort_by):<br>required: **false**<br><p>The parameter by which to sort the results. The default is CreationTime.</p><br>
