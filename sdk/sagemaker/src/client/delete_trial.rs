...
impl super::Client {
    ...
    ///   - [`trial_name(impl ::std::convert::Into<String>)`](crate::operation::delete_trial::builders::DeleteTrialFluentBuilder::trial_name) / [`set_trial_name(Option<String>)`](crate::operation::delete_trial::builders::DeleteTrialFluentBuilder::set_trial_name): <p>The name of the trial to delete.</p>
