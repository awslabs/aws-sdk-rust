...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl ::std::convert::Into<String>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_pipeline_name): <p>The name or Amazon Resource Name (ARN) of the pipeline.</p>
    ///   - [`created_after(DateTime)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::created_after) / [`set_created_after(Option<DateTime>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_created_after): <p>A filter that returns the pipeline executions that were created after a specified time.</p>
    ///   - [`created_before(DateTime)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::created_before) / [`set_created_before(Option<DateTime>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_created_before): <p>A filter that returns the pipeline executions that were created before a specified time.</p>
    ///   - [`sort_by(SortPipelineExecutionsBy)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::sort_by) / [`set_sort_by(Option<SortPipelineExecutionsBy>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_sort_by): <p>The field by which to sort results. The default is <code>CreatedTime</code>.</p>
    ///   - [`sort_order(SortOrder)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::sort_order) / [`set_sort_order(Option<SortOrder>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_sort_order): <p>The sort order for results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_next_token): <p>If the result of the previous <code>ListPipelineExecutions</code> request was truncated, the response includes a <code>NextToken</code>. To retrieve the next set of pipeline executions, use the token in the next request.</p>
    ///   - [`max_results(i32)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_max_results): <p>The maximum number of pipeline executions to return in the response.</p>
