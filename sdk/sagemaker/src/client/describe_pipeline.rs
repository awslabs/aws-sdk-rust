...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl Into<String>)`](crate::operation::describe_pipeline::builders::DescribePipelineFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::describe_pipeline::builders::DescribePipelineFluentBuilder::set_pipeline_name): <p>The name or Amazon Resource Name (ARN) of the pipeline to describe.</p>
