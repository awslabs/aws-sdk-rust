...
impl super::Client {
    ...
    ///   - [`transform_job_name(impl Into<String>)`](crate::operation::stop_transform_job::builders::StopTransformJobFluentBuilder::transform_job_name) / [`set_transform_job_name(Option<String>)`](crate::operation::stop_transform_job::builders::StopTransformJobFluentBuilder::set_transform_job_name):<br>required: **true**<br><p>The name of the batch transform job to stop.</p><br>
