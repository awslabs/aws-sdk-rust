...
impl super::Client {
    ...
    ///   - [`pipeline_name_prefix(impl ::std::convert::Into<String>)`](crate::operation::list_pipelines::builders::ListPipelinesFluentBuilder::pipeline_name_prefix) / [`set_pipeline_name_prefix(Option<String>)`](crate::operation::list_pipelines::builders::ListPipelinesFluentBuilder::set_pipeline_name_prefix): <p>The prefix of the pipeline name.</p>
