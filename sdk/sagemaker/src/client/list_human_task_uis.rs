...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_human_task_uis::builders::ListHumanTaskUisFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_human_task_uis::builders::ListHumanTaskUisFluentBuilder::set_next_token): <p>A token to resume pagination.</p>
