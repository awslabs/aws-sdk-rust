...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::set_tags): <p>A list of tags to associate with the experiment. You can use <a href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_Search.html">Search</a> API to search on the tags.</p>
