...
impl super::Client {
    ...
    ///   - [`image_name(impl ::std::convert::Into<String>)`](crate::operation::describe_image_version::builders::DescribeImageVersionFluentBuilder::image_name) / [`set_image_name(Option<String>)`](crate::operation::describe_image_version::builders::DescribeImageVersionFluentBuilder::set_image_name): <p>The name of the image.</p>
    ...
    ///   - [`alias(impl ::std::convert::Into<String>)`](crate::operation::describe_image_version::builders::DescribeImageVersionFluentBuilder::alias) / [`set_alias(Option<String>)`](crate::operation::describe_image_version::builders::DescribeImageVersionFluentBuilder::set_alias): <p>The alias of the image version.</p>
