...
impl super::Client {
    ...
    ///   - [`creation_time_after(DateTime)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::creation_time_after) / [`set_creation_time_after(Option<DateTime>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_creation_time_after): <p>A filter that returns only processing jobs created after the specified time.</p>
    ///   - [`creation_time_before(DateTime)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::creation_time_before) / [`set_creation_time_before(Option<DateTime>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_creation_time_before): <p>A filter that returns only processing jobs created after the specified time.</p>
    ///   - [`last_modified_time_after(DateTime)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::last_modified_time_after) / [`set_last_modified_time_after(Option<DateTime>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_last_modified_time_after): <p>A filter that returns only processing jobs modified after the specified time.</p>
    ///   - [`last_modified_time_before(DateTime)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::last_modified_time_before) / [`set_last_modified_time_before(Option<DateTime>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_last_modified_time_before): <p>A filter that returns only processing jobs modified before the specified time.</p>
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_name_contains): <p>A string in the processing job name. This filter returns only processing jobs whose name contains the specified string.</p>
    ///   - [`status_equals(ProcessingJobStatus)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::status_equals) / [`set_status_equals(Option<ProcessingJobStatus>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_status_equals): <p>A filter that retrieves only processing jobs with a specific status.</p>
    ///   - [`sort_by(SortBy)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::sort_by) / [`set_sort_by(Option<SortBy>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_sort_by): <p>The field to sort results by. The default is <code>CreationTime</code>.</p>
    ///   - [`sort_order(SortOrder)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::sort_order) / [`set_sort_order(Option<SortOrder>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_sort_order): <p>The sort order for results. The default is <code>Ascending</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_next_token): <p>If the result of the previous <code>ListProcessingJobs</code> request was truncated, the response includes a <code>NextToken</code>. To retrieve the next set of processing jobs, use the token in the next request.</p>
    ///   - [`max_results(i32)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_processing_jobs::builders::ListProcessingJobsFluentBuilder::set_max_results): <p>The maximum number of processing jobs to return in the response.</p>
