...
impl super::Client {
    ...
    ///   - [`hub_name(impl ::std::convert::Into<String>)`](crate::operation::delete_hub_content::builders::DeleteHubContentFluentBuilder::hub_name) / [`set_hub_name(Option<String>)`](crate::operation::delete_hub_content::builders::DeleteHubContentFluentBuilder::set_hub_name): <p>The name of the hub that you want to delete content in.</p>
    ...
    ///   - [`hub_content_name(impl ::std::convert::Into<String>)`](crate::operation::delete_hub_content::builders::DeleteHubContentFluentBuilder::hub_content_name) / [`set_hub_content_name(Option<String>)`](crate::operation::delete_hub_content::builders::DeleteHubContentFluentBuilder::set_hub_content_name): <p>The name of the content that you want to delete from a hub.</p>
