...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_labeling_jobs::builders::ListLabelingJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_labeling_jobs::builders::ListLabelingJobsFluentBuilder::set_next_token): <p>If the result of the previous <code>ListLabelingJobs</code> request was truncated, the response includes a <code>NextToken</code>. To retrieve the next set of labeling jobs, use the token in the next request.</p>
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::list_labeling_jobs::builders::ListLabelingJobsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_labeling_jobs::builders::ListLabelingJobsFluentBuilder::set_name_contains): <p>A string in the labeling job name. This filter returns only labeling jobs whose name contains the specified string.</p>
    ...
    pub fn list_labeling_jobs(
        &self,
    ) -> crate::operation::list_labeling_jobs::builders::ListLabelingJobsFluentBuilder {
        crate::operation::list_labeling_jobs::builders::ListLabelingJobsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
