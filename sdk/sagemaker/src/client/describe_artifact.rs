...
impl super::Client {
    ...
    ///   - [`artifact_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_artifact::builders::DescribeArtifactFluentBuilder::artifact_arn) / [`set_artifact_arn(Option<String>)`](crate::operation::describe_artifact::builders::DescribeArtifactFluentBuilder::set_artifact_arn): <p>The Amazon Resource Name (ARN) of the artifact to describe.</p>
