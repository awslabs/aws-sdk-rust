...
impl super::Client {
    ...
    ///   - [`workforce_name(impl Into<String>)`](crate::operation::delete_workforce::builders::DeleteWorkforceFluentBuilder::workforce_name) / [`set_workforce_name(Option<String>)`](crate::operation::delete_workforce::builders::DeleteWorkforceFluentBuilder::set_workforce_name):<br>required: **true**<br><p>The name of the workforce.</p><br>
