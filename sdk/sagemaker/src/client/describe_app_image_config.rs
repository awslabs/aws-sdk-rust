...
impl super::Client {
    ...
    ///   - [`app_image_config_name(impl ::std::convert::Into<String>)`](crate::operation::describe_app_image_config::builders::DescribeAppImageConfigFluentBuilder::app_image_config_name) / [`set_app_image_config_name(Option<String>)`](crate::operation::describe_app_image_config::builders::DescribeAppImageConfigFluentBuilder::set_app_image_config_name): <p>The name of the AppImageConfig to describe.</p>
