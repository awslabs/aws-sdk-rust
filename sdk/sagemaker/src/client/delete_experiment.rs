...
impl super::Client {
    ...
    ///   - [`experiment_name(impl Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::experiment_name) / [`set_experiment_name(Option<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::set_experiment_name):<br>required: **true**<br><p>The name of the experiment to delete.</p><br>
