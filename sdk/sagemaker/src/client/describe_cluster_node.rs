...
impl super::Client {
    ...
    ///   - [`node_logical_id(impl Into<String>)`](crate::operation::describe_cluster_node::builders::DescribeClusterNodeFluentBuilder::node_logical_id) / [`set_node_logical_id(Option<String>)`](crate::operation::describe_cluster_node::builders::DescribeClusterNodeFluentBuilder::set_node_logical_id):<br>required: **false**<br><p>The logical identifier of the node to describe. You can specify either <code>NodeLogicalId</code> or <code>InstanceId</code>, but not both. <code>NodeLogicalId</code> can be used to describe nodes that are still being provisioned and don't yet have an <code>InstanceId</code> assigned.</p><br>
