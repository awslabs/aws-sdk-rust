...
impl super::Client {
    ...
    ///   - [`node_id(impl Into<String>)`](crate::operation::describe_cluster_node::builders::DescribeClusterNodeFluentBuilder::node_id) / [`set_node_id(Option<String>)`](crate::operation::describe_cluster_node::builders::DescribeClusterNodeFluentBuilder::set_node_id):<br>required: **true**<br><p>The ID of the SageMaker HyperPod cluster node.</p><br>
