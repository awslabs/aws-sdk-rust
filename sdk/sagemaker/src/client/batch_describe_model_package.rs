...
impl super::Client {
    ...
    ///   - [`model_package_arn_list(impl Into<String>)`](crate::operation::batch_describe_model_package::builders::BatchDescribeModelPackageFluentBuilder::model_package_arn_list) / [`set_model_package_arn_list(Option<Vec::<String>>)`](crate::operation::batch_describe_model_package::builders::BatchDescribeModelPackageFluentBuilder::set_model_package_arn_list):<br>required: **true**<br><p>The list of Amazon Resource Name (ARN) of the model package groups.</p><br>
