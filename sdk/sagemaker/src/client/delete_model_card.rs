...
impl super::Client {
    ...
    ///   - [`model_card_name(impl Into<String>)`](crate::operation::delete_model_card::builders::DeleteModelCardFluentBuilder::model_card_name) / [`set_model_card_name(Option<String>)`](crate::operation::delete_model_card::builders::DeleteModelCardFluentBuilder::set_model_card_name):<br>required: **true**<br><p>The name of the model card to delete.</p><br>
