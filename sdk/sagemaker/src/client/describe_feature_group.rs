...
impl super::Client {
    ...
    ///   - [`feature_group_name(impl ::std::convert::Into<String>)`](crate::operation::describe_feature_group::builders::DescribeFeatureGroupFluentBuilder::feature_group_name) / [`set_feature_group_name(Option<String>)`](crate::operation::describe_feature_group::builders::DescribeFeatureGroupFluentBuilder::set_feature_group_name): <p>The name of the <code>FeatureGroup</code> you want described. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_feature_group::builders::DescribeFeatureGroupFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_feature_group::builders::DescribeFeatureGroupFluentBuilder::set_next_token): <p>A token to resume pagination of the list of <code>Features</code> (<code>FeatureDefinitions</code>). 2,500 <code>Features</code> are returned by default.</p>
