...
impl super::Client {
    ...
    ///   - [`feature_group_name(impl Into<String>)`](crate::operation::describe_feature_group::builders::DescribeFeatureGroupFluentBuilder::feature_group_name) / [`set_feature_group_name(Option<String>)`](crate::operation::describe_feature_group::builders::DescribeFeatureGroupFluentBuilder::set_feature_group_name): <p>The name of the <code>FeatureGroup</code> you want described. </p>
