...
impl super::Client {
    ...
    ///   - [`human_task_ui_name(impl Into<String>)`](crate::operation::create_human_task_ui::builders::CreateHumanTaskUiFluentBuilder::human_task_ui_name) / [`set_human_task_ui_name(Option<String>)`](crate::operation::create_human_task_ui::builders::CreateHumanTaskUiFluentBuilder::set_human_task_ui_name):<br>required: **true**<br><p>The name of the user interface you are creating.</p><br>
    ///   - [`ui_template(UiTemplate)`](crate::operation::create_human_task_ui::builders::CreateHumanTaskUiFluentBuilder::ui_template) / [`set_ui_template(Option<UiTemplate>)`](crate::operation::create_human_task_ui::builders::CreateHumanTaskUiFluentBuilder::set_ui_template):<br>required: **true**<br><p>The Liquid template for the worker user interface.</p><br>
    ///   - [`tags(Tag)`](crate::operation::create_human_task_ui::builders::CreateHumanTaskUiFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_human_task_ui::builders::CreateHumanTaskUiFluentBuilder::set_tags):<br>required: **false**<br><p>An array of key-value pairs that contain metadata to help you categorize and organize a human review workflow user interface. Each tag consists of a key and a value, both of which you define.</p><br>
