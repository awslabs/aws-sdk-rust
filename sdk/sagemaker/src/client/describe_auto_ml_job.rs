...
impl super::Client {
    ...
    ///   - [`generate_candidate_definitions_only(Option<bool>)`](crate::operation::describe_auto_ml_job::DescribeAutoMlJobOutput::generate_candidate_definitions_only): <p>Indicates whether the output for an AutoML job generates candidate definitions only.</p>
    ...
    ///   - [`resolved_attributes(Option<ResolvedAttributes>)`](crate::operation::describe_auto_ml_job::DescribeAutoMlJobOutput::resolved_attributes): <p>Contains <code>ProblemType</code>, <code>AutoMLJobObjective</code>, and <code>CompletionCriteria</code>. If you do not provide these values, they are inferred.</p>
