...
impl super::Client {
    ...
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::list_stage_devices::builders::ListStageDevicesFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::list_stage_devices::builders::ListStageDevicesFluentBuilder::set_stage_name): <p>The name of the stage in the deployment.</p>
