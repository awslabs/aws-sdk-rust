...
impl super::Client {
    ...
    ///   - [`ui_template(UiTemplate)`](crate::operation::render_ui_template::builders::RenderUiTemplateFluentBuilder::ui_template) / [`set_ui_template(Option<UiTemplate>)`](crate::operation::render_ui_template::builders::RenderUiTemplateFluentBuilder::set_ui_template):<br>required: **false**<br><p>A <code>Template</code> object containing the worker UI template to render.</p><br>
    ///   - [`task(RenderableTask)`](crate::operation::render_ui_template::builders::RenderUiTemplateFluentBuilder::task) / [`set_task(Option<RenderableTask>)`](crate::operation::render_ui_template::builders::RenderUiTemplateFluentBuilder::set_task):<br>required: **true**<br><p>A <code>RenderableTask</code> object containing a representative task to render.</p><br>
    ///   - [`role_arn(impl Into<String>)`](crate::operation::render_ui_template::builders::RenderUiTemplateFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::render_ui_template::builders::RenderUiTemplateFluentBuilder::set_role_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that has access to the S3 objects that are used by the template.</p><br>
