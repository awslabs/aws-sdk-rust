...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::create_space::builders::CreateSpaceFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::create_space::builders::CreateSpaceFluentBuilder::set_domain_id): <p>The ID of the associated Domain.</p>
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::create_space::builders::CreateSpaceFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::create_space::builders::CreateSpaceFluentBuilder::set_space_name): <p>The name of the space.</p>
