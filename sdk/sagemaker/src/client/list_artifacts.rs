...
impl super::Client {
    ...
    ///   - [`created_before(DateTime)`](crate::operation::list_artifacts::builders::ListArtifactsFluentBuilder::created_before) / [`set_created_before(Option<DateTime>)`](crate::operation::list_artifacts::builders::ListArtifactsFluentBuilder::set_created_before):<br>required: **false**<br><p>A filter that returns only artifacts created on or before the specified time.</p><br>
    ///   - [`sort_by(SortArtifactsBy)`](crate::operation::list_artifacts::builders::ListArtifactsFluentBuilder::sort_by) / [`set_sort_by(Option<SortArtifactsBy>)`](crate::operation::list_artifacts::builders::ListArtifactsFluentBuilder::set_sort_by):<br>required: **false**<br><p>The property used to sort results. The default value is <code>CreationTime</code>.</p><br>
