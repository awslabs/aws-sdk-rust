...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_app::builders::CreateAppFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_app::builders::CreateAppFluentBuilder::set_tags): <p>Each tag consists of a key and an optional value. Tag keys must be unique per resource.</p>
