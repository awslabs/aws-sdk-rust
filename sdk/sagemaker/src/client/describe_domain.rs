...
impl super::Client {
    ...
    ///   - [`single_sign_on_application_arn(Option<String>)`](crate::operation::describe_domain::DescribeDomainOutput::single_sign_on_application_arn): <p>The ARN of the application managed by SageMaker AI in IAM Identity Center. This value is only returned for domains created after October 1, 2023.</p>
    ...
    ///   - [`subnet_ids(Option<Vec::<String>>)`](crate::operation::describe_domain::DescribeDomainOutput::subnet_ids): <p>The VPC subnets that the domain uses for communication.</p>
    ///   - [`url(Option<String>)`](crate::operation::describe_domain::DescribeDomainOutput::url): <p>The domain's URL.</p>
    ///   - [`vpc_id(Option<String>)`](crate::operation::describe_domain::DescribeDomainOutput::vpc_id): <p>The ID of the Amazon Virtual Private Cloud (VPC) that the domain uses for communication.</p>
    ...
    ///   - [`home_efs_file_system_creation(Option<HomeEfsFileSystemCreation>)`](crate::operation::describe_domain::DescribeDomainOutput::home_efs_file_system_creation): <p>Indicates whether a home EFS file system is created for the domain.</p>
