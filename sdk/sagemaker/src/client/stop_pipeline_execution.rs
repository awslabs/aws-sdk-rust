...
impl super::Client {
    ...
    ///   - [`pipeline_execution_arn(impl ::std::convert::Into<String>)`](crate::operation::stop_pipeline_execution::builders::StopPipelineExecutionFluentBuilder::pipeline_execution_arn) / [`set_pipeline_execution_arn(Option<String>)`](crate::operation::stop_pipeline_execution::builders::StopPipelineExecutionFluentBuilder::set_pipeline_execution_arn): <p>The Amazon Resource Name (ARN) of the pipeline execution.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::stop_pipeline_execution::builders::StopPipelineExecutionFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::stop_pipeline_execution::builders::StopPipelineExecutionFluentBuilder::set_client_request_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the operation. An idempotent operation completes no more than once.</p>
