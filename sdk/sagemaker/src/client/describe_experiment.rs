...
impl super::Client {
    ...
    ///   - [`experiment_name(impl ::std::convert::Into<String>)`](crate::operation::describe_experiment::builders::DescribeExperimentFluentBuilder::experiment_name) / [`set_experiment_name(Option<String>)`](crate::operation::describe_experiment::builders::DescribeExperimentFluentBuilder::set_experiment_name): <p>The name of the experiment to describe.</p>
