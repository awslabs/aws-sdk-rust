...
impl super::Client {
    ...
    ///   - [`edge_packaging_job_name(impl ::std::convert::Into<String>)`](crate::operation::describe_edge_packaging_job::builders::DescribeEdgePackagingJobFluentBuilder::edge_packaging_job_name) / [`set_edge_packaging_job_name(Option<String>)`](crate::operation::describe_edge_packaging_job::builders::DescribeEdgePackagingJobFluentBuilder::set_edge_packaging_job_name): <p>The name of the edge packaging job.</p>
