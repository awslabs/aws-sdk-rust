...
impl super::Client {
    ...
    ///   - [`edge_deployment_plan_name(impl Into<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::edge_deployment_plan_name) / [`set_edge_deployment_plan_name(Option<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::set_edge_deployment_plan_name):<br>required: **true**<br><p>The name of the deployment plan to describe.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::set_next_token):<br>required: **false**<br><p>If the edge deployment plan has enough stages to require tokening, then this is the response from the last list of stages returned.</p><br>
    ///   - [`max_results(i32)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to select (50 by default).</p><br>
    ...
    ///   - [`edge_deployment_success(Option<i32>)`](crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanOutput::edge_deployment_success): <p>The number of edge devices with the successful deployment.</p>
    ///   - [`edge_deployment_pending(Option<i32>)`](crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanOutput::edge_deployment_pending): <p>The number of edge devices yet to pick up deployment, or in progress.</p>
    ///   - [`edge_deployment_failed(Option<i32>)`](crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanOutput::edge_deployment_failed): <p>The number of edge devices that failed the deployment.</p>
