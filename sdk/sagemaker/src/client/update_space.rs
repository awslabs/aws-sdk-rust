...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::set_domain_id): <p>The ID of the associated Domain.</p>
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::set_space_name): <p>The name of the space.</p>
