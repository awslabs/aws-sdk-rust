...
impl super::Client {
    ...
    ///   - [`space_display_name(impl Into<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::space_display_name) / [`set_space_display_name(Option<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::set_space_display_name):<br>required: **false**<br><p>The name of the space that appears in the Amazon SageMaker Studio UI.</p><br>
