...
impl super::Client {
    ...
    ///   - [`model_package_group_name(impl Into<String>)`](crate::operation::delete_model_package_group_policy::builders::DeleteModelPackageGroupPolicyFluentBuilder::model_package_group_name) / [`set_model_package_group_name(Option<String>)`](crate::operation::delete_model_package_group_policy::builders::DeleteModelPackageGroupPolicyFluentBuilder::set_model_package_group_name):<br>required: **true**<br><p>The name of the model group for which to delete the policy.</p><br>
