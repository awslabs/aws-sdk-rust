...
impl super::Client  {
    ...
    pub fn describe_notebook_instance_lifecycle_config(&self) -> crate::client::fluent_builders::DescribeNotebookInstanceLifecycleConfig {
                                crate::client::fluent_builders::DescribeNotebookInstanceLifecycleConfig::new(self.handle.clone())
                            }
}
