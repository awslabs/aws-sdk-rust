...
impl super::Client {
    ...
    ///   - [`trial_component_name(impl ::std::convert::Into<String>)`](crate::operation::delete_trial_component::builders::DeleteTrialComponentFluentBuilder::trial_component_name) / [`set_trial_component_name(Option<String>)`](crate::operation::delete_trial_component::builders::DeleteTrialComponentFluentBuilder::set_trial_component_name): <p>The name of the component to delete.</p>
