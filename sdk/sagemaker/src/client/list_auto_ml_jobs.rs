...
impl super::Client {
    ...
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::list_auto_ml_jobs::builders::ListAutoMLJobsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_auto_ml_jobs::builders::ListAutoMLJobsFluentBuilder::set_name_contains): <p>Request a list of jobs, using a search filter for name.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_auto_ml_jobs::builders::ListAutoMLJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_auto_ml_jobs::builders::ListAutoMLJobsFluentBuilder::set_next_token): <p>If the previous response was truncated, you receive this token. Use it in your next request to receive the next set of results.</p>
