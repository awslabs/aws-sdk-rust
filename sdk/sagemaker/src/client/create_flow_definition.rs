...
impl super::Client {
    ...
    ///   - [`flow_definition_name(impl ::std::convert::Into<String>)`](crate::operation::create_flow_definition::builders::CreateFlowDefinitionFluentBuilder::flow_definition_name) / [`set_flow_definition_name(Option<String>)`](crate::operation::create_flow_definition::builders::CreateFlowDefinitionFluentBuilder::set_flow_definition_name): <p>The name of your flow definition.</p>
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_flow_definition::builders::CreateFlowDefinitionFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::create_flow_definition::builders::CreateFlowDefinitionFluentBuilder::set_role_arn): <p>The Amazon Resource Name (ARN) of the role needed to call other services on your behalf. For example, <code>arn:aws:iam::1234567890:role/service-role/AmazonSageMaker-ExecutionRole-20180111T151298</code>.</p>
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_flow_definition::builders::CreateFlowDefinitionFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_flow_definition::builders::CreateFlowDefinitionFluentBuilder::set_tags): <p>An array of key-value pairs that contain metadata to help you categorize and organize a flow definition. Each tag consists of a key and a value, both of which you define.</p>
