...
impl super::Client {
    ...
    ///   - [`last_modified_time_before(DateTime)`](crate::operation::list_images::builders::ListImagesFluentBuilder::last_modified_time_before) / [`set_last_modified_time_before(Option<DateTime>)`](crate::operation::list_images::builders::ListImagesFluentBuilder::set_last_modified_time_before):<br>required: **false**<br><p>A filter that returns only images modified on or before the specified time.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_images::builders::ListImagesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_images::builders::ListImagesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of images to return in the response. The default value is 10.</p><br>
    ///   - [`name_contains(impl Into<String>)`](crate::operation::list_images::builders::ListImagesFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_images::builders::ListImagesFluentBuilder::set_name_contains):<br>required: **false**<br><p>A filter that returns only images whose name contains the specified string.</p><br>
