...
impl super::Client {
    ...
    ///   - [`endpoint_name(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::endpoint_name) / [`set_endpoint_name(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_endpoint_name): <p>The name of the endpoint whose configuration you want to update.</p>
    ///   - [`endpoint_config_name(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::endpoint_config_name) / [`set_endpoint_config_name(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_endpoint_config_name): <p>The name of the new endpoint configuration.</p>
