...
impl super::Client {
    ...
    ///   - [`artifact_arn(impl Into<String>)`](crate::operation::delete_artifact::builders::DeleteArtifactFluentBuilder::artifact_arn) / [`set_artifact_arn(Option<String>)`](crate::operation::delete_artifact::builders::DeleteArtifactFluentBuilder::set_artifact_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the artifact to delete.</p><br>
    ///   - [`source(ArtifactSource)`](crate::operation::delete_artifact::builders::DeleteArtifactFluentBuilder::source) / [`set_source(Option<ArtifactSource>)`](crate::operation::delete_artifact::builders::DeleteArtifactFluentBuilder::set_source):<br>required: **false**<br><p>The URI of the source.</p><br>
