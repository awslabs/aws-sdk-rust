...
impl super::Client {
    ...
    ///   - [`restricted_instance_groups(Option<Vec::<ClusterRestrictedInstanceGroupDetails>>)`](crate::operation::describe_cluster::DescribeClusterOutput::restricted_instance_groups): <p>The specialized instance groups for training models like Amazon Nova to be created in the SageMaker HyperPod cluster.</p>
    ///   - [`restricted_instance_groups_config(Option<ClusterRestrictedInstanceGroupsConfigOutput>)`](crate::operation::describe_cluster::DescribeClusterOutput::restricted_instance_groups_config): <p>The configuration for the restricted instance groups (RIG) in the SageMaker HyperPod cluster.</p>
    ...
    ///   - [`tiered_storage_config(Option<ClusterTieredStorageConfig>)`](crate::operation::describe_cluster::DescribeClusterOutput::tiered_storage_config): <p>The current configuration for managed tier checkpointing on the HyperPod cluster. For example, this shows whether the feature is enabled and the percentage of cluster memory allocated for checkpoint storage.</p>
