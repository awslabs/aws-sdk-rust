...
impl super::Client {
    ...
    ///   - [`effective_trusted_identity_propagation_status(Option<FeatureStatus>)`](crate::operation::describe_app::DescribeAppOutput::effective_trusted_identity_propagation_status): <p>The effective status of Trusted Identity Propagation (TIP) for this application. When enabled, user identities from IAM Identity Center are being propagated through the application to TIP enabled Amazon Web Services services. When disabled, standard IAM role-based access is used.</p>
    ///   - [`recovery_mode(Option<bool>)`](crate::operation::describe_app::DescribeAppOutput::recovery_mode): <p>Indicates whether the application is launched in recovery mode.</p>
    ...
    ///   - [`resource_spec(Option<ResourceSpec>)`](crate::operation::describe_app::DescribeAppOutput::resource_spec): <p>The instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance.</p>
