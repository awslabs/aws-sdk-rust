...
impl super::Client {
    ...
    ///   - [`hub_name(impl Into<String>)`](crate::operation::delete_hub::builders::DeleteHubFluentBuilder::hub_name) / [`set_hub_name(Option<String>)`](crate::operation::delete_hub::builders::DeleteHubFluentBuilder::set_hub_name):<br>required: **true**<br><p>The name of the hub to delete.</p><br>
