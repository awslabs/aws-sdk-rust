...
impl super::Client {
    ...
    ///   - [`trial_name(impl Into<String>)`](crate::operation::update_trial::builders::UpdateTrialFluentBuilder::trial_name) / [`set_trial_name(Option<String>)`](crate::operation::update_trial::builders::UpdateTrialFluentBuilder::set_trial_name):<br>required: **true**<br><p>The name of the trial to update.</p><br>
    ///   - [`display_name(impl Into<String>)`](crate::operation::update_trial::builders::UpdateTrialFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_trial::builders::UpdateTrialFluentBuilder::set_display_name):<br>required: **false**<br><p>The name of the trial as displayed. The name doesn't need to be unique. If <code>DisplayName</code> isn't specified, <code>TrialName</code> is displayed.</p><br>
