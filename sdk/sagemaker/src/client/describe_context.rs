...
impl super::Client {
    ...
    ///   - [`context_name(impl ::std::convert::Into<String>)`](crate::operation::describe_context::builders::DescribeContextFluentBuilder::context_name) / [`set_context_name(Option<String>)`](crate::operation::describe_context::builders::DescribeContextFluentBuilder::set_context_name): <p>The name of the context to describe.</p>
