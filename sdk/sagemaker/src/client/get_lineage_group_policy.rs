...
impl super::Client {
    ...
    ///   - [`lineage_group_name(impl Into<String>)`](crate::operation::get_lineage_group_policy::builders::GetLineageGroupPolicyFluentBuilder::lineage_group_name) / [`set_lineage_group_name(Option<String>)`](crate::operation::get_lineage_group_policy::builders::GetLineageGroupPolicyFluentBuilder::set_lineage_group_name):<br>required: **true**<br><p>The name or Amazon Resource Name (ARN) of the lineage group.</p><br>
