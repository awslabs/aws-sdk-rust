...
impl ::std::convert::From<&str> for FeaturizationMethodName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeaturizationMethodName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeaturizationMethodName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeaturizationMethodName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FeaturizationMethodName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FeaturizationMethodName {
