...
pub fn ser_list_monitor_evaluations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_monitor_evaluations::ListMonitorEvaluationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
