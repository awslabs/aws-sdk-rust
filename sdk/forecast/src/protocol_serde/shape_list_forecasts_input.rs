...
pub fn ser_list_forecasts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_forecasts::ListForecastsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
