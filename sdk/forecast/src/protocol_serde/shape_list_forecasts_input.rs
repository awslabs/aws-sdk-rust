...
pub fn ser_list_forecasts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListForecastsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
