...
pub fn ser_time_series_identifiers(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimeSeriesIdentifiers) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_time_series_identifiers<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TimeSeriesIdentifiers>, aws_smithy_json::deserialize::error::DeserializeError>
