...
pub fn ser_create_predictor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePredictorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
