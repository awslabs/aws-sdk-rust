...
pub fn ser_create_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_monitor::CreateMonitorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
