...
pub fn ser_create_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateMonitorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
