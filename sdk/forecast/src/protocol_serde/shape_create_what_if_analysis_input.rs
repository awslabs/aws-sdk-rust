...
pub fn ser_create_what_if_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_what_if_analysis::CreateWhatIfAnalysisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
