...
pub(crate) fn de_predictor_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PredictorSummary>, aws_smithy_json::deserialize::error::DeserializeError>
