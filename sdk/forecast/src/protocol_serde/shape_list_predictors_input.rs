...
pub fn ser_list_predictors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPredictorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
