...
pub fn ser_list_monitors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListMonitorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
