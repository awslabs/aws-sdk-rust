...
pub fn ser_create_auto_predictor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAutoPredictorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
