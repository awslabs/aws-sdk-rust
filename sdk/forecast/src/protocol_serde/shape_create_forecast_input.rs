...
pub fn ser_create_forecast_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateForecastInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
