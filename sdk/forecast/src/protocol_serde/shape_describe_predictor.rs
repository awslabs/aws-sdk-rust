...
pub fn de_describe_predictor_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_predictor::DescribePredictorOutput, crate::operation::describe_predictor::DescribePredictorError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_predictor_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_predictor::DescribePredictorOutput, crate::operation::describe_predictor::DescribePredictorError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_describe_predictor_input(input: &crate::operation::describe_predictor::DescribePredictorInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
