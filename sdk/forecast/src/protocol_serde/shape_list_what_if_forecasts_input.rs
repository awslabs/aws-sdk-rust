...
pub fn ser_list_what_if_forecasts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListWhatIfForecastsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
