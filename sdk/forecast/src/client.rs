...
/// For example, the [`CreateAutoPredictor`](crate::operation) operation has
...
mod create_explainability;

mod create_explainability_export;

mod create_forecast;

mod create_forecast_export_job;

mod create_monitor;

mod create_predictor;

mod create_predictor_backtest_export_job;

mod create_what_if_analysis;

mod create_what_if_forecast;

mod create_what_if_forecast_export;

mod delete_dataset;

mod delete_dataset_group;

mod delete_dataset_import_job;

mod delete_explainability;

mod delete_explainability_export;

mod delete_forecast;

mod delete_forecast_export_job;

mod delete_monitor;

mod delete_predictor;

mod delete_predictor_backtest_export_job;

mod delete_resource_tree;

mod delete_what_if_analysis;

mod delete_what_if_forecast;

mod delete_what_if_forecast_export;

mod describe_auto_predictor;
...
mod describe_explainability;

mod describe_explainability_export;

mod describe_forecast;

mod describe_forecast_export_job;

mod describe_monitor;

mod describe_predictor;

mod describe_predictor_backtest_export_job;

mod describe_what_if_analysis;

mod describe_what_if_forecast;

mod describe_what_if_forecast_export;
...
mod list_explainabilities;

mod list_explainability_exports;

mod list_forecast_export_jobs;

mod list_forecasts;

mod list_monitor_evaluations;

mod list_monitors;

mod list_predictor_backtest_export_jobs;

mod list_predictors;

mod list_tags_for_resource;

mod list_what_if_analyses;

mod list_what_if_forecast_exports;

mod list_what_if_forecasts;
