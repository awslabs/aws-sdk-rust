...
pub struct ListWhatIfForecastsOutput  {
    ...
    #[doc(hidden)]pub what_if_forecasts: std::option::Option<std::vec::Vec<crate::model::WhatIfForecastSummary>>,
...
pub struct ListWhatIfForecastExportsOutput  {
    ...
    #[doc(hidden)]pub what_if_forecast_exports: std::option::Option<std::vec::Vec<crate::model::WhatIfForecastExportSummary>>,
...
pub struct ListWhatIfAnalysesOutput  {
    ...
    #[doc(hidden)]pub what_if_analyses: std::option::Option<std::vec::Vec<crate::model::WhatIfAnalysisSummary>>,
    /// <p>If the response is truncated, Forecast returns this token. To retrieve the next set of results, use the token in the next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListPredictorsOutput  {
    ...
    #[doc(hidden)]pub predictors: std::option::Option<std::vec::Vec<crate::model::PredictorSummary>>,
...
pub struct ListPredictorBacktestExportJobsOutput  {
    ...
    #[doc(hidden)]pub predictor_backtest_export_jobs: std::option::Option<std::vec::Vec<crate::model::PredictorBacktestExportJobSummary>>,
...
impl  std::fmt::Debug for ListPredictorBacktestExportJobsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predictor_backtest_export_jobs", &self.predictor_backtest_export_jobs);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListMonitorsOutput  {
    ...
    #[doc(hidden)]pub monitors: std::option::Option<std::vec::Vec<crate::model::MonitorSummary>>,
    /// <p>If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListMonitorEvaluationsOutput  {
    ...
    #[doc(hidden)]pub predictor_monitor_evaluations: std::option::Option<std::vec::Vec<crate::model::PredictorMonitorEvaluation>>,
}
...
impl  std::fmt::Debug for ListMonitorEvaluationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("predictor_monitor_evaluations", &self.predictor_monitor_evaluations);
        formatter.finish()
    }
}
...
pub struct ListForecastsOutput  {
    ...
    #[doc(hidden)]pub forecasts: std::option::Option<std::vec::Vec<crate::model::ForecastSummary>>,
    /// <p>If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListForecastExportJobsOutput  {
    ...
    #[doc(hidden)]pub forecast_export_jobs: std::option::Option<std::vec::Vec<crate::model::ForecastExportJobSummary>>,
    /// <p>If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListExplainabilityExportsOutput  {
    ...
    #[doc(hidden)]pub explainability_exports: std::option::Option<std::vec::Vec<crate::model::ExplainabilityExportSummary>>,
    /// <p>Returns this token if the response is truncated. To retrieve the next set of results, use the token in the next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListExplainabilitiesOutput  {
    ...
    #[doc(hidden)]pub explainabilities: std::option::Option<std::vec::Vec<crate::model::ExplainabilitySummary>>,
    /// <p>Returns this token if the response is truncated. To retrieve the next set of results, use the token in the next request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetAccuracyMetricsOutput  {
    ...
    #[doc(hidden)]pub predictor_evaluation_results: std::option::Option<std::vec::Vec<crate::model::EvaluationResult>>,
...
impl  std::fmt::Debug for GetAccuracyMetricsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predictor_evaluation_results", &self.predictor_evaluation_results);
...
pub struct DescribeWhatIfForecastExportOutput  {
    ...
    #[doc(hidden)]pub estimated_time_remaining_in_minutes: std::option::Option<i64>,
...
impl  std::fmt::Debug for DescribeWhatIfForecastExportOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("estimated_time_remaining_in_minutes", &self.estimated_time_remaining_in_minutes);
...
pub struct DescribePredictorOutput  {
    ...
    #[doc(hidden)]pub auto_ml_algorithm_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub predictor_execution_details: std::option::Option<crate::model::PredictorExecutionDetails>,
    ...
    #[doc(hidden)]pub dataset_import_job_arns: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for DescribePredictorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("predictor_execution_details", &self.predictor_execution_details);
        formatter.field("estimated_time_remaining_in_minutes", &self.estimated_time_remaining_in_minutes);
        formatter.field("is_auto_predictor", &self.is_auto_predictor);
...
pub struct DescribeMonitorOutput  {
    ...
    #[doc(hidden)]pub last_evaluation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The state of the monitor's latest evaluation.</p>
    #[doc(hidden)]pub last_evaluation_state: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub baseline: std::option::Option<crate::model::Baseline>,
    ...
    #[doc(hidden)]pub estimated_evaluation_time_remaining_in_minutes: std::option::Option<i64>,
}
...
impl  std::fmt::Debug for DescribeMonitorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("creation_time", &self.creation_time);
        formatter.field("last_modification_time", &self.last_modification_time);
        formatter.field("estimated_evaluation_time_remaining_in_minutes", &self.estimated_evaluation_time_remaining_in_minutes);
        formatter.finish()
    }
}
...
pub struct DescribeDatasetImportJobOutput  {
    ...
    #[doc(hidden)]pub field_statistics: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Statistics>>,
    /// <p>The size of the dataset in gigabytes (GB) after the import job has finished.</p>
    #[doc(hidden)]pub data_size: std::option::Option<f64>,
...
pub struct DescribeAutoPredictorOutput  {
    ...
    #[doc(hidden)]pub explainability_info: std::option::Option<crate::model::ExplainabilityInfo>,
    /// <p>A object with the Amazon Resource Name (ARN) and status of the monitor resource.</p>
    #[doc(hidden)]pub monitor_info: std::option::Option<crate::model::MonitorInfo>,
