...
impl super::Client {
    ...
    ///   - [`what_if_forecast_export_name(impl ::std::convert::Into<String>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::what_if_forecast_export_name) / [`set_what_if_forecast_export_name(Option<String>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::set_what_if_forecast_export_name): <p>The name of the what-if forecast to export.</p>
    ///   - [`what_if_forecast_arns(Vec<String>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::what_if_forecast_arns) / [`set_what_if_forecast_arns(Option<Vec<String>>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::set_what_if_forecast_arns): <p>The list of what-if forecast Amazon Resource Names (ARNs) to export.</p>
    ///   - [`destination(DataDestination)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::destination) / [`set_destination(Option<DataDestination>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::set_destination): <p>The location where you want to save the forecast and an Identity and Access Management (IAM) role that Amazon Forecast can assume to access the location. The forecast must be exported to an Amazon S3 bucket.</p>  <p>If encryption is used, <code>Destination</code> must include an Key Management Service (KMS) key. The IAM role must allow Amazon Forecast permission to access the key.</p>
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::set_tags): <p>A list of <a href="https://docs.aws.amazon.com/forecast/latest/dg/tagging-forecast-resources.html">tags</a> to apply to the what if forecast.</p>
    ///   - [`format(impl ::std::convert::Into<String>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::format) / [`set_format(Option<String>)`](crate::operation::create_what_if_forecast_export::builders::CreateWhatIfForecastExportFluentBuilder::set_format): <p>The format of the exported data, CSV or PARQUET.</p>
