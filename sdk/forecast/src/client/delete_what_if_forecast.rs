...
impl super::Client {
    ...
    ///   - [`what_if_forecast_arn(impl Into<String>)`](crate::operation::delete_what_if_forecast::builders::DeleteWhatIfForecastFluentBuilder::what_if_forecast_arn) / [`set_what_if_forecast_arn(Option<String>)`](crate::operation::delete_what_if_forecast::builders::DeleteWhatIfForecastFluentBuilder::set_what_if_forecast_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the what-if forecast that you want to delete.</p><br>
