...
impl super::Client {
    ...
    ///   - [`predictor_backtest_export_job_arn(impl Into<String>)`](crate::operation::delete_predictor_backtest_export_job::builders::DeletePredictorBacktestExportJobFluentBuilder::predictor_backtest_export_job_arn) / [`set_predictor_backtest_export_job_arn(Option<String>)`](crate::operation::delete_predictor_backtest_export_job::builders::DeletePredictorBacktestExportJobFluentBuilder::set_predictor_backtest_export_job_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the predictor backtest export job to delete.</p><br>
    ...
    pub fn delete_predictor_backtest_export_job(
        &self,
    ) -> crate::operation::delete_predictor_backtest_export_job::builders::DeletePredictorBacktestExportJobFluentBuilder {
