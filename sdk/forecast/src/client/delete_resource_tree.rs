...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::delete_resource_tree::builders::DeleteResourceTreeFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::delete_resource_tree::builders::DeleteResourceTreeFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the parent resource to delete. All child resources of the parent resource will also be deleted.</p><br>
