...
impl super::Client {
    ...
    ///   - [`forecast_arn(impl Into<String>)`](crate::operation::delete_forecast::builders::DeleteForecastFluentBuilder::forecast_arn) / [`set_forecast_arn(Option<String>)`](crate::operation::delete_forecast::builders::DeleteForecastFluentBuilder::set_forecast_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the forecast to delete.</p><br>
