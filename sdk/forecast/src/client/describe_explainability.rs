...
impl super::Client {
    ...
    ///   - [`data_source(Option<DataSource>)`](crate::operation::describe_explainability::DescribeExplainabilityOutput::data_source): <p>The source of your data, an AWS Identity and Access Management (IAM) role that allows Amazon Forecast to access the data and, optionally, an AWS Key Management Service (KMS) key.</p>
