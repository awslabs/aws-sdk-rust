...
impl super::Client {
    ...
    ///   - [`dataset_arn(impl Into<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::dataset_arn) / [`set_dataset_arn(Option<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::set_dataset_arn): <p>The Amazon Resource Name (ARN) of the dataset.</p>
    ...
    ///   - [`encryption_config(Option<EncryptionConfig>)`](crate::operation::describe_dataset::DescribeDatasetOutput::encryption_config): <p>The AWS Key Management Service (KMS) key and the AWS Identity and Access Management (IAM) role that Amazon Forecast can assume to access the key.</p>
