...
impl super::Client {
    ...
    ///   - [`monitor_arn(impl Into<String>)`](crate::operation::delete_monitor::builders::DeleteMonitorFluentBuilder::monitor_arn) / [`set_monitor_arn(Option<String>)`](crate::operation::delete_monitor::builders::DeleteMonitorFluentBuilder::set_monitor_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the monitor resource to delete.</p><br>
