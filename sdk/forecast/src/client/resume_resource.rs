...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::resume_resource::builders::ResumeResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::resume_resource::builders::ResumeResourceFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the monitor resource to resume.</p><br>
