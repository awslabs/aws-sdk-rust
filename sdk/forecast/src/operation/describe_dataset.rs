...
impl DescribeDatasetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_dataset::DescribeDataset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_dataset::ser_describe_dataset_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataset {
    type Output =
        ::std::result::Result<crate::operation::describe_dataset::DescribeDatasetOutput, crate::operation::describe_dataset::DescribeDatasetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_dataset::de_describe_dataset_http_response_with_props(status, headers, body)
        }
    }
}
