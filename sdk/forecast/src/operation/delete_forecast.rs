...
impl DeleteForecastInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_forecast::DeleteForecast::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteForecast {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_forecast::de_delete_forecast_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_forecast::de_delete_forecast_http_response(
                status, headers, body,
            )
        }
    }
