...
impl CreateAutoPredictorInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_auto_predictor::CreateAutoPredictor::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAutoPredictor {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_auto_predictor::de_create_auto_predictor_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::create_auto_predictor::CreateAutoPredictorError
{
