...
impl DescribePredictorBacktestExportJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_predictor_backtest_export_job::DescribePredictorBacktestExportJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_predictor_backtest_export_job::DescribePredictorBacktestExportJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePredictorBacktestExportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_predictor_backtest_export_job::de_describe_predictor_backtest_export_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
