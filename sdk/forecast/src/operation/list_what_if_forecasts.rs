...
impl ListWhatIfForecastsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_what_if_forecasts::ListWhatIfForecasts,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWhatIfForecasts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_what_if_forecasts::de_list_what_if_forecasts_http_response_with_props(status, headers, body)
        }
    }
}
