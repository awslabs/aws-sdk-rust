...
impl ListMonitorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_monitors::ListMonitors, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_monitors::ser_list_monitors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMonitors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_monitors::de_list_monitors_http_response_with_props(status, headers, body)
        }
    }
}
