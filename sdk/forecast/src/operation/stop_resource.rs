...
impl StopResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_resource::StopResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_resource::de_stop_resource_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_resource::de_stop_resource_http_response_with_props(
                status, headers, body,
            )
        }
    }
