...
impl CreateWhatIfForecastExportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_what_if_forecast_export::CreateWhatIfForecastExport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWhatIfForecastExport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_what_if_forecast_export::de_create_what_if_forecast_export_http_response_with_props(
                status, headers, body,
            )
        }
    }
