...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWhatIfForecastExport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_what_if_forecast_export::de_create_what_if_forecast_export_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_what_if_forecast_export::CreateWhatIfForecastExportError
{
