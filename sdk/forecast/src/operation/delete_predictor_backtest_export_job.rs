...
impl DeletePredictorBacktestExportJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobInput,
                    ) -> ::std::result::Result<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeletePredictorBacktestExportJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeletePredictorBacktestExportJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeletePredictorBacktestExportJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeletePredictorBacktestExportJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeletePredictorBacktestExportJob")
...
.with_interceptor(DeletePredictorBacktestExportJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobError>::new());
...
#[derive(Debug)]
            struct DeletePredictorBacktestExportJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePredictorBacktestExportJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_predictor_backtest_export_job::de_delete_predictor_backtest_export_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeletePredictorBacktestExportJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePredictorBacktestExportJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_predictor_backtest_export_job::ser_delete_predictor_backtest_export_job_input(&input)?);
...
#[derive(Debug)]
            struct DeletePredictorBacktestExportJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeletePredictorBacktestExportJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeletePredictorBacktestExportJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeletePredictorBacktestExportJobInput>()
                        .ok_or("failed to downcast to DeletePredictorBacktestExportJobInput")?;
...
pub enum DeletePredictorBacktestExportJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeletePredictorBacktestExportJobError) for what information is available for the error.")]
...
impl DeletePredictorBacktestExportJobError {
    /// Creates the `DeletePredictorBacktestExportJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeletePredictorBacktestExportJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeletePredictorBacktestExportJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJobError {
...
mod _delete_predictor_backtest_export_job_output;
