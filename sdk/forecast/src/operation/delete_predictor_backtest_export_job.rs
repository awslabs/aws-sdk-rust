...
impl DeletePredictorBacktestExportJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_predictor_backtest_export_job::DeletePredictorBacktestExportJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePredictorBacktestExportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_predictor_backtest_export_job::de_delete_predictor_backtest_export_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
