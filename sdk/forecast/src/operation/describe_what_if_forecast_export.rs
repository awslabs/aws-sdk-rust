    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_what_if_forecast_export::DescribeWhatIfForecastExportError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_what_if_forecast_export::DescribeWhatIfForecastExportOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeWhatIfForecastExportResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeWhatIfForecastExportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_what_if_forecast_export::DescribeWhatIfForecastExportInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeWhatIfForecastExportEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_what_if_forecast_export::DescribeWhatIfForecastExportError {
