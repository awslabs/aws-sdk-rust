...
impl CreateForecastInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_forecast::CreateForecast, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_forecast::ser_create_forecast_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateForecast {
    type Output =
        ::std::result::Result<crate::operation::create_forecast::CreateForecastOutput, crate::operation::create_forecast::CreateForecastError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_forecast::de_create_forecast_http_response_with_props(status, headers, body)
        }
    }
}
