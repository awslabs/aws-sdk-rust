...
impl CreatePredictorBacktestExportJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePredictorBacktestExportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_predictor_backtest_export_job::de_create_predictor_backtest_export_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
