...
impl ListWhatIfForecastExportsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsInput, ::aws_smithy_types::error::operation::BuildError> {
