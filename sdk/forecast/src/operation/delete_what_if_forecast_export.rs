...
impl DeleteWhatIfForecastExportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_what_if_forecast_export::DeleteWhatIfForecastExport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWhatIfForecastExport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_what_if_forecast_export::de_delete_what_if_forecast_export_http_response_with_props(
                status, headers, body,
            )
        }
    }
