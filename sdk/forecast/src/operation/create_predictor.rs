...
impl CreatePredictorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_predictor::CreatePredictor, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_predictor::ser_create_predictor_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePredictor {
    type Output =
        ::std::result::Result<crate::operation::create_predictor::CreatePredictorOutput, crate::operation::create_predictor::CreatePredictorError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_predictor::de_create_predictor_http_response_with_props(status, headers, body)
        }
    }
}
