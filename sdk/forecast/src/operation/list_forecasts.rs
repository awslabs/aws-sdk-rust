...
impl ListForecastsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_forecasts::ListForecasts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_forecasts::ser_list_forecasts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListForecasts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_forecasts::de_list_forecasts_http_response_with_props(status, headers, body)
        }
    }
}
