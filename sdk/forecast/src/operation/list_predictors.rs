...
impl ListPredictorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_predictors::ListPredictors, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_predictors::ser_list_predictors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPredictors {
    type Output =
        ::std::result::Result<crate::operation::list_predictors::ListPredictorsOutput, crate::operation::list_predictors::ListPredictorsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_predictors::de_list_predictors_http_response_with_props(status, headers, body)
        }
    }
}
