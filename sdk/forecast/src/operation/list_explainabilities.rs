...
/// Orchestration and serialization glue logic for `ListExplainabilities`.
...
impl ListExplainabilities {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_explainabilities::ListExplainabilitiesInput,
                    ) -> ::std::result::Result<crate::operation::list_explainabilities::ListExplainabilitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_explainabilities::ListExplainabilitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_explainabilities::ListExplainabilitiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_explainabilities::ListExplainabilitiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListExplainabilities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListExplainabilities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListExplainabilitiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListExplainabilitiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListExplainabilities")
...
.with_interceptor(ListExplainabilitiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_explainabilities::ListExplainabilitiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_explainabilities::ListExplainabilitiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_explainabilities::ListExplainabilitiesError>::new());
...
#[derive(Debug)]
            struct ListExplainabilitiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListExplainabilitiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_explainabilities::de_list_explainabilities_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_explainabilities::de_list_explainabilities_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListExplainabilitiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListExplainabilitiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_explainabilities::ListExplainabilitiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_explainabilities::ListExplainabilitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_explainabilities::ser_list_explainabilities_input(&input)?);
...
#[derive(Debug)]
            struct ListExplainabilitiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListExplainabilitiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListExplainabilitiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListExplainabilitiesInput>()
                        .ok_or("failed to downcast to ListExplainabilitiesInput")?;
...
pub enum ListExplainabilitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListExplainabilitiesError) for what information is available for the error.")]
...
impl ListExplainabilitiesError {
    /// Creates the `ListExplainabilitiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListExplainabilitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListExplainabilitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_explainabilities::ListExplainabilitiesError {
...
mod _list_explainabilities_output;
