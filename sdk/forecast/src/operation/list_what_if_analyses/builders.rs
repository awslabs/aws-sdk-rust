...
impl ListWhatIfAnalysesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_what_if_analyses::ListWhatIfAnalysesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_what_if_analyses::ListWhatIfAnalysesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_what_if_analyses::ListWhatIfAnalysesOutput, crate::operation::list_what_if_analyses::ListWhatIfAnalysesError, Self> {
