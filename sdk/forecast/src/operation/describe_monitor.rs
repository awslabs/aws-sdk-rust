...
impl DescribeMonitorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_monitor::DescribeMonitor::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMonitor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_monitor::de_describe_monitor_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_monitor::DescribeMonitorError
{
