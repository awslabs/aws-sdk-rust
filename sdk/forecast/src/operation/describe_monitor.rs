...
impl DescribeMonitorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_monitor::DescribeMonitor, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_monitor::ser_describe_monitor_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMonitor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_monitor::de_describe_monitor_http_response_with_props(status, headers, body)
        }
    }
}
