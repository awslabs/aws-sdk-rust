...
impl ListPredictorBacktestExportJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPredictorBacktestExportJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_predictor_backtest_export_jobs::de_list_predictor_backtest_export_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
