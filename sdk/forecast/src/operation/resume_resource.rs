...
impl ResumeResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::resume_resource::ResumeResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resume_resource::ser_resume_resource_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resume_resource::de_resume_resource_http_response_with_props(status, headers, body)
        }
    }
}
