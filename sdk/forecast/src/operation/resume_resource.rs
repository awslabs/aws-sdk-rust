...
impl ResumeResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::resume_resource::ResumeResource,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resume_resource::ResumeResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resume_resource::de_resume_resource_http_error(
                status, headers, body,
            )
        } else {
