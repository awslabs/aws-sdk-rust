...
/// Orchestration and serialization glue logic for `ListWhatIfForecastExports`.
...
impl ListWhatIfForecastExports {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsInput,
                    ) -> ::std::result::Result<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListWhatIfForecastExports {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListWhatIfForecastExports");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListWhatIfForecastExportsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListWhatIfForecastExportsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWhatIfForecastExports")
...
.with_interceptor(ListWhatIfForecastExportsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsError>::new());
...
#[derive(Debug)]
            struct ListWhatIfForecastExportsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListWhatIfForecastExportsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_what_if_forecast_exports::de_list_what_if_forecast_exports_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListWhatIfForecastExportsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListWhatIfForecastExportsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_what_if_forecast_exports::ser_list_what_if_forecast_exports_input(&input)?);
...
#[derive(Debug)]
            struct ListWhatIfForecastExportsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListWhatIfForecastExportsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListWhatIfForecastExportsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListWhatIfForecastExportsInput>()
                        .ok_or("failed to downcast to ListWhatIfForecastExportsInput")?;
...
pub enum ListWhatIfForecastExportsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListWhatIfForecastExportsError) for what information is available for the error.")]
...
impl ListWhatIfForecastExportsError {
    /// Creates the `ListWhatIfForecastExportsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListWhatIfForecastExportsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListWhatIfForecastExportsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExportsError {
...
mod _list_what_if_forecast_exports_output;
