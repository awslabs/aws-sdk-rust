...
impl ListWhatIfForecastExportsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_what_if_forecast_exports::ListWhatIfForecastExports::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWhatIfForecastExports {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_what_if_forecast_exports::de_list_what_if_forecast_exports_http_response_with_props(
                status, headers, body,
            )
        }
    }
