...
impl DescribeForecastExportJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_forecast_export_job::DescribeForecastExportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeForecastExportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_forecast_export_job::de_describe_forecast_export_job_http_response_with_props(status, headers, body)
        }
    }
}
