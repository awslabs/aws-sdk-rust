...
impl CreateWhatIfForecastFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_what_if_forecast::CreateWhatIfForecastOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_what_if_forecast::CreateWhatIfForecastError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_what_if_forecast::CreateWhatIfForecastOutput, crate::operation::create_what_if_forecast::CreateWhatIfForecastError, Self> {
