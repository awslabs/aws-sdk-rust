...
impl DeleteResourceTreeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_resource_tree::ser_delete_resource_tree_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResourceTree {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_resource_tree::de_delete_resource_tree_http_response_with_props(status, headers, body)
        }
    }
}
