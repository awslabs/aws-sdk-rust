...
impl ListPredictorsFluentBuilder  {
    /// Creates a new `ListPredictors`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_predictors::ListPredictorsOutput, aws_smithy_http::result::SdkError<crate::operation::list_predictors::ListPredictorsError>>
                     {
