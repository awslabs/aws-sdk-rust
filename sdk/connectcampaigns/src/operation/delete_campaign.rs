...
impl DeleteCampaignInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_campaign::DeleteCampaign, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCampaign {
    type Output =
        ::std::result::Result<crate::operation::delete_campaign::DeleteCampaignOutput, crate::operation::delete_campaign::DeleteCampaignError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_campaign::de_delete_campaign_http_response_with_props(status, headers, body)
        }
    }
}
