    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/campaigns/{id}", id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_campaign::DeleteCampaign::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCampaign {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_campaign::de_delete_campaign_http_error(
                status, headers, body,
            )
        } else {
