...
impl ResumeCampaignFluentBuilder  {
    /// Creates a new `ResumeCampaign`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::resume_campaign::ResumeCampaignOutput, aws_smithy_http::result::SdkError<crate::operation::resume_campaign::ResumeCampaignError>>
                     {
