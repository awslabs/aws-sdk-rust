...
impl StopCampaignFluentBuilder  {
    /// Creates a new `StopCampaign`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::stop_campaign::StopCampaignOutput, aws_smithy_http::result::SdkError<crate::operation::stop_campaign::StopCampaignError>>
                     {
