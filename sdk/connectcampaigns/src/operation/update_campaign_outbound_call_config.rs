...
impl UpdateCampaignOutboundCallConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_campaign_outbound_call_config::UpdateCampaignOutboundCallConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_campaign_outbound_call_config::UpdateCampaignOutboundCallConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCampaignOutboundCallConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_campaign_outbound_call_config::de_update_campaign_outbound_call_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
