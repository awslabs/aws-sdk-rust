...
impl UpdateCampaignDialerConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_campaign_dialer_config::UpdateCampaignDialerConfig,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_campaign_dialer_config::UpdateCampaignDialerConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCampaignDialerConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_campaign_dialer_config::de_update_campaign_dialer_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
