...
impl GetConnectInstanceConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_connect_instance_config::GetConnectInstanceConfigInput, ::aws_smithy_types::error::operation::BuildError> {
