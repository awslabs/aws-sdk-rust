...
impl ListCampaignsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_campaigns::ListCampaigns::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCampaigns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_campaigns::de_list_campaigns_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_campaigns::de_list_campaigns_http_response_with_props(
                status, headers, body,
            )
        }
    }
