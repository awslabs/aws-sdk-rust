...
pub fn ser_dialer_config(
    ...
    match input {
        crate::types::DialerConfig::ProgressiveDialerConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_2.key("progressiveDialerConfig").start_object();
        ...
        crate::types::DialerConfig::PredictiveDialerConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_2.key("predictiveDialerConfig").start_object();
        ...
        crate::types::DialerConfig::AgentlessDialerConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_2.key("agentlessDialerConfig").start_object();
