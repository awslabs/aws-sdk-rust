...
pub fn ser_outbound_call_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutboundCallConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_outbound_call_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OutboundCallConfig>, aws_smithy_json::deserialize::error::DeserializeError>
