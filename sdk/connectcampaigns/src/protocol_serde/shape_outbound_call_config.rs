...
pub fn ser_outbound_call_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OutboundCallConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_outbound_call_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::OutboundCallConfig>, aws_smithy_json::deserialize::error::DeserializeError>
