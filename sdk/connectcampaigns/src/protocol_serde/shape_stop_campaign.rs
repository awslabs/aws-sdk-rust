...
pub fn de_stop_campaign_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::stop_campaign::StopCampaignOutput, crate::operation::stop_campaign::StopCampaignError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::stop_campaign::StopCampaignError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_campaign_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::stop_campaign::StopCampaignOutput, crate::operation::stop_campaign::StopCampaignError> {
    Ok({
        #[allow(unused_mut)]
