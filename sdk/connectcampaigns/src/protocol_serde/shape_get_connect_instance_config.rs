...
pub fn de_get_connect_instance_config_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_connect_instance_config::GetConnectInstanceConfigOutput, crate::operation::get_connect_instance_config::GetConnectInstanceConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_connect_instance_config::GetConnectInstanceConfigError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_connect_instance_config_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_connect_instance_config::GetConnectInstanceConfigOutput, crate::operation::get_connect_instance_config::GetConnectInstanceConfigError> {
    Ok({
        #[allow(unused_mut)]
