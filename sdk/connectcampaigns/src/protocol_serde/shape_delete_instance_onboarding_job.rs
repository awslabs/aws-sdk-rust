...
pub fn de_delete_instance_onboarding_job_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobOutput, crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::invalid_state_exception_correct_errors(output).build().map_err(crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_instance_onboarding_job_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobOutput, crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError> {
    Ok({
        #[allow(unused_mut)]
