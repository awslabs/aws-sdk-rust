...
pub fn de_delete_instance_onboarding_job_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobOutput, crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_instance_onboarding_job_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobOutput, crate::operation::delete_instance_onboarding_job::DeleteInstanceOnboardingJobError> {
    Ok({
        #[allow(unused_mut)]
