    ...
    Err(match error_code {
        "AccessDeniedException" => crate::error::DescribeCampaignError::AccessDeniedException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeCampaignError::unhandled)?;
        ...
        "InternalServerException" => {
            crate::error::DescribeCampaignError::InternalServerException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_server_exception::de_internal_server_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeCampaignError::unhandled)?;
                    output = output.set_x_amz_error_type(
        ...
        "ValidationException" => {
            crate::error::DescribeCampaignError::ValidationException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_validation_exception::de_validation_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeCampaignError::unhandled)?;
                    output = output.set_x_amz_error_type(
