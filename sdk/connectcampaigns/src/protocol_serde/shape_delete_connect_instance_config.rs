...
pub fn de_delete_connect_instance_config_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteConnectInstanceConfigOutput, crate::error::DeleteConnectInstanceConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteConnectInstanceConfigError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_connect_instance_config_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteConnectInstanceConfigOutput, crate::error::DeleteConnectInstanceConfigError> {
    Ok({
        #[allow(unused_mut)]
