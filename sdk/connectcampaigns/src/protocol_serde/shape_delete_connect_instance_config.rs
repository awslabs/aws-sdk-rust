...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_connect_instance_config_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigOutput, crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError> {
    Ok({
        #[allow(unused_mut)]
