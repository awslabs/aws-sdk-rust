...
pub fn de_delete_connect_instance_config_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigOutput, crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_connect_instance_config_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigOutput, crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError> {
    Ok({
        #[allow(unused_mut)]
