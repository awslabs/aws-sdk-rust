...
pub fn de_start_instance_onboarding_job_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobOutput, crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::conflict_exception_correct_errors(output).build().map_err(crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobError::unhandled)?
                }
            ;
            tmp
        }),
...
pub fn ser_start_instance_onboarding_job_input(input: &crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
