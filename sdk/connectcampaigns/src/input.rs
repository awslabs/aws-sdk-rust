...
impl PutDialRequestBatchInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_dial_request_batch::ser_put_dial_request_batch_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateCampaignNameInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_campaign_name::ser_update_campaign_name_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
