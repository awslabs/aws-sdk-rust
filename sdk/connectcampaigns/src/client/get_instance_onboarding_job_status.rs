...
impl super::Client {
    ...
    ///   - [`connect_instance_id(impl Into<String>)`](crate::operation::get_instance_onboarding_job_status::builders::GetInstanceOnboardingJobStatusFluentBuilder::connect_instance_id) / [`set_connect_instance_id(Option<String>)`](crate::operation::get_instance_onboarding_job_status::builders::GetInstanceOnboardingJobStatusFluentBuilder::set_connect_instance_id):<br>required: **true**<br>Amazon Connect Instance Id<br>
