...
impl super::Client {
    ...
    ///   - [`campaign_ids(impl Into<String>)`](crate::operation::get_campaign_state_batch::builders::GetCampaignStateBatchFluentBuilder::campaign_ids) / [`set_campaign_ids(Option<Vec<String>>)`](crate::operation::get_campaign_state_batch::builders::GetCampaignStateBatchFluentBuilder::set_campaign_ids): List of CampaignId
