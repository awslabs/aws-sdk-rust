...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::stop_campaign::builders::StopCampaignFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::stop_campaign::builders::StopCampaignFluentBuilder::set_id):<br>required: **true**<br>Identifier representing a Campaign<br>
