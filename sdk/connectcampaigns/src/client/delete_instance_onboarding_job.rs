...
impl super::Client {
    ...
    ///   - [`connect_instance_id(impl Into<String>)`](crate::operation::delete_instance_onboarding_job::builders::DeleteInstanceOnboardingJobFluentBuilder::connect_instance_id) / [`set_connect_instance_id(impl Into<String>)`](crate::operation::delete_instance_onboarding_job::builders::DeleteInstanceOnboardingJobFluentBuilder::set_connect_instance_id):<br>required: **true**<br>Amazon Connect Instance Id<br>
