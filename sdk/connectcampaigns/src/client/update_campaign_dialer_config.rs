...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_campaign_dialer_config::builders::UpdateCampaignDialerConfigFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_campaign_dialer_config::builders::UpdateCampaignDialerConfigFluentBuilder::set_id):<br>required: **true**<br>Identifier representing a Campaign<br>
    ///   - [`dialer_config(DialerConfig)`](crate::operation::update_campaign_dialer_config::builders::UpdateCampaignDialerConfigFluentBuilder::dialer_config) / [`set_dialer_config(Option<DialerConfig>)`](crate::operation::update_campaign_dialer_config::builders::UpdateCampaignDialerConfigFluentBuilder::set_dialer_config):<br>required: **true**<br>The possible types of dialer config parameters<br>
