...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::put_dial_request_batch::builders::PutDialRequestBatchFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::put_dial_request_batch::builders::PutDialRequestBatchFluentBuilder::set_id):<br>required: **true**<br>Identifier representing a Campaign<br>
    ///   - [`dial_requests(DialRequest)`](crate::operation::put_dial_request_batch::builders::PutDialRequestBatchFluentBuilder::dial_requests) / [`set_dial_requests(Option<Vec::<DialRequest>>)`](crate::operation::put_dial_request_batch::builders::PutDialRequestBatchFluentBuilder::set_dial_requests):<br>required: **true**<br>A list of dial requests.<br>
