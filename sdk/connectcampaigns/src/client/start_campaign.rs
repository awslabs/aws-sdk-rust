...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::start_campaign::builders::StartCampaignFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::start_campaign::builders::StartCampaignFluentBuilder::set_id):<br>required: **true**<br>Identifier representing a Campaign<br>
