...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::set_id): Identifier representing a Campaign
    ///   - [`connect_contact_flow_id(impl ::std::convert::Into<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::connect_contact_flow_id) / [`set_connect_contact_flow_id(Option<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::set_connect_contact_flow_id): The identifier of the contact flow for the outbound call.
    ///   - [`connect_source_phone_number(impl ::std::convert::Into<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::connect_source_phone_number) / [`set_connect_source_phone_number(Option<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::set_connect_source_phone_number): The phone number associated with the Amazon Connect instance, in E.164 format. If you do not specify a source phone number, you must specify a queue.
