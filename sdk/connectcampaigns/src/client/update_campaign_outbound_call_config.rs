...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::update_campaign_outbound_call_config::builders::UpdateCampaignOutboundCallConfigFluentBuilder::set_id):<br>required: **true**<br>Identifier representing a Campaign<br>
