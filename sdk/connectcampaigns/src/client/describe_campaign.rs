...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_campaign::builders::DescribeCampaignFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::describe_campaign::builders::DescribeCampaignFluentBuilder::set_id):<br>required: **true**<br>Identifier representing a Campaign<br>
