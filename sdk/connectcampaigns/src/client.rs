...
impl Client  {
    ...
    pub fn get_instance_onboarding_job_status(&self) -> fluent_builders::GetInstanceOnboardingJobStatus {
    ...
    pub fn update_campaign_outbound_call_config(&self) -> fluent_builders::UpdateCampaignOutboundCallConfig {
