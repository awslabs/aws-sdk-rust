...
impl  OutboundCallConfig  {
    ...
    pub fn connect_contact_flow_id(&self) -> & str {
        use std::ops::Deref; self.connect_contact_flow_id.deref()
    }
    /// The phone number associated with the Amazon Connect instance, in E.164 format. If you do not specify a source phone number, you must specify a queue.
        ...
        ::std::result::Result::Ok(
            crate::types::OutboundCallConfig {
                connect_contact_flow_id: self.connect_contact_flow_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("connect_contact_flow_id", "connect_contact_flow_id was not specified but it is required when building OutboundCallConfig")
                    )?
                ,
