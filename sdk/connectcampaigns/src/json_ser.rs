...
pub fn serialize_structure_crate_input_create_campaign_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCampaignInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_5) = &input.outbound_call_config {
        ...
        crate::json_ser::serialize_structure_crate_model_outbound_call_config(&mut object_6, var_5)?;
        object_6.finish();
    }
...
pub fn serialize_structure_crate_input_get_campaign_state_batch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCampaignStateBatchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_put_dial_request_batch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutDialRequestBatchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_20 in var_18 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dial_request(&mut object_21, item_20)?;
                object_21.finish();
            }
        }
        array_19.finish();
...
pub fn serialize_structure_crate_input_start_instance_onboarding_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartInstanceOnboardingJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_campaign_dialer_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCampaignDialerConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_campaign_name_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCampaignNameInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_campaign_outbound_call_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCampaignOutboundCallConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_31) = &input.answer_machine_detection_config {
        ...
        crate::json_ser::serialize_structure_crate_model_answer_machine_detection_config(&mut object_32, var_31)?;
        object_32.finish();
    }
    ...
    if let Some(var_34) = &input.connect_source_phone_number {
        object.key("connectSourcePhoneNumber").string(var_34.as_str());
    }
    Ok(())
}

pub fn serialize_union_crate_model_dialer_config(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DialerConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
        crate::model::DialerConfig::ProgressiveDialerConfig(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_progressive_dialer_config(&mut object_35, inner)?;
                object_35.finish();
            }
        },
        crate::model::DialerConfig::PredictiveDialerConfig(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_predictive_dialer_config(&mut object_36, inner)?;
                object_36.finish();
            }
        },
        crate::model::DialerConfig::Unknown => return Err(aws_smithy_http::operation::error::SerializationError::unknown_variant("DialerConfig"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_outbound_call_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutboundCallConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_38) = &input.connect_source_phone_number {
        object.key("connectSourcePhoneNumber").string(var_38.as_str());
    }
    ...
    if let Some(var_40) = &input.answer_machine_detection_config {
        ...
        crate::json_ser::serialize_structure_crate_model_answer_machine_detection_config(&mut object_41, var_40)?;
        object_41.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_campaign_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CampaignFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_42) = &input.instance_id_filter {
        #[allow(unused_mut)]
        let mut object_43 = object.key("instanceIdFilter").start_object();
        crate::json_ser::serialize_structure_crate_model_instance_id_filter(&mut object_43, var_42)?;
        object_43.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_dial_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DialRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_46) = &input.expiration_time {
        object.key("expirationTime").date_time(var_46, aws_smithy_types::date_time::Format::DateTime)?;
    }
...
pub fn serialize_structure_crate_model_progressive_dialer_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProgressiveDialerConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_54) = &input.bandwidth_allocation {
        object.key("bandwidthAllocation").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_54).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_predictive_dialer_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PredictiveDialerConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_55) = &input.bandwidth_allocation {
        object.key("bandwidthAllocation").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_55).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_instance_id_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceIdFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
