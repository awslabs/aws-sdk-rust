...
impl CreateMlModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_ml_model::CreateMLModel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_ml_model::ser_create_ml_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMLModel {
    type Output =
        ::std::result::Result<crate::operation::create_ml_model::CreateMlModelOutput, crate::operation::create_ml_model::CreateMLModelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_ml_model::de_create_ml_model_http_response_with_props(status, headers, body)
        }
    }
}
