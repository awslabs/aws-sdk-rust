...
impl UpdateDataSourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_data_source::UpdateDataSource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_data_source::de_update_data_source_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_data_source::UpdateDataSourceError
{
