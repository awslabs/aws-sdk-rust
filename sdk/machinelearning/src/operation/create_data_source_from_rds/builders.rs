...
impl CreateDataSourceFromRDSFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_data_source_from_rds::CreateDataSourceFromRdsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_data_source_from_rds::CreateDataSourceFromRDSError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_data_source_from_rds::CreateDataSourceFromRdsOutput, crate::operation::create_data_source_from_rds::CreateDataSourceFromRDSError, Self> {
