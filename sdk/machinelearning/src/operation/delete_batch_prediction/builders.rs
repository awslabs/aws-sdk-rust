...
impl DeleteBatchPredictionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_batch_prediction::DeleteBatchPredictionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_batch_prediction::DeleteBatchPredictionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_batch_prediction::DeleteBatchPredictionOutput, crate::operation::delete_batch_prediction::DeleteBatchPredictionError, Self> {
