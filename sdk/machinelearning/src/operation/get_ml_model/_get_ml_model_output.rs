...
pub struct GetMlModelOutput {
    ...
    /// <ul>
    /// <li>
    /// <p><code>PENDING</code> - Amazon Machine Learning (Amazon ML) submitted a request to describe a <code>MLModel</code>.</p></li>
    /// <li>
    /// <p><code>INPROGRESS</code> - The request is processing.</p></li>
    /// <li>
    /// <p><code>FAILED</code> - The request did not run to completion. The ML model isn't usable.</p></li>
    /// <li>
    /// <p><code>COMPLETED</code> - The request completed successfully.</p></li>
    /// <li>
    ...
    /// <ul>
    /// <li>
    /// <p>REGRESSION -- Produces a numeric result. For example, "What price should a house be listed at?"</p></li>
    /// <li>
    /// <p>BINARY -- Produces one of two possible results. For example, "Is this an e-commerce website?"</p></li>
    /// <li>
    /// <p>MULTICLASS -- Produces one of several possible results. For example, "Is this a HIGH, LOW or MEDIUM risk trade?"</p></li>
    /// </ul>
...
impl GetMlModelOutput {
    /// Creates a new builder-style object to manufacture [`GetMlModelOutput`](crate::operation::get_ml_model::GetMlModelOutput).
    pub fn builder() -> crate::operation::get_ml_model::builders::GetMlModelOutputBuilder {
        crate::operation::get_ml_model::builders::GetMlModelOutputBuilder::default()
    }
}
...
impl GetMlModelOutputBuilder {
    ...
    pub fn score_threshold_last_updated_at(mut self, input: ::aws_smithy_types::DateTime) -> Self {
        self.score_threshold_last_updated_at = ::std::option::Option::Some(input);
        self
    }
    /// <p>The time of the most recent edit to the <code>ScoreThreshold</code>. The time is expressed in epoch time.</p>
    ...
    /// Consumes the builder and constructs a [`GetMlModelOutput`](crate::operation::get_ml_model::GetMlModelOutput).
    pub fn build(self) -> crate::operation::get_ml_model::GetMlModelOutput {
