...
/// Paginator for [`DescribeMLModels`](crate::operation::describe_ml_models::DescribeMLModels)
            ...
            impl DescribeMlModelsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_ml_models::DescribeMlModelsOutput, aws_smithy_http::result::SdkError<crate::operation::describe_ml_models::DescribeMLModelsError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeMlModelsPaginator`
                ...
                impl  DescribeMlModelsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::MlModel, aws_smithy_http::result::SdkError<crate::operation::describe_ml_models::DescribeMLModelsError>>> + Unpin
                     {
