...
impl DescribeBatchPredictionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_batch_predictions::DescribeBatchPredictionsInput, ::aws_smithy_types::error::operation::BuildError> {
