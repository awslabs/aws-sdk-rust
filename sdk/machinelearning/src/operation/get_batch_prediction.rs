...
impl GetBatchPredictionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_batch_prediction::ser_get_batch_prediction_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBatchPrediction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_batch_prediction::de_get_batch_prediction_http_response_with_props(status, headers, body)
        }
    }
}
