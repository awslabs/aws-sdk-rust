...
impl GetBatchPredictionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_batch_prediction::ser_get_batch_prediction_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_batch_prediction::GetBatchPrediction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_batch_prediction::GetBatchPredictionError
{
