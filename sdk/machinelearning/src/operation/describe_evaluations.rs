...
impl DescribeEvaluations {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Machine Learning.DescribeEvaluations",
            "rpc.service" = "Machine Learning",
            "rpc.method" = "DescribeEvaluations",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeEvaluations")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeEvaluationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_evaluations::de_describe_evaluations_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_evaluations::de_describe_evaluations_http_response(status, headers, body, _cfg)
        };
