...
impl DescribeDataSourcesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_data_sources::ser_describe_data_sources_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_data_sources::DescribeDataSources::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_data_sources::DescribeDataSourcesError
{
