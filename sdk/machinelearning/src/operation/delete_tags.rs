...
impl DeleteTags {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Machine Learning", "DeleteTags", input, runtime_plugins, stop_point).await
    }
