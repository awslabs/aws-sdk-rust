...
impl UpdateMlModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_ml_model::UpdateMLModel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_ml_model::ser_update_ml_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMLModel {
    type Output =
        ::std::result::Result<crate::operation::update_ml_model::UpdateMlModelOutput, crate::operation::update_ml_model::UpdateMLModelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_ml_model::de_update_ml_model_http_response_with_props(status, headers, body)
        }
    }
}
