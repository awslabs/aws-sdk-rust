...
impl PredictFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::predict::PredictOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::predict::PredictError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
