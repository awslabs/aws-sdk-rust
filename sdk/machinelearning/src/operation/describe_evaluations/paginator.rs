...
/// Paginator for [`DescribeEvaluations`](crate::operation::describe_evaluations::DescribeEvaluations)
            ...
            impl DescribeEvaluationsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_evaluations::DescribeEvaluationsOutput, aws_smithy_http::result::SdkError<crate::operation::describe_evaluations::DescribeEvaluationsError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeEvaluationsPaginator`
                ...
                impl  DescribeEvaluationsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::Evaluation, aws_smithy_http::result::SdkError<crate::operation::describe_evaluations::DescribeEvaluationsError>>> + Unpin
                     {
