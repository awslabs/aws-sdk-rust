...
impl UpdateBatchPredictionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_batch_prediction::UpdateBatchPredictionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_batch_prediction::UpdateBatchPredictionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_batch_prediction::UpdateBatchPredictionOutput, crate::operation::update_batch_prediction::UpdateBatchPredictionError, Self> {
