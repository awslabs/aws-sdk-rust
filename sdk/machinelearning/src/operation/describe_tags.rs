...
impl DescribeTagsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_tags::ser_describe_tags_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_tags::DescribeTags::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTags", "machinelearning"));
