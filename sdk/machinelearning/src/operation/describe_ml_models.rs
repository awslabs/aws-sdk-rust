...
impl DescribeMlModelsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_ml_models::ser_describe_ml_models_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMLModels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_ml_models::de_describe_ml_models_http_response_with_props(status, headers, body)
        }
    }
}
