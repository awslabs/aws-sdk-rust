...
/// Orchestration and serialization glue logic for `CreateDataSourceFromRedshift`.
...
impl CreateDataSourceFromRedshift {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDataSourceFromRedshift {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateDataSourceFromRedshift");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateDataSourceFromRedshiftRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateDataSourceFromRedshiftResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDataSourceFromRedshift")
...
.with_interceptor(CreateDataSourceFromRedshiftEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError>::new());
...
#[derive(Debug)]
            struct CreateDataSourceFromRedshiftResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDataSourceFromRedshiftResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_data_source_from_redshift::de_create_data_source_from_redshift_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateDataSourceFromRedshiftRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDataSourceFromRedshiftRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_data_source_from_redshift::ser_create_data_source_from_redshift_input(&input)?);
...
#[derive(Debug)]
            struct CreateDataSourceFromRedshiftEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDataSourceFromRedshiftEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateDataSourceFromRedshiftEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateDataSourceFromRedshiftInput>()
                        .ok_or("failed to downcast to CreateDataSourceFromRedshiftInput")?;
...
pub enum CreateDataSourceFromRedshiftError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateDataSourceFromRedshiftError) for what information is available for the error.")]
...
impl CreateDataSourceFromRedshiftError {
    /// Creates the `CreateDataSourceFromRedshiftError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDataSourceFromRedshiftError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateDataSourceFromRedshiftError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError {
...
mod _create_data_source_from_redshift_output;
