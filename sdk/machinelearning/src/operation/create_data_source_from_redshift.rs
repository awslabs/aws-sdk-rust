...
impl CreateDataSourceFromRedshiftInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshift::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataSourceFromRedshift {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_data_source_from_redshift::de_create_data_source_from_redshift_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateDataSourceFromRedshiftError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_data_source_from_redshift::CreateDataSourceFromRedshiftError
{
