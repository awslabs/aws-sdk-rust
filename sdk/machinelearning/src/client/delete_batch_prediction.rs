...
impl super::Client {
    ...
    ///   - [`batch_prediction_id(impl Into<String>)`](crate::operation::delete_batch_prediction::builders::DeleteBatchPredictionFluentBuilder::batch_prediction_id) / [`set_batch_prediction_id(Option<String>)`](crate::operation::delete_batch_prediction::builders::DeleteBatchPredictionFluentBuilder::set_batch_prediction_id):<br>required: **true**<br><p>A user-supplied ID that uniquely identifies the <code>BatchPrediction</code>.</p><br>
