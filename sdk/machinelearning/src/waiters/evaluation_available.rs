...
///
/// Fluent builder for the `evaluation_available` waiter.
///
...
pub struct EvaluationAvailableFluentBuilder {
...
impl EvaluationAvailableFluentBuilder {
    /// Creates a new `EvaluationAvailableFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::evaluation_available::EvaluationAvailableFinalPoll,
        crate::waiters::evaluation_available::WaitUntilEvaluationAvailableError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_evaluations_147c4749b8435ead2(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Results[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_evaluations_772ab1725e6b52e57(result) {
        ...
        let operation = move || {
            ...
            async move { crate::operation::describe_evaluations::DescribeEvaluations::orchestrate(&runtime_plugins, input).await }
        };
...
/// Successful return type for the `evaluation_available` waiter.
pub type EvaluationAvailableFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_evaluations::DescribeEvaluationsOutput,
...
/// Error type for the `evaluation_available` waiter.
pub type WaitUntilEvaluationAvailableError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_evaluations::DescribeEvaluationsOutput,
    crate::operation::describe_evaluations::DescribeEvaluationsError,
>;
