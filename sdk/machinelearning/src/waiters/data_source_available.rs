...
///
/// Fluent builder for the `data_source_available` waiter.
///
...
pub struct DataSourceAvailableFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_data_sources::builders::DescribeDataSourcesInputBuilder,
}
impl DataSourceAvailableFluentBuilder {
    /// Creates a new `DataSourceAvailableFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::data_source_available::DataSourceAvailableFinalPoll,
        crate::waiters::data_source_available::WaitUntilDataSourceAvailableError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_data_sources_147c4749b8435ead2(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Results[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_data_sources_772ab1725e6b52e57(result) {
        ...
        let operation = move || {
            ...
            async move { crate::operation::describe_data_sources::DescribeDataSources::orchestrate(&runtime_plugins, input).await }
        };
...
/// Successful return type for the `data_source_available` waiter.
pub type DataSourceAvailableFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_data_sources::DescribeDataSourcesOutput,
...
/// Error type for the `data_source_available` waiter.
pub type WaitUntilDataSourceAvailableError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_data_sources::DescribeDataSourcesOutput,
    crate::operation::describe_data_sources::DescribeDataSourcesError,
>;
