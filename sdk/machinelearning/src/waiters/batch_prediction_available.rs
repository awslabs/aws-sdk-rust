...
///
/// Fluent builder for the `batch_prediction_available` waiter.
///
...
pub struct BatchPredictionAvailableFluentBuilder {
...
impl BatchPredictionAvailableFluentBuilder {
    /// Creates a new `BatchPredictionAvailableFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::batch_prediction_available::BatchPredictionAvailableFinalPoll,
        crate::waiters::batch_prediction_available::WaitUntilBatchPredictionAvailableError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_batch_predictions_147c4749b8435ead2(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Results[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_batch_predictions_772ab1725e6b52e57(result) {
        ...
        let operation = move || {
            ...
            async move { crate::operation::describe_batch_predictions::DescribeBatchPredictions::orchestrate(&runtime_plugins, input).await }
        };
...
pub type BatchPredictionAvailableFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_batch_predictions::DescribeBatchPredictionsOutput,
...
/// Error type for the `batch_prediction_available` waiter.
pub type WaitUntilBatchPredictionAvailableError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_batch_predictions::DescribeBatchPredictionsOutput,
    crate::operation::describe_batch_predictions::DescribeBatchPredictionsError,
>;
