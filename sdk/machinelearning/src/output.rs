...
pub struct PredictOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub prediction: std::option::Option<crate::model::Prediction>,
}
impl PredictOutput {
    /// <p>The output from a <code>Predict</code> operation: </p> 
    /// <ul> 
...
pub mod predict_output {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>PredictedValue</code> - Present for a <code>REGRESSION</code> <code>MLModel</code> request. </p> </li> 
        /// </ul>
        pub fn set_prediction(mut self, input: std::option::Option<crate::model::Prediction>) -> Self {
...
pub struct GetDataSourceOutput  {
    ...
    /// <p> <b>Note:</b> This parameter is provided as part of the verbose format.</p>
    #[doc(hidden)]pub data_source_schema: std::option::Option<std::string::String>,
}
...
pub struct DescribeMlModelsOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::MlModel>>,
...
pub mod describe_ml_models_output {
    ...
    impl Builder {
        ...
        /// <p>A list of <code>MLModel</code> that meet the search criteria.</p>
        pub fn set_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::MlModel>>) -> Self {
...
pub struct DescribeEvaluationsOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::Evaluation>>,
    /// <p>The ID of the next page in the paginated results that indicates at least one more page follows.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod describe_evaluations_output {
    ...
    impl Builder {
        ...
        /// <p>A list of <code>Evaluation</code> that meet the search criteria. </p>
        pub fn set_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::Evaluation>>) -> Self {
            self.results = input; self
        }
        /// <p>The ID of the next page in the paginated results that indicates at least one more page follows.</p>
        pub fn next_token(mut self, input: impl Into<std::string::String>) -> Self {
...
pub struct DescribeDataSourcesOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::DataSource>>,
...
pub mod describe_data_sources_output {
    ...
    impl Builder {
        ...
        /// <p>A list of <code>DataSource</code> that meet the search criteria. </p>
        pub fn set_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::DataSource>>) -> Self {
            self.results = input; self
        }
        /// <p>An ID of the next page in the paginated results that indicates at least one more page follows.</p>
        pub fn next_token(mut self, input: impl Into<std::string::String>) -> Self {
...
pub struct DescribeBatchPredictionsOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::BatchPrediction>>,
    /// <p>The ID of the next page in the paginated results that indicates at least one more page follows.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod describe_batch_predictions_output {
    ...
    impl Builder {
        ...
        /// <p>A list of <code>BatchPrediction</code> objects that meet the search criteria. </p>
        pub fn set_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::BatchPrediction>>) -> Self {
            self.results = input; self
        }
        /// <p>The ID of the next page in the paginated results that indicates at least one more page follows.</p>
        pub fn next_token(mut self, input: impl Into<std::string::String>) -> Self {
...
pub struct DeleteRealtimeEndpointOutput  {
    ...
    #[doc(hidden)]pub realtime_endpoint_info: std::option::Option<crate::model::RealtimeEndpointInfo>,
}
impl DeleteRealtimeEndpointOutput {
    ...
    /// <p>The endpoint information of the <code>MLModel</code> </p>
    pub fn realtime_endpoint_info(&self) -> std::option::Option<& crate::model::RealtimeEndpointInfo> {
...
pub mod delete_realtime_endpoint_output {
    ...
    impl Builder {
        ...
        /// <p>The endpoint information of the <code>MLModel</code> </p>
        pub fn set_realtime_endpoint_info(mut self, input: std::option::Option<crate::model::RealtimeEndpointInfo>) -> Self {
