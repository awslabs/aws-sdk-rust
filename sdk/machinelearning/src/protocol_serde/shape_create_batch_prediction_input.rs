...
pub fn ser_create_batch_prediction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBatchPredictionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
