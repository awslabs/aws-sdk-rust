...
pub fn ser_describe_batch_predictions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_batch_predictions::DescribeBatchPredictionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
