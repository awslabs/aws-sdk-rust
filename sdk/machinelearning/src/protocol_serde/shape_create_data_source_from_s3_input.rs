...
pub fn ser_create_data_source_from_s3_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDataSourceFromS3Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
