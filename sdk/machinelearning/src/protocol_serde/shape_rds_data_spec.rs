...
pub fn ser_rds_data_spec(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RdsDataSpec) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
