...
pub fn ser_create_data_source_from_redshift_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDataSourceFromRedshiftInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
