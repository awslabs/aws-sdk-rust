...
pub fn ser_h264_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::H264Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_h264_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::H264Settings>, aws_smithy_json::deserialize::error::DeserializeError>
