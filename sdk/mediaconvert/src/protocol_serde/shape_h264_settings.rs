...
pub fn ser_h264_settings(
    ...
    if let Some(var_10) = &input.field_encoding {
        object.key("fieldEncoding").string(var_10.as_str());
    }
    ...
    if let Some(var_14) = &input.framerate_denominator {
        object.key("framerateDenominator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
    if let Some(var_15) = &input.framerate_numerator {
        object.key("framerateNumerator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    ...
    if let Some(var_17) = &input.gop_closed_cadence {
        object.key("gopClosedCadence").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
    if let Some(var_18) = &input.gop_size {
        object.key("gopSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_18).into()));
    }
    ...
    if let Some(var_20) = &input.hrd_buffer_final_fill_percentage {
        object.key("hrdBufferFinalFillPercentage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.hrd_buffer_initial_fill_percentage {
        object.key("hrdBufferInitialFillPercentage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    if let Some(var_22) = &input.hrd_buffer_size {
        object.key("hrdBufferSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_22).into()));
    }
    if let Some(var_23) = &input.interlace_mode {
        object.key("interlaceMode").string(var_23.as_str());
    }
    if let Some(var_24) = &input.max_bitrate {
        object.key("maxBitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_24).into()));
    }
    if let Some(var_25) = &input.min_i_interval {
        object.key("minIInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    if let Some(var_26) = &input.number_b_frames_between_reference_frames {
        object.key("numberBFramesBetweenReferenceFrames").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    if let Some(var_27) = &input.number_reference_frames {
        object.key("numberReferenceFrames").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_27).into()));
    }
    ...
    if let Some(var_38) = &input.slices {
        object.key("slices").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_38).into()));
    }
    if let Some(var_39) = &input.slow_pal {
        object.key("slowPal").string(var_39.as_str());
    }
    if let Some(var_40) = &input.softness {
        object.key("softness").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_40).into()));
    }
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "endOfStreamMarkers" => {
                                builder = builder.set_end_of_stream_markers(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::H264EndOfStreamMarkers::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
