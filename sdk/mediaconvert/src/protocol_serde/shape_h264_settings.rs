...
pub fn ser_h264_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::H264Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_17) = &input.qvbr_settings {
        ...
        crate::protocol_serde::shape_h264_qvbr_settings::ser_h264_qvbr_settings(&mut object_18, var_17)?;
        object_18.finish();
    }
    ...
    if let Some(var_24) = &input.spatial_adaptive_quantization {
        object.key("spatialAdaptiveQuantization").string(var_24.as_str());
    }
    ...
    if let Some(var_27) = &input.temporal_adaptive_quantization {
        object.key("temporalAdaptiveQuantization").string(var_27.as_str());
    }
    if let Some(var_28) = &input.unregistered_sei_timecode {
        object.key("unregisteredSeiTimecode").string(var_28.as_str());
    }
    Ok(())
}
