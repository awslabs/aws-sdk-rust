...
pub fn ser_av1_qvbr_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Av1QvbrSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_av1_qvbr_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Av1QvbrSettings>, aws_smithy_json::deserialize::error::DeserializeError>
