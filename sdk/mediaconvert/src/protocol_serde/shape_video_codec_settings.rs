...
pub fn ser_video_codec_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VideoCodecSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_video_codec_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VideoCodecSettings>, aws_smithy_json::deserialize::error::DeserializeError>
