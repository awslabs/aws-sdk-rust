...
pub(crate) fn de_video_codec_settings<'a, I>(
    ...
    Option<crate::model::VideoCodecSettings>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "av1Settings" => {
                                builder = builder.set_av1_settings(
                                    crate::protocol_serde::shape_av1_settings::de_av1_settings(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "vc3Settings" => {
                                builder = builder.set_vc3_settings(
                                    crate::protocol_serde::shape_vc3_settings::de_vc3_settings(
                                        tokens,
                                    )?,
                                );
                            }
                            "vp8Settings" => {
                                builder = builder.set_vp8_settings(
                                    crate::protocol_serde::shape_vp8_settings::de_vp8_settings(
                                        tokens,
                                    )?,
                                );
                            }
                            "vp9Settings" => {
                                builder = builder.set_vp9_settings(
                                    crate::protocol_serde::shape_vp9_settings::de_vp9_settings(
                                        tokens,
                                    )?,
                                );
                            }
