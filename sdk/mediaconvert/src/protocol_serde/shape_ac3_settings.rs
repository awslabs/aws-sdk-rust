...
pub fn ser_ac3_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Ac3Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.bitrate != 0 {
    ...
    if let Some(var_3) = &input.dynamic_range_compression_line {
        object.key("dynamicRangeCompressionLine").string(var_3.as_str());
    }
    if let Some(var_4) = &input.dynamic_range_compression_profile {
        object.key("dynamicRangeCompressionProfile").string(var_4.as_str());
    }
    if let Some(var_5) = &input.dynamic_range_compression_rf {
        object.key("dynamicRangeCompressionRf").string(var_5.as_str());
    }
...
pub(crate) fn de_ac3_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Ac3Settings>, aws_smithy_json::deserialize::error::DeserializeError>
