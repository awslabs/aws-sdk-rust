...
pub fn ser_kantar_watermark_settings(
    ...
    if let Some(var_4) = &input.file_offset {
        object.key("fileOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_4).into()));
    }
    if let Some(var_5) = &input.kantar_license_id {
        object.key("kantarLicenseId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
