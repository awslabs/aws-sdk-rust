...
pub fn ser_kantar_watermark_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KantarWatermarkSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_kantar_watermark_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KantarWatermarkSettings>, aws_smithy_json::deserialize::error::DeserializeError>
