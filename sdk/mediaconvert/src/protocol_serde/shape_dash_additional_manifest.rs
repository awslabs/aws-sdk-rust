...
pub(crate) fn de_dash_additional_manifest<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DashAdditionalManifest>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
