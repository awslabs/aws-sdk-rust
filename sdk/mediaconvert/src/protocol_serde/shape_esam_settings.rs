...
pub fn ser_esam_settings(
    ...
    if let Some(var_1) = &input.manifest_confirm_condition_notification {
        ...
        crate::protocol_serde::shape_esam_manifest_confirm_condition_notification::ser_esam_manifest_confirm_condition_notification(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "manifestConfirmConditionNotification" => {
                            builder = builder.set_manifest_confirm_condition_notification(
                                    crate::protocol_serde::shape_esam_manifest_confirm_condition_notification::de_esam_manifest_confirm_condition_notification(tokens, _value, depth + 1)?
                                );
                        }
