...
pub fn ser_esam_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EsamSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_esam_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EsamSettings>, aws_smithy_json::deserialize::error::DeserializeError>
