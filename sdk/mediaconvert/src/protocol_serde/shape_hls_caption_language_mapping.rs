...
pub(crate) fn de_hls_caption_language_mapping<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::HlsCaptionLanguageMapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
