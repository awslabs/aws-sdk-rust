...
pub fn ser_caption_source_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CaptionSourceSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_caption_source_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CaptionSourceSettings>, aws_smithy_json::deserialize::error::DeserializeError>
