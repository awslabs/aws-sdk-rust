...
pub fn ser_caption_source_settings(
    ...
    if let Some(var_7) = &input.file_source_settings {
        ...
        crate::protocol_serde::shape_file_source_settings::ser_file_source_settings(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
    ...
    if let Some(var_12) = &input.track_source_settings {
        ...
        crate::protocol_serde::shape_track_source_settings::ser_track_source_settings(
            &mut object_13,
            var_12,
        )?;
        object_13.finish();
    ...
    if let Some(var_14) = &input.webvtt_hls_source_settings {
        ...
        crate::protocol_serde::shape_webvtt_hls_source_settings::ser_webvtt_hls_source_settings(
            &mut object_15,
            var_14,
        )?;
        object_15.finish();
...
pub(crate) fn de_caption_source_settings<'a, I>(
    ...
    Option<crate::types::CaptionSourceSettings>,
