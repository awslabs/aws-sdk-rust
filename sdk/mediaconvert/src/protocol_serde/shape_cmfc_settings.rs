...
pub(crate) fn de_cmfc_settings<'a, I>(
    ...
    Option<crate::types::CmfcSettings>,
                        ...
                        .as_ref()
                    {
                        ...
                        "audioTrackType" => {
                            builder = builder.set_audio_track_type(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::CmfcAudioTrackType::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                            ...
                            builder = builder.set_descriptive_video_service_flag(
                                ...
                                .map(|s| {
                                    s.to_unescaped().map(|u| {
                                        crate::types::CmfcDescriptiveVideoServiceFlag::from(
                                            u.as_ref(),
                                        )
                                    })
                                })
                        ...
                        "klvMetadata" => {
                            builder = builder.set_klv_metadata(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::CmfcKlvMetadata::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        "manifestMetadataSignaling" => {
                            builder = builder.set_manifest_metadata_signaling(
                                ...
                                .map(|s| {
                                    s.to_unescaped().map(|u| {
                                        crate::types::CmfcManifestMetadataSignaling::from(
                                            u.as_ref(),
                                        )
                                    })
                                })
                        ...
                        "scte35Esam" => {
                            builder = builder.set_scte35_esam(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::CmfcScte35Esam::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        "scte35Source" => {
                            builder = builder.set_scte35_source(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::CmfcScte35Source::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        "timedMetadata" => {
                            builder = builder.set_timed_metadata(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::CmfcTimedMetadata::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
