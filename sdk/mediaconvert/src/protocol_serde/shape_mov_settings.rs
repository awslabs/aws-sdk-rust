...
pub fn ser_mov_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MovSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_mov_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MovSettings>, aws_smithy_json::deserialize::error::DeserializeError>
