...
pub fn ser_opus_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpusSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.bitrate != 0 {
...
pub(crate) fn de_opus_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OpusSettings>, aws_smithy_json::deserialize::error::DeserializeError>
