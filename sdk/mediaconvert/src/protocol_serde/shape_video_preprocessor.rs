...
pub fn ser_video_preprocessor(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VideoPreprocessor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_video_preprocessor<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VideoPreprocessor>, aws_smithy_json::deserialize::error::DeserializeError>
