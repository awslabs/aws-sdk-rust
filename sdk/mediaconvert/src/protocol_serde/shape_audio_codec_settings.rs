...
pub fn ser_audio_codec_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AudioCodecSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_audio_codec_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AudioCodecSettings>, aws_smithy_json::deserialize::error::DeserializeError>
