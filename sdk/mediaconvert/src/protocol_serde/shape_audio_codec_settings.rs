            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "aacSettings" => {
                            builder =
                                builder.set_aac_settings(crate::protocol_serde::shape_aac_settings::de_aac_settings(tokens, _value, depth + 1)?);
                        }
                        "ac3Settings" => {
                            builder =
                                builder.set_ac3_settings(crate::protocol_serde::shape_ac3_settings::de_ac3_settings(tokens, _value, depth + 1)?);
                        }
                        "ac4Settings" => {
                            builder =
                                builder.set_ac4_settings(crate::protocol_serde::shape_ac4_settings::de_ac4_settings(tokens, _value, depth + 1)?);
                        }
                        "aiffSettings" => {
                            builder =
                                builder.set_aiff_settings(crate::protocol_serde::shape_aiff_settings::de_aiff_settings(tokens, _value, depth + 1)?);
                        }
                        "codec" => {
                        ...
                        "eac3AtmosSettings" => {
                            builder = builder.set_eac3_atmos_settings(crate::protocol_serde::shape_eac3_atmos_settings::de_eac3_atmos_settings(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "eac3Settings" => {
                            builder =
                                builder.set_eac3_settings(crate::protocol_serde::shape_eac3_settings::de_eac3_settings(tokens, _value, depth + 1)?);
                        }
                        "flacSettings" => {
                            builder =
                                builder.set_flac_settings(crate::protocol_serde::shape_flac_settings::de_flac_settings(tokens, _value, depth + 1)?);
                        }
                        "mp2Settings" => {
                            builder =
                                builder.set_mp2_settings(crate::protocol_serde::shape_mp2_settings::de_mp2_settings(tokens, _value, depth + 1)?);
                        }
                        "mp3Settings" => {
                            builder =
                                builder.set_mp3_settings(crate::protocol_serde::shape_mp3_settings::de_mp3_settings(tokens, _value, depth + 1)?);
                        }
                        "opusSettings" => {
                            builder =
                                builder.set_opus_settings(crate::protocol_serde::shape_opus_settings::de_opus_settings(tokens, _value, depth + 1)?);
                        }
                        "vorbisSettings" => {
                            builder = builder.set_vorbis_settings(crate::protocol_serde::shape_vorbis_settings::de_vorbis_settings(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "wavSettings" => {
                            builder =
                                builder.set_wav_settings(crate::protocol_serde::shape_wav_settings::de_wav_settings(tokens, _value, depth + 1)?);
                        }
