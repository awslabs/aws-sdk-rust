...
pub fn de_get_preset_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_preset::GetPresetOutput, crate::operation::get_preset::GetPresetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_preset::GetPresetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_preset_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_preset::GetPresetOutput, crate::operation::get_preset::GetPresetError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_preset::builders::GetPresetOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_preset::de_get_preset(response.body().as_ref(), output).map_err(crate::operation::get_preset::GetPresetError::unhandled)?;
