...
pub fn de_get_preset_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_preset::GetPresetOutput, crate::operation::get_preset::GetPresetError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => crate::operation::get_preset::GetPresetError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::get_preset::builders::GetPresetOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
