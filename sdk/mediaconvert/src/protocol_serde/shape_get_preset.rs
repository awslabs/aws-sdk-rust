...
pub fn de_get_preset_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetPresetOutput, crate::error::GetPresetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetPresetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_preset_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetPresetOutput, crate::error::GetPresetError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_preset_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_preset::de_get_preset(response.body().as_ref(), output).map_err(crate::error::GetPresetError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_preset(value: &[u8], mut builder: crate::output::get_preset_output::Builder) -> Result<crate::output::get_preset_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
