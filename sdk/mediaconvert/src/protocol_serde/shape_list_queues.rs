...
pub fn de_list_queues_http_error(
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => crate::operation::list_queues::ListQueuesError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "queues" => {
                    builder = builder.set_queues(crate::protocol_serde::shape_list_of_queue::de_list_of_queue(tokens, _value, depth + 1)?);
                }
                "totalConcurrentJobs" => {
