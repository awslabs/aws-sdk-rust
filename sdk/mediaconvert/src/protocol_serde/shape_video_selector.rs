...
pub fn ser_video_selector(
    ...
    if let Some(var_7) = &input.max_luminance {
        object.key("maxLuminance").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.pad_video {
        object.key("padVideo").string(var_8.as_str());
    }
    if let Some(var_9) = &input.pid {
        object.key("pid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.program_number {
        object.key("programNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
