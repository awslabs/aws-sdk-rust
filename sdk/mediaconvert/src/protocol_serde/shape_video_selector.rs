...
pub fn ser_video_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VideoSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_video_selector<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VideoSelector>, aws_smithy_json::deserialize::error::DeserializeError>
