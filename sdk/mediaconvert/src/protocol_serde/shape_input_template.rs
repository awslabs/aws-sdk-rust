...
pub fn ser_input_template(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InputTemplate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_input_template<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InputTemplate>, aws_smithy_json::deserialize::error::DeserializeError>
