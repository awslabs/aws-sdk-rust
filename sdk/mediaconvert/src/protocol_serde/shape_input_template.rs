...
pub fn ser_input_template(
    ...
    if let Some(var_25) = &input.filter_strength {
        object.key("filterStrength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    ...
    if let Some(var_35) = &input.program_number {
        object.key("programNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_35).into()));
    }
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_advanced_input_filter(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AdvancedInputFilter::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "audioSelectors" => {
                                builder = builder.set_audio_selectors(
                                    crate::protocol_serde::shape_map_of_audio_selector::de_map_of_audio_selector(tokens)?
                                );
                            }
                            "captionSelectors" => {
                                builder = builder.set_caption_selectors(
                                    crate::protocol_serde::shape_map_of_caption_selector::de_map_of_caption_selector(tokens)?
                                );
                            }
                            "crop" => {
                            ...
                            "inputClippings" => {
                                builder = builder.set_input_clippings(
                                    crate::protocol_serde::shape_list_of_input_clipping::de_list_of_input_clipping(tokens)?
                                );
                            }
                            "inputScanType" => {
                            ...
                            "videoOverlays" => {
                                builder = builder.set_video_overlays(
                                    crate::protocol_serde::shape_list_of_video_overlay::de_list_of_video_overlay(tokens)?
                                );
                            }
                            "videoSelector" => {
