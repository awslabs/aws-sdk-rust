...
pub fn ser_update_queue_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateQueueInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
