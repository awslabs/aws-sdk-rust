...
pub fn ser_m3u8_settings(
    ...
    if let Some(var_2) = &input.audio_frames_per_pes {
        object.key("audioFramesPerPes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    ...
    if let Some(var_7) = &input.max_pcr_interval {
        object.key("maxPcrInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.nielsen_id3 {
        object.key("nielsenId3").string(var_8.as_str());
    }
    if let Some(var_9) = &input.pat_interval {
        object.key("patInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.pcr_control {
        object.key("pcrControl").string(var_10.as_str());
    }
    if let Some(var_11) = &input.pcr_pid {
        object.key("pcrPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    if let Some(var_12) = &input.pmt_interval {
        object.key("pmtInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
    if let Some(var_13) = &input.pmt_pid {
        object.key("pmtPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.private_metadata_pid {
        object.key("privateMetadataPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
    if let Some(var_15) = &input.program_number {
        object.key("programNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    if let Some(var_16) = &input.pts_offset {
        object.key("ptsOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    if let Some(var_17) = &input.pts_offset_mode {
        object.key("ptsOffsetMode").string(var_17.as_str());
    }
    if let Some(var_18) = &input.scte35_pid {
        object.key("scte35Pid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_18).into()));
    }
    ...
    if let Some(var_21) = &input.timed_metadata_pid {
        object.key("timedMetadataPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    if let Some(var_22) = &input.transport_stream_id {
        object.key("transportStreamId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_22).into()));
    }
    if let Some(var_23) = &input.video_pid {
        object.key("videoPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_23).into()));
    }
    Ok(())
}
