...
pub(crate) fn de_mp4_settings<'a, I>(
    ...
    Option<crate::types::Mp4Settings>,
                        ...
                        .as_ref()
                    {
                        "audioDuration" => {
                            builder = builder.set_audio_duration(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::CmfcAudioDuration::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        ...
                        "freeSpaceBox" => {
                            builder = builder.set_free_space_box(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::Mp4FreeSpaceBox::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        "moovPlacement" => {
                            builder = builder.set_moov_placement(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::Mp4MoovPlacement::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
