...
pub fn ser_mp4_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Mp4Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_mp4_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Mp4Settings>, aws_smithy_json::deserialize::error::DeserializeError>
