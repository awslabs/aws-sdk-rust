...
pub(crate) fn de_mp4_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::Mp4Settings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "cslgAtom" => {
                            builder = builder.set_cslg_atom(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::Mp4CslgAtom::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "cttsVersion" => {
                        ...
                        "freeSpaceBox" => {
                            builder = builder.set_free_space_box(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::Mp4FreeSpaceBox::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "moovPlacement" => {
                            builder = builder.set_moov_placement(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::Mp4MoovPlacement::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "mp4MajorBrand" => {
