...
pub fn ser_nielsen_non_linear_watermark_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NielsenNonLinearWatermarkSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_nielsen_non_linear_watermark_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NielsenNonLinearWatermarkSettings>, aws_smithy_json::deserialize::error::DeserializeError>
