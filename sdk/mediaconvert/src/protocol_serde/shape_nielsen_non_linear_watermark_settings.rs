...
pub(crate) fn de_nielsen_non_linear_watermark_settings<'a, I>(
    ...
    Option<crate::types::NielsenNonLinearWatermarkSettings>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_active_watermark_process(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::NielsenActiveWatermarkProcessType::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "sourceWatermarkStatus" => {
                                builder = builder.set_source_watermark_status(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::NielsenSourceWatermarkStatusType::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "uniqueTicPerAudioTrack" => {
                                builder = builder.set_unique_tic_per_audio_track(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::NielsenUniqueTicPerAudioTrackType::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
