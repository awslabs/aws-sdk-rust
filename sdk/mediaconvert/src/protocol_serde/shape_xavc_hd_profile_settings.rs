...
pub(crate) fn de_xavc_hd_profile_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::XavcHdProfileSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "bitrateClass" => {
                            builder = builder.set_bitrate_class(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::XavcHdProfileBitrateClass::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "qualityTuningLevel" => {
                            builder = builder.set_quality_tuning_level(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::XavcHdProfileQualityTuningLevel::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "slices" => {
                        ...
                        "telecine" => {
                            builder = builder.set_telecine(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::XavcHdProfileTelecine::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
