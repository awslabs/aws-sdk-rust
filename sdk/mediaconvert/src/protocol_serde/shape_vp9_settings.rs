...
pub fn ser_vp9_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Vp9Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.bitrate != 0 {
...
pub(crate) fn de_vp9_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Vp9Settings>, aws_smithy_json::deserialize::error::DeserializeError>
