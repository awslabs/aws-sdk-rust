...
pub fn ser_cmaf_encryption_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CmafEncryptionSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cmaf_encryption_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CmafEncryptionSettings>, aws_smithy_json::deserialize::error::DeserializeError>
