...
) -> ::std::result::Result<Option<crate::types::MpdSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "accessibilityCaptionHints" => {
                            builder = builder.set_accessibility_caption_hints(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdAccessibilityCaptionHints::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "audioDuration" => {
                            builder = builder.set_audio_duration(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdAudioDuration::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "klvMetadata" => {
                            builder = builder.set_klv_metadata(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdKlvMetadata::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "manifestMetadataSignaling" => {
                            builder = builder.set_manifest_metadata_signaling(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdManifestMetadataSignaling::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "scte35Esam" => {
                            builder = builder.set_scte35_esam(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdScte35Esam::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "scte35Source" => {
                        ...
                        "timedMetadata" => {
                            builder = builder.set_timed_metadata(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdTimedMetadata::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "timedMetadataBoxVersion" => {
                            builder = builder.set_timed_metadata_box_version(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MpdTimedMetadataBoxVersion::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
