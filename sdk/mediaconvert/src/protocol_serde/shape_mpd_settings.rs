...
pub(crate) fn de_mpd_settings<'a, I>(
    ...
    Option<crate::types::MpdSettings>,
                        ...
                        .as_ref()
                    {
                        ...
                        "audioDuration" => {
                            builder = builder.set_audio_duration(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::MpdAudioDuration::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        ...
                        "scte35Source" => {
                            builder = builder.set_scte35_source(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::MpdScte35Source::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
                        "timedMetadata" => {
                            builder = builder.set_timed_metadata(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::MpdTimedMetadata::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
