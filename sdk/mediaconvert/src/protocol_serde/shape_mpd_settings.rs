...
pub fn ser_mpd_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MpdSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_mpd_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MpdSettings>, aws_smithy_json::deserialize::error::DeserializeError>
