...
pub fn ser_noise_reducer_temporal_filter_settings(
    ...
    if let Some(var_1) = &input.aggressive_mode {
        object.key("aggressiveMode").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_4) = &input.speed {
        object.key("speed").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.strength {
        object.key("strength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    Ok(())
}
