                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "currentPhase" => {
                                builder = builder.set_current_phase(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::JobPhase::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            ...
                            "messages" => {
                                builder = builder.set_messages(
                                    crate::protocol_serde::shape_job_messages::de_job_messages(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "settings" => {
                                builder = builder.set_settings(
                                    crate::protocol_serde::shape_job_settings::de_job_settings(
                                        tokens,
                                    )?,
                                );
                            }
