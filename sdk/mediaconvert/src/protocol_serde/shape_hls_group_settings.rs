...
pub fn ser_hls_group_settings(
    ...
    if let Some(var_36) = &input.segment_length {
        object.key("segmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_36).into()));
    }
    ...
    if let Some(var_38) = &input.segments_per_subdirectory {
        object.key("segmentsPerSubdirectory").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_38).into()));
    }
    ...
    if let Some(var_42) = &input.timed_metadata_id3_period {
        object.key("timedMetadataId3Period").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_42).into()));
    }
    if let Some(var_43) = &input.timestamp_delta_milliseconds {
        object.key("timestampDeltaMilliseconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_43).into()));
    }
    Ok(())
}
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "adMarkers" => {
                                builder = builder.set_ad_markers(
                                    crate::protocol_serde::shape_list_of_hls_ad_markers::de_list_of_hls_ad_markers(tokens)?
                                );
                            }
                            "additionalManifests" => {
                            ...
                            "progressiveWriteHlsManifest" => {
                                builder = builder.set_progressive_write_hls_manifest(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::HlsProgressiveWriteHlsManifest::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
