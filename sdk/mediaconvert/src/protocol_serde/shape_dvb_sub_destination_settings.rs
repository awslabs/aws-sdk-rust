                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "applyFontColor" => {
                                builder = builder.set_apply_font_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubtitleApplyFontColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "backgroundColor" => {
                                builder = builder.set_background_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubtitleBackgroundColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "fallbackFont" => {
                                builder = builder.set_fallback_font(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubSubtitleFallbackFont::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "stylePassthrough" => {
                                builder = builder.set_style_passthrough(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubtitleStylePassthrough::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "teletextSpacing" => {
                                builder = builder.set_teletext_spacing(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::DvbSubtitleTeletextSpacing::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
