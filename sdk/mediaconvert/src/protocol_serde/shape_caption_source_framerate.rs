...
pub(crate) fn de_caption_source_framerate<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::CaptionSourceFramerate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
