...
pub fn ser_speke_key_provider_cmaf(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SpekeKeyProviderCmaf) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_speke_key_provider_cmaf<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SpekeKeyProviderCmaf>, aws_smithy_json::deserialize::error::DeserializeError>
