...
) -> ::std::result::Result<Option<crate::types::Mp3Settings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "rateControlMode" => {
                            builder = builder.set_rate_control_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::Mp3RateControlMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "sampleRate" => {
