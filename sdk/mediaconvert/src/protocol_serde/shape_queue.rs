            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "reservationPlan" => {
                            builder =
                                builder.set_reservation_plan(crate::protocol_serde::shape_reservation_plan::de_reservation_plan(tokens, _value)?);
                        }
                        "serviceOverrides" => {
                            builder = builder.set_service_overrides(
                                crate::protocol_serde::shape_list_of_service_override::de_list_of_service_override(tokens, _value)?,
                            );
                        }
                        "status" => {
