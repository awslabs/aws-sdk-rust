...
pub fn ser_m2ts_settings(
    ...
    if let Some(var_3) = &input.audio_frames_per_pes {
        object.key("audioFramesPerPes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_7) = &input.bitrate {
        object.key("bitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    ...
    if let Some(var_19) = &input.dvb_teletext_pid {
        object.key("dvbTeletextPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_19).into()));
    }
    ...
    if let Some(var_24) = &input.fragment_time {
        object.key("fragmentTime").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_24).into()));
    }
    ...
    if let Some(var_26) = &input.max_pcr_interval {
        object.key("maxPcrInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    if let Some(var_27) = &input.min_ebp_interval {
        object.key("minEbpInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_27).into()));
    }
    ...
    if let Some(var_29) = &input.null_packet_bitrate {
        object.key("nullPacketBitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_29).into()));
    }
    if let Some(var_30) = &input.pat_interval {
        object.key("patInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_30).into()));
    }
    if let Some(var_31) = &input.pcr_control {
        object.key("pcrControl").string(var_31.as_str());
    }
    if let Some(var_32) = &input.pcr_pid {
        object.key("pcrPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_32).into()));
    }
    if let Some(var_33) = &input.pmt_interval {
        object.key("pmtInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_33).into()));
    }
    if let Some(var_34) = &input.pmt_pid {
        object.key("pmtPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_34).into()));
    }
    if let Some(var_35) = &input.private_metadata_pid {
        object.key("privateMetadataPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_35).into()));
    }
    if let Some(var_36) = &input.program_number {
        object.key("programNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_36).into()));
    }
    if let Some(var_37) = &input.pts_offset {
        object.key("ptsOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_37).into()));
    }
    ...
    if let Some(var_42) = &input.scte35_pid {
        object.key("scte35Pid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_42).into()));
    }
    ...
    if let Some(var_47) = &input.timed_metadata_pid {
        object.key("timedMetadataPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_47).into()));
    }
    if let Some(var_48) = &input.transport_stream_id {
        object.key("transportStreamId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_48).into()));
    }
    if let Some(var_49) = &input.video_pid {
        object.key("videoPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_49).into()));
    }
    Ok(())
}
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ptsOffsetMode" => {
                                builder = builder.set_pts_offset_mode(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::TsPtsOffset::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
