...
pub fn ser_avc_intra_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AvcIntraSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_avc_intra_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AvcIntraSettings>, aws_smithy_json::deserialize::error::DeserializeError>
