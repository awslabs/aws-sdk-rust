...
pub fn ser_hls_image_based_trick_play_variant(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::HlsImageBasedTrickPlayVariant,
...
pub(crate) fn de_hls_image_based_trick_play_variant<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::HlsImageBasedTrickPlayVariant>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::HlsImageBasedTrickPlayVariantBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "intervalCadence" => {
                            builder = builder.set_interval_cadence(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsIntervalCadence::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "thumbnailHeight" => {
