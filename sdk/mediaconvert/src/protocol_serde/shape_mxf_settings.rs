...
pub fn ser_mxf_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MxfSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_mxf_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MxfSettings>, aws_smithy_json::deserialize::error::DeserializeError>
