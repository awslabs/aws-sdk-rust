...
pub fn ser_vorbis_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VorbisSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.channels != 0 {
...
pub(crate) fn de_vorbis_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VorbisSettings>, aws_smithy_json::deserialize::error::DeserializeError>
