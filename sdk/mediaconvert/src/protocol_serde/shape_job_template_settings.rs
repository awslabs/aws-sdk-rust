...
pub fn ser_job_template_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobTemplateSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_job_template_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobTemplateSettings>, aws_smithy_json::deserialize::error::DeserializeError>
