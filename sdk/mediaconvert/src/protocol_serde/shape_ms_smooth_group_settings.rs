...
pub fn ser_ms_smooth_group_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MsSmoothGroupSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_ms_smooth_group_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MsSmoothGroupSettings>, aws_smithy_json::deserialize::error::DeserializeError>
