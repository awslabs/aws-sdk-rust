...
pub fn ser_audio_selector(
    ...
    if let Some(var_8) = &input.offset {
        object.key("offset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    ...
    if let Some(var_12) = &input.program_selection {
        object.key("programSelection").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
    ...
    if let Some(var_16) = &input.tracks {
        ...
        for item_18 in var_16 {
             {
                array_17.value().number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*item_18).into()));
            }
        }
        array_17.finish();
    }
