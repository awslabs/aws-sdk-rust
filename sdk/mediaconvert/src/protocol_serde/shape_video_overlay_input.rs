...
pub(crate) fn de_video_overlay_input<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VideoOverlayInput>, ::aws_smithy_json::deserialize::error::DeserializeError>
