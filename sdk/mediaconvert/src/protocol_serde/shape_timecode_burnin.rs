...
pub(crate) fn de_timecode_burnin<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TimecodeBurnin>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "position" => {
                            builder = builder.set_position(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TimecodeBurninPosition::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "prefix" => {
