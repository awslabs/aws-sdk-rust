...
pub fn ser_timecode_burnin(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimecodeBurnin) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_timecode_burnin<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TimecodeBurnin>, aws_smithy_json::deserialize::error::DeserializeError>
