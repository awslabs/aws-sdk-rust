...
pub fn ser_aac_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AacSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aac_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AacSettings>, aws_smithy_json::deserialize::error::DeserializeError>
