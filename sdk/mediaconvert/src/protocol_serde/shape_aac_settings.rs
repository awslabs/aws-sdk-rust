...
) -> Result<Option<crate::types::AacSettings>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "codecProfile" => {
                                builder = builder.set_codec_profile(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::AacCodecProfile::from(u.as_ref())
                                        })
                                    })
                                    .transpose()?,
                                );
                            ...
                            "specification" => {
                                builder = builder.set_specification(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::AacSpecification::from(u.as_ref())
                                        })
                                    })
                                    .transpose()?,
                                );
