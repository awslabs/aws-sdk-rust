...
pub fn ser_cmaf_image_based_trick_play_variant(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CmafImageBasedTrickPlayVariant,
...
pub(crate) fn de_cmaf_image_based_trick_play_variant<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::CmafImageBasedTrickPlayVariant>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::CmafImageBasedTrickPlayVariantBuilder::default();
            loop {
                match tokens.next().transpose()? {
