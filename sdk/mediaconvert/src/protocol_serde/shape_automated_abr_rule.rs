...
pub fn ser_automated_abr_rule(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_allowed_rendition_size::ser_allowed_rendition_size(
                    &mut object_4,
                    item_3,
                )?;
                object_4.finish();
    ...
    if let Some(var_9) = &input.min_bottom_rendition_size {
        ...
        crate::protocol_serde::shape_min_bottom_rendition_size::ser_min_bottom_rendition_size(
            &mut object_10,
            var_9,
        )?;
        object_10.finish();
    ...
    if let Some(var_11) = &input.min_top_rendition_size {
        ...
        crate::protocol_serde::shape_min_top_rendition_size::ser_min_top_rendition_size(
            &mut object_12,
            var_11,
        )?;
        object_12.finish();
...
pub(crate) fn de_automated_abr_rule<'a, I>(
    ...
    Option<crate::types::AutomatedAbrRule>,
