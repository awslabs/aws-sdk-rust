                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "audioOnlyContainer" => {
                            builder = builder.set_audio_only_container(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsAudioOnlyContainer::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "audioRenditionSets" => {
                        ...
                        "audioTrackType" => {
                            builder = builder.set_audio_track_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsAudioTrackType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "descriptiveVideoServiceFlag" => {
                            builder = builder.set_descriptive_video_service_flag(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsDescriptiveVideoServiceFlag::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "iFrameOnlyManifest" => {
                            builder = builder.set_i_frame_only_manifest(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HlsIFrameOnlyManifest::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "segmentModifier" => {
