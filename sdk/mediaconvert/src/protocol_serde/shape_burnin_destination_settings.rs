                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "applyFontColor" => {
                                builder = builder.set_apply_font_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::BurninSubtitleApplyFontColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "fallbackFont" => {
                                builder = builder.set_fallback_font(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::BurninSubtitleFallbackFont::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "outlineColor" => {
                                builder = builder.set_outline_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::BurninSubtitleOutlineColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "shadowColor" => {
                                builder = builder.set_shadow_color(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::BurninSubtitleShadowColor::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
