...
pub fn ser_burnin_destination_settings(
    ...
    if let Some(var_4) = &input.background_opacity {
        object.key("backgroundOpacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    ...
    if let Some(var_7) = &input.font_opacity {
        object.key("fontOpacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.font_resolution {
        object.key("fontResolution").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    if let Some(var_9) = &input.font_script {
        object.key("fontScript").string(var_9.as_str());
    }
    if let Some(var_10) = &input.font_size {
        object.key("fontSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    ...
    if let Some(var_13) = &input.outline_size {
        object.key("outlineSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.shadow_color {
        object.key("shadowColor").string(var_14.as_str());
    }
    if let Some(var_15) = &input.shadow_opacity {
        object.key("shadowOpacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    if let Some(var_16) = &input.shadow_x_offset {
        object.key("shadowXOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    if let Some(var_17) = &input.shadow_y_offset {
        object.key("shadowYOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
    ...
    if let Some(var_20) = &input.x_position {
        object.key("xPosition").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.y_position {
        object.key("yPosition").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    Ok(())
}
