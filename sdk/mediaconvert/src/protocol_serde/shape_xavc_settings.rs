...
pub fn ser_xavc_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::XavcSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_xavc_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::XavcSettings>, aws_smithy_json::deserialize::error::DeserializeError>
