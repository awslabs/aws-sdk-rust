...
pub fn ser_job_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_job_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobSettings>, aws_smithy_json::deserialize::error::DeserializeError>
