...
pub fn ser_job_settings(
    ...
    if let Some(var_12) = &input.follow_source {
        object.key("followSource").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
...
pub(crate) fn de_job_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::JobSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "colorConversion3DLUTSettings" => {
                                builder = builder.set_color_conversion3_dlut_settings(
                                    crate::protocol_serde::shape_list_of_color_conversion3_dlut_setting::de_list_of_color_conversion3_dlut_setting(tokens)?
                                );
                            }
                            "esam" => {
                            ...
                            "inputs" => {
                                builder = builder.set_inputs(
                                    crate::protocol_serde::shape_list_of_input::de_list_of_input(tokens)?
                                );
                            }
                            "kantarWatermark" => {
