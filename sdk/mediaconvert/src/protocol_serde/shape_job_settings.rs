...
pub fn ser_job_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::JobSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "inputs" => {
                                builder = builder.set_inputs(
                                    crate::protocol_serde::shape___list_of_input::de___list_of_input(tokens)?
                                );
                            }
                            "kantarWatermark" => {
