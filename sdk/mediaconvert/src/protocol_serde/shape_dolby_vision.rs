...
pub fn ser_dolby_vision(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DolbyVision) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_dolby_vision<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DolbyVision>, aws_smithy_json::deserialize::error::DeserializeError>
