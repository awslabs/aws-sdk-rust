...
pub(crate) fn de_hls_image_based_trick_play_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::HlsImageBasedTrickPlaySettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
