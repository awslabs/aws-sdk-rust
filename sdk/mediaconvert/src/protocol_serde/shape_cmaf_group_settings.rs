...
pub fn ser_cmaf_group_settings(
    ...
    if let Some(var_14) = &input.fragment_length {
        object.key("fragmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
    ...
    if let Some(var_20) = &input.min_buffer_time {
        object.key("minBufferTime").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.min_final_segment_length {
        object.key("minFinalSegmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_21).into()));
    }
    ...
    if let Some(var_26) = &input.segment_length {
        object.key("segmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
