...
pub fn ser_create_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
