...
pub fn ser_audio_normalization_settings(
    ...
    if let Some(var_3) = &input.correction_gate_level {
        object.key("correctionGateLevel").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_6) = &input.target_lkfs {
        object.key("targetLkfs").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_6).into()));
    }
    if let Some(var_7) = &input.true_peak_limiter_threshold {
        object.key("truePeakLimiterThreshold").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_7).into()));
    }
    Ok(())
}
