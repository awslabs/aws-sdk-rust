...
pub fn ser_nielsen_configuration(
...
pub(crate) fn de_nielsen_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::NielsenConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
