...
pub(crate) fn de_noise_reducer_spatial_filter_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::NoiseReducerSpatialFilterSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
