...
pub fn ser_av1_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Av1Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_av1_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Av1Settings>, aws_smithy_json::deserialize::error::DeserializeError>
