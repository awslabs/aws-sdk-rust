...
pub(crate) fn de_ancillary_source_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AncillarySourceSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "convert608To708" => {
                            builder = builder.set_convert608_to708(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AncillaryConvert608To708::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "terminateCaptions" => {
                            builder = builder.set_terminate_captions(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AncillaryTerminateCaptions::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
