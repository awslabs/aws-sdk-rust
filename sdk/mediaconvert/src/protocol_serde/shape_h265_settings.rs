...
pub fn ser_h265_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::H265Settings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_h265_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::H265Settings>, aws_smithy_json::deserialize::error::DeserializeError>
