...
pub fn ser_eac3_atmos_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Eac3AtmosSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.bitrate != 0 {
...
pub(crate) fn de_eac3_atmos_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Eac3AtmosSettings>, aws_smithy_json::deserialize::error::DeserializeError>
