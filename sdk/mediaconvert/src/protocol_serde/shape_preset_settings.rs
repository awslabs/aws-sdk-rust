...
pub fn ser_preset_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PresetSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_preset_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PresetSettings>, aws_smithy_json::deserialize::error::DeserializeError>
