...
impl Builder {
    ...
    /// use aws_sdk_mediaconvert::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_mediaconvert::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
