        ...
        for item_499 in var_497 {
            {
                array_498.value().number(
                    #[allow(clippy::useless_conversion)]
                    aws_smithy_types::Number::NegInt((*item_499).into()),
                );
            }
        }
        array_498.finish();
...
pub fn serialize_structure_crate_model_m3u8_settings(
    ...
    if let Some(var_516) = &input.audio_pids {
        ...
        for item_518 in var_516 {
            {
                array_517.value().number(
                    #[allow(clippy::useless_conversion)]
                    aws_smithy_types::Number::NegInt((*item_518).into()),
                );
            }
        }
        array_517.finish();
...
pub fn serialize_structure_crate_model_output_channel_mapping(
    ...
    if let Some(var_1043) = &input.input_channels {
        ...
        for item_1045 in var_1043 {
            {
                array_1044.value().number(
                    #[allow(clippy::useless_conversion)]
                    aws_smithy_types::Number::NegInt((*item_1045).into()),
                );
            }
        }
        array_1044.finish();
    ...
    if let Some(var_1046) = &input.input_channels_fine_tune {
        ...
        for item_1048 in var_1046 {
            {
                array_1047.value().number(
                    #[allow(clippy::useless_conversion)]
                    aws_smithy_types::Number::Float((*item_1048).into()),
                );
            }
        }
        array_1047.finish();
...
pub fn serialize_structure_crate_model_clip_limits(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ClipLimits,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
