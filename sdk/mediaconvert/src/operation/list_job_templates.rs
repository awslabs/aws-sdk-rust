        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.list_by {
                    {
                        query.push_kv("listBy", &::aws_smithy_http::query::fmt_string(inner_2.as_str()));
                    }
                }
...
impl ListJobTemplatesError {
    ...
    /// Returns `true` if the error kind is `ListJobTemplatesError::ServiceQuotaExceededException`.
