...
impl ListVersionsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_versions::paginator::ListVersionsPaginatorItems {
        crate::operation::list_versions::paginator::ListVersionsPaginatorItems(self)
    }
...
/// Flattened paginator for `ListVersionsPaginator`
///
/// This is created with [`.items()`](ListVersionsPaginator::items)
pub struct ListVersionsPaginatorItems(ListVersionsPaginator);

impl ListVersionsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_versions_output_output_versions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
