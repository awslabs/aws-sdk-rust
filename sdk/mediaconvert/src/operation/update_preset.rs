...
impl UpdatePresetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_preset::UpdatePreset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePreset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_preset::de_update_preset_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_preset::de_update_preset_http_response_with_props(
                status, headers, body,
            )
        }
    }
