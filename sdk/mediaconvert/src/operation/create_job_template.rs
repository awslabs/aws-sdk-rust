...
impl CreateJobTemplate {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "CreateJobTemplate", input, runtime_plugins, stop_point)
...
impl CreateJobTemplateError {
    ...
    /// Returns `true` if the error kind is `CreateJobTemplateError::ServiceQuotaExceededException`.
