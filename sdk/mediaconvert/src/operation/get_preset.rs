...
impl GetPresetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_preset::GetPreset,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2017-08-29/presets/{Name}", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_preset::GetPreset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPreset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_preset::de_get_preset_http_response_with_props(
                status, headers, body,
            )
        }
    }
