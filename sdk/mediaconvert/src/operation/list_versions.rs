...
impl ListVersions {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "ListVersions", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2017-08-29/versions").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_versions::ListVersionsInput,
...
impl ListVersionsError {
    ...
    /// Returns `true` if the error kind is `ListVersionsError::ServiceQuotaExceededException`.
