...
impl DeletePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "DeletePolicy", input, runtime_plugins, stop_point)
...
impl DeletePolicyError {
    ...
    /// Returns `true` if the error kind is `DeletePolicyError::ServiceQuotaExceededException`.
