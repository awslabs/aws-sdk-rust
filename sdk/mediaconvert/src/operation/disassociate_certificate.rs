    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2017-08-29/certificates/{Arn}", Arn = arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_certificate::DisassociateCertificate::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_certificate::DisassociateCertificateError
{
