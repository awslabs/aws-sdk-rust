    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2017-08-29/certificates")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_certificate::AssociateCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_associate_certificate::de_associate_certificate_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_certificate::AssociateCertificateError
{
