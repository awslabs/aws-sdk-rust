...
impl CreateQueueInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_queue::CreateQueue::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateQueue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_queue::de_create_queue_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_queue::de_create_queue_http_response_with_props(
                status, headers, body,
            )
        }
    }
