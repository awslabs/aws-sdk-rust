...
impl ListPresets {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "ListPresets", input, runtime_plugins, stop_point)
...
impl ListPresetsError {
    ...
    /// Returns `true` if the error kind is `ListPresetsError::ServiceQuotaExceededException`.
