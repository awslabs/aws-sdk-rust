...
impl GetQueueInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_queue::GetQueue,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2017-08-29/queues/{Name}", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_queue::GetQueue::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_queue::de_get_queue_http_response_with_props(
                status, headers, body,
            )
        }
    }
