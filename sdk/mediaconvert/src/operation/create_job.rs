...
impl CreateJob {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "CreateJob", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateJob", "MediaConvert"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateJobTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("JobEngineVersion") {
            if let ::std::option::Option::Some(value) = input.job_engine_version.as_deref() {
                captured.insert("JobEngineVersion", value);
            }
        }
        if requested.should_capture("JobTemplate") {
            if let ::std::option::Option::Some(value) = input.job_template.as_deref() {
                captured.insert("JobTemplate", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2017-08-29/jobs").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
