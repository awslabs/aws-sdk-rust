...
impl DescribeEndpoints {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "DescribeEndpoints", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2017-08-29/endpoints").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl DescribeEndpointsError {
    ...
    /// Returns `true` if the error kind is `DescribeEndpointsError::ServiceQuotaExceededException`.
