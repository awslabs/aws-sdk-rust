...
impl DeletePreset {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "DeletePreset", input, runtime_plugins, stop_point)
...
impl DeletePresetError {
    ...
    /// Returns `true` if the error kind is `DeletePresetError::ServiceQuotaExceededException`.
