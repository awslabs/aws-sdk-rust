...
impl UpdateJobTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_job_template::UpdateJobTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_job_template::UpdateJobTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_job_template::UpdateJobTemplateOutput, crate::operation::update_job_template::UpdateJobTemplateError, Self> {
