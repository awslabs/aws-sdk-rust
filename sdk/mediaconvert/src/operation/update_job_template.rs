    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2017-08-29/jobTemplates/{Name}", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_job_template::UpdateJobTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_job_template::de_update_job_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_job_template::UpdateJobTemplateError
{
