...
impl UpdateJobTemplateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_job_template::ser_update_job_template_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_job_template::de_update_job_template_http_response_with_props(status, headers, body)
        }
    }
}
