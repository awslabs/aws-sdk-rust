...
impl DeleteQueueInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_queue::DeleteQueue::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteQueue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_queue::de_delete_queue_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_queue::de_delete_queue_http_response_with_props(
                status, headers, body,
            )
        }
    }
