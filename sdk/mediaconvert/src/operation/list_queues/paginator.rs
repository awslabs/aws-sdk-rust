...
impl ListQueuesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Queue, ::aws_smithy_http::result::SdkError<crate::operation::list_queues::ListQueuesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_queues_output_queues(page).unwrap_or_default().into_iter())
    }
}
