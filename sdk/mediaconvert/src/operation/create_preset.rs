...
impl CreatePresetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_preset::CreatePreset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePreset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_preset::de_create_preset_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_preset::de_create_preset_http_response_with_props(
                status, headers, body,
            )
        }
    }
