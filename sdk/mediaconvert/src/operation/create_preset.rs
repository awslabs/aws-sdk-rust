...
impl CreatePresetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_preset::CreatePreset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_preset::ser_create_preset_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePreset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_preset::de_create_preset_http_response_with_props(status, headers, body)
        }
    }
}
