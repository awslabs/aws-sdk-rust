...
/// Operation shape for `AssociateCertificate`.
            ...
            /// [`associate_certificate`](crate::client::fluent_builders::AssociateCertificate).
            ///
...
/// Operation shape for `DisassociateCertificate`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`disassociate_certificate`](crate::client::fluent_builders::DisassociateCertificate).
            ///
            /// `ParseStrictResponse` impl for `DisassociateCertificate`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateCertificate {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 202 {
                        crate::protocol_serde::shape_disassociate_certificate::de_disassociate_certificate_http_error(response)
                     } else {
                        crate::protocol_serde::shape_disassociate_certificate::de_disassociate_certificate_http_response(response)
                     }
                }
            }
...
/// Operation shape for `GetJobTemplate`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_job_template`](crate::client::fluent_builders::GetJobTemplate).
            ///
            /// `ParseStrictResponse` impl for `GetJobTemplate`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for GetJobTemplate {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_job_template::de_get_job_template_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_job_template::de_get_job_template_http_response(response)
                     }
                }
            }
...
/// Operation shape for `GetPreset`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_preset`](crate::client::fluent_builders::GetPreset).
            ///
...
/// Operation shape for `GetQueue`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_queue`](crate::client::fluent_builders::GetQueue).
            ///
...
/// Operation shape for `UpdateJobTemplate`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_job_template`](crate::client::fluent_builders::UpdateJobTemplate).
            ///
...
/// Operation shape for `UpdatePreset`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_preset`](crate::client::fluent_builders::UpdatePreset).
            ///
            /// `ParseStrictResponse` impl for `UpdatePreset`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for UpdatePreset {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_preset::de_update_preset_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_preset::de_update_preset_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UpdateQueue`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_queue`](crate::client::fluent_builders::UpdateQueue).
            ///
            /// `ParseStrictResponse` impl for `UpdateQueue`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateQueue {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_queue::de_update_queue_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_queue::de_update_queue_http_response(response)
                     }
                }
            }
