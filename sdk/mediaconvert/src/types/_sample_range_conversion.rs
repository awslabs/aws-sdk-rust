...
impl ::std::convert::From<&str> for SampleRangeConversion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SampleRangeConversion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SampleRangeConversion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SampleRangeConversion::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SampleRangeConversion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
