...
pub struct CmafImageBasedTrickPlayVariant {
...
impl CmafImageBasedTrickPlayVariant {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval. If set to FOLLOW_SEGMENTATION, MediaConvert generates thumbnail playlist entries that align exactly with video segment boundaries. FOLLOW_SEGMENTATION requires 1x1 tiling.
...
impl CmafImageBasedTrickPlayVariant {
    /// Creates a new builder-style object to manufacture [`CmafImageBasedTrickPlayVariant`](crate::types::CmafImageBasedTrickPlayVariant).
    pub fn builder() -> crate::types::builders::CmafImageBasedTrickPlayVariantBuilder {
        crate::types::builders::CmafImageBasedTrickPlayVariantBuilder::default()
    }
}

/// A builder for [`CmafImageBasedTrickPlayVariant`](crate::types::CmafImageBasedTrickPlayVariant).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CmafImageBasedTrickPlayVariantBuilder {
...
impl CmafImageBasedTrickPlayVariantBuilder {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval. If set to FOLLOW_SEGMENTATION, MediaConvert generates thumbnail playlist entries that align exactly with video segment boundaries. FOLLOW_SEGMENTATION requires 1x1 tiling.
    ...
    /// Consumes the builder and constructs a [`CmafImageBasedTrickPlayVariant`](crate::types::CmafImageBasedTrickPlayVariant).
    pub fn build(self) -> crate::types::CmafImageBasedTrickPlayVariant {
        crate::types::CmafImageBasedTrickPlayVariant {
