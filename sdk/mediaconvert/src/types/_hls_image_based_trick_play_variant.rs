...
pub struct HlsImageBasedTrickPlayVariant {
...
impl HlsImageBasedTrickPlayVariant {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval. If set to FOLLOW_SEGMENTATION, MediaConvert generates thumbnail playlist entries that align exactly with video segment boundaries. FOLLOW_SEGMENTATION requires 1x1 tiling.
...
impl HlsImageBasedTrickPlayVariant {
    /// Creates a new builder-style object to manufacture [`HlsImageBasedTrickPlayVariant`](crate::types::HlsImageBasedTrickPlayVariant).
    pub fn builder() -> crate::types::builders::HlsImageBasedTrickPlayVariantBuilder {
        crate::types::builders::HlsImageBasedTrickPlayVariantBuilder::default()
    }
}

/// A builder for [`HlsImageBasedTrickPlayVariant`](crate::types::HlsImageBasedTrickPlayVariant).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct HlsImageBasedTrickPlayVariantBuilder {
...
impl HlsImageBasedTrickPlayVariantBuilder {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval. If set to FOLLOW_SEGMENTATION, MediaConvert generates thumbnail playlist entries that align exactly with video segment boundaries. FOLLOW_SEGMENTATION requires 1x1 tiling.
    ...
    /// Consumes the builder and constructs a [`HlsImageBasedTrickPlayVariant`](crate::types::HlsImageBasedTrickPlayVariant).
    pub fn build(self) -> crate::types::HlsImageBasedTrickPlayVariant {
        crate::types::HlsImageBasedTrickPlayVariant {
