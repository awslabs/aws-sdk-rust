...
/// When writing a match expression against `Xavc4kProfileCodecProfile`, it is important to ensure
...
///     Xavc4kProfileCodecProfile::High => { /* ... */ },
///     Xavc4kProfileCodecProfile::High422 => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `xavc4kprofilecodecprofile` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Xavc4kProfileCodecProfile::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Xavc4kProfileCodecProfile::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Xavc4kProfileCodecProfile::NewFeature` is defined.
...
impl ::std::convert::From<&str> for Xavc4kProfileCodecProfile {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Xavc4kProfileCodecProfile::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Xavc4kProfileCodecProfile {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Xavc4kProfileCodecProfile::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Xavc4kProfileCodecProfile {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
