...
impl  JobSettings  {
    ...
    pub fn color_conversion3_dlut_settings(&self) -> & [crate::types::ColorConversion3DlutSetting] {
        self.color_conversion3_dlut_settings.as_deref()
        .unwrap_or_default()
    }
    /// Settings for Event Signaling And Messaging (ESAM). If you don't do ad insertion, you can ignore these settings.
...
impl JobSettingsBuilder {
    ...
    /// Use 3D LUTs to specify custom color mapping behavior when you convert from one color space into another. You can include up to 8 different 3D LUTs.
    pub fn set_color_conversion3_dlut_settings(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::ColorConversion3DlutSetting>>) -> Self {
        self.color_conversion3_dlut_settings = input; self
    }
    /// Use 3D LUTs to specify custom color mapping behavior when you convert from one color space into another. You can include up to 8 different 3D LUTs.
