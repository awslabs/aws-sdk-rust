...
/// When writing a match expression against `AacCodecProfile`, it is important to ensure
...
///
/// ```text
/// # let aaccodecprofile = unimplemented!();
/// match aaccodecprofile {
///     AacCodecProfile::Hev1 => { /* ... */ },
///     AacCodecProfile::Hev2 => { /* ... */ },
///     AacCodecProfile::Lc => { /* ... */ },
///     AacCodecProfile::Xhe => { /* ... */ },
...
/// }
/// ```
/// The above code demonstrates that when `aaccodecprofile` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `AacCodecProfile::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `AacCodecProfile::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `AacCodecProfile::NewFeature` is defined.
/// Specifically, when `aaccodecprofile` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AacCodecProfile::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AacCodecProfile {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AacCodecProfile::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AacCodecProfile {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AacCodecProfile::from(s))
    }
}
impl AacCodecProfile {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AacCodecProfile::Xhe => "XHE",
            AacCodecProfile::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AacCodecProfile {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
