...
/// When writing a match expression against `Eac3AtmosDynamicRangeCompressionRf`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `eac3atmosdynamicrangecompressionrf` represents
...
/// version of SDK where the variant `Eac3AtmosDynamicRangeCompressionRf::NewFeature` is defined.
/// Specifically, when `eac3atmosdynamicrangecompressionrf` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Eac3AtmosDynamicRangeCompressionRf::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for Eac3AtmosDynamicRangeCompressionRf {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Eac3AtmosDynamicRangeCompressionRf::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Eac3AtmosDynamicRangeCompressionRf {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Eac3AtmosDynamicRangeCompressionRf::from(s))
    }
}
impl Eac3AtmosDynamicRangeCompressionRf {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Eac3AtmosDynamicRangeCompressionRf::Unknown(value) => value.as_str(),
        }
    }
