...
impl EmbeddedDestinationSettingsBuilder {
    ...
    pub fn build(self) -> crate::types::EmbeddedDestinationSettings {
        crate::types::EmbeddedDestinationSettings {
            destination608_channel_number: self.destination608_channel_number.unwrap_or_default(),
            destination708_service_number: self.destination708_service_number.unwrap_or_default(),
        }
    }
}
