...
impl AssociateCertificateInput {
    ...
    > {
        Ok({
            ...
            let body = crate::operation_ser::serialize_operation_associate_certificate(&self)
                .map_err(|err| {
...
impl CreateJobTemplateInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_job_template(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl CreateQueueInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_queue(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl DescribeEndpointsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_describe_endpoints(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl GetQueueInput {
    ...
    > {
        Ok({
            ...
            let op =
                smithy_http::operation::Operation::new(request, crate::operation::GetQueue::new())
                    .with_metadata(smithy_http::operation::Metadata::new(
                        "GetQueue",
                        "mediaconvert",
                    ));
...
impl ListJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_2) = &self.order {
            query.push_kv("order", &smithy_http::query::fmt_string(&inner_2));
        }
        if let Some(inner_3) = &self.queue {
            query.push_kv("queue", &smithy_http::query::fmt_string(&inner_3));
        }
        if let Some(inner_4) = &self.status {
            query.push_kv("status", &smithy_http::query::fmt_string(&inner_4));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListJobTemplatesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_5) = &self.category {
            query.push_kv("category", &smithy_http::query::fmt_string(&inner_5));
        }
        if let Some(inner_6) = &self.list_by {
            query.push_kv("listBy", &smithy_http::query::fmt_string(&inner_6));
        }
        if self.max_results != 0 {
            query.push_kv(
                "maxResults",
        ...
        if let Some(inner_8) = &self.order {
            query.push_kv("order", &smithy_http::query::fmt_string(&inner_8));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListPresetsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_9) = &self.category {
            query.push_kv("category", &smithy_http::query::fmt_string(&inner_9));
        }
        if let Some(inner_10) = &self.list_by {
            query.push_kv("listBy", &smithy_http::query::fmt_string(&inner_10));
        }
        if self.max_results != 0 {
            query.push_kv(
                "maxResults",
        ...
        if let Some(inner_12) = &self.order {
            query.push_kv("order", &smithy_http::query::fmt_string(&inner_12));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListQueuesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_13) = &self.list_by {
            query.push_kv("listBy", &smithy_http::query::fmt_string(&inner_13));
        }
        if self.max_results != 0 {
            query.push_kv(
                "maxResults",
        ...
        if let Some(inner_15) = &self.order {
            query.push_kv("order", &smithy_http::query::fmt_string(&inner_15));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl UpdateJobTemplateInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_job_template(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl UpdatePresetInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_preset(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl UpdateQueueInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_queue(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
