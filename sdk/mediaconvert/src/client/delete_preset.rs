...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_preset::builders::DeletePresetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_preset::builders::DeletePresetFluentBuilder::set_name):<br>required: **true**<br>The name of the preset to be deleted.<br>
