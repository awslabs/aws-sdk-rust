...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::associate_certificate::builders::AssociateCertificateFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::associate_certificate::builders::AssociateCertificateFluentBuilder::set_arn):<br>required: **true**<br>The ARN of the ACM certificate that you want to associate with your MediaConvert resource.<br>
