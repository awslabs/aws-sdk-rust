...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_preset::builders::GetPresetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_preset::builders::GetPresetFluentBuilder::set_name): The name of the preset.
