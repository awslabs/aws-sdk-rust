...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_job_template::builders::GetJobTemplateFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_job_template::builders::GetJobTemplateFluentBuilder::set_name):<br>required: **true**<br>The name of the job template.<br>
