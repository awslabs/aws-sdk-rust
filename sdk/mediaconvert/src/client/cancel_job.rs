...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::cancel_job::builders::CancelJobFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::cancel_job::builders::CancelJobFluentBuilder::set_id):<br>required: **true**<br>The Job ID of the job to be cancelled.<br>
