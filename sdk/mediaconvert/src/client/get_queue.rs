...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_queue::builders::GetQueueFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_queue::builders::GetQueueFluentBuilder::set_name):<br>required: **true**<br>The name of the queue that you want information about.<br>
