...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::set_max_results): Optional. Max number of endpoints, up to twenty, that will be returned at one time.
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::set_next_token): Use this string, provided with the response to a previous request, to request the next batch of endpoints.
