...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_presets::builders::ListPresetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_presets::builders::ListPresetsFluentBuilder::set_max_results): Optional. Number of presets, up to twenty, that will be returned at one time
