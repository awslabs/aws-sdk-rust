...
impl super::Client {
    ...
    ///   - [`category(impl ::std::convert::Into<String>)`](crate::operation::list_presets::builders::ListPresetsFluentBuilder::category) / [`set_category(Option<String>)`](crate::operation::list_presets::builders::ListPresetsFluentBuilder::set_category): Optionally, specify a preset category to limit responses to only presets from that category.
