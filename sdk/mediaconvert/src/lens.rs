...
pub(crate) fn reflens_structure_crate_output_describe_endpoints_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_list_presets_output_next_token(
...
pub(crate) fn lens_structure_crate_output_describe_endpoints_output_endpoints(
    input: crate::output::DescribeEndpointsOutput,
...
pub(crate) fn lens_structure_crate_output_list_queues_output_queues(
    input: crate::output::ListQueuesOutput,
