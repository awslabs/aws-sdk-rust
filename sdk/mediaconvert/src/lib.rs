...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("mediaconvert", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Elemental MediaConvert.
pub mod client;
