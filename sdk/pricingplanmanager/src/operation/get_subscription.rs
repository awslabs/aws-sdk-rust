...
impl GetSubscription {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Pricing Plan Manager.GetSubscription",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v1/GetSubscription").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_subscription::ser_get_subscription_input(&input)?);
