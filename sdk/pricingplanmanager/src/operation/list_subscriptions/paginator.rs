...
impl ListSubscriptionsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `subscription_summaries`. Queries to the underlying service
...
impl ListSubscriptionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_subscriptions_output_output_subscription_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
