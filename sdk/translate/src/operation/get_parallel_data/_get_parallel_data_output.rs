...
impl GetParallelDataOutputBuilder {
    ...
    pub fn set_parallel_data_properties(
        mut self,
        input: std::option::Option<crate::types::ParallelDataProperties>,
    ) -> Self {
    ...
    pub fn set_data_location(
        mut self,
        input: std::option::Option<crate::types::ParallelDataDataLocation>,
    ) -> Self {
    ...
    pub fn auxiliary_data_location(
        mut self,
        input: crate::types::ParallelDataDataLocation,
    ) -> Self {
