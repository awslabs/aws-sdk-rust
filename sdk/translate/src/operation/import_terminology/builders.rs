...
impl ImportTerminologyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::import_terminology::ImportTerminologyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_terminology::ImportTerminologyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::import_terminology::ImportTerminologyOutput, crate::operation::import_terminology::ImportTerminologyError, Self> {
