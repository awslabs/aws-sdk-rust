...
impl TranslateDocument {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::translate_document::TranslateDocumentError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::translate_document::TranslateDocumentOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("translate", "TranslateDocument", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TranslateDocument {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("TranslateDocument", "translate"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TranslateDocument")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(TranslateDocumentEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for TranslateDocumentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for TranslateDocumentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::translate_document::TranslateDocumentInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_translate_document::ser_translate_document_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for TranslateDocumentEndpointParamsInterceptor {
...
pub type TranslateDocumentErrorKind = TranslateDocumentError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for TranslateDocumentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::translate_document::TranslateDocumentError {
...
impl TranslateDocumentError {
    ...
    /// Creates the `TranslateDocumentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
