...
impl TranslateDocumentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_translate_document::ser_translate_document_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::translate_document::TranslateDocument::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TranslateDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_translate_document::de_translate_document_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::translate_document::TranslateDocumentError
{
