...
impl TranslateDocumentInput {
    /// Consumes the builder and constructs an Operation<[`TranslateDocument`](crate::operation::translate_document::TranslateDocument)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::translate_document::TranslateDocument,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_translate_document::ser_translate_document_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::translate_document::TranslateDocument::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("TranslateDocument", "translate"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for TranslateDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_translate_document::de_translate_document_http_response_with_props(status, headers, body)
        }
    }
