...
impl ListParallelDataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_parallel_data::ser_list_parallel_data_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListParallelData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_parallel_data::de_list_parallel_data_http_response_with_props(status, headers, body)
        }
    }
}
