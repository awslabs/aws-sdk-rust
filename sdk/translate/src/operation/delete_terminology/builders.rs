...
impl DeleteTerminologyFluentBuilder  {
    /// Creates a new `DeleteTerminology`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_terminology::DeleteTerminologyOutput, aws_smithy_http::result::SdkError<crate::operation::delete_terminology::DeleteTerminologyError>>
                     {
