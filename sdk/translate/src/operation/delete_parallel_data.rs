...
impl DeleteParallelDataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_parallel_data::DeleteParallelData,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_parallel_data::ser_delete_parallel_data_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteParallelData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_parallel_data::de_delete_parallel_data_http_response_with_props(status, headers, body)
        }
    }
}
