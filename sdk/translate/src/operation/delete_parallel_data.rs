...
impl DeleteParallelDataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_parallel_data::ser_delete_parallel_data_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_parallel_data::DeleteParallelData::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_parallel_data::DeleteParallelDataError
{
