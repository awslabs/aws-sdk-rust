...
impl ListTerminologiesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_terminologies::ser_list_terminologies_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTerminologies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_terminologies::de_list_terminologies_http_response_with_props(status, headers, body)
        }
    }
}
