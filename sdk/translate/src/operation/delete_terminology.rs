...
impl DeleteTerminologyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_terminology::DeleteTerminology,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_terminology::ser_delete_terminology_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTerminology {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_terminology::de_delete_terminology_http_response_with_props(status, headers, body)
        }
    }
}
