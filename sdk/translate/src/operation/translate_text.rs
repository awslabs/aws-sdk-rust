...
impl TranslateTextInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::translate_text::TranslateText::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TranslateText {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_translate_text::de_translate_text_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_translate_text::de_translate_text_http_response_with_props(
                status, headers, body,
            )
        }
    }
