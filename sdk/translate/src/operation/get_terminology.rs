...
impl GetTerminologyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_terminology::GetTerminology, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_terminology::ser_get_terminology_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTerminology {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_terminology::de_get_terminology_http_response_with_props(status, headers, body)
        }
    }
}
