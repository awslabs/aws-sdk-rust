...
impl GetTerminologyInput {
    /// Consumes the builder and constructs an Operation<[`GetTerminology`](crate::operation::get_terminology::GetTerminology)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_terminology::GetTerminology, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_terminology::GetTerminologyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_terminology::ser_get_terminology_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_terminology::GetTerminology::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetTerminology {
                type Output = std::result::Result<crate::operation::get_terminology::GetTerminologyOutput, crate::operation::get_terminology::GetTerminologyError>;
