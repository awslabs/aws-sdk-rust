...
impl GetParallelDataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_parallel_data::GetParallelData, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_parallel_data::ser_get_parallel_data_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetParallelData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_parallel_data::de_get_parallel_data_http_response_with_props(status, headers, body)
        }
    }
}
