...
impl CreateParallelDataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_parallel_data::ser_create_parallel_data_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_parallel_data::CreateParallelData::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_parallel_data::CreateParallelDataError
{
