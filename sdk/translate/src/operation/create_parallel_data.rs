...
impl CreateParallelDataInput {
    /// Consumes the builder and constructs an Operation<[`CreateParallelData`](crate::operation::create_parallel_data::CreateParallelData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_parallel_data::CreateParallelData, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_parallel_data::CreateParallelDataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_parallel_data::ser_create_parallel_data_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_parallel_data::CreateParallelData::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateParallelData {
                type Output = std::result::Result<crate::operation::create_parallel_data::CreateParallelDataOutput, crate::operation::create_parallel_data::CreateParallelDataError>;
