...
impl ListLanguagesInput {
    /// Consumes the builder and constructs an Operation<[`ListLanguages`](crate::operation::list_languages::ListLanguages)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_languages::ListLanguages, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_languages::ser_list_languages_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_languages::ListLanguages::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLanguages {
    type Output = ::std::result::Result<crate::operation::list_languages::ListLanguagesOutput, crate::operation::list_languages::ListLanguagesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_languages::de_list_languages_http_response_with_props(status, headers, body)
        }
    }
}
