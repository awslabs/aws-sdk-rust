...
impl UpdateParallelDataInput {
    /// Consumes the builder and constructs an Operation<[`UpdateParallelData`](crate::operation::update_parallel_data::UpdateParallelData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_parallel_data::UpdateParallelData, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_parallel_data::UpdateParallelDataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_parallel_data::ser_update_parallel_data_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_parallel_data::UpdateParallelData::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateParallelData {
                type Output = std::result::Result<crate::operation::update_parallel_data::UpdateParallelDataOutput, crate::operation::update_parallel_data::UpdateParallelDataError>;
