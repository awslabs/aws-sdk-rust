...
impl UpdateParallelDataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_parallel_data::ser_update_parallel_data_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_parallel_data::UpdateParallelData::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_parallel_data::UpdateParallelDataError
{
