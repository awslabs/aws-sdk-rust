...
impl StopTextTranslationJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_text_translation_job::StopTextTranslationJobInput,
                    ) -> ::std::result::Result<crate::operation::stop_text_translation_job::StopTextTranslationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_text_translation_job::StopTextTranslationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_text_translation_job::StopTextTranslationJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_text_translation_job::StopTextTranslationJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopTextTranslationJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopTextTranslationJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopTextTranslationJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopTextTranslationJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopTextTranslationJob")
...
.with_interceptor(StopTextTranslationJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_text_translation_job::StopTextTranslationJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_text_translation_job::StopTextTranslationJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_text_translation_job::StopTextTranslationJobError>::new());
...
#[derive(Debug)]
            struct StopTextTranslationJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopTextTranslationJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_text_translation_job::de_stop_text_translation_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_text_translation_job::de_stop_text_translation_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopTextTranslationJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopTextTranslationJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_text_translation_job::StopTextTranslationJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_text_translation_job::StopTextTranslationJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_text_translation_job::ser_stop_text_translation_job_input(&input)?);
...
#[derive(Debug)]
            struct StopTextTranslationJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopTextTranslationJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopTextTranslationJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopTextTranslationJobInput>()
                        .ok_or("failed to downcast to StopTextTranslationJobInput")?;
...
pub enum StopTextTranslationJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopTextTranslationJobError) for what information is available for the error.")]
...
impl StopTextTranslationJobError {
    /// Creates the `StopTextTranslationJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopTextTranslationJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopTextTranslationJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_text_translation_job::StopTextTranslationJobError {
...
mod _stop_text_translation_job_output;
