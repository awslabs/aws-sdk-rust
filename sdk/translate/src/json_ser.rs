...
pub fn serialize_structure_crate_input_create_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateParallelDataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteParallelDataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_terminology_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteTerminologyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_text_translation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeTextTranslationJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetParallelDataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_terminology_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTerminologyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_import_terminology_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportTerminologyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_languages_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListLanguagesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListParallelDataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_terminologies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTerminologiesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_text_translation_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTextTranslationJobsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_text_translation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartTextTranslationJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_stop_text_translation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopTextTranslationJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_translate_text_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TranslateTextInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateParallelDataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_parallel_data_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParallelDataConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_terminology_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TerminologyData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_text_translation_job_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TextTranslationJobFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_translation_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TranslationSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
