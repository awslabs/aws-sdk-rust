...
pub fn serialize_structure_create_parallel_data_input(
    ...
    if let Some(var_3) = &input.parallel_data_config {
        ...
        crate::json_ser::serialize_structure_parallel_data_config(&mut object_4, var_3);
        object_4.finish();
    }
    if let Some(var_5) = &input.encryption_key {
        let mut object_6 = object.key("EncryptionKey").start_object();
        crate::json_ser::serialize_structure_encryption_key(&mut object_6, var_5);
        object_6.finish();
    }
...
pub fn serialize_structure_delete_parallel_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_terminology_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_text_translation_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_parallel_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_terminology_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_import_terminology_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_17) = &input.terminology_data {
        ...
        crate::json_ser::serialize_structure_terminology_data(&mut object_18, var_17);
        object_18.finish();
    }
    if let Some(var_19) = &input.encryption_key {
        let mut object_20 = object.key("EncryptionKey").start_object();
        crate::json_ser::serialize_structure_encryption_key(&mut object_20, var_19);
        object_20.finish();
    }
}

pub fn serialize_structure_list_parallel_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_terminologies_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_text_translation_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_25) = &input.filter {
        ...
        crate::json_ser::serialize_structure_text_translation_job_filter(&mut object_26, var_25);
        object_26.finish();
    }
...
pub fn serialize_structure_start_text_translation_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_30) = &input.input_data_config {
        ...
        crate::json_ser::serialize_structure_input_data_config(&mut object_31, var_30);
        object_31.finish();
    }
    if let Some(var_32) = &input.output_data_config {
        let mut object_33 = object.key("OutputDataConfig").start_object();
        crate::json_ser::serialize_structure_output_data_config(&mut object_33, var_32);
        object_33.finish();
    }
...
pub fn serialize_structure_stop_text_translation_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_translate_text_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_parallel_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_55) = &input.parallel_data_config {
        ...
        crate::json_ser::serialize_structure_parallel_data_config(&mut object_56, var_55);
        object_56.finish();
    }
...
pub fn serialize_structure_parallel_data_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_terminology_data(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_text_translation_job_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
