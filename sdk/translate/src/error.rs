...
impl std::error::Error for TranslateTextError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            Self::DetectedLanguageLowConfidenceException(_inner) => Some(_inner),
            Self::InternalServerException(_inner) => Some(_inner),
            Self::InvalidRequestException(_inner) => Some(_inner),
            Self::ResourceNotFoundException(_inner) => Some(_inner),
            ...
            Self::TooManyRequestsException(_inner) => Some(_inner),
            Self::UnsupportedLanguagePairException(_inner) => Some(_inner),
            Self::Unhandled(_inner) => Some(_inner),
        }
    }
}
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UnsupportedDisplayLanguageCodeException
{
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        &self.meta
    }
