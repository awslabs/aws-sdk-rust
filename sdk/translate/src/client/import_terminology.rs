...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::import_terminology::builders::ImportTerminologyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::import_terminology::builders::ImportTerminologyFluentBuilder::set_name): <p>The name of the custom terminology being imported.</p>
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::import_terminology::builders::ImportTerminologyFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::import_terminology::builders::ImportTerminologyFluentBuilder::set_description): <p>The description of the custom terminology being imported.</p>
