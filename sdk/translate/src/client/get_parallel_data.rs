...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_parallel_data::builders::GetParallelDataFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_parallel_data::builders::GetParallelDataFluentBuilder::set_name):<br>required: **true**<br><p>The name of the parallel data resource that is being retrieved.</p><br>
