...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_terminology::builders::GetTerminologyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_terminology::builders::GetTerminologyFluentBuilder::set_name): <p>The name of the custom terminology being retrieved.</p>
