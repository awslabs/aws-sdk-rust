...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_text_translation_job::builders::StopTextTranslationJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_text_translation_job::builders::StopTextTranslationJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The job ID of the job to be stopped.</p><br>
