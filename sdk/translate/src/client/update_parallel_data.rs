...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_parallel_data::builders::UpdateParallelDataFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_parallel_data::builders::UpdateParallelDataFluentBuilder::set_name): <p>The name of the parallel data resource being updated.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_parallel_data::builders::UpdateParallelDataFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_parallel_data::builders::UpdateParallelDataFluentBuilder::set_description): <p>A custom description for the parallel data resource in Amazon Translate.</p>
