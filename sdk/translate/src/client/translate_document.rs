...
impl super::Client {
    ...
    pub fn translate_document(
        &self,
    ) -> crate::operation::translate_document::builders::TranslateDocumentFluentBuilder {
        crate::operation::translate_document::builders::TranslateDocumentFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
