...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_text_translation_job::builders::DescribeTextTranslationJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_text_translation_job::builders::DescribeTextTranslationJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier that Amazon Translate generated for the job. The <code>StartTextTranslationJob</code> operation returns this identifier in its response.</p><br>
