...
{
    pub fn create_parallel_data(&self) -> fluent_builders::CreateParallelData<C> {
        fluent_builders::CreateParallelData::new(self.handle.clone())
    }
    pub fn delete_parallel_data(&self) -> fluent_builders::DeleteParallelData<C> {
        fluent_builders::DeleteParallelData::new(self.handle.clone())
    }
    pub fn delete_terminology(&self) -> fluent_builders::DeleteTerminology<C> {
        fluent_builders::DeleteTerminology::new(self.handle.clone())
    }
    pub fn describe_text_translation_job(&self) -> fluent_builders::DescribeTextTranslationJob<C> {
        fluent_builders::DescribeTextTranslationJob::new(self.handle.clone())
    }
    pub fn get_parallel_data(&self) -> fluent_builders::GetParallelData<C> {
        fluent_builders::GetParallelData::new(self.handle.clone())
    }
    pub fn get_terminology(&self) -> fluent_builders::GetTerminology<C> {
        fluent_builders::GetTerminology::new(self.handle.clone())
    }
    pub fn import_terminology(&self) -> fluent_builders::ImportTerminology<C> {
        fluent_builders::ImportTerminology::new(self.handle.clone())
    }
    pub fn list_parallel_data(&self) -> fluent_builders::ListParallelData<C> {
        fluent_builders::ListParallelData::new(self.handle.clone())
    }
    pub fn list_terminologies(&self) -> fluent_builders::ListTerminologies<C> {
        fluent_builders::ListTerminologies::new(self.handle.clone())
    }
    pub fn list_text_translation_jobs(&self) -> fluent_builders::ListTextTranslationJobs<C> {
        fluent_builders::ListTextTranslationJobs::new(self.handle.clone())
    }
    pub fn start_text_translation_job(&self) -> fluent_builders::StartTextTranslationJob<C> {
        fluent_builders::StartTextTranslationJob::new(self.handle.clone())
    }
    pub fn stop_text_translation_job(&self) -> fluent_builders::StopTextTranslationJob<C> {
        fluent_builders::StopTextTranslationJob::new(self.handle.clone())
    }
    pub fn translate_text(&self) -> fluent_builders::TranslateText<C> {
        fluent_builders::TranslateText::new(self.handle.clone())
    }
    pub fn update_parallel_data(&self) -> fluent_builders::UpdateParallelData<C> {
        fluent_builders::UpdateParallelData::new(self.handle.clone())
    }
}
pub mod fluent_builders {
    #[derive(std::fmt::Debug)]
    pub struct CreateParallelData<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::create_parallel_data_input::Builder,
    }
    impl<C> CreateParallelData<C> {
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::CreateParallelDataError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct DeleteParallelData<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::delete_parallel_data_input::Builder,
    }
    impl<C> DeleteParallelData<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::DeleteParallelDataError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct DeleteTerminology<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::delete_terminology_input::Builder,
    }
    impl<C> DeleteTerminology<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::DeleteTerminologyError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeTextTranslationJob<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_text_translation_job_input::Builder,
    }
    impl<C> DescribeTextTranslationJob<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::DescribeTextTranslationJobError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetParallelData<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_parallel_data_input::Builder,
    }
    impl<C> GetParallelData<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::GetParallelDataError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetTerminology<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_terminology_input::Builder,
    }
    impl<C> GetTerminology<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::GetTerminologyError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct ImportTerminology<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::import_terminology_input::Builder,
    }
    impl<C> ImportTerminology<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::ImportTerminologyError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListParallelData<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_parallel_data_input::Builder,
    }
    impl<C> ListParallelData<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::ListParallelDataError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListTerminologies<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_terminologies_input::Builder,
    }
    impl<C> ListTerminologies<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::ListTerminologiesError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListTextTranslationJobs<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_text_translation_jobs_input::Builder,
    }
    impl<C> ListTextTranslationJobs<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::ListTextTranslationJobsError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct StartTextTranslationJob<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::start_text_translation_job_input::Builder,
    }
    impl<C> StartTextTranslationJob<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::StartTextTranslationJobError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
        ...
        pub fn source_language_code(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.source_language_code(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct StopTextTranslationJob<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::stop_text_translation_job_input::Builder,
    }
    impl<C> StopTextTranslationJob<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::StopTextTranslationJobError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct TranslateText<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::translate_text_input::Builder,
    }
    impl<C> TranslateText<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::TranslateTextError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
        ...
        pub fn target_language_code(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.target_language_code(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct UpdateParallelData<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::update_parallel_data_input::Builder,
    }
    impl<C> UpdateParallelData<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::UpdateParallelDataError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
