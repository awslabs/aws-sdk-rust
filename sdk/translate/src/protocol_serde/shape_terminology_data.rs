...
pub fn ser_terminology_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TerminologyData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
