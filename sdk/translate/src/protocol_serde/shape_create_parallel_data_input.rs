...
pub fn ser_create_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateParallelDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
