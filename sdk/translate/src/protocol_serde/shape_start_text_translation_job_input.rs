...
pub fn ser_start_text_translation_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartTextTranslationJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
