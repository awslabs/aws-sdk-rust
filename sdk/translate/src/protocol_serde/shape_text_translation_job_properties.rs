...
) -> Result<Option<crate::types::TextTranslationJobProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::TextTranslationJobPropertiesBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TargetLanguageCodes" => {
                            builder = builder.set_target_language_codes(
                                crate::protocol_serde::shape_target_language_code_string_list::de_target_language_code_string_list(tokens)?,
                            );
                        }
                        "TerminologyNames" => {
                            builder = builder.set_terminology_names(crate::protocol_serde::shape_resource_name_list::de_resource_name_list(tokens)?);
                        }
                        "ParallelDataNames" => {
                            builder =
                                builder.set_parallel_data_names(crate::protocol_serde::shape_resource_name_list::de_resource_name_list(tokens)?);
                        }
                        "Message" => {
                        ...
                        "Settings" => {
                            builder = builder.set_settings(crate::protocol_serde::shape_translation_settings::de_translation_settings(tokens)?);
                        }
