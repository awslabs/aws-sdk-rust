...
pub(crate) fn de_text_translation_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TextTranslationJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
