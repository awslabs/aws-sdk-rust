...
pub fn ser_update_parallel_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateParallelDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
