...
impl super::Client  {
    ...
    pub fn describe_association_execution_targets(&self) -> crate::client::fluent_builders::DescribeAssociationExecutionTargets {
                                crate::client::fluent_builders::DescribeAssociationExecutionTargets::new(self.handle.clone())
                            }
}
