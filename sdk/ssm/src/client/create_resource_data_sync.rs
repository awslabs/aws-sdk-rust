...
impl super::Client  {
    ...
    pub fn create_resource_data_sync(&self) -> crate::client::fluent_builders::CreateResourceDataSync {
                                crate::client::fluent_builders::CreateResourceDataSync::new(self.handle.clone())
                            }
}
