...
impl super::Client {
    ...
    ///   - [`sync_name(impl ::std::convert::Into<String>)`](crate::operation::create_resource_data_sync::builders::CreateResourceDataSyncFluentBuilder::sync_name) / [`set_sync_name(Option<String>)`](crate::operation::create_resource_data_sync::builders::CreateResourceDataSyncFluentBuilder::set_sync_name): <p>A name for the configuration.</p>
