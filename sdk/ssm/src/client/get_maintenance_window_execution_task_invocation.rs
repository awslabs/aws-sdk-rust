...
impl super::Client  {
    ...
    pub fn get_maintenance_window_execution_task_invocation(&self) -> crate::client::fluent_builders::GetMaintenanceWindowExecutionTaskInvocation {
                                crate::client::fluent_builders::GetMaintenanceWindowExecutionTaskInvocation::new(self.handle.clone())
                            }
}
