...
impl super::Client {
    ...
    ///   - [`sync_name(impl Into<String>)`](crate::operation::update_resource_data_sync::builders::UpdateResourceDataSyncFluentBuilder::sync_name) / [`set_sync_name(Option<String>)`](crate::operation::update_resource_data_sync::builders::UpdateResourceDataSyncFluentBuilder::set_sync_name):<br>required: **true**<br><p>The name of the resource data sync you want to update.</p><br>
    ///   - [`sync_type(impl Into<String>)`](crate::operation::update_resource_data_sync::builders::UpdateResourceDataSyncFluentBuilder::sync_type) / [`set_sync_type(Option<String>)`](crate::operation::update_resource_data_sync::builders::UpdateResourceDataSyncFluentBuilder::set_sync_type):<br>required: **true**<br><p>The type of resource data sync. The supported <code>SyncType</code> is SyncFromSource.</p><br>
