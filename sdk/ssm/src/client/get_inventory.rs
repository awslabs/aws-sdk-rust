...
impl super::Client {
    ...
    ///   - [`filters(InventoryFilter)`](crate::operation::get_inventory::builders::GetInventoryFluentBuilder::filters) / [`set_filters(Option<Vec<InventoryFilter>>)`](crate::operation::get_inventory::builders::GetInventoryFluentBuilder::set_filters): <p>One or more filters. Use a filter to return a more specific list of results.</p>
    ...
    ///   - [`result_attributes(ResultAttribute)`](crate::operation::get_inventory::builders::GetInventoryFluentBuilder::result_attributes) / [`set_result_attributes(Option<Vec<ResultAttribute>>)`](crate::operation::get_inventory::builders::GetInventoryFluentBuilder::set_result_attributes): <p>The list of inventory item types to return.</p>
