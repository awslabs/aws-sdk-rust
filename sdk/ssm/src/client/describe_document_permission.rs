...
impl super::Client {
    ...
    ///   - [`account_ids(Option<Vec::<String>>)`](crate::operation::describe_document_permission::DescribeDocumentPermissionOutput::account_ids): <p>The account IDs that have permission to use this document. The ID can be either an Amazon Web Services account number or <code>all</code>.</p>
