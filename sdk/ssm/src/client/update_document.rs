...
impl super::Client {
    ...
    ///   - [`content(impl ::std::convert::Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_content): <p>A valid JSON or YAML string.</p>
    ///   - [`attachments(Vec<AttachmentsSource>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::attachments) / [`set_attachments(Option<Vec<AttachmentsSource>>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_attachments): <p>A list of key-value pairs that describe attachments to a version of a document.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_name): <p>The name of the SSM document that you want to update.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_display_name): <p>The friendly name of the SSM document that you want to update. This value can differ for each version of the document. If you don't specify a value for this parameter in your request, the existing value is applied to the new document version.</p>
    ///   - [`version_name(impl ::std::convert::Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::version_name) / [`set_version_name(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_version_name): <p>An optional field specifying the version of the artifact you are updating with the document. For example, "Release 12, Update 6". This value is unique across all versions of a document, and can't be changed.</p>
    ///   - [`document_version(impl ::std::convert::Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::document_version) / [`set_document_version(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_document_version): <p>The version of the document that you want to update. Currently, Systems Manager supports updating only the latest version of the document. You can specify the version number of the latest version or use the <code>$LATEST</code> variable.</p> <note>   <p>If you change a document version for a State Manager association, Systems Manager immediately runs the association unless you previously specifed the <code>apply-only-at-cron-interval</code> parameter.</p>  </note>
    ///   - [`document_format(DocumentFormat)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::document_format) / [`set_document_format(Option<DocumentFormat>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_document_format): <p>Specify the document format for the new document version. Systems Manager supports JSON and YAML documents. JSON is the default format.</p>
    ///   - [`target_type(impl ::std::convert::Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::target_type) / [`set_target_type(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_target_type): <p>Specify a new target type for the document.</p>
