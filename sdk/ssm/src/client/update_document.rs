...
impl super::Client {
    ...
    ///   - [`content(impl Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_content): <p>A valid JSON or YAML string.</p>
    ...
    ///   - [`target_type(impl Into<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::target_type) / [`set_target_type(Option<String>)`](crate::operation::update_document::builders::UpdateDocumentFluentBuilder::set_target_type): <p>Specify a new target type for the document.</p>
