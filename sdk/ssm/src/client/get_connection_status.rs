...
impl super::Client {
    ...
    ///   - [`status(Option<ConnectionStatus>)`](crate::operation::get_connection_status::GetConnectionStatusOutput::status): <p>The status of the connection to the managed node.</p>
