...
impl super::Client {
    ...
    ///   - [`labels(impl Into<String>)`](crate::operation::label_parameter_version::builders::LabelParameterVersionFluentBuilder::labels) / [`set_labels(Option<Vec<String>>)`](crate::operation::label_parameter_version::builders::LabelParameterVersionFluentBuilder::set_labels): <p>One or more labels to attach to the specified parameter version.</p>
