...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::label_parameter_version::builders::LabelParameterVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::label_parameter_version::builders::LabelParameterVersionFluentBuilder::set_name):<br>required: **true**<br><p>The parameter name on which you want to attach one or more labels.</p><note>  <p>You can't enter the Amazon Resource Name (ARN) for a parameter, only the parameter name itself.</p> </note><br>
