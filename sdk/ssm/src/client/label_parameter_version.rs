...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::label_parameter_version::builders::LabelParameterVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::label_parameter_version::builders::LabelParameterVersionFluentBuilder::set_name): <p>The parameter name on which you want to attach one or more labels.</p>
