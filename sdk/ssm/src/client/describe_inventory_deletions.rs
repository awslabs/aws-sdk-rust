...
impl super::Client {
    ...
    ///   - [`deletion_id(impl ::std::convert::Into<String>)`](crate::operation::describe_inventory_deletions::builders::DescribeInventoryDeletionsFluentBuilder::deletion_id) / [`set_deletion_id(Option<String>)`](crate::operation::describe_inventory_deletions::builders::DescribeInventoryDeletionsFluentBuilder::set_deletion_id): <p>Specify the delete inventory ID for which you want information. This ID was returned by the <code>DeleteInventory</code> operation.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_inventory_deletions::builders::DescribeInventoryDeletionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_inventory_deletions::builders::DescribeInventoryDeletionsFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results. </p>
