...
impl super::Client  {
    ...
    pub fn describe_maintenance_windows_for_target(&self) -> crate::client::fluent_builders::DescribeMaintenanceWindowsForTarget {
                                crate::client::fluent_builders::DescribeMaintenanceWindowsForTarget::new(self.handle.clone())
                            }
}
