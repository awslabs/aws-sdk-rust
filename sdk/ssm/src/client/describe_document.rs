...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::describe_document::builders::DescribeDocumentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_document::builders::DescribeDocumentFluentBuilder::set_name):<br>required: **true**<br><p>The name of the SSM document.</p><note>  <p>If you're calling a shared SSM document from a different Amazon Web Services account, <code>Name</code> is the full Amazon Resource Name (ARN) of the document.</p> </note><br>
