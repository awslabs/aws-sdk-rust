...
impl super::Client {
    ...
    ///   - [`document_filter_list(DocumentFilter)`](crate::operation::list_documents::builders::ListDocumentsFluentBuilder::document_filter_list) / [`set_document_filter_list(Option<Vec<DocumentFilter>>)`](crate::operation::list_documents::builders::ListDocumentsFluentBuilder::set_document_filter_list): <p>This data type is deprecated. Instead, use <code>Filters</code>.</p>
