...
impl super::Client {
    ...
    ///   - [`window_id(impl Into<String>)`](crate::operation::delete_maintenance_window::builders::DeleteMaintenanceWindowFluentBuilder::window_id) / [`set_window_id(Option<String>)`](crate::operation::delete_maintenance_window::builders::DeleteMaintenanceWindowFluentBuilder::set_window_id):<br>required: **true**<br><p>The ID of the maintenance window to delete.</p><br>
