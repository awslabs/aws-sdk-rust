...
impl super::Client {
    ...
    ///   - [`type_name(impl ::std::convert::Into<String>)`](crate::operation::get_inventory_schema::builders::GetInventorySchemaFluentBuilder::type_name) / [`set_type_name(Option<String>)`](crate::operation::get_inventory_schema::builders::GetInventorySchemaFluentBuilder::set_type_name): <p>The type of inventory item to return.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_inventory_schema::builders::GetInventorySchemaFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_inventory_schema::builders::GetInventorySchemaFluentBuilder::set_next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
