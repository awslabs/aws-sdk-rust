...
impl super::Client {
    ...
    ///   - [`filters(OpsFilter)`](crate::operation::get_ops_summary::builders::GetOpsSummaryFluentBuilder::filters) / [`set_filters(Option<Vec<OpsFilter>>)`](crate::operation::get_ops_summary::builders::GetOpsSummaryFluentBuilder::set_filters): <p>Optional filters used to scope down the returned OpsData. </p>
    ...
    ///   - [`result_attributes(OpsResultAttribute)`](crate::operation::get_ops_summary::builders::GetOpsSummaryFluentBuilder::result_attributes) / [`set_result_attributes(Option<Vec<OpsResultAttribute>>)`](crate::operation::get_ops_summary::builders::GetOpsSummaryFluentBuilder::set_result_attributes): <p>The OpsData data type to return.</p>
