...
impl CreateAssociationBatch {
    ...
    pub fn set_entries(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::model::CreateAssociationBatchRequestEntry>>,
    ) -> Self {
...
impl DescribeAssociationExecutionTargets {
    ...
    pub fn set_filters(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::model::AssociationExecutionTargetsFilter>>,
    ) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
...
impl DescribeInstanceInformation {
    ...
    pub fn set_filters(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::model::InstanceInformationStringFilter>>,
    ) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
