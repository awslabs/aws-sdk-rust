...
impl super::Client {
    ...
    ///   - [`resource_type(ResourceTypeForTagging)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::resource_type) / [`set_resource_type(Option<ResourceTypeForTagging>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::set_resource_type):<br>required: **true**<br><p>Returns a list of tags for a specific resource type.</p><br>
    ///   - [`resource_id(impl Into<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::set_resource_id):<br>required: **true**<br><p>The resource ID for which you want to see a list of tags.</p><br>
