...
impl super::Client {
    ...
    ///   - [`filters(CommandFilter)`](crate::operation::list_commands::builders::ListCommandsFluentBuilder::filters) / [`set_filters(Option<Vec<CommandFilter>>)`](crate::operation::list_commands::builders::ListCommandsFluentBuilder::set_filters): <p>(Optional) One or more filters. Use a filter to return a more specific list of results. </p>
