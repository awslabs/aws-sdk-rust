...
impl super::Client {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::create_ops_metadata::builders::CreateOpsMetadataFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::create_ops_metadata::builders::CreateOpsMetadataFluentBuilder::set_resource_id): <p>A resource ID for a new Application Manager application.</p>
