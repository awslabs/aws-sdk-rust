...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_document::builders::GetDocumentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_document::builders::GetDocumentFluentBuilder::set_name): <p>The name of the SSM document.</p>
    ///   - [`version_name(impl ::std::convert::Into<String>)`](crate::operation::get_document::builders::GetDocumentFluentBuilder::version_name) / [`set_version_name(Option<String>)`](crate::operation::get_document::builders::GetDocumentFluentBuilder::set_version_name): <p>An optional field specifying the version of the artifact associated with the document. For example, "Release 12, Update 6". This value is unique across all versions of a document and can't be changed.</p>
    ///   - [`document_version(impl ::std::convert::Into<String>)`](crate::operation::get_document::builders::GetDocumentFluentBuilder::document_version) / [`set_document_version(Option<String>)`](crate::operation::get_document::builders::GetDocumentFluentBuilder::set_document_version): <p>The document version for which you want information.</p>
