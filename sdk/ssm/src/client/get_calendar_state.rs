...
impl super::Client {
    ...
    ///   - [`calendar_names(impl Into<String>)`](crate::operation::get_calendar_state::builders::GetCalendarStateFluentBuilder::calendar_names) / [`set_calendar_names(Option<Vec::<String>>)`](crate::operation::get_calendar_state::builders::GetCalendarStateFluentBuilder::set_calendar_names):<br>required: **true**<br><p>The names of Amazon Resource Names (ARNs) of the Systems Manager documents (SSM documents) that represent the calendar entries for which you want to get the state.</p><br>
