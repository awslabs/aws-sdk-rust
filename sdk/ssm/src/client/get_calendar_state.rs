...
impl super::Client {
    ...
    ///   - [`at_time(impl ::std::convert::Into<String>)`](crate::operation::get_calendar_state::builders::GetCalendarStateFluentBuilder::at_time) / [`set_at_time(Option<String>)`](crate::operation::get_calendar_state::builders::GetCalendarStateFluentBuilder::set_at_time): <p>(Optional) The specific time for which you want to get calendar state information, in <a href="https://en.wikipedia.org/wiki/ISO_8601">ISO 8601</a> format. If you don't specify a value or <code>AtTime</code>, the current time is used.</p>
