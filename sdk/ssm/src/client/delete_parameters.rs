...
impl super::Client {
    ...
    ///   - [`names(impl Into<String>)`](crate::operation::delete_parameters::builders::DeleteParametersFluentBuilder::names) / [`set_names(Option<Vec<String>>)`](crate::operation::delete_parameters::builders::DeleteParametersFluentBuilder::set_names): <p>The names of the parameters to delete. After deleting a parameter, wait for at least 30 seconds to create a parameter with the same name.</p>
