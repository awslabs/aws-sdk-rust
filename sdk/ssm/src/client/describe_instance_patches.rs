...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::set_instance_id): <p>The ID of the managed node whose patch state information should be retrieved.</p>
    ///   - [`filters(Vec<PatchOrchestratorFilter>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::filters) / [`set_filters(Option<Vec<PatchOrchestratorFilter>>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::set_filters): <p>Each element in the array is a structure containing a key-value pair.</p>  <p>Supported keys for <code>DescribeInstancePatches</code>include the following:</p>  <ul>   <li> <p> <b> <code>Classification</code> </b> </p> <p>Sample values: <code>Security</code> | <code>SecurityUpdates</code> </p> </li>   <li> <p> <b> <code>KBId</code> </b> </p> <p>Sample values: <code>KB4480056</code> | <code>java-1.7.0-openjdk.x86_64</code> </p> </li>   <li> <p> <b> <code>Severity</code> </b> </p> <p>Sample values: <code>Important</code> | <code>Medium</code> | <code>Low</code> </p> </li>   <li> <p> <b> <code>State</code> </b> </p> <p>Sample values: <code>Installed</code> | <code>InstalledOther</code> | <code>InstalledPendingReboot</code> </p> </li>  </ul>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::set_next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
    ///   - [`max_results(i32)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_instance_patches::builders::DescribeInstancePatchesFluentBuilder::set_max_results): <p>The maximum number of patches to return (per page).</p>
