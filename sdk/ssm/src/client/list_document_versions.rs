...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::list_document_versions::builders::ListDocumentVersionsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_document_versions::builders::ListDocumentVersionsFluentBuilder::set_name): <p>The name of the document. You can specify an Amazon Resource Name (ARN).</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_document_versions::builders::ListDocumentVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_document_versions::builders::ListDocumentVersionsFluentBuilder::set_next_token): <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
