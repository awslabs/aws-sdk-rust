...
impl super::Client  {
    ...
    pub fn describe_maintenance_window_executions(&self) -> crate::client::fluent_builders::DescribeMaintenanceWindowExecutions {
                                crate::client::fluent_builders::DescribeMaintenanceWindowExecutions::new(self.handle.clone())
                            }
}
