...
impl super::Client  {
    ...
    pub fn deregister_task_from_maintenance_window(&self) -> crate::client::fluent_builders::DeregisterTaskFromMaintenanceWindow {
                                crate::client::fluent_builders::DeregisterTaskFromMaintenanceWindow::new(self.handle.clone())
                            }
}
