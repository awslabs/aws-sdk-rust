...
impl super::Client {
    ...
    ///   - [`labels(impl Into<String>)`](crate::operation::unlabel_parameter_version::builders::UnlabelParameterVersionFluentBuilder::labels) / [`set_labels(Option<Vec<String>>)`](crate::operation::unlabel_parameter_version::builders::UnlabelParameterVersionFluentBuilder::set_labels): <p>One or more labels to delete from the specified parameter version.</p>
