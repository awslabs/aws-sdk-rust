...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::unlabel_parameter_version::builders::UnlabelParameterVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::unlabel_parameter_version::builders::UnlabelParameterVersionFluentBuilder::set_name): <p>The name of the parameter from which you want to delete one or more labels.</p>
