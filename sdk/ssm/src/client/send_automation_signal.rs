...
impl super::Client {
    ...
    ///   - [`automation_execution_id(impl ::std::convert::Into<String>)`](crate::operation::send_automation_signal::builders::SendAutomationSignalFluentBuilder::automation_execution_id) / [`set_automation_execution_id(Option<String>)`](crate::operation::send_automation_signal::builders::SendAutomationSignalFluentBuilder::set_automation_execution_id): <p>The unique identifier for an existing Automation execution that you want to send the signal to.</p>
