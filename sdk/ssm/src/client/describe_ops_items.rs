...
impl super::Client {
    ...
    pub fn describe_ops_items(
        &self,
    ) -> crate::operation::describe_ops_items::builders::DescribeOpsItemsFluentBuilder {
        crate::operation::describe_ops_items::builders::DescribeOpsItemsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
