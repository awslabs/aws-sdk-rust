...
impl super::Client {
    ...
    ///   - [`baseline_id(impl Into<String>)`](crate::operation::register_default_patch_baseline::builders::RegisterDefaultPatchBaselineFluentBuilder::baseline_id) / [`set_baseline_id(Option<String>)`](crate::operation::register_default_patch_baseline::builders::RegisterDefaultPatchBaselineFluentBuilder::set_baseline_id):<br>required: **true**<br><p>The ID of the patch baseline that should be the default patch baseline.</p><br>
