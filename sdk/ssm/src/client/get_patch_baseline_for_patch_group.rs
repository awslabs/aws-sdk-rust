...
impl super::Client {
    ...
    ///   - [`operating_system(OperatingSystem)`](crate::operation::get_patch_baseline_for_patch_group::builders::GetPatchBaselineForPatchGroupFluentBuilder::operating_system) / [`set_operating_system(Option<OperatingSystem>)`](crate::operation::get_patch_baseline_for_patch_group::builders::GetPatchBaselineForPatchGroupFluentBuilder::set_operating_system):<br>required: **false**<br><p>Returns the operating system rule specified for patch groups using the patch baseline. The default value is <code>WINDOWS</code>.</p><br>
