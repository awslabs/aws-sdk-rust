...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::set_resource_arn): <p>Amazon Resource Name (ARN) of the resource to which the policies are attached.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results.</p>
