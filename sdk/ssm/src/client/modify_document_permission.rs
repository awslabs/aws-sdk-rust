...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::modify_document_permission::builders::ModifyDocumentPermissionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::modify_document_permission::builders::ModifyDocumentPermissionFluentBuilder::set_name): <p>The name of the document that you want to share.</p>
