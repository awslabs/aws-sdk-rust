...
impl super::Client {
    ...
    ///   - [`baseline_id(impl Into<String>)`](crate::operation::delete_patch_baseline::builders::DeletePatchBaselineFluentBuilder::baseline_id) / [`set_baseline_id(Option<String>)`](crate::operation::delete_patch_baseline::builders::DeletePatchBaselineFluentBuilder::set_baseline_id):<br>required: **true**<br><p>The ID of the patch baseline to delete.</p><br>
