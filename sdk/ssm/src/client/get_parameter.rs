...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_parameter::builders::GetParameterFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_parameter::builders::GetParameterFluentBuilder::set_name):<br>required: **true**<br><p>The name of the parameter you want to query.</p> <p>To query by parameter label, use <code>"Name": "name:label"</code>. To query by parameter version, use <code>"Name": "name:version"</code>.</p><br>
