...
impl super::Client {
    ...
    ///   - [`association_filter_list(AssociationFilter)`](crate::operation::list_associations::builders::ListAssociationsFluentBuilder::association_filter_list) / [`set_association_filter_list(Option<Vec<AssociationFilter>>)`](crate::operation::list_associations::builders::ListAssociationsFluentBuilder::set_association_filter_list): <p>One or more filters. Use a filter to return a more specific list of results.</p> <note>   <p>Filtering associations using the <code>InstanceID</code> attribute only returns legacy associations created using the <code>InstanceID</code> attribute. Associations targeting the managed node that are part of the Target Attributes <code>ResourceGroup</code> or <code>Tags</code> aren't returned.</p>  </note>
