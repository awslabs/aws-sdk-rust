...
impl super::Client {
    ...
    ///   - [`activation_id(impl Into<String>)`](crate::operation::delete_activation::builders::DeleteActivationFluentBuilder::activation_id) / [`set_activation_id(Option<String>)`](crate::operation::delete_activation::builders::DeleteActivationFluentBuilder::set_activation_id):<br>required: **true**<br><p>The ID of the activation that you want to delete.</p><br>
