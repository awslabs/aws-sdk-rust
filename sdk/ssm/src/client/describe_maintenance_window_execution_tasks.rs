...
impl super::Client  {
    ...
    pub fn describe_maintenance_window_execution_tasks(&self) -> crate::client::fluent_builders::DescribeMaintenanceWindowExecutionTasks {
                                crate::client::fluent_builders::DescribeMaintenanceWindowExecutionTasks::new(self.handle.clone())
                            }
}
