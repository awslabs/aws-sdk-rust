...
impl super::Client {
    ...
    ///   - [`command_id(impl ::std::convert::Into<String>)`](crate::operation::cancel_command::builders::CancelCommandFluentBuilder::command_id) / [`set_command_id(Option<String>)`](crate::operation::cancel_command::builders::CancelCommandFluentBuilder::set_command_id): <p>The ID of the command you want to cancel.</p>
