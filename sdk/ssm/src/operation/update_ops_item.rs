...
impl UpdateOpsItemInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_ops_item::UpdateOpsItem, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_ops_item::ser_update_ops_item_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateOpsItem {
    type Output =
        ::std::result::Result<crate::operation::update_ops_item::UpdateOpsItemOutput, crate::operation::update_ops_item::UpdateOpsItemError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_ops_item::de_update_ops_item_http_response_with_props(status, headers, body)
        }
    }
}
