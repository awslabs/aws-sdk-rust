...
impl UpdateOpsItemInput {
    /// Consumes the builder and constructs an Operation<[`UpdateOpsItem`](crate::operation::update_ops_item::UpdateOpsItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_ops_item::UpdateOpsItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_ops_item::UpdateOpsItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_ops_item::ser_update_ops_item_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_ops_item::UpdateOpsItem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateOpsItem", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateOpsItem {
                type Output = std::result::Result<crate::operation::update_ops_item::UpdateOpsItemOutput, crate::operation::update_ops_item::UpdateOpsItemError>;
