...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateOpsItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_ops_item::de_update_ops_item_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_ops_item::de_update_ops_item_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateOpsItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_ops_item::UpdateOpsItemInput,
