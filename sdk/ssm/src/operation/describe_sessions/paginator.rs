...
impl DescribeSessionsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_sessions::paginator::DescribeSessionsPaginatorItems {
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_sessions_output_next_token(resp);
...
impl DescribeSessionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_sessions_output_sessions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
