...
impl DescribeDocumentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_document::DescribeDocument, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_document::ser_describe_document_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_document::de_describe_document_http_response_with_props(status, headers, body)
        }
    }
}
