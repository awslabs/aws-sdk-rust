...
impl DescribeDocumentInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDocument`](crate::operation::describe_document::DescribeDocument)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_document::DescribeDocument, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_document::DescribeDocumentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_document::ser_describe_document_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_document::DescribeDocument::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDocument", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDocument {
                type Output = std::result::Result<crate::operation::describe_document::DescribeDocumentOutput, crate::operation::describe_document::DescribeDocumentError>;
