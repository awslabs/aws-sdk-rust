...
impl CreateResourceDataSyncInput {
    /// Consumes the builder and constructs an Operation<[`CreateResourceDataSync`](crate::operation::create_resource_data_sync::CreateResourceDataSync)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_resource_data_sync::ser_create_resource_data_sync_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_resource_data_sync::CreateResourceDataSync::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateResourceDataSync", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResourceDataSync {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_resource_data_sync::de_create_resource_data_sync_http_response_with_props(status, headers, body)
        }
    }
}
