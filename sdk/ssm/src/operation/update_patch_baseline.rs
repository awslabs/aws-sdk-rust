...
impl UpdatePatchBaselineInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_patch_baseline::ser_update_patch_baseline_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_patch_baseline::UpdatePatchBaseline::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_patch_baseline::UpdatePatchBaselineError
{
