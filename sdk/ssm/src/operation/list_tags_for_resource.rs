...
impl ListTagsForResource {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::list_tags_for_resource::ListTagsForResourceInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::list_tags_for_resource::ListTagsForResourceOutput::SCHEMA;
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "ListTagsForResource", input, runtime_plugins, stop_point)
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
            ...
            let err = match error_code {
                ...
                "InvalidResourceId" => crate::operation::list_tags_for_resource::ListTagsForResourceError::InvalidResourceId({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                ...
                "InvalidResourceType" => crate::operation::list_tags_for_resource::ListTagsForResourceError::InvalidResourceType({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::list_tags_for_resource::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::list_tags_for_resource::ListTagsForResourceError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::list_tags_for_resource::ListTagsForResourceError::generic(generic),
                    }
                }
            };
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::list_tags_for_resource::ListTagsForResourceOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
