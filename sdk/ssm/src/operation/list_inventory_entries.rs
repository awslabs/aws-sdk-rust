...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListInventoryEntriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_inventory_entries::de_list_inventory_entries_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_inventory_entries::de_list_inventory_entries_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListInventoryEntriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_inventory_entries::ListInventoryEntriesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_inventory_entries::ser_list_inventory_entries_input(
            &input,
        )?);
