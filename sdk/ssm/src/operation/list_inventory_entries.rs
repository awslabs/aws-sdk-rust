...
impl ListInventoryEntriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_inventory_entries::ser_list_inventory_entries_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_inventory_entries::ListInventoryEntries::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_inventory_entries::ListInventoryEntriesError
{
