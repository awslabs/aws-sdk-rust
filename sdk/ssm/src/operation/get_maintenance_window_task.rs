...
impl GetMaintenanceWindowTaskInput {
    /// Consumes the builder and constructs an Operation<[`GetMaintenanceWindowTask`](crate::operation::get_maintenance_window_task::GetMaintenanceWindowTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_maintenance_window_task::GetMaintenanceWindowTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_maintenance_window_task::GetMaintenanceWindowTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_maintenance_window_task::ser_get_maintenance_window_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_maintenance_window_task::GetMaintenanceWindowTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetMaintenanceWindowTask", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetMaintenanceWindowTask`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetMaintenanceWindowTask {
                type Output = std::result::Result<crate::operation::get_maintenance_window_task::GetMaintenanceWindowTaskOutput, crate::operation::get_maintenance_window_task::GetMaintenanceWindowTaskError>;
