...
impl GetMaintenanceWindowTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_maintenance_window_task::GetMaintenanceWindowTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMaintenanceWindowTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_maintenance_window_task::de_get_maintenance_window_task_http_response_with_props(status, headers, body)
        }
    }
