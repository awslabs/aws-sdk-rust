...
impl DescribeAssociationExecutionTargetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssociationExecutionTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_association_execution_targets::de_describe_association_execution_targets_http_response_with_props(
                status, headers, body,
            )
        }
    }
