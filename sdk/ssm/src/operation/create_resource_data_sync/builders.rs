...
impl crate::operation::create_resource_data_sync::builders::CreateResourceDataSyncInputBuilder {
...
/// <p>You can configure Systems Manager Inventory to use the <code>SyncToDestination</code> type to synchronize Inventory data from multiple Amazon Web Services Regions to a single Amazon Simple Storage Service (Amazon S3) bucket. For more information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/inventory-create-resource-data-sync.html">Creatinga a resource data sync for Inventory</a> in the <i>Amazon Web Services Systems Manager User Guide</i>.</p>
...
impl CreateResourceDataSyncFluentBuilder {
    /// Creates a new `CreateResourceDataSyncFluentBuilder`.
