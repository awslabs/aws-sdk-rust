    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp =
                        crate::operation::describe_available_patches::DescribeAvailablePatches::orchestrate(&runtime_plugins, input.clone()).await;
...
impl DescribeAvailablePatchesPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_available_patches_output_patches(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
