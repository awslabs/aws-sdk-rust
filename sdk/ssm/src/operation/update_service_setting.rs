...
impl UpdateServiceSettingInput {
    /// Consumes the builder and constructs an Operation<[`UpdateServiceSetting`](crate::operation::update_service_setting::UpdateServiceSetting)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_service_setting::UpdateServiceSetting, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_service_setting::UpdateServiceSettingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_service_setting::ser_update_service_setting_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_service_setting::UpdateServiceSetting::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateServiceSetting", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateServiceSetting {
                type Output = std::result::Result<crate::operation::update_service_setting::UpdateServiceSettingOutput, crate::operation::update_service_setting::UpdateServiceSettingError>;
