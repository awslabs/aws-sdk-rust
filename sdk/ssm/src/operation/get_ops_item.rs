...
impl GetOpsItem {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::get_ops_item::GetOpsItemInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::get_ops_item::GetOpsItemOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_ops_item::GetOpsItemError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_ops_item::GetOpsItemOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "GetOpsItem", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.GetOpsItem",
                "rpc.service" = "SSM",
                "rpc.method" = "GetOpsItem",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOpsItem {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetOpsItem");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetOpsItemRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetOpsItemResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetOpsItem")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetOpsItem", "SSM"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOpsItem")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetOpsItemTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetOpsItemEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct GetOpsItemTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOpsItemTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetOpsItemInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("OpsItemId") {
            if let ::std::option::Option::Some(value) = input.ops_item_id.as_deref() {
                captured.insert("OpsItemId", value);
            }
        }
        if requested.should_capture("OpsItemArn") {
            if let ::std::option::Option::Some(value) = input.ops_item_arn.as_deref() {
                captured.insert("OpsItemArn", value);
            }
        }
...
#[derive(Debug)]
struct GetOpsItemResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOpsItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
            ...
            let error_code = match generic.code() {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::get_ops_item::GetOpsItemError::unhandled(generic)),
                    ))
                }
            };
            let _error_message = generic.message().map(|msg| msg.to_owned());
            let err = match error_code {
                "InternalServerError" => crate::operation::get_ops_item::GetOpsItemError::InternalServerError({
                ...
                "OpsItemAccessDeniedException" => crate::operation::get_ops_item::GetOpsItemError::OpsItemAccessDeniedException({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::OpsItemAccessDeniedException::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                ...
                "OpsItemNotFoundException" => crate::operation::get_ops_item::GetOpsItemError::OpsItemNotFoundException({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::OpsItemNotFoundException::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::get_ops_item::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::get_ops_item::GetOpsItemError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::get_ops_item::GetOpsItemError::generic(generic),
                    }
                }
            };
            ...
            let protocol = _cfg
                .load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                .expect("a SharedClientProtocol is required");
            let mut deser = protocol.deserialize_response(response, GetOpsItem::OUTPUT_SCHEMA, _cfg).map_err(|e| {
                ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
            })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::get_ops_item::GetOpsItemOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct GetOpsItemRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOpsItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<crate::operation::get_ops_item::GetOpsItemInput>().expect("correct type");

        let protocol = _cfg
            .load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
            .expect("a SharedClientProtocol is required");
        let mut request = protocol
            .serialize_request(&input, GetOpsItem::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct GetOpsItemEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOpsItemEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetOpsItemEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetOpsItemInput>()
            .ok_or("failed to downcast to GetOpsItemInput")?;
...
pub enum GetOpsItemError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetOpsItemError) for what information is available for the error.")]
...
impl GetOpsItemError {
    ...
    /// Creates the `GetOpsItemError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OpsItemAccessDeniedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::OpsItemNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetOpsItemError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_ops_item::GetOpsItemError {
