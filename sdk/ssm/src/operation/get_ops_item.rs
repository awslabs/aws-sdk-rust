...
impl GetOpsItemInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_ops_item::GetOpsItem, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_ops_item::ser_get_ops_item_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOpsItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ops_item::de_get_ops_item_http_response_with_props(status, headers, body)
        }
    }
}
