...
/// Orchestration and serialization glue logic for `GetDefaultPatchBaseline`.
...
impl GetDefaultPatchBaseline {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDefaultPatchBaseline {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDefaultPatchBaseline");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDefaultPatchBaselineRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDefaultPatchBaselineResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDefaultPatchBaseline")
...
.with_interceptor(GetDefaultPatchBaselineEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError>::new());
...
#[derive(Debug)]
            struct GetDefaultPatchBaselineResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDefaultPatchBaselineResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_default_patch_baseline::de_get_default_patch_baseline_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_default_patch_baseline::de_get_default_patch_baseline_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDefaultPatchBaselineRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDefaultPatchBaselineRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_default_patch_baseline::ser_get_default_patch_baseline_input(&input)?);
...
#[derive(Debug)]
            struct GetDefaultPatchBaselineEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDefaultPatchBaselineEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDefaultPatchBaselineEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDefaultPatchBaselineInput>()
                        .ok_or("failed to downcast to GetDefaultPatchBaselineInput")?;
...
pub enum GetDefaultPatchBaselineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDefaultPatchBaselineError) for what information is available for the error.")]
...
impl GetDefaultPatchBaselineError {
    /// Creates the `GetDefaultPatchBaselineError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDefaultPatchBaselineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDefaultPatchBaselineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError {
...
mod _get_default_patch_baseline_output;
