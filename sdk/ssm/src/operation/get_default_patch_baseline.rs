...
impl GetDefaultPatchBaseline {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "GetDefaultPatchBaseline", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.GetDefaultPatchBaseline",
                "rpc.service" = "SSM",
                "rpc.method" = "GetDefaultPatchBaseline",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDefaultPatchBaseline {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDefaultPatchBaselineRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDefaultPatchBaselineResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDefaultPatchBaseline")
                .build()
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                "InternalServerError" => crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError::InternalServerError({
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::get_default_patch_baseline::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, GetDefaultPatchBaseline::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDefaultPatchBaselineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, GetDefaultPatchBaseline::INPUT_SCHEMA, "/", _cfg)
