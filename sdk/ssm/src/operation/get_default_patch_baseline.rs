...
impl GetDefaultPatchBaselineInput {
    /// Consumes the builder and constructs an Operation<[`GetDefaultPatchBaseline`](crate::operation::get_default_patch_baseline::GetDefaultPatchBaseline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_default_patch_baseline::GetDefaultPatchBaseline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_default_patch_baseline::ser_get_default_patch_baseline_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_default_patch_baseline::GetDefaultPatchBaseline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDefaultPatchBaseline", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDefaultPatchBaseline`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDefaultPatchBaseline {
                type Output = std::result::Result<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput, crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError>;
