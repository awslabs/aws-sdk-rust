...
impl ListComplianceSummariesInput {
    /// Consumes the builder and constructs an Operation<[`ListComplianceSummaries`](crate::operation::list_compliance_summaries::ListComplianceSummaries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_compliance_summaries::ListComplianceSummaries, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_compliance_summaries::ListComplianceSummariesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_compliance_summaries::ser_list_compliance_summaries_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_compliance_summaries::ListComplianceSummaries::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListComplianceSummaries", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListComplianceSummaries {
                type Output = std::result::Result<crate::operation::list_compliance_summaries::ListComplianceSummariesOutput, crate::operation::list_compliance_summaries::ListComplianceSummariesError>;
