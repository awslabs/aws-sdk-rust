...
impl UnlabelParameterVersionInput {
    /// Consumes the builder and constructs an Operation<[`UnlabelParameterVersion`](crate::operation::unlabel_parameter_version::UnlabelParameterVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::unlabel_parameter_version::UnlabelParameterVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::unlabel_parameter_version::UnlabelParameterVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_unlabel_parameter_version::ser_unlabel_parameter_version_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::unlabel_parameter_version::UnlabelParameterVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UnlabelParameterVersion", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UnlabelParameterVersion`.
...
impl aws_smithy_http::response::ParseStrictResponse for UnlabelParameterVersion {
                type Output = std::result::Result<crate::operation::unlabel_parameter_version::UnlabelParameterVersionOutput, crate::operation::unlabel_parameter_version::UnlabelParameterVersionError>;
