...
impl DescribeMaintenanceWindowTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_maintenance_window_tasks::de_describe_maintenance_window_tasks_http_response_with_props(
                status, headers, body,
            )
        }
    }
