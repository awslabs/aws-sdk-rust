...
impl DescribeInstancePatchStatesForPatchGroupPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_instance_patch_states_for_patch_group::paginator::DescribeInstancePatchStatesForPatchGroupPaginatorItems {
...
impl DescribeInstancePatchStatesForPatchGroupPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_instance_patch_states_for_patch_group_output_output_instance_patch_states(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
