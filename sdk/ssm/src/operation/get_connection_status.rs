...
impl GetConnectionStatusInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_connection_status::ser_get_connection_status_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_connection_status::GetConnectionStatus::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_connection_status::GetConnectionStatusError
{
