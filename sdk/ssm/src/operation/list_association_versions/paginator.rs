...
impl ListAssociationVersionsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_association_versions::paginator::ListAssociationVersionsPaginatorItems
    {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_association_versions_output_next_token(
                                    resp,
                                );
