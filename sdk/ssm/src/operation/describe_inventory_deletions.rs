...
impl DescribeInventoryDeletionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_inventory_deletions::DescribeInventoryDeletions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInventoryDeletions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_inventory_deletions::de_describe_inventory_deletions_http_response_with_props(status, headers, body)
        }
    }
}
