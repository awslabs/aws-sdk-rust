...
impl DescribeInventoryDeletionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInventoryDeletions`](crate::operation::describe_inventory_deletions::DescribeInventoryDeletions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_inventory_deletions::DescribeInventoryDeletions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_inventory_deletions::DescribeInventoryDeletionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_inventory_deletions::ser_describe_inventory_deletions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_inventory_deletions::DescribeInventoryDeletions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeInventoryDeletions", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeInventoryDeletions`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInventoryDeletions {
                type Output = std::result::Result<crate::operation::describe_inventory_deletions::DescribeInventoryDeletionsOutput, crate::operation::describe_inventory_deletions::DescribeInventoryDeletionsError>;
