...
impl GetOpsSummaryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_ops_summary::GetOpsSummary, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_ops_summary::ser_get_ops_summary_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOpsSummary {
    type Output =
        ::std::result::Result<crate::operation::get_ops_summary::GetOpsSummaryOutput, crate::operation::get_ops_summary::GetOpsSummaryError>;
