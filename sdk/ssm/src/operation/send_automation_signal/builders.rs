...
impl SendAutomationSignalFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_automation_signal::SendAutomationSignalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_automation_signal::SendAutomationSignalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_automation_signal::SendAutomationSignalOutput, crate::operation::send_automation_signal::SendAutomationSignalError, Self> {
