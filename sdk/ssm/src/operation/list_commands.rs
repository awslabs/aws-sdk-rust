...
impl ListCommandsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_commands::ListCommands, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_commands::ser_list_commands_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCommands {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_commands::de_list_commands_http_response_with_props(status, headers, body)
        }
    }
