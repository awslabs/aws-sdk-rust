...
impl ListCommandsInput {
    /// Consumes the builder and constructs an Operation<[`ListCommands`](crate::operation::list_commands::ListCommands)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_commands::ListCommands, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_commands::ListCommandsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_commands::ser_list_commands_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_commands::ListCommands::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListCommands", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListCommands`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListCommands {
                type Output = std::result::Result<crate::operation::list_commands::ListCommandsOutput, crate::operation::list_commands::ListCommandsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_commands::de_list_commands_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_commands::de_list_commands_http_response(response)
                     }
                }
            }
