...
impl ListCommandsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_commands::ListCommands::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCommands {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_commands::de_list_commands_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_commands::de_list_commands_http_response_with_props(
                status, headers, body,
            )
        }
    }
