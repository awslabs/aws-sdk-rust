...
impl DescribeMaintenanceWindowExecutionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_maintenance_window_executions::DescribeMaintenanceWindowExecutions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_maintenance_window_executions::de_describe_maintenance_window_executions_http_response_with_props(
                status, headers, body,
            )
        }
    }
