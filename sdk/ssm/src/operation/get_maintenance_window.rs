...
impl GetMaintenanceWindowInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_maintenance_window::ser_get_maintenance_window_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_maintenance_window::GetMaintenanceWindow::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_maintenance_window::GetMaintenanceWindowError
{
