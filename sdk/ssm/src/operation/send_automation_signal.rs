...
impl SendAutomationSignalInput {
    /// Consumes the builder and constructs an Operation<[`SendAutomationSignal`](crate::operation::send_automation_signal::SendAutomationSignal)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_automation_signal::SendAutomationSignal::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SendAutomationSignal", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendAutomationSignal {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_automation_signal::de_send_automation_signal_http_response_with_props(status, headers, body)
        }
    }
}
