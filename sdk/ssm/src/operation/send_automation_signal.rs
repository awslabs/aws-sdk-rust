...
impl SendAutomationSignalInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_automation_signal::SendAutomationSignal, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_automation_signal::SendAutomationSignalInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_send_automation_signal::ser_send_automation_signal_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for SendAutomationSignal {
                type Output = std::result::Result<crate::operation::send_automation_signal::SendAutomationSignalOutput, crate::operation::send_automation_signal::SendAutomationSignalError>;
