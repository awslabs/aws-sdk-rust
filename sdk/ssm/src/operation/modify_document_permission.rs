...
impl ModifyDocumentPermission {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::modify_document_permission::ModifyDocumentPermissionInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::modify_document_permission::ModifyDocumentPermissionOutput::SCHEMA;
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "ModifyDocumentPermission", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.service" = "SSM",
                "rpc.method" = "ModifyDocumentPermission",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDocumentPermission")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyDocumentPermissionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyDocumentPermissionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDocumentPermissionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyDocumentPermissionInput>() else {
        ...
        if requested.should_capture("SharedDocumentVersion") {
            if let ::std::option::Option::Some(value) = input.shared_document_version.as_deref() {
                captured.insert("SharedDocumentVersion", value);
            }
        }
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::modify_document_permission::ModifyDocumentPermissionError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                "DocumentLimitExceeded" => crate::operation::modify_document_permission::ModifyDocumentPermissionError::DocumentLimitExceeded({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::DocumentLimitExceeded::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                ...
                "DocumentPermissionLimit" => crate::operation::modify_document_permission::ModifyDocumentPermissionError::DocumentPermissionLimit({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::DocumentPermissionLimit::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                ...
                "InvalidPermissionType" => crate::operation::modify_document_permission::ModifyDocumentPermissionError::InvalidPermissionType({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::InvalidPermissionType::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::modify_document_permission::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::modify_document_permission::ModifyDocumentPermissionError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::modify_document_permission::ModifyDocumentPermissionError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, ModifyDocumentPermission::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::modify_document_permission::ModifyDocumentPermissionOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyDocumentPermissionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request = protocol
            .serialize_request(&input, ModifyDocumentPermission::INPUT_SCHEMA, "/", _cfg)
