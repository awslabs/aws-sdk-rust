...
impl ModifyDocumentPermissionInput {
    /// Consumes the builder and constructs an Operation<[`ModifyDocumentPermission`](crate::operation::modify_document_permission::ModifyDocumentPermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_document_permission::ModifyDocumentPermission, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_document_permission::ModifyDocumentPermissionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_document_permission::ser_modify_document_permission_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_document_permission::ModifyDocumentPermission::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyDocumentPermission", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ModifyDocumentPermission`.
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyDocumentPermission {
                type Output = std::result::Result<crate::operation::modify_document_permission::ModifyDocumentPermissionOutput, crate::operation::modify_document_permission::ModifyDocumentPermissionError>;
