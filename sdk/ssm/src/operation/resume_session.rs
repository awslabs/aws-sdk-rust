...
impl ResumeSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resume_session::ResumeSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resume_session::de_resume_session_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_resume_session::de_resume_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
