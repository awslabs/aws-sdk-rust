...
impl StartAutomationExecutionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_automation_execution::StartAutomationExecutionInput, ::aws_smithy_types::error::operation::BuildError> {
