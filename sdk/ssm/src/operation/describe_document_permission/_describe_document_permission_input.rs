...
impl DescribeDocumentPermissionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_document_permission::DescribeDocumentPermissionInput, ::aws_smithy_types::error::operation::BuildError> {
