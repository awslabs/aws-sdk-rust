...
impl DescribeDocumentPermissionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_document_permission::DescribeDocumentPermissionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_document_permission::DescribeDocumentPermissionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_document_permission::DescribeDocumentPermissionOutput, crate::operation::describe_document_permission::DescribeDocumentPermissionError, Self> {
