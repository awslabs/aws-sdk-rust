...
impl DescribeEffectivePatchesForPatchBaselinePaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_effective_patches_for_patch_baseline::paginator::DescribeEffectivePatchesForPatchBaselinePaginatorItems {
...
impl DescribeEffectivePatchesForPatchBaselinePaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_effective_patches_for_patch_baseline_output_output_effective_patches(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
