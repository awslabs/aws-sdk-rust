...
impl GetOpsSummaryPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_ops_summary::paginator::GetOpsSummaryPaginatorItems {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_get_ops_summary_output_next_token(resp);
...
impl GetOpsSummaryPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_ops_summary_output_entities(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
