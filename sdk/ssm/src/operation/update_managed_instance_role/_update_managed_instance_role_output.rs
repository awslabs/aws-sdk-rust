...
static UPDATEMANAGEDINSTANCEROLEOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static UPDATEMANAGEDINSTANCEROLEOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#UpdateManagedInstanceRoleOutput",
        "com.amazonaws.ssm.synthetic",
        "UpdateManagedInstanceRoleOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&UPDATEMANAGEDINSTANCEROLEOUTPUT_MEMBER__REQUEST_ID],
)
.with_original_name("UpdateManagedInstanceRoleResult");
impl UpdateManagedInstanceRoleOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &UPDATEMANAGEDINSTANCEROLEOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for UpdateManagedInstanceRoleOutput {
...
impl UpdateManagedInstanceRoleOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&UPDATEMANAGEDINSTANCEROLEOUTPUT_SCHEMA, &mut |member, deser| {
