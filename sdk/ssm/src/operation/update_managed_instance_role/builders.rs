...
impl UpdateManagedInstanceRoleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleOutput, crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError, Self> {
