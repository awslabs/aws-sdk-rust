...
impl UpdateDocumentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_document::UpdateDocument, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_document::ser_update_document_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_document::UpdateDocument::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDocument", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_document::de_update_document_http_response_with_props(status, headers, body)
        }
    }
}
