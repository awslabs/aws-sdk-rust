...
impl GetAutomationExecutionInput {
    /// Consumes the builder and constructs an Operation<[`GetAutomationExecution`](crate::operation::get_automation_execution::GetAutomationExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_automation_execution::GetAutomationExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_automation_execution::GetAutomationExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_automation_execution::ser_get_automation_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_automation_execution::GetAutomationExecution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAutomationExecution", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAutomationExecution {
                type Output = std::result::Result<crate::operation::get_automation_execution::GetAutomationExecutionOutput, crate::operation::get_automation_execution::GetAutomationExecutionError>;
