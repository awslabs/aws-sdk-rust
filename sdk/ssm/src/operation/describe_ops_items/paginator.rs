...
impl DescribeOpsItemsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_ops_items::paginator::DescribeOpsItemsPaginatorItems {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_ops_items_output_next_token(resp);
...
impl DescribeOpsItemsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_ops_items_output_ops_item_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
