...
static STOPAUTOMATIONEXECUTIONOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static STOPAUTOMATIONEXECUTIONOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#StopAutomationExecutionOutput",
        "com.amazonaws.ssm.synthetic",
        "StopAutomationExecutionOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&STOPAUTOMATIONEXECUTIONOUTPUT_MEMBER__REQUEST_ID],
)
.with_original_name("StopAutomationExecutionResult");
impl StopAutomationExecutionOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &STOPAUTOMATIONEXECUTIONOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for StopAutomationExecutionOutput {
...
impl StopAutomationExecutionOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&STOPAUTOMATIONEXECUTIONOUTPUT_SCHEMA, &mut |member, deser| {
