...
impl StartAssociationsOnceInput {
    /// Consumes the builder and constructs an Operation<[`StartAssociationsOnce`](crate::operation::start_associations_once::StartAssociationsOnce)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_associations_once::StartAssociationsOnce, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_associations_once::StartAssociationsOnceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_associations_once::ser_start_associations_once_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_associations_once::StartAssociationsOnce::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartAssociationsOnce", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartAssociationsOnce {
                type Output = std::result::Result<crate::operation::start_associations_once::StartAssociationsOnceOutput, crate::operation::start_associations_once::StartAssociationsOnceError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_associations_once::de_start_associations_once_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_associations_once::de_start_associations_once_http_response(response)
                     }
                }
            }
