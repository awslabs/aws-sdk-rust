...
impl UpdateAssociationStatusInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAssociationStatus`](crate::operation::update_association_status::UpdateAssociationStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_association_status::UpdateAssociationStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_association_status::UpdateAssociationStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_association_status::ser_update_association_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_association_status::UpdateAssociationStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateAssociationStatus", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAssociationStatus {
                type Output = std::result::Result<crate::operation::update_association_status::UpdateAssociationStatusOutput, crate::operation::update_association_status::UpdateAssociationStatusError>;
