...
impl GetPatchBaselineForPatchGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_patch_baseline_for_patch_group::GetPatchBaselineForPatchGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPatchBaselineForPatchGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_patch_baseline_for_patch_group::de_get_patch_baseline_for_patch_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
