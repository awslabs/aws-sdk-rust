...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPatchBaselineForPatchGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_patch_baseline_for_patch_group::de_get_patch_baseline_for_patch_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_patch_baseline_for_patch_group::GetPatchBaselineForPatchGroupError
{
