...
impl GetCalendarStateInput {
    /// Consumes the builder and constructs an Operation<[`GetCalendarState`](crate::operation::get_calendar_state::GetCalendarState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_calendar_state::GetCalendarState, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_calendar_state::GetCalendarStateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_calendar_state::ser_get_calendar_state_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_calendar_state::GetCalendarState::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetCalendarState", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetCalendarState {
                type Output = std::result::Result<crate::operation::get_calendar_state::GetCalendarStateOutput, crate::operation::get_calendar_state::GetCalendarStateError>;
