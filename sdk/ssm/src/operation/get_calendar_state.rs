...
impl GetCalendarStateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_calendar_state::ser_get_calendar_state_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCalendarState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_calendar_state::de_get_calendar_state_http_response_with_props(status, headers, body)
        }
    }
}
