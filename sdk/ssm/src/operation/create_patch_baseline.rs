...
impl CreatePatchBaselineInput {
    /// Consumes the builder and constructs an Operation<[`CreatePatchBaseline`](crate::operation::create_patch_baseline::CreatePatchBaseline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_patch_baseline::CreatePatchBaseline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_patch_baseline::CreatePatchBaselineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_patch_baseline::ser_create_patch_baseline_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_patch_baseline::CreatePatchBaseline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePatchBaseline", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePatchBaseline {
                type Output = std::result::Result<crate::operation::create_patch_baseline::CreatePatchBaselineOutput, crate::operation::create_patch_baseline::CreatePatchBaselineError>;
