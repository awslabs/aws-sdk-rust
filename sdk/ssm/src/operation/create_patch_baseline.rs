...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePatchBaselineResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_patch_baseline::de_create_patch_baseline_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_patch_baseline::de_create_patch_baseline_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePatchBaselineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_patch_baseline::CreatePatchBaselineInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_patch_baseline::ser_create_patch_baseline_input(
            &input,
        )?);
