...
/// Orchestration and serialization glue logic for `CreatePatchBaseline`.
...
impl CreatePatchBaseline {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::create_patch_baseline::CreatePatchBaselineInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::create_patch_baseline::CreatePatchBaselineOutput::SCHEMA;
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::create_patch_baseline::CreatePatchBaselineInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_patch_baseline::CreatePatchBaselineError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_patch_baseline::CreatePatchBaselineOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "CreatePatchBaseline", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.CreatePatchBaseline",
                "rpc.service" = "SSM",
                "rpc.method" = "CreatePatchBaseline",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_patch_baseline::CreatePatchBaselineInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePatchBaseline {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreatePatchBaseline");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreatePatchBaselineRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreatePatchBaselineResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreatePatchBaseline")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePatchBaseline")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreatePatchBaselineTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreatePatchBaselineEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreatePatchBaselineTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePatchBaselineTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreatePatchBaselineInput>() else {
...
#[derive(Debug)]
struct CreatePatchBaselineResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePatchBaselineResponseDeserializer {
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::create_patch_baseline::CreatePatchBaselineError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                ...
                "ResourceLimitExceededException" => {
                    crate::operation::create_patch_baseline::CreatePatchBaselineError::ResourceLimitExceededException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::create_patch_baseline::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::create_patch_baseline::CreatePatchBaselineError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::create_patch_baseline::CreatePatchBaselineError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, CreatePatchBaseline::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::create_patch_baseline::CreatePatchBaselineOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct CreatePatchBaselineRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePatchBaselineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_patch_baseline::CreatePatchBaselineInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, CreatePatchBaseline::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct CreatePatchBaselineEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePatchBaselineEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreatePatchBaselineEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreatePatchBaselineInput>()
            .ok_or("failed to downcast to CreatePatchBaselineInput")?;
...
pub enum CreatePatchBaselineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreatePatchBaselineError) for what information is available for the error.")]
...
impl CreatePatchBaselineError {
    ...
    /// Creates the `CreatePatchBaselineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreatePatchBaselineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_patch_baseline::CreatePatchBaselineError {
...
mod _create_patch_baseline_output;
