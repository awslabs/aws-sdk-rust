...
impl CreatePatchBaselineInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_patch_baseline::ser_create_patch_baseline_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_patch_baseline::CreatePatchBaseline::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_patch_baseline::CreatePatchBaselineError
{
