...
impl RegisterTargetWithMaintenanceWindowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindow,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterTargetWithMaintenanceWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_target_with_maintenance_window::de_register_target_with_maintenance_window_http_response_with_props(
                status, headers, body,
            )
        }
    }
