...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterTargetWithMaintenanceWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_target_with_maintenance_window::de_register_target_with_maintenance_window_http_response_with_props(status, headers, body)
        }
    }
}
