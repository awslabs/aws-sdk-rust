...
impl RegisterTargetWithMaintenanceWindow {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "SSM",
            "rpc.method" = "RegisterTargetWithMaintenanceWindow",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterTargetWithMaintenanceWindow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterTargetWithMaintenanceWindow");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterTargetWithMaintenanceWindowRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterTargetWithMaintenanceWindowResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterTargetWithMaintenanceWindow")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterTargetWithMaintenanceWindow")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterTargetWithMaintenanceWindowTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterTargetWithMaintenanceWindowEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct RegisterTargetWithMaintenanceWindowTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterTargetWithMaintenanceWindowTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterTargetWithMaintenanceWindowInput>() else {
...
#[derive(Debug)]
struct RegisterTargetWithMaintenanceWindowResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterTargetWithMaintenanceWindowResponseDeserializer {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::unhandled(generic),
                        ),
                    ))
                }
            };
...
let mut tmp = match protocol.deserialize_error_response(response, _cfg)
                        .and_then(|mut deser| crate::types::error::DoesNotExistException::deserialize_with_response(&mut *deser, response.headers(), response.status().into(), body))
                    {
...
let mut tmp = match protocol.deserialize_error_response(response, _cfg)
                        .and_then(|mut deser| crate::types::error::IdempotentParameterMismatch::deserialize_with_response(&mut *deser, response.headers(), response.status().into(), body))
                    {
                        ::std::result::Result::Ok(val) => val,
                        ::std::result::Result::Err(e) => return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))),
                    };
...
let mut tmp = match protocol.deserialize_error_response(response, _cfg)
                        .and_then(|mut deser| crate::types::error::ResourceLimitExceededException::deserialize_with_response(&mut *deser, response.headers(), response.status().into(), body))
                    {
                        ::std::result::Result::Ok(val) => val,
                        ::std::result::Result::Err(e) => return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))),
                    };
...
_ => {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::register_target_with_maintenance_window::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::generic(generic),
                    }
                }
};
            ...
            let mut deser = protocol
                .deserialize_response(response, RegisterTargetWithMaintenanceWindow::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output =
                crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowOutput::deserialize_with_response(
                    &mut *deser,
                    _response_headers,
...
#[derive(Debug)]
struct RegisterTargetWithMaintenanceWindowRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterTargetWithMaintenanceWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, RegisterTargetWithMaintenanceWindow::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct RegisterTargetWithMaintenanceWindowEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterTargetWithMaintenanceWindowEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "RegisterTargetWithMaintenanceWindowEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<RegisterTargetWithMaintenanceWindowInput>()
            .ok_or("failed to downcast to RegisterTargetWithMaintenanceWindowInput")?;
...
pub enum RegisterTargetWithMaintenanceWindowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterTargetWithMaintenanceWindowError) for what information is available for the error.")]
...
impl RegisterTargetWithMaintenanceWindowError {
    ...
    /// Creates the `RegisterTargetWithMaintenanceWindowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterTargetWithMaintenanceWindowError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterTargetWithMaintenanceWindowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError {
...
mod _register_target_with_maintenance_window_output;
