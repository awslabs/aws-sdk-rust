...
impl RegisterTargetWithMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`RegisterTargetWithMaintenanceWindow`](crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_target_with_maintenance_window::ser_register_target_with_maintenance_window_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindow::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterTargetWithMaintenanceWindow", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterTargetWithMaintenanceWindow {
                type Output = std::result::Result<crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowOutput, crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError>;
