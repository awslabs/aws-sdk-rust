...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterTargetWithMaintenanceWindowResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_target_with_maintenance_window::de_register_target_with_maintenance_window_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_target_with_maintenance_window::de_register_target_with_maintenance_window_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterTargetWithMaintenanceWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_register_target_with_maintenance_window::ser_register_target_with_maintenance_window_input(&input)?,
        );
