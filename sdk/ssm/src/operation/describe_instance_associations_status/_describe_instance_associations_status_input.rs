...
impl DescribeInstanceAssociationsStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusInput, ::aws_smithy_types::error::operation::BuildError> {
