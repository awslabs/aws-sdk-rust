...
impl ModifyDocumentPermissionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_document_permission::ModifyDocumentPermissionInput, ::aws_smithy_types::error::operation::BuildError> {
