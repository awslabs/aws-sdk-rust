...
impl TerminateSessionInput {
    /// Consumes the builder and constructs an Operation<[`TerminateSession`](crate::operation::terminate_session::TerminateSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::terminate_session::TerminateSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::terminate_session::TerminateSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_session::TerminateSession::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TerminateSession", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for TerminateSession {
                type Output = std::result::Result<crate::operation::terminate_session::TerminateSessionOutput, crate::operation::terminate_session::TerminateSessionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_terminate_session::de_terminate_session_http_error(response)
                     } else {
                        crate::protocol_serde::shape_terminate_session::de_terminate_session_http_response(response)
                     }
                }
            }
