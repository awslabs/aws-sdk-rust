...
impl TerminateSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::terminate_session::TerminateSession, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_terminate_session::ser_terminate_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_terminate_session::de_terminate_session_http_response_with_props(status, headers, body)
        }
    }
}
