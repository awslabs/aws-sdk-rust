...
impl TerminateSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::terminate_session::TerminateSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_terminate_session::de_terminate_session_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::terminate_session::TerminateSessionError
{
