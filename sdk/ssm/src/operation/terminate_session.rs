...
/// Orchestration and serialization glue logic for `TerminateSession`.
...
impl TerminateSession {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::terminate_session::TerminateSessionInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::terminate_session::TerminateSessionOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::terminate_session::TerminateSessionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::terminate_session::TerminateSessionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "TerminateSession", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.TerminateSession",
                "rpc.service" = "SSM",
                "rpc.method" = "TerminateSession",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TerminateSession {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TerminateSession");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            TerminateSessionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            TerminateSessionResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("TerminateSession", "SSM"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TerminateSession")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                TerminateSessionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                TerminateSessionEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct TerminateSessionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TerminateSessionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<TerminateSessionInput>() else {
...
#[derive(Debug)]
struct TerminateSessionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TerminateSessionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
            ...
            let error_code = match generic.code() {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::terminate_session::TerminateSessionError::unhandled(
                            generic,
                        )),
                    ))
                }
            ...
            let err = match error_code {
                "InternalServerError" => crate::operation::terminate_session::TerminateSessionError::InternalServerError({
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::terminate_session::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::terminate_session::TerminateSessionError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::terminate_session::TerminateSessionError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, TerminateSession::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::terminate_session::TerminateSessionOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct TerminateSessionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TerminateSessionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::terminate_session::TerminateSessionInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, TerminateSession::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct TerminateSessionEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TerminateSessionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "TerminateSessionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<TerminateSessionInput>()
            .ok_or("failed to downcast to TerminateSessionInput")?;
...
pub enum TerminateSessionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TerminateSessionError) for what information is available for the error.")]
...
impl TerminateSessionError {
    ...
    /// Creates the `TerminateSessionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TerminateSessionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::terminate_session::TerminateSessionError {
