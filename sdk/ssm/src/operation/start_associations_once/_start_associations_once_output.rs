...
static STARTASSOCIATIONSONCEOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static STARTASSOCIATIONSONCEOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#StartAssociationsOnceOutput",
        "com.amazonaws.ssm.synthetic",
        "StartAssociationsOnceOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&STARTASSOCIATIONSONCEOUTPUT_MEMBER__REQUEST_ID],
)
.with_original_name("StartAssociationsOnceResult");
impl StartAssociationsOnceOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &STARTASSOCIATIONSONCEOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for StartAssociationsOnceOutput {
...
impl StartAssociationsOnceOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&STARTASSOCIATIONSONCEOUTPUT_SCHEMA, &mut |member, deser| {
