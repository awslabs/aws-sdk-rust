...
impl DeleteResourceDataSyncInput {
    /// Consumes the builder and constructs an Operation<[`DeleteResourceDataSync`](crate::operation::delete_resource_data_sync::DeleteResourceDataSync)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_resource_data_sync::DeleteResourceDataSync, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_resource_data_sync::DeleteResourceDataSyncInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_resource_data_sync::ser_delete_resource_data_sync_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_resource_data_sync::DeleteResourceDataSync::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteResourceDataSync", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteResourceDataSync`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteResourceDataSync {
                type Output = std::result::Result<crate::operation::delete_resource_data_sync::DeleteResourceDataSyncOutput, crate::operation::delete_resource_data_sync::DeleteResourceDataSyncError>;
