...
impl ListDocumentsInput {
    /// Consumes the builder and constructs an Operation<[`ListDocuments`](crate::operation::list_documents::ListDocuments)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_documents::ListDocuments, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_documents::ser_list_documents_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_documents::ListDocuments::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDocuments", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDocuments {
    type Output = ::std::result::Result<crate::operation::list_documents::ListDocumentsOutput, crate::operation::list_documents::ListDocumentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_documents::de_list_documents_http_response_with_props(status, headers, body)
        }
    }
}
