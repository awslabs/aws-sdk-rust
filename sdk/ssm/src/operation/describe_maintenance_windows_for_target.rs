...
impl DescribeMaintenanceWindowsForTargetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_maintenance_windows_for_target::DescribeMaintenanceWindowsForTarget,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_maintenance_windows_for_target::DescribeMaintenanceWindowsForTarget::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowsForTarget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_maintenance_windows_for_target::de_describe_maintenance_windows_for_target_http_response_with_props(
                status, headers, body,
            )
        }
    }
