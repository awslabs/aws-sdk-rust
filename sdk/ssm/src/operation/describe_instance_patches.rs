...
impl DescribeInstancePatchesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInstancePatches`](crate::operation::describe_instance_patches::DescribeInstancePatches)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_instance_patches::DescribeInstancePatches, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_instance_patches::DescribeInstancePatchesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_instance_patches::ser_describe_instance_patches_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_instance_patches::DescribeInstancePatches::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeInstancePatches", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeInstancePatches`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInstancePatches {
                type Output = std::result::Result<crate::operation::describe_instance_patches::DescribeInstancePatchesOutput, crate::operation::describe_instance_patches::DescribeInstancePatchesError>;
