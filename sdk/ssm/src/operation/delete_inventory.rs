...
impl DeleteInventoryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInventory`](crate::operation::delete_inventory::DeleteInventory)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_inventory::DeleteInventory, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_inventory::ser_delete_inventory_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_inventory::DeleteInventory::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteInventory", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInventory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_inventory::de_delete_inventory_http_response_with_props(status, headers, body)
        }
    }
}
