...
impl DeleteInventoryInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_inventory::DeleteInventory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_inventory::DeleteInventoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_inventory::ser_delete_inventory_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteInventory {
                type Output = std::result::Result<crate::operation::delete_inventory::DeleteInventoryOutput, crate::operation::delete_inventory::DeleteInventoryError>;
