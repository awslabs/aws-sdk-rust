...
impl GetOpsMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_ops_metadata::GetOpsMetadata, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_ops_metadata::ser_get_ops_metadata_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOpsMetadata {
    type Output =
        ::std::result::Result<crate::operation::get_ops_metadata::GetOpsMetadataOutput, crate::operation::get_ops_metadata::GetOpsMetadataError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ops_metadata::de_get_ops_metadata_http_response_with_props(status, headers, body)
        }
    }
}
