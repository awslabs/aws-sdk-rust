...
impl GetOpsMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetOpsMetadata`](crate::operation::get_ops_metadata::GetOpsMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_ops_metadata::GetOpsMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_ops_metadata::GetOpsMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ops_metadata::ser_get_ops_metadata_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_ops_metadata::GetOpsMetadata::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetOpsMetadata", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetOpsMetadata {
                type Output = std::result::Result<crate::operation::get_ops_metadata::GetOpsMetadataOutput, crate::operation::get_ops_metadata::GetOpsMetadataError>;
