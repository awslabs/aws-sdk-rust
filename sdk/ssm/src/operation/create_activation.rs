...
impl CreateActivationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_activation::CreateActivation, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_activation::ser_create_activation_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateActivation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_activation::de_create_activation_http_response_with_props(status, headers, body)
        }
    }
}
