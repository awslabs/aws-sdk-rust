...
impl CreateActivationInput {
    /// Consumes the builder and constructs an Operation<[`CreateActivation`](crate::operation::create_activation::CreateActivation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_activation::CreateActivation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_activation::CreateActivationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_activation::ser_create_activation_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_activation::CreateActivation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateActivation", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateActivation`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateActivation {
                type Output = std::result::Result<crate::operation::create_activation::CreateActivationOutput, crate::operation::create_activation::CreateActivationError>;
