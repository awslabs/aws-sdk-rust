...
impl DeregisterTargetFromMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterTargetFromMaintenanceWindow`](crate::operation::deregister_target_from_maintenance_window::DeregisterTargetFromMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_target_from_maintenance_window::DeregisterTargetFromMaintenanceWindow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_target_from_maintenance_window::DeregisterTargetFromMaintenanceWindowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_target_from_maintenance_window::ser_deregister_target_from_maintenance_window_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_target_from_maintenance_window::DeregisterTargetFromMaintenanceWindow::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeregisterTargetFromMaintenanceWindow", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterTargetFromMaintenanceWindow {
                type Output = std::result::Result<crate::operation::deregister_target_from_maintenance_window::DeregisterTargetFromMaintenanceWindowOutput, crate::operation::deregister_target_from_maintenance_window::DeregisterTargetFromMaintenanceWindowError>;
