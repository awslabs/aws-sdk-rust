...
impl ListOpsItemRelatedItemsInput {
    /// Consumes the builder and constructs an Operation<[`ListOpsItemRelatedItems`](crate::operation::list_ops_item_related_items::ListOpsItemRelatedItems)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_ops_item_related_items::ListOpsItemRelatedItems, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_ops_item_related_items::ListOpsItemRelatedItemsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_ops_item_related_items::ser_list_ops_item_related_items_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_ops_item_related_items::ListOpsItemRelatedItems::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListOpsItemRelatedItems", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListOpsItemRelatedItems`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListOpsItemRelatedItems {
                type Output = std::result::Result<crate::operation::list_ops_item_related_items::ListOpsItemRelatedItemsOutput, crate::operation::list_ops_item_related_items::ListOpsItemRelatedItemsError>;
