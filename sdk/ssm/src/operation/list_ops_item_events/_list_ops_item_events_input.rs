...
static LISTOPSITEMEVENTSINPUT_MEMBER_FILTERS_MEMBER: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#OpsItemEventFilters$member", "com.amazonaws.ssm", "OpsItemEventFilters"),
    ::aws_smithy_schema::ShapeType::Structure,
    "member",
    0,
);
static LISTOPSITEMEVENTSINPUT_MEMBER_FILTERS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListOpsItemEventsInput$Filters",
...
.with_list_member(&LISTOPSITEMEVENTSINPUT_MEMBER_FILTERS_MEMBER);
static LISTOPSITEMEVENTSINPUT_MEMBER_MAX_RESULTS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListOpsItemEventsInput$MaxResults",
        "com.amazonaws.ssm.synthetic",
        "ListOpsItemEventsInput",
    ),
...
static LISTOPSITEMEVENTSINPUT_MEMBER_NEXT_TOKEN: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListOpsItemEventsInput$NextToken",
        "com.amazonaws.ssm.synthetic",
        "ListOpsItemEventsInput",
    ),
...
static LISTOPSITEMEVENTSINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListOpsItemEventsInput",
        "com.amazonaws.ssm.synthetic",
        "ListOpsItemEventsInput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[
        &LISTOPSITEMEVENTSINPUT_MEMBER_FILTERS,
        &LISTOPSITEMEVENTSINPUT_MEMBER_MAX_RESULTS,
        &LISTOPSITEMEVENTSINPUT_MEMBER_NEXT_TOKEN,
    ],
)
.with_payload_hint(::aws_smithy_schema::PayloadHint::NoStructPayload)
.with_original_name("ListOpsItemEventsRequest");
impl ListOpsItemEventsInput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &LISTOPSITEMEVENTSINPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for ListOpsItemEventsInput {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.filters {
            ser.write_list(
                ...
                &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                    for item in val {
                        ser.write_struct(crate::types::OpsItemEventFilter::SCHEMA, item)?;
                    }
                    Ok(())
                },
            )?;
        ...
        if let Some(ref val) = self.max_results {
            ser.write_integer(&LISTOPSITEMEVENTSINPUT_MEMBER_MAX_RESULTS, *val)?;
        }
        if let Some(ref val) = self.next_token {
            ser.write_string(&LISTOPSITEMEVENTSINPUT_MEMBER_NEXT_TOKEN, val)?;
        }
        Ok(())
    }
}
impl ListOpsItemEventsInput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&LISTOPSITEMEVENTSINPUT_SCHEMA, &mut |member, deser| {
                    ...
                    if deser.is_null() {
                        ...
                        builder.filters = Some({
                            ...
                            deser.read_list(member, &mut |deser| {
                                container.push(crate::types::OpsItemEventFilter::deserialize(deser)?);
                                Ok(())
                            })?;
                            container
                        });
