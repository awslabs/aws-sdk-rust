...
impl PutParameterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_parameter::PutParameter, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_parameter::ser_put_parameter_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutParameter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_parameter::de_put_parameter_http_response_with_props(status, headers, body)
        }
    }
}
