...
impl SendCommandInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_command::SendCommand, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_command::SendCommandInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_command::SendCommand::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SendCommand", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for SendCommand {
                type Output = std::result::Result<crate::operation::send_command::SendCommandOutput, crate::operation::send_command::SendCommandError>;
