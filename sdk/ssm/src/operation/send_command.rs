...
impl SendCommandInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_command::SendCommand, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_command::ser_send_command_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendCommand {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_command::de_send_command_http_response_with_props(status, headers, body)
        }
    }
