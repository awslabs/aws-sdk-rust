    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeEffectiveInstanceAssociations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeEffectiveInstanceAssociations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeEffectiveInstanceAssociationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeEffectiveInstanceAssociationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeEffectiveInstanceAssociations")
...
.with_interceptor(DescribeEffectiveInstanceAssociationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsError>::new());
...
#[derive(Debug)]
            struct DescribeEffectiveInstanceAssociationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeEffectiveInstanceAssociationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_effective_instance_associations::de_describe_effective_instance_associations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_effective_instance_associations::de_describe_effective_instance_associations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeEffectiveInstanceAssociationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeEffectiveInstanceAssociationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_effective_instance_associations::ser_describe_effective_instance_associations_input(&input)?);
...
#[derive(Debug)]
            struct DescribeEffectiveInstanceAssociationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeEffectiveInstanceAssociationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeEffectiveInstanceAssociationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeEffectiveInstanceAssociationsInput>()
                        .ok_or("failed to downcast to DescribeEffectiveInstanceAssociationsInput")?;
...
pub enum DescribeEffectiveInstanceAssociationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeEffectiveInstanceAssociationsError) for what information is available for the error.")]
...
impl DescribeEffectiveInstanceAssociationsError {
    /// Creates the `DescribeEffectiveInstanceAssociationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeEffectiveInstanceAssociationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeEffectiveInstanceAssociationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_effective_instance_associations::DescribeEffectiveInstanceAssociationsError {
