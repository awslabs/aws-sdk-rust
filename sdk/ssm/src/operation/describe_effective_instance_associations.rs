...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEffectiveInstanceAssociations {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_effective_instance_associations::de_describe_effective_instance_associations_http_response_with_props(status, headers, body)
        }
    }
}
