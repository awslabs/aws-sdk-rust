...
impl DescribeInstancePatchesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_instance_patches::paginator::DescribeInstancePatchesPaginatorItems
    {
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_instance_patches_output_next_token(
                                    resp,
                                );
...
impl DescribeInstancePatchesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_instance_patches_output_patches(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
