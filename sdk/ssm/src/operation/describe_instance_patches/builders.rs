...
impl DescribeInstancePatchesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_instance_patches::DescribeInstancePatchesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_instance_patches::DescribeInstancePatchesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_instance_patches::DescribeInstancePatchesOutput, crate::operation::describe_instance_patches::DescribeInstancePatchesError, Self> {
