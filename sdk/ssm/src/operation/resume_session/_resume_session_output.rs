...
static RESUMESESSIONOUTPUT_MEMBER_SESSION_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ResumeSessionOutput$SessionId",
...
static RESUMESESSIONOUTPUT_MEMBER_TOKEN_VALUE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ResumeSessionOutput$TokenValue",
        "com.amazonaws.ssm.synthetic",
        "ResumeSessionOutput",
    ),
    ::aws_smithy_schema::ShapeType::String,
...
static RESUMESESSIONOUTPUT_MEMBER_STREAM_URL: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ResumeSessionOutput$StreamUrl",
        "com.amazonaws.ssm.synthetic",
        "ResumeSessionOutput",
    ),
    ::aws_smithy_schema::ShapeType::String,
...
static RESUMESESSIONOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static RESUMESESSIONOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ResumeSessionOutput",
        "com.amazonaws.ssm.synthetic",
        "ResumeSessionOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[
        &RESUMESESSIONOUTPUT_MEMBER_SESSION_ID,
        &RESUMESESSIONOUTPUT_MEMBER_TOKEN_VALUE,
        &RESUMESESSIONOUTPUT_MEMBER_STREAM_URL,
        &RESUMESESSIONOUTPUT_MEMBER__REQUEST_ID,
    ],
)
.with_original_name("ResumeSessionResponse");
impl ResumeSessionOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &RESUMESESSIONOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for ResumeSessionOutput {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.session_id {
            ser.write_string(&RESUMESESSIONOUTPUT_MEMBER_SESSION_ID, val)?;
        }
        if let Some(ref val) = self.token_value {
            ser.write_string(&RESUMESESSIONOUTPUT_MEMBER_TOKEN_VALUE, val)?;
        }
        if let Some(ref val) = self.stream_url {
            ser.write_string(&RESUMESESSIONOUTPUT_MEMBER_STREAM_URL, val)?;
        }
        Ok(())
    }
}
impl ResumeSessionOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&RESUMESESSIONOUTPUT_SCHEMA, &mut |member, deser| {
