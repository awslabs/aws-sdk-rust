...
static DELETEACTIVATIONOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static DELETEACTIVATIONOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DeleteActivationOutput",
        "com.amazonaws.ssm.synthetic",
        "DeleteActivationOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&DELETEACTIVATIONOUTPUT_MEMBER__REQUEST_ID],
)
.with_original_name("DeleteActivationResult");
impl DeleteActivationOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &DELETEACTIVATIONOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for DeleteActivationOutput {
...
impl DeleteActivationOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&DELETEACTIVATIONOUTPUT_SCHEMA, &mut |member, deser| {
