...
impl UpdateDocumentMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_document_metadata::UpdateDocumentMetadata,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDocumentMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_document_metadata::de_update_document_metadata_http_response_with_props(status, headers, body)
        }
    }
}
