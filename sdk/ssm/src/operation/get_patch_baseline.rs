...
impl GetPatchBaselineInput {
    /// Consumes the builder and constructs an Operation<[`GetPatchBaseline`](crate::operation::get_patch_baseline::GetPatchBaseline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_patch_baseline::GetPatchBaseline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_patch_baseline::GetPatchBaselineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_patch_baseline::ser_get_patch_baseline_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_patch_baseline::GetPatchBaseline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPatchBaseline", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetPatchBaseline`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetPatchBaseline {
                type Output = std::result::Result<crate::operation::get_patch_baseline::GetPatchBaselineOutput, crate::operation::get_patch_baseline::GetPatchBaselineError>;
