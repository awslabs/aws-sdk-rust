...
impl GetPatchBaselineInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_patch_baseline::GetPatchBaseline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPatchBaseline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_patch_baseline::de_get_patch_baseline_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_patch_baseline::GetPatchBaselineError
{
