...
impl DescribeInstanceInformationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInstanceInformation`](crate::operation::describe_instance_information::DescribeInstanceInformation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_instance_information::DescribeInstanceInformation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_instance_information::DescribeInstanceInformationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_instance_information::ser_describe_instance_information_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_instance_information::DescribeInstanceInformation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeInstanceInformation", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeInstanceInformation`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInstanceInformation {
                type Output = std::result::Result<crate::operation::describe_instance_information::DescribeInstanceInformationOutput, crate::operation::describe_instance_information::DescribeInstanceInformationError>;
