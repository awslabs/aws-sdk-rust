...
static DEREGISTERMANAGEDINSTANCEOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static DEREGISTERMANAGEDINSTANCEOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DeregisterManagedInstanceOutput",
        "com.amazonaws.ssm.synthetic",
        "DeregisterManagedInstanceOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&DEREGISTERMANAGEDINSTANCEOUTPUT_MEMBER__REQUEST_ID],
)
.with_original_name("DeregisterManagedInstanceResult");
impl DeregisterManagedInstanceOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &DEREGISTERMANAGEDINSTANCEOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for DeregisterManagedInstanceOutput {
...
impl DeregisterManagedInstanceOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&DEREGISTERMANAGEDINSTANCEOUTPUT_SCHEMA, &mut |member, deser| {
