...
impl crate::operation::register_default_patch_baseline::builders::RegisterDefaultPatchBaselineInputBuilder {
...
impl RegisterDefaultPatchBaselineFluentBuilder {
    /// Creates a new `RegisterDefaultPatchBaselineFluentBuilder`.
