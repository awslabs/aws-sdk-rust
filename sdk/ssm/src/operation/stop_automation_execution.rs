...
impl StopAutomationExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StopAutomationExecution`](crate::operation::stop_automation_execution::StopAutomationExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_automation_execution::StopAutomationExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_automation_execution::StopAutomationExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_automation_execution::ser_stop_automation_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_automation_execution::StopAutomationExecution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopAutomationExecution", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopAutomationExecution {
                type Output = std::result::Result<crate::operation::stop_automation_execution::StopAutomationExecutionOutput, crate::operation::stop_automation_execution::StopAutomationExecutionError>;
