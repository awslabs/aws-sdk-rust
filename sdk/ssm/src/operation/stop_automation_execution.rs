...
impl StopAutomationExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_automation_execution::StopAutomationExecution,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopAutomationExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_automation_execution::de_stop_automation_execution_http_response_with_props(status, headers, body)
        }
    }
}
