...
impl ListCommandsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Command, ::aws_smithy_http::result::SdkError<crate::operation::list_commands::ListCommandsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_commands_output_commands(page).unwrap_or_default().into_iter())
    }
}
