...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstancePatchStatesForPatchGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_instance_patch_states_for_patch_group::de_describe_instance_patch_states_for_patch_group_http_response_with_props(status, headers, body)
        }
    }
