...
impl DescribeAvailablePatchesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAvailablePatches`](crate::operation::describe_available_patches::DescribeAvailablePatches)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_available_patches::DescribeAvailablePatches, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_available_patches::DescribeAvailablePatchesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_available_patches::ser_describe_available_patches_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_available_patches::DescribeAvailablePatches::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeAvailablePatches", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAvailablePatches {
                type Output = std::result::Result<crate::operation::describe_available_patches::DescribeAvailablePatchesOutput, crate::operation::describe_available_patches::DescribeAvailablePatchesError>;
