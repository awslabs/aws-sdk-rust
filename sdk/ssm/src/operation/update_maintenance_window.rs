...
impl UpdateMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMaintenanceWindow`](crate::operation::update_maintenance_window::UpdateMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_maintenance_window::UpdateMaintenanceWindow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_maintenance_window::UpdateMaintenanceWindowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_maintenance_window::ser_update_maintenance_window_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_maintenance_window::UpdateMaintenanceWindow::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateMaintenanceWindow", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceWindow {
                type Output = std::result::Result<crate::operation::update_maintenance_window::UpdateMaintenanceWindowOutput, crate::operation::update_maintenance_window::UpdateMaintenanceWindowError>;
