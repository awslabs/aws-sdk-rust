...
impl GetCommandInvocationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_command_invocation::ser_get_command_invocation_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_command_invocation::GetCommandInvocation::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_command_invocation::GetCommandInvocationError
{
