...
impl CreateAssociation {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::create_association::CreateAssociationInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::create_association::CreateAssociationOutput::SCHEMA;
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "CreateAssociation", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.CreateAssociation",
                "rpc.service" = "SSM",
                "rpc.method" = "CreateAssociation",
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
            ...
            let error_code = match generic.code() {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::create_association::CreateAssociationError::unhandled(
                            generic,
                        )),
                    ))
                }
            ...
            let err = match error_code {
                "AssociationAlreadyExists" => crate::operation::create_association::CreateAssociationError::AssociationAlreadyExists({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::AssociationAlreadyExists::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                ...
                "InvalidTag" => crate::operation::create_association::CreateAssociationError::InvalidTag({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::InvalidTag::deserialize_with_response(&mut *deser, response.headers(), response.status().into(), body)
                    }) {
                        ::std::result::Result::Ok(val) => val,
                        ::std::result::Result::Err(e) => {
                            return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::create_association::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::create_association::CreateAssociationError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::create_association::CreateAssociationError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, CreateAssociation::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::create_association::CreateAssociationOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request = protocol
            .serialize_request(&input, CreateAssociation::INPUT_SCHEMA, "/", _cfg)
