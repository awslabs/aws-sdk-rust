...
impl DescribeAssociationInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_association::ser_describe_association_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_association::DescribeAssociation::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_association::DescribeAssociationError
{
