...
impl ListAssociationVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListAssociationVersions`](crate::operation::list_association_versions::ListAssociationVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_association_versions::ListAssociationVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_association_versions::ListAssociationVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_association_versions::ser_list_association_versions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_association_versions::ListAssociationVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAssociationVersions", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssociationVersions {
                type Output = std::result::Result<crate::operation::list_association_versions::ListAssociationVersionsOutput, crate::operation::list_association_versions::ListAssociationVersionsError>;
