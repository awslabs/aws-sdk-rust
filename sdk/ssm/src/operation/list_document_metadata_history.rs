...
impl ListDocumentMetadataHistoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_document_metadata_history::ListDocumentMetadataHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDocumentMetadataHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_document_metadata_history::de_list_document_metadata_history_http_response_with_props(
                status, headers, body,
            )
        }
    }
