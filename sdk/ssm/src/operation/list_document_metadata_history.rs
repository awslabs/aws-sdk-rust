...
impl ListDocumentMetadataHistory {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryOutput::SCHEMA;
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "ListDocumentMetadataHistory", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.service" = "SSM",
                "rpc.method" = "ListDocumentMetadataHistory",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListDocumentMetadataHistory")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDocumentMetadataHistory")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListDocumentMetadataHistoryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListDocumentMetadataHistoryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDocumentMetadataHistoryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListDocumentMetadataHistoryInput>() else {
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                ...
                "InvalidDocumentVersion" => {
                    crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryError::InvalidDocumentVersion({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::list_document_metadata_history::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, ListDocumentMetadataHistory::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDocumentMetadataHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request = protocol
            .serialize_request(&input, ListDocumentMetadataHistory::INPUT_SCHEMA, "/", _cfg)
