...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDocumentMetadataHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_document_metadata_history::de_list_document_metadata_history_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListDocumentMetadataHistoryError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryError
{
