...
impl ListDocumentMetadataHistoryInput {
    /// Consumes the builder and constructs an Operation<[`ListDocumentMetadataHistory`](crate::operation::list_document_metadata_history::ListDocumentMetadataHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_document_metadata_history::ListDocumentMetadataHistory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_document_metadata_history::ser_list_document_metadata_history_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_document_metadata_history::ListDocumentMetadataHistory::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDocumentMetadataHistory", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListDocumentMetadataHistory {
                type Output = std::result::Result<crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryOutput, crate::operation::list_document_metadata_history::ListDocumentMetadataHistoryError>;
