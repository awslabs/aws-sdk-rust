...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDeployablePatchSnapshotForInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_deployable_patch_snapshot_for_instance::de_get_deployable_patch_snapshot_for_instance_http_response_with_props(status, headers, body)
        }
    }
}
