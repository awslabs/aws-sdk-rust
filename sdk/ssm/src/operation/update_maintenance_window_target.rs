...
impl UpdateMaintenanceWindowTargetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMaintenanceWindowTarget`](crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTarget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTarget, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTargetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_maintenance_window_target::ser_update_maintenance_window_target_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTarget::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateMaintenanceWindowTarget", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceWindowTarget {
                type Output = std::result::Result<crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTargetOutput, crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTargetError>;
