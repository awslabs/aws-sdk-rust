...
impl UpdateMaintenanceWindowTargetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTarget::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceWindowTarget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_maintenance_window_target::de_update_maintenance_window_target_http_response_with_props(
                status, headers, body,
            )
        }
    }
