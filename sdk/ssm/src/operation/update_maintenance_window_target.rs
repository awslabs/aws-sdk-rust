...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceWindowTarget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_maintenance_window_target::de_update_maintenance_window_target_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_maintenance_window_target::UpdateMaintenanceWindowTargetError
{
