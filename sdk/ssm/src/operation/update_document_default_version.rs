...
impl UpdateDocumentDefaultVersion {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::update_document_default_version::UpdateDocumentDefaultVersionInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::update_document_default_version::UpdateDocumentDefaultVersionOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_document_default_version::UpdateDocumentDefaultVersionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "UpdateDocumentDefaultVersion", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.UpdateDocumentDefaultVersion",
                "rpc.service" = "SSM",
                "rpc.method" = "UpdateDocumentDefaultVersion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDocumentDefaultVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDocumentDefaultVersion");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateDocumentDefaultVersionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateDocumentDefaultVersionResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDocumentDefaultVersion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateDocumentDefaultVersionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateDocumentDefaultVersionEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateDocumentDefaultVersionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDocumentDefaultVersionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateDocumentDefaultVersionInput>() else {
...
#[derive(Debug)]
struct UpdateDocumentDefaultVersionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDocumentDefaultVersionResponseDeserializer {
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                ...
                "InvalidDocumentVersion" => {
                    crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError::InvalidDocumentVersion({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::update_document_default_version::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, UpdateDocumentDefaultVersion::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::update_document_default_version::UpdateDocumentDefaultVersionOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct UpdateDocumentDefaultVersionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDocumentDefaultVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_document_default_version::UpdateDocumentDefaultVersionInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, UpdateDocumentDefaultVersion::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct UpdateDocumentDefaultVersionEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDocumentDefaultVersionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateDocumentDefaultVersionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateDocumentDefaultVersionInput>()
            .ok_or("failed to downcast to UpdateDocumentDefaultVersionInput")?;
...
pub enum UpdateDocumentDefaultVersionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDocumentDefaultVersionError) for what information is available for the error.")]
...
impl UpdateDocumentDefaultVersionError {
    ...
    /// Creates the `UpdateDocumentDefaultVersionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDocumentDefaultVersionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError {
