...
static DELETERESOURCEPOLICYOUTPUT_MEMBER__REQUEST_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static DELETERESOURCEPOLICYOUTPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DeleteResourcePolicyOutput",
        "com.amazonaws.ssm.synthetic",
        "DeleteResourcePolicyOutput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&DELETERESOURCEPOLICYOUTPUT_MEMBER__REQUEST_ID],
)
.with_original_name("DeleteResourcePolicyResponse");
impl DeleteResourcePolicyOutput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &DELETERESOURCEPOLICYOUTPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for DeleteResourcePolicyOutput {
...
impl DeleteResourcePolicyOutput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&DELETERESOURCEPOLICYOUTPUT_SCHEMA, &mut |member, deser| {
