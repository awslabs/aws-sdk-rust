...
/// Orchestration and serialization glue logic for `DescribePatchBaselines`.
...
impl DescribePatchBaselines {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_patch_baselines::DescribePatchBaselinesInput,
                    ) -> ::std::result::Result<crate::operation::describe_patch_baselines::DescribePatchBaselinesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_patch_baselines::DescribePatchBaselinesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_patch_baselines::DescribePatchBaselinesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_patch_baselines::DescribePatchBaselinesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribePatchBaselines {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribePatchBaselines");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribePatchBaselinesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribePatchBaselinesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribePatchBaselines")
...
.with_interceptor(DescribePatchBaselinesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_patch_baselines::DescribePatchBaselinesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_patch_baselines::DescribePatchBaselinesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_patch_baselines::DescribePatchBaselinesError>::new());
...
#[derive(Debug)]
            struct DescribePatchBaselinesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePatchBaselinesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_patch_baselines::de_describe_patch_baselines_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_patch_baselines::de_describe_patch_baselines_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribePatchBaselinesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePatchBaselinesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_patch_baselines::DescribePatchBaselinesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_patch_baselines::DescribePatchBaselinesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_patch_baselines::ser_describe_patch_baselines_input(&input)?);
...
#[derive(Debug)]
            struct DescribePatchBaselinesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribePatchBaselinesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribePatchBaselinesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribePatchBaselinesInput>()
                        .ok_or("failed to downcast to DescribePatchBaselinesInput")?;
...
pub enum DescribePatchBaselinesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribePatchBaselinesError) for what information is available for the error.")]
...
impl DescribePatchBaselinesError {
    /// Creates the `DescribePatchBaselinesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribePatchBaselinesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribePatchBaselinesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_patch_baselines::DescribePatchBaselinesError {
...
mod _describe_patch_baselines_output;
