...
impl DescribePatchBaselinesInput {
    /// Consumes the builder and constructs an Operation<[`DescribePatchBaselines`](crate::operation::describe_patch_baselines::DescribePatchBaselines)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_patch_baselines::DescribePatchBaselines, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_patch_baselines::DescribePatchBaselinesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_patch_baselines::ser_describe_patch_baselines_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_patch_baselines::DescribePatchBaselines::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePatchBaselines", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribePatchBaselines`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePatchBaselines {
                type Output = std::result::Result<crate::operation::describe_patch_baselines::DescribePatchBaselinesOutput, crate::operation::describe_patch_baselines::DescribePatchBaselinesError>;
