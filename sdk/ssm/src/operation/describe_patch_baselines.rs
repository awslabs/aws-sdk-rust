...
impl DescribePatchBaselinesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_patch_baselines::DescribePatchBaselines,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePatchBaselines {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_patch_baselines::de_describe_patch_baselines_http_response_with_props(status, headers, body)
        }
    }
}
