...
impl GetDefaultPatchBaselineFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineOutput, crate::operation::get_default_patch_baseline::GetDefaultPatchBaselineError, Self> {
