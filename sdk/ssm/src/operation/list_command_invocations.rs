...
impl ListCommandInvocationsInput {
    /// Consumes the builder and constructs an Operation<[`ListCommandInvocations`](crate::operation::list_command_invocations::ListCommandInvocations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_command_invocations::ListCommandInvocations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_command_invocations::ListCommandInvocationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_command_invocations::ser_list_command_invocations_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_command_invocations::ListCommandInvocations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListCommandInvocations", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListCommandInvocations {
                type Output = std::result::Result<crate::operation::list_command_invocations::ListCommandInvocationsOutput, crate::operation::list_command_invocations::ListCommandInvocationsError>;
