...
impl GetInventoryInput {
    /// Consumes the builder and constructs an Operation<[`GetInventory`](crate::operation::get_inventory::GetInventory)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_inventory::GetInventory, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_inventory::ser_get_inventory_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_inventory::GetInventory::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetInventory", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInventory {
    type Output = ::std::result::Result<crate::operation::get_inventory::GetInventoryOutput, crate::operation::get_inventory::GetInventoryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_inventory::de_get_inventory_http_response_with_props(status, headers, body)
        }
    }
}
