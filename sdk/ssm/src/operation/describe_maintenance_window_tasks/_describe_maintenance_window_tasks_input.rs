...
static DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_WINDOW_ID: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeMaintenanceWindowTasksInput$WindowId",
...
static DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_FILTERS_MEMBER: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
...
static DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_FILTERS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeMaintenanceWindowTasksInput$Filters",
        "com.amazonaws.ssm.synthetic",
        "DescribeMaintenanceWindowTasksInput",
    ),
...
.with_list_member(&DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_FILTERS_MEMBER);
static DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_MAX_RESULTS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeMaintenanceWindowTasksInput$MaxResults",
        "com.amazonaws.ssm.synthetic",
        "DescribeMaintenanceWindowTasksInput",
    ),
...
static DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_NEXT_TOKEN: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeMaintenanceWindowTasksInput$NextToken",
        "com.amazonaws.ssm.synthetic",
        "DescribeMaintenanceWindowTasksInput",
    ),
    ::aws_smithy_schema::ShapeType::String,
...
static DESCRIBEMAINTENANCEWINDOWTASKSINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeMaintenanceWindowTasksInput",
        "com.amazonaws.ssm.synthetic",
        "DescribeMaintenanceWindowTasksInput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[
        &DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_WINDOW_ID,
        &DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_FILTERS,
        &DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_MAX_RESULTS,
        &DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_NEXT_TOKEN,
    ],
)
.with_payload_hint(::aws_smithy_schema::PayloadHint::NoStructPayload)
.with_original_name("DescribeMaintenanceWindowTasksRequest");
impl DescribeMaintenanceWindowTasksInput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &DESCRIBEMAINTENANCEWINDOWTASKSINPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for DescribeMaintenanceWindowTasksInput {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.window_id {
            ser.write_string(&DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_WINDOW_ID, val)?;
        }
        ...
        if let Some(ref val) = self.max_results {
            ser.write_integer(&DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_MAX_RESULTS, *val)?;
        }
        if let Some(ref val) = self.next_token {
            ser.write_string(&DESCRIBEMAINTENANCEWINDOWTASKSINPUT_MEMBER_NEXT_TOKEN, val)?;
        }
        Ok(())
    }
}
impl DescribeMaintenanceWindowTasksInput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&DESCRIBEMAINTENANCEWINDOWTASKSINPUT_SCHEMA, &mut |member, deser| {
