...
/// Orchestration and serialization glue logic for `DescribeInstanceAssociationsStatus`.
...
impl DescribeInstanceAssociationsStatus {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "SSM",
            "rpc.method" = "DescribeInstanceAssociationsStatus",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInstanceAssociationsStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeInstanceAssociationsStatus");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeInstanceAssociationsStatusRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeInstanceAssociationsStatusResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeInstanceAssociationsStatus")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInstanceAssociationsStatus")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribeInstanceAssociationsStatusTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribeInstanceAssociationsStatusEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct DescribeInstanceAssociationsStatusTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeInstanceAssociationsStatusTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeInstanceAssociationsStatusInput>() else {
...
#[derive(Debug)]
struct DescribeInstanceAssociationsStatusResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeInstanceAssociationsStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                "InternalServerError" => {
                    crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError::InternalServerError({
                ...
                "InvalidInstanceId" => {
                    crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError::InvalidInstanceId({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                ...
                "InvalidNextToken" => {
                    crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError::InvalidNextToken({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::describe_instance_associations_status::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, DescribeInstanceAssociationsStatus::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output =
                crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusOutput::deserialize_with_response(
                    &mut *deser,
                    _response_headers,
                    response.status().into(),
                    body,
...
#[derive(Debug)]
struct DescribeInstanceAssociationsStatusRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeInstanceAssociationsStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, DescribeInstanceAssociationsStatus::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct DescribeInstanceAssociationsStatusEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeInstanceAssociationsStatusEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "DescribeInstanceAssociationsStatusEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DescribeInstanceAssociationsStatusInput>()
            .ok_or("failed to downcast to DescribeInstanceAssociationsStatusInput")?;
...
pub enum DescribeInstanceAssociationsStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeInstanceAssociationsStatusError) for what information is available for the error.")]
...
impl DescribeInstanceAssociationsStatusError {
    ...
    /// Creates the `DescribeInstanceAssociationsStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeInstanceAssociationsStatusError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeInstanceAssociationsStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatusError {
...
mod _describe_instance_associations_status_output;
