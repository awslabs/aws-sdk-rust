...
impl DescribeInstanceAssociationsStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatus,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_instance_associations_status::DescribeInstanceAssociationsStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstanceAssociationsStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_instance_associations_status::de_describe_instance_associations_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
