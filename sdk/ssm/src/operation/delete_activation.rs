...
impl DeleteActivationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_activation::DeleteActivation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_activation::DeleteActivationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_activation::ser_delete_activation_input(&self)?
        );
...
/// `ParseStrictResponse` impl for `DeleteActivation`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteActivation {
                type Output = std::result::Result<crate::operation::delete_activation::DeleteActivationOutput, crate::operation::delete_activation::DeleteActivationError>;
