...
impl DeleteActivationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_activation::DeleteActivation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteActivation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_activation::de_delete_activation_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_activation::DeleteActivationError
{
