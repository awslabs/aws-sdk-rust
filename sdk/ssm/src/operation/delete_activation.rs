...
impl DeleteActivationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteActivation`](crate::operation::delete_activation::DeleteActivation)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_activation::DeleteActivation, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_activation::ser_delete_activation_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_activation::DeleteActivation::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteActivation", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteActivation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_activation::de_delete_activation_http_response_with_props(status, headers, body)
        }
    }
}
