...
impl DeleteOpsMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_ops_metadata::DeleteOpsMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOpsMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_ops_metadata::de_delete_ops_metadata_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_ops_metadata::DeleteOpsMetadataError
{
