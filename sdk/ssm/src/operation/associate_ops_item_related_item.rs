...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateOpsItemRelatedItemResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_ops_item_related_item::de_associate_ops_item_related_item_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_associate_ops_item_related_item::de_associate_ops_item_related_item_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateOpsItemRelatedItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItemInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_ops_item_related_item::ser_associate_ops_item_related_item_input(&input)?,
        );
