...
impl GetParameterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_parameter::GetParameter, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_parameter::ser_get_parameter_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetParameter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_parameter::de_get_parameter_http_response_with_props(status, headers, body)
        }
    }
