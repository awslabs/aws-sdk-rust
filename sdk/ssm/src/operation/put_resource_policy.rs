...
impl PutResourcePolicy {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::put_resource_policy::PutResourcePolicyInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::put_resource_policy::PutResourcePolicyOutput::SCHEMA;
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "PutResourcePolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutResourcePolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PutResourcePolicy", "SSM"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutResourcePolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("PolicyHash") {
            if let ::std::option::Option::Some(value) = input.policy_hash.as_deref() {
                captured.insert("PolicyHash", value);
            }
        }
        ...
        if !success && status != 200 || force_error {
            ...
            let err = match error_code {
                ...
                "MalformedResourcePolicyDocumentException" => {
                    crate::operation::put_resource_policy::PutResourcePolicyError::MalformedResourcePolicyDocumentException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::MalformedResourcePolicyDocumentException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                ...
                "ResourcePolicyConflictException" => {
                    crate::operation::put_resource_policy::PutResourcePolicyError::ResourcePolicyConflictException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::ResourcePolicyConflictException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                ...
                "ResourcePolicyInvalidParameterException" => {
                    crate::operation::put_resource_policy::PutResourcePolicyError::ResourcePolicyInvalidParameterException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::ResourcePolicyInvalidParameterException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                ...
                "ResourcePolicyLimitExceededException" => {
                    crate::operation::put_resource_policy::PutResourcePolicyError::ResourcePolicyLimitExceededException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::ResourcePolicyLimitExceededException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                ...
                "ResourcePolicyNotFoundException" => {
                    crate::operation::put_resource_policy::PutResourcePolicyError::ResourcePolicyNotFoundException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::ResourcePolicyNotFoundException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::put_resource_policy::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::put_resource_policy::PutResourcePolicyError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::put_resource_policy::PutResourcePolicyError::generic(generic),
                    }
                }
            };
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::put_resource_policy::PutResourcePolicyOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
