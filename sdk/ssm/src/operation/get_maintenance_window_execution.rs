...
impl GetMaintenanceWindowExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_maintenance_window_execution::GetMaintenanceWindowExecution,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_maintenance_window_execution::GetMaintenanceWindowExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMaintenanceWindowExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_maintenance_window_execution::de_get_maintenance_window_execution_http_response_with_props(
                status, headers, body,
            )
        }
    }
