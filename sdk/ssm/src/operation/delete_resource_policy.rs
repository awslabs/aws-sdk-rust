...
impl DeleteResourcePolicy {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::delete_resource_policy::DeleteResourcePolicyInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::delete_resource_policy::DeleteResourcePolicyOutput::SCHEMA;
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "DeleteResourcePolicy", input, runtime_plugins, stop_point)
        ...
        if !success && status != 200 || force_error {
            ...
            let err = match error_code {
                ...
                "ResourcePolicyConflictException" => {
                    crate::operation::delete_resource_policy::DeleteResourcePolicyError::ResourcePolicyConflictException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                ...
                "ResourcePolicyInvalidParameterException" => {
                    crate::operation::delete_resource_policy::DeleteResourcePolicyError::ResourcePolicyInvalidParameterException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                ...
                "ResourcePolicyNotFoundException" => {
                    crate::operation::delete_resource_policy::DeleteResourcePolicyError::ResourcePolicyNotFoundException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::delete_resource_policy::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::delete_resource_policy::DeleteResourcePolicyError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::delete_resource_policy::DeleteResourcePolicyError::generic(generic),
                    }
                }
            };
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::delete_resource_policy::DeleteResourcePolicyOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
impl DeleteResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::MalformedResourcePolicyDocumentException`.
