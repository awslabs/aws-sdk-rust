...
static CREATEACTIVATIONINPUT_MEMBER_DESCRIPTION: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$Description",
...
static CREATEACTIVATIONINPUT_MEMBER_DEFAULT_INSTANCE_NAME: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$DefaultInstanceName",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
    ::aws_smithy_schema::ShapeType::String,
...
static CREATEACTIVATIONINPUT_MEMBER_IAM_ROLE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$IamRole",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
    ::aws_smithy_schema::ShapeType::String,
...
static CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_LIMIT: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$RegistrationLimit",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
...
static CREATEACTIVATIONINPUT_MEMBER_EXPIRATION_DATE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$ExpirationDate",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
...
static CREATEACTIVATIONINPUT_MEMBER_TAGS_MEMBER: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#TagList$member", "com.amazonaws.ssm", "TagList"),
    ::aws_smithy_schema::ShapeType::Structure,
    "member",
    0,
);
static CREATEACTIVATIONINPUT_MEMBER_TAGS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$Tags",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
...
.with_list_member(&CREATEACTIVATIONINPUT_MEMBER_TAGS_MEMBER);
static CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_METADATA_MEMBER: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#RegistrationMetadataList$member",
        "com.amazonaws.ssm",
...
static CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_METADATA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput$RegistrationMetadata",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
    ::aws_smithy_schema::ShapeType::List,
...
.with_list_member(&CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_METADATA_MEMBER);
static CREATEACTIVATIONINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#CreateActivationInput",
        "com.amazonaws.ssm.synthetic",
        "CreateActivationInput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[
        &CREATEACTIVATIONINPUT_MEMBER_DESCRIPTION,
        &CREATEACTIVATIONINPUT_MEMBER_DEFAULT_INSTANCE_NAME,
        &CREATEACTIVATIONINPUT_MEMBER_IAM_ROLE,
        &CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_LIMIT,
        &CREATEACTIVATIONINPUT_MEMBER_EXPIRATION_DATE,
        &CREATEACTIVATIONINPUT_MEMBER_TAGS,
        &CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_METADATA,
    ],
)
.with_payload_hint(::aws_smithy_schema::PayloadHint::NoStructPayload)
.with_original_name("CreateActivationRequest");
impl CreateActivationInput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &CREATEACTIVATIONINPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for CreateActivationInput {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.description {
            ser.write_string(&CREATEACTIVATIONINPUT_MEMBER_DESCRIPTION, val)?;
        }
        if let Some(ref val) = self.default_instance_name {
            ser.write_string(&CREATEACTIVATIONINPUT_MEMBER_DEFAULT_INSTANCE_NAME, val)?;
        }
        if let Some(ref val) = self.iam_role {
            ser.write_string(&CREATEACTIVATIONINPUT_MEMBER_IAM_ROLE, val)?;
        }
        if let Some(ref val) = self.registration_limit {
            ser.write_integer(&CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_LIMIT, *val)?;
        }
        if let Some(ref val) = self.expiration_date {
            ser.write_timestamp(&CREATEACTIVATIONINPUT_MEMBER_EXPIRATION_DATE, val)?;
        }
        ...
        if let Some(ref val) = self.registration_metadata {
            ser.write_list(
                &CREATEACTIVATIONINPUT_MEMBER_REGISTRATION_METADATA,
                &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                    for item in val {
                        ser.write_struct(crate::types::RegistrationMetadataItem::SCHEMA, item)?;
                    }
                    Ok(())
                },
            )?;
...
impl CreateActivationInput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&CREATEACTIVATIONINPUT_SCHEMA, &mut |member, deser| {
            match member.member_index() {
                ...
                Some(6) => {
                    if deser.is_null() {
                        ...
                        builder.registration_metadata = Some({
                            let mut container = Vec::new();
                            deser.read_list(member, &mut |deser| {
                                container.push(crate::types::RegistrationMetadataItem::deserialize(deser)?);
                                Ok(())
                            })?;
                            container
                        });
