...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEffectivePatchesForPatchBaseline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_effective_patches_for_patch_baseline::de_describe_effective_patches_for_patch_baseline_http_response_with_props(status, headers, body)
        }
    }
}
