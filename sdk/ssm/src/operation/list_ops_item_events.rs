...
impl ListOpsItemEventsInput {
    /// Consumes the builder and constructs an Operation<[`ListOpsItemEvents`](crate::operation::list_ops_item_events::ListOpsItemEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_ops_item_events::ListOpsItemEvents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_ops_item_events::ListOpsItemEventsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_ops_item_events::ser_list_ops_item_events_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_ops_item_events::ListOpsItemEvents::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListOpsItemEvents", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListOpsItemEvents {
                type Output = std::result::Result<crate::operation::list_ops_item_events::ListOpsItemEventsOutput, crate::operation::list_ops_item_events::ListOpsItemEventsError>;
