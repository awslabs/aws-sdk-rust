...
impl ListOpsItemEventsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_ops_item_events::ser_list_ops_item_events_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOpsItemEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_ops_item_events::de_list_ops_item_events_http_response_with_props(status, headers, body)
        }
    }
}
