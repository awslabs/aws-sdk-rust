...
impl aws_smithy_http::response::ParseStrictResponse for ListOpsItemEvents {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_ops_item_events::de_list_ops_item_events_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_ops_item_events::de_list_ops_item_events_http_response(response)
                     }
                }
            }
