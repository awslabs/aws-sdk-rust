...
impl DescribeActivationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_activations::ser_describe_activations_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeActivations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_activations::de_describe_activations_http_response_with_props(status, headers, body)
        }
    }
}
