...
impl GetServiceSettingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_setting::ser_get_service_setting_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceSetting {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_setting::de_get_service_setting_http_response_with_props(status, headers, body)
        }
    }
}
