...
impl GetServiceSettingInput {
    /// Consumes the builder and constructs an Operation<[`GetServiceSetting`](crate::operation::get_service_setting::GetServiceSetting)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_service_setting::GetServiceSetting, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_service_setting::GetServiceSettingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_service_setting::ser_get_service_setting_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_service_setting::GetServiceSetting::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetServiceSetting", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetServiceSetting`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetServiceSetting {
                type Output = std::result::Result<crate::operation::get_service_setting::GetServiceSettingOutput, crate::operation::get_service_setting::GetServiceSettingError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_service_setting::de_get_service_setting_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_service_setting::de_get_service_setting_http_response(response)
                     }
                }
            }
