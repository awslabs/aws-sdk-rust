...
impl CreateMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`CreateMaintenanceWindow`](crate::operation::create_maintenance_window::CreateMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_maintenance_window::CreateMaintenanceWindow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_maintenance_window::CreateMaintenanceWindowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_maintenance_window::ser_create_maintenance_window_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_maintenance_window::CreateMaintenanceWindow::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateMaintenanceWindow", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateMaintenanceWindow`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateMaintenanceWindow {
                type Output = std::result::Result<crate::operation::create_maintenance_window::CreateMaintenanceWindowOutput, crate::operation::create_maintenance_window::CreateMaintenanceWindowError>;
