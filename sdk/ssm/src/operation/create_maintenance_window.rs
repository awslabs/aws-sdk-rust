...
/// Orchestration and serialization glue logic for `CreateMaintenanceWindow`.
...
impl CreateMaintenanceWindow {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::create_maintenance_window::CreateMaintenanceWindowInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::create_maintenance_window::CreateMaintenanceWindowOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_maintenance_window::CreateMaintenanceWindowError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_maintenance_window::CreateMaintenanceWindowOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "CreateMaintenanceWindow", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.CreateMaintenanceWindow",
                "rpc.service" = "SSM",
                "rpc.method" = "CreateMaintenanceWindow",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_maintenance_window::CreateMaintenanceWindowInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMaintenanceWindow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateMaintenanceWindow");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateMaintenanceWindowRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateMaintenanceWindowResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateMaintenanceWindow")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateMaintenanceWindow")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateMaintenanceWindowTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateMaintenanceWindowEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateMaintenanceWindowTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMaintenanceWindowTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateMaintenanceWindowInput>() else {
        ...
        if requested.should_capture("StartDate") {
            if let ::std::option::Option::Some(value) = input.start_date.as_deref() {
                captured.insert("StartDate", value);
            }
        }
        if requested.should_capture("EndDate") {
            if let ::std::option::Option::Some(value) = input.end_date.as_deref() {
                captured.insert("EndDate", value);
            }
        }
        ...
        if requested.should_capture("ScheduleTimezone") {
            if let ::std::option::Option::Some(value) = input.schedule_timezone.as_deref() {
                captured.insert("ScheduleTimezone", value);
            }
        }
...
#[derive(Debug)]
struct CreateMaintenanceWindowResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMaintenanceWindowResponseDeserializer {
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::create_maintenance_window::CreateMaintenanceWindowError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                "IdempotentParameterMismatch" => {
                    crate::operation::create_maintenance_window::CreateMaintenanceWindowError::IdempotentParameterMismatch({
                ...
                "ResourceLimitExceededException" => {
                    crate::operation::create_maintenance_window::CreateMaintenanceWindowError::ResourceLimitExceededException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::ResourceLimitExceededException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::create_maintenance_window::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::create_maintenance_window::CreateMaintenanceWindowError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::create_maintenance_window::CreateMaintenanceWindowError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, CreateMaintenanceWindow::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::create_maintenance_window::CreateMaintenanceWindowOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct CreateMaintenanceWindowRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMaintenanceWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_maintenance_window::CreateMaintenanceWindowInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, CreateMaintenanceWindow::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct CreateMaintenanceWindowEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMaintenanceWindowEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateMaintenanceWindowEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateMaintenanceWindowInput>()
            .ok_or("failed to downcast to CreateMaintenanceWindowInput")?;
...
pub enum CreateMaintenanceWindowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateMaintenanceWindowError) for what information is available for the error.")]
...
impl CreateMaintenanceWindowError {
    ...
    /// Creates the `CreateMaintenanceWindowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateMaintenanceWindowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_maintenance_window::CreateMaintenanceWindowError {
...
mod _create_maintenance_window_output;
