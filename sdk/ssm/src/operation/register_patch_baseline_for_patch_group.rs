...
impl RegisterPatchBaselineForPatchGroup {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "SSM",
            "rpc.method" = "RegisterPatchBaselineForPatchGroup",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterPatchBaselineForPatchGroup {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterPatchBaselineForPatchGroupRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterPatchBaselineForPatchGroupResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterPatchBaselineForPatchGroup")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterPatchBaselineForPatchGroup")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterPatchBaselineForPatchGroupTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RegisterPatchBaselineForPatchGroupTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterPatchBaselineForPatchGroupTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterPatchBaselineForPatchGroupInput>() else {
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupError::unhandled(generic),
                        ),
                    ))
                }
            };
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::register_patch_baseline_for_patch_group::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, RegisterPatchBaselineForPatchGroup::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output =
                crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupOutput::deserialize_with_response(
                    &mut *deser,
                    _response_headers,
                    response.status().into(),
                    body,
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterPatchBaselineForPatchGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, RegisterPatchBaselineForPatchGroup::INPUT_SCHEMA, "/", _cfg)
