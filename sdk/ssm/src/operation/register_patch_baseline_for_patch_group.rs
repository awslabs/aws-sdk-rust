...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterPatchBaselineForPatchGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_patch_baseline_for_patch_group::de_register_patch_baseline_for_patch_group_http_response_with_props(status, headers, body)
        }
    }
}
