...
impl RegisterPatchBaselineForPatchGroupInput {
    /// Consumes the builder and constructs an Operation<[`RegisterPatchBaselineForPatchGroup`](crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_patch_baseline_for_patch_group::ser_register_patch_baseline_for_patch_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterPatchBaselineForPatchGroup", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterPatchBaselineForPatchGroup {
                type Output = std::result::Result<crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupOutput, crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupError>;
