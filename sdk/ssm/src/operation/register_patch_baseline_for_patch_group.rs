...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterPatchBaselineForPatchGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_patch_baseline_for_patch_group::de_register_patch_baseline_for_patch_group_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_patch_baseline_for_patch_group::de_register_patch_baseline_for_patch_group_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterPatchBaselineForPatchGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_register_patch_baseline_for_patch_group::ser_register_patch_baseline_for_patch_group_input(&input)?,
        );
