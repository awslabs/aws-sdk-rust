...
impl RegisterPatchBaselineForPatchGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroup,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_patch_baseline_for_patch_group::RegisterPatchBaselineForPatchGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterPatchBaselineForPatchGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_patch_baseline_for_patch_group::de_register_patch_baseline_for_patch_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
