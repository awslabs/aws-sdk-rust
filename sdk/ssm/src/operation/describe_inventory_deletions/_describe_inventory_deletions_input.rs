...
impl DescribeInventoryDeletionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_inventory_deletions::DescribeInventoryDeletionsInput, ::aws_smithy_types::error::operation::BuildError> {
