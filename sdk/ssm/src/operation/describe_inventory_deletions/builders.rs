...
impl crate::operation::describe_inventory_deletions::builders::DescribeInventoryDeletionsInputBuilder {
...
impl DescribeInventoryDeletionsFluentBuilder {
    /// Creates a new `DescribeInventoryDeletionsFluentBuilder`.
