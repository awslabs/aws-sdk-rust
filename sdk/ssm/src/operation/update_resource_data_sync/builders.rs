...
impl UpdateResourceDataSyncFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_resource_data_sync::UpdateResourceDataSyncOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_resource_data_sync::UpdateResourceDataSyncError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_resource_data_sync::UpdateResourceDataSyncOutput, crate::operation::update_resource_data_sync::UpdateResourceDataSyncError, Self> {
