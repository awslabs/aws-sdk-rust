...
impl DeletePatchBaselineInput {
    /// Consumes the builder and constructs an Operation<[`DeletePatchBaseline`](crate::operation::delete_patch_baseline::DeletePatchBaseline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_patch_baseline::DeletePatchBaseline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_patch_baseline::DeletePatchBaselineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_patch_baseline::ser_delete_patch_baseline_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_patch_baseline::DeletePatchBaseline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeletePatchBaseline", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeletePatchBaseline`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePatchBaseline {
                type Output = std::result::Result<crate::operation::delete_patch_baseline::DeletePatchBaselineOutput, crate::operation::delete_patch_baseline::DeletePatchBaselineError>;
