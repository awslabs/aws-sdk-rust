...
impl DeletePatchBaselineInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_patch_baseline::ser_delete_patch_baseline_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_patch_baseline::DeletePatchBaseline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePatchBaseline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_patch_baseline::de_delete_patch_baseline_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_patch_baseline::DeletePatchBaselineError
{
