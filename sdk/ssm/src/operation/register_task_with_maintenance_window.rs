...
impl RegisterTaskWithMaintenanceWindowInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterTaskWithMaintenanceWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_task_with_maintenance_window::de_register_task_with_maintenance_window_http_response_with_props(
                status, headers, body,
            )
        }
    }
