...
/// Orchestration and serialization glue logic for `RegisterTaskWithMaintenanceWindow`.
...
impl RegisterTaskWithMaintenanceWindow {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "SSM",
            "rpc.method" = "RegisterTaskWithMaintenanceWindow",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterTaskWithMaintenanceWindow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterTaskWithMaintenanceWindow");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterTaskWithMaintenanceWindowRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterTaskWithMaintenanceWindowResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterTaskWithMaintenanceWindow")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterTaskWithMaintenanceWindow")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterTaskWithMaintenanceWindowTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterTaskWithMaintenanceWindowEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct RegisterTaskWithMaintenanceWindowTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterTaskWithMaintenanceWindowTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterTaskWithMaintenanceWindowInput>() else {
...
#[derive(Debug)]
struct RegisterTaskWithMaintenanceWindowResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterTaskWithMaintenanceWindowResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                ...
                "FeatureNotAvailableException" => {
                    crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError::FeatureNotAvailableException({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                            crate::types::error::FeatureNotAvailableException::deserialize_with_response(
                                &mut *deser,
                                response.headers(),
                                response.status().into(),
                                body,
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::register_task_with_maintenance_window::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, RegisterTaskWithMaintenanceWindow::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output =
                crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowOutput::deserialize_with_response(
                    &mut *deser,
                    _response_headers,
                    response.status().into(),
                    body,
...
#[derive(Debug)]
struct RegisterTaskWithMaintenanceWindowRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterTaskWithMaintenanceWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, RegisterTaskWithMaintenanceWindow::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct RegisterTaskWithMaintenanceWindowEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterTaskWithMaintenanceWindowEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "RegisterTaskWithMaintenanceWindowEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<RegisterTaskWithMaintenanceWindowInput>()
            .ok_or("failed to downcast to RegisterTaskWithMaintenanceWindowInput")?;
...
pub enum RegisterTaskWithMaintenanceWindowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterTaskWithMaintenanceWindowError) for what information is available for the error.")]
...
impl RegisterTaskWithMaintenanceWindowError {
    ...
    /// Creates the `RegisterTaskWithMaintenanceWindowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::FeatureNotAvailableException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for RegisterTaskWithMaintenanceWindowError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::FeatureNotAvailableException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterTaskWithMaintenanceWindowError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DoesNotExistException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::FeatureNotAvailableException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterTaskWithMaintenanceWindowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError {
...
mod _register_task_with_maintenance_window_output;
