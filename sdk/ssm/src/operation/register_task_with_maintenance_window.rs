...
impl RegisterTaskWithMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`RegisterTaskWithMaintenanceWindow`](crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindow, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        assert_ne!(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_task_with_maintenance_window::ser_register_task_with_maintenance_window_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindow::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterTaskWithMaintenanceWindow", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterTaskWithMaintenanceWindow {
    type Output = ::std::result::Result<crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowOutput, crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_task_with_maintenance_window::de_register_task_with_maintenance_window_http_response_with_props(status, headers, body)
        }
    }
}
