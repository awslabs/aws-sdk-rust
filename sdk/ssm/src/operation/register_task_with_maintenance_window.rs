...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterTaskWithMaintenanceWindowResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_task_with_maintenance_window::de_register_task_with_maintenance_window_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_task_with_maintenance_window::de_register_task_with_maintenance_window_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterTaskWithMaintenanceWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::register_task_with_maintenance_window::RegisterTaskWithMaintenanceWindowInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_register_task_with_maintenance_window::ser_register_task_with_maintenance_window_input(&input)?,
        );
