...
impl ListResourceDataSyncPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_resource_data_sync::paginator::ListResourceDataSyncPaginatorItems
    {
        crate::operation::list_resource_data_sync::paginator::ListResourceDataSyncPaginatorItems(
            self,
        )
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_resource_data_sync_output_next_token(
                                    resp,
                                );
...
impl ListResourceDataSyncPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_resource_data_sync_output_resource_data_sync_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
