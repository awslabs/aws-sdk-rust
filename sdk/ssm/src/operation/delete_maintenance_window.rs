...
impl DeleteMaintenanceWindowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_maintenance_window::DeleteMaintenanceWindow,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMaintenanceWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_maintenance_window::de_delete_maintenance_window_http_response_with_props(status, headers, body)
        }
    }
}
