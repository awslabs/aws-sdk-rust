...
impl DeleteMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMaintenanceWindow`](crate::operation::delete_maintenance_window::DeleteMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_maintenance_window::DeleteMaintenanceWindow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_maintenance_window::DeleteMaintenanceWindowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_maintenance_window::ser_delete_maintenance_window_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_maintenance_window::DeleteMaintenanceWindow::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteMaintenanceWindow", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteMaintenanceWindow {
                type Output = std::result::Result<crate::operation::delete_maintenance_window::DeleteMaintenanceWindowOutput, crate::operation::delete_maintenance_window::DeleteMaintenanceWindowError>;
