...
impl PutComplianceItemsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_compliance_items::ser_put_compliance_items_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_compliance_items::PutComplianceItems::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutComplianceItems {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_compliance_items::de_put_compliance_items_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_compliance_items::PutComplianceItemsError
{
