...
impl PutComplianceItemsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_compliance_items::ser_put_compliance_items_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutComplianceItems {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_compliance_items::de_put_compliance_items_http_response_with_props(status, headers, body)
        }
    }
}
