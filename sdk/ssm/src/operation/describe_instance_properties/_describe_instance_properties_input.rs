...
static DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_INSTANCE_PROPERTY_FILTER_LIST_MEMBER: ::aws_smithy_schema::Schema<'static> =
    ::aws_smithy_schema::Schema::new_member(
        ::aws_smithy_schema::ShapeId::from_parts(
            "com.amazonaws.ssm#InstancePropertyFilterList$member",
            "com.amazonaws.ssm",
    ...
    .with_xml_name("InstancePropertyFilter");
static DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_INSTANCE_PROPERTY_FILTER_LIST: ::aws_smithy_schema::Schema<'static> =
    ::aws_smithy_schema::Schema::new_member(
        ::aws_smithy_schema::ShapeId::from_parts(
            "com.amazonaws.ssm.synthetic#DescribeInstancePropertiesInput$InstancePropertyFilterList",
    ...
    .with_list_member(&DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_INSTANCE_PROPERTY_FILTER_LIST_MEMBER);
static DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_FILTERS_WITH_OPERATOR_MEMBER: ::aws_smithy_schema::Schema<'static> =
    ::aws_smithy_schema::Schema::new_member(
        ::aws_smithy_schema::ShapeId::from_parts(
            "com.amazonaws.ssm#InstancePropertyStringFilterList$member",
            "com.amazonaws.ssm",
    ...
    .with_xml_name("InstancePropertyStringFilter");
static DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_FILTERS_WITH_OPERATOR: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeInstancePropertiesInput$FiltersWithOperator",
        "com.amazonaws.ssm.synthetic",
        "DescribeInstancePropertiesInput",
    ),
    ::aws_smithy_schema::ShapeType::List,
...
.with_list_member(&DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_FILTERS_WITH_OPERATOR_MEMBER);
static DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_MAX_RESULTS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeInstancePropertiesInput$MaxResults",
        "com.amazonaws.ssm.synthetic",
        "DescribeInstancePropertiesInput",
    ),
...
static DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_NEXT_TOKEN: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeInstancePropertiesInput$NextToken",
        "com.amazonaws.ssm.synthetic",
        "DescribeInstancePropertiesInput",
    ),
...
static DESCRIBEINSTANCEPROPERTIESINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#DescribeInstancePropertiesInput",
        "com.amazonaws.ssm.synthetic",
        "DescribeInstancePropertiesInput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[
        &DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_INSTANCE_PROPERTY_FILTER_LIST,
        &DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_FILTERS_WITH_OPERATOR,
        &DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_MAX_RESULTS,
        &DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_NEXT_TOKEN,
    ],
)
.with_payload_hint(::aws_smithy_schema::PayloadHint::NoStructPayload)
.with_original_name("DescribeInstancePropertiesRequest");
impl DescribeInstancePropertiesInput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &DESCRIBEINSTANCEPROPERTIESINPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for DescribeInstancePropertiesInput {
    #[allow(unused_variables, clippy::diverging_sub_expression)]
    fn serialize_members(
        &self,
        ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer,
    ) -> ::std::result::Result<(), ::aws_smithy_schema::serde::SerdeError> {
        if let Some(ref val) = self.instance_property_filter_list {
            ser.write_list(
                &DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_INSTANCE_PROPERTY_FILTER_LIST,
                &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                    for item in val {
                        ser.write_struct(crate::types::InstancePropertyFilter::SCHEMA, item)?;
                    }
                    Ok(())
                },
            )?;
        }
        if let Some(ref val) = self.filters_with_operator {
            ser.write_list(
                &DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_FILTERS_WITH_OPERATOR,
                &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                    for item in val {
                        ser.write_struct(crate::types::InstancePropertyStringFilter::SCHEMA, item)?;
                    }
                    Ok(())
                },
            )?;
        ...
        if let Some(ref val) = self.max_results {
            ser.write_integer(&DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_MAX_RESULTS, *val)?;
        }
        if let Some(ref val) = self.next_token {
            ser.write_string(&DESCRIBEINSTANCEPROPERTIESINPUT_MEMBER_NEXT_TOKEN, val)?;
        }
        Ok(())
    }
}
impl DescribeInstancePropertiesInput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&DESCRIBEINSTANCEPROPERTIESINPUT_SCHEMA, &mut |member, deser| {
            match member.member_index() {
                Some(0) => {
                    if deser.is_null() {
                        deser.read_null()?;
                    } else {
                        builder.instance_property_filter_list = Some({
                            let mut container = Vec::new();
                            deser.read_list(member, &mut |deser| {
                                container.push(crate::types::InstancePropertyFilter::deserialize(deser)?);
                                Ok(())
                            })?;
                            container
                        });
                ...
                Some(1) => {
                    if deser.is_null() {
                        ...
                        builder.filters_with_operator = Some({
                            let mut container = Vec::new();
                            deser.read_list(member, &mut |deser| {
                                container.push(crate::types::InstancePropertyStringFilter::deserialize(deser)?);
                                Ok(())
                            })?;
                            container
                        });
