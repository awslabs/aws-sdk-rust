                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_describe_maintenance_window_execution_task_invocations_output_output_next_token(resp);
...
impl DescribeMaintenanceWindowExecutionTaskInvocationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_maintenance_window_execution_task_invocations_output_output_window_execution_task_invocation_identities(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
