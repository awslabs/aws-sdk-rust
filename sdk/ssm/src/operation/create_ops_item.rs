...
impl CreateOpsItemInput {
    /// Consumes the builder and constructs an Operation<[`CreateOpsItem`](crate::operation::create_ops_item::CreateOpsItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_ops_item::CreateOpsItem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_ops_item::CreateOpsItemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_ops_item::ser_create_ops_item_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_ops_item::CreateOpsItem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateOpsItem", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateOpsItem`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateOpsItem {
                type Output = std::result::Result<crate::operation::create_ops_item::CreateOpsItemOutput, crate::operation::create_ops_item::CreateOpsItemError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_ops_item::de_create_ops_item_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_ops_item::de_create_ops_item_http_response(response)
                     }
                }
            }
