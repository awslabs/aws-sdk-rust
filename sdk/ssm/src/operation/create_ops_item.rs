...
impl CreateOpsItemInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_ops_item::CreateOpsItem, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_ops_item::ser_create_ops_item_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOpsItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_ops_item::de_create_ops_item_http_response_with_props(status, headers, body)
        }
    }
}
