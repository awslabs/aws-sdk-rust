...
/// Orchestration and serialization glue logic for `CreateOpsItem`.
...
impl CreateOpsItem {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::create_ops_item::CreateOpsItemInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::create_ops_item::CreateOpsItemOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_ops_item::CreateOpsItemError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_ops_item::CreateOpsItemOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "CreateOpsItem", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.CreateOpsItem",
                "rpc.service" = "SSM",
                "rpc.method" = "CreateOpsItem",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateOpsItem {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateOpsItem");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateOpsItemRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateOpsItemResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateOpsItem")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateOpsItem", "SSM"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateOpsItem")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateOpsItemTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateOpsItemEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateOpsItemTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateOpsItemTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateOpsItemInput>() else {
        ...
        if requested.should_capture("OpsItemType") {
            if let ::std::option::Option::Some(value) = input.ops_item_type.as_deref() {
                captured.insert("OpsItemType", value);
            }
        }
...
#[derive(Debug)]
struct CreateOpsItemResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateOpsItemResponseDeserializer {
        ...
        if !success && status != 200 || force_error {
            ...
            let error_code = match generic.code() {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::create_ops_item::CreateOpsItemError::unhandled(
                            generic,
                        )),
                    ))
                }
            ...
            let err = match error_code {
                ...
                "OpsItemAlreadyExistsException" => crate::operation::create_ops_item::CreateOpsItemError::OpsItemAlreadyExistsException({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::OpsItemAlreadyExistsException::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::create_ops_item::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::create_ops_item::CreateOpsItemError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::create_ops_item::CreateOpsItemError::generic(generic),
                    }
                }
            };
            ...
            let protocol = _cfg
                .load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                .expect("a SharedClientProtocol is required");
            let mut deser = protocol.deserialize_response(response, CreateOpsItem::OUTPUT_SCHEMA, _cfg).map_err(|e| {
                ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
            })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::create_ops_item::CreateOpsItemOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct CreateOpsItemRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateOpsItemRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_ops_item::CreateOpsItemInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, CreateOpsItem::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct CreateOpsItemEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateOpsItemEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateOpsItemEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateOpsItemInput>()
            .ok_or("failed to downcast to CreateOpsItemInput")?;
...
pub enum CreateOpsItemError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateOpsItemError) for what information is available for the error.")]
...
impl CreateOpsItemError {
    ...
    /// Creates the `CreateOpsItemError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OpsItemAlreadyExistsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateOpsItemError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_ops_item::CreateOpsItemError {
