...
impl GetDocumentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_document::ser_get_document_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_document::GetDocument::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDocument", "ssm"));
