...
impl DescribePatchGroupStateInput {
    /// Consumes the builder and constructs an Operation<[`DescribePatchGroupState`](crate::operation::describe_patch_group_state::DescribePatchGroupState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_patch_group_state::DescribePatchGroupState, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_patch_group_state::DescribePatchGroupStateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_patch_group_state::ser_describe_patch_group_state_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_patch_group_state::DescribePatchGroupState::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePatchGroupState", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribePatchGroupState`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePatchGroupState {
                type Output = std::result::Result<crate::operation::describe_patch_group_state::DescribePatchGroupStateOutput, crate::operation::describe_patch_group_state::DescribePatchGroupStateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_patch_group_state::de_describe_patch_group_state_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_patch_group_state::de_describe_patch_group_state_http_response(response)
                     }
                }
            }
