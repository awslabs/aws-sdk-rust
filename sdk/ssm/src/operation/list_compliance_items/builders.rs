...
impl ListComplianceItemsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_compliance_items::ListComplianceItemsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_compliance_items::ListComplianceItemsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_compliance_items::ListComplianceItemsOutput, crate::operation::list_compliance_items::ListComplianceItemsError, Self> {
