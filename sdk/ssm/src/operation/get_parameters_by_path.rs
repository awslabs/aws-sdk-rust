...
impl GetParametersByPathInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_parameters_by_path::ser_get_parameters_by_path_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_parameters_by_path::GetParametersByPath::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_parameters_by_path::GetParametersByPathError
{
