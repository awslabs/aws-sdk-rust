...
impl GetParametersByPathInput {
    /// Consumes the builder and constructs an Operation<[`GetParametersByPath`](crate::operation::get_parameters_by_path::GetParametersByPath)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_parameters_by_path::GetParametersByPath, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_parameters_by_path::GetParametersByPathInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_parameters_by_path::ser_get_parameters_by_path_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_parameters_by_path::GetParametersByPath::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetParametersByPath", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetParametersByPath {
                type Output = std::result::Result<crate::operation::get_parameters_by_path::GetParametersByPathOutput, crate::operation::get_parameters_by_path::GetParametersByPathError>;
