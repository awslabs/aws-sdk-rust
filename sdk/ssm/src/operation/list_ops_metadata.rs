...
impl ListOpsMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_ops_metadata::ListOpsMetadata, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_ops_metadata::ser_list_ops_metadata_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOpsMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_ops_metadata::de_list_ops_metadata_http_response_with_props(status, headers, body)
        }
    }
}
