...
impl ListOpsMetadataInput {
    /// Consumes the builder and constructs an Operation<[`ListOpsMetadata`](crate::operation::list_ops_metadata::ListOpsMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_ops_metadata::ListOpsMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_ops_metadata::ListOpsMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_ops_metadata::ser_list_ops_metadata_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_ops_metadata::ListOpsMetadata::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListOpsMetadata", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListOpsMetadata {
                type Output = std::result::Result<crate::operation::list_ops_metadata::ListOpsMetadataOutput, crate::operation::list_ops_metadata::ListOpsMetadataError>;
