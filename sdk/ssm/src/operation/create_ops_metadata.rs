...
impl CreateOpsMetadataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_ops_metadata::ser_create_ops_metadata_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOpsMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_ops_metadata::de_create_ops_metadata_http_response_with_props(status, headers, body)
        }
    }
}
