...
impl DescribePatchPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`DescribePatchProperties`](crate::operation::describe_patch_properties::DescribePatchProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_patch_properties::DescribePatchProperties, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_patch_properties::DescribePatchPropertiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_patch_properties::ser_describe_patch_properties_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_patch_properties::DescribePatchProperties::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePatchProperties", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePatchProperties {
                type Output = std::result::Result<crate::operation::describe_patch_properties::DescribePatchPropertiesOutput, crate::operation::describe_patch_properties::DescribePatchPropertiesError>;
