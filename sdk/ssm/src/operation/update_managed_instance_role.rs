...
/// Orchestration and serialization glue logic for `UpdateManagedInstanceRole`.
...
impl UpdateManagedInstanceRole {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleOutput::SCHEMA;
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "UpdateManagedInstanceRole", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.UpdateManagedInstanceRole",
                "rpc.service" = "SSM",
                "rpc.method" = "UpdateManagedInstanceRole",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateManagedInstanceRole {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateManagedInstanceRole");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateManagedInstanceRoleRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateManagedInstanceRoleResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateManagedInstanceRole")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateManagedInstanceRole")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateManagedInstanceRoleTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateManagedInstanceRoleEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateManagedInstanceRoleTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateManagedInstanceRoleTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateManagedInstanceRoleInput>() else {
...
#[derive(Debug)]
struct UpdateManagedInstanceRoleResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateManagedInstanceRoleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                "InternalServerError" => crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError::InternalServerError({
                ...
                "InvalidInstanceId" => crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError::InvalidInstanceId({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::update_managed_instance_role::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, UpdateManagedInstanceRole::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct UpdateManagedInstanceRoleRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateManagedInstanceRoleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, UpdateManagedInstanceRole::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct UpdateManagedInstanceRoleEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateManagedInstanceRoleEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateManagedInstanceRoleEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateManagedInstanceRoleInput>()
            .ok_or("failed to downcast to UpdateManagedInstanceRoleInput")?;
...
pub enum UpdateManagedInstanceRoleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateManagedInstanceRoleError) for what information is available for the error.")]
...
impl UpdateManagedInstanceRoleError {
    ...
    /// Creates the `UpdateManagedInstanceRoleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateManagedInstanceRoleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError {
...
mod _update_managed_instance_role_output;
