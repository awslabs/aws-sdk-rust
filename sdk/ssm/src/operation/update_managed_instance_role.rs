...
impl UpdateManagedInstanceRoleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateManagedInstanceRole`](crate::operation::update_managed_instance_role::UpdateManagedInstanceRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_managed_instance_role::UpdateManagedInstanceRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_managed_instance_role::ser_update_managed_instance_role_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_managed_instance_role::UpdateManagedInstanceRole::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateManagedInstanceRole", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateManagedInstanceRole {
                type Output = std::result::Result<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleOutput, crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleError>;
