...
impl UpdateManagedInstanceRoleInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_managed_instance_role::UpdateManagedInstanceRole::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateManagedInstanceRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_managed_instance_role::de_update_managed_instance_role_http_response_with_props(status, headers, body)
        }
    }
}
