...
impl DescribePatchGroupsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_patch_groups::paginator::DescribePatchGroupsPaginatorItems {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_patch_groups_output_next_token(resp);
...
impl DescribePatchGroupsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_patch_groups_output_mappings(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
