...
impl PutParameterFluentBuilder {
    ...
    /// Access the PutParameter as a reference.
    pub fn as_input(&self) -> &crate::operation::put_parameter::builders::PutParameterInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_parameter::PutParameterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_parameter::PutParameterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::put_parameter::PutParameter::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_parameter::PutParameterOutput, crate::operation::put_parameter::PutParameterError, Self> {
    ...
    pub fn get_allowed_pattern(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_allowed_pattern()
    }
