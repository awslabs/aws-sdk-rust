...
impl ListResourceComplianceSummariesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummaries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceComplianceSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resource_compliance_summaries::de_list_resource_compliance_summaries_http_response_with_props(
                status, headers, body,
            )
        }
    }
