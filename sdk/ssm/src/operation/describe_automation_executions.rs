...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAutomationExecutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_automation_executions::de_describe_automation_executions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeAutomationExecutionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_automation_executions::DescribeAutomationExecutionsError
{
