...
impl DescribePatchGroups {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::describe_patch_groups::DescribePatchGroupsInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::describe_patch_groups::DescribePatchGroupsOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_patch_groups::DescribePatchGroupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_patch_groups::DescribePatchGroupsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "DescribePatchGroups", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.DescribePatchGroups",
                "rpc.service" = "SSM",
                "rpc.method" = "DescribePatchGroups",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribePatchGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribePatchGroupsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribePatchGroupsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribePatchGroups")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribePatchGroups")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribePatchGroupsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribePatchGroupsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribePatchGroupsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribePatchGroupsInput>() else {
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::describe_patch_groups::DescribePatchGroupsError::unhandled(generic),
                        ),
                    ))
                }
            };
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::describe_patch_groups::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::describe_patch_groups::DescribePatchGroupsError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::describe_patch_groups::DescribePatchGroupsError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, DescribePatchGroups::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::describe_patch_groups::DescribePatchGroupsOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePatchGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_patch_groups::DescribePatchGroupsInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, DescribePatchGroups::INPUT_SCHEMA, "/", _cfg)
