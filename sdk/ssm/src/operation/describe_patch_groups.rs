...
impl DescribePatchGroupsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_patch_groups::ser_describe_patch_groups_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_patch_groups::DescribePatchGroups::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_patch_groups::DescribePatchGroupsError
{
