...
impl UpdateMaintenanceWindowTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceWindowTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_maintenance_window_task::de_update_maintenance_window_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
