...
impl UpdateMaintenanceWindowTaskInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMaintenanceWindowTask`](crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_maintenance_window_task::ser_update_maintenance_window_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateMaintenanceWindowTask", "ssm"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMaintenanceWindowTask {
                type Output = std::result::Result<crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTaskOutput, crate::operation::update_maintenance_window_task::UpdateMaintenanceWindowTaskError>;
