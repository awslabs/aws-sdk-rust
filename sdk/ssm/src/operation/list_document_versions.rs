...
impl ListDocumentVersionsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_document_versions::ser_list_document_versions_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_document_versions::ListDocumentVersions::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::list_document_versions::ListDocumentVersionsError
{
