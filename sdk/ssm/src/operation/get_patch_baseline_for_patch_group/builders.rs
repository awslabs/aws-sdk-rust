...
impl GetPatchBaselineForPatchGroupFluentBuilder {
    ...
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_patch_baseline_for_patch_group::GetPatchBaselineForPatchGroupOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_patch_baseline_for_patch_group::GetPatchBaselineForPatchGroupError>>
                     {
        let op = self
            .inner
            .build()
