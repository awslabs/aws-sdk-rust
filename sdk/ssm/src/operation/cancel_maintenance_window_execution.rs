...
impl CancelMaintenanceWindowExecutionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_maintenance_window_execution::CancelMaintenanceWindowExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelMaintenanceWindowExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_maintenance_window_execution::de_cancel_maintenance_window_execution_http_response_with_props(
                status, headers, body,
            )
        }
    }
