...
impl CancelMaintenanceWindowExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_maintenance_window_execution::CancelMaintenanceWindowExecution,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelMaintenanceWindowExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_maintenance_window_execution::de_cancel_maintenance_window_execution_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_maintenance_window_execution::CancelMaintenanceWindowExecutionError
{
