...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelCommand {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_cancel_command::de_cancel_command_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_cancel_command::de_cancel_command_http_response_with_props(
                status, headers, body,
            )
        }
    }
