...
impl CancelCommand {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::cancel_command::CancelCommandInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::cancel_command::CancelCommandOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::cancel_command::CancelCommandError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::cancel_command::CancelCommandOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "CancelCommand", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.CancelCommand",
                "rpc.service" = "SSM",
                "rpc.method" = "CancelCommand",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelCommand {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelCommand");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CancelCommandRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CancelCommandResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CancelCommand", "SSM"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelCommand")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CancelCommandTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CancelCommandEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CancelCommandTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelCommandTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CancelCommandInput>() else {
...
#[derive(Debug)]
struct CancelCommandResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelCommandResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
            ...
            let error_code = match generic.code() {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::cancel_command::CancelCommandError::unhandled(generic)),
                    ))
                }
            };
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::cancel_command::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::cancel_command::CancelCommandError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::cancel_command::CancelCommandError::generic(generic),
                    }
                }
            };
            ...
            let protocol = _cfg
                .load::<::aws_smithy_schema::protocol::SharedClientProtocol>()
                .expect("a SharedClientProtocol is required");
            let mut deser = protocol.deserialize_response(response, CancelCommand::OUTPUT_SCHEMA, _cfg).map_err(|e| {
                ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
            })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::cancel_command::CancelCommandOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct CancelCommandRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelCommandRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::cancel_command::CancelCommandInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, CancelCommand::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct CancelCommandEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelCommandEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CancelCommandEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CancelCommandInput>()
            .ok_or("failed to downcast to CancelCommandInput")?;
...
pub enum CancelCommandError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelCommandError) for what information is available for the error.")]
...
impl CancelCommandError {
    ...
    /// Creates the `CancelCommandError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelCommandError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_command::CancelCommandError {
