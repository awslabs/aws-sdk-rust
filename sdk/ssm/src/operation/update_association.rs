...
/// Orchestration and serialization glue logic for `UpdateAssociation`.
...
impl UpdateAssociation {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::update_association::UpdateAssociationInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = crate::operation::update_association::UpdateAssociationOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_association::UpdateAssociationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_association::UpdateAssociationOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "UpdateAssociation", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.UpdateAssociation",
                "rpc.service" = "SSM",
                "rpc.method" = "UpdateAssociation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateAssociation");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateAssociationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateAssociationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateAssociation")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SensitiveOutput);
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateAssociation", "SSM"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateAssociation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateAssociationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateAssociationEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateAssociationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAssociationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateAssociationInput>() else {
        ...
        if requested.should_capture("AssociationVersion") {
            if let ::std::option::Option::Some(value) = input.association_version.as_deref() {
                captured.insert("AssociationVersion", value);
            }
        }
...
#[derive(Debug)]
struct UpdateAssociationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAssociationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        if !success && status != 200 || force_error {
            ...
            let error_code = match generic.code() {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(crate::operation::update_association::UpdateAssociationError::unhandled(
                            generic,
                        )),
                    ))
                }
            ...
            let err = match error_code {
                "AssociationDoesNotExist" => crate::operation::update_association::UpdateAssociationError::AssociationDoesNotExist({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::AssociationDoesNotExist::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                ...
                "AssociationVersionLimitExceeded" => crate::operation::update_association::UpdateAssociationError::AssociationVersionLimitExceeded({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::AssociationVersionLimitExceeded::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                ...
                "InvalidAssociationVersion" => crate::operation::update_association::UpdateAssociationError::InvalidAssociationVersion({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::InvalidAssociationVersion::deserialize_with_response(
                            &mut *deser,
                            response.headers(),
                            response.status().into(),
                            body,
                ...
                "InvalidUpdate" => crate::operation::update_association::UpdateAssociationError::InvalidUpdate({
                    let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                        crate::types::error::InvalidUpdate::deserialize_with_response(&mut *deser, response.headers(), response.status().into(), body)
                    }) {
                        ::std::result::Result::Ok(val) => val,
                        ::std::result::Result::Err(e) => {
                            return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::update_association::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::update_association::UpdateAssociationError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::update_association::UpdateAssociationError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, UpdateAssociation::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::update_association::UpdateAssociationOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct UpdateAssociationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_association::UpdateAssociationInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, UpdateAssociation::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct UpdateAssociationEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAssociationEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateAssociationEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateAssociationInput>()
            .ok_or("failed to downcast to UpdateAssociationInput")?;
...
pub enum UpdateAssociationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateAssociationError) for what information is available for the error.")]
...
impl UpdateAssociationError {
    ...
    /// Creates the `UpdateAssociationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AssociationVersionLimitExceeded(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InternalServerError(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidAssociationVersion(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::InvalidUpdate(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for UpdateAssociationError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::AssociationVersionLimitExceeded(_inner) => ::std::option::Option::Some(_inner),
            Self::InternalServerError(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidAssociationVersion(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::InvalidUpdate(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateAssociationError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AssociationVersionLimitExceeded(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InternalServerError(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidAssociationVersion(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::InvalidUpdate(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::TooManyUpdates(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateAssociationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_association::UpdateAssociationError {
