...
impl UpdateAssociationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_association::ser_update_association_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_association::de_update_association_http_response_with_props(status, headers, body)
        }
    }
