...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAssociationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_association::de_update_association_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_association::de_update_association_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_association::UpdateAssociationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_association::ser_update_association_input(&input)?);
