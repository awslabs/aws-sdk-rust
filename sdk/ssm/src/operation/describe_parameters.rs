...
impl DescribeParametersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeParameters`](crate::operation::describe_parameters::DescribeParameters)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_parameters::ser_describe_parameters_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_parameters::DescribeParameters::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeParameters", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_parameters::de_describe_parameters_http_response_with_props(status, headers, body)
        }
    }
}
