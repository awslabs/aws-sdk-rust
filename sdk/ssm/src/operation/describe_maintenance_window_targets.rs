...
impl DescribeMaintenanceWindowTargets {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargetsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeMaintenanceWindowTargetsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeMaintenanceWindowTargetsRequestSerializer {
