...
impl StartAutomationExecution {
    ...
    pub const INPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::start_automation_execution::StartAutomationExecutionInput::SCHEMA;
    /// The schema for this operation's output shape.
    pub const OUTPUT_SCHEMA: &'static ::aws_smithy_schema::Schema<'static> =
        crate::operation::start_automation_execution::StartAutomationExecutionOutput::SCHEMA;
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_automation_execution::StartAutomationExecutionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_automation_execution::StartAutomationExecutionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SSM", "StartAutomationExecution", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SSM.StartAutomationExecution",
                "rpc.service" = "SSM",
                "rpc.method" = "StartAutomationExecution",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartAutomationExecution {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartAutomationExecution");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartAutomationExecutionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartAutomationExecutionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartAutomationExecution")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartAutomationExecution")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartAutomationExecutionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartAutomationExecutionEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct StartAutomationExecutionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartAutomationExecutionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartAutomationExecutionInput>() else {
        ...
        if requested.should_capture("TargetParameterName") {
            if let ::std::option::Option::Some(value) = input.target_parameter_name.as_deref() {
                captured.insert("TargetParameterName", value);
            }
        }
        ...
        if requested.should_capture("TargetLocationsURL") {
            if let ::std::option::Option::Some(value) = input.target_locations_url.as_deref() {
                captured.insert("TargetLocationsURL", value);
            }
        }
...
#[derive(Debug)]
struct StartAutomationExecutionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartAutomationExecutionResponseDeserializer {
        ...
        if !success && status != 200 || force_error {
                ...
                ::std::option::Option::None => {
                    return ::std::result::Result::Err(::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(
                        ::aws_smithy_runtime_api::box_error::BoxError::from(
                            crate::operation::start_automation_execution::StartAutomationExecutionError::unhandled(generic),
                        ),
                    ))
                }
            };
            ...
            let err = match error_code {
                ...
                "IdempotentParameterMismatch" => {
                    crate::operation::start_automation_execution::StartAutomationExecutionError::IdempotentParameterMismatch({
                        let mut tmp = match protocol.deserialize_error_response(response, _cfg).and_then(|mut deser| {
                    ...
                    match protocol
                        ...
                        .and_then(|mut deser| {
                            ::aws_smithy_schema::registry::reify_error(
                                crate::operation::start_automation_execution::error_registry::REGISTRY
                                    .or(&crate::error_type_registry::REGISTRY),
                                error_code,
                                &mut *deser,
                            )
                        }) {
                        ::std::option::Option::Some(source) => <crate::operation::start_automation_execution::StartAutomationExecutionError as ::aws_smithy_runtime_api::client::result::CreateUnhandledError>::create_unhandled_error(source, ::std::option::Option::Some(generic)),
                        ::std::option::Option::None => crate::operation::start_automation_execution::StartAutomationExecutionError::generic(generic),
                    }
                }
            };
            ...
            let mut deser = protocol
                .deserialize_response(response, StartAutomationExecution::OUTPUT_SCHEMA, _cfg)
                .map_err(|e| {
                    ::aws_smithy_runtime_api::client::orchestrator::OrchestratorError::other(::aws_smithy_runtime_api::box_error::BoxError::from(e))
                })?;
            ...
            #[allow(unused_mut)]
            let mut output = crate::operation::start_automation_execution::StartAutomationExecutionOutput::deserialize_with_response(
                &mut *deser,
                _response_headers,
                response.status().into(),
                body,
...
#[derive(Debug)]
struct StartAutomationExecutionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartAutomationExecutionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_automation_execution::StartAutomationExecutionInput>()
            .expect("correct type");
        ...
        let mut request = protocol
            .serialize_request(&input, StartAutomationExecution::INPUT_SCHEMA, "/", _cfg)
...
#[derive(Debug)]
struct StartAutomationExecutionEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartAutomationExecutionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "StartAutomationExecutionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartAutomationExecutionInput>()
            .ok_or("failed to downcast to StartAutomationExecutionInput")?;
...
pub enum StartAutomationExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartAutomationExecutionError) for what information is available for the error.")]
...
impl StartAutomationExecutionError {
    ...
    /// Creates the `StartAutomationExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartAutomationExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_automation_execution::StartAutomationExecutionError {
