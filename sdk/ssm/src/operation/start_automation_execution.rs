...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartAutomationExecutionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_automation_execution::de_start_automation_execution_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_automation_execution::de_start_automation_execution_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartAutomationExecutionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_automation_execution::ser_start_automation_execution_input(&input)?,
        );
