...
static LISTCOMPLIANCESUMMARIESINPUT_MEMBER_FILTERS_MEMBER: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
...
static LISTCOMPLIANCESUMMARIESINPUT_MEMBER_FILTERS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListComplianceSummariesInput$Filters",
...
.with_list_member(&LISTCOMPLIANCESUMMARIESINPUT_MEMBER_FILTERS_MEMBER);
static LISTCOMPLIANCESUMMARIESINPUT_MEMBER_NEXT_TOKEN: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListComplianceSummariesInput$NextToken",
        "com.amazonaws.ssm.synthetic",
        "ListComplianceSummariesInput",
    ),
...
static LISTCOMPLIANCESUMMARIESINPUT_MEMBER_MAX_RESULTS: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListComplianceSummariesInput$MaxResults",
        "com.amazonaws.ssm.synthetic",
        "ListComplianceSummariesInput",
    ),
...
static LISTCOMPLIANCESUMMARIESINPUT_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm.synthetic#ListComplianceSummariesInput",
        "com.amazonaws.ssm.synthetic",
        "ListComplianceSummariesInput",
    ),
    ::aws_smithy_schema::ShapeType::Structure,
    &[
        &LISTCOMPLIANCESUMMARIESINPUT_MEMBER_FILTERS,
        &LISTCOMPLIANCESUMMARIESINPUT_MEMBER_NEXT_TOKEN,
        &LISTCOMPLIANCESUMMARIESINPUT_MEMBER_MAX_RESULTS,
    ],
)
.with_payload_hint(::aws_smithy_schema::PayloadHint::NoStructPayload)
.with_original_name("ListComplianceSummariesRequest");
impl ListComplianceSummariesInput {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &LISTCOMPLIANCESUMMARIESINPUT_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for ListComplianceSummariesInput {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.next_token {
            ser.write_string(&LISTCOMPLIANCESUMMARIESINPUT_MEMBER_NEXT_TOKEN, val)?;
        }
        if let Some(ref val) = self.max_results {
            ser.write_integer(&LISTCOMPLIANCESUMMARIESINPUT_MEMBER_MAX_RESULTS, *val)?;
        }
        Ok(())
    }
}
impl ListComplianceSummariesInput {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&LISTCOMPLIANCESUMMARIESINPUT_SCHEMA, &mut |member, deser| {
