...
impl DescribeMaintenanceWindowsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsInput, ::aws_smithy_types::error::operation::BuildError> {
