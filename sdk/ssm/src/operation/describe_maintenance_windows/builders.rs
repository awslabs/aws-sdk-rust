...
pub use crate::operation::describe_maintenance_windows::_describe_maintenance_windows_output::DescribeMaintenanceWindowsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsOutput,
                    crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsError,
                > for DescribeMaintenanceWindowsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeMaintenanceWindowsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_maintenance_windows::DescribeMaintenanceWindows::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsOutput, crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_maintenance_windows::paginator::DescribeMaintenanceWindowsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
