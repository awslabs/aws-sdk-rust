...
impl CreateDocumentInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_document::CreateDocument, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_document::CreateDocumentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_document::ser_create_document_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDocument {
                type Output = std::result::Result<crate::operation::create_document::CreateDocumentOutput, crate::operation::create_document::CreateDocumentError>;
