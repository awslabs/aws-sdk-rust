...
impl CreateDocumentInput {
    /// Consumes the builder and constructs an Operation<[`CreateDocument`](crate::operation::create_document::CreateDocument)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_document::CreateDocument, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_document::ser_create_document_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_document::CreateDocument::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDocument", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDocument {
    type Output =
        ::std::result::Result<crate::operation::create_document::CreateDocumentOutput, crate::operation::create_document::CreateDocumentError>;
