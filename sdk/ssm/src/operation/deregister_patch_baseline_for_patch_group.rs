...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterPatchBaselineForPatchGroup {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeregisterPatchBaselineForPatchGroup", "ssm"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeregisterPatchBaselineForPatchGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeregisterPatchBaselineForPatchGroupRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeregisterPatchBaselineForPatchGroupEndpointParamsInterceptor {
