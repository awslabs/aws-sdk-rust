...
impl StartChangeRequestExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartChangeRequestExecution`](crate::operation::start_change_request_execution::StartChangeRequestExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_change_request_execution::StartChangeRequestExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_change_request_execution::StartChangeRequestExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_change_request_execution::ser_start_change_request_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_change_request_execution::StartChangeRequestExecution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartChangeRequestExecution", "ssm"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `StartChangeRequestExecution`.
...
impl aws_smithy_http::response::ParseStrictResponse for StartChangeRequestExecution {
                type Output = std::result::Result<crate::operation::start_change_request_execution::StartChangeRequestExecutionOutput, crate::operation::start_change_request_execution::StartChangeRequestExecutionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_change_request_execution::de_start_change_request_execution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_change_request_execution::de_start_change_request_execution_http_response(response)
                     }
                }
            }
