...
impl ::aws_smithy_http::response::ParseStrictResponse for StartChangeRequestExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_change_request_execution::de_start_change_request_execution_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StartChangeRequestExecutionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_change_request_execution::StartChangeRequestExecutionError
{
