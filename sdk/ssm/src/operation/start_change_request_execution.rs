...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartChangeRequestExecutionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_change_request_execution::de_start_change_request_execution_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_change_request_execution::de_start_change_request_execution_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartChangeRequestExecutionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_change_request_execution::StartChangeRequestExecutionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_change_request_execution::ser_start_change_request_execution_input(&input)?,
        );
