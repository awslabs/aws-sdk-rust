...
impl DescribeMaintenanceWindowScheduleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowSchedule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_maintenance_window_schedule::de_describe_maintenance_window_schedule_http_response_with_props(
                status, headers, body,
            )
        }
    }
