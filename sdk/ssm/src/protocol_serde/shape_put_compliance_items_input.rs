...
pub fn ser_put_compliance_items_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutComplianceItemsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
