...
pub fn ser_compliance_item_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComplianceItemEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
