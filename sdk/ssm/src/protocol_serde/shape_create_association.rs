...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_association::CreateAssociationError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "AssociationAlreadyExists" => {
            crate::operation::create_association::CreateAssociationError::AssociationAlreadyExists(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "AssociationLimitExceeded" => {
            crate::operation::create_association::CreateAssociationError::AssociationLimitExceeded(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "InternalServerError" => {
            crate::operation::create_association::CreateAssociationError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocument" => {
            crate::operation::create_association::CreateAssociationError::InvalidDocument({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocumentVersion" => {
            crate::operation::create_association::CreateAssociationError::InvalidDocumentVersion({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidInstanceId" => {
            crate::operation::create_association::CreateAssociationError::InvalidInstanceId({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidOutputLocation" => {
            crate::operation::create_association::CreateAssociationError::InvalidOutputLocation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidParameters" => {
            crate::operation::create_association::CreateAssociationError::InvalidParameters({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidSchedule" => {
            crate::operation::create_association::CreateAssociationError::InvalidSchedule({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidTarget" => {
            crate::operation::create_association::CreateAssociationError::InvalidTarget({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidTargetBuilder::default();
                    output =
                        crate::protocol_serde::shape_invalid_target::de_invalid_target_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(
                            crate::operation::create_association::CreateAssociationError::unhandled,
                        )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "InvalidTargetMaps" => {
            crate::operation::create_association::CreateAssociationError::InvalidTargetMaps({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnsupportedPlatformType" => {
            crate::operation::create_association::CreateAssociationError::UnsupportedPlatformType({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
