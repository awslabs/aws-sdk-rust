...
pub fn de_create_association_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_association::CreateAssociationOutput, crate::operation::create_association::CreateAssociationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_association_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_association::CreateAssociationOutput, crate::operation::create_association::CreateAssociationError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_create_association_input(input: &crate::operation::create_association::CreateAssociationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_create_association_input::ser_create_association_input_input(&mut object, input)?;
    object.finish();
