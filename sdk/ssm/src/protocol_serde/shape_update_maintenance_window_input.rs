...
pub fn ser_update_maintenance_window_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateMaintenanceWindowInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
