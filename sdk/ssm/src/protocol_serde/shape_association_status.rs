...
pub(crate) fn de_association_status<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AssociationStatus>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "Name" => {
                            builder = builder.set_name(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AssociationStatusName::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Message" => {
