...
pub fn ser_update_patch_baseline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePatchBaselineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
