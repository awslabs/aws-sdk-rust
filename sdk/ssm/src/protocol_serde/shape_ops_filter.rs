...
pub fn ser_ops_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OpsFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
