...
pub fn ser_ops_item_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OpsItemFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
