...
pub fn ser_put_parameter_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutParameterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
