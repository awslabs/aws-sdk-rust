...
pub fn ser_ops_item_event_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OpsItemEventFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
