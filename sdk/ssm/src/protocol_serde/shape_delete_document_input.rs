...
pub fn ser_delete_document_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteDocumentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
