...
pub fn ser_delete_inventory_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteInventoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
