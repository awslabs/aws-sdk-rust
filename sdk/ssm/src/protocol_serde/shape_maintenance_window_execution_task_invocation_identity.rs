...
pub(crate) fn de_maintenance_window_execution_task_invocation_identity<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> Result<Option<crate::types::MaintenanceWindowExecutionTaskInvocationIdentity>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
