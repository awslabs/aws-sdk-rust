...
pub fn ser_baseline_override(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BaselineOverride) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
