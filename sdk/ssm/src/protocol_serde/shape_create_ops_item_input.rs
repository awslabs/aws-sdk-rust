...
pub fn ser_create_ops_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOpsItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
