...
pub fn ser_list_compliance_items_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListComplianceItemsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
