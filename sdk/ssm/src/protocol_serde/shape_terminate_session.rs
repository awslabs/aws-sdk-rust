    ...
    Err(match error_code {
        "InternalServerError" => crate::error::TerminateSessionError::InternalServerError({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_internal_server_error::de_internal_server_error_json_err(response.body().as_ref(), output).map_err(crate::error::TerminateSessionError::unhandled)?;
