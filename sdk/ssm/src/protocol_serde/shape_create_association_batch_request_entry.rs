...
pub fn ser_create_association_batch_request_entry(
    ...
    if let Some(var_29) = &input.schedule_offset {
        object.key("ScheduleOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_29).into()));
    }
    if let Some(var_30) = &input.duration {
        object.key("Duration").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_30).into()));
    }
...
pub(crate) fn de_create_association_batch_request_entry<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CreateAssociationBatchRequestEntry>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::create_association_batch_request_entry_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
