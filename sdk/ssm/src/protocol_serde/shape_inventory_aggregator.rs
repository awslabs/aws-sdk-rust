...
pub fn ser_inventory_aggregator(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InventoryAggregator) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
