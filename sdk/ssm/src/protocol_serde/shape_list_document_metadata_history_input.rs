...
pub fn ser_list_document_metadata_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListDocumentMetadataHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
