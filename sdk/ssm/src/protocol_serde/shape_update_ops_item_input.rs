...
pub fn ser_update_ops_item_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateOpsItemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
