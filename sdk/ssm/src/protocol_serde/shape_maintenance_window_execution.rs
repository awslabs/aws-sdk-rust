...
pub(crate) fn de_maintenance_window_execution<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::MaintenanceWindowExecution>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
