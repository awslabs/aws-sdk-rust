...
pub fn ser_get_ops_summary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetOpsSummaryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
