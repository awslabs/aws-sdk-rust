...
pub(crate) fn de_association_version_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AssociationVersionInfo>, aws_smithy_json::deserialize::error::DeserializeError>
