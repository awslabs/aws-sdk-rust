...
pub(crate) fn de_automation_execution_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutomationExecutionMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "AutomationType" => {
                                builder = builder.set_automation_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::AutomationType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
