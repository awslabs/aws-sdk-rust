...
pub fn ser_create_patch_baseline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePatchBaselineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
