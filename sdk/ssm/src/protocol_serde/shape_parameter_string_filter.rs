...
pub fn ser_parameter_string_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParameterStringFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
