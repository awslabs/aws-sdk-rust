...
pub fn ser_describe_maintenance_window_execution_task_invocations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_maintenance_window_execution_task_invocations::DescribeMaintenanceWindowExecutionTaskInvocationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
