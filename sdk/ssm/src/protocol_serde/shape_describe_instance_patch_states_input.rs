...
pub fn ser_describe_instance_patch_states_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeInstancePatchStatesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
