...
pub(crate) fn de_document_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DocumentDescription>, aws_smithy_json::deserialize::error::DeserializeError>
