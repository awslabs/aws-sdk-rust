...
pub fn ser_describe_maintenance_window_schedule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeMaintenanceWindowScheduleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
