...
pub fn ser_describe_instance_patches_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeInstancePatchesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
