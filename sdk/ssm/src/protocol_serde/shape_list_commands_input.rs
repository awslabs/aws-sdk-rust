...
pub fn ser_list_commands_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCommandsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
