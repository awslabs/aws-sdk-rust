...
pub(crate) fn de_maintenance_window_identity<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::MaintenanceWindowIdentity>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
