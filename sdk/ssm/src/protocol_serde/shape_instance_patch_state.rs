...
pub(crate) fn de_instance_patch_state<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstancePatchState>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "RebootOption" => {
                                builder = builder.set_reboot_option(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::RebootOption::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
