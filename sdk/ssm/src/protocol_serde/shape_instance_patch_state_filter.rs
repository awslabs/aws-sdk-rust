...
pub fn ser_instance_patch_state_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstancePatchStateFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
