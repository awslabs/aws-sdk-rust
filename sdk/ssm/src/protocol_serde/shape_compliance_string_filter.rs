...
pub fn ser_compliance_string_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComplianceStringFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
