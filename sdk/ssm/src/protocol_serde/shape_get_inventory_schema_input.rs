...
pub fn ser_get_inventory_schema_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetInventorySchemaInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
