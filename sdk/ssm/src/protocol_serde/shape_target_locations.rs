...
pub(crate) fn de_target_locations<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::TargetLocation>>, aws_smithy_json::deserialize::error::DeserializeError>
