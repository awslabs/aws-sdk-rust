...
pub fn ser_create_ops_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOpsMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
