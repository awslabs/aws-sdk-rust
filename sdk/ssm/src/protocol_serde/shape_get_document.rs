    ...
    Err(match error_code {
        "InternalServerError" => crate::error::GetDocumentError::InternalServerError({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_internal_server_error::de_internal_server_error_json_err(response.body().as_ref(), output).map_err(crate::error::GetDocumentError::unhandled)?;
        ...
        "InvalidDocument" => {
            crate::error::GetDocumentError::InvalidDocument({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::invalid_document::Builder::default();
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_document::de_invalid_document_json_err(response.body().as_ref(), output).map_err(crate::error::GetDocumentError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidDocumentVersion" => crate::error::GetDocumentError::InvalidDocumentVersion({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_invalid_document_version::de_invalid_document_version_json_err(response.body().as_ref(), output).map_err(crate::error::GetDocumentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
