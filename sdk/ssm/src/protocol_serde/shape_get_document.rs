...
pub fn de_get_document_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_document::GetDocumentOutput, crate::operation::get_document::GetDocumentError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::get_document::builders::GetDocumentOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
