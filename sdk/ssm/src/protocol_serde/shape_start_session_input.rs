...
pub fn ser_start_session_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartSessionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
