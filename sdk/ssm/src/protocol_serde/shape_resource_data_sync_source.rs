...
pub fn ser_resource_data_sync_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceDataSyncSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
