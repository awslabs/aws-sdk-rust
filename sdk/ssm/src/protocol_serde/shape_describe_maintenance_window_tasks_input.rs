...
pub fn ser_describe_maintenance_window_tasks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeMaintenanceWindowTasksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
