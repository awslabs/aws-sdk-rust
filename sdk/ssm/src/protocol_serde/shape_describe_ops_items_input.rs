...
pub fn ser_describe_ops_items_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeOpsItemsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
