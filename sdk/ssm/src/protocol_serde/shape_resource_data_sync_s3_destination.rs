                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SyncFormat" => {
                            builder = builder.set_sync_format(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ResourceDataSyncS3Format::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Region" => {
                        ...
                        "DestinationDataSharing" => {
                            builder = builder.set_destination_data_sharing(
                                    crate::protocol_serde::shape_resource_data_sync_destination_data_sharing::de_resource_data_sync_destination_data_sharing(tokens, _value, depth + 1)?
                                );
                        }
