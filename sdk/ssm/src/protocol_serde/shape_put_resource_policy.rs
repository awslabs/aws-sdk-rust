        ...
        "ResourcePolicyConflictException" => {
            crate::error::PutResourcePolicyError::ResourcePolicyConflictException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_policy_conflict_exception::de_resource_policy_conflict_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PutResourcePolicyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "ResourcePolicyInvalidParameterException" => {
            crate::error::PutResourcePolicyError::ResourcePolicyInvalidParameterException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_policy_invalid_parameter_exception::de_resource_policy_invalid_parameter_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PutResourcePolicyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "ResourcePolicyLimitExceededException" => {
            crate::error::PutResourcePolicyError::ResourcePolicyLimitExceededException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_policy_limit_exceeded_exception::de_resource_policy_limit_exceeded_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PutResourcePolicyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
