...
pub fn ser_create_cloud_connector_input_input(
    ...
    if let Some(var_4) = &input.configuration {
        ...
        crate::protocol_serde::shape_cloud_connector_configuration::ser_cloud_connector_configuration(&mut object_5, var_4)?;
        object_5.finish();
    }
    if let Some(var_6) = &input.config_connector_arn {
        object.key("ConfigConnectorArn").string(var_6.as_str());
    }
