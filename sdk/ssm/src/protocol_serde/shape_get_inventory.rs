...
pub fn de_get_inventory_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_inventory::GetInventoryOutput, crate::operation::get_inventory::GetInventoryError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_inventory_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_inventory::GetInventoryOutput, crate::operation::get_inventory::GetInventoryError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_get_inventory_input(input: &crate::operation::get_inventory::GetInventoryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_get_inventory(value: &[u8], mut builder: crate::operation::get_inventory::builders::GetInventoryOutputBuilder) -> Result<crate::operation::get_inventory::builders::GetInventoryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
