...
> {
    ...
    Err(match error_code {
        "InternalServerError" => {
            crate::operation::get_inventory::GetInventoryError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidNextToken" => {
            crate::operation::get_inventory::GetInventoryError::InvalidNextToken({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidTypeNameException" => {
            crate::operation::get_inventory::GetInventoryError::InvalidTypeNameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_inventory::de_get_inventory(_response_body, output)
                .map_err(crate::operation::get_inventory::GetInventoryError::unhandled)?;
