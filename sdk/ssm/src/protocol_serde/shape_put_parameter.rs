...
pub fn de_put_parameter_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_parameter::PutParameterOutput, crate::operation::put_parameter::PutParameterError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_parameter_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_parameter::PutParameterOutput, crate::operation::put_parameter::PutParameterError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_put_parameter_input(input: &crate::operation::put_parameter::PutParameterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
