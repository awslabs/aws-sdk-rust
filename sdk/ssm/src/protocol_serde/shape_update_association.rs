...
pub fn ser_update_association_input(
    ...
    crate::protocol_serde::shape_update_association_input::ser_update_association_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::update_association::UpdateAssociationError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_update_association::de_update_association(
