...
pub fn ser_list_inventory_entries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListInventoryEntriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
