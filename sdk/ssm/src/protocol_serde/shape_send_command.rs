    ...
    Err(match error_code {
        ...
        "InvalidNotificationConfig" => crate::operation::send_command::SendCommandError::InvalidNotificationConfig({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_notification_config::de_invalid_notification_config_json_err(_response_body, output)
                    .map_err(crate::operation::send_command::SendCommandError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidOutputFolder" => crate::operation::send_command::SendCommandError::InvalidOutputFolder({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_output_folder::de_invalid_output_folder_json_err(_response_body, output)
                    .map_err(crate::operation::send_command::SendCommandError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidRole" => crate::operation::send_command::SendCommandError::InvalidRole({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_role::de_invalid_role_json_err(_response_body, output)
                    .map_err(crate::operation::send_command::SendCommandError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Command" => {
                    builder = builder.set_command(crate::protocol_serde::shape_command::de_command(tokens, _value, depth + 1)?);
                }
