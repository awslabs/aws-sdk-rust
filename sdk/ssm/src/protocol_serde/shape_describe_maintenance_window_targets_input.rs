...
pub fn ser_describe_maintenance_window_targets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeMaintenanceWindowTargetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
