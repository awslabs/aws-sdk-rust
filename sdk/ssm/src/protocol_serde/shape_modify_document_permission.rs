...
pub fn de_modify_document_permission_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_document_permission::ModifyDocumentPermissionOutput, crate::operation::modify_document_permission::ModifyDocumentPermissionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_document_permission_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_document_permission::ModifyDocumentPermissionOutput, crate::operation::modify_document_permission::ModifyDocumentPermissionError> {
    Ok({
        #[allow(unused_mut)]
