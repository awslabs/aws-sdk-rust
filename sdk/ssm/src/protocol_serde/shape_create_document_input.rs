...
pub fn ser_create_document_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDocumentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
