...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_maintenance_window_task_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
        ...
        match tokens.next().transpose()? {
            ...
            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    ...
                    "Targets" => {
                        builder = builder
                            .set_targets(crate::protocol_serde::shape_targets::de_targets(tokens)?);
                    }
                    "TaskArn" => {
                        ...
                        builder = builder.set_cutoff_behavior(
                            ...
                            .map(|s| {
                                s.to_unescaped().map(|u| {
                                    crate::types::MaintenanceWindowTaskCutoffBehavior::from(
                                        u.as_ref(),
                                    )
                                })
                            })
