...
pub fn ser_describe_automation_step_executions_input(input: &crate::operation::describe_automation_step_executions::DescribeAutomationStepExecutionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
