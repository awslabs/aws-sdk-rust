...
pub fn ser_register_target_with_maintenance_window_input(
    ...
    crate::protocol_serde::shape_register_target_with_maintenance_window_input::ser_register_target_with_maintenance_window_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::unhandled)?;
    ...
    Err(match error_code {
        "DoesNotExistException" => {
            crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::DoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_idempotent_parameter_mismatch::de_idempotent_parameter_mismatch_json_err(_response_body, output)
                            .map_err(
                                crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "InternalServerError" => {
            crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_target_with_maintenance_window_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_register_target_with_maintenance_window::de_register_target_with_maintenance_window(_response_body, output)
                .map_err(crate::operation::register_target_with_maintenance_window::RegisterTargetWithMaintenanceWindowError::unhandled)?;
