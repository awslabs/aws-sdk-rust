...
pub(crate) fn de_compliance_execution_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ComplianceExecutionSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
