...
pub fn ser_ops_aggregator(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpsAggregator) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
