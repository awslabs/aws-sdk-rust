...
) -> ::std::result::Result<Option<crate::types::AutomationExecution>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AutomationExecutionStatus" => {
                            builder = builder.set_automation_execution_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AutomationExecutionStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "StepExecutions" => {
                            builder = builder.set_step_executions(crate::protocol_serde::shape_step_execution_list::de_step_execution_list(tokens)?);
                        }
                        "StepExecutionsTruncated" => {
                            builder =
                                builder.set_step_executions_truncated(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "Parameters" => {
                        ...
                        "ResolvedTargets" => {
                            builder = builder.set_resolved_targets(crate::protocol_serde::shape_resolved_targets::de_resolved_targets(tokens)?);
                        }
                        "MaxConcurrency" => {
                        ...
                        "ProgressCounters" => {
                            builder = builder.set_progress_counters(crate::protocol_serde::shape_progress_counters::de_progress_counters(tokens)?);
                        }
                        "AlarmConfiguration" => {
                            builder =
                        ...
                        "AutomationSubtype" => {
                            builder = builder.set_automation_subtype(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AutomationSubtype::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ScheduledTime" => {
                            builder = builder.set_scheduled_time(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        "Runbooks" => {
                            builder = builder.set_runbooks(crate::protocol_serde::shape_runbooks::de_runbooks(tokens)?);
                        }
                        "OpsItemId" => {
