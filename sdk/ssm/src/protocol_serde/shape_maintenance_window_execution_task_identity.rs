...
pub(crate) fn de_maintenance_window_execution_task_identity<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::MaintenanceWindowExecutionTaskIdentity>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::MaintenanceWindowExecutionTaskIdentityBuilder::default();
            loop {
                match tokens.next().transpose()? {
