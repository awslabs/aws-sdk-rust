...
pub fn ser_send_command_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendCommandInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
