...
pub fn ser_list_nodes_summary_input_input(
        ...
        for item_4 in var_2 {
            {
                ...
                crate::protocol_serde::shape_node_filter::ser_node_filter(&mut object_5, item_4)?;
                object_5.finish();
            }
        }
        array_3.finish();
        ...
        for item_8 in var_6 {
            {
                ...
                crate::protocol_serde::shape_node_aggregator::ser_node_aggregator(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
