...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_document::UpdateDocumentError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "DocumentVersionLimitExceeded" => {
            crate::operation::update_document::UpdateDocumentError::DocumentVersionLimitExceeded({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DuplicateDocumentContent" => {
            crate::operation::update_document::UpdateDocumentError::DuplicateDocumentContent({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DuplicateDocumentVersionName" => {
            crate::operation::update_document::UpdateDocumentError::DuplicateDocumentVersionName({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalServerError" => {
            crate::operation::update_document::UpdateDocumentError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocument" => {
            crate::operation::update_document::UpdateDocumentError::InvalidDocument({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocumentContent" => {
            crate::operation::update_document::UpdateDocumentError::InvalidDocumentContent({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocumentOperation" => {
            crate::operation::update_document::UpdateDocumentError::InvalidDocumentOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocumentSchemaVersion" => {
            crate::operation::update_document::UpdateDocumentError::InvalidDocumentSchemaVersion({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidDocumentVersion" => {
            crate::operation::update_document::UpdateDocumentError::InvalidDocumentVersion({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "MaxDocumentSizeExceeded" => {
            crate::operation::update_document::UpdateDocumentError::MaxDocumentSizeExceeded({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_document_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_update_document(
    ...
    crate::operation::update_document::builders::UpdateDocumentOutputBuilder,
