...
pub fn ser_register_target_with_maintenance_window_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterTargetWithMaintenanceWindowInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
