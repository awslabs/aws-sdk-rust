...
pub fn ser_list_command_invocations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_command_invocations::ListCommandInvocationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
