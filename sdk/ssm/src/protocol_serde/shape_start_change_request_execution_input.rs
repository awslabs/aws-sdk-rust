...
pub fn ser_start_change_request_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartChangeRequestExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
