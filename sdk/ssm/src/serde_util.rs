...
pub(crate) fn credentials_correct_errors(mut builder: crate::types::builders::CredentialsBuilder) -> crate::types::builders::CredentialsBuilder {
    ...
    if builder.expiration_time.is_none() {
        builder.expiration_time = Some(::aws_smithy_types::DateTime::from_fractional_secs(0, 0_f64))
    }
    builder
}
...
pub(crate) fn azure_subscription_correct_errors(
    mut builder: crate::types::builders::AzureSubscriptionBuilder,
) -> crate::types::builders::AzureSubscriptionBuilder {
