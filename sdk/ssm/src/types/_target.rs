...
static TARGET_MEMBER_KEY: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#Target$Key", "com.amazonaws.ssm", "Target"),
    ::aws_smithy_schema::ShapeType::String,
    "Key",
    0,
);
static TARGET_MEMBER_VALUES_MEMBER: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#TargetValues$member", "com.amazonaws.ssm", "TargetValues"),
    ::aws_smithy_schema::ShapeType::String,
    "member",
    0,
);
static TARGET_MEMBER_VALUES: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#Target$Values", "com.amazonaws.ssm", "Target"),
    ::aws_smithy_schema::ShapeType::List,
    "Values",
    1,
)
.with_list_member(&TARGET_MEMBER_VALUES_MEMBER);
static TARGET_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#Target", "com.amazonaws.ssm", "Target"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&TARGET_MEMBER_KEY, &TARGET_MEMBER_VALUES],
);
impl Target {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &TARGET_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for Target {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.key {
            ser.write_string(&TARGET_MEMBER_KEY, val)?;
        }
        if let Some(ref val) = self.values {
            ser.write_list(&TARGET_MEMBER_VALUES, &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                for item in val {
...
impl Target {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&TARGET_SCHEMA, &mut |member, deser| {
