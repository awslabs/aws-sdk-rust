...
static UNSUPPORTEDOPERATIONEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#UnsupportedOperationException$Message",
        "com.amazonaws.ssm",
...
static UNSUPPORTEDOPERATIONEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("UnsupportedOperation".to_string()),
            );
            obj.insert(
...
static UNSUPPORTEDOPERATIONEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
    ...
    &[&UNSUPPORTEDOPERATIONEXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&UNSUPPORTEDOPERATIONEXCEPTION_TRAITS);
impl UnsupportedOperationException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &UNSUPPORTEDOPERATIONEXCEPTION_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for UnsupportedOperationException {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&UNSUPPORTEDOPERATIONEXCEPTION_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl UnsupportedOperationException {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&UNSUPPORTEDOPERATIONEXCEPTION_SCHEMA, &mut |member, deser| {
