...
static INVALIDKEYID_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#InvalidKeyId$message", "com.amazonaws.ssm", "InvalidKeyId"),
    ::aws_smithy_schema::ShapeType::String,
    "message",
    0,
);
static INVALIDKEYID_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert("code".to_string(), ::aws_smithy_types::Document::String("InvalidKeyId".to_string()));
            obj.insert(
...
static INVALIDKEYID_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#InvalidKeyId", "com.amazonaws.ssm", "InvalidKeyId"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&INVALIDKEYID_MEMBER_MESSAGE],
)
.with_traits(&INVALIDKEYID_TRAITS);
impl InvalidKeyId {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &INVALIDKEYID_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for InvalidKeyId {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&INVALIDKEYID_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl InvalidKeyId {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&INVALIDKEYID_SCHEMA, &mut |member, deser| {
