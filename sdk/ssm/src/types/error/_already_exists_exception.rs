...
static ALREADYEXISTSEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#AlreadyExistsException$Message",
        "com.amazonaws.ssm",
...
static ALREADYEXISTSEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("AlreadyExistsException".to_string()),
            );
            obj.insert(
...
static ALREADYEXISTSEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#AlreadyExistsException", "com.amazonaws.ssm", "AlreadyExistsException"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&ALREADYEXISTSEXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&ALREADYEXISTSEXCEPTION_TRAITS);
impl AlreadyExistsException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &ALREADYEXISTSEXCEPTION_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for AlreadyExistsException {
