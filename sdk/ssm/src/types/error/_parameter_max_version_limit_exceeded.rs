...
static PARAMETERMAXVERSIONLIMITEXCEEDED_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#ParameterMaxVersionLimitExceeded$message",
        "com.amazonaws.ssm",
...
static PARAMETERMAXVERSIONLIMITEXCEEDED_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("ParameterMaxVersionLimitExceeded".to_string()),
            );
            obj.insert(
...
static PARAMETERMAXVERSIONLIMITEXCEEDED_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
    ...
    &[&PARAMETERMAXVERSIONLIMITEXCEEDED_MEMBER_MESSAGE],
)
.with_traits(&PARAMETERMAXVERSIONLIMITEXCEEDED_TRAITS);
impl ParameterMaxVersionLimitExceeded {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &PARAMETERMAXVERSIONLIMITEXCEEDED_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for ParameterMaxVersionLimitExceeded {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&PARAMETERMAXVERSIONLIMITEXCEEDED_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl ParameterMaxVersionLimitExceeded {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&PARAMETERMAXVERSIONLIMITEXCEEDED_SCHEMA, &mut |member, deser| {
