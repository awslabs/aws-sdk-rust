...
static INVALIDROLE_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#InvalidRole$Message", "com.amazonaws.ssm", "InvalidRole"),
    ::aws_smithy_schema::ShapeType::String,
    "Message",
    0,
);
static INVALIDROLE_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert("code".to_string(), ::aws_smithy_types::Document::String("InvalidRole".to_string()));
            obj.insert(
...
static INVALIDROLE_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#InvalidRole", "com.amazonaws.ssm", "InvalidRole"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&INVALIDROLE_MEMBER_MESSAGE],
)
.with_traits(&INVALIDROLE_TRAITS);
impl InvalidRole {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &INVALIDROLE_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for InvalidRole {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&INVALIDROLE_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl InvalidRole {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&INVALIDROLE_SCHEMA, &mut |member, deser| {
