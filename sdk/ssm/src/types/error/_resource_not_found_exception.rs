...
static RESOURCENOTFOUNDEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#ResourceNotFoundException$Message",
        "com.amazonaws.ssm",
...
static RESOURCENOTFOUNDEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("ResourceNotFoundException".to_string()),
            );
            obj.insert(
...
static RESOURCENOTFOUNDEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
...
impl ResourceNotFoundException {
    ...
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &RESOURCENOTFOUNDEXCEPTION_SCHEMA;
}
