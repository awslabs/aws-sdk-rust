...
static UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#UnsupportedInventorySchemaVersionException$Message",
        "com.amazonaws.ssm",
...
static UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("UnsupportedInventorySchemaVersion".to_string()),
            );
            obj.insert(
...
static UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
    ...
    &[&UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_TRAITS);
impl UnsupportedInventorySchemaVersionException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for UnsupportedInventorySchemaVersionException {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl UnsupportedInventorySchemaVersionException {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&UNSUPPORTEDINVENTORYSCHEMAVERSIONEXCEPTION_SCHEMA, &mut |member, deser| {
