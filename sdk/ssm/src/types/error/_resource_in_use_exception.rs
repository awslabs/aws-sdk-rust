...
static RESOURCEINUSEEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#ResourceInUseException$Message",
        "com.amazonaws.ssm",
...
static RESOURCEINUSEEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("ResourceInUseException".to_string()),
            );
            obj.insert(
...
static RESOURCEINUSEEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#ResourceInUseException", "com.amazonaws.ssm", "ResourceInUseException"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&RESOURCEINUSEEXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&RESOURCEINUSEEXCEPTION_TRAITS);
impl ResourceInUseException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &RESOURCEINUSEEXCEPTION_SCHEMA;
}
