...
static INVALIDNEXTTOKEN_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#InvalidNextToken$Message", "com.amazonaws.ssm", "InvalidNextToken"),
    ::aws_smithy_schema::ShapeType::String,
    "Message",
    0,
);
static INVALIDNEXTTOKEN_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert("code".to_string(), ::aws_smithy_types::Document::String("InvalidNextToken".to_string()));
            obj.insert(
...
static INVALIDNEXTTOKEN_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#InvalidNextToken", "com.amazonaws.ssm", "InvalidNextToken"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&INVALIDNEXTTOKEN_MEMBER_MESSAGE],
)
.with_traits(&INVALIDNEXTTOKEN_TRAITS);
impl InvalidNextToken {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &INVALIDNEXTTOKEN_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for InvalidNextToken {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&INVALIDNEXTTOKEN_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl InvalidNextToken {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&INVALIDNEXTTOKEN_SCHEMA, &mut |member, deser| {
