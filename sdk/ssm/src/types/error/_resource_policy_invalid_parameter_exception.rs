...
static RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_PARAMETER_NAMES_MEMBER: ::aws_smithy_schema::Schema<'static> =
    ::aws_smithy_schema::Schema::new_member(
        ::aws_smithy_schema::ShapeId::from_parts(
            "com.amazonaws.ssm#ResourcePolicyParameterNamesList$member",
            "com.amazonaws.ssm",
...
static RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_PARAMETER_NAMES: ::aws_smithy_schema::Schema<'static> =
    ::aws_smithy_schema::Schema::new_member(
        ::aws_smithy_schema::ShapeId::from_parts(
            "com.amazonaws.ssm#ResourcePolicyInvalidParameterException$ParameterNames",
            "com.amazonaws.ssm",
    ...
    .with_list_member(&RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_PARAMETER_NAMES_MEMBER);
static RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#ResourcePolicyInvalidParameterException$Message",
        "com.amazonaws.ssm",
        "ResourcePolicyInvalidParameterException",
    ),
    ::aws_smithy_schema::ShapeType::String,
...
static RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("ResourcePolicyInvalidParameterException".to_string()),
            );
            obj.insert(
...
static RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
    ...
    &[
        &RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_PARAMETER_NAMES,
        &RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_MESSAGE,
    ],
)
.with_traits(&RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_TRAITS);
impl ResourcePolicyInvalidParameterException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for ResourcePolicyInvalidParameterException {
    #[allow(unused_variables, clippy::diverging_sub_expression)]
    fn serialize_members(
        &self,
        ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer,
    ) -> ::std::result::Result<(), ::aws_smithy_schema::serde::SerdeError> {
        if let Some(ref val) = self.parameter_names {
            ser.write_list(
                &RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_PARAMETER_NAMES,
                &|ser: &mut dyn ::aws_smithy_schema::serde::ShapeSerializer| {
                    for item in val {
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl ResourcePolicyInvalidParameterException {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&RESOURCEPOLICYINVALIDPARAMETEREXCEPTION_SCHEMA, &mut |member, deser| {
            match member.member_index() {
                Some(0) => {
                    if deser.is_null() {
                        deser.read_null()?;
                    } else {
                        builder.parameter_names = Some(deser.read_string_list(member)?);
                    }
                }
                Some(1) => {
                    if deser.is_null() {
