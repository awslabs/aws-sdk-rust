...
static INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#InvalidAutomationExecutionParametersException$Message",
        "com.amazonaws.ssm",
...
static INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert(
                "code".to_string(),
                ::aws_smithy_types::Document::String("InvalidAutomationExecutionParameters".to_string()),
            );
            obj.insert(
...
static INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
    ...
    &[&INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_TRAITS);
impl InvalidAutomationExecutionParametersException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for InvalidAutomationExecutionParametersException {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl InvalidAutomationExecutionParametersException {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&INVALIDAUTOMATIONEXECUTIONPARAMETERSEXCEPTION_SCHEMA, &mut |member, deser| {
