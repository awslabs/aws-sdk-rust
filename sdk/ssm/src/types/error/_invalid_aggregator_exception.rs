...
static INVALIDAGGREGATOREXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts(
        "com.amazonaws.ssm#InvalidAggregatorException$Message",
        "com.amazonaws.ssm",
...
static INVALIDAGGREGATOREXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert("code".to_string(), ::aws_smithy_types::Document::String("InvalidAggregator".to_string()));
            obj.insert(
...
static INVALIDAGGREGATOREXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts(
    ...
    &[&INVALIDAGGREGATOREXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&INVALIDAGGREGATOREXCEPTION_TRAITS);
impl InvalidAggregatorException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &INVALIDAGGREGATOREXCEPTION_SCHEMA;
}
impl ::aws_smithy_schema::serde::SerializableStruct for InvalidAggregatorException {
    ...
    fn serialize_members(
        ...
        if let Some(ref val) = self.message {
            ser.write_string(&INVALIDAGGREGATOREXCEPTION_MEMBER_MESSAGE, val)?;
        }
        Ok(())
    }
}
impl InvalidAggregatorException {
    ...
    pub fn deserialize(
        ...
        deserializer.read_struct(&INVALIDAGGREGATOREXCEPTION_SCHEMA, &mut |member, deser| {
