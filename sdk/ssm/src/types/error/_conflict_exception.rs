...
static CONFLICTEXCEPTION_MEMBER_MESSAGE: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_member(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#ConflictException$Message", "com.amazonaws.ssm", "ConflictException"),
    ::aws_smithy_schema::ShapeType::String,
    "Message",
    0,
);
static CONFLICTEXCEPTION_TRAITS: std::sync::LazyLock<::aws_smithy_schema::TraitMap> = std::sync::LazyLock::new(|| {
    ...
    map.insert(Box::new(::aws_smithy_schema::DocumentTrait::new(
        ::aws_smithy_schema::ShapeId::from_parts("aws.protocols#awsQueryError", "aws.protocols", "awsQueryError"),
        {
            ...
            obj.insert("code".to_string(), ::aws_smithy_types::Document::String("ConflictException".to_string()));
            obj.insert(
...
static CONFLICTEXCEPTION_SCHEMA: ::aws_smithy_schema::Schema<'static> = ::aws_smithy_schema::Schema::new_struct(
    ::aws_smithy_schema::ShapeId::from_parts("com.amazonaws.ssm#ConflictException", "com.amazonaws.ssm", "ConflictException"),
    ::aws_smithy_schema::ShapeType::Structure,
    &[&CONFLICTEXCEPTION_MEMBER_MESSAGE],
)
.with_traits(&CONFLICTEXCEPTION_TRAITS);
impl ConflictException {
    /// The schema for this shape.
    pub const SCHEMA: &'static ::aws_smithy_schema::Schema<'static> = &CONFLICTEXCEPTION_SCHEMA;
}
