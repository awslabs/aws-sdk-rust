...
pub fn serialize_structure_import_application_usage_input(
    ...
    if let Some(var_1) = &input.source_s3_location {
        ...
        crate::json_ser::serialize_structure_source_s3_location(&mut object_2, var_1);
        object_2.finish();
    }
}
...
pub fn serialize_structure_put_report_definition_input(
    ...
    if let Some(var_3) = &input.destination_s3_location {
        ...
        crate::json_ser::serialize_structure_s3_location(&mut object_4, var_3);
        object_4.finish();
    }
...
pub fn serialize_structure_update_report_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_9) = &input.destination_s3_location {
        ...
        crate::json_ser::serialize_structure_s3_location(&mut object_10, var_9);
        object_10.finish();
    }
...
pub fn serialize_structure_source_s3_location(
    object: &mut smithy_json::serialize::JsonObjectWriter,
