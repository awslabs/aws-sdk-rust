...
impl GetReportDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_report_definition::GetReportDefinition::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetReportDefinition", "applicationcostprofiler"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReportDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_report_definition::de_get_report_definition_http_response_with_props(status, headers, body)
        }
    }
}
