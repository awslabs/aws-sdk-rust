...
pub(crate) fn de_report_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReportDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
