...
impl ::std::convert::From<&str> for ClassificationScopeUpdateOperation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClassificationScopeUpdateOperation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClassificationScopeUpdateOperation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClassificationScopeUpdateOperation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClassificationScopeUpdateOperation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ClassificationScopeUpdateOperation {
