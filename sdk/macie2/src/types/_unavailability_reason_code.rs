...
impl UnavailabilityReasonCode {
    ...
    UnavailabilityReasonCode::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["ACCOUNT_NOT_IN_ORGANIZATION", "INVALID_CLASSIFICATION_RESULT", "INVALID_RESULT_SIGNATURE", "MEMBER_ROLE_TOO_PERMISSIVE", "MISSING_GET_MEMBER_PERMISSION", "OBJECT_EXCEEDS_SIZE_QUOTA", "OBJECT_UNAVAILABLE", "RESULT_NOT_SIGNED", "ROLE_TOO_PERMISSIVE", "UNSUPPORTED_FINDING_TYPE", "UNSUPPORTED_OBJECT_TYPE"]
                }
            }
