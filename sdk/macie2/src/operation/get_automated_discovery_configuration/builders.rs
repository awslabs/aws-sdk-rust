...
impl crate::operation::get_automated_discovery_configuration::builders::GetAutomatedDiscoveryConfigurationInputBuilder {
...
impl GetAutomatedDiscoveryConfigurationFluentBuilder {
    /// Creates a new `GetAutomatedDiscoveryConfigurationFluentBuilder`.
