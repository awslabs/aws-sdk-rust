...
/// Orchestration and serialization glue logic for `GetInvitationsCount`.
...
impl GetInvitationsCount {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_invitations_count::GetInvitationsCountInput,
                    ) -> ::std::result::Result<crate::operation::get_invitations_count::GetInvitationsCountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_invitations_count::GetInvitationsCountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_invitations_count::GetInvitationsCountError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_invitations_count::GetInvitationsCountOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInvitationsCount {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetInvitationsCount");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetInvitationsCountRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetInvitationsCountResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInvitationsCount")
...
.with_interceptor(GetInvitationsCountEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_invitations_count::GetInvitationsCountError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_invitations_count::GetInvitationsCountError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_invitations_count::GetInvitationsCountError>::new());
...
#[derive(Debug)]
            struct GetInvitationsCountResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInvitationsCountResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_invitations_count::de_get_invitations_count_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetInvitationsCountRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInvitationsCountRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_invitations_count::GetInvitationsCountInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_invitations_count::GetInvitationsCountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/invitations/count").expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetInvitationsCountEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInvitationsCountEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetInvitationsCountEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetInvitationsCountInput>()
                        .ok_or("failed to downcast to GetInvitationsCountInput")?;
...
pub enum GetInvitationsCountError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetInvitationsCountError) for what information is available for the error.")]
...
impl GetInvitationsCountError {
    /// Creates the `GetInvitationsCountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetInvitationsCountError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetInvitationsCountError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_invitations_count::GetInvitationsCountError {
...
mod _get_invitations_count_output;
