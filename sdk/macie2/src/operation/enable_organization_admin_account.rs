...
impl EnableOrganizationAdminAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_organization_admin_account::EnableOrganizationAdminAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableOrganizationAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_organization_admin_account::de_enable_organization_admin_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
