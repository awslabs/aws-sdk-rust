...
impl GetResourceProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_resource_profile::GetResourceProfile,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_profile::de_get_resource_profile_http_response_with_props(status, headers, body)
        }
    }
}
