...
impl UpdateAutomatedDiscoveryConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_automated_discovery_configuration::UpdateAutomatedDiscoveryConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_automated_discovery_configuration::UpdateAutomatedDiscoveryConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_automated_discovery_configuration::UpdateAutomatedDiscoveryConfiguration::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_automated_discovery_configuration::UpdateAutomatedDiscoveryConfigurationOutput, crate::operation::update_automated_discovery_configuration::UpdateAutomatedDiscoveryConfigurationError, Self> {
