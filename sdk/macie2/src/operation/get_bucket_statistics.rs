    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/datasources/s3/statistics")
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_bucket_statistics::ser_get_bucket_statistics_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bucket_statistics::GetBucketStatistics::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_bucket_statistics::GetBucketStatisticsError
{
