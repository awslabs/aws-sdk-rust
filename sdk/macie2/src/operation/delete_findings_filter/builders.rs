...
impl DeleteFindingsFilterFluentBuilder  {
    /// Creates a new `DeleteFindingsFilter`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_findings_filter::DeleteFindingsFilterOutput, aws_smithy_http::result::SdkError<crate::operation::delete_findings_filter::DeleteFindingsFilterError>>
                     {
