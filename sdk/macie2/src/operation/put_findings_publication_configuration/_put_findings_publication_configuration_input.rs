...
impl PutFindingsPublicationConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_findings_publication_configuration::PutFindingsPublicationConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
