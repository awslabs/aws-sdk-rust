...
impl ListSensitivityInspectionTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sensitivity_inspection_templates::ListSensitivityInspectionTemplatesInput, ::aws_smithy_types::error::operation::BuildError> {
