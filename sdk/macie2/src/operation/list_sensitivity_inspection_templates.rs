...
impl ListSensitivityInspectionTemplatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_sensitivity_inspection_templates::ListSensitivityInspectionTemplates,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_sensitivity_inspection_templates::ListSensitivityInspectionTemplates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSensitivityInspectionTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sensitivity_inspection_templates::de_list_sensitivity_inspection_templates_http_response_with_props(
                status, headers, body,
            )
        }
    }
