...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableOrganizationAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_organization_admin_account::de_disable_organization_admin_account_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disable_organization_admin_account::DisableOrganizationAdminAccountError
{
