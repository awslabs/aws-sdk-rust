...
impl DisableOrganizationAdminAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_organization_admin_account::DisableOrganizationAdminAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableOrganizationAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_organization_admin_account::de_disable_organization_admin_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
