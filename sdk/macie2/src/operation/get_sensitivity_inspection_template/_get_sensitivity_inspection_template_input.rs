...
impl GetSensitivityInspectionTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_sensitivity_inspection_template::GetSensitivityInspectionTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
