    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/macie/members/{id}", id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_member_session::UpdateMemberSession::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_member_session::UpdateMemberSessionError
{
