...
impl UpdateAllowListFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_allow_list::UpdateAllowListOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_allow_list::UpdateAllowListError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_allow_list::UpdateAllowListOutput, crate::operation::update_allow_list::UpdateAllowListError, Self> {
