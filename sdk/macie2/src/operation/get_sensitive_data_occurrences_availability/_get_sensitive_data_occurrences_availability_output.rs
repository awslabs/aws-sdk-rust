...
pub struct GetSensitiveDataOccurrencesAvailabilityOutput {
    ...
    /// <li>
    /// <p>OBJECT_UNAVAILABLE - The affected S3 object isn't available. The object was renamed, moved, or deleted. Or the object was changed after Macie created the finding.</p></li>
    /// <li>
