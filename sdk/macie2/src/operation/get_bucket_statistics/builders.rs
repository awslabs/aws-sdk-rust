...
impl GetBucketStatisticsFluentBuilder  {
    /// Creates a new `GetBucketStatistics`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_bucket_statistics::GetBucketStatisticsOutput, aws_smithy_http::result::SdkError<crate::operation::get_bucket_statistics::GetBucketStatisticsError>>
                     {
