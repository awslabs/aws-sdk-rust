...
impl DeleteCustomDataIdentifierInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_custom_data_identifier::DeleteCustomDataIdentifier::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomDataIdentifier {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_custom_data_identifier::de_delete_custom_data_identifier_http_response_with_props(
                status, headers, body,
            )
        }
    }
