    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/custom-data-identifiers/get")
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetCustomDataIdentifiers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_custom_data_identifiers::de_batch_get_custom_data_identifiers_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for BatchGetCustomDataIdentifiersError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_get_custom_data_identifiers::BatchGetCustomDataIdentifiersError
{
