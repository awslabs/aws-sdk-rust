...
impl BatchGetCustomDataIdentifiersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_custom_data_identifiers::BatchGetCustomDataIdentifiers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetCustomDataIdentifiers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_custom_data_identifiers::de_batch_get_custom_data_identifiers_http_response_with_props(
                status, headers, body,
            )
        }
    }
