...
impl DescribeClassificationJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_classification_job::DescribeClassificationJob,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_classification_job::DescribeClassificationJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClassificationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_classification_job::de_describe_classification_job_http_response_with_props(status, headers, body)
        }
    }
}
