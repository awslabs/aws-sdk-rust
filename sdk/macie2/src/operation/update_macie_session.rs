...
impl UpdateMacieSessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_macie_session::ser_update_macie_session_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_macie_session::UpdateMacieSession::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_macie_session::UpdateMacieSessionError
{
