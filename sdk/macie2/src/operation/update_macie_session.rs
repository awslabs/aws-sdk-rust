...
impl UpdateMacieSessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_macie_session::ser_update_macie_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMacieSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_macie_session::de_update_macie_session_http_response_with_props(status, headers, body)
        }
    }
}
