...
impl ListResourceProfileDetectionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resource_profile_detections::ListResourceProfileDetections::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceProfileDetections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resource_profile_detections::de_list_resource_profile_detections_http_response_with_props(
                status, headers, body,
            )
        }
    }
