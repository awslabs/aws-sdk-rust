...
impl GetSensitiveDataOccurrencesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrences::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetSensitiveDataOccurrencesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError
{
