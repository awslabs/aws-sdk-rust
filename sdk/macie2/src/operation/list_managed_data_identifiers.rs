...
impl ListManagedDataIdentifiersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_managed_data_identifiers::ListManagedDataIdentifiers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListManagedDataIdentifiers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_managed_data_identifiers::de_list_managed_data_identifiers_http_response_with_props(
                status, headers, body,
            )
        }
    }
