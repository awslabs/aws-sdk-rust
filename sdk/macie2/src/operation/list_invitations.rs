...
impl ListInvitationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_invitations::ListInvitations, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInvitations {
    type Output =
        ::std::result::Result<crate::operation::list_invitations::ListInvitationsOutput, crate::operation::list_invitations::ListInvitationsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_invitations::de_list_invitations_http_response_with_props(status, headers, body)
        }
    }
}
