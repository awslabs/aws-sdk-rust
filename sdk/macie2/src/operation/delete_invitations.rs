...
impl DeleteInvitationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_invitations::ser_delete_invitations_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInvitations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_invitations::de_delete_invitations_http_response_with_props(status, headers, body)
        }
    }
}
