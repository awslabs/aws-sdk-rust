...
impl GetCustomDataIdentifier {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_custom_data_identifier::GetCustomDataIdentifierInput,
                    ) -> ::std::result::Result<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCustomDataIdentifier {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCustomDataIdentifier");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCustomDataIdentifierRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCustomDataIdentifierResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCustomDataIdentifier")
...
.with_interceptor(GetCustomDataIdentifierEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierError>::new());
...
#[derive(Debug)]
            struct GetCustomDataIdentifierResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCustomDataIdentifierResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_custom_data_identifier::de_get_custom_data_identifier_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetCustomDataIdentifierRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCustomDataIdentifierRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_custom_data_identifier::GetCustomDataIdentifierInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/custom-data-identifiers/{id}", id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetCustomDataIdentifierEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCustomDataIdentifierEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCustomDataIdentifierEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCustomDataIdentifierInput>()
                        .ok_or("failed to downcast to GetCustomDataIdentifierInput")?;
...
pub enum GetCustomDataIdentifierError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCustomDataIdentifierError) for what information is available for the error.")]
...
impl GetCustomDataIdentifierError {
    /// Creates the `GetCustomDataIdentifierError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCustomDataIdentifierError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCustomDataIdentifierError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_custom_data_identifier::GetCustomDataIdentifierError {
...
mod _get_custom_data_identifier_output;
