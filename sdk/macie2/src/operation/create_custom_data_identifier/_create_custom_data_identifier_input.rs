...
impl CreateCustomDataIdentifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_custom_data_identifier::CreateCustomDataIdentifierInput, ::aws_smithy_types::error::operation::BuildError> {
