...
pub fn ser_list_classification_jobs_input(
    ...
    if let Some(var_1) = &input.filter_criteria {
        ...
        crate::protocol_serde::shape_list_jobs_filter_criteria::ser_list_jobs_filter_criteria(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_4) = &input.sort_criteria {
        ...
        crate::protocol_serde::shape_list_jobs_sort_criteria::ser_list_jobs_sort_criteria(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
