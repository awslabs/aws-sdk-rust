...
pub fn ser_create_findings_filter_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFindingsFilterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
