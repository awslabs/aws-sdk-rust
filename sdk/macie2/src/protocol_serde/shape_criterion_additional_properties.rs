...
pub fn ser_criterion_additional_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CriterionAdditionalProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_criterion_additional_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CriterionAdditionalProperties>, aws_smithy_json::deserialize::error::DeserializeError>
