...
pub(crate) fn de_security_hub_configuration<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SecurityHubConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "publishClassificationFindings" => {
                            builder = builder
                                .set_publish_classification_findings(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "publishPolicyFindings" => {
                            builder = builder.set_publish_policy_findings(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
            ...
            Ok(Some(crate::serde_util::security_hub_configuration_correct_errors(builder).build()))
        }
