...
pub(crate) fn de_bucket_count_policy_allows_unencrypted_object_uploads<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BucketCountPolicyAllowsUnencryptedObjectUploads>, aws_smithy_json::deserialize::error::DeserializeError>
