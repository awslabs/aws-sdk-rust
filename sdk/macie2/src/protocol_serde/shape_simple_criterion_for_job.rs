...
pub fn ser_simple_criterion_for_job(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SimpleCriterionForJob) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_simple_criterion_for_job<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SimpleCriterionForJob>, aws_smithy_json::deserialize::error::DeserializeError>
