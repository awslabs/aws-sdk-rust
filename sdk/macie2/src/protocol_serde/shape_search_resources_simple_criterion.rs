...
pub fn ser_search_resources_simple_criterion(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SearchResourcesSimpleCriterion) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
