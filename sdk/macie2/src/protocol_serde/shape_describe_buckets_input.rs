...
pub fn ser_describe_buckets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBucketsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
