...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnprocessableEntityException" => {
            crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError::UnprocessableEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sensitive_data_occurrences_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_sensitive_data_occurrences::de_get_sensitive_data_occurrences(_response_body, output)
            .map_err(crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::RevealRequestStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
