...
pub fn de_get_sensitive_data_occurrences_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSensitiveDataOccurrencesOutput, crate::error::GetSensitiveDataOccurrencesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetSensitiveDataOccurrencesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sensitive_data_occurrences_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSensitiveDataOccurrencesOutput, crate::error::GetSensitiveDataOccurrencesError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_sensitive_data_occurrences(value: &[u8], mut builder: crate::output::get_sensitive_data_occurrences_output::Builder) -> Result<crate::output::get_sensitive_data_occurrences_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
