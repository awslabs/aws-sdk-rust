...
pub fn de_get_sensitive_data_occurrences_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesOutput, crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sensitive_data_occurrences_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesOutput, crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesError> {
    Ok({
        #[allow(unused_mut)]
