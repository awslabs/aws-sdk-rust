            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "lastRunErrorStatus" => {
                            builder = builder
                                .set_last_run_error_status(crate::protocol_serde::shape_last_run_error_status::de_last_run_error_status(tokens)?);
                        }
                        "name" => {
                        ...
                        "userPausedDetails" => {
                            builder =
                                builder.set_user_paused_details(crate::protocol_serde::shape_user_paused_details::de_user_paused_details(tokens)?);
                        }
