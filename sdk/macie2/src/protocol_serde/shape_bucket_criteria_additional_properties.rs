...
pub fn ser_bucket_criteria_additional_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BucketCriteriaAdditionalProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
