...
pub fn ser_bucket_criteria_additional_properties(
    ...
    if let Some(var_4) = &input.gt {
        object.key("gt").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.gte {
        object.key("gte").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.lt {
        object.key("lt").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.lte {
        object.key("lte").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
