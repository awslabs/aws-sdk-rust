...
) -> Result<Option<crate::types::MatchingBucket>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "errorCode" => {
                            builder = builder.set_error_code(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::BucketMetadataErrorCode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "errorMessage" => {
                        ...
                        "jobDetails" => {
                            builder = builder.set_job_details(crate::protocol_serde::shape_job_details::de_job_details(tokens)?);
                        }
