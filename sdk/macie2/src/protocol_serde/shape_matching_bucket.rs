...
pub(crate) fn de_matching_bucket<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MatchingBucket>, aws_smithy_json::deserialize::error::DeserializeError>
