...
pub fn de_batch_update_automated_discovery_accounts_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::unhandled,
                        )?;
        ...
        "ConflictException" => {
            crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_update_automated_discovery_accounts_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_update_automated_discovery_accounts::de_batch_update_automated_discovery_accounts(
            _response_body,
            output,
        )
        .map_err(crate::operation::batch_update_automated_discovery_accounts::BatchUpdateAutomatedDiscoveryAccountsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "errors" => {
                    builder = builder.set_errors(
                            crate::protocol_serde::shape_list_of_automated_discovery_account_update_error::de_list_of_automated_discovery_account_update_error(tokens, _value, depth + 1)?
                        );
                }
