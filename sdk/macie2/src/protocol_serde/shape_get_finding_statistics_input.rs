...
pub fn ser_get_finding_statistics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetFindingStatisticsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
