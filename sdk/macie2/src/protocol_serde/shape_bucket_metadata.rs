...
pub(crate) fn de_bucket_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BucketMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
