...
) -> Result<Option<crate::types::BucketMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "bucketCreatedAt" => {
                            builder = builder.set_bucket_created_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                        ...
                        "replicationDetails" => {
                            builder =
                                builder.set_replication_details(crate::protocol_serde::shape_replication_details::de_replication_details(tokens)?);
                        }
                        "sensitivityScore" => {
                        ...
                        "sharedAccess" => {
                            builder = builder.set_shared_access(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::SharedAccess::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "sizeInBytes" => {
                        ...
                        "versioning" => {
                            builder = builder.set_versioning(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
