        ...
        for item_5 in var_3 {
            {
                ...
                crate::protocol_serde::shape_tag_value_pair::ser_tag_value_pair(
                    &mut object_6,
                    item_5,
                )?;
                object_6.finish();
...
) -> Result<Option<crate::types::TagScopeTerm>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "target" => {
                                builder = builder.set_target(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::TagTarget::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
