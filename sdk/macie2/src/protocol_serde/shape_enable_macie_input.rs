...
pub fn ser_enable_macie_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EnableMacieInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
