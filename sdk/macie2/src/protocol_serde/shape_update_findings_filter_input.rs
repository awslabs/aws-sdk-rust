...
pub fn ser_update_findings_filter_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_findings_filter::UpdateFindingsFilterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
