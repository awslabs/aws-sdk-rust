...
pub fn ser_create_invitations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateInvitationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
