            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "action" => {
                            builder = builder.set_action(crate::protocol_serde::shape_finding_action::de_finding_action(tokens, _value)?);
                        }
                        "actor" => {
                            builder = builder.set_actor(crate::protocol_serde::shape_finding_actor::de_finding_actor(tokens, _value)?);
                        }
