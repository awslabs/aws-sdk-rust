...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::disassociate_from_master_account::DisassociateFromMasterAccountError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::disassociate_from_master_account::DisassociateFromMasterAccountError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
