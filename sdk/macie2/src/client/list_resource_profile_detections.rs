...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_resource_profile_detections::builders::ListResourceProfileDetectionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_resource_profile_detections::builders::ListResourceProfileDetectionsFluentBuilder::set_max_results): <p>The maximum number of items to include in each page of a paginated response.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_resource_profile_detections::builders::ListResourceProfileDetectionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_resource_profile_detections::builders::ListResourceProfileDetectionsFluentBuilder::set_next_token): <p>The nextToken string that specifies which page of results to return in a paginated response.</p>
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::list_resource_profile_detections::builders::ListResourceProfileDetectionsFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_resource_profile_detections::builders::ListResourceProfileDetectionsFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the S3 bucket that the request applies to.</p>
