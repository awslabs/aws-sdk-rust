...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_findings_filter::builders::GetFindingsFilterFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_findings_filter::builders::GetFindingsFilterFluentBuilder::set_id):<br>required: **true**<br><p>The unique identifier for the Amazon Macie resource that the request applies to.</p><br>
