...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::batch_get_custom_data_identifiers::builders::BatchGetCustomDataIdentifiersFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::batch_get_custom_data_identifiers::builders::BatchGetCustomDataIdentifiersFluentBuilder::set_ids): <p>An array of custom data identifier IDs, one for each custom data identifier to retrieve information about.</p>
