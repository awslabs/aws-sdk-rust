...
impl super::Client {
    ...
    ///   - [`deleted(Option<bool>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::deleted): <p>Specifies whether the custom data identifier was deleted. If you delete a custom data identifier, Amazon Macie doesn't delete it permanently. Instead, it soft deletes the identifier.</p>
    ///   - [`description(Option<String>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::description): <p>The custom description of the custom data identifier.</p>
    ///   - [`id(Option<String>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::id): <p>The unique identifier for the custom data identifier.</p>
    ///   - [`ignore_words(Option<Vec<String>>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::ignore_words): <p>An array that lists specific character sequences (<i>ignore words</i>) to exclude from the results. If the text matched by the regular expression contains any string in this array, Amazon Macie ignores it. Ignore words are case sensitive.</p>
    ///   - [`keywords(Option<Vec<String>>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::keywords): <p>An array that lists specific character sequences (<i>keywords</i>), one of which must precede and be within proximity (maximumMatchDistance) of the regular expression to match. Keywords aren't case sensitive.</p>
    ///   - [`maximum_match_distance(Option<i32>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::maximum_match_distance): <p>The maximum number of characters that can exist between the end of at least one complete character sequence specified by the keywords array and the end of the text that matches the regex pattern. If a complete keyword precedes all the text that matches the pattern and the keyword is within the specified distance, Amazon Macie includes the result. Otherwise, Macie excludes the result.</p>
    ///   - [`name(Option<String>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::name): <p>The custom name of the custom data identifier.</p>
    ///   - [`regex(Option<String>)`](crate::operation::get_custom_data_identifier::GetCustomDataIdentifierOutput::regex): <p>The regular expression (<i>regex</i>) that defines the pattern to match.</p>
