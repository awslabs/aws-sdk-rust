...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_classification_scope::builders::UpdateClassificationScopeFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_classification_scope::builders::UpdateClassificationScopeFluentBuilder::set_id):<br>required: **true**<br><p>The unique identifier for the Amazon Macie resource that the request applies to.</p><br>
    ///   - [`s3(S3ClassificationScopeUpdate)`](crate::operation::update_classification_scope::builders::UpdateClassificationScopeFluentBuilder::s3) / [`set_s3(Option<S3ClassificationScopeUpdate>)`](crate::operation::update_classification_scope::builders::UpdateClassificationScopeFluentBuilder::set_s3):<br>required: **false**<br><p>The S3 buckets to add or remove from the exclusion list defined by the classification scope.</p><br>
