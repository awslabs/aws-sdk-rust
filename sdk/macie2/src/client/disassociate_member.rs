...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::disassociate_member::builders::DisassociateMemberFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::disassociate_member::builders::DisassociateMemberFluentBuilder::set_id):<br>required: **true**<br><p>The unique identifier for the Amazon Macie resource that the request applies to.</p><br>
