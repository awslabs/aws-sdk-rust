...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_managed_data_identifiers::builders::ListManagedDataIdentifiersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_managed_data_identifiers::builders::ListManagedDataIdentifiersFluentBuilder::set_next_token): <p>The nextToken string that specifies which page of results to return in a paginated response.</p>
