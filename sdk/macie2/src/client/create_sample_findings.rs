...
impl super::Client {
    ...
    ///   - [`finding_types(FindingType)`](crate::operation::create_sample_findings::builders::CreateSampleFindingsFluentBuilder::finding_types) / [`set_finding_types(Option<Vec::<FindingType>>)`](crate::operation::create_sample_findings::builders::CreateSampleFindingsFluentBuilder::set_finding_types):<br>required: **false**<br><p>An array of finding types, one for each type of sample finding to create. To create a sample of every type of finding that Amazon Macie supports, don't include this array in your request.</p><br>
