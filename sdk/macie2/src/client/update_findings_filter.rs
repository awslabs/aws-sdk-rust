...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::update_findings_filter::builders::UpdateFindingsFilterFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_findings_filter::builders::UpdateFindingsFilterFluentBuilder::set_description): <p>A custom description of the filter. The description can contain as many as 512 characters.</p>  <p>We strongly recommend that you avoid including any sensitive data in the description of a filter. Other users of your account might be able to see this description, depending on the actions that they're allowed to perform in Amazon Macie.</p>
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_findings_filter::builders::UpdateFindingsFilterFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_findings_filter::builders::UpdateFindingsFilterFluentBuilder::set_name): <p>A custom name for the filter. The name must contain at least 3 characters and can contain as many as 64 characters.</p>  <p>We strongly recommend that you avoid including any sensitive data in the name of a filter. Other users of your account might be able to see this name, depending on the actions that they're allowed to perform in Amazon Macie.</p>
