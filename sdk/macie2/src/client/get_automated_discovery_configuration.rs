...
impl super::Client {
    /// Constructs a fluent builder for the [`GetAutomatedDiscoveryConfiguration`](crate::operation::get_automated_discovery_configuration::builders::GetAutomatedDiscoveryConfigurationFluentBuilder) operation.
    ///
    /// - The fluent builder takes no input, just [`send`](crate::operation::get_automated_discovery_configuration::builders::GetAutomatedDiscoveryConfigurationFluentBuilder::send) it.
    /// - On success, responds with [`GetAutomatedDiscoveryConfigurationOutput`](crate::operation::get_automated_discovery_configuration::GetAutomatedDiscoveryConfigurationOutput) with field(s):
    ///   - [`classification_scope_id(Option<String>)`](crate::operation::get_automated_discovery_configuration::GetAutomatedDiscoveryConfigurationOutput::classification_scope_id): <p>The unique identifier for the classification scope that's used when performing automated sensitive data discovery for the account. The classification scope specifies S3 buckets to exclude from automated sensitive data discovery.</p>
    ///   - [`disabled_at(Option<DateTime>)`](crate::operation::get_automated_discovery_configuration::GetAutomatedDiscoveryConfigurationOutput::disabled_at): <p>The date and time, in UTC and extended ISO 8601 format, when automated sensitive data discovery was most recently disabled for the account. This value is null if automated sensitive data discovery wasn't enabled and subsequently disabled for the account.</p>
    ///   - [`first_enabled_at(Option<DateTime>)`](crate::operation::get_automated_discovery_configuration::GetAutomatedDiscoveryConfigurationOutput::first_enabled_at): <p>The date and time, in UTC and extended ISO 8601 format, when automated sensitive data discovery was initially enabled for the account. This value is null if automated sensitive data discovery has never been enabled for the account.</p>
    ///   - [`last_updated_at(Option<DateTime>)`](crate::operation::get_automated_discovery_configuration::GetAutomatedDiscoveryConfigurationOutput::last_updated_at): <p>The date and time, in UTC and extended ISO 8601 format, when automated sensitive data discovery was most recently enabled or disabled for the account.</p>
