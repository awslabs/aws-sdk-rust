...
impl super::Client {
    ...
    pub fn update_macie_session(
        &self,
    ) -> crate::operation::update_macie_session::builders::UpdateMacieSessionFluentBuilder {
        crate::operation::update_macie_session::builders::UpdateMacieSessionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
