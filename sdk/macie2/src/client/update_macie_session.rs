...
impl super::Client {
    ...
    ///   - [`status(MacieStatus)`](crate::operation::update_macie_session::builders::UpdateMacieSessionFluentBuilder::status) / [`set_status(Option<MacieStatus>)`](crate::operation::update_macie_session::builders::UpdateMacieSessionFluentBuilder::set_status):<br>required: **false**<br><p>Specifies a new status for the account. Valid values are: ENABLED, resume all Amazon Macie activities for the account; and, PAUSED, suspend all Macie activities for the account.</p><br>
