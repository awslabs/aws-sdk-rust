...
impl super::Client {
    ...
    ///   - [`filter_by(UsageStatisticsFilter)`](crate::operation::get_usage_statistics::builders::GetUsageStatisticsFluentBuilder::filter_by) / [`set_filter_by(Option<Vec<UsageStatisticsFilter>>)`](crate::operation::get_usage_statistics::builders::GetUsageStatisticsFluentBuilder::set_filter_by): <p>An array of objects, one for each condition to use to filter the query results. If you specify more than one condition, Amazon Macie uses an AND operator to join the conditions.</p>
    ///   - [`max_results(i32)`](crate::operation::get_usage_statistics::builders::GetUsageStatisticsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_usage_statistics::builders::GetUsageStatisticsFluentBuilder::set_max_results): <p>The maximum number of items to include in each page of the response.</p>
