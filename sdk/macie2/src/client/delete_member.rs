...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_member::builders::DeleteMemberFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_member::builders::DeleteMemberFluentBuilder::set_id):<br>required: **true**<br><p>The unique identifier for the Amazon Macie resource that the request applies to.</p><br>
