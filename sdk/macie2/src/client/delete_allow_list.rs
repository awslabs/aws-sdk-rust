...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_allow_list::builders::DeleteAllowListFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_allow_list::builders::DeleteAllowListFluentBuilder::set_id): <p>The unique identifier for the Amazon Macie resource that the request applies to.</p>
