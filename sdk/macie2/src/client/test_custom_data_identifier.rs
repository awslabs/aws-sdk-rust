...
impl super::Client  {
    ...
    pub fn test_custom_data_identifier(&self) -> crate::client::fluent_builders::TestCustomDataIdentifier {
                                crate::client::fluent_builders::TestCustomDataIdentifier::new(self.handle.clone())
                            }
}
