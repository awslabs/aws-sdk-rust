...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_sensitivity_inspection_template::builders::UpdateSensitivityInspectionTemplateFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_sensitivity_inspection_template::builders::UpdateSensitivityInspectionTemplateFluentBuilder::set_description): <p>A custom description of the template. The description can contain as many as 200 characters.</p>
