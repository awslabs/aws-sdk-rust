...
impl super::Client  {
    ...
    pub fn update_sensitivity_inspection_template(&self) -> crate::client::fluent_builders::UpdateSensitivityInspectionTemplate {
                                crate::client::fluent_builders::UpdateSensitivityInspectionTemplate::new(self.handle.clone())
                            }
}
