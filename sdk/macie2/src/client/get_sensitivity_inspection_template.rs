...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_sensitivity_inspection_template::builders::GetSensitivityInspectionTemplateFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_sensitivity_inspection_template::builders::GetSensitivityInspectionTemplateFluentBuilder::set_id): <p>The unique identifier for the Amazon Macie resource that the request applies to.</p>
