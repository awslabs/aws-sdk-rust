...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_buckets::builders::DescribeBucketsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_buckets::builders::DescribeBucketsFluentBuilder::set_max_results): <p>The maximum number of items to include in each page of the response. The default value is 50.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_buckets::builders::DescribeBucketsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_buckets::builders::DescribeBucketsFluentBuilder::set_next_token): <p>The nextToken string that specifies which page of results to return in a paginated response.</p>
