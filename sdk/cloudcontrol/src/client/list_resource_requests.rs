...
impl super::Client {
    /// Constructs a fluent builder for the [`ListResourceRequests`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::into_paginator).
    ///
    /// - The fluent builder is configurable:
    ///   - [`max_results(i32)`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::set_max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>  <p>The default is <code>20</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::set_next_token): <p>If the previous paginated request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call this action again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`resource_request_status_filter(ResourceRequestStatusFilter)`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::resource_request_status_filter) / [`set_resource_request_status_filter(Option<ResourceRequestStatusFilter>)`](crate::operation::list_resource_requests::builders::ListResourceRequestsFluentBuilder::set_resource_request_status_filter): <p>The filter criteria to apply to the requests returned.</p>
    /// - On success, responds with [`ListResourceRequestsOutput`](crate::operation::list_resource_requests::ListResourceRequestsOutput) with field(s):
