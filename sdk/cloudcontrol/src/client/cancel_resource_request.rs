...
impl super::Client {
    ...
    ///   - [`request_token(impl Into<String>)`](crate::operation::cancel_resource_request::builders::CancelResourceRequestFluentBuilder::request_token) / [`set_request_token(impl Into<String>)`](crate::operation::cancel_resource_request::builders::CancelResourceRequestFluentBuilder::set_request_token):<br>required: **true**<br><p>The <code>RequestToken</code> of the <code>ProgressEvent</code> object returned by the resource operation request.</p><br>
