...
pub trait Waiters {
    ...
    fn wait_until_resource_request_success(&self) -> crate::waiters::resource_request_success::ResourceRequestSuccessFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_resource_request_success(&self) -> crate::waiters::resource_request_success::ResourceRequestSuccessFluentBuilder {
        crate::waiters::resource_request_success::ResourceRequestSuccessFluentBuilder::new(self.handle.clone())
    }
}
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_cloudcontrol::Error> {
/// # let client: aws_sdk_cloudcontrol::Client = unimplemented!();
...
mod get_resource_request_status;

mod list_resource_requests;
