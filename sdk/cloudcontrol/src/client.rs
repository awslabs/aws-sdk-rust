...
impl Client  {
    ...
    pub fn cancel_resource_request(&self) -> crate::client::fluent_builders::CancelResourceRequest {
                            crate::client::fluent_builders::CancelResourceRequest::new(self.handle.clone())
                        }
