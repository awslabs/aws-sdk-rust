...
pub(crate) fn de_resource_descriptions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ResourceDescription>>, aws_smithy_json::deserialize::error::DeserializeError>
