...
pub fn ser_list_resource_requests_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListResourceRequestsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
