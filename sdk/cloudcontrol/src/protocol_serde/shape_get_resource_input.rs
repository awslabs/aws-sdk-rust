...
pub fn ser_get_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
