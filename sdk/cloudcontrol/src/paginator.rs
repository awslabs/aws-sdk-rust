...
/// Paginator for [`ListResourceRequests`](crate::operation::ListResourceRequests)
            ...
            impl ListResourceRequestsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_resource_requests_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListResourceRequestsOutput, aws_smithy_http::result::SdkError<crate::error::ListResourceRequestsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListResourceRequestsPaginator`
                ...
                impl  ListResourceRequestsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ProgressEvent, aws_smithy_http::result::SdkError<crate::error::ListResourceRequestsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListResourcesPaginator`
                ...
                impl  ListResourcesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ResourceDescription, aws_smithy_http::result::SdkError<crate::error::ListResourcesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_resources_output_resource_descriptions(page).unwrap_or_default().into_iter())
                    }
                }
