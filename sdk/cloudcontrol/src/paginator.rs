...
impl<C, M, R> ListResourceRequestsPaginator<C, M, R>
where
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_token = crate::lens::reflens_structure_crate_output_list_resource_requests_output_next_token(resp).cloned();
