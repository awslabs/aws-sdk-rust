...
impl smithy_types::retry::ProvideErrorKind for CancelResourceRequestError {
...
impl CancelResourceRequestError {
    pub fn new(kind: CancelResourceRequestErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for GetResourceRequestStatusError {
    fn code(&self) -> Option<&str> {
...
impl GetResourceRequestStatusError {
    pub fn new(kind: GetResourceRequestStatusErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for ListResourceRequestsError {
    fn code(&self) -> Option<&str> {
...
impl ListResourceRequestsError {
    pub fn new(kind: ListResourceRequestsErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
