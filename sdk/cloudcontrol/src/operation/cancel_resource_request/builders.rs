...
impl CancelResourceRequestFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_resource_request::CancelResourceRequestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_resource_request::CancelResourceRequestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_resource_request::CancelResourceRequestOutput, crate::operation::cancel_resource_request::CancelResourceRequestError, Self> {
