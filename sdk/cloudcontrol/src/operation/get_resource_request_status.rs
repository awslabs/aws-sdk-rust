...
impl GetResourceRequestStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetResourceRequestStatus`](crate::operation::get_resource_request_status::GetResourceRequestStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_resource_request_status::GetResourceRequestStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource_request_status::GetResourceRequestStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_resource_request_status::ser_get_resource_request_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_request_status::GetResourceRequestStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetResourceRequestStatus", "cloudcontrol"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetResourceRequestStatus {
                type Output = std::result::Result<crate::operation::get_resource_request_status::GetResourceRequestStatusOutput, crate::operation::get_resource_request_status::GetResourceRequestStatusError>;
