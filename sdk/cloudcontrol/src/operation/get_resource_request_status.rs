...
impl GetResourceRequestStatusInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_request_status::GetResourceRequestStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceRequestStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_request_status::de_get_resource_request_status_http_response_with_props(status, headers, body)
        }
    }
