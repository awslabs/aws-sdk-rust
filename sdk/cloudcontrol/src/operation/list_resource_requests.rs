...
impl ListResourceRequestsInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceRequests`](crate::operation::list_resource_requests::ListResourceRequests)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_resource_requests::ListResourceRequests, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_requests::ListResourceRequestsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resource_requests::ser_list_resource_requests_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_requests::ListResourceRequests::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListResourceRequests", "cloudcontrol"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListResourceRequests {
                type Output = std::result::Result<crate::operation::list_resource_requests::ListResourceRequestsOutput, crate::operation::list_resource_requests::ListResourceRequestsError>;
