...
impl CancelResourceRequestInput {
    /// Consumes the builder and constructs an Operation<[`CancelResourceRequest`](crate::operation::cancel_resource_request::CancelResourceRequest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_resource_request::CancelResourceRequest, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_resource_request::CancelResourceRequestInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_resource_request::ser_cancel_resource_request_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_resource_request::CancelResourceRequest::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelResourceRequest", "cloudcontrol"));
...
impl aws_smithy_http::response::ParseStrictResponse for CancelResourceRequest {
                type Output = std::result::Result<crate::operation::cancel_resource_request::CancelResourceRequestOutput, crate::operation::cancel_resource_request::CancelResourceRequestError>;
