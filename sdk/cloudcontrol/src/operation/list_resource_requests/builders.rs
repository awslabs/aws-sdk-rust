...
impl ListResourceRequestsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_resource_requests::ListResourceRequestsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_requests::ListResourceRequestsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_resource_requests::ListResourceRequestsOutput, crate::operation::list_resource_requests::ListResourceRequestsError, Self> {
