...
impl DeleteResourceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteResource`](crate::operation::delete_resource::DeleteResource)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_resource::DeleteResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_resource::ser_delete_resource_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_resource::DeleteResource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteResource", "cloudcontrol"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResource {
    type Output =
        ::std::result::Result<crate::operation::delete_resource::DeleteResourceOutput, crate::operation::delete_resource::DeleteResourceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_resource::de_delete_resource_http_response_with_props(status, headers, body)
        }
    }
