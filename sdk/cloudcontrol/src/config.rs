...
impl Builder {
    ...
    /// use aws_sdk_cloudcontrol::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_cloudcontrol::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
