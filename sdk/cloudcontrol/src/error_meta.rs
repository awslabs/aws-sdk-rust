        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::CreateResourceErrorKind::HandlerInternalFailureException(
                        inner,
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::DeleteResourceErrorKind::HandlerInternalFailureException(
                        inner,
                    ) => Error::HandlerInternalFailureException(inner),
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::ListResourcesErrorKind::HandlerInternalFailureException(
                        inner,
                    ) => Error::HandlerInternalFailureException(inner),
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::UpdateResourceErrorKind::HandlerInternalFailureException(
                        inner,
                    ) => Error::HandlerInternalFailureException(inner),
