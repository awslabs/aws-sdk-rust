...
pub struct UpdateResourceOutput  {
    ...
    #[doc(hidden)]pub progress_event: std::option::Option<crate::model::ProgressEvent>,
}
...
pub struct ListResourcesOutput  {
    ...
    #[doc(hidden)]pub resource_descriptions: std::option::Option<std::vec::Vec<crate::model::ResourceDescription>>,
...
pub struct ListResourceRequestsOutput  {
    ...
    #[doc(hidden)]pub resource_request_status_summaries: std::option::Option<std::vec::Vec<crate::model::ProgressEvent>>,
    /// <p>If the request doesn't return all of the remaining results, <code>NextToken</code> is set to a token. To retrieve the next set of results, call <code>ListResources</code> again and assign that token to the request object's <code>NextToken</code> parameter. If the request returns all results, <code>NextToken</code> is set to null.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListResourceRequestsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("resource_request_status_summaries", &self.resource_request_status_summaries);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetResourceOutput  {
    ...
    #[doc(hidden)]pub resource_description: std::option::Option<crate::model::ResourceDescription>,
}
