...
pub struct ProgressEvent  {
    ...
    #[doc(hidden)]pub request_token: std::option::Option<std::string::String>,
    /// <p>The resource operation type.</p>
    #[doc(hidden)]pub operation: std::option::Option<crate::model::Operation>,
    ...
    /// </ul>
    #[doc(hidden)]pub operation_status: std::option::Option<crate::model::OperationStatus>,
    /// <p>When the resource operation request was initiated.</p>
    #[doc(hidden)]pub event_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A JSON string containing the resource model, consisting of each resource property and its current value.</p>
    #[doc(hidden)]pub resource_model: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub error_code: std::option::Option<crate::model::HandlerErrorCode>,
    /// <p>When to next request the status of this resource operation request.</p>
    #[doc(hidden)]pub retry_after: std::option::Option<aws_smithy_types::DateTime>,
}
impl ProgressEvent {
    /// <p>The name of the resource type used in the operation.</p>
...
pub struct ResourceDescription  {
    ...
    #[doc(hidden)]pub properties: std::option::Option<std::string::String>,
}
...
pub struct ResourceRequestStatusFilter  {
    ...
    #[doc(hidden)]pub operations: std::option::Option<std::vec::Vec<crate::model::Operation>>,
    ...
    /// </ul>
    #[doc(hidden)]pub operation_statuses: std::option::Option<std::vec::Vec<crate::model::OperationStatus>>,
}
