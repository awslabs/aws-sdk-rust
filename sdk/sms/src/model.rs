...
pub struct ServerGroup  {
    ...
    #[doc(hidden)]pub server_group_id: std::option::Option<std::string::String>,
...
pub struct Server  {
    ...
    #[doc(hidden)]pub vm_server: std::option::Option<crate::model::VmServer>,
    ...
    #[doc(hidden)]pub replication_job_terminated: std::option::Option<bool>,
}
impl Server {
    /// <p>The ID of the server.</p>
...
impl  std::fmt::Debug for Server  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("replication_job_terminated", &self.replication_job_terminated);
        formatter.finish()
    }
}
...
pub struct VmServer  {
    ...
    #[doc(hidden)]pub vm_server_address: std::option::Option<crate::model::VmServerAddress>,
    /// <p>The name of the VM.</p>
    #[doc(hidden)]pub vm_name: std::option::Option<std::string::String>,
    /// <p>The name of the VM manager.</p>
    #[doc(hidden)]pub vm_manager_name: std::option::Option<std::string::String>,
    /// <p>The type of VM management product.</p>
    #[doc(hidden)]pub vm_manager_type: std::option::Option<crate::model::VmManagerType>,
...
pub struct VmServerAddress  {
    ...
    #[doc(hidden)]pub vm_manager_id: std::option::Option<std::string::String>,
    /// <p>The ID of the VM.</p>
    #[doc(hidden)]pub vm_id: std::option::Option<std::string::String>,
}
...
pub struct AppSummary  {
    ...
    #[doc(hidden)]pub imported_app_id: std::option::Option<std::string::String>,
    /// <p>The name of the application.</p>
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The description of the application.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>Status of the application.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::AppStatus>,
    ...
    #[doc(hidden)]pub replication_configuration_status: std::option::Option<crate::model::AppReplicationConfigurationStatus>,
    /// <p>The replication status of the application.</p>
    #[doc(hidden)]pub replication_status: std::option::Option<crate::model::AppReplicationStatus>,
    /// <p>A message related to the replication status of the application.</p>
    #[doc(hidden)]pub replication_status_message: std::option::Option<std::string::String>,
    /// <p>The timestamp of the application's most recent successful replication.</p>
    #[doc(hidden)]pub latest_replication_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Status of the launch configuration.</p>
    #[doc(hidden)]pub launch_configuration_status: std::option::Option<crate::model::AppLaunchConfigurationStatus>,
    /// <p>The launch status of the application.</p>
    #[doc(hidden)]pub launch_status: std::option::Option<crate::model::AppLaunchStatus>,
    /// <p>A message related to the launch status of the application.</p>
    #[doc(hidden)]pub launch_status_message: std::option::Option<std::string::String>,
    /// <p>Details about the latest launch of the application.</p>
    #[doc(hidden)]pub launch_details: std::option::Option<crate::model::LaunchDetails>,
    ...
    #[doc(hidden)]pub total_server_groups: std::option::Option<i32>,
    /// <p>The number of servers present in the application.</p>
    #[doc(hidden)]pub total_servers: std::option::Option<i32>,
}
impl AppSummary {
    /// <p>The unique ID of the application.</p>
...
impl  std::fmt::Debug for AppSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("replication_configuration_status", &self.replication_configuration_status);
        formatter.field("replication_status", &self.replication_status);
        formatter.field("replication_status_message", &self.replication_status_message);
        formatter.field("latest_replication_time", &self.latest_replication_time);
        formatter.field("launch_configuration_status", &self.launch_configuration_status);
...
pub struct LaunchDetails  {
    ...
    #[doc(hidden)]pub latest_launch_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct ServerGroupValidationConfiguration  {
    ...
    #[doc(hidden)]pub server_validation_configurations: std::option::Option<std::vec::Vec<crate::model::ServerValidationConfiguration>>,
}
...
impl  std::fmt::Debug for ServerGroupValidationConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("server_group_id", &self.server_group_id);
        formatter.field("server_validation_configurations", &self.server_validation_configurations);
        formatter.finish()
    }
}
...
pub struct ServerValidationConfiguration  {
    ...
    #[doc(hidden)]pub validation_id: std::option::Option<std::string::String>,
    /// <p>The name of the configuration.</p>
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The validation strategy.</p>
    #[doc(hidden)]pub server_validation_strategy: std::option::Option<crate::model::ServerValidationStrategy>,
    /// <p>The validation parameters.</p>
    #[doc(hidden)]pub user_data_validation_parameters: std::option::Option<crate::model::UserDataValidationParameters>,
}
...
impl  std::fmt::Debug for ServerValidationConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("name", &self.name);
        formatter.field("server_validation_strategy", &self.server_validation_strategy);
        formatter.field("user_data_validation_parameters", &self.user_data_validation_parameters);
        formatter.finish()
    }
}
...
pub struct UserDataValidationParameters  {
    ...
    #[doc(hidden)]pub script_type: std::option::Option<crate::model::ScriptType>,
}
...
pub struct AppValidationConfiguration  {
    ...
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The validation strategy.</p>
    #[doc(hidden)]pub app_validation_strategy: std::option::Option<crate::model::AppValidationStrategy>,
    /// <p>The validation parameters.</p>
    #[doc(hidden)]pub ssm_validation_parameters: std::option::Option<crate::model::SsmValidationParameters>,
}
...
pub struct SsmValidationParameters  {
    ...
    #[doc(hidden)]pub execution_timeout_seconds: i32,
...
pub struct ServerGroupReplicationConfiguration  {
    ...
    #[doc(hidden)]pub server_replication_configurations: std::option::Option<std::vec::Vec<crate::model::ServerReplicationConfiguration>>,
}
...
impl  std::fmt::Debug for ServerGroupReplicationConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("server_group_id", &self.server_group_id);
        formatter.field("server_replication_configurations", &self.server_replication_configurations);
        formatter.finish()
    }
}
...
pub struct ServerReplicationConfiguration  {
    ...
    #[doc(hidden)]pub server_replication_parameters: std::option::Option<crate::model::ServerReplicationParameters>,
}
...
impl  std::fmt::Debug for ServerReplicationConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("server", &self.server);
        formatter.field("server_replication_parameters", &self.server_replication_parameters);
        formatter.finish()
    }
}
...
pub struct ServerReplicationParameters  {
    ...
    #[doc(hidden)]pub seed_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct ServerGroupLaunchConfiguration  {
    ...
    #[doc(hidden)]pub launch_order: std::option::Option<i32>,
    /// <p>The launch configuration for servers in the server group.</p>
    #[doc(hidden)]pub server_launch_configurations: std::option::Option<std::vec::Vec<crate::model::ServerLaunchConfiguration>>,
}
...
impl  std::fmt::Debug for ServerGroupLaunchConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("server_launch_configurations", &self.server_launch_configurations);
        formatter.finish()
    }
}
...
pub struct ServerLaunchConfiguration  {
    ...
    #[doc(hidden)]pub logical_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub subnet: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub user_data: std::option::Option<crate::model::UserData>,
    ...
    #[doc(hidden)]pub iam_instance_profile_name: std::option::Option<std::string::String>,
    /// <p>Location of an Amazon S3 object.</p>
    #[doc(hidden)]pub configure_script: std::option::Option<crate::model::S3Location>,
    /// <p>The type of configuration script.</p>
    #[doc(hidden)]pub configure_script_type: std::option::Option<crate::model::ScriptType>,
}
...
pub struct NotificationContext  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ValidationStatus>,
...
pub struct ReplicationRun  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::ReplicationRunState>,
    /// <p>The type of replication run.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ReplicationRunType>,
    /// <p>Details about the current stage of the replication run.</p>
    #[doc(hidden)]pub stage_details: std::option::Option<crate::model::ReplicationRunStageDetails>,
    ...
    #[doc(hidden)]pub completed_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct ReplicationRunStageDetails  {
    ...
    #[doc(hidden)]pub stage_progress: std::option::Option<std::string::String>,
}
...
pub struct ReplicationJob  {
    ...
    #[doc(hidden)]pub latest_ami_id: std::option::Option<std::string::String>,
    /// <p>The state of the replication job.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ReplicationJobState>,
    /// <p>The description of the current status of the replication job.</p>
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
...
pub struct Connector  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ConnectorStatus>,
    /// <p>The capabilities of the connector.</p>
    #[doc(hidden)]pub capability_list: std::option::Option<std::vec::Vec<crate::model::ConnectorCapability>>,
    /// <p>The name of the VM manager.</p>
    #[doc(hidden)]pub vm_manager_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub associated_on: std::option::Option<aws_smithy_types::DateTime>,
}
impl Connector {
    /// <p>The ID of the connector.</p>
...
pub struct ValidationOutput  {
    ...
    #[doc(hidden)]pub latest_validation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The output from validating an application.</p>
    #[doc(hidden)]pub app_validation_output: std::option::Option<crate::model::AppValidationOutput>,
    /// <p>The output from validation an instance.</p>
    #[doc(hidden)]pub server_validation_output: std::option::Option<crate::model::ServerValidationOutput>,
}
...
pub struct AppValidationOutput  {
    ...
    #[doc(hidden)]pub ssm_output: std::option::Option<crate::model::SsmOutput>,
}
