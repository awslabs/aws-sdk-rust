...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::launch_app::builders::LaunchAppFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::launch_app::builders::LaunchAppFluentBuilder::set_app_id): <p>The ID of the application.</p>
