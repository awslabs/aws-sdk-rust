...
impl super::Client {
    ...
    ///   - [`replication_job_id(impl ::std::convert::Into<String>)`](crate::operation::get_replication_jobs::builders::GetReplicationJobsFluentBuilder::replication_job_id) / [`set_replication_job_id(Option<String>)`](crate::operation::get_replication_jobs::builders::GetReplicationJobsFluentBuilder::set_replication_job_id): <p>The ID of the replication job.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_replication_jobs::builders::GetReplicationJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_replication_jobs::builders::GetReplicationJobsFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
