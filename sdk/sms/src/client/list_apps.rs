...
impl super::Client {
    ...
    ///   - [`app_ids(impl Into<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::app_ids) / [`set_app_ids(Option<Vec<String>>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::set_app_ids): <p>The unique application IDs.</p>
