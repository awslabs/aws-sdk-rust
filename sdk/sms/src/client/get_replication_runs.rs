...
impl super::Client {
    ...
    ///   - [`replication_job_id(impl Into<String>)`](crate::operation::get_replication_runs::builders::GetReplicationRunsFluentBuilder::replication_job_id) / [`set_replication_job_id(Option<String>)`](crate::operation::get_replication_runs::builders::GetReplicationRunsFluentBuilder::set_replication_job_id):<br>required: **true**<br><p>The ID of the replication job.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_replication_runs::builders::GetReplicationRunsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_replication_runs::builders::GetReplicationRunsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of results.</p><br>
