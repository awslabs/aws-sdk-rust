...
impl super::Client {
    ...
    pub fn import_app_catalog(
        &self,
    ) -> crate::operation::import_app_catalog::builders::ImportAppCatalogFluentBuilder {
        crate::operation::import_app_catalog::builders::ImportAppCatalogFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
