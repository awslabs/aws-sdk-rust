...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::put_app_replication_configuration::builders::PutAppReplicationConfigurationFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::put_app_replication_configuration::builders::PutAppReplicationConfigurationFluentBuilder::set_app_id): <p>The ID of the application.</p>
