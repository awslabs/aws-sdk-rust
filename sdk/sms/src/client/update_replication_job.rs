...
impl super::Client {
    ...
    ///   - [`replication_job_id(impl ::std::convert::Into<String>)`](crate::operation::update_replication_job::builders::UpdateReplicationJobFluentBuilder::replication_job_id) / [`set_replication_job_id(Option<String>)`](crate::operation::update_replication_job::builders::UpdateReplicationJobFluentBuilder::set_replication_job_id): <p>The ID of the replication job.</p>
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::update_replication_job::builders::UpdateReplicationJobFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::update_replication_job::builders::UpdateReplicationJobFluentBuilder::set_role_name): <p>The name of the IAM role to be used by Server Migration Service.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_replication_job::builders::UpdateReplicationJobFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_replication_job::builders::UpdateReplicationJobFluentBuilder::set_description): <p>The description of the replication job.</p>
