...
pub fn serialize_structure_create_app_input(
    ...
    if let Some(var_3) = &input.role_name {
        object.key("roleName").string(var_3);
    }
        ...
        for item_7 in var_5 {
            {
                ...
                crate::json_ser::serialize_structure_server_group(&mut object_8, item_7);
                object_8.finish();
            }
        }
        array_6.finish();
...
pub fn serialize_structure_create_replication_job_input(
    ...
    if let Some(var_18) = &input.role_name {
        object.key("roleName").string(var_18);
    }
    ...
    if let Some(var_22) = &input.kms_key_id {
        object.key("kmsKeyId").string(var_22);
    }
}
...
pub fn serialize_structure_delete_app_input(
    ...
    if let Some(var_23) = &input.app_id {
        object.key("appId").string(var_23);
    }
...
pub fn serialize_structure_delete_app_launch_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::DeleteAppLaunchConfigurationInput,
) {
    if let Some(var_26) = &input.app_id {
        object.key("appId").string(var_26);
    }
}

pub fn serialize_structure_delete_app_replication_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::DeleteAppReplicationConfigurationInput,
) {
    if let Some(var_27) = &input.app_id {
        object.key("appId").string(var_27);
    }
}

pub fn serialize_structure_delete_app_validation_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::DeleteAppValidationConfigurationInput,
) {
    if let Some(var_28) = &input.app_id {
        object.key("appId").string(var_28);
    }
}

pub fn serialize_structure_delete_replication_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::DeleteReplicationJobInput,
) {
    if let Some(var_29) = &input.replication_job_id {
        object.key("replicationJobId").string(var_29);
    }
}

pub fn serialize_structure_disassociate_connector_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::DisassociateConnectorInput,
) {
    if let Some(var_30) = &input.connector_id {
        object.key("connectorId").string(var_30);
    }
}

pub fn serialize_structure_generate_change_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GenerateChangeSetInput,
) {
    if let Some(var_31) = &input.app_id {
        object.key("appId").string(var_31);
    }
...
pub fn serialize_structure_generate_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GenerateTemplateInput,
) {
    if let Some(var_33) = &input.app_id {
        object.key("appId").string(var_33);
    }
...
pub fn serialize_structure_get_app_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetAppInput,
) {
    if let Some(var_35) = &input.app_id {
        object.key("appId").string(var_35);
    }
}

pub fn serialize_structure_get_app_launch_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetAppLaunchConfigurationInput,
) {
    if let Some(var_36) = &input.app_id {
        object.key("appId").string(var_36);
    }
}

pub fn serialize_structure_get_app_replication_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetAppReplicationConfigurationInput,
) {
    if let Some(var_37) = &input.app_id {
        object.key("appId").string(var_37);
    }
}

pub fn serialize_structure_get_app_validation_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetAppValidationConfigurationInput,
) {
    if let Some(var_38) = &input.app_id {
        object.key("appId").string(var_38);
    }
}

pub fn serialize_structure_get_app_validation_output_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetAppValidationOutputInput,
) {
    if let Some(var_39) = &input.app_id {
        object.key("appId").string(var_39);
    }
}

pub fn serialize_structure_get_connectors_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_replication_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetReplicationJobsInput,
) {
    if let Some(var_42) = &input.replication_job_id {
        object.key("replicationJobId").string(var_42);
    }
...
pub fn serialize_structure_get_replication_runs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::GetReplicationRunsInput,
) {
    if let Some(var_45) = &input.replication_job_id {
        object.key("replicationJobId").string(var_45);
    }
...
pub fn serialize_structure_get_servers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_52 in var_50 {
            {
                ...
                crate::json_ser::serialize_structure_vm_server_address(&mut object_53, item_52);
                object_53.finish();
            }
        }
        array_51.finish();
...
pub fn serialize_structure_import_app_catalog_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::ImportAppCatalogInput,
) {
    if let Some(var_54) = &input.role_name {
        object.key("roleName").string(var_54);
    }
}

pub fn serialize_structure_launch_app_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::LaunchAppInput,
) {
    if let Some(var_55) = &input.app_id {
        object.key("appId").string(var_55);
    }
}
        ...
        for item_69 in var_67 {
            {
                ...
                crate::json_ser::serialize_structure_server_group_launch_configuration(
                    &mut object_70,
                    item_69,
                );
                object_70.finish();
...
pub fn serialize_structure_put_app_replication_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::PutAppReplicationConfigurationInput,
) {
    if let Some(var_71) = &input.app_id {
        object.key("appId").string(var_71);
    }
        ...
        for item_74 in var_72 {
            {
                ...
                crate::json_ser::serialize_structure_server_group_replication_configuration(
                    &mut object_75,
                    item_74,
                );
                object_75.finish();
...
pub fn serialize_structure_put_app_validation_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::PutAppValidationConfigurationInput,
) {
    if let Some(var_76) = &input.app_id {
        object.key("appId").string(var_76);
    }
        ...
        for item_79 in var_77 {
            {
                ...
                crate::json_ser::serialize_structure_app_validation_configuration(
                    &mut object_80,
                    item_79,
                );
                object_80.finish();
        ...
        for item_83 in var_81 {
            {
                ...
                crate::json_ser::serialize_structure_server_group_validation_configuration(
                    &mut object_84,
                    item_83,
                );
                object_84.finish();
...
pub fn serialize_structure_start_app_replication_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::StartAppReplicationInput,
) {
    if let Some(var_85) = &input.app_id {
        object.key("appId").string(var_85);
    }
}

pub fn serialize_structure_start_on_demand_app_replication_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::StartOnDemandAppReplicationInput,
) {
    if let Some(var_86) = &input.app_id {
        object.key("appId").string(var_86);
    }
...
pub fn serialize_structure_start_on_demand_replication_run_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::StartOnDemandReplicationRunInput,
) {
    if let Some(var_88) = &input.replication_job_id {
        object.key("replicationJobId").string(var_88);
    }
...
pub fn serialize_structure_stop_app_replication_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::StopAppReplicationInput,
) {
    if let Some(var_90) = &input.app_id {
        object.key("appId").string(var_90);
    }
}

pub fn serialize_structure_terminate_app_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::TerminateAppInput,
) {
    if let Some(var_91) = &input.app_id {
        object.key("appId").string(var_91);
    }
}

pub fn serialize_structure_update_app_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::UpdateAppInput,
) {
    if let Some(var_92) = &input.app_id {
        object.key("appId").string(var_92);
    }
    ...
    if let Some(var_95) = &input.role_name {
        object.key("roleName").string(var_95);
    }
        ...
        for item_98 in var_96 {
            {
                ...
                crate::json_ser::serialize_structure_server_group(&mut object_99, item_98);
                object_99.finish();
            }
        }
        array_97.finish();
...
pub fn serialize_structure_update_replication_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::UpdateReplicationJobInput,
) {
    if let Some(var_104) = &input.replication_job_id {
        object.key("replicationJobId").string(var_104);
    }
    ...
    if let Some(var_108) = &input.role_name {
        object.key("roleName").string(var_108);
    }
    ...
    if let Some(var_112) = &input.kms_key_id {
        object.key("kmsKeyId").string(var_112);
    }
}

pub fn serialize_structure_server_group(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ServerGroup,
) {
    if let Some(var_113) = &input.server_group_id {
        object.key("serverGroupId").string(var_113);
    }
        ...
        for item_117 in var_115 {
            {
                ...
                crate::json_ser::serialize_structure_server(&mut object_118, item_117);
                object_118.finish();
            }
        }
        array_116.finish();
        ...
        for item_130 in var_128 {
            {
                ...
                crate::json_ser::serialize_structure_server_launch_configuration(
                    &mut object_131,
                    item_130,
                );
                object_131.finish();
...
pub fn serialize_structure_server_group_replication_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ServerGroupReplicationConfiguration,
) {
    if let Some(var_132) = &input.server_group_id {
        object.key("serverGroupId").string(var_132);
    }
        ...
        for item_135 in var_133 {
            {
                ...
                crate::json_ser::serialize_structure_server_replication_configuration(
                    &mut object_136,
                    item_135,
                );
                object_136.finish();
...
pub fn serialize_structure_app_validation_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::AppValidationConfiguration,
) {
    if let Some(var_137) = &input.validation_id {
        object.key("validationId").string(var_137);
    }
    ...
    if let Some(var_140) = &input.ssm_validation_parameters {
        ...
        crate::json_ser::serialize_structure_ssm_validation_parameters(&mut object_141, var_140);
        object_141.finish();
    }
}

pub fn serialize_structure_server_group_validation_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ServerGroupValidationConfiguration,
) {
    if let Some(var_142) = &input.server_group_id {
        object.key("serverGroupId").string(var_142);
    }
        ...
        for item_145 in var_143 {
            {
                ...
                crate::json_ser::serialize_structure_server_validation_configuration(
                    &mut object_146,
                    item_145,
                );
                object_146.finish();
...
pub fn serialize_structure_server(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::Server,
) {
    if let Some(var_147) = &input.server_id {
        object.key("serverId").string(var_147);
    }
    ...
    if let Some(var_149) = &input.vm_server {
        ...
        crate::json_ser::serialize_structure_vm_server(&mut object_150, var_149);
        object_150.finish();
    }
    if let Some(var_151) = &input.replication_job_id {
        object.key("replicationJobId").string(var_151);
    }
...
pub fn serialize_structure_server_launch_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_153) = &input.server {
        ...
        crate::json_ser::serialize_structure_server(&mut object_154, var_153);
        object_154.finish();
    }
    if let Some(var_155) = &input.logical_id {
        object.key("logicalId").string(var_155);
    }
    if let Some(var_156) = &input.vpc {
        object.key("vpc").string(var_156);
    }
    if let Some(var_157) = &input.subnet {
        object.key("subnet").string(var_157);
    }
    if let Some(var_158) = &input.security_group {
        object.key("securityGroup").string(var_158);
    }
    ...
    if let Some(var_160) = &input.user_data {
        ...
        crate::json_ser::serialize_structure_user_data(&mut object_161, var_160);
        object_161.finish();
    }
    if let Some(var_162) = &input.instance_type {
        object.key("instanceType").string(var_162);
    }
    ...
    if let Some(var_164) = &input.iam_instance_profile_name {
        object.key("iamInstanceProfileName").string(var_164);
    }
    if let Some(var_165) = &input.configure_script {
        let mut object_166 = object.key("configureScript").start_object();
        crate::json_ser::serialize_structure_s3_location(&mut object_166, var_165);
        object_166.finish();
    }
...
pub fn serialize_structure_server_replication_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_168) = &input.server {
        ...
        crate::json_ser::serialize_structure_server(&mut object_169, var_168);
        object_169.finish();
    }
    if let Some(var_170) = &input.server_replication_parameters {
        ...
        crate::json_ser::serialize_structure_server_replication_parameters(
            &mut object_171,
            var_170,
        );
        object_171.finish();
...
pub fn serialize_structure_ssm_validation_parameters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_172) = &input.source {
        ...
        crate::json_ser::serialize_structure_source(&mut object_173, var_172);
        object_173.finish();
    }
    if let Some(var_174) = &input.instance_id {
        object.key("instanceId").string(var_174);
    }
    if let Some(var_175) = &input.script_type {
        object.key("scriptType").string(var_175.as_str());
    }
    if let Some(var_176) = &input.command {
        object.key("command").string(var_176);
    }
    if input.execution_timeout_seconds != 0 {
        object.key("executionTimeoutSeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.execution_timeout_seconds).into()),
        );
    }
    if let Some(var_177) = &input.output_s3_bucket_name {
        object.key("outputS3BucketName").string(var_177);
    }
}

pub fn serialize_structure_server_validation_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_178) = &input.server {
        ...
        crate::json_ser::serialize_structure_server(&mut object_179, var_178);
        object_179.finish();
    }
    if let Some(var_180) = &input.validation_id {
        object.key("validationId").string(var_180);
    }
    ...
    if let Some(var_183) = &input.user_data_validation_parameters {
        ...
        crate::json_ser::serialize_structure_user_data_validation_parameters(
            &mut object_184,
            var_183,
        );
        object_184.finish();
...
pub fn serialize_structure_vm_server(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_user_data(
    ...
    if let Some(var_191) = &input.s3_location {
        ...
        crate::json_ser::serialize_structure_s3_location(&mut object_192, var_191);
        object_192.finish();
    }
}
...
pub fn serialize_structure_s3_location(
    ...
    if let Some(var_193) = &input.bucket {
        object.key("bucket").string(var_193);
    }
...
pub fn serialize_structure_server_replication_parameters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_195) = &input.seed_time {
        object
            .key("seedTime")
            .instant(var_195, smithy_types::instant::Format::EpochSeconds);
    }
    ...
    if let Some(var_201) = &input.kms_key_id {
        object.key("kmsKeyId").string(var_201);
    }
}
...
pub fn serialize_structure_user_data_validation_parameters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_204) = &input.source {
        ...
        crate::json_ser::serialize_structure_source(&mut object_205, var_204);
        object_205.finish();
    }
