...
pub fn serialize_structure_crate_input_create_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAppInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_replication_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReplicationJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAppInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_app_launch_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAppLaunchConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_app_replication_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAppReplicationConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_app_validation_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAppValidationConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_replication_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteReplicationJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_disassociate_connector_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateConnectorInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_generate_change_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateChangeSetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_generate_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateTemplateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_app_launch_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppLaunchConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_app_replication_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppReplicationConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_app_validation_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppValidationConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_app_validation_output_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAppValidationOutputInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_connectors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetConnectorsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_replication_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetReplicationJobsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_replication_runs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetReplicationRunsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_servers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetServersInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_import_app_catalog_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportAppCatalogInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_launch_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::LaunchAppInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_apps_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAppsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_notify_app_validation_output_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::NotifyAppValidationOutputInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_app_launch_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAppLaunchConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_app_replication_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAppReplicationConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_app_validation_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAppValidationConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_app_replication_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartAppReplicationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_on_demand_app_replication_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartOnDemandAppReplicationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_on_demand_replication_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartOnDemandReplicationRunInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_stop_app_replication_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopAppReplicationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_terminate_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TerminateAppInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAppInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_replication_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateReplicationJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_group(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerGroup) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_vm_server_address(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VmServerAddress) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_notification_context(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NotificationContext) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_group_launch_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerGroupLaunchConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_group_replication_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerGroupReplicationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_app_validation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AppValidationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_group_validation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerGroupValidationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Server) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_launch_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerLaunchConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_replication_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerReplicationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_ssm_validation_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SsmValidationParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_validation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerValidationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_vm_server(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VmServer) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_user_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_server_replication_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerReplicationParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_user_data_validation_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserDataValidationParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
