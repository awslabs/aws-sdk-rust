...
pub struct UpdateAppOutput  {
    ...
    #[doc(hidden)]pub app_summary: std::option::Option<crate::model::AppSummary>,
    /// <p>The updated server groups in the application.</p>
    #[doc(hidden)]pub server_groups: std::option::Option<std::vec::Vec<crate::model::ServerGroup>>,
...
pub struct StartOnDemandReplicationRunOutput  {
    ...
    #[doc(hidden)]pub replication_run_id: std::option::Option<std::string::String>,
}
...
pub struct ListAppsOutput  {
    ...
    #[doc(hidden)]pub apps: std::option::Option<std::vec::Vec<crate::model::AppSummary>>,
...
pub struct GetServersOutput  {
    ...
    #[doc(hidden)]pub last_modified_on: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The status of the server catalog.</p>
    #[doc(hidden)]pub server_catalog_status: std::option::Option<crate::model::ServerCatalogStatus>,
    /// <p>Information about the servers.</p>
    #[doc(hidden)]pub server_list: std::option::Option<std::vec::Vec<crate::model::Server>>,
    /// <p>The token required to retrieve the next set of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetReplicationRunsOutput  {
    ...
    #[doc(hidden)]pub replication_job: std::option::Option<crate::model::ReplicationJob>,
    /// <p>Information about the replication runs.</p>
    #[doc(hidden)]pub replication_run_list: std::option::Option<std::vec::Vec<crate::model::ReplicationRun>>,
    /// <p>The token required to retrieve the next set of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetReplicationJobsOutput  {
    ...
    #[doc(hidden)]pub replication_job_list: std::option::Option<std::vec::Vec<crate::model::ReplicationJob>>,
    /// <p>The token required to retrieve the next set of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetConnectorsOutput  {
    ...
    #[doc(hidden)]pub connector_list: std::option::Option<std::vec::Vec<crate::model::Connector>>,
    /// <p>The token required to retrieve the next set of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetAppValidationOutputOutput  {
    ...
    #[doc(hidden)]pub validation_output_list: std::option::Option<std::vec::Vec<crate::model::ValidationOutput>>,
}
...
pub struct GetAppValidationConfigurationOutput  {
    ...
    #[doc(hidden)]pub app_validation_configurations: std::option::Option<std::vec::Vec<crate::model::AppValidationConfiguration>>,
    /// <p>The configuration for instance validation.</p>
    #[doc(hidden)]pub server_group_validation_configurations: std::option::Option<std::vec::Vec<crate::model::ServerGroupValidationConfiguration>>,
}
...
impl  std::fmt::Debug for GetAppValidationConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("app_validation_configurations", &self.app_validation_configurations);
        formatter.field("server_group_validation_configurations", &self.server_group_validation_configurations);
        formatter.finish()
    }
}
...
pub struct GetAppReplicationConfigurationOutput  {
    ...
    #[doc(hidden)]pub server_group_replication_configurations: std::option::Option<std::vec::Vec<crate::model::ServerGroupReplicationConfiguration>>,
}
...
impl  std::fmt::Debug for GetAppReplicationConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("server_group_replication_configurations", &self.server_group_replication_configurations);
        formatter.finish()
    }
}
...
pub struct GetAppLaunchConfigurationOutput  {
    ...
    #[doc(hidden)]pub role_name: std::option::Option<std::string::String>,
    /// <p>Indicates whether the application is configured to launch automatically after replication is complete.</p>
    #[doc(hidden)]pub auto_launch: std::option::Option<bool>,
    /// <p>The launch configurations for server groups in this application.</p>
    #[doc(hidden)]pub server_group_launch_configurations: std::option::Option<std::vec::Vec<crate::model::ServerGroupLaunchConfiguration>>,
}
...
impl  std::fmt::Debug for GetAppLaunchConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("server_group_launch_configurations", &self.server_group_launch_configurations);
        formatter.finish()
    }
}
...
pub struct GenerateTemplateOutput  {
    ...
    #[doc(hidden)]pub s3_location: std::option::Option<crate::model::S3Location>,
}
...
pub struct CreateReplicationJobOutput  {
    ...
    #[doc(hidden)]pub replication_job_id: std::option::Option<std::string::String>,
}
