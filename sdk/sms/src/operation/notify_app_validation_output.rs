...
impl NotifyAppValidationOutput {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::notify_app_validation_output::NotifyAppValidationOutputOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::notify_app_validation_output::NotifyAppValidationOutputError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::notify_app_validation_output::NotifyAppValidationOutputError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::notify_app_validation_output::NotifyAppValidationOutputOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for NotifyAppValidationOutput {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("NotifyAppValidationOutput");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(NotifyAppValidationOutputRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(NotifyAppValidationOutputResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("NotifyAppValidationOutput")
...
.with_interceptor(NotifyAppValidationOutputEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::notify_app_validation_output::NotifyAppValidationOutputError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::notify_app_validation_output::NotifyAppValidationOutputError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::notify_app_validation_output::NotifyAppValidationOutputError>::new());
...
#[derive(Debug)]
            struct NotifyAppValidationOutputResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for NotifyAppValidationOutputResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_notify_app_validation_output::de_notify_app_validation_output_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct NotifyAppValidationOutputRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for NotifyAppValidationOutputRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::notify_app_validation_output::NotifyAppValidationOutputInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::notify_app_validation_output::NotifyAppValidationOutputInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_notify_app_validation_output::ser_notify_app_validation_output_input(&input)?);
...
#[derive(Debug)]
            struct NotifyAppValidationOutputEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for NotifyAppValidationOutputEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "NotifyAppValidationOutputEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<NotifyAppValidationOutputInput>()
                        .ok_or("failed to downcast to NotifyAppValidationOutputInput")?;
...
pub enum NotifyAppValidationOutputError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-NotifyAppValidationOutputError) for what information is available for the error.")]
...
impl NotifyAppValidationOutputError {
    /// Creates the `NotifyAppValidationOutputError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `NotifyAppValidationOutputError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for NotifyAppValidationOutputError {
...
impl ::aws_types::request_id::RequestId for crate::operation::notify_app_validation_output::NotifyAppValidationOutputError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::notify_app_validation_output::_notify_app_validation_output_output::NotifyAppValidationOutputOutput;

pub use crate::operation::notify_app_validation_output::_notify_app_validation_output_input::NotifyAppValidationOutputInput;

mod _notify_app_validation_output_input;

mod _notify_app_validation_output_output;
