...
impl NotifyAppValidationOutputInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::notify_app_validation_output::NotifyAppValidationOutput::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for NotifyAppValidationOutput {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_notify_app_validation_output::de_notify_app_validation_output_http_response_with_props(status, headers, body)
        }
    }
}
