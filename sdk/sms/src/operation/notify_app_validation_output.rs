...
impl NotifyAppValidationOutputInput {
    /// Consumes the builder and constructs an Operation<[`NotifyAppValidationOutput`](crate::operation::notify_app_validation_output::NotifyAppValidationOutput)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::notify_app_validation_output::NotifyAppValidationOutput, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::notify_app_validation_output::NotifyAppValidationOutputInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::notify_app_validation_output::NotifyAppValidationOutput::new())
...
impl aws_smithy_http::response::ParseStrictResponse for NotifyAppValidationOutput {
                type Output = std::result::Result<crate::operation::notify_app_validation_output::NotifyAppValidationOutputOutput, crate::operation::notify_app_validation_output::NotifyAppValidationOutputError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_notify_app_validation_output::de_notify_app_validation_output_http_error(response)
                     } else {
                        crate::protocol_serde::shape_notify_app_validation_output::de_notify_app_validation_output_http_response(response)
                     }
                }
            }
