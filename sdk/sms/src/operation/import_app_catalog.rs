    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::import_app_catalog::ImportAppCatalogError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::import_app_catalog::ImportAppCatalogOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ImportAppCatalogRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::import_app_catalog::ImportAppCatalogInput>()
            .expect("correct type");
