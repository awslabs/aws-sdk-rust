...
impl crate::operation::put_app_validation_configuration::builders::PutAppValidationConfigurationInputBuilder {
...
impl PutAppValidationConfigurationFluentBuilder {
    /// Creates a new `PutAppValidationConfigurationFluentBuilder`.
