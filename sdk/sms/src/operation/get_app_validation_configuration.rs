...
impl GetAppValidationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetAppValidationConfiguration`](crate::operation::get_app_validation_configuration::GetAppValidationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_app_validation_configuration::GetAppValidationConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_app_validation_configuration::GetAppValidationConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_app_validation_configuration::GetAppValidationConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetAppValidationConfiguration {
                type Output = std::result::Result<crate::operation::get_app_validation_configuration::GetAppValidationConfigurationOutput, crate::operation::get_app_validation_configuration::GetAppValidationConfigurationError>;
