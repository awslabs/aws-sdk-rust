...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppValidationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_app_validation_configuration::de_get_app_validation_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_app_validation_configuration::GetAppValidationConfigurationError
{
