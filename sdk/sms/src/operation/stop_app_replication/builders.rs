...
impl StopAppReplicationFluentBuilder  {
    /// Creates a new `StopAppReplication`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::stop_app_replication::StopAppReplicationOutput, aws_smithy_http::result::SdkError<crate::operation::stop_app_replication::StopAppReplicationError>>
                     {
