...
impl StartOnDemandAppReplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_on_demand_app_replication::StartOnDemandAppReplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartOnDemandAppReplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_on_demand_app_replication::de_start_on_demand_app_replication_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StartOnDemandAppReplicationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError
{
