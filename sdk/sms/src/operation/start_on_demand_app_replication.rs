...
/// Orchestration and serialization glue logic for `StartOnDemandAppReplication`.
...
impl StartOnDemandAppReplication {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationInput,
                    ) -> ::std::result::Result<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartOnDemandAppReplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartOnDemandAppReplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartOnDemandAppReplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartOnDemandAppReplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartOnDemandAppReplication")
...
.with_interceptor(StartOnDemandAppReplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError>::new());
...
#[derive(Debug)]
            struct StartOnDemandAppReplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartOnDemandAppReplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_on_demand_app_replication::de_start_on_demand_app_replication_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_on_demand_app_replication::de_start_on_demand_app_replication_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartOnDemandAppReplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartOnDemandAppReplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_on_demand_app_replication::ser_start_on_demand_app_replication_input(&input)?);
...
#[derive(Debug)]
            struct StartOnDemandAppReplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartOnDemandAppReplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartOnDemandAppReplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartOnDemandAppReplicationInput>()
                        .ok_or("failed to downcast to StartOnDemandAppReplicationInput")?;
...
pub enum StartOnDemandAppReplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartOnDemandAppReplicationError) for what information is available for the error.")]
...
impl StartOnDemandAppReplicationError {
    /// Creates the `StartOnDemandAppReplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartOnDemandAppReplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartOnDemandAppReplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::start_on_demand_app_replication::_start_on_demand_app_replication_output::StartOnDemandAppReplicationOutput;

pub use crate::operation::start_on_demand_app_replication::_start_on_demand_app_replication_input::StartOnDemandAppReplicationInput;

mod _start_on_demand_app_replication_input;

mod _start_on_demand_app_replication_output;
