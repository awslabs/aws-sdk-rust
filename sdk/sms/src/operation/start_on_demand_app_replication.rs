...
impl StartOnDemandAppReplicationInput {
    /// Consumes the builder and constructs an Operation<[`StartOnDemandAppReplication`](crate::operation::start_on_demand_app_replication::StartOnDemandAppReplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_on_demand_app_replication::StartOnDemandAppReplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartOnDemandAppReplication", "sms"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `StartOnDemandAppReplication`.
...
impl aws_smithy_http::response::ParseStrictResponse for StartOnDemandAppReplication {
                type Output = std::result::Result<crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationOutput, crate::operation::start_on_demand_app_replication::StartOnDemandAppReplicationError>;
