...
impl LaunchAppInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::launch_app::LaunchApp,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::launch_app::LaunchApp::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for LaunchApp {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_launch_app::de_launch_app_http_response_with_props(
                status, headers, body,
            )
        }
    }
