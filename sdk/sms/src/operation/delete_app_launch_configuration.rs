...
impl DeleteAppLaunchConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_app_launch_configuration::DeleteAppLaunchConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_app_launch_configuration::DeleteAppLaunchConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAppLaunchConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_app_launch_configuration::de_delete_app_launch_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteAppLaunchConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_app_launch_configuration::DeleteAppLaunchConfigurationError
{
