...
impl PutAppLaunchConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutAppLaunchConfiguration`](crate::operation::put_app_launch_configuration::PutAppLaunchConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_app_launch_configuration::PutAppLaunchConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_app_launch_configuration::PutAppLaunchConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_app_launch_configuration::PutAppLaunchConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutAppLaunchConfiguration", "sms"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutAppLaunchConfiguration`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutAppLaunchConfiguration {
                type Output = std::result::Result<crate::operation::put_app_launch_configuration::PutAppLaunchConfigurationOutput, crate::operation::put_app_launch_configuration::PutAppLaunchConfigurationError>;
