...
impl PutAppLaunchConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_app_launch_configuration::PutAppLaunchConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAppLaunchConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_app_launch_configuration::de_put_app_launch_configuration_http_response_with_props(status, headers, body)
        }
    }
}
