    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::import_server_catalog::ImportServerCatalogError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::import_server_catalog::ImportServerCatalogOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ImportServerCatalogRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::import_server_catalog::ImportServerCatalogInput>()
            .expect("correct type");
