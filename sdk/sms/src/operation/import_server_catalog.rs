...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportServerCatalog {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportServerCatalog")
            .with_interceptor(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportServerCatalogRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_server_catalog::ser_import_server_catalog_input(
            &input,
        )?);
