...
impl GetReplicationRuns {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_replication_runs::GetReplicationRunsInput,
                    ) -> ::std::result::Result<crate::operation::get_replication_runs::GetReplicationRunsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_replication_runs::GetReplicationRunsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_replication_runs::GetReplicationRunsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_replication_runs::GetReplicationRunsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetReplicationRuns {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetReplicationRuns");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetReplicationRunsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetReplicationRunsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetReplicationRuns")
...
.with_interceptor(GetReplicationRunsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_replication_runs::GetReplicationRunsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_replication_runs::GetReplicationRunsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_replication_runs::GetReplicationRunsError>::new());
...
#[derive(Debug)]
            struct GetReplicationRunsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetReplicationRunsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_replication_runs::de_get_replication_runs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetReplicationRunsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetReplicationRunsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_replication_runs::GetReplicationRunsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_replication_runs::GetReplicationRunsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_replication_runs::ser_get_replication_runs_input(&input)?);
...
#[derive(Debug)]
            struct GetReplicationRunsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetReplicationRunsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetReplicationRunsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetReplicationRunsInput>()
                        .ok_or("failed to downcast to GetReplicationRunsInput")?;
...
pub enum GetReplicationRunsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetReplicationRunsError) for what information is available for the error.")]
...
impl GetReplicationRunsError {
    /// Creates the `GetReplicationRunsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetReplicationRunsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetReplicationRunsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_replication_runs::GetReplicationRunsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_replication_runs::_get_replication_runs_output::GetReplicationRunsOutput;

pub use crate::operation::get_replication_runs::_get_replication_runs_input::GetReplicationRunsInput;

mod _get_replication_runs_input;

mod _get_replication_runs_output;
