...
impl GetReplicationRunsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_replication_runs::ser_get_replication_runs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReplicationRuns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_replication_runs::de_get_replication_runs_http_response_with_props(status, headers, body)
        }
    }
}
