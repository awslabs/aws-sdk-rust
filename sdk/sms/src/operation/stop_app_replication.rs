...
impl StopAppReplicationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_app_replication::ser_stop_app_replication_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopAppReplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_app_replication::de_stop_app_replication_http_response_with_props(status, headers, body)
        }
    }
}
