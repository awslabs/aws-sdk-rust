...
impl StopAppReplicationInput {
    /// Consumes the builder and constructs an Operation<[`StopAppReplication`](crate::operation::stop_app_replication::StopAppReplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_app_replication::StopAppReplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_app_replication::StopAppReplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_app_replication::ser_stop_app_replication_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_app_replication::StopAppReplication::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopAppReplication {
                type Output = std::result::Result<crate::operation::stop_app_replication::StopAppReplicationOutput, crate::operation::stop_app_replication::StopAppReplicationError>;
