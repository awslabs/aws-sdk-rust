...
impl StopAppReplicationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_app_replication::StopAppReplication::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StopAppReplication {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_app_replication::de_stop_app_replication_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::stop_app_replication::StopAppReplicationError
{
