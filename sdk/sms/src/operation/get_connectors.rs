...
impl GetConnectorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_connectors::GetConnectors, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_connectors::ser_get_connectors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConnectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_connectors::de_get_connectors_http_response_with_props(status, headers, body)
        }
    }
}
