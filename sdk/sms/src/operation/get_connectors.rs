...
impl GetConnectorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_connectors::GetConnectors,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_connectors::GetConnectors::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConnectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_connectors::de_get_connectors_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_connectors::de_get_connectors_http_response_with_props(
                status, headers, body,
            )
        }
    }
