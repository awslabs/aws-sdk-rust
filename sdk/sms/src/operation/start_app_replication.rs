...
impl StartAppReplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_app_replication::StartAppReplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAppReplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_app_replication::de_start_app_replication_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_app_replication::StartAppReplicationError
{
