...
impl StartAppReplicationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_app_replication::StartAppReplication,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAppReplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_app_replication::de_start_app_replication_http_response_with_props(status, headers, body)
        }
    }
}
