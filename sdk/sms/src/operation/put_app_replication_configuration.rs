...
impl PutAppReplicationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutAppReplicationConfiguration`](crate::operation::put_app_replication_configuration::PutAppReplicationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_app_replication_configuration::PutAppReplicationConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_app_replication_configuration::PutAppReplicationConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutAppReplicationConfiguration", "sms"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutAppReplicationConfiguration`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutAppReplicationConfiguration {
                type Output = std::result::Result<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationOutput, crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError>;
