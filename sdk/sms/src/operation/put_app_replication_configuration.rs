...
impl PutAppReplicationConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_app_replication_configuration::PutAppReplicationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAppReplicationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_app_replication_configuration::de_put_app_replication_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
