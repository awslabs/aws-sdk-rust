...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAppReplicationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_app_replication_configuration::de_put_app_replication_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError
{
