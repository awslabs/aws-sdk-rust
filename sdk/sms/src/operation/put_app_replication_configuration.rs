...
/// Orchestration and serialization glue logic for `PutAppReplicationConfiguration`.
...
impl PutAppReplicationConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutAppReplicationConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutAppReplicationConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutAppReplicationConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutAppReplicationConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutAppReplicationConfiguration")
...
.with_interceptor(PutAppReplicationConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError>::new());
...
#[derive(Debug)]
            struct PutAppReplicationConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutAppReplicationConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_app_replication_configuration::de_put_app_replication_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_app_replication_configuration::de_put_app_replication_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutAppReplicationConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutAppReplicationConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_app_replication_configuration::ser_put_app_replication_configuration_input(&input)?);
...
#[derive(Debug)]
            struct PutAppReplicationConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutAppReplicationConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutAppReplicationConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutAppReplicationConfigurationInput>()
                        .ok_or("failed to downcast to PutAppReplicationConfigurationInput")?;
...
pub enum PutAppReplicationConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutAppReplicationConfigurationError) for what information is available for the error.")]
...
impl PutAppReplicationConfigurationError {
    /// Creates the `PutAppReplicationConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutAppReplicationConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutAppReplicationConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutAppReplicationConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_app_replication_configuration::PutAppReplicationConfigurationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_app_replication_configuration::_put_app_replication_configuration_output::PutAppReplicationConfigurationOutput;

pub use crate::operation::put_app_replication_configuration::_put_app_replication_configuration_input::PutAppReplicationConfigurationInput;

mod _put_app_replication_configuration_input;

mod _put_app_replication_configuration_output;
