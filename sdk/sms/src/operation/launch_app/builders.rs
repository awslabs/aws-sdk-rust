...
impl LaunchAppFluentBuilder  {
    /// Creates a new `LaunchApp`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::launch_app::LaunchAppOutput, aws_smithy_http::result::SdkError<crate::operation::launch_app::LaunchAppError>>
                     {
