...
impl GenerateChangeSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_generate_change_set::ser_generate_change_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateChangeSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_change_set::de_generate_change_set_http_response_with_props(status, headers, body)
        }
    }
}
