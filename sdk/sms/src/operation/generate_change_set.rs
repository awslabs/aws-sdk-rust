...
/// Orchestration and serialization glue logic for `GenerateChangeSet`.
...
impl GenerateChangeSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::generate_change_set::GenerateChangeSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_change_set::GenerateChangeSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::generate_change_set::GenerateChangeSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::generate_change_set::GenerateChangeSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateChangeSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateChangeSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GenerateChangeSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GenerateChangeSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateChangeSet")
...
.with_interceptor(GenerateChangeSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::generate_change_set::GenerateChangeSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::generate_change_set::GenerateChangeSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::generate_change_set::GenerateChangeSetError>::new());
...
#[derive(Debug)]
            struct GenerateChangeSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateChangeSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_generate_change_set::de_generate_change_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_generate_change_set::de_generate_change_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GenerateChangeSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateChangeSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::generate_change_set::GenerateChangeSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::generate_change_set::GenerateChangeSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_generate_change_set::ser_generate_change_set_input(&input)?);
...
#[derive(Debug)]
            struct GenerateChangeSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateChangeSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GenerateChangeSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GenerateChangeSetInput>()
                        .ok_or("failed to downcast to GenerateChangeSetInput")?;
...
pub enum GenerateChangeSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateChangeSetError) for what information is available for the error.")]
...
impl GenerateChangeSetError {
    /// Creates the `GenerateChangeSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GenerateChangeSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateChangeSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_change_set::GenerateChangeSetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::generate_change_set::_generate_change_set_output::GenerateChangeSetOutput;

pub use crate::operation::generate_change_set::_generate_change_set_input::GenerateChangeSetInput;

mod _generate_change_set_input;

mod _generate_change_set_output;
