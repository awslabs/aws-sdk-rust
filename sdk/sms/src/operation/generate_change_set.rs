...
impl GenerateChangeSetInput {
    /// Consumes the builder and constructs an Operation<[`GenerateChangeSet`](crate::operation::generate_change_set::GenerateChangeSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_change_set::GenerateChangeSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_change_set::GenerateChangeSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_change_set::GenerateChangeSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GenerateChangeSet", "sms"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GenerateChangeSet`.
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateChangeSet {
                type Output = std::result::Result<crate::operation::generate_change_set::GenerateChangeSetOutput, crate::operation::generate_change_set::GenerateChangeSetError>;
