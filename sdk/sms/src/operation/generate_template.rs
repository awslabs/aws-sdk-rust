...
impl GenerateTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_template::GenerateTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_generate_template::de_generate_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::generate_template::GenerateTemplateError
{
