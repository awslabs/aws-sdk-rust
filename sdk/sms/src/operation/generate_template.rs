...
impl GenerateTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GenerateTemplate`](crate::operation::generate_template::GenerateTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_template::GenerateTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_template::GenerateTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_template::GenerateTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GenerateTemplate", "sms"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GenerateTemplate`.
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateTemplate {
                type Output = std::result::Result<crate::operation::generate_template::GenerateTemplateOutput, crate::operation::generate_template::GenerateTemplateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_generate_template::de_generate_template_http_error(response)
                     } else {
                        crate::protocol_serde::shape_generate_template::de_generate_template_http_response(response)
                     }
                }
            }
