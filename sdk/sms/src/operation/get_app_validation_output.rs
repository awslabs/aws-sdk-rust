...
/// Orchestration and serialization glue logic for `GetAppValidationOutput`.
...
impl GetAppValidationOutput {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_app_validation_output::GetAppValidationOutputOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_app_validation_output::GetAppValidationOutputError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_app_validation_output::GetAppValidationOutputError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_app_validation_output::GetAppValidationOutputOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAppValidationOutput {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAppValidationOutput");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAppValidationOutputRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAppValidationOutputResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAppValidationOutput")
...
.with_interceptor(GetAppValidationOutputEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_app_validation_output::GetAppValidationOutputError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_app_validation_output::GetAppValidationOutputError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_app_validation_output::GetAppValidationOutputError>::new());
...
#[derive(Debug)]
            struct GetAppValidationOutputResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAppValidationOutputResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_app_validation_output::de_get_app_validation_output_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetAppValidationOutputRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAppValidationOutputRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_app_validation_output::GetAppValidationOutputInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_app_validation_output::GetAppValidationOutputInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_app_validation_output::ser_get_app_validation_output_input(&input)?);
...
#[derive(Debug)]
            struct GetAppValidationOutputEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAppValidationOutputEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAppValidationOutputEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAppValidationOutputInput>()
                        .ok_or("failed to downcast to GetAppValidationOutputInput")?;
...
pub enum GetAppValidationOutputError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAppValidationOutputError) for what information is available for the error.")]
...
impl GetAppValidationOutputError {
    /// Creates the `GetAppValidationOutputError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAppValidationOutputError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAppValidationOutputError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_app_validation_output::GetAppValidationOutputError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_app_validation_output::_get_app_validation_output_output::GetAppValidationOutputOutput;

pub use crate::operation::get_app_validation_output::_get_app_validation_output_input::GetAppValidationOutputInput;

mod _get_app_validation_output_input;

mod _get_app_validation_output_output;
