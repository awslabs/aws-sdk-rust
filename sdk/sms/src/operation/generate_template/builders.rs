...
pub use crate::operation::generate_template::_generate_template_output::GenerateTemplateOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::generate_template::GenerateTemplateOutput,
                    crate::operation::generate_template::GenerateTemplateError,
                > for GenerateTemplateFluentBuilder
            {
                fn send(
                    self,
...
impl GenerateTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::generate_template::GenerateTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_template::GenerateTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::generate_template::GenerateTemplate::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::generate_template::GenerateTemplate::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::generate_template::GenerateTemplateOutput, crate::operation::generate_template::GenerateTemplateError, Self> {
