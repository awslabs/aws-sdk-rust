...
impl StartOnDemandReplicationRun {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("sms", "StartOnDemandReplicationRun", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartOnDemandReplicationRun {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartOnDemandReplicationRunRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartOnDemandReplicationRunResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartOnDemandReplicationRun", "sms"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartOnDemandReplicationRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_on_demand_replication_run::ser_start_on_demand_replication_run_input(&input)?,
        );
...
impl ::std::error::Error for StartOnDemandReplicationRunError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::ReplicationRunLimitExceededException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartOnDemandReplicationRunError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ReplicationRunLimitExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
