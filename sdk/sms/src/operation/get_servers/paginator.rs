...
impl GetServersPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Server, ::aws_smithy_http::result::SdkError<crate::operation::get_servers::GetServersError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_servers_output_server_list(page).unwrap_or_default().into_iter())
    }
}
