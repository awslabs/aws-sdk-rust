...
impl TerminateAppInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::terminate_app::TerminateApp,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::terminate_app::TerminateApp::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for TerminateApp {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_terminate_app::de_terminate_app_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_terminate_app::de_terminate_app_http_response_with_props(
                status, headers, body,
            )
        }
    }
