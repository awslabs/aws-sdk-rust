...
impl NotifyAppValidationOutputInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::notify_app_validation_output::NotifyAppValidationOutputInput, ::aws_smithy_types::error::operation::BuildError> {
