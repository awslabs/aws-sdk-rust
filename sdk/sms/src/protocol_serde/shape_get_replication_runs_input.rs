...
pub fn ser_get_replication_runs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetReplicationRunsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
