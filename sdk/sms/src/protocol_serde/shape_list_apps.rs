...
pub fn de_list_apps_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_apps::ListAppsOutput, crate::operation::list_apps::ListAppsError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::list_apps::builders::ListAppsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "apps" => {
                    builder = builder.set_apps(crate::protocol_serde::shape_apps::de_apps(tokens)?);
                }
                "nextToken" => {
