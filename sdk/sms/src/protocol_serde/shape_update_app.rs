...
pub fn de_update_app_http_error(
    ...
    Err(match error_code {
        ...
        "MissingRequiredParameterException" => {
            crate::error::UpdateAppError::MissingRequiredParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "OperationNotPermittedException" => {
            crate::error::UpdateAppError::OperationNotPermittedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnauthorizedOperationException" => {
            crate::error::UpdateAppError::UnauthorizedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
