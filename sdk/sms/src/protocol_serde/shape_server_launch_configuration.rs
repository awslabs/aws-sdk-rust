...
pub fn ser_server_launch_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServerLaunchConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_server_launch_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServerLaunchConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
