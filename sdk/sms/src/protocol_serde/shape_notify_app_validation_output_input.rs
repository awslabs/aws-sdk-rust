...
pub fn ser_notify_app_validation_output_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::NotifyAppValidationOutputInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
