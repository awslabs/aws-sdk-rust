...
pub fn de_create_replication_job_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_replication_job::CreateReplicationJobOutput, crate::operation::create_replication_job::CreateReplicationJobError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_replication_job_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_replication_job::CreateReplicationJobOutput, crate::operation::create_replication_job::CreateReplicationJobError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_create_replication_job_input(input: &crate::operation::create_replication_job::CreateReplicationJobInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_create_replication_job_input::ser_create_replication_job_input_input(&mut object, input)?;
    object.finish();
