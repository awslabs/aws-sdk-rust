...
pub(crate) fn de_apps<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::AppSummary>>, aws_smithy_json::deserialize::error::DeserializeError>
