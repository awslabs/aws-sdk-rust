...
impl UpdateInstanceCustomHealthStatusInput {
    /// Consumes the builder and constructs an Operation<[`UpdateInstanceCustomHealthStatus`](crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_instance_custom_health_status::ser_update_instance_custom_health_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateInstanceCustomHealthStatus", "servicediscovery"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateInstanceCustomHealthStatus {
                type Output = std::result::Result<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusOutput, crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusError>;
