...
impl UpdateInstanceCustomHealthStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInstanceCustomHealthStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_instance_custom_health_status::de_update_instance_custom_health_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
