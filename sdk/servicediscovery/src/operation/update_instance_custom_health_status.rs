    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateInstanceCustomHealthStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateInstanceCustomHealthStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateInstanceCustomHealthStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateInstanceCustomHealthStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateInstanceCustomHealthStatus")
...
.with_interceptor(UpdateInstanceCustomHealthStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusError>::new());
...
#[derive(Debug)]
            struct UpdateInstanceCustomHealthStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateInstanceCustomHealthStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_instance_custom_health_status::de_update_instance_custom_health_status_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_instance_custom_health_status::de_update_instance_custom_health_status_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateInstanceCustomHealthStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateInstanceCustomHealthStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_instance_custom_health_status::ser_update_instance_custom_health_status_input(&input)?);
...
#[derive(Debug)]
            struct UpdateInstanceCustomHealthStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateInstanceCustomHealthStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateInstanceCustomHealthStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateInstanceCustomHealthStatusInput>()
                        .ok_or("failed to downcast to UpdateInstanceCustomHealthStatusInput")?;
...
pub enum UpdateInstanceCustomHealthStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateInstanceCustomHealthStatusError) for what information is available for the error.")]
...
impl UpdateInstanceCustomHealthStatusError {
    /// Creates the `UpdateInstanceCustomHealthStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateInstanceCustomHealthStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CustomHealthNotFound(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateInstanceCustomHealthStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_instance_custom_health_status::UpdateInstanceCustomHealthStatusError {
...
mod _update_instance_custom_health_status_output;
