...
impl ListNamespacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_namespaces::ListNamespaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_namespaces::ser_list_namespaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNamespaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_namespaces::de_list_namespaces_http_response_with_props(status, headers, body)
        }
    }
}
