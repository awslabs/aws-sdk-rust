...
impl ListNamespacesInput {
    /// Consumes the builder and constructs an Operation<[`ListNamespaces`](crate::operation::list_namespaces::ListNamespaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_namespaces::ListNamespaces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_namespaces::ListNamespacesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_namespaces::ser_list_namespaces_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_namespaces::ListNamespaces::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListNamespaces", "servicediscovery"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListNamespaces {
                type Output = std::result::Result<crate::operation::list_namespaces::ListNamespacesOutput, crate::operation::list_namespaces::ListNamespacesError>;
