...
impl DiscoverInstancesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_discover_instances::ser_discover_instances_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DiscoverInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_discover_instances::de_discover_instances_http_response_with_props(status, headers, body)
        }
    }
}
