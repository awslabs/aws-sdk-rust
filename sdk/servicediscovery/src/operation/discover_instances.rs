...
impl DiscoverInstancesInput {
    /// Consumes the builder and constructs an Operation<[`DiscoverInstances`](crate::operation::discover_instances::DiscoverInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::discover_instances::DiscoverInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::discover_instances::DiscoverInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_discover_instances::ser_discover_instances_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::discover_instances::DiscoverInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DiscoverInstances", "servicediscovery"));
...
impl aws_smithy_http::response::ParseStrictResponse for DiscoverInstances {
                type Output = std::result::Result<crate::operation::discover_instances::DiscoverInstancesOutput, crate::operation::discover_instances::DiscoverInstancesError>;
