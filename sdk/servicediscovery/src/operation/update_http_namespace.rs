...
impl UpdateHttpNamespaceInput {
    /// Consumes the builder and constructs an Operation<[`UpdateHttpNamespace`](crate::operation::update_http_namespace::UpdateHttpNamespace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_http_namespace::UpdateHttpNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_http_namespace::UpdateHttpNamespaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_http_namespace::ser_update_http_namespace_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_http_namespace::UpdateHttpNamespace::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateHttpNamespace", "servicediscovery"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateHttpNamespace {
                type Output = std::result::Result<crate::operation::update_http_namespace::UpdateHttpNamespaceOutput, crate::operation::update_http_namespace::UpdateHttpNamespaceError>;
