...
impl aws_smithy_http::response::ParseStrictResponse for UpdateHttpNamespace {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_http_namespace::de_update_http_namespace_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_http_namespace::de_update_http_namespace_http_response(response)
                     }
                }
            }
