...
impl GetInstanceFluentBuilder  {
    /// Creates a new `GetInstance`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_instance::GetInstance, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_instance::GetInstanceError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_instance::GetInstanceOutput, aws_smithy_http::result::SdkError<crate::operation::get_instance::GetInstanceError>>
                     {
