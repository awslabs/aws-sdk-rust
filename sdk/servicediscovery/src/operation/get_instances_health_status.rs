...
/// Orchestration and serialization glue logic for `GetInstancesHealthStatus`.
...
impl GetInstancesHealthStatus {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_instances_health_status::GetInstancesHealthStatusInput,
                    ) -> ::std::result::Result<crate::operation::get_instances_health_status::GetInstancesHealthStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_instances_health_status::GetInstancesHealthStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_instances_health_status::GetInstancesHealthStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_instances_health_status::GetInstancesHealthStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInstancesHealthStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetInstancesHealthStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetInstancesHealthStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetInstancesHealthStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInstancesHealthStatus")
...
.with_interceptor(GetInstancesHealthStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_instances_health_status::GetInstancesHealthStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_instances_health_status::GetInstancesHealthStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_instances_health_status::GetInstancesHealthStatusError>::new());
...
#[derive(Debug)]
            struct GetInstancesHealthStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstancesHealthStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_instances_health_status::de_get_instances_health_status_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_instances_health_status::de_get_instances_health_status_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetInstancesHealthStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstancesHealthStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_instances_health_status::GetInstancesHealthStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_instances_health_status::GetInstancesHealthStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_instances_health_status::ser_get_instances_health_status_input(&input)?);
...
#[derive(Debug)]
            struct GetInstancesHealthStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInstancesHealthStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetInstancesHealthStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetInstancesHealthStatusInput>()
                        .ok_or("failed to downcast to GetInstancesHealthStatusInput")?;
...
pub enum GetInstancesHealthStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetInstancesHealthStatusError) for what information is available for the error.")]
...
impl GetInstancesHealthStatusError {
    /// Creates the `GetInstancesHealthStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetInstancesHealthStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InstanceNotFound(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetInstancesHealthStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_instances_health_status::GetInstancesHealthStatusError {
...
mod _get_instances_health_status_output;
