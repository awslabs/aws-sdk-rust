...
impl GetInstancesHealthStatusInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_instances_health_status::GetInstancesHealthStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstancesHealthStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_instances_health_status::de_get_instances_health_status_http_response_with_props(status, headers, body)
        }
    }
}
