...
impl GetInstancesHealthStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetInstancesHealthStatus`](crate::operation::get_instances_health_status::GetInstancesHealthStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_instances_health_status::GetInstancesHealthStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instances_health_status::GetInstancesHealthStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instances_health_status::ser_get_instances_health_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_instances_health_status::GetInstancesHealthStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInstancesHealthStatus", "servicediscovery"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstancesHealthStatus {
                type Output = std::result::Result<crate::operation::get_instances_health_status::GetInstancesHealthStatusOutput, crate::operation::get_instances_health_status::GetInstancesHealthStatusError>;
