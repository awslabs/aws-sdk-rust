...
impl CreatePublicDnsNamespaceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_public_dns_namespace::CreatePublicDnsNamespace::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePublicDnsNamespace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_public_dns_namespace::de_create_public_dns_namespace_http_response_with_props(status, headers, body)
        }
    }
}
