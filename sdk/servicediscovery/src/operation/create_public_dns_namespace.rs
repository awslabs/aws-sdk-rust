...
impl CreatePublicDnsNamespaceInput {
    /// Consumes the builder and constructs an Operation<[`CreatePublicDnsNamespace`](crate::operation::create_public_dns_namespace::CreatePublicDnsNamespace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_public_dns_namespace::CreatePublicDnsNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_public_dns_namespace::CreatePublicDnsNamespaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_public_dns_namespace::ser_create_public_dns_namespace_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_public_dns_namespace::CreatePublicDnsNamespace::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePublicDnsNamespace", "servicediscovery"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePublicDnsNamespace {
                type Output = std::result::Result<crate::operation::create_public_dns_namespace::CreatePublicDnsNamespaceOutput, crate::operation::create_public_dns_namespace::CreatePublicDnsNamespaceError>;
