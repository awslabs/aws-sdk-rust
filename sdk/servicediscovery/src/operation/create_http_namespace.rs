...
impl CreateHttpNamespace {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_http_namespace::CreateHttpNamespaceInput,
                    ) -> ::std::result::Result<crate::operation::create_http_namespace::CreateHttpNamespaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_http_namespace::CreateHttpNamespaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_http_namespace::CreateHttpNamespaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_http_namespace::CreateHttpNamespaceOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_http_namespace::CreateHttpNamespaceInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateHttpNamespace {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateHttpNamespace");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateHttpNamespaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateHttpNamespaceResponseDeserializer));
...
.with_interceptor(CreateHttpNamespaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_http_namespace::CreateHttpNamespaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_http_namespace::CreateHttpNamespaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_http_namespace::CreateHttpNamespaceError>::new());
...
#[derive(Debug)]
            struct CreateHttpNamespaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateHttpNamespaceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_http_namespace::de_create_http_namespace_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_http_namespace::de_create_http_namespace_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateHttpNamespaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateHttpNamespaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_http_namespace::CreateHttpNamespaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_http_namespace::CreateHttpNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_http_namespace::ser_create_http_namespace_input(&input)?);
...
#[derive(Debug)]
            struct CreateHttpNamespaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateHttpNamespaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateHttpNamespaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateHttpNamespaceInput>()
                        .ok_or("failed to downcast to CreateHttpNamespaceInput")?;
...
pub enum CreateHttpNamespaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateHttpNamespaceError) for what information is available for the error.")]
...
impl CreateHttpNamespaceError {
    /// Creates the `CreateHttpNamespaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateHttpNamespaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateHttpNamespaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_http_namespace::CreateHttpNamespaceError {
...
mod _create_http_namespace_output;
