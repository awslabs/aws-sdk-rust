...
impl CreateHttpNamespaceInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_http_namespace::ser_create_http_namespace_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_http_namespace::CreateHttpNamespace::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_http_namespace::CreateHttpNamespaceError
{
