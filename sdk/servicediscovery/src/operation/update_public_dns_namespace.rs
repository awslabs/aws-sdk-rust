...
impl UpdatePublicDnsNamespace {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdatePublicDnsNamespace {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdatePublicDnsNamespace");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdatePublicDnsNamespaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdatePublicDnsNamespaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdatePublicDnsNamespace")
...
.with_interceptor(UpdatePublicDnsNamespaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceError>::new());
...
#[derive(Debug)]
            struct UpdatePublicDnsNamespaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdatePublicDnsNamespaceResponseDeserializer {
...
#[derive(Debug)]
            struct UpdatePublicDnsNamespaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdatePublicDnsNamespaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_public_dns_namespace::ser_update_public_dns_namespace_input(&input)?);
...
#[derive(Debug)]
            struct UpdatePublicDnsNamespaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdatePublicDnsNamespaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdatePublicDnsNamespaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdatePublicDnsNamespaceInput>()
                        .ok_or("failed to downcast to UpdatePublicDnsNamespaceInput")?;
...
pub enum UpdatePublicDnsNamespaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdatePublicDnsNamespaceError) for what information is available for the error.")]
...
impl UpdatePublicDnsNamespaceError {
    /// Creates the `UpdatePublicDnsNamespaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdatePublicDnsNamespaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdatePublicDnsNamespaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceError {
