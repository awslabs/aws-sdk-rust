...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateServiceError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ServiceAlreadyExists(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::std::error::Error for CreateServiceError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::ServiceAlreadyExists(_inner) => ::std::option::Option::Some(_inner),
