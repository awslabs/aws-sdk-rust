...
impl CreateHttpNamespaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_http_namespace::CreateHttpNamespaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_http_namespace::CreateHttpNamespaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_http_namespace::CreateHttpNamespaceOutput, crate::operation::create_http_namespace::CreateHttpNamespaceError, Self> {
