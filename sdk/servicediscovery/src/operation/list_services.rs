...
impl ListServicesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_services::ListServices, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_services::ser_list_services_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_services::de_list_services_http_response_with_props(status, headers, body)
        }
    }
}
