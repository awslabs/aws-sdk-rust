...
pub mod create_http_namespace_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateHttpNamespaceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateHttpNamespaceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateHttpNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::CreateHttpNamespaceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod create_private_dns_namespace_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreatePrivateDnsNamespaceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreatePrivateDnsNamespaceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreatePrivateDnsNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::CreatePrivateDnsNamespaceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod create_public_dns_namespace_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreatePublicDnsNamespaceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreatePublicDnsNamespaceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreatePublicDnsNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::CreatePublicDnsNamespaceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod discover_instances_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DiscoverInstancesInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DiscoverInstancesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DiscoverInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DiscoverInstancesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_instance_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetInstanceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetInstanceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetInstanceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_instances_health_status_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetInstancesHealthStatusInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetInstancesHealthStatusInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetInstancesHealthStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetInstancesHealthStatusInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_operation_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetOperationInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetOperationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetOperation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetOperationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_http_namespace_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateHttpNamespaceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateHttpNamespaceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateHttpNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateHttpNamespaceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_instance_custom_health_status_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateInstanceCustomHealthStatusInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateInstanceCustomHealthStatusInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateInstanceCustomHealthStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateInstanceCustomHealthStatusInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_private_dns_namespace_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdatePrivateDnsNamespaceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdatePrivateDnsNamespaceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdatePrivateDnsNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::UpdatePrivateDnsNamespaceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_public_dns_namespace_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdatePublicDnsNamespaceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdatePublicDnsNamespaceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdatePublicDnsNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::UpdatePublicDnsNamespaceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
