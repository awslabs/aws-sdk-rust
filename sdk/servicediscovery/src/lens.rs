...
pub(crate) fn reflens_get_instances_health_status_output_output_next_token(
    input: &crate::operation::get_instances_health_status::GetInstancesHealthStatusOutput,
