...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_services::builders::ListServicesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::set_max_results): <p>The maximum number of services that you want Cloud Map to return in the response to a <code>ListServices</code> request. If you don't specify a value for <code>MaxResults</code>, Cloud Map returns up to 100 services.</p>
    ///   - [`filters(Vec<ServiceFilter>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::filters) / [`set_filters(Option<Vec<ServiceFilter>>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::set_filters): <p>A complex type that contains specifications for the namespaces that you want to list services for. </p>  <p>If you specify more than one filter, an operation must match all filters to be returned by <code>ListServices</code>.</p>
