...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_private_dns_namespace::builders::UpdatePrivateDnsNamespaceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_private_dns_namespace::builders::UpdatePrivateDnsNamespaceFluentBuilder::set_id):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the namespace that you want to update.</p><br>
