...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_id): <p>The ID of the service that you want to get settings for.</p>
