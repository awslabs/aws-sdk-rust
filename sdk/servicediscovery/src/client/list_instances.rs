...
impl super::Client {
    ...
    ///   - [`service_id(impl Into<String>)`](crate::operation::list_instances::builders::ListInstancesFluentBuilder::service_id) / [`set_service_id(Option<String>)`](crate::operation::list_instances::builders::ListInstancesFluentBuilder::set_service_id):<br>required: **true**<br><p>The ID of the service that you want to list instances for.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_instances::builders::ListInstancesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_instances::builders::ListInstancesFluentBuilder::set_next_token):<br>required: **false**<br><p>For the first <code>ListInstances</code> request, omit this value.</p> <p>If more than <code>MaxResults</code> instances match the specified criteria, you can submit another <code>ListInstances</code> request to get the next group of results. Specify the value of <code>NextToken</code> from the previous response in the next request.</p><br>
