...
impl super::Client {
    ...
    ///   - [`service_id(impl ::std::convert::Into<String>)`](crate::operation::deregister_instance::builders::DeregisterInstanceFluentBuilder::service_id) / [`set_service_id(Option<String>)`](crate::operation::deregister_instance::builders::DeregisterInstanceFluentBuilder::set_service_id): <p>The ID of the service that the instance is associated with.</p>
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::deregister_instance::builders::DeregisterInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::deregister_instance::builders::DeregisterInstanceFluentBuilder::set_instance_id): <p>The value that you specified for <code>Id</code> in the <a href="https://docs.aws.amazon.com/cloud-map/latest/api/API_RegisterInstance.html">RegisterInstance</a> request.</p>
