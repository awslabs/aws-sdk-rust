...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_id):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the service that you want to update. If the namespace associated with the service is shared with your Amazon Web Services account, specify the service ARN. For more information about shared namespaces, see <a href="https://docs.aws.amazon.com/cloud-map/latest/dg/sharing-namespaces.html">Cross-account Cloud Map namespace sharing</a> in the <i>Cloud Map Developer Guide</i></p><br>
    ///   - [`service(ServiceChange)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::service) / [`set_service(Option<ServiceChange>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_service):<br>required: **true**<br><p>A complex type that contains the new settings for the service. You can specify a maximum of 30 attributes (key-value pairs).</p><br>
