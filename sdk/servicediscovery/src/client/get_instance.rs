...
impl super::Client {
    ...
    ///   - [`service_id(impl ::std::convert::Into<String>)`](crate::operation::get_instance::builders::GetInstanceFluentBuilder::service_id) / [`set_service_id(Option<String>)`](crate::operation::get_instance::builders::GetInstanceFluentBuilder::set_service_id): <p>The ID of the service that the instance is associated with.</p>
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::get_instance::builders::GetInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::get_instance::builders::GetInstanceFluentBuilder::set_instance_id): <p>The ID of the instance that you want to get information about.</p>
