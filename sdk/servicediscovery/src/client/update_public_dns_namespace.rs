...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the namespace being updated.</p><br>
