...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::set_id):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the namespace being updated.</p><br>
    ///   - [`updater_request_id(impl Into<String>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::updater_request_id) / [`set_updater_request_id(Option<String>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::set_updater_request_id):<br>required: **false**<br><p>A unique string that identifies the request and that allows failed <code>UpdatePublicDnsNamespace</code> requests to be retried without the risk of running the operation twice. <code>UpdaterRequestId</code> can be any unique string (for example, a date/timestamp).</p><br>
    ///   - [`namespace(PublicDnsNamespaceChange)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::namespace) / [`set_namespace(Option<PublicDnsNamespaceChange>)`](crate::operation::update_public_dns_namespace::builders::UpdatePublicDnsNamespaceFluentBuilder::set_namespace):<br>required: **true**<br><p>Updated properties for the public DNS namespace.</p><br>
