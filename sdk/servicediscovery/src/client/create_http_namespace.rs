...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_http_namespace::builders::CreateHttpNamespaceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_http_namespace::builders::CreateHttpNamespaceFluentBuilder::set_name):<br>required: **true**<br><p>The name that you want to assign to this namespace.</p><br>
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_http_namespace::builders::CreateHttpNamespaceFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_http_namespace::builders::CreateHttpNamespaceFluentBuilder::set_description):<br>required: **false**<br><p>A description for the namespace.</p><br>
    ///   - [`tags(Tag)`](crate::operation::create_http_namespace::builders::CreateHttpNamespaceFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_http_namespace::builders::CreateHttpNamespaceFluentBuilder::set_tags):<br>required: **false**<br><p>The tags to add to the namespace. Each tag consists of a key and an optional value that you define. Tags keys can be up to 128 characters in length, and tag values can be up to 256 characters in length.</p><br>
