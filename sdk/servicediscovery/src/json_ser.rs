...
pub fn serialize_structure_create_http_namespace_input(
...
pub fn serialize_structure_create_private_dns_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_16) = &input.properties {
        ...
        crate::json_ser::serialize_structure_private_dns_namespace_properties(
            &mut object_17,
            var_16,
        );
        object_17.finish();
...
pub fn serialize_structure_create_public_dns_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_25) = &input.properties {
        ...
        crate::json_ser::serialize_structure_public_dns_namespace_properties(
            &mut object_26,
            var_25,
        );
        object_26.finish();
...
pub fn serialize_structure_create_service_input(
    ...
    if let Some(var_31) = &input.dns_config {
        ...
        crate::json_ser::serialize_structure_dns_config(&mut object_32, var_31);
        object_32.finish();
    }
    if let Some(var_33) = &input.health_check_config {
        let mut object_34 = object.key("HealthCheckConfig").start_object();
        crate::json_ser::serialize_structure_health_check_config(&mut object_34, var_33);
        object_34.finish();
    }
    if let Some(var_35) = &input.health_check_custom_config {
        let mut object_36 = object.key("HealthCheckCustomConfig").start_object();
        crate::json_ser::serialize_structure_health_check_custom_config(&mut object_36, var_35);
        object_36.finish();
    }
...
pub fn serialize_structure_delete_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deregister_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_discover_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_instances_health_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_namespaces_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_76 in var_74 {
            {
                ...
                crate::json_ser::serialize_structure_namespace_filter(&mut object_77, item_76);
                object_77.finish();
            }
        }
        array_75.finish();
...
pub fn serialize_structure_list_operations_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_82 in var_80 {
            {
                ...
                crate::json_ser::serialize_structure_operation_filter(&mut object_83, item_82);
                object_83.finish();
            }
        }
        array_81.finish();
        ...
        for item_88 in var_86 {
            {
                ...
                crate::json_ser::serialize_structure_service_filter(&mut object_89, item_88);
                object_89.finish();
            }
        }
        array_87.finish();
...
pub fn serialize_structure_register_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_101 in var_99 {
            {
                ...
                crate::json_ser::serialize_structure_tag(&mut object_102, item_101);
                object_102.finish();
            }
        }
        array_100.finish();
...
pub fn serialize_structure_update_http_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_109) = &input.namespace {
        ...
        crate::json_ser::serialize_structure_http_namespace_change(&mut object_110, var_109);
        object_110.finish();
    }
}

pub fn serialize_structure_update_instance_custom_health_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_private_dns_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_116) = &input.namespace {
        ...
        crate::json_ser::serialize_structure_private_dns_namespace_change(&mut object_117, var_116);
        object_117.finish();
    }
}

pub fn serialize_structure_update_public_dns_namespace_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_120) = &input.namespace {
        ...
        crate::json_ser::serialize_structure_public_dns_namespace_change(&mut object_121, var_120);
        object_121.finish();
    }
}
...
pub fn serialize_structure_update_service_input(
    ...
    if let Some(var_123) = &input.service {
        ...
        crate::json_ser::serialize_structure_service_change(&mut object_124, var_123);
        object_124.finish();
    }
}
...
pub fn serialize_structure_private_dns_namespace_properties(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_127) = &input.dns_properties {
        ...
        crate::json_ser::serialize_structure_private_dns_properties_mutable(
            &mut object_128,
            var_127,
        );
        object_128.finish();
...
pub fn serialize_structure_public_dns_namespace_properties(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_129) = &input.dns_properties {
        ...
        crate::json_ser::serialize_structure_public_dns_properties_mutable(
            &mut object_130,
            var_129,
        );
        object_130.finish();
...
pub fn serialize_structure_dns_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_135 in var_133 {
            {
                ...
                crate::json_ser::serialize_structure_dns_record(&mut object_136, item_135);
                object_136.finish();
            }
        }
        array_134.finish();
...
pub fn serialize_structure_health_check_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_health_check_custom_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_namespace_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_operation_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_service_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_http_namespace_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_private_dns_namespace_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_158) = &input.properties {
        ...
        crate::json_ser::serialize_structure_private_dns_namespace_properties_change(
            &mut object_159,
            var_158,
        );
        object_159.finish();
...
pub fn serialize_structure_public_dns_namespace_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_161) = &input.properties {
        ...
        crate::json_ser::serialize_structure_public_dns_namespace_properties_change(
            &mut object_162,
            var_161,
        );
        object_162.finish();
...
pub fn serialize_structure_service_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_164) = &input.dns_config {
        ...
        crate::json_ser::serialize_structure_dns_config_change(&mut object_165, var_164);
        object_165.finish();
    }
    if let Some(var_166) = &input.health_check_config {
        let mut object_167 = object.key("HealthCheckConfig").start_object();
        crate::json_ser::serialize_structure_health_check_config(&mut object_167, var_166);
        object_167.finish();
    }
}

pub fn serialize_structure_private_dns_properties_mutable(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::PrivateDnsPropertiesMutable,
) {
    if let Some(var_168) = &input.soa {
        let mut object_169 = object.key("SOA").start_object();
        crate::json_ser::serialize_structure_soa(&mut object_169, var_168);
        object_169.finish();
    }
}

pub fn serialize_structure_public_dns_properties_mutable(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::PublicDnsPropertiesMutable,
) {
    if let Some(var_170) = &input.soa {
        let mut object_171 = object.key("SOA").start_object();
        crate::json_ser::serialize_structure_soa(&mut object_171, var_170);
        object_171.finish();
    }
}

pub fn serialize_structure_dns_record(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_private_dns_namespace_properties_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_174) = &input.dns_properties {
        ...
        crate::json_ser::serialize_structure_private_dns_properties_mutable_change(
            &mut object_175,
            var_174,
        );
        object_175.finish();
...
pub fn serialize_structure_public_dns_namespace_properties_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_176) = &input.dns_properties {
        ...
        crate::json_ser::serialize_structure_public_dns_properties_mutable_change(
            &mut object_177,
            var_176,
        );
        object_177.finish();
...
pub fn serialize_structure_dns_config_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_180 in var_178 {
            {
                ...
                crate::json_ser::serialize_structure_dns_record(&mut object_181, item_180);
                object_181.finish();
            }
        }
        array_179.finish();
...
pub fn serialize_structure_soa(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_private_dns_properties_mutable_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_183) = &input.soa {
        ...
        crate::json_ser::serialize_structure_soa_change(&mut object_184, var_183);
        object_184.finish();
    }
}

pub fn serialize_structure_public_dns_properties_mutable_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_185) = &input.soa {
        ...
        crate::json_ser::serialize_structure_soa_change(&mut object_186, var_185);
        object_186.finish();
    }
}

pub fn serialize_structure_soa_change(
    object: &mut smithy_json::serialize::JsonObjectWriter,
