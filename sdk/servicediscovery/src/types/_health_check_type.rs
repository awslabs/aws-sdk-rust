...
impl ::std::convert::From<&str> for HealthCheckType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HealthCheckType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HealthCheckType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HealthCheckType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HealthCheckType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
