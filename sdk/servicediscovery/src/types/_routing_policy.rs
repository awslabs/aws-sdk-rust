...
impl ::std::convert::From<&str> for RoutingPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RoutingPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RoutingPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RoutingPolicy::from(s))
    }
}
impl RoutingPolicy {
...
impl ::std::convert::AsRef<str> for RoutingPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
