...
/// Operation shape for `CreateHttpNamespace`.
            ...
            /// [`create_http_namespace`](crate::client::fluent_builders::CreateHttpNamespace).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for CreateHttpNamespace {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_http_namespace::de_create_http_namespace_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_http_namespace::de_create_http_namespace_http_response(response)
                     }
                }
            }
...
/// Operation shape for `CreatePrivateDnsNamespace`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`create_private_dns_namespace`](crate::client::fluent_builders::CreatePrivateDnsNamespace).
            ///
...
/// Operation shape for `CreatePublicDnsNamespace`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`create_public_dns_namespace`](crate::client::fluent_builders::CreatePublicDnsNamespace).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterInstance {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_deregister_instance::de_deregister_instance_http_error(response)
                     } else {
                        crate::protocol_serde::shape_deregister_instance::de_deregister_instance_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DiscoverInstances`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`discover_instances`](crate::client::fluent_builders::DiscoverInstances).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DiscoverInstances {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_discover_instances::de_discover_instances_http_error(response)
                     } else {
                        crate::protocol_serde::shape_discover_instances::de_discover_instances_http_response(response)
                     }
                }
            }
...
/// Operation shape for `GetInstance`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_instance`](crate::client::fluent_builders::GetInstance).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstance {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_instance::de_get_instance_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_instance::de_get_instance_http_response(response)
                     }
                }
            }
...
/// Operation shape for `GetInstancesHealthStatus`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_instances_health_status`](crate::client::fluent_builders::GetInstancesHealthStatus).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterInstance {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_register_instance::de_register_instance_http_error(response)
                     } else {
                        crate::protocol_serde::shape_register_instance::de_register_instance_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UpdateHttpNamespace`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_http_namespace`](crate::client::fluent_builders::UpdateHttpNamespace).
            ///
...
/// Operation shape for `UpdateInstanceCustomHealthStatus`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_instance_custom_health_status`](crate::client::fluent_builders::UpdateInstanceCustomHealthStatus).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateInstanceCustomHealthStatus {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_instance_custom_health_status::de_update_instance_custom_health_status_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_instance_custom_health_status::de_update_instance_custom_health_status_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UpdatePrivateDnsNamespace`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_private_dns_namespace`](crate::client::fluent_builders::UpdatePrivateDnsNamespace).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for UpdatePrivateDnsNamespace {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_private_dns_namespace::de_update_private_dns_namespace_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_private_dns_namespace::de_update_private_dns_namespace_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UpdatePublicDnsNamespace`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_public_dns_namespace`](crate::client::fluent_builders::UpdatePublicDnsNamespace).
            ///
