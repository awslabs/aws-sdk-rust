...
pub struct RejectGrantOutput  {
    ...
    /// <p>Grant status.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::GrantStatus>,
    /// <p>Grant version.</p>
...
pub struct ListUsageForLicenseConfigurationOutput  {
    ...
    #[doc(hidden)]pub license_configuration_usage_list: std::option::Option<std::vec::Vec<crate::model::LicenseConfigurationUsage>>,
...
impl  std::fmt::Debug for ListUsageForLicenseConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("license_configuration_usage_list", &self.license_configuration_usage_list);
...
pub struct ListTokensOutput  {
    ...
    #[doc(hidden)]pub tokens: std::option::Option<std::vec::Vec<crate::model::TokenData>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListResourceInventoryOutput  {
    ...
    #[doc(hidden)]pub resource_inventory_list: std::option::Option<std::vec::Vec<crate::model::ResourceInventory>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListReceivedLicensesOutput  {
    ...
    #[doc(hidden)]pub licenses: std::option::Option<std::vec::Vec<crate::model::GrantedLicense>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListReceivedGrantsOutput  {
    ...
    #[doc(hidden)]pub grants: std::option::Option<std::vec::Vec<crate::model::Grant>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListLicenseVersionsOutput  {
    /// <p>License details.</p>
    #[doc(hidden)]pub licenses: std::option::Option<std::vec::Vec<crate::model::License>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListLicenseSpecificationsForResourceOutput  {
    ...
    #[doc(hidden)]pub license_specifications: std::option::Option<std::vec::Vec<crate::model::LicenseSpecification>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListLicenseManagerReportGeneratorsOutput  {
    ...
    #[doc(hidden)]pub report_generators: std::option::Option<std::vec::Vec<crate::model::ReportGenerator>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListLicenseConversionTasksOutput  {
    ...
    #[doc(hidden)]pub license_conversion_tasks: std::option::Option<std::vec::Vec<crate::model::LicenseConversionTask>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListLicenseConfigurationsOutput  {
    /// <p>Information about the license configurations.</p>
    #[doc(hidden)]pub license_configurations: std::option::Option<std::vec::Vec<crate::model::LicenseConfiguration>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListFailuresForLicenseConfigurationOperationsOutput  {
    ...
    #[doc(hidden)]pub license_operation_failure_list: std::option::Option<std::vec::Vec<crate::model::LicenseOperationFailure>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListFailuresForLicenseConfigurationOperationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("license_operation_failure_list", &self.license_operation_failure_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListAssociationsForLicenseConfigurationOutput  {
    ...
    #[doc(hidden)]pub license_configuration_associations: std::option::Option<std::vec::Vec<crate::model::LicenseConfigurationAssociation>>,
    /// <p>Token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListAssociationsForLicenseConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("license_configuration_associations", &self.license_configuration_associations);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetServiceSettingsOutput  {
    ...
    #[doc(hidden)]pub organization_configuration: std::option::Option<crate::model::OrganizationConfiguration>,
    /// <p>Indicates whether cross-account discovery is enabled.</p>
    #[doc(hidden)]pub enable_cross_accounts_discovery: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub license_manager_resource_share_arn: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetServiceSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("organization_configuration", &self.organization_configuration);
        formatter.field("enable_cross_accounts_discovery", &self.enable_cross_accounts_discovery);
        formatter.field("license_manager_resource_share_arn", &self.license_manager_resource_share_arn);
        formatter.finish()
    }
}
...
pub struct GetLicenseUsageOutput  {
    ...
    #[doc(hidden)]pub license_usage: std::option::Option<crate::model::LicenseUsage>,
}
...
pub struct GetLicenseManagerReportGeneratorOutput  {
    /// <p>A report generator that creates periodic reports about your license configurations.</p>
    #[doc(hidden)]pub report_generator: std::option::Option<crate::model::ReportGenerator>,
}
...
pub struct GetLicenseOutput  {
    /// <p>License details.</p>
    #[doc(hidden)]pub license: std::option::Option<crate::model::License>,
}
...
pub struct GetGrantOutput  {
    /// <p>Grant details.</p>
    #[doc(hidden)]pub grant: std::option::Option<crate::model::Grant>,
}
impl GetGrantOutput {
    /// <p>Grant details.</p>
...
pub struct ExtendLicenseConsumptionOutput  {
    ...
    #[doc(hidden)]pub license_consumption_token: std::option::Option<std::string::String>,
    /// <p>Date and time at which the license consumption expires.</p>
    #[doc(hidden)]pub expiration: std::option::Option<std::string::String>,
}
...
pub struct DeleteLicenseOutput  {
    /// <p>License status.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::LicenseDeletionStatus>,
    /// <p>Date when the license is deleted.</p>
    #[doc(hidden)]pub deletion_date: std::option::Option<std::string::String>,
}
...
pub struct CreateTokenOutput  {
    ...
    /// <p>Token type.</p>
    #[doc(hidden)]pub token_type: std::option::Option<crate::model::TokenType>,
...
pub struct CheckoutLicenseOutput  {
    /// <p>Checkout type.</p>
    #[doc(hidden)]pub checkout_type: std::option::Option<crate::model::CheckoutType>,
    /// <p>License consumption token.</p>
    #[doc(hidden)]pub license_consumption_token: std::option::Option<std::string::String>,
    /// <p>Allowed license entitlements.</p>
    #[doc(hidden)]pub entitlements_allowed: std::option::Option<std::vec::Vec<crate::model::EntitlementData>>,
    /// <p>Signed token.</p>
    #[doc(hidden)]pub signed_token: std::option::Option<std::string::String>,
    /// <p>Node ID.</p>
    #[doc(hidden)]pub node_id: std::option::Option<std::string::String>,
    /// <p>Date and time at which the license checkout is issued.</p>
    #[doc(hidden)]pub issued_at: std::option::Option<std::string::String>,
...
pub struct CheckoutBorrowLicenseOutput  {
    ...
    #[doc(hidden)]pub checkout_metadata: std::option::Option<std::vec::Vec<crate::model::Metadata>>,
}
