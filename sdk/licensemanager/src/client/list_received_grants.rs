...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_received_grants::builders::ListReceivedGrantsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_received_grants::builders::ListReceivedGrantsFluentBuilder::set_next_token): <p>Token for the next set of results.</p>
