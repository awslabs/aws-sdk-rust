...
impl super::Client  {
    ...
    pub fn create_license_manager_report_generator(&self) -> crate::client::fluent_builders::CreateLicenseManagerReportGenerator {
                                crate::client::fluent_builders::CreateLicenseManagerReportGenerator::new(self.handle.clone())
                            }
}
