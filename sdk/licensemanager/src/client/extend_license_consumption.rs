...
impl super::Client {
    ...
    ///   - [`license_consumption_token(impl Into<String>)`](crate::operation::extend_license_consumption::builders::ExtendLicenseConsumptionFluentBuilder::license_consumption_token) / [`set_license_consumption_token(Option<String>)`](crate::operation::extend_license_consumption::builders::ExtendLicenseConsumptionFluentBuilder::set_license_consumption_token):<br>required: **true**<br><p>License consumption token.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::extend_license_consumption::builders::ExtendLicenseConsumptionFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::extend_license_consumption::builders::ExtendLicenseConsumptionFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request. Provides an error response if you do not have the required permissions.</p><br>
