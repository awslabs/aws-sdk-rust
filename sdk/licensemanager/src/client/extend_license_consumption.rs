...
impl super::Client {
    ...
    ///   - [`license_consumption_token(impl ::std::convert::Into<String>)`](crate::operation::extend_license_consumption::builders::ExtendLicenseConsumptionFluentBuilder::license_consumption_token) / [`set_license_consumption_token(Option<String>)`](crate::operation::extend_license_consumption::builders::ExtendLicenseConsumptionFluentBuilder::set_license_consumption_token): <p>License consumption token.</p>
