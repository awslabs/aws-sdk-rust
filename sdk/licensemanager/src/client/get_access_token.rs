...
impl super::Client {
    ...
    ///   - [`token_properties(impl Into<String>)`](crate::operation::get_access_token::builders::GetAccessTokenFluentBuilder::token_properties) / [`set_token_properties(Option<Vec<String>>)`](crate::operation::get_access_token::builders::GetAccessTokenFluentBuilder::set_token_properties): <p>Token properties to validate against those present in the JWT token.</p>
