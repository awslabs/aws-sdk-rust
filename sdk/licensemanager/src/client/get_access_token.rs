...
impl super::Client {
    ...
    ///   - [`token(impl Into<String>)`](crate::operation::get_access_token::builders::GetAccessTokenFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::get_access_token::builders::GetAccessTokenFluentBuilder::set_token):<br>required: **true**<br><p>Refresh token, encoded as a JWT token.</p><br>
    ///   - [`token_properties(impl Into<String>)`](crate::operation::get_access_token::builders::GetAccessTokenFluentBuilder::token_properties) / [`set_token_properties(Option<Vec::<String>>)`](crate::operation::get_access_token::builders::GetAccessTokenFluentBuilder::set_token_properties):<br>required: **false**<br><p>Token properties to validate against those present in the JWT token.</p><br>
