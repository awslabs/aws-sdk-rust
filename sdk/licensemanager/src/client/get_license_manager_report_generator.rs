...
impl super::Client {
    ...
    ///   - [`license_manager_report_generator_arn(impl Into<String>)`](crate::operation::get_license_manager_report_generator::builders::GetLicenseManagerReportGeneratorFluentBuilder::license_manager_report_generator_arn) / [`set_license_manager_report_generator_arn(Option<String>)`](crate::operation::get_license_manager_report_generator::builders::GetLicenseManagerReportGeneratorFluentBuilder::set_license_manager_report_generator_arn):<br>required: **true**<br><p>Amazon Resource Name (ARN) of the report generator.</p><br>
