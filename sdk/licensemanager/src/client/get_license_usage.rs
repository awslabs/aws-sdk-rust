...
impl super::Client {
    ...
    ///   - [`license_arn(impl Into<String>)`](crate::operation::get_license_usage::builders::GetLicenseUsageFluentBuilder::license_arn) / [`set_license_arn(Option<String>)`](crate::operation::get_license_usage::builders::GetLicenseUsageFluentBuilder::set_license_arn):<br>required: **true**<br><p>Amazon Resource Name (ARN) of the license.</p><br>
