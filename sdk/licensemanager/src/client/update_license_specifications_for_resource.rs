...
impl super::Client  {
    ...
    pub fn update_license_specifications_for_resource(&self) -> crate::client::fluent_builders::UpdateLicenseSpecificationsForResource {
                                crate::client::fluent_builders::UpdateLicenseSpecificationsForResource::new(self.handle.clone())
                            }
}
