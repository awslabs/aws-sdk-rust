...
impl super::Client {
    ...
    ///   - [`token_id(impl Into<String>)`](crate::operation::delete_token::builders::DeleteTokenFluentBuilder::token_id) / [`set_token_id(Option<String>)`](crate::operation::delete_token::builders::DeleteTokenFluentBuilder::set_token_id):<br>required: **true**<br><p>Token ID.</p><br>
