...
impl super::Client  {
    ...
    pub fn create_license_conversion_task_for_resource(&self) -> crate::client::fluent_builders::CreateLicenseConversionTaskForResource {
                                crate::client::fluent_builders::CreateLicenseConversionTaskForResource::new(self.handle.clone())
                            }
}
