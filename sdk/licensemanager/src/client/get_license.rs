...
impl super::Client {
    ...
    ///   - [`license_arn(impl ::std::convert::Into<String>)`](crate::operation::get_license::builders::GetLicenseFluentBuilder::license_arn) / [`set_license_arn(Option<String>)`](crate::operation::get_license::builders::GetLicenseFluentBuilder::set_license_arn): <p>Amazon Resource Name (ARN) of the license.</p>
    ///   - [`version(impl ::std::convert::Into<String>)`](crate::operation::get_license::builders::GetLicenseFluentBuilder::version) / [`set_version(Option<String>)`](crate::operation::get_license::builders::GetLicenseFluentBuilder::set_version): <p>License version.</p>
