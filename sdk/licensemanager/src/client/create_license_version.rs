...
impl super::Client {
    ...
    ///   - [`license_arn(impl ::std::convert::Into<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::license_arn) / [`set_license_arn(Option<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::set_license_arn): <p>Amazon Resource Name (ARN) of the license.</p>
    ///   - [`license_name(impl ::std::convert::Into<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::license_name) / [`set_license_name(Option<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::set_license_name): <p>License name.</p>
    ///   - [`product_name(impl ::std::convert::Into<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::product_name) / [`set_product_name(Option<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::set_product_name): <p>Product name.</p>
    ...
    ///   - [`home_region(impl ::std::convert::Into<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::home_region) / [`set_home_region(Option<String>)`](crate::operation::create_license_version::builders::CreateLicenseVersionFluentBuilder::set_home_region): <p>Home Region of the license.</p>
