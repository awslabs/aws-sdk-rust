...
pub fn ser_list_tokens_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTokensInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
