...
pub fn ser_checkout_license_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CheckoutLicenseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
