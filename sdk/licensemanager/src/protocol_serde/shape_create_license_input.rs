...
pub fn ser_create_license_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLicenseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
