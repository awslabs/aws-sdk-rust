...
pub fn de_get_service_settings_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_service_settings::GetServiceSettingsOutput, crate::operation::get_service_settings::GetServiceSettingsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_service_settings_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_service_settings::GetServiceSettingsOutput, crate::operation::get_service_settings::GetServiceSettingsError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_get_service_settings_input(_input: &crate::operation::get_service_settings::GetServiceSettingsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
