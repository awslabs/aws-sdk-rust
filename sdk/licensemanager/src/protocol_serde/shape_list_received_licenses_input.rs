...
pub fn ser_list_received_licenses_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListReceivedLicensesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
