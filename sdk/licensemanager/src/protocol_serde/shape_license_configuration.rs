...
pub(crate) fn de_license_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LicenseConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
