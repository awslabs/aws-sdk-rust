                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "LicenseCountHardLimit" => {
                            builder =
                                builder.set_license_count_hard_limit(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "DisassociateWhenNotFound" => {
                            builder =
                                builder.set_disassociate_when_not_found(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "ConsumedLicenses" => {
