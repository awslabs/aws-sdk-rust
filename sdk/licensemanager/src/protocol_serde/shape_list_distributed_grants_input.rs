...
pub fn ser_list_distributed_grants_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_distributed_grants::ListDistributedGrantsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
