...
pub fn ser_list_license_manager_report_generators_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListLicenseManagerReportGeneratorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
