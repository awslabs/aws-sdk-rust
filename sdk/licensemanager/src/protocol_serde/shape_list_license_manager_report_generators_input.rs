...
pub fn ser_list_license_manager_report_generators_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
