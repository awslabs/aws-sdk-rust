...
) -> Result<Option<crate::types::ReportGenerator>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ReportType" => {
                            builder = builder.set_report_type(crate::protocol_serde::shape_report_type_list::de_report_type_list(tokens)?);
                        }
                        "ReportContext" => {
                            builder = builder.set_report_context(crate::protocol_serde::shape_report_context::de_report_context(tokens)?);
                        }
                        "ReportFrequency" => {
                            builder = builder.set_report_frequency(crate::protocol_serde::shape_report_frequency::de_report_frequency(tokens)?);
                        }
