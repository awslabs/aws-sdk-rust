...
pub(crate) fn de_metadata_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Metadata>>, aws_smithy_json::deserialize::error::DeserializeError>
