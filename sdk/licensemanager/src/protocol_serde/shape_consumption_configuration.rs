                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ProvisionalConfiguration" => {
                                builder = builder.set_provisional_configuration(
                                    crate::protocol_serde::shape_provisional_configuration::de_provisional_configuration(tokens, _value, depth + 1)?,
                                );
                            }
                            "BorrowConfiguration" => {
                                builder = builder.set_borrow_configuration(
                                    crate::protocol_serde::shape_borrow_configuration::de_borrow_configuration(tokens, _value, depth + 1)?,
                                );
                            }
