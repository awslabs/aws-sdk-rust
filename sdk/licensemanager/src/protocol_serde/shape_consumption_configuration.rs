...
pub fn ser_consumption_configuration(
    ...
    if let Some(var_2) = &input.provisional_configuration {
        ...
        crate::protocol_serde::shape_provisional_configuration::ser_provisional_configuration(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
    ...
    if let Some(var_4) = &input.borrow_configuration {
        ...
        crate::protocol_serde::shape_borrow_configuration::ser_borrow_configuration(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
...
pub(crate) fn de_consumption_configuration<'a, I>(
    ...
    Option<crate::types::ConsumptionConfiguration>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "RenewType" => {
                                builder = builder.set_renew_type(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::RenewType::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
