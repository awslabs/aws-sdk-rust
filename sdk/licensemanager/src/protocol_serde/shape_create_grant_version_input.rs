...
pub fn ser_create_grant_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGrantVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
