...
pub(crate) fn de_license_configurations<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::LicenseConfiguration>>, aws_smithy_json::deserialize::error::DeserializeError>
