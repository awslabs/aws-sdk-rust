...
pub fn ser_list_received_grants_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListReceivedGrantsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
