...
pub fn ser_list_received_licenses_for_organization_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListReceivedLicensesForOrganizationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
