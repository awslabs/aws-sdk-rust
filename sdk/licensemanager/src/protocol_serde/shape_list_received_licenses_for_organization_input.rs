...
pub fn ser_list_received_licenses_for_organization_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
