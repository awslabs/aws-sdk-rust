...
pub fn ser_list_licenses_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListLicensesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
