...
pub fn ser_update_license_manager_report_generator_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLicenseManagerReportGeneratorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
