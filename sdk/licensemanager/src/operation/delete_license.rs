...
impl DeleteLicenseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_license::DeleteLicense, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_license::ser_delete_license_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLicense {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_license::de_delete_license_http_response_with_props(status, headers, body)
        }
    }
}
