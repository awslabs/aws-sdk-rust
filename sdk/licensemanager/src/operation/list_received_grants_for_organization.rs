...
impl ListReceivedGrantsForOrganizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReceivedGrantsForOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_received_grants_for_organization::de_list_received_grants_for_organization_http_response_with_props(
                status, headers, body,
            )
        }
    }
