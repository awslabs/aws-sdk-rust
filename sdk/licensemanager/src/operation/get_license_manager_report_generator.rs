...
impl GetLicenseManagerReportGeneratorInput {
    /// Consumes the builder and constructs an Operation<[`GetLicenseManagerReportGenerator`](crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGenerator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGenerator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_license_manager_report_generator::ser_get_license_manager_report_generator_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGenerator::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLicenseManagerReportGenerator {
                type Output = std::result::Result<crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorOutput, crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorError>;
