...
impl GetLicenseManagerReportGenerator {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetLicenseManagerReportGenerator",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLicenseManagerReportGenerator {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetLicenseManagerReportGeneratorRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetLicenseManagerReportGeneratorResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetLicenseManagerReportGenerator")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLicenseManagerReportGenerator")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetLicenseManagerReportGeneratorTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetLicenseManagerReportGeneratorTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLicenseManagerReportGeneratorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetLicenseManagerReportGeneratorInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLicenseManagerReportGeneratorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_license_manager_report_generator::de_get_license_manager_report_generator_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_license_manager_report_generator::de_get_license_manager_report_generator_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLicenseManagerReportGeneratorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_license_manager_report_generator::GetLicenseManagerReportGeneratorInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_license_manager_report_generator::ser_get_license_manager_report_generator_input(&input)?,
        );
