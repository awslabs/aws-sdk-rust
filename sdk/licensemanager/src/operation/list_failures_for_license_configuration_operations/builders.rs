...
pub use crate::operation::list_failures_for_license_configuration_operations::_list_failures_for_license_configuration_operations_output::ListFailuresForLicenseConfigurationOperationsOutputBuilder;

pub use crate::operation::list_failures_for_license_configuration_operations::_list_failures_for_license_configuration_operations_input::ListFailuresForLicenseConfigurationOperationsInputBuilder;
...
pub struct ListFailuresForLicenseConfigurationOperationsFluentBuilder {
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsOutput,
                    crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsError,
                > for ListFailuresForLicenseConfigurationOperationsFluentBuilder
            {
                fn send(
                    self,
...
impl ListFailuresForLicenseConfigurationOperationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsOutput, crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsError, Self> {
