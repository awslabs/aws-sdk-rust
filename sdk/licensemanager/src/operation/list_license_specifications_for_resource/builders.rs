...
impl ListLicenseSpecificationsForResourceInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResourceOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResourceError, ::aws_smithy_http::operation::Response>>
