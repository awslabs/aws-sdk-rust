...
impl UpdateServiceSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateServiceSettings`](crate::operation::update_service_settings::UpdateServiceSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_service_settings::UpdateServiceSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_service_settings::UpdateServiceSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_service_settings::UpdateServiceSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateServiceSettings {
                type Output = std::result::Result<crate::operation::update_service_settings::UpdateServiceSettingsOutput, crate::operation::update_service_settings::UpdateServiceSettingsError>;
