...
impl DeleteToken {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("License Manager", "DeleteToken", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTokenTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("TokenId") {
            if let ::std::option::Option::Some(value) = input.token_id.as_deref() {
                captured.insert("TokenId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_token::ser_delete_token_input(&input)?);
