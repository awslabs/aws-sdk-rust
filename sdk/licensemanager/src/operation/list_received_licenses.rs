...
impl ListReceivedLicensesInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_licenses::ser_list_received_licenses_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_received_licenses::ListReceivedLicenses::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::list_received_licenses::ListReceivedLicensesError
{
