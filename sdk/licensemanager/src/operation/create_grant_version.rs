...
impl CreateGrantVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_grant_version::ser_create_grant_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGrantVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_grant_version::de_create_grant_version_http_response_with_props(status, headers, body)
        }
    }
}
