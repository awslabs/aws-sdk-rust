...
impl DeleteGrantInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_grant::DeleteGrant::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_grant::de_delete_grant_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_grant::de_delete_grant_http_response_with_props(
                status, headers, body,
            )
        }
    }
