...
impl DeleteGrantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_grant::DeleteGrant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_grant::ser_delete_grant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_grant::de_delete_grant_http_response_with_props(status, headers, body)
        }
    }
}
