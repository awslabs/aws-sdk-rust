...
impl AcceptGrantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::accept_grant::AcceptGrant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_accept_grant::ser_accept_grant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_grant::de_accept_grant_http_response_with_props(status, headers, body)
        }
    }
}
