...
/// Orchestration and serialization glue logic for `ListLicenseConfigurations`.
...
impl ListLicenseConfigurations {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_license_configurations::ListLicenseConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_license_configurations::ListLicenseConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_license_configurations::ListLicenseConfigurationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_license_configurations::ListLicenseConfigurationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListLicenseConfigurations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListLicenseConfigurations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListLicenseConfigurationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListLicenseConfigurationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListLicenseConfigurations")
...
.with_interceptor(ListLicenseConfigurationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_license_configurations::ListLicenseConfigurationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_license_configurations::ListLicenseConfigurationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_license_configurations::ListLicenseConfigurationsError>::new());
...
#[derive(Debug)]
            struct ListLicenseConfigurationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListLicenseConfigurationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_license_configurations::de_list_license_configurations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_license_configurations::de_list_license_configurations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListLicenseConfigurationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListLicenseConfigurationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_license_configurations::ListLicenseConfigurationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_license_configurations::ListLicenseConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_license_configurations::ser_list_license_configurations_input(&input)?);
...
#[derive(Debug)]
            struct ListLicenseConfigurationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListLicenseConfigurationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListLicenseConfigurationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListLicenseConfigurationsInput>()
                        .ok_or("failed to downcast to ListLicenseConfigurationsInput")?;
...
pub enum ListLicenseConfigurationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListLicenseConfigurationsError) for what information is available for the error.")]
...
impl ListLicenseConfigurationsError {
    /// Creates the `ListLicenseConfigurationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListLicenseConfigurationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListLicenseConfigurationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_license_configurations::ListLicenseConfigurationsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_license_configurations::_list_license_configurations_output::ListLicenseConfigurationsOutput;

pub use crate::operation::list_license_configurations::_list_license_configurations_input::ListLicenseConfigurationsInput;

mod _list_license_configurations_input;

mod _list_license_configurations_output;
