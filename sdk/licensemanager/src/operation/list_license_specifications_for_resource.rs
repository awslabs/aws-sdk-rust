...
impl ListLicenseSpecificationsForResourceInput {
    /// Consumes the builder and constructs an Operation<[`ListLicenseSpecificationsForResource`](crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_license_specifications_for_resource::ser_list_license_specifications_for_resource_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListLicenseSpecificationsForResource {
                type Output = std::result::Result<crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResourceOutput, crate::operation::list_license_specifications_for_resource::ListLicenseSpecificationsForResourceError>;
