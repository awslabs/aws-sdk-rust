...
impl ListResourceInventoryInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceInventory`](crate::operation::list_resource_inventory::ListResourceInventory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_resource_inventory::ListResourceInventory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_inventory::ListResourceInventoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resource_inventory::ser_list_resource_inventory_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_inventory::ListResourceInventory::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListResourceInventory {
                type Output = std::result::Result<crate::operation::list_resource_inventory::ListResourceInventoryOutput, crate::operation::list_resource_inventory::ListResourceInventoryError>;
