...
/// Orchestration and serialization glue logic for `ListResourceInventory`.
...
impl ListResourceInventory {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_resource_inventory::ListResourceInventoryInput,
                    ) -> ::std::result::Result<crate::operation::list_resource_inventory::ListResourceInventoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_inventory::ListResourceInventoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_resource_inventory::ListResourceInventoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_resource_inventory::ListResourceInventoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListResourceInventory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListResourceInventory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListResourceInventoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListResourceInventoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListResourceInventory")
...
.with_interceptor(ListResourceInventoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_resource_inventory::ListResourceInventoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_resource_inventory::ListResourceInventoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_resource_inventory::ListResourceInventoryError>::new());
...
#[derive(Debug)]
            struct ListResourceInventoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceInventoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_resource_inventory::de_list_resource_inventory_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_resource_inventory::de_list_resource_inventory_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListResourceInventoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceInventoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_resource_inventory::ListResourceInventoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_resource_inventory::ListResourceInventoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_resource_inventory::ser_list_resource_inventory_input(&input)?);
...
#[derive(Debug)]
            struct ListResourceInventoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListResourceInventoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListResourceInventoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListResourceInventoryInput>()
                        .ok_or("failed to downcast to ListResourceInventoryInput")?;
...
pub enum ListResourceInventoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListResourceInventoryError) for what information is available for the error.")]
...
impl ListResourceInventoryError {
    /// Creates the `ListResourceInventoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListResourceInventoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListResourceInventoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_resource_inventory::ListResourceInventoryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_resource_inventory::_list_resource_inventory_output::ListResourceInventoryOutput;

pub use crate::operation::list_resource_inventory::_list_resource_inventory_input::ListResourceInventoryInput;

mod _list_resource_inventory_input;

mod _list_resource_inventory_output;
