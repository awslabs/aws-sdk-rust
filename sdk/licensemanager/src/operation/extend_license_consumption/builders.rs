...
pub use crate::operation::extend_license_consumption::_extend_license_consumption_output::ExtendLicenseConsumptionOutputBuilder;
...
impl ExtendLicenseConsumptionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::extend_license_consumption::ExtendLicenseConsumptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::extend_license_consumption::ExtendLicenseConsumption::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::extend_license_consumption::ExtendLicenseConsumption::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::extend_license_consumption::ExtendLicenseConsumptionOutput, crate::operation::extend_license_consumption::ExtendLicenseConsumptionError, Self> {
