...
impl ListFailuresForLicenseConfigurationOperations {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListFailuresForLicenseConfigurationOperations",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFailuresForLicenseConfigurationOperations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListFailuresForLicenseConfigurationOperationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListFailuresForLicenseConfigurationOperationsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListFailuresForLicenseConfigurationOperations")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListFailuresForLicenseConfigurationOperations")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    ListFailuresForLicenseConfigurationOperationsTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListFailuresForLicenseConfigurationOperationsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFailuresForLicenseConfigurationOperationsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListFailuresForLicenseConfigurationOperationsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFailuresForLicenseConfigurationOperationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_failures_for_license_configuration_operations::de_list_failures_for_license_configuration_operations_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_failures_for_license_configuration_operations::de_list_failures_for_license_configuration_operations_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFailuresForLicenseConfigurationOperationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsInput>()
            .expect("correct type");
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsError
{
