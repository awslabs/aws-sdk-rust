...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListFailuresForLicenseConfigurationOperationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListFailuresForLicenseConfigurationOperationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_failures_for_license_configuration_operations::ser_list_failures_for_license_configuration_operations_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListFailuresForLicenseConfigurationOperationsEndpointParamsInterceptor {
