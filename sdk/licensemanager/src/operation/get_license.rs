...
impl GetLicenseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_license::GetLicense, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_license::ser_get_license_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLicense {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_license::de_get_license_http_response_with_props(status, headers, body)
        }
    }
}
