...
impl aws_smithy_http::response::ParseStrictResponse for UpdateLicenseSpecificationsForResource {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_license_specifications_for_resource::de_update_license_specifications_for_resource_http_response_with_props(status, headers, body)
        }
    }
}
