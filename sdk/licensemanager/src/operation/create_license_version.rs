...
impl CreateLicenseVersionInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_license_version::ser_create_license_version_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_license_version::CreateLicenseVersion::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_license_version::CreateLicenseVersionError
{
