...
impl ListLicenseConversionTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_license_conversion_tasks::ListLicenseConversionTasks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLicenseConversionTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_license_conversion_tasks::de_list_license_conversion_tasks_http_response_with_props(
                status, headers, body,
            )
        }
    }
