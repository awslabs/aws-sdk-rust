...
impl UpdateLicenseManagerReportGeneratorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGeneratorInput, ::aws_smithy_types::error::operation::BuildError> {
