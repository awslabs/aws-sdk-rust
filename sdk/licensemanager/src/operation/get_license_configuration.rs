...
impl GetLicenseConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetLicenseConfiguration`](crate::operation::get_license_configuration::GetLicenseConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_license_configuration::GetLicenseConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_license_configuration::GetLicenseConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_license_configuration::ser_get_license_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_license_configuration::GetLicenseConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLicenseConfiguration {
                type Output = std::result::Result<crate::operation::get_license_configuration::GetLicenseConfigurationOutput, crate::operation::get_license_configuration::GetLicenseConfigurationError>;
