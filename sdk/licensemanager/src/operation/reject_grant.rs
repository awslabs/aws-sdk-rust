...
impl RejectGrantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reject_grant::RejectGrant,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reject_grant::RejectGrant::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reject_grant::de_reject_grant_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_reject_grant::de_reject_grant_http_response_with_props(
                status, headers, body,
            )
        }
    }
