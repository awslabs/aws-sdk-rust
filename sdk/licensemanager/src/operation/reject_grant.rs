...
impl RejectGrantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reject_grant::RejectGrant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reject_grant::ser_reject_grant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_grant::de_reject_grant_http_response_with_props(status, headers, body)
        }
    }
}
