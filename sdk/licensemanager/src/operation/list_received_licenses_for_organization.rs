...
impl ListReceivedLicensesForOrganizationInput {
    /// Consumes the builder and constructs an Operation<[`ListReceivedLicensesForOrganization`](crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        assert_ne!(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_licenses_for_organization::ser_list_received_licenses_for_organization_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganization::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReceivedLicensesForOrganization {
    type Output = ::std::result::Result<crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationOutput, crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_received_licenses_for_organization::de_list_received_licenses_for_organization_http_response_with_props(status, headers, body)
        }
    }
}
