...
impl ListReceivedLicensesForOrganization {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListReceivedLicensesForOrganization",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListReceivedLicensesForOrganization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListReceivedLicensesForOrganizationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListReceivedLicensesForOrganizationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListReceivedLicensesForOrganization")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListReceivedLicensesForOrganization")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListReceivedLicensesForOrganizationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListReceivedLicensesForOrganizationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListReceivedLicensesForOrganizationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListReceivedLicensesForOrganizationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListReceivedLicensesForOrganizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_received_licenses_for_organization::de_list_received_licenses_for_organization_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_received_licenses_for_organization::de_list_received_licenses_for_organization_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListReceivedLicensesForOrganizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_licenses_for_organization::ser_list_received_licenses_for_organization_input(&input)?,
        );
