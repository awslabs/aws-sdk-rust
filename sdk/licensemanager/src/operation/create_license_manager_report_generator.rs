...
impl CreateLicenseManagerReportGeneratorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGenerator,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGenerator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLicenseManagerReportGenerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_license_manager_report_generator::de_create_license_manager_report_generator_http_response_with_props(
                status, headers, body,
            )
        }
    }
