...
/// Orchestration and serialization glue logic for `CreateLicenseManagerReportGenerator`.
...
impl CreateLicenseManagerReportGenerator {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLicenseManagerReportGenerator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLicenseManagerReportGenerator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLicenseManagerReportGeneratorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLicenseManagerReportGeneratorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLicenseManagerReportGenerator")
...
.with_interceptor(CreateLicenseManagerReportGeneratorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorError>::new());
...
#[derive(Debug)]
            struct CreateLicenseManagerReportGeneratorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLicenseManagerReportGeneratorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_license_manager_report_generator::de_create_license_manager_report_generator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_license_manager_report_generator::de_create_license_manager_report_generator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLicenseManagerReportGeneratorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLicenseManagerReportGeneratorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_license_manager_report_generator::ser_create_license_manager_report_generator_input(&input)?);
...
#[derive(Debug)]
            struct CreateLicenseManagerReportGeneratorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLicenseManagerReportGeneratorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLicenseManagerReportGeneratorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLicenseManagerReportGeneratorInput>()
                        .ok_or("failed to downcast to CreateLicenseManagerReportGeneratorInput")?;
...
pub enum CreateLicenseManagerReportGeneratorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLicenseManagerReportGeneratorError) for what information is available for the error.")]
...
impl CreateLicenseManagerReportGeneratorError {
    /// Creates the `CreateLicenseManagerReportGeneratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLicenseManagerReportGeneratorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLicenseManagerReportGeneratorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_license_manager_report_generator::CreateLicenseManagerReportGeneratorError {
...
mod _create_license_manager_report_generator_output;
