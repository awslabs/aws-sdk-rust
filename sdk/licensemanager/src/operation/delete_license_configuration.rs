...
/// Orchestration and serialization glue logic for `DeleteLicenseConfiguration`.
...
impl DeleteLicenseConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_license_configuration::DeleteLicenseConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::delete_license_configuration::DeleteLicenseConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_license_configuration::DeleteLicenseConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_license_configuration::DeleteLicenseConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_license_configuration::DeleteLicenseConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLicenseConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteLicenseConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteLicenseConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteLicenseConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteLicenseConfiguration")
...
.with_interceptor(DeleteLicenseConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_license_configuration::DeleteLicenseConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_license_configuration::DeleteLicenseConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_license_configuration::DeleteLicenseConfigurationError>::new());
...
#[derive(Debug)]
            struct DeleteLicenseConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteLicenseConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_license_configuration::de_delete_license_configuration_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteLicenseConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLicenseConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_license_configuration::DeleteLicenseConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_license_configuration::DeleteLicenseConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_license_configuration::ser_delete_license_configuration_input(&input)?);
...
#[derive(Debug)]
            struct DeleteLicenseConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteLicenseConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteLicenseConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteLicenseConfigurationInput>()
                        .ok_or("failed to downcast to DeleteLicenseConfigurationInput")?;
...
pub enum DeleteLicenseConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteLicenseConfigurationError) for what information is available for the error.")]
...
impl DeleteLicenseConfigurationError {
    /// Creates the `DeleteLicenseConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteLicenseConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteLicenseConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_license_configuration::DeleteLicenseConfigurationError {
...
mod _delete_license_configuration_output;
