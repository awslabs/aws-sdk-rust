...
impl DeleteLicenseConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_license_configuration::DeleteLicenseConfiguration,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_license_configuration::DeleteLicenseConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLicenseConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_license_configuration::de_delete_license_configuration_http_response_with_props(status, headers, body)
        }
    }
}
