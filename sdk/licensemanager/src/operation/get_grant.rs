...
impl GetGrantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_grant::GetGrant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_grant::ser_get_grant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_grant::de_get_grant_http_response_with_props(status, headers, body)
        }
    }
}
