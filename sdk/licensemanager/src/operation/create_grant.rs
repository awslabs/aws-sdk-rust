...
impl CreateGrant {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("License Manager", "CreateGrant", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateGrantTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("GrantName") {
            if let ::std::option::Option::Some(value) = input.grant_name.as_deref() {
                captured.insert("GrantName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateGrantResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_grant::de_create_grant_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_grant::de_create_grant_http_response(status, headers, body, _cfg)
        };
