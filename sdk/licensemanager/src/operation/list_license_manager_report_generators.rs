...
impl ListLicenseManagerReportGeneratorsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGenerators::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLicenseManagerReportGenerators {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_license_manager_report_generators::de_list_license_manager_report_generators_http_response_with_props(
                status, headers, body,
            )
        }
    }
