...
impl CheckoutLicenseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::checkout_license::CheckoutLicenseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::checkout_license::CheckoutLicenseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::checkout_license::CheckoutLicenseOutput, crate::operation::checkout_license::CheckoutLicenseError, Self> {
