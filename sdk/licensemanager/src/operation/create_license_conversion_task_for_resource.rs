    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLicenseConversionTaskForResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLicenseConversionTaskForResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLicenseConversionTaskForResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLicenseConversionTaskForResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLicenseConversionTaskForResource")
...
.with_interceptor(CreateLicenseConversionTaskForResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError>::new());
...
#[derive(Debug)]
            struct CreateLicenseConversionTaskForResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLicenseConversionTaskForResourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_create_license_conversion_task_for_resource::de_create_license_conversion_task_for_resource_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLicenseConversionTaskForResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLicenseConversionTaskForResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_license_conversion_task_for_resource::ser_create_license_conversion_task_for_resource_input(&input)?);
...
#[derive(Debug)]
            struct CreateLicenseConversionTaskForResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLicenseConversionTaskForResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLicenseConversionTaskForResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLicenseConversionTaskForResourceInput>()
                        .ok_or("failed to downcast to CreateLicenseConversionTaskForResourceInput")?;
...
pub enum CreateLicenseConversionTaskForResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLicenseConversionTaskForResourceError) for what information is available for the error.")]
...
impl CreateLicenseConversionTaskForResourceError {
    /// Creates the `CreateLicenseConversionTaskForResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLicenseConversionTaskForResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLicenseConversionTaskForResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError {
