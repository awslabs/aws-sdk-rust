...
impl GetLicenseUsageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_license_usage::GetLicenseUsage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_license_usage::ser_get_license_usage_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLicenseUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_license_usage::de_get_license_usage_http_response_with_props(status, headers, body)
        }
    }
}
