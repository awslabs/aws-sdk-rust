...
impl GetLicenseUsageInput {
    /// Consumes the builder and constructs an Operation<[`GetLicenseUsage`](crate::operation::get_license_usage::GetLicenseUsage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_license_usage::GetLicenseUsage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_license_usage::GetLicenseUsageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_license_usage::ser_get_license_usage_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_license_usage::GetLicenseUsage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLicenseUsage {
                type Output = std::result::Result<crate::operation::get_license_usage::GetLicenseUsageOutput, crate::operation::get_license_usage::GetLicenseUsageError>;
