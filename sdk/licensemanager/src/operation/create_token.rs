...
impl CreateToken {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_token::CreateTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_token::CreateTokenOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("License Manager", "CreateToken", input, runtime_plugins, stop_point)
...
#[derive(Debug)]
struct CreateTokenTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTokenTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateTokenInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("LicenseArn") {
            if let ::std::option::Option::Some(value) = input.license_arn.as_deref() {
                captured.insert("LicenseArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_token::de_create_token_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_token::de_create_token_http_response(status, headers, body, _cfg)
        };
