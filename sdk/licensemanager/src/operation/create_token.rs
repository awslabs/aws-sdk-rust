...
impl CreateTokenInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_token::CreateToken, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_token::ser_create_token_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_token::de_create_token_http_response_with_props(status, headers, body)
        }
    }
}
