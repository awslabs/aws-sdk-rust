...
impl CheckoutLicenseInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::checkout_license::CheckoutLicense::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckoutLicense {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_checkout_license::de_checkout_license_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::checkout_license::CheckoutLicenseError
{
