...
impl CheckoutLicenseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::checkout_license::CheckoutLicense, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_checkout_license::ser_checkout_license_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckoutLicense {
    type Output =
        ::std::result::Result<crate::operation::checkout_license::CheckoutLicenseOutput, crate::operation::checkout_license::CheckoutLicenseError>;
