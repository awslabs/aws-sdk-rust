...
impl ListLicensesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_licenses::ListLicenses, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_licenses::ser_list_licenses_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLicenses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_licenses::de_list_licenses_http_response_with_props(status, headers, body)
        }
    }
}
