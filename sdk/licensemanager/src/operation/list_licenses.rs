...
impl ListLicensesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_licenses::ListLicenses,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_licenses::ListLicenses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLicenses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_licenses::de_list_licenses_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_licenses::de_list_licenses_http_response_with_props(
                status, headers, body,
            )
        }
    }
