...
impl CheckInLicenseInput {
    /// Consumes the builder and constructs an Operation<[`CheckInLicense`](crate::operation::check_in_license::CheckInLicense)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::check_in_license::CheckInLicense, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::check_in_license::CheckInLicenseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_check_in_license::ser_check_in_license_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::check_in_license::CheckInLicense::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CheckInLicense {
                type Output = std::result::Result<crate::operation::check_in_license::CheckInLicenseOutput, crate::operation::check_in_license::CheckInLicenseError>;
