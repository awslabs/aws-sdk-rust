...
impl CheckInLicenseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::check_in_license::CheckInLicense, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_check_in_license::ser_check_in_license_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckInLicense {
    type Output =
        ::std::result::Result<crate::operation::check_in_license::CheckInLicenseOutput, crate::operation::check_in_license::CheckInLicenseError>;
