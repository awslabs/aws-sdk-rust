...
impl ListReceivedGrantsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_grants::ser_list_received_grants_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_received_grants::ListReceivedGrants::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::list_received_grants::ListReceivedGrantsError
{
