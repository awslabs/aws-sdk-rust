...
impl ListUsageForLicenseConfiguration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListUsageForLicenseConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListUsageForLicenseConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListUsageForLicenseConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListUsageForLicenseConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListUsageForLicenseConfiguration")
...
.with_interceptor(ListUsageForLicenseConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError>::new());
...
#[derive(Debug)]
            struct ListUsageForLicenseConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUsageForLicenseConfigurationResponseDeserializer {
...
#[derive(Debug)]
            struct ListUsageForLicenseConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUsageForLicenseConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_usage_for_license_configuration::ser_list_usage_for_license_configuration_input(&input)?);
...
#[derive(Debug)]
            struct ListUsageForLicenseConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListUsageForLicenseConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListUsageForLicenseConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListUsageForLicenseConfigurationInput>()
                        .ok_or("failed to downcast to ListUsageForLicenseConfigurationInput")?;
...
pub enum ListUsageForLicenseConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListUsageForLicenseConfigurationError) for what information is available for the error.")]
...
impl ListUsageForLicenseConfigurationError {
    /// Creates the `ListUsageForLicenseConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListUsageForLicenseConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListUsageForLicenseConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError {
