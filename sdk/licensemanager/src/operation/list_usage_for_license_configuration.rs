...
impl ListUsageForLicenseConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUsageForLicenseConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_usage_for_license_configuration::de_list_usage_for_license_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
