...
impl ListDistributedGrantsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_distributed_grants::ListDistributedGrantsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_distributed_grants::ListDistributedGrantsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_distributed_grants::ListDistributedGrantsOutput, crate::operation::list_distributed_grants::ListDistributedGrantsError, Self> {
