...
impl ListTokensInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_tokens::ListTokens, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tokens::ser_list_tokens_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTokens {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tokens::de_list_tokens_http_response_with_props(status, headers, body)
        }
    }
}
