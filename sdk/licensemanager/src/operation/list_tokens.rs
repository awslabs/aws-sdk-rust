...
impl ListTokensInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_tokens::ListTokens,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_tokens::ListTokens::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTokens {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_tokens::de_list_tokens_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_tokens::de_list_tokens_http_response_with_props(
                status, headers, body,
            )
        }
    }
