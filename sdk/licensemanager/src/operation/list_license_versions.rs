...
impl ListLicenseVersionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_license_versions::ser_list_license_versions_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_license_versions::ListLicenseVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLicenseVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_license_versions::de_list_license_versions_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_license_versions::ListLicenseVersionsError
{
