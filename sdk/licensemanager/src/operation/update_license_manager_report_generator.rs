...
impl UpdateLicenseManagerReportGeneratorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGenerator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLicenseManagerReportGenerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_license_manager_report_generator::de_update_license_manager_report_generator_http_response_with_props(
                status, headers, body,
            )
        }
    }
