...
impl ListLicenseConfigurationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_license_configurations::ListLicenseConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_license_configurations::ListLicenseConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_license_configurations::ListLicenseConfigurationsOutput, crate::operation::list_license_configurations::ListLicenseConfigurationsError, Self> {
