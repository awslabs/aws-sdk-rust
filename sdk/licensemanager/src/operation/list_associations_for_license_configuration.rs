...
/// Orchestration and serialization glue logic for `ListAssociationsForLicenseConfiguration`.
...
impl ListAssociationsForLicenseConfiguration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssociationsForLicenseConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssociationsForLicenseConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssociationsForLicenseConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssociationsForLicenseConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssociationsForLicenseConfiguration")
...
.with_interceptor(ListAssociationsForLicenseConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError>::new());
...
#[derive(Debug)]
            struct ListAssociationsForLicenseConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssociationsForLicenseConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_associations_for_license_configuration::de_list_associations_for_license_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_associations_for_license_configuration::de_list_associations_for_license_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAssociationsForLicenseConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssociationsForLicenseConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_associations_for_license_configuration::ser_list_associations_for_license_configuration_input(&input)?);
...
#[derive(Debug)]
            struct ListAssociationsForLicenseConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssociationsForLicenseConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAssociationsForLicenseConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssociationsForLicenseConfigurationInput>()
                        .ok_or("failed to downcast to ListAssociationsForLicenseConfigurationInput")?;
...
pub enum ListAssociationsForLicenseConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssociationsForLicenseConfigurationError) for what information is available for the error.")]
...
impl ListAssociationsForLicenseConfigurationError {
    /// Creates the `ListAssociationsForLicenseConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssociationsForLicenseConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssociationsForLicenseConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError {
...
mod _list_associations_for_license_configuration_output;
