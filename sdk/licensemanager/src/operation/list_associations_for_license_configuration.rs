...
impl ListAssociationsForLicenseConfiguration {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListAssociationsForLicenseConfiguration",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssociationsForLicenseConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAssociationsForLicenseConfigurationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAssociationsForLicenseConfigurationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAssociationsForLicenseConfiguration")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssociationsForLicenseConfiguration")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListAssociationsForLicenseConfigurationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListAssociationsForLicenseConfigurationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssociationsForLicenseConfigurationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListAssociationsForLicenseConfigurationInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("LicenseConfigurationArn") {
            if let ::std::option::Option::Some(value) = input.license_configuration_arn.as_deref() {
                captured.insert("LicenseConfigurationArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssociationsForLicenseConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_associations_for_license_configuration::de_list_associations_for_license_configuration_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_associations_for_license_configuration::de_list_associations_for_license_configuration_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssociationsForLicenseConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_associations_for_license_configuration::ser_list_associations_for_license_configuration_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_associations_for_license_configuration::ListAssociationsForLicenseConfigurationError
{
