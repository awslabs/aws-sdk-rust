...
impl ExtendLicenseConsumptionInput {
    /// Consumes the builder and constructs an Operation<[`ExtendLicenseConsumption`](crate::operation::extend_license_consumption::ExtendLicenseConsumption)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::extend_license_consumption::ExtendLicenseConsumption, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::extend_license_consumption::ExtendLicenseConsumptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_extend_license_consumption::ser_extend_license_consumption_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::extend_license_consumption::ExtendLicenseConsumption::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExtendLicenseConsumption {
                type Output = std::result::Result<crate::operation::extend_license_consumption::ExtendLicenseConsumptionOutput, crate::operation::extend_license_consumption::ExtendLicenseConsumptionError>;
