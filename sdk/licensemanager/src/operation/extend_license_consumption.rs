...
/// Orchestration and serialization glue logic for `ExtendLicenseConsumption`.
...
impl ExtendLicenseConsumption {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::extend_license_consumption::ExtendLicenseConsumptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExtendLicenseConsumption {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExtendLicenseConsumption");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExtendLicenseConsumptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExtendLicenseConsumptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExtendLicenseConsumption")
...
.with_interceptor(ExtendLicenseConsumptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError>::new());
...
#[derive(Debug)]
            struct ExtendLicenseConsumptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExtendLicenseConsumptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_extend_license_consumption::de_extend_license_consumption_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_extend_license_consumption::de_extend_license_consumption_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ExtendLicenseConsumptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExtendLicenseConsumptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::extend_license_consumption::ExtendLicenseConsumptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_extend_license_consumption::ser_extend_license_consumption_input(&input)?);
...
#[derive(Debug)]
            struct ExtendLicenseConsumptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExtendLicenseConsumptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExtendLicenseConsumptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExtendLicenseConsumptionInput>()
                        .ok_or("failed to downcast to ExtendLicenseConsumptionInput")?;
...
pub enum ExtendLicenseConsumptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExtendLicenseConsumptionError) for what information is available for the error.")]
...
impl ExtendLicenseConsumptionError {
    /// Creates the `ExtendLicenseConsumptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExtendLicenseConsumptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExtendLicenseConsumptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::extend_license_consumption::ExtendLicenseConsumptionError {
...
mod _extend_license_consumption_output;
