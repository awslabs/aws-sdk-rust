...
impl ExtendLicenseConsumption {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ExtendLicenseConsumption",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExtendLicenseConsumption {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ExtendLicenseConsumptionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ExtendLicenseConsumptionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ExtendLicenseConsumption")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExtendLicenseConsumption")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ExtendLicenseConsumptionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ExtendLicenseConsumptionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExtendLicenseConsumptionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ExtendLicenseConsumptionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExtendLicenseConsumptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_extend_license_consumption::de_extend_license_consumption_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_extend_license_consumption::de_extend_license_consumption_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExtendLicenseConsumptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::extend_license_consumption::ExtendLicenseConsumptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::extend_license_consumption::ExtendLicenseConsumptionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_extend_license_consumption::ser_extend_license_consumption_input(&input)?,
        );
