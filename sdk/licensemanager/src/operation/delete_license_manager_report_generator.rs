...
impl DeleteLicenseManagerReportGeneratorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_license_manager_report_generator::DeleteLicenseManagerReportGenerator,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_license_manager_report_generator::DeleteLicenseManagerReportGenerator::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLicenseManagerReportGenerator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_license_manager_report_generator::de_delete_license_manager_report_generator_http_response_with_props(
                status, headers, body,
            )
        }
    }
