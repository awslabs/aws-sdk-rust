...
pub fn ser_modify_redshift_idc_application_input_input_input(input: &crate::operation::modify_redshift_idc_application::ModifyRedshiftIdcApplicationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
