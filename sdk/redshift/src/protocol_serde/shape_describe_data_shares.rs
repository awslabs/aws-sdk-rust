...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_data_shares::de_describe_data_shares(_response_body, output)
            .map_err(crate::operation::describe_data_shares::DescribeDataSharesError::unhandled)?;
...
) -> std::result::Result<crate::operation::describe_data_shares::builders::DescribeDataSharesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("DescribeDataSharesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeDataSharesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDataSharesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDataSharesResult got {start_el:?}"
            )));
        }
