...
pub fn de_delete_scheduled_action_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_scheduled_action::DeleteScheduledActionOutput, crate::operation::delete_scheduled_action::DeleteScheduledActionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_scheduled_action_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_scheduled_action::DeleteScheduledActionOutput, crate::operation::delete_scheduled_action::DeleteScheduledActionError> {
    Ok({
        #[allow(unused_mut)]
