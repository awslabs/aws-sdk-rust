...
pub fn de_describe_cluster_subnet_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeClusterSubnetGroupsOutput, crate::error::DescribeClusterSubnetGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeClusterSubnetGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cluster_subnet_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeClusterSubnetGroupsOutput, crate::error::DescribeClusterSubnetGroupsError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_describe_cluster_subnet_groups(inp: &[u8], mut builder: crate::output::describe_cluster_subnet_groups_output::Builder) -> Result<crate::output::describe_cluster_subnet_groups_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
