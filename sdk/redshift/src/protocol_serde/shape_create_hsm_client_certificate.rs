...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateError::unhandled)?;
    ...
    Err(match error_code {
        "HsmClientCertificateAlreadyExistsFault" => {
            crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateError::HsmClientCertificateAlreadyExistsFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "HsmClientCertificateQuotaExceededFault" => {
            crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateError::HsmClientCertificateQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_hsm_client_certificate::de_create_hsm_client_certificate(_response_body, output)
            .map_err(crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateHsmClientCertificateResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateHsmClientCertificateResult got {start_el:?}"
            )));
        }
