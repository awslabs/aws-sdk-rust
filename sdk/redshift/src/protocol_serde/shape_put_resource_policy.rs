    ...
    Err(match error_code {
        "ConflictPolicyUpdateFault" => crate::operation::put_resource_policy::PutResourcePolicyError::ConflictPolicyUpdateFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_conflict_policy_update_fault::de_conflict_policy_update_fault_xml_err(_response_body, output)
                    .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
...
pub fn de_put_resource_policy(
    ...
    if !(start_el.matches("PutResourcePolicyResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected PutResourcePolicyResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("PutResourcePolicyResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected PutResourcePolicyResult got {start_el:?}"
            )));
        }
