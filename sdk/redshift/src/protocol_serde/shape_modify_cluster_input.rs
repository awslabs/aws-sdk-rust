...
pub fn ser_modify_cluster_input_input_input(input: &crate::operation::modify_cluster::ModifyClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
