...
pub fn de_modify_snapshot_copy_retention_period_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidClusterState" => {
            crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::InvalidClusterStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRetentionPeriodFault" => {
            crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::InvalidRetentionPeriodFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidRetentionPeriodFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_retention_period_fault::de_invalid_retention_period_fault_xml_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::unhandled)?;
        ...
        "SnapshotCopyDisabledFault" => {
            crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::SnapshotCopyDisabledFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::SnapshotCopyDisabledFaultBuilder::default();
                    output =
                        crate::protocol_serde::shape_snapshot_copy_disabled_fault::de_snapshot_copy_disabled_fault_xml_err(_response_body, output)
                            .map_err(crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "UnauthorizedOperation" => {
            crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::UnauthorizedOperation({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_snapshot_copy_retention_period_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_snapshot_copy_retention_period::de_modify_snapshot_copy_retention_period(_response_body, output)
            .map_err(crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError::unhandled)?;
