...
pub fn ser_create_snapshot_schedule_input_input_input(input: &crate::operation::create_snapshot_schedule::CreateSnapshotScheduleInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
