...
pub fn ser_create_snapshot_schedule_input_input(input: &crate::input::CreateSnapshotScheduleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
