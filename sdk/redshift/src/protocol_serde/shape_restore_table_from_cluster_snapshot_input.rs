...
pub fn ser_restore_table_from_cluster_snapshot_input_input(input: &crate::input::RestoreTableFromClusterSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
