...
pub fn de_describe_node_configuration_options_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeNodeConfigurationOptionsOutput, crate::error::DescribeNodeConfigurationOptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeNodeConfigurationOptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_node_configuration_options_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeNodeConfigurationOptionsOutput, crate::error::DescribeNodeConfigurationOptionsError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_describe_node_configuration_options(inp: &[u8], mut builder: crate::output::describe_node_configuration_options_output::Builder) -> Result<crate::output::describe_node_configuration_options_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
