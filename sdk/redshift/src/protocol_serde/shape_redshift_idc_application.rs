...
pub fn de_redshift_idc_application(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::RedshiftIdcApplication, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
