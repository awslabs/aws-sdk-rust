...
pub fn de_deferred_maintenance_window(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeferredMaintenanceWindow, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
