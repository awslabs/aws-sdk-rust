...
pub fn de_authorize_data_share_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AuthorizeDataShareOutput, crate::error::AuthorizeDataShareError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AuthorizeDataShareError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_data_share_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AuthorizeDataShareOutput, crate::error::AuthorizeDataShareError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::authorize_data_share_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_authorize_data_share::de_authorize_data_share(response.body().as_ref(), output).map_err(crate::error::AuthorizeDataShareError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_authorize_data_share(inp: &[u8], mut builder: crate::output::authorize_data_share_output::Builder) -> Result<crate::output::authorize_data_share_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
