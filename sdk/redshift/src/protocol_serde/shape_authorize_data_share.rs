...
) -> std::result::Result<crate::operation::authorize_data_share::builders::AuthorizeDataShareOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("AuthorizeDataShareResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected AuthorizeDataShareResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            ,
            s if s.matches("DataShareType") /* DataShareType com.amazonaws.redshift.synthetic#AuthorizeDataShareOutput$DataShareType */ =>  {
                let var_6 =
                    Some(
