...
pub fn de_authorize_data_share_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_data_share::AuthorizeDataShareOutput, crate::operation::authorize_data_share::AuthorizeDataShareError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_data_share_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_data_share::AuthorizeDataShareOutput, crate::operation::authorize_data_share::AuthorizeDataShareError> {
    Ok({
        #[allow(unused_mut)]
