...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsError::unhandled)?;
    ...
    Err(match error_code {
        "BatchDeleteRequestSizeExceeded" => {
            crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsError::BatchDeleteRequestSizeExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::BatchDeleteRequestSizeExceededFaultBuilder::default();
                    output =
                        crate::protocol_serde::shape_batch_delete_request_size_exceeded_fault::de_batch_delete_request_size_exceeded_fault_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_delete_cluster_snapshots::de_batch_delete_cluster_snapshots(_response_body, output)
            .map_err(crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("BatchDeleteClusterSnapshotsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected BatchDeleteClusterSnapshotsResult got {start_el:?}"
            )));
        }
