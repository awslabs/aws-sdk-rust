...
pub fn de_pause_cluster_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::pause_cluster::PauseClusterOutput, crate::operation::pause_cluster::PauseClusterError> {
    #[allow(unused_mut)]
...
pub fn de_pause_cluster_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_pause_cluster::de_pause_cluster(_response_body, output)
            .map_err(crate::operation::pause_cluster::PauseClusterError::unhandled)?;
...
pub fn de_pause_cluster(
...
) -> std::result::Result<crate::operation::pause_cluster::builders::PauseClusterOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("PauseClusterResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected PauseClusterResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("PauseClusterResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected PauseClusterResult got {start_el:?}"
            )));
        }
