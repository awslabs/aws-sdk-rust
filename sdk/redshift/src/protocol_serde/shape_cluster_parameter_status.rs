...
pub fn de_cluster_parameter_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterParameterStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
