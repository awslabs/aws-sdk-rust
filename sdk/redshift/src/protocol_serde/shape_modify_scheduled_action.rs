...
pub fn de_modify_scheduled_action_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_scheduled_action::ModifyScheduledActionOutput, crate::operation::modify_scheduled_action::ModifyScheduledActionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_scheduled_action_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_scheduled_action::ModifyScheduledActionOutput, crate::operation::modify_scheduled_action::ModifyScheduledActionError> {
    Ok({
        #[allow(unused_mut)]
