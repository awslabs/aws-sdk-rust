...
pub fn de_describe_clusters(
...
) -> std::result::Result<crate::operation::describe_clusters::builders::DescribeClustersOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeClustersResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeClustersResult got {start_el:?}"
            )));
        }
