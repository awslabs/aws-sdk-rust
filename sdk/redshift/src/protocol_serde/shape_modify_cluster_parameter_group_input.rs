...
pub fn ser_modify_cluster_parameter_group_input_input_input(input: &crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
