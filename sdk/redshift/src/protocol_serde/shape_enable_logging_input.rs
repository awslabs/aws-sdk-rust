...
pub fn ser_enable_logging_input_input_input(input: &crate::operation::enable_logging::EnableLoggingInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
