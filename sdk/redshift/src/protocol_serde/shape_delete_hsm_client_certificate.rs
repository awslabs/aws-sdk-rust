...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_hsm_client_certificate_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateOutput, crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateError> {
    Ok({
        #[allow(unused_mut)]
