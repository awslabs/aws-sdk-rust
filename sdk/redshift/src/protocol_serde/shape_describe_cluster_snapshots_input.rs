...
pub fn ser_describe_cluster_snapshots_input_input_input(input: &crate::operation::describe_cluster_snapshots::DescribeClusterSnapshotsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
