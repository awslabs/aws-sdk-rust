...
pub fn ser_describe_cluster_snapshots_input_input(input: &crate::input::DescribeClusterSnapshotsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
