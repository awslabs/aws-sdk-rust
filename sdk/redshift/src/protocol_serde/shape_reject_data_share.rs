...
pub fn de_reject_data_share_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::reject_data_share::RejectDataShareOutput, crate::operation::reject_data_share::RejectDataShareError> {
    #[allow(unused_mut)]
...
pub fn de_reject_data_share_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_reject_data_share::de_reject_data_share(_response_body, output)
            .map_err(crate::operation::reject_data_share::RejectDataShareError::unhandled)?;
...
pub fn de_reject_data_share(
    ...
    if !(start_el.matches("RejectDataShareResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected RejectDataShareResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("RejectDataShareResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected RejectDataShareResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            ,
            s if s.matches("DataShareType") /* DataShareType com.amazonaws.redshift.synthetic#RejectDataShareOutput$DataShareType */ =>  {
                let var_6 =
                    Some(
