...
pub fn de_reject_data_share_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RejectDataShareOutput, crate::error::RejectDataShareError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::RejectDataShareError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reject_data_share_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RejectDataShareOutput, crate::error::RejectDataShareError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::reject_data_share_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_reject_data_share::de_reject_data_share(response.body().as_ref(), output).map_err(crate::error::RejectDataShareError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_reject_data_share(inp: &[u8], mut builder: crate::output::reject_data_share_output::Builder) -> Result<crate::output::reject_data_share_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
