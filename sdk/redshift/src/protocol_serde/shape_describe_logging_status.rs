...
pub fn de_describe_logging_status_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled(generic))
                            };
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cluster_not_found_fault::de_cluster_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled)?;
        ...
        "UnsupportedOperation" => crate::operation::describe_logging_status::DescribeLoggingStatusError::UnsupportedOperationFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::UnsupportedOperationFaultBuilder::default();
                    output = crate::protocol_serde::shape_unsupported_operation_fault::de_unsupported_operation_fault_xml_err(_response_body, output).map_err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_logging_status_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_logging_status::builders::DescribeLoggingStatusOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_logging_status::de_describe_logging_status(_response_body, output).map_err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_logging_status(inp: &[u8], mut builder: crate::operation::describe_logging_status::builders::DescribeLoggingStatusOutputBuilder) -> Result<crate::operation::describe_logging_status::builders::DescribeLoggingStatusOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DescribeLoggingStatusResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected DescribeLoggingStatusResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeLoggingStatusResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected DescribeLoggingStatusResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected DescribeLoggingStatusResult tag"))
                    };
    Ok(builder)
}
