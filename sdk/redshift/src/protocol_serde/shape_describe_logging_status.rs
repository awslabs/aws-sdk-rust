...
pub fn de_describe_logging_status_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_logging_status_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError> {
    Ok({
        #[allow(unused_mut)]
