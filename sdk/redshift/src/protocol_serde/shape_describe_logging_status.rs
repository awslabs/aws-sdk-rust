...
pub fn de_describe_logging_status_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_logging_status_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_logging_status::builders::DescribeLoggingStatusOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_logging_status::de_describe_logging_status(response.body().as_ref(), output).map_err(crate::operation::describe_logging_status::DescribeLoggingStatusError::unhandled)?;
