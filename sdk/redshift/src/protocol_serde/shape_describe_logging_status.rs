...
pub fn de_describe_logging_status_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeLoggingStatusOutput, crate::error::DescribeLoggingStatusError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeLoggingStatusError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_logging_status_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeLoggingStatusOutput, crate::error::DescribeLoggingStatusError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_logging_status_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_logging_status::de_describe_logging_status(response.body().as_ref(), output).map_err(crate::error::DescribeLoggingStatusError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_logging_status(inp: &[u8], mut builder: crate::output::describe_logging_status_output::Builder) -> Result<crate::output::describe_logging_status_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
