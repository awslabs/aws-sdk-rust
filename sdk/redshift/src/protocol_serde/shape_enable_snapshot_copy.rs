...
pub fn de_enable_snapshot_copy_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_snapshot_copy::EnableSnapshotCopyOutput, crate::operation::enable_snapshot_copy::EnableSnapshotCopyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_snapshot_copy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_snapshot_copy::EnableSnapshotCopyOutput, crate::operation::enable_snapshot_copy::EnableSnapshotCopyError> {
    Ok({
        #[allow(unused_mut)]
