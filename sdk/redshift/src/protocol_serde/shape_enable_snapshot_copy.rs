...
pub fn de_enable_snapshot_copy_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_snapshot_copy::EnableSnapshotCopyOutput, crate::operation::enable_snapshot_copy::EnableSnapshotCopyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::enable_snapshot_copy::EnableSnapshotCopyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_snapshot_copy_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_snapshot_copy::EnableSnapshotCopyOutput, crate::operation::enable_snapshot_copy::EnableSnapshotCopyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::enable_snapshot_copy::builders::EnableSnapshotCopyOutputBuilder::default();
        output = crate::protocol_serde::shape_enable_snapshot_copy::de_enable_snapshot_copy(_response_body, output).map_err(crate::operation::enable_snapshot_copy::EnableSnapshotCopyError::unhandled)?;
