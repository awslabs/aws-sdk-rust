...
pub fn ser_create_usage_limit_input_input(input: &crate::input::CreateUsageLimitInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
