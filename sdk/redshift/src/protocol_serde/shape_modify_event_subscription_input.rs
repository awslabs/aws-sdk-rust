...
pub fn ser_modify_event_subscription_input_input_input(input: &crate::operation::modify_event_subscription::ModifyEventSubscriptionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
