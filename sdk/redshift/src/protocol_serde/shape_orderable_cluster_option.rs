...
pub fn de_orderable_cluster_option(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OrderableClusterOption, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
