...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ClusterSnapshotNotFound" => {
            crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::ClusterSnapshotNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidClusterSnapshotState" => {
            crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::InvalidClusterSnapshotStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidClusterState" => {
            crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::InvalidClusterStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidTableRestoreArgument" => {
            crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::InvalidTableRestoreArgumentFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidTableRestoreArgumentFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_table_restore_argument_fault::de_invalid_table_restore_argument_fault_xml_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::unhandled)?;
        ...
        "UnsupportedOperation" => {
            crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::UnsupportedOperationFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_restore_table_from_cluster_snapshot::de_restore_table_from_cluster_snapshot(_response_body, output)
            .map_err(crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("RestoreTableFromClusterSnapshotResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected RestoreTableFromClusterSnapshotResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("RestoreTableFromClusterSnapshotResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected RestoreTableFromClusterSnapshotResult got {start_el:?}"
            )));
        }
