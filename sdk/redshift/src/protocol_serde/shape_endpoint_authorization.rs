...
pub fn de_endpoint_authorization(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EndpointAuthorization, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
