...
pub fn de_attribute_value_target(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AttributeValueTarget, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
