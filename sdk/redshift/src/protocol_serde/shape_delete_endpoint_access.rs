...
#[allow(unused_mut)]
pub fn de_delete_endpoint_access(inp: &[u8], mut builder: crate::output::delete_endpoint_access_output::Builder) -> Result<crate::output::delete_endpoint_access_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
