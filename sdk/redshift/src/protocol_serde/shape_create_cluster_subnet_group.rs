...
pub fn de_create_cluster_subnet_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateClusterSubnetGroupOutput, crate::error::CreateClusterSubnetGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateClusterSubnetGroupError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_subnet::de_invalid_subnet_xml_err(response.body().as_ref(), output).map_err(crate::error::CreateClusterSubnetGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cluster_subnet_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateClusterSubnetGroupOutput, crate::error::CreateClusterSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_create_cluster_subnet_group(inp: &[u8], mut builder: crate::output::create_cluster_subnet_group_output::Builder) -> Result<crate::output::create_cluster_subnet_group_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
