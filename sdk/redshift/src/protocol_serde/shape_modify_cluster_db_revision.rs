...
pub fn de_modify_cluster_db_revision_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyClusterDbRevisionOutput, crate::error::ModifyClusterDbRevisionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyClusterDbRevisionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_cluster_db_revision_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyClusterDbRevisionOutput, crate::error::ModifyClusterDbRevisionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::modify_cluster_db_revision_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_cluster_db_revision::de_modify_cluster_db_revision(response.body().as_ref(), output).map_err(crate::error::ModifyClusterDbRevisionError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_cluster_db_revision(inp: &[u8], mut builder: crate::output::modify_cluster_db_revision_output::Builder) -> Result<crate::output::modify_cluster_db_revision_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
