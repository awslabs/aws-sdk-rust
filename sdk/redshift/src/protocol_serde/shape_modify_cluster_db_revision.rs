...
pub fn de_modify_cluster_db_revision_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_cluster_db_revision::ModifyClusterDbRevisionOutput, crate::operation::modify_cluster_db_revision::ModifyClusterDbRevisionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::modify_cluster_db_revision::ModifyClusterDbRevisionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_cluster_db_revision_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_cluster_db_revision::ModifyClusterDbRevisionOutput, crate::operation::modify_cluster_db_revision::ModifyClusterDbRevisionError> {
    Ok({
        #[allow(unused_mut)]
