...
#[allow(unused_mut)]
pub fn ser_scheduled_action_type(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ScheduledActionType) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
