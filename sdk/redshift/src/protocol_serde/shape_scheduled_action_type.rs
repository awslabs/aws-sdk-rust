...
#[allow(unused_mut)]
pub fn ser_scheduled_action_type(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ScheduledActionType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_scheduled_action_type(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScheduledActionType, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
