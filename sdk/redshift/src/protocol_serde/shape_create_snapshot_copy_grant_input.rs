...
pub fn ser_create_snapshot_copy_grant_input_input(input: &crate::input::CreateSnapshotCopyGrantInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
