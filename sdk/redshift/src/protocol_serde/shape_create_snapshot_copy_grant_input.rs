...
pub fn ser_create_snapshot_copy_grant_input_input(input: &crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
