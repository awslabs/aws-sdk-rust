...
pub fn de_authentication_profile(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AuthenticationProfile, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
