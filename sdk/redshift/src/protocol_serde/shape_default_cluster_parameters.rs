...
pub fn de_default_cluster_parameters(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DefaultClusterParameters, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
