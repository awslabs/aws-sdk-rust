...
pub fn ser_delete_hsm_configuration_input_input(input: &crate::input::DeleteHsmConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
