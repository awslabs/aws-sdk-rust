...
pub fn de_describe_cluster_tracks_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeClusterTracksOutput, crate::error::DescribeClusterTracksError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeClusterTracksError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cluster_tracks_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeClusterTracksOutput, crate::error::DescribeClusterTracksError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_cluster_tracks_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_cluster_tracks::de_describe_cluster_tracks(response.body().as_ref(), output).map_err(crate::error::DescribeClusterTracksError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_cluster_tracks(inp: &[u8], mut builder: crate::output::describe_cluster_tracks_output::Builder) -> Result<crate::output::describe_cluster_tracks_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
