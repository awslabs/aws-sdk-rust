...
pub fn de_snapshot_copy_grant_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::SnapshotCopyGrant>, aws_smithy_xml::decode::XmlDecodeError> {
