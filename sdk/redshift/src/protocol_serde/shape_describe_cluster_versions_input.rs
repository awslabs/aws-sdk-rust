...
pub fn ser_describe_cluster_versions_input_input_input(input: &crate::operation::describe_cluster_versions::DescribeClusterVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
