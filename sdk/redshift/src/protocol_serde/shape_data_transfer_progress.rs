...
pub fn de_data_transfer_progress(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DataTransferProgress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
