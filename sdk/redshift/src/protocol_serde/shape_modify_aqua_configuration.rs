...
pub fn de_modify_aqua_configuration_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_aqua_configuration_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError> {
    Ok({
        #[allow(unused_mut)]
