...
pub fn de_modify_aqua_configuration_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_aqua_configuration_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError> {
    Ok({
        #[allow(unused_mut)]
