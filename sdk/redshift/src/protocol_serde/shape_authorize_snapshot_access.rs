...
pub fn de_authorize_snapshot_access_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessOutput, crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_snapshot_access_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessOutput, crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessError> {
    Ok({
        #[allow(unused_mut)]
