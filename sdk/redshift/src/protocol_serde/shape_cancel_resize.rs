...
pub fn de_cancel_resize_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
    ...
    Err(match error_code {
        "ClusterNotFound" => crate::operation::cancel_resize::CancelResizeError::ClusterNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ClusterNotFoundFaultBuilder::default();
                    output = crate::protocol_serde::shape_cluster_not_found_fault::de_cluster_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
        ...
        "InvalidClusterState" => crate::operation::cancel_resize::CancelResizeError::InvalidClusterStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidClusterStateFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_cluster_state_fault::de_invalid_cluster_state_fault_xml_err(_response_body, output).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "ResizeNotFound" => crate::operation::cancel_resize::CancelResizeError::ResizeNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ResizeNotFoundFaultBuilder::default();
                    output = crate::protocol_serde::shape_resize_not_found_fault::de_resize_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "UnsupportedOperation" => crate::operation::cancel_resize::CancelResizeError::UnsupportedOperationFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::UnsupportedOperationFaultBuilder::default();
                    output = crate::protocol_serde::shape_unsupported_operation_fault::de_unsupported_operation_fault_xml_err(_response_body, output).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_resize_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::cancel_resize::builders::CancelResizeOutputBuilder::default();
        output = crate::protocol_serde::shape_cancel_resize::de_cancel_resize(_response_body, output).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_cancel_resize(inp: &[u8], mut builder: crate::operation::cancel_resize::builders::CancelResizeOutputBuilder) -> Result<crate::operation::cancel_resize::builders::CancelResizeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
