...
pub fn de_cancel_resize_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_resize_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    Ok({
        #[allow(unused_mut)]
