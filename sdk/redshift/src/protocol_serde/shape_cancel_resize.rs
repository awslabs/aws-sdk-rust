...
pub fn de_cancel_resize_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_resize_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::cancel_resize::builders::CancelResizeOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_cancel_resize::de_cancel_resize(response.body().as_ref(), output).map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
