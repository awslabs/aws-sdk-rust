...
pub fn de_cancel_resize_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError> {
    #[allow(unused_mut)]
...
pub fn de_cancel_resize_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_resize::de_cancel_resize(_response_body, output)
            .map_err(crate::operation::cancel_resize::CancelResizeError::unhandled)?;
...
pub fn de_cancel_resize(
...
) -> std::result::Result<crate::operation::cancel_resize::builders::CancelResizeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CancelResizeResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CancelResizeResult got {start_el:?}"
            )));
        }
