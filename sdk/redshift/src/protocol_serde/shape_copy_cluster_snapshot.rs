...
pub fn de_copy_cluster_snapshot_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_cluster_snapshot::CopyClusterSnapshotOutput, crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_cluster_snapshot_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_cluster_snapshot::CopyClusterSnapshotOutput, crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError> {
    Ok({
        #[allow(unused_mut)]
