...
pub fn de_modify_snapshot_schedule_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifySnapshotScheduleOutput, crate::error::ModifySnapshotScheduleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifySnapshotScheduleError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_schedule_fault::de_invalid_schedule_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::ModifySnapshotScheduleError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_snapshot_schedule_not_found_fault::de_snapshot_schedule_not_found_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::ModifySnapshotScheduleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_snapshot_schedule_update_in_progress_fault::de_snapshot_schedule_update_in_progress_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::ModifySnapshotScheduleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_snapshot_schedule_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifySnapshotScheduleOutput, crate::error::ModifySnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::modify_snapshot_schedule_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_snapshot_schedule::de_modify_snapshot_schedule(response.body().as_ref(), output).map_err(crate::error::ModifySnapshotScheduleError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_snapshot_schedule(inp: &[u8], mut builder: crate::output::modify_snapshot_schedule_output::Builder) -> Result<crate::output::modify_snapshot_schedule_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
