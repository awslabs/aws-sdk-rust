...
pub fn de_modify_snapshot_schedule_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput, crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_schedule_fault::de_invalid_schedule_fault_xml_err(_response_body, output).map_err(crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_snapshot_schedule_not_found_fault::de_snapshot_schedule_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_snapshot_schedule_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput, crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_snapshot_schedule::builders::ModifySnapshotScheduleOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_snapshot_schedule::de_modify_snapshot_schedule(_response_body, output).map_err(crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError::unhandled)?;
