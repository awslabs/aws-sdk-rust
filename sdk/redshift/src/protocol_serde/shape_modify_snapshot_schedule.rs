...
pub fn de_modify_snapshot_schedule_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput, crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_snapshot_schedule_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput, crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
