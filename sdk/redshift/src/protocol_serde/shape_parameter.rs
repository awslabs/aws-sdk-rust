...
#[allow(unused_mut)]
pub fn ser_parameter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Parameter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_parameter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Parameter, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
