...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_cluster_db_revisions::de_describe_cluster_db_revisions(_response_body, output)
            .map_err(crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeClusterDbRevisionsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeClusterDbRevisionsResult got {start_el:?}"
            )));
        }
