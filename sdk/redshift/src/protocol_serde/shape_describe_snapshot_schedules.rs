...
pub fn de_describe_snapshot_schedules_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(
        crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedulesError::unhandled,
    )?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    Err(
        crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedulesError::generic(
            generic,
        ),
    )
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_snapshot_schedules_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedulesOutput,
    crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedulesError,
