            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_redshift_idc_application_not_exists_fault::de_redshift_idc_application_not_exists_fault_xml_err(_response_body, output).map_err(crate::operation::create_cluster::CreateClusterError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
