...
pub fn de_cluster_subnet_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ClusterSubnetGroup>, aws_smithy_xml::decode::XmlDecodeError> {
