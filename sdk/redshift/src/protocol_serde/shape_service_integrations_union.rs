...
#[allow(unused_mut)]
pub fn ser_service_integrations_union(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ServiceIntegrationsUnion) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::ServiceIntegrationsUnion::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ServiceIntegrationsUnion"))
    }
    Ok(())
}

pub fn de_service_integrations_union(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ServiceIntegrationsUnion, ::aws_smithy_xml::decode::XmlDecodeError> {
