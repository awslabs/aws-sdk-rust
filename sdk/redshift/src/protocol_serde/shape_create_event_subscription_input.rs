...
pub fn ser_create_event_subscription_input_input(input: &crate::input::CreateEventSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
