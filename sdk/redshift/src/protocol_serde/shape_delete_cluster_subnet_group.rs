...
pub fn de_delete_cluster_subnet_group_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupOutput, crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_cluster_subnet_group_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupOutput, crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
