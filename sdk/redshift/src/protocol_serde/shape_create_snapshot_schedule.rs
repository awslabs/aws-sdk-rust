...
pub fn de_create_snapshot_schedule_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_snapshot_schedule_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
