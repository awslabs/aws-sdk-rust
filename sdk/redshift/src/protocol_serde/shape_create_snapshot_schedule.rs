...
pub fn de_create_snapshot_schedule_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError::unhandled(generic))
                            };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_snapshot_schedule_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleOutputBuilder::default();
        output = crate::protocol_serde::shape_create_snapshot_schedule::de_create_snapshot_schedule(_response_body, output).map_err(crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_snapshot_schedule(inp: &[u8], mut builder: crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleOutputBuilder) -> Result<crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateSnapshotScheduleResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected CreateSnapshotScheduleResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("CreateSnapshotScheduleResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected CreateSnapshotScheduleResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected CreateSnapshotScheduleResult tag"))
                    };
    Ok(builder)
}
