...
pub fn de_create_snapshot_schedule_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_snapshot_schedule_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_snapshot_schedule::de_create_snapshot_schedule(response.body().as_ref(), output).map_err(crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError::unhandled)?;
