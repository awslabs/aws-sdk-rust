...
pub fn de_create_snapshot_schedule_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateSnapshotScheduleOutput, crate::error::CreateSnapshotScheduleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateSnapshotScheduleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_snapshot_schedule_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateSnapshotScheduleOutput, crate::error::CreateSnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_snapshot_schedule_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_snapshot_schedule::de_create_snapshot_schedule(response.body().as_ref(), output).map_err(crate::error::CreateSnapshotScheduleError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_snapshot_schedule(inp: &[u8], mut builder: crate::output::create_snapshot_schedule_output::Builder) -> Result<crate::output::create_snapshot_schedule_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
