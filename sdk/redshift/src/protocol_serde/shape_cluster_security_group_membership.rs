...
pub fn de_cluster_security_group_membership(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterSecurityGroupMembership, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
