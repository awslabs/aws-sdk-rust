...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError::unhandled)?;
    ...
    Err(match error_code {
        "ClusterParameterGroupNotFound" => {
            crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError::ClusterParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidClusterParameterGroupState" => {
            crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError::InvalidClusterParameterGroupStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reset_cluster_parameter_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_reset_cluster_parameter_group::de_reset_cluster_parameter_group(_response_body, output)
            .map_err(crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError::unhandled)?;
...
pub fn de_reset_cluster_parameter_group(
    inp: &[u8],
    mut builder: crate::operation::reset_cluster_parameter_group::builders::ResetClusterParameterGroupOutputBuilder,
) -> Result<
    crate::operation::reset_cluster_parameter_group::builders::ResetClusterParameterGroupOutputBuilder,
