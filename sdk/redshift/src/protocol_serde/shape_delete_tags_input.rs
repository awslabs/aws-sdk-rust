...
pub fn ser_delete_tags_input_input(input: &crate::operation::delete_tags::DeleteTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
