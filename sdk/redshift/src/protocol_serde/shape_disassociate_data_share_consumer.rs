...
pub fn de_disassociate_data_share_consumer_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisassociateDataShareConsumerOutput, crate::error::DisassociateDataShareConsumerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DisassociateDataShareConsumerError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_data_share_consumer_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisassociateDataShareConsumerOutput, crate::error::DisassociateDataShareConsumerError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_disassociate_data_share_consumer(inp: &[u8], mut builder: crate::output::disassociate_data_share_consumer_output::Builder) -> Result<crate::output::disassociate_data_share_consumer_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
