...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_data_share_consumer_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput, crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError> {
    Ok({
        #[allow(unused_mut)]
