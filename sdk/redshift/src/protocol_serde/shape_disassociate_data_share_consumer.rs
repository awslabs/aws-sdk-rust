...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_data_share_consumer::de_disassociate_data_share_consumer(_response_body, output)
            .map_err(crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DisassociateDataShareConsumerResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DisassociateDataShareConsumerResult got {start_el:?}"
            )));
        }
