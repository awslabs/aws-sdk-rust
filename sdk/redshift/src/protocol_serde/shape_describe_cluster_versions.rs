...
> {
    ...
    Err(crate::operation::describe_cluster_versions::DescribeClusterVersionsError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cluster_versions_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::describe_cluster_versions::builders::DescribeClusterVersionsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
