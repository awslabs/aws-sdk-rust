...
pub fn de_hsm_client_certificate(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HsmClientCertificate, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
