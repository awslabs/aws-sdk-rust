...
pub fn de_supported_platform(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SupportedPlatform, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
