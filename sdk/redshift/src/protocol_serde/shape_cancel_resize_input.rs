...
pub fn ser_cancel_resize_input_input(input: &crate::input::CancelResizeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
