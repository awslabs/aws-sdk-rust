...
pub fn de_create_usage_limit_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_usage_limit::CreateUsageLimitOutput, crate::operation::create_usage_limit::CreateUsageLimitError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "UsageLimitAlreadyExists" => crate::operation::create_usage_limit::CreateUsageLimitError::UsageLimitAlreadyExistsFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_usage_limit_already_exists_fault::de_usage_limit_already_exists_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_usage_limit::CreateUsageLimitError::unhandled)?;
...
pub fn de_create_usage_limit_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_usage_limit::de_create_usage_limit(_response_body, output)
            .map_err(crate::operation::create_usage_limit::CreateUsageLimitError::unhandled)?;
...
pub fn de_create_usage_limit(
...
) -> std::result::Result<crate::operation::create_usage_limit::builders::CreateUsageLimitOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateUsageLimitResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateUsageLimitResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateUsageLimitResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateUsageLimitResult got {start_el:?}"
            )));
        }
