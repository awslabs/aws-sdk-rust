...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_usage_limit_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_usage_limit::CreateUsageLimitOutput, crate::operation::create_usage_limit::CreateUsageLimitError> {
...
) -> Result<crate::operation::create_usage_limit::builders::CreateUsageLimitOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
