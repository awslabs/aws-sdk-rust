...
pub fn de_node_configuration_option(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NodeConfigurationOption, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
