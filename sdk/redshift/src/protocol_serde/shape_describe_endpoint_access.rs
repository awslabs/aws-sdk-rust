...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_endpoint_access::DescribeEndpointAccessError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_endpoint_access::de_describe_endpoint_access(_response_body, output)
            .map_err(crate::operation::describe_endpoint_access::DescribeEndpointAccessError::unhandled)?;
...
) -> Result<crate::operation::describe_endpoint_access::builders::DescribeEndpointAccessOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
