...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_cluster_snapshots::DescribeClusterSnapshotsError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_cluster_snapshots::DescribeClusterSnapshotsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_cluster_snapshots::de_describe_cluster_snapshots(_response_body, output)
            .map_err(crate::operation::describe_cluster_snapshots::DescribeClusterSnapshotsError::unhandled)?;
...
) -> Result<crate::operation::describe_cluster_snapshots::builders::DescribeClusterSnapshotsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
