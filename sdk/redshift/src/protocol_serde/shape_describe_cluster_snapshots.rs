...
pub fn de_describe_cluster_snapshots_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeClusterSnapshotsOutput, crate::error::DescribeClusterSnapshotsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeClusterSnapshotsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_cluster_snapshots_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeClusterSnapshotsOutput, crate::error::DescribeClusterSnapshotsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_cluster_snapshots_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_cluster_snapshots::de_describe_cluster_snapshots(response.body().as_ref(), output).map_err(crate::error::DescribeClusterSnapshotsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_cluster_snapshots(inp: &[u8], mut builder: crate::output::describe_cluster_snapshots_output::Builder) -> Result<crate::output::describe_cluster_snapshots_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
