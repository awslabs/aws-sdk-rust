...
pub fn de_account_with_restore_access(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccountWithRestoreAccess, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
