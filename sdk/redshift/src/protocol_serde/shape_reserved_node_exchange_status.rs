...
pub fn de_reserved_node_exchange_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedNodeExchangeStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
