...
pub fn ser_modify_scheduled_action_input_input_input(input: &crate::operation::modify_scheduled_action::ModifyScheduledActionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
