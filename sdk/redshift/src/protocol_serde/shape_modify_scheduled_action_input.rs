...
pub fn ser_modify_scheduled_action_input_input(
    input: &crate::operation::modify_scheduled_action::ModifyScheduledActionInput,
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    if let Some(var_4) = &input.target_action {
        crate::protocol_serde::shape_scheduled_action_type::ser_scheduled_action_type(
            scope_3, var_4,
        )?;
    }
    #[allow(unused_mut)]
