...
pub fn ser_modify_scheduled_action_input_input(input: &crate::input::ModifyScheduledActionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
