...
pub fn ser_describe_events_input_input_input(input: &crate::operation::describe_events::DescribeEventsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
