...
pub fn de_describe_storage_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_storage::de_describe_storage(_response_body, output)
            .map_err(crate::operation::describe_storage::DescribeStorageError::unhandled)?;
...
pub fn de_describe_storage(
...
) -> std::result::Result<crate::operation::describe_storage::builders::DescribeStorageOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DescribeStorageResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeStorageResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeStorageResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeStorageResult got {start_el:?}"
            )));
        }
