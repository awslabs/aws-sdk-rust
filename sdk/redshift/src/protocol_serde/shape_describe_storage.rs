...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_storage_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_storage::DescribeStorageOutput, crate::operation::describe_storage::DescribeStorageError> {
...
) -> Result<crate::operation::describe_storage::builders::DescribeStorageOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
