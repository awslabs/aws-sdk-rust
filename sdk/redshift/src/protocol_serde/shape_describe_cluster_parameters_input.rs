...
pub fn ser_describe_cluster_parameters_input_input_input(input: &crate::operation::describe_cluster_parameters::DescribeClusterParametersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
