...
pub fn ser_get_cluster_credentials_with_iam_input_input(input: &crate::input::GetClusterCredentialsWithIamInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
