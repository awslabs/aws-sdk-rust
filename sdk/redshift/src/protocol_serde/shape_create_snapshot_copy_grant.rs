...
pub fn de_create_snapshot_copy_grant_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateSnapshotCopyGrantOutput, crate::error::CreateSnapshotCopyGrantError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateSnapshotCopyGrantError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_snapshot_copy_grant_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateSnapshotCopyGrantOutput, crate::error::CreateSnapshotCopyGrantError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_snapshot_copy_grant_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_snapshot_copy_grant::de_create_snapshot_copy_grant(response.body().as_ref(), output).map_err(crate::error::CreateSnapshotCopyGrantError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_snapshot_copy_grant(inp: &[u8], mut builder: crate::output::create_snapshot_copy_grant_output::Builder) -> Result<crate::output::create_snapshot_copy_grant_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
