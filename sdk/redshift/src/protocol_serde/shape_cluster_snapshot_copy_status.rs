...
pub fn de_cluster_snapshot_copy_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterSnapshotCopyStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
