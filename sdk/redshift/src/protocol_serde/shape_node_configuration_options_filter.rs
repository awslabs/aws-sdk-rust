...
#[allow(unused_mut)]
pub fn ser_node_configuration_options_filter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::NodeConfigurationOptionsFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
