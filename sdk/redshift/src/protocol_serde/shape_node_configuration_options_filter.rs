...
#[allow(unused_mut)]
pub fn ser_node_configuration_options_filter(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::NodeConfigurationOptionsFilter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
