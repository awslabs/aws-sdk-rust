...
pub fn de_associate_data_share_consumer_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssociateDataShareConsumerOutput, crate::error::AssociateDataShareConsumerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AssociateDataShareConsumerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_data_share_fault::de_invalid_data_share_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::AssociateDataShareConsumerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_namespace_fault::de_invalid_namespace_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::AssociateDataShareConsumerError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_data_share_consumer_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssociateDataShareConsumerOutput, crate::error::AssociateDataShareConsumerError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::associate_data_share_consumer_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_associate_data_share_consumer::de_associate_data_share_consumer(response.body().as_ref(), output).map_err(crate::error::AssociateDataShareConsumerError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_associate_data_share_consumer(inp: &[u8], mut builder: crate::output::associate_data_share_consumer_output::Builder) -> Result<crate::output::associate_data_share_consumer_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
