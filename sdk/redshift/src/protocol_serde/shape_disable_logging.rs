...
pub fn de_disable_logging_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_logging::DisableLoggingOutput, crate::operation::disable_logging::DisableLoggingError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_logging_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_logging::DisableLoggingOutput, crate::operation::disable_logging::DisableLoggingError> {
    Ok({
        #[allow(unused_mut)]
