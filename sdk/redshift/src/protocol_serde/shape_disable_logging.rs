...
pub fn de_disable_logging_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_logging::DisableLoggingOutput, crate::operation::disable_logging::DisableLoggingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::disable_logging::DisableLoggingError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cluster_not_found_fault::de_cluster_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::disable_logging::DisableLoggingError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_cluster_state_fault::de_invalid_cluster_state_fault_xml_err(_response_body, output).map_err(crate::operation::disable_logging::DisableLoggingError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unsupported_operation_fault::de_unsupported_operation_fault_xml_err(_response_body, output).map_err(crate::operation::disable_logging::DisableLoggingError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_logging_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_logging::DisableLoggingOutput, crate::operation::disable_logging::DisableLoggingError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::disable_logging::builders::DisableLoggingOutputBuilder::default();
        output = crate::protocol_serde::shape_disable_logging::de_disable_logging(_response_body, output).map_err(crate::operation::disable_logging::DisableLoggingError::unhandled)?;
