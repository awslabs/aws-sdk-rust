...
pub fn de_disable_logging_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisableLoggingOutput, crate::error::DisableLoggingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DisableLoggingError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_logging_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisableLoggingOutput, crate::error::DisableLoggingError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::disable_logging_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_disable_logging::de_disable_logging(response.body().as_ref(), output).map_err(crate::error::DisableLoggingError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_disable_logging(inp: &[u8], mut builder: crate::output::disable_logging_output::Builder) -> Result<crate::output::disable_logging_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
