...
pub fn de_cluster_associated_to_schedule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterAssociatedToSchedule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
