...
pub fn de_snapshot_copy_grant(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SnapshotCopyGrant, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
