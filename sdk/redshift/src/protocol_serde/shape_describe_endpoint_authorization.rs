...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_endpoint_authorization::de_describe_endpoint_authorization(_response_body, output)
            .map_err(crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeEndpointAuthorizationResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeEndpointAuthorizationResult got {start_el:?}"
            )));
        }
