...
pub fn de_create_cluster_parameter_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateClusterParameterGroupOutput, crate::error::CreateClusterParameterGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateClusterParameterGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cluster_parameter_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateClusterParameterGroupOutput, crate::error::CreateClusterParameterGroupError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_create_cluster_parameter_group(inp: &[u8], mut builder: crate::output::create_cluster_parameter_group_output::Builder) -> Result<crate::output::create_cluster_parameter_group_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
