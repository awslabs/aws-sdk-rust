...
pub fn de_create_cluster_parameter_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_cluster_parameter_group::CreateClusterParameterGroupOutput, crate::operation::create_cluster_parameter_group::CreateClusterParameterGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cluster_parameter_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_cluster_parameter_group::CreateClusterParameterGroupOutput, crate::operation::create_cluster_parameter_group::CreateClusterParameterGroupError> {
    Ok({
        #[allow(unused_mut)]
