...
pub fn ser_describe_clusters_input_input(input: &crate::operation::describe_clusters::DescribeClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
