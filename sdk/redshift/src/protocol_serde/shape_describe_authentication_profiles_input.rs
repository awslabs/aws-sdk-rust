...
pub fn ser_describe_authentication_profiles_input_input_input(
    input: &crate::operation::describe_authentication_profiles::DescribeAuthenticationProfilesInput,
