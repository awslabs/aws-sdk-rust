...
pub fn de_deauthorize_data_share_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::deauthorize_data_share::DeauthorizeDataShareOutput, crate::operation::deauthorize_data_share::DeauthorizeDataShareError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::deauthorize_data_share::DeauthorizeDataShareError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deauthorize_data_share_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::deauthorize_data_share::DeauthorizeDataShareOutput, crate::operation::deauthorize_data_share::DeauthorizeDataShareError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_deauthorize_data_share::de_deauthorize_data_share(response.body().as_ref(), output).map_err(crate::operation::deauthorize_data_share::DeauthorizeDataShareError::unhandled)?;
