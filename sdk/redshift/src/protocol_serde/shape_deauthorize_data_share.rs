...
pub fn de_deauthorize_data_share_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeauthorizeDataShareOutput, crate::error::DeauthorizeDataShareError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeauthorizeDataShareError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_data_share_fault::de_invalid_data_share_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::DeauthorizeDataShareError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deauthorize_data_share_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeauthorizeDataShareOutput, crate::error::DeauthorizeDataShareError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::deauthorize_data_share_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_deauthorize_data_share::de_deauthorize_data_share(response.body().as_ref(), output).map_err(crate::error::DeauthorizeDataShareError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_deauthorize_data_share(inp: &[u8], mut builder: crate::output::deauthorize_data_share_output::Builder) -> Result<crate::output::deauthorize_data_share_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
