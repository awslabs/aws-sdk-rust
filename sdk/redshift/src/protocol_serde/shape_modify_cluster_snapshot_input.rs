...
pub fn ser_modify_cluster_snapshot_input_input(input: &crate::input::ModifyClusterSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
