...
pub fn de_cluster_db_revision(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterDbRevision, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
