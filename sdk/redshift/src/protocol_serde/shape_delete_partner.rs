...
pub fn de_delete_partner_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_partner::DeletePartnerOutput, crate::operation::delete_partner::DeletePartnerError> {
    #[allow(unused_mut)]
...
pub fn de_delete_partner_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_partner::de_delete_partner(_response_body, output)
            .map_err(crate::operation::delete_partner::DeletePartnerError::unhandled)?;
...
) -> Result<crate::operation::delete_partner::builders::DeletePartnerOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
