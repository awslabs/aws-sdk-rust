...
pub fn de_delete_partner_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeletePartnerOutput, crate::error::DeletePartnerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeletePartnerError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_partner_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeletePartnerOutput, crate::error::DeletePartnerError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_partner_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_partner::de_delete_partner(response.body().as_ref(), output).map_err(crate::error::DeletePartnerError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_partner(inp: &[u8], mut builder: crate::output::delete_partner_output::Builder) -> Result<crate::output::delete_partner_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
