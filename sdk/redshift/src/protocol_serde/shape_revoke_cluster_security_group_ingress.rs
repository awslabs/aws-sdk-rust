...
pub fn de_revoke_cluster_security_group_ingress_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError::unhandled)?;
    ...
    Err(match error_code {
        "AuthorizationNotFound" => {
            crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError::AuthorizationNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ClusterSecurityGroupNotFound" => {
            crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError::ClusterSecurityGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidClusterSecurityGroupState" => {
            crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError::InvalidClusterSecurityGroupStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_revoke_cluster_security_group_ingress_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_revoke_cluster_security_group_ingress::de_revoke_cluster_security_group_ingress(_response_body, output)
            .map_err(crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError::unhandled)?;
