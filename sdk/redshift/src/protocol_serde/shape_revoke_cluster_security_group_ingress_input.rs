...
pub fn ser_revoke_cluster_security_group_ingress_input_input_input(input: &crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
