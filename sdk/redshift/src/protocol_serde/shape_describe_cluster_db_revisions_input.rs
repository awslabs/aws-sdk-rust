...
pub fn ser_describe_cluster_db_revisions_input_input(input: &crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
