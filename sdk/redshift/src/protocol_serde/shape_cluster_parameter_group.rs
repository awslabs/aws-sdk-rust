...
pub fn de_cluster_parameter_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterParameterGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
