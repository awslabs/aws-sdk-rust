...
pub fn de_cluster_parameter_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ClusterParameterGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::ClusterParameterGroup::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("ParameterGroupFamily") /* ParameterGroupFamily com.amazonaws.redshift#ClusterParameterGroup$ParameterGroupFamily */ =>  {
                ...
                ;
                builder = builder.set_parameter_group_family(var_2);
            }
            ,
