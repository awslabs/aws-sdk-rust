...
#[allow(unused_mut)]
pub fn ser_lake_formation_scope_union(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LakeFormationScopeUnion) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::LakeFormationScopeUnion::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("LakeFormationScopeUnion"))
    }
    Ok(())
}

pub fn de_lake_formation_scope_union(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LakeFormationScopeUnion, ::aws_smithy_xml::decode::XmlDecodeError> {
