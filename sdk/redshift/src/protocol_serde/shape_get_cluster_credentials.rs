...
pub fn de_get_cluster_credentials_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetClusterCredentialsOutput, crate::error::GetClusterCredentialsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetClusterCredentialsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_cluster_credentials_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetClusterCredentialsOutput, crate::error::GetClusterCredentialsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_cluster_credentials_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_cluster_credentials::de_get_cluster_credentials(response.body().as_ref(), output).map_err(crate::error::GetClusterCredentialsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_cluster_credentials(inp: &[u8], mut builder: crate::output::get_cluster_credentials_output::Builder) -> Result<crate::output::get_cluster_credentials_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
