...
pub fn de_describe_hsm_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeHsmConfigurationsOutput, crate::error::DescribeHsmConfigurationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeHsmConfigurationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_hsm_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeHsmConfigurationsOutput, crate::error::DescribeHsmConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_describe_hsm_configurations(inp: &[u8], mut builder: crate::output::describe_hsm_configurations_output::Builder) -> Result<crate::output::describe_hsm_configurations_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
