...
pub fn de_describe_hsm_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsOutput, crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_hsm_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsOutput, crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
