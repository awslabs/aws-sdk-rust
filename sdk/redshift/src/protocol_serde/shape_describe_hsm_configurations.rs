...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "HsmConfigurationNotFoundFault" => {
            crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError::HsmConfigurationNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_hsm_configurations::de_describe_hsm_configurations(_response_body, output)
            .map_err(crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeHsmConfigurationsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeHsmConfigurationsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeHsmConfigurationsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeHsmConfigurationsResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("HsmConfigurations") /* HsmConfigurations com.amazonaws.redshift.synthetic#DescribeHsmConfigurationsOutput$HsmConfigurations */ =>  {
                let var_2 =
                    Some(
                        crate::protocol_serde::shape_hsm_configuration_list::de_hsm_configuration_list(&mut tag, depth + 1)
                        ?
                    )
                ;
