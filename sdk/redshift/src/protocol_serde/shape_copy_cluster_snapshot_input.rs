...
pub fn ser_copy_cluster_snapshot_input_input(input: &crate::input::CopyClusterSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
