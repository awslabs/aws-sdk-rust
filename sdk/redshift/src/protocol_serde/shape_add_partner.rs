...
pub fn de_add_partner_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::add_partner::AddPartnerOutput, crate::operation::add_partner::AddPartnerError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_partner_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::add_partner::AddPartnerOutput, crate::operation::add_partner::AddPartnerError> {
...
#[allow(unused_mut)]
pub fn de_add_partner(
    inp: &[u8],
    mut builder: crate::operation::add_partner::builders::AddPartnerOutputBuilder,
) -> std::result::Result<crate::operation::add_partner::builders::AddPartnerOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("AddPartnerResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AddPartnerResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("AddPartnerResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected AddPartnerResult got {start_el:?}"
            )));
        }
