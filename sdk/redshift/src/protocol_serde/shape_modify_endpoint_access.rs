...
pub fn de_modify_endpoint_access_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_endpoint_access::ModifyEndpointAccessOutput, crate::operation::modify_endpoint_access::ModifyEndpointAccessError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cluster_not_found_fault::de_cluster_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_endpoint_not_found_fault::de_endpoint_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_cluster_state_fault::de_invalid_cluster_state_fault_xml_err(_response_body, output).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_endpoint_state_fault::de_invalid_endpoint_state_fault_xml_err(_response_body, output).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unauthorized_operation::de_unauthorized_operation_xml_err(_response_body, output).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_endpoint_access_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_endpoint_access::ModifyEndpointAccessOutput, crate::operation::modify_endpoint_access::ModifyEndpointAccessError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_endpoint_access::builders::ModifyEndpointAccessOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_endpoint_access::de_modify_endpoint_access(_response_body, output).map_err(crate::operation::modify_endpoint_access::ModifyEndpointAccessError::unhandled)?;
