...
pub fn ser_create_hsm_configuration_input_input(input: &crate::input::CreateHsmConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
