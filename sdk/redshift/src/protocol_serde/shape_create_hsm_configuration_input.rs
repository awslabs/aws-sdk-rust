...
pub fn ser_create_hsm_configuration_input_input_input(input: &crate::operation::create_hsm_configuration::CreateHsmConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
