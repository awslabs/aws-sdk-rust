...
pub fn de_resume_cluster_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::resume_cluster::ResumeClusterOutput, crate::operation::resume_cluster::ResumeClusterError> {
    #[allow(unused_mut)]
...
pub fn de_resume_cluster_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_resume_cluster::de_resume_cluster(_response_body, output)
            .map_err(crate::operation::resume_cluster::ResumeClusterError::unhandled)?;
...
pub fn de_resume_cluster(
    ...
    if !(start_el.matches("ResumeClusterResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ResumeClusterResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ResumeClusterResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ResumeClusterResult got {start_el:?}"
            )));
        }
