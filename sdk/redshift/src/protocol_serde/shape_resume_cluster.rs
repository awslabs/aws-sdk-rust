...
pub fn de_resume_cluster_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ResumeClusterOutput, crate::error::ResumeClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ResumeClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_resume_cluster_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ResumeClusterOutput, crate::error::ResumeClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::resume_cluster_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_resume_cluster::de_resume_cluster(response.body().as_ref(), output).map_err(crate::error::ResumeClusterError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_resume_cluster(inp: &[u8], mut builder: crate::output::resume_cluster_output::Builder) -> Result<crate::output::resume_cluster_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
