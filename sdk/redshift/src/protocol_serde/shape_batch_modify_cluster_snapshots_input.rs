...
pub fn ser_batch_modify_cluster_snapshots_input_input(input: &crate::input::BatchModifyClusterSnapshotsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
