...
pub fn ser_batch_modify_cluster_snapshots_input_input_input(input: &crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
