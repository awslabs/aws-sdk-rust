...
#[allow(unused_mut)]
pub fn ser_resize_cluster_message(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ResizeClusterMessage) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
