...
pub fn ser_restore_from_cluster_snapshot_input_input_input(input: &crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
