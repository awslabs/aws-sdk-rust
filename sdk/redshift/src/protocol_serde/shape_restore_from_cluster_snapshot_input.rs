...
pub fn ser_restore_from_cluster_snapshot_input_input(input: &crate::input::RestoreFromClusterSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
