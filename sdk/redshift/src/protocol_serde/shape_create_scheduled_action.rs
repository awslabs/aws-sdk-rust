...
pub fn de_create_scheduled_action_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateScheduledActionOutput, crate::error::CreateScheduledActionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateScheduledActionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_scheduled_action_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateScheduledActionOutput, crate::error::CreateScheduledActionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_scheduled_action_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_scheduled_action::de_create_scheduled_action(response.body().as_ref(), output).map_err(crate::error::CreateScheduledActionError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_scheduled_action(inp: &[u8], mut builder: crate::output::create_scheduled_action_output::Builder) -> Result<crate::output::create_scheduled_action_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
