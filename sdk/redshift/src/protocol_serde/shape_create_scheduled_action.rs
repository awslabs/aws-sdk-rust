    ...
    Err(match error_code {
        ...
        "ScheduledActionAlreadyExists" => crate::operation::create_scheduled_action::CreateScheduledActionError::ScheduledActionAlreadyExistsFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_scheduled_action_already_exists_fault::de_scheduled_action_already_exists_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_scheduled_action::CreateScheduledActionError::unhandled)?;
        ...
        "ScheduledActionQuotaExceeded" => crate::operation::create_scheduled_action::CreateScheduledActionError::ScheduledActionQuotaExceededFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_scheduled_action_quota_exceeded_fault::de_scheduled_action_quota_exceeded_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_scheduled_action::CreateScheduledActionError::unhandled)?;
        ...
        "ScheduledActionTypeUnsupported" => {
            crate::operation::create_scheduled_action::CreateScheduledActionError::ScheduledActionTypeUnsupportedFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> Result<crate::operation::create_scheduled_action::builders::CreateScheduledActionOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
