...
pub fn ser_get_reserved_node_exchange_offerings_input_input(input: &crate::input::GetReservedNodeExchangeOfferingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
