...
pub fn de_describe_partners_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_partners::DescribePartnersOutput, crate::operation::describe_partners::DescribePartnersError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_partners_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_partners::DescribePartnersOutput, crate::operation::describe_partners::DescribePartnersError> {
    Ok({
        #[allow(unused_mut)]
