...
pub fn de_describe_partners(
...
) -> std::result::Result<crate::operation::describe_partners::builders::DescribePartnersOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribePartnersResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribePartnersResult got {start_el:?}"
            )));
        }
