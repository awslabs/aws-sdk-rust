...
pub fn de_delete_authentication_profile_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileOutput, crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_authentication_profile_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileOutput, crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError> {
    Ok({
        #[allow(unused_mut)]
