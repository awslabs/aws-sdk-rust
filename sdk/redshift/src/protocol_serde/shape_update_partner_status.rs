...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_partner_status_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_partner_status::UpdatePartnerStatusOutput, crate::operation::update_partner_status::UpdatePartnerStatusError> {
    Ok({
        #[allow(unused_mut)]
