...
pub fn de_update_partner_status_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_partner_status::UpdatePartnerStatusOutput, crate::operation::update_partner_status::UpdatePartnerStatusError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "UnsupportedOperation" => crate::operation::update_partner_status::UpdatePartnerStatusError::UnsupportedOperationFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::UnsupportedOperationFaultBuilder::default();
                    output = crate::protocol_serde::shape_unsupported_operation_fault::de_unsupported_operation_fault_xml_err(_response_body, output).map_err(crate::operation::update_partner_status::UpdatePartnerStatusError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_partner_status_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_partner_status::UpdatePartnerStatusOutput, crate::operation::update_partner_status::UpdatePartnerStatusError> {
    Ok({
        #[allow(unused_mut)]
