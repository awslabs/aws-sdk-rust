...
) -> std::result::Result<crate::operation::update_partner_status::builders::UpdatePartnerStatusOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("UpdatePartnerStatusResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected UpdatePartnerStatusResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("UpdatePartnerStatusResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected UpdatePartnerStatusResult got {start_el:?}"
            )));
        }
