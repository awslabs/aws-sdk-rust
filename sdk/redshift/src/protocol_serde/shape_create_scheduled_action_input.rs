...
pub fn ser_create_scheduled_action_input_input_input(input: &crate::operation::create_scheduled_action::CreateScheduledActionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
