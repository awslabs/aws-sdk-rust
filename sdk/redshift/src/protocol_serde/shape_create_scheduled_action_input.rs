...
pub fn ser_create_scheduled_action_input_input(input: &crate::input::CreateScheduledActionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
