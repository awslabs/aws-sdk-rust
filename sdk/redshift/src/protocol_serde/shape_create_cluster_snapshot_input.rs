...
pub fn ser_create_cluster_snapshot_input_input_input(input: &crate::operation::create_cluster_snapshot::CreateClusterSnapshotInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
