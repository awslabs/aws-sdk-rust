...
pub fn de_describe_resize_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_resize::DescribeResizeOutput, crate::operation::describe_resize::DescribeResizeError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_resize_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_resize::DescribeResizeOutput, crate::operation::describe_resize::DescribeResizeError> {
    Ok({
        #[allow(unused_mut)]
