...
pub fn de_describe_resize_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeResizeOutput, crate::error::DescribeResizeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeResizeError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_cluster_not_found_fault::de_cluster_not_found_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::DescribeResizeError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resize_not_found_fault::de_resize_not_found_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::DescribeResizeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_resize_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeResizeOutput, crate::error::DescribeResizeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_resize_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_resize::de_describe_resize(response.body().as_ref(), output).map_err(crate::error::DescribeResizeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_resize(inp: &[u8], mut builder: crate::output::describe_resize_output::Builder) -> Result<crate::output::describe_resize_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
