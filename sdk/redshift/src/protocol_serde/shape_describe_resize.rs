...
pub fn de_describe_resize_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_resize::DescribeResizeOutput, crate::operation::describe_resize::DescribeResizeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_resize::DescribeResizeError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unsupported_operation_fault::de_unsupported_operation_fault_xml_err(_response_body, output).map_err(crate::operation::describe_resize::DescribeResizeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_resize_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_resize::DescribeResizeOutput, crate::operation::describe_resize::DescribeResizeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_resize::builders::DescribeResizeOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_resize::de_describe_resize(_response_body, output).map_err(crate::operation::describe_resize::DescribeResizeError::unhandled)?;
