...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidSnapshotCopyGrantStateFault" => {
            crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantError::InvalidSnapshotCopyGrantStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidSnapshotCopyGrantStateFaultBuilder::default();
                    output =
                        crate::protocol_serde::shape_invalid_snapshot_copy_grant_state_fault::de_invalid_snapshot_copy_grant_state_fault_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantError::unhandled)?;
        ...
        "SnapshotCopyGrantNotFoundFault" => {
            crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantError::SnapshotCopyGrantNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_snapshot_copy_grant_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
