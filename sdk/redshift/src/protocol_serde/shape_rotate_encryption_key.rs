...
> {
    ...
    Err(match error_code {
        ...
        "DependentServiceRequestThrottlingFault" => {
            crate::operation::rotate_encryption_key::RotateEncryptionKeyError::DependentServiceRequestThrottlingFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_rotate_encryption_key::de_rotate_encryption_key(_response_body, output)
            .map_err(crate::operation::rotate_encryption_key::RotateEncryptionKeyError::unhandled)?;
...
) -> std::result::Result<crate::operation::rotate_encryption_key::builders::RotateEncryptionKeyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("RotateEncryptionKeyResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected RotateEncryptionKeyResult got {start_el:?}"
            )));
        }
