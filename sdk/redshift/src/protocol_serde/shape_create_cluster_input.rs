...
pub fn ser_create_cluster_input_input_input(input: &crate::operation::create_cluster::CreateClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
