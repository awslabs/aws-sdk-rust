...
pub fn de_cluster_subnet_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterSubnetGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
