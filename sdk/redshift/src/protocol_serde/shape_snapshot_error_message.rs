...
pub fn de_snapshot_error_message(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SnapshotErrorMessage, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
