...
pub fn ser_modify_cluster_db_revision_input_input(input: &crate::operation::modify_cluster_db_revision::ModifyClusterDbRevisionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
