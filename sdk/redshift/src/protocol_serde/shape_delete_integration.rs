...
pub fn de_delete_integration(
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            match tag.start_el() {
            s if s.matches("IntegrationArn") /* IntegrationArn com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$IntegrationArn */ =>  {
                let var_1 =
                    Some(
            ...
            ,
            s if s.matches("IntegrationName") /* IntegrationName com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$IntegrationName */ =>  {
                let var_2 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            ,
            s if s.matches("SourceArn") /* SourceArn com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$SourceArn */ =>  {
                let var_3 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            ,
            s if s.matches("TargetArn") /* TargetArn com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$TargetArn */ =>  {
                let var_4 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            ,
            s if s.matches("Status") /* Status com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$Status */ =>  {
                let var_5 =
                    Some(
            ...
            ,
            s if s.matches("Errors") /* Errors com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$Errors */ =>  {
                let var_6 =
                    Some(
            ...
            ,
            s if s.matches("CreateTime") /* CreateTime com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$CreateTime */ =>  {
                let var_7 =
                    Some(
            ...
            ,
            s if s.matches("Description") /* Description com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$Description */ =>  {
                let var_8 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            ,
            s if s.matches("KMSKeyId") /* KMSKeyId com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$KMSKeyId */ =>  {
                let var_9 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            ,
            s if s.matches("AdditionalEncryptionContext") /* AdditionalEncryptionContext com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$AdditionalEncryptionContext */ =>  {
                let var_10 =
                    Some(
            ...
            ,
            s if s.matches("Tags") /* Tags com.amazonaws.redshift.synthetic#DeleteIntegrationOutput$Tags */ =>  {
                let var_11 =
                    Some(
