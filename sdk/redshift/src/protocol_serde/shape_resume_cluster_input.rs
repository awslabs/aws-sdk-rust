...
pub fn ser_resume_cluster_input_input(input: &crate::input::ResumeClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
