...
pub fn de_reserved_node_configuration_option(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedNodeConfigurationOption, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
