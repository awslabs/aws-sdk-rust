...
pub fn de_enable_logging_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::EnableLoggingOutput, crate::error::EnableLoggingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::EnableLoggingError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_logging_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::EnableLoggingOutput, crate::error::EnableLoggingError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::enable_logging_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_enable_logging::de_enable_logging(response.body().as_ref(), output).map_err(crate::error::EnableLoggingError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_enable_logging(inp: &[u8], mut builder: crate::output::enable_logging_output::Builder) -> Result<crate::output::enable_logging_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
