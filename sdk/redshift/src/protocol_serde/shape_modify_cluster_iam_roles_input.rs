...
pub fn ser_modify_cluster_iam_roles_input_input_input(input: &crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
