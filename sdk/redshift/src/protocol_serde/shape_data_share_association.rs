...
pub fn de_data_share_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DataShareAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
