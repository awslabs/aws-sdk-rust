...
pub fn de_authorize_endpoint_access_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AuthorizeEndpointAccessOutput, crate::error::AuthorizeEndpointAccessError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AuthorizeEndpointAccessError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_endpoint_access_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AuthorizeEndpointAccessOutput, crate::error::AuthorizeEndpointAccessError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::authorize_endpoint_access_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_authorize_endpoint_access::de_authorize_endpoint_access(response.body().as_ref(), output).map_err(crate::error::AuthorizeEndpointAccessError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_authorize_endpoint_access(inp: &[u8], mut builder: crate::output::authorize_endpoint_access_output::Builder) -> Result<crate::output::authorize_endpoint_access_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
