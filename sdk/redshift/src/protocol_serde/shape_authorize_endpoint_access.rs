...
pub fn de_authorize_endpoint_access_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessOutput, crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_endpoint_access_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessOutput, crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError> {
    Ok({
        #[allow(unused_mut)]
