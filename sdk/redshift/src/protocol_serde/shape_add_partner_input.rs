...
pub fn ser_add_partner_input_input(input: &crate::input::AddPartnerInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
