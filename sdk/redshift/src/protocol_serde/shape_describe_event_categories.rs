...
pub fn de_describe_event_categories_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_event_categories_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::DescribeEventCategoriesOutput,
    crate::error::DescribeEventCategoriesError,
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_describe_event_categories::de_describe_event_categories(
