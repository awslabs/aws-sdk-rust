...
pub fn ser_create_endpoint_access_input_input_input(input: &crate::operation::create_endpoint_access::CreateEndpointAccessInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
