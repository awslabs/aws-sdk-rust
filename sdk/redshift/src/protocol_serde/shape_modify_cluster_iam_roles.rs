...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_cluster_iam_roles::de_modify_cluster_iam_roles(_response_body, output)
            .map_err(crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError::unhandled)?;
...
) -> Result<crate::operation::modify_cluster_iam_roles::builders::ModifyClusterIamRolesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
