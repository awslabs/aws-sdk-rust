...
pub fn de_modify_cluster_iam_roles_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesOutput, crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_cluster_iam_roles_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesOutput, crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_cluster_iam_roles::builders::ModifyClusterIamRolesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_cluster_iam_roles::de_modify_cluster_iam_roles(response.body().as_ref(), output).map_err(crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError::unhandled)?;
