...
pub fn ser_delete_cluster_input_input(input: &crate::input::DeleteClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
