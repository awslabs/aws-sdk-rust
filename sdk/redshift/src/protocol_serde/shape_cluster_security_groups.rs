...
pub fn de_cluster_security_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ClusterSecurityGroup>, aws_smithy_xml::decode::XmlDecodeError> {
