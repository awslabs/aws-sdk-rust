...
pub fn de_create_custom_domain_association_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_custom_domain_association_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    ...
    if !(start_el.matches("CreateCustomDomainAssociationResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateCustomDomainAssociationResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateCustomDomainAssociationResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateCustomDomainAssociationResult got {start_el:?}"
            )));
        }
        ...
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(
            "expected CreateCustomDomainAssociationResult tag",
        ));
    };
    Ok(builder)
}
