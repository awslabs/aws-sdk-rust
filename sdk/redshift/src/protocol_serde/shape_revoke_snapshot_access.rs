...
pub fn de_revoke_snapshot_access_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput, crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_revoke_snapshot_access_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput, crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError> {
    Ok({
        #[allow(unused_mut)]
