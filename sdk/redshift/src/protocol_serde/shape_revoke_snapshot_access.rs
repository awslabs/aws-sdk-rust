...
pub fn de_revoke_snapshot_access_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput, crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_revoke_snapshot_access_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput, crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::revoke_snapshot_access::builders::RevokeSnapshotAccessOutputBuilder::default();
        output = crate::protocol_serde::shape_revoke_snapshot_access::de_revoke_snapshot_access(_response_body, output).map_err(crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError::unhandled)?;
