...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_data_shares_for_producer::de_describe_data_shares_for_producer(_response_body, output)
            .map_err(crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDataSharesForProducerResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDataSharesForProducerResult got {start_el:?}"
            )));
        }
