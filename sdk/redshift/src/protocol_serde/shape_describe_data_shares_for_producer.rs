...
pub fn de_describe_data_shares_for_producer_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerOutput, crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_namespace_fault::de_invalid_namespace_fault_xml_err(_response_body, output).map_err(crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_data_shares_for_producer_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerOutput, crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_describe_data_shares_for_producer::de_describe_data_shares_for_producer(_response_body, output).map_err(crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError::unhandled)?;
