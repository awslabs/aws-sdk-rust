...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_authentication_profile_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_authentication_profile::CreateAuthenticationProfileOutput, crate::operation::create_authentication_profile::CreateAuthenticationProfileError> {
    Ok({
        #[allow(unused_mut)]
