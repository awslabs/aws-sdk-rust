...
#[allow(unused_mut)]
pub fn de_delete_cluster(inp: &[u8], mut builder: crate::output::delete_cluster_output::Builder) -> Result<crate::output::delete_cluster_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
