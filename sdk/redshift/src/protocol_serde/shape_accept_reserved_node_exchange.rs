...
pub fn de_accept_reserved_node_exchange_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AcceptReservedNodeExchangeOutput, crate::error::AcceptReservedNodeExchangeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AcceptReservedNodeExchangeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_accept_reserved_node_exchange_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AcceptReservedNodeExchangeOutput, crate::error::AcceptReservedNodeExchangeError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_accept_reserved_node_exchange(inp: &[u8], mut builder: crate::output::accept_reserved_node_exchange_output::Builder) -> Result<crate::output::accept_reserved_node_exchange_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
