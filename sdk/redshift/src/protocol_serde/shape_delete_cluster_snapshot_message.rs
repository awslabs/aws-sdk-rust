...
#[allow(unused_mut)]
pub fn ser_delete_cluster_snapshot_message(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DeleteClusterSnapshotMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
