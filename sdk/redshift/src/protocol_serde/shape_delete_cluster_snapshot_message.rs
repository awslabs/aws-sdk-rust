...
#[allow(unused_mut)]
pub fn ser_delete_cluster_snapshot_message(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DeleteClusterSnapshotMessage) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
