...
pub fn ser_modify_usage_limit_input_input(input: &crate::input::ModifyUsageLimitInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
