...
pub fn de_modify_usage_limit_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::modify_usage_limit::ModifyUsageLimitOutput, crate::operation::modify_usage_limit::ModifyUsageLimitError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "InvalidUsageLimit" => crate::operation::modify_usage_limit::ModifyUsageLimitError::InvalidUsageLimitFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_usage_limit_fault::de_invalid_usage_limit_fault_xml_err(_response_body, output)
                    .map_err(crate::operation::modify_usage_limit::ModifyUsageLimitError::unhandled)?;
...
pub fn de_modify_usage_limit_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_usage_limit::de_modify_usage_limit(_response_body, output)
            .map_err(crate::operation::modify_usage_limit::ModifyUsageLimitError::unhandled)?;
