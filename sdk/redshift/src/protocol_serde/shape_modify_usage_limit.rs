...
pub fn de_modify_usage_limit_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_usage_limit::ModifyUsageLimitOutput, crate::operation::modify_usage_limit::ModifyUsageLimitError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::modify_usage_limit::ModifyUsageLimitError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_usage_limit_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_usage_limit::ModifyUsageLimitOutput, crate::operation::modify_usage_limit::ModifyUsageLimitError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_usage_limit::builders::ModifyUsageLimitOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_usage_limit::de_modify_usage_limit(response.body().as_ref(), output).map_err(crate::operation::modify_usage_limit::ModifyUsageLimitError::unhandled)?;
