...
pub fn de_modify_usage_limit_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyUsageLimitOutput, crate::error::ModifyUsageLimitError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyUsageLimitError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_usage_limit_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyUsageLimitOutput, crate::error::ModifyUsageLimitError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::modify_usage_limit_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_usage_limit::de_modify_usage_limit(response.body().as_ref(), output).map_err(crate::error::ModifyUsageLimitError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_usage_limit(inp: &[u8], mut builder: crate::output::modify_usage_limit_output::Builder) -> Result<crate::output::modify_usage_limit_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
