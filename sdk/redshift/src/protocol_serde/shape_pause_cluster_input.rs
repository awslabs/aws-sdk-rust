...
pub fn ser_pause_cluster_input_input(input: &crate::input::PauseClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
