...
pub fn ser_resize_cluster_input_input(input: &crate::input::ResizeClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
