...
pub fn ser_resize_cluster_input_input_input(input: &crate::operation::resize_cluster::ResizeClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
