...
pub fn ser_describe_scheduled_actions_input_input_input(input: &crate::operation::describe_scheduled_actions::DescribeScheduledActionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
