...
pub fn ser_describe_reserved_nodes_input_input(input: &crate::input::DescribeReservedNodesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
