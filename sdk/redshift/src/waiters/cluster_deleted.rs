...
impl ClusterDeletedFluentBuilder {
    ...
    ) -> ::std::result::Result<crate::waiters::cluster_deleted::ClusterDeletedFinalPoll, crate::waiters::cluster_deleted::WaitUntilClusterDeletedError>
    {
        ...
        >| {
            ...
            // Matches: {"output":{"path":"Clusters[].ClusterStatus","expected":"creating","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_clusters_578c8eab71e8a5d97(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"Clusters[].ClusterStatus","expected":"modifying","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_clusters_fdd41c9d20f5639c9(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
