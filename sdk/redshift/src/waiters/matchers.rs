...
pub(crate) fn match_describe_clusters_d94f699084f934f23(
    ...
    fn path_traversal<'a>(
        ...
        let _prj_3 = _fld_1
            .iter()
            .flat_map(|v| {
                fn map(v: &crate::types::Cluster) -> ::std::option::Option<&::std::string::String> {
                    let _fld_2 = v.cluster_status.as_ref()?;
...
pub(crate) fn match_describe_clusters_99b2faa1a0233f771(
    ...
    fn path_traversal<'a>(
        ...
        let _prj_4 = _fld_1
            ...
            .flat_map(|v| {
                fn map(v: &crate::types::Cluster) -> ::std::option::Option<&::std::string::String> {
                    let _fld_2 = v.restore_status.as_ref()?;
...
pub(crate) fn match_describe_cluster_snapshots_9940112fa5e89d7d9(
    ...
    fn path_traversal<'a>(
        ...
        let _prj_3 = _fld_1
            .iter()
            .flat_map(|v| {
                fn map(v: &crate::types::Snapshot) -> ::std::option::Option<&::std::string::String> {
