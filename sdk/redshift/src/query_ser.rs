...
#[allow(unused_mut)]
pub fn serialize_structure_delete_cluster_snapshot_message(
...
#[allow(unused_mut)]
pub fn serialize_structure_scheduled_action_type(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_10) = &input.resize_cluster {
        crate::query_ser::serialize_structure_resize_cluster_message(scope_9, var_10);
    }
    #[allow(unused_mut)]
    let mut scope_11 = writer.prefix("PauseCluster");
    if let Some(var_12) = &input.pause_cluster {
        crate::query_ser::serialize_structure_pause_cluster_message(scope_11, var_12);
    }
    #[allow(unused_mut)]
    let mut scope_13 = writer.prefix("ResumeCluster");
    if let Some(var_14) = &input.resume_cluster {
        crate::query_ser::serialize_structure_resume_cluster_message(scope_13, var_14);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_snapshot_sorting_entity(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_node_configuration_options_filter(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_scheduled_action_filter(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_resize_cluster_message(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_pause_cluster_message(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_resume_cluster_message(
    mut writer: smithy_query::QueryValueWriter,
