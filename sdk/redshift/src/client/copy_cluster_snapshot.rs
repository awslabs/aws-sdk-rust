...
impl super::Client {
    ...
    ///   - [`source_snapshot_cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::source_snapshot_cluster_identifier) / [`set_source_snapshot_cluster_identifier(Option<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::set_source_snapshot_cluster_identifier): <p>The identifier of the cluster the source snapshot was created from. This parameter is required if your IAM user has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.</p>  <p>Constraints:</p>  <ul>   <li> <p>Must be the identifier for a valid cluster.</p> </li>  </ul>
