...
impl super::Client {
    ...
    ///   - [`source_snapshot_identifier(impl ::std::convert::Into<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::source_snapshot_identifier) / [`set_source_snapshot_identifier(Option<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::set_source_snapshot_identifier): <p>The identifier for the source snapshot.</p>  <p>Constraints:</p>  <ul>   <li> <p>Must be the identifier for a valid automated snapshot whose state is <code>available</code>.</p> </li>  </ul>
    ///   - [`source_snapshot_cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::source_snapshot_cluster_identifier) / [`set_source_snapshot_cluster_identifier(Option<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::set_source_snapshot_cluster_identifier): <p>The identifier of the cluster the source snapshot was created from. This parameter is required if your IAM user or role has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.</p>  <p>Constraints:</p>  <ul>   <li> <p>Must be the identifier for a valid cluster.</p> </li>  </ul>
    ///   - [`target_snapshot_identifier(impl ::std::convert::Into<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::target_snapshot_identifier) / [`set_target_snapshot_identifier(Option<String>)`](crate::operation::copy_cluster_snapshot::builders::CopyClusterSnapshotFluentBuilder::set_target_snapshot_identifier): <p>The identifier given to the new manual snapshot.</p>  <p>Constraints:</p>  <ul>   <li> <p>Cannot be null, empty, or blank.</p> </li>   <li> <p>Must contain from 1 to 255 alphanumeric characters or hyphens.</p> </li>   <li> <p>First character must be a letter.</p> </li>   <li> <p>Cannot end with a hyphen or contain two consecutive hyphens.</p> </li>   <li> <p>Must be unique for the Amazon Web Services account that is making the request.</p> </li>  </ul>
