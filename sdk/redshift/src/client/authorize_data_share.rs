...
impl super::Client {
    ...
    ///   - [`data_share_arn(impl ::std::convert::Into<String>)`](crate::operation::authorize_data_share::builders::AuthorizeDataShareFluentBuilder::data_share_arn) / [`set_data_share_arn(Option<String>)`](crate::operation::authorize_data_share::builders::AuthorizeDataShareFluentBuilder::set_data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare that producers are to authorize sharing for.</p>
    ///   - [`consumer_identifier(impl ::std::convert::Into<String>)`](crate::operation::authorize_data_share::builders::AuthorizeDataShareFluentBuilder::consumer_identifier) / [`set_consumer_identifier(Option<String>)`](crate::operation::authorize_data_share::builders::AuthorizeDataShareFluentBuilder::set_consumer_identifier): <p>The identifier of the data consumer that is authorized to access the datashare. This identifier is an Amazon Web Services account ID or a keyword, such as ADX.</p>
    ...
    pub fn authorize_data_share(
        &self,
    ) -> crate::operation::authorize_data_share::builders::AuthorizeDataShareFluentBuilder {
        crate::operation::authorize_data_share::builders::AuthorizeDataShareFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
