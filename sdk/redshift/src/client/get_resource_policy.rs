...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::get_resource_policy::builders::GetResourcePolicyFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_resource_policy::builders::GetResourcePolicyFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the resource of which its resource policy is fetched.</p><br>
    ...
    ///   - [`resource_policy(Option<ResourcePolicy>)`](crate::operation::get_resource_policy::GetResourcePolicyOutput::resource_policy): <p>The content of the resource policy.</p>
