...
impl super::Client {
    ...
    ///   - [`total_backup_size_in_mega_bytes(Option<f64>)`](crate::operation::describe_storage::DescribeStorageOutput::total_backup_size_in_mega_bytes): <p>The total amount of storage currently used for snapshots.</p>
    ///   - [`total_provisioned_storage_in_mega_bytes(Option<f64>)`](crate::operation::describe_storage::DescribeStorageOutput::total_provisioned_storage_in_mega_bytes): <p>The total amount of storage currently provisioned.</p>
