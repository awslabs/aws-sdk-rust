...
impl super::Client {
    ...
    ///   - [`cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::disable_logging::builders::DisableLoggingFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::disable_logging::builders::DisableLoggingFluentBuilder::set_cluster_identifier): <p>The identifier of the cluster on which logging is to be stopped.</p>  <p>Example: <code>examplecluster</code> </p>
