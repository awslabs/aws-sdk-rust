...
impl super::Client {
    ...
    ///   - [`cluster_identifier(impl Into<String>)`](crate::operation::reboot_cluster::builders::RebootClusterFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::reboot_cluster::builders::RebootClusterFluentBuilder::set_cluster_identifier):<br>required: **true**<br><p>The cluster identifier.</p><br>
