...
impl super::Client {
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::describe_table_restore_status::builders::DescribeTableRestoreStatusFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_table_restore_status::builders::DescribeTableRestoreStatusFluentBuilder::set_marker): <p>An optional pagination token provided by a previous <code>DescribeTableRestoreStatus</code> request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by the <code>MaxRecords</code> parameter.</p>
