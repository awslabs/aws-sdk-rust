...
impl super::Client {
    ...
    ///   - [`vpc_ids(impl Into<String>)`](crate::operation::authorize_endpoint_access::builders::AuthorizeEndpointAccessFluentBuilder::vpc_ids) / [`set_vpc_ids(Option<Vec<String>>)`](crate::operation::authorize_endpoint_access::builders::AuthorizeEndpointAccessFluentBuilder::set_vpc_ids): <p>The virtual private cloud (VPC) identifiers to grant access to.</p>
