...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::get_reserved_node_exchange_offerings::builders::GetReservedNodeExchangeOfferingsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::get_reserved_node_exchange_offerings::builders::GetReservedNodeExchangeOfferingsFluentBuilder::set_marker): <p>A value that indicates the starting point for the next set of ReservedNodeOfferings.</p>
