...
impl super::Client {
    ...
    ///   - [`custom_domain_name(impl Into<String>)`](crate::operation::create_custom_domain_association::builders::CreateCustomDomainAssociationFluentBuilder::custom_domain_name) / [`set_custom_domain_name(Option<String>)`](crate::operation::create_custom_domain_association::builders::CreateCustomDomainAssociationFluentBuilder::set_custom_domain_name): <p>The custom domain name for a custom domain association.</p>
    ///   - [`custom_domain_certificate_arn(impl Into<String>)`](crate::operation::create_custom_domain_association::builders::CreateCustomDomainAssociationFluentBuilder::custom_domain_certificate_arn) / [`set_custom_domain_certificate_arn(Option<String>)`](crate::operation::create_custom_domain_association::builders::CreateCustomDomainAssociationFluentBuilder::set_custom_domain_certificate_arn): <p>The certificate Amazon Resource Name (ARN) for the custom domain name association.</p>
