...
impl super::Client {
    ...
    ///   - [`data_share_arn(impl ::std::convert::Into<String>)`](crate::operation::reject_data_share::builders::RejectDataShareFluentBuilder::data_share_arn) / [`set_data_share_arn(Option<String>)`](crate::operation::reject_data_share::builders::RejectDataShareFluentBuilder::set_data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare to reject.</p>
