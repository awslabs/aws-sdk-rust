...
impl super::Client {
    ...
    ///   - [`data_share_arn(Option<String>)`](crate::operation::reject_data_share::RejectDataShareOutput::data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare that the consumer is to use.</p>
    ///   - [`producer_arn(Option<String>)`](crate::operation::reject_data_share::RejectDataShareOutput::producer_arn): <p>The Amazon Resource Name (ARN) of the producer namespace.</p>
