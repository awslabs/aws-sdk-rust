...
impl super::Client {
    ...
    ///   - [`source_type(impl ::std::convert::Into<String>)`](crate::operation::describe_event_categories::builders::DescribeEventCategoriesFluentBuilder::source_type) / [`set_source_type(Option<String>)`](crate::operation::describe_event_categories::builders::DescribeEventCategoriesFluentBuilder::set_source_type): <p>The source type, such as cluster or parameter group, to which the described event categories apply.</p>  <p>Valid values: cluster, cluster-snapshot, cluster-parameter-group, cluster-security-group, and scheduled-action.</p>
