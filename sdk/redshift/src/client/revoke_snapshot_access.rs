...
impl super::Client {
    ...
    ///   - [`snapshot_arn(impl Into<String>)`](crate::operation::revoke_snapshot_access::builders::RevokeSnapshotAccessFluentBuilder::snapshot_arn) / [`set_snapshot_arn(Option<String>)`](crate::operation::revoke_snapshot_access::builders::RevokeSnapshotAccessFluentBuilder::set_snapshot_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the snapshot associated with the message to revoke access.</p><br>
