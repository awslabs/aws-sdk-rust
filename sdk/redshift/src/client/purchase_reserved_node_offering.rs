...
impl super::Client {
    ...
    ///   - [`reserved_node_offering_id(impl Into<String>)`](crate::operation::purchase_reserved_node_offering::builders::PurchaseReservedNodeOfferingFluentBuilder::reserved_node_offering_id) / [`set_reserved_node_offering_id(Option<String>)`](crate::operation::purchase_reserved_node_offering::builders::PurchaseReservedNodeOfferingFluentBuilder::set_reserved_node_offering_id):<br>required: **true**<br><p>The unique identifier of the reserved node offering you want to purchase.</p><br>
    ///   - [`node_count(i32)`](crate::operation::purchase_reserved_node_offering::builders::PurchaseReservedNodeOfferingFluentBuilder::node_count) / [`set_node_count(Option<i32>)`](crate::operation::purchase_reserved_node_offering::builders::PurchaseReservedNodeOfferingFluentBuilder::set_node_count):<br>required: **false**<br><p>The number of reserved nodes that you want to purchase.</p> <p>Default: <code>1</code></p><br>
