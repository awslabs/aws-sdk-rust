...
impl super::Client {
    ...
    ///   - [`cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::rotate_encryption_key::builders::RotateEncryptionKeyFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::rotate_encryption_key::builders::RotateEncryptionKeyFluentBuilder::set_cluster_identifier): <p>The unique identifier of the cluster that you want to rotate the encryption keys for.</p>  <p>Constraints: Must be the name of valid cluster that has encryption enabled.</p>
