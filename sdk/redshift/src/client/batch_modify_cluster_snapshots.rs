...
impl super::Client {
    ...
    ///   - [`force(bool)`](crate::operation::batch_modify_cluster_snapshots::builders::BatchModifyClusterSnapshotsFluentBuilder::force) / [`set_force(Option<bool>)`](crate::operation::batch_modify_cluster_snapshots::builders::BatchModifyClusterSnapshotsFluentBuilder::set_force):<br>required: **false**<br><p>A boolean value indicating whether to override an exception if the retention period has passed.</p><br>
