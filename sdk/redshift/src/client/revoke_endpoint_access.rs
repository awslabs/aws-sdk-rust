...
impl super::Client {
    ...
    ///   - [`cluster_identifier(impl Into<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::set_cluster_identifier):<br>required: **false**<br><p>The cluster to revoke access from.</p><br>
    ///   - [`account(impl Into<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::account) / [`set_account(Option<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::set_account):<br>required: **false**<br><p>The Amazon Web Services account ID whose access is to be revoked.</p><br>
    ///   - [`vpc_ids(impl Into<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::vpc_ids) / [`set_vpc_ids(Option<Vec::<String>>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::set_vpc_ids):<br>required: **false**<br><p>The virtual private cloud (VPC) identifiers for which access is to be revoked.</p><br>
    ///   - [`force(bool)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::force) / [`set_force(Option<bool>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::set_force):<br>required: **false**<br><p>Indicates whether to force the revoke action. If true, the Redshift-managed VPC endpoints associated with the endpoint authorization are also deleted.</p><br>
