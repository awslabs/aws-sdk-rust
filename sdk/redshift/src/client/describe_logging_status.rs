...
impl super::Client {
    ...
    ///   - [`log_destination_type(Option<LogDestinationType>)`](crate::operation::describe_logging_status::DescribeLoggingStatusOutput::log_destination_type): <p>The log destination type. An enum with possible values of <code>s3</code>, <code>cloudwatch</code>, and <code>s3table</code>.</p>
    ///   - [`log_exports(Option<Vec::<String>>)`](crate::operation::describe_logging_status::DescribeLoggingStatusOutput::log_exports): <p>The collection of exported log types. When <code>LogDestinationType</code> is <code>s3</code> or <code>cloudwatch</code>, possible values are <code>connectionlog</code>, <code>useractivitylog</code>, and <code>userlog</code>. When <code>LogDestinationType</code> is <code>s3table</code>, the values are the names of the system tables being published.</p>
    ///   - [`s3_tables(Option<S3TablePublishStatus>)`](crate::operation::describe_logging_status::DescribeLoggingStatusOutput::s3_tables): <p>The status of system table publishing to S3 Tables. This field is populated only when system table publishing is active.</p>
