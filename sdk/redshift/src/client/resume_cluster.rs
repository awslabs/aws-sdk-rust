...
impl super::Client {
    ...
    ///   - [`cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::resume_cluster::builders::ResumeClusterFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::resume_cluster::builders::ResumeClusterFluentBuilder::set_cluster_identifier): <p>The identifier of the cluster to be resumed.</p>
