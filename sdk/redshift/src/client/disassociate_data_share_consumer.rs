...
impl super::Client {
    ...
    ///   - [`data_share_arn(impl ::std::convert::Into<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::data_share_arn) / [`set_data_share_arn(Option<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::set_data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare to remove association for. </p>
    ///   - [`disassociate_entire_account(bool)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::disassociate_entire_account) / [`set_disassociate_entire_account(Option<bool>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::set_disassociate_entire_account): <p>A value that specifies whether association for the datashare is removed from the entire account.</p>
    ///   - [`consumer_arn(impl ::std::convert::Into<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::consumer_arn) / [`set_consumer_arn(Option<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::set_consumer_arn): <p>The Amazon Resource Name (ARN) of the consumer that association for the datashare is removed from.</p>
    ///   - [`consumer_region(impl ::std::convert::Into<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::consumer_region) / [`set_consumer_region(Option<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::set_consumer_region): <p>From a datashare consumer account, removes association of a datashare from all the existing and future namespaces in the specified Amazon Web Services Region.</p>
    ...
    ///   - [`allow_publicly_accessible_consumers(bool)`](crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput::allow_publicly_accessible_consumers): <p>A value that specifies whether the datashare can be shared to a publicly accessible cluster.</p>
