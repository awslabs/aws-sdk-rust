...
impl super::Client {
    ...
    ///   - [`consumer_arn(impl Into<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::consumer_arn) / [`set_consumer_arn(Option<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::set_consumer_arn): <p>The Amazon Resource Name (ARN) of the consumer that association for the datashare is removed from.</p>
