...
impl super::Client {
    ...
    ///   - [`consumer_arn(impl Into<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::consumer_arn) / [`set_consumer_arn(Option<String>)`](crate::operation::disassociate_data_share_consumer::builders::DisassociateDataShareConsumerFluentBuilder::set_consumer_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the consumer namespace that association for the datashare is removed from.</p><br>
    ...
    ///   - [`data_share_arn(Option<String>)`](crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput::data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare that the consumer is to use.</p>
    ///   - [`producer_arn(Option<String>)`](crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput::producer_arn): <p>The Amazon Resource Name (ARN) of the producer namespace.</p>
