...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleFluentBuilder::set_tags):<br>required: **false**<br><p>An optional set of tags you can use to search for the schedule.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleFluentBuilder::set_dry_run):<br>required: **false**<br><p></p><br>
    ///   - [`next_invocations(i32)`](crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleFluentBuilder::next_invocations) / [`set_next_invocations(Option<i32>)`](crate::operation::create_snapshot_schedule::builders::CreateSnapshotScheduleFluentBuilder::set_next_invocations):<br>required: **false**<br><p></p><br>
