...
impl super::Client {
    ...
    ///   - [`authentication_profile_name(impl ::std::convert::Into<String>)`](crate::operation::delete_authentication_profile::builders::DeleteAuthenticationProfileFluentBuilder::authentication_profile_name) / [`set_authentication_profile_name(Option<String>)`](crate::operation::delete_authentication_profile::builders::DeleteAuthenticationProfileFluentBuilder::set_authentication_profile_name): <p>The name of the authentication profile to delete.</p>
