...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_hsm_client_certificate::builders::CreateHsmClientCertificateFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_hsm_client_certificate::builders::CreateHsmClientCertificateFluentBuilder::set_tags): <p>A list of tag instances.</p>
