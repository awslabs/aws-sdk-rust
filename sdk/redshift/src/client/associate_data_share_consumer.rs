...
impl super::Client {
    ...
    ///   - [`data_share_arn(Option<String>)`](crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput::data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare that the consumer is to use.</p>
    ///   - [`producer_arn(Option<String>)`](crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput::producer_arn): <p>The Amazon Resource Name (ARN) of the producer namespace.</p>
    ///   - [`allow_publicly_accessible_consumers(Option<bool>)`](crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput::allow_publicly_accessible_consumers): <p>A value that specifies whether the datashare can be shared to a publicly accessible cluster.</p>
    ...
    ///   - [`data_share_type(Option<DataShareType>)`](crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput::data_share_type): <p>The type of the datashare created by RegisterNamespace.</p>
    ...
    pub fn associate_data_share_consumer(
        &self,
    ) -> crate::operation::associate_data_share_consumer::builders::AssociateDataShareConsumerFluentBuilder {
