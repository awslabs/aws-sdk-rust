...
/// Orchestration and serialization glue logic for `ModifyAquaConfiguration`.
...
impl ModifyAquaConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_aqua_configuration::ModifyAquaConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyAquaConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyAquaConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyAquaConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyAquaConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyAquaConfiguration")
...
.with_interceptor(ModifyAquaConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError>::new());
...
#[derive(Debug)]
            struct ModifyAquaConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyAquaConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_aqua_configuration::de_modify_aqua_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_aqua_configuration::de_modify_aqua_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyAquaConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyAquaConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_aqua_configuration::ModifyAquaConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_aqua_configuration_input::ser_modify_aqua_configuration_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyAquaConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyAquaConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyAquaConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyAquaConfigurationInput>()
                        .ok_or("failed to downcast to ModifyAquaConfigurationInput")?;
...
pub enum ModifyAquaConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyAquaConfigurationError) for what information is available for the error.")]
...
impl ModifyAquaConfigurationError {
    /// Creates the `ModifyAquaConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyAquaConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyAquaConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError {
...
mod _modify_aqua_configuration_output;
