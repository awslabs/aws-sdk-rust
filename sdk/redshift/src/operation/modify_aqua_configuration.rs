...
impl ModifyAquaConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`ModifyAquaConfiguration`](crate::operation::modify_aqua_configuration::ModifyAquaConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_aqua_configuration::ModifyAquaConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_aqua_configuration::ModifyAquaConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_aqua_configuration_input::ser_modify_aqua_configuration_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_aqua_configuration::ModifyAquaConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyAquaConfiguration", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyAquaConfiguration {
                type Output = std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError>;
