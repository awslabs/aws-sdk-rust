...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetReservedNodeExchangeConfigurationOptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_reserved_node_exchange_configuration_options_input::ser_get_reserved_node_exchange_configuration_options_input_input(&input)?);
