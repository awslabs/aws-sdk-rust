...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetReservedNodeExchangeConfigurationOptionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetReservedNodeExchangeConfigurationOptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_reserved_node_exchange_configuration_options_input::ser_get_reserved_node_exchange_configuration_options_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetReservedNodeExchangeConfigurationOptionsEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetReservedNodeExchangeConfigurationOptionsError {
