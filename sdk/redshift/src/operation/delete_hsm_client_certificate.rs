...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHsmClientCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_hsm_client_certificate::de_delete_hsm_client_certificate_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateError
{
