...
impl DeleteHsmClientCertificateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteHsmClientCertificate`](crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_hsm_client_certificate_input::ser_delete_hsm_client_certificate_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteHsmClientCertificate", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteHsmClientCertificate {
                type Output = std::result::Result<crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateOutput, crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateError>;
