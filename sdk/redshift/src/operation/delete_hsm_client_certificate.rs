...
impl DeleteHsmClientCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHsmClientCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_hsm_client_certificate::de_delete_hsm_client_certificate_http_response_with_props(
                status, headers, body,
            )
        }
    }
