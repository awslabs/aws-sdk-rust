...
impl crate::operation::batch_delete_cluster_snapshots::builders::BatchDeleteClusterSnapshotsInputBuilder {
...
impl BatchDeleteClusterSnapshotsFluentBuilder {
    /// Creates a new `BatchDeleteClusterSnapshotsFluentBuilder`.
