...
impl DescribeClusterDbRevisionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeClusterDbRevisions`](crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cluster_db_revisions_input::ser_describe_cluster_db_revisions_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeClusterDbRevisions", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeClusterDbRevisions {
                type Output = std::result::Result<crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsOutput, crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsError>;
