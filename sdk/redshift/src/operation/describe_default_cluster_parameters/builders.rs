...
impl DescribeDefaultClusterParametersInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::describe_default_cluster_parameters::DescribeDefaultClusterParametersOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_default_cluster_parameters::DescribeDefaultClusterParametersError, ::aws_smithy_http::operation::Response>>
