...
impl crate::operation::get_reserved_node_exchange_offerings::builders::GetReservedNodeExchangeOfferingsInputBuilder {
...
impl GetReservedNodeExchangeOfferingsFluentBuilder {
    /// Creates a new `GetReservedNodeExchangeOfferingsFluentBuilder`.
