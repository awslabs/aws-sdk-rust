...
impl ModifyClusterIamRolesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyClusterIamRoles`](crate::operation::modify_cluster_iam_roles::ModifyClusterIamRoles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRoles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_cluster_iam_roles_input::ser_modify_cluster_iam_roles_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_cluster_iam_roles::ModifyClusterIamRoles::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyClusterIamRoles", "redshift"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ModifyClusterIamRoles`.
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyClusterIamRoles {
                type Output = std::result::Result<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesOutput, crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError>;
