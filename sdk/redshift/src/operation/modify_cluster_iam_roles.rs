...
impl ModifyClusterIamRoles {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "ModifyClusterIamRoles", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Redshift.ModifyClusterIamRoles",
                "rpc.service" = "Redshift",
                "rpc.method" = "ModifyClusterIamRoles",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyClusterIamRoles {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyClusterIamRolesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyClusterIamRolesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyClusterIamRoles")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyClusterIamRoles")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyClusterIamRolesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyClusterIamRolesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyClusterIamRolesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyClusterIamRolesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyClusterIamRolesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_cluster_iam_roles::de_modify_cluster_iam_roles_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_modify_cluster_iam_roles::de_modify_cluster_iam_roles_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyClusterIamRolesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::modify_cluster_iam_roles::ModifyClusterIamRolesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_cluster_iam_roles_input::ser_modify_cluster_iam_roles_input_input_input(&input)?,
        );
