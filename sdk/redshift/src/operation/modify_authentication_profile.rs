...
impl ModifyAuthenticationProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_authentication_profile::ModifyAuthenticationProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyAuthenticationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_authentication_profile::de_modify_authentication_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
