...
/// Orchestration and serialization glue logic for `ModifyAuthenticationProfile`.
...
impl ModifyAuthenticationProfile {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_authentication_profile::ModifyAuthenticationProfileInput,
                    ) -> ::std::result::Result<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyAuthenticationProfile {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyAuthenticationProfile");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyAuthenticationProfileRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyAuthenticationProfileResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyAuthenticationProfile")
...
.with_interceptor(ModifyAuthenticationProfileEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileError>::new());
...
#[derive(Debug)]
            struct ModifyAuthenticationProfileResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyAuthenticationProfileResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_authentication_profile::de_modify_authentication_profile_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_authentication_profile::de_modify_authentication_profile_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyAuthenticationProfileRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyAuthenticationProfileRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_authentication_profile::ModifyAuthenticationProfileInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_authentication_profile::ModifyAuthenticationProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_authentication_profile_input::ser_modify_authentication_profile_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyAuthenticationProfileEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyAuthenticationProfileEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyAuthenticationProfileEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyAuthenticationProfileInput>()
                        .ok_or("failed to downcast to ModifyAuthenticationProfileInput")?;
...
pub enum ModifyAuthenticationProfileError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyAuthenticationProfileError) for what information is available for the error.")]
...
impl ModifyAuthenticationProfileError {
    /// Creates the `ModifyAuthenticationProfileError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyAuthenticationProfileError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AuthenticationProfileQuotaExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyAuthenticationProfileError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_authentication_profile::ModifyAuthenticationProfileError {
...
mod _modify_authentication_profile_output;
