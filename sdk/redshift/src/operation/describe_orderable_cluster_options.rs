...
impl DescribeOrderableClusterOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_orderable_cluster_options::DescribeOrderableClusterOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOrderableClusterOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_orderable_cluster_options::de_describe_orderable_cluster_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
