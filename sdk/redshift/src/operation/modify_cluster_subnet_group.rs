...
impl ModifyClusterSubnetGroupInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_cluster_subnet_group::ModifyClusterSubnetGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_cluster_subnet_group::ModifyClusterSubnetGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_cluster_subnet_group::ModifyClusterSubnetGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyClusterSubnetGroup", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyClusterSubnetGroup {
                type Output = std::result::Result<crate::operation::modify_cluster_subnet_group::ModifyClusterSubnetGroupOutput, crate::operation::modify_cluster_subnet_group::ModifyClusterSubnetGroupError>;
