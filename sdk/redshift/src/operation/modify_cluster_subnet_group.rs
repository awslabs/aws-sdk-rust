...
impl ModifyClusterSubnetGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_cluster_subnet_group::ModifyClusterSubnetGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyClusterSubnetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_cluster_subnet_group::de_modify_cluster_subnet_group_http_response_with_props(status, headers, body)
        }
    }
}
