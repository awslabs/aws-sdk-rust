...
impl RotateEncryptionKeyInput {
    /// Consumes the builder and constructs an Operation<[`RotateEncryptionKey`](crate::operation::rotate_encryption_key::RotateEncryptionKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::rotate_encryption_key::RotateEncryptionKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rotate_encryption_key::RotateEncryptionKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_rotate_encryption_key_input::ser_rotate_encryption_key_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::rotate_encryption_key::RotateEncryptionKey::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RotateEncryptionKey", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for RotateEncryptionKey {
                type Output = std::result::Result<crate::operation::rotate_encryption_key::RotateEncryptionKeyOutput, crate::operation::rotate_encryption_key::RotateEncryptionKeyError>;
