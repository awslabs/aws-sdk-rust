...
/// Orchestration and serialization glue logic for `RotateEncryptionKey`.
...
impl RotateEncryptionKey {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::rotate_encryption_key::RotateEncryptionKeyInput,
                    ) -> ::std::result::Result<crate::operation::rotate_encryption_key::RotateEncryptionKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rotate_encryption_key::RotateEncryptionKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::rotate_encryption_key::RotateEncryptionKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::rotate_encryption_key::RotateEncryptionKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RotateEncryptionKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RotateEncryptionKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RotateEncryptionKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RotateEncryptionKeyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RotateEncryptionKey")
...
.with_interceptor(RotateEncryptionKeyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::rotate_encryption_key::RotateEncryptionKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::rotate_encryption_key::RotateEncryptionKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::rotate_encryption_key::RotateEncryptionKeyError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RotateEncryptionKeyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_rotate_encryption_key::de_rotate_encryption_key_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_rotate_encryption_key::de_rotate_encryption_key_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateEncryptionKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::rotate_encryption_key::RotateEncryptionKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::rotate_encryption_key::RotateEncryptionKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_rotate_encryption_key_input::ser_rotate_encryption_key_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RotateEncryptionKeyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RotateEncryptionKeyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RotateEncryptionKeyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RotateEncryptionKeyInput>()
                        .ok_or("failed to downcast to RotateEncryptionKeyInput")?;
...
pub enum RotateEncryptionKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RotateEncryptionKeyError) for what information is available for the error.")]
...
impl RotateEncryptionKeyError {
    /// Creates the `RotateEncryptionKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RotateEncryptionKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `RotateEncryptionKeyError::UnsupportedOperationFault`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RotateEncryptionKeyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::rotate_encryption_key::RotateEncryptionKeyError {
...
mod _rotate_encryption_key_output;
