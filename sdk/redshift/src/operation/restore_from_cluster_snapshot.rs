    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreFromClusterSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RestoreFromClusterSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RestoreFromClusterSnapshotResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RestoreFromClusterSnapshot", "redshift"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreFromClusterSnapshot")
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreFromClusterSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_restore_from_cluster_snapshot_input::ser_restore_from_cluster_snapshot_input_input_input(&input)?,
        );
...
impl ::std::error::Error for RestoreFromClusterSnapshotError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::AccessToSnapshotDeniedFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RestoreFromClusterSnapshotError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AccessToSnapshotDeniedFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
