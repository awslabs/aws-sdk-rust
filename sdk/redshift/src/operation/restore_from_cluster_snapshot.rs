...
impl RestoreFromClusterSnapshot {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreFromClusterSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RestoreFromClusterSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RestoreFromClusterSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RestoreFromClusterSnapshotResponseDeserializer));
...
.with_interceptor(RestoreFromClusterSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_restore_from_cluster_snapshot::de_restore_from_cluster_snapshot_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_restore_from_cluster_snapshot::de_restore_from_cluster_snapshot_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreFromClusterSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_restore_from_cluster_snapshot_input::ser_restore_from_cluster_snapshot_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RestoreFromClusterSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreFromClusterSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RestoreFromClusterSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RestoreFromClusterSnapshotInput>()
                        .ok_or("failed to downcast to RestoreFromClusterSnapshotInput")?;
...
pub enum RestoreFromClusterSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RestoreFromClusterSnapshotError) for what information is available for the error.")]
...
impl RestoreFromClusterSnapshotError {
    /// Creates the `RestoreFromClusterSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreFromClusterSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AccessToSnapshotDeniedFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `RestoreFromClusterSnapshotError::Ipv6CidrBlockNotFoundFault`.
...
impl ::std::error::Error for RestoreFromClusterSnapshotError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::Ipv6CidrBlockNotFoundFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RestoreFromClusterSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotError {
