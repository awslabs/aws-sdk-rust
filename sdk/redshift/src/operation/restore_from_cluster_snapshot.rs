...
impl RestoreFromClusterSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreFromClusterSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_from_cluster_snapshot::de_restore_from_cluster_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
