...
impl DescribeSnapshotSchedulesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedules::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSnapshotSchedules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_snapshot_schedules::de_describe_snapshot_schedules_http_response_with_props(status, headers, body)
        }
    }
}
