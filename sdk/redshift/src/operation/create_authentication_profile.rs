...
impl CreateAuthenticationProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_authentication_profile::CreateAuthenticationProfile,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_authentication_profile::CreateAuthenticationProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAuthenticationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_authentication_profile::de_create_authentication_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
