...
impl CreateAuthenticationProfileInput {
    /// Consumes the builder and constructs an Operation<[`CreateAuthenticationProfile`](crate::operation::create_authentication_profile::CreateAuthenticationProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_authentication_profile::CreateAuthenticationProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_authentication_profile::CreateAuthenticationProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_authentication_profile_input::ser_create_authentication_profile_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_authentication_profile::CreateAuthenticationProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateAuthenticationProfile", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAuthenticationProfile {
                type Output = std::result::Result<crate::operation::create_authentication_profile::CreateAuthenticationProfileOutput, crate::operation::create_authentication_profile::CreateAuthenticationProfileError>;
