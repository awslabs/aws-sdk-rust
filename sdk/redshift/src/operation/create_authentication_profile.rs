...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAuthenticationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_authentication_profile::de_create_authentication_profile_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateAuthenticationProfileError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_authentication_profile::CreateAuthenticationProfileError
{
