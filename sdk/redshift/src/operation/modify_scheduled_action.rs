    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "ModifyScheduledAction", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.method" = "ModifyScheduledAction",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyScheduledAction")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyScheduledActionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_scheduled_action::de_modify_scheduled_action_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_modify_scheduled_action::de_modify_scheduled_action_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyScheduledActionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_scheduled_action_input::ser_modify_scheduled_action_input_input_input(&input)?,
        );
