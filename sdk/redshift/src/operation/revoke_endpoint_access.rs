...
impl RevokeEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`RevokeEndpointAccess`](crate::operation::revoke_endpoint_access::RevokeEndpointAccess)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_endpoint_access_input::ser_revoke_endpoint_access_input_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_endpoint_access::RevokeEndpointAccess::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RevokeEndpointAccess", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeEndpointAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_endpoint_access::de_revoke_endpoint_access_http_response_with_props(status, headers, body)
        }
    }
}
