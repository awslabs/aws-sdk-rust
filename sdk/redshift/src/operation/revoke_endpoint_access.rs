...
impl RevokeEndpointAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::revoke_endpoint_access::RevokeEndpointAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::revoke_endpoint_access::RevokeEndpointAccessOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "RevokeEndpointAccess", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Redshift.RevokeEndpointAccess",
                "rpc.service" = "Redshift",
                "rpc.method" = "RevokeEndpointAccess",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeEndpointAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RevokeEndpointAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RevokeEndpointAccessResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RevokeEndpointAccess")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeEndpointAccess")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RevokeEndpointAccessTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RevokeEndpointAccessTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeEndpointAccessTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RevokeEndpointAccessInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeEndpointAccessResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_revoke_endpoint_access::de_revoke_endpoint_access_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_revoke_endpoint_access::de_revoke_endpoint_access_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeEndpointAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::revoke_endpoint_access::RevokeEndpointAccessInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_endpoint_access_input::ser_revoke_endpoint_access_input_input_input(&input)?,
        );
...
impl ::std::error::Error for RevokeEndpointAccessError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::EndpointAuthorizationNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
            Self::EndpointNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::InvalidEndpointStateFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RevokeEndpointAccessError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::EndpointAuthorizationNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::EndpointNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::InvalidEndpointStateFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
