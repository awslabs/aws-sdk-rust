...
impl DeleteSnapshotCopyGrantInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSnapshotCopyGrant`](crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrant)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrant, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_snapshot_copy_grant_input::ser_delete_snapshot_copy_grant_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrant::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteSnapshotCopyGrant", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSnapshotCopyGrant {
                type Output = std::result::Result<crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantOutput, crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantError>;
