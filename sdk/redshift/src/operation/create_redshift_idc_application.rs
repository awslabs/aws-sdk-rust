...
/// Orchestration and serialization glue logic for `CreateRedshiftIdcApplication`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateRedshiftIdcApplication;
impl CreateRedshiftIdcApplication {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateRedshiftIdcApplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateRedshiftIdcApplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateRedshiftIdcApplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateRedshiftIdcApplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateRedshiftIdcApplication")
...
.with_interceptor(CreateRedshiftIdcApplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationError>::new());
...
#[derive(Debug)]
            struct CreateRedshiftIdcApplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRedshiftIdcApplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_redshift_idc_application::de_create_redshift_idc_application_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_redshift_idc_application::de_create_redshift_idc_application_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateRedshiftIdcApplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRedshiftIdcApplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_redshift_idc_application_input::ser_create_redshift_idc_application_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateRedshiftIdcApplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRedshiftIdcApplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateRedshiftIdcApplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateRedshiftIdcApplicationInput>()
                        .ok_or("failed to downcast to CreateRedshiftIdcApplicationInput")?;
...
/// Error type for the `CreateRedshiftIdcApplicationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateRedshiftIdcApplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateRedshiftIdcApplicationError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateRedshiftIdcApplicationError {
    /// Creates the `CreateRedshiftIdcApplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateRedshiftIdcApplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateRedshiftIdcApplicationError::DependentServiceAccessDeniedFault`.
    pub fn is_dependent_service_access_denied_fault(&self) -> bool {
        matches!(self, Self::DependentServiceAccessDeniedFault(_))
    }
    /// Returns `true` if the error kind is `CreateRedshiftIdcApplicationError::DependentServiceUnavailableFault`.
...
impl ::std::error::Error for CreateRedshiftIdcApplicationError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::RedshiftIdcApplicationAlreadyExistsFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::RedshiftIdcApplicationQuotaExceededFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for CreateRedshiftIdcApplicationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateRedshiftIdcApplicationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateRedshiftIdcApplicationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateRedshiftIdcApplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationError {
...
mod _create_redshift_idc_application_output;
