...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRedshiftIdcApplicationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_redshift_idc_application::de_create_redshift_idc_application_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_redshift_idc_application::de_create_redshift_idc_application_http_response(
