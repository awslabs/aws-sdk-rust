    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableSnapshotCopy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EnableSnapshotCopyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct EnableSnapshotCopyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableSnapshotCopyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EnableSnapshotCopyInput>() else {
        ...
        if requested.should_capture("SnapshotCopyGrantName") {
            if let ::std::option::Option::Some(value) = input.snapshot_copy_grant_name.as_deref() {
                captured.insert("SnapshotCopyGrantName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableSnapshotCopyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_snapshot_copy::de_enable_snapshot_copy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_enable_snapshot_copy::de_enable_snapshot_copy_http_response(status, headers, body, _cfg)
        };
