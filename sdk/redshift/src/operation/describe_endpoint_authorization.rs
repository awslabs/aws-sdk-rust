...
impl DescribeEndpointAuthorizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEndpointAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_endpoint_authorization::de_describe_endpoint_authorization_http_response_with_props(
                status, headers, body,
            )
        }
    }
