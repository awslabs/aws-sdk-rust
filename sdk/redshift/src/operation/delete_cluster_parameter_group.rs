...
impl DeleteClusterParameterGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_cluster_parameter_group::DeleteClusterParameterGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_cluster_parameter_group::de_delete_cluster_parameter_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
