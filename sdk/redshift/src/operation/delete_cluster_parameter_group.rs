...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_cluster_parameter_group::de_delete_cluster_parameter_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteClusterParameterGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_cluster_parameter_group::DeleteClusterParameterGroupError
{
