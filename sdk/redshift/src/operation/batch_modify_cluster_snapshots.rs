...
impl BatchModifyClusterSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`BatchModifyClusterSnapshots`](crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_modify_cluster_snapshots_input::ser_batch_modify_cluster_snapshots_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchModifyClusterSnapshots", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchModifyClusterSnapshots {
                type Output = std::result::Result<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsOutput, crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError>;
