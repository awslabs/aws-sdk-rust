...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchModifyClusterSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_modify_cluster_snapshots::de_batch_modify_cluster_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for BatchModifyClusterSnapshotsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError
{
