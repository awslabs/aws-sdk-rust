...
/// Orchestration and serialization glue logic for `BatchModifyClusterSnapshots`.
...
impl BatchModifyClusterSnapshots {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchModifyClusterSnapshots {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchModifyClusterSnapshots");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchModifyClusterSnapshotsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchModifyClusterSnapshotsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchModifyClusterSnapshots")
...
.with_interceptor(BatchModifyClusterSnapshotsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchModifyClusterSnapshotsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_modify_cluster_snapshots::de_batch_modify_cluster_snapshots_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_modify_cluster_snapshots::de_batch_modify_cluster_snapshots_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchModifyClusterSnapshotsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_modify_cluster_snapshots_input::ser_batch_modify_cluster_snapshots_input_input_input(&input)?);
...
#[derive(Debug)]
            struct BatchModifyClusterSnapshotsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchModifyClusterSnapshotsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchModifyClusterSnapshotsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchModifyClusterSnapshotsInput>()
                        .ok_or("failed to downcast to BatchModifyClusterSnapshotsInput")?;
...
pub enum BatchModifyClusterSnapshotsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchModifyClusterSnapshotsError) for what information is available for the error.")]
...
impl BatchModifyClusterSnapshotsError {
    /// Creates the `BatchModifyClusterSnapshotsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchModifyClusterSnapshotsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BatchModifyClusterSnapshotsLimitExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchModifyClusterSnapshotsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError {
...
mod _batch_modify_cluster_snapshots_output;
