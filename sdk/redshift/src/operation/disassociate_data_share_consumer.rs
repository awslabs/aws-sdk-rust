...
impl DisassociateDataShareConsumerInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDataShareConsumer`](crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_data_share_consumer_input::ser_disassociate_data_share_consumer_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisassociateDataShareConsumer", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateDataShareConsumer {
                type Output = std::result::Result<crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput, crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError>;
