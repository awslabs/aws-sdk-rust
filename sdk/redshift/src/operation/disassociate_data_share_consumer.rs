...
impl DisassociateDataShareConsumerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumer,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateDataShareConsumer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_data_share_consumer::de_disassociate_data_share_consumer_http_response_with_props(
                status, headers, body,
            )
        }
    }
