...
impl DescribeCustomDomainAssociationsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::describe_custom_domain_associations::DescribeCustomDomainAssociationsOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_custom_domain_associations::DescribeCustomDomainAssociationsError, ::aws_smithy_http::operation::Response>>
