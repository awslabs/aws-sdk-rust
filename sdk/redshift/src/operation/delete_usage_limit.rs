...
impl DeleteUsageLimitInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUsageLimit`](crate::operation::delete_usage_limit::DeleteUsageLimit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_usage_limit::DeleteUsageLimit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_usage_limit::DeleteUsageLimitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_usage_limit_input::ser_delete_usage_limit_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_usage_limit::DeleteUsageLimit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteUsageLimit", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUsageLimit {
                type Output = std::result::Result<crate::operation::delete_usage_limit::DeleteUsageLimitOutput, crate::operation::delete_usage_limit::DeleteUsageLimitError>;
