...
impl DescribeEventSubscriptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_event_subscriptions::DescribeEventSubscriptionsInput, ::aws_smithy_types::error::operation::BuildError> {
