...
impl DescribeReservedNodeExchangeStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_reserved_node_exchange_status::DescribeReservedNodeExchangeStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedNodeExchangeStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_node_exchange_status::de_describe_reserved_node_exchange_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
