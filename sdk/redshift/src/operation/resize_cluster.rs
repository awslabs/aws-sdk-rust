...
impl ResizeClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::resize_cluster::ResizeCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resize_cluster_input::ser_resize_cluster_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResizeCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resize_cluster::de_resize_cluster_http_response_with_props(status, headers, body)
        }
    }
}
