...
impl DescribeHsmClientCertificatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_hsm_client_certificates::DescribeHsmClientCertificatesInput, ::aws_smithy_types::error::operation::BuildError> {
