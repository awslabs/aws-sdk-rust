...
impl DescribeHsmClientCertificatesInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_hsm_client_certificates::DescribeHsmClientCertificatesInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
