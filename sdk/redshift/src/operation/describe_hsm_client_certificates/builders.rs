...
impl DescribeHsmClientCertificatesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_hsm_client_certificates::DescribeHsmClientCertificatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_hsm_client_certificates::DescribeHsmClientCertificatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_hsm_client_certificates::DescribeHsmClientCertificatesOutput, crate::operation::describe_hsm_client_certificates::DescribeHsmClientCertificatesError, Self> {
