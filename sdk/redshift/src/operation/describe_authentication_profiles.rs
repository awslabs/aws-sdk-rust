...
impl DescribeAuthenticationProfilesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_authentication_profiles::DescribeAuthenticationProfiles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAuthenticationProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_authentication_profiles::de_describe_authentication_profiles_http_response_with_props(
                status, headers, body,
            )
        }
    }
