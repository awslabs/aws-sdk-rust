...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_snapshot_schedule_input::ser_delete_snapshot_schedule_input_input_input(&input)?);
