...
impl DescribeDataSharesForConsumerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_data_shares_for_consumer::DescribeDataSharesForConsumer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataSharesForConsumer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_shares_for_consumer::de_describe_data_shares_for_consumer_http_response_with_props(
                status, headers, body,
            )
        }
    }
