...
impl CreateIntegration {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("redshift", "CreateIntegration", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateIntegrationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_integration_input::ser_create_integration_input_input_input(&input)?,
        );
...
impl CreateIntegrationError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::IntegrationSourceNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::IntegrationTargetNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `CreateIntegrationError::IntegrationSourceNotFoundFault`.
    pub fn is_integration_source_not_found_fault(&self) -> bool {
        matches!(self, Self::IntegrationSourceNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `CreateIntegrationError::IntegrationTargetNotFoundFault`.
    pub fn is_integration_target_not_found_fault(&self) -> bool {
        matches!(self, Self::IntegrationTargetNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `CreateIntegrationError::InvalidClusterStateFault`.
    pub fn is_invalid_cluster_state_fault(&self) -> bool {
        matches!(self, Self::InvalidClusterStateFault(_))
    }
    /// Returns `true` if the error kind is `CreateIntegrationError::InvalidTagFault`.
    pub fn is_invalid_tag_fault(&self) -> bool {
        matches!(self, Self::InvalidTagFault(_))
    }
    /// Returns `true` if the error kind is `CreateIntegrationError::TagLimitExceededFault`.
    pub fn is_tag_limit_exceeded_fault(&self) -> bool {
        matches!(self, Self::TagLimitExceededFault(_))
    }
    /// Returns `true` if the error kind is `CreateIntegrationError::UnsupportedOperationFault`.
...
impl ::std::error::Error for CreateIntegrationError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::IntegrationSourceNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
            Self::IntegrationTargetNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for CreateIntegrationError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::IntegrationSourceNotFoundFault(_inner) => _inner.fmt(f),
            Self::IntegrationTargetNotFoundFault(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateIntegrationError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::IntegrationSourceNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::IntegrationTargetNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
