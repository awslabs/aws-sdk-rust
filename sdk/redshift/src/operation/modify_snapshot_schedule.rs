...
impl ModifySnapshotScheduleInput {
    /// Consumes the builder and constructs an Operation<[`ModifySnapshotSchedule`](crate::operation::modify_snapshot_schedule::ModifySnapshotSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_snapshot_schedule::ModifySnapshotSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_snapshot_schedule_input::ser_modify_snapshot_schedule_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_snapshot_schedule::ModifySnapshotSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifySnapshotSchedule", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifySnapshotSchedule {
                type Output = std::result::Result<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput, crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError>;
