...
/// Orchestration and serialization glue logic for `ModifySnapshotSchedule`.
...
impl ModifySnapshotSchedule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleInput,
                    ) -> ::std::result::Result<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifySnapshotSchedule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifySnapshotSchedule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifySnapshotScheduleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifySnapshotScheduleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifySnapshotSchedule")
...
.with_interceptor(ModifySnapshotScheduleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifySnapshotScheduleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_snapshot_schedule::de_modify_snapshot_schedule_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifySnapshotScheduleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_snapshot_schedule_input::ser_modify_snapshot_schedule_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifySnapshotScheduleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifySnapshotScheduleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifySnapshotScheduleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifySnapshotScheduleInput>()
                        .ok_or("failed to downcast to ModifySnapshotScheduleInput")?;
...
pub enum ModifySnapshotScheduleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifySnapshotScheduleError) for what information is available for the error.")]
...
impl ModifySnapshotScheduleError {
    /// Creates the `ModifySnapshotScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySnapshotScheduleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SnapshotScheduleUpdateInProgressFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifySnapshotScheduleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_snapshot_schedule::ModifySnapshotScheduleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_snapshot_schedule::_modify_snapshot_schedule_output::ModifySnapshotScheduleOutput;

pub use crate::operation::modify_snapshot_schedule::_modify_snapshot_schedule_input::ModifySnapshotScheduleInput;

mod _modify_snapshot_schedule_input;

mod _modify_snapshot_schedule_output;
