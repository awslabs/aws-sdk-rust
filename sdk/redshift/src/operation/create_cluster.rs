...
impl CreateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "CreateCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("LoadSampleData") {
            if let ::std::option::Option::Some(value) = input.load_sample_data.as_deref() {
                captured.insert("LoadSampleData", value);
            }
        }
