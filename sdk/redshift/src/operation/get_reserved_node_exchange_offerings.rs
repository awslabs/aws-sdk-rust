...
impl GetReservedNodeExchangeOfferingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_reserved_node_exchange_offerings::GetReservedNodeExchangeOfferings,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_reserved_node_exchange_offerings::GetReservedNodeExchangeOfferings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReservedNodeExchangeOfferings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_reserved_node_exchange_offerings::de_get_reserved_node_exchange_offerings_http_response_with_props(
                status, headers, body,
            )
        }
    }
