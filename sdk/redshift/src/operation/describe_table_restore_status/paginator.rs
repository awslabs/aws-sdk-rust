        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_table_restore_status::DescribeTableRestoreStatus::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl DescribeTableRestoreStatusPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_table_restore_status_output_output_table_restore_status_details(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
