...
pub use crate::operation::describe_table_restore_status::_describe_table_restore_status_output::DescribeTableRestoreStatusOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_table_restore_status::DescribeTableRestoreStatusOutput,
                    crate::operation::describe_table_restore_status::DescribeTableRestoreStatusError,
                > for DescribeTableRestoreStatusFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeTableRestoreStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_table_restore_status::DescribeTableRestoreStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_table_restore_status::DescribeTableRestoreStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_table_restore_status::DescribeTableRestoreStatus::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_table_restore_status::DescribeTableRestoreStatus::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_table_restore_status::DescribeTableRestoreStatusOutput, crate::operation::describe_table_restore_status::DescribeTableRestoreStatusError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_table_restore_status::paginator::DescribeTableRestoreStatusPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
