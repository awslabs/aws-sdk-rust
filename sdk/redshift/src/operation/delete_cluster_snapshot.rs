...
impl DeleteClusterSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`DeleteClusterSnapshot`](crate::operation::delete_cluster_snapshot::DeleteClusterSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_cluster_snapshot::DeleteClusterSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_cluster_snapshot::DeleteClusterSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_cluster_snapshot_input::ser_delete_cluster_snapshot_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cluster_snapshot::DeleteClusterSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteClusterSnapshot", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteClusterSnapshot {
                type Output = std::result::Result<crate::operation::delete_cluster_snapshot::DeleteClusterSnapshotOutput, crate::operation::delete_cluster_snapshot::DeleteClusterSnapshotError>;
