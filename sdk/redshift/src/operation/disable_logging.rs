...
impl DisableLoggingInput {
    /// Consumes the builder and constructs an Operation<[`DisableLogging`](crate::operation::disable_logging::DisableLogging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_logging::DisableLogging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_logging::DisableLoggingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_logging_input::ser_disable_logging_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_logging::DisableLogging::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisableLogging", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisableLogging {
                type Output = std::result::Result<crate::operation::disable_logging::DisableLoggingOutput, crate::operation::disable_logging::DisableLoggingError>;
