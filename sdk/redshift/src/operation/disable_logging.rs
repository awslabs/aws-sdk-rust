...
impl DisableLoggingInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_logging_input::ser_disable_logging_input_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_logging::DisableLogging::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DisableLogging {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_disable_logging::de_disable_logging_http_error(
                status, headers, body,
            )
        } else {
