...
impl CreateClusterParameterGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_cluster_parameter_group::CreateClusterParameterGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cluster_parameter_group::de_create_cluster_parameter_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
