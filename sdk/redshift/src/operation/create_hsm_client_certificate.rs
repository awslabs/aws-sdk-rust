...
impl CreateHsmClientCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_hsm_client_certificate::CreateHsmClientCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHsmClientCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_hsm_client_certificate::de_create_hsm_client_certificate_http_response_with_props(
                status, headers, body,
            )
        }
    }
