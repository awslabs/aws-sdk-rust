...
impl DescribeReservedNodeOfferingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_reserved_node_offerings::DescribeReservedNodeOfferingsInput, ::aws_smithy_types::error::operation::BuildError> {
