...
impl DescribeReservedNodeOfferingsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_reserved_node_offerings::DescribeReservedNodeOfferingsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
