...
impl PauseClusterInput {
    /// Consumes the builder and constructs an Operation<[`PauseCluster`](crate::operation::pause_cluster::PauseCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::pause_cluster::PauseCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::pause_cluster::PauseClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_pause_cluster_input::ser_pause_cluster_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::pause_cluster::PauseCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PauseCluster", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for PauseCluster {
                type Output = std::result::Result<crate::operation::pause_cluster::PauseClusterOutput, crate::operation::pause_cluster::PauseClusterError>;
