...
impl PurchaseReservedNodeOfferingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOffering::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseReservedNodeOffering {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_purchase_reserved_node_offering::de_purchase_reserved_node_offering_http_response_with_props(
                status, headers, body,
            )
        }
    }
