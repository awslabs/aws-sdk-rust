...
impl PurchaseReservedNodeOfferingInput {
    /// Consumes the builder and constructs an Operation<[`PurchaseReservedNodeOffering`](crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOffering)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOffering, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOfferingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_purchase_reserved_node_offering_input::ser_purchase_reserved_node_offering_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOffering::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PurchaseReservedNodeOffering", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for PurchaseReservedNodeOffering {
                type Output = std::result::Result<crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOfferingOutput, crate::operation::purchase_reserved_node_offering::PurchaseReservedNodeOfferingError>;
