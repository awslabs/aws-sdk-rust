...
impl CreateScheduledActionInput {
    /// Consumes the builder and constructs an Operation<[`CreateScheduledAction`](crate::operation::create_scheduled_action::CreateScheduledAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_scheduled_action::CreateScheduledAction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_scheduled_action::CreateScheduledActionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_scheduled_action_input::ser_create_scheduled_action_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_scheduled_action::CreateScheduledAction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateScheduledAction", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateScheduledAction {
                type Output = std::result::Result<crate::operation::create_scheduled_action::CreateScheduledActionOutput, crate::operation::create_scheduled_action::CreateScheduledActionError>;
