...
impl PutResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("redshift", "PutResourcePolicy", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutResourcePolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutResourcePolicy", "redshift"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutResourcePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_resource_policy_input::ser_put_resource_policy_input_input_input(&input)?,
        );
...
impl PutResourcePolicyError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ConflictPolicyUpdateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `PutResourcePolicyError::ConflictPolicyUpdateFault`.
    pub fn is_conflict_policy_update_fault(&self) -> bool {
        matches!(self, Self::ConflictPolicyUpdateFault(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::InvalidPolicyFault`.
    pub fn is_invalid_policy_fault(&self) -> bool {
        matches!(self, Self::InvalidPolicyFault(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::ResourceNotFoundFault`.
    pub fn is_resource_not_found_fault(&self) -> bool {
        matches!(self, Self::ResourceNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::UnsupportedOperationFault`.
...
impl ::std::error::Error for PutResourcePolicyError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::ConflictPolicyUpdateFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for PutResourcePolicyError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            Self::ConflictPolicyUpdateFault(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutResourcePolicyError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ConflictPolicyUpdateFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
