...
impl AuthorizeEndpointAccess {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeEndpointAccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AuthorizeEndpointAccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AuthorizeEndpointAccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AuthorizeEndpointAccessResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AuthorizeEndpointAccess")
...
.with_interceptor(AuthorizeEndpointAccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError>::new());
...
#[derive(Debug)]
            struct AuthorizeEndpointAccessResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AuthorizeEndpointAccessResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_authorize_endpoint_access::de_authorize_endpoint_access_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_authorize_endpoint_access::de_authorize_endpoint_access_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AuthorizeEndpointAccessRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AuthorizeEndpointAccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_authorize_endpoint_access_input::ser_authorize_endpoint_access_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AuthorizeEndpointAccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AuthorizeEndpointAccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AuthorizeEndpointAccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AuthorizeEndpointAccessInput>()
                        .ok_or("failed to downcast to AuthorizeEndpointAccessInput")?;
...
pub enum AuthorizeEndpointAccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AuthorizeEndpointAccessError) for what information is available for the error.")]
...
impl AuthorizeEndpointAccessError {
    /// Creates the `AuthorizeEndpointAccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AuthorizeEndpointAccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::EndpointAuthorizationAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::EndpointAuthorizationsPerClusterLimitExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidAuthorizationStateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AuthorizeEndpointAccessError {
...
impl ::aws_types::request_id::RequestId for crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError {
...
mod _authorize_endpoint_access_output;
