...
impl AuthorizeEndpointAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "AuthorizeEndpointAccess", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Redshift.AuthorizeEndpointAccess",
                "rpc.service" = "Redshift",
                "rpc.method" = "AuthorizeEndpointAccess",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeEndpointAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AuthorizeEndpointAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AuthorizeEndpointAccessResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AuthorizeEndpointAccess")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AuthorizeEndpointAccess")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AuthorizeEndpointAccessTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AuthorizeEndpointAccessTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AuthorizeEndpointAccessTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AuthorizeEndpointAccessInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AuthorizeEndpointAccessResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_authorize_endpoint_access::de_authorize_endpoint_access_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_authorize_endpoint_access::de_authorize_endpoint_access_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AuthorizeEndpointAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_endpoint_access_input::ser_authorize_endpoint_access_input_input_input(&input)?,
        );
