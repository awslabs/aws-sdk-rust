...
impl AuthorizeEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeEndpointAccess`](crate::operation::authorize_endpoint_access::AuthorizeEndpointAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for AuthorizeEndpointAccess {
                type Output = std::result::Result<crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessOutput, crate::operation::authorize_endpoint_access::AuthorizeEndpointAccessError>;
