...
impl RevokeClusterSecurityGroupIngressInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeClusterSecurityGroupIngress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_cluster_security_group_ingress::de_revoke_cluster_security_group_ingress_http_response_with_props(
                status, headers, body,
            )
        }
    }
