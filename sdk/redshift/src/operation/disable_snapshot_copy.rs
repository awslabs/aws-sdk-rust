...
/// Orchestration and serialization glue logic for `DisableSnapshotCopy`.
...
impl DisableSnapshotCopy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disable_snapshot_copy::DisableSnapshotCopyInput,
                    ) -> ::std::result::Result<crate::operation::disable_snapshot_copy::DisableSnapshotCopyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_snapshot_copy::DisableSnapshotCopyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_snapshot_copy::DisableSnapshotCopyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_snapshot_copy::DisableSnapshotCopyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableSnapshotCopy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableSnapshotCopy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableSnapshotCopyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableSnapshotCopyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableSnapshotCopy")
...
.with_interceptor(DisableSnapshotCopyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_snapshot_copy::DisableSnapshotCopyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_snapshot_copy::DisableSnapshotCopyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_snapshot_copy::DisableSnapshotCopyError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableSnapshotCopyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_snapshot_copy::de_disable_snapshot_copy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disable_snapshot_copy::de_disable_snapshot_copy_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableSnapshotCopyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_snapshot_copy::DisableSnapshotCopyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_snapshot_copy::DisableSnapshotCopyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_snapshot_copy_input::ser_disable_snapshot_copy_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableSnapshotCopyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableSnapshotCopyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableSnapshotCopyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableSnapshotCopyInput>()
                        .ok_or("failed to downcast to DisableSnapshotCopyInput")?;
...
pub enum DisableSnapshotCopyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableSnapshotCopyError) for what information is available for the error.")]
...
impl DisableSnapshotCopyError {
    /// Creates the `DisableSnapshotCopyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableSnapshotCopyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SnapshotCopyAlreadyDisabledFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableSnapshotCopyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_snapshot_copy::DisableSnapshotCopyError {
...
mod _disable_snapshot_copy_output;
