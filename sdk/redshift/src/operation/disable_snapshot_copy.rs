...
impl DisableSnapshotCopyInput {
    /// Consumes the builder and constructs an Operation<[`DisableSnapshotCopy`](crate::operation::disable_snapshot_copy::DisableSnapshotCopy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_snapshot_copy::DisableSnapshotCopy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_snapshot_copy::DisableSnapshotCopyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_snapshot_copy_input::ser_disable_snapshot_copy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_snapshot_copy::DisableSnapshotCopy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisableSnapshotCopy", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisableSnapshotCopy {
                type Output = std::result::Result<crate::operation::disable_snapshot_copy::DisableSnapshotCopyOutput, crate::operation::disable_snapshot_copy::DisableSnapshotCopyError>;
