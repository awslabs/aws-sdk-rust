    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_custom_domain_association::DeleteCustomDomainAssociationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_custom_domain_association::DeleteCustomDomainAssociationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomDomainAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteCustomDomainAssociation", "redshift"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteCustomDomainAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteCustomDomainAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_custom_domain_association_input::ser_delete_custom_domain_association_input_input(&input)?,
        );
...
impl DeleteCustomDomainAssociationError {
    ...
    /// Returns `true` if the error kind is `DeleteCustomDomainAssociationError::ClusterNotFoundFault`.
    pub fn is_cluster_not_found_fault(&self) -> bool {
        matches!(self, Self::ClusterNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomDomainAssociationError::CustomCnameAssociationFault`.
    pub fn is_custom_cname_association_fault(&self) -> bool {
        matches!(self, Self::CustomCnameAssociationFault(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomDomainAssociationError::UnsupportedOperationFault`.
