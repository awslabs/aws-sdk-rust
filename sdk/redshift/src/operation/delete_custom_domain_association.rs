...
impl DeleteCustomDomainAssociationInput {
    ...
    > {
        ...
        .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteCustomDomainAssociation", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomDomainAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_custom_domain_association::de_delete_custom_domain_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
