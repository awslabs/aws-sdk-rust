...
/// Orchestration and serialization glue logic for `ModifyClusterSnapshot`.
...
impl ModifyClusterSnapshot {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyClusterSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyClusterSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyClusterSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyClusterSnapshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyClusterSnapshot")
...
.with_interceptor(ModifyClusterSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyClusterSnapshotResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_cluster_snapshot::de_modify_cluster_snapshot_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_cluster_snapshot::de_modify_cluster_snapshot_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyClusterSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_cluster_snapshot_input::ser_modify_cluster_snapshot_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyClusterSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyClusterSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyClusterSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyClusterSnapshotInput>()
                        .ok_or("failed to downcast to ModifyClusterSnapshotInput")?;
...
pub enum ModifyClusterSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyClusterSnapshotError) for what information is available for the error.")]
...
impl ModifyClusterSnapshotError {
    /// Creates the `ModifyClusterSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyClusterSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyClusterSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_cluster_snapshot::ModifyClusterSnapshotError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_cluster_snapshot::_modify_cluster_snapshot_output::ModifyClusterSnapshotOutput;

pub use crate::operation::modify_cluster_snapshot::_modify_cluster_snapshot_input::ModifyClusterSnapshotInput;

mod _modify_cluster_snapshot_input;

mod _modify_cluster_snapshot_output;
