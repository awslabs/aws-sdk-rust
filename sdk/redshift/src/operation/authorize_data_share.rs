...
impl AuthorizeDataShare {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::authorize_data_share::AuthorizeDataShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::authorize_data_share::AuthorizeDataShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::authorize_data_share::AuthorizeDataShareError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::authorize_data_share::AuthorizeDataShareOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeDataShare {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AuthorizeDataShare");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AuthorizeDataShareRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AuthorizeDataShareResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AuthorizeDataShare")
...
.with_interceptor(AuthorizeDataShareEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::authorize_data_share::AuthorizeDataShareError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::authorize_data_share::AuthorizeDataShareError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::authorize_data_share::AuthorizeDataShareError>::new());
...
#[derive(Debug)]
            struct AuthorizeDataShareResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AuthorizeDataShareResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_authorize_data_share::de_authorize_data_share_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_authorize_data_share::de_authorize_data_share_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AuthorizeDataShareRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AuthorizeDataShareRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::authorize_data_share::AuthorizeDataShareInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::authorize_data_share::AuthorizeDataShareInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_authorize_data_share_input::ser_authorize_data_share_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AuthorizeDataShareEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AuthorizeDataShareEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AuthorizeDataShareEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AuthorizeDataShareInput>()
                        .ok_or("failed to downcast to AuthorizeDataShareInput")?;
...
pub enum AuthorizeDataShareError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AuthorizeDataShareError) for what information is available for the error.")]
...
impl AuthorizeDataShareError {
    /// Creates the `AuthorizeDataShareError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AuthorizeDataShareError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AuthorizeDataShareError {
...
impl ::aws_types::request_id::RequestId for crate::operation::authorize_data_share::AuthorizeDataShareError {
...
mod _authorize_data_share_output;
