...
impl AuthorizeDataShareInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeDataShare`](crate::operation::authorize_data_share::AuthorizeDataShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::authorize_data_share::AuthorizeDataShare, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_data_share::AuthorizeDataShareInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_data_share_input::ser_authorize_data_share_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::authorize_data_share::AuthorizeDataShare::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AuthorizeDataShare", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for AuthorizeDataShare {
                type Output = std::result::Result<crate::operation::authorize_data_share::AuthorizeDataShareOutput, crate::operation::authorize_data_share::AuthorizeDataShareError>;
