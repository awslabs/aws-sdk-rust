...
/// Flattened paginator for `DescribeTagsPaginator`
                ...
                impl  DescribeTagsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::TaggedResource, aws_smithy_http::result::SdkError<crate::operation::describe_tags::DescribeTagsError>>> + Unpin
                     {
