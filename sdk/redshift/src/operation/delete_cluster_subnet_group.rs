...
/// Orchestration and serialization glue logic for `DeleteClusterSubnetGroup`.
...
impl DeleteClusterSubnetGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteClusterSubnetGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteClusterSubnetGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteClusterSubnetGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteClusterSubnetGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteClusterSubnetGroup")
...
.with_interceptor(DeleteClusterSubnetGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteClusterSubnetGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_cluster_subnet_group::de_delete_cluster_subnet_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_cluster_subnet_group::de_delete_cluster_subnet_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteClusterSubnetGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_cluster_subnet_group_input::ser_delete_cluster_subnet_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteClusterSubnetGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteClusterSubnetGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteClusterSubnetGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteClusterSubnetGroupInput>()
                        .ok_or("failed to downcast to DeleteClusterSubnetGroupInput")?;
...
pub enum DeleteClusterSubnetGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteClusterSubnetGroupError) for what information is available for the error.")]
...
impl DeleteClusterSubnetGroupError {
    /// Creates the `DeleteClusterSubnetGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteClusterSubnetGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidClusterSubnetStateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteClusterSubnetGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_cluster_subnet_group::_delete_cluster_subnet_group_output::DeleteClusterSubnetGroupOutput;

pub use crate::operation::delete_cluster_subnet_group::_delete_cluster_subnet_group_input::DeleteClusterSubnetGroupInput;

mod _delete_cluster_subnet_group_input;

mod _delete_cluster_subnet_group_output;
