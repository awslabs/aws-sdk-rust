...
impl DeleteClusterSubnetGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cluster_subnet_group::DeleteClusterSubnetGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClusterSubnetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_cluster_subnet_group::de_delete_cluster_subnet_group_http_response_with_props(status, headers, body)
        }
    }
}
