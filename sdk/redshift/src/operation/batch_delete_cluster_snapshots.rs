...
impl BatchDeleteClusterSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeleteClusterSnapshots`](crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_delete_cluster_snapshots_input::ser_batch_delete_cluster_snapshots_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchDeleteClusterSnapshots", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDeleteClusterSnapshots {
                type Output = std::result::Result<crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsOutput, crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsError>;
