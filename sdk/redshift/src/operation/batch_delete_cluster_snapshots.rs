...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteClusterSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_cluster_snapshots::de_batch_delete_cluster_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for BatchDeleteClusterSnapshotsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsError
{
