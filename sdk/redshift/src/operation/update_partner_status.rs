...
impl UpdatePartnerStatusInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePartnerStatus`](crate::operation::update_partner_status::UpdatePartnerStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_partner_status::UpdatePartnerStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_partner_status::UpdatePartnerStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_partner_status_input::ser_update_partner_status_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_partner_status::UpdatePartnerStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdatePartnerStatus", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdatePartnerStatus {
                type Output = std::result::Result<crate::operation::update_partner_status::UpdatePartnerStatusOutput, crate::operation::update_partner_status::UpdatePartnerStatusError>;
