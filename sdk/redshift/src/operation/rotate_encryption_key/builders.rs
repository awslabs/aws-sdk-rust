...
impl RotateEncryptionKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::rotate_encryption_key::RotateEncryptionKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rotate_encryption_key::RotateEncryptionKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::rotate_encryption_key::RotateEncryptionKeyOutput, crate::operation::rotate_encryption_key::RotateEncryptionKeyError, Self> {
