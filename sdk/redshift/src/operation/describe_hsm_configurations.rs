...
impl DescribeHsmConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHsmConfigurations`](crate::operation::describe_hsm_configurations::DescribeHsmConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_hsm_configurations::DescribeHsmConfigurations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_hsm_configurations_input::ser_describe_hsm_configurations_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_hsm_configurations::DescribeHsmConfigurations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeHsmConfigurations", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeHsmConfigurations {
                type Output = std::result::Result<crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsOutput, crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsError>;
