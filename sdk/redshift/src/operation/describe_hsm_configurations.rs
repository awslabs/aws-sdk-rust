...
impl DescribeHsmConfigurationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_hsm_configurations::DescribeHsmConfigurations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHsmConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_hsm_configurations::de_describe_hsm_configurations_http_response_with_props(status, headers, body)
        }
    }
}
