...
impl CreateSnapshotScheduleInput {
    /// Consumes the builder and constructs an Operation<[`CreateSnapshotSchedule`](crate::operation::create_snapshot_schedule::CreateSnapshotSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_snapshot_schedule::CreateSnapshotSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_snapshot_schedule::CreateSnapshotScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_snapshot_schedule_input::ser_create_snapshot_schedule_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_snapshot_schedule::CreateSnapshotSchedule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSnapshotSchedule", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSnapshotSchedule {
                type Output = std::result::Result<crate::operation::create_snapshot_schedule::CreateSnapshotScheduleOutput, crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError>;
...
impl aws_http::request_id::RequestId for crate::operation::create_snapshot_schedule::CreateSnapshotScheduleError {
