...
impl DescribeClusterSecurityGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterSecurityGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cluster_security_groups::de_describe_cluster_security_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
