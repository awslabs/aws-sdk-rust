...
impl AssociateDataShareConsumerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput, crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError, Self> {
