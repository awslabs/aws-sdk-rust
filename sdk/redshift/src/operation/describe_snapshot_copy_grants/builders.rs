...
impl DescribeSnapshotCopyGrantsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_snapshot_copy_grants::DescribeSnapshotCopyGrantsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_snapshot_copy_grants::DescribeSnapshotCopyGrantsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_snapshot_copy_grants::DescribeSnapshotCopyGrantsOutput, crate::operation::describe_snapshot_copy_grants::DescribeSnapshotCopyGrantsError, Self> {
