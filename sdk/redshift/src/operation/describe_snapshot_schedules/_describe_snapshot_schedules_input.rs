...
impl DescribeSnapshotSchedulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedulesInput, ::aws_smithy_types::error::operation::BuildError> {
