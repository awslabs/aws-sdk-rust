...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeClusterSecurityGroupIngress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_authorize_cluster_security_group_ingress::de_authorize_cluster_security_group_ingress_http_response_with_props(status, headers, body)
        }
    }
}
