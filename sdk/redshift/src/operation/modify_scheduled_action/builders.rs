...
impl ModifyScheduledActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_scheduled_action::ModifyScheduledActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_scheduled_action::ModifyScheduledActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_scheduled_action::ModifyScheduledActionOutput, crate::operation::modify_scheduled_action::ModifyScheduledActionError, Self> {
