...
impl DescribeDataSharesForConsumerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_data_shares_for_consumer::DescribeDataSharesForConsumerInput, ::aws_smithy_types::error::operation::BuildError> {
