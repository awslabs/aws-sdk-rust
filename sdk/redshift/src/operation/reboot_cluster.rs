...
impl RebootClusterInput {
    /// Consumes the builder and constructs an Operation<[`RebootCluster`](crate::operation::reboot_cluster::RebootCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reboot_cluster::RebootCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_cluster::RebootClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_cluster_input::ser_reboot_cluster_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_cluster::RebootCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RebootCluster", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for RebootCluster {
                type Output = std::result::Result<crate::operation::reboot_cluster::RebootClusterOutput, crate::operation::reboot_cluster::RebootClusterError>;
