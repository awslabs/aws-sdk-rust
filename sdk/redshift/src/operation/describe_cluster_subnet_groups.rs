...
impl DescribeClusterSubnetGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterSubnetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cluster_subnet_groups::de_describe_cluster_subnet_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
