...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterSubnetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cluster_subnet_groups::de_describe_cluster_subnet_groups_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeClusterSubnetGroupsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroupsError
{
