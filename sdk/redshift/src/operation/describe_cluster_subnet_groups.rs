...
impl DescribeClusterSubnetGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeClusterSubnetGroups`](crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cluster_subnet_groups_input::ser_describe_cluster_subnet_groups_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeClusterSubnetGroups", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeClusterSubnetGroups {
                type Output = std::result::Result<crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroupsOutput, crate::operation::describe_cluster_subnet_groups::DescribeClusterSubnetGroupsError>;
