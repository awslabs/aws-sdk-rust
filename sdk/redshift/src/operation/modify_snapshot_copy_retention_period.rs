...
impl ModifySnapshotCopyRetentionPeriod {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ModifySnapshotCopyRetentionPeriod",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifySnapshotCopyRetentionPeriod {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifySnapshotCopyRetentionPeriodRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifySnapshotCopyRetentionPeriodResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifySnapshotCopyRetentionPeriod")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifySnapshotCopyRetentionPeriod")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifySnapshotCopyRetentionPeriodTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifySnapshotCopyRetentionPeriodTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifySnapshotCopyRetentionPeriodTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifySnapshotCopyRetentionPeriodInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifySnapshotCopyRetentionPeriodResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_snapshot_copy_retention_period::de_modify_snapshot_copy_retention_period_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_modify_snapshot_copy_retention_period::de_modify_snapshot_copy_retention_period_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifySnapshotCopyRetentionPeriodRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_snapshot_copy_retention_period_input::ser_modify_snapshot_copy_retention_period_input_input_input(
                &input,
            )?,
        );
...
impl ::std::error::Error for ModifySnapshotCopyRetentionPeriodError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::SnapshotCopyDisabledFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifySnapshotCopyRetentionPeriodError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SnapshotCopyDisabledFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
