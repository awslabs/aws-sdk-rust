...
impl ModifySnapshotCopyRetentionPeriodInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriod::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifySnapshotCopyRetentionPeriod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_snapshot_copy_retention_period::de_modify_snapshot_copy_retention_period_http_response_with_props(
                status, headers, body,
            )
        }
    }
