...
impl ModifySnapshotCopyRetentionPeriod {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifySnapshotCopyRetentionPeriod {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifySnapshotCopyRetentionPeriod");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifySnapshotCopyRetentionPeriodRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifySnapshotCopyRetentionPeriodResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifySnapshotCopyRetentionPeriod")
...
.with_interceptor(ModifySnapshotCopyRetentionPeriodEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifySnapshotCopyRetentionPeriodResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_snapshot_copy_retention_period::de_modify_snapshot_copy_retention_period_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifySnapshotCopyRetentionPeriodRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_snapshot_copy_retention_period_input::ser_modify_snapshot_copy_retention_period_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifySnapshotCopyRetentionPeriodEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifySnapshotCopyRetentionPeriodEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifySnapshotCopyRetentionPeriodEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifySnapshotCopyRetentionPeriodInput>()
                        .ok_or("failed to downcast to ModifySnapshotCopyRetentionPeriodInput")?;
...
pub enum ModifySnapshotCopyRetentionPeriodError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifySnapshotCopyRetentionPeriodError) for what information is available for the error.")]
...
impl ModifySnapshotCopyRetentionPeriodError {
    /// Creates the `ModifySnapshotCopyRetentionPeriodError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySnapshotCopyRetentionPeriodError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SnapshotCopyDisabledFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifySnapshotCopyRetentionPeriodError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifySnapshotCopyRetentionPeriodError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError {
...
mod _modify_snapshot_copy_retention_period_output;
