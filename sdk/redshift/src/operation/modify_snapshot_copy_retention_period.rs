...
impl ModifySnapshotCopyRetentionPeriodInput {
    /// Consumes the builder and constructs an Operation<[`ModifySnapshotCopyRetentionPeriod`](crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriod)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriod, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_snapshot_copy_retention_period_input::ser_modify_snapshot_copy_retention_period_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriod::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifySnapshotCopyRetentionPeriod", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifySnapshotCopyRetentionPeriod {
                type Output = std::result::Result<crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodOutput, crate::operation::modify_snapshot_copy_retention_period::ModifySnapshotCopyRetentionPeriodError>;
