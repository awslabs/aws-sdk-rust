...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEventSubscriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_event_subscription::de_create_event_subscription_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_event_subscription::de_create_event_subscription_http_response(status, headers, body)
        };
