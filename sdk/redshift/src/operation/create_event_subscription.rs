...
/// Orchestration and serialization glue logic for `CreateEventSubscription`.
...
impl CreateEventSubscription {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_event_subscription::CreateEventSubscriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_event_subscription::CreateEventSubscriptionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "CreateEventSubscription", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Redshift.CreateEventSubscription",
                "rpc.service" = "Redshift",
                "rpc.method" = "CreateEventSubscription",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateEventSubscription {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateEventSubscription");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateEventSubscriptionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateEventSubscriptionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateEventSubscription")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateEventSubscription")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateEventSubscriptionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateEventSubscriptionEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateEventSubscriptionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateEventSubscriptionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateEventSubscriptionInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("SubscriptionName") {
            if let ::std::option::Option::Some(value) = input.subscription_name.as_deref() {
                captured.insert("SubscriptionName", value);
            }
        }
        ...
        if requested.should_capture("SourceType") {
            if let ::std::option::Option::Some(value) = input.source_type.as_deref() {
                captured.insert("SourceType", value);
            }
        }
        if requested.should_capture("Severity") {
            if let ::std::option::Option::Some(value) = input.severity.as_deref() {
                captured.insert("Severity", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEventSubscriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_event_subscription::de_create_event_subscription_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_event_subscription::de_create_event_subscription_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateEventSubscriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_event_subscription::CreateEventSubscriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_event_subscription::CreateEventSubscriptionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_event_subscription_input::ser_create_event_subscription_input_input_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateEventSubscriptionEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateEventSubscriptionEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateEventSubscriptionEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateEventSubscriptionInput>()
            .ok_or("failed to downcast to CreateEventSubscriptionInput")?;
...
pub enum CreateEventSubscriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateEventSubscriptionError) for what information is available for the error.")]
...
impl CreateEventSubscriptionError {
    ...
    /// Creates the `CreateEventSubscriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::EventSubscriptionQuotaExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::SubscriptionAlreadyExistFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for CreateEventSubscriptionError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::EventSubscriptionQuotaExceededFault(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::SubscriptionAlreadyExistFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateEventSubscriptionError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::EventSubscriptionQuotaExceededFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::SubscriptionAlreadyExistFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateEventSubscriptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_event_subscription::CreateEventSubscriptionError {
...
mod _create_event_subscription_output;
