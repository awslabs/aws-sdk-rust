...
impl DescribeClusterDbRevisionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsOutput, crate::operation::describe_cluster_db_revisions::DescribeClusterDbRevisionsError, Self> {
