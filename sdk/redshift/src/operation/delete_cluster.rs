...
impl DeleteClusterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_cluster_input::ser_delete_cluster_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_cluster::DeleteCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_cluster::de_delete_cluster_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_cluster::de_delete_cluster_http_response_with_props(
                status, headers, body,
            )
        }
    }
