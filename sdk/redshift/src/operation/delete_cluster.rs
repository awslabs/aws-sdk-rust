...
impl DeleteClusterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_cluster_input::ser_delete_cluster_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cluster::DeleteCluster::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteCluster", "redshift"));
