...
impl DescribeEventSubscriptionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_event_subscriptions::DescribeEventSubscriptions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEventSubscriptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_event_subscriptions::de_describe_event_subscriptions_http_response_with_props(status, headers, body)
        }
    }
}
