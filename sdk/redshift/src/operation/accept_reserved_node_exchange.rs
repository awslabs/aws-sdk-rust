...
impl AcceptReservedNodeExchange {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AcceptReservedNodeExchange",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptReservedNodeExchange {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AcceptReservedNodeExchangeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AcceptReservedNodeExchangeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AcceptReservedNodeExchange")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptReservedNodeExchange")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AcceptReservedNodeExchangeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AcceptReservedNodeExchangeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptReservedNodeExchangeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AcceptReservedNodeExchangeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptReservedNodeExchangeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_accept_reserved_node_exchange::de_accept_reserved_node_exchange_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_accept_reserved_node_exchange::de_accept_reserved_node_exchange_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptReservedNodeExchangeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_accept_reserved_node_exchange_input::ser_accept_reserved_node_exchange_input_input_input(&input)?,
        );
