...
impl AcceptReservedNodeExchangeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchange::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptReservedNodeExchange {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_reserved_node_exchange::de_accept_reserved_node_exchange_http_response_with_props(
                status, headers, body,
            )
        }
    }
