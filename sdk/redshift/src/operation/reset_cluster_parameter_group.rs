...
impl ResetClusterParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`ResetClusterParameterGroup`](crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_cluster_parameter_group_input::ser_reset_cluster_parameter_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResetClusterParameterGroup", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResetClusterParameterGroup {
                type Output = std::result::Result<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupOutput, crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError>;
