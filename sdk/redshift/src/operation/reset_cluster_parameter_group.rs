...
impl ResetClusterParameterGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reset_cluster_parameter_group::de_reset_cluster_parameter_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
