...
/// Orchestration and serialization glue logic for `ResetClusterParameterGroup`.
...
impl ResetClusterParameterGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupInput,
                    ) -> ::std::result::Result<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetClusterParameterGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResetClusterParameterGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResetClusterParameterGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResetClusterParameterGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetClusterParameterGroup")
...
.with_interceptor(ResetClusterParameterGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResetClusterParameterGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reset_cluster_parameter_group::de_reset_cluster_parameter_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reset_cluster_parameter_group::de_reset_cluster_parameter_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResetClusterParameterGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reset_cluster_parameter_group_input::ser_reset_cluster_parameter_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ResetClusterParameterGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResetClusterParameterGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResetClusterParameterGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResetClusterParameterGroupInput>()
                        .ok_or("failed to downcast to ResetClusterParameterGroupInput")?;
...
pub enum ResetClusterParameterGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResetClusterParameterGroupError) for what information is available for the error.")]
...
impl ResetClusterParameterGroupError {
    /// Creates the `ResetClusterParameterGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetClusterParameterGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResetClusterParameterGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupError {
...
mod _reset_cluster_parameter_group_output;
