...
impl CreateRedshiftIdcApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_redshift_idc_application::CreateRedshiftIdcApplicationInput, ::aws_smithy_types::error::operation::BuildError> {
