...
impl EnableSnapshotCopyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_snapshot_copy::EnableSnapshotCopyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_snapshot_copy::EnableSnapshotCopyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_snapshot_copy::EnableSnapshotCopyOutput, crate::operation::enable_snapshot_copy::EnableSnapshotCopyError, Self> {
