...
impl DescribeNodeConfigurationOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNodeConfigurationOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_node_configuration_options::de_describe_node_configuration_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
