...
impl EnableLoggingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_logging_input::ser_enable_logging_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_logging::EnableLogging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableLogging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_logging::de_enable_logging_http_error(
                status, headers, body,
            )
        } else {
