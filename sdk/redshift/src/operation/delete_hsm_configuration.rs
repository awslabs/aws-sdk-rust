...
impl DeleteHsmConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteHsmConfiguration`](crate::operation::delete_hsm_configuration::DeleteHsmConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_hsm_configuration::DeleteHsmConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_hsm_configuration::DeleteHsmConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_hsm_configuration_input::ser_delete_hsm_configuration_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_hsm_configuration::DeleteHsmConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteHsmConfiguration", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteHsmConfiguration {
                type Output = std::result::Result<crate::operation::delete_hsm_configuration::DeleteHsmConfigurationOutput, crate::operation::delete_hsm_configuration::DeleteHsmConfigurationError>;
