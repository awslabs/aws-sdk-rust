...
impl DeleteHsmConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_hsm_configuration::DeleteHsmConfiguration,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHsmConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_hsm_configuration::de_delete_hsm_configuration_http_response_with_props(status, headers, body)
        }
    }
}
