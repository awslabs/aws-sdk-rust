...
impl DeletePartnerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_partner_input::ser_delete_partner_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_partner::DeletePartner::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePartner {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_partner::de_delete_partner_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_partner::de_delete_partner_http_response_with_props(
                status, headers, body,
            )
        }
    }
