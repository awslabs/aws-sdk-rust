...
impl DescribeResizeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_resize_input::ser_describe_resize_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_resize::DescribeResize::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeResize {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_resize::de_describe_resize_http_error(
                status, headers, body,
            )
        } else {
