...
impl GetReservedNodeExchangeConfigurationOptionsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_reserved_node_exchange_configuration_options::paginator::GetReservedNodeExchangeConfigurationOptionsPaginatorItems
    {
...
impl GetReservedNodeExchangeConfigurationOptionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_reserved_node_exchange_configuration_options_output_output_reserved_node_configuration_option_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
