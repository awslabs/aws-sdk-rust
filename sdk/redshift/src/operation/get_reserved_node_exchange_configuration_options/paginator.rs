...
/// Flattened paginator for `GetReservedNodeExchangeConfigurationOptionsPaginator`
                ...
                impl  GetReservedNodeExchangeConfigurationOptionsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::ReservedNodeConfigurationOption, aws_smithy_http::result::SdkError<crate::operation::get_reserved_node_exchange_configuration_options::GetReservedNodeExchangeConfigurationOptionsError>>> + Unpin
                     {
