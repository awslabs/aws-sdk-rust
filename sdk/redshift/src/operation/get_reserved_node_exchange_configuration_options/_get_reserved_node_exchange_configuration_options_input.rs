...
impl GetReservedNodeExchangeConfigurationOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_reserved_node_exchange_configuration_options::GetReservedNodeExchangeConfigurationOptionsInput, ::aws_smithy_types::error::operation::BuildError> {
