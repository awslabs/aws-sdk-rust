...
/// Orchestration and serialization glue logic for `RevokeSnapshotAccess`.
...
impl RevokeSnapshotAccess {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::revoke_snapshot_access::RevokeSnapshotAccessInput,
                    ) -> ::std::result::Result<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeSnapshotAccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RevokeSnapshotAccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RevokeSnapshotAccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RevokeSnapshotAccessResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeSnapshotAccess")
...
.with_interceptor(RevokeSnapshotAccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeSnapshotAccessResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_revoke_snapshot_access::de_revoke_snapshot_access_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_revoke_snapshot_access::de_revoke_snapshot_access_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeSnapshotAccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::revoke_snapshot_access::RevokeSnapshotAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_revoke_snapshot_access_input::ser_revoke_snapshot_access_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RevokeSnapshotAccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeSnapshotAccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RevokeSnapshotAccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RevokeSnapshotAccessInput>()
                        .ok_or("failed to downcast to RevokeSnapshotAccessInput")?;
...
pub enum RevokeSnapshotAccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RevokeSnapshotAccessError) for what information is available for the error.")]
...
impl RevokeSnapshotAccessError {
    /// Creates the `RevokeSnapshotAccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeSnapshotAccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RevokeSnapshotAccessError {
...
impl ::aws_types::request_id::RequestId for crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError {
...
mod _revoke_snapshot_access_output;
