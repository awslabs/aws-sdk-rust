...
impl RevokeSnapshotAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "RevokeSnapshotAccess", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Redshift.RevokeSnapshotAccess",
                "rpc.service" = "Redshift",
                "rpc.method" = "RevokeSnapshotAccess",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeSnapshotAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RevokeSnapshotAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RevokeSnapshotAccessResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RevokeSnapshotAccess")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeSnapshotAccess")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RevokeSnapshotAccessTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RevokeSnapshotAccessTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeSnapshotAccessTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RevokeSnapshotAccessInput>() else {
        ...
        if requested.should_capture("AccountWithRestoreAccess") {
            if let ::std::option::Option::Some(value) = input.account_with_restore_access.as_deref() {
                captured.insert("AccountWithRestoreAccess", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeSnapshotAccessResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_revoke_snapshot_access::de_revoke_snapshot_access_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_revoke_snapshot_access::de_revoke_snapshot_access_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeSnapshotAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::revoke_snapshot_access::RevokeSnapshotAccessInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_snapshot_access_input::ser_revoke_snapshot_access_input_input_input(&input)?,
        );
