...
impl RevokeSnapshotAccessInput {
    /// Consumes the builder and constructs an Operation<[`RevokeSnapshotAccess`](crate::operation::revoke_snapshot_access::RevokeSnapshotAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::revoke_snapshot_access::RevokeSnapshotAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_snapshot_access::RevokeSnapshotAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_snapshot_access_input::ser_revoke_snapshot_access_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_snapshot_access::RevokeSnapshotAccess::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RevokeSnapshotAccess", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for RevokeSnapshotAccess {
                type Output = std::result::Result<crate::operation::revoke_snapshot_access::RevokeSnapshotAccessOutput, crate::operation::revoke_snapshot_access::RevokeSnapshotAccessError>;
