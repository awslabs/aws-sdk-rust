...
impl DescribeClusterSecurityGroupsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroupsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
