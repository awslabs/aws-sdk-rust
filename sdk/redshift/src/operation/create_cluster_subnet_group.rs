...
impl CreateClusterSubnetGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cluster_subnet_group::CreateClusterSubnetGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClusterSubnetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cluster_subnet_group::de_create_cluster_subnet_group_http_response_with_props(status, headers, body)
        }
    }
}
