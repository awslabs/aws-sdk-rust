...
impl ModifyClusterMaintenanceInput {
    /// Consumes the builder and constructs an Operation<[`ModifyClusterMaintenance`](crate::operation::modify_cluster_maintenance::ModifyClusterMaintenance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_cluster_maintenance::ModifyClusterMaintenance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_cluster_maintenance::ModifyClusterMaintenanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_cluster_maintenance_input::ser_modify_cluster_maintenance_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_cluster_maintenance::ModifyClusterMaintenance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyClusterMaintenance", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyClusterMaintenance {
                type Output = std::result::Result<crate::operation::modify_cluster_maintenance::ModifyClusterMaintenanceOutput, crate::operation::modify_cluster_maintenance::ModifyClusterMaintenanceError>;
