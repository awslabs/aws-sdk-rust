...
impl DescribeOrderableClusterOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_orderable_cluster_options::DescribeOrderableClusterOptionsInput, ::aws_smithy_types::error::operation::BuildError> {
