...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_scheduled_action_input::ser_delete_scheduled_action_input_input_input(&input)?);
