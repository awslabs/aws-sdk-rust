...
impl DeleteScheduledActionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteScheduledAction`](crate::operation::delete_scheduled_action::DeleteScheduledAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_scheduled_action::DeleteScheduledAction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_scheduled_action::DeleteScheduledActionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_scheduled_action::DeleteScheduledAction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteScheduledAction", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteScheduledAction {
                type Output = std::result::Result<crate::operation::delete_scheduled_action::DeleteScheduledActionOutput, crate::operation::delete_scheduled_action::DeleteScheduledActionError>;
