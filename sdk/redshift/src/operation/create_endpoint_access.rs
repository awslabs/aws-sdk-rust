...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEndpointAccessResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_endpoint_access::de_create_endpoint_access_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_endpoint_access::de_create_endpoint_access_http_response(status, headers, body)
        };
