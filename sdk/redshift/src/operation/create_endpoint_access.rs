...
impl CreateEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`CreateEndpointAccess`](crate::operation::create_endpoint_access::CreateEndpointAccess)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_endpoint_access_input::ser_create_endpoint_access_input_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_endpoint_access::CreateEndpointAccess::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateEndpointAccess", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEndpointAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_endpoint_access::de_create_endpoint_access_http_response_with_props(status, headers, body)
        }
    }
}
