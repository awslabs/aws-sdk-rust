...
impl CreateEndpointAccessInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_endpoint_access::CreateEndpointAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_endpoint_access::CreateEndpointAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for CreateEndpointAccess {
                type Output = std::result::Result<crate::operation::create_endpoint_access::CreateEndpointAccessOutput, crate::operation::create_endpoint_access::CreateEndpointAccessError>;
