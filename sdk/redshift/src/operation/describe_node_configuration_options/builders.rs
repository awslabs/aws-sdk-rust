...
impl DescribeNodeConfigurationOptionsFluentBuilder {
    ...
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> std::result::Result<crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptionsOutput, aws_smithy_http::result::SdkError<crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptionsError>>
                     {
        let op = self
            .inner
            .build()
