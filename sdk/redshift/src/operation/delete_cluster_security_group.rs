...
/// Orchestration and serialization glue logic for `DeleteClusterSecurityGroup`.
...
impl DeleteClusterSecurityGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteClusterSecurityGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteClusterSecurityGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteClusterSecurityGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteClusterSecurityGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteClusterSecurityGroup")
...
.with_interceptor(DeleteClusterSecurityGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteClusterSecurityGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_cluster_security_group::de_delete_cluster_security_group_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteClusterSecurityGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_cluster_security_group_input::ser_delete_cluster_security_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteClusterSecurityGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteClusterSecurityGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteClusterSecurityGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteClusterSecurityGroupInput>()
                        .ok_or("failed to downcast to DeleteClusterSecurityGroupInput")?;
...
pub enum DeleteClusterSecurityGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteClusterSecurityGroupError) for what information is available for the error.")]
...
impl DeleteClusterSecurityGroupError {
    /// Creates the `DeleteClusterSecurityGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteClusterSecurityGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteClusterSecurityGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_cluster_security_group::DeleteClusterSecurityGroupError {
...
mod _delete_cluster_security_group_output;
