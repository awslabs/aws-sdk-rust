...
impl DescribeLoggingStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_logging_status::DescribeLoggingStatus,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoggingStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_logging_status::de_describe_logging_status_http_response_with_props(status, headers, body)
        }
    }
}
