...
impl DescribeLoggingStatusInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLoggingStatus`](crate::operation::describe_logging_status::DescribeLoggingStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_logging_status::DescribeLoggingStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_logging_status::DescribeLoggingStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_logging_status_input::ser_describe_logging_status_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_logging_status::DescribeLoggingStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeLoggingStatus", "redshift"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeLoggingStatus`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLoggingStatus {
                type Output = std::result::Result<crate::operation::describe_logging_status::DescribeLoggingStatusOutput, crate::operation::describe_logging_status::DescribeLoggingStatusError>;
