...
impl RestoreTableFromClusterSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RestoreTableFromClusterSnapshot",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreTableFromClusterSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RestoreTableFromClusterSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RestoreTableFromClusterSnapshotResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RestoreTableFromClusterSnapshot")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreTableFromClusterSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RestoreTableFromClusterSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RestoreTableFromClusterSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreTableFromClusterSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RestoreTableFromClusterSnapshotInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreTableFromClusterSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_restore_table_from_cluster_snapshot::de_restore_table_from_cluster_snapshot_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_restore_table_from_cluster_snapshot::de_restore_table_from_cluster_snapshot_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreTableFromClusterSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_restore_table_from_cluster_snapshot_input::ser_restore_table_from_cluster_snapshot_input_input_input(
                &input,
            )?,
        );
...
impl ::std::error::Error for RestoreTableFromClusterSnapshotError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InProgressTableRestoreQuotaExceededFault(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::InvalidTableRestoreArgumentFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RestoreTableFromClusterSnapshotError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InProgressTableRestoreQuotaExceededFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::InvalidTableRestoreArgumentFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
