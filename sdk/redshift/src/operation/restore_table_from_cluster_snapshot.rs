...
impl RestoreTableFromClusterSnapshot {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_table_from_cluster_snapshot::RestoreTableFromClusterSnapshotOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RestoreTableFromClusterSnapshotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RestoreTableFromClusterSnapshotRequestSerializer {
