...
impl DisableSnapshotCopyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disable_snapshot_copy::DisableSnapshotCopyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_snapshot_copy::DisableSnapshotCopyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disable_snapshot_copy::DisableSnapshotCopyOutput, crate::operation::disable_snapshot_copy::DisableSnapshotCopyError, Self> {
