...
impl CreateSnapshotCopyGrant {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift", "CreateSnapshotCopyGrant", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Redshift.CreateSnapshotCopyGrant",
                "rpc.service" = "Redshift",
                "rpc.method" = "CreateSnapshotCopyGrant",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSnapshotCopyGrant {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateSnapshotCopyGrantRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateSnapshotCopyGrantResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateSnapshotCopyGrant")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSnapshotCopyGrant")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateSnapshotCopyGrantTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateSnapshotCopyGrantTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateSnapshotCopyGrantTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateSnapshotCopyGrantInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSnapshotCopyGrantResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_snapshot_copy_grant::de_create_snapshot_copy_grant_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_snapshot_copy_grant::de_create_snapshot_copy_grant_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSnapshotCopyGrantRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_snapshot_copy_grant_input::ser_create_snapshot_copy_grant_input_input_input(&input)?,
        );
...
impl ::std::error::Error for CreateSnapshotCopyGrantError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::SnapshotCopyGrantAlreadyExistsFault(_inner) => ::std::option::Option::Some(_inner),
            Self::SnapshotCopyGrantQuotaExceededFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateSnapshotCopyGrantError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SnapshotCopyGrantAlreadyExistsFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::SnapshotCopyGrantQuotaExceededFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
