...
impl CreateClusterSecurityGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateClusterSecurityGroup`](crate::operation::create_cluster_security_group::CreateClusterSecurityGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_cluster_security_group::CreateClusterSecurityGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_cluster_security_group::CreateClusterSecurityGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_cluster_security_group_input::ser_create_cluster_security_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_cluster_security_group::CreateClusterSecurityGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateClusterSecurityGroup", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateClusterSecurityGroup {
                type Output = std::result::Result<crate::operation::create_cluster_security_group::CreateClusterSecurityGroupOutput, crate::operation::create_cluster_security_group::CreateClusterSecurityGroupError>;
