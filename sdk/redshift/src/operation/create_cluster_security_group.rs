...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClusterSecurityGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cluster_security_group::de_create_cluster_security_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_cluster_security_group::CreateClusterSecurityGroupError
{
