...
impl CancelResizeInput {
    /// Consumes the builder and constructs an Operation<[`CancelResize`](crate::operation::cancel_resize::CancelResize)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_resize::CancelResize, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_resize::CancelResizeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_resize_input::ser_cancel_resize_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_resize::CancelResize::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelResize", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CancelResize {
                type Output = std::result::Result<crate::operation::cancel_resize::CancelResizeOutput, crate::operation::cancel_resize::CancelResizeError>;
