...
impl CancelResizeInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_resize::CancelResize::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CancelResize {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_cancel_resize::de_cancel_resize_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_cancel_resize::de_cancel_resize_http_response_with_props(
                status, headers, body,
            )
        }
    }
