...
impl ModifyClusterParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyClusterParameterGroup`](crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_cluster_parameter_group_input::ser_modify_cluster_parameter_group_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyClusterParameterGroup", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyClusterParameterGroup {
                type Output = std::result::Result<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupOutput, crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError>;
