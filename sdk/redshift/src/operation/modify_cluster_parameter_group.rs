...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_cluster_parameter_group::de_modify_cluster_parameter_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ModifyClusterParameterGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError
{
