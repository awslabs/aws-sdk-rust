...
/// Orchestration and serialization glue logic for `ModifyClusterParameterGroup`.
...
impl ModifyClusterParameterGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyClusterParameterGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyClusterParameterGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyClusterParameterGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyClusterParameterGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyClusterParameterGroup")
...
.with_interceptor(ModifyClusterParameterGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyClusterParameterGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_cluster_parameter_group::de_modify_cluster_parameter_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_cluster_parameter_group::de_modify_cluster_parameter_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyClusterParameterGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_cluster_parameter_group_input::ser_modify_cluster_parameter_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyClusterParameterGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyClusterParameterGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyClusterParameterGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyClusterParameterGroupInput>()
                        .ok_or("failed to downcast to ModifyClusterParameterGroupInput")?;
...
pub enum ModifyClusterParameterGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyClusterParameterGroupError) for what information is available for the error.")]
...
impl ModifyClusterParameterGroupError {
    /// Creates the `ModifyClusterParameterGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyClusterParameterGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidClusterParameterGroupStateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyClusterParameterGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_cluster_parameter_group::ModifyClusterParameterGroupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_cluster_parameter_group::_modify_cluster_parameter_group_output::ModifyClusterParameterGroupOutput;

pub use crate::operation::modify_cluster_parameter_group::_modify_cluster_parameter_group_input::ModifyClusterParameterGroupInput;

mod _modify_cluster_parameter_group_input;

mod _modify_cluster_parameter_group_output;
