...
impl CreateSnapshotCopyGrantInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantInput, ::aws_smithy_types::error::operation::BuildError> {
