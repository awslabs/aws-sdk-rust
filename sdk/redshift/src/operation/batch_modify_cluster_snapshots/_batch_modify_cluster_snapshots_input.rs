...
impl BatchModifyClusterSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsInput, ::aws_smithy_types::error::operation::BuildError> {
