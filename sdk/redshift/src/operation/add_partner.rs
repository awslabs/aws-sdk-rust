...
impl AddPartnerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_partner::AddPartner::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddPartner {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_add_partner::de_add_partner_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_add_partner::de_add_partner_http_response_with_props(
                status, headers, body,
            )
        }
    }
