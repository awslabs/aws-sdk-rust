...
impl DeleteAuthenticationProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_authentication_profile::DeleteAuthenticationProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAuthenticationProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_authentication_profile::de_delete_authentication_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
