...
/// Orchestration and serialization glue logic for `DeleteAuthenticationProfile`.
...
impl DeleteAuthenticationProfile {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_authentication_profile::DeleteAuthenticationProfileInput,
                    ) -> ::std::result::Result<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAuthenticationProfile {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAuthenticationProfile");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAuthenticationProfileRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAuthenticationProfileResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAuthenticationProfile")
...
.with_interceptor(DeleteAuthenticationProfileEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError>::new());
...
#[derive(Debug)]
            struct DeleteAuthenticationProfileResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAuthenticationProfileResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_authentication_profile::de_delete_authentication_profile_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_authentication_profile::de_delete_authentication_profile_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteAuthenticationProfileRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAuthenticationProfileRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_authentication_profile::DeleteAuthenticationProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_authentication_profile_input::ser_delete_authentication_profile_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteAuthenticationProfileEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAuthenticationProfileEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAuthenticationProfileEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAuthenticationProfileInput>()
                        .ok_or("failed to downcast to DeleteAuthenticationProfileInput")?;
...
pub enum DeleteAuthenticationProfileError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAuthenticationProfileError) for what information is available for the error.")]
...
impl DeleteAuthenticationProfileError {
    /// Creates the `DeleteAuthenticationProfileError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAuthenticationProfileError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AuthenticationProfileNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidAuthenticationProfileRequestFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAuthenticationProfileError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError {
...
mod _delete_authentication_profile_output;
