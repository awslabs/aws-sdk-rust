...
impl DeleteAuthenticationProfileInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAuthenticationProfile`](crate::operation::delete_authentication_profile::DeleteAuthenticationProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_authentication_profile::DeleteAuthenticationProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_authentication_profile::DeleteAuthenticationProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_authentication_profile_input::ser_delete_authentication_profile_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_authentication_profile::DeleteAuthenticationProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteAuthenticationProfile", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAuthenticationProfile {
                type Output = std::result::Result<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileOutput, crate::operation::delete_authentication_profile::DeleteAuthenticationProfileError>;
