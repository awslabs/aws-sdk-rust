...
impl GetClusterCredentialsWithIamInput {
    /// Consumes the builder and constructs an Operation<[`GetClusterCredentialsWithIAM`](crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAM)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAM, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_cluster_credentials_with_iam_input::ser_get_cluster_credentials_with_iam_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAM::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetClusterCredentialsWithIAM", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetClusterCredentialsWithIAM {
                type Output = std::result::Result<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamOutput, crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError>;
