...
/// Orchestration and serialization glue logic for `GetClusterCredentialsWithIAM`.
...
impl GetClusterCredentialsWithIAM {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamInput,
                    ) -> ::std::result::Result<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetClusterCredentialsWithIAM {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetClusterCredentialsWithIAM");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetClusterCredentialsWithIAMRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetClusterCredentialsWithIAMResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetClusterCredentialsWithIAM")
...
.with_interceptor(GetClusterCredentialsWithIAMEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError>::new());
...
#[derive(Debug)]
            struct GetClusterCredentialsWithIAMResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetClusterCredentialsWithIAMResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_cluster_credentials_with_iam::de_get_cluster_credentials_with_iam_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_cluster_credentials_with_iam::de_get_cluster_credentials_with_iam_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetClusterCredentialsWithIAMRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetClusterCredentialsWithIAMRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_cluster_credentials_with_iam_input::ser_get_cluster_credentials_with_iam_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetClusterCredentialsWithIAMEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetClusterCredentialsWithIAMEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetClusterCredentialsWithIAMEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetClusterCredentialsWithIamInput>()
                        .ok_or("failed to downcast to GetClusterCredentialsWithIamInput")?;
...
pub enum GetClusterCredentialsWithIAMError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetClusterCredentialsWithIAMError) for what information is available for the error.")]
...
impl GetClusterCredentialsWithIAMError {
    /// Creates the `GetClusterCredentialsWithIAMError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetClusterCredentialsWithIAMError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetClusterCredentialsWithIAMError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError {
...
mod _get_cluster_credentials_with_iam_output;
