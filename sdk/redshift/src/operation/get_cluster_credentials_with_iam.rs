...
impl GetClusterCredentialsWithIamInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAM::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClusterCredentialsWithIAM {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cluster_credentials_with_iam::de_get_cluster_credentials_with_iam_http_response_with_props(
                status, headers, body,
            )
        }
    }
