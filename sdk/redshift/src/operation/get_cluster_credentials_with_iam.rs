...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClusterCredentialsWithIAM {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cluster_credentials_with_iam::de_get_cluster_credentials_with_iam_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetClusterCredentialsWithIAMError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_cluster_credentials_with_iam::GetClusterCredentialsWithIAMError
{
