...
impl AssociateDataShareConsumerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_data_share_consumer::AssociateDataShareConsumer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDataShareConsumer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_data_share_consumer::de_associate_data_share_consumer_http_response_with_props(
                status, headers, body,
            )
        }
    }
