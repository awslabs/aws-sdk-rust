...
impl AssociateDataShareConsumerInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDataShareConsumer`](crate::operation::associate_data_share_consumer::AssociateDataShareConsumer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_data_share_consumer::AssociateDataShareConsumer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_data_share_consumer::AssociateDataShareConsumerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_data_share_consumer_input::ser_associate_data_share_consumer_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_data_share_consumer::AssociateDataShareConsumer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateDataShareConsumer", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateDataShareConsumer {
                type Output = std::result::Result<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput, crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError>;
