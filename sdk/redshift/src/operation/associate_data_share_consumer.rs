...
/// Orchestration and serialization glue logic for `AssociateDataShareConsumer`.
...
impl AssociateDataShareConsumer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_data_share_consumer::AssociateDataShareConsumerInput,
                    ) -> ::std::result::Result<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateDataShareConsumer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateDataShareConsumer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateDataShareConsumerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateDataShareConsumerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateDataShareConsumer")
...
.with_interceptor(AssociateDataShareConsumerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError>::new());
...
#[derive(Debug)]
            struct AssociateDataShareConsumerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateDataShareConsumerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_data_share_consumer::de_associate_data_share_consumer_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AssociateDataShareConsumerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateDataShareConsumerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_data_share_consumer::AssociateDataShareConsumerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_data_share_consumer_input::ser_associate_data_share_consumer_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AssociateDataShareConsumerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateDataShareConsumerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateDataShareConsumerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateDataShareConsumerInput>()
                        .ok_or("failed to downcast to AssociateDataShareConsumerInput")?;
...
pub enum AssociateDataShareConsumerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateDataShareConsumerError) for what information is available for the error.")]
...
impl AssociateDataShareConsumerError {
    /// Creates the `AssociateDataShareConsumerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateDataShareConsumerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateDataShareConsumerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_data_share_consumer::AssociateDataShareConsumerError {
...
mod _associate_data_share_consumer_output;
