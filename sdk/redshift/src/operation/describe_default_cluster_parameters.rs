...
impl DescribeDefaultClusterParametersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_default_cluster_parameters::DescribeDefaultClusterParameters::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDefaultClusterParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_default_cluster_parameters::de_describe_default_cluster_parameters_http_response_with_props(
                status, headers, body,
            )
        }
    }
