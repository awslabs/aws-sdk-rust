...
impl RejectDataShareInput {
    /// Consumes the builder and constructs an Operation<[`RejectDataShare`](crate::operation::reject_data_share::RejectDataShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reject_data_share::RejectDataShare, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reject_data_share::RejectDataShareInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reject_data_share_input::ser_reject_data_share_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reject_data_share::RejectDataShare::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RejectDataShare", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for RejectDataShare {
                type Output = std::result::Result<crate::operation::reject_data_share::RejectDataShareOutput, crate::operation::reject_data_share::RejectDataShareError>;
