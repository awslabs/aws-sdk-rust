...
impl ResumeClusterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resume_cluster_input::ser_resume_cluster_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resume_cluster::ResumeCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resume_cluster::de_resume_cluster_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_resume_cluster::de_resume_cluster_http_response_with_props(
                status, headers, body,
            )
        }
    }
