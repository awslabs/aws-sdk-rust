...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_resource_policy_input::ser_get_resource_policy_input_input_input(&input)?);
...
impl ::std::error::Error for GetResourcePolicyError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::InvalidPolicyFault(_inner) =>
