...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyClusterSnapshotSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_cluster_snapshot_schedule::de_modify_cluster_snapshot_schedule_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_cluster_snapshot_schedule::ModifyClusterSnapshotScheduleError
{
