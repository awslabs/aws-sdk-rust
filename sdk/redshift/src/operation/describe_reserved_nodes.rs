...
impl DescribeReservedNodes {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("redshift", "DescribeReservedNodes", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeReservedNodes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeReservedNodes", "redshift"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeReservedNodesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_describe_reserved_nodes_input::ser_describe_reserved_nodes_input_input_input(&input)?,
        );
