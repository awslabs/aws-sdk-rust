...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_reserved_nodes_input::ser_describe_reserved_nodes_input_input_input(&input)?);
