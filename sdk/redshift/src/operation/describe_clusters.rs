...
impl DescribeClustersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeClusters`](crate::operation::describe_clusters::DescribeClusters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_clusters::DescribeClusters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_clusters::DescribeClustersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_clusters_input::ser_describe_clusters_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_clusters::DescribeClusters::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeClusters", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeClusters {
                type Output = std::result::Result<crate::operation::describe_clusters::DescribeClustersOutput, crate::operation::describe_clusters::DescribeClustersError>;
