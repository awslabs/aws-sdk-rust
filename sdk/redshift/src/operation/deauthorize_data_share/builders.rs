...
impl DeauthorizeDataShareInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.deauthorize_data_share();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::deauthorize_data_share::DeauthorizeDataShareOutput,
                    crate::operation::deauthorize_data_share::DeauthorizeDataShareError,
                > for DeauthorizeDataShareFluentBuilder
            {
                fn send(
                    self,
...
impl DeauthorizeDataShareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deauthorize_data_share::DeauthorizeDataShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deauthorize_data_share::DeauthorizeDataShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::deauthorize_data_share::DeauthorizeDataShare::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::deauthorize_data_share::DeauthorizeDataShare::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deauthorize_data_share::DeauthorizeDataShareOutput, crate::operation::deauthorize_data_share::DeauthorizeDataShareError, Self> {
