...
impl DescribeTableRestoreStatusInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTableRestoreStatus`](crate::operation::describe_table_restore_status::DescribeTableRestoreStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_table_restore_status::DescribeTableRestoreStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_table_restore_status::DescribeTableRestoreStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_table_restore_status_input::ser_describe_table_restore_status_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_table_restore_status::DescribeTableRestoreStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeTableRestoreStatus", "redshift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTableRestoreStatus {
                type Output = std::result::Result<crate::operation::describe_table_restore_status::DescribeTableRestoreStatusOutput, crate::operation::describe_table_restore_status::DescribeTableRestoreStatusError>;
