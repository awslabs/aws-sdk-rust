...
impl Builder {
    ...
    /// use aws_sdk_pinpointsmsvoicev2::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_pinpointsmsvoicev2::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
