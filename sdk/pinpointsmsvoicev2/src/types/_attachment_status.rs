...
///     AttachmentStatus::UploadComplete => { /* ... */ },
///     AttachmentStatus::UploadFailed => { /* ... */ },
///     AttachmentStatus::UploadInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for AttachmentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "UPLOAD_COMPLETE" => AttachmentStatus::UploadComplete,
            "UPLOAD_FAILED" => AttachmentStatus::UploadFailed,
            "UPLOAD_IN_PROGRESS" => AttachmentStatus::UploadInProgress,
            other => AttachmentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttachmentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttachmentStatus::from(s))
    }
}
impl AttachmentStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AttachmentStatus::Deleted => "DELETED",
            AttachmentStatus::UploadComplete => "UPLOAD_COMPLETE",
            AttachmentStatus::UploadFailed => "UPLOAD_FAILED",
            AttachmentStatus::UploadInProgress => "UPLOAD_IN_PROGRESS",
            AttachmentStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["DELETED", "UPLOAD_COMPLETE", "UPLOAD_FAILED", "UPLOAD_IN_PROGRESS"]
    }
}
