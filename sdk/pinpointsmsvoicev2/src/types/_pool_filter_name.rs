...
impl PoolFilterName {
    ...
    PoolFilterName::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["deletion-protection-enabled", "message-type", "opt-out-list-name", "self-managed-opt-outs-enabled", "shared-routes-enabled", "status", "two-way-channel-arn", "two-way-enabled"]
                }
            }
