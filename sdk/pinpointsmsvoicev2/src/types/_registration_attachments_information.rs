...
impl RegistrationAttachmentsInformationBuilder {
    ...
    pub fn set_attachment_upload_error_reason(mut self, input: ::std::option::Option<crate::types::AttachmentUploadErrorReason>) -> Self {
        self.attachment_upload_error_reason = input; self
    }
    /// <p>A description of why the upload didn't successfully complete.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::RegistrationAttachmentsInformation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::RegistrationAttachmentsInformation {
                registration_attachment_arn: self.registration_attachment_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_attachment_arn", "registration_attachment_arn was not specified but it is required when building RegistrationAttachmentsInformation")
                    )?
                ,
                registration_attachment_id: self.registration_attachment_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_attachment_id", "registration_attachment_id was not specified but it is required when building RegistrationAttachmentsInformation")
                    )?
                ,
                attachment_status: self.attachment_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("attachment_status", "attachment_status was not specified but it is required when building RegistrationAttachmentsInformation")
                    )?
                ,
                ...
                created_timestamp: self.created_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_timestamp", "created_timestamp was not specified but it is required when building RegistrationAttachmentsInformation")
                    )?
                ,
            }
        )
