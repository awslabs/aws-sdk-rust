...
impl ResourceType {
    ...
    ResourceType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["account", "configuration-set", "event-destination", "keyword", "opt-out-list", "opted-out-number", "phone-number", "pool", "registration", "registration-attachment", "sender-id", "verified-destination-number"]
                }
            }
