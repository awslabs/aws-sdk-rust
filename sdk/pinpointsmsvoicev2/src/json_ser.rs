...
pub fn serialize_structure_crate_input_associate_origination_identity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateOriginationIdentityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_event_destination_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEventDestinationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_opt_out_list_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOptOutListInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePoolInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_configuration_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteConfigurationSetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_default_message_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteDefaultMessageTypeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_default_sender_id_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteDefaultSenderIdInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_event_destination_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteEventDestinationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_keyword_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteKeywordInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_opted_out_number_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteOptedOutNumberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_opt_out_list_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteOptOutListInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeletePoolInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_account_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeAccountAttributesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_account_limits_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeAccountLimitsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_configuration_sets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeConfigurationSetsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_keywords_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeKeywordsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_opted_out_numbers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeOptedOutNumbersInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_opt_out_lists_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeOptOutListsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_phone_numbers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePhoneNumbersInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_pools_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePoolsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_sender_ids_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSenderIdsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_spend_limits_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSpendLimitsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_disassociate_origination_identity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateOriginationIdentityInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_pool_origination_identities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPoolOriginationIdentitiesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_keyword_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutKeywordInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_opted_out_number_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutOptedOutNumberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_release_phone_number_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ReleasePhoneNumberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_request_phone_number_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RequestPhoneNumberInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_send_text_message_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendTextMessageInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_set_default_message_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetDefaultMessageTypeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_set_default_sender_id_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetDefaultSenderIdInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_set_text_message_spend_limit_override_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetTextMessageSpendLimitOverrideInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_set_voice_message_spend_limit_override_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetVoiceMessageSpendLimitOverrideInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_event_destination_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEventDestinationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePoolInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_configuration_set_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfigurationSetFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_opted_out_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OptedOutFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_phone_number_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PhoneNumberFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_pool_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PoolFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sender_id_and_country(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SenderIdAndCountry) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sender_id_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SenderIdFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_pool_origination_identities_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PoolOriginationIdentitiesFilter) -> Result<(), aws_smithy_http::operation::SerializationError> {
