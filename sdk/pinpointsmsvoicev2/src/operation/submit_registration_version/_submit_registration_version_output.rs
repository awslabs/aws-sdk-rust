...
impl SubmitRegistrationVersionOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::submit_registration_version::SubmitRegistrationVersionOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::submit_registration_version::SubmitRegistrationVersionOutput {
                registration_arn: self.registration_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_arn", "registration_arn was not specified but it is required when building SubmitRegistrationVersionOutput")
                    )?
                ,
                registration_id: self.registration_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_id", "registration_id was not specified but it is required when building SubmitRegistrationVersionOutput")
                    )?
                ,
                version_number: self.version_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("version_number", "version_number was not specified but it is required when building SubmitRegistrationVersionOutput")
                    )?
                ,
                registration_version_status: self.registration_version_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_version_status", "registration_version_status was not specified but it is required when building SubmitRegistrationVersionOutput")
                    )?
                ,
