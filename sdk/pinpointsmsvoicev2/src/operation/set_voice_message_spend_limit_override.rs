...
impl SetVoiceMessageSpendLimitOverride {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetVoiceMessageSpendLimitOverride {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetVoiceMessageSpendLimitOverride");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetVoiceMessageSpendLimitOverrideRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetVoiceMessageSpendLimitOverrideResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetVoiceMessageSpendLimitOverride")
...
.with_interceptor(SetVoiceMessageSpendLimitOverrideEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideError>::new());
...
#[derive(Debug)]
            struct SetVoiceMessageSpendLimitOverrideResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetVoiceMessageSpendLimitOverrideResponseDeserializer {
...
#[derive(Debug)]
            struct SetVoiceMessageSpendLimitOverrideRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetVoiceMessageSpendLimitOverrideRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_voice_message_spend_limit_override::ser_set_voice_message_spend_limit_override_input(&input)?);
...
#[derive(Debug)]
            struct SetVoiceMessageSpendLimitOverrideEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetVoiceMessageSpendLimitOverrideEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetVoiceMessageSpendLimitOverrideEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetVoiceMessageSpendLimitOverrideInput>()
                        .ok_or("failed to downcast to SetVoiceMessageSpendLimitOverrideInput")?;
...
pub enum SetVoiceMessageSpendLimitOverrideError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetVoiceMessageSpendLimitOverrideError) for what information is available for the error.")]
...
impl SetVoiceMessageSpendLimitOverrideError {
    /// Creates the `SetVoiceMessageSpendLimitOverrideError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetVoiceMessageSpendLimitOverrideError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetVoiceMessageSpendLimitOverrideError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideError {
...
mod _set_voice_message_spend_limit_override_output;
