...
impl SetVoiceMessageSpendLimitOverrideInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverride::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetVoiceMessageSpendLimitOverride {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_voice_message_spend_limit_override::de_set_voice_message_spend_limit_override_http_response_with_props(
                status, headers, body,
            )
        }
    }
