...
impl ReleasePhoneNumberInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_release_phone_number::ser_release_phone_number_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::release_phone_number::ReleasePhoneNumber::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::release_phone_number::ReleasePhoneNumberError
{
