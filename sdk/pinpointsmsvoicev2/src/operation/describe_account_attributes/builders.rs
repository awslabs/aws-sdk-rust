...
impl DescribeAccountAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_account_attributes::DescribeAccountAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_account_attributes::DescribeAccountAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_account_attributes::DescribeAccountAttributesOutput, crate::operation::describe_account_attributes::DescribeAccountAttributesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_account_attributes::paginator::DescribeAccountAttributesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::describe_account_attributes::paginator::DescribeAccountAttributesPaginator {
                                crate::operation::describe_account_attributes::paginator::DescribeAccountAttributesPaginator::new(self.handle, self.inner)
                            }
