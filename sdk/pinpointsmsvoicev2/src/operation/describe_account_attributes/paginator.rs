...
/// Paginator for [`DescribeAccountAttributes`](crate::operation::describe_account_attributes::DescribeAccountAttributes)
            ...
            impl DescribeAccountAttributesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_account_attributes::DescribeAccountAttributesOutput, aws_smithy_http::result::SdkError<crate::operation::describe_account_attributes::DescribeAccountAttributesError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_describe_account_attributes_output_next_token(resp);
...
/// Flattened paginator for `DescribeAccountAttributesPaginator`
                ...
                impl  DescribeAccountAttributesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::AccountAttribute, aws_smithy_http::result::SdkError<crate::operation::describe_account_attributes::DescribeAccountAttributesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_account_attributes_output_account_attributes(page).unwrap_or_default().into_iter())
                    }
                }
