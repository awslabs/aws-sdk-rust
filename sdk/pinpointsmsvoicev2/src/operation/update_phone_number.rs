...
impl UpdatePhoneNumberInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_phone_number::UpdatePhoneNumber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_phone_number::UpdatePhoneNumber::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdatePhoneNumber", "pinpointsmsvoicev2"));
