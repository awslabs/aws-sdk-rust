...
impl SendDestinationNumberVerificationCodeOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::send_destination_number_verification_code::SendDestinationNumberVerificationCodeOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::send_destination_number_verification_code::SendDestinationNumberVerificationCodeOutput {
                message_id: self.message_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("message_id", "message_id was not specified but it is required when building SendDestinationNumberVerificationCodeOutput")
                    )?
                ,
