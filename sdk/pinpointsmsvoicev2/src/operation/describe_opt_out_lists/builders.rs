...
impl DescribeOptOutListsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_opt_out_lists::DescribeOptOutListsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_opt_out_lists::DescribeOptOutListsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_opt_out_lists::DescribeOptOutListsOutput, crate::operation::describe_opt_out_lists::DescribeOptOutListsError, Self> {
