...
impl DeleteRegistrationFieldValueOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_registration_field_value::DeleteRegistrationFieldValueOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_registration_field_value::DeleteRegistrationFieldValueOutput {
                registration_arn: self.registration_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_arn", "registration_arn was not specified but it is required when building DeleteRegistrationFieldValueOutput")
                    )?
                ,
                registration_id: self.registration_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_id", "registration_id was not specified but it is required when building DeleteRegistrationFieldValueOutput")
                    )?
                ,
                version_number: self.version_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("version_number", "version_number was not specified but it is required when building DeleteRegistrationFieldValueOutput")
                    )?
                ,
                field_path: self.field_path
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("field_path", "field_path was not specified but it is required when building DeleteRegistrationFieldValueOutput")
                    )?
                ,
