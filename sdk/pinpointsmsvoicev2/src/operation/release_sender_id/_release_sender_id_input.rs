...
impl ReleaseSenderIdInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::release_sender_id::ReleaseSenderIdInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::release_sender_id::ReleaseSenderIdInput {
