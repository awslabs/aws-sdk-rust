...
impl ReleaseSenderIdFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::release_sender_id::ReleaseSenderIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::release_sender_id::ReleaseSenderIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::release_sender_id::ReleaseSenderIdOutput, crate::operation::release_sender_id::ReleaseSenderIdError, Self> {
