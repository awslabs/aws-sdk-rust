...
impl SendTextMessageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_text_message::SendTextMessage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_text_message::ser_send_text_message_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendTextMessage {
    type Output =
        ::std::result::Result<crate::operation::send_text_message::SendTextMessageOutput, crate::operation::send_text_message::SendTextMessageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_text_message::de_send_text_message_http_response_with_props(status, headers, body)
        }
    }
}
