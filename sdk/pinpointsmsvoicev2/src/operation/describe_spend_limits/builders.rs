...
impl DescribeSpendLimitsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_spend_limits::DescribeSpendLimitsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_spend_limits::DescribeSpendLimitsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_spend_limits::DescribeSpendLimitsOutput, crate::operation::describe_spend_limits::DescribeSpendLimitsError, Self> {
