...
impl DisassociateOriginationIdentityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_origination_identity::DisassociateOriginationIdentityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_origination_identity::DisassociateOriginationIdentityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_origination_identity::DisassociateOriginationIdentityOutput, crate::operation::disassociate_origination_identity::DisassociateOriginationIdentityError, Self> {
