...
impl  DescribeRegistrationFieldValuesOutput  {
    ...
    pub fn registration_field_values(&self) -> & [crate::types::RegistrationFieldValueInformation] {
        use std::ops::Deref; self.registration_field_values.deref()
    }
    /// <p>The token to be used for the next set of paginated results. You don't need to supply a value for this field in the initial request.</p>
...
impl DescribeRegistrationFieldValuesOutputBuilder {
    ...
    /// <p>An array of RegistrationFieldValues objects that contain the values for the requested registration.</p>
    pub fn set_registration_field_values(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::RegistrationFieldValueInformation>>) -> Self {
        self.registration_field_values = input; self
    }
    /// <p>An array of RegistrationFieldValues objects that contain the values for the requested registration.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_registration_field_values::DescribeRegistrationFieldValuesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_registration_field_values::DescribeRegistrationFieldValuesOutput {
                registration_arn: self.registration_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_arn", "registration_arn was not specified but it is required when building DescribeRegistrationFieldValuesOutput")
                    )?
                ,
                registration_id: self.registration_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_id", "registration_id was not specified but it is required when building DescribeRegistrationFieldValuesOutput")
                    )?
                ,
                version_number: self.version_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("version_number", "version_number was not specified but it is required when building DescribeRegistrationFieldValuesOutput")
                    )?
                ,
                registration_field_values: self.registration_field_values
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_field_values", "registration_field_values was not specified but it is required when building DescribeRegistrationFieldValuesOutput")
                    )?
                ,
