...
impl DeleteDefaultMessageTypeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_default_message_type::DeleteDefaultMessageTypeInput, ::aws_smithy_types::error::operation::BuildError> {
