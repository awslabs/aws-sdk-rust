...
impl DeleteKeywordInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_keyword::DeleteKeyword, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_keyword::ser_delete_keyword_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteKeyword {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_keyword::de_delete_keyword_http_response_with_props(status, headers, body)
        }
    }
}
