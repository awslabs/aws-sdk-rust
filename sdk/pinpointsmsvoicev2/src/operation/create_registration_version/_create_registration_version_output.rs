...
pub struct CreateRegistrationVersionOutput  {
...
impl ::aws_types::request_id::RequestId for CreateRegistrationVersionOutput {
                                    fn request_id(&self) -> Option<&str> {
                                        self._request_id.as_deref()
                                    }
                                }
impl CreateRegistrationVersionOutput {
    /// Creates a new builder-style object to manufacture [`CreateRegistrationVersionOutput`](crate::operation::create_registration_version::CreateRegistrationVersionOutput).
    pub fn builder() -> crate::operation::create_registration_version::builders::CreateRegistrationVersionOutputBuilder {
        crate::operation::create_registration_version::builders::CreateRegistrationVersionOutputBuilder::default()
    }
}

/// A builder for [`CreateRegistrationVersionOutput`](crate::operation::create_registration_version::CreateRegistrationVersionOutput).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct CreateRegistrationVersionOutputBuilder {
...
impl CreateRegistrationVersionOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) for the registration.</p>
    ...
    /// Consumes the builder and constructs a [`CreateRegistrationVersionOutput`](crate::operation::create_registration_version::CreateRegistrationVersionOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`registration_arn`](crate::operation::create_registration_version::builders::CreateRegistrationVersionOutputBuilder::registration_arn)
    /// - [`registration_id`](crate::operation::create_registration_version::builders::CreateRegistrationVersionOutputBuilder::registration_id)
    /// - [`version_number`](crate::operation::create_registration_version::builders::CreateRegistrationVersionOutputBuilder::version_number)
    /// - [`registration_version_status`](crate::operation::create_registration_version::builders::CreateRegistrationVersionOutputBuilder::registration_version_status)
    pub fn build(self) -> ::std::result::Result<crate::operation::create_registration_version::CreateRegistrationVersionOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_registration_version::CreateRegistrationVersionOutput {
                registration_arn: self.registration_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_arn", "registration_arn was not specified but it is required when building CreateRegistrationVersionOutput")
                    )?
                ,
                registration_id: self.registration_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_id", "registration_id was not specified but it is required when building CreateRegistrationVersionOutput")
                    )?
                ,
                version_number: self.version_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("version_number", "version_number was not specified but it is required when building CreateRegistrationVersionOutput")
                    )?
                ,
                registration_version_status: self.registration_version_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_version_status", "registration_version_status was not specified but it is required when building CreateRegistrationVersionOutput")
                    )?
                ,
