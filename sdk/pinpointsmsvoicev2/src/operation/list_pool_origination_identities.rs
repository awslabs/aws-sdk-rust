...
impl ListPoolOriginationIdentitiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_pool_origination_identities::ListPoolOriginationIdentities::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPoolOriginationIdentities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pool_origination_identities::de_list_pool_origination_identities_http_response_with_props(
                status, headers, body,
            )
        }
    }
