...
impl DescribeConfigurationSetsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_configuration_sets::DescribeConfigurationSets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_sets::de_describe_configuration_sets_http_response_with_props(status, headers, body)
        }
    }
}
