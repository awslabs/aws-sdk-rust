...
impl DeleteRegistrationAttachmentOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_registration_attachment::DeleteRegistrationAttachmentOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_registration_attachment::DeleteRegistrationAttachmentOutput {
                registration_attachment_arn: self.registration_attachment_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_attachment_arn", "registration_attachment_arn was not specified but it is required when building DeleteRegistrationAttachmentOutput")
                    )?
                ,
                registration_attachment_id: self.registration_attachment_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("registration_attachment_id", "registration_attachment_id was not specified but it is required when building DeleteRegistrationAttachmentOutput")
                    )?
                ,
                attachment_status: self.attachment_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("attachment_status", "attachment_status was not specified but it is required when building DeleteRegistrationAttachmentOutput")
                    )?
                ,
                ...
                created_timestamp: self.created_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_timestamp", "created_timestamp was not specified but it is required when building DeleteRegistrationAttachmentOutput")
                    )?
                ,
