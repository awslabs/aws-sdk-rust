...
pub use crate::operation::create_registration_attachment::_create_registration_attachment_output::CreateRegistrationAttachmentOutputBuilder;

pub use crate::operation::create_registration_attachment::_create_registration_attachment_input::CreateRegistrationAttachmentInputBuilder;
...
impl CreateRegistrationAttachmentInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.create_registration_attachment();
...
pub struct CreateRegistrationAttachmentFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_registration_attachment::builders::CreateRegistrationAttachmentInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_registration_attachment::CreateRegistrationAttachmentOutput,
                    crate::operation::create_registration_attachment::CreateRegistrationAttachmentError,
                > for CreateRegistrationAttachmentFluentBuilder
            {
                fn send(
                    self,
...
impl CreateRegistrationAttachmentFluentBuilder {
    /// Creates a new `CreateRegistrationAttachment`.
    ...
    /// Access the CreateRegistrationAttachment as a reference.
    pub fn as_input(&self) -> &crate::operation::create_registration_attachment::builders::CreateRegistrationAttachmentInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_registration_attachment::CreateRegistrationAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_registration_attachment::CreateRegistrationAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_registration_attachment::CreateRegistrationAttachment::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_registration_attachment::CreateRegistrationAttachment::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_registration_attachment::CreateRegistrationAttachmentOutput, crate::operation::create_registration_attachment::CreateRegistrationAttachmentError, Self> {
