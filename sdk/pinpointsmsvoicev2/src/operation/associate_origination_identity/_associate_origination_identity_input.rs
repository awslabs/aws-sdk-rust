...
impl AssociateOriginationIdentityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_origination_identity::AssociateOriginationIdentityInput, ::aws_smithy_types::error::operation::BuildError> {
