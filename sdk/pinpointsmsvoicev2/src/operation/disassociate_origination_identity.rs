...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateOriginationIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_origination_identity::de_disassociate_origination_identity_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_origination_identity::DisassociateOriginationIdentityError
{
