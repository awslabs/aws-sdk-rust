...
impl DescribeConfigurationSetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_configuration_sets::DescribeConfigurationSetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_configuration_sets::DescribeConfigurationSetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_configuration_sets::DescribeConfigurationSetsOutput, crate::operation::describe_configuration_sets::DescribeConfigurationSetsError, Self> {
