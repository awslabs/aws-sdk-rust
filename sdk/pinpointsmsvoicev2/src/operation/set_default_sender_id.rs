...
impl SetDefaultSenderId {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_default_sender_id::SetDefaultSenderIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_default_sender_id::SetDefaultSenderIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_default_sender_id::SetDefaultSenderIdError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_default_sender_id::SetDefaultSenderIdOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetDefaultSenderId {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetDefaultSenderId");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetDefaultSenderIdRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetDefaultSenderIdResponseDeserializer));
...
.with_interceptor(SetDefaultSenderIdEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_default_sender_id::SetDefaultSenderIdError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_default_sender_id::SetDefaultSenderIdError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_default_sender_id::SetDefaultSenderIdError>::new());
...
#[derive(Debug)]
            struct SetDefaultSenderIdResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetDefaultSenderIdResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_default_sender_id::de_set_default_sender_id_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_default_sender_id::de_set_default_sender_id_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetDefaultSenderIdRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetDefaultSenderIdRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_default_sender_id::SetDefaultSenderIdInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_default_sender_id::SetDefaultSenderIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_default_sender_id::ser_set_default_sender_id_input(&input)?);
...
#[derive(Debug)]
            struct SetDefaultSenderIdEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetDefaultSenderIdEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetDefaultSenderIdEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetDefaultSenderIdInput>()
                        .ok_or("failed to downcast to SetDefaultSenderIdInput")?;
...
pub enum SetDefaultSenderIdError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetDefaultSenderIdError) for what information is available for the error.")]
...
impl SetDefaultSenderIdError {
    /// Creates the `SetDefaultSenderIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetDefaultSenderIdError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetDefaultSenderIdError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_default_sender_id::SetDefaultSenderIdError {
...
mod _set_default_sender_id_output;
