...
impl PutRegistrationFieldValueFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_registration_field_value::PutRegistrationFieldValueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_registration_field_value::PutRegistrationFieldValueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_registration_field_value::PutRegistrationFieldValueOutput, crate::operation::put_registration_field_value::PutRegistrationFieldValueError, Self> {
