...
impl PutRegistrationFieldValueInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_registration_field_value::PutRegistrationFieldValueInput, ::aws_smithy_types::error::operation::BuildError> {
