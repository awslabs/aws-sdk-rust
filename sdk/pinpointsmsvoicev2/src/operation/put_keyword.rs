...
impl PutKeywordInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_keyword::PutKeyword::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutKeyword {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_keyword::de_put_keyword_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_keyword::de_put_keyword_http_response_with_props(
                status, headers, body,
            )
        }
    }
