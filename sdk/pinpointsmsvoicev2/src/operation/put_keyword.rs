...
impl PutKeywordInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_keyword::PutKeyword, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_keyword::ser_put_keyword_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutKeyword {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_keyword::de_put_keyword_http_response_with_props(status, headers, body)
        }
    }
}
