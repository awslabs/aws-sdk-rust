...
impl CreateOptOutListInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_opt_out_list::ser_create_opt_out_list_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOptOutList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_opt_out_list::de_create_opt_out_list_http_response_with_props(status, headers, body)
        }
    }
}
