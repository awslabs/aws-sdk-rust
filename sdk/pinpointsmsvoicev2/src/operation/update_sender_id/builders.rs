...
impl UpdateSenderIdFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_sender_id::UpdateSenderIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_sender_id::UpdateSenderIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_sender_id::UpdateSenderIdOutput, crate::operation::update_sender_id::UpdateSenderIdError, Self> {
