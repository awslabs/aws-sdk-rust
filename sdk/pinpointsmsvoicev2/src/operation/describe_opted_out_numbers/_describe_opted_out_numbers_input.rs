...
impl DescribeOptedOutNumbersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_opted_out_numbers::DescribeOptedOutNumbersInput, ::aws_smithy_types::error::operation::BuildError> {
