...
impl DescribeOptedOutNumbersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_opted_out_numbers::DescribeOptedOutNumbersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_opted_out_numbers::DescribeOptedOutNumbersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_opted_out_numbers::DescribeOptedOutNumbersOutput, crate::operation::describe_opted_out_numbers::DescribeOptedOutNumbersError, Self> {
