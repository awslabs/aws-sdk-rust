...
impl DescribeRegistrationFieldDefinitionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_registration_field_definitions::DescribeRegistrationFieldDefinitionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_registration_field_definitions::DescribeRegistrationFieldDefinitionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_registration_field_definitions::DescribeRegistrationFieldDefinitions::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_registration_field_definitions::DescribeRegistrationFieldDefinitionsOutput, crate::operation::describe_registration_field_definitions::DescribeRegistrationFieldDefinitionsError, Self> {
    ...
    /// Create a paginator for this request
                            ...
                            pub fn into_paginator(self) -> crate::operation::describe_registration_field_definitions::paginator::DescribeRegistrationFieldDefinitionsPaginator {
                                crate::operation::describe_registration_field_definitions::paginator::DescribeRegistrationFieldDefinitionsPaginator::new(self.handle, self.inner)
                            }
