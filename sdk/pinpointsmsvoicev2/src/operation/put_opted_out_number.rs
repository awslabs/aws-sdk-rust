...
impl PutOptedOutNumberInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_opted_out_number::ser_put_opted_out_number_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutOptedOutNumber {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_opted_out_number::de_put_opted_out_number_http_response_with_props(status, headers, body)
        }
    }
}
