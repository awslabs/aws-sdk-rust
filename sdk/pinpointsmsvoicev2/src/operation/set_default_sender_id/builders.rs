...
impl SetDefaultSenderIdFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_default_sender_id::SetDefaultSenderIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_default_sender_id::SetDefaultSenderIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_default_sender_id::SetDefaultSenderIdOutput, crate::operation::set_default_sender_id::SetDefaultSenderIdError, Self> {
