...
impl CreateOptOutListFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_opt_out_list::CreateOptOutListOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_opt_out_list::CreateOptOutListError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_opt_out_list::CreateOptOutListOutput, crate::operation::create_opt_out_list::CreateOptOutListError, Self> {
