...
impl CreateVerifiedDestinationNumberInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_verified_destination_number::CreateVerifiedDestinationNumberInput, ::aws_smithy_types::error::operation::BuildError> {
