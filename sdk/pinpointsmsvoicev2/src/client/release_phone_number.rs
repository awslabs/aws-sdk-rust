...
impl super::Client {
    ...
    ///   - [`two_way_channel_role(Option<String>)`](crate::operation::release_phone_number::ReleasePhoneNumberOutput::two_way_channel_role): <p>An optional IAM Role Arn for a service to assume, to be able to post inbound SMS messages.</p>
    ///   - [`self_managed_opt_outs_enabled(bool)`](crate::operation::release_phone_number::ReleasePhoneNumberOutput::self_managed_opt_outs_enabled): <p>By default this is set to false. When set to false and an end recipient sends a message that begins with HELP or STOP to one of your dedicated numbers, End User Messaging SMS automatically replies with a customizable message and adds the end recipient to the OptOutList. When set to true you're responsible for responding to HELP and STOP requests. You're also responsible for tracking and honoring opt-out requests.</p>
    ...
    ///   - [`registration_id(Option<String>)`](crate::operation::release_phone_number::ReleasePhoneNumberOutput::registration_id): <p>The unique identifier for the registration.</p>
