...
impl super::Client {
    ...
    ///   - [`opt_out_list_name(impl Into<String>)`](crate::operation::create_opt_out_list::builders::CreateOptOutListFluentBuilder::opt_out_list_name) / [`set_opt_out_list_name(impl Into<String>)`](crate::operation::create_opt_out_list::builders::CreateOptOutListFluentBuilder::set_opt_out_list_name):<br>required: **true**<br><p>The name of the new OptOutList.</p><br>
    ///   - [`tags(Tag)`](crate::operation::create_opt_out_list::builders::CreateOptOutListFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_opt_out_list::builders::CreateOptOutListFluentBuilder::set_tags):<br>required: **false**<br><p>An array of tags (key and value pairs) to associate with the new OptOutList.</p><br>
