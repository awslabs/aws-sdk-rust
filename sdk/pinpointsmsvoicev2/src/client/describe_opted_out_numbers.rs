...
impl super::Client {
    ...
    ///   - [`opt_out_list_name(impl ::std::convert::Into<String>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::opt_out_list_name) / [`set_opt_out_list_name(Option<String>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::set_opt_out_list_name): <p>The OptOutListName or OptOutListArn of the OptOutList. You can use <code>DescribeOptOutLists</code> to find the values for OptOutListName and OptOutListArn.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results. You don't need to supply a value for this field in the initial request.</p>
