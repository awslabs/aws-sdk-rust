...
impl super::Client {
    ...
    ///   - [`opted_out_numbers(impl Into<String>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::opted_out_numbers) / [`set_opted_out_numbers(Option<Vec<String>>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::set_opted_out_numbers): <p>An array of phone numbers to search for in the OptOutList.</p>
    ///   - [`filters(OptedOutFilter)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::filters) / [`set_filters(Option<Vec<OptedOutFilter>>)`](crate::operation::describe_opted_out_numbers::builders::DescribeOptedOutNumbersFluentBuilder::set_filters): <p>An array of OptedOutFilter objects to filter the results on.</p>
