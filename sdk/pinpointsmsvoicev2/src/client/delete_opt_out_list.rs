...
impl super::Client {
    ...
    ///   - [`opt_out_list_name(impl Into<String>)`](crate::operation::delete_opt_out_list::builders::DeleteOptOutListFluentBuilder::opt_out_list_name) / [`set_opt_out_list_name(impl Into<String>)`](crate::operation::delete_opt_out_list::builders::DeleteOptOutListFluentBuilder::set_opt_out_list_name):<br>required: **true**<br><p>The OptOutListName or OptOutListArn of the OptOutList to delete. You can use <code>DescribeOptOutLists</code> to find the values for OptOutListName and OptOutListArn.</p><br>
