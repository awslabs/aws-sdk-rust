...
impl super::Client {
    ...
    ///   - [`configuration_set_name(impl Into<String>)`](crate::operation::delete_default_sender_id::builders::DeleteDefaultSenderIdFluentBuilder::configuration_set_name) / [`set_configuration_set_name(impl Into<String>)`](crate::operation::delete_default_sender_id::builders::DeleteDefaultSenderIdFluentBuilder::set_configuration_set_name):<br>required: **true**<br><p>The name of the configuration set or the configuration set Amazon Resource Name (ARN) to delete the default sender ID from. The ConfigurationSetName and ConfigurationSetArn can be found using the <code>DescribeConfigurationSets</code> action.</p><br>
