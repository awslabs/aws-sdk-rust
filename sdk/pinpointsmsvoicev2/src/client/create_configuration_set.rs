...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::set_tags): <p>An array of key and value pair tags that's associated with the new configuration set. </p>
