...
impl super::Client {
    ...
    ///   - [`monthly_limit(i64)`](crate::operation::set_voice_message_spend_limit_override::builders::SetVoiceMessageSpendLimitOverrideFluentBuilder::monthly_limit) / [`set_monthly_limit(i64)`](crate::operation::set_voice_message_spend_limit_override::builders::SetVoiceMessageSpendLimitOverrideFluentBuilder::set_monthly_limit):<br>required: **true**<br><p>The new monthly limit to enforce on voice messages.</p><br>
