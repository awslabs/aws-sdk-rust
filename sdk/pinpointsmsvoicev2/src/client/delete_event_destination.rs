...
impl super::Client {
    ...
    ///   - [`configuration_set_name(impl ::std::convert::Into<String>)`](crate::operation::delete_event_destination::builders::DeleteEventDestinationFluentBuilder::configuration_set_name) / [`set_configuration_set_name(Option<String>)`](crate::operation::delete_event_destination::builders::DeleteEventDestinationFluentBuilder::set_configuration_set_name): <p>The name of the configuration set or the configuration set's Amazon Resource Name (ARN) to remove the event destination from. The ConfigurateSetName and ConfigurationSetArn can be found using the <code>DescribeConfigurationSets</code> action.</p>
    ///   - [`event_destination_name(impl ::std::convert::Into<String>)`](crate::operation::delete_event_destination::builders::DeleteEventDestinationFluentBuilder::event_destination_name) / [`set_event_destination_name(Option<String>)`](crate::operation::delete_event_destination::builders::DeleteEventDestinationFluentBuilder::set_event_destination_name): <p>The name of the event destination to delete.</p>
