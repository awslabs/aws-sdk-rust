...
impl super::Client {
    ...
    ///   - [`filters(PhoneNumberFilter)`](crate::operation::describe_phone_numbers::builders::DescribePhoneNumbersFluentBuilder::filters) / [`set_filters(Option<Vec<PhoneNumberFilter>>)`](crate::operation::describe_phone_numbers::builders::DescribePhoneNumbersFluentBuilder::set_filters): <p>An array of PhoneNumberFilter objects to filter the results.</p>
