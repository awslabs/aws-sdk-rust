...
impl super::Client {
    ...
    ///   - [`origination_identity(impl Into<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::origination_identity) / [`set_origination_identity(impl Into<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::set_origination_identity):<br>required: **true**<br><p>The origination identity to use such as a PhoneNumberId, PhoneNumberArn, PoolId or PoolArn. You can use <code>DescribePhoneNumbers</code> to find the values for PhoneNumberId and PhoneNumberArn and <code>DescribePools</code> to find the values of PoolId and PoolArn.</p><br>
    ///   - [`keyword(impl Into<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::keyword) / [`set_keyword(impl Into<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::set_keyword):<br>required: **true**<br><p>The keyword to delete.</p><br>
