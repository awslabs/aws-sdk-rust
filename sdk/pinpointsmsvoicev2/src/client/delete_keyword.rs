...
impl super::Client {
    ...
    ///   - [`origination_identity(impl ::std::convert::Into<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::origination_identity) / [`set_origination_identity(Option<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::set_origination_identity): <p>The origination identity to use such as a PhoneNumberId, PhoneNumberArn, PoolId or PoolArn. You can use <code>DescribePhoneNumbers</code> to find the values for PhoneNumberId and PhoneNumberArn and <code>DescribePools</code> to find the values of PoolId and PoolArn.</p>
    ///   - [`keyword(impl ::std::convert::Into<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::keyword) / [`set_keyword(Option<String>)`](crate::operation::delete_keyword::builders::DeleteKeywordFluentBuilder::set_keyword): <p>The keyword to delete.</p>
