...
pub fn ser_send_text_message_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendTextMessageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
