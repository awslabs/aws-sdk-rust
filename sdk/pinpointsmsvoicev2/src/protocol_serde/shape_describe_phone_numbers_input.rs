...
pub fn ser_describe_phone_numbers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePhoneNumbersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
