...
pub fn ser_update_phone_number_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePhoneNumberInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
