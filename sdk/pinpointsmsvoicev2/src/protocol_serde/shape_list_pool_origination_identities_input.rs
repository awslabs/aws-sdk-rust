...
pub fn ser_list_pool_origination_identities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPoolOriginationIdentitiesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
