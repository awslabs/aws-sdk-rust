...
pub fn ser_describe_keywords_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeKeywordsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
