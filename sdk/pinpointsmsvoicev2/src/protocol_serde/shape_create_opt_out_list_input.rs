...
pub fn ser_create_opt_out_list_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_opt_out_list::CreateOptOutListInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
