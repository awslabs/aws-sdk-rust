...
pub fn ser_create_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePoolInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
