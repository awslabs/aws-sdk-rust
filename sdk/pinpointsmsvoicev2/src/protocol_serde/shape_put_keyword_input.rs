...
pub fn ser_put_keyword_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutKeywordInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
