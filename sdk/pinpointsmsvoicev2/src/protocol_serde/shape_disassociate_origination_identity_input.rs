...
pub fn ser_disassociate_origination_identity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateOriginationIdentityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
