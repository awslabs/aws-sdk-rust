...
pub fn ser_send_voice_message_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendVoiceMessageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
