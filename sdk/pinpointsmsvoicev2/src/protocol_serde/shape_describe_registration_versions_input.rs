...
pub fn ser_describe_registration_versions_input_input(
    ...
    if let Some(var_2) = &input.version_numbers {
        let mut array_3 = object.key("VersionNumbers").start_array();
        for item_4 in var_2 {
            {
        ...
        for item_7 in var_5 {
            {
                ...
                crate::protocol_serde::shape_registration_version_filter::ser_registration_version_filter(&mut object_8, item_7)?;
                object_8.finish();
            }
        }
        array_6.finish();
