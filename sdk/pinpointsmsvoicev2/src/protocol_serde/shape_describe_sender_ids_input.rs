...
pub fn ser_describe_sender_ids_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSenderIdsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
