...
pub fn ser_describe_sender_ids_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_sender_ids::DescribeSenderIdsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1) = &input.sender_ids {
        let mut array_2 = object.key("SenderIds").start_array();
        for item_3 in var_1 {
             {
                #[allow(unused_mut)]
