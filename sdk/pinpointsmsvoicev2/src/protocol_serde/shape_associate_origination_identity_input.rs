...
pub fn ser_associate_origination_identity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateOriginationIdentityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
