...
pub struct UpdatePoolOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::PoolStatus>,
    /// <p>The type of message for the pool to use.</p>
    #[doc(hidden)]pub message_type: std::option::Option<crate::model::MessageType>,
    /// <p>By default this is set to false. When set to true you can receive incoming text messages from your end recipients.</p>
    #[doc(hidden)]pub two_way_enabled: bool,
    /// <p>The Amazon Resource Name (ARN) of the two way channel.</p>
    #[doc(hidden)]pub two_way_channel_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub self_managed_opt_outs_enabled: bool,
    /// <p>The name of the OptOutList associated with the pool.</p>
    #[doc(hidden)]pub opt_out_list_name: std::option::Option<std::string::String>,
    /// <p>Indicates whether shared routes are enabled for the pool.</p>
    #[doc(hidden)]pub shared_routes_enabled: bool,
    /// <p>When set to true the pool can't be deleted.</p>
    #[doc(hidden)]pub deletion_protection_enabled: bool,
...
impl  std::fmt::Debug for UpdatePoolOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("self_managed_opt_outs_enabled", &self.self_managed_opt_outs_enabled);
        formatter.field("opt_out_list_name", &self.opt_out_list_name);
        formatter.field("shared_routes_enabled", &self.shared_routes_enabled);
        formatter.field("deletion_protection_enabled", &self.deletion_protection_enabled);
...
pub struct UpdatePhoneNumberOutput  {
    ...
    #[doc(hidden)]pub phone_number_arn: std::option::Option<std::string::String>,
    /// <p>The unique identifier of the phone number.</p>
    #[doc(hidden)]pub phone_number_id: std::option::Option<std::string::String>,
    /// <p>The phone number that was updated.</p>
    #[doc(hidden)]pub phone_number: std::option::Option<std::string::String>,
    /// <p>The current status of the request.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::NumberStatus>,
    /// <p>The two-character code, in ISO 3166-1 alpha-2 format, for the country or region. </p>
    #[doc(hidden)]pub iso_country_code: std::option::Option<std::string::String>,
    /// <p>The type of message. Valid values are TRANSACTIONAL for messages that are critical or time-sensitive and PROMOTIONAL for messages that aren't critical or time-sensitive.</p>
    #[doc(hidden)]pub message_type: std::option::Option<crate::model::MessageType>,
    /// <p>Specifies if the number could be used for text messages, voice or both.</p>
    #[doc(hidden)]pub number_capabilities: std::option::Option<std::vec::Vec<crate::model::NumberCapability>>,
    /// <p>The type of number that was requested.</p>
    #[doc(hidden)]pub number_type: std::option::Option<crate::model::NumberType>,
    /// <p>The monthly leasing price of the phone number, in US dollars.</p>
    #[doc(hidden)]pub monthly_leasing_price: std::option::Option<std::string::String>,
    /// <p>By default this is set to false. When set to true you can receive incoming text messages from your end recipients.</p>
    #[doc(hidden)]pub two_way_enabled: bool,
    /// <p>The Amazon Resource Name (ARN) of the two way channel.</p>
    #[doc(hidden)]pub two_way_channel_arn: std::option::Option<std::string::String>,
...
pub struct UpdateEventDestinationOutput  {
    ...
    #[doc(hidden)]pub configuration_set_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub event_destination: std::option::Option<crate::model::EventDestination>,
}
...
pub struct SetVoiceMessageSpendLimitOverrideOutput  {
    ...
    #[doc(hidden)]pub monthly_limit: std::option::Option<i64>,
}
...
pub struct SetDefaultSenderIdOutput  {
    ...
    #[doc(hidden)]pub sender_id: std::option::Option<std::string::String>,
}
...
pub struct RequestPhoneNumberOutput  {
    ...
    #[doc(hidden)]pub number_type: std::option::Option<crate::model::RequestableNumberType>,
...
pub struct PutOptedOutNumberOutput  {
    ...
    #[doc(hidden)]pub opt_out_list_arn: std::option::Option<std::string::String>,
    /// <p>The OptOutListName that the phone number was removed from.</p>
    #[doc(hidden)]pub opt_out_list_name: std::option::Option<std::string::String>,
    /// <p>The phone number that was added to the OptOutList.</p>
    #[doc(hidden)]pub opted_out_number: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub opted_out_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>This is true if it was the end user who requested their phone number be removed. </p>
    #[doc(hidden)]pub end_user_opted_out: bool,
}
...
pub struct PutKeywordOutput  {
    ...
    #[doc(hidden)]pub origination_identity_arn: std::option::Option<std::string::String>,
    /// <p>The PhoneNumberId or PoolId that the keyword was associated with.</p>
    #[doc(hidden)]pub origination_identity: std::option::Option<std::string::String>,
    /// <p>The keyword that was added.</p>
    #[doc(hidden)]pub keyword: std::option::Option<std::string::String>,
    /// <p>The message associated with the keyword.</p>
    #[doc(hidden)]pub keyword_message: std::option::Option<std::string::String>,
    /// <p>The action to perform when the keyword is used.</p>
    #[doc(hidden)]pub keyword_action: std::option::Option<crate::model::KeywordAction>,
}
...
pub struct ListPoolOriginationIdentitiesOutput  {
    ...
    #[doc(hidden)]pub origination_identities: std::option::Option<std::vec::Vec<crate::model::OriginationIdentityMetadata>>,
...
pub struct DescribeSpendLimitsOutput  {
    ...
    #[doc(hidden)]pub spend_limits: std::option::Option<std::vec::Vec<crate::model::SpendLimit>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeSenderIdsOutput  {
    ...
    #[doc(hidden)]pub sender_ids: std::option::Option<std::vec::Vec<crate::model::SenderIdInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribePoolsOutput  {
    ...
    #[doc(hidden)]pub pools: std::option::Option<std::vec::Vec<crate::model::PoolInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribePhoneNumbersOutput  {
    ...
    #[doc(hidden)]pub phone_numbers: std::option::Option<std::vec::Vec<crate::model::PhoneNumberInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeOptOutListsOutput  {
    ...
    #[doc(hidden)]pub opt_out_lists: std::option::Option<std::vec::Vec<crate::model::OptOutListInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeOptedOutNumbersOutput  {
    ...
    #[doc(hidden)]pub opted_out_numbers: std::option::Option<std::vec::Vec<crate::model::OptedOutNumberInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeKeywordsOutput  {
    ...
    #[doc(hidden)]pub keywords: std::option::Option<std::vec::Vec<crate::model::KeywordInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeConfigurationSetsOutput  {
    ...
    #[doc(hidden)]pub configuration_sets: std::option::Option<std::vec::Vec<crate::model::ConfigurationSetInformation>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeAccountLimitsOutput  {
    ...
    #[doc(hidden)]pub account_limits: std::option::Option<std::vec::Vec<crate::model::AccountLimit>>,
    /// <p>The token to be used for the next set of paginated results. If this field is empty then there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DeleteConfigurationSetOutput  {
    ...
    #[doc(hidden)]pub default_message_type: std::option::Option<crate::model::MessageType>,
    /// <p>The default Sender ID of the configuration set that was deleted.</p>
    #[doc(hidden)]pub default_sender_id: std::option::Option<std::string::String>,
