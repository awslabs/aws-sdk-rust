...
//! offered by Amazon Pinpoint Email Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Pinpoint Email Service.
