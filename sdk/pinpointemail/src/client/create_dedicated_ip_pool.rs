...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_dedicated_ip_pool::builders::CreateDedicatedIpPoolFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_dedicated_ip_pool::builders::CreateDedicatedIpPoolFluentBuilder::set_tags): <p>An object that defines the tags (keys and values) that you want to associate with the pool.</p>
