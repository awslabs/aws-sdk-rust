...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::set_tags): <p>An array of objects that define the tags (keys and values) that you want to associate with the email identity.</p>
