...
impl super::Client {
    ...
    ///   - [`email_identity(impl ::std::convert::Into<String>)`](crate::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder::email_identity) / [`set_email_identity(Option<String>)`](crate::operation::put_email_identity_dkim_attributes::builders::PutEmailIdentityDkimAttributesFluentBuilder::set_email_identity): <p>The email identity that you want to change the DKIM settings for.</p>
