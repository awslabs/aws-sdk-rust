...
impl super::Client {
    ...
    ///   - [`tracking_options(TrackingOptions)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::tracking_options) / [`set_tracking_options(Option<TrackingOptions>)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::set_tracking_options): <p>An object that defines the open and click tracking options for emails that you send using the configuration set.</p>
    ///   - [`delivery_options(DeliveryOptions)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::delivery_options) / [`set_delivery_options(Option<DeliveryOptions>)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::set_delivery_options): <p>An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.</p>
    ///   - [`reputation_options(ReputationOptions)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::reputation_options) / [`set_reputation_options(Option<ReputationOptions>)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::set_reputation_options): <p>An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.</p>
    ///   - [`sending_options(SendingOptions)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::sending_options) / [`set_sending_options(Option<SendingOptions>)`](crate::operation::create_configuration_set::builders::CreateConfigurationSetFluentBuilder::set_sending_options): <p>An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.</p>
