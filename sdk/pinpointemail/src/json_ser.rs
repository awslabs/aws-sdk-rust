...
pub fn serialize_structure_create_configuration_set_input(
    ...
    if let Some(var_2) = &input.delivery_options {
        ...
        crate::json_ser::serialize_structure_delivery_options(&mut object_3, var_2);
        object_3.finish();
    }
    if let Some(var_4) = &input.reputation_options {
        let mut object_5 = object.key("ReputationOptions").start_object();
        crate::json_ser::serialize_structure_reputation_options(&mut object_5, var_4);
        object_5.finish();
    }
    if let Some(var_6) = &input.sending_options {
        let mut object_7 = object.key("SendingOptions").start_object();
        crate::json_ser::serialize_structure_sending_options(&mut object_7, var_6);
        object_7.finish();
    }
    ...
    if let Some(var_12) = &input.tracking_options {
        ...
        crate::json_ser::serialize_structure_tracking_options(&mut object_13, var_12);
        object_13.finish();
    }
}

pub fn serialize_structure_create_configuration_set_event_destination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_14) = &input.event_destination {
        ...
        crate::json_ser::serialize_structure_event_destination_definition(&mut object_15, var_14);
        object_15.finish();
    }
...
pub fn serialize_structure_create_dedicated_ip_pool_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_deliverability_test_report_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_22) = &input.content {
        ...
        crate::json_ser::serialize_structure_email_content(&mut object_23, var_22);
        object_23.finish();
    }
...
pub fn serialize_structure_create_email_identity_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_account_dedicated_ip_warmup_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_account_sending_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_configuration_set_delivery_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_configuration_set_reputation_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_configuration_set_sending_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_configuration_set_tracking_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_dedicated_ip_in_pool_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_dedicated_ip_warmup_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_deliverability_dashboard_option_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_42 in var_40 {
            {
                ...
                crate::json_ser::serialize_structure_domain_deliverability_tracking_option(
                    &mut object_43,
                    item_42,
                );
                object_43.finish();
...
pub fn serialize_structure_put_email_identity_dkim_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_email_identity_feedback_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_email_identity_mail_from_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_send_email_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_47) = &input.content {
        ...
        crate::json_ser::serialize_structure_email_content(&mut object_48, var_47);
        object_48.finish();
    }
    if let Some(var_49) = &input.destination {
        let mut object_50 = object.key("Destination").start_object();
        crate::json_ser::serialize_structure_destination(&mut object_50, var_49);
        object_50.finish();
    }
        ...
        for item_53 in var_51 {
            {
                ...
                crate::json_ser::serialize_structure_message_tag(&mut object_54, item_53);
                object_54.finish();
            }
        }
        array_52.finish();
...
pub fn serialize_structure_update_configuration_set_event_destination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_65) = &input.event_destination {
        ...
        crate::json_ser::serialize_structure_event_destination_definition(&mut object_66, var_65);
        object_66.finish();
    }
}

pub fn serialize_structure_delivery_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_reputation_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_69) = &input.last_fresh_start {
        object
            .key("LastFreshStart")
            .instant(var_69, smithy_types::instant::Format::EpochSeconds);
    }
}

pub fn serialize_structure_sending_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_tracking_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_event_destination_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_76) = &input.kinesis_firehose_destination {
        ...
        crate::json_ser::serialize_structure_kinesis_firehose_destination(&mut object_77, var_76);
        object_77.finish();
    }
    if let Some(var_78) = &input.cloud_watch_destination {
        let mut object_79 = object.key("CloudWatchDestination").start_object();
        crate::json_ser::serialize_structure_cloud_watch_destination(&mut object_79, var_78);
        object_79.finish();
    }
    if let Some(var_80) = &input.sns_destination {
        let mut object_81 = object.key("SnsDestination").start_object();
        crate::json_ser::serialize_structure_sns_destination(&mut object_81, var_80);
        object_81.finish();
    }
    if let Some(var_82) = &input.pinpoint_destination {
        let mut object_83 = object.key("PinpointDestination").start_object();
        crate::json_ser::serialize_structure_pinpoint_destination(&mut object_83, var_82);
        object_83.finish();
    }
}

pub fn serialize_structure_email_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::EmailContent,
) {
    if let Some(var_84) = &input.simple {
        let mut object_85 = object.key("Simple").start_object();
        crate::json_ser::serialize_structure_message(&mut object_85, var_84);
        object_85.finish();
    }
    if let Some(var_86) = &input.raw {
        let mut object_87 = object.key("Raw").start_object();
        crate::json_ser::serialize_structure_raw_message(&mut object_87, var_86);
        object_87.finish();
    }
    if let Some(var_88) = &input.template {
        let mut object_89 = object.key("Template").start_object();
        crate::json_ser::serialize_structure_template(&mut object_89, var_88);
        object_89.finish();
    }
}

pub fn serialize_structure_domain_deliverability_tracking_option(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_91) = &input.subscription_start_date {
        object
            ...
            .instant(var_91, smithy_types::instant::Format::EpochSeconds);
    }
    if let Some(var_92) = &input.inbox_placement_tracking_option {
        ...
        crate::json_ser::serialize_structure_inbox_placement_tracking_option(
            &mut object_93,
            var_92,
        );
        object_93.finish();
...
pub fn serialize_structure_message_tag(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_kinesis_firehose_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cloud_watch_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_109 in var_107 {
            {
                ...
                crate::json_ser::serialize_structure_cloud_watch_dimension_configuration(
                    &mut object_110,
                    item_109,
                );
                object_110.finish();
...
pub fn serialize_structure_sns_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_pinpoint_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_message(
    ...
    if let Some(var_113) = &input.subject {
        ...
        crate::json_ser::serialize_structure_content(&mut object_114, var_113);
        object_114.finish();
    }
    if let Some(var_115) = &input.body {
        let mut object_116 = object.key("Body").start_object();
        crate::json_ser::serialize_structure_body(&mut object_116, var_115);
        object_116.finish();
    }
}

pub fn serialize_structure_raw_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_117) = &input.data {
        object
            .key("Data")
            .string_unchecked(&smithy_types::base64::encode(var_117));
    }
}

pub fn serialize_structure_template(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_inbox_placement_tracking_option(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cloud_watch_dimension_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_body(
    ...
    if let Some(var_128) = &input.text {
        ...
        crate::json_ser::serialize_structure_content(&mut object_129, var_128);
        object_129.finish();
    }
    if let Some(var_130) = &input.html {
        let mut object_131 = object.key("Html").start_object();
        crate::json_ser::serialize_structure_content(&mut object_131, var_130);
        object_131.finish();
    }
}
