...
impl Builder {
    ...
    /// use aws_sdk_pinpointemail::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_pinpointemail::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
