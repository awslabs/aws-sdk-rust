...
pub fn de_get_deliverability_dashboard_options_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetDeliverabilityDashboardOptionsOutput, crate::error::GetDeliverabilityDashboardOptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetDeliverabilityDashboardOptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_deliverability_dashboard_options_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetDeliverabilityDashboardOptionsOutput, crate::error::GetDeliverabilityDashboardOptionsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_deliverability_dashboard_options(value: &[u8], mut builder: crate::output::get_deliverability_dashboard_options_output::Builder) -> Result<crate::output::get_deliverability_dashboard_options_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
