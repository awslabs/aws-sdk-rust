            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "VolumeStatistics" => {
                            builder =
                                builder.set_volume_statistics(crate::protocol_serde::shape_volume_statistics::de_volume_statistics(tokens, _value)?);
                        }
                        "DomainIspPlacements" => {
                            builder = builder.set_domain_isp_placements(
                                crate::protocol_serde::shape_domain_isp_placements::de_domain_isp_placements(tokens, _value)?,
                            );
                        }
