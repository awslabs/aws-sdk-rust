...
impl ListEmailIdentitiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_email_identities::ListEmailIdentitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_email_identities::ListEmailIdentitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_email_identities::ListEmailIdentitiesOutput, crate::operation::list_email_identities::ListEmailIdentitiesError, Self> {
