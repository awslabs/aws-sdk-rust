...
impl GetDomainDeliverabilityCampaignInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_domain_deliverability_campaign::GetDomainDeliverabilityCampaign::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomainDeliverabilityCampaign {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_domain_deliverability_campaign::de_get_domain_deliverability_campaign_http_response_with_props(
                status, headers, body,
            )
        }
    }
