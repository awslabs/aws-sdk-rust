...
impl ListDomainDeliverabilityCampaignsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_domain_deliverability_campaigns::ListDomainDeliverabilityCampaigns::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDomainDeliverabilityCampaigns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_domain_deliverability_campaigns::de_list_domain_deliverability_campaigns_http_response_with_props(
                status, headers, body,
            )
        }
    }
