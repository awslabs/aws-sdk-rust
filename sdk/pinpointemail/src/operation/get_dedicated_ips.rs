...
impl GetDedicatedIpsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_dedicated_ips::GetDedicatedIps, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDedicatedIps {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_dedicated_ips::de_get_dedicated_ips_http_response_with_props(status, headers, body)
        }
    }
}
