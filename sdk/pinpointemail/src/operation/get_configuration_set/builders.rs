...
impl GetConfigurationSetFluentBuilder  {
    /// Creates a new `GetConfigurationSet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_configuration_set::GetConfigurationSetOutput, aws_smithy_http::result::SdkError<crate::operation::get_configuration_set::GetConfigurationSetError>>
                     {
