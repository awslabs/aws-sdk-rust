    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutEmailIdentityDkimAttributes {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutEmailIdentityDkimAttributes")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutEmailIdentityDkimAttributesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutEmailIdentityDkimAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/v1/email/identities/{EmailIdentity}/dkim", EmailIdentity = email_identity)
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutEmailIdentityDkimAttributesEndpointParamsInterceptor {
