    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/email/account/sending")
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountSendingAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_account_sending_attributes::de_put_account_sending_attributes_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PutAccountSendingAttributesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_account_sending_attributes::PutAccountSendingAttributesError
{
