...
impl PutAccountSendingAttributesInput {
    /// Consumes the builder and constructs an Operation<[`PutAccountSendingAttributes`](crate::operation::put_account_sending_attributes::PutAccountSendingAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_account_sending_attributes::PutAccountSendingAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_account_sending_attributes::PutAccountSendingAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_account_sending_attributes::PutAccountSendingAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutAccountSendingAttributes", "pinpointemail"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutAccountSendingAttributes {
                type Output = std::result::Result<crate::operation::put_account_sending_attributes::PutAccountSendingAttributesOutput, crate::operation::put_account_sending_attributes::PutAccountSendingAttributesError>;
