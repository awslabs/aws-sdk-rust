...
impl PutAccountSendingAttributesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_account_sending_attributes::PutAccountSendingAttributes,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_account_sending_attributes::PutAccountSendingAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountSendingAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_account_sending_attributes::de_put_account_sending_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
