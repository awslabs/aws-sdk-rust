...
impl PutConfigurationSetSendingOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_configuration_set_sending_options::PutConfigurationSetSendingOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutConfigurationSetSendingOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_configuration_set_sending_options::de_put_configuration_set_sending_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
