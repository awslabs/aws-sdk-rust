...
impl PutDedicatedIpWarmupAttributesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributes,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_dedicated_ip_warmup_attributes::PutDedicatedIpWarmupAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDedicatedIpWarmupAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_dedicated_ip_warmup_attributes::de_put_dedicated_ip_warmup_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
