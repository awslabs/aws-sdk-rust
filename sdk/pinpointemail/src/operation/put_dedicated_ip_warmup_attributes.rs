    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/email/dedicated-ips/{Ip}/warmup", Ip = ip)
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDedicatedIpWarmupAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_dedicated_ip_warmup_attributes::de_put_dedicated_ip_warmup_attributes_http_response_with_props(status, headers, body)
        }
    }
}
