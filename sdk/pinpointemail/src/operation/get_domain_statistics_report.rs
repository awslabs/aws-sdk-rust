...
impl GetDomainStatisticsReportInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_domain_statistics_report::GetDomainStatisticsReport::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomainStatisticsReport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_domain_statistics_report::de_get_domain_statistics_report_http_response_with_props(status, headers, body)
        }
    }
}
