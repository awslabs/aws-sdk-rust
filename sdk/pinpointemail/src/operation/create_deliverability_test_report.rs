...
impl CreateDeliverabilityTestReportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_deliverability_test_report::CreateDeliverabilityTestReport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDeliverabilityTestReport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_deliverability_test_report::de_create_deliverability_test_report_http_response_with_props(
                status, headers, body,
            )
        }
    }
