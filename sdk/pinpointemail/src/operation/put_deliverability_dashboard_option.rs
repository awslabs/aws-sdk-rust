...
impl PutDeliverabilityDashboardOptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_deliverability_dashboard_option::PutDeliverabilityDashboardOption::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDeliverabilityDashboardOption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_deliverability_dashboard_option::de_put_deliverability_dashboard_option_http_response_with_props(
                status, headers, body,
            )
        }
    }
