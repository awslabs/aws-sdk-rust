    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/email/deliverability-dashboard")
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDeliverabilityDashboardOption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_deliverability_dashboard_option::de_put_deliverability_dashboard_option_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_deliverability_dashboard_option::PutDeliverabilityDashboardOptionError
{
