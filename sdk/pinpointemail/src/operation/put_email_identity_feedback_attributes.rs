...
impl PutEmailIdentityFeedbackAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_email_identity_feedback_attributes::PutEmailIdentityFeedbackAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutEmailIdentityFeedbackAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_email_identity_feedback_attributes::de_put_email_identity_feedback_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
