...
impl ListDeliverabilityTestReportsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_deliverability_test_reports::ListDeliverabilityTestReports::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeliverabilityTestReports {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_deliverability_test_reports::de_list_deliverability_test_reports_http_response_with_props(
                status, headers, body,
            )
        }
    }
