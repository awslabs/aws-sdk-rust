...
/// Configuration for a aws_sdk_partnercentralrevenuemeasurement service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_partnercentralrevenuemeasurement::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_partnercentralrevenuemeasurement::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_partnercentralrevenuemeasurement::Config::builder();
    ...
    /// impl aws_sdk_partnercentralrevenuemeasurement::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_partnercentralrevenuemeasurement::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_partnercentralrevenuemeasurement::Config::builder()
    ...
    ///     // ...
    ///     .build();
    /// let client = aws_sdk_partnercentralrevenuemeasurement::Client::from_conf(config);
    /// ```
    ...
    /// rules for `aws_sdk_partnercentralrevenuemeasurement`.
    ///
    ///
    ...
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_partnercentralrevenuemeasurement::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_partnercentralrevenuemeasurement::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::Config;
    /// use aws_sdk_partnercentralrevenuemeasurement::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_partnercentralrevenuemeasurement::config::Config;
    /// use aws_sdk_partnercentralrevenuemeasurement::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `partnercentralrevenuemeasurement`
    /// (or `partnercentralrevenuemeasurement-<region>` if a region is configured).
    /// All PartnerCentral Revenue Measurement clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::Config;
    /// use aws_sdk_partnercentralrevenuemeasurement::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::Config;
    /// use aws_sdk_partnercentralrevenuemeasurement::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::IdentityCache;
    ///
    /// let config = aws_sdk_partnercentralrevenuemeasurement::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_partnercentralrevenuemeasurement::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_partnercentralrevenuemeasurement::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_partnercentralrevenuemeasurement::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("partnercentral"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_partnercentralrevenuemeasurement::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PartnerCentralRevenueMeasurement");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_partnercentralrevenuemeasurement::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "partnercentralrevenuemeasurement";
    ...
    let scope = "aws-sdk-partnercentralrevenuemeasurement";
