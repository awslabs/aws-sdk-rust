...
impl UntagResource {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "PartnerCentral Revenue Measurement.UntagResource",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/PartnerCentralRevenueMeasurement/operation/UntagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
