...
impl ListTagsForResource {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "PartnerCentral Revenue Measurement.ListTagsForResource",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/PartnerCentralRevenueMeasurement/operation/ListTagsForResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
