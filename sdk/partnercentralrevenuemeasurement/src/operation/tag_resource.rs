...
impl TagResource {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "PartnerCentral Revenue Measurement.TagResource",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/PartnerCentralRevenueMeasurement/operation/TagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
