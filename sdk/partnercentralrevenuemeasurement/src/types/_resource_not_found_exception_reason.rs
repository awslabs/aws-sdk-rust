...
///     ResourceNotFoundExceptionReason::ResourceNotFound => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceNotFoundExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "RESOURCE_NOT_FOUND" => ResourceNotFoundExceptionReason::ResourceNotFound,
...
impl ResourceNotFoundExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceNotFoundExceptionReason::ResourceNotFound => "RESOURCE_NOT_FOUND",
...
impl ::std::fmt::Display for ResourceNotFoundExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ResourceNotFoundExceptionReason::ResourceNotFound => write!(f, "RESOURCE_NOT_FOUND"),
