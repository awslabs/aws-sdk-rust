...
///     ConflictExceptionReason::RevisionMismatch => { /* ... */ },
...
impl ::std::convert::From<&str> for ConflictExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            "REVISION_MISMATCH" => ConflictExceptionReason::RevisionMismatch,
...
impl ConflictExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ConflictExceptionReason::RevisionMismatch => "REVISION_MISMATCH",
...
impl ::std::fmt::Display for ConflictExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ConflictExceptionReason::RevisionMismatch => write!(f, "REVISION_MISMATCH"),
