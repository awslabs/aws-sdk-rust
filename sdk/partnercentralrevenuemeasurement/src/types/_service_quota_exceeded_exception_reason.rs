...
///     ServiceQuotaExceededExceptionReason::AttributionLimitExceeded => { /* ... */ },
///     ServiceQuotaExceededExceptionReason::TagLimitExceeded => { /* ... */ },
...
impl ::std::convert::From<&str> for ServiceQuotaExceededExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "ATTRIBUTION_LIMIT_EXCEEDED" => ServiceQuotaExceededExceptionReason::AttributionLimitExceeded,
            "TAG_LIMIT_EXCEEDED" => ServiceQuotaExceededExceptionReason::TagLimitExceeded,
...
impl ServiceQuotaExceededExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ServiceQuotaExceededExceptionReason::AttributionLimitExceeded => "ATTRIBUTION_LIMIT_EXCEEDED",
            ServiceQuotaExceededExceptionReason::TagLimitExceeded => "TAG_LIMIT_EXCEEDED",
            ServiceQuotaExceededExceptionReason::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ATTRIBUTION_LIMIT_EXCEEDED", "TAG_LIMIT_EXCEEDED"]
    }
}
...
impl ::std::fmt::Display for ServiceQuotaExceededExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ServiceQuotaExceededExceptionReason::AttributionLimitExceeded => write!(f, "ATTRIBUTION_LIMIT_EXCEEDED"),
            ServiceQuotaExceededExceptionReason::TagLimitExceeded => write!(f, "TAG_LIMIT_EXCEEDED"),
