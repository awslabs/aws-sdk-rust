...
//! offered by Connect Health. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Connect Health.
...
/// let config = aws_sdk_connecthealth::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`ActivateSubscription`](crate::operation::activate_subscription) operation has
/// a [`Client::activate_subscription`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.activate_subscription()
///     .domain_id("example")
///     .send()
///     .await;
/// ```
...
/// Configuration for Connect Health.
pub mod config;
