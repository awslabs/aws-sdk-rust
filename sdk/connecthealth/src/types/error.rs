...
/// Error type for the `MedicalScribeOutputStreamError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum MedicalScribeOutputStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-MedicalScribeOutputStreamError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl MedicalScribeOutputStreamError {
    /// Creates the `MedicalScribeOutputStreamError::Unhandled` variant from any error type.
    pub fn unhandled(
        err: impl ::std::convert::Into<::std::boxed::Box<dyn ::std::error::Error + ::std::marker::Send + ::std::marker::Sync + 'static>>,
    ) -> Self {
        Self::Unhandled(crate::error::sealed_unhandled::Unhandled {
    ...
    /// Creates the `MedicalScribeOutputStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    pub fn generic(err: ::aws_smithy_types::error::ErrorMetadata) -> Self {
        Self::Unhandled(crate::error::sealed_unhandled::Unhandled {
            source: err.clone().into(),
            meta: err,
    ...
    /// Returns `true` if the error kind is `MedicalScribeOutputStreamError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `MedicalScribeOutputStreamError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for MedicalScribeOutputStreamError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
...
impl ::std::fmt::Display for MedicalScribeOutputStreamError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for MedicalScribeOutputStreamError {
    fn code(&self) -> ::std::option::Option<&str> {
        ::aws_smithy_types::error::metadata::ProvideErrorMetadata::code(self)
    }
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for MedicalScribeOutputStreamError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for MedicalScribeOutputStreamError {
    fn create_unhandled_error(
        source: ::std::boxed::Box<dyn ::std::error::Error + ::std::marker::Send + ::std::marker::Sync + 'static>,
        meta: ::std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
    ) -> Self {
...
impl ::aws_types::request_id::RequestId for crate::types::error::MedicalScribeOutputStreamError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}
