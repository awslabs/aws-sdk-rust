    ...
    Err(match error_code {
        ...
        "ModelError" => crate::error::InvokeEndpointError {
            ...
            kind: crate::error::InvokeEndpointErrorKind::ModelError({
                ...
                let _ = response;
                output = crate::json_deser::model_error(response.body().as_ref(), output)
                    .map_err(crate::error::InvokeEndpointError::unhandled)?;
                output.build()
            }),
        },
...
pub fn parse_invoke_endpoint_response(
    ...
    Ok({
        ...
        let _ = response;
        output = output.set_body(crate::http_serde::deser_payload_invoke_endpoint_body(
            response.body().as_ref(),
        )?);
        output = output.set_content_type(
            crate::http_serde::deser_header_invoke_endpoint_content_type(response.headers())
                .map_err(|_| {
        ...
        output = output.set_custom_attributes(
            crate::http_serde::deser_header_invoke_endpoint_custom_attributes(response.headers())
        ...
        output = output.set_invoked_production_variant(
            crate::http_serde::deser_header_invoke_endpoint_invoked_production_variant(response.headers())
