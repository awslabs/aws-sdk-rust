...
#[allow(clippy::unnecessary_wraps)]pub fn parse_invoke_endpoint_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InvokeEndpointOutput, crate::error::InvokeEndpointError> {
    ...
    Err(match error_code {
        "InternalDependencyException" => crate::error::InvokeEndpointError { meta: generic, kind: crate::error::InvokeEndpointErrorKind::InternalDependencyException({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::internal_dependency_exception::Builder::default();
                    let _ = response;
        ...
        "InternalFailure" => crate::error::InvokeEndpointError { meta: generic, kind: crate::error::InvokeEndpointErrorKind::InternalFailure({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::internal_failure::Builder::default();
                    let _ = response;
        ...
        "ModelError" => crate::error::InvokeEndpointError { meta: generic, kind: crate::error::InvokeEndpointErrorKind::ModelError({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::model_error::Builder::default();
                    let _ = response;
        ...
        "ModelNotReadyException" => crate::error::InvokeEndpointError { meta: generic, kind: crate::error::InvokeEndpointErrorKind::ModelNotReadyException({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::model_not_ready_exception::Builder::default();
                    let _ = response;
        ...
        "ServiceUnavailable" => crate::error::InvokeEndpointError { meta: generic, kind: crate::error::InvokeEndpointErrorKind::ServiceUnavailable({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::service_unavailable::Builder::default();
                    let _ = response;
        ...
        "ValidationError" => crate::error::InvokeEndpointError { meta: generic, kind: crate::error::InvokeEndpointErrorKind::ValidationError({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::validation_error::Builder::default();
                    let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_invoke_endpoint_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InvokeEndpointOutput, crate::error::InvokeEndpointError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::invoke_endpoint_output::Builder::default();
        let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_invoke_endpoint_async_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InvokeEndpointAsyncOutput, crate::error::InvokeEndpointAsyncError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_invoke_endpoint_async_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InvokeEndpointAsyncOutput, crate::error::InvokeEndpointAsyncError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::invoke_endpoint_async_output::Builder::default();
        let _ = response;
