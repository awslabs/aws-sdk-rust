        ...
        match response_headers.message_type.as_str() {
            "event" =>  {
                match response_headers.smithy_type.as_str() {
                    "PayloadPart" =>  {
                        ...
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::ResponseStream::PayloadPart(builder.build())))
                    }
                    _unknown_variant =>  {
            ...
            "exception" =>  {
                ...
                "ModelStreamError" =>  {
                    ...
                    builder = crate::protocol_serde::shape_model_stream_error::de_model_stream_error_json_err(&message.payload()[..], builder)
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::ResponseStreamError::ModelStreamError(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "InternalStreamFailure" =>  {
                    ...
                    builder = crate::protocol_serde::shape_internal_stream_failure::de_internal_stream_failure_json_err(&message.payload()[..], builder)
                                                            .map_err(|err| {
                                                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall InternalStreamFailure: {}", err))
                                                            })?;
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::ResponseStreamError::InternalStreamFailure(
                                                                builder.build()
                                                            )
                                                        ))
                }
