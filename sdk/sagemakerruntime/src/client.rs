...
impl Client  {
    ...
    pub fn invoke_endpoint(&self) -> crate::client::fluent_builders::InvokeEndpoint {
                            crate::client::fluent_builders::InvokeEndpoint::new(self.handle.clone())
                        }
    ...
    pub fn invoke_endpoint_async(&self) -> crate::client::fluent_builders::InvokeEndpointAsync {
                            crate::client::fluent_builders::InvokeEndpointAsync::new(self.handle.clone())
                        }
}
