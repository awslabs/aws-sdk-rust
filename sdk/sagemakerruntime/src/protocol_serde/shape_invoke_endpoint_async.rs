...
pub fn de_invoke_endpoint_async_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncOutput, crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_invoke_endpoint_async_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncOutput, crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError> {
    Ok({
        #[allow(unused_mut)]
    ...
    if let ::std::option::Option::Some(inner_9) = &input.input_location {
        let formatted_10 = inner_9.as_str();
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("input_location", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_11) = &input.request_ttl_seconds {
        ...
        let formatted_12 = encoder.encode();
                        if !formatted_12.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("request_ttl_seconds", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_13) = &input.invocation_timeout_seconds {
        ...
        let formatted_14 = encoder.encode();
                        if !formatted_14.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("invocation_timeout_seconds", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
