...
> {
    ...
    Err(match error_code {
        "InternalFailure" => {
            crate::error::InvokeEndpointAsyncError::InternalFailure({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationError" => {
            crate::error::InvokeEndpointAsyncError::ValidationError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = output.set_output_location(
            ...
            .map_err(|_| {
                crate::error::InvokeEndpointAsyncError::unhandled(
