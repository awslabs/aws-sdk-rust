...
pub fn de_invoke_endpoint_async_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InvokeEndpointAsyncOutput, crate::error::InvokeEndpointAsyncError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::InvokeEndpointAsyncError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_failure::de_internal_failure_json_err(response.body().as_ref(), output).map_err(crate::error::InvokeEndpointAsyncError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_unavailable::de_service_unavailable_json_err(response.body().as_ref(), output).map_err(crate::error::InvokeEndpointAsyncError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_validation_error::de_validation_error_json_err(response.body().as_ref(), output).map_err(crate::error::InvokeEndpointAsyncError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_invoke_endpoint_async_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::InvokeEndpointAsyncOutput, crate::error::InvokeEndpointAsyncError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::invoke_endpoint_async_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_invoke_endpoint_async::de_invoke_endpoint_async(response.body().as_ref(), output).map_err(crate::error::InvokeEndpointAsyncError::unhandled)?;
...
pub(crate) fn de_invoke_endpoint_async(value: &[u8], mut builder: crate::output::invoke_endpoint_async_output::Builder) -> Result<crate::output::invoke_endpoint_async_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
