...
pub(crate) fn de_closed_session_id_header(
    ...
    let headers = header_map.get_all_bytes("X-Amzn-SageMaker-Closed-Session-Id");
...
pub(crate) fn de_custom_attributes_header(
    ...
    let headers = header_map.get_all_bytes("X-Amzn-SageMaker-Custom-Attributes");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
...
pub(crate) fn de_new_session_id_header(
    ...
    let headers = header_map.get_all_bytes("X-Amzn-SageMaker-New-Session-Id");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
