...
pub fn de_invoke_endpoint_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_endpoint::InvokeEndpointOutput, crate::operation::invoke_endpoint::InvokeEndpointError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_invoke_endpoint_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_endpoint::InvokeEndpointOutput, crate::operation::invoke_endpoint::InvokeEndpointError> {
    Ok({
        #[allow(unused_mut)]
    ...
    if let ::std::option::Option::Some(inner_5) = &input.custom_attributes {
        let formatted_6 = inner_5.as_str();
                        if !formatted_6.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("custom_attributes", format!(
                                "`{}` cannot be used as a header value: {}",
    ...
    if let ::std::option::Option::Some(inner_7) = &input.target_model {
        let formatted_8 = inner_7.as_str();
                        if !formatted_8.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("target_model", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_9) = &input.target_variant {
        let formatted_10 = inner_9.as_str();
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("target_variant", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_11) = &input.target_container_hostname {
        let formatted_12 = inner_11.as_str();
                        if !formatted_12.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("target_container_hostname", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_13) = &input.inference_id {
        let formatted_14 = inner_13.as_str();
                        if !formatted_14.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("inference_id", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_15) = &input.enable_explanations {
        let formatted_16 = inner_15.as_str();
                        if !formatted_16.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("enable_explanations", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_17) = &input.inference_component_name {
        let formatted_18 = inner_17.as_str();
                        if !formatted_18.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("inference_component_name", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
