...
pub struct InvokeEndpointAsyncOutput  {
    ...
    #[doc(hidden)]pub inference_id: std::option::Option<std::string::String>,
    /// <p>The Amazon S3 URI where the inference response payload is stored.</p>
    #[doc(hidden)]pub output_location: std::option::Option<std::string::String>,
}
...
pub struct InvokeEndpointOutput  {
    ...
    #[doc(hidden)]pub invoked_production_variant: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub custom_attributes: std::option::Option<std::string::String>,
}
