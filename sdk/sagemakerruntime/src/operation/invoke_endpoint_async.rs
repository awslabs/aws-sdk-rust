...
/// Orchestration and serialization glue logic for `InvokeEndpointAsync`.
...
impl InvokeEndpointAsync {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeEndpointAsync {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InvokeEndpointAsync");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(InvokeEndpointAsyncRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InvokeEndpointAsyncResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvokeEndpointAsync")
...
.with_interceptor(InvokeEndpointAsyncEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError>::new());
...
#[derive(Debug)]
            struct InvokeEndpointAsyncResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvokeEndpointAsyncResponseDeserializer {
            ...
            let parse_result = if !success && status != 202 || force_error {
                crate::protocol_serde::shape_invoke_endpoint_async::de_invoke_endpoint_async_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct InvokeEndpointAsyncRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvokeEndpointAsyncRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::invoke_endpoint_async::InvokeEndpointAsyncInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/endpoints/{EndpointName}/async-invocations", EndpointName = endpoint_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct InvokeEndpointAsyncEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InvokeEndpointAsyncEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "InvokeEndpointAsyncEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<InvokeEndpointAsyncInput>()
                        .ok_or("failed to downcast to InvokeEndpointAsyncInput")?;
...
pub enum InvokeEndpointAsyncError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InvokeEndpointAsyncError) for what information is available for the error.")]
...
impl InvokeEndpointAsyncError {
    /// Creates the `InvokeEndpointAsyncError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InvokeEndpointAsyncError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InvokeEndpointAsyncError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError {
...
mod _invoke_endpoint_async_output;
