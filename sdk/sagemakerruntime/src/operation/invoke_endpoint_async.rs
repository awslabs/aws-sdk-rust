...
impl InvokeEndpointAsyncInput {
    /// Consumes the builder and constructs an Operation<[`InvokeEndpointAsync`](crate::operation::invoke_endpoint_async::InvokeEndpointAsync)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::invoke_endpoint_async::InvokeEndpointAsync, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::invoke_endpoint_async::InvokeEndpointAsyncInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/endpoints/{EndpointName}/async-invocations", EndpointName = endpoint_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::invoke_endpoint_async::InvokeEndpointAsync::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("InvokeEndpointAsync", "sagemakerruntime"));
...
impl aws_smithy_http::response::ParseStrictResponse for InvokeEndpointAsync {
                type Output = std::result::Result<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncOutput, crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError>;
