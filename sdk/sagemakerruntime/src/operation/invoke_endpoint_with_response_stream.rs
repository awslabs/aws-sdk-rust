...
/// Orchestration and serialization glue logic for `InvokeEndpointWithResponseStream`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InvokeEndpointWithResponseStream;
impl InvokeEndpointWithResponseStream {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeEndpointWithResponseStream {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InvokeEndpointWithResponseStream");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(InvokeEndpointWithResponseStreamRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InvokeEndpointWithResponseStreamResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InvokeEndpointWithResponseStream")
...
.with_interceptor(InvokeEndpointWithResponseStreamEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamError>::new());
...
#[derive(Debug)]
            struct InvokeEndpointWithResponseStreamResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvokeEndpointWithResponseStreamResponseDeserializer {
                ...
                ::std::option::Option::Some(crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_invoke_endpoint_with_response_stream::de_invoke_endpoint_with_response_stream_http_response(response)))
            }
            ...
            crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_invoke_endpoint_with_response_stream::de_invoke_endpoint_with_response_stream_http_error(response.status().as_u16(), response.headers(), body))
                }
            }
#[derive(Debug)]
            struct InvokeEndpointWithResponseStreamRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvokeEndpointWithResponseStreamRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.endpoint_name;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("endpoint_name", "cannot be empty or unset"))?;
    let endpoint_name = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if endpoint_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("endpoint_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/endpoints/{EndpointName}/invocations-response-stream", EndpointName = endpoint_name).expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_invoke_endpoint_with_response_stream::ser_invoke_endpoint_with_response_stream_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_invoke_endpoint_with_response_stream_input::ser_body_http_payload( input.body)?);
...
#[derive(Debug)]
            struct InvokeEndpointWithResponseStreamEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InvokeEndpointWithResponseStreamEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "InvokeEndpointWithResponseStreamEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<InvokeEndpointWithResponseStreamInput>()
                        .ok_or("failed to downcast to InvokeEndpointWithResponseStreamInput")?;
...
/// Error type for the `InvokeEndpointWithResponseStreamError` operation.
#[non_exhaustive]
...
pub enum InvokeEndpointWithResponseStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InvokeEndpointWithResponseStreamError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl InvokeEndpointWithResponseStreamError {
    /// Creates the `InvokeEndpointWithResponseStreamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InvokeEndpointWithResponseStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `InvokeEndpointWithResponseStreamError::InternalFailure`.
    ...
    /// Returns `true` if the error kind is `InvokeEndpointWithResponseStreamError::ModelStreamError`.
...
impl ::std::error::Error for InvokeEndpointWithResponseStreamError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::ModelStreamError(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::InternalStreamFailure(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for InvokeEndpointWithResponseStreamError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for InvokeEndpointWithResponseStreamError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for InvokeEndpointWithResponseStreamError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InvokeEndpointWithResponseStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamError {
...
mod _invoke_endpoint_with_response_stream_output;
