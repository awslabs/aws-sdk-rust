...
pub struct InvokeEndpointWithResponseStreamOutputBuilder {
    pub(crate) body: ::std::option::Option<crate::event_receiver::EventReceiver<crate::types::ResponseStream, crate::types::error::ResponseStreamError>>,
...
impl InvokeEndpointWithResponseStreamOutputBuilder {
    ...
    pub fn body(mut self, input: crate::event_receiver::EventReceiver<crate::types::ResponseStream, crate::types::error::ResponseStreamError>) -> Self {
        self.body = ::std::option::Option::Some(input);
        self
    }
    /// <p>A stream of payload parts. Each part contains a portion of the response for a streaming inference request.</p>
    pub fn set_body(mut self, input: ::std::option::Option<crate::event_receiver::EventReceiver<crate::types::ResponseStream, crate::types::error::ResponseStreamError>>) -> Self {
        self.body = input; self
    }
    /// <p>A stream of payload parts. Each part contains a portion of the response for a streaming inference request.</p>
    pub fn get_body(&self) -> &::std::option::Option<crate::event_receiver::EventReceiver<crate::types::ResponseStream, crate::types::error::ResponseStreamError>> {
        &self.body
    }
    /// <p>The MIME type of the inference returned from the model container.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::invoke_endpoint_with_response_stream::InvokeEndpointWithResponseStreamOutput {
                body: self.body
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("body", "body was not specified but it is required when building InvokeEndpointWithResponseStreamOutput")
                    )?
                ,
