...
impl InvokeEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::invoke_endpoint::InvokeEndpoint,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::invoke_endpoint::InvokeEndpoint::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InvokeEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_invoke_endpoint::de_invoke_endpoint_http_error(
                status, headers, body,
            )
        } else {
