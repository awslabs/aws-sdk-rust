...
impl InvokeEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::invoke_endpoint::InvokeEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_invoke_endpoint_input::ser_body_http_payload(self.body)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for InvokeEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_invoke_endpoint::de_invoke_endpoint_http_response_with_props(status, headers, body)
        }
    }
