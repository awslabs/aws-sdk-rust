...
pub(crate) fn reflens_export_components_output_output_next_token(
...
pub(crate) fn reflens_export_forms_output_output_next_token(
...
pub(crate) fn reflens_export_themes_output_output_next_token(
...
pub(crate) fn reflens_list_codegen_jobs_output_output_next_token(
...
pub(crate) fn reflens_list_forms_output_output_next_token(
...
pub(crate) fn lens_export_components_output_output_entities(
    input: crate::operation::export_components::ExportComponentsOutput,
...
pub(crate) fn lens_export_forms_output_output_entities(
    input: crate::operation::export_forms::ExportFormsOutput,
...
pub(crate) fn lens_export_themes_output_output_entities(
    input: crate::operation::export_themes::ExportThemesOutput,
...
pub(crate) fn lens_list_codegen_jobs_output_output_entities(
    input: crate::operation::list_codegen_jobs::ListCodegenJobsOutput,
...
pub(crate) fn lens_list_components_output_output_entities(
    input: crate::operation::list_components::ListComponentsOutput,
...
pub(crate) fn lens_list_forms_output_output_entities(
    input: crate::operation::list_forms::ListFormsOutput,
...
pub(crate) fn lens_list_themes_output_output_entities(
    input: crate::operation::list_themes::ListThemesOutput,
