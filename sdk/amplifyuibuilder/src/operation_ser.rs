...
pub fn serialize_payload_create_form_input(
...
pub fn serialize_payload_put_metadata_flag_input(
    payload: &std::option::Option<crate::model::PutMetadataFlagBody>,
) -> Result<std::vec::Vec<u8>, aws_smithy_http::operation::error::BuildError> {
    let payload = match payload.as_ref() {
        Some(t) => t,
        None => return Ok(crate::operation_ser::rest_json_unsetpayload()),
...
pub fn serialize_payload_update_form_input(
    payload: &std::option::Option<crate::model::UpdateFormData>,
) -> Result<std::vec::Vec<u8>, aws_smithy_http::operation::error::BuildError> {
    let payload = match payload.as_ref() {
        Some(t) => t,
        None => return Ok(crate::operation_ser::rest_json_unsetpayload()),
...
pub fn serialize_member_com_amazonaws_amplifyuibuilder_synthetic_create_form_input_form_to_create(
...
pub fn serialize_member_com_amazonaws_amplifyuibuilder_synthetic_put_metadata_flag_input_body(
...
pub fn serialize_member_com_amazonaws_amplifyuibuilder_synthetic_update_form_input_updated_form(
