...
pub(crate) fn de_react_start_codegen_job_data<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ReactStartCodegenJobData>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_module(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::JsModule::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "target" => {
                                builder = builder.set_target(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::JsTarget::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "script" => {
                                builder = builder.set_script(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::JsScript::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "renderTypeDeclarations" => {
                                builder = builder.set_render_type_declarations(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "inlineSourceMap" => {
                                builder = builder.set_inline_source_map(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "apiConfiguration" => {
                                builder = builder.set_api_configuration(
                                    crate::protocol_serde::shape_api_configuration::de_api_configuration(tokens)?
                                );
                            }
                            "dependencies" => {
