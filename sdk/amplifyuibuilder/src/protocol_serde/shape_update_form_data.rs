...
pub fn ser_update_form_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateFormData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
