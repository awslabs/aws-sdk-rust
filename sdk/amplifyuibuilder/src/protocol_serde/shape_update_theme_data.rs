...
pub fn ser_update_theme_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateThemeData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
