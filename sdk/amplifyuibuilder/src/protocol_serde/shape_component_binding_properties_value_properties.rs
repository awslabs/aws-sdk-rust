...
pub fn ser_component_binding_properties_value_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentBindingPropertiesValueProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_component_binding_properties_value_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComponentBindingPropertiesValueProperties>, aws_smithy_json::deserialize::error::DeserializeError>
