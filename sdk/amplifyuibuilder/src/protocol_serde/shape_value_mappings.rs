            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "values" => {
                            builder = builder.set_values(crate::protocol_serde::shape_value_mapping_list::de_value_mapping_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "bindingProperties" => {
                            builder = builder.set_binding_properties(
                                crate::protocol_serde::shape_form_input_binding_properties::de_form_input_binding_properties(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
