...
pub fn ser_component_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentProperty) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_component_property<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComponentProperty>, aws_smithy_json::deserialize::error::DeserializeError>
