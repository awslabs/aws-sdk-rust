...
pub fn ser_component_child(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentChild) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_component_child<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComponentChild>, aws_smithy_json::deserialize::error::DeserializeError>
