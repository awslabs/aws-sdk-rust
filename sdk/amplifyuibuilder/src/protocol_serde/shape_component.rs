...
pub(crate) fn de_component_payload(
    ...
    let result = crate::protocol_serde::shape_component::de_component(tokens)?
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "variants" => {
                            builder = builder.set_variants(crate::protocol_serde::shape_component_variants::de_component_variants(tokens)?);
                        }
                        "overrides" => {
