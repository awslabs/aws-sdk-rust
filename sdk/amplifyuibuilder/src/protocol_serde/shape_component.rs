...
pub fn de_component_payload(
    input: &[u8],
) -> Result<crate::types::Component, aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input))
            .peekable();
    let tokens = &mut tokens_owned;
    let result = crate::protocol_serde::shape_component::de_component(tokens)?.ok_or_else(|| {
