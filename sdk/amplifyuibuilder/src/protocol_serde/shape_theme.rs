...
pub fn de_theme_payload(input: &[u8]) -> Result<crate::model::Theme, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_theme<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Theme>, aws_smithy_json::deserialize::error::DeserializeError>
