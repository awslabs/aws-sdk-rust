...
pub fn ser_field_input_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldInputConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_field_input_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FieldInputConfig>, aws_smithy_json::deserialize::error::DeserializeError>
