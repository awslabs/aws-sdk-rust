                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "bindingProperties" => {
                            builder = builder.set_binding_properties(
                                    crate::protocol_serde::shape_form_input_value_property_binding_properties::de_form_input_value_property_binding_properties(tokens, _value, depth + 1)?
                                );
                        }
                        "concat" => {
                            builder = builder.set_concat(
                                crate::protocol_serde::shape_form_input_value_property_list::de_form_input_value_property_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
