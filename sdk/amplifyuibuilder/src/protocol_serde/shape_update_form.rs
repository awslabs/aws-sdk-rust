...
pub fn de_update_form_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateFormOutput, crate::error::UpdateFormError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateFormError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_form_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateFormOutput, crate::error::UpdateFormError> {
    Ok({
        #[allow(unused_mut)]
