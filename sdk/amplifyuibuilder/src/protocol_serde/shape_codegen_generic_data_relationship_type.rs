...
pub(crate) fn de_codegen_generic_data_relationship_type<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CodegenGenericDataRelationshipType>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::GenericDataRelationshipType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "canUnlinkAssociatedModel" => {
                                builder = builder.set_can_unlink_associated_model(
                            ...
                            "associatedFields" => {
                                builder = builder.set_associated_fields(
                                    crate::protocol_serde::shape_associated_fields_list::de_associated_fields_list(tokens)?
                                );
                            }
                            "isHasManyIndex" => {
                                builder = builder.set_is_has_many_index(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::codegen_generic_data_relationship_type_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
