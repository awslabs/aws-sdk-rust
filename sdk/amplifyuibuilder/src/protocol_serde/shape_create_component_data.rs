...
pub fn ser_create_component_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateComponentData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
