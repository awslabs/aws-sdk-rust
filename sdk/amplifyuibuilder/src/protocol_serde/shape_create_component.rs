...
pub fn de_create_component_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateComponentOutput, crate::error::CreateComponentError> {
    ...
    Err(match error_code {
        ...
        "InvalidParameterException" => crate::error::CreateComponentError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => crate::error::CreateComponentError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
