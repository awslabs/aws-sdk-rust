...
pub fn ser_component_condition_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentConditionProperty) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_component_condition_property<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComponentConditionProperty>, aws_smithy_json::deserialize::error::DeserializeError>
