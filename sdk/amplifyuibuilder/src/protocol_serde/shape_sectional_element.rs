...
pub fn ser_sectional_element(
    ...
    if let Some(var_4) = &input.level {
        object.key("level").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
...
pub(crate) fn de_sectional_element<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SectionalElement>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::sectional_element_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
