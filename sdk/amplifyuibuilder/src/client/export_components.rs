...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::export_components::builders::ExportComponentsFluentBuilder::app_id) / [`set_app_id(impl Into<String>)`](crate::operation::export_components::builders::ExportComponentsFluentBuilder::set_app_id):<br>required: **true**<br><p>The unique ID of the Amplify app to export components to.</p><br>
    ///   - [`environment_name(impl Into<String>)`](crate::operation::export_components::builders::ExportComponentsFluentBuilder::environment_name) / [`set_environment_name(impl Into<String>)`](crate::operation::export_components::builders::ExportComponentsFluentBuilder::set_environment_name):<br>required: **true**<br><p>The name of the backend environment that is a part of the Amplify app.</p><br>
