...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::start_codegen_job::builders::StartCodegenJobFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::start_codegen_job::builders::StartCodegenJobFluentBuilder::set_app_id): <p>The unique ID for the Amplify app.</p>
