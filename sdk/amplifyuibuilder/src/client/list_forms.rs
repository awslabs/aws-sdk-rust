...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::list_forms::builders::ListFormsFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::list_forms::builders::ListFormsFluentBuilder::set_app_id): <p>The unique ID for the Amplify app.</p>
    ///   - [`environment_name(impl ::std::convert::Into<String>)`](crate::operation::list_forms::builders::ListFormsFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::list_forms::builders::ListFormsFluentBuilder::set_environment_name): <p>The name of the backend environment that is a part of the Amplify app.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_forms::builders::ListFormsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_forms::builders::ListFormsFluentBuilder::set_next_token): <p>The token to request the next page of results.</p>
