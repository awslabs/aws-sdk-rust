...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::get_metadata::builders::GetMetadataFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::get_metadata::builders::GetMetadataFluentBuilder::set_app_id):<br>required: **true**<br><p>The unique ID of the Amplify app.</p><br>
