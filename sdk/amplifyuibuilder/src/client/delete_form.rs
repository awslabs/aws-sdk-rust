...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::delete_form::builders::DeleteFormFluentBuilder::app_id) / [`set_app_id(impl Into<String>)`](crate::operation::delete_form::builders::DeleteFormFluentBuilder::set_app_id):<br>required: **true**<br><p>The unique ID of the Amplify app associated with the form to delete.</p><br>
    ///   - [`environment_name(impl Into<String>)`](crate::operation::delete_form::builders::DeleteFormFluentBuilder::environment_name) / [`set_environment_name(impl Into<String>)`](crate::operation::delete_form::builders::DeleteFormFluentBuilder::set_environment_name):<br>required: **true**<br><p>The name of the backend environment that is a part of the Amplify app.</p><br>
    ///   - [`id(impl Into<String>)`](crate::operation::delete_form::builders::DeleteFormFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::delete_form::builders::DeleteFormFluentBuilder::set_id):<br>required: **true**<br><p>The unique ID of the form to delete.</p><br>
