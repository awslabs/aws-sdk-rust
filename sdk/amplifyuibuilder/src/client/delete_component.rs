...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::set_app_id): <p>The unique ID of the Amplify app associated with the component to delete.</p>
    ///   - [`environment_name(impl ::std::convert::Into<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::set_environment_name): <p>The name of the backend environment that is a part of the Amplify app.</p>
