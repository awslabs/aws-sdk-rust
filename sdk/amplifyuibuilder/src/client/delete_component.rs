...
impl super::Client {
    ...
    ///   - [`environment_name(impl Into<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::set_environment_name):<br>required: **true**<br><p>The name of the backend environment that is a part of the Amplify app.</p><br>
    ///   - [`id(impl Into<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::set_id):<br>required: **true**<br><p>The unique ID of the component to delete.</p><br>
