...
impl super::Client {
    ...
    ///   - [`tags(HashMap::<String, String>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>A list of tag key value pairs for a specified Amazon Resource Name (ARN).</p>
