...
impl Builder {
    ...
    /// use aws_sdk_amplifyuibuilder::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_amplifyuibuilder::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
