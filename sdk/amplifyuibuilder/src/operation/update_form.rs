...
impl UpdateFormInput {
    /// Consumes the builder and constructs an Operation<[`UpdateForm`](crate::operation::update_form::UpdateForm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_form::UpdateForm, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_form::UpdateFormInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_form::UpdateFormInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_form::UpdateForm::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateForm {
                type Output = std::result::Result<crate::operation::update_form::UpdateFormOutput, crate::operation::update_form::UpdateFormError>;
