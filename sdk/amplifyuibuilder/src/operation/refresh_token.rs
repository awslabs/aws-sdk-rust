    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/tokens/{provider}/refresh", provider = provider)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::refresh_token::RefreshToken::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RefreshToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_refresh_token::de_refresh_token_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_refresh_token::de_refresh_token_http_response_with_props(
                status, headers, body,
            )
        }
    }
