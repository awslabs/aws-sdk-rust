...
fn uri_query(_input: &crate::operation::create_component::CreateComponentInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_component_input::ser_component_to_create_http_payload(& input.component_to_create)?);
