    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/tokens/{provider}", provider = provider)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::exchange_code_for_token::ExchangeCodeForToken::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::exchange_code_for_token::ExchangeCodeForTokenError
{
