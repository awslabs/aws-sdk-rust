...
impl DeleteThemeInputBuilder {
    ...
    /// - [`app_id`](crate::operation::delete_theme::builders::DeleteThemeInputBuilder::app_id)
    /// - [`environment_name`](crate::operation::delete_theme::builders::DeleteThemeInputBuilder::environment_name)
    /// - [`id`](crate::operation::delete_theme::builders::DeleteThemeInputBuilder::id)
        ...
        ::std::result::Result::Ok(crate::operation::delete_theme::DeleteThemeInput {
            app_id: self.app_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "app_id",
                    "app_id was not specified but it is required when building DeleteThemeInput",
                )
            })?,
            environment_name: self.environment_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "environment_name",
                    "environment_name was not specified but it is required when building DeleteThemeInput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building DeleteThemeInput",
                )
            })?,
        })
    }
