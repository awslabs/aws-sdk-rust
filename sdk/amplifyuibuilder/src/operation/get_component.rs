...
impl GetComponentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_component::GetComponent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComponent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_component::de_get_component_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_component::de_get_component_http_response_with_props(
                status, headers, body,
            )
        }
    }
