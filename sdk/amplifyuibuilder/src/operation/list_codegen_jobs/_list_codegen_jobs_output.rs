...
pub struct ListCodegenJobsOutput {
    ...
    pub entities: ::std::option::Option<::std::vec::Vec<crate::types::CodegenJobSummary>>,
...
impl ListCodegenJobsOutput {
    /// <p>The list of code generation jobs for the Amplify app.</p>
    pub fn entities(&self) -> ::std::option::Option<&[crate::types::CodegenJobSummary]> {
...
impl ::aws_http::request_id::RequestId for ListCodegenJobsOutput {
...
impl ListCodegenJobsOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::list_codegen_jobs::ListCodegenJobsOutput {
