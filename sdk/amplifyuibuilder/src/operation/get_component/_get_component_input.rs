...
impl GetComponentInputBuilder {
    ...
    /// - [`app_id`](crate::operation::get_component::builders::GetComponentInputBuilder::app_id)
    /// - [`environment_name`](crate::operation::get_component::builders::GetComponentInputBuilder::environment_name)
    /// - [`id`](crate::operation::get_component::builders::GetComponentInputBuilder::id)
        ...
        ::std::result::Result::Ok(crate::operation::get_component::GetComponentInput {
            app_id: self.app_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "app_id",
                    "app_id was not specified but it is required when building GetComponentInput",
                )
            })?,
            environment_name: self.environment_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "environment_name",
                    "environment_name was not specified but it is required when building GetComponentInput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetComponentInput",
                )
            })?,
        })
    }
