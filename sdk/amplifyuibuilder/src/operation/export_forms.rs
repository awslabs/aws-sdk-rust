...
impl ExportFormsInput {
    /// Consumes the builder and constructs an Operation<[`ExportForms`](crate::operation::export_forms::ExportForms)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::export_forms::ExportForms, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_forms::ExportFormsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::export_forms::ExportFormsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::export_forms::ExportForms::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExportForms {
                type Output = std::result::Result<crate::operation::export_forms::ExportFormsOutput, crate::operation::export_forms::ExportFormsError>;
