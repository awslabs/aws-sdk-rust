...
impl ExchangeCodeForTokenFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::exchange_code_for_token::ExchangeCodeForTokenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::exchange_code_for_token::ExchangeCodeForTokenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::exchange_code_for_token::ExchangeCodeForTokenOutput, crate::operation::exchange_code_for_token::ExchangeCodeForTokenError, Self> {
