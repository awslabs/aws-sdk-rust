...
impl ListFormsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_forms::ListForms,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_forms::ListForms::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListForms {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_forms::de_list_forms_http_response_with_props(
                status, headers, body,
            )
        }
    }
