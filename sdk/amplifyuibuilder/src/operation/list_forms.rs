...
impl ListFormsInput {
    /// Consumes the builder and constructs an Operation<[`ListForms`](crate::operation::list_forms::ListForms)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_forms::ListForms, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_forms::ListFormsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_forms::ListFormsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_forms::ListForms::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListForms {
                type Output = std::result::Result<crate::operation::list_forms::ListFormsOutput, crate::operation::list_forms::ListFormsError>;
