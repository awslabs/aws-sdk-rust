...
impl ListFormsFluentBuilder  {
    /// Creates a new `ListForms`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_forms::ListFormsOutput, aws_smithy_http::result::SdkError<crate::operation::list_forms::ListFormsError>>
                     {
