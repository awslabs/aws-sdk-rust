...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateTheme {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateTheme", "amplifyuibuilder"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for UpdateThemeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_theme_input::ser_updated_theme_http_payload(
            &input.updated_theme,
        )?);
