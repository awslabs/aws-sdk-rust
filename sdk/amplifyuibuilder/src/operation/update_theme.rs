...
fn uri_query(_input: &crate::operation::update_theme::UpdateThemeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_theme_input::ser_updated_theme_http_payload(& input.updated_theme)?);
