...
impl GetThemeFluentBuilder  {
    /// Creates a new `GetTheme`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_theme::GetThemeOutput, aws_smithy_http::result::SdkError<crate::operation::get_theme::GetThemeError>>
                     {
