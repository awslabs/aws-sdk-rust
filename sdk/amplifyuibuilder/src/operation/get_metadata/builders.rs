...
impl GetMetadataFluentBuilder  {
    /// Creates a new `GetMetadata`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_metadata::GetMetadataOutput, aws_smithy_http::result::SdkError<crate::operation::get_metadata::GetMetadataError>>
                     {
