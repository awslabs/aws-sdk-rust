...
impl ExportComponentsInputBuilder {
    ...
    /// - [`app_id`](crate::operation::export_components::builders::ExportComponentsInputBuilder::app_id)
    /// - [`environment_name`](crate::operation::export_components::builders::ExportComponentsInputBuilder::environment_name)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::export_components::ExportComponentsInput {
            app_id: self.app_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "app_id",
                    "app_id was not specified but it is required when building ExportComponentsInput",
                )
            })?,
            environment_name: self.environment_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "environment_name",
                    "environment_name was not specified but it is required when building ExportComponentsInput",
                )
            })?,
