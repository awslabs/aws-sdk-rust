...
impl CreateFormInput {
    /// Consumes the builder and constructs an Operation<[`CreateForm`](crate::operation::create_form::CreateForm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_form::CreateForm, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_form::CreateFormInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_form::CreateFormInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_form::CreateForm::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateForm {
                type Output = std::result::Result<crate::operation::create_form::CreateFormOutput, crate::operation::create_form::CreateFormError>;
