...
pub fn serialize_structure_crate_model_create_component_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateComponentData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_create_form_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateFormData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_create_theme_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateThemeData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_exchange_code_for_token_request_body(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExchangeCodeForTokenRequestBody) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_put_metadata_flag_body(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PutMetadataFlagBody) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_refresh_token_request_body(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RefreshTokenRequestBody) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_update_component_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateComponentData) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_88) = &input.properties {
        ...
        for (key_90, value_91) in var_88 {
             {
                let mut object_92 = object_89.key(key_90).start_object();
    ...
    if let Some(var_101) = &input.overrides {
        ...
        for (key_103, value_104) in var_101 {
             {
                let mut object_105 = object_102.key(key_103).start_object();
                for (key_106, value_107) in value_104 {
                     {
                        object_105.key(key_106).string(value_107.as_str());
                    }
                }
                object_105.finish();
            }
    ...
    if let Some(var_108) = &input.binding_properties {
        ...
        for (key_110, value_111) in var_108 {
             {
                let mut object_112 = object_109.key(key_110).start_object();
...
pub fn serialize_structure_crate_model_update_form_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateFormData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_update_theme_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateThemeData) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentProperty) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_child(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentChild) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_180) = &input.properties {
        ...
        for (key_182, value_183) in var_180 {
             {
                let mut object_184 = object_181.key(key_182).start_object();
...
pub fn serialize_structure_crate_model_component_variant(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentVariant) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_binding_properties_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentBindingPropertiesValue) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_data_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentDataConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_event(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentEvent) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_form_data_type_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormDataTypeConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_field_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_form_style(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormStyle) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sectional_element(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SectionalElement) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_form_cta(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormCta) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_theme_values(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ThemeValues) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_property_binding_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentPropertyBindingProperties) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_form_binding_element(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormBindingElement) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_condition_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentConditionProperty) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_component_binding_properties_value_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComponentBindingPropertiesValueProperties) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sort_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SortProperty) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_action_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActionParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_308) = &input.fields {
        ...
        for (key_310, value_311) in var_308 {
             {
                let mut object_312 = object_309.key(key_310).start_object();
...
pub fn serialize_union_crate_model_field_position(object_228: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldPosition) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::FieldPosition::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("FieldPosition"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_field_input_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldInputConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_field_validation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldValidationConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_330) = &input.r#type {
        object.key("type").string(var_330.as_str());
    }
    if let Some(var_331) = &input.str_values {
        let mut array_332 = object.key("strValues").start_array();
    ...
    if let Some(var_334) = &input.num_values {
        let mut array_335 = object.key("numValues").start_array();
        for item_336 in var_334 {
             {
                array_335.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*item_336).into()));
            }
        }
        array_335.finish();
    }
    if let Some(var_337) = &input.validation_message {
        object.key("validationMessage").string(var_337.as_str());
    }
    Ok(())
}

pub fn serialize_union_crate_model_form_style_config(object_237: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormStyleConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::FormStyleConfig::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("FormStyleConfig"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_form_button(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormButton) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_338) = &input.excluded {
        object.key("excluded").boolean(*var_338);
    }
    if let Some(var_339) = &input.children {
        object.key("children").string(var_339.as_str());
    }
    if let Some(var_340) = &input.position {
        let mut object_341 = object.key("position").start_object();
        crate::json_ser::serialize_union_crate_model_field_position(&mut object_341, var_340)?;
        object_341.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_theme_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ThemeValue) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_342) = &input.value {
        object.key("value").string(var_342.as_str());
    }
    if let Some(var_343) = &input.children {
        let mut array_344 = object.key("children").start_array();
        for item_345 in var_343 {
             {
                let mut object_346 = array_344.value().start_object();
                crate::json_ser::serialize_structure_crate_model_theme_values(&mut object_346, item_345)?;
                object_346.finish();
            }
        }
        array_344.finish();
...
pub fn serialize_structure_crate_model_mutation_action_set_state_parameter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MutationActionSetStateParameter) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_347) = &input.component_name {
        object.key("componentName").string(var_347.as_str());
    }
    if let Some(var_348) = &input.property {
        object.key("property").string(var_348.as_str());
    }
    if let Some(var_349) = &input.set {
        let mut object_350 = object.key("set").start_object();
        crate::json_ser::serialize_structure_crate_model_component_property(&mut object_350, var_349)?;
        object_350.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_value_mappings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ValueMappings) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_353 in var_351 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_value_mapping(&mut object_354, item_353)?;
                object_354.finish();
            }
        }
        array_352.finish();
...
pub fn serialize_structure_crate_model_value_mapping(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ValueMapping) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_355) = &input.display_value {
        let mut object_356 = object.key("displayValue").start_object();
        crate::json_ser::serialize_structure_crate_model_form_input_value_property(&mut object_356, var_355)?;
        object_356.finish();
    }
    if let Some(var_357) = &input.value {
        let mut object_358 = object.key("value").start_object();
        crate::json_ser::serialize_structure_crate_model_form_input_value_property(&mut object_358, var_357)?;
        object_358.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_form_input_value_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FormInputValueProperty) -> Result<(), aws_smithy_http::operation::SerializationError> {
