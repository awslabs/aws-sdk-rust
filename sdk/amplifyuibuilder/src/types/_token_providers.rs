...
impl ::std::convert::From<&str> for TokenProviders {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TokenProviders::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TokenProviders {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TokenProviders::from(s))
    }
}
impl TokenProviders {
...
impl ::std::convert::AsRef<str> for TokenProviders {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
