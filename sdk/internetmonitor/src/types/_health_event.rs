        ...
        ::std::result::Result::Ok(
            crate::types::HealthEvent {
                event_arn: self.event_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("event_arn", "event_arn was not specified but it is required when building HealthEvent")
                    )?
                ,
                event_id: self.event_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("event_id", "event_id was not specified but it is required when building HealthEvent")
                    )?
                ,
                started_at: self.started_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("started_at", "started_at was not specified but it is required when building HealthEvent")
                    )?
                ,
                ...
                last_updated_at: self.last_updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_updated_at", "last_updated_at was not specified but it is required when building HealthEvent")
                    )?
                ,
                impacted_locations: self.impacted_locations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("impacted_locations", "impacted_locations was not specified but it is required when building HealthEvent")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building HealthEvent")
                    )?
                ,
                ...
                impact_type: self.impact_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("impact_type", "impact_type was not specified but it is required when building HealthEvent")
                    )?
                ,
