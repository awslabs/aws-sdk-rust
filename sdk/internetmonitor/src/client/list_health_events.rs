...
impl super::Client {
    ...
    ///   - [`monitor_name(impl Into<String>)`](crate::operation::list_health_events::builders::ListHealthEventsFluentBuilder::monitor_name) / [`set_monitor_name(impl Into<String>)`](crate::operation::list_health_events::builders::ListHealthEventsFluentBuilder::set_monitor_name):<br>required: **true**<br><p>The name of the monitor.</p><br>
