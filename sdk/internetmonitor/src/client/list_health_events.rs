...
impl super::Client {
    ...
    ///   - [`linked_account_id(impl Into<String>)`](crate::operation::list_health_events::builders::ListHealthEventsFluentBuilder::linked_account_id) / [`set_linked_account_id(Option<String>)`](crate::operation::list_health_events::builders::ListHealthEventsFluentBuilder::set_linked_account_id):<br>required: **false**<br><p>TBD</p><br>
