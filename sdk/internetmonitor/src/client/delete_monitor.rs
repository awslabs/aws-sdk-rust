...
impl super::Client {
    ...
    ///   - [`monitor_name(impl Into<String>)`](crate::operation::delete_monitor::builders::DeleteMonitorFluentBuilder::monitor_name) / [`set_monitor_name(impl Into<String>)`](crate::operation::delete_monitor::builders::DeleteMonitorFluentBuilder::set_monitor_name):<br>required: **true**<br><p>The name of the monitor to delete.</p><br>
