...
impl super::Client  {
    ...
    ///   - [`monitor_name(impl Into<String>)`](crate::operation::get_health_event::builders::GetHealthEventFluentBuilder::monitor_name) / [`set_monitor_name(Option<String>)`](crate::operation::get_health_event::builders::GetHealthEventFluentBuilder::set_monitor_name): <p>The name of the monitor.</p>
    ///   - [`event_id(impl Into<String>)`](crate::operation::get_health_event::builders::GetHealthEventFluentBuilder::event_id) / [`set_event_id(Option<String>)`](crate::operation::get_health_event::builders::GetHealthEventFluentBuilder::set_event_id): <p>The internally generated identifier of a health event. Because <code>EventID</code> contains the forward slash (“/”) character, you must URL-encode the <code>EventID</code> field in the request URL.</p>
