...
pub fn ser_update_monitor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_monitor::UpdateMonitorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
