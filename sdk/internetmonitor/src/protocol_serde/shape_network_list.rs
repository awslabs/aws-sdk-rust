...
pub(crate) fn de_network_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Network>>, aws_smithy_json::deserialize::error::DeserializeError>
