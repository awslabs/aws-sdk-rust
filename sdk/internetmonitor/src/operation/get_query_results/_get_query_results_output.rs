...
impl GetQueryResultsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_query_results::GetQueryResultsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_query_results::GetQueryResultsOutput {
                fields: self.fields
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("fields", "fields was not specified but it is required when building GetQueryResultsOutput")
                    )?
                ,
                data: self.data
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data", "data was not specified but it is required when building GetQueryResultsOutput")
                    )?
                ,
