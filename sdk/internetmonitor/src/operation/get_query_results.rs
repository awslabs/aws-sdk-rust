...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v20210603/Monitors/{MonitorName}/Queries/{QueryId}/Results", MonitorName = monitor_name, QueryId = query_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_query_results::GetQueryResultsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl GetQueryResultsError {
    ...
    /// Returns `true` if the error kind is `GetQueryResultsError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `GetQueryResultsError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `GetQueryResultsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GetQueryResultsError::ValidationException`.
