...
impl GetCorsPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_cors_policy::GetCorsPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_cors_policy::ser_get_cors_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCorsPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cors_policy::de_get_cors_policy_http_response_with_props(status, headers, body)
        }
    }
}
