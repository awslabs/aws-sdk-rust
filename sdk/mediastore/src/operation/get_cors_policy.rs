...
impl GetCorsPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetCorsPolicy`](crate::operation::get_cors_policy::GetCorsPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_cors_policy::GetCorsPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cors_policy::GetCorsPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_cors_policy::ser_get_cors_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_cors_policy::GetCorsPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetCorsPolicy {
                type Output = std::result::Result<crate::operation::get_cors_policy::GetCorsPolicyOutput, crate::operation::get_cors_policy::GetCorsPolicyError>;
