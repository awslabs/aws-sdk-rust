...
impl GetMetricPolicyInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_metric_policy::GetMetricPolicy::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetMetricPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_metric_policy::de_get_metric_policy_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_metric_policy::de_get_metric_policy_http_response(
                response,
            )
        }
    }
