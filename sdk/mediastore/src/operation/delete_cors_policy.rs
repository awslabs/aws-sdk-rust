...
impl DeleteCorsPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCorsPolicy`](crate::operation::delete_cors_policy::DeleteCorsPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_cors_policy::DeleteCorsPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_cors_policy::DeleteCorsPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_cors_policy::ser_delete_cors_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cors_policy::DeleteCorsPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCorsPolicy {
                type Output = std::result::Result<crate::operation::delete_cors_policy::DeleteCorsPolicyOutput, crate::operation::delete_cors_policy::DeleteCorsPolicyError>;
