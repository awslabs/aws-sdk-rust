...
impl DescribeContainerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_container::ser_describe_container_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeContainer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_container::de_describe_container_http_response_with_props(status, headers, body)
        }
    }
}
