...
impl DescribeContainerInput {
    /// Consumes the builder and constructs an Operation<[`DescribeContainer`](crate::operation::describe_container::DescribeContainer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_container::DescribeContainer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_container::DescribeContainerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_container::ser_describe_container_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_container::DescribeContainer::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeContainer {
                type Output = std::result::Result<crate::operation::describe_container::DescribeContainerOutput, crate::operation::describe_container::DescribeContainerError>;
