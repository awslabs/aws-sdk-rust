...
impl CreateContainerInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_container::CreateContainer::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateContainer {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_container::de_create_container_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_container::de_create_container_http_response(
                status, headers, body,
            )
        }
    }
