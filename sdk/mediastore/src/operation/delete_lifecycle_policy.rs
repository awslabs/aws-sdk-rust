...
impl DeleteLifecyclePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("mediastore", "DeleteLifecyclePolicy", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLifecyclePolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteLifecyclePolicy", "mediastore"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLifecyclePolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_lifecycle_policy::ser_delete_lifecycle_policy_input(
            &input,
        )?);
