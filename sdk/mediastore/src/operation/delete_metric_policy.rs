...
impl DeleteMetricPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_metric_policy::DeleteMetricPolicy,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_metric_policy::ser_delete_metric_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMetricPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_metric_policy::de_delete_metric_policy_http_response_with_props(status, headers, body)
        }
    }
}
