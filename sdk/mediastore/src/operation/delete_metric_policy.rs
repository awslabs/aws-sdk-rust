...
impl DeleteMetricPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_metric_policy::ser_delete_metric_policy_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_metric_policy::DeleteMetricPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMetricPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_metric_policy::de_delete_metric_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_metric_policy::DeleteMetricPolicyError
{
