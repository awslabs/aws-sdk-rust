...
impl GetLifecyclePolicyInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_lifecycle_policy::ser_get_lifecycle_policy_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_lifecycle_policy::GetLifecyclePolicy::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_lifecycle_policy::GetLifecyclePolicyError
{
