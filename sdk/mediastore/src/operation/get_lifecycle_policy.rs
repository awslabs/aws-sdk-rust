...
impl GetLifecyclePolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_lifecycle_policy::ser_get_lifecycle_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLifecyclePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lifecycle_policy::de_get_lifecycle_policy_http_response_with_props(status, headers, body)
        }
    }
}
