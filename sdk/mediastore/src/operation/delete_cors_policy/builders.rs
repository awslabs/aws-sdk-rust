...
impl DeleteCorsPolicyFluentBuilder  {
    /// Creates a new `DeleteCorsPolicy`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_cors_policy::DeleteCorsPolicyOutput, aws_smithy_http::result::SdkError<crate::operation::delete_cors_policy::DeleteCorsPolicyError>>
                     {
