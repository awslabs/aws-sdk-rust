...
impl GetContainerPolicyInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_policy::ser_get_container_policy_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_container_policy::GetContainerPolicy::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetContainerPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_container_policy::de_get_container_policy_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_container_policy::de_get_container_policy_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::get_container_policy::GetContainerPolicyError
{
