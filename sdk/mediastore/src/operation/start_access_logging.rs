...
impl StartAccessLoggingInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_access_logging::ser_start_access_logging_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_access_logging::StartAccessLogging::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StartAccessLogging {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_start_access_logging::de_start_access_logging_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::start_access_logging::StartAccessLoggingError
{
