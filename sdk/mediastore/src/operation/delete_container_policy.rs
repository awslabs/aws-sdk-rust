...
impl DeleteContainerPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteContainerPolicy`](crate::operation::delete_container_policy::DeleteContainerPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_container_policy::DeleteContainerPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_container_policy::DeleteContainerPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_container_policy::ser_delete_container_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_container_policy::DeleteContainerPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteContainerPolicy {
                type Output = std::result::Result<crate::operation::delete_container_policy::DeleteContainerPolicyOutput, crate::operation::delete_container_policy::DeleteContainerPolicyError>;
