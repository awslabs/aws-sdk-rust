...
impl PutMetricPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_metric_policy::PutMetricPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMetricPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_metric_policy::de_put_metric_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_metric_policy::PutMetricPolicyError
{
