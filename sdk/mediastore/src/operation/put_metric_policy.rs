...
impl PutMetricPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_metric_policy::PutMetricPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_metric_policy::ser_put_metric_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMetricPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_metric_policy::de_put_metric_policy_http_response_with_props(status, headers, body)
        }
    }
}
