...
impl DeleteContainerFluentBuilder  {
    /// Creates a new `DeleteContainer`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_container::DeleteContainerOutput, aws_smithy_http::result::SdkError<crate::operation::delete_container::DeleteContainerError>>
                     {
