...
impl StopAccessLoggingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_access_logging::StopAccessLogging::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopAccessLogging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_access_logging::de_stop_access_logging_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_access_logging::StopAccessLoggingError
{
