...
impl StopAccessLoggingInput {
    /// Consumes the builder and constructs an Operation<[`StopAccessLogging`](crate::operation::stop_access_logging::StopAccessLogging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_access_logging::StopAccessLogging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_access_logging::StopAccessLoggingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_access_logging::ser_stop_access_logging_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_access_logging::StopAccessLogging::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopAccessLogging {
                type Output = std::result::Result<crate::operation::stop_access_logging::StopAccessLoggingOutput, crate::operation::stop_access_logging::StopAccessLoggingError>;
