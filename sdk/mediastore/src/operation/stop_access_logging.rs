...
/// Orchestration and serialization glue logic for `StopAccessLogging`.
...
impl StopAccessLogging {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_access_logging::StopAccessLoggingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_access_logging::StopAccessLoggingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_access_logging::StopAccessLoggingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_access_logging::StopAccessLoggingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopAccessLogging {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopAccessLogging");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopAccessLoggingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopAccessLoggingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopAccessLogging")
...
.with_interceptor(StopAccessLoggingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_access_logging::StopAccessLoggingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_access_logging::StopAccessLoggingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_access_logging::StopAccessLoggingError>::new());
...
#[derive(Debug)]
            struct StopAccessLoggingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopAccessLoggingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_access_logging::de_stop_access_logging_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_access_logging::de_stop_access_logging_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopAccessLoggingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopAccessLoggingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_access_logging::StopAccessLoggingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_access_logging::StopAccessLoggingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_access_logging::ser_stop_access_logging_input(&input)?);
...
#[derive(Debug)]
            struct StopAccessLoggingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopAccessLoggingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopAccessLoggingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopAccessLoggingInput>()
                        .ok_or("failed to downcast to StopAccessLoggingInput")?;
...
pub enum StopAccessLoggingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopAccessLoggingError) for what information is available for the error.")]
...
impl StopAccessLoggingError {
    /// Creates the `StopAccessLoggingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopAccessLoggingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopAccessLoggingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_access_logging::StopAccessLoggingError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::stop_access_logging::_stop_access_logging_output::StopAccessLoggingOutput;

pub use crate::operation::stop_access_logging::_stop_access_logging_input::StopAccessLoggingInput;

mod _stop_access_logging_input;

mod _stop_access_logging_output;
