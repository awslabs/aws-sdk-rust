...
impl StopAccessLoggingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_access_logging::StopAccessLogging,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_access_logging::ser_stop_access_logging_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopAccessLogging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_access_logging::de_stop_access_logging_http_response_with_props(status, headers, body)
        }
    }
}
