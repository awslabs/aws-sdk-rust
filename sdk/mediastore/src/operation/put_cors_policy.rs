...
impl PutCorsPolicyInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_cors_policy::PutCorsPolicy::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for PutCorsPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_cors_policy::de_put_cors_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_cors_policy::de_put_cors_policy_http_response(
                status, headers, body,
            )
        }
    }
