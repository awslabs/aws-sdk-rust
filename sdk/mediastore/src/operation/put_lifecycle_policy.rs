...
/// Orchestration and serialization glue logic for `PutLifecyclePolicy`.
...
impl PutLifecyclePolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_lifecycle_policy::PutLifecyclePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_lifecycle_policy::PutLifecyclePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_lifecycle_policy::PutLifecyclePolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_lifecycle_policy::PutLifecyclePolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutLifecyclePolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutLifecyclePolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutLifecyclePolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutLifecyclePolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutLifecyclePolicy")
...
.with_interceptor(PutLifecyclePolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_lifecycle_policy::PutLifecyclePolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_lifecycle_policy::PutLifecyclePolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_lifecycle_policy::PutLifecyclePolicyError>::new());
...
#[derive(Debug)]
            struct PutLifecyclePolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutLifecyclePolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_lifecycle_policy::de_put_lifecycle_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_lifecycle_policy::de_put_lifecycle_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutLifecyclePolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutLifecyclePolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_lifecycle_policy::PutLifecyclePolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_lifecycle_policy::PutLifecyclePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_lifecycle_policy::ser_put_lifecycle_policy_input(&input)?);
...
#[derive(Debug)]
            struct PutLifecyclePolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutLifecyclePolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutLifecyclePolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutLifecyclePolicyInput>()
                        .ok_or("failed to downcast to PutLifecyclePolicyInput")?;
...
pub enum PutLifecyclePolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutLifecyclePolicyError) for what information is available for the error.")]
...
impl PutLifecyclePolicyError {
    /// Creates the `PutLifecyclePolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutLifecyclePolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutLifecyclePolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_lifecycle_policy::PutLifecyclePolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_lifecycle_policy::_put_lifecycle_policy_output::PutLifecyclePolicyOutput;

pub use crate::operation::put_lifecycle_policy::_put_lifecycle_policy_input::PutLifecyclePolicyInput;

mod _put_lifecycle_policy_input;

mod _put_lifecycle_policy_output;
