...
impl PutLifecyclePolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_lifecycle_policy::ser_put_lifecycle_policy_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_lifecycle_policy::PutLifecyclePolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_lifecycle_policy::PutLifecyclePolicyError
{
