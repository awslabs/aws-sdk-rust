...
pub struct GetMetricPolicyOutput  {
    ...
    #[doc(hidden)]pub metric_policy: std::option::Option<crate::model::MetricPolicy>,
}
...
pub struct GetLifecyclePolicyOutput  {
    ...
    #[doc(hidden)]pub lifecycle_policy: std::option::Option<std::string::String>,
}
...
pub struct GetCorsPolicyOutput  {
    ...
    #[doc(hidden)]pub cors_policy: std::option::Option<std::vec::Vec<crate::model::CorsRule>>,
}
...
pub struct DescribeContainerOutput  {
    ...
    #[doc(hidden)]pub container: std::option::Option<crate::model::Container>,
}
