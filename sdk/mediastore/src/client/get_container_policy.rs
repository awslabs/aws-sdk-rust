...
impl super::Client {
    ...
    ///   - [`container_name(impl ::std::convert::Into<String>)`](crate::operation::get_container_policy::builders::GetContainerPolicyFluentBuilder::container_name) / [`set_container_name(Option<String>)`](crate::operation::get_container_policy::builders::GetContainerPolicyFluentBuilder::set_container_name): <p>The name of the container. </p>
