...
impl super::Client {
    ...
    ///   - [`container_name(impl Into<String>)`](crate::operation::stop_access_logging::builders::StopAccessLoggingFluentBuilder::container_name) / [`set_container_name(Option<String>)`](crate::operation::stop_access_logging::builders::StopAccessLoggingFluentBuilder::set_container_name):<br>required: **true**<br><p>The name of the container that you want to stop access logging on.</p><br>
