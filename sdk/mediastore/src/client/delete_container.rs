...
impl super::Client {
    ...
    ///   - [`container_name(impl Into<String>)`](crate::operation::delete_container::builders::DeleteContainerFluentBuilder::container_name) / [`set_container_name(Option<String>)`](crate::operation::delete_container::builders::DeleteContainerFluentBuilder::set_container_name):<br>required: **true**<br><p>The name of the container to delete.</p><br>
