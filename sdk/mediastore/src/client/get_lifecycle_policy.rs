...
impl super::Client {
    ...
    ///   - [`container_name(impl Into<String>)`](crate::operation::get_lifecycle_policy::builders::GetLifecyclePolicyFluentBuilder::container_name) / [`set_container_name(Option<String>)`](crate::operation::get_lifecycle_policy::builders::GetLifecyclePolicyFluentBuilder::set_container_name):<br>required: **true**<br><p>The name of the container that the object lifecycle policy is assigned to.</p><br>
    ...
    ///   - [`lifecycle_policy(String)`](crate::operation::get_lifecycle_policy::GetLifecyclePolicyOutput::lifecycle_policy): <p>The object lifecycle policy that is assigned to the container.</p>
