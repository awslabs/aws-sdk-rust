...
impl super::Client {
    ...
    ///   - [`resource(impl Into<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::resource) / [`set_resource(Option<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::set_resource):<br>required: **true**<br><p>The Amazon Resource Name (ARN) for the container.</p><br>
