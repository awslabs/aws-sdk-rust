...
impl ::std::convert::From<&str> for MethodName {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PUT" => MethodName::Put,
            other => MethodName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MethodName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MethodName::from(s))
    }
}
impl MethodName {
...
impl ::std::convert::AsRef<str> for MethodName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
