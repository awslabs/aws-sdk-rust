...
pub fn ser_cors_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CorsRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cors_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CorsRule>, aws_smithy_json::deserialize::error::DeserializeError>
