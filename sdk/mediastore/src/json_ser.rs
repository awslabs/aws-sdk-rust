...
pub fn serialize_structure_create_container_input(
...
pub fn serialize_structure_delete_container_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_container_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_cors_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_lifecycle_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_metric_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_container_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_container_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_cors_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_lifecycle_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_metric_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_containers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_container_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_cors_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_24 in var_22 {
            {
                ...
                crate::json_ser::serialize_structure_cors_rule(&mut object_25, item_24);
                object_25.finish();
            }
        }
        array_23.finish();
...
pub fn serialize_structure_put_lifecycle_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_metric_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_29) = &input.metric_policy {
        ...
        crate::json_ser::serialize_structure_metric_policy(&mut object_30, var_29);
        object_30.finish();
    }
}

pub fn serialize_structure_start_access_logging_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_access_logging_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_metric_policy(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_59 in var_57 {
            {
                ...
                crate::json_ser::serialize_structure_metric_policy_rule(&mut object_60, item_59);
                object_60.finish();
            }
        }
        array_58.finish();
...
pub fn serialize_structure_metric_policy_rule(
    object: &mut smithy_json::serialize::JsonObjectWriter,
