...
/// For example, the [`CreateContainer`](crate::operation) operation has
...
mod delete_container_policy;

mod delete_cors_policy;

mod delete_lifecycle_policy;

mod delete_metric_policy;

mod describe_container;
...
mod get_container_policy;

mod get_cors_policy;

mod get_lifecycle_policy;

mod get_metric_policy;

mod list_containers;

mod list_tags_for_resource;

mod put_container_policy;

mod put_cors_policy;

mod put_lifecycle_policy;

mod put_metric_policy;

mod start_access_logging;

mod stop_access_logging;
