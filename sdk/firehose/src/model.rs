...
pub struct AmazonOpenSearchServerlessDestinationUpdate  {
    ...
    #[doc(hidden)]
    pub buffering_hints: std::option::Option<crate::model::AmazonOpenSearchServerlessBufferingHints>,
...
impl AmazonOpenSearchServerlessDestinationUpdate {
    ...
    /// <p>The buffering options. If no value is specified, AmazonopensearchBufferingHints object default values are used.</p>
    pub fn buffering_hints(&self) -> std::option::Option<& crate::model::AmazonOpenSearchServerlessBufferingHints> {
        self.buffering_hints.as_ref()
    }
    /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to the Serverless offering for Amazon OpenSearch Service. The default value is 300 (5 minutes).</p>
    pub fn retry_options(&self) -> std::option::Option<& crate::model::AmazonOpenSearchServerlessRetryOptions> {
...
pub mod amazon_open_search_serverless_destination_update {
    ...
    pub struct Builder {
        ...
        pub(crate) buffering_hints: std::option::Option<crate::model::AmazonOpenSearchServerlessBufferingHints>,
        pub(crate) retry_options: std::option::Option<crate::model::AmazonOpenSearchServerlessRetryOptions>,
    ...
    impl Builder {
        ...
        /// <p>The buffering options. If no value is specified, AmazonopensearchBufferingHints object default values are used.</p>
        pub fn buffering_hints(mut self, input: crate::model::AmazonOpenSearchServerlessBufferingHints) -> Self {
            self.buffering_hints = Some(input);
            self
        }
        /// <p>The buffering options. If no value is specified, AmazonopensearchBufferingHints object default values are used.</p>
        pub fn set_buffering_hints(mut self, input: std::option::Option<crate::model::AmazonOpenSearchServerlessBufferingHints>) -> Self {
            self.buffering_hints = input; self
        }
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to the Serverless offering for Amazon OpenSearch Service. The default value is 300 (5 minutes).</p>
        pub fn retry_options(mut self, input: crate::model::AmazonOpenSearchServerlessRetryOptions) -> Self {
            self.retry_options = Some(input);
            self
        }
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to the Serverless offering for Amazon OpenSearch Service. The default value is 300 (5 minutes).</p>
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::AmazonOpenSearchServerlessRetryOptions>) -> Self {
...
impl std::convert::From<&str> for ProcessorParameterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProcessorParameterName::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for NoEncryptionConfig {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NoEncryptionConfig::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for HttpEndpointS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HttpEndpointS3BackupMode::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub struct HttpEndpointRequestConfiguration  {
    ...
    #[doc(hidden)]
    pub common_attributes: std::option::Option<std::vec::Vec<crate::model::HttpEndpointCommonAttribute>>,
}
...
impl std::convert::From<&str> for SplunkS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SplunkS3BackupMode::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub struct AmazonopensearchserviceDestinationUpdate  {
    ...
    #[doc(hidden)]
    pub index_rotation_period: std::option::Option<crate::model::AmazonopensearchserviceIndexRotationPeriod>,
    /// <p>The buffering options. If no value is specified, AmazonopensearchBufferingHints object default values are used. </p>
    #[doc(hidden)]
...
impl std::convert::From<&str> for AmazonopensearchserviceIndexRotationPeriod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AmazonopensearchserviceIndexRotationPeriod::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for ElasticsearchIndexRotationPeriod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElasticsearchIndexRotationPeriod::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for RedshiftS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RedshiftS3BackupMode::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub struct ExtendedS3DestinationUpdate  {
    ...
    #[doc(hidden)]
    pub data_format_conversion_configuration: std::option::Option<crate::model::DataFormatConversionConfiguration>,
    ...
    #[doc(hidden)]
    pub dynamic_partitioning_configuration: std::option::Option<crate::model::DynamicPartitioningConfiguration>,
}
...
impl std::convert::From<&str> for ParquetWriterVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParquetWriterVersion::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for ParquetCompression {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParquetCompression::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for DeliveryStreamType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeliveryStreamType::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub struct DeliveryStreamDescription  {
    ...
    #[doc(hidden)]
    pub delivery_stream_encryption_configuration: std::option::Option<crate::model::DeliveryStreamEncryptionConfiguration>,
...
pub struct DestinationDescription  {
    ...
    #[doc(hidden)]
    pub extended_s3_destination_description: std::option::Option<crate::model::ExtendedS3DestinationDescription>,
    /// <p>The destination in Amazon Redshift.</p>
    #[doc(hidden)]
    pub redshift_destination_description: std::option::Option<crate::model::RedshiftDestinationDescription>,
    /// <p>The destination in Amazon ES.</p>
    #[doc(hidden)]
    pub elasticsearch_destination_description: std::option::Option<crate::model::ElasticsearchDestinationDescription>,
    /// <p>The destination in Amazon OpenSearch Service.</p>
    #[doc(hidden)]
    pub amazonopensearchservice_destination_description: std::option::Option<crate::model::AmazonopensearchserviceDestinationDescription>,
    /// <p>The destination in Splunk.</p>
    #[doc(hidden)]
    pub splunk_destination_description: std::option::Option<crate::model::SplunkDestinationDescription>,
    /// <p>Describes the specified HTTP endpoint destination.</p>
    #[doc(hidden)]
    pub http_endpoint_destination_description: std::option::Option<crate::model::HttpEndpointDestinationDescription>,
    /// <p>The destination in the Serverless offering for Amazon OpenSearch Service.</p>
    #[doc(hidden)]
    pub amazon_open_search_serverless_destination_description: std::option::Option<crate::model::AmazonOpenSearchServerlessDestinationDescription>,
}
impl DestinationDescription {
    ...
    /// <p>The destination in the Serverless offering for Amazon OpenSearch Service.</p>
    pub fn amazon_open_search_serverless_destination_description(&self) -> std::option::Option<& crate::model::AmazonOpenSearchServerlessDestinationDescription> {
...
pub mod destination_description {
    ...
    pub struct Builder {
        ...
        pub(crate) amazon_open_search_serverless_destination_description: std::option::Option<crate::model::AmazonOpenSearchServerlessDestinationDescription>,
    }
    impl Builder {
        /// <p>The ID of the destination.</p>
        ...
        /// <p>The destination in the Serverless offering for Amazon OpenSearch Service.</p>
        pub fn amazon_open_search_serverless_destination_description(mut self, input: crate::model::AmazonOpenSearchServerlessDestinationDescription) -> Self {
            self.amazon_open_search_serverless_destination_description = Some(input);
            self
        }
        /// <p>The destination in the Serverless offering for Amazon OpenSearch Service.</p>
        pub fn set_amazon_open_search_serverless_destination_description(mut self, input: std::option::Option<crate::model::AmazonOpenSearchServerlessDestinationDescription>) -> Self {
...
impl AmazonOpenSearchServerlessDestinationDescription {
    ...
    /// <p>The Amazon S3 backup mode.</p>
    pub fn s3_backup_mode(&self) -> std::option::Option<& crate::model::AmazonOpenSearchServerlessS3BackupMode> {
        self.s3_backup_mode.as_ref()
    }
    /// <p>Describes a destination in Amazon S3.</p>
    pub fn s3_destination_description(&self) -> std::option::Option<& crate::model::S3DestinationDescription> {
...
pub mod amazon_open_search_serverless_destination_description {
    ...
    pub struct Builder {
        ...
        pub(crate) buffering_hints: std::option::Option<crate::model::AmazonOpenSearchServerlessBufferingHints>,
        pub(crate) retry_options: std::option::Option<crate::model::AmazonOpenSearchServerlessRetryOptions>,
        pub(crate) s3_backup_mode: std::option::Option<crate::model::AmazonOpenSearchServerlessS3BackupMode>,
        pub(crate) s3_destination_description: std::option::Option<crate::model::S3DestinationDescription>,
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
    ...
    impl Builder {
        ...
        /// <p>The Amazon S3 backup mode.</p>
        pub fn s3_backup_mode(mut self, input: crate::model::AmazonOpenSearchServerlessS3BackupMode) -> Self {
            self.s3_backup_mode = Some(input);
            self
        }
        /// <p>The Amazon S3 backup mode.</p>
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::AmazonOpenSearchServerlessS3BackupMode>) -> Self {
            self.s3_backup_mode = input; self
        }
        /// <p>Describes a destination in Amazon S3.</p>
        pub fn s3_destination_description(mut self, input: crate::model::S3DestinationDescription) -> Self {
...
impl std::convert::From<&str> for AmazonOpenSearchServerlessS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AmazonOpenSearchServerlessS3BackupMode::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for AmazonopensearchserviceS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AmazonopensearchserviceS3BackupMode::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for ElasticsearchS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElasticsearchS3BackupMode::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
pub struct SourceDescription  {
    ...
    #[doc(hidden)]
    pub kinesis_stream_source_description: std::option::Option<crate::model::KinesisStreamSourceDescription>,
}
...
impl std::convert::From<&str> for DeliveryStreamFailureType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeliveryStreamFailureType::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for DeliveryStreamEncryptionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeliveryStreamEncryptionStatus::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
...
impl std::convert::From<&str> for DeliveryStreamStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeliveryStreamStatus::Unknown(crate::types::UnknownVariantValue(other.to_owned()))
        }
    }
}
