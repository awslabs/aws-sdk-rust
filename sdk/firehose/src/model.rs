...
pub struct HttpEndpointDestinationUpdate  {
    ...
    #[doc(hidden)]pub endpoint_configuration: std::option::Option<crate::model::HttpEndpointConfiguration>,
    ...
    #[doc(hidden)]pub buffering_hints: std::option::Option<crate::model::HttpEndpointBufferingHints>,
    /// <p>Describes the Amazon CloudWatch logging options for your delivery stream.</p>
    #[doc(hidden)]pub cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
    /// <p>The configuration of the request sent to the HTTP endpoint specified as the destination.</p>
    #[doc(hidden)]pub request_configuration: std::option::Option<crate::model::HttpEndpointRequestConfiguration>,
    /// <p>Describes a data processing configuration.</p>
    #[doc(hidden)]pub processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
    ...
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::HttpEndpointRetryOptions>,
    ...
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::HttpEndpointS3BackupMode>,
    /// <p>Describes an update for a destination in Amazon S3.</p>
    #[doc(hidden)]pub s3_update: std::option::Option<crate::model::S3DestinationUpdate>,
}
impl HttpEndpointDestinationUpdate {
    /// <p>Describes the configuration of the HTTP endpoint destination.</p>
    pub fn endpoint_configuration(&self) -> std::option::Option<& crate::model::HttpEndpointConfiguration> {
        self.endpoint_configuration.as_ref()
    }
    /// <p>Describes buffering options that can be applied to the data before it is delivered to the HTTPS endpoint destination. Kinesis Data Firehose teats these options as hints, and it might choose to use more optimal values. The <code>SizeInMBs</code> and <code>IntervalInSeconds</code> parameters are optional. However, if specify a value for one of them, you must also provide a value for the other. </p>
    pub fn buffering_hints(&self) -> std::option::Option<& crate::model::HttpEndpointBufferingHints> {
        self.buffering_hints.as_ref()
    }
    /// <p>Describes the Amazon CloudWatch logging options for your delivery stream.</p>
    pub fn cloud_watch_logging_options(&self) -> std::option::Option<& crate::model::CloudWatchLoggingOptions> {
        self.cloud_watch_logging_options.as_ref()
    }
    /// <p>The configuration of the request sent to the HTTP endpoint specified as the destination.</p>
    pub fn request_configuration(&self) -> std::option::Option<& crate::model::HttpEndpointRequestConfiguration> {
        self.request_configuration.as_ref()
    }
    /// <p>Describes a data processing configuration.</p>
    pub fn processing_configuration(&self) -> std::option::Option<& crate::model::ProcessingConfiguration> {
...
pub mod http_endpoint_destination_update {
    ...
    pub struct Builder {
        pub(crate) endpoint_configuration: std::option::Option<crate::model::HttpEndpointConfiguration>,
        pub(crate) buffering_hints: std::option::Option<crate::model::HttpEndpointBufferingHints>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
        pub(crate) request_configuration: std::option::Option<crate::model::HttpEndpointRequestConfiguration>,
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
    ...
    impl Builder {
        /// <p>Describes the configuration of the HTTP endpoint destination.</p>
        pub fn endpoint_configuration(mut self, input: crate::model::HttpEndpointConfiguration) -> Self {
            self.endpoint_configuration = Some(input);
            self
        }
        /// <p>Describes the configuration of the HTTP endpoint destination.</p>
        pub fn set_endpoint_configuration(mut self, input: std::option::Option<crate::model::HttpEndpointConfiguration>) -> Self {
        ...
        /// <p>Describes buffering options that can be applied to the data before it is delivered to the HTTPS endpoint destination. Kinesis Data Firehose teats these options as hints, and it might choose to use more optimal values. The <code>SizeInMBs</code> and <code>IntervalInSeconds</code> parameters are optional. However, if specify a value for one of them, you must also provide a value for the other. </p>
        pub fn set_buffering_hints(mut self, input: std::option::Option<crate::model::HttpEndpointBufferingHints>) -> Self {
            self.buffering_hints = input; self
        }
        /// <p>Describes the Amazon CloudWatch logging options for your delivery stream.</p>
        pub fn cloud_watch_logging_options(mut self, input: crate::model::CloudWatchLoggingOptions) -> Self {
            self.cloud_watch_logging_options = Some(input);
            self
        }
        /// <p>Describes the Amazon CloudWatch logging options for your delivery stream.</p>
        pub fn set_cloud_watch_logging_options(mut self, input: std::option::Option<crate::model::CloudWatchLoggingOptions>) -> Self {
            self.cloud_watch_logging_options = input; self
        }
        /// <p>The configuration of the request sent to the HTTP endpoint specified as the destination.</p>
        pub fn request_configuration(mut self, input: crate::model::HttpEndpointRequestConfiguration) -> Self {
            self.request_configuration = Some(input);
            self
        }
        /// <p>The configuration of the request sent to the HTTP endpoint specified as the destination.</p>
        pub fn set_request_configuration(mut self, input: std::option::Option<crate::model::HttpEndpointRequestConfiguration>) -> Self {
            self.request_configuration = input; self
        }
        /// <p>Describes a data processing configuration.</p>
        pub fn processing_configuration(mut self, input: crate::model::ProcessingConfiguration) -> Self {
            self.processing_configuration = Some(input);
            self
        }
        /// <p>Describes a data processing configuration.</p>
        pub fn set_processing_configuration(mut self, input: std::option::Option<crate::model::ProcessingConfiguration>) -> Self {
        ...
        /// <p>Describes the retry behavior in case Kinesis Data Firehose is unable to deliver data to the specified HTTP endpoint destination, or if it doesn't receive a valid acknowledgment of receipt from the specified HTTP endpoint destination.</p>
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::HttpEndpointRetryOptions>) -> Self {
        ...
        /// <p>Describes the S3 bucket backup options for the data that Kinesis Firehose delivers to the HTTP endpoint destination. You can back up all documents (<code>AllData</code>) or only the documents that Kinesis Data Firehose could not deliver to the specified HTTP endpoint destination (<code>FailedDataOnly</code>).</p>
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::HttpEndpointS3BackupMode>) -> Self {
        ...
        /// <p>Describes an update for a destination in Amazon S3.</p>
        pub fn set_s3_update(mut self, input: std::option::Option<crate::model::S3DestinationUpdate>) -> Self {
...
pub struct S3DestinationUpdate  {
    ...
    #[doc(hidden)]pub error_output_prefix: std::option::Option<std::string::String>,
    /// <p>The buffering option. If no value is specified, <code>BufferingHints</code> object default values are used.</p>
    #[doc(hidden)]pub buffering_hints: std::option::Option<crate::model::BufferingHints>,
    ...
    #[doc(hidden)]pub compression_format: std::option::Option<crate::model::CompressionFormat>,
...
pub mod s3_destination_update {
    ...
    impl Builder {
        ...
        /// <p>The buffering option. If no value is specified, <code>BufferingHints</code> object default values are used.</p>
        pub fn set_buffering_hints(mut self, input: std::option::Option<crate::model::BufferingHints>) -> Self {
            self.buffering_hints = input; self
        }
        /// <p>The compression format. If no value is specified, the default is <code>UNCOMPRESSED</code>.</p> 
        /// <p>The compression formats <code>SNAPPY</code> or <code>ZIP</code> cannot be specified for Amazon Redshift destinations because they are not supported by the Amazon Redshift <code>COPY</code> operation that reads from the S3 bucket.</p>
...
pub struct EncryptionConfiguration  {
    ...
    #[doc(hidden)]pub no_encryption_config: std::option::Option<crate::model::NoEncryptionConfig>,
    /// <p>The encryption key.</p>
    #[doc(hidden)]pub kms_encryption_config: std::option::Option<crate::model::KmsEncryptionConfig>,
}
...
pub mod encryption_configuration {
    ...
    impl Builder {
        ...
        /// <p>Specifically override existing encryption information to ensure that no encryption is used.</p>
        pub fn set_no_encryption_config(mut self, input: std::option::Option<crate::model::NoEncryptionConfig>) -> Self {
...
pub struct KmsEncryptionConfig  {
    ...
    #[doc(hidden)]pub awskms_key_arn: std::option::Option<std::string::String>,
}
...
pub struct BufferingHints  {
    ...
    #[doc(hidden)]pub size_in_m_bs: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub interval_in_seconds: std::option::Option<i32>,
}
impl BufferingHints {
    /// <p>Buffer incoming data to the specified size, in MiBs, before delivering it to the destination. The default value is 5. This parameter is optional but if you specify a value for it, you must also specify a value for <code>IntervalInSeconds</code>, and vice versa.</p> 
    /// <p>We recommend setting this parameter to a value greater than the amount of data you typically ingest into the delivery stream in 10 seconds. For example, if you typically ingest data at 1 MiB/sec, the value should be 10 MiB or higher.</p>
...
pub struct HttpEndpointRetryOptions  {
    ...
    #[doc(hidden)]pub duration_in_seconds: std::option::Option<i32>,
}
...
pub struct Processor  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ProcessorType>,
    /// <p>The processor parameters.</p>
    #[doc(hidden)]pub parameters: std::option::Option<std::vec::Vec<crate::model::ProcessorParameter>>,
}
impl Processor {
    /// <p>The type of processor.</p>
...
pub mod processor {
    ...
    impl Builder {
        ...
        /// <p>The processor parameters.</p>
        pub fn set_parameters(mut self, input: std::option::Option<std::vec::Vec<crate::model::ProcessorParameter>>) -> Self {
...
pub struct ProcessorParameter  {
    ...
    #[doc(hidden)]pub parameter_name: std::option::Option<crate::model::ProcessorParameterName>,
...
pub mod processor_parameter {
    ...
    impl Builder {
        ...
        /// <p>The name of the parameter.</p>
        pub fn set_parameter_name(mut self, input: std::option::Option<crate::model::ProcessorParameterName>) -> Self {
...
pub struct HttpEndpointRequestConfiguration  {
    ...
    #[doc(hidden)]pub content_encoding: std::option::Option<crate::model::ContentEncoding>,
    /// <p>Describes the metadata sent to the HTTP endpoint destination.</p>
    #[doc(hidden)]pub common_attributes: std::option::Option<std::vec::Vec<crate::model::HttpEndpointCommonAttribute>>,
}
impl HttpEndpointRequestConfiguration {
    ...
    /// <p>Describes the metadata sent to the HTTP endpoint destination.</p>
    pub fn common_attributes(&self) -> std::option::Option<& [crate::model::HttpEndpointCommonAttribute]> {
...
pub mod http_endpoint_request_configuration {
    ...
    pub struct Builder {
        ...
        pub(crate) common_attributes: std::option::Option<std::vec::Vec<crate::model::HttpEndpointCommonAttribute>>,
    }
    impl Builder {
        /// <p>Kinesis Data Firehose uses the content encoding to compress the body of a request before sending the request to the destination. For more information, see <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Encoding">Content-Encoding</a> in MDN Web Docs, the official Mozilla documentation.</p>
        ...
        /// <p>Kinesis Data Firehose uses the content encoding to compress the body of a request before sending the request to the destination. For more information, see <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Encoding">Content-Encoding</a> in MDN Web Docs, the official Mozilla documentation.</p>
        pub fn set_content_encoding(mut self, input: std::option::Option<crate::model::ContentEncoding>) -> Self {
        ...
        ///
        /// <p>Describes the metadata sent to the HTTP endpoint destination.</p>
        pub fn common_attributes(mut self, input: crate::model::HttpEndpointCommonAttribute) -> Self {
        ...
        /// <p>Describes the metadata sent to the HTTP endpoint destination.</p>
        pub fn set_common_attributes(mut self, input: std::option::Option<std::vec::Vec<crate::model::HttpEndpointCommonAttribute>>) -> Self {
...
pub struct SplunkDestinationUpdate  {
    ...
    #[doc(hidden)]pub hec_endpoint: std::option::Option<std::string::String>,
    /// <p>This type can be either "Raw" or "Event."</p>
    #[doc(hidden)]pub hec_endpoint_type: std::option::Option<crate::model::HecEndpointType>,
    /// <p>A GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.</p>
    #[doc(hidden)]pub hec_token: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub hec_acknowledgment_timeout_in_seconds: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::SplunkRetryOptions>,
    ...
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::SplunkS3BackupMode>,
...
impl  std::fmt::Debug for SplunkDestinationUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("hec_acknowledgment_timeout_in_seconds", &self.hec_acknowledgment_timeout_in_seconds);
        formatter.field("retry_options", &self.retry_options);
        formatter.field("s3_backup_mode", &self.s3_backup_mode);
        formatter.field("s3_update", &self.s3_update);
        formatter.field("processing_configuration", &self.processing_configuration);
...
pub mod splunk_destination_update {
    ...
    impl Builder {
        ...
        /// <p>This type can be either "Raw" or "Event."</p>
        pub fn set_hec_endpoint_type(mut self, input: std::option::Option<crate::model::HecEndpointType>) -> Self {
        ...
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver data to Splunk or if it doesn't receive an acknowledgment of receipt from Splunk.</p>
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::SplunkRetryOptions>) -> Self {
            self.retry_options = input; self
        }
        /// <p>Specifies how you want Kinesis Data Firehose to back up documents to Amazon S3. When set to <code>FailedDocumentsOnly</code>, Kinesis Data Firehose writes any data that could not be indexed to the configured Amazon S3 destination. When set to <code>AllEvents</code>, Kinesis Data Firehose delivers all incoming records to Amazon S3, and also writes failed documents to Amazon S3. The default value is <code>FailedEventsOnly</code>.</p> 
        /// <p>You can update this backup mode from <code>FailedEventsOnly</code> to <code>AllEvents</code>. You can't update it from <code>AllEvents</code> to <code>FailedEventsOnly</code>.</p>
        ...
        /// <p>Specifies how you want Kinesis Data Firehose to back up documents to Amazon S3. When set to <code>FailedDocumentsOnly</code>, Kinesis Data Firehose writes any data that could not be indexed to the configured Amazon S3 destination. When set to <code>AllEvents</code>, Kinesis Data Firehose delivers all incoming records to Amazon S3, and also writes failed documents to Amazon S3. The default value is <code>FailedEventsOnly</code>.</p> 
        /// <p>You can update this backup mode from <code>FailedEventsOnly</code> to <code>AllEvents</code>. You can't update it from <code>AllEvents</code> to <code>FailedEventsOnly</code>.</p>
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::SplunkS3BackupMode>) -> Self {
            self.s3_backup_mode = input; self
        }
        /// <p>Your update to the configuration of the backup Amazon S3 location.</p>
        pub fn s3_update(mut self, input: crate::model::S3DestinationUpdate) -> Self {
...
pub struct AmazonopensearchserviceDestinationUpdate  {
    ...
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub cluster_endpoint: std::option::Option<std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    ...
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub index_rotation_period: std::option::Option<crate::model::AmazonopensearchserviceIndexRotationPeriod>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub buffering_hints: std::option::Option<crate::model::AmazonopensearchserviceBufferingHints>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::AmazonopensearchserviceRetryOptions>,
    /// <p>Describes an update for a destination in Amazon S3.</p>
    #[doc(hidden)]pub s3_update: std::option::Option<crate::model::S3DestinationUpdate>,
    /// <p>Describes a data processing configuration.</p>
    #[doc(hidden)]pub processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
...
impl AmazonopensearchserviceDestinationUpdate {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn index_rotation_period(&self) -> std::option::Option<& crate::model::AmazonopensearchserviceIndexRotationPeriod> {
        self.index_rotation_period.as_ref()
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn buffering_hints(&self) -> std::option::Option<& crate::model::AmazonopensearchserviceBufferingHints> {
        self.buffering_hints.as_ref()
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn retry_options(&self) -> std::option::Option<& crate::model::AmazonopensearchserviceRetryOptions> {
        self.retry_options.as_ref()
    }
    /// <p>Describes an update for a destination in Amazon S3.</p>
    pub fn s3_update(&self) -> std::option::Option<& crate::model::S3DestinationUpdate> {
...
pub mod amazonopensearchservice_destination_update {
    ...
    pub struct Builder {
        ...
        pub(crate) index_rotation_period: std::option::Option<crate::model::AmazonopensearchserviceIndexRotationPeriod>,
        pub(crate) buffering_hints: std::option::Option<crate::model::AmazonopensearchserviceBufferingHints>,
        pub(crate) retry_options: std::option::Option<crate::model::AmazonopensearchserviceRetryOptions>,
        pub(crate) s3_update: std::option::Option<crate::model::S3DestinationUpdate>,
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
    }
    impl Builder {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn index_rotation_period(mut self, input: crate::model::AmazonopensearchserviceIndexRotationPeriod) -> Self {
            self.index_rotation_period = Some(input);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn set_index_rotation_period(mut self, input: std::option::Option<crate::model::AmazonopensearchserviceIndexRotationPeriod>) -> Self {
            self.index_rotation_period = input; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn buffering_hints(mut self, input: crate::model::AmazonopensearchserviceBufferingHints) -> Self {
            self.buffering_hints = Some(input);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn set_buffering_hints(mut self, input: std::option::Option<crate::model::AmazonopensearchserviceBufferingHints>) -> Self {
            self.buffering_hints = input; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn retry_options(mut self, input: crate::model::AmazonopensearchserviceRetryOptions) -> Self {
            self.retry_options = Some(input);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::AmazonopensearchserviceRetryOptions>) -> Self {
            self.retry_options = input; self
        }
        /// <p>Describes an update for a destination in Amazon S3.</p>
        pub fn s3_update(mut self, input: crate::model::S3DestinationUpdate) -> Self {
...
pub struct ElasticsearchDestinationUpdate  {
    ...
    #[doc(hidden)]pub index_rotation_period: std::option::Option<crate::model::ElasticsearchIndexRotationPeriod>,
    /// <p>The buffering options. If no value is specified, <code>ElasticsearchBufferingHints</code> object default values are used. </p>
    #[doc(hidden)]pub buffering_hints: std::option::Option<crate::model::ElasticsearchBufferingHints>,
    ...
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::ElasticsearchRetryOptions>,
...
impl ElasticsearchDestinationUpdate {
    ...
    /// <p>The Elasticsearch index rotation period. Index rotation appends a timestamp to <code>IndexName</code> to facilitate the expiration of old data. For more information, see <a href="https://docs.aws.amazon.com/firehose/latest/dev/basic-deliver.html#es-index-rotation">Index Rotation for the Amazon ES Destination</a>. Default value is&nbsp;<code>OneDay</code>.</p>
    pub fn index_rotation_period(&self) -> std::option::Option<& crate::model::ElasticsearchIndexRotationPeriod> {
        self.index_rotation_period.as_ref()
    }
    /// <p>The buffering options. If no value is specified, <code>ElasticsearchBufferingHints</code> object default values are used. </p>
    pub fn buffering_hints(&self) -> std::option::Option<& crate::model::ElasticsearchBufferingHints> {
        self.buffering_hints.as_ref()
    }
    /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to Amazon ES. The default value is 300 (5 minutes).</p>
...
pub mod elasticsearch_destination_update {
    ...
    pub struct Builder {
        ...
        pub(crate) index_name: std::option::Option<std::string::String>,
        pub(crate) type_name: std::option::Option<std::string::String>,
        pub(crate) index_rotation_period: std::option::Option<crate::model::ElasticsearchIndexRotationPeriod>,
    ...
    impl Builder {
        ...
        /// <p>The Elasticsearch index rotation period. Index rotation appends a timestamp to <code>IndexName</code> to facilitate the expiration of old data. For more information, see <a href="https://docs.aws.amazon.com/firehose/latest/dev/basic-deliver.html#es-index-rotation">Index Rotation for the Amazon ES Destination</a>. Default value is&nbsp;<code>OneDay</code>.</p>
        pub fn index_rotation_period(mut self, input: crate::model::ElasticsearchIndexRotationPeriod) -> Self {
            self.index_rotation_period = Some(input);
            self
        }
        /// <p>The Elasticsearch index rotation period. Index rotation appends a timestamp to <code>IndexName</code> to facilitate the expiration of old data. For more information, see <a href="https://docs.aws.amazon.com/firehose/latest/dev/basic-deliver.html#es-index-rotation">Index Rotation for the Amazon ES Destination</a>. Default value is&nbsp;<code>OneDay</code>.</p>
        pub fn set_index_rotation_period(mut self, input: std::option::Option<crate::model::ElasticsearchIndexRotationPeriod>) -> Self {
            self.index_rotation_period = input; self
        }
        /// <p>The buffering options. If no value is specified, <code>ElasticsearchBufferingHints</code> object default values are used. </p>
        ...
        /// <p>The buffering options. If no value is specified, <code>ElasticsearchBufferingHints</code> object default values are used. </p>
        pub fn set_buffering_hints(mut self, input: std::option::Option<crate::model::ElasticsearchBufferingHints>) -> Self {
            self.buffering_hints = input; self
        }
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to Amazon ES. The default value is 300 (5 minutes).</p>
        ...
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to Amazon ES. The default value is 300 (5 minutes).</p>
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::ElasticsearchRetryOptions>) -> Self {
            self.retry_options = input; self
        }
        /// <p>The Amazon S3 destination.</p>
        pub fn s3_update(mut self, input: crate::model::S3DestinationUpdate) -> Self {
...
pub struct RedshiftDestinationUpdate  {
    ...
    #[doc(hidden)]pub cluster_jdbcurl: std::option::Option<std::string::String>,
    /// <p>The <code>COPY</code> command.</p>
    #[doc(hidden)]pub copy_command: std::option::Option<crate::model::CopyCommand>,
    ...
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::RedshiftRetryOptions>,
    /// <p>The Amazon S3 destination.</p> 
    ...
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::RedshiftS3BackupMode>,
    /// <p>The Amazon S3 destination for backup.</p>
    #[doc(hidden)]pub s3_backup_update: std::option::Option<crate::model::S3DestinationUpdate>,
    /// <p>The Amazon CloudWatch logging options for your delivery stream.</p>
    #[doc(hidden)]pub cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
}
...
pub mod redshift_destination_update {
    ...
    impl Builder {
        ...
        /// <p>The <code>COPY</code> command.</p>
        pub fn set_copy_command(mut self, input: std::option::Option<crate::model::CopyCommand>) -> Self {
        ...
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver documents to Amazon Redshift. Default value is 3600 (60 minutes).</p>
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::RedshiftRetryOptions>) -> Self {
            self.retry_options = input; self
        }
        /// <p>The Amazon S3 destination.</p> 
        /// <p>The compression formats <code>SNAPPY</code> or <code>ZIP</code> cannot be specified in <code>RedshiftDestinationUpdate.S3Update</code> because the Amazon Redshift <code>COPY</code> operation that reads from the S3 bucket doesn't support these compression formats.</p>
        ...
        /// <p>You can update a delivery stream to enable Amazon S3 backup if it is disabled. If backup is enabled, you can't update the delivery stream to disable it. </p>
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::RedshiftS3BackupMode>) -> Self {
            self.s3_backup_mode = input; self
        }
        /// <p>The Amazon S3 destination for backup.</p>
        ...
        /// <p>The Amazon S3 destination for backup.</p>
        pub fn set_s3_backup_update(mut self, input: std::option::Option<crate::model::S3DestinationUpdate>) -> Self {
...
pub struct CopyCommand  {
    ...
    #[doc(hidden)]pub data_table_name: std::option::Option<std::string::String>,
    /// <p>A comma-separated list of column names.</p>
    #[doc(hidden)]pub data_table_columns: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub copy_options: std::option::Option<std::string::String>,
}
impl CopyCommand {
    /// <p>The name of the target table. The table must already exist in the database.</p>
...
pub struct ExtendedS3DestinationUpdate  {
    ...
    #[doc(hidden)]pub processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
    /// <p>You can update a delivery stream to enable Amazon S3 backup if it is disabled. If backup is enabled, you can't update the delivery stream to disable it. </p>
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::S3BackupMode>,
    /// <p>The Amazon S3 destination for backup.</p>
    #[doc(hidden)]pub s3_backup_update: std::option::Option<crate::model::S3DestinationUpdate>,
    ...
    #[doc(hidden)]pub data_format_conversion_configuration: std::option::Option<crate::model::DataFormatConversionConfiguration>,
    ...
    #[doc(hidden)]pub dynamic_partitioning_configuration: std::option::Option<crate::model::DynamicPartitioningConfiguration>,
}
impl ExtendedS3DestinationUpdate {
    ...
    /// <p>The serializer, deserializer, and schema for converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.</p>
    pub fn data_format_conversion_configuration(&self) -> std::option::Option<& crate::model::DataFormatConversionConfiguration> {
        self.data_format_conversion_configuration.as_ref()
    }
    /// <p>The configuration of the dynamic partitioning mechanism that creates smaller data sets from the streaming data by partitioning it based on partition keys. Currently, dynamic partitioning is only supported for Amazon S3 destinations. For more information, see <a href="https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html">https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html</a> </p>
    pub fn dynamic_partitioning_configuration(&self) -> std::option::Option<& crate::model::DynamicPartitioningConfiguration> {
...
impl  std::fmt::Debug for ExtendedS3DestinationUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("s3_backup_mode", &self.s3_backup_mode);
        formatter.field("s3_backup_update", &self.s3_backup_update);
        formatter.field("data_format_conversion_configuration", &self.data_format_conversion_configuration);
        formatter.field("dynamic_partitioning_configuration", &self.dynamic_partitioning_configuration);
        formatter.finish()
    }
}
...
pub mod extended_s3_destination_update {
    ...
    pub struct Builder {
        ...
        pub(crate) s3_backup_update: std::option::Option<crate::model::S3DestinationUpdate>,
        pub(crate) data_format_conversion_configuration: std::option::Option<crate::model::DataFormatConversionConfiguration>,
        pub(crate) dynamic_partitioning_configuration: std::option::Option<crate::model::DynamicPartitioningConfiguration>,
    }
    impl Builder {
        /// <p>The Amazon Resource Name (ARN) of the AWS credentials. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and AWS Service Namespaces</a>.</p>
        pub fn role_arn(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>You can update a delivery stream to enable Amazon S3 backup if it is disabled. If backup is enabled, you can't update the delivery stream to disable it. </p>
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::S3BackupMode>) -> Self {
            self.s3_backup_mode = input; self
        }
        /// <p>The Amazon S3 destination for backup.</p>
        pub fn s3_backup_update(mut self, input: crate::model::S3DestinationUpdate) -> Self {
        ...
        /// <p>The serializer, deserializer, and schema for converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.</p>
        pub fn data_format_conversion_configuration(mut self, input: crate::model::DataFormatConversionConfiguration) -> Self {
            self.data_format_conversion_configuration = Some(input);
            self
        }
        /// <p>The serializer, deserializer, and schema for converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.</p>
        pub fn set_data_format_conversion_configuration(mut self, input: std::option::Option<crate::model::DataFormatConversionConfiguration>) -> Self {
            self.data_format_conversion_configuration = input; self
        }
        /// <p>The configuration of the dynamic partitioning mechanism that creates smaller data sets from the streaming data by partitioning it based on partition keys. Currently, dynamic partitioning is only supported for Amazon S3 destinations. For more information, see <a href="https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html">https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html</a> </p>
        pub fn dynamic_partitioning_configuration(mut self, input: crate::model::DynamicPartitioningConfiguration) -> Self {
            self.dynamic_partitioning_configuration = Some(input);
            self
        }
        /// <p>The configuration of the dynamic partitioning mechanism that creates smaller data sets from the streaming data by partitioning it based on partition keys. Currently, dynamic partitioning is only supported for Amazon S3 destinations. For more information, see <a href="https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html">https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html</a> </p>
        pub fn set_dynamic_partitioning_configuration(mut self, input: std::option::Option<crate::model::DynamicPartitioningConfiguration>) -> Self {
...
pub struct DynamicPartitioningConfiguration  {
    ...
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::RetryOptions>,
...
pub mod dynamic_partitioning_configuration {
    ...
    impl Builder {
        ...
        /// <p>The retry behavior in case Kinesis Data Firehose is unable to deliver data to an Amazon S3 prefix.</p>
        pub fn set_retry_options(mut self, input: std::option::Option<crate::model::RetryOptions>) -> Self {
            self.retry_options = input; self
        }
        /// <p>Specifies that the dynamic partitioning is enabled for this Kinesis Data Firehose delivery stream.</p>
        pub fn enabled(mut self, input: bool) -> Self {
...
pub struct DataFormatConversionConfiguration  {
    ...
    #[doc(hidden)]pub schema_configuration: std::option::Option<crate::model::SchemaConfiguration>,
    ...
    #[doc(hidden)]pub input_format_configuration: std::option::Option<crate::model::InputFormatConfiguration>,
    ...
    #[doc(hidden)]pub output_format_configuration: std::option::Option<crate::model::OutputFormatConfiguration>,
...
impl DataFormatConversionConfiguration {
    ...
    /// <p>Specifies the deserializer that you want Kinesis Data Firehose to use to convert the format of your data from JSON. This parameter is required if <code>Enabled</code> is set to true.</p>
    pub fn input_format_configuration(&self) -> std::option::Option<& crate::model::InputFormatConfiguration> {
        self.input_format_configuration.as_ref()
    }
    /// <p>Specifies the serializer that you want Kinesis Data Firehose to use to convert the format of your data to the Parquet or ORC format. This parameter is required if <code>Enabled</code> is set to true.</p>
    pub fn output_format_configuration(&self) -> std::option::Option<& crate::model::OutputFormatConfiguration> {
...
impl  std::fmt::Debug for DataFormatConversionConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("input_format_configuration", &self.input_format_configuration);
        formatter.field("output_format_configuration", &self.output_format_configuration);
        formatter.field("enabled", &self.enabled);
        formatter.finish()
    }
}
...
pub mod data_format_conversion_configuration {
    ...
    pub struct Builder {
        ...
        pub(crate) input_format_configuration: std::option::Option<crate::model::InputFormatConfiguration>,
        pub(crate) output_format_configuration: std::option::Option<crate::model::OutputFormatConfiguration>,
        pub(crate) enabled: std::option::Option<bool>,
    }
    impl Builder {
        /// <p>Specifies the AWS Glue Data Catalog table that contains the column information. This parameter is required if <code>Enabled</code> is set to true.</p>
        ...
        /// <p>Specifies the AWS Glue Data Catalog table that contains the column information. This parameter is required if <code>Enabled</code> is set to true.</p>
        pub fn set_schema_configuration(mut self, input: std::option::Option<crate::model::SchemaConfiguration>) -> Self {
            self.schema_configuration = input; self
        }
        /// <p>Specifies the deserializer that you want Kinesis Data Firehose to use to convert the format of your data from JSON. This parameter is required if <code>Enabled</code> is set to true.</p>
        pub fn input_format_configuration(mut self, input: crate::model::InputFormatConfiguration) -> Self {
            self.input_format_configuration = Some(input);
            self
        }
        /// <p>Specifies the deserializer that you want Kinesis Data Firehose to use to convert the format of your data from JSON. This parameter is required if <code>Enabled</code> is set to true.</p>
        pub fn set_input_format_configuration(mut self, input: std::option::Option<crate::model::InputFormatConfiguration>) -> Self {
            self.input_format_configuration = input; self
        }
        /// <p>Specifies the serializer that you want Kinesis Data Firehose to use to convert the format of your data to the Parquet or ORC format. This parameter is required if <code>Enabled</code> is set to true.</p>
        pub fn output_format_configuration(mut self, input: crate::model::OutputFormatConfiguration) -> Self {
            self.output_format_configuration = Some(input);
            self
        }
        /// <p>Specifies the serializer that you want Kinesis Data Firehose to use to convert the format of your data to the Parquet or ORC format. This parameter is required if <code>Enabled</code> is set to true.</p>
        pub fn set_output_format_configuration(mut self, input: std::option::Option<crate::model::OutputFormatConfiguration>) -> Self {
...
pub struct OutputFormatConfiguration  {
    ...
    #[doc(hidden)]pub serializer: std::option::Option<crate::model::Serializer>,
}
...
pub mod output_format_configuration {
    ...
    impl Builder {
        ...
        /// <p>Specifies which serializer to use. You can choose either the ORC SerDe or the Parquet SerDe. If both are non-null, the server rejects the request.</p>
        pub fn set_serializer(mut self, input: std::option::Option<crate::model::Serializer>) -> Self {
...
pub struct Serializer  {
    ...
    #[doc(hidden)]pub parquet_ser_de: std::option::Option<crate::model::ParquetSerDe>,
    ...
    #[doc(hidden)]pub orc_ser_de: std::option::Option<crate::model::OrcSerDe>,
}
impl Serializer {
    /// <p>A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see <a href="https://parquet.apache.org/documentation/latest/">Apache Parquet</a>.</p>
...
pub mod serializer {
    ...
    impl Builder {
        ...
        /// <p>A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see <a href="https://parquet.apache.org/documentation/latest/">Apache Parquet</a>.</p>
        pub fn set_parquet_ser_de(mut self, input: std::option::Option<crate::model::ParquetSerDe>) -> Self {
        ...
        /// <p>A serializer to use for converting data to the ORC format before storing it in Amazon S3. For more information, see <a href="https://orc.apache.org/docs/">Apache ORC</a>.</p>
        pub fn set_orc_ser_de(mut self, input: std::option::Option<crate::model::OrcSerDe>) -> Self {
...
pub struct OrcSerDe  {
    ...
    #[doc(hidden)]pub stripe_size_bytes: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub block_size_bytes: std::option::Option<i32>,
    /// <p>The number of rows between index entries. The default is 10,000 and the minimum is 1,000.</p>
    #[doc(hidden)]pub row_index_stride: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub enable_padding: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub padding_tolerance: std::option::Option<f64>,
    /// <p>The compression code to use over data blocks. The default is <code>SNAPPY</code>.</p>
    #[doc(hidden)]pub compression: std::option::Option<crate::model::OrcCompression>,
    /// <p>The column names for which you want Kinesis Data Firehose to create bloom filters. The default is <code>null</code>.</p>
    #[doc(hidden)]pub bloom_filter_columns: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub bloom_filter_false_positive_probability: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub dictionary_key_threshold: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub format_version: std::option::Option<crate::model::OrcFormatVersion>,
}
impl OrcSerDe {
    /// <p>The number of bytes in each stripe. The default is 64 MiB and the minimum is 8 MiB.</p>
...
impl  std::fmt::Debug for OrcSerDe  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("bloom_filter_false_positive_probability", &self.bloom_filter_false_positive_probability);
...
pub mod orc_ser_de {
    ...
    impl Builder {
        ...
        /// <p>The compression code to use over data blocks. The default is <code>SNAPPY</code>.</p>
        pub fn set_compression(mut self, input: std::option::Option<crate::model::OrcCompression>) -> Self {
        ...
        /// <p>The version of the file to write. The possible values are <code>V0_11</code> and <code>V0_12</code>. The default is <code>V0_12</code>.</p>
        pub fn set_format_version(mut self, input: std::option::Option<crate::model::OrcFormatVersion>) -> Self {
...
pub struct ParquetSerDe  {
    ...
    #[doc(hidden)]pub page_size_bytes: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub compression: std::option::Option<crate::model::ParquetCompression>,
    /// <p>Indicates whether to enable dictionary compression.</p>
    #[doc(hidden)]pub enable_dictionary_compression: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub max_padding_bytes: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub writer_version: std::option::Option<crate::model::ParquetWriterVersion>,
}
impl ParquetSerDe {
    /// <p>The Hadoop Distributed File System (HDFS) block size. This is useful if you intend to copy the data from Amazon S3 to HDFS before querying. The default is 256 MiB and the minimum is 64 MiB. Kinesis Data Firehose uses this value for padding calculations.</p>
    pub fn block_size_bytes(&self) -> std::option::Option<i32> {
...
impl  std::fmt::Debug for ParquetSerDe  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("compression", &self.compression);
        formatter.field("enable_dictionary_compression", &self.enable_dictionary_compression);
...
pub mod parquet_ser_de {
    ...
    impl Builder {
        ...
        /// <p>The compression code to use over data blocks. The possible values are <code>UNCOMPRESSED</code>, <code>SNAPPY</code>, and <code>GZIP</code>, with the default being <code>SNAPPY</code>. Use <code>SNAPPY</code> for higher decompression speed. Use <code>GZIP</code> if the compression ratio is more important than speed.</p>
        pub fn set_compression(mut self, input: std::option::Option<crate::model::ParquetCompression>) -> Self {
            self.compression = input; self
        }
        /// <p>Indicates whether to enable dictionary compression.</p>
        ...
        /// <p>Indicates the version of row format to output. The possible values are <code>V1</code> and <code>V2</code>. The default is <code>V1</code>.</p>
        pub fn set_writer_version(mut self, input: std::option::Option<crate::model::ParquetWriterVersion>) -> Self {
...
pub struct InputFormatConfiguration  {
    ...
    #[doc(hidden)]pub deserializer: std::option::Option<crate::model::Deserializer>,
}
...
pub mod input_format_configuration {
    ...
    impl Builder {
        ...
        /// <p>Specifies which deserializer to use. You can choose either the Apache Hive JSON SerDe or the OpenX JSON SerDe. If both are non-null, the server rejects the request.</p>
        pub fn set_deserializer(mut self, input: std::option::Option<crate::model::Deserializer>) -> Self {
...
pub struct Deserializer  {
    ...
    #[doc(hidden)]pub open_x_json_ser_de: std::option::Option<crate::model::OpenXJsonSerDe>,
    ...
    #[doc(hidden)]pub hive_json_ser_de: std::option::Option<crate::model::HiveJsonSerDe>,
}
impl Deserializer {
    /// <p>The OpenX SerDe. Used by Kinesis Data Firehose for deserializing data, which means converting it from the JSON format in preparation for serializing it to the Parquet or ORC format. This is one of two deserializers you can choose, depending on which one offers the functionality you need. The other option is the native Hive / HCatalog JsonSerDe.</p>
...
pub mod deserializer {
    ...
    impl Builder {
        ...
        /// <p>The OpenX SerDe. Used by Kinesis Data Firehose for deserializing data, which means converting it from the JSON format in preparation for serializing it to the Parquet or ORC format. This is one of two deserializers you can choose, depending on which one offers the functionality you need. The other option is the native Hive / HCatalog JsonSerDe.</p>
        pub fn set_open_x_json_ser_de(mut self, input: std::option::Option<crate::model::OpenXJsonSerDe>) -> Self {
        ...
        /// <p>The native Hive / HCatalog JsonSerDe. Used by Kinesis Data Firehose for deserializing data, which means converting it from the JSON format in preparation for serializing it to the Parquet or ORC format. This is one of two deserializers you can choose, depending on which one offers the functionality you need. The other option is the OpenX SerDe.</p>
        pub fn set_hive_json_ser_de(mut self, input: std::option::Option<crate::model::HiveJsonSerDe>) -> Self {
...
pub struct HiveJsonSerDe  {
    ...
    #[doc(hidden)]pub timestamp_formats: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl HiveJsonSerDe {
    /// <p>Indicates how you want Kinesis Data Firehose to parse the date and timestamps that may be present in your input data JSON. To specify these format strings, follow the pattern syntax of JodaTime's DateTimeFormat format strings. For more information, see <a href="https://www.joda.org/joda-time/apidocs/org/joda/time/format/DateTimeFormat.html">Class DateTimeFormat</a>. You can also use the special value <code>millis</code> to parse timestamps in epoch milliseconds. If you don't specify a format, Kinesis Data Firehose uses <code>java.sql.Timestamp::valueOf</code> by default.</p>
...
pub struct OpenXJsonSerDe  {
    ...
    #[doc(hidden)]pub convert_dots_in_json_keys_to_underscores: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub case_insensitive: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub column_to_json_key_mappings: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl OpenXJsonSerDe {
    /// <p>When set to <code>true</code>, specifies that the names of the keys include dots and that you want Kinesis Data Firehose to replace them with underscores. This is useful because Apache Hive does not allow dots in column names. For example, if the JSON contains a key whose name is "a.b", you can define the column name to be "a_b" when using this option.</p> 
    /// <p>The default is <code>false</code>.</p>
...
impl  std::fmt::Debug for OpenXJsonSerDe  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("convert_dots_in_json_keys_to_underscores", &self.convert_dots_in_json_keys_to_underscores);
        formatter.field("case_insensitive", &self.case_insensitive);
        formatter.field("column_to_json_key_mappings", &self.column_to_json_key_mappings);
        formatter.finish()
    }
}
...
pub struct DeliveryStreamDescription  {
    ...
    #[doc(hidden)]pub delivery_stream_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub delivery_stream_status: std::option::Option<crate::model::DeliveryStreamStatus>,
    ...
    #[doc(hidden)]pub failure_description: std::option::Option<crate::model::FailureDescription>,
    /// <p>Indicates the server-side encryption (SSE) status for the delivery stream.</p>
    #[doc(hidden)]pub delivery_stream_encryption_configuration: std::option::Option<crate::model::DeliveryStreamEncryptionConfiguration>,
    ...
    /// </ul>
    #[doc(hidden)]pub delivery_stream_type: std::option::Option<crate::model::DeliveryStreamType>,
    ...
    #[doc(hidden)]pub source: std::option::Option<crate::model::SourceDescription>,
    /// <p>The destinations.</p>
    #[doc(hidden)]pub destinations: std::option::Option<std::vec::Vec<crate::model::DestinationDescription>>,
    /// <p>Indicates whether there are more destinations available to list.</p>
    #[doc(hidden)]pub has_more_destinations: std::option::Option<bool>,
}
impl DeliveryStreamDescription {
    ...
    /// <p>The status of the delivery stream. If the status of a delivery stream is <code>CREATING_FAILED</code>, this status doesn't change, and you can't invoke <code>CreateDeliveryStream</code> again on it. However, you can invoke the <code>DeleteDeliveryStream</code> operation to delete it.</p>
    pub fn delivery_stream_status(&self) -> std::option::Option<& crate::model::DeliveryStreamStatus> {
    ...
    /// <p>Indicates the server-side encryption (SSE) status for the delivery stream.</p>
    pub fn delivery_stream_encryption_configuration(&self) -> std::option::Option<& crate::model::DeliveryStreamEncryptionConfiguration> {
...
impl  std::fmt::Debug for DeliveryStreamDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("delivery_stream_encryption_configuration", &self.delivery_stream_encryption_configuration);
...
pub mod delivery_stream_description {
    ...
    pub struct Builder {
        ...
        pub(crate) delivery_stream_encryption_configuration: std::option::Option<crate::model::DeliveryStreamEncryptionConfiguration>,
        ...
        pub(crate) destinations: std::option::Option<std::vec::Vec<crate::model::DestinationDescription>>,
    ...
    impl Builder {
        ...
        /// <p>The status of the delivery stream. If the status of a delivery stream is <code>CREATING_FAILED</code>, this status doesn't change, and you can't invoke <code>CreateDeliveryStream</code> again on it. However, you can invoke the <code>DeleteDeliveryStream</code> operation to delete it.</p>
        pub fn set_delivery_stream_status(mut self, input: std::option::Option<crate::model::DeliveryStreamStatus>) -> Self {
        ...
        /// <p>Provides details in case one of the following operations fails due to an error related to KMS: <code>CreateDeliveryStream</code>, <code>DeleteDeliveryStream</code>, <code>StartDeliveryStreamEncryption</code>, <code>StopDeliveryStreamEncryption</code>.</p>
        pub fn set_failure_description(mut self, input: std::option::Option<crate::model::FailureDescription>) -> Self {
            self.failure_description = input; self
        }
        /// <p>Indicates the server-side encryption (SSE) status for the delivery stream.</p>
        pub fn delivery_stream_encryption_configuration(mut self, input: crate::model::DeliveryStreamEncryptionConfiguration) -> Self {
            self.delivery_stream_encryption_configuration = Some(input);
            self
        }
        /// <p>Indicates the server-side encryption (SSE) status for the delivery stream.</p>
        pub fn set_delivery_stream_encryption_configuration(mut self, input: std::option::Option<crate::model::DeliveryStreamEncryptionConfiguration>) -> Self {
        ...
        /// <p>If the <code>DeliveryStreamType</code> parameter is <code>KinesisStreamAsSource</code>, a <code>SourceDescription</code> object describing the source Kinesis data stream.</p>
        pub fn set_source(mut self, input: std::option::Option<crate::model::SourceDescription>) -> Self {
        ...
        /// <p>The destinations.</p>
        pub fn set_destinations(mut self, input: std::option::Option<std::vec::Vec<crate::model::DestinationDescription>>) -> Self {
...
pub struct DestinationDescription  {
    ...
    #[doc(hidden)]pub s3_destination_description: std::option::Option<crate::model::S3DestinationDescription>,
    /// <p>The destination in Amazon S3.</p>
    #[doc(hidden)]pub extended_s3_destination_description: std::option::Option<crate::model::ExtendedS3DestinationDescription>,
    /// <p>The destination in Amazon Redshift.</p>
    #[doc(hidden)]pub redshift_destination_description: std::option::Option<crate::model::RedshiftDestinationDescription>,
    /// <p>The destination in Amazon ES.</p>
    #[doc(hidden)]pub elasticsearch_destination_description: std::option::Option<crate::model::ElasticsearchDestinationDescription>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub amazonopensearchservice_destination_description: std::option::Option<crate::model::AmazonopensearchserviceDestinationDescription>,
    /// <p>The destination in Splunk.</p>
    #[doc(hidden)]pub splunk_destination_description: std::option::Option<crate::model::SplunkDestinationDescription>,
    /// <p>Describes the specified HTTP endpoint destination.</p>
    #[doc(hidden)]pub http_endpoint_destination_description: std::option::Option<crate::model::HttpEndpointDestinationDescription>,
}
impl DestinationDescription {
    ...
    /// <p>[Deprecated] The destination in Amazon S3.</p>
    pub fn s3_destination_description(&self) -> std::option::Option<& crate::model::S3DestinationDescription> {
        self.s3_destination_description.as_ref()
    }
    /// <p>The destination in Amazon S3.</p>
    pub fn extended_s3_destination_description(&self) -> std::option::Option<& crate::model::ExtendedS3DestinationDescription> {
        self.extended_s3_destination_description.as_ref()
    }
    /// <p>The destination in Amazon Redshift.</p>
    pub fn redshift_destination_description(&self) -> std::option::Option<& crate::model::RedshiftDestinationDescription> {
        self.redshift_destination_description.as_ref()
    }
    /// <p>The destination in Amazon ES.</p>
    pub fn elasticsearch_destination_description(&self) -> std::option::Option<& crate::model::ElasticsearchDestinationDescription> {
        self.elasticsearch_destination_description.as_ref()
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn amazonopensearchservice_destination_description(&self) -> std::option::Option<& crate::model::AmazonopensearchserviceDestinationDescription> {
        self.amazonopensearchservice_destination_description.as_ref()
    }
    /// <p>The destination in Splunk.</p>
    pub fn splunk_destination_description(&self) -> std::option::Option<& crate::model::SplunkDestinationDescription> {
        self.splunk_destination_description.as_ref()
    }
    /// <p>Describes the specified HTTP endpoint destination.</p>
    pub fn http_endpoint_destination_description(&self) -> std::option::Option<& crate::model::HttpEndpointDestinationDescription> {
...
impl  std::fmt::Debug for DestinationDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("extended_s3_destination_description", &self.extended_s3_destination_description);
        formatter.field("redshift_destination_description", &self.redshift_destination_description);
        formatter.field("elasticsearch_destination_description", &self.elasticsearch_destination_description);
        formatter.field("amazonopensearchservice_destination_description", &self.amazonopensearchservice_destination_description);
        formatter.field("splunk_destination_description", &self.splunk_destination_description);
        formatter.field("http_endpoint_destination_description", &self.http_endpoint_destination_description);
        formatter.finish()
    }
}
...
pub mod destination_description {
    ...
    pub struct Builder {
        ...
        pub(crate) s3_destination_description: std::option::Option<crate::model::S3DestinationDescription>,
        pub(crate) extended_s3_destination_description: std::option::Option<crate::model::ExtendedS3DestinationDescription>,
        pub(crate) redshift_destination_description: std::option::Option<crate::model::RedshiftDestinationDescription>,
        pub(crate) elasticsearch_destination_description: std::option::Option<crate::model::ElasticsearchDestinationDescription>,
        pub(crate) amazonopensearchservice_destination_description: std::option::Option<crate::model::AmazonopensearchserviceDestinationDescription>,
        pub(crate) splunk_destination_description: std::option::Option<crate::model::SplunkDestinationDescription>,
        pub(crate) http_endpoint_destination_description: std::option::Option<crate::model::HttpEndpointDestinationDescription>,
    }
    impl Builder {
        /// <p>The ID of the destination.</p>
        ...
        /// <p>[Deprecated] The destination in Amazon S3.</p>
        pub fn s3_destination_description(mut self, input: crate::model::S3DestinationDescription) -> Self {
            self.s3_destination_description = Some(input);
            self
        }
        /// <p>[Deprecated] The destination in Amazon S3.</p>
        pub fn set_s3_destination_description(mut self, input: std::option::Option<crate::model::S3DestinationDescription>) -> Self {
            self.s3_destination_description = input; self
        }
        /// <p>The destination in Amazon S3.</p>
        pub fn extended_s3_destination_description(mut self, input: crate::model::ExtendedS3DestinationDescription) -> Self {
            self.extended_s3_destination_description = Some(input);
            self
        }
        /// <p>The destination in Amazon S3.</p>
        pub fn set_extended_s3_destination_description(mut self, input: std::option::Option<crate::model::ExtendedS3DestinationDescription>) -> Self {
            self.extended_s3_destination_description = input; self
        }
        /// <p>The destination in Amazon Redshift.</p>
        pub fn redshift_destination_description(mut self, input: crate::model::RedshiftDestinationDescription) -> Self {
            self.redshift_destination_description = Some(input);
            self
        }
        /// <p>The destination in Amazon Redshift.</p>
        pub fn set_redshift_destination_description(mut self, input: std::option::Option<crate::model::RedshiftDestinationDescription>) -> Self {
            self.redshift_destination_description = input; self
        }
        /// <p>The destination in Amazon ES.</p>
        pub fn elasticsearch_destination_description(mut self, input: crate::model::ElasticsearchDestinationDescription) -> Self {
            self.elasticsearch_destination_description = Some(input);
            self
        }
        /// <p>The destination in Amazon ES.</p>
        pub fn set_elasticsearch_destination_description(mut self, input: std::option::Option<crate::model::ElasticsearchDestinationDescription>) -> Self {
            self.elasticsearch_destination_description = input; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn amazonopensearchservice_destination_description(mut self, input: crate::model::AmazonopensearchserviceDestinationDescription) -> Self {
            self.amazonopensearchservice_destination_description = Some(input);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn set_amazonopensearchservice_destination_description(mut self, input: std::option::Option<crate::model::AmazonopensearchserviceDestinationDescription>) -> Self {
            self.amazonopensearchservice_destination_description = input; self
        }
        /// <p>The destination in Splunk.</p>
        pub fn splunk_destination_description(mut self, input: crate::model::SplunkDestinationDescription) -> Self {
            self.splunk_destination_description = Some(input);
            self
        }
        /// <p>The destination in Splunk.</p>
        pub fn set_splunk_destination_description(mut self, input: std::option::Option<crate::model::SplunkDestinationDescription>) -> Self {
            self.splunk_destination_description = input; self
        }
        /// <p>Describes the specified HTTP endpoint destination.</p>
        pub fn http_endpoint_destination_description(mut self, input: crate::model::HttpEndpointDestinationDescription) -> Self {
            self.http_endpoint_destination_description = Some(input);
            self
        }
        /// <p>Describes the specified HTTP endpoint destination.</p>
        pub fn set_http_endpoint_destination_description(mut self, input: std::option::Option<crate::model::HttpEndpointDestinationDescription>) -> Self {
...
pub struct HttpEndpointDestinationDescription  {
    ...
    #[doc(hidden)]pub endpoint_configuration: std::option::Option<crate::model::HttpEndpointDescription>,
    /// <p>Describes buffering options that can be applied to the data before it is delivered to the HTTPS endpoint destination. Kinesis Data Firehose teats these options as hints, and it might choose to use more optimal values. The <code>SizeInMBs</code> and <code>IntervalInSeconds</code> parameters are optional. However, if specify a value for one of them, you must also provide a value for the other. </p>
    #[doc(hidden)]pub buffering_hints: std::option::Option<crate::model::HttpEndpointBufferingHints>,
    /// <p>Describes the Amazon CloudWatch logging options for your delivery stream.</p>
    #[doc(hidden)]pub cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
...
impl HttpEndpointDestinationDescription {
    /// <p>The configuration of the specified HTTP endpoint destination.</p>
    pub fn endpoint_configuration(&self) -> std::option::Option<& crate::model::HttpEndpointDescription> {
        self.endpoint_configuration.as_ref()
    }
    /// <p>Describes buffering options that can be applied to the data before it is delivered to the HTTPS endpoint destination. Kinesis Data Firehose teats these options as hints, and it might choose to use more optimal values. The <code>SizeInMBs</code> and <code>IntervalInSeconds</code> parameters are optional. However, if specify a value for one of them, you must also provide a value for the other. </p>
    pub fn buffering_hints(&self) -> std::option::Option<& crate::model::HttpEndpointBufferingHints> {
...
pub mod http_endpoint_destination_description {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) endpoint_configuration: std::option::Option<crate::model::HttpEndpointDescription>,
        pub(crate) buffering_hints: std::option::Option<crate::model::HttpEndpointBufferingHints>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
        pub(crate) request_configuration: std::option::Option<crate::model::HttpEndpointRequestConfiguration>,
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
    ...
    impl Builder {
        /// <p>The configuration of the specified HTTP endpoint destination.</p>
        pub fn endpoint_configuration(mut self, input: crate::model::HttpEndpointDescription) -> Self {
            self.endpoint_configuration = Some(input);
            self
        }
        /// <p>The configuration of the specified HTTP endpoint destination.</p>
        pub fn set_endpoint_configuration(mut self, input: std::option::Option<crate::model::HttpEndpointDescription>) -> Self {
            self.endpoint_configuration = input; self
        }
        /// <p>Describes buffering options that can be applied to the data before it is delivered to the HTTPS endpoint destination. Kinesis Data Firehose teats these options as hints, and it might choose to use more optimal values. The <code>SizeInMBs</code> and <code>IntervalInSeconds</code> parameters are optional. However, if specify a value for one of them, you must also provide a value for the other. </p>
        pub fn buffering_hints(mut self, input: crate::model::HttpEndpointBufferingHints) -> Self {
...
pub struct AmazonopensearchserviceDestinationDescription  {
    ...
    #[doc(hidden)]pub retry_options: std::option::Option<crate::model::AmazonopensearchserviceRetryOptions>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::AmazonopensearchserviceS3BackupMode>,
    /// <p>Describes a destination in Amazon S3.</p>
    #[doc(hidden)]pub s3_destination_description: std::option::Option<crate::model::S3DestinationDescription>,
    /// <p>Describes a data processing configuration.</p>
    #[doc(hidden)]pub processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
    ...
    #[doc(hidden)]pub vpc_configuration_description: std::option::Option<crate::model::VpcConfigurationDescription>,
}
impl AmazonopensearchserviceDestinationDescription {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn s3_backup_mode(&self) -> std::option::Option<& crate::model::AmazonopensearchserviceS3BackupMode> {
        self.s3_backup_mode.as_ref()
    }
    /// <p>Describes a destination in Amazon S3.</p>
    pub fn s3_destination_description(&self) -> std::option::Option<& crate::model::S3DestinationDescription> {
...
impl  std::fmt::Debug for AmazonopensearchserviceDestinationDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("processing_configuration", &self.processing_configuration);
        formatter.field("cloud_watch_logging_options", &self.cloud_watch_logging_options);
        formatter.field("vpc_configuration_description", &self.vpc_configuration_description);
        formatter.finish()
    }
}
...
pub mod amazonopensearchservice_destination_description {
    ...
    pub struct Builder {
        ...
        pub(crate) buffering_hints: std::option::Option<crate::model::AmazonopensearchserviceBufferingHints>,
        pub(crate) retry_options: std::option::Option<crate::model::AmazonopensearchserviceRetryOptions>,
        pub(crate) s3_backup_mode: std::option::Option<crate::model::AmazonopensearchserviceS3BackupMode>,
        pub(crate) s3_destination_description: std::option::Option<crate::model::S3DestinationDescription>,
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
    ...
    impl Builder {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn s3_backup_mode(mut self, input: crate::model::AmazonopensearchserviceS3BackupMode) -> Self {
            self.s3_backup_mode = Some(input);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::AmazonopensearchserviceS3BackupMode>) -> Self {
            self.s3_backup_mode = input; self
        }
        /// <p>Describes a destination in Amazon S3.</p>
        pub fn s3_destination_description(mut self, input: crate::model::S3DestinationDescription) -> Self {
...
pub struct ElasticsearchDestinationDescription  {
    ...
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::ElasticsearchS3BackupMode>,
    /// <p>The Amazon S3 destination.</p>
    #[doc(hidden)]pub s3_destination_description: std::option::Option<crate::model::S3DestinationDescription>,
    /// <p>The data processing configuration.</p>
    #[doc(hidden)]pub processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
...
pub mod elasticsearch_destination_description {
    ...
    impl Builder {
        ...
        /// <p>The Amazon S3 backup mode.</p>
        pub fn set_s3_backup_mode(mut self, input: std::option::Option<crate::model::ElasticsearchS3BackupMode>) -> Self {
            self.s3_backup_mode = input; self
        }
        /// <p>The Amazon S3 destination.</p>
        pub fn s3_destination_description(mut self, input: crate::model::S3DestinationDescription) -> Self {
...
pub struct RedshiftDestinationDescription  {
    ...
    #[doc(hidden)]pub s3_backup_description: std::option::Option<crate::model::S3DestinationDescription>,
    /// <p>The Amazon CloudWatch logging options for your delivery stream.</p>
    #[doc(hidden)]pub cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
}
impl RedshiftDestinationDescription {
    ...
    /// <p>The configuration for backup in Amazon S3.</p>
    pub fn s3_backup_description(&self) -> std::option::Option<& crate::model::S3DestinationDescription> {
...
pub mod redshift_destination_description {
    ...
    pub struct Builder {
        ...
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
        pub(crate) s3_backup_mode: std::option::Option<crate::model::RedshiftS3BackupMode>,
        pub(crate) s3_backup_description: std::option::Option<crate::model::S3DestinationDescription>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
    }
    impl Builder {
        /// <p>The Amazon Resource Name (ARN) of the AWS credentials. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and AWS Service Namespaces</a>.</p>
        ...
        /// <p>The configuration for backup in Amazon S3.</p>
        pub fn s3_backup_description(mut self, input: crate::model::S3DestinationDescription) -> Self {
            self.s3_backup_description = Some(input);
            self
        }
        /// <p>The configuration for backup in Amazon S3.</p>
        pub fn set_s3_backup_description(mut self, input: std::option::Option<crate::model::S3DestinationDescription>) -> Self {
...
pub struct SourceDescription  {
    ...
    #[doc(hidden)]pub kinesis_stream_source_description: std::option::Option<crate::model::KinesisStreamSourceDescription>,
}
impl SourceDescription {
    /// <p>The <code>KinesisStreamSourceDescription</code> value for the source Kinesis data stream.</p>
    pub fn kinesis_stream_source_description(&self) -> std::option::Option<& crate::model::KinesisStreamSourceDescription> {
...
impl  std::fmt::Debug for SourceDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("kinesis_stream_source_description", &self.kinesis_stream_source_description);
        formatter.finish()
    }
}
...
pub mod source_description {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) kinesis_stream_source_description: std::option::Option<crate::model::KinesisStreamSourceDescription>,
    }
    impl Builder {
        /// <p>The <code>KinesisStreamSourceDescription</code> value for the source Kinesis data stream.</p>
        pub fn kinesis_stream_source_description(mut self, input: crate::model::KinesisStreamSourceDescription) -> Self {
            self.kinesis_stream_source_description = Some(input);
            self
        }
        /// <p>The <code>KinesisStreamSourceDescription</code> value for the source Kinesis data stream.</p>
        pub fn set_kinesis_stream_source_description(mut self, input: std::option::Option<crate::model::KinesisStreamSourceDescription>) -> Self {
...
pub struct KinesisStreamSourceDescription  {
    ...
    #[doc(hidden)]pub kinesis_stream_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub delivery_start_timestamp: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct DeliveryStreamEncryptionConfiguration  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::DeliveryStreamEncryptionStatus>,
    /// <p>Provides details in case one of the following operations fails due to an error related to KMS: <code>CreateDeliveryStream</code>, <code>DeleteDeliveryStream</code>, <code>StartDeliveryStreamEncryption</code>, <code>StopDeliveryStreamEncryption</code>.</p>
    #[doc(hidden)]pub failure_description: std::option::Option<crate::model::FailureDescription>,
}
...
pub mod delivery_stream_encryption_configuration {
    ...
    impl Builder {
        ...
        /// <p>This is the server-side encryption (SSE) status for the delivery stream. For a full description of the different values of this status, see <code>StartDeliveryStreamEncryption</code> and <code>StopDeliveryStreamEncryption</code>. If this status is <code>ENABLING_FAILED</code> or <code>DISABLING_FAILED</code>, it is the status of the most recent attempt to enable or disable SSE, respectively.</p>
        pub fn set_status(mut self, input: std::option::Option<crate::model::DeliveryStreamEncryptionStatus>) -> Self {
...
pub struct FailureDescription  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::DeliveryStreamFailureType>,
...
pub mod failure_description {
    ...
    impl Builder {
        ...
        /// <p>The type of error that caused the failure.</p>
        pub fn set_type(mut self, input: std::option::Option<crate::model::DeliveryStreamFailureType>) -> Self {
            self.r#type = input; self
        }
        /// <p>A message providing details about the error that caused the failure.</p>
...
pub struct HttpEndpointDestinationConfiguration  {
    ...
    #[doc(hidden)]pub s3_configuration: std::option::Option<crate::model::S3DestinationConfiguration>,
}
impl HttpEndpointDestinationConfiguration {
    ...
    /// <p>Describes the configuration of a destination in Amazon S3.</p>
    pub fn s3_configuration(&self) -> std::option::Option<& crate::model::S3DestinationConfiguration> {
...
pub mod http_endpoint_destination_configuration {
    ...
    impl Builder {
        ...
        /// <p>Describes the configuration of a destination in Amazon S3.</p>
        pub fn set_s3_configuration(mut self, input: std::option::Option<crate::model::S3DestinationConfiguration>) -> Self {
...
pub struct RedshiftDestinationConfiguration  {
    ...
    #[doc(hidden)]pub s3_backup_mode: std::option::Option<crate::model::RedshiftS3BackupMode>,
    /// <p>The configuration for backup in Amazon S3.</p>
    #[doc(hidden)]pub s3_backup_configuration: std::option::Option<crate::model::S3DestinationConfiguration>,
    /// <p>The CloudWatch logging options for your delivery stream.</p>
    #[doc(hidden)]pub cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
}
impl RedshiftDestinationConfiguration {
    ...
    /// <p>The configuration for backup in Amazon S3.</p>
    pub fn s3_backup_configuration(&self) -> std::option::Option<& crate::model::S3DestinationConfiguration> {
...
pub mod redshift_destination_configuration {
    ...
    pub struct Builder {
        ...
        pub(crate) processing_configuration: std::option::Option<crate::model::ProcessingConfiguration>,
        pub(crate) s3_backup_mode: std::option::Option<crate::model::RedshiftS3BackupMode>,
        pub(crate) s3_backup_configuration: std::option::Option<crate::model::S3DestinationConfiguration>,
        pub(crate) cloud_watch_logging_options: std::option::Option<crate::model::CloudWatchLoggingOptions>,
    }
    impl Builder {
        /// <p>The Amazon Resource Name (ARN) of the AWS credentials. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and AWS Service Namespaces</a>.</p>
        ...
        /// <p>The configuration for backup in Amazon S3.</p>
        pub fn s3_backup_configuration(mut self, input: crate::model::S3DestinationConfiguration) -> Self {
            self.s3_backup_configuration = Some(input);
            self
        }
        /// <p>The configuration for backup in Amazon S3.</p>
        pub fn set_s3_backup_configuration(mut self, input: std::option::Option<crate::model::S3DestinationConfiguration>) -> Self {
