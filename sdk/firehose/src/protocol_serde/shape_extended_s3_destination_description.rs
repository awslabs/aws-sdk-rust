...
pub(crate) fn de_extended_s3_destination_description<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ExtendedS3DestinationDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DataFormatConversionConfiguration" => {
                            builder = builder.set_data_format_conversion_configuration(
                                crate::protocol_serde::shape_data_format_conversion_configuration::de_data_format_conversion_configuration(
                                    tokens, _value,
                                )?,
                            );
                        }
                        "DynamicPartitioningConfiguration" => {
                            builder = builder.set_dynamic_partitioning_configuration(
                                crate::protocol_serde::shape_dynamic_partitioning_configuration::de_dynamic_partitioning_configuration(
                                    tokens, _value,
                                )?,
                            );
                        }
