...
pub(crate) fn de_extended_s3_destination_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ExtendedS3DestinationDescription>, aws_smithy_json::deserialize::error::DeserializeError>
