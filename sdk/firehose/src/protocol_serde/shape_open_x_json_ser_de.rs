...
pub fn ser_open_x_json_ser_de(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpenXJsonSerDe) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_open_x_json_ser_de<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OpenXJsonSerDe>, aws_smithy_json::deserialize::error::DeserializeError>
