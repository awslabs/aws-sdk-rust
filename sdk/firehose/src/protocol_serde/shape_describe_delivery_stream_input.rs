...
pub fn ser_describe_delivery_stream_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeDeliveryStreamInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
