...
pub fn ser_amazon_open_search_serverless_destination_configuration(
    ...
    if let Some(var_2) = &input.buffering_hints {
        ...
        crate::protocol_serde::shape_amazon_open_search_serverless_buffering_hints::ser_amazon_open_search_serverless_buffering_hints(&mut object_3, var_2)?;
        object_3.finish();
    }
    if let Some(var_4) = &input.retry_options {
        #[allow(unused_mut)]
        let mut object_5 = object.key("RetryOptions").start_object();
        crate::protocol_serde::shape_amazon_open_search_serverless_retry_options::ser_amazon_open_search_serverless_retry_options(&mut object_5, var_4)?;
        object_5.finish();
    }
