...
pub fn ser_list_delivery_streams_input(
    ...
    crate::protocol_serde::shape_list_delivery_streams_input::ser_list_delivery_streams_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_delivery_streams::de_list_delivery_streams(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_delivery_streams::ListDeliveryStreamsError::unhandled)?;
