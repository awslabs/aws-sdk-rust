...
pub fn ser_tag_delivery_stream_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TagDeliveryStreamInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
