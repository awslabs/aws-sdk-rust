...
pub fn ser_data_format_conversion_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataFormatConversionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_data_format_conversion_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataFormatConversionConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
