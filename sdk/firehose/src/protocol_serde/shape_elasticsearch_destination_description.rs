...
pub(crate) fn de_elasticsearch_destination_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ElasticsearchDestinationDescription>, aws_smithy_json::deserialize::error::DeserializeError>
