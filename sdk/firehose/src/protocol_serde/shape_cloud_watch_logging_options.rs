...
pub(crate) fn de_cloud_watch_logging_options<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::CloudWatchLoggingOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
