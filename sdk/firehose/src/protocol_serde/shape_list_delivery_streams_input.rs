...
pub fn ser_list_delivery_streams_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListDeliveryStreamsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
