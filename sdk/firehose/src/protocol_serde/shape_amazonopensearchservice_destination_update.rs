...
pub fn ser_amazonopensearchservice_destination_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AmazonopensearchserviceDestinationUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
