...
pub(crate) fn de_amazonopensearchservice_destination_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AmazonopensearchserviceDestinationDescription>, aws_smithy_json::deserialize::error::DeserializeError>
