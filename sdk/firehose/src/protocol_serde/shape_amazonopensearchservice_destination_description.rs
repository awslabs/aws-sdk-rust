...
pub(crate) fn de_amazonopensearchservice_destination_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AmazonopensearchserviceDestinationDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "BufferingHints" => {
                                builder = builder.set_buffering_hints(
                                    crate::protocol_serde::shape_amazonopensearchservice_buffering_hints::de_amazonopensearchservice_buffering_hints(tokens)?
                                );
                            }
                            "RetryOptions" => {
                            ...
                            "S3BackupMode" => {
                                builder = builder.set_s3_backup_mode(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AmazonopensearchserviceS3BackupMode::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "DocumentIdOptions" => {
                                builder = builder.set_document_id_options(
                                    crate::protocol_serde::shape_document_id_options::de_document_id_options(tokens)?
                                );
                            }
