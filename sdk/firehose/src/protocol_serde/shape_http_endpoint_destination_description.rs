                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "EndpointConfiguration" => {
                            builder = builder.set_endpoint_configuration(
                                crate::protocol_serde::shape_http_endpoint_description::de_http_endpoint_description(tokens, _value)?,
                            );
                        }
                        "BufferingHints" => {
                            builder = builder.set_buffering_hints(
                                crate::protocol_serde::shape_http_endpoint_buffering_hints::de_http_endpoint_buffering_hints(tokens, _value)?,
                            );
                        }
                        ...
                        "RetryOptions" => {
                            builder = builder.set_retry_options(
                                crate::protocol_serde::shape_http_endpoint_retry_options::de_http_endpoint_retry_options(tokens, _value)?,
                            );
                        }
                        "S3BackupMode" => {
