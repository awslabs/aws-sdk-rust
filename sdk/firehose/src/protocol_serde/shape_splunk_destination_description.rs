...
pub(crate) fn de_splunk_destination_description<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SplunkDestinationDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RetryOptions" => {
                            builder = builder.set_retry_options(crate::protocol_serde::shape_splunk_retry_options::de_splunk_retry_options(
                                tokens, _value,
                            )?);
                        }
                        "S3BackupMode" => {
                        ...
                        "BufferingHints" => {
                            builder = builder.set_buffering_hints(crate::protocol_serde::shape_splunk_buffering_hints::de_splunk_buffering_hints(
                                tokens, _value,
                            )?);
                        }
