...
pub(crate) fn de_splunk_destination_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SplunkDestinationDescription>, aws_smithy_json::deserialize::error::DeserializeError>
