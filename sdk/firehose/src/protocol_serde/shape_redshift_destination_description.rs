...
) -> Result<Option<crate::types::RedshiftDestinationDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "CopyCommand" => {
                            builder = builder.set_copy_command(crate::protocol_serde::shape_copy_command::de_copy_command(tokens)?);
                        }
                        "Username" => {
                        ...
                        "RetryOptions" => {
                            builder =
                                builder.set_retry_options(crate::protocol_serde::shape_redshift_retry_options::de_redshift_retry_options(tokens)?);
                        }
                        ...
                        "S3BackupMode" => {
                            builder = builder.set_s3_backup_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RedshiftS3BackupMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "S3BackupDescription" => {
            ...
            Ok(Some(
                crate::serde_util::redshift_destination_description_correct_errors(builder)
                    .build()
