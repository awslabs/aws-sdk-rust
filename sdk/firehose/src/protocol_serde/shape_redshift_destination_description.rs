...
pub(crate) fn de_redshift_destination_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RedshiftDestinationDescription>, aws_smithy_json::deserialize::error::DeserializeError>
