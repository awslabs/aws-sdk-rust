...
pub(crate) fn de_amazon_open_search_serverless_destination_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AmazonOpenSearchServerlessDestinationDescription>, aws_smithy_json::deserialize::error::DeserializeError>
