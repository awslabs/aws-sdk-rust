                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "BufferingHints" => {
                            builder = builder.set_buffering_hints(
                                    crate::protocol_serde::shape_amazon_open_search_serverless_buffering_hints::de_amazon_open_search_serverless_buffering_hints(tokens, _value)?
                                );
                        }
                        "RetryOptions" => {
                            builder = builder.set_retry_options(
                                    crate::protocol_serde::shape_amazon_open_search_serverless_retry_options::de_amazon_open_search_serverless_retry_options(tokens, _value)?
                                );
                        }
                        "S3BackupMode" => {
