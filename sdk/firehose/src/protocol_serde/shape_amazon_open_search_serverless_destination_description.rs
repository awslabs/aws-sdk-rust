...
) -> Result<Option<crate::types::AmazonOpenSearchServerlessDestinationDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "S3BackupMode" => {
                            builder = builder.set_s3_backup_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::AmazonOpenSearchServerlessS3BackupMode::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
