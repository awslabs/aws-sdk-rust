                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "BufferingHints" => {
                            builder = builder.set_buffering_hints(
                                    crate::protocol_serde::shape_amazon_open_search_serverless_buffering_hints::de_amazon_open_search_serverless_buffering_hints(tokens, _value, depth + 1)?
                                );
                        }
                        "RetryOptions" => {
                            builder = builder.set_retry_options(
                                    crate::protocol_serde::shape_amazon_open_search_serverless_retry_options::de_amazon_open_search_serverless_retry_options(tokens, _value, depth + 1)?
                                );
                        }
                        "S3BackupMode" => {
                        ...
                        "VpcConfigurationDescription" => {
                            builder = builder.set_vpc_configuration_description(
                                crate::protocol_serde::shape_vpc_configuration_description::de_vpc_configuration_description(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
