...
pub(crate) fn de_snowflake_destination_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SnowflakeDestinationDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DataLoadingOption" => {
                                builder = builder.set_data_loading_option(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::SnowflakeDataLoadingOption::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "RetryOptions" => {
                                builder = builder.set_retry_options(
                                    crate::protocol_serde::shape_snowflake_retry_options::de_snowflake_retry_options(tokens)?
                                );
                            }
                            "S3BackupMode" => {
                                builder = builder.set_s3_backup_mode(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::SnowflakeS3BackupMode::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
