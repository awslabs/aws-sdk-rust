...
pub fn ser_http_endpoint_destination_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HttpEndpointDestinationUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
