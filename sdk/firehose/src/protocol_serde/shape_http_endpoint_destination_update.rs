...
pub fn ser_http_endpoint_destination_update(
    ...
    if let Some(var_1) = &input.endpoint_configuration {
        ...
        crate::protocol_serde::shape_http_endpoint_configuration::ser_http_endpoint_configuration(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_12) = &input.retry_options {
        ...
        crate::protocol_serde::shape_http_endpoint_retry_options::ser_http_endpoint_retry_options(
            &mut object_13,
            var_12,
        )?;
        object_13.finish();
