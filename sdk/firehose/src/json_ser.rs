...
pub fn serialize_structure_extended_s3_destination_configuration(
    ...
    if let Some(var_103) = &input.dynamic_partitioning_configuration {
        let mut object_104 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_dynamic_partitioning_configuration(
            &mut object_104,
            var_103,
        );
        object_104.finish();
...
pub fn serialize_structure_redshift_destination_configuration(
    ...
    if let Some(var_107) = &input.copy_command {
        ...
        crate::json_ser::serialize_structure_copy_command(&mut object_108, var_107);
        object_108.finish();
    }
    ...
    if let Some(var_111) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_redshift_retry_options(&mut object_112, var_111);
        object_112.finish();
    }
    if let Some(var_113) = &input.s3_configuration {
        let mut object_114 = object.key("S3Configuration").start_object();
        crate::json_ser::serialize_structure_s3_destination_configuration(&mut object_114, var_113);
        object_114.finish();
    }
    if let Some(var_115) = &input.processing_configuration {
        let mut object_116 = object.key("ProcessingConfiguration").start_object();
        crate::json_ser::serialize_structure_processing_configuration(&mut object_116, var_115);
        object_116.finish();
    }
    ...
    if let Some(var_118) = &input.s3_backup_configuration {
        ...
        crate::json_ser::serialize_structure_s3_destination_configuration(&mut object_119, var_118);
        object_119.finish();
    }
    if let Some(var_120) = &input.cloud_watch_logging_options {
        let mut object_121 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_121, var_120);
        object_121.finish();
    }
}
...
pub fn serialize_structure_elasticsearch_destination_configuration(
    ...
    if let Some(var_130) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_elasticsearch_retry_options(&mut object_131, var_130);
        object_131.finish();
    }
...
pub fn serialize_structure_splunk_destination_configuration(
    ...
    if let Some(var_145) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_splunk_retry_options(&mut object_146, var_145);
        object_146.finish();
    }
    ...
    if let Some(var_148) = &input.s3_configuration {
        ...
        crate::json_ser::serialize_structure_s3_destination_configuration(&mut object_149, var_148);
        object_149.finish();
    }
    if let Some(var_150) = &input.processing_configuration {
        let mut object_151 = object.key("ProcessingConfiguration").start_object();
        crate::json_ser::serialize_structure_processing_configuration(&mut object_151, var_150);
        object_151.finish();
    }
    if let Some(var_152) = &input.cloud_watch_logging_options {
        let mut object_153 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_153, var_152);
        object_153.finish();
    }
}
...
pub fn serialize_structure_http_endpoint_destination_configuration(
    ...
    if let Some(var_154) = &input.endpoint_configuration {
        ...
        crate::json_ser::serialize_structure_http_endpoint_configuration(&mut object_155, var_154);
        object_155.finish();
    }
    ...
    if let Some(var_158) = &input.cloud_watch_logging_options {
        ...
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_159, var_158);
        object_159.finish();
    }
    ...
    if let Some(var_162) = &input.processing_configuration {
        ...
        crate::json_ser::serialize_structure_processing_configuration(&mut object_163, var_162);
        object_163.finish();
    }
    ...
    if let Some(var_165) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_http_endpoint_retry_options(&mut object_166, var_165);
        object_166.finish();
    }
    ...
    if let Some(var_168) = &input.s3_configuration {
        ...
        crate::json_ser::serialize_structure_s3_destination_configuration(&mut object_169, var_168);
        object_169.finish();
    }
}
...
pub fn serialize_structure_s3_destination_update(
    ...
    if let Some(var_177) = &input.buffering_hints {
        ...
        crate::json_ser::serialize_structure_buffering_hints(&mut object_178, var_177);
        object_178.finish();
    }
    ...
    if let Some(var_180) = &input.encryption_configuration {
        ...
        crate::json_ser::serialize_structure_encryption_configuration(&mut object_181, var_180);
        object_181.finish();
    }
    if let Some(var_182) = &input.cloud_watch_logging_options {
        let mut object_183 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_183, var_182);
        object_183.finish();
    }
}
...
pub fn serialize_structure_extended_s3_destination_update(
    ...
    if let Some(var_188) = &input.buffering_hints {
        ...
        crate::json_ser::serialize_structure_buffering_hints(&mut object_189, var_188);
        object_189.finish();
    }
    ...
    if let Some(var_191) = &input.encryption_configuration {
        ...
        crate::json_ser::serialize_structure_encryption_configuration(&mut object_192, var_191);
        object_192.finish();
    }
    if let Some(var_193) = &input.cloud_watch_logging_options {
        let mut object_194 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_194, var_193);
        object_194.finish();
    }
    if let Some(var_195) = &input.processing_configuration {
        let mut object_196 = object.key("ProcessingConfiguration").start_object();
        crate::json_ser::serialize_structure_processing_configuration(&mut object_196, var_195);
        object_196.finish();
    }
    ...
    if let Some(var_198) = &input.s3_backup_update {
        ...
        crate::json_ser::serialize_structure_s3_destination_update(&mut object_199, var_198);
        object_199.finish();
    }
...
pub fn serialize_structure_redshift_destination_update(
    ...
    if let Some(var_206) = &input.copy_command {
        ...
        crate::json_ser::serialize_structure_copy_command(&mut object_207, var_206);
        object_207.finish();
    }
    ...
    if let Some(var_210) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_redshift_retry_options(&mut object_211, var_210);
        object_211.finish();
    }
    if let Some(var_212) = &input.s3_update {
        let mut object_213 = object.key("S3Update").start_object();
        crate::json_ser::serialize_structure_s3_destination_update(&mut object_213, var_212);
        object_213.finish();
    }
    if let Some(var_214) = &input.processing_configuration {
        let mut object_215 = object.key("ProcessingConfiguration").start_object();
        crate::json_ser::serialize_structure_processing_configuration(&mut object_215, var_214);
        object_215.finish();
    }
    ...
    if let Some(var_217) = &input.s3_backup_update {
        ...
        crate::json_ser::serialize_structure_s3_destination_update(&mut object_218, var_217);
        object_218.finish();
    }
    if let Some(var_219) = &input.cloud_watch_logging_options {
        let mut object_220 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_220, var_219);
        object_220.finish();
    }
}
...
pub fn serialize_structure_elasticsearch_destination_update(
    ...
    if let Some(var_229) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_elasticsearch_retry_options(&mut object_230, var_229);
        object_230.finish();
    }
    if let Some(var_231) = &input.s3_update {
        let mut object_232 = object.key("S3Update").start_object();
        crate::json_ser::serialize_structure_s3_destination_update(&mut object_232, var_231);
        object_232.finish();
    }
    if let Some(var_233) = &input.processing_configuration {
        let mut object_234 = object.key("ProcessingConfiguration").start_object();
        crate::json_ser::serialize_structure_processing_configuration(&mut object_234, var_233);
        object_234.finish();
    }
    if let Some(var_235) = &input.cloud_watch_logging_options {
        let mut object_236 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_236, var_235);
        object_236.finish();
    }
}
...
pub fn serialize_structure_splunk_destination_update(
    ...
    if let Some(var_241) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_splunk_retry_options(&mut object_242, var_241);
        object_242.finish();
    }
    ...
    if let Some(var_244) = &input.s3_update {
        ...
        crate::json_ser::serialize_structure_s3_destination_update(&mut object_245, var_244);
        object_245.finish();
    }
    if let Some(var_246) = &input.processing_configuration {
        let mut object_247 = object.key("ProcessingConfiguration").start_object();
        crate::json_ser::serialize_structure_processing_configuration(&mut object_247, var_246);
        object_247.finish();
    }
    if let Some(var_248) = &input.cloud_watch_logging_options {
        let mut object_249 = object.key("CloudWatchLoggingOptions").start_object();
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_249, var_248);
        object_249.finish();
    }
}
...
pub fn serialize_structure_http_endpoint_destination_update(
    ...
    if let Some(var_250) = &input.endpoint_configuration {
        ...
        crate::json_ser::serialize_structure_http_endpoint_configuration(&mut object_251, var_250);
        object_251.finish();
    }
    ...
    if let Some(var_254) = &input.cloud_watch_logging_options {
        ...
        crate::json_ser::serialize_structure_cloud_watch_logging_options(&mut object_255, var_254);
        object_255.finish();
    }
    ...
    if let Some(var_258) = &input.processing_configuration {
        ...
        crate::json_ser::serialize_structure_processing_configuration(&mut object_259, var_258);
        object_259.finish();
    }
    ...
    if let Some(var_261) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_http_endpoint_retry_options(&mut object_262, var_261);
        object_262.finish();
    }
    ...
    if let Some(var_264) = &input.s3_update {
        ...
        crate::json_ser::serialize_structure_s3_destination_update(&mut object_265, var_264);
        object_265.finish();
    }
}
...
pub fn serialize_structure_encryption_configuration(
    ...
    if let Some(var_269) = &input.kms_encryption_config {
        ...
        crate::json_ser::serialize_structure_kms_encryption_config(&mut object_270, var_269);
        object_270.finish();
    }
}
        ...
        for item_277 in var_275 {
            {
                ...
                crate::json_ser::serialize_structure_processor(&mut object_278, item_277);
                object_278.finish();
            }
        }
        array_276.finish();
...
pub fn serialize_structure_data_format_conversion_configuration(
    ...
    if let Some(var_279) = &input.schema_configuration {
        ...
        crate::json_ser::serialize_structure_schema_configuration(&mut object_280, var_279);
        object_280.finish();
    }
    if let Some(var_281) = &input.input_format_configuration {
        let mut object_282 = object.key("InputFormatConfiguration").start_object();
        crate::json_ser::serialize_structure_input_format_configuration(&mut object_282, var_281);
        object_282.finish();
    }
    if let Some(var_283) = &input.output_format_configuration {
        ...
        crate::json_ser::serialize_structure_output_format_configuration(&mut object_284, var_283);
        object_284.finish();
    }
...
pub fn serialize_structure_dynamic_partitioning_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_286) = &input.retry_options {
        ...
        crate::json_ser::serialize_structure_retry_options(&mut object_287, var_286);
        object_287.finish();
    }
        ...
        for item_319 in var_317 {
            {
                ...
                crate::json_ser::serialize_structure_processor_parameter(&mut object_320, item_319);
                object_320.finish();
            }
        }
        array_318.finish();
...
pub fn serialize_structure_input_format_configuration(
    ...
    if let Some(var_327) = &input.deserializer {
        ...
        crate::json_ser::serialize_structure_deserializer(&mut object_328, var_327);
        object_328.finish();
    }
}
...
pub fn serialize_structure_output_format_configuration(
    ...
    if let Some(var_329) = &input.serializer {
        ...
        crate::json_ser::serialize_structure_serializer(&mut object_330, var_329);
        object_330.finish();
    }
}

pub fn serialize_structure_retry_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deserializer(
    ...
    if let Some(var_336) = &input.open_x_json_ser_de {
        ...
        crate::json_ser::serialize_structure_open_x_json_ser_de(&mut object_337, var_336);
        object_337.finish();
    }
    if let Some(var_338) = &input.hive_json_ser_de {
        let mut object_339 = object.key("HiveJsonSerDe").start_object();
        crate::json_ser::serialize_structure_hive_json_ser_de(&mut object_339, var_338);
        object_339.finish();
    }
}
...
pub fn serialize_structure_serializer(
    ...
    if let Some(var_340) = &input.parquet_ser_de {
        ...
        crate::json_ser::serialize_structure_parquet_ser_de(&mut object_341, var_340);
        object_341.finish();
    }
    if let Some(var_342) = &input.orc_ser_de {
        let mut object_343 = object.key("OrcSerDe").start_object();
        crate::json_ser::serialize_structure_orc_ser_de(&mut object_343, var_342);
        object_343.finish();
    }
}
