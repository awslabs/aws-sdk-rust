...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDeliveryStreamEncryption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_delivery_stream_encryption::de_stop_delivery_stream_encryption_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StopDeliveryStreamEncryptionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_delivery_stream_encryption::StopDeliveryStreamEncryptionError
{
