...
impl StopDeliveryStreamEncryptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_delivery_stream_encryption::StopDeliveryStreamEncryption::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDeliveryStreamEncryption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_delivery_stream_encryption::de_stop_delivery_stream_encryption_http_response_with_props(
                status, headers, body,
            )
        }
    }
