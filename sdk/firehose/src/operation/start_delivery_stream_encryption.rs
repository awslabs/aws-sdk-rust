...
impl StartDeliveryStreamEncryptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_delivery_stream_encryption::StartDeliveryStreamEncryption::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDeliveryStreamEncryption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_delivery_stream_encryption::de_start_delivery_stream_encryption_http_response_with_props(
                status, headers, body,
            )
        }
    }
