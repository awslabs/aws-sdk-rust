...
impl ListTagsForDeliveryStreamInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_tags_for_delivery_stream::ListTagsForDeliveryStream::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTagsForDeliveryStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tags_for_delivery_stream::de_list_tags_for_delivery_stream_http_response_with_props(
                status, headers, body,
            )
        }
    }
