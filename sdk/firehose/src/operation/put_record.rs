...
impl PutRecordInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_record::PutRecord, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_record::ser_put_record_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_record::PutRecord::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutRecord", "firehose"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRecord {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_record::de_put_record_http_response_with_props(status, headers, body)
        }
    }
}
