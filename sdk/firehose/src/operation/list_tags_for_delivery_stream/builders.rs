...
impl ListTagsForDeliveryStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_tags_for_delivery_stream::ListTagsForDeliveryStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_tags_for_delivery_stream::ListTagsForDeliveryStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_tags_for_delivery_stream::ListTagsForDeliveryStreamOutput, crate::operation::list_tags_for_delivery_stream::ListTagsForDeliveryStreamError, Self> {
