...
impl ListTagsForDeliveryStreamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_tags_for_delivery_stream::ListTagsForDeliveryStreamInput, ::aws_smithy_types::error::operation::BuildError> {
