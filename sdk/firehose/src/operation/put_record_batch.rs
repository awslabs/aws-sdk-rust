...
impl PutRecordBatchInput {
    /// Consumes the builder and constructs an Operation<[`PutRecordBatch`](crate::operation::put_record_batch::PutRecordBatch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_record_batch::PutRecordBatch, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_record_batch::PutRecordBatchInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_record_batch::PutRecordBatch::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutRecordBatch", "firehose"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutRecordBatch {
                type Output = std::result::Result<crate::operation::put_record_batch::PutRecordBatchOutput, crate::operation::put_record_batch::PutRecordBatchError>;
