...
impl PutRecordBatchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_record_batch::PutRecordBatch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_record_batch::ser_put_record_batch_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRecordBatch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_record_batch::de_put_record_batch_http_response_with_props(status, headers, body)
        }
    }
}
