...
impl ListDeliveryStreamsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_delivery_streams::ListDeliveryStreamsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_delivery_streams::ListDeliveryStreamsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_delivery_streams::ListDeliveryStreamsOutput, crate::operation::list_delivery_streams::ListDeliveryStreamsError, Self> {
