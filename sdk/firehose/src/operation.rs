...
/// Operation shape for `CreateDeliveryStream`.
            ...
            /// [`create_delivery_stream`](crate::client::fluent_builders::CreateDeliveryStream).
            ///
            /// `ParseStrictResponse` impl for `CreateDeliveryStream`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDeliveryStream {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_delivery_stream::de_create_delivery_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_delivery_stream::de_create_delivery_stream_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DeleteDeliveryStream`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`delete_delivery_stream`](crate::client::fluent_builders::DeleteDeliveryStream).
            ///
...
/// Operation shape for `DescribeDeliveryStream`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_delivery_stream`](crate::client::fluent_builders::DescribeDeliveryStream).
            ///
            /// `ParseStrictResponse` impl for `DescribeDeliveryStream`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDeliveryStream {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_delivery_stream::de_describe_delivery_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_delivery_stream::de_describe_delivery_stream_http_response(response)
                     }
                }
            }
...
/// Operation shape for `ListDeliveryStreams`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`list_delivery_streams`](crate::client::fluent_builders::ListDeliveryStreams).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for ListDeliveryStreams {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_delivery_streams::de_list_delivery_streams_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_delivery_streams::de_list_delivery_streams_http_response(response)
                     }
                }
            }
...
/// Operation shape for `ListTagsForDeliveryStream`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`list_tags_for_delivery_stream`](crate::client::fluent_builders::ListTagsForDeliveryStream).
            ///
            /// `ParseStrictResponse` impl for `ListTagsForDeliveryStream`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for ListTagsForDeliveryStream {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_tags_for_delivery_stream::de_list_tags_for_delivery_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_tags_for_delivery_stream::de_list_tags_for_delivery_stream_http_response(response)
                     }
                }
            }
...
/// Operation shape for `PutRecordBatch`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`put_record_batch`](crate::client::fluent_builders::PutRecordBatch).
            ///
            /// `ParseStrictResponse` impl for `PutRecordBatch`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for PutRecordBatch {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_record_batch::de_put_record_batch_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_record_batch::de_put_record_batch_http_response(response)
                     }
                }
            }
...
/// Operation shape for `StartDeliveryStreamEncryption`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`start_delivery_stream_encryption`](crate::client::fluent_builders::StartDeliveryStreamEncryption).
            ///
            /// `ParseStrictResponse` impl for `StartDeliveryStreamEncryption`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for StartDeliveryStreamEncryption {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_delivery_stream_encryption::de_start_delivery_stream_encryption_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_delivery_stream_encryption::de_start_delivery_stream_encryption_http_response(response)
                     }
                }
            }
...
/// Operation shape for `StopDeliveryStreamEncryption`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`stop_delivery_stream_encryption`](crate::client::fluent_builders::StopDeliveryStreamEncryption).
            ///
            /// `ParseStrictResponse` impl for `StopDeliveryStreamEncryption`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for StopDeliveryStreamEncryption {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_stop_delivery_stream_encryption::de_stop_delivery_stream_encryption_http_error(response)
                     } else {
                        crate::protocol_serde::shape_stop_delivery_stream_encryption::de_stop_delivery_stream_encryption_http_response(response)
                     }
                }
            }
...
/// Operation shape for `TagDeliveryStream`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`tag_delivery_stream`](crate::client::fluent_builders::TagDeliveryStream).
            ///
            /// `ParseStrictResponse` impl for `TagDeliveryStream`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for TagDeliveryStream {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_tag_delivery_stream::de_tag_delivery_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_tag_delivery_stream::de_tag_delivery_stream_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UntagDeliveryStream`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`untag_delivery_stream`](crate::client::fluent_builders::UntagDeliveryStream).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for UntagDeliveryStream {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_untag_delivery_stream::de_untag_delivery_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_untag_delivery_stream::de_untag_delivery_stream_http_response(response)
                     }
                }
            }
