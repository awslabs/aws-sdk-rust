...
impl super::Client {
    ...
    pub fn delete_delivery_stream(
        &self,
    ) -> crate::operation::delete_delivery_stream::builders::DeleteDeliveryStreamFluentBuilder {
        crate::operation::delete_delivery_stream::builders::DeleteDeliveryStreamFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
