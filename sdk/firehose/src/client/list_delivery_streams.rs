...
impl super::Client {
    ...
    ///   - [`exclusive_start_delivery_stream_name(impl ::std::convert::Into<String>)`](crate::operation::list_delivery_streams::builders::ListDeliveryStreamsFluentBuilder::exclusive_start_delivery_stream_name) / [`set_exclusive_start_delivery_stream_name(Option<String>)`](crate::operation::list_delivery_streams::builders::ListDeliveryStreamsFluentBuilder::set_exclusive_start_delivery_stream_name): <p>The list of delivery streams returned by this call to <code>ListDeliveryStreams</code> will start with the delivery stream whose name comes alphabetically immediately after the name you specify in <code>ExclusiveStartDeliveryStreamName</code>.</p>
