...
impl super::Client {
    ...
    ///   - [`delivery_stream_name(impl Into<String>)`](crate::operation::describe_delivery_stream::builders::DescribeDeliveryStreamFluentBuilder::delivery_stream_name) / [`set_delivery_stream_name(Option<String>)`](crate::operation::describe_delivery_stream::builders::DescribeDeliveryStreamFluentBuilder::set_delivery_stream_name):<br>required: **true**<br><p>The name of the delivery stream.</p><br>
    ///   - [`limit(i32)`](crate::operation::describe_delivery_stream::builders::DescribeDeliveryStreamFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_delivery_stream::builders::DescribeDeliveryStreamFluentBuilder::set_limit):<br>required: **false**<br><p>The limit on the number of destinations to return. You can have one destination per delivery stream.</p><br>
    ///   - [`exclusive_start_destination_id(impl Into<String>)`](crate::operation::describe_delivery_stream::builders::DescribeDeliveryStreamFluentBuilder::exclusive_start_destination_id) / [`set_exclusive_start_destination_id(Option<String>)`](crate::operation::describe_delivery_stream::builders::DescribeDeliveryStreamFluentBuilder::set_exclusive_start_destination_id):<br>required: **false**<br><p>The ID of the destination to start returning the destination information. Kinesis Data Firehose supports one destination per delivery stream.</p><br>
