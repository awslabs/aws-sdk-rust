...
impl super::Client {
    ...
    ///   - [`delivery_stream_name(impl ::std::convert::Into<String>)`](crate::operation::put_record_batch::builders::PutRecordBatchFluentBuilder::delivery_stream_name) / [`set_delivery_stream_name(Option<String>)`](crate::operation::put_record_batch::builders::PutRecordBatchFluentBuilder::set_delivery_stream_name): <p>The name of the delivery stream.</p>
