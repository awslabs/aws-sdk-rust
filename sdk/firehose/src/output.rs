...
pub struct PutRecordBatchOutput  {
    ...
    #[doc(hidden)]pub failed_put_count: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub request_responses: std::option::Option<std::vec::Vec<crate::model::PutRecordBatchResponseEntry>>,
}
...
pub struct PutRecordOutput  {
    ...
    #[doc(hidden)]pub record_id: std::option::Option<std::string::String>,
    /// <p>Indicates whether server-side encryption (SSE) was enabled during this operation.</p>
    #[doc(hidden)]pub encrypted: std::option::Option<bool>,
}
...
pub struct ListDeliveryStreamsOutput  {
    ...
    #[doc(hidden)]pub delivery_stream_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Indicates whether there are more delivery streams available to list.</p>
    #[doc(hidden)]pub has_more_delivery_streams: std::option::Option<bool>,
}
...
pub struct DescribeDeliveryStreamOutput  {
    ...
    #[doc(hidden)]pub delivery_stream_description: std::option::Option<crate::model::DeliveryStreamDescription>,
}
...
impl  std::fmt::Debug for DescribeDeliveryStreamOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("delivery_stream_description", &self.delivery_stream_description);
        formatter.finish()
    }
}
