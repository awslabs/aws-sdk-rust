...
pub struct VpcConfigurationDescription  {
    ...
    /// </ul>
    /// <p>If you revoke these permissions after you create the delivery stream, Firehose can't scale out by creating more ENIs when necessary. You might therefore see a degradation in performance.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::VpcConfigurationDescription {
                ...
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building VpcConfigurationDescription")
                    )?
                ,
