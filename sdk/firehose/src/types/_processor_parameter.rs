        ...
        ::std::result::Result::Ok(
            crate::types::ProcessorParameter {
                parameter_name: self.parameter_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("parameter_name", "parameter_name was not specified but it is required when building ProcessorParameter")
                    )?
                ,
                parameter_value: self.parameter_value
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("parameter_value", "parameter_value was not specified but it is required when building ProcessorParameter")
                    )?
                ,
            }
        )
