...
other => ProcessorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for ProcessorType {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(ProcessorType::from(s))
                    }
                }
impl ProcessorType {
    ...
    ProcessorType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AppendDelimiterToRecord", "CloudWatchLogProcessing", "Decompression", "Lambda", "MetadataExtraction", "RecordDeAggregation"]
                }
            }
