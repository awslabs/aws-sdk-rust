...
impl  CopyCommand  {
    ...
    pub fn data_table_name(&self) -> & str {
        use std::ops::Deref; self.data_table_name.deref()
    }
    /// <p>A comma-separated list of column names.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::CopyCommand {
                data_table_name: self.data_table_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_table_name", "data_table_name was not specified but it is required when building CopyCommand")
                    )?
                ,
