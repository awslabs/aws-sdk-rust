...
impl ::std::convert::From<&str> for HecEndpointType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HecEndpointType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HecEndpointType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HecEndpointType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HecEndpointType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
