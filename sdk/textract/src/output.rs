...
pub struct GetExpenseAnalysisOutput  {
    ...
    #[doc(hidden)]pub document_metadata: std::option::Option<crate::model::DocumentMetadata>,
    ...
    #[doc(hidden)]pub expense_documents: std::option::Option<std::vec::Vec<crate::model::ExpenseDocument>>,
    /// <p>A list of warnings that occurred during the text-detection operation for the document.</p>
    #[doc(hidden)]pub warnings: std::option::Option<std::vec::Vec<crate::model::Warning>>,
    ...
    #[doc(hidden)]pub analyze_expense_model_version: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetExpenseAnalysisOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("analyze_expense_model_version", &self.analyze_expense_model_version);
        formatter.finish()
    }
}
...
pub struct GetDocumentTextDetectionOutput  {
    ...
    #[doc(hidden)]pub blocks: std::option::Option<std::vec::Vec<crate::model::Block>>,
    /// <p>A list of warnings that occurred during the text-detection operation for the document.</p>
    #[doc(hidden)]pub warnings: std::option::Option<std::vec::Vec<crate::model::Warning>>,
    /// <p>Returns if the detection job could not be completed. Contains explanation for what error occured. </p>
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
    /// <p></p>
    #[doc(hidden)]pub detect_document_text_model_version: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetDocumentTextDetectionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("warnings", &self.warnings);
        formatter.field("status_message", &self.status_message);
        formatter.field("detect_document_text_model_version", &self.detect_document_text_model_version);
        formatter.finish()
    }
}
...
pub struct GetDocumentAnalysisOutput  {
    ...
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
    /// <p></p>
    #[doc(hidden)]pub analyze_document_model_version: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetDocumentAnalysisOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("warnings", &self.warnings);
        formatter.field("status_message", &self.status_message);
        formatter.field("analyze_document_model_version", &self.analyze_document_model_version);
        formatter.finish()
    }
}
...
pub struct AnalyzeIdOutput  {
    ...
    #[doc(hidden)]pub identity_documents: std::option::Option<std::vec::Vec<crate::model::IdentityDocument>>,
    /// <p>Information about the input document.</p>
    #[doc(hidden)]pub document_metadata: std::option::Option<crate::model::DocumentMetadata>,
    /// <p>The version of the AnalyzeIdentity API being used to process documents.</p>
    #[doc(hidden)]pub analyze_id_model_version: std::option::Option<std::string::String>,
}
...
pub struct AnalyzeDocumentOutput  {
    ...
    #[doc(hidden)]pub human_loop_activation_output: std::option::Option<crate::model::HumanLoopActivationOutput>,
...
impl  std::fmt::Debug for AnalyzeDocumentOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("document_metadata", &self.document_metadata);
        formatter.field("blocks", &self.blocks);
        formatter.field("human_loop_activation_output", &self.human_loop_activation_output);
        formatter.field("analyze_document_model_version", &self.analyze_document_model_version);
        formatter.finish()
    }
}
