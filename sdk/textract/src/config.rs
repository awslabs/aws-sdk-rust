...
impl Builder {
    ...
    /// use aws_sdk_textract::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_textract::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
