...
pub fn ser_start_lending_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_lending_analysis::StartLendingAnalysisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
