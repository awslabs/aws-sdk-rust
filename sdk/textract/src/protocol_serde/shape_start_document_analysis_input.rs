...
pub fn ser_start_document_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartDocumentAnalysisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
