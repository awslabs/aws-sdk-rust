    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AnalyzeDocumentInput`](crate::input::AnalyzeDocumentInput) with field(s):
    ///   - [`document(Option<Document>)`](crate::input::AnalyzeDocumentInput::document): <p>The input document as base64-encoded bytes or an Amazon S3 object. If you use the AWS CLI to call Amazon Textract operations, you can't pass image bytes. The document must be an image in JPEG or PNG format.</p>  <p>If you're using an AWS SDK to call Amazon Textract, you might not need to base64-encode image bytes that are passed using the <code>Bytes</code> field. </p>
    ///   - [`feature_types(Option<Vec<FeatureType>>)`](crate::input::AnalyzeDocumentInput::feature_types): <p>A list of the types of analysis to perform. Add TABLES to the list to return information about the tables that are detected in the input document. Add FORMS to return detected form data. To perform both types of analysis, add TABLES and FORMS to <code>FeatureTypes</code>. All lines and words detected in the document are included in the response (including text that isn't related to the value of <code>FeatureTypes</code>). </p>
    ///   - [`human_loop_config(Option<HumanLoopConfig>)`](crate::input::AnalyzeDocumentInput::human_loop_config): <p>Sets the configuration for the human in the loop workflow for analyzing documents.</p>
    ...
    ///
    /// - Takes [`AnalyzeIdInput`](crate::input::AnalyzeIdInput) with field(s):
    ///   - [`document_pages(Option<Vec<Document>>)`](crate::input::AnalyzeIdInput::document_pages): <p>The document being passed to AnalyzeID.</p>
    ...
    ///
    /// - Takes [`DetectDocumentTextInput`](crate::input::DetectDocumentTextInput) with field(s):
    ///   - [`document(Option<Document>)`](crate::input::DetectDocumentTextInput::document): <p>The input document as base64-encoded bytes or an Amazon S3 object. If you use the AWS CLI to call Amazon Textract operations, you can't pass image bytes. The document must be an image in JPEG or PNG format.</p>  <p>If you're using an AWS SDK to call Amazon Textract, you might not need to base64-encode image bytes that are passed using the <code>Bytes</code> field. </p>
    ...
    ///
    /// - Takes [`GetDocumentAnalysisInput`](crate::input::GetDocumentAnalysisInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetDocumentAnalysisInput::job_id): <p>A unique identifier for the text-detection job. The <code>JobId</code> is returned from <code>StartDocumentAnalysis</code>. A <code>JobId</code> value is only valid for 7 days.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetDocumentAnalysisInput::max_results): <p>The maximum number of results to return per paginated call. The largest value that you can specify is 1,000. If you specify a value greater than 1,000, a maximum of 1,000 results is returned. The default value is 1,000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetDocumentAnalysisInput::next_token): <p>If the previous response was incomplete (because there are more blocks to retrieve), Amazon Textract returns a pagination token in the response. You can use this pagination token to retrieve the next set of blocks.</p>
    ...
    ///
    /// - Takes [`GetDocumentTextDetectionInput`](crate::input::GetDocumentTextDetectionInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetDocumentTextDetectionInput::job_id): <p>A unique identifier for the text detection job. The <code>JobId</code> is returned from <code>StartDocumentTextDetection</code>. A <code>JobId</code> value is only valid for 7 days.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetDocumentTextDetectionInput::max_results): <p>The maximum number of results to return per paginated call. The largest value you can specify is 1,000. If you specify a value greater than 1,000, a maximum of 1,000 results is returned. The default value is 1,000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetDocumentTextDetectionInput::next_token): <p>If the previous response was incomplete (because there are more blocks to retrieve), Amazon Textract returns a pagination token in the response. You can use this pagination token to retrieve the next set of blocks.</p>
    ...
    ///
    /// - Takes [`GetExpenseAnalysisInput`](crate::input::GetExpenseAnalysisInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetExpenseAnalysisInput::job_id): <p>A unique identifier for the text detection job. The <code>JobId</code> is returned from <code>StartExpenseAnalysis</code>. A <code>JobId</code> value is only valid for 7 days.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetExpenseAnalysisInput::max_results): <p>The maximum number of results to return per paginated call. The largest value you can specify is 20. If you specify a value greater than 20, a maximum of 20 results is returned. The default value is 20.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetExpenseAnalysisInput::next_token): <p>If the previous response was incomplete (because there are more blocks to retrieve), Amazon Textract returns a pagination token in the response. You can use this pagination token to retrieve the next set of blocks.</p>
    ...
    ///
    /// - Takes [`StartDocumentAnalysisInput`](crate::input::StartDocumentAnalysisInput) with field(s):
    ///   - [`document_location(Option<DocumentLocation>)`](crate::input::StartDocumentAnalysisInput::document_location): <p>The location of the document to be processed.</p>
    ///   - [`feature_types(Option<Vec<FeatureType>>)`](crate::input::StartDocumentAnalysisInput::feature_types): <p>A list of the types of analysis to perform. Add TABLES to the list to return information about the tables that are detected in the input document. Add FORMS to return detected form data. To perform both types of analysis, add TABLES and FORMS to <code>FeatureTypes</code>. All lines and words detected in the document are included in the response (including text that isn't related to the value of <code>FeatureTypes</code>). </p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartDocumentAnalysisInput::client_request_token): <p>The idempotent token that you use to identify the start request. If you use the same token with multiple <code>StartDocumentAnalysis</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidentally started more than once. For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/api-async.html">Calling Amazon Textract Asynchronous Operations</a>.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartDocumentAnalysisInput::job_tag): <p>An identifier that you specify that's included in the completion notification published to the Amazon SNS topic. For example, you can use <code>JobTag</code> to identify the type of document that the completion notification corresponds to (such as a tax form or a receipt).</p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartDocumentAnalysisInput::notification_channel): <p>The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to. </p>
    ///   - [`output_config(Option<OutputConfig>)`](crate::input::StartDocumentAnalysisInput::output_config): <p>Sets if the output will go to a customer defined bucket. By default, Amazon Textract will save the results internally to be accessed by the GetDocumentAnalysis operation.</p>
    ///   - [`kms_key_id(Option<String>)`](crate::input::StartDocumentAnalysisInput::kms_key_id): <p>The KMS key used to encrypt the inference results. This can be in either Key ID or Key Alias format. When a KMS key is provided, the KMS key will be used for server-side encryption of the objects in the customer bucket. When this parameter is not enabled, the result will be encrypted server side,using SSE-S3.</p>
    ...
    ///
    /// - Takes [`StartDocumentTextDetectionInput`](crate::input::StartDocumentTextDetectionInput) with field(s):
    ///   - [`document_location(Option<DocumentLocation>)`](crate::input::StartDocumentTextDetectionInput::document_location): <p>The location of the document to be processed.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartDocumentTextDetectionInput::client_request_token): <p>The idempotent token that's used to identify the start request. If you use the same token with multiple <code>StartDocumentTextDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidentally started more than once. For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/api-async.html">Calling Amazon Textract Asynchronous Operations</a>.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartDocumentTextDetectionInput::job_tag): <p>An identifier that you specify that's included in the completion notification published to the Amazon SNS topic. For example, you can use <code>JobTag</code> to identify the type of document that the completion notification corresponds to (such as a tax form or a receipt).</p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartDocumentTextDetectionInput::notification_channel): <p>The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to. </p>
    ///   - [`output_config(Option<OutputConfig>)`](crate::input::StartDocumentTextDetectionInput::output_config): <p>Sets if the output will go to a customer defined bucket. By default Amazon Textract will save the results internally to be accessed with the GetDocumentTextDetection operation.</p>
    ///   - [`kms_key_id(Option<String>)`](crate::input::StartDocumentTextDetectionInput::kms_key_id): <p>The KMS key used to encrypt the inference results. This can be in either Key ID or Key Alias format. When a KMS key is provided, the KMS key will be used for server-side encryption of the objects in the customer bucket. When this parameter is not enabled, the result will be encrypted server side,using SSE-S3.</p>
    ...
    ///
    /// - Takes [`StartExpenseAnalysisInput`](crate::input::StartExpenseAnalysisInput) with field(s):
    ///   - [`document_location(Option<DocumentLocation>)`](crate::input::StartExpenseAnalysisInput::document_location): <p>The location of the document to be processed.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartExpenseAnalysisInput::client_request_token): <p>The idempotent token that's used to identify the start request. If you use the same token with multiple <code>StartDocumentTextDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidentally started more than once. For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/api-async.html">Calling Amazon Textract Asynchronous Operations</a> </p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartExpenseAnalysisInput::job_tag): <p>An identifier you specify that's included in the completion notification published to the Amazon SNS topic. For example, you can use <code>JobTag</code> to identify the type of document that the completion notification corresponds to (such as a tax form or a receipt).</p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartExpenseAnalysisInput::notification_channel): <p>The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to. </p>
    ///   - [`output_config(Option<OutputConfig>)`](crate::input::StartExpenseAnalysisInput::output_config): <p>Sets if the output will go to a customer defined bucket. By default, Amazon Textract will save the results internally to be accessed by the <code>GetExpenseAnalysis</code> operation.</p>
    ///   - [`kms_key_id(Option<String>)`](crate::input::StartExpenseAnalysisInput::kms_key_id): <p>The KMS key used to encrypt the inference results. This can be in either Key ID or Key Alias format. When a KMS key is provided, the KMS key will be used for server-side encryption of the objects in the customer bucket. When this parameter is not enabled, the result will be encrypted server side,using SSE-S3.</p>
