...
impl GetExpenseAnalysisInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_expense_analysis::ser_get_expense_analysis_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetExpenseAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_expense_analysis::de_get_expense_analysis_http_response_with_props(status, headers, body)
        }
    }
}
