...
impl StartLendingAnalysis {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_lending_analysis::StartLendingAnalysisError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_lending_analysis::StartLendingAnalysisOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Textract", "StartLendingAnalysis", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Textract.StartLendingAnalysis",
                "rpc.service" = "Textract",
                "rpc.method" = "StartLendingAnalysis",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartLendingAnalysis {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartLendingAnalysisRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartLendingAnalysisResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartLendingAnalysis")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartLendingAnalysis")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartLendingAnalysisTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartLendingAnalysisTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartLendingAnalysisTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartLendingAnalysisInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartLendingAnalysisResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_lending_analysis::de_start_lending_analysis_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_lending_analysis::de_start_lending_analysis_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartLendingAnalysisRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_lending_analysis::StartLendingAnalysisInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_lending_analysis::StartLendingAnalysisInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_lending_analysis::ser_start_lending_analysis_input(
            &input,
        )?);
