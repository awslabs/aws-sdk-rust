...
impl StartLendingAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`StartLendingAnalysis`](crate::operation::start_lending_analysis::StartLendingAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_lending_analysis::StartLendingAnalysis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_lending_analysis::StartLendingAnalysisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_lending_analysis::ser_start_lending_analysis_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_lending_analysis::StartLendingAnalysis::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartLendingAnalysis {
                type Output = std::result::Result<crate::operation::start_lending_analysis::StartLendingAnalysisOutput, crate::operation::start_lending_analysis::StartLendingAnalysisError>;
