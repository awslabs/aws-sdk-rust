...
impl GetDocumentTextDetectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_document_text_detection::GetDocumentTextDetectionInput, ::aws_smithy_types::error::operation::BuildError> {
