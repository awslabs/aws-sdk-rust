...
impl GetExpenseAnalysisFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_expense_analysis::GetExpenseAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_expense_analysis::GetExpenseAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_expense_analysis::GetExpenseAnalysisOutput, crate::operation::get_expense_analysis::GetExpenseAnalysisError, Self> {
