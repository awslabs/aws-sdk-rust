...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateAdapterVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateAdapterVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_adapter_version::ser_create_adapter_version_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateAdapterVersionEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateAdapterVersionError {
