...
pub type CreateAdapterVersionErrorKind = CreateAdapterVersionError;
...
impl CreateAdapterVersionError {
    ...
    /// Creates the `CreateAdapterVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
