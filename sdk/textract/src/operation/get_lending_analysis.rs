...
impl GetLendingAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`GetLendingAnalysis`](crate::operation::get_lending_analysis::GetLendingAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_lending_analysis::GetLendingAnalysis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_lending_analysis::GetLendingAnalysisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_lending_analysis::ser_get_lending_analysis_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_lending_analysis::GetLendingAnalysis::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLendingAnalysis {
                type Output = std::result::Result<crate::operation::get_lending_analysis::GetLendingAnalysisOutput, crate::operation::get_lending_analysis::GetLendingAnalysisError>;
