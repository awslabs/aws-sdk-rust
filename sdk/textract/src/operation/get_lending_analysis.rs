...
/// Orchestration and serialization glue logic for `GetLendingAnalysis`.
...
impl GetLendingAnalysis {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_lending_analysis::GetLendingAnalysisInput,
                    ) -> ::std::result::Result<crate::operation::get_lending_analysis::GetLendingAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lending_analysis::GetLendingAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_lending_analysis::GetLendingAnalysisError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_lending_analysis::GetLendingAnalysisOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLendingAnalysis {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLendingAnalysis");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLendingAnalysisRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLendingAnalysisResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLendingAnalysis")
...
.with_interceptor(GetLendingAnalysisEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_lending_analysis::GetLendingAnalysisError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_lending_analysis::GetLendingAnalysisError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_lending_analysis::GetLendingAnalysisError>::new());
...
#[derive(Debug)]
            struct GetLendingAnalysisResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLendingAnalysisResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_lending_analysis::de_get_lending_analysis_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_lending_analysis::de_get_lending_analysis_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetLendingAnalysisRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLendingAnalysisRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_lending_analysis::GetLendingAnalysisInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_lending_analysis::GetLendingAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_lending_analysis::ser_get_lending_analysis_input(&input)?);
...
#[derive(Debug)]
            struct GetLendingAnalysisEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLendingAnalysisEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetLendingAnalysisEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLendingAnalysisInput>()
                        .ok_or("failed to downcast to GetLendingAnalysisInput")?;
...
pub enum GetLendingAnalysisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLendingAnalysisError) for what information is available for the error.")]
...
impl GetLendingAnalysisError {
    /// Creates the `GetLendingAnalysisError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLendingAnalysisError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidJobIdException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLendingAnalysisError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_lending_analysis::GetLendingAnalysisError {
...
mod _get_lending_analysis_output;
