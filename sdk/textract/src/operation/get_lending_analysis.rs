...
impl GetLendingAnalysisInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_lending_analysis::GetLendingAnalysis,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_lending_analysis::ser_get_lending_analysis_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLendingAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lending_analysis::de_get_lending_analysis_http_response_with_props(status, headers, body)
        }
    }
}
