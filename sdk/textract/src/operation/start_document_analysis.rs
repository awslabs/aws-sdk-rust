...
impl StartDocumentAnalysis {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_document_analysis::StartDocumentAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_document_analysis::StartDocumentAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_document_analysis::StartDocumentAnalysisError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_document_analysis::StartDocumentAnalysisOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDocumentAnalysis {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartDocumentAnalysis");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartDocumentAnalysisRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartDocumentAnalysisResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDocumentAnalysis")
...
.with_interceptor(StartDocumentAnalysisEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_document_analysis::StartDocumentAnalysisError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_document_analysis::StartDocumentAnalysisError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_document_analysis::StartDocumentAnalysisError>::new());
...
#[derive(Debug)]
            struct StartDocumentAnalysisResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartDocumentAnalysisResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_document_analysis::de_start_document_analysis_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_document_analysis::de_start_document_analysis_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartDocumentAnalysisRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartDocumentAnalysisRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_document_analysis::StartDocumentAnalysisInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_document_analysis::StartDocumentAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_document_analysis::ser_start_document_analysis_input(&input)?);
...
#[derive(Debug)]
            struct StartDocumentAnalysisEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartDocumentAnalysisEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartDocumentAnalysisEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartDocumentAnalysisInput>()
                        .ok_or("failed to downcast to StartDocumentAnalysisInput")?;
...
pub enum StartDocumentAnalysisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartDocumentAnalysisError) for what information is available for the error.")]
...
impl StartDocumentAnalysisError {
    /// Creates the `StartDocumentAnalysisError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartDocumentAnalysisError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartDocumentAnalysisError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_document_analysis::StartDocumentAnalysisError {
...
mod _start_document_analysis_output;
