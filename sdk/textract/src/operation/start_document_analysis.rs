...
impl StartDocumentAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`StartDocumentAnalysis`](crate::operation::start_document_analysis::StartDocumentAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_document_analysis::StartDocumentAnalysis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_document_analysis::StartDocumentAnalysisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_document_analysis::StartDocumentAnalysis::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartDocumentAnalysis {
                type Output = std::result::Result<crate::operation::start_document_analysis::StartDocumentAnalysisOutput, crate::operation::start_document_analysis::StartDocumentAnalysisError>;
