...
impl AnalyzeExpenseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::analyze_expense::AnalyzeExpense, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_analyze_expense::ser_analyze_expense_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AnalyzeExpense {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_analyze_expense::de_analyze_expense_http_response_with_props(status, headers, body)
        }
    }
}
