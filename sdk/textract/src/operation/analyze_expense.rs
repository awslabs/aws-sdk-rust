...
impl AnalyzeExpenseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::analyze_expense::AnalyzeExpense,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::analyze_expense::AnalyzeExpense::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AnalyzeExpense {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_analyze_expense::de_analyze_expense_http_error(
                status, headers, body,
            )
        } else {
