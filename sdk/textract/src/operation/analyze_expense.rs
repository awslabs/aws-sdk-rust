...
impl AnalyzeExpenseInput {
    /// Consumes the builder and constructs an Operation<[`AnalyzeExpense`](crate::operation::analyze_expense::AnalyzeExpense)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::analyze_expense::AnalyzeExpense, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::analyze_expense::AnalyzeExpenseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::analyze_expense::AnalyzeExpense::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AnalyzeExpense {
                type Output = std::result::Result<crate::operation::analyze_expense::AnalyzeExpenseOutput, crate::operation::analyze_expense::AnalyzeExpenseError>;
