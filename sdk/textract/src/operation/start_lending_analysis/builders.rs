...
impl StartLendingAnalysisFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_lending_analysis::StartLendingAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_lending_analysis::StartLendingAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_lending_analysis::StartLendingAnalysisOutput, crate::operation::start_lending_analysis::StartLendingAnalysisError, Self> {
