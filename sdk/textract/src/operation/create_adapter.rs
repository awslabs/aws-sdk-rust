    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAdapter")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreateAdapterEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateAdapterResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateAdapterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_adapter::ser_create_adapter_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateAdapterEndpointParamsInterceptor {
...
pub type CreateAdapterErrorKind = CreateAdapterError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateAdapterError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_adapter::CreateAdapterError {
...
impl CreateAdapterError {
    ...
    /// Creates the `CreateAdapterError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
