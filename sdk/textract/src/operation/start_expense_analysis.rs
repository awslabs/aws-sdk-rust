...
impl StartExpenseAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`StartExpenseAnalysis`](crate::operation::start_expense_analysis::StartExpenseAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_expense_analysis::StartExpenseAnalysis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_expense_analysis::StartExpenseAnalysisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_expense_analysis::ser_start_expense_analysis_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_expense_analysis::StartExpenseAnalysis::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartExpenseAnalysis {
                type Output = std::result::Result<crate::operation::start_expense_analysis::StartExpenseAnalysisOutput, crate::operation::start_expense_analysis::StartExpenseAnalysisError>;
