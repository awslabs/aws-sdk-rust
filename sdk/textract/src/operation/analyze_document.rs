...
impl AnalyzeDocument {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::analyze_document::AnalyzeDocumentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::analyze_document::AnalyzeDocumentOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("textract", "AnalyzeDocument", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AnalyzeDocument {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AnalyzeDocumentResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AnalyzeDocument", "textract"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AnalyzeDocumentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::analyze_document::AnalyzeDocumentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::analyze_document::AnalyzeDocumentInput,
