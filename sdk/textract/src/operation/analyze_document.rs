...
impl AnalyzeDocumentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::analyze_document::AnalyzeDocument, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_analyze_document::ser_analyze_document_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AnalyzeDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_analyze_document::de_analyze_document_http_response_with_props(status, headers, body)
        }
    }
}
