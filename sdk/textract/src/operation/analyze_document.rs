...
impl AnalyzeDocumentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::analyze_document::AnalyzeDocument::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AnalyzeDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_analyze_document::de_analyze_document_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::analyze_document::AnalyzeDocumentError
{
