...
impl AnalyzeDocumentInput {
    /// Consumes the builder and constructs an Operation<[`AnalyzeDocument`](crate::operation::analyze_document::AnalyzeDocument)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::analyze_document::AnalyzeDocument, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::analyze_document::AnalyzeDocumentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::analyze_document::AnalyzeDocument::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AnalyzeDocument {
                type Output = std::result::Result<crate::operation::analyze_document::AnalyzeDocumentOutput, crate::operation::analyze_document::AnalyzeDocumentError>;
