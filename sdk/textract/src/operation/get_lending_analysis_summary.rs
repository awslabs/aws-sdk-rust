...
impl GetLendingAnalysisSummaryInput {
    /// Consumes the builder and constructs an Operation<[`GetLendingAnalysisSummary`](crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummary::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLendingAnalysisSummary {
                type Output = std::result::Result<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryOutput, crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError>;
