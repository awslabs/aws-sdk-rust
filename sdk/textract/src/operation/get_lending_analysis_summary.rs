...
/// Orchestration and serialization glue logic for `GetLendingAnalysisSummary`.
...
impl GetLendingAnalysisSummary {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLendingAnalysisSummary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLendingAnalysisSummary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLendingAnalysisSummaryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLendingAnalysisSummaryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLendingAnalysisSummary")
...
.with_interceptor(GetLendingAnalysisSummaryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError>::new());
...
#[derive(Debug)]
            struct GetLendingAnalysisSummaryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLendingAnalysisSummaryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_lending_analysis_summary::de_get_lending_analysis_summary_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetLendingAnalysisSummaryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLendingAnalysisSummaryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_lending_analysis_summary::ser_get_lending_analysis_summary_input(&input)?);
...
#[derive(Debug)]
            struct GetLendingAnalysisSummaryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLendingAnalysisSummaryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetLendingAnalysisSummaryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLendingAnalysisSummaryInput>()
                        .ok_or("failed to downcast to GetLendingAnalysisSummaryInput")?;
...
pub enum GetLendingAnalysisSummaryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLendingAnalysisSummaryError) for what information is available for the error.")]
...
impl GetLendingAnalysisSummaryError {
    /// Creates the `GetLendingAnalysisSummaryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLendingAnalysisSummaryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLendingAnalysisSummaryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_lending_analysis_summary::_get_lending_analysis_summary_output::GetLendingAnalysisSummaryOutput;

pub use crate::operation::get_lending_analysis_summary::_get_lending_analysis_summary_input::GetLendingAnalysisSummaryInput;

mod _get_lending_analysis_summary_input;

mod _get_lending_analysis_summary_output;
