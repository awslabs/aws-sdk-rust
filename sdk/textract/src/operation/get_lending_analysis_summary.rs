...
impl GetLendingAnalysisSummaryInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummary::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLendingAnalysisSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lending_analysis_summary::de_get_lending_analysis_summary_http_response_with_props(status, headers, body)
        }
    }
}
