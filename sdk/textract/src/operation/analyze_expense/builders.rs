...
impl AnalyzeExpenseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::analyze_expense::AnalyzeExpenseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::analyze_expense::AnalyzeExpenseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::analyze_expense::AnalyzeExpenseOutput, crate::operation::analyze_expense::AnalyzeExpenseError, Self> {
