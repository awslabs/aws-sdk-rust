...
impl DetectDocumentTextInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_document_text::ser_detect_document_text_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectDocumentText {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_document_text::de_detect_document_text_http_response_with_props(status, headers, body)
        }
    }
}
