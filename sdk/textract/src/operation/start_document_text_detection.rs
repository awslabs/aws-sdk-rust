...
impl StartDocumentTextDetectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_document_text_detection::StartDocumentTextDetection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDocumentTextDetection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_document_text_detection::de_start_document_text_detection_http_response_with_props(
                status, headers, body,
            )
        }
    }
