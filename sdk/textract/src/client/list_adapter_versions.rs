...
impl super::Client {
    ...
    ///   - [`adapter_id(impl Into<String>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::adapter_id) / [`set_adapter_id(Option<String>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::set_adapter_id): <p>A string containing a unique ID for the adapter to match for when listing adapter versions.</p>
    ///   - [`after_creation_time(DateTime)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::after_creation_time) / [`set_after_creation_time(Option<DateTime>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::set_after_creation_time): <p>Specifies the lower bound for the ListAdapterVersions operation. Ensures ListAdapterVersions returns only adapter versions created after the specified creation time.</p>
    ///   - [`before_creation_time(DateTime)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::before_creation_time) / [`set_before_creation_time(Option<DateTime>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::set_before_creation_time): <p>Specifies the upper bound for the ListAdapterVersions operation. Ensures ListAdapterVersions returns only adapter versions created after the specified creation time.</p>
    ///   - [`max_results(i32)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::set_max_results): <p>The maximum number of results to return when listing adapter versions.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_adapter_versions::builders::ListAdapterVersionsFluentBuilder::set_next_token): <p>Identifies the next page of results to return when listing adapter versions.</p>
