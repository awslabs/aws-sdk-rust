...
impl super::Client {
    ...
    ///   - [`after_creation_time(DateTime)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::after_creation_time) / [`set_after_creation_time(Option<DateTime>)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::set_after_creation_time): <p>Specifies the lower bound for the ListAdapters operation. Ensures ListAdapters returns only adapters created after the specified creation time.</p>
    ///   - [`before_creation_time(DateTime)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::before_creation_time) / [`set_before_creation_time(Option<DateTime>)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::set_before_creation_time): <p>Specifies the upper bound for the ListAdapters operation. Ensures ListAdapters returns only adapters created before the specified creation time.</p>
    ///   - [`max_results(i32)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::set_max_results): <p>The maximum number of results to return when listing adapters.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_adapters::builders::ListAdaptersFluentBuilder::set_next_token): <p>Identifies the next page of results to return when listing adapters.</p>
