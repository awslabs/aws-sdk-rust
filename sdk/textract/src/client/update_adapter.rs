...
impl super::Client {
    ...
    ///   - [`adapter_id(impl Into<String>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::adapter_id) / [`set_adapter_id(Option<String>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::set_adapter_id): <p>A string containing a unique ID for the adapter that will be updated.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::set_description): <p>The new description to be applied to the adapter.</p>
    ///   - [`adapter_name(impl Into<String>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::adapter_name) / [`set_adapter_name(Option<String>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::set_adapter_name): <p>The new name to be applied to the adapter.</p>
    ///   - [`auto_update(AutoUpdate)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::auto_update) / [`set_auto_update(Option<AutoUpdate>)`](crate::operation::update_adapter::builders::UpdateAdapterFluentBuilder::set_auto_update): <p>The new auto-update status to be applied to the adapter.</p>
