...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_document_analysis::builders::GetDocumentAnalysisFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_document_analysis::builders::GetDocumentAnalysisFluentBuilder::set_job_id):<br>required: **true**<br><p>A unique identifier for the text-detection job. The <code>JobId</code> is returned from <code>StartDocumentAnalysis</code>. A <code>JobId</code> value is only valid for 7 days.</p><br>
    ///   - [`max_results(i32)`](crate::operation::get_document_analysis::builders::GetDocumentAnalysisFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_document_analysis::builders::GetDocumentAnalysisFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return per paginated call. The largest value that you can specify is 1,000. If you specify a value greater than 1,000, a maximum of 1,000 results is returned. The default value is 1,000.</p><br>
