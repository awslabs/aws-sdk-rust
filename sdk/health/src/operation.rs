...
/// Operation shape for `DescribeAffectedAccountsForOrganization`.
            ...
            /// [`describe_affected_accounts_for_organization`](crate::client::fluent_builders::DescribeAffectedAccountsForOrganization).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAffectedAccountsForOrganization {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_affected_accounts_for_organization::de_describe_affected_accounts_for_organization_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_affected_accounts_for_organization::de_describe_affected_accounts_for_organization_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeAffectedEntities`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_affected_entities`](crate::client::fluent_builders::DescribeAffectedEntities).
            ///
            /// `ParseStrictResponse` impl for `DescribeAffectedEntities`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAffectedEntities {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_affected_entities::de_describe_affected_entities_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_affected_entities::de_describe_affected_entities_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeAffectedEntitiesForOrganization`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_affected_entities_for_organization`](crate::client::fluent_builders::DescribeAffectedEntitiesForOrganization).
            ///
...
/// Operation shape for `DescribeEntityAggregates`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_entity_aggregates`](crate::client::fluent_builders::DescribeEntityAggregates).
            ///
            /// `ParseStrictResponse` impl for `DescribeEntityAggregates`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEntityAggregates {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_entity_aggregates::de_describe_entity_aggregates_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_entity_aggregates::de_describe_entity_aggregates_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeEventAggregates`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_event_aggregates`](crate::client::fluent_builders::DescribeEventAggregates).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventAggregates {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_event_aggregates::de_describe_event_aggregates_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_event_aggregates::de_describe_event_aggregates_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeEventDetails`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_event_details`](crate::client::fluent_builders::DescribeEventDetails).
            ///
            /// `ParseStrictResponse` impl for `DescribeEventDetails`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventDetails {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_event_details::de_describe_event_details_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_event_details::de_describe_event_details_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeEventDetailsForOrganization`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_event_details_for_organization`](crate::client::fluent_builders::DescribeEventDetailsForOrganization).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventDetailsForOrganization {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_event_details_for_organization::de_describe_event_details_for_organization_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_event_details_for_organization::de_describe_event_details_for_organization_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeEventsForOrganization`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_events_for_organization`](crate::client::fluent_builders::DescribeEventsForOrganization).
            ///
            /// `ParseStrictResponse` impl for `DescribeEventsForOrganization`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventsForOrganization {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_events_for_organization::de_describe_events_for_organization_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_events_for_organization::de_describe_events_for_organization_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeEventTypes`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_event_types`](crate::client::fluent_builders::DescribeEventTypes).
            ///
            /// `ParseStrictResponse` impl for `DescribeEventTypes`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventTypes {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_event_types::de_describe_event_types_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_event_types::de_describe_event_types_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeHealthServiceStatusForOrganization`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_health_service_status_for_organization`](crate::client::fluent_builders::DescribeHealthServiceStatusForOrganization).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeHealthServiceStatusForOrganization {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_health_service_status_for_organization::de_describe_health_service_status_for_organization_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_health_service_status_for_organization::de_describe_health_service_status_for_organization_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DisableHealthServiceAccessForOrganization`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`disable_health_service_access_for_organization`](crate::client::fluent_builders::DisableHealthServiceAccessForOrganization).
            ///
...
/// Operation shape for `EnableHealthServiceAccessForOrganization`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`enable_health_service_access_for_organization`](crate::client::fluent_builders::EnableHealthServiceAccessForOrganization).
            ///
