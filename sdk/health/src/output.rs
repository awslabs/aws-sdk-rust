...
pub struct DescribeHealthServiceStatusForOrganizationOutput  {
    ...
    #[doc(hidden)]pub health_service_access_status_for_organization: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeHealthServiceStatusForOrganizationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("health_service_access_status_for_organization", &self.health_service_access_status_for_organization);
        formatter.finish()
    }
}
...
pub struct DescribeEventsForOrganizationOutput  {
    ...
    #[doc(hidden)]pub events: std::option::Option<std::vec::Vec<crate::model::OrganizationEvent>>,
    /// <p>If the results of a search are large, only a portion of the results are returned, and a <code>nextToken</code> pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeEventDetailsForOrganizationOutput  {
    ...
    #[doc(hidden)]pub successful_set: std::option::Option<std::vec::Vec<crate::model::OrganizationEventDetails>>,
    /// <p>Error messages for any events that could not be retrieved.</p>
    #[doc(hidden)]pub failed_set: std::option::Option<std::vec::Vec<crate::model::OrganizationEventDetailsErrorItem>>,
}
...
pub struct DescribeEventDetailsOutput  {
    /// <p>Information about the events that could be retrieved.</p>
    #[doc(hidden)]pub successful_set: std::option::Option<std::vec::Vec<crate::model::EventDetails>>,
    /// <p>Error messages for any events that could not be retrieved.</p>
    #[doc(hidden)]pub failed_set: std::option::Option<std::vec::Vec<crate::model::EventDetailsErrorItem>>,
}
...
pub struct DescribeEventAggregatesOutput  {
    ...
    #[doc(hidden)]pub event_aggregates: std::option::Option<std::vec::Vec<crate::model::EventAggregate>>,
    /// <p>If the results of a search are large, only a portion of the results are returned, and a <code>nextToken</code> pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeEntityAggregatesOutput  {
    ...
    #[doc(hidden)]pub entity_aggregates: std::option::Option<std::vec::Vec<crate::model::EntityAggregate>>,
}
...
pub struct DescribeAffectedEntitiesForOrganizationOutput  {
    ...
    #[doc(hidden)]pub entities: std::option::Option<std::vec::Vec<crate::model::AffectedEntity>>,
    ...
    #[doc(hidden)]pub failed_set: std::option::Option<std::vec::Vec<crate::model::OrganizationAffectedEntitiesErrorItem>>,
    /// <p>If the results of a search are large, only a portion of the results are returned, and a <code>nextToken</code> pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeAffectedAccountsForOrganizationOutput  {
    ...
    #[doc(hidden)]pub affected_accounts: std::option::Option<std::vec::Vec<std::string::String>>,
