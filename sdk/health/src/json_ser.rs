...
pub fn serialize_structure_describe_affected_accounts_for_organization_input(
...
pub fn serialize_structure_describe_affected_entities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_4) = &input.filter {
        ...
        crate::json_ser::serialize_structure_entity_filter(&mut object_5, var_4);
        object_5.finish();
    }
...
pub fn serialize_structure_describe_affected_entities_for_organization_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_11 in var_9 {
            {
                ...
                crate::json_ser::serialize_structure_event_account_filter(&mut object_12, item_11);
                object_12.finish();
            }
        }
        array_10.finish();
...
pub fn serialize_structure_describe_entity_aggregates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_event_aggregates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_19) = &input.filter {
        ...
        crate::json_ser::serialize_structure_event_filter(&mut object_20, var_19);
        object_20.finish();
    }
...
pub fn serialize_structure_describe_event_details_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_event_details_for_organization_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_30 in var_28 {
            {
                ...
                crate::json_ser::serialize_structure_event_account_filter(&mut object_31, item_30);
                object_31.finish();
            }
        }
        array_29.finish();
...
pub fn serialize_structure_describe_events_input(
    ...
    if let Some(var_33) = &input.filter {
        ...
        crate::json_ser::serialize_structure_event_filter(&mut object_34, var_33);
        object_34.finish();
    }
...
pub fn serialize_structure_describe_events_for_organization_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_38) = &input.filter {
        ...
        crate::json_ser::serialize_structure_organization_event_filter(&mut object_39, var_38);
        object_39.finish();
    }
...
pub fn serialize_structure_describe_event_types_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::DescribeEventTypesInput,
) {
    if let Some(var_43) = &input.filter {
        let mut object_44 = object.key("filter").start_object();
        crate::json_ser::serialize_structure_event_type_filter(&mut object_44, var_43);
        object_44.finish();
    }
...
pub fn serialize_structure_entity_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_59 in var_57 {
            {
                ...
                crate::json_ser::serialize_structure_date_time_range(&mut object_60, item_59);
                object_60.finish();
            }
        }
        array_58.finish();
...
pub fn serialize_structure_event_account_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_89 in var_87 {
            {
                ...
                crate::json_ser::serialize_structure_date_time_range(&mut object_90, item_89);
                object_90.finish();
            }
        }
        array_88.finish();
        ...
        for item_93 in var_91 {
            {
                ...
                crate::json_ser::serialize_structure_date_time_range(&mut object_94, item_93);
                object_94.finish();
            }
        }
        array_92.finish();
        ...
        for item_97 in var_95 {
            {
                ...
                crate::json_ser::serialize_structure_date_time_range(&mut object_98, item_97);
                object_98.finish();
            }
        }
        array_96.finish();
...
pub fn serialize_structure_organization_event_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_129) = &input.start_time {
        ...
        crate::json_ser::serialize_structure_date_time_range(&mut object_130, var_129);
        object_130.finish();
    }
    if let Some(var_131) = &input.end_time {
        let mut object_132 = object.key("endTime").start_object();
        crate::json_ser::serialize_structure_date_time_range(&mut object_132, var_131);
        object_132.finish();
    }
    if let Some(var_133) = &input.last_updated_time {
        let mut object_134 = object.key("lastUpdatedTime").start_object();
        crate::json_ser::serialize_structure_date_time_range(&mut object_134, var_133);
        object_134.finish();
    }
...
pub fn serialize_structure_event_type_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_date_time_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_156) = &input.from {
        object
            .key("from")
            .instant(var_156, smithy_types::instant::Format::EpochSeconds);
    }
    if let Some(var_157) = &input.to {
        object
            .key("to")
            .instant(var_157, smithy_types::instant::Format::EpochSeconds);
    }
}
