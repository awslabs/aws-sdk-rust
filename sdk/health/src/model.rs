...
pub struct OrganizationEventDetailsErrorItem {
    ...
    /// <li> <p>Your Amazon Web Services account doesn't include the Amazon Web Services Support plan required to use the Health API. You must have either a Business or Enterprise Support plan.</p> </li>
    /// </ul>
