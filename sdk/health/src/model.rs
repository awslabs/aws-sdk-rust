...
pub struct EventType  {
    ...
    #[doc(hidden)]pub category: std::option::Option<crate::model::EventTypeCategory>,
}
impl EventType {
    /// <p>The Amazon Web Services service that is affected by the event. For example, <code>EC2</code>, <code>RDS</code>.</p>
...
pub mod event_type {
    ...
    impl Builder {
        ...
        /// <p>A list of event type category codes. Possible values are <code>issue</code>, <code>accountNotification</code>, or <code>scheduledChange</code>. Currently, the <code>investigation</code> value isn't supported at this time.</p>
        pub fn set_category(mut self, input: std::option::Option<crate::model::EventTypeCategory>) -> Self {
...
pub struct EventTypeFilter  {
    ...
    #[doc(hidden)]pub event_type_codes: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    /// <p>A list of event type category codes. Possible values are <code>issue</code>, <code>accountNotification</code>, or <code>scheduledChange</code>. Currently, the <code>investigation</code> value isn't supported at this time.</p>
    #[doc(hidden)]pub event_type_categories: std::option::Option<std::vec::Vec<crate::model::EventTypeCategory>>,
}
...
pub mod event_type_filter {
    ...
    pub struct Builder {
        ...
        pub(crate) event_type_categories: std::option::Option<std::vec::Vec<crate::model::EventTypeCategory>>,
    }
    impl Builder {
        ...
        /// <p>A list of event type category codes. Possible values are <code>issue</code>, <code>accountNotification</code>, or <code>scheduledChange</code>. Currently, the <code>investigation</code> value isn't supported at this time.</p>
        pub fn set_event_type_categories(mut self, input: std::option::Option<std::vec::Vec<crate::model::EventTypeCategory>>) -> Self {
...
pub struct OrganizationEvent  {
    ...
    #[doc(hidden)]pub event_type_code: std::option::Option<std::string::String>,
    /// <p>A list of event type category codes. Possible values are <code>issue</code>, <code>accountNotification</code>, or <code>scheduledChange</code>. Currently, the <code>investigation</code> value isn't supported at this time.</p>
    #[doc(hidden)]pub event_type_category: std::option::Option<crate::model::EventTypeCategory>,
    ...
    /// </ul>
    #[doc(hidden)]pub event_scope_code: std::option::Option<crate::model::EventScopeCode>,
    ...
    #[doc(hidden)]pub status_code: std::option::Option<crate::model::EventStatusCode>,
}
...
pub mod organization_event {
    ...
    impl Builder {
        ...
        /// <p>A list of event type category codes. Possible values are <code>issue</code>, <code>accountNotification</code>, or <code>scheduledChange</code>. Currently, the <code>investigation</code> value isn't supported at this time.</p>
        pub fn set_event_type_category(mut self, input: std::option::Option<crate::model::EventTypeCategory>) -> Self {
        ...
        /// <p>The most recent status of the event. Possible values are <code>open</code>, <code>closed</code>, and <code>upcoming</code>.</p>
        pub fn set_status_code(mut self, input: std::option::Option<crate::model::EventStatusCode>) -> Self {
...
pub struct OrganizationEventFilter  {
    ...
    #[doc(hidden)]pub aws_account_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The Amazon Web Services services associated with the event. For example, <code>EC2</code>, <code>RDS</code>.</p>
    #[doc(hidden)]pub services: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub start_time: std::option::Option<crate::model::DateTimeRange>,
    /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
    #[doc(hidden)]pub end_time: std::option::Option<crate::model::DateTimeRange>,
    /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
    #[doc(hidden)]pub last_updated_time: std::option::Option<crate::model::DateTimeRange>,
    /// <p>A list of entity ARNs (unique identifiers).</p>
    #[doc(hidden)]pub entity_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of entity identifiers, such as EC2 instance IDs (i-34ab692e) or EBS volumes (vol-426ab23e).</p>
    #[doc(hidden)]pub entity_values: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of event type category codes. Possible values are <code>issue</code>, <code>accountNotification</code>, or <code>scheduledChange</code>. Currently, the <code>investigation</code> value isn't supported at this time.</p>
    #[doc(hidden)]pub event_type_categories: std::option::Option<std::vec::Vec<crate::model::EventTypeCategory>>,
    /// <p>A list of event status codes.</p>
    #[doc(hidden)]pub event_status_codes: std::option::Option<std::vec::Vec<crate::model::EventStatusCode>>,
}
...
pub mod organization_event_filter {
    ...
    pub struct Builder {
        ...
        pub(crate) event_type_categories: std::option::Option<std::vec::Vec<crate::model::EventTypeCategory>>,
        pub(crate) event_status_codes: std::option::Option<std::vec::Vec<crate::model::EventStatusCode>>,
    }
    impl Builder {
        /// Appends an item to `event_type_codes`.
        ///
        ...
        /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
        pub fn set_start_time(mut self, input: std::option::Option<crate::model::DateTimeRange>) -> Self {
            self.start_time = input; self
        }
        /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
        ...
        /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
        pub fn set_end_time(mut self, input: std::option::Option<crate::model::DateTimeRange>) -> Self {
            self.end_time = input; self
        }
        /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
        ...
        /// <p>A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter</a> and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter</a> objects. If <code>from</code> is set and <code>to</code> is set: match items where the timestamp (<code>startTime</code>, <code>endTime</code>, or <code>lastUpdatedTime</code>) is between <code>from</code> and <code>to</code> inclusive. If <code>from</code> is set and <code>to</code> is not set: match items where the timestamp value is equal to or after <code>from</code>. If <code>from</code> is not set and <code>to</code> is set: match items where the timestamp value is equal to or before <code>to</code>.</p>
        pub fn set_last_updated_time(mut self, input: std::option::Option<crate::model::DateTimeRange>) -> Self {
            self.last_updated_time = input; self
        }
        ...
        /// <p>A list of event status codes.</p>
        pub fn set_event_status_codes(mut self, input: std::option::Option<std::vec::Vec<crate::model::EventStatusCode>>) -> Self {
...
pub struct DateTimeRange  {
    ...
    #[doc(hidden)]pub from: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The ending date and time of a time range.</p>
    #[doc(hidden)]pub to: std::option::Option<aws_smithy_types::DateTime>,
}
impl DateTimeRange {
    /// <p>The starting date and time of a time range.</p>
...
pub struct EventFilter  {
    ...
    #[doc(hidden)]pub start_times: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>,
    /// <p>A list of dates and times that the event ended.</p>
    #[doc(hidden)]pub end_times: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>,
    /// <p>A list of dates and times that the event was last updated.</p>
    #[doc(hidden)]pub last_updated_times: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>,
    /// <p>A list of entity ARNs (unique identifiers).</p>
    #[doc(hidden)]pub entity_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    /// </note>
    #[doc(hidden)]pub tags: std::option::Option<std::vec::Vec<std::collections::HashMap<std::string::String, std::string::String>>>,
    /// <p>A list of event status codes.</p>
    #[doc(hidden)]pub event_status_codes: std::option::Option<std::vec::Vec<crate::model::EventStatusCode>>,
}
impl EventFilter {
...
pub mod event_filter {
    ...
    pub struct Builder {
        ...
        pub(crate) last_updated_times: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>,
        pub(crate) entity_arns: std::option::Option<std::vec::Vec<std::string::String>>,
        pub(crate) entity_values: std::option::Option<std::vec::Vec<std::string::String>>,
        pub(crate) event_type_categories: std::option::Option<std::vec::Vec<crate::model::EventTypeCategory>>,
    ...
    impl Builder {
        ...
        /// <p>A list of dates and times that the event began.</p>
        pub fn set_start_times(mut self, input: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>) -> Self {
        ...
        /// <p>A list of dates and times that the event ended.</p>
        pub fn set_end_times(mut self, input: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>) -> Self {
        ...
        /// <p>A list of dates and times that the event was last updated.</p>
        pub fn set_last_updated_times(mut self, input: std::option::Option<std::vec::Vec<crate::model::DateTimeRange>>) -> Self {
...
pub struct OrganizationEventDetailsErrorItem  {
    ...
    #[doc(hidden)]pub error_name: std::option::Option<std::string::String>,
...
pub struct OrganizationEventDetails  {
    ...
    #[doc(hidden)]pub event_description: std::option::Option<crate::model::EventDescription>,
    /// <p>Additional metadata about the event.</p>
    #[doc(hidden)]pub event_metadata: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub mod organization_event_details {
    ...
    impl Builder {
        ...
        /// <p>The detailed description of the event. Included in the information returned by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetails.html">DescribeEventDetails</a> operation.</p>
        pub fn set_event_description(mut self, input: std::option::Option<crate::model::EventDescription>) -> Self {
...
pub struct EventDescription  {
    ...
    #[doc(hidden)]pub latest_description: std::option::Option<std::string::String>,
}
...
pub struct EventAggregate  {
    ...
    #[doc(hidden)]pub aggregate_value: std::option::Option<std::string::String>,
...
pub struct AffectedEntity  {
    ...
    #[doc(hidden)]pub entity_value: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status_code: std::option::Option<crate::model::EntityStatusCode>,
    /// <p>A map of entity tags attached to the affected entity.</p> <note> 
    /// <p>Currently, the <code>tags</code> property isn't supported.</p> 
    /// </note>
...
pub mod affected_entity {
    ...
    impl Builder {
        ...
        /// <p>The most recent status of the entity affected by the event. The possible values are <code>IMPAIRED</code>, <code>UNIMPAIRED</code>, and <code>UNKNOWN</code>.</p>
        pub fn set_status_code(mut self, input: std::option::Option<crate::model::EntityStatusCode>) -> Self {
            self.status_code = input; self
        }
...
pub struct EntityFilter  {
    ...
    #[doc(hidden)]pub status_codes: std::option::Option<std::vec::Vec<crate::model::EntityStatusCode>>,
}
impl EntityFilter {
    /// <p>A list of event ARNs (unique identifiers). For example: <code>"arn:aws:health:us-east-1::event/EC2/EC2_INSTANCE_RETIREMENT_SCHEDULED/EC2_INSTANCE_RETIREMENT_SCHEDULED_ABC123-CDE456", "arn:aws:health:us-west-1::event/EBS/AWS_EBS_LOST_VOLUME/AWS_EBS_LOST_VOLUME_CHI789_JKL101"</code> </p>
    pub fn event_arns(&self) -> std::option::Option<& [std::string::String]> {
...
pub mod entity_filter {
    ...
    impl Builder {
        ...
        /// <p>A list of entity status codes (<code>IMPAIRED</code>, <code>UNIMPAIRED</code>, or <code>UNKNOWN</code>).</p>
        pub fn set_status_codes(mut self, input: std::option::Option<std::vec::Vec<crate::model::EntityStatusCode>>) -> Self {
