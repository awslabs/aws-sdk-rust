...
impl ::std::convert::From<&str> for EventTypeCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventTypeCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventTypeCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventTypeCategory::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventTypeCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
