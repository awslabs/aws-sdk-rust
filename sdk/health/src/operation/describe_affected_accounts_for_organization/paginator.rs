    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::describe_affected_accounts_for_organization::DescribeAffectedAccountsForOrganization::orchestrate(
                        &runtime_plugins,
                        input.clone(),
                    )
                    .await;
...
impl DescribeAffectedAccountsForOrganizationPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_affected_accounts_for_organization_output_affected_accounts(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
