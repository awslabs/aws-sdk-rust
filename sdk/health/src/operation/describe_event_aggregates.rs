...
impl DescribeEventAggregatesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEventAggregates`](crate::operation::describe_event_aggregates::DescribeEventAggregates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_event_aggregates::DescribeEventAggregates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_event_aggregates::DescribeEventAggregatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_event_aggregates::ser_describe_event_aggregates_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_event_aggregates::DescribeEventAggregates::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventAggregates {
                type Output = std::result::Result<crate::operation::describe_event_aggregates::DescribeEventAggregatesOutput, crate::operation::describe_event_aggregates::DescribeEventAggregatesError>;
