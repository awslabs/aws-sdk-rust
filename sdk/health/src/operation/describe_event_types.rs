...
impl DescribeEventTypesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_event_types::ser_describe_event_types_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEventTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_event_types::de_describe_event_types_http_response_with_props(status, headers, body)
        }
    }
}
