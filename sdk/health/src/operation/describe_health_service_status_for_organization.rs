...
impl DescribeHealthServiceStatusForOrganizationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHealthServiceStatusForOrganization`](crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_health_service_status_for_organization::ser_describe_health_service_status_for_organization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganization::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeHealthServiceStatusForOrganization {
                type Output = std::result::Result<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationOutput, crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError {
