    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeHealthServiceStatusForOrganization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeHealthServiceStatusForOrganization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeHealthServiceStatusForOrganizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeHealthServiceStatusForOrganizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeHealthServiceStatusForOrganization")
...
.with_interceptor(DescribeHealthServiceStatusForOrganizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError>::new());
...
#[derive(Debug)]
            struct DescribeHealthServiceStatusForOrganizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeHealthServiceStatusForOrganizationResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeHealthServiceStatusForOrganizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeHealthServiceStatusForOrganizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_health_service_status_for_organization::ser_describe_health_service_status_for_organization_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct DescribeHealthServiceStatusForOrganizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeHealthServiceStatusForOrganizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeHealthServiceStatusForOrganizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeHealthServiceStatusForOrganizationInput>()
                        .ok_or("failed to downcast to DescribeHealthServiceStatusForOrganizationInput")?;
...
pub enum DescribeHealthServiceStatusForOrganizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeHealthServiceStatusForOrganizationError) for what information is available for the error.")]
...
impl DescribeHealthServiceStatusForOrganizationError {
    /// Creates the `DescribeHealthServiceStatusForOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeHealthServiceStatusForOrganizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeHealthServiceStatusForOrganizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError {
...
mod _describe_health_service_status_for_organization_output;
