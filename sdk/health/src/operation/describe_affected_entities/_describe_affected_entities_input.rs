...
impl DescribeAffectedEntitiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_affected_entities::DescribeAffectedEntitiesInput, ::aws_smithy_types::error::operation::BuildError> {
