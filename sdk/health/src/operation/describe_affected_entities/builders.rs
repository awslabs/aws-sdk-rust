...
impl DescribeAffectedEntitiesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_affected_entities();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_affected_entities::DescribeAffectedEntitiesOutput,
                    crate::operation::describe_affected_entities::DescribeAffectedEntitiesError,
                > for DescribeAffectedEntitiesFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeAffectedEntitiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_affected_entities::DescribeAffectedEntitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_affected_entities::DescribeAffectedEntitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_affected_entities::DescribeAffectedEntities::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_affected_entities::DescribeAffectedEntitiesOutput, crate::operation::describe_affected_entities::DescribeAffectedEntitiesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_affected_entities::paginator::DescribeAffectedEntitiesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
