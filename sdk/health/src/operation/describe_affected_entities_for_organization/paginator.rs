...
impl DescribeAffectedEntitiesForOrganizationPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_affected_entities_for_organization::paginator::DescribeAffectedEntitiesForOrganizationPaginatorItems {
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_affected_entities_for_organization::DescribeAffectedEntitiesForOrganization::orchestrate(
                                &runtime_plugins,
                                input.clone(),
                            )
                            .await;
...
impl DescribeAffectedEntitiesForOrganizationPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_affected_entities_for_organization_output_output_entities(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
