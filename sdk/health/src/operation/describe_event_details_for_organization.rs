...
impl DescribeEventDetailsForOrganizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_event_details_for_organization::DescribeEventDetailsForOrganization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEventDetailsForOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_event_details_for_organization::de_describe_event_details_for_organization_http_response_with_props(
                status, headers, body,
            )
        }
    }
