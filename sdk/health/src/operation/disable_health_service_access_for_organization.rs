...
impl DisableHealthServiceAccessForOrganization {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disable_health_service_access_for_organization::DisableHealthServiceAccessForOrganizationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disable_health_service_access_for_organization::DisableHealthServiceAccessForOrganizationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Health",
            "rpc.method" = "DisableHealthServiceAccessForOrganization",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableHealthServiceAccessForOrganization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisableHealthServiceAccessForOrganizationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisableHealthServiceAccessForOrganizationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisableHealthServiceAccessForOrganization")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableHealthServiceAccessForOrganization")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableHealthServiceAccessForOrganizationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disable_health_service_access_for_organization::de_disable_health_service_access_for_organization_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_disable_health_service_access_for_organization::de_disable_health_service_access_for_organization_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableHealthServiceAccessForOrganizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disable_health_service_access_for_organization::DisableHealthServiceAccessForOrganizationInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disable_health_service_access_for_organization::ser_disable_health_service_access_for_organization_input(
                &input,
            )?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::disable_health_service_access_for_organization::DisableHealthServiceAccessForOrganizationError
{
