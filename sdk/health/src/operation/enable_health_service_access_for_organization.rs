...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableHealthServiceAccessForOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_health_service_access_for_organization::de_enable_health_service_access_for_organization_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type EnableHealthServiceAccessForOrganizationErrorKind =
