...
impl DescribeEventsForOrganizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_events_for_organization::DescribeEventsForOrganizationInput, ::aws_smithy_types::error::operation::BuildError> {
