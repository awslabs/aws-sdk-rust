...
pub fn ser_date_time_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DateTimeRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
