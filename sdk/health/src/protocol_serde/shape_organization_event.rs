...
pub(crate) fn de_organization_event<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OrganizationEvent>, aws_smithy_json::deserialize::error::DeserializeError>
