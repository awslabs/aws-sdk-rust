...
pub fn de_describe_health_service_status_for_organization_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_health_service_status_for_organization_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_health_service_status_for_organization::de_describe_health_service_status_for_organization(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_health_service_status_for_organization::DescribeHealthServiceStatusForOrganizationError::unhandled)?;
