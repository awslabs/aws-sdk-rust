                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "statusCode" => {
                            builder = builder.set_status_code(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::EventStatusCode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "eventScopeCode" => {
                            builder = builder.set_event_scope_code(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::EventScopeCode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "actionability" => {
                        ...
                        "personas" => {
                            builder = builder.set_personas(crate::protocol_serde::shape_event_persona_list::de_event_persona_list(tokens, _value)?);
                        }
