...
pub fn de_enable_health_service_access_for_organization_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::enable_health_service_access_for_organization::EnableHealthServiceAccessForOrganizationError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_health_service_access_for_organization_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
