...
pub fn ser_describe_event_types_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEventTypesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
