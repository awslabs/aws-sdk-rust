...
pub fn ser_entity_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EntityFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
