...
pub fn ser_describe_affected_entities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeAffectedEntitiesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
