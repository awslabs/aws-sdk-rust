                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::DescribeEventAggregatesOutput, aws_smithy_http::result::SdkError<crate::error::DescribeEventAggregatesError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_describe_event_aggregates_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
...
/// Flattened paginator for `DescribeAffectedEntitiesForOrganizationPaginator`
                ...
                impl  DescribeAffectedEntitiesForOrganizationPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::AffectedEntity, aws_smithy_http::result::SdkError<crate::error::DescribeAffectedEntitiesForOrganizationError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_affected_entities_for_organization_output_entities(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `DescribeEventAggregatesPaginator`
                ...
                impl  DescribeEventAggregatesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::EventAggregate, aws_smithy_http::result::SdkError<crate::error::DescribeEventAggregatesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_event_aggregates_output_event_aggregates(page).unwrap_or_default().into_iter())
                    }
                }
