...
impl super::Client  {
    ...
    pub fn describe_health_service_status_for_organization(&self) -> crate::client::fluent_builders::DescribeHealthServiceStatusForOrganization {
                                crate::client::fluent_builders::DescribeHealthServiceStatusForOrganization::new(self.handle.clone())
                            }
}
