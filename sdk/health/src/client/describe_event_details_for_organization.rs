...
impl super::Client {
    ...
    ///   - [`organization_event_detail_filters(EventAccountFilter)`](crate::operation::describe_event_details_for_organization::builders::DescribeEventDetailsForOrganizationFluentBuilder::organization_event_detail_filters) / [`set_organization_event_detail_filters(Option<Vec::<EventAccountFilter>>)`](crate::operation::describe_event_details_for_organization::builders::DescribeEventDetailsForOrganizationFluentBuilder::set_organization_event_detail_filters):<br>required: **true**<br><p>A set of JSON elements that includes the <code>awsAccountId</code> and the <code>eventArn</code>.</p><br>
    ///   - [`locale(impl Into<String>)`](crate::operation::describe_event_details_for_organization::builders::DescribeEventDetailsForOrganizationFluentBuilder::locale) / [`set_locale(Option<String>)`](crate::operation::describe_event_details_for_organization::builders::DescribeEventDetailsForOrganizationFluentBuilder::set_locale):<br>required: **false**<br><p>The locale (language) to return information in. English (en) is the default and the only supported value at this time.</p><br>
