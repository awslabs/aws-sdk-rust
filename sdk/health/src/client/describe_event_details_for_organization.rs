...
impl super::Client  {
    ...
    pub fn describe_event_details_for_organization(&self) -> crate::client::fluent_builders::DescribeEventDetailsForOrganization {
                                crate::client::fluent_builders::DescribeEventDetailsForOrganization::new(self.handle.clone())
                            }
}
