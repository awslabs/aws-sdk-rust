...
/// For example, the [`DescribeAffectedAccountsForOrganization`](crate::operation) operation has
...
mod describe_affected_accounts_for_organization;

mod describe_affected_entities;

mod describe_affected_entities_for_organization;
...
mod describe_event_details_for_organization;

mod describe_event_types;

mod describe_events;

mod describe_events_for_organization;
