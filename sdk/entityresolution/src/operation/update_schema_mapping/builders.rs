...
impl UpdateSchemaMappingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_schema_mapping::UpdateSchemaMappingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_schema_mapping::UpdateSchemaMappingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_schema_mapping::UpdateSchemaMappingOutput, crate::operation::update_schema_mapping::UpdateSchemaMappingError, Self> {
