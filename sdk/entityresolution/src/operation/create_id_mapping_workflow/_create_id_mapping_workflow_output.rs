...
impl  CreateIdMappingWorkflowOutput  {
    ...
    pub fn input_source_config(&self) -> & [crate::types::IdMappingWorkflowInputSource] {
        use std::ops::Deref; self.input_source_config.deref()
    }
    /// <p>A list of <code>IdMappingWorkflowOutputSource</code> objects, each of which contains fields <code>OutputS3Path</code> and <code>Output</code>.</p>
    pub fn output_source_config(&self) -> & [crate::types::IdMappingWorkflowOutputSource] {
        use std::ops::Deref; self.output_source_config.deref()
    }
    /// <p>An object which defines the <code>idMappingType</code> and the <code>providerProperties</code>.</p>
...
impl CreateIdMappingWorkflowOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_id_mapping_workflow::CreateIdMappingWorkflowOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_id_mapping_workflow::CreateIdMappingWorkflowOutput {
                workflow_name: self.workflow_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workflow_name", "workflow_name was not specified but it is required when building CreateIdMappingWorkflowOutput")
                    )?
                ,
                workflow_arn: self.workflow_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workflow_arn", "workflow_arn was not specified but it is required when building CreateIdMappingWorkflowOutput")
                    )?
                ,
                ...
                input_source_config: self.input_source_config
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("input_source_config", "input_source_config was not specified but it is required when building CreateIdMappingWorkflowOutput")
                    )?
                ,
                output_source_config: self.output_source_config
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("output_source_config", "output_source_config was not specified but it is required when building CreateIdMappingWorkflowOutput")
                    )?
                ,
                ...
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building CreateIdMappingWorkflowOutput")
                    )?
                ,
