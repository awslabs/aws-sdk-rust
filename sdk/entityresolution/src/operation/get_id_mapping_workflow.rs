...
/// Orchestration and serialization glue logic for `GetIdMappingWorkflow`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetIdMappingWorkflow;
impl GetIdMappingWorkflow {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowInput,
                    ) -> ::std::result::Result<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIdMappingWorkflow {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetIdMappingWorkflow");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetIdMappingWorkflowRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetIdMappingWorkflowResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIdMappingWorkflow")
...
.with_interceptor(GetIdMappingWorkflowEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_id_mapping_workflow::de_get_id_mapping_workflow_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_id_mapping_workflow::de_get_id_mapping_workflow_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetIdMappingWorkflowRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/idmappingworkflows/{workflowName}", workflowName = workflow_name).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetIdMappingWorkflowEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetIdMappingWorkflowInput>()
                        .ok_or("failed to downcast to GetIdMappingWorkflowInput")?;
...
/// Error type for the `GetIdMappingWorkflowError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetIdMappingWorkflowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetIdMappingWorkflowError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetIdMappingWorkflowError {
    /// Creates the `GetIdMappingWorkflowError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetIdMappingWorkflowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetIdMappingWorkflowError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetIdMappingWorkflowError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `GetIdMappingWorkflowError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetIdMappingWorkflowError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GetIdMappingWorkflowError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for GetIdMappingWorkflowError {
...
impl ::std::fmt::Display for GetIdMappingWorkflowError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetIdMappingWorkflowError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetIdMappingWorkflowError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetIdMappingWorkflowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_id_mapping_workflow::GetIdMappingWorkflowError {
...
mod _get_id_mapping_workflow_output;
