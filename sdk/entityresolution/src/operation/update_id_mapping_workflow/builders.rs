...
impl UpdateIdMappingWorkflowFluentBuilder {
    /// Creates a new `UpdateIdMappingWorkflow`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_id_mapping_workflow::UpdateIdMappingWorkflowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_id_mapping_workflow::UpdateIdMappingWorkflowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_id_mapping_workflow::UpdateIdMappingWorkflowOutput, crate::operation::update_id_mapping_workflow::UpdateIdMappingWorkflowError, Self> {
