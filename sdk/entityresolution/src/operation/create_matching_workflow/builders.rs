...
pub use crate::operation::create_matching_workflow::_create_matching_workflow_output::CreateMatchingWorkflowOutputBuilder;
...
pub struct CreateMatchingWorkflowFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_matching_workflow::builders::CreateMatchingWorkflowInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_matching_workflow::CreateMatchingWorkflowOutput,
                    crate::operation::create_matching_workflow::CreateMatchingWorkflowError,
                > for CreateMatchingWorkflowFluentBuilder
            {
                fn send(
                    self,
...
impl CreateMatchingWorkflowFluentBuilder {
    /// Creates a new `CreateMatchingWorkflow`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_matching_workflow::CreateMatchingWorkflowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_matching_workflow::CreateMatchingWorkflowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_matching_workflow::CreateMatchingWorkflow::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_matching_workflow::CreateMatchingWorkflow::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_matching_workflow::CreateMatchingWorkflowOutput, crate::operation::create_matching_workflow::CreateMatchingWorkflowError, Self> {
