...
impl ::aws_http::request_id::RequestId for GetMatchingJobOutput {
...
impl GetMatchingJobOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_matching_job::GetMatchingJobOutput, ::aws_smithy_http::operation::error::BuildError> {
