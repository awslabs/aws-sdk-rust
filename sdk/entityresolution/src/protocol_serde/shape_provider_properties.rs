...
pub(crate) fn de_provider_properties<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ProviderProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "intermediateSourceConfiguration" => {
                            builder = builder.set_intermediate_source_configuration(
                                crate::protocol_serde::shape_intermediate_source_configuration::de_intermediate_source_configuration(tokens, _value)?,
                            );
                        }
