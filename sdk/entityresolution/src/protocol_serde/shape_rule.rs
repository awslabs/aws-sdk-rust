...
pub fn ser_rule(
    ...
    if let Some(var_2) = &input.matching_keys {
        let mut array_3 = object.key("matchingKeys").start_array();
        for item_4 in var_2 {
            {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "matchingKeys" => {
                            builder = builder.set_matching_keys(crate::protocol_serde::shape_matching_keys::de_matching_keys(tokens)?);
                        }
