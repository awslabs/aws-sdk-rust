...
pub fn ser_rule(
    ...
    {
        let mut array_1 = object.key("matchingKeys").start_array();
        for item_2 in &input.matching_keys {
            {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "matchingKeys" => {
                            builder = builder.set_matching_keys(crate::protocol_serde::shape_matching_keys::de_matching_keys(tokens, _value)?);
                        }
