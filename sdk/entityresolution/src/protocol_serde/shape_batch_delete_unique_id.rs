            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "disconnectedUniqueIds" => {
                    builder = builder.set_disconnected_unique_ids(
                        crate::protocol_serde::shape_disconnected_unique_ids_list::de_disconnected_unique_ids_list(tokens, _value, depth + 1)?,
                    );
                }
                "errors" => {
                    builder = builder.set_errors(
                        crate::protocol_serde::shape_delete_unique_id_errors_list::de_delete_unique_id_errors_list(tokens, _value, depth + 1)?,
                    );
                }
                "status" => {
