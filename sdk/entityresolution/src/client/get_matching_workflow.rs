...
impl super::Client {
    ...
    ///   - [`output_source_config(Vec::<OutputSource>)`](crate::operation::get_matching_workflow::GetMatchingWorkflowOutput::output_source_config): <p>A list of <code>OutputSource</code> objects, each of which contains fields <code>outputS3Path</code>, <code>applyNormalization</code>, <code>KMSArn</code>, and <code>output</code>.</p>
