...
impl super::Client {
    ...
    ///   - [`provider_id_name_space_configuration(Option<ProviderIdNameSpaceConfiguration>)`](crate::operation::get_provider_service::GetProviderServiceOutput::provider_id_name_space_configuration): <p>The provider configuration required for different ID namespace types.</p>
    ///   - [`provider_job_configuration(Option<Document>)`](crate::operation::get_provider_service::GetProviderServiceOutput::provider_job_configuration): <p>Provider service job configurations.</p>
    ...
    ///   - [`provider_component_schema(Option<ProviderComponentSchema>)`](crate::operation::get_provider_service::GetProviderServiceOutput::provider_component_schema): <p>Input schema for the provider service.</p>
