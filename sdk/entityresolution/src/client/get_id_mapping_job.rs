...
impl super::Client {
    ...
    ///   - [`workflow_name(impl Into<String>)`](crate::operation::get_id_mapping_job::builders::GetIdMappingJobFluentBuilder::workflow_name) / [`set_workflow_name(Option<String>)`](crate::operation::get_id_mapping_job::builders::GetIdMappingJobFluentBuilder::set_workflow_name): <p>The name of the workflow.</p>
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_id_mapping_job::builders::GetIdMappingJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_id_mapping_job::builders::GetIdMappingJobFluentBuilder::set_job_id): <p>The ID of the job.</p>
    /// - On success, responds with [`GetIdMappingJobOutput`](crate::operation::get_id_mapping_job::GetIdMappingJobOutput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::operation::get_id_mapping_job::GetIdMappingJobOutput::job_id): <p>The ID of the job.</p>
    ///   - [`status(Option<JobStatus>)`](crate::operation::get_id_mapping_job::GetIdMappingJobOutput::status): <p>The current status of the job.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::operation::get_id_mapping_job::GetIdMappingJobOutput::start_time): <p>The time at which the job was started.</p>
