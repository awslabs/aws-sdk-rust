...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_matching_workflows::builders::ListMatchingWorkflowsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_matching_workflows::builders::ListMatchingWorkflowsFluentBuilder::set_next_token): <p>The pagination token from the previous API call.</p>
