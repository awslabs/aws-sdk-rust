...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_matching_workflows::builders::ListMatchingWorkflowsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_matching_workflows::builders::ListMatchingWorkflowsFluentBuilder::set_next_token): <p>The pagination token from the previous <code>ListSchemaMappings</code> API call.</p>
    ///   - [`max_results(i32)`](crate::operation::list_matching_workflows::builders::ListMatchingWorkflowsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_matching_workflows::builders::ListMatchingWorkflowsFluentBuilder::set_max_results): <p>The maximum number of objects returned per page.</p>
