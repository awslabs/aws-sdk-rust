...
impl super::Client {
    ...
    ///   - [`workflow_name(impl ::std::convert::Into<String>)`](crate::operation::get_match_id::builders::GetMatchIdFluentBuilder::workflow_name) / [`set_workflow_name(Option<String>)`](crate::operation::get_match_id::builders::GetMatchIdFluentBuilder::set_workflow_name): <p>The name of the workflow.</p>
    ///   - [`record(HashMap<String, String>)`](crate::operation::get_match_id::builders::GetMatchIdFluentBuilder::record) / [`set_record(Option<HashMap<String, String>>)`](crate::operation::get_match_id::builders::GetMatchIdFluentBuilder::set_record): <p>The record to fetch the Match ID for.</p>
