...
/// <p>An object containing <code>FieldName</code>, <code>Type</code>, <code>GroupName</code>, <code>MatchKey</code>, and <code>SubType</code>.</p>
#[non_exhaustive]
