...
pub struct DeleteUniqueIdError {
    ...
    /// <p>The error type for the delete unique ID operation.</p>
    /// <p>The <code>SERVICE_ERROR</code> value indicates that an internal service-side problem occurred during the deletion operation.</p>
    /// <p>The <code>VALIDATION_ERROR</code> value indicates that the deletion operation couldn't complete because of invalid input parameters or data.</p>
