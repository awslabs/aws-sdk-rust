...
pub(crate) fn reflens_list_id_mapping_jobs_output_next_token(
...
pub(crate) fn reflens_list_id_mapping_workflows_output_next_token(
...
pub(crate) fn reflens_list_matching_jobs_output_next_token(
...
pub(crate) fn reflens_list_matching_workflows_output_next_token(
...
pub(crate) fn reflens_list_provider_services_output_next_token(
...
pub(crate) fn reflens_list_schema_mappings_output_next_token(
...
pub(crate) fn lens_list_id_mapping_jobs_output_jobs(
    input: crate::operation::list_id_mapping_jobs::ListIdMappingJobsOutput,
...
pub(crate) fn lens_list_id_mapping_workflows_output_workflow_summaries(
    input: crate::operation::list_id_mapping_workflows::ListIdMappingWorkflowsOutput,
...
pub(crate) fn lens_list_matching_jobs_output_jobs(
    input: crate::operation::list_matching_jobs::ListMatchingJobsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::JobSummary>> {
    let input = match input.jobs {
        ::std::option::Option::None => return ::std::option::Option::None,
...
pub(crate) fn lens_list_matching_workflows_output_workflow_summaries(
    input: crate::operation::list_matching_workflows::ListMatchingWorkflowsOutput,
...
pub(crate) fn lens_list_provider_services_output_provider_service_summaries(
    input: crate::operation::list_provider_services::ListProviderServicesOutput,
...
pub(crate) fn lens_list_schema_mappings_output_schema_list(
    input: crate::operation::list_schema_mappings::ListSchemaMappingsOutput,
