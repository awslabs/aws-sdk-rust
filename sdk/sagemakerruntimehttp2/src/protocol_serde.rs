...
pub(crate) mod shape_invoke_endpoint_with_bidirectional_stream;
...
pub(crate) mod shape_input_validation_error;

pub(crate) mod shape_internal_server_error;

pub(crate) mod shape_internal_stream_failure;

pub(crate) mod shape_invoke_endpoint_with_bidirectional_stream_output;
