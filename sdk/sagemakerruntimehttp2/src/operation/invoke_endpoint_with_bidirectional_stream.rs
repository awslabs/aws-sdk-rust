...
/// Orchestration and serialization glue logic for `InvokeEndpointWithBidirectionalStream`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InvokeEndpointWithBidirectionalStream;
impl InvokeEndpointWithBidirectionalStream {
    /// Creates a new `InvokeEndpointWithBidirectionalStream`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::invoke_endpoint_with_bidirectional_stream::InvokeEndpointWithBidirectionalStreamError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::invoke_endpoint_with_bidirectional_stream::InvokeEndpointWithBidirectionalStreamOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "SageMaker Runtime HTTP2.InvokeEndpointWithBidirectionalStream",
            "rpc.service" = "SageMaker Runtime HTTP2",
            "rpc.method" = "InvokeEndpointWithBidirectionalStream",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InvokeEndpointWithBidirectionalStream {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InvokeEndpointWithBidirectionalStream");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            InvokeEndpointWithBidirectionalStreamRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            InvokeEndpointWithBidirectionalStreamResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("InvokeEndpointWithBidirectionalStream")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InvokeEndpointWithBidirectionalStreamResponseDeserializer {
    ...
    fn deserialize_nonstreaming(
        ...
        crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_invoke_endpoint_with_bidirectional_stream::de_invoke_endpoint_with_bidirectional_stream_http_error(
...
#[derive(Debug)]
struct InvokeEndpointWithBidirectionalStreamRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InvokeEndpointWithBidirectionalStreamRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::invoke_endpoint_with_bidirectional_stream::InvokeEndpointWithBidirectionalStreamInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::invoke_endpoint_with_bidirectional_stream::InvokeEndpointWithBidirectionalStreamInput,
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("endpoint_name", "cannot be empty or unset"))?;
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_invoke_endpoint_with_bidirectional_stream::ser_invoke_endpoint_with_bidirectional_stream_headers(
                        input, builder,
                    )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from({
            let error_marshaller = crate::event_stream_serde::RequestStreamEventErrorMarshaller::new();
            let marshaller = crate::event_stream_serde::RequestStreamEventMarshaller::new();
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InvokeEndpointWithBidirectionalStreamEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<InvokeEndpointWithBidirectionalStreamInput>()
            .ok_or("failed to downcast to InvokeEndpointWithBidirectionalStreamInput")?;
...
/// Error type for the `InvokeEndpointWithBidirectionalStreamError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum InvokeEndpointWithBidirectionalStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InvokeEndpointWithBidirectionalStreamError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl InvokeEndpointWithBidirectionalStreamError {
    /// Creates the `InvokeEndpointWithBidirectionalStreamError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `InvokeEndpointWithBidirectionalStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InputValidationError(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `InvokeEndpointWithBidirectionalStreamError::InputValidationError`.
    pub fn is_input_validation_error(&self) -> bool {
        matches!(self, Self::InputValidationError(_))
    }
    /// Returns `true` if the error kind is `InvokeEndpointWithBidirectionalStreamError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
    /// Returns `true` if the error kind is `InvokeEndpointWithBidirectionalStreamError::InternalStreamFailure`.
    pub fn is_internal_stream_failure(&self) -> bool {
        matches!(self, Self::InternalStreamFailure(_))
    }
    /// Returns `true` if the error kind is `InvokeEndpointWithBidirectionalStreamError::ModelError`.
    pub fn is_model_error(&self) -> bool {
        matches!(self, Self::ModelError(_))
    }
    /// Returns `true` if the error kind is `InvokeEndpointWithBidirectionalStreamError::ModelStreamError`.
    pub fn is_model_stream_error(&self) -> bool {
        matches!(self, Self::ModelStreamError(_))
    }
    /// Returns `true` if the error kind is `InvokeEndpointWithBidirectionalStreamError::ServiceUnavailableError`.
    pub fn is_service_unavailable_error(&self) -> bool {
        matches!(self, Self::ServiceUnavailableError(_))
    }
}
impl ::std::error::Error for InvokeEndpointWithBidirectionalStreamError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::InputValidationError(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for InvokeEndpointWithBidirectionalStreamError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            Self::InputValidationError(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::retry::ProvideErrorKind for InvokeEndpointWithBidirectionalStreamError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for InvokeEndpointWithBidirectionalStreamError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InputValidationError(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InvokeEndpointWithBidirectionalStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invoke_endpoint_with_bidirectional_stream::InvokeEndpointWithBidirectionalStreamError {
...
mod _invoke_endpoint_with_bidirectional_stream_output;
