...
pub(crate) fn de_subject_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::SubjectDetail>, aws_smithy_json::deserialize::error::DeserializeError>
