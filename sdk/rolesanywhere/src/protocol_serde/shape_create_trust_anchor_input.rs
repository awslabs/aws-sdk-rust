...
pub fn ser_create_trust_anchor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTrustAnchorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
