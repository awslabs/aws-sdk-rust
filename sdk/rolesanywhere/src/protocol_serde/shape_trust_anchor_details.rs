...
pub(crate) fn de_trust_anchor_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::TrustAnchorDetail>>, aws_smithy_json::deserialize::error::DeserializeError>
