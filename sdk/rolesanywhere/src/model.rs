...
pub struct Source  {
    ...
    #[doc(hidden)]pub source_type: std::option::Option<crate::model::TrustAnchorType>,
    /// <p>The data field of the trust anchor depending on its type. </p>
    #[doc(hidden)]pub source_data: std::option::Option<crate::model::SourceData>,
}
impl Source {
    /// <p>The type of the trust anchor. </p>
...
pub struct SubjectSummary  {
    ...
    #[doc(hidden)]pub subject_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub x509_subject: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_seen_at: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct SubjectDetail  {
    ...
    #[doc(hidden)]pub credentials: std::option::Option<std::vec::Vec<crate::model::CredentialSummary>>,
    /// <p>The specified instance properties associated with the request.</p>
    #[doc(hidden)]pub instance_properties: std::option::Option<std::vec::Vec<crate::model::InstanceProperty>>,
}
impl SubjectDetail {
    /// <p>The ARN of the resource.</p>
    pub fn subject_arn(&self) -> std::option::Option<& str> {
...
pub struct InstanceProperty  {
    /// <p>The ISO-8601 time stamp of when the certificate was last used in a <a href="https://docs.aws.amazon.com/rolesanywhere/latest/APIReference/API_CreateSession.html">CreateSession</a> operation.</p>
    #[doc(hidden)]pub seen_at: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub failed: std::option::Option<bool>,
}
...
pub struct CredentialSummary  {
    ...
    #[doc(hidden)]pub x509_certificate_data: std::option::Option<std::string::String>,
    /// <p>Indicates whether the <a href="https://docs.aws.amazon.com/rolesanywhere/latest/APIReference/API_CreateSession.html">CreateSession</a> operation was successful. </p>
    #[doc(hidden)]pub failed: std::option::Option<bool>,
}
...
pub struct CrlDetail  {
    ...
    #[doc(hidden)]pub crl_arn: std::option::Option<std::string::String>,
