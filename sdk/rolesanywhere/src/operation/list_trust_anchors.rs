...
impl ListTrustAnchorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_trust_anchors::ListTrustAnchors,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrustAnchors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_trust_anchors::de_list_trust_anchors_http_response_with_props(status, headers, body)
        }
    }
}
