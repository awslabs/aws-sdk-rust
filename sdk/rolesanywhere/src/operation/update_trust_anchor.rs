...
impl UpdateTrustAnchorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_trust_anchor::ser_update_trust_anchor_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrustAnchor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_trust_anchor::de_update_trust_anchor_http_response_with_props(status, headers, body)
        }
    }
}
