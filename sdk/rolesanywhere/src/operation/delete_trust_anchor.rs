...
impl DeleteTrustAnchorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_trust_anchor::DeleteTrustAnchor,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrustAnchor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_trust_anchor::de_delete_trust_anchor_http_response_with_props(status, headers, body)
        }
    }
}
