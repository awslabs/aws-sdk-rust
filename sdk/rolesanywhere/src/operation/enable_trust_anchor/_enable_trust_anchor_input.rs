...
impl EnableTrustAnchorInputBuilder {
    ...
    /// - [`trust_anchor_id`](crate::operation::enable_trust_anchor::builders::EnableTrustAnchorInputBuilder::trust_anchor_id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::enable_trust_anchor::EnableTrustAnchorInput {
            trust_anchor_id: self.trust_anchor_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "trust_anchor_id",
                    "trust_anchor_id was not specified but it is required when building EnableTrustAnchorInput",
                )
            })?,
        })
    }
