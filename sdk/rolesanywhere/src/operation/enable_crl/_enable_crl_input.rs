...
impl EnableCrlInputBuilder {
    ...
    /// - [`crl_id`](crate::operation::enable_crl::builders::EnableCrlInputBuilder::crl_id)
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_crl::EnableCrlInput, ::aws_smithy_http::operation::error::BuildError> {
        ::std::result::Result::Ok(crate::operation::enable_crl::EnableCrlInput {
            crl_id: self.crl_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "crl_id",
                    "crl_id was not specified but it is required when building EnableCrlInput",
                )
            })?,
        })
    }
