...
impl crate::operation::enable_crl::builders::EnableCrlInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::enable_crl::EnableCrlOutput, crate::operation::enable_crl::EnableCrlError>
    for EnableCrlFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::enable_crl::EnableCrlOutput, crate::operation::enable_crl::EnableCrlError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl EnableCrlFluentBuilder {
    /// Creates a new `EnableCrlFluentBuilder`.
