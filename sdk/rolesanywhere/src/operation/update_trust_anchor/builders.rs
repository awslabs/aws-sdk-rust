...
impl UpdateTrustAnchorFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_trust_anchor::UpdateTrustAnchorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_trust_anchor::UpdateTrustAnchorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_trust_anchor::UpdateTrustAnchorOutput, crate::operation::update_trust_anchor::UpdateTrustAnchorError, Self> {
