...
impl UpdateCrlInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCrl`](crate::operation::update_crl::UpdateCrl)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_crl::UpdateCrl, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_crl::ser_update_crl_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_crl::UpdateCrl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCrl {
    type Output = ::std::result::Result<crate::operation::update_crl::UpdateCrlOutput, crate::operation::update_crl::UpdateCrlError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_crl::de_update_crl_http_response_with_props(status, headers, body)
        }
    }
}
