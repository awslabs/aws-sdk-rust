...
pub struct EnableTrustAnchorOutput  {
    ...
    #[doc(hidden)]pub trust_anchor: std::option::Option<crate::model::TrustAnchorDetail>,
}
...
pub struct ListTrustAnchorsOutput  {
    ...
    #[doc(hidden)]pub trust_anchors: std::option::Option<std::vec::Vec<crate::model::TrustAnchorDetail>>,
}
...
pub struct ListSubjectsOutput  {
    ...
    #[doc(hidden)]pub subjects: std::option::Option<std::vec::Vec<crate::model::SubjectSummary>>,
    /// <p>A token that indicates where the output should continue from, if a previous operation did not show all results. To get the next results, call the operation again with this value.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetSubjectOutput  {
    ...
    #[doc(hidden)]pub subject: std::option::Option<crate::model::SubjectDetail>,
}
...
pub struct EnableProfileOutput  {
    ...
    #[doc(hidden)]pub profile: std::option::Option<crate::model::ProfileDetail>,
}
...
pub struct ListProfilesOutput  {
    ...
    #[doc(hidden)]pub profiles: std::option::Option<std::vec::Vec<crate::model::ProfileDetail>>,
}
...
pub struct EnableCrlOutput  {
    ...
    #[doc(hidden)]pub crl: std::option::Option<crate::model::CrlDetail>,
}
...
pub struct ListCrlsOutput  {
    ...
    #[doc(hidden)]pub crls: std::option::Option<std::vec::Vec<crate::model::CrlDetail>>,
}
impl ListCrlsOutput {
    /// <p>A token that indicates where the output should continue from, if a previous operation did not show all results. To get the next results, call the operation again with this value.</p>
    pub fn next_token(&self) -> std::option::Option<& str> {
