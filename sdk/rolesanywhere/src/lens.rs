...
pub(crate) fn reflens_structure_crate_output_list_crls_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_list_subjects_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_list_trust_anchors_output_next_token(
...
pub(crate) fn lens_structure_crate_output_list_crls_output_crls(
    input: crate::output::ListCrlsOutput,
...
pub(crate) fn lens_structure_crate_output_list_subjects_output_subjects(
    input: crate::output::ListSubjectsOutput,
...
pub(crate) fn lens_structure_crate_output_list_trust_anchors_output_trust_anchors(
    input: crate::output::ListTrustAnchorsOutput,
