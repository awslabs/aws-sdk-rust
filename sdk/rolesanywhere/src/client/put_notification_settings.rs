...
impl super::Client {
    ...
    ///   - [`trust_anchor_id(impl ::std::convert::Into<String>)`](crate::operation::put_notification_settings::builders::PutNotificationSettingsFluentBuilder::trust_anchor_id) / [`set_trust_anchor_id(Option<String>)`](crate::operation::put_notification_settings::builders::PutNotificationSettingsFluentBuilder::set_trust_anchor_id): <p>The unique identifier of the trust anchor.</p>
    ///   - [`notification_settings(Vec<NotificationSetting>)`](crate::operation::put_notification_settings::builders::PutNotificationSettingsFluentBuilder::notification_settings) / [`set_notification_settings(Option<Vec<NotificationSetting>>)`](crate::operation::put_notification_settings::builders::PutNotificationSettingsFluentBuilder::set_notification_settings): <p>A list of notification settings to be associated to the trust anchor.</p>
