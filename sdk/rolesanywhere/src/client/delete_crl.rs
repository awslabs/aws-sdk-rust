...
impl super::Client {
    ...
    ///   - [`crl_id(impl ::std::convert::Into<String>)`](crate::operation::delete_crl::builders::DeleteCrlFluentBuilder::crl_id) / [`set_crl_id(Option<String>)`](crate::operation::delete_crl::builders::DeleteCrlFluentBuilder::set_crl_id): <p>The unique identifier of the certificate revocation list (CRL).</p>
