...
impl super::Client {
    ...
    pub fn enable_trust_anchor(
        &self,
    ) -> crate::operation::enable_trust_anchor::builders::EnableTrustAnchorFluentBuilder {
        crate::operation::enable_trust_anchor::builders::EnableTrustAnchorFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
