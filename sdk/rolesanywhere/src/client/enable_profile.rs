...
impl super::Client {
    ...
    ///   - [`profile_id(impl Into<String>)`](crate::operation::enable_profile::builders::EnableProfileFluentBuilder::profile_id) / [`set_profile_id(impl Into<String>)`](crate::operation::enable_profile::builders::EnableProfileFluentBuilder::set_profile_id):<br>required: **true**<br><p>The unique identifier of the profile.</p><br>
