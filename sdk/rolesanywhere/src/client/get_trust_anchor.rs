...
impl super::Client {
    ...
    ///   - [`trust_anchor_id(impl ::std::convert::Into<String>)`](crate::operation::get_trust_anchor::builders::GetTrustAnchorFluentBuilder::trust_anchor_id) / [`set_trust_anchor_id(Option<String>)`](crate::operation::get_trust_anchor::builders::GetTrustAnchorFluentBuilder::set_trust_anchor_id): <p>The unique identifier of the trust anchor.</p>
