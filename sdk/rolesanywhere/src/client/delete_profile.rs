...
impl super::Client {
    ...
    ///   - [`profile_id(impl Into<String>)`](crate::operation::delete_profile::builders::DeleteProfileFluentBuilder::profile_id) / [`set_profile_id(impl Into<String>)`](crate::operation::delete_profile::builders::DeleteProfileFluentBuilder::set_profile_id):<br>required: **true**<br><p>The unique identifier of the profile.</p><br>
