...
impl CreateTrustAnchorError {
    /// Creates a new `CreateTrustAnchorError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateTrustAnchorErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl DeleteCrlError {
    /// Creates a new `DeleteCrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteCrlErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl DeleteTrustAnchorError {
    /// Creates a new `DeleteTrustAnchorError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteTrustAnchorErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl DisableCrlError {
    /// Creates a new `DisableCrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DisableCrlErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl DisableProfileError {
    /// Creates a new `DisableProfileError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DisableProfileErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl DisableTrustAnchorError {
    /// Creates a new `DisableTrustAnchorError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DisableTrustAnchorErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl EnableCrlError {
    /// Creates a new `EnableCrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: EnableCrlErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl EnableProfileError {
    /// Creates a new `EnableProfileError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: EnableProfileErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl EnableTrustAnchorError {
    /// Creates a new `EnableTrustAnchorError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: EnableTrustAnchorErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl GetCrlError {
    /// Creates a new `GetCrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: GetCrlErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl GetSubjectError {
    /// Creates a new `GetSubjectError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: GetSubjectErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl GetTrustAnchorError {
    /// Creates a new `GetTrustAnchorError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: GetTrustAnchorErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl ImportCrlError {
    /// Creates a new `ImportCrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ImportCrlErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl ListCrlsError {
    /// Creates a new `ListCrlsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ListCrlsErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl ListSubjectsError {
    /// Creates a new `ListSubjectsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ListSubjectsErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl ListTrustAnchorsError {
    /// Creates a new `ListTrustAnchorsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ListTrustAnchorsErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl UpdateCrlError {
    /// Creates a new `UpdateCrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateCrlErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
...
impl UpdateTrustAnchorError {
    /// Creates a new `UpdateTrustAnchorError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateTrustAnchorErrorKind::Unhandled(err.into()),
                            meta: Default::default()
                        }
                    }
