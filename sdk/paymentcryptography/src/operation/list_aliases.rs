...
impl ListAliasesInput {
    /// Consumes the builder and constructs an Operation<[`ListAliases`](crate::operation::list_aliases::ListAliases)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_aliases::ListAliases, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_aliases::ser_list_aliases_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_aliases::ListAliases::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAliases", "paymentcryptography"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAliases {
    type Output = ::std::result::Result<crate::operation::list_aliases::ListAliasesOutput, crate::operation::list_aliases::ListAliasesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_aliases::de_list_aliases_http_response_with_props(status, headers, body)
        }
    }
}
