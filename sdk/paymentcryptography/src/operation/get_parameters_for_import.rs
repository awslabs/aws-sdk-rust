...
impl GetParametersForImportInput {
    /// Consumes the builder and constructs an Operation<[`GetParametersForImport`](crate::operation::get_parameters_for_import::GetParametersForImport)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_parameters_for_import::GetParametersForImport::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetParametersForImport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_parameters_for_import::de_get_parameters_for_import_http_response_with_props(status, headers, body)
        }
    }
