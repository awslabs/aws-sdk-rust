...
impl GetAliasInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_alias::GetAliasError, ::aws_smithy_http::operation::Response>,
    > {
...
impl GetAliasFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        crate::client::customize::CustomizableOperation<crate::operation::get_alias::GetAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
        ::aws_smithy_http::result::SdkError<crate::operation::get_alias::GetAliasError>,
    > {
