                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token = crate::lens::reflens_list_keys_output_next_token(resp);
...
impl ListKeysPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::KeySummary, ::aws_smithy_http::result::SdkError<crate::operation::list_keys::ListKeysError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_keys_output_keys(page).unwrap_or_default().into_iter())
    }
}
