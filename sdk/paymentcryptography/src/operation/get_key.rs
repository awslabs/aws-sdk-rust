...
impl GetKeyInput {
    /// Consumes the builder and constructs an Operation<[`GetKey`](crate::operation::get_key::GetKey)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_key::GetKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_key::ser_get_key_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_key::GetKey::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetKey", "paymentcryptography"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKey {
    type Output = ::std::result::Result<crate::operation::get_key::GetKeyOutput, crate::operation::get_key::GetKeyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_key::de_get_key_http_response_with_props(status, headers, body)
        }
    }
}
