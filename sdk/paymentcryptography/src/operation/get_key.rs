...
impl GetKeyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_key::ser_get_key_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_key::GetKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_key::de_get_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
