...
impl ::std::fmt::Debug for ImportKeyInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ImportKeyInput");
        formatter.field("key_material", &self.key_material);
        formatter.field("key_check_value_algorithm", &self.key_check_value_algorithm);
        formatter.field("enabled", &self.enabled);
        formatter.field("tags", &self.tags);
        formatter.field("replication_regions", &self.replication_regions);
...
impl ::std::fmt::Debug for ImportKeyInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ImportKeyInputBuilder");
        formatter.field("key_material", &self.key_material);
        formatter.field("key_check_value_algorithm", &self.key_check_value_algorithm);
        formatter.field("enabled", &self.enabled);
        formatter.field("tags", &self.tags);
