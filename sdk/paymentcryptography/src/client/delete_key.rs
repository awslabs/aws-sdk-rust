...
impl super::Client {
    ...
    ///   - [`key_identifier(impl ::std::convert::Into<String>)`](crate::operation::delete_key::builders::DeleteKeyFluentBuilder::key_identifier) / [`set_key_identifier(Option<String>)`](crate::operation::delete_key::builders::DeleteKeyFluentBuilder::set_key_identifier): <p>The <code>KeyARN</code> of the key that is scheduled for deletion.</p>
