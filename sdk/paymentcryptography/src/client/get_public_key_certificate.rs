...
impl super::Client {
    ...
    ///   - [`key_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_public_key_certificate::builders::GetPublicKeyCertificateFluentBuilder::key_identifier) / [`set_key_identifier(Option<String>)`](crate::operation::get_public_key_certificate::builders::GetPublicKeyCertificateFluentBuilder::set_key_identifier): <p>The <code>KeyARN</code> of the asymmetric key pair.</p>
