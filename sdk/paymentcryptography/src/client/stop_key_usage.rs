...
impl super::Client {
    ...
    ///   - [`key_identifier(impl Into<String>)`](crate::operation::stop_key_usage::builders::StopKeyUsageFluentBuilder::key_identifier) / [`set_key_identifier(Option<String>)`](crate::operation::stop_key_usage::builders::StopKeyUsageFluentBuilder::set_key_identifier): <p>The <code>KeyArn</code> of the key.</p>
