...
pub struct UpdateQualificationTypeOutput  {
    ...
    #[doc(hidden)]pub qualification_type: std::option::Option<crate::model::QualificationType>,
}
...
pub struct NotifyWorkersOutput  {
    ...
    #[doc(hidden)]pub notify_workers_failure_statuses: std::option::Option<std::vec::Vec<crate::model::NotifyWorkersFailureStatus>>,
}
...
impl  std::fmt::Debug for NotifyWorkersOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("notify_workers_failure_statuses", &self.notify_workers_failure_statuses);
        formatter.finish()
    }
}
...
pub struct ListWorkersWithQualificationTypeOutput  {
    ...
    #[doc(hidden)]pub qualifications: std::option::Option<std::vec::Vec<crate::model::Qualification>>,
}
...
pub struct ListWorkerBlocksOutput  {
    ...
    #[doc(hidden)]pub worker_blocks: std::option::Option<std::vec::Vec<crate::model::WorkerBlock>>,
}
...
pub struct ListReviewPolicyResultsForHitOutput  {
    ...
    #[doc(hidden)]pub assignment_review_report: std::option::Option<crate::model::ReviewReport>,
    /// <p>Contains both ReviewResult and ReviewAction elements for a particular HIT. </p>
    #[doc(hidden)]pub hit_review_report: std::option::Option<crate::model::ReviewReport>,
    /// <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Mechanical Turk returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListReviewableHiTsOutput  {
    ...
    #[doc(hidden)]pub hi_ts: std::option::Option<std::vec::Vec<crate::model::Hit>>,
}
...
pub struct ListQualificationTypesOutput  {
    ...
    #[doc(hidden)]pub qualification_types: std::option::Option<std::vec::Vec<crate::model::QualificationType>>,
}
...
pub struct ListQualificationRequestsOutput  {
    ...
    #[doc(hidden)]pub qualification_requests: std::option::Option<std::vec::Vec<crate::model::QualificationRequest>>,
}
...
pub struct ListBonusPaymentsOutput  {
    ...
    #[doc(hidden)]pub bonus_payments: std::option::Option<std::vec::Vec<crate::model::BonusPayment>>,
}
...
pub struct ListAssignmentsForHitOutput  {
    ...
    #[doc(hidden)]pub assignments: std::option::Option<std::vec::Vec<crate::model::Assignment>>,
}
...
pub struct GetQualificationScoreOutput  {
    ...
    #[doc(hidden)]pub qualification: std::option::Option<crate::model::Qualification>,
}
...
pub struct GetHitOutput  {
    ...
    #[doc(hidden)]pub hit: std::option::Option<crate::model::Hit>,
}
impl GetHitOutput {
    /// <p> Contains the requested HIT data.</p>
...
pub struct GetFileUploadUrlOutput  {
    ...
    #[doc(hidden)]pub file_upload_url: std::option::Option<std::string::String>,
}
...
pub struct GetAssignmentOutput  {
    ...
    #[doc(hidden)]pub assignment: std::option::Option<crate::model::Assignment>,
...
pub struct GetAccountBalanceOutput  {
    ...
    #[doc(hidden)]pub available_balance: std::option::Option<std::string::String>,
    /// <p>A string representing a currency amount.</p>
    #[doc(hidden)]pub on_hold_balance: std::option::Option<std::string::String>,
}
