    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::AssociateQualificationWithWorkerErrorKind::RequestError(
                        inner,
                    ) => Error::RequestError(inner),
                    crate::error::AssociateQualificationWithWorkerErrorKind::ServiceFault(
                        inner,
                    ) => Error::ServiceFault(inner),
    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::CreateAdditionalAssignmentsForHITErrorKind::RequestError(
                        inner,
                    ) => Error::RequestError(inner),
                    crate::error::CreateAdditionalAssignmentsForHITErrorKind::ServiceFault(
                        inner,
                    ) => Error::ServiceFault(inner),
    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::DisassociateQualificationFromWorkerErrorKind::RequestError(
                        inner,
                    ) => Error::RequestError(inner),
                    crate::error::DisassociateQualificationFromWorkerErrorKind::ServiceFault(
                        inner,
                    ) => Error::ServiceFault(inner),
                    crate::error::DisassociateQualificationFromWorkerErrorKind::Unhandled(
                        inner,
                    ) => Error::Unhandled(crate::error::Unhandled::new(inner.into())),
                }
            }
    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::ListWorkersWithQualificationTypeErrorKind::RequestError(
                        inner,
                    ) => Error::RequestError(inner),
                    crate::error::ListWorkersWithQualificationTypeErrorKind::ServiceFault(
                        inner,
                    ) => Error::ServiceFault(inner),
