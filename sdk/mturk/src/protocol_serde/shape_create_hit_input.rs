...
pub fn ser_create_hit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateHitInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
