...
pub fn ser_list_reviewable_hi_ts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListReviewableHiTsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
