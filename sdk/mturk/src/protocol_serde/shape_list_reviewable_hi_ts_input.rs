...
pub fn ser_list_reviewable_hi_ts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_reviewable_hi_ts::ListReviewableHiTsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
