...
pub fn ser_list_hi_ts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListHiTsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
