...
pub fn ser_qualification_requirement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QualificationRequirement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_qualification_requirement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::QualificationRequirement>, aws_smithy_json::deserialize::error::DeserializeError>
