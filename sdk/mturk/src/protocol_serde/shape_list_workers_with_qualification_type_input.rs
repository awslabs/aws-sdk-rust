...
pub fn ser_list_workers_with_qualification_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
