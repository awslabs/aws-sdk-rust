...
pub fn ser_notify_workers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::NotifyWorkersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
