...
impl AcceptQualificationRequestInput {
    /// Consumes the builder and constructs an Operation<[`AcceptQualificationRequest`](crate::operation::accept_qualification_request::AcceptQualificationRequest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::accept_qualification_request::AcceptQualificationRequest, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::accept_qualification_request::AcceptQualificationRequestInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::accept_qualification_request::AcceptQualificationRequest::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AcceptQualificationRequest {
                type Output = std::result::Result<crate::operation::accept_qualification_request::AcceptQualificationRequestOutput, crate::operation::accept_qualification_request::AcceptQualificationRequestError>;
