...
impl AcceptQualificationRequestInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::accept_qualification_request::AcceptQualificationRequest::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptQualificationRequest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_qualification_request::de_accept_qualification_request_http_response_with_props(status, headers, body)
        }
    }
}
