...
/// Orchestration and serialization glue logic for `AcceptQualificationRequest`.
...
impl AcceptQualificationRequest {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::accept_qualification_request::AcceptQualificationRequestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_qualification_request::AcceptQualificationRequestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_qualification_request::AcceptQualificationRequestError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_qualification_request::AcceptQualificationRequestOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptQualificationRequest {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptQualificationRequest");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptQualificationRequestRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptQualificationRequestResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptQualificationRequest")
...
.with_interceptor(AcceptQualificationRequestEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_qualification_request::AcceptQualificationRequestError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_qualification_request::AcceptQualificationRequestError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_qualification_request::AcceptQualificationRequestError>::new());
...
#[derive(Debug)]
            struct AcceptQualificationRequestResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptQualificationRequestResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_qualification_request::de_accept_qualification_request_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AcceptQualificationRequestRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptQualificationRequestRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_qualification_request::AcceptQualificationRequestInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_qualification_request::AcceptQualificationRequestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_accept_qualification_request::ser_accept_qualification_request_input(&input)?);
...
#[derive(Debug)]
            struct AcceptQualificationRequestEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptQualificationRequestEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AcceptQualificationRequestEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptQualificationRequestInput>()
                        .ok_or("failed to downcast to AcceptQualificationRequestInput")?;
...
pub enum AcceptQualificationRequestError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptQualificationRequestError) for what information is available for the error.")]
...
impl AcceptQualificationRequestError {
    /// Creates the `AcceptQualificationRequestError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptQualificationRequestError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptQualificationRequestError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_qualification_request::AcceptQualificationRequestError {
...
mod _accept_qualification_request_output;
