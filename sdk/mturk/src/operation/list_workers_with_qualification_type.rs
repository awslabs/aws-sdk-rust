...
impl ListWorkersWithQualificationTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkersWithQualificationType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_workers_with_qualification_type::de_list_workers_with_qualification_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
