...
impl UpdateNotificationSettingsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_notification_settings::UpdateNotificationSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNotificationSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_notification_settings::de_update_notification_settings_http_response_with_props(status, headers, body)
        }
    }
}
