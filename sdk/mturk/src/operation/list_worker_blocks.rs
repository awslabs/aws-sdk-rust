...
impl ListWorkerBlocksInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_worker_blocks::ser_list_worker_blocks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkerBlocks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_worker_blocks::de_list_worker_blocks_http_response_with_props(status, headers, body)
        }
    }
}
