...
impl CreateHitWithHitTypeInput {
    /// Consumes the builder and constructs an Operation<[`CreateHITWithHITType`](crate::operation::create_hit_with_hit_type::CreateHITWithHITType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_hit_with_hit_type::CreateHITWithHITType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_hit_with_hit_type::CreateHitWithHitTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_hit_with_hit_type::CreateHITWithHITType::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateHITWithHITType {
                type Output = std::result::Result<crate::operation::create_hit_with_hit_type::CreateHitWithHitTypeOutput, crate::operation::create_hit_with_hit_type::CreateHITWithHITTypeError>;
