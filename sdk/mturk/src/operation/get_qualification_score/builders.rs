...
impl GetQualificationScoreFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_qualification_score::GetQualificationScoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_qualification_score::GetQualificationScoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_qualification_score::GetQualificationScoreOutput, crate::operation::get_qualification_score::GetQualificationScoreError, Self> {
