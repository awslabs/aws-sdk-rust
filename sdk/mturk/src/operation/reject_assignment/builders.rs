...
impl RejectAssignmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reject_assignment::RejectAssignmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_assignment::RejectAssignmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reject_assignment::RejectAssignmentOutput, crate::operation::reject_assignment::RejectAssignmentError, Self> {
