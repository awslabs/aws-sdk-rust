...
impl CreateAdditionalAssignmentsForHitInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_additional_assignments_for_hit::CreateAdditionalAssignmentsForHIT::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAdditionalAssignmentsForHIT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_additional_assignments_for_hit::de_create_additional_assignments_for_hit_http_response_with_props(
                status, headers, body,
            )
        }
    }
