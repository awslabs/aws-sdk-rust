...
impl CreateAdditionalAssignmentsForHitInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_additional_assignments_for_hit::CreateAdditionalAssignmentsForHIT, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_additional_assignments_for_hit::CreateAdditionalAssignmentsForHitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
