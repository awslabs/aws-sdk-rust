...
impl ListReviewableHITsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_reviewable_hits::ListReviewableHiTsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_reviewable_hits::ListReviewableHITsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_reviewable_hits::ListReviewableHiTsOutput, crate::operation::list_reviewable_hits::ListReviewableHITsError, Self> {
