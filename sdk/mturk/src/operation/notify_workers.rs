...
impl NotifyWorkersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::notify_workers::NotifyWorkers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for NotifyWorkers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_notify_workers::de_notify_workers_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_notify_workers::de_notify_workers_http_response_with_props(
                status, headers, body,
            )
        }
    }
