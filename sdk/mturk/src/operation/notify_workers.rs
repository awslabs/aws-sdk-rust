...
impl NotifyWorkersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::notify_workers::NotifyWorkers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_notify_workers::ser_notify_workers_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for NotifyWorkers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_notify_workers::de_notify_workers_http_response_with_props(status, headers, body)
        }
    }
}
