...
impl NotifyWorkersInput {
    /// Consumes the builder and constructs an Operation<[`NotifyWorkers`](crate::operation::notify_workers::NotifyWorkers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::notify_workers::NotifyWorkers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::notify_workers::NotifyWorkersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::notify_workers::NotifyWorkers::new())
...
impl aws_smithy_http::response::ParseStrictResponse for NotifyWorkers {
                type Output = std::result::Result<crate::operation::notify_workers::NotifyWorkersOutput, crate::operation::notify_workers::NotifyWorkersError>;
