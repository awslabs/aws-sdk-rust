...
impl ListReviewableHiTsOutput {
    ...
    /// <p> The list of HIT elements returned by the query.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.hi_ts.is_none()`.
    pub fn hi_ts(&self) -> &[crate::types::Hit] {
        self.hi_ts.as_deref().unwrap_or_default()
    }
}
impl ::aws_http::request_id::RequestId for ListReviewableHiTsOutput {
...
impl ListReviewableHiTsOutputBuilder {
    ...
    pub fn hi_ts(mut self, input: crate::types::Hit) -> Self {
        ...
        v.push(input);
        self.hi_ts = ::std::option::Option::Some(v);
        self
    }
    /// <p> The list of HIT elements returned by the query.</p>
    ...
    /// Consumes the builder and constructs a [`ListReviewableHiTsOutput`](crate::operation::list_reviewable_hi_ts::ListReviewableHiTsOutput).
    pub fn build(self) -> crate::operation::list_reviewable_hi_ts::ListReviewableHiTsOutput {
