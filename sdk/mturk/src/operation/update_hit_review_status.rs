...
impl UpdateHitReviewStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_hit_review_status::UpdateHITReviewStatus,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateHITReviewStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_hit_review_status::de_update_hit_review_status_http_response_with_props(status, headers, body)
        }
    }
}
