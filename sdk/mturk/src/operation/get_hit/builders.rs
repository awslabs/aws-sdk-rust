...
impl GetHitInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_hit::GetHITError, ::aws_smithy_http::operation::Response>,
    > {
...
impl GetHITFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::get_hit::GetHitOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_hit::GetHITError>>
    {
        let op = self
            .inner
            .build()
