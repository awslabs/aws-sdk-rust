...
impl CreateHitInput {
    /// Consumes the builder and constructs an Operation<[`CreateHIT`](crate::operation::create_hit::CreateHIT)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_hit::CreateHIT, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_hit::ser_create_hit_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_hit::CreateHIT::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHIT {
    type Output = ::std::result::Result<crate::operation::create_hit::CreateHitOutput, crate::operation::create_hit::CreateHITError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_hit::de_create_hit_http_response_with_props(status, headers, body)
        }
    }
}
