...
impl ApproveAssignmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_approve_assignment::ser_approve_assignment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApproveAssignment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_approve_assignment::de_approve_assignment_http_response_with_props(status, headers, body)
        }
    }
}
