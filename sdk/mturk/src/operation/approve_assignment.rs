...
impl ApproveAssignmentInput {
    /// Consumes the builder and constructs an Operation<[`ApproveAssignment`](crate::operation::approve_assignment::ApproveAssignment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::approve_assignment::ApproveAssignment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::approve_assignment::ApproveAssignmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::approve_assignment::ApproveAssignment::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ApproveAssignment {
                type Output = std::result::Result<crate::operation::approve_assignment::ApproveAssignmentOutput, crate::operation::approve_assignment::ApproveAssignmentError>;
