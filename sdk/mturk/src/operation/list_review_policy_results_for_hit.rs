...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReviewPolicyResultsForHIT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_review_policy_results_for_hit::de_list_review_policy_results_for_hit_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_review_policy_results_for_hit::ListReviewPolicyResultsForHITError
{
