...
impl CreateHitTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_hit_type::CreateHITType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_hit_type::ser_create_hit_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHITType {
    type Output =
        ::std::result::Result<crate::operation::create_hit_type::CreateHitTypeOutput, crate::operation::create_hit_type::CreateHITTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_hit_type::de_create_hit_type_http_response_with_props(status, headers, body)
        }
    }
}
