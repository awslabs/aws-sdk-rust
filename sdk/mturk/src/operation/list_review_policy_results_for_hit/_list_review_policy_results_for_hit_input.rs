...
impl ListReviewPolicyResultsForHitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_review_policy_results_for_hit::ListReviewPolicyResultsForHitInput, ::aws_smithy_types::error::operation::BuildError> {
