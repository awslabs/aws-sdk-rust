...
impl ListHITsForQualificationType {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_hits_for_qualification_type::ListHITsForQualificationTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_hits_for_qualification_type::ListHITsForQualificationTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListHITsForQualificationType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListHITsForQualificationType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListHITsForQualificationTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListHITsForQualificationTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListHITsForQualificationType")
...
.with_interceptor(ListHITsForQualificationTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_hits_for_qualification_type::ListHITsForQualificationTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_hits_for_qualification_type::ListHITsForQualificationTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_hits_for_qualification_type::ListHITsForQualificationTypeError>::new());
...
#[derive(Debug)]
            struct ListHITsForQualificationTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListHITsForQualificationTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_hits_for_qualification_type::de_list_hits_for_qualification_type_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_hits_for_qualification_type::de_list_hits_for_qualification_type_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListHITsForQualificationTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListHITsForQualificationTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_hits_for_qualification_type::ser_list_hits_for_qualification_type_input(&input)?);
...
#[derive(Debug)]
            struct ListHITsForQualificationTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListHITsForQualificationTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListHITsForQualificationTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListHiTsForQualificationTypeInput>()
                        .ok_or("failed to downcast to ListHiTsForQualificationTypeInput")?;
...
pub enum ListHITsForQualificationTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListHITsForQualificationTypeError) for what information is available for the error.")]
...
impl ListHITsForQualificationTypeError {
    /// Creates the `ListHITsForQualificationTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListHITsForQualificationTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListHITsForQualificationTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_hits_for_qualification_type::ListHITsForQualificationTypeError {
...
mod _list_hits_for_qualification_type_output;
