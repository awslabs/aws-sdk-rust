...
impl ListBonusPaymentsInput {
    /// Consumes the builder and constructs an Operation<[`ListBonusPayments`](crate::operation::list_bonus_payments::ListBonusPayments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_bonus_payments::ListBonusPayments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_bonus_payments::ListBonusPaymentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_bonus_payments::ListBonusPayments::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListBonusPayments {
                type Output = std::result::Result<crate::operation::list_bonus_payments::ListBonusPaymentsOutput, crate::operation::list_bonus_payments::ListBonusPaymentsError>;
