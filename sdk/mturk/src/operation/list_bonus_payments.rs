...
impl ListBonusPaymentsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_bonus_payments::ser_list_bonus_payments_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBonusPayments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_bonus_payments::de_list_bonus_payments_http_response_with_props(status, headers, body)
        }
    }
}
