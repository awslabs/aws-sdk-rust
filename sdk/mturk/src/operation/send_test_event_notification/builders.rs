...
impl SendTestEventNotificationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_test_event_notification::SendTestEventNotificationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_test_event_notification::SendTestEventNotificationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_test_event_notification::SendTestEventNotificationOutput, crate::operation::send_test_event_notification::SendTestEventNotificationError, Self> {
