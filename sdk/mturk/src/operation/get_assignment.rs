...
impl GetAssignmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_assignment::GetAssignment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_assignment::ser_get_assignment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAssignment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_assignment::de_get_assignment_http_response_with_props(status, headers, body)
        }
    }
}
