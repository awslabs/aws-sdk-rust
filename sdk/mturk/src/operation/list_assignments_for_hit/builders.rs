...
impl ListAssignmentsForHITFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_assignments_for_hit::ListAssignmentsForHitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_assignments_for_hit::ListAssignmentsForHITError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_assignments_for_hit::ListAssignmentsForHitOutput, crate::operation::list_assignments_for_hit::ListAssignmentsForHITError, Self> {
