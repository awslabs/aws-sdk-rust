...
impl GetAccountBalanceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_account_balance::ser_get_account_balance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountBalance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_account_balance::de_get_account_balance_http_response_with_props(status, headers, body)
        }
    }
}
