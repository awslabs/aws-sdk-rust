...
impl GetAccountBalanceInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountBalance`](crate::operation::get_account_balance::GetAccountBalance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_account_balance::GetAccountBalance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_account_balance::GetAccountBalanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_balance::GetAccountBalance::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccountBalance {
                type Output = std::result::Result<crate::operation::get_account_balance::GetAccountBalanceOutput, crate::operation::get_account_balance::GetAccountBalanceError>;
