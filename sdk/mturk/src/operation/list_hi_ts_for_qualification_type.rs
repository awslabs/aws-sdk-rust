    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_hi_ts_for_qualification_type::ListHITsForQualificationTypeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_hi_ts_for_qualification_type::ListHiTsForQualificationTypeOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListHITsForQualificationTypeResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_hi_ts_for_qualification_type::de_list_hi_ts_for_qualification_type_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListHITsForQualificationTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_hi_ts_for_qualification_type::ListHiTsForQualificationTypeInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_hi_ts_for_qualification_type::ser_list_hi_ts_for_qualification_type_input(&input)?,
        );
