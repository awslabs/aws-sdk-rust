...
impl RejectAssignmentInput {
    /// Consumes the builder and constructs an Operation<[`RejectAssignment`](crate::operation::reject_assignment::RejectAssignment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reject_assignment::RejectAssignment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reject_assignment::RejectAssignmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reject_assignment::RejectAssignment::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RejectAssignment {
                type Output = std::result::Result<crate::operation::reject_assignment::RejectAssignmentOutput, crate::operation::reject_assignment::RejectAssignmentError>;
