...
impl RejectAssignmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reject_assignment::RejectAssignment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reject_assignment::ser_reject_assignment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectAssignment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_assignment::de_reject_assignment_http_response_with_props(status, headers, body)
        }
    }
}
