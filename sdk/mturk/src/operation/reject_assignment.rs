...
/// Orchestration and serialization glue logic for `RejectAssignment`.
...
impl RejectAssignment {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::reject_assignment::RejectAssignmentInput,
                    ) -> ::std::result::Result<crate::operation::reject_assignment::RejectAssignmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_assignment::RejectAssignmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reject_assignment::RejectAssignmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reject_assignment::RejectAssignmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectAssignment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RejectAssignment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RejectAssignmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RejectAssignmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RejectAssignment")
...
.with_interceptor(RejectAssignmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reject_assignment::RejectAssignmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reject_assignment::RejectAssignmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reject_assignment::RejectAssignmentError>::new());
...
#[derive(Debug)]
            struct RejectAssignmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RejectAssignmentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reject_assignment::de_reject_assignment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reject_assignment::de_reject_assignment_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RejectAssignmentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RejectAssignmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reject_assignment::RejectAssignmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reject_assignment::RejectAssignmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reject_assignment::ser_reject_assignment_input(&input)?);
...
#[derive(Debug)]
            struct RejectAssignmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RejectAssignmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RejectAssignmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RejectAssignmentInput>()
                        .ok_or("failed to downcast to RejectAssignmentInput")?;
...
pub enum RejectAssignmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RejectAssignmentError) for what information is available for the error.")]
...
impl RejectAssignmentError {
    /// Creates the `RejectAssignmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RejectAssignmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RejectAssignmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reject_assignment::RejectAssignmentError {
