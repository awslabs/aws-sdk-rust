...
impl ListReviewableHITs {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::list_reviewable_hi_ts::ListReviewableHiTsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_reviewable_hi_ts::ListReviewableHITsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_reviewable_hi_ts::ListReviewableHiTsOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListReviewableHITs")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListReviewableHITsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListReviewableHITsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_list_reviewable_hi_ts::de_list_reviewable_hi_ts_http_error(status, headers, body)
        } else {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListReviewableHITsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_reviewable_hi_ts::ListReviewableHiTsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_reviewable_hi_ts::ListReviewableHiTsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_reviewable_hi_ts::ser_list_reviewable_hi_ts_input(
            &input,
        )?);
...
impl ::aws_http::request_id::RequestId for crate::operation::list_reviewable_hi_ts::ListReviewableHITsError {
...
pub use crate::operation::list_reviewable_hi_ts::_list_reviewable_hi_ts_output::ListReviewableHiTsOutput;

pub use crate::operation::list_reviewable_hi_ts::_list_reviewable_hi_ts_input::ListReviewableHiTsInput;

mod _list_reviewable_hi_ts_input;

mod _list_reviewable_hi_ts_output;
