...
impl UpdateHitTypeOfHitInput {
    /// Consumes the builder and constructs an Operation<[`UpdateHITTypeOfHIT`](crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHIT)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHIT::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateHITTypeOfHIT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_hit_type_of_hit::de_update_hit_type_of_hit_http_response_with_props(status, headers, body)
        }
    }
}
