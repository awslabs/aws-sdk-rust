...
impl UpdateHitTypeOfHitInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHIT, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_hit_type_of_hit::UpdateHitTypeOfHitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateHITTypeOfHIT {
                type Output = std::result::Result<crate::operation::update_hit_type_of_hit::UpdateHitTypeOfHitOutput, crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError>;
