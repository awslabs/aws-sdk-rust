...
/// Orchestration and serialization glue logic for `UpdateHITTypeOfHIT`.
...
impl UpdateHITTypeOfHIT {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_hit_type_of_hit::UpdateHitTypeOfHitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_hit_type_of_hit::UpdateHitTypeOfHitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateHITTypeOfHIT {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateHITTypeOfHIT");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateHITTypeOfHITRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateHITTypeOfHITResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateHITTypeOfHIT")
...
.with_interceptor(UpdateHITTypeOfHITEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError>::new());
...
#[derive(Debug)]
            struct UpdateHITTypeOfHITResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateHITTypeOfHITResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_hit_type_of_hit::de_update_hit_type_of_hit_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateHITTypeOfHITRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateHITTypeOfHITRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_hit_type_of_hit::UpdateHitTypeOfHitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_hit_type_of_hit::UpdateHitTypeOfHitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_hit_type_of_hit::ser_update_hit_type_of_hit_input(&input)?);
...
#[derive(Debug)]
            struct UpdateHITTypeOfHITEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateHITTypeOfHITEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateHITTypeOfHITEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateHitTypeOfHitInput>()
                        .ok_or("failed to downcast to UpdateHitTypeOfHitInput")?;
...
pub enum UpdateHITTypeOfHITError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateHITTypeOfHITError) for what information is available for the error.")]
...
impl UpdateHITTypeOfHITError {
    /// Creates the `UpdateHITTypeOfHITError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateHITTypeOfHITError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateHITTypeOfHITError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_hit_type_of_hit::UpdateHITTypeOfHITError {
...
mod _update_hit_type_of_hit_output;
