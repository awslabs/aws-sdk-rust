...
impl UpdateExpirationForHITFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_expiration_for_hit::UpdateExpirationForHitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_expiration_for_hit::UpdateExpirationForHITError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_expiration_for_hit::UpdateExpirationForHitOutput, crate::operation::update_expiration_for_hit::UpdateExpirationForHITError, Self> {
