...
impl CreateHITWithHITTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_hit_with_hit_type::CreateHitWithHitTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_hit_with_hit_type::CreateHITWithHITTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_hit_with_hit_type::CreateHitWithHitTypeOutput, crate::operation::create_hit_with_hit_type::CreateHITWithHITTypeError, Self> {
