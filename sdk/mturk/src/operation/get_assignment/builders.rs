...
impl GetAssignmentFluentBuilder  {
    /// Creates a new `GetAssignment`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_assignment::GetAssignmentOutput, aws_smithy_http::result::SdkError<crate::operation::get_assignment::GetAssignmentError>>
                     {
