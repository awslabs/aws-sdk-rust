...
impl ListHiTsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_hi_ts::ListHITs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_hi_ts::ser_list_hi_ts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHITs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_hi_ts::de_list_hi_ts_http_response_with_props(status, headers, body)
        }
    }
}
