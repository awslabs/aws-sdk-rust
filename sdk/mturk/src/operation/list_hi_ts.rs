...
impl ListHITs {
    ...
    > {
        let map_err = |err: ::aws_smithy_http::result::SdkError<
            ...
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >| {
            err.map_service_error(|err| err.downcast::<crate::operation::list_hi_ts::ListHITsError>().expect("correct error type"))
        };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_hi_ts::ListHiTsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListHITsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<crate::operation::list_hi_ts::ListHiTsInput>().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListHITsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ListHITsEndpointParamsInterceptor"
    }
