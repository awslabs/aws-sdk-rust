...
impl ListHITs {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::list_hi_ts::ListHiTsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_hi_ts::ListHITsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_hi_ts::ListHiTsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("mturk", "ListHITs", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListHITs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListHITs");
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListHITs", "mturk"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListHITs")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListHITsEndpointParamsInterceptor) as _),
        )
    }
}

#[derive(Debug)]
struct ListHITsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListHITsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_hi_ts::de_list_hi_ts_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ListHITsRequestSerializer;
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListHITsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_hi_ts::ListHiTsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_hi_ts::ListHiTsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_hi_ts::ser_list_hi_ts_input(&input)?);
...
#[derive(Debug)]
struct ListHITsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListHITsEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListHiTsInput>()
            .ok_or("failed to downcast to ListHiTsInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_hi_ts::ListHITsError {
...
pub use crate::operation::list_hi_ts::_list_hi_ts_output::ListHiTsOutput;

pub use crate::operation::list_hi_ts::_list_hi_ts_input::ListHiTsInput;

mod _list_hi_ts_input;

mod _list_hi_ts_output;
