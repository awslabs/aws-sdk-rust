...
impl ListHiTsInput {
    /// Consumes the builder and constructs an Operation<[`ListHITs`](crate::operation::list_hi_ts::ListHITs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_hi_ts::ListHITs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_hi_ts::ListHiTsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_hi_ts::ListHITs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListHITs {
                type Output = std::result::Result<crate::operation::list_hi_ts::ListHiTsOutput, crate::operation::list_hi_ts::ListHITsError>;
