...
impl GetHitInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_hit::GetHIT, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_hit::ser_get_hit_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHIT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_hit::de_get_hit_http_response_with_props(status, headers, body)
        }
    }
}
