...
impl ListHiTsForQualificationTypeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeInput, ::aws_smithy_types::error::operation::BuildError> {
