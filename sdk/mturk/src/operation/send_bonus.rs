...
impl SendBonusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_bonus::SendBonus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_bonus::ser_send_bonus_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendBonus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_bonus::de_send_bonus_http_response_with_props(status, headers, body)
        }
    }
}
