...
impl RejectQualificationRequestInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::reject_qualification_request::RejectQualificationRequest::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectQualificationRequest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_qualification_request::de_reject_qualification_request_http_response_with_props(status, headers, body)
        }
    }
}
