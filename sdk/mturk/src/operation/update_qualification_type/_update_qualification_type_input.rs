...
impl UpdateQualificationTypeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_qualification_type::UpdateQualificationTypeInput, ::aws_smithy_types::error::operation::BuildError> {
