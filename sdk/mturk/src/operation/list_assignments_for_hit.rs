...
impl ListAssignmentsForHitInput {
    /// Consumes the builder and constructs an Operation<[`ListAssignmentsForHIT`](crate::operation::list_assignments_for_hit::ListAssignmentsForHIT)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_assignments_for_hit::ListAssignmentsForHIT, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_assignments_for_hit::ListAssignmentsForHitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_assignments_for_hit::ListAssignmentsForHIT::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssignmentsForHIT {
                type Output = std::result::Result<crate::operation::list_assignments_for_hit::ListAssignmentsForHitOutput, crate::operation::list_assignments_for_hit::ListAssignmentsForHITError>;
