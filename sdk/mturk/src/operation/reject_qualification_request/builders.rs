...
impl RejectQualificationRequestFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reject_qualification_request::RejectQualificationRequestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_qualification_request::RejectQualificationRequestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reject_qualification_request::RejectQualificationRequestOutput, crate::operation::reject_qualification_request::RejectQualificationRequestError, Self> {
