...
impl UpdateExpirationForHitInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_expiration_for_hit::UpdateExpirationForHIT,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateExpirationForHIT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_expiration_for_hit::de_update_expiration_for_hit_http_response_with_props(status, headers, body)
        }
    }
}
