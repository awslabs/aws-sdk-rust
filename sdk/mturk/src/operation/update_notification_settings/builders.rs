...
impl UpdateNotificationSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_notification_settings::UpdateNotificationSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_notification_settings::UpdateNotificationSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_notification_settings::UpdateNotificationSettingsOutput, crate::operation::update_notification_settings::UpdateNotificationSettingsError, Self> {
