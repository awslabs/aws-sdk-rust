...
impl crate::operation::update_notification_settings::builders::UpdateNotificationSettingsInputBuilder {
...
impl UpdateNotificationSettingsFluentBuilder {
    /// Creates a new `UpdateNotificationSettingsFluentBuilder`.
