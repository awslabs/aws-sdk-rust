...
impl ListQualificationRequestsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_qualification_requests::ListQualificationRequests::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQualificationRequests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_qualification_requests::de_list_qualification_requests_http_response_with_props(status, headers, body)
        }
    }
}
