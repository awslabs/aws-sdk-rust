...
impl DeleteHitInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_hit::DeleteHIT, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_hit::ser_delete_hit_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHIT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_hit::de_delete_hit_http_response_with_props(status, headers, body)
        }
    }
}
