...
impl super::Client {
    ...
    ///   - [`hit_id(impl Into<String>)`](crate::operation::delete_hit::builders::DeleteHITFluentBuilder::hit_id) / [`set_hit_id(Option<String>)`](crate::operation::delete_hit::builders::DeleteHITFluentBuilder::set_hit_id):<br>required: **true**<br><p>The ID of the HIT to be deleted.</p><br>
