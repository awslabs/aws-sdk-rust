...
impl super::Client {
    ...
    ///   - [`hit_id(impl ::std::convert::Into<String>)`](crate::operation::list_bonus_payments::builders::ListBonusPaymentsFluentBuilder::hit_id) / [`set_hit_id(Option<String>)`](crate::operation::list_bonus_payments::builders::ListBonusPaymentsFluentBuilder::set_hit_id): <p>The ID of the HIT associated with the bonus payments to retrieve. If not specified, all bonus payments for all assignments for the given HIT are returned. Either the HITId parameter or the AssignmentId parameter must be specified</p>
    ///   - [`assignment_id(impl ::std::convert::Into<String>)`](crate::operation::list_bonus_payments::builders::ListBonusPaymentsFluentBuilder::assignment_id) / [`set_assignment_id(Option<String>)`](crate::operation::list_bonus_payments::builders::ListBonusPaymentsFluentBuilder::set_assignment_id): <p>The ID of the assignment associated with the bonus payments to retrieve. If specified, only bonus payments for the given assignment are returned. Either the HITId parameter or the AssignmentId parameter must be specified</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_bonus_payments::builders::ListBonusPaymentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_bonus_payments::builders::ListBonusPaymentsFluentBuilder::set_next_token): <p>Pagination token</p>
