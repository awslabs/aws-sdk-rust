...
impl super::Client {
    ...
    ///   - [`worker_id(impl Into<String>)`](crate::operation::delete_worker_block::builders::DeleteWorkerBlockFluentBuilder::worker_id) / [`set_worker_id(Option<String>)`](crate::operation::delete_worker_block::builders::DeleteWorkerBlockFluentBuilder::set_worker_id):<br>required: **true**<br><p>The ID of the Worker to unblock.</p><br>
    ///   - [`reason(impl Into<String>)`](crate::operation::delete_worker_block::builders::DeleteWorkerBlockFluentBuilder::reason) / [`set_reason(Option<String>)`](crate::operation::delete_worker_block::builders::DeleteWorkerBlockFluentBuilder::set_reason):<br>required: **false**<br><p>A message that explains the reason for unblocking the Worker. The Worker does not see this message.</p><br>
