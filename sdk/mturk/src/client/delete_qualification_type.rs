...
impl super::Client {
    ...
    ///   - [`qualification_type_id(impl Into<String>)`](crate::operation::delete_qualification_type::builders::DeleteQualificationTypeFluentBuilder::qualification_type_id) / [`set_qualification_type_id(Option<String>)`](crate::operation::delete_qualification_type::builders::DeleteQualificationTypeFluentBuilder::set_qualification_type_id):<br>required: **true**<br><p>The ID of the QualificationType to dispose.</p><br>
