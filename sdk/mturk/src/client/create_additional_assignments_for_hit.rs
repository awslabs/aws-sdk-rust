...
impl super::Client {
    ...
    ///   - [`hit_id(impl ::std::convert::Into<String>)`](crate::operation::create_additional_assignments_for_hit::builders::CreateAdditionalAssignmentsForHITFluentBuilder::hit_id) / [`set_hit_id(Option<String>)`](crate::operation::create_additional_assignments_for_hit::builders::CreateAdditionalAssignmentsForHITFluentBuilder::set_hit_id): <p>The ID of the HIT to extend.</p>
