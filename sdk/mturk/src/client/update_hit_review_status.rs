...
impl super::Client {
    ...
    ///   - [`hit_id(impl ::std::convert::Into<String>)`](crate::operation::update_hit_review_status::builders::UpdateHITReviewStatusFluentBuilder::hit_id) / [`set_hit_id(Option<String>)`](crate::operation::update_hit_review_status::builders::UpdateHITReviewStatusFluentBuilder::set_hit_id): <p> The ID of the HIT to update. </p>
