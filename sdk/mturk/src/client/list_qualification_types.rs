...
impl super::Client {
    ...
    ///   - [`query(impl Into<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::query) / [`set_query(Option<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_query): <p> A text query against all of the searchable attributes of Qualification types. </p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Mechanical Turk returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
