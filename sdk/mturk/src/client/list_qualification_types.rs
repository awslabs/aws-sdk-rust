...
impl super::Client {
    ...
    ///   - [`query(impl ::std::convert::Into<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::query) / [`set_query(Option<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_query): <p> A text query against all of the searchable attributes of Qualification types. </p>
    ///   - [`must_be_requestable(bool)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::must_be_requestable) / [`set_must_be_requestable(Option<bool>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_must_be_requestable): <p>Specifies that only Qualification types that a user can request through the Amazon Mechanical Turk web site, such as by taking a Qualification test, are returned as results of the search. Some Qualification types, such as those assigned automatically by the system, cannot be requested directly by users. If false, all Qualification types, including those managed by the system, are considered. Valid values are True | False. </p>
    ///   - [`must_be_owned_by_caller(bool)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::must_be_owned_by_caller) / [`set_must_be_owned_by_caller(Option<bool>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_must_be_owned_by_caller): <p> Specifies that only Qualification types that the Requester created are returned. If false, the operation returns all Qualification types. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Mechanical Turk returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    ///   - [`max_results(i32)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder::set_max_results): <p> The maximum number of results to return in a single call. </p>
    ...
    pub fn list_qualification_types(
        &self,
    ) -> crate::operation::list_qualification_types::builders::ListQualificationTypesFluentBuilder
    {
