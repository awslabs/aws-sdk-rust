...
///
/// Client for invoking operations on Amazon WorkSpaces Thin Client. Each operation on Amazon WorkSpaces Thin Client is a method on this
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_workspacesthinclient::Error> {
/// # let client: aws_sdk_workspacesthinclient::Client = unimplemented!();
...
mod deregister_device;

mod get_device;

mod get_environment;

mod get_software_set;

mod list_devices;

mod list_environments;

mod list_software_sets;
