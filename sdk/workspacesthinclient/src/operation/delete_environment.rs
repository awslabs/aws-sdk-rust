    ...
    pub(crate) async fn orchestrate(
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::delete_environment::DeleteEnvironmentInput = input.downcast_mut().expect("correct type");
...
#[derive(Debug)]
    ...
    ::std::write!(output, "/environments/{id}", id = id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::delete_environment::DeleteEnvironmentInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
