...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_device::DeregisterDeviceError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_software_set::GetSoftwareSetError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_software_sets::ListSoftwareSetsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_software_set::UpdateSoftwareSetError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::update_software_set::UpdateSoftwareSetError> for Error {
    fn from(err: crate::operation::update_software_set::UpdateSoftwareSetError) -> Self {
        match err {
            ...
            crate::operation::update_software_set::UpdateSoftwareSetError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
