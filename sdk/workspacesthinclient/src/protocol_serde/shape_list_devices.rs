...
pub fn de_list_devices_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_devices::ListDevicesOutput, crate::operation::list_devices::ListDevicesError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_devices::ListDevicesError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
                output.build()
