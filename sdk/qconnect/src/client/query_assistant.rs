...
impl super::Client {
    ...
    ///   - [`assistant_id(impl Into<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::assistant_id) / [`set_assistant_id(Option<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::set_assistant_id):<br>required: **true**<br><p>The identifier of the Amazon Q in Connect assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p><br>
    ///   - [`query_text(impl Into<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::query_text) / [`set_query_text(Option<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::set_query_text):<br>required: **false**<br><p>The text to search for.</p><br>
    ...
    ///   - [`query_input_data(QueryInputData)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::query_input_data) / [`set_query_input_data(Option<QueryInputData>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::set_query_input_data):<br>required: **false**<br><p>Information about the query.</p><br>
    ///   - [`override_knowledge_base_search_type(KnowledgeBaseSearchType)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::override_knowledge_base_search_type) / [`set_override_knowledge_base_search_type(Option<KnowledgeBaseSearchType>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::set_override_knowledge_base_search_type):<br>required: **false**<br><p>The search type to be used against the Knowledge Base for this request. The values can be <code>SEMANTIC</code> which uses vector embeddings or <code>HYBRID</code> which use vector embeddings and raw text.</p><br>
