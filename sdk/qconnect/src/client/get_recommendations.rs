...
impl super::Client {
    ...
    ///   - [`next_chunk_token(impl Into<String>)`](crate::operation::get_recommendations::builders::GetRecommendationsFluentBuilder::next_chunk_token) / [`set_next_chunk_token(Option<String>)`](crate::operation::get_recommendations::builders::GetRecommendationsFluentBuilder::set_next_chunk_token):<br>required: **false**<br><p>The token for the next set of chunks. Use the value returned in the previous response in the next request to retrieve the next set of chunks.</p><br>
    ///   - [`recommendation_type(RecommendationType)`](crate::operation::get_recommendations::builders::GetRecommendationsFluentBuilder::recommendation_type) / [`set_recommendation_type(Option<RecommendationType>)`](crate::operation::get_recommendations::builders::GetRecommendationsFluentBuilder::set_recommendation_type):<br>required: **false**<br><p>The type of recommendation being requested.</p><br>
