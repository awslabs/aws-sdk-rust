...
impl RemoveKnowledgeBaseTemplateUriInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriInput, ::aws_smithy_types::error::operation::BuildError> {
