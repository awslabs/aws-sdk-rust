...
/// Paginator for [`ListKnowledgeBases`](crate::operation::list_knowledge_bases::ListKnowledgeBases)
pub struct ListKnowledgeBasesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_knowledge_bases::builders::ListKnowledgeBasesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListKnowledgeBasesPaginator {
    ...
    pub fn items(self) -> crate::operation::list_knowledge_bases::paginator::ListKnowledgeBasesPaginatorItems {
        crate::operation::list_knowledge_bases::paginator::ListKnowledgeBasesPaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_knowledge_bases::ListKnowledgeBases::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_knowledge_bases::ListKnowledgeBases::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_knowledge_bases_output_output_next_token(resp);
...
pub struct ListKnowledgeBasesPaginatorItems(ListKnowledgeBasesPaginator);

impl ListKnowledgeBasesPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_knowledge_bases_output_output_knowledge_base_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
