...
pub use crate::operation::create_ai_agent::_create_ai_agent_input::CreateAiAgentInputBuilder;

pub use crate::operation::create_ai_agent::_create_ai_agent_output::CreateAiAgentOutputBuilder;

impl crate::operation::create_ai_agent::builders::CreateAiAgentInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::create_ai_agent::CreateAIAgentError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.create_ai_agent();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `CreateAIAgent`.
///
/// <p>Creates an Amazon Q in Connect AI Agent.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct CreateAIAgentFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::create_ai_agent::builders::CreateAiAgentInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_ai_agent::CreateAiAgentOutput,
        crate::operation::create_ai_agent::CreateAIAgentError,
    > for CreateAIAgentFluentBuilder
{
    fn send(
        self,
...
impl CreateAIAgentFluentBuilder {
    /// Creates a new `CreateAIAgentFluentBuilder`.
    ...
    /// Access the CreateAIAgent as a reference.
    pub fn as_input(&self) -> &crate::operation::create_ai_agent::builders::CreateAiAgentInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_ai_agent::CreateAIAgent::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_ai_agent::CreateAIAgent::orchestrate(&runtime_plugins, input).await
    }
