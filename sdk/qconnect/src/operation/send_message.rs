...
impl SendMessage {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("QConnect", "SendMessage", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendMessage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("SendMessage", "QConnect"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendMessageTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("orchestratorUseCase") {
            if let ::std::option::Option::Some(value) = input.orchestrator_use_case.as_deref() {
                captured.insert("orchestratorUseCase", value);
            }
        }
        if requested.should_capture("originRequestId") {
            if let ::std::option::Option::Some(value) = input.origin_request_id.as_deref() {
                captured.insert("originRequestId", value);
            }
        }
...
impl SendMessageError {
    ...
    /// Returns `true` if the error kind is `SendMessageError::DependencyFailedException`.
    pub fn is_dependency_failed_exception(&self) -> bool {
        matches!(self, Self::DependencyFailedException(_))
    }
    /// Returns `true` if the error kind is `SendMessageError::RequestTimeoutException`.
