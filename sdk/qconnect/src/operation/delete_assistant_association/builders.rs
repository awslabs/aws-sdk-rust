...
pub use crate::operation::delete_assistant_association::_delete_assistant_association_output::DeleteAssistantAssociationOutputBuilder;

pub use crate::operation::delete_assistant_association::_delete_assistant_association_input::DeleteAssistantAssociationInputBuilder;
...
impl DeleteAssistantAssociationInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_assistant_association();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_assistant_association::DeleteAssistantAssociationOutput,
                    crate::operation::delete_assistant_association::DeleteAssistantAssociationError,
                > for DeleteAssistantAssociationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteAssistantAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_assistant_association::DeleteAssistantAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_assistant_association::DeleteAssistantAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_assistant_association::DeleteAssistantAssociation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_assistant_association::DeleteAssistantAssociation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_assistant_association::DeleteAssistantAssociationOutput, crate::operation::delete_assistant_association::DeleteAssistantAssociationError, Self> {
