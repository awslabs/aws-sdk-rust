...
impl DeleteKnowledgeBaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_knowledge_base::DeleteKnowledgeBaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_knowledge_base::DeleteKnowledgeBaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_knowledge_base::DeleteKnowledgeBaseOutput, crate::operation::delete_knowledge_base::DeleteKnowledgeBaseError, Self> {
