...
impl CreateSession {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("QConnect", "CreateSession", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSession {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateSession", "QConnect"));
...
impl CreateSessionError {
    ...
    /// Returns `true` if the error kind is `CreateSessionError::DependencyFailedException`.
    ...
    /// Returns `true` if the error kind is `CreateSessionError::UnauthorizedException`.
