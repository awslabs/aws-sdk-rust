...
/// Paginator for [`ListModels`](crate::operation::list_models::ListModels)
pub struct ListModelsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_models::builders::ListModelsInputBuilder,
...
impl ListModelsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `model_summaries`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_models::paginator::ListModelsPaginatorItems {
        crate::operation::list_models::paginator::ListModelsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_models::ListModels::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_models_output_output_next_token(resp);
...
impl ListModelsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_models_output_output_model_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
