        ...
        ::std::result::Result::Ok(
            crate::operation::put_feedback::PutFeedbackOutput {
                assistant_id: self.assistant_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assistant_id", "assistant_id was not specified but it is required when building PutFeedbackOutput")
                    )?
                ,
                assistant_arn: self.assistant_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assistant_arn", "assistant_arn was not specified but it is required when building PutFeedbackOutput")
                    )?
                ,
                target_id: self.target_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("target_id", "target_id was not specified but it is required when building PutFeedbackOutput")
                    )?
                ,
                target_type: self.target_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("target_type", "target_type was not specified but it is required when building PutFeedbackOutput")
                    )?
                ,
