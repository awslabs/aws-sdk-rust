...
/// Paginator for [`QueryAssistant`](crate::operation::query_assistant::QueryAssistant)
pub struct QueryAssistantPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::query_assistant::builders::QueryAssistantInputBuilder,
    stop_on_duplicate_token: bool,
}

impl QueryAssistantPaginator {
    ...
    pub fn items(self) -> crate::operation::query_assistant::paginator::QueryAssistantPaginatorItems {
        crate::operation::query_assistant::paginator::QueryAssistantPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::query_assistant::QueryAssistant::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_query_assistant_output_output_next_token(resp);
...
pub struct QueryAssistantPaginatorItems(QueryAssistantPaginator);

impl QueryAssistantPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_query_assistant_output_output_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
