...
impl DeleteImportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_import_job::DeleteImportJobInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_import_job::DeleteImportJobInput {
