...
impl  SearchSessionsOutput  {
    ...
    pub fn session_summaries(&self) -> & [crate::types::SessionSummary] {
        use std::ops::Deref; self.session_summaries.deref()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
...
impl SearchSessionsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_sessions::SearchSessionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::search_sessions::SearchSessionsOutput {
                session_summaries: self.session_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("session_summaries", "session_summaries was not specified but it is required when building SearchSessionsOutput")
                    )?
                ,
