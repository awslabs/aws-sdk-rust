...
pub fn ser_vector_ingestion_configuration(
    ...
    if let Some(var_3) = &input.parsing_configuration {
        #[allow(unused_mut)]
        let mut object_4 = object.key("parsingConfiguration").start_object();
        crate::protocol_serde::shape_parsing_configuration::ser_parsing_configuration(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}
