                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "defaultAttributes" => {
                            builder = builder.set_default_attributes(
                                crate::protocol_serde::shape_message_template_attributes::de_message_template_attributes(tokens, _value, depth + 1)?,
                            );
                        }
                        "attributeTypes" => {
                            builder = builder.set_attribute_types(
                                crate::protocol_serde::shape_message_template_attribute_type_list::de_message_template_attribute_type_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
