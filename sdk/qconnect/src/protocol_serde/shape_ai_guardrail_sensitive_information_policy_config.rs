                        ...
                        match key.to_unescaped()?.as_ref() {
                            "piiEntitiesConfig" => {
                                builder = builder.set_pii_entities_config(
                                    crate::protocol_serde::shape_guardrail_pii_entities_config::de_guardrail_pii_entities_config(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "regexesConfig" => {
                                builder = builder.set_regexes_config(
                                    crate::protocol_serde::shape_guardrail_regexes_config::de_guardrail_regexes_config(tokens, _value, depth + 1)?,
                                );
                            }
