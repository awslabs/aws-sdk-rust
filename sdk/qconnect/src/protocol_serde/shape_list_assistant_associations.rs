...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_assistant_associations::ListAssistantAssociationsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_assistant_associations::ListAssistantAssociationsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_assistant_associations::de_list_assistant_associations(_response_body, output)
            .map_err(crate::operation::list_assistant_associations::ListAssistantAssociationsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_assistant_associations_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_assistant_associations::ListAssistantAssociationsError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "assistantAssociationSummaries" => {
                    builder = builder.set_assistant_association_summaries(
                        crate::protocol_serde::shape_assistant_association_summary_list::de_assistant_association_summary_list(tokens, _value)?,
                    );
                }
                "nextToken" => {
