                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "text" => Some(crate::types::SpanMessageValue::Text(
                            crate::protocol_serde::shape_span_text_value::de_span_text_value(tokens)?
                        ...
                        "toolUse" => Some(crate::types::SpanMessageValue::ToolUse(
                            crate::protocol_serde::shape_span_tool_use_value::de_span_tool_use_value(tokens)?.ok_or_else(|| {
                        ...
                        "toolResult" => Some(crate::types::SpanMessageValue::ToolResult(
                            crate::protocol_serde::shape_span_tool_result_value::de_span_tool_result_value(tokens)?.ok_or_else(|| {
