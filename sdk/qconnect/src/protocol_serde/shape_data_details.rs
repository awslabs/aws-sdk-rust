...
pub(crate) fn de_data_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
