                        ...
                        variant = match key.as_ref() {
                            "contentData" => {
                                Some(crate::types::DataDetails::ContentData(
                                    crate::protocol_serde::shape_content_data_details::de_content_data_details(tokens, _value, depth + 1)?
                            ...
                            "generativeData" => {
                                Some(crate::types::DataDetails::GenerativeData(
                                    crate::protocol_serde::shape_generative_data_details::de_generative_data_details(tokens, _value, depth + 1)?
                            ...
                            "intentDetectedData" => {
                                Some(crate::types::DataDetails::IntentDetectedData(
                                    crate::protocol_serde::shape_intent_detected_data_details::de_intent_detected_data_details(tokens, _value, depth + 1)?
                            ...
                            "sourceContentData" => {
                                Some(crate::types::DataDetails::SourceContentData(
                                    crate::protocol_serde::shape_source_content_data_details::de_source_content_data_details(tokens, _value, depth + 1)?
                            ...
                            "generativeChunkData" => {
                                Some(crate::types::DataDetails::GenerativeChunkData(
                                    crate::protocol_serde::shape_generative_chunk_data_details::de_generative_chunk_data_details(tokens, _value, depth + 1)?
                            ...
                            "emailResponseChunkData" => {
                                Some(crate::types::DataDetails::EmailResponseChunkData(
                                    crate::protocol_serde::shape_email_response_chunk_data_details::de_email_response_chunk_data_details(tokens, _value, depth + 1)?
                            ...
                            "emailOverviewChunkData" => {
                                Some(crate::types::DataDetails::EmailOverviewChunkData(
                                    crate::protocol_serde::shape_email_overview_chunk_data_details::de_email_overview_chunk_data_details(tokens, _value, depth + 1)?
                            ...
                            "emailGenerativeAnswerChunkData" => {
                                Some(crate::types::DataDetails::EmailGenerativeAnswerChunkData(
                                    crate::protocol_serde::shape_email_generative_answer_chunk_data_details::de_email_generative_answer_chunk_data_details(tokens, _value, depth + 1)?
                            ...
                            "caseSummarizationChunkData" => {
                                Some(crate::types::DataDetails::CaseSummarizationChunkData(
                                    crate::protocol_serde::shape_case_summarization_chunk_data_details::de_case_summarization_chunk_data_details(tokens, _value, depth + 1)?
                            ...
                            "suggestedMessageData" => {
                                Some(crate::types::DataDetails::SuggestedMessageData(
                                    crate::protocol_serde::shape_suggested_message_data_details::de_suggested_message_data_details(tokens, _value, depth + 1)?
                            ...
                            "notesData" => {
                                Some(crate::types::DataDetails::NotesData(
                                    crate::protocol_serde::shape_notes_data_details::de_notes_data_details(tokens, _value, depth + 1)?
                            ...
                            "notesChunkData" => {
                                Some(crate::types::DataDetails::NotesChunkData(
                                    crate::protocol_serde::shape_notes_chunk_data_details::de_notes_chunk_data_details(tokens, _value, depth + 1)?
                            ...
                            "proactiveRecommendationData" => {
                                Some(crate::types::DataDetails::ProactiveRecommendationData(
                                    crate::protocol_serde::shape_proactive_recommendation_data_details::de_proactive_recommendation_data_details(tokens, _value, depth + 1)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'proactiveRecommendationData' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
