...
pub fn ser_tool_override_input_value(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::ToolOverrideInputValue,
    ...
    if let Some(var_1) = &input.value {
        ...
        crate::protocol_serde::shape_tool_override_input_value_configuration::ser_tool_override_input_value_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::ToolOverrideInputValueBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::tool_override_input_value_correct_errors(builder)
                    .build()
