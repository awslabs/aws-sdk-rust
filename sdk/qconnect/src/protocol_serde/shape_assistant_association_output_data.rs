                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "knowledgeBaseAssociation" => Some(crate::types::AssistantAssociationOutputData::KnowledgeBaseAssociation(
                            crate::protocol_serde::shape_knowledge_base_association_data::de_knowledge_base_association_data(tokens)?.ok_or_else(
                                || {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom(
                                        "value for 'knowledgeBaseAssociation' cannot be null",
                                    )
                                },
                            )?,
                        )),
