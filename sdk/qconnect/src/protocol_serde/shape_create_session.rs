...
pub fn de_create_session_http_error(
    ...
    Err(match error_code {
        ...
        "DependencyFailedException" => crate::operation::create_session::CreateSessionError::DependencyFailedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnauthorizedException" => crate::operation::create_session::CreateSessionError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
