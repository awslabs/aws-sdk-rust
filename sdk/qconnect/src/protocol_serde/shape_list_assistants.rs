...
pub fn de_list_assistants_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_assistants::ListAssistantsOutput, crate::operation::list_assistants::ListAssistantsError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_assistants::ListAssistantsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_assistants::ListAssistantsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnauthorizedException" => crate::operation::list_assistants::ListAssistantsError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::list_assistants::ListAssistantsError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_assistants_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_assistants::builders::ListAssistantsOutputBuilder::default();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "assistantSummaries" => {
                    builder = builder.set_assistant_summaries(crate::protocol_serde::shape_assistant_list::de_assistant_list(tokens, _value)?);
                }
                "nextToken" => {
