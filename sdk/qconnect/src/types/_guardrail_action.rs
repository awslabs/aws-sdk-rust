...
///
/// <p>The outcome of a guardrail assessment.</p>
#[non_exhaustive]
#[derive(
...
impl ::std::convert::From<&str> for GuardrailAction {
    fn from(s: &str) -> Self {
        match s {
            "BLOCKED" => GuardrailAction::Blocked,
            "MASKED" => GuardrailAction::Masked,
...
impl GuardrailAction {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            GuardrailAction::Blocked => "BLOCKED",
            GuardrailAction::Masked => "MASKED",
...
impl ::std::fmt::Display for GuardrailAction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            GuardrailAction::Blocked => write!(f, "BLOCKED"),
            GuardrailAction::Masked => write!(f, "MASKED"),
