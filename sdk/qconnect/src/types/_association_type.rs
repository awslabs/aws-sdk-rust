...
///     AssociationType::ExternalBedrockKnowledgeBase => { /* ... */ },
...
impl ::std::convert::From<&str> for AssociationType {
    fn from(s: &str) -> Self {
        match s {
            "EXTERNAL_BEDROCK_KNOWLEDGE_BASE" => AssociationType::ExternalBedrockKnowledgeBase,
...
impl AssociationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AssociationType::ExternalBedrockKnowledgeBase => "EXTERNAL_BEDROCK_KNOWLEDGE_BASE",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["EXTERNAL_BEDROCK_KNOWLEDGE_BASE", "KNOWLEDGE_BASE"]
    }
}
...
impl ::std::fmt::Display for AssociationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AssociationType::ExternalBedrockKnowledgeBase => write!(f, "EXTERNAL_BEDROCK_KNOWLEDGE_BASE"),
