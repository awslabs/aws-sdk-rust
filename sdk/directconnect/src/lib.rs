...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("directconnect", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Direct Connect.
pub mod client;
