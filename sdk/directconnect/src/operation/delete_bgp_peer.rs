...
impl DeleteBgpPeerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_bgp_peer::DeleteBGPPeer,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_bgp_peer::DeleteBGPPeer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBGPPeer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_bgp_peer::de_delete_bgp_peer_http_error(
                status, headers, body,
            )
        } else {
