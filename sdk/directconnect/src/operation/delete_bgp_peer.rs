...
impl DeleteBgpPeerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBGPPeer`](crate::operation::delete_bgp_peer::DeleteBGPPeer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_bgp_peer::DeleteBGPPeer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_bgp_peer::DeleteBgpPeerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_bgp_peer::ser_delete_bgp_peer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bgp_peer::DeleteBGPPeer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBGPPeer", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBGPPeer {
                type Output = std::result::Result<crate::operation::delete_bgp_peer::DeleteBgpPeerOutput, crate::operation::delete_bgp_peer::DeleteBGPPeerError>;
