...
impl DeleteBgpPeerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_bgp_peer::DeleteBGPPeer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_bgp_peer::ser_delete_bgp_peer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBGPPeer {
    type Output =
        ::std::result::Result<crate::operation::delete_bgp_peer::DeleteBgpPeerOutput, crate::operation::delete_bgp_peer::DeleteBGPPeerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_bgp_peer::de_delete_bgp_peer_http_response_with_props(status, headers, body)
        }
    }
}
