...
/// Orchestration and serialization glue logic for `UpdateDirectConnectGateway`.
...
impl UpdateDirectConnectGateway {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayInput,
                    ) -> ::std::result::Result<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDirectConnectGateway {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDirectConnectGateway");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateDirectConnectGatewayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateDirectConnectGatewayResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDirectConnectGateway")
...
.with_interceptor(UpdateDirectConnectGatewayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError>::new());
...
#[derive(Debug)]
            struct UpdateDirectConnectGatewayResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDirectConnectGatewayResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_direct_connect_gateway::de_update_direct_connect_gateway_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_direct_connect_gateway::de_update_direct_connect_gateway_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateDirectConnectGatewayRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDirectConnectGatewayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_direct_connect_gateway::ser_update_direct_connect_gateway_input(&input)?);
...
#[derive(Debug)]
            struct UpdateDirectConnectGatewayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDirectConnectGatewayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateDirectConnectGatewayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateDirectConnectGatewayInput>()
                        .ok_or("failed to downcast to UpdateDirectConnectGatewayInput")?;
...
pub enum UpdateDirectConnectGatewayError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDirectConnectGatewayError) for what information is available for the error.")]
...
impl UpdateDirectConnectGatewayError {
    /// Creates the `UpdateDirectConnectGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDirectConnectGatewayError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDirectConnectGatewayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_direct_connect_gateway::_update_direct_connect_gateway_output::UpdateDirectConnectGatewayOutput;

pub use crate::operation::update_direct_connect_gateway::_update_direct_connect_gateway_input::UpdateDirectConnectGatewayInput;

mod _update_direct_connect_gateway_input;

mod _update_direct_connect_gateway_output;
