...
impl UpdateDirectConnectGatewayInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDirectConnectGateway`](crate::operation::update_direct_connect_gateway::UpdateDirectConnectGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGateway, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_direct_connect_gateway::ser_update_direct_connect_gateway_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_direct_connect_gateway::UpdateDirectConnectGateway::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateDirectConnectGateway", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDirectConnectGateway {
                type Output = std::result::Result<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayOutput, crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError>;
