...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDirectConnectGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_direct_connect_gateway::de_update_direct_connect_gateway_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayError
{
