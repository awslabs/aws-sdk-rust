...
impl UpdateDirectConnectGatewayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_direct_connect_gateway::UpdateDirectConnectGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDirectConnectGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_direct_connect_gateway::de_update_direct_connect_gateway_http_response_with_props(
                status, headers, body,
            )
        }
    }
