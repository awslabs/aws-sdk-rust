...
/// Orchestration and serialization glue logic for `DeleteDirectConnectGatewayAssociationProposal`.
...
impl DeleteDirectConnectGatewayAssociationProposal {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDirectConnectGatewayAssociationProposal {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDirectConnectGatewayAssociationProposal");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDirectConnectGatewayAssociationProposalRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDirectConnectGatewayAssociationProposalResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDirectConnectGatewayAssociationProposal")
...
.with_interceptor(DeleteDirectConnectGatewayAssociationProposalEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalError>::new());
...
#[derive(Debug)]
            struct DeleteDirectConnectGatewayAssociationProposalResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDirectConnectGatewayAssociationProposalResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteDirectConnectGatewayAssociationProposalRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDirectConnectGatewayAssociationProposalRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_direct_connect_gateway_association_proposal::ser_delete_direct_connect_gateway_association_proposal_input(&input)?);
...
#[derive(Debug)]
            struct DeleteDirectConnectGatewayAssociationProposalEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDirectConnectGatewayAssociationProposalEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteDirectConnectGatewayAssociationProposalEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteDirectConnectGatewayAssociationProposalInput>()
                        .ok_or("failed to downcast to DeleteDirectConnectGatewayAssociationProposalInput")?;
...
pub enum DeleteDirectConnectGatewayAssociationProposalError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDirectConnectGatewayAssociationProposalError) for what information is available for the error.")]
...
impl DeleteDirectConnectGatewayAssociationProposalError {
    /// Creates the `DeleteDirectConnectGatewayAssociationProposalError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDirectConnectGatewayAssociationProposalError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDirectConnectGatewayAssociationProposalError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_direct_connect_gateway_association_proposal::DeleteDirectConnectGatewayAssociationProposalError {
...
mod _delete_direct_connect_gateway_association_proposal_output;
