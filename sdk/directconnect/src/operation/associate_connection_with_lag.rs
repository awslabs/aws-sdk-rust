...
impl AssociateConnectionWithLagInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_connection_with_lag::AssociateConnectionWithLag::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateConnectionWithLag {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_connection_with_lag::de_associate_connection_with_lag_http_response_with_props(
                status, headers, body,
            )
        }
    }
