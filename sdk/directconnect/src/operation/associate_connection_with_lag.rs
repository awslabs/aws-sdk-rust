...
/// Orchestration and serialization glue logic for `AssociateConnectionWithLag`.
...
impl AssociateConnectionWithLag {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateConnectionWithLag {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateConnectionWithLag");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateConnectionWithLagRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateConnectionWithLagResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateConnectionWithLag")
...
.with_interceptor(AssociateConnectionWithLagEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_connection_with_lag::de_associate_connection_with_lag_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AssociateConnectionWithLagRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateConnectionWithLagRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_connection_with_lag::AssociateConnectionWithLagInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_connection_with_lag::ser_associate_connection_with_lag_input(&input)?);
...
#[derive(Debug)]
            struct AssociateConnectionWithLagEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateConnectionWithLagEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateConnectionWithLagEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateConnectionWithLagInput>()
                        .ok_or("failed to downcast to AssociateConnectionWithLagInput")?;
...
pub enum AssociateConnectionWithLagError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateConnectionWithLagError) for what information is available for the error.")]
...
impl AssociateConnectionWithLagError {
    /// Creates the `AssociateConnectionWithLagError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateConnectionWithLagError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateConnectionWithLagError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError {
...
mod _associate_connection_with_lag_output;
