...
impl AssociateConnectionWithLag {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.AssociateConnectionWithLag",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "AssociateConnectionWithLag",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateConnectionWithLag {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateConnectionWithLagRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateConnectionWithLagResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AssociateConnectionWithLag")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateConnectionWithLag")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AssociateConnectionWithLagTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AssociateConnectionWithLagTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateConnectionWithLagTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AssociateConnectionWithLagInput>() else {
        ...
        if requested.should_capture("lagId") {
            if let ::std::option::Option::Some(value) = input.lag_id.as_deref() {
                captured.insert("lagId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateConnectionWithLagResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_connection_with_lag::de_associate_connection_with_lag_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_associate_connection_with_lag::de_associate_connection_with_lag_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateConnectionWithLagRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::associate_connection_with_lag::AssociateConnectionWithLagInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_connection_with_lag::ser_associate_connection_with_lag_input(&input)?,
        );
