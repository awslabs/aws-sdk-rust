...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateConnectionWithLag {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_connection_with_lag::de_associate_connection_with_lag_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError
{
