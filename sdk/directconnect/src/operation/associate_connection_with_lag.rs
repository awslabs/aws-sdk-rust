...
impl AssociateConnectionWithLagInput {
    /// Consumes the builder and constructs an Operation<[`AssociateConnectionWithLag`](crate::operation::associate_connection_with_lag::AssociateConnectionWithLag)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_connection_with_lag::AssociateConnectionWithLag, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_connection_with_lag::AssociateConnectionWithLagInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_connection_with_lag::ser_associate_connection_with_lag_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_connection_with_lag::AssociateConnectionWithLag::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateConnectionWithLag", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateConnectionWithLag {
                type Output = std::result::Result<crate::operation::associate_connection_with_lag::AssociateConnectionWithLagOutput, crate::operation::associate_connection_with_lag::AssociateConnectionWithLagError>;
