...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmPrivateVirtualInterface {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_confirm_private_virtual_interface::de_confirm_private_virtual_interface_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError
{
