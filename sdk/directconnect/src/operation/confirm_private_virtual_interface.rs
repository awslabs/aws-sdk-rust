...
impl ConfirmPrivateVirtualInterface {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ConfirmPrivateVirtualInterface {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ConfirmPrivateVirtualInterface");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ConfirmPrivateVirtualInterfaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ConfirmPrivateVirtualInterfaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ConfirmPrivateVirtualInterface")
...
.with_interceptor(ConfirmPrivateVirtualInterfaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError>::new());
...
#[derive(Debug)]
            struct ConfirmPrivateVirtualInterfaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmPrivateVirtualInterfaceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_confirm_private_virtual_interface::de_confirm_private_virtual_interface_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ConfirmPrivateVirtualInterfaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmPrivateVirtualInterfaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_confirm_private_virtual_interface::ser_confirm_private_virtual_interface_input(&input)?);
...
#[derive(Debug)]
            struct ConfirmPrivateVirtualInterfaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ConfirmPrivateVirtualInterfaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ConfirmPrivateVirtualInterfaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ConfirmPrivateVirtualInterfaceInput>()
                        .ok_or("failed to downcast to ConfirmPrivateVirtualInterfaceInput")?;
...
pub enum ConfirmPrivateVirtualInterfaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ConfirmPrivateVirtualInterfaceError) for what information is available for the error.")]
...
impl ConfirmPrivateVirtualInterfaceError {
    /// Creates the `ConfirmPrivateVirtualInterfaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ConfirmPrivateVirtualInterfaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ConfirmPrivateVirtualInterfaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::confirm_private_virtual_interface::ConfirmPrivateVirtualInterfaceError {
...
mod _confirm_private_virtual_interface_output;
