...
impl DescribeDirectConnectGatewayAttachments {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDirectConnectGatewayAttachments {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDirectConnectGatewayAttachments");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDirectConnectGatewayAttachmentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDirectConnectGatewayAttachmentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDirectConnectGatewayAttachments")
...
.with_interceptor(DescribeDirectConnectGatewayAttachmentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError>::new());
...
#[derive(Debug)]
            struct DescribeDirectConnectGatewayAttachmentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDirectConnectGatewayAttachmentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_direct_connect_gateway_attachments::de_describe_direct_connect_gateway_attachments_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDirectConnectGatewayAttachmentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDirectConnectGatewayAttachmentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_direct_connect_gateway_attachments::ser_describe_direct_connect_gateway_attachments_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDirectConnectGatewayAttachmentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDirectConnectGatewayAttachmentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDirectConnectGatewayAttachmentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDirectConnectGatewayAttachmentsInput>()
                        .ok_or("failed to downcast to DescribeDirectConnectGatewayAttachmentsInput")?;
...
pub enum DescribeDirectConnectGatewayAttachmentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDirectConnectGatewayAttachmentsError) for what information is available for the error.")]
...
impl DescribeDirectConnectGatewayAttachmentsError {
    /// Creates the `DescribeDirectConnectGatewayAttachmentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDirectConnectGatewayAttachmentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDirectConnectGatewayAttachmentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError {
