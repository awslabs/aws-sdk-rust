...
impl StartBgpFailoverTestInput {
    /// Consumes the builder and constructs an Operation<[`StartBgpFailoverTest`](crate::operation::start_bgp_failover_test::StartBgpFailoverTest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_bgp_failover_test::StartBgpFailoverTest, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_bgp_failover_test::StartBgpFailoverTestInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_bgp_failover_test::ser_start_bgp_failover_test_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_bgp_failover_test::StartBgpFailoverTest::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartBgpFailoverTest", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartBgpFailoverTest {
                type Output = std::result::Result<crate::operation::start_bgp_failover_test::StartBgpFailoverTestOutput, crate::operation::start_bgp_failover_test::StartBgpFailoverTestError>;
