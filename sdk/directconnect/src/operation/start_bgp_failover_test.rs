...
impl StartBgpFailoverTest {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_bgp_failover_test::StartBgpFailoverTestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_bgp_failover_test::StartBgpFailoverTestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_bgp_failover_test::StartBgpFailoverTestError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_bgp_failover_test::StartBgpFailoverTestOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartBgpFailoverTest {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartBgpFailoverTest");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartBgpFailoverTestRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartBgpFailoverTestResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartBgpFailoverTest")
...
.with_interceptor(StartBgpFailoverTestEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_bgp_failover_test::StartBgpFailoverTestError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_bgp_failover_test::StartBgpFailoverTestError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_bgp_failover_test::StartBgpFailoverTestError>::new());
...
#[derive(Debug)]
            struct StartBgpFailoverTestResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartBgpFailoverTestResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_bgp_failover_test::de_start_bgp_failover_test_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_bgp_failover_test::de_start_bgp_failover_test_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartBgpFailoverTestRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartBgpFailoverTestRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_bgp_failover_test::StartBgpFailoverTestInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_bgp_failover_test::StartBgpFailoverTestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_bgp_failover_test::ser_start_bgp_failover_test_input(&input)?);
...
#[derive(Debug)]
            struct StartBgpFailoverTestEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartBgpFailoverTestEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartBgpFailoverTestEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartBgpFailoverTestInput>()
                        .ok_or("failed to downcast to StartBgpFailoverTestInput")?;
...
pub enum StartBgpFailoverTestError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartBgpFailoverTestError) for what information is available for the error.")]
...
impl StartBgpFailoverTestError {
    /// Creates the `StartBgpFailoverTestError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartBgpFailoverTestError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartBgpFailoverTestError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_bgp_failover_test::StartBgpFailoverTestError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::start_bgp_failover_test::_start_bgp_failover_test_output::StartBgpFailoverTestOutput;

pub use crate::operation::start_bgp_failover_test::_start_bgp_failover_test_input::StartBgpFailoverTestInput;

mod _start_bgp_failover_test_input;

mod _start_bgp_failover_test_output;
