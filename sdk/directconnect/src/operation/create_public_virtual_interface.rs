...
impl CreatePublicVirtualInterface {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.CreatePublicVirtualInterface",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "CreatePublicVirtualInterface",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePublicVirtualInterface {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreatePublicVirtualInterfaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreatePublicVirtualInterfaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreatePublicVirtualInterface")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePublicVirtualInterface")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreatePublicVirtualInterfaceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreatePublicVirtualInterfaceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePublicVirtualInterfaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreatePublicVirtualInterfaceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePublicVirtualInterfaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_public_virtual_interface::de_create_public_virtual_interface_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_public_virtual_interface::de_create_public_virtual_interface_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePublicVirtualInterfaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_public_virtual_interface::ser_create_public_virtual_interface_input(&input)?,
        );
...
impl CreatePublicVirtualInterfaceError {
    ...
    /// Returns `true` if the error kind is `CreatePublicVirtualInterfaceError::LimitExceededException`.
