...
impl DescribeVirtualGateways {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.DescribeVirtualGateways",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "DescribeVirtualGateways",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVirtualGateways {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeVirtualGatewaysRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeVirtualGatewaysResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeVirtualGateways")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeVirtualGatewaysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_virtual_gateways::de_describe_virtual_gateways_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_virtual_gateways::de_describe_virtual_gateways_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeVirtualGatewaysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_describe_virtual_gateways::ser_describe_virtual_gateways_input(&input)?,
        );
