    ...
    for AcceptDirectConnectGatewayAssociationProposal
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_direct_connect_gateway_association_proposal::de_accept_direct_connect_gateway_association_proposal_http_response_with_props(status, headers, body)
        }
    }
}
