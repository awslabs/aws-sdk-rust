...
impl AcceptDirectConnectGatewayAssociationProposal {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptDirectConnectGatewayAssociationProposal {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptDirectConnectGatewayAssociationProposal");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptDirectConnectGatewayAssociationProposalRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptDirectConnectGatewayAssociationProposalResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptDirectConnectGatewayAssociationProposal")
...
.with_interceptor(AcceptDirectConnectGatewayAssociationProposalEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalError>::new());
...
#[derive(Debug)]
            struct AcceptDirectConnectGatewayAssociationProposalResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptDirectConnectGatewayAssociationProposalResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_direct_connect_gateway_association_proposal::de_accept_direct_connect_gateway_association_proposal_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_accept_direct_connect_gateway_association_proposal::de_accept_direct_connect_gateway_association_proposal_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AcceptDirectConnectGatewayAssociationProposalRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptDirectConnectGatewayAssociationProposalRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_accept_direct_connect_gateway_association_proposal::ser_accept_direct_connect_gateway_association_proposal_input(&input)?);
...
#[derive(Debug)]
            struct AcceptDirectConnectGatewayAssociationProposalEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptDirectConnectGatewayAssociationProposalEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AcceptDirectConnectGatewayAssociationProposalEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptDirectConnectGatewayAssociationProposalInput>()
                        .ok_or("failed to downcast to AcceptDirectConnectGatewayAssociationProposalInput")?;
...
pub enum AcceptDirectConnectGatewayAssociationProposalError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptDirectConnectGatewayAssociationProposalError) for what information is available for the error.")]
...
impl AcceptDirectConnectGatewayAssociationProposalError {
    /// Creates the `AcceptDirectConnectGatewayAssociationProposalError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptDirectConnectGatewayAssociationProposalError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptDirectConnectGatewayAssociationProposalError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_direct_connect_gateway_association_proposal::AcceptDirectConnectGatewayAssociationProposalError {
...
mod _accept_direct_connect_gateway_association_proposal_output;
