...
/// Orchestration and serialization glue logic for `DisassociateMacSecKey`.
...
impl DisassociateMacSecKey {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateMacSecKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateMacSecKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateMacSecKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateMacSecKeyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateMacSecKey")
...
.with_interceptor(DisassociateMacSecKeyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError>::new());
...
#[derive(Debug)]
            struct DisassociateMacSecKeyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateMacSecKeyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_mac_sec_key::de_disassociate_mac_sec_key_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_mac_sec_key::de_disassociate_mac_sec_key_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateMacSecKeyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateMacSecKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_mac_sec_key::ser_disassociate_mac_sec_key_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateMacSecKeyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateMacSecKeyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateMacSecKeyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateMacSecKeyInput>()
                        .ok_or("failed to downcast to DisassociateMacSecKeyInput")?;
...
pub enum DisassociateMacSecKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateMacSecKeyError) for what information is available for the error.")]
...
impl DisassociateMacSecKeyError {
    /// Creates the `DisassociateMacSecKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateMacSecKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateMacSecKeyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError {
...
mod _disassociate_mac_sec_key_output;
