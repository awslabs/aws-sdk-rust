...
impl DisassociateMacSecKeyInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateMacSecKey`](crate::operation::disassociate_mac_sec_key::DisassociateMacSecKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_mac_sec_key::ser_disassociate_mac_sec_key_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_mac_sec_key::DisassociateMacSecKey::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisassociateMacSecKey", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateMacSecKey {
                type Output = std::result::Result<crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyOutput, crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyError>;
