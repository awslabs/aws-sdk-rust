...
impl DescribeInterconnectLoaInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInterconnectLoa`](crate::operation::describe_interconnect_loa::DescribeInterconnectLoa)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_interconnect_loa::DescribeInterconnectLoa, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_interconnect_loa::DescribeInterconnectLoaInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_interconnect_loa::ser_describe_interconnect_loa_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_interconnect_loa::DescribeInterconnectLoa::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeInterconnectLoa", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInterconnectLoa {
                type Output = std::result::Result<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaOutput, crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError>;
