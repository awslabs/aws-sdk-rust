...
/// Orchestration and serialization glue logic for `DescribeInterconnectLoa`.
...
impl DescribeInterconnectLoa {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_interconnect_loa::DescribeInterconnectLoaInput,
                    ) -> ::std::result::Result<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInterconnectLoa {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeInterconnectLoa");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeInterconnectLoaRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeInterconnectLoaResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInterconnectLoa")
...
.with_interceptor(DescribeInterconnectLoaEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError>::new());
...
#[derive(Debug)]
            struct DescribeInterconnectLoaResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeInterconnectLoaResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_interconnect_loa::de_describe_interconnect_loa_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_interconnect_loa::de_describe_interconnect_loa_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeInterconnectLoaRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeInterconnectLoaRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_interconnect_loa::DescribeInterconnectLoaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_interconnect_loa::DescribeInterconnectLoaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_interconnect_loa::ser_describe_interconnect_loa_input(&input)?);
...
#[derive(Debug)]
            struct DescribeInterconnectLoaEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeInterconnectLoaEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeInterconnectLoaEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeInterconnectLoaInput>()
                        .ok_or("failed to downcast to DescribeInterconnectLoaInput")?;
...
pub enum DescribeInterconnectLoaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeInterconnectLoaError) for what information is available for the error.")]
...
impl DescribeInterconnectLoaError {
    /// Creates the `DescribeInterconnectLoaError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeInterconnectLoaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeInterconnectLoaError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_interconnect_loa::DescribeInterconnectLoaError {
...
mod _describe_interconnect_loa_output;
