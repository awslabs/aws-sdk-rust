...
/// Orchestration and serialization glue logic for `DescribeDirectConnectGateways`.
...
impl DescribeDirectConnectGateways {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDirectConnectGateways {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDirectConnectGateways");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDirectConnectGatewaysRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDirectConnectGatewaysResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDirectConnectGateways")
...
.with_interceptor(DescribeDirectConnectGatewaysEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError>::new());
...
#[derive(Debug)]
            struct DescribeDirectConnectGatewaysResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDirectConnectGatewaysResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_direct_connect_gateways::de_describe_direct_connect_gateways_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_direct_connect_gateways::de_describe_direct_connect_gateways_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDirectConnectGatewaysRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDirectConnectGatewaysRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_direct_connect_gateways::ser_describe_direct_connect_gateways_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDirectConnectGatewaysEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDirectConnectGatewaysEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDirectConnectGatewaysEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDirectConnectGatewaysInput>()
                        .ok_or("failed to downcast to DescribeDirectConnectGatewaysInput")?;
...
pub enum DescribeDirectConnectGatewaysError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDirectConnectGatewaysError) for what information is available for the error.")]
...
impl DescribeDirectConnectGatewaysError {
    /// Creates the `DescribeDirectConnectGatewaysError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDirectConnectGatewaysError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDirectConnectGatewaysError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError {
...
mod _describe_direct_connect_gateways_output;
