...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDirectConnectGateways {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_direct_connect_gateways::de_describe_direct_connect_gateways_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGatewaysError
{
