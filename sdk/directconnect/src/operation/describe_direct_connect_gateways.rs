...
impl DescribeDirectConnectGatewaysInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_direct_connect_gateways::DescribeDirectConnectGateways::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDirectConnectGateways {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_direct_connect_gateways::de_describe_direct_connect_gateways_http_response_with_props(
                status, headers, body,
            )
        }
    }
