...
impl AllocatePublicVirtualInterfaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceOutput, crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceError, Self> {
