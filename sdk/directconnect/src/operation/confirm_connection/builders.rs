...
impl ConfirmConnectionFluentBuilder  {
    /// Creates a new `ConfirmConnection`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::confirm_connection::ConfirmConnectionOutput, aws_smithy_http::result::SdkError<crate::operation::confirm_connection::ConfirmConnectionError>>
                     {
