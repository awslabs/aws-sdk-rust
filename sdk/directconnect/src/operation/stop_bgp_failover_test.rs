...
impl StopBgpFailoverTestInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_bgp_failover_test::ser_stop_bgp_failover_test_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_bgp_failover_test::StopBgpFailoverTest::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::stop_bgp_failover_test::StopBgpFailoverTestError
{
