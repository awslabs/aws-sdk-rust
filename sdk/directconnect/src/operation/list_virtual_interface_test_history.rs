...
impl ListVirtualInterfaceTestHistoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVirtualInterfaceTestHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_virtual_interface_test_history::de_list_virtual_interface_test_history_http_response_with_props(
                status, headers, body,
            )
        }
    }
