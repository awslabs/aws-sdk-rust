...
impl ListVirtualInterfaceTestHistoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistory,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVirtualInterfaceTestHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_virtual_interface_test_history::de_list_virtual_interface_test_history_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryError
{
