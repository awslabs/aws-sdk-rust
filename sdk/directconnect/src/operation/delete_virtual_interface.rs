...
impl DeleteVirtualInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVirtualInterface`](crate::operation::delete_virtual_interface::DeleteVirtualInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_virtual_interface::DeleteVirtualInterface, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_virtual_interface::DeleteVirtualInterfaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_virtual_interface::ser_delete_virtual_interface_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_virtual_interface::DeleteVirtualInterface::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteVirtualInterface", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVirtualInterface {
                type Output = std::result::Result<crate::operation::delete_virtual_interface::DeleteVirtualInterfaceOutput, crate::operation::delete_virtual_interface::DeleteVirtualInterfaceError>;
