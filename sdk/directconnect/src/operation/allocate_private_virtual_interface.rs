...
/// Orchestration and serialization glue logic for `AllocatePrivateVirtualInterface`.
...
impl AllocatePrivateVirtualInterface {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocatePrivateVirtualInterface {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AllocatePrivateVirtualInterface");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AllocatePrivateVirtualInterfaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AllocatePrivateVirtualInterfaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocatePrivateVirtualInterface")
...
.with_interceptor(AllocatePrivateVirtualInterfaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_allocate_private_virtual_interface::de_allocate_private_virtual_interface_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AllocatePrivateVirtualInterfaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocatePrivateVirtualInterfaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_allocate_private_virtual_interface::ser_allocate_private_virtual_interface_input(&input)?);
...
#[derive(Debug)]
            struct AllocatePrivateVirtualInterfaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocatePrivateVirtualInterfaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AllocatePrivateVirtualInterfaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AllocatePrivateVirtualInterfaceInput>()
                        .ok_or("failed to downcast to AllocatePrivateVirtualInterfaceInput")?;
...
pub enum AllocatePrivateVirtualInterfaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AllocatePrivateVirtualInterfaceError) for what information is available for the error.")]
...
impl AllocatePrivateVirtualInterfaceError {
    /// Creates the `AllocatePrivateVirtualInterfaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AllocatePrivateVirtualInterfaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AllocatePrivateVirtualInterfaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError {
...
mod _allocate_private_virtual_interface_output;
