...
impl AllocatePrivateVirtualInterface {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.AllocatePrivateVirtualInterface",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "AllocatePrivateVirtualInterface",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocatePrivateVirtualInterface {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AllocatePrivateVirtualInterfaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AllocatePrivateVirtualInterfaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllocatePrivateVirtualInterface")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocatePrivateVirtualInterface")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AllocatePrivateVirtualInterfaceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AllocatePrivateVirtualInterfaceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocatePrivateVirtualInterfaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AllocatePrivateVirtualInterfaceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllocatePrivateVirtualInterfaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_allocate_private_virtual_interface::de_allocate_private_virtual_interface_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocatePrivateVirtualInterfaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_private_virtual_interface::ser_allocate_private_virtual_interface_input(&input)?,
        );
