...
impl AllocatePrivateVirtualInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`AllocatePrivateVirtualInterface`](crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterface, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_private_virtual_interface::ser_allocate_private_virtual_interface_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterface::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AllocatePrivateVirtualInterface", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for AllocatePrivateVirtualInterface {
                type Output = std::result::Result<crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput, crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceError>;
