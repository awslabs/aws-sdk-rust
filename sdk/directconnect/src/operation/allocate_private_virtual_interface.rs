...
impl AllocatePrivateVirtualInterfaceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterface::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AllocatePrivateVirtualInterface {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_allocate_private_virtual_interface::de_allocate_private_virtual_interface_http_response_with_props(
                status, headers, body,
            )
        }
    }
