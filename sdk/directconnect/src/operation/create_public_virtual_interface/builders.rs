...
impl CreatePublicVirtualInterfaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::create_public_virtual_interface::CreatePublicVirtualInterface::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceOutput, crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceError, Self> {
