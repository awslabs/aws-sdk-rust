...
impl ConfirmCustomerAgreementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::confirm_customer_agreement::ConfirmCustomerAgreement,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmCustomerAgreement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_confirm_customer_agreement::de_confirm_customer_agreement_http_response_with_props(status, headers, body)
        }
    }
}
