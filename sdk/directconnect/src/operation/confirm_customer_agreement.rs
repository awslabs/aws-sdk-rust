...
/// Orchestration and serialization glue logic for `ConfirmCustomerAgreement`.
...
impl ConfirmCustomerAgreement {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ConfirmCustomerAgreement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ConfirmCustomerAgreement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ConfirmCustomerAgreementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ConfirmCustomerAgreementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ConfirmCustomerAgreement")
...
.with_interceptor(ConfirmCustomerAgreementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError>::new());
...
#[derive(Debug)]
            struct ConfirmCustomerAgreementResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmCustomerAgreementResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_confirm_customer_agreement::de_confirm_customer_agreement_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_confirm_customer_agreement::de_confirm_customer_agreement_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ConfirmCustomerAgreementRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmCustomerAgreementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_confirm_customer_agreement::ser_confirm_customer_agreement_input(&input)?);
...
#[derive(Debug)]
            struct ConfirmCustomerAgreementEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ConfirmCustomerAgreementEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ConfirmCustomerAgreementEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ConfirmCustomerAgreementInput>()
                        .ok_or("failed to downcast to ConfirmCustomerAgreementInput")?;
...
pub enum ConfirmCustomerAgreementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ConfirmCustomerAgreementError) for what information is available for the error.")]
...
impl ConfirmCustomerAgreementError {
    /// Creates the `ConfirmCustomerAgreementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ConfirmCustomerAgreementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ConfirmCustomerAgreementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError {
...
mod _confirm_customer_agreement_output;
