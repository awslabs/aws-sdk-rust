...
impl ConfirmCustomerAgreementInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmCustomerAgreement`](crate::operation::confirm_customer_agreement::ConfirmCustomerAgreement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_confirm_customer_agreement::ser_confirm_customer_agreement_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::confirm_customer_agreement::ConfirmCustomerAgreement::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ConfirmCustomerAgreement", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for ConfirmCustomerAgreement {
                type Output = std::result::Result<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementOutput, crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementError>;
