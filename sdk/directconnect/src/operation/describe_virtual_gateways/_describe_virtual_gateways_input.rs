...
impl DescribeVirtualGatewaysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysInput, ::aws_smithy_types::error::operation::BuildError> {
