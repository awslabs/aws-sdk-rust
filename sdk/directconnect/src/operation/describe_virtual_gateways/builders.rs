...
impl DescribeVirtualGatewaysFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysOutput, crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysError, Self> {
