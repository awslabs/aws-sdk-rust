...
impl AssociateVirtualInterface {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateVirtualInterface {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateVirtualInterface");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateVirtualInterfaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateVirtualInterfaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateVirtualInterface")
...
.with_interceptor(AssociateVirtualInterfaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError>::new());
...
#[derive(Debug)]
            struct AssociateVirtualInterfaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateVirtualInterfaceResponseDeserializer {
...
#[derive(Debug)]
            struct AssociateVirtualInterfaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateVirtualInterfaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_virtual_interface::AssociateVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_virtual_interface::ser_associate_virtual_interface_input(&input)?);
...
#[derive(Debug)]
            struct AssociateVirtualInterfaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateVirtualInterfaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateVirtualInterfaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateVirtualInterfaceInput>()
                        .ok_or("failed to downcast to AssociateVirtualInterfaceInput")?;
...
pub enum AssociateVirtualInterfaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateVirtualInterfaceError) for what information is available for the error.")]
...
impl AssociateVirtualInterfaceError {
    /// Creates the `AssociateVirtualInterfaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateVirtualInterfaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateVirtualInterfaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError {
