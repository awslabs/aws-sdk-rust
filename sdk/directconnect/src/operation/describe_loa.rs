...
impl DescribeLoaInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_loa::DescribeLoa::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoa {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_loa::de_describe_loa_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_loa::de_describe_loa_http_response_with_props(
                status, headers, body,
            )
        }
    }
