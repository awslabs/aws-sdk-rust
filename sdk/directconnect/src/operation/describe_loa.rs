...
impl DescribeLoaInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_loa::DescribeLoa, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_loa::ser_describe_loa_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoa {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_loa::de_describe_loa_http_response_with_props(status, headers, body)
        }
    }
}
