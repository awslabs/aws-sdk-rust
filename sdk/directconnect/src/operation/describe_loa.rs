...
impl DescribeLoaInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLoa`](crate::operation::describe_loa::DescribeLoa)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_loa::DescribeLoa, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_loa::DescribeLoaInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_loa::ser_describe_loa_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_loa::DescribeLoa::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeLoa", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLoa {
                type Output = std::result::Result<crate::operation::describe_loa::DescribeLoaOutput, crate::operation::describe_loa::DescribeLoaError>;
