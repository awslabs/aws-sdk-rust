...
impl crate::operation::update_direct_connect_gateway::builders::UpdateDirectConnectGatewayInputBuilder {
...
impl UpdateDirectConnectGatewayFluentBuilder {
    /// Creates a new `UpdateDirectConnectGatewayFluentBuilder`.
