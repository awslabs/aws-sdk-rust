...
impl DescribeCustomerMetadataInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCustomerMetadata`](crate::operation::describe_customer_metadata::DescribeCustomerMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_customer_metadata::DescribeCustomerMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_customer_metadata::ser_describe_customer_metadata_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_customer_metadata::DescribeCustomerMetadata::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeCustomerMetadata", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCustomerMetadata {
                type Output = std::result::Result<crate::operation::describe_customer_metadata::DescribeCustomerMetadataOutput, crate::operation::describe_customer_metadata::DescribeCustomerMetadataError>;
