...
impl DescribeCustomerMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_customer_metadata::DescribeCustomerMetadata,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCustomerMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_customer_metadata::de_describe_customer_metadata_http_response_with_props(status, headers, body)
        }
    }
}
