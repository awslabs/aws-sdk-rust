...
impl DeleteLagInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLag`](crate::operation::delete_lag::DeleteLag)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_lag::DeleteLag, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_lag::DeleteLagInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_lag::ser_delete_lag_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_lag::DeleteLag::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteLag", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLag {
                type Output = std::result::Result<crate::operation::delete_lag::DeleteLagOutput, crate::operation::delete_lag::DeleteLagError>;
