...
impl DeleteLagInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_lag::DeleteLag,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_lag::DeleteLag::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLag {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_lag::de_delete_lag_http_response_with_props(
                status, headers, body,
            )
        }
    }
