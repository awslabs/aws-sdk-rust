...
impl DescribeLoaFluentBuilder  {
    /// Creates a new `DescribeLoa`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_loa::DescribeLoaOutput, aws_smithy_http::result::SdkError<crate::operation::describe_loa::DescribeLoaError>>
                     {
