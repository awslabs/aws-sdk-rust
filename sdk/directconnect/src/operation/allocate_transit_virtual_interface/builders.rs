...
impl crate::operation::allocate_transit_virtual_interface::builders::AllocateTransitVirtualInterfaceInputBuilder {
...
impl AllocateTransitVirtualInterfaceFluentBuilder {
    /// Creates a new `AllocateTransitVirtualInterfaceFluentBuilder`.
