...
impl AllocateTransitVirtualInterfaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceOutput, crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceError, Self> {
