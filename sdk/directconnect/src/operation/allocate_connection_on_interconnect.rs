...
impl AllocateConnectionOnInterconnectInput {
    /// Consumes the builder and constructs an Operation<[`AllocateConnectionOnInterconnect`](crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnect)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnect, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_connection_on_interconnect::ser_allocate_connection_on_interconnect_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnect::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AllocateConnectionOnInterconnect", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for AllocateConnectionOnInterconnect {
                type Output = std::result::Result<crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectOutput, crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectError>;
