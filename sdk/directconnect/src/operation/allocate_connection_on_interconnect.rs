...
impl ::aws_smithy_http::response::ParseStrictResponse for AllocateConnectionOnInterconnect {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_allocate_connection_on_interconnect::de_allocate_connection_on_interconnect_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectError
{
