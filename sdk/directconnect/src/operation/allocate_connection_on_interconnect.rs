...
impl AllocateConnectionOnInterconnect {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AllocateConnectionOnInterconnectResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AllocateConnectionOnInterconnectRequestSerializer {
