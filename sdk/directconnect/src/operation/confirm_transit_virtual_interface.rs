...
impl ConfirmTransitVirtualInterface {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ConfirmTransitVirtualInterface {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ConfirmTransitVirtualInterface");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ConfirmTransitVirtualInterfaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ConfirmTransitVirtualInterfaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ConfirmTransitVirtualInterface")
...
.with_interceptor(ConfirmTransitVirtualInterfaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceError>::new());
...
#[derive(Debug)]
            struct ConfirmTransitVirtualInterfaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ConfirmTransitVirtualInterfaceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_confirm_transit_virtual_interface::de_confirm_transit_virtual_interface_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ConfirmTransitVirtualInterfaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ConfirmTransitVirtualInterfaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_confirm_transit_virtual_interface::ser_confirm_transit_virtual_interface_input(&input)?);
...
#[derive(Debug)]
            struct ConfirmTransitVirtualInterfaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ConfirmTransitVirtualInterfaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ConfirmTransitVirtualInterfaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ConfirmTransitVirtualInterfaceInput>()
                        .ok_or("failed to downcast to ConfirmTransitVirtualInterfaceInput")?;
...
pub enum ConfirmTransitVirtualInterfaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ConfirmTransitVirtualInterfaceError) for what information is available for the error.")]
...
impl ConfirmTransitVirtualInterfaceError {
    /// Creates the `ConfirmTransitVirtualInterfaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ConfirmTransitVirtualInterfaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ConfirmTransitVirtualInterfaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterfaceError {
