...
impl ConfirmTransitVirtualInterfaceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::confirm_transit_virtual_interface::ConfirmTransitVirtualInterface::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmTransitVirtualInterface {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_confirm_transit_virtual_interface::de_confirm_transit_virtual_interface_http_response_with_props(
                status, headers, body,
            )
        }
    }
