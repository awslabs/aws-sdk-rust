...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_interconnects::DescribeInterconnectsOutput,
                    crate::operation::describe_interconnects::DescribeInterconnectsError,
                > for DescribeInterconnectsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeInterconnectsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_interconnects::DescribeInterconnectsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_interconnects::DescribeInterconnectsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_interconnects::DescribeInterconnectsOutput, crate::operation::describe_interconnects::DescribeInterconnectsError, Self> {
