...
impl AssociateHostedConnectionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_hosted_connection::AssociateHostedConnection::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateHostedConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_hosted_connection::de_associate_hosted_connection_http_response_with_props(status, headers, body)
        }
    }
}
