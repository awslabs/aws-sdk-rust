...
impl AssociateHostedConnectionInput {
    /// Consumes the builder and constructs an Operation<[`AssociateHostedConnection`](crate::operation::associate_hosted_connection::AssociateHostedConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_hosted_connection::AssociateHostedConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_hosted_connection::AssociateHostedConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_hosted_connection::ser_associate_hosted_connection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_hosted_connection::AssociateHostedConnection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateHostedConnection", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateHostedConnection {
                type Output = std::result::Result<crate::operation::associate_hosted_connection::AssociateHostedConnectionOutput, crate::operation::associate_hosted_connection::AssociateHostedConnectionError>;
