...
impl DescribeHostedConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_hosted_connections::DescribeHostedConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
