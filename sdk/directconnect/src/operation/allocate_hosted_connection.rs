...
impl AllocateHostedConnectionInput {
    /// Consumes the builder and constructs an Operation<[`AllocateHostedConnection`](crate::operation::allocate_hosted_connection::AllocateHostedConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::allocate_hosted_connection::AllocateHostedConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::allocate_hosted_connection::AllocateHostedConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_hosted_connection::ser_allocate_hosted_connection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::allocate_hosted_connection::AllocateHostedConnection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AllocateHostedConnection", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for AllocateHostedConnection {
                type Output = std::result::Result<crate::operation::allocate_hosted_connection::AllocateHostedConnectionOutput, crate::operation::allocate_hosted_connection::AllocateHostedConnectionError>;
