...
impl AllocateHostedConnection {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::allocate_hosted_connection::AllocateHostedConnectionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::allocate_hosted_connection::AllocateHostedConnectionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.AllocateHostedConnection",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "AllocateHostedConnection",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateHostedConnection {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AllocateHostedConnectionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AllocateHostedConnectionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllocateHostedConnection")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocateHostedConnection")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AllocateHostedConnectionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AllocateHostedConnectionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocateHostedConnectionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AllocateHostedConnectionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllocateHostedConnectionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_allocate_hosted_connection::de_allocate_hosted_connection_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_allocate_hosted_connection::de_allocate_hosted_connection_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocateHostedConnectionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::allocate_hosted_connection::AllocateHostedConnectionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::allocate_hosted_connection::AllocateHostedConnectionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_hosted_connection::ser_allocate_hosted_connection_input(&input)?,
        );
