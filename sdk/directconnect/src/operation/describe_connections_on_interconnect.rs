...
/// Orchestration and serialization glue logic for `DescribeConnectionsOnInterconnect`.
...
impl DescribeConnectionsOnInterconnect {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeConnectionsOnInterconnect {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeConnectionsOnInterconnect");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeConnectionsOnInterconnectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeConnectionsOnInterconnectResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeConnectionsOnInterconnect")
...
.with_interceptor(DescribeConnectionsOnInterconnectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError>::new());
...
#[derive(Debug)]
            struct DescribeConnectionsOnInterconnectResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConnectionsOnInterconnectResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_connections_on_interconnect::de_describe_connections_on_interconnect_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeConnectionsOnInterconnectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConnectionsOnInterconnectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_connections_on_interconnect::ser_describe_connections_on_interconnect_input(&input)?);
...
#[derive(Debug)]
            struct DescribeConnectionsOnInterconnectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeConnectionsOnInterconnectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeConnectionsOnInterconnectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeConnectionsOnInterconnectInput>()
                        .ok_or("failed to downcast to DescribeConnectionsOnInterconnectInput")?;
...
pub enum DescribeConnectionsOnInterconnectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeConnectionsOnInterconnectError) for what information is available for the error.")]
...
impl DescribeConnectionsOnInterconnectError {
    /// Creates the `DescribeConnectionsOnInterconnectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeConnectionsOnInterconnectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeConnectionsOnInterconnectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError {
...
mod _describe_connections_on_interconnect_output;
