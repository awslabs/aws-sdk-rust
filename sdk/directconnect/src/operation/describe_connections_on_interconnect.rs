...
impl DescribeConnectionsOnInterconnectInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnect,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnect::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConnectionsOnInterconnect {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_connections_on_interconnect::de_describe_connections_on_interconnect_http_response_with_props(
                status, headers, body,
            )
        }
    }
