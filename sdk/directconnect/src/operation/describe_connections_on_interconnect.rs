...
impl DescribeConnectionsOnInterconnectInput {
    /// Consumes the builder and constructs an Operation<[`DescribeConnectionsOnInterconnect`](crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnect)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnect, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_connections_on_interconnect::ser_describe_connections_on_interconnect_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnect::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeConnectionsOnInterconnect", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConnectionsOnInterconnect {
    type Output = ::std::result::Result<crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectOutput, crate::operation::describe_connections_on_interconnect::DescribeConnectionsOnInterconnectError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_connections_on_interconnect::de_describe_connections_on_interconnect_http_response_with_props(status, headers, body)
        }
    }
}
