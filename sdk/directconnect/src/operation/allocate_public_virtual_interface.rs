...
impl AllocatePublicVirtualInterfaceInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterface,
...
impl aws_smithy_http::response::ParseStrictResponse for AllocatePublicVirtualInterface {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_allocate_public_virtual_interface::de_allocate_public_virtual_interface_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceError
{
