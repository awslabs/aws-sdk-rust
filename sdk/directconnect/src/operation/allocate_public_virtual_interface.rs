...
impl AllocatePublicVirtualInterface {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.AllocatePublicVirtualInterface",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "AllocatePublicVirtualInterface",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocatePublicVirtualInterface {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AllocatePublicVirtualInterfaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AllocatePublicVirtualInterfaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllocatePublicVirtualInterface")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocatePublicVirtualInterface")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AllocatePublicVirtualInterfaceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AllocatePublicVirtualInterfaceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocatePublicVirtualInterfaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AllocatePublicVirtualInterfaceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocatePublicVirtualInterfaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_public_virtual_interface::ser_allocate_public_virtual_interface_input(&input)?,
        );
...
impl AllocatePublicVirtualInterfaceError {
    ...
    /// Returns `true` if the error kind is `AllocatePublicVirtualInterfaceError::LimitExceededException`.
