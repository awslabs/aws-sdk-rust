...
impl CreateDirectConnectGatewayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_direct_connect_gateway::CreateDirectConnectGatewayInput, ::aws_smithy_types::error::operation::BuildError> {
