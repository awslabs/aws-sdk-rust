...
impl DeleteInterconnectInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInterconnect`](crate::operation::delete_interconnect::DeleteInterconnect)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_interconnect::DeleteInterconnect, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_interconnect::DeleteInterconnectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_interconnect::ser_delete_interconnect_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_interconnect::DeleteInterconnect::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteInterconnect", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteInterconnect {
                type Output = std::result::Result<crate::operation::delete_interconnect::DeleteInterconnectOutput, crate::operation::delete_interconnect::DeleteInterconnectError>;
