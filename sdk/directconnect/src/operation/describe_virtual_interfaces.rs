...
impl DescribeVirtualInterfacesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVirtualInterfaces`](crate::operation::describe_virtual_interfaces::DescribeVirtualInterfaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfaces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_virtual_interfaces::ser_describe_virtual_interfaces_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_interfaces::DescribeVirtualInterfaces::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeVirtualInterfaces", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeVirtualInterfaces {
                type Output = std::result::Result<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesOutput, crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError>;
