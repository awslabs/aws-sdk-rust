...
impl DescribeVirtualInterfacesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_interfaces::DescribeVirtualInterfaces::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVirtualInterfaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_virtual_interfaces::de_describe_virtual_interfaces_http_response_with_props(status, headers, body)
        }
    }
}
