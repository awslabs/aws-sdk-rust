...
/// Orchestration and serialization glue logic for `DescribeVirtualInterfaces`.
...
impl DescribeVirtualInterfaces {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVirtualInterfaces {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeVirtualInterfaces");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeVirtualInterfacesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeVirtualInterfacesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVirtualInterfaces")
...
.with_interceptor(DescribeVirtualInterfacesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError>::new());
...
#[derive(Debug)]
            struct DescribeVirtualInterfacesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeVirtualInterfacesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_virtual_interfaces::de_describe_virtual_interfaces_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeVirtualInterfacesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeVirtualInterfacesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_virtual_interfaces::ser_describe_virtual_interfaces_input(&input)?);
...
#[derive(Debug)]
            struct DescribeVirtualInterfacesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeVirtualInterfacesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeVirtualInterfacesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeVirtualInterfacesInput>()
                        .ok_or("failed to downcast to DescribeVirtualInterfacesInput")?;
...
pub enum DescribeVirtualInterfacesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeVirtualInterfacesError) for what information is available for the error.")]
...
impl DescribeVirtualInterfacesError {
    /// Creates the `DescribeVirtualInterfacesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeVirtualInterfacesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeVirtualInterfacesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_virtual_interfaces::DescribeVirtualInterfacesError {
...
mod _describe_virtual_interfaces_output;
