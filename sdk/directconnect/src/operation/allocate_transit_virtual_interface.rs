...
impl AllocateTransitVirtualInterface {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.AllocateTransitVirtualInterface",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "AllocateTransitVirtualInterface",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateTransitVirtualInterface {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AllocateTransitVirtualInterfaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AllocateTransitVirtualInterfaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllocateTransitVirtualInterface")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocateTransitVirtualInterface")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AllocateTransitVirtualInterfaceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AllocateTransitVirtualInterfaceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocateTransitVirtualInterfaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AllocateTransitVirtualInterfaceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllocateTransitVirtualInterfaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_allocate_transit_virtual_interface::de_allocate_transit_virtual_interface_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocateTransitVirtualInterfaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::allocate_transit_virtual_interface::AllocateTransitVirtualInterfaceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_transit_virtual_interface::ser_allocate_transit_virtual_interface_input(&input)?,
        );
...
impl AllocateTransitVirtualInterfaceError {
    ...
    /// Returns `true` if the error kind is `AllocateTransitVirtualInterfaceError::LimitExceededException`.
