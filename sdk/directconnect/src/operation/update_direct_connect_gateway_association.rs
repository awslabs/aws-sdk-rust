...
impl UpdateDirectConnectGatewayAssociationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDirectConnectGatewayAssociation`](crate::operation::update_direct_connect_gateway_association::UpdateDirectConnectGatewayAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_direct_connect_gateway_association::UpdateDirectConnectGatewayAssociation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_direct_connect_gateway_association::ser_update_direct_connect_gateway_association_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_direct_connect_gateway_association::UpdateDirectConnectGatewayAssociation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDirectConnectGatewayAssociation", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDirectConnectGatewayAssociation {
    type Output = ::std::result::Result<crate::operation::update_direct_connect_gateway_association::UpdateDirectConnectGatewayAssociationOutput, crate::operation::update_direct_connect_gateway_association::UpdateDirectConnectGatewayAssociationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_direct_connect_gateway_association::de_update_direct_connect_gateway_association_http_response_with_props(status, headers, body)
        }
    }
}
