...
impl DisassociateConnectionFromLagInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateConnectionFromLag`](crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLag)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLag, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_connection_from_lag::ser_disassociate_connection_from_lag_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLag::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisassociateConnectionFromLag", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateConnectionFromLag {
                type Output = std::result::Result<crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagOutput, crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagError>;
