...
impl CreateBgpPeerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_bgp_peer::CreateBGPPeer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_bgp_peer::ser_create_bgp_peer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBGPPeer {
    type Output =
        ::std::result::Result<crate::operation::create_bgp_peer::CreateBgpPeerOutput, crate::operation::create_bgp_peer::CreateBGPPeerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_bgp_peer::de_create_bgp_peer_http_response_with_props(status, headers, body)
        }
    }
}
