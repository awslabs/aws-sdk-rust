...
impl CreateBgpPeerInput {
    /// Consumes the builder and constructs an Operation<[`CreateBGPPeer`](crate::operation::create_bgp_peer::CreateBGPPeer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_bgp_peer::CreateBGPPeer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_bgp_peer::CreateBgpPeerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_bgp_peer::ser_create_bgp_peer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_bgp_peer::CreateBGPPeer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateBGPPeer", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBGPPeer {
                type Output = std::result::Result<crate::operation::create_bgp_peer::CreateBgpPeerOutput, crate::operation::create_bgp_peer::CreateBGPPeerError>;
