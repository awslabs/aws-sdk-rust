...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDirectConnectGatewayAssociationProposalsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDirectConnectGatewayAssociationProposalsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_direct_connect_gateway_association_proposals::ser_describe_direct_connect_gateway_association_proposals_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDirectConnectGatewayAssociationProposalsEndpointParamsInterceptor {
