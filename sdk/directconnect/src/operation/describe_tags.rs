...
impl DescribeTags {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Direct Connect", "DescribeTags", input, runtime_plugins, stop_point).await
    }
