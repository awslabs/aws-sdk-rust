...
impl DeleteDirectConnectGatewayInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDirectConnectGateway`](crate::operation::delete_direct_connect_gateway::DeleteDirectConnectGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_direct_connect_gateway::DeleteDirectConnectGateway, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_direct_connect_gateway::DeleteDirectConnectGatewayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_direct_connect_gateway::ser_delete_direct_connect_gateway_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_direct_connect_gateway::DeleteDirectConnectGateway::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDirectConnectGateway", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDirectConnectGateway {
                type Output = std::result::Result<crate::operation::delete_direct_connect_gateway::DeleteDirectConnectGatewayOutput, crate::operation::delete_direct_connect_gateway::DeleteDirectConnectGatewayError>;
