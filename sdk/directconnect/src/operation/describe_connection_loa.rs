...
impl DescribeConnectionLoa {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_connection_loa::DescribeConnectionLoaInput,
                    ) -> ::std::result::Result<crate::operation::describe_connection_loa::DescribeConnectionLoaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_connection_loa::DescribeConnectionLoaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_connection_loa::DescribeConnectionLoaError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_connection_loa::DescribeConnectionLoaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeConnectionLoa {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeConnectionLoa");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeConnectionLoaRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeConnectionLoaResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeConnectionLoa")
...
.with_interceptor(DescribeConnectionLoaEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_connection_loa::DescribeConnectionLoaError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_connection_loa::DescribeConnectionLoaError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_connection_loa::DescribeConnectionLoaError>::new());
...
#[derive(Debug)]
            struct DescribeConnectionLoaResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConnectionLoaResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_connection_loa::de_describe_connection_loa_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeConnectionLoaRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConnectionLoaRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_connection_loa::DescribeConnectionLoaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_connection_loa::DescribeConnectionLoaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_connection_loa::ser_describe_connection_loa_input(&input)?);
...
#[derive(Debug)]
            struct DescribeConnectionLoaEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeConnectionLoaEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeConnectionLoaEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeConnectionLoaInput>()
                        .ok_or("failed to downcast to DescribeConnectionLoaInput")?;
...
pub enum DescribeConnectionLoaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeConnectionLoaError) for what information is available for the error.")]
...
impl DescribeConnectionLoaError {
    /// Creates the `DescribeConnectionLoaError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeConnectionLoaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeConnectionLoaError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_connection_loa::DescribeConnectionLoaError {
...
mod _describe_connection_loa_output;
