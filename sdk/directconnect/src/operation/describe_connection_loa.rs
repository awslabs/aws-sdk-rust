...
impl DescribeConnectionLoaInput {
    /// Consumes the builder and constructs an Operation<[`DescribeConnectionLoa`](crate::operation::describe_connection_loa::DescribeConnectionLoa)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_connection_loa::DescribeConnectionLoa, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_connection_loa::DescribeConnectionLoaInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_connection_loa::ser_describe_connection_loa_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_connection_loa::DescribeConnectionLoa::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeConnectionLoa", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConnectionLoa {
                type Output = std::result::Result<crate::operation::describe_connection_loa::DescribeConnectionLoaOutput, crate::operation::describe_connection_loa::DescribeConnectionLoaError>;
