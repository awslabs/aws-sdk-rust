...
impl crate::operation::delete_direct_connect_gateway::builders::DeleteDirectConnectGatewayInputBuilder {
...
impl DeleteDirectConnectGatewayFluentBuilder {
    /// Creates a new `DeleteDirectConnectGatewayFluentBuilder`.
