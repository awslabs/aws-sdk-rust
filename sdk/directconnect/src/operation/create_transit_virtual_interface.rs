...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTransitVirtualInterface {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_transit_virtual_interface::de_create_transit_virtual_interface_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceError
{
