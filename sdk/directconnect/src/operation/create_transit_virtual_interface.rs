...
impl CreateTransitVirtualInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`CreateTransitVirtualInterface`](crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterface, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_transit_virtual_interface::ser_create_transit_virtual_interface_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterface::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateTransitVirtualInterface", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateTransitVirtualInterface {
                type Output = std::result::Result<crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceOutput, crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceError>;
