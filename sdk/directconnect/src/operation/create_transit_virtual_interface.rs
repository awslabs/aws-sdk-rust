...
impl CreateTransitVirtualInterfaceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterface::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTransitVirtualInterface {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_transit_virtual_interface::de_create_transit_virtual_interface_http_response_with_props(
                status, headers, body,
            )
        }
    }
