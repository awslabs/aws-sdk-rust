...
impl CreateTransitVirtualInterface {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Direct Connect.CreateTransitVirtualInterface",
            "rpc.service" = "Direct Connect",
            "rpc.method" = "CreateTransitVirtualInterface",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTransitVirtualInterface {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateTransitVirtualInterfaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateTransitVirtualInterfaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateTransitVirtualInterface")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTransitVirtualInterface")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateTransitVirtualInterfaceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateTransitVirtualInterfaceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTransitVirtualInterfaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateTransitVirtualInterfaceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTransitVirtualInterfaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_transit_virtual_interface::CreateTransitVirtualInterfaceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_transit_virtual_interface::ser_create_transit_virtual_interface_input(&input)?,
        );
...
impl CreateTransitVirtualInterfaceError {
    ...
    /// Returns `true` if the error kind is `CreateTransitVirtualInterfaceError::LimitExceededException`.
