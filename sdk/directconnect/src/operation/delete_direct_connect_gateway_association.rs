...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDirectConnectGatewayAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_direct_connect_gateway_association::de_delete_direct_connect_gateway_association_http_response_with_props(status, headers, body)
        }
    }
}
