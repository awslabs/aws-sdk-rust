...
impl CreateInterconnectInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_interconnect::ser_create_interconnect_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInterconnect {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_interconnect::de_create_interconnect_http_response_with_props(status, headers, body)
        }
    }
}
