...
impl CreateInterconnectInput {
    /// Consumes the builder and constructs an Operation<[`CreateInterconnect`](crate::operation::create_interconnect::CreateInterconnect)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_interconnect::CreateInterconnect, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_interconnect::CreateInterconnectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_interconnect::ser_create_interconnect_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_interconnect::CreateInterconnect::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateInterconnect", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateInterconnect {
                type Output = std::result::Result<crate::operation::create_interconnect::CreateInterconnectOutput, crate::operation::create_interconnect::CreateInterconnectError>;
