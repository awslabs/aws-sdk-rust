...
impl UpdateVirtualInterfaceAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_virtual_interface_attributes::UpdateVirtualInterfaceAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVirtualInterfaceAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_virtual_interface_attributes::de_update_virtual_interface_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
