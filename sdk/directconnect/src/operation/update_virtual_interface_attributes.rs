...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVirtualInterfaceAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_virtual_interface_attributes::de_update_virtual_interface_attributes_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_virtual_interface_attributes::UpdateVirtualInterfaceAttributesError
{
