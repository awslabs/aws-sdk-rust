...
impl CreateDirectConnectGatewayAssociationProposal {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalInput,
                    ) -> ::std::result::Result<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDirectConnectGatewayAssociationProposal {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateDirectConnectGatewayAssociationProposal");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateDirectConnectGatewayAssociationProposalRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateDirectConnectGatewayAssociationProposalResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDirectConnectGatewayAssociationProposal")
...
.with_interceptor(CreateDirectConnectGatewayAssociationProposalEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalError>::new());
...
#[derive(Debug)]
            struct CreateDirectConnectGatewayAssociationProposalResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDirectConnectGatewayAssociationProposalResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_direct_connect_gateway_association_proposal::de_create_direct_connect_gateway_association_proposal_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_direct_connect_gateway_association_proposal::de_create_direct_connect_gateway_association_proposal_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateDirectConnectGatewayAssociationProposalRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDirectConnectGatewayAssociationProposalRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_direct_connect_gateway_association_proposal::ser_create_direct_connect_gateway_association_proposal_input(&input)?);
...
#[derive(Debug)]
            struct CreateDirectConnectGatewayAssociationProposalEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDirectConnectGatewayAssociationProposalEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateDirectConnectGatewayAssociationProposalEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateDirectConnectGatewayAssociationProposalInput>()
                        .ok_or("failed to downcast to CreateDirectConnectGatewayAssociationProposalInput")?;
...
pub enum CreateDirectConnectGatewayAssociationProposalError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateDirectConnectGatewayAssociationProposalError) for what information is available for the error.")]
...
impl CreateDirectConnectGatewayAssociationProposalError {
    /// Creates the `CreateDirectConnectGatewayAssociationProposalError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDirectConnectGatewayAssociationProposalError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateDirectConnectGatewayAssociationProposalError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_direct_connect_gateway_association_proposal::CreateDirectConnectGatewayAssociationProposalError {
...
mod _create_direct_connect_gateway_association_proposal_output;
