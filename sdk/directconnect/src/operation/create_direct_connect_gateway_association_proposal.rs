...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateDirectConnectGatewayAssociationProposalResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateDirectConnectGatewayAssociationProposalRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_direct_connect_gateway_association_proposal::ser_create_direct_connect_gateway_association_proposal_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateDirectConnectGatewayAssociationProposalEndpointParamsInterceptor {
