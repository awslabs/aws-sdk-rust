...
impl DeleteConnectionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteConnection`](crate::operation::delete_connection::DeleteConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_connection::DeleteConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_connection::DeleteConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_connection::ser_delete_connection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_connection::DeleteConnection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteConnection", "directconnect"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteConnection {
                type Output = std::result::Result<crate::operation::delete_connection::DeleteConnectionOutput, crate::operation::delete_connection::DeleteConnectionError>;
