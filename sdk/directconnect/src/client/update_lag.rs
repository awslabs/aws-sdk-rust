...
impl super::Client {
    ...
    ///   - [`connections_bandwidth(Option<String>)`](crate::operation::update_lag::UpdateLagOutput::connections_bandwidth): <p>The individual bandwidth of the physical connections bundled by the LAG. The possible values are 1Gbps, 10Gbps, 100Gbps, or 400 Gbps..</p>
    ///   - [`number_of_connections(i32)`](crate::operation::update_lag::UpdateLagOutput::number_of_connections): <p>The number of physical dedicated connections initially provisioned and bundled by the LAG. You can have a maximum of four connections when the port speed is 1 Gbps or 10 Gbps, or two when the port speed is 100 Gbps or 400 Gbps.</p>
