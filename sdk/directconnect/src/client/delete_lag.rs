...
impl super::Client {
    ...
    ///   - [`prefix_pool_size_ipv4(Option<i32>)`](crate::operation::delete_lag::DeleteLagOutput::prefix_pool_size_ipv4): <p>The total number of inbound IPv4 route prefixes you can allocate across the virtual interfaces on the LAG. Not applicable to LAGs that are interconnects and support hosted connections.</p>
    ///   - [`prefix_pool_size_ipv6(Option<i32>)`](crate::operation::delete_lag::DeleteLagOutput::prefix_pool_size_ipv6): <p>The total number of inbound IPv6 route prefixes you can allocate across the virtual interfaces on the LAG. Not applicable to LAGs that are interconnects and support hosted connections.</p>
