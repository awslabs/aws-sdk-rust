...
impl super::Client {
    ...
    ///   - [`direct_connect_gateway_name(impl ::std::convert::Into<String>)`](crate::operation::create_direct_connect_gateway::builders::CreateDirectConnectGatewayFluentBuilder::direct_connect_gateway_name) / [`set_direct_connect_gateway_name(Option<String>)`](crate::operation::create_direct_connect_gateway::builders::CreateDirectConnectGatewayFluentBuilder::set_direct_connect_gateway_name): <p>The name of the Direct Connect gateway.</p>
