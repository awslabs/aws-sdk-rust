...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_direct_connect_gateway::builders::CreateDirectConnectGatewayFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_direct_connect_gateway::builders::CreateDirectConnectGatewayFluentBuilder::set_tags):<br>required: **false**<br><p>The key-value pair tags associated with the request.</p><br>
