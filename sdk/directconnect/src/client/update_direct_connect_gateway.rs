...
impl super::Client {
    ...
    ///   - [`direct_connect_gateway(Option<DirectConnectGateway>)`](crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayOutput::direct_connect_gateway): <p>Informaiton about a Direct Connect gateway, which enables you to connect virtual interfaces and virtual private gateways or transit gateways.</p>
