...
impl super::Client {
    ...
    ///   - [`virtual_interface_id(impl Into<String>)`](crate::operation::create_bgp_peer::builders::CreateBGPPeerFluentBuilder::virtual_interface_id) / [`set_virtual_interface_id(Option<String>)`](crate::operation::create_bgp_peer::builders::CreateBGPPeerFluentBuilder::set_virtual_interface_id):<br>required: **false**<br><p>The ID of the virtual interface.</p><br>
    ///   - [`new_bgp_peer(NewBgpPeer)`](crate::operation::create_bgp_peer::builders::CreateBGPPeerFluentBuilder::new_bgp_peer) / [`set_new_bgp_peer(Option<NewBgpPeer>)`](crate::operation::create_bgp_peer::builders::CreateBGPPeerFluentBuilder::set_new_bgp_peer):<br>required: **false**<br><p>Information about the BGP peer.</p><br>
