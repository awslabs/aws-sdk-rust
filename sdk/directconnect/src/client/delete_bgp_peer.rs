...
impl super::Client {
    ...
    ///   - [`virtual_interface_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bgp_peer::builders::DeleteBGPPeerFluentBuilder::virtual_interface_id) / [`set_virtual_interface_id(Option<String>)`](crate::operation::delete_bgp_peer::builders::DeleteBGPPeerFluentBuilder::set_virtual_interface_id): <p>The ID of the virtual interface.</p>
    ...
    ///   - [`customer_address(impl ::std::convert::Into<String>)`](crate::operation::delete_bgp_peer::builders::DeleteBGPPeerFluentBuilder::customer_address) / [`set_customer_address(Option<String>)`](crate::operation::delete_bgp_peer::builders::DeleteBGPPeerFluentBuilder::set_customer_address): <p>The IP address assigned to the customer interface.</p>
    ///   - [`bgp_peer_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bgp_peer::builders::DeleteBGPPeerFluentBuilder::bgp_peer_id) / [`set_bgp_peer_id(Option<String>)`](crate::operation::delete_bgp_peer::builders::DeleteBGPPeerFluentBuilder::set_bgp_peer_id): <p>The ID of the BGP peer.</p>
