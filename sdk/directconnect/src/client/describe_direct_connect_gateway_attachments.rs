...
impl super::Client {
    ...
    ///   - [`direct_connect_gateway_id(impl ::std::convert::Into<String>)`](crate::operation::describe_direct_connect_gateway_attachments::builders::DescribeDirectConnectGatewayAttachmentsFluentBuilder::direct_connect_gateway_id) / [`set_direct_connect_gateway_id(Option<String>)`](crate::operation::describe_direct_connect_gateway_attachments::builders::DescribeDirectConnectGatewayAttachmentsFluentBuilder::set_direct_connect_gateway_id): <p>The ID of the Direct Connect gateway.</p>
    ///   - [`virtual_interface_id(impl ::std::convert::Into<String>)`](crate::operation::describe_direct_connect_gateway_attachments::builders::DescribeDirectConnectGatewayAttachmentsFluentBuilder::virtual_interface_id) / [`set_virtual_interface_id(Option<String>)`](crate::operation::describe_direct_connect_gateway_attachments::builders::DescribeDirectConnectGatewayAttachmentsFluentBuilder::set_virtual_interface_id): <p>The ID of the virtual interface.</p>
