...
impl super::Client {
    ...
    ///   - [`resource_arns(impl Into<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::resource_arns) / [`set_resource_arns(Option<Vec<String>>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_resource_arns): <p>The Amazon Resource Names (ARNs) of the resources.</p>
