...
impl super::Client {
    ...
    ///   - [`bgp_peers(impl Into<String>)`](crate::operation::start_bgp_failover_test::builders::StartBgpFailoverTestFluentBuilder::bgp_peers) / [`set_bgp_peers(Option<Vec<String>>)`](crate::operation::start_bgp_failover_test::builders::StartBgpFailoverTestFluentBuilder::set_bgp_peers): <p>The BGP peers to place in the DOWN state.</p>
