...
impl super::Client {
    ...
    ///   - [`interconnect_name(impl ::std::convert::Into<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::interconnect_name) / [`set_interconnect_name(Option<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::set_interconnect_name): <p>The name of the interconnect.</p>
    ///   - [`bandwidth(impl ::std::convert::Into<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::bandwidth) / [`set_bandwidth(Option<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::set_bandwidth): <p>The port bandwidth, in Gbps. The possible values are 1 and 10.</p>
    ///   - [`location(impl ::std::convert::Into<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::location) / [`set_location(Option<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::set_location): <p>The location of the interconnect.</p>
    ///   - [`lag_id(impl ::std::convert::Into<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::lag_id) / [`set_lag_id(Option<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::set_lag_id): <p>The ID of the LAG.</p>
    ...
    ///   - [`provider_name(impl ::std::convert::Into<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::provider_name) / [`set_provider_name(Option<String>)`](crate::operation::create_interconnect::builders::CreateInterconnectFluentBuilder::set_provider_name): <p>The name of the service provider associated with the interconnect.</p>
