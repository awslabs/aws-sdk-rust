...
impl super::Client {
    ...
    ///   - [`connection_id(impl ::std::convert::Into<String>)`](crate::operation::describe_loa::builders::DescribeLoaFluentBuilder::connection_id) / [`set_connection_id(Option<String>)`](crate::operation::describe_loa::builders::DescribeLoaFluentBuilder::set_connection_id): <p>The ID of a connection, LAG, or interconnect.</p>
    ///   - [`provider_name(impl ::std::convert::Into<String>)`](crate::operation::describe_loa::builders::DescribeLoaFluentBuilder::provider_name) / [`set_provider_name(Option<String>)`](crate::operation::describe_loa::builders::DescribeLoaFluentBuilder::set_provider_name): <p>The name of the service provider who establishes connectivity on your behalf. If you specify this parameter, the LOA-CFA lists the provider name alongside your company name as the requester of the cross connect.</p>
