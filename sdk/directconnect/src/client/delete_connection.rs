...
impl super::Client  {
    ...
    ///   - [`jumbo_frame_capable(Option<bool>)`](crate::operation::delete_connection::DeleteConnectionOutput::jumbo_frame_capable): <p>Indicates whether jumbo frames (9001 MTU) are supported.</p>
