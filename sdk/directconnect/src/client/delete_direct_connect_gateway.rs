...
impl super::Client {
    ...
    ///   - [`direct_connect_gateway_id(impl Into<String>)`](crate::operation::delete_direct_connect_gateway::builders::DeleteDirectConnectGatewayFluentBuilder::direct_connect_gateway_id) / [`set_direct_connect_gateway_id(Option<String>)`](crate::operation::delete_direct_connect_gateway::builders::DeleteDirectConnectGatewayFluentBuilder::set_direct_connect_gateway_id):<br>required: **true**<br><p>The ID of the Direct Connect gateway.</p><br>
