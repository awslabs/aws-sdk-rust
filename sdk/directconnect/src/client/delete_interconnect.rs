...
impl super::Client {
    ...
    ///   - [`interconnect_id(impl ::std::convert::Into<String>)`](crate::operation::delete_interconnect::builders::DeleteInterconnectFluentBuilder::interconnect_id) / [`set_interconnect_id(Option<String>)`](crate::operation::delete_interconnect::builders::DeleteInterconnectFluentBuilder::set_interconnect_id): <p>The ID of the interconnect.</p>
    ...
    pub fn delete_interconnect(
        &self,
    ) -> crate::operation::delete_interconnect::builders::DeleteInterconnectFluentBuilder {
        crate::operation::delete_interconnect::builders::DeleteInterconnectFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
