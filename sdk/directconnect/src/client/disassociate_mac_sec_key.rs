...
impl super::Client {
    ...
    ///   - [`connection_id(impl Into<String>)`](crate::operation::disassociate_mac_sec_key::builders::DisassociateMacSecKeyFluentBuilder::connection_id) / [`set_connection_id(Option<String>)`](crate::operation::disassociate_mac_sec_key::builders::DisassociateMacSecKeyFluentBuilder::set_connection_id):<br>required: **true**<br><p>The ID of the dedicated connection (dxcon-xxxx), interconnect (dxcon-xxxx), or LAG (dxlag-xxxx).</p> <p>You can use <code>DescribeConnections</code>, <code>DescribeInterconnects</code>, or <code>DescribeLags</code> to retrieve connection ID.</p><br>
    ...
    ///   - [`connection_id(Option<String>)`](crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyOutput::connection_id): <p>The ID of the dedicated connection (dxcon-xxxx), interconnect (dxcon-xxxx), or LAG (dxlag-xxxx).</p>
    ///   - [`mac_sec_keys(Option<Vec::<MacSecKey>>)`](crate::operation::disassociate_mac_sec_key::DisassociateMacSecKeyOutput::mac_sec_keys): <p>The MAC Security (MACsec) security keys no longer associated with the connection.</p>
