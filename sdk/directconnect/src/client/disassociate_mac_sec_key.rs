...
impl super::Client {
    ...
    ///   - [`connection_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_mac_sec_key::builders::DisassociateMacSecKeyFluentBuilder::connection_id) / [`set_connection_id(Option<String>)`](crate::operation::disassociate_mac_sec_key::builders::DisassociateMacSecKeyFluentBuilder::set_connection_id): <p>The ID of the dedicated connection (dxcon-xxxx), or the ID of the LAG (dxlag-xxxx).</p>  <p>You can use <code>DescribeConnections</code> or <code>DescribeLags</code> to retrieve connection ID.</p>
    ///   - [`secret_arn(impl ::std::convert::Into<String>)`](crate::operation::disassociate_mac_sec_key::builders::DisassociateMacSecKeyFluentBuilder::secret_arn) / [`set_secret_arn(Option<String>)`](crate::operation::disassociate_mac_sec_key::builders::DisassociateMacSecKeyFluentBuilder::set_secret_arn): <p>The Amazon Resource Name (ARN) of the MAC Security (MACsec) secret key.</p>  <p>You can use <code>DescribeConnections</code> to retrieve the ARN of the MAC Security (MACsec) secret key.</p>
