...
impl ::std::convert::From<&str> for BgpStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "up" => BgpStatus::Up,
            other => BgpStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BgpStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BgpStatus::from(s))
    }
}
impl BgpStatus {
...
impl ::std::convert::AsRef<str> for BgpStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
