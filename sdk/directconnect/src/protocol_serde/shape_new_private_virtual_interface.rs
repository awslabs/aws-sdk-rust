...
pub fn ser_new_private_virtual_interface(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NewPrivateVirtualInterface) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
