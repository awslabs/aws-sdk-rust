...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_virtual_interface_attributes::UpdateVirtualInterfaceAttributesError::unhandled)?;
    ...
    Err(match error_code {
        "DirectConnectClientException" => {
            crate::operation::update_virtual_interface_attributes::UpdateVirtualInterfaceAttributesError::DirectConnectClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DirectConnectServerException" => {
            crate::operation::update_virtual_interface_attributes::UpdateVirtualInterfaceAttributesError::DirectConnectServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_virtual_interface_attributes::de_update_virtual_interface_attributes(_response_body, output)
            .map_err(crate::operation::update_virtual_interface_attributes::UpdateVirtualInterfaceAttributesError::unhandled)?;
...
pub(crate) fn de_update_virtual_interface_attributes(
    value: &[u8],
    mut builder: crate::operation::update_virtual_interface_attributes::builders::UpdateVirtualInterfaceAttributesOutputBuilder,
) -> Result<
    crate::operation::update_virtual_interface_attributes::builders::UpdateVirtualInterfaceAttributesOutputBuilder,
