...
pub fn ser_associate_mac_sec_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateMacSecKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
