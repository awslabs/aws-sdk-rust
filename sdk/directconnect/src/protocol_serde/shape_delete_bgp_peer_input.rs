...
pub fn ser_delete_bgp_peer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteBgpPeerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
