...
pub fn ser_new_transit_virtual_interface_allocation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NewTransitVirtualInterfaceAllocation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
