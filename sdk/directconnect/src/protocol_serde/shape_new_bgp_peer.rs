...
pub fn ser_new_bgp_peer(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NewBgpPeer) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.asn != 0 {
