...
pub fn ser_list_virtual_interface_test_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListVirtualInterfaceTestHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
