...
pub fn ser_update_virtual_interface_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateVirtualInterfaceAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
