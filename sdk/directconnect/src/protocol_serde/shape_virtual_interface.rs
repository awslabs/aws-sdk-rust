...
pub(crate) fn de_virtual_interface<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VirtualInterface>, aws_smithy_json::deserialize::error::DeserializeError>
