...
pub fn ser_update_direct_connect_gateway_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDirectConnectGatewayInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
