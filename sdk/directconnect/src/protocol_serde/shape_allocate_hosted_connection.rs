...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DirectConnectClientException" => {
            crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::DirectConnectClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DirectConnectServerException" => {
            crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::DirectConnectServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DuplicateTagKeysException" => crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::DuplicateTagKeysException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_duplicate_tag_keys_exception::de_duplicate_tag_keys_exception_json_err(_response_body, output)
                    .map_err(crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_allocate_hosted_connection::de_allocate_hosted_connection(_response_body, output)
            .map_err(crate::operation::allocate_hosted_connection::AllocateHostedConnectionError::unhandled)?;
