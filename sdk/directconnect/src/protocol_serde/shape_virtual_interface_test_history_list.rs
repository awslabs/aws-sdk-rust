...
pub(crate) fn de_virtual_interface_test_history_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::VirtualInterfaceTestHistory>>, aws_smithy_json::deserialize::error::DeserializeError>
