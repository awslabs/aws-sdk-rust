...
pub fn ser_describe_direct_connect_gateway_associations_input(input: &crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
