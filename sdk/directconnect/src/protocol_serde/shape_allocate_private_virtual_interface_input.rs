...
pub fn ser_allocate_private_virtual_interface_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AllocatePrivateVirtualInterfaceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
