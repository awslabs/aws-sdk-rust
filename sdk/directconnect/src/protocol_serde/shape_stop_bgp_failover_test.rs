...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_stop_bgp_failover_test::de_stop_bgp_failover_test(_response_body, output)
            .map_err(crate::operation::stop_bgp_failover_test::StopBgpFailoverTestError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "virtualInterfaceTest" => {
                    builder = builder.set_virtual_interface_test(
                        crate::protocol_serde::shape_virtual_interface_test_history::de_virtual_interface_test_history(tokens, _value, depth + 1)?,
                    );
                }
