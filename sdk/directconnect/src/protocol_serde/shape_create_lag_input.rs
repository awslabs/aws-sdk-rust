...
pub fn ser_create_lag_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLagInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
