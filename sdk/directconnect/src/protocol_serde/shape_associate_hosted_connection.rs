...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_hosted_connection::AssociateHostedConnectionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::associate_hosted_connection::AssociateHostedConnectionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DirectConnectClientException" => {
            crate::operation::associate_hosted_connection::AssociateHostedConnectionError::DirectConnectClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DirectConnectServerException" => {
            crate::operation::associate_hosted_connection::AssociateHostedConnectionError::DirectConnectServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_hosted_connection::de_associate_hosted_connection(_response_body, output)
            .map_err(crate::operation::associate_hosted_connection::AssociateHostedConnectionError::unhandled)?;
...
pub fn ser_associate_hosted_connection_input(
    ...
    crate::protocol_serde::shape_associate_hosted_connection_input::ser_associate_hosted_connection_input_input(&mut object, input)?;
    object.finish();
