...
pub fn ser_new_transit_virtual_interface(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NewTransitVirtualInterface) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
