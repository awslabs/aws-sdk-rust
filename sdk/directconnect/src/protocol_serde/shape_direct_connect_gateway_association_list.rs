...
pub(crate) fn de_direct_connect_gateway_association_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DirectConnectGatewayAssociation>>, aws_smithy_json::deserialize::error::DeserializeError>
