...
pub(crate) fn de_direct_connect_gateway_association<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DirectConnectGatewayAssociation>, aws_smithy_json::deserialize::error::DeserializeError>
