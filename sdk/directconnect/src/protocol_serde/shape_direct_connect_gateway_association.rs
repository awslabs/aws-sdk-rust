...
) -> Result<Option<crate::types::DirectConnectGatewayAssociation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "associatedGateway" => {
                            builder = builder.set_associated_gateway(crate::protocol_serde::shape_associated_gateway::de_associated_gateway(tokens)?);
                        }
                        "associationId" => {
