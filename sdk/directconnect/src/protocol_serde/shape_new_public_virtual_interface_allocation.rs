...
pub fn ser_new_public_virtual_interface_allocation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::NewPublicVirtualInterfaceAllocation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
