...
pub(crate) fn de_location_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Location>>, ::aws_smithy_json::deserialize::error::DeserializeError>
