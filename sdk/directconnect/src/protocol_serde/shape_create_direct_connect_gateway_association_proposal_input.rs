...
pub fn ser_create_direct_connect_gateway_association_proposal_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDirectConnectGatewayAssociationProposalInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
