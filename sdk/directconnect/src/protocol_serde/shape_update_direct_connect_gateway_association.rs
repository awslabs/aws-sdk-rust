...
pub fn ser_update_direct_connect_gateway_association_input(
    ...
    crate::protocol_serde::shape_update_direct_connect_gateway_association_input::ser_update_direct_connect_gateway_association_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_direct_connect_gateway_association_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
