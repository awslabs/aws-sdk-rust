...
pub fn ser_allocate_connection_on_interconnect_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AllocateConnectionOnInterconnectInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
