...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
                    aws_http::user_agent::ApiMetadata::new("licensemanagerusersubscriptions", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS License Manager User Subscriptions.
pub mod client;
