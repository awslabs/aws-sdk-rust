...
impl Builder {
    ...
    /// use aws_sdk_licensemanagerusersubscriptions::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    pub fn build(mut self) -> Config {
        ...
        let retry_partition = layer
            ...
            .cloned()
            .unwrap_or_else(|| ::aws_smithy_runtime::client::retries::RetryPartition::new("licensemanagerusersubscriptions"));
        ...
        layer.store_put(::aws_types::SigningService::from_static("license-manager-user-subscriptions"));
        layer
