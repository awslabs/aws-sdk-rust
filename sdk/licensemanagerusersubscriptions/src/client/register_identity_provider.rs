...
impl super::Client {
    ...
    ///   - [`identity_provider(IdentityProvider)`](crate::operation::register_identity_provider::builders::RegisterIdentityProviderFluentBuilder::identity_provider) / [`set_identity_provider(Option<IdentityProvider>)`](crate::operation::register_identity_provider::builders::RegisterIdentityProviderFluentBuilder::set_identity_provider):<br>required: **true**<br><p>An object that specifies details for the identity provider.</p><br>
    ///   - [`product(impl Into<String>)`](crate::operation::register_identity_provider::builders::RegisterIdentityProviderFluentBuilder::product) / [`set_product(impl Into<String>)`](crate::operation::register_identity_provider::builders::RegisterIdentityProviderFluentBuilder::set_product):<br>required: **true**<br><p>The name of the user-based subscription product.</p><br>
