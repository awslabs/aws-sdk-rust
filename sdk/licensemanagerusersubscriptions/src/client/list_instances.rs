...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::list_instances::builders::ListInstancesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_instances::builders::ListInstancesFluentBuilder::set_filters): <p>An array of structures that you can use to filter the results to those that match one or more sets of key-value pairs that you specify.</p>
