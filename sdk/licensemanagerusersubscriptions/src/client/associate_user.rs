...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_username):<br>required: **true**<br><p>The user name from the identity provider.</p><br>
    ///   - [`instance_id(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_instance_id):<br>required: **true**<br><p>The ID of the EC2 instance that provides the user-based subscription.</p><br>
    ///   - [`identity_provider(IdentityProvider)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::identity_provider) / [`set_identity_provider(Option<IdentityProvider>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_identity_provider):<br>required: **true**<br><p>The identity provider for the user.</p><br>
    ///   - [`domain(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_domain):<br>required: **false**<br><p>The domain name of the Active Directory that contains information for the user to associate.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_tags):<br>required: **false**<br><p>The tags that apply for the user association.</p><br>
