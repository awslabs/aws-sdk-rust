...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::username) / [`set_username(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_username):<br>required: **true**<br><p>The user name from the identity provider for the user.</p><br>
    ///   - [`instance_id(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::instance_id) / [`set_instance_id(impl Into<String>)`](crate::operation::associate_user::builders::AssociateUserFluentBuilder::set_instance_id):<br>required: **true**<br><p>The ID of the EC2 instance, which provides user-based subscriptions.</p><br>
