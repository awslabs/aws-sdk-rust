...
impl super::Client {
    ...
    ///   - [`product(impl Into<String>)`](crate::operation::list_product_subscriptions::builders::ListProductSubscriptionsFluentBuilder::product) / [`set_product(impl Into<String>)`](crate::operation::list_product_subscriptions::builders::ListProductSubscriptionsFluentBuilder::set_product):<br>required: **true**<br><p>The name of the user-based subscription product.</p><br>
