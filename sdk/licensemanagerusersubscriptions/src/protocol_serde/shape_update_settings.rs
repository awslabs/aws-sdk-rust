...
pub fn ser_update_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
