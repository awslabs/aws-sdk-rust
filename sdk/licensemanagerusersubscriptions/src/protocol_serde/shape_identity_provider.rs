...
pub fn ser_identity_provider(object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::IdentityProvider) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::IdentityProvider::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("IdentityProvider"))
    }
    Ok(())
}
