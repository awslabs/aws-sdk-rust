...
pub fn ser_identity_provider(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IdentityProvider) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
