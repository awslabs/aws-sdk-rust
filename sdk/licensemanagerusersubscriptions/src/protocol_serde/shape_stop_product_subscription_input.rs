...
pub fn ser_stop_product_subscription_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopProductSubscriptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
