...
pub fn ser_create_license_server_endpoint_input_input(
    ...
    if let Some(var_2) = &input.license_server_settings {
        #[allow(unused_mut)]
        let mut object_3 = object.key("LicenseServerSettings").start_object();
        crate::protocol_serde::shape_license_server_settings::ser_license_server_settings(&mut object_3, var_2)?;
        object_3.finish();
    }
