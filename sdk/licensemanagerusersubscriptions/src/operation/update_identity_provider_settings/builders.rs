...
impl crate::operation::update_identity_provider_settings::builders::UpdateIdentityProviderSettingsInputBuilder {
...
impl UpdateIdentityProviderSettingsFluentBuilder {
    /// Creates a new `UpdateIdentityProviderSettingsFluentBuilder`.
