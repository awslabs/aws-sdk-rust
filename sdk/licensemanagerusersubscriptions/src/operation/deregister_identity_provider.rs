...
impl DeregisterIdentityProviderInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_identity_provider::DeregisterIdentityProvider::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterIdentityProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_identity_provider::de_deregister_identity_provider_http_response_with_props(status, headers, body)
        }
    }
}
