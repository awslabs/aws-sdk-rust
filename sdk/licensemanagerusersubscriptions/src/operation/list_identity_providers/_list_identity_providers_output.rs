...
impl  ListIdentityProvidersOutput  {
    ...
    pub fn identity_provider_summaries(&self) -> & [crate::types::IdentityProviderSummary] {
        use std::ops::Deref; self.identity_provider_summaries.deref()
    }
    /// <p>Token for the next set of results.</p>
...
impl ListIdentityProvidersOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_identity_providers::ListIdentityProvidersOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_identity_providers::ListIdentityProvidersOutput {
                identity_provider_summaries: self.identity_provider_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("identity_provider_summaries", "identity_provider_summaries was not specified but it is required when building ListIdentityProvidersOutput")
                    )?
                ,
