    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp =
                        crate::operation::list_product_subscriptions::ListProductSubscriptions::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListProductSubscriptionsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_product_subscriptions_output_product_user_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
