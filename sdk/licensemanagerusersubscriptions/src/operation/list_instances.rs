    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                ...
                ::std::write!(output, "/instance/ListInstances").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_instances::ListInstances::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("ListInstances", "licensemanagerusersubscriptions"),
        );
