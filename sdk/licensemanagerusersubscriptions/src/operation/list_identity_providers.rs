...
#[derive(Debug)]
    ...
    ::std::write!(output, "/identity-provider/ListIdentityProviders").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_identity_providers::ser_list_identity_providers_input(&input)?);
