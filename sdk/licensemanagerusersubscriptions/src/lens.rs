...
pub(crate) fn reflens_list_user_associations_output_output_next_token(
...
pub(crate) fn lens_list_identity_providers_output_output_identity_provider_summaries(
    input: crate::operation::list_identity_providers::ListIdentityProvidersOutput,
