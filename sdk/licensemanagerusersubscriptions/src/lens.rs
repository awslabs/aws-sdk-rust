...
pub(crate) fn reflens_structure_crate_output_list_product_subscriptions_output_next_token(
...
pub(crate) fn reflens_structure_crate_output_list_user_associations_output_next_token(
...
pub(crate) fn lens_structure_crate_output_list_identity_providers_output_identity_provider_summaries(
    input: crate::output::ListIdentityProvidersOutput,
...
pub(crate) fn lens_structure_crate_output_list_instances_output_instance_summaries(
    input: crate::output::ListInstancesOutput,
...
pub(crate) fn lens_structure_crate_output_list_product_subscriptions_output_product_user_summaries(
    input: crate::output::ListProductSubscriptionsOutput,
...
pub(crate) fn lens_structure_crate_output_list_user_associations_output_instance_user_summaries(
    input: crate::output::ListUserAssociationsOutput,
