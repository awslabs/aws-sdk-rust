...
impl UpdateJobExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_job_execution::ser_update_job_execution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_job_execution::de_update_job_execution_http_response_with_props(status, headers, body)
        }
    }
}
