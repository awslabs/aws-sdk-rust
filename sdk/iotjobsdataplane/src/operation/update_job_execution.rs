...
impl UpdateJobExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_job_execution::ser_update_job_execution_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_job_execution::UpdateJobExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_job_execution::de_update_job_execution_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_job_execution::UpdateJobExecutionError
{
