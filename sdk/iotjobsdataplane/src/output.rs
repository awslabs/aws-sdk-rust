...
pub struct UpdateJobExecutionOutput  {
    ...
    #[doc(hidden)]pub execution_state: std::option::Option<crate::model::JobExecutionState>,
...
pub struct GetPendingJobExecutionsOutput  {
    ...
    #[doc(hidden)]pub in_progress_jobs: std::option::Option<std::vec::Vec<crate::model::JobExecutionSummary>>,
    /// <p>A list of JobExecutionSummary objects with status QUEUED.</p>
    #[doc(hidden)]pub queued_jobs: std::option::Option<std::vec::Vec<crate::model::JobExecutionSummary>>,
}
