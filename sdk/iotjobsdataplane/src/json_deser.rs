...
pub(crate) fn deser_operation_crate_operation_update_job_execution(
    ...
    crate::output::update_job_execution_output::Builder,
    aws_smithy_json::deserialize::error::DeserializeError,
> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value))
...
) -> Result<Option<crate::model::JobExecution>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
...
pub(crate) fn deser_structure_crate_model_job_execution_state<'a, I>(
    ...
    Option<crate::model::JobExecutionState>,
    aws_smithy_json::deserialize::error::DeserializeError,
>
where
    I: Iterator<
...
pub(crate) fn deser_structure_crate_model_job_execution_summary<'a, I>(
    ...
    Option<crate::model::JobExecutionSummary>,
    aws_smithy_json::deserialize::error::DeserializeError,
>
where
    I: Iterator<
