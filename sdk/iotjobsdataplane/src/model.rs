...
pub struct JobExecution  {
    ...
    #[doc(hidden)]pub job_document: std::option::Option<std::string::String>,
}
impl JobExecution {
    /// <p>The unique identifier you assigned to this job when it was created.</p>
...
impl  std::fmt::Debug for JobExecution  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("approximate_seconds_before_timed_out", &self.approximate_seconds_before_timed_out);
        formatter.field("version_number", &self.version_number);
