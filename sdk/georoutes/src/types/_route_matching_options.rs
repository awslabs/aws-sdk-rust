...
pub struct RouteMatchingOptions {
...
impl ::std::fmt::Debug for RouteMatchingOptions {
...
impl RouteMatchingOptions {
    /// Creates a new builder-style object to manufacture [`RouteMatchingOptions`](crate::types::RouteMatchingOptions).
    pub fn builder() -> crate::types::builders::RouteMatchingOptionsBuilder {
        crate::types::builders::RouteMatchingOptionsBuilder::default()
    }
}

/// A builder for [`RouteMatchingOptions`](crate::types::RouteMatchingOptions).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct RouteMatchingOptionsBuilder {
...
impl RouteMatchingOptionsBuilder {
    /// <p>Attempts to match the provided position to a road similar to the provided name.</p>
    ...
    /// Consumes the builder and constructs a [`RouteMatchingOptions`](crate::types::RouteMatchingOptions).
    pub fn build(self) -> crate::types::RouteMatchingOptions {
        crate::types::RouteMatchingOptions {
...
impl ::std::fmt::Debug for RouteMatchingOptionsBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
