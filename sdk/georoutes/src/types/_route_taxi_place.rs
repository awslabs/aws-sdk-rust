...
pub struct RouteTaxiPlace {
    ...
    pub r#type: ::std::option::Option<crate::types::RouteTaxiPlaceType>,
...
impl RouteTaxiPlace {
    ...
    /// <p>The type of the place.</p>
    pub fn r#type(&self) -> ::std::option::Option<&crate::types::RouteTaxiPlaceType> {
        self.r#type.as_ref()
    }
    /// <p>Index of the waypoint in the request.</p>
...
impl ::std::fmt::Debug for RouteTaxiPlace {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("RouteTaxiPlace");
...
impl RouteTaxiPlace {
    /// Creates a new builder-style object to manufacture [`RouteTaxiPlace`](crate::types::RouteTaxiPlace).
    pub fn builder() -> crate::types::builders::RouteTaxiPlaceBuilder {
        crate::types::builders::RouteTaxiPlaceBuilder::default()
    }
}

/// A builder for [`RouteTaxiPlace`](crate::types::RouteTaxiPlace).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct RouteTaxiPlaceBuilder {
    ...
    pub(crate) r#type: ::std::option::Option<crate::types::RouteTaxiPlaceType>,
    pub(crate) waypoint_index: ::std::option::Option<i32>,
}
impl RouteTaxiPlaceBuilder {
    /// <p>Details of the access point.</p>
    ...
    /// <p>The type of the place.</p>
    pub fn r#type(mut self, input: crate::types::RouteTaxiPlaceType) -> Self {
        self.r#type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of the place.</p>
    pub fn set_type(mut self, input: ::std::option::Option<crate::types::RouteTaxiPlaceType>) -> Self {
        self.r#type = input;
        self
    }
    /// <p>The type of the place.</p>
    pub fn get_type(&self) -> &::std::option::Option<crate::types::RouteTaxiPlaceType> {
        &self.r#type
    }
    /// <p>Index of the waypoint in the request.</p>
    ...
    /// Consumes the builder and constructs a [`RouteTaxiPlace`](crate::types::RouteTaxiPlace).
    /// This method will fail if any of the following fields are not set:
    /// - [`position`](crate::types::builders::RouteTaxiPlaceBuilder::position)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteTaxiPlace, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteTaxiPlace {
            ...
            position: self.position.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "position",
                    "position was not specified but it is required when building RouteTaxiPlace",
                )
            })?,
...
impl ::std::fmt::Debug for RouteTaxiPlaceBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("RouteTaxiPlaceBuilder");
        formatter.field("access_point_details", &self.access_point_details);
        formatter.field("name", &"*** Sensitive Data Redacted ***");
        formatter.field("original_position", &"*** Sensitive Data Redacted ***");
        formatter.field("position", &"*** Sensitive Data Redacted ***");
