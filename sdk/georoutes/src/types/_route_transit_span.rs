...
impl ::std::fmt::Debug for RouteTransitSpan {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("RouteTransitSpan");
...
impl RouteTransitSpan {
    /// Creates a new builder-style object to manufacture [`RouteTransitSpan`](crate::types::RouteTransitSpan).
    pub fn builder() -> crate::types::builders::RouteTransitSpanBuilder {
        crate::types::builders::RouteTransitSpanBuilder::default()
    }
}

/// A builder for [`RouteTransitSpan`](crate::types::RouteTransitSpan).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct RouteTransitSpanBuilder {
...
impl RouteTransitSpanBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteTransitSpan`](crate::types::RouteTransitSpan).
    pub fn build(self) -> crate::types::RouteTransitSpan {
        crate::types::RouteTransitSpan {
...
impl ::std::fmt::Debug for RouteTransitSpanBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("RouteTransitSpanBuilder");
        formatter.field("country", &"*** Sensitive Data Redacted ***");
        formatter.field("distance", &"*** Sensitive Data Redacted ***");
        formatter.field("duration", &"*** Sensitive Data Redacted ***");
        formatter.field("geometry_offset", &self.geometry_offset);
