...
) -> Result<Option<crate::types::RoutePedestrianSpan>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PedestrianAccess" => {
                            builder = builder.set_pedestrian_access(
                                    crate::protocol_serde::shape_route_span_pedestrian_access_attribute_list::de_route_span_pedestrian_access_attribute_list(tokens)?
                                );
                        }
                        "Region" => {
