...
pub(crate) fn de_circle<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::Circle>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Center" => {
                            builder = builder.set_center(crate::protocol_serde::shape_position::de_position(tokens, _value, depth + 1)?);
                        }
                        "Radius" => {
                            builder = builder
