...
pub fn ser_route_truck_options(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::RouteTruckOptions,
    ...
    if let Some(var_6) = &input.license_plate {
        ...
        crate::protocol_serde::shape_route_vehicle_license_plate::ser_route_vehicle_license_plate(&mut object_7, var_6)?;
        object_7.finish();
    }
    ...
    if let Some(var_11) = &input.trailer {
        ...
        crate::protocol_serde::shape_route_trailer_options::ser_route_trailer_options(&mut object_12, var_11)?;
        object_12.finish();
    }
