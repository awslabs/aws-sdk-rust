...
/// For example, the [`AssociateServiceRoleToAccount`](crate::operation) operation has
...
mod batch_associate_client_device_with_core_device;

mod batch_disassociate_client_device_from_core_device;

mod cancel_deployment;

mod create_component_version;

mod create_deployment;

mod delete_component;

mod delete_core_device;
...
mod get_component_version_artifact;
...
mod list_client_devices_associated_with_core_device;

mod list_component_versions;

mod list_components;

mod list_core_devices;

mod list_deployments;

mod list_effective_deployments;

mod list_installed_components;

mod list_tags_for_resource;

mod resolve_component_candidates;
