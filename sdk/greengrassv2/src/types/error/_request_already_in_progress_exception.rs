...
impl ::aws_http::request_id::RequestId for crate::types::error::RequestAlreadyInProgressException {
...
impl RequestAlreadyInProgressExceptionBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::error::RequestAlreadyInProgressException, ::aws_smithy_http::operation::error::BuildError> {
