...
if (*use_fips) == (true) {
                                ...
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://greengrass.us-gov-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-gov-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://greengrass.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
...
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "greengrass"
    .to_string().into());
    out.insert("signingRegion".to_string(), "us-gov-east-1"
    .to_string().into());
    out
}),])
.build());
