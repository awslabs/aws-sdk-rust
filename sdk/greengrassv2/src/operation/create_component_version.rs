    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/greengrass/v2/createComponentVersion")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_component_version::CreateComponentVersion::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_component_version::CreateComponentVersionError
{
