    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/greengrass/v2/components")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_components::ListComponents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListComponents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_components::de_list_components_http_error(
                status, headers, body,
            )
        } else {
