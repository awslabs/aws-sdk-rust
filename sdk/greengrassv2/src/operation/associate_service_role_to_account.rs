...
impl AssociateServiceRoleToAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_service_role_to_account::AssociateServiceRoleToAccount,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_service_role_to_account::AssociateServiceRoleToAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateServiceRoleToAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_service_role_to_account::de_associate_service_role_to_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
