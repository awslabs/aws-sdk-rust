...
pub struct ListComponentsOutput  {
    ...
    #[doc(hidden)]
    pub components: std::option::Option<std::vec::Vec<crate::types::Component>>,
...
impl ListComponentsOutput {
    /// <p>A list that summarizes each component.</p>
    pub fn components(&self) -> std::option::Option<& [crate::types::Component]> {
...
impl ListComponentsOutputBuilder {
    ...
    ///
    /// <p>A list that summarizes each component.</p>
    pub fn components(mut self, input: crate::types::Component) -> Self {
