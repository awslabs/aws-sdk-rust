...
impl ResolveComponentCandidatesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::resolve_component_candidates::ResolveComponentCandidates::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveComponentCandidates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resolve_component_candidates::de_resolve_component_candidates_http_response_with_props(status, headers, body)
        }
    }
}
