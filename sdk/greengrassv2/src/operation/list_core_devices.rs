    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/greengrass/v2/coreDevices")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_core_devices::ListCoreDevices::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_core_devices::ListCoreDevicesError
{
