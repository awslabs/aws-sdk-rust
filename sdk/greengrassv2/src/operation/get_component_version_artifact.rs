...
impl GetComponentVersionArtifactInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_component_version_artifact::GetComponentVersionArtifact,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_component_version_artifact::GetComponentVersionArtifact::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComponentVersionArtifact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_component_version_artifact::de_get_component_version_artifact_http_response_with_props(
                status, headers, body,
            )
        }
    }
