    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let artifact_name = ::aws_smithy_http::label::fmt_string(
                    input_2,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComponentVersionArtifact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_component_version_artifact::de_get_component_version_artifact_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetComponentVersionArtifactError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_component_version_artifact::GetComponentVersionArtifactError
{
