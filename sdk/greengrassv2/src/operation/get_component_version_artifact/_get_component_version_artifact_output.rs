...
impl  GetComponentVersionArtifactOutput  {
    ...
    pub fn pre_signed_url(&self) -> & str {
        use std::ops::Deref; self.pre_signed_url.deref()
    }
}
...
impl GetComponentVersionArtifactOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_component_version_artifact::GetComponentVersionArtifactOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_component_version_artifact::GetComponentVersionArtifactOutput {
                pre_signed_url: self.pre_signed_url
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pre_signed_url", "pre_signed_url was not specified but it is required when building GetComponentVersionArtifactOutput")
                    )?
                ,
