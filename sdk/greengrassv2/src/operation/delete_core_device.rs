...
impl DeleteCoreDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_core_device::DeleteCoreDevice,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCoreDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_core_device::de_delete_core_device_http_response_with_props(status, headers, body)
        }
    }
}
