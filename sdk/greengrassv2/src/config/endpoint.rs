...
mod test {
    ...
    fn test_20() {
        let params = crate::config::endpoint::Params::builder()
            .region("dataplane-us-gov-east-1".to_string())
            .use_fips(false)
            .use_dual_stack(false)
            .build()
            .expect("invalid params");
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://greengrass-ats.iot.us-gov-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                ...
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4", 2)
                        .put("signingName", "greengrass".to_string())
    ...
    fn test_21() {
        let params = crate::config::endpoint::Params::builder()
            .region("dataplane-us-gov-west-1".to_string())
            .use_fips(false)
            .use_dual_stack(false)
            .build()
            .expect("invalid params");
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://greengrass-ats.iot.us-gov-west-1.amazonaws.com");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
...
/// Endpoint resolver trait specific to AWS IoT Greengrass V2
                            ...
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                ...
                                .auth_scheme(
                                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4".to_string(), 2)
                                        .put("signingName", "greengrass")
                                        .put("signingRegion", "us-gov-east-1"),
                                )
                                .build(),
                        ),
                ...
                ref_val => {
                    ...
                    let condition_result = match node.condition_index {
                        ...
                        9 => (|_diagnostic_collector: &mut crate::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            let partition_resolver = &self.partition_resolver;
                            (region) == &mut Some(("dataplane-us-gov-east-1".to_string().into()))
                        })(&mut _diagnostic_collector),
                        10 => (|_diagnostic_collector: &mut crate::endpoint_lib::diagnostic::DiagnosticCollector| -> bool {
                            let partition_resolver = &self.partition_resolver;
                            (region) == &mut Some(("dataplane-us-gov-west-1".to_string().into()))
                        })(&mut _diagnostic_collector),
