...
/// Paginator for [`ListClientDevicesAssociatedWithCoreDevice`](crate::operation::ListClientDevicesAssociatedWithCoreDevice)
            ...
            impl ListClientDevicesAssociatedWithCoreDevicePaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_client_devices_associated_with_core_device_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                /// Create a flattened paginator
                    ...
                    pub fn items(self) -> crate::paginator::ListClientDevicesAssociatedWithCoreDevicePaginatorItems {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListClientDevicesAssociatedWithCoreDeviceOutput, aws_smithy_http::result::SdkError<crate::error::ListClientDevicesAssociatedWithCoreDeviceError>>> + Unpin
                 {
...
/// Paginator for [`ListComponentVersions`](crate::operation::ListComponentVersions)
            ...
            impl ListComponentVersionsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_component_versions_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListComponentVersionsOutput, aws_smithy_http::result::SdkError<crate::error::ListComponentVersionsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListCoreDevices`](crate::operation::ListCoreDevices)
            ...
            impl ListCoreDevicesPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_core_devices_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListCoreDevicesOutput, aws_smithy_http::result::SdkError<crate::error::ListCoreDevicesError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListEffectiveDeployments`](crate::operation::ListEffectiveDeployments)
            ...
            impl ListEffectiveDeploymentsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_effective_deployments_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListEffectiveDeploymentsOutput, aws_smithy_http::result::SdkError<crate::error::ListEffectiveDeploymentsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListInstalledComponents`](crate::operation::ListInstalledComponents)
            ...
            impl ListInstalledComponentsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_installed_components_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListInstalledComponentsOutput, aws_smithy_http::result::SdkError<crate::error::ListInstalledComponentsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `ListClientDevicesAssociatedWithCoreDevicePaginator`
                ...
                impl  ListClientDevicesAssociatedWithCoreDevicePaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::AssociatedClientDevice, aws_smithy_http::result::SdkError<crate::error::ListClientDevicesAssociatedWithCoreDeviceError>>> + Unpin
                     {
...
/// Flattened paginator for `ListComponentsPaginator`
                ...
                impl  ListComponentsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Component, aws_smithy_http::result::SdkError<crate::error::ListComponentsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListComponentVersionsPaginator`
                ...
                impl  ListComponentVersionsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ComponentVersionListItem, aws_smithy_http::result::SdkError<crate::error::ListComponentVersionsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListCoreDevicesPaginator`
                ...
                impl  ListCoreDevicesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::CoreDevice, aws_smithy_http::result::SdkError<crate::error::ListCoreDevicesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_core_devices_output_core_devices(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListDeploymentsPaginator`
                ...
                impl  ListDeploymentsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Deployment, aws_smithy_http::result::SdkError<crate::error::ListDeploymentsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListEffectiveDeploymentsPaginator`
                ...
                impl  ListEffectiveDeploymentsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::EffectiveDeployment, aws_smithy_http::result::SdkError<crate::error::ListEffectiveDeploymentsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListInstalledComponentsPaginator`
                ...
                impl  ListInstalledComponentsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::InstalledComponent, aws_smithy_http::result::SdkError<crate::error::ListInstalledComponentsError>>> + Unpin
                     {
