...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::list_component_versions::builders::ListComponentVersionsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::list_component_versions::builders::ListComponentVersionsFluentBuilder::set_arn): <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">ARN</a> of the component.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_component_versions::builders::ListComponentVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_component_versions::builders::ListComponentVersionsFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
