...
impl super::Client {
    ...
    ///   - [`core_device_thing_name(impl ::std::convert::Into<String>)`](crate::operation::delete_core_device::builders::DeleteCoreDeviceFluentBuilder::core_device_thing_name) / [`set_core_device_thing_name(Option<String>)`](crate::operation::delete_core_device::builders::DeleteCoreDeviceFluentBuilder::set_core_device_thing_name): <p>The name of the core device. This is also the name of the IoT thing.</p>
    ...
    pub fn delete_core_device(
        &self,
    ) -> crate::operation::delete_core_device::builders::DeleteCoreDeviceFluentBuilder {
        crate::operation::delete_core_device::builders::DeleteCoreDeviceFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
