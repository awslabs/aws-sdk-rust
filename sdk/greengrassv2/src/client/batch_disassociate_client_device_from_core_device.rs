...
impl super::Client {
    ...
    ///   - [`core_device_thing_name(impl ::std::convert::Into<String>)`](crate::operation::batch_disassociate_client_device_from_core_device::builders::BatchDisassociateClientDeviceFromCoreDeviceFluentBuilder::core_device_thing_name) / [`set_core_device_thing_name(Option<String>)`](crate::operation::batch_disassociate_client_device_from_core_device::builders::BatchDisassociateClientDeviceFromCoreDeviceFluentBuilder::set_core_device_thing_name): <p>The name of the core device. This is also the name of the IoT thing.</p>
