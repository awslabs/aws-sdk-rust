...
impl super::Client {
    ...
    ///   - [`component_name(Option<String>)`](crate::operation::create_component_version::CreateComponentVersionOutput::component_name): <p>The name of the component.</p>
    ///   - [`component_version(Option<String>)`](crate::operation::create_component_version::CreateComponentVersionOutput::component_version): <p>The version of the component.</p>
