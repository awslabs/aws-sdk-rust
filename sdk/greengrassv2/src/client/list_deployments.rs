...
impl super::Client {
    ...
    ///   - [`target_arn(impl ::std::convert::Into<String>)`](crate::operation::list_deployments::builders::ListDeploymentsFluentBuilder::target_arn) / [`set_target_arn(Option<String>)`](crate::operation::list_deployments::builders::ListDeploymentsFluentBuilder::set_target_arn): <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">ARN</a> of the target IoT thing or thing group.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_deployments::builders::ListDeploymentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_deployments::builders::ListDeploymentsFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
