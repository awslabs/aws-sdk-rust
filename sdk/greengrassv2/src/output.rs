...
pub struct ResolveComponentCandidatesOutput  {
    ...
    #[doc(hidden)]pub resolved_component_versions: std::option::Option<std::vec::Vec<crate::model::ResolvedComponentVersion>>,
}
...
impl  std::fmt::Debug for ResolveComponentCandidatesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("resolved_component_versions", &self.resolved_component_versions);
        formatter.finish()
    }
}
...
pub struct ListInstalledComponentsOutput  {
    ...
    /// </note>
    #[doc(hidden)]pub installed_components: std::option::Option<std::vec::Vec<crate::model::InstalledComponent>>,
...
pub struct ListEffectiveDeploymentsOutput  {
    ...
    #[doc(hidden)]pub effective_deployments: std::option::Option<std::vec::Vec<crate::model::EffectiveDeployment>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListCoreDevicesOutput  {
    ...
    #[doc(hidden)]pub core_devices: std::option::Option<std::vec::Vec<crate::model::CoreDevice>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListComponentVersionsOutput  {
    ...
    #[doc(hidden)]pub component_versions: std::option::Option<std::vec::Vec<crate::model::ComponentVersionListItem>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListComponentsOutput  {
    ...
    #[doc(hidden)]pub components: std::option::Option<std::vec::Vec<crate::model::Component>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListClientDevicesAssociatedWithCoreDeviceOutput  {
    ...
    #[doc(hidden)]pub associated_client_devices: std::option::Option<std::vec::Vec<crate::model::AssociatedClientDevice>>,
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetDeploymentOutput  {
    ...
    #[doc(hidden)]pub is_latest_for_target: bool,
    /// <p>A list of key-value pairs that contain metadata for the resource. For more information, see <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/tag-resources.html">Tag your resources</a> in the <i>IoT Greengrass V2 Developer Guide</i>.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct GetCoreDeviceOutput  {
    ...
    #[doc(hidden)]pub core_version: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_status_update_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A list of key-value pairs that contain metadata for the resource. For more information, see <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/tag-resources.html">Tag your resources</a> in the <i>IoT Greengrass V2 Developer Guide</i>.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
impl  std::fmt::Debug for GetCoreDeviceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_status_update_timestamp", &self.last_status_update_timestamp);
        formatter.field("tags", &self.tags);
        formatter.finish()
    }
}
...
pub struct GetComponentOutput  {
    ...
    #[doc(hidden)]pub recipe: std::option::Option<aws_smithy_types::Blob>,
    /// <p>A list of key-value pairs that contain metadata for the resource. For more information, see <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/tag-resources.html">Tag your resources</a> in the <i>IoT Greengrass V2 Developer Guide</i>.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct DescribeComponentOutput  {
    ...
    #[doc(hidden)]pub component_version: std::option::Option<std::string::String>,
    /// <p>The time at which the component was created, expressed in ISO 8601 format.</p>
    #[doc(hidden)]pub creation_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The publisher of the component version.</p>
    #[doc(hidden)]pub publisher: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::CloudComponentStatus>,
    /// <p>The platforms that the component version supports.</p>
    #[doc(hidden)]pub platforms: std::option::Option<std::vec::Vec<crate::model::ComponentPlatform>>,
    /// <p>A list of key-value pairs that contain metadata for the resource. For more information, see <a href="https://docs.aws.amazon.com/greengrass/v2/developerguide/tag-resources.html">Tag your resources</a> in the <i>IoT Greengrass V2 Developer Guide</i>.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct BatchDisassociateClientDeviceFromCoreDeviceOutput  {
    ...
    #[doc(hidden)]pub error_entries: std::option::Option<std::vec::Vec<crate::model::DisassociateClientDeviceFromCoreDeviceErrorEntry>>,
}
...
pub struct BatchAssociateClientDeviceWithCoreDeviceOutput  {
    ...
    #[doc(hidden)]pub error_entries: std::option::Option<std::vec::Vec<crate::model::AssociateClientDeviceWithCoreDeviceErrorEntry>>,
}
