...
pub fn ser_lambda_container_params(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaContainerParams) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
