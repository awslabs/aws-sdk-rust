...
pub(crate) fn de_io_t_job_rate_increase_criteria<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::IoTJobRateIncreaseCriteria>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
