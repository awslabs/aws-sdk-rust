...
pub fn ser_create_deployment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDeploymentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
