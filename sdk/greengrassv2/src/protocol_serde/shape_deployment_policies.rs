...
pub fn ser_deployment_policies(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeploymentPolicies) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_deployment_policies<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeploymentPolicies>, aws_smithy_json::deserialize::error::DeserializeError>
