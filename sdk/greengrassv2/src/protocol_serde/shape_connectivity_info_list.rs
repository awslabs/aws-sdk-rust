...
pub(crate) fn de_connectivity_info_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::ConnectivityInfo>>, aws_smithy_json::deserialize::error::DeserializeError>
