...
pub fn ser_io_t_job_exponential_rollout_rate(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IoTJobExponentialRolloutRate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
...
pub(crate) fn de_io_t_job_exponential_rollout_rate<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IoTJobExponentialRolloutRate>, aws_smithy_json::deserialize::error::DeserializeError>
