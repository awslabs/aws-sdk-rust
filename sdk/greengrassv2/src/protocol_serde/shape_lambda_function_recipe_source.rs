...
pub fn ser_lambda_function_recipe_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaFunctionRecipeSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
