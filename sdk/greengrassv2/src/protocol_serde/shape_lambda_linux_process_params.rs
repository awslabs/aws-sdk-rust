...
pub fn ser_lambda_linux_process_params(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaLinuxProcessParams) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
