...
pub fn ser_lambda_volume_mount(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaVolumeMount) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
