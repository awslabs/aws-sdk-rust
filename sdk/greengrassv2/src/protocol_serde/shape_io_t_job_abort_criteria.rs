...
pub fn ser_io_t_job_abort_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IoTJobAbortCriteria) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_io_t_job_abort_criteria<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IoTJobAbortCriteria>, aws_smithy_json::deserialize::error::DeserializeError>
