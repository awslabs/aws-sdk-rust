...
pub struct AccessPoliciesStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<std::string::String>,
    /// <p>The status of domain configuration option.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OptionStatus>,
}
...
pub struct OptionStatus  {
    ...
    #[doc(hidden)]pub update_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A unique integer that indicates when this option was last updated.</p>
    #[doc(hidden)]pub update_version: i32,
    ...
    /// </ul>
    #[doc(hidden)]pub state: std::option::Option<crate::model::OptionState>,
    /// <p>Indicates that the option will be deleted once processing is complete.</p>
    #[doc(hidden)]pub pending_deletion: std::option::Option<bool>,
}
impl OptionStatus {
    /// <p>A timestamp for when this option was created.</p>
...
pub struct ScalingParametersStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::ScalingParameters>,
    /// <p>The status of domain configuration option.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OptionStatus>,
}
...
pub struct ScalingParameters  {
    ...
    #[doc(hidden)]pub desired_instance_type: std::option::Option<crate::model::PartitionInstanceType>,
    /// <p>The number of replicas you want to preconfigure for each index partition.</p>
    #[doc(hidden)]pub desired_replication_count: i32,
    ...
    #[doc(hidden)]pub desired_partition_count: i32,
}
...
pub struct DomainEndpointOptionsStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::DomainEndpointOptions>,
...
pub struct DomainEndpointOptions  {
    ...
    #[doc(hidden)]pub enforce_https: std::option::Option<bool>,
    /// <p>The minimum required TLS version</p>
    #[doc(hidden)]pub tls_security_policy: std::option::Option<crate::model::TlsSecurityPolicy>,
}
...
pub struct SuggesterStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::Suggester>,
    /// <p>The status of domain configuration option.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OptionStatus>,
}
...
pub struct Suggester  {
    ...
    #[doc(hidden)]pub document_suggester_options: std::option::Option<crate::model::DocumentSuggesterOptions>,
}
impl Suggester {
    /// <p>Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).</p>
...
impl  std::fmt::Debug for Suggester  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("document_suggester_options", &self.document_suggester_options);
        formatter.finish()
    }
}
...
pub struct DocumentSuggesterOptions  {
    ...
    #[doc(hidden)]pub source_field: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub fuzzy_matching: std::option::Option<crate::model::SuggesterFuzzyMatching>,
    ...
    #[doc(hidden)]pub sort_expression: std::option::Option<std::string::String>,
}
...
pub struct IndexFieldStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::IndexField>,
    /// <p>The status of domain configuration option.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OptionStatus>,
}
...
pub struct IndexField  {
    ...
    #[doc(hidden)]pub index_field_type: std::option::Option<crate::model::IndexFieldType>,
    ...
    #[doc(hidden)]pub int_options: std::option::Option<crate::model::IntOptions>,
    ...
    #[doc(hidden)]pub double_options: std::option::Option<crate::model::DoubleOptions>,
    ...
    #[doc(hidden)]pub literal_options: std::option::Option<crate::model::LiteralOptions>,
    ...
    #[doc(hidden)]pub text_options: std::option::Option<crate::model::TextOptions>,
    ...
    #[doc(hidden)]pub date_options: std::option::Option<crate::model::DateOptions>,
    ...
    #[doc(hidden)]pub lat_lon_options: std::option::Option<crate::model::LatLonOptions>,
    ...
    #[doc(hidden)]pub int_array_options: std::option::Option<crate::model::IntArrayOptions>,
    ...
    #[doc(hidden)]pub double_array_options: std::option::Option<crate::model::DoubleArrayOptions>,
    ...
    #[doc(hidden)]pub literal_array_options: std::option::Option<crate::model::LiteralArrayOptions>,
    ...
    #[doc(hidden)]pub text_array_options: std::option::Option<crate::model::TextArrayOptions>,
    ...
    #[doc(hidden)]pub date_array_options: std::option::Option<crate::model::DateArrayOptions>,
}
impl IndexField {
    /// <p>A string that represents the name of an index field. CloudSearch supports regular index fields as well as dynamic fields. A dynamic field's name defines a pattern that begins or ends with a wildcard. Any document fields that don't map to a regular index field but do match a dynamic field's pattern are configured with the dynamic field's indexing options. </p> 
    /// <p>Regular field names begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore). Dynamic field names must begin or end with a wildcard (*). The wildcard can also be the only character in a dynamic field name. Multiple wildcards, and wildcards embedded within a string are not supported. </p> 
...
pub struct DateArrayOptions  {
    ...
    #[doc(hidden)]pub source_fields: std::option::Option<std::string::String>,
    /// <p>Whether facet information can be returned for the field.</p>
    #[doc(hidden)]pub facet_enabled: std::option::Option<bool>,
    /// <p>Whether the contents of the field are searchable.</p>
    #[doc(hidden)]pub search_enabled: std::option::Option<bool>,
    /// <p>Whether the contents of the field can be returned in the search results.</p>
    #[doc(hidden)]pub return_enabled: std::option::Option<bool>,
}
...
pub struct TextArrayOptions  {
    ...
    #[doc(hidden)]pub highlight_enabled: std::option::Option<bool>,
    /// <p>The name of an analysis scheme for a <code>text-array</code> field.</p>
    #[doc(hidden)]pub analysis_scheme: std::option::Option<std::string::String>,
}
...
pub struct DoubleArrayOptions  {
    /// A value to use for the field if the field isn't specified for a document.
    #[doc(hidden)]pub default_value: std::option::Option<f64>,
    /// <p>A list of source fields to map to the field. </p>
    #[doc(hidden)]pub source_fields: std::option::Option<std::string::String>,
    /// <p>Whether facet information can be returned for the field.</p>
    #[doc(hidden)]pub facet_enabled: std::option::Option<bool>,
...
pub struct IntArrayOptions  {
    /// A value to use for the field if the field isn't specified for a document.
    #[doc(hidden)]pub default_value: std::option::Option<i64>,
    /// <p>A list of source fields to map to the field. </p>
    #[doc(hidden)]pub source_fields: std::option::Option<std::string::String>,
    /// <p>Whether facet information can be returned for the field.</p>
    #[doc(hidden)]pub facet_enabled: std::option::Option<bool>,
...
pub struct LatLonOptions  {
    ...
    #[doc(hidden)]pub sort_enabled: std::option::Option<bool>,
}
impl LatLonOptions {
    /// A value to use for the field if the field isn't specified for a document.
    pub fn default_value(&self) -> std::option::Option<& str> {
...
pub struct ExpressionStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::Expression>,
    /// <p>The status of domain configuration option.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OptionStatus>,
}
...
pub struct Expression  {
    ...
    #[doc(hidden)]pub expression_value: std::option::Option<std::string::String>,
}
impl Expression {
    /// <p>Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).</p>
...
pub struct DomainStatus  {
    ...
    #[doc(hidden)]pub created: std::option::Option<bool>,
...
pub struct Limits  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub maximum_replication_count: i32,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub maximum_partition_count: i32,
}
impl Limits {
    #[allow(missing_docs)] // documentation missing in model
...
pub struct AnalysisSchemeStatus  {
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::AnalysisScheme>,
    /// <p>The status of domain configuration option.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OptionStatus>,
}
...
pub struct AnalysisScheme  {
    ...
    #[doc(hidden)]pub analysis_scheme_language: std::option::Option<crate::model::AnalysisSchemeLanguage>,
    /// <p>Synonyms, stopwords, and stemming options for an analysis scheme. Includes tokenization dictionary for Japanese.</p>
    #[doc(hidden)]pub analysis_options: std::option::Option<crate::model::AnalysisOptions>,
}
impl AnalysisScheme {
    /// <p>Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).</p>
...
pub struct AnalysisOptions  {
    ...
    #[doc(hidden)]pub synonyms: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub stopwords: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub stemming_dictionary: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub japanese_tokenization_dictionary: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub algorithmic_stemming: std::option::Option<crate::model::AlgorithmicStemming>,
}
...
impl  std::fmt::Debug for AnalysisOptions  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("japanese_tokenization_dictionary", &self.japanese_tokenization_dictionary);
