...
impl DefineSuggesterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::define_suggester::DefineSuggesterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError, Self> {
