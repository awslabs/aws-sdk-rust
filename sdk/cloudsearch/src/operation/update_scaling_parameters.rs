...
/// Orchestration and serialization glue logic for `UpdateScalingParameters`.
...
impl UpdateScalingParameters {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_scaling_parameters::UpdateScalingParametersInput,
                    ) -> ::std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_scaling_parameters::UpdateScalingParametersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_scaling_parameters::UpdateScalingParametersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateScalingParameters {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateScalingParameters");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateScalingParametersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateScalingParametersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateScalingParameters")
...
.with_interceptor(UpdateScalingParametersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_scaling_parameters::UpdateScalingParametersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_scaling_parameters::UpdateScalingParametersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_scaling_parameters::UpdateScalingParametersError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateScalingParametersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_scaling_parameters::de_update_scaling_parameters_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateScalingParametersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_scaling_parameters::UpdateScalingParametersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_scaling_parameters::UpdateScalingParametersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_scaling_parameters_input::ser_update_scaling_parameters_input_input_input(&input)?);
...
#[derive(Debug)]
            struct UpdateScalingParametersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateScalingParametersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateScalingParametersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateScalingParametersInput>()
                        .ok_or("failed to downcast to UpdateScalingParametersInput")?;
...
pub enum UpdateScalingParametersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateScalingParametersError) for what information is available for the error.")]
...
impl UpdateScalingParametersError {
    /// Creates the `UpdateScalingParametersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateScalingParametersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateScalingParametersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_scaling_parameters::UpdateScalingParametersError {
...
mod _update_scaling_parameters_output;
