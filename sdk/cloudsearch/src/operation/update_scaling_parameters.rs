...
impl UpdateScalingParametersInput {
    /// Consumes the builder and constructs an Operation<[`UpdateScalingParameters`](crate::operation::update_scaling_parameters::UpdateScalingParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_scaling_parameters::UpdateScalingParameters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_scaling_parameters::UpdateScalingParametersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_scaling_parameters::UpdateScalingParameters::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateScalingParameters {
                type Output = std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, crate::operation::update_scaling_parameters::UpdateScalingParametersError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_scaling_parameters::de_update_scaling_parameters_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_scaling_parameters::de_update_scaling_parameters_http_response(response)
                     }
                }
            }
