...
impl DescribeDomainEndpointOptionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDomainEndpointOptions`](crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDomainEndpointOptions {
                type Output = std::result::Result<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsOutput, crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError>;
