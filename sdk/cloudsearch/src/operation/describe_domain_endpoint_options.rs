...
/// Orchestration and serialization glue logic for `DescribeDomainEndpointOptions`.
...
impl DescribeDomainEndpointOptions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDomainEndpointOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDomainEndpointOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDomainEndpointOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDomainEndpointOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDomainEndpointOptions")
...
.with_interceptor(DescribeDomainEndpointOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDomainEndpointOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_domain_endpoint_options::de_describe_domain_endpoint_options_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_domain_endpoint_options::de_describe_domain_endpoint_options_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDomainEndpointOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_domain_endpoint_options_input::ser_describe_domain_endpoint_options_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDomainEndpointOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDomainEndpointOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDomainEndpointOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDomainEndpointOptionsInput>()
                        .ok_or("failed to downcast to DescribeDomainEndpointOptionsInput")?;
...
pub enum DescribeDomainEndpointOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDomainEndpointOptionsError) for what information is available for the error.")]
...
impl DescribeDomainEndpointOptionsError {
    /// Creates the `DescribeDomainEndpointOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDomainEndpointOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDomainEndpointOptionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDomainEndpointOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError {
...
mod _describe_domain_endpoint_options_output;
