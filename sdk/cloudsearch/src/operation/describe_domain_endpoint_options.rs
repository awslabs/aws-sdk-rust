...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDomainEndpointOptionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_domain_endpoint_options::de_describe_domain_endpoint_options_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_domain_endpoint_options::de_describe_domain_endpoint_options_http_response(
