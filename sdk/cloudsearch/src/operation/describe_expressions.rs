...
impl DescribeExpressionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_expressions::DescribeExpressions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExpressions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_expressions::de_describe_expressions_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_expressions::DescribeExpressionsError
{
