...
impl UpdateServiceAccessPoliciesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_service_access_policies::UpdateServiceAccessPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateServiceAccessPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_service_access_policies::de_update_service_access_policies_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateServiceAccessPoliciesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_service_access_policies::UpdateServiceAccessPoliciesError
{
