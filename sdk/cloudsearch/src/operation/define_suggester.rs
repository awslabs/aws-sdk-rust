...
impl DefineSuggesterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::define_suggester::DefineSuggester::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DefineSuggester {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_define_suggester::de_define_suggester_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::define_suggester::DefineSuggesterError
{
