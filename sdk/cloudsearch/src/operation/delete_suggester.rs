...
impl DeleteSuggesterInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::delete_suggester::DeleteSuggester,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_suggester::DeleteSuggester::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSuggester {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_suggester::de_delete_suggester_http_error(
                status, headers, body,
            )
        } else {
