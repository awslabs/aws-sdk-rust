...
impl DeleteSuggesterInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_suggester::DeleteSuggester, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_suggester::DeleteSuggesterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSuggester {
                type Output = std::result::Result<crate::operation::delete_suggester::DeleteSuggesterOutput, crate::operation::delete_suggester::DeleteSuggesterError>;
