...
impl UpdateAvailabilityOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_availability_options::UpdateAvailabilityOptionsInput, ::aws_smithy_types::error::operation::BuildError> {
