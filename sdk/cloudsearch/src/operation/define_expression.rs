...
impl DefineExpressionInput {
    /// Consumes the builder and constructs an Operation<[`DefineExpression`](crate::operation::define_expression::DefineExpression)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::define_expression::DefineExpression, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::define_expression::DefineExpressionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::define_expression::DefineExpression::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DefineExpression {
                type Output = std::result::Result<crate::operation::define_expression::DefineExpressionOutput, crate::operation::define_expression::DefineExpressionError>;
