...
impl DescribeAvailabilityOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_availability_options::DescribeAvailabilityOptions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_availability_options::DescribeAvailabilityOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAvailabilityOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_availability_options::de_describe_availability_options_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeAvailabilityOptionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_availability_options::DescribeAvailabilityOptionsError
{
