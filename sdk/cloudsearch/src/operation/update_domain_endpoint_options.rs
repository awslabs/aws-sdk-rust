...
impl UpdateDomainEndpointOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainEndpointOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_domain_endpoint_options::de_update_domain_endpoint_options_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateDomainEndpointOptionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError
{
