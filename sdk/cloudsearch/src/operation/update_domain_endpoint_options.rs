...
/// Orchestration and serialization glue logic for `UpdateDomainEndpointOptions`.
...
impl UpdateDomainEndpointOptions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsInput,
                    ) -> ::std::result::Result<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDomainEndpointOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDomainEndpointOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateDomainEndpointOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateDomainEndpointOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDomainEndpointOptions")
...
.with_interceptor(UpdateDomainEndpointOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDomainEndpointOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_domain_endpoint_options::de_update_domain_endpoint_options_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_domain_endpoint_options::de_update_domain_endpoint_options_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDomainEndpointOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_domain_endpoint_options_input::ser_update_domain_endpoint_options_input_input_input(&input)?);
...
#[derive(Debug)]
            struct UpdateDomainEndpointOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDomainEndpointOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateDomainEndpointOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateDomainEndpointOptionsInput>()
                        .ok_or("failed to downcast to UpdateDomainEndpointOptionsInput")?;
...
pub enum UpdateDomainEndpointOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDomainEndpointOptionsError) for what information is available for the error.")]
...
impl UpdateDomainEndpointOptionsError {
    /// Creates the `UpdateDomainEndpointOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDomainEndpointOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDomainEndpointOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_domain_endpoint_options::_update_domain_endpoint_options_output::UpdateDomainEndpointOptionsOutput;

pub use crate::operation::update_domain_endpoint_options::_update_domain_endpoint_options_input::UpdateDomainEndpointOptionsInput;

mod _update_domain_endpoint_options_input;

mod _update_domain_endpoint_options_output;
