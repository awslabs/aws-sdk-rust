...
impl crate::operation::describe_domain_endpoint_options::builders::DescribeDomainEndpointOptionsInputBuilder {
...
impl DescribeDomainEndpointOptionsFluentBuilder {
    /// Creates a new `DescribeDomainEndpointOptionsFluentBuilder`.
