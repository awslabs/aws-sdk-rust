...
impl DefineIndexFieldInput {
    /// Consumes the builder and constructs an Operation<[`DefineIndexField`](crate::operation::define_index_field::DefineIndexField)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::define_index_field::DefineIndexField, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::define_index_field::DefineIndexFieldInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::define_index_field::DefineIndexField::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DefineIndexField {
                type Output = std::result::Result<crate::operation::define_index_field::DefineIndexFieldOutput, crate::operation::define_index_field::DefineIndexFieldError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_define_index_field::de_define_index_field_http_error(response)
                     } else {
                        crate::protocol_serde::shape_define_index_field::de_define_index_field_http_response(response)
                     }
                }
            }
