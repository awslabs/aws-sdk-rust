...
impl DefineIndexFieldInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::define_index_field::DefineIndexField::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DefineIndexField {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_define_index_field::de_define_index_field_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::define_index_field::DefineIndexFieldError
{
