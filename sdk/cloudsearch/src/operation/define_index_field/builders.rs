...
impl DefineIndexFieldFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::define_index_field::DefineIndexFieldOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::define_index_field::DefineIndexFieldError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::define_index_field::DefineIndexFieldOutput, crate::operation::define_index_field::DefineIndexFieldError, Self> {
