...
impl UpdateScalingParametersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_scaling_parameters::UpdateScalingParametersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, crate::operation::update_scaling_parameters::UpdateScalingParametersError, Self> {
