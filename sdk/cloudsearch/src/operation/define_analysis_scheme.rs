...
/// Orchestration and serialization glue logic for `DefineAnalysisScheme`.
...
impl DefineAnalysisScheme {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::define_analysis_scheme::DefineAnalysisSchemeInput,
                    ) -> ::std::result::Result<crate::operation::define_analysis_scheme::DefineAnalysisSchemeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::define_analysis_scheme::DefineAnalysisSchemeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DefineAnalysisScheme {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DefineAnalysisScheme");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DefineAnalysisSchemeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DefineAnalysisSchemeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DefineAnalysisScheme")
...
.with_interceptor(DefineAnalysisSchemeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DefineAnalysisSchemeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_define_analysis_scheme::de_define_analysis_scheme_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_define_analysis_scheme::de_define_analysis_scheme_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DefineAnalysisSchemeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::define_analysis_scheme::DefineAnalysisSchemeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_define_analysis_scheme_input::ser_define_analysis_scheme_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DefineAnalysisSchemeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DefineAnalysisSchemeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DefineAnalysisSchemeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DefineAnalysisSchemeInput>()
                        .ok_or("failed to downcast to DefineAnalysisSchemeInput")?;
...
pub enum DefineAnalysisSchemeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DefineAnalysisSchemeError) for what information is available for the error.")]
...
impl DefineAnalysisSchemeError {
    /// Creates the `DefineAnalysisSchemeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DefineAnalysisSchemeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DefineAnalysisSchemeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::define_analysis_scheme::DefineAnalysisSchemeError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::define_analysis_scheme::_define_analysis_scheme_output::DefineAnalysisSchemeOutput;

pub use crate::operation::define_analysis_scheme::_define_analysis_scheme_input::DefineAnalysisSchemeInput;

mod _define_analysis_scheme_input;

mod _define_analysis_scheme_output;
