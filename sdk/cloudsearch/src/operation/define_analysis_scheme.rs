...
impl DefineAnalysisScheme {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudSearch", "DefineAnalysisScheme", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudSearch.DefineAnalysisScheme",
                "rpc.service" = "CloudSearch",
                "rpc.method" = "DefineAnalysisScheme",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DefineAnalysisScheme {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DefineAnalysisSchemeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DefineAnalysisSchemeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DefineAnalysisScheme")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DefineAnalysisScheme")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DefineAnalysisSchemeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DefineAnalysisSchemeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DefineAnalysisSchemeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DefineAnalysisSchemeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DefineAnalysisSchemeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_define_analysis_scheme::de_define_analysis_scheme_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_define_analysis_scheme::de_define_analysis_scheme_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DefineAnalysisSchemeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::define_analysis_scheme::DefineAnalysisSchemeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::define_analysis_scheme::DefineAnalysisSchemeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_define_analysis_scheme_input::ser_define_analysis_scheme_input_input_input(&input)?,
        );
