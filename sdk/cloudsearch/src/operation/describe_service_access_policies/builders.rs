...
impl DescribeServiceAccessPoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_service_access_policies::DescribeServiceAccessPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_service_access_policies::DescribeServiceAccessPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_service_access_policies::DescribeServiceAccessPoliciesOutput, crate::operation::describe_service_access_policies::DescribeServiceAccessPoliciesError, Self> {
