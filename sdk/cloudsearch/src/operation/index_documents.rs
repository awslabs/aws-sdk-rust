...
impl IndexDocumentsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::index_documents::IndexDocuments::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for IndexDocuments {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_index_documents::de_index_documents_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_index_documents::de_index_documents_http_response(
                status, headers, body,
            )
        }
    }
