...
impl IndexDocuments {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::index_documents::IndexDocumentsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::index_documents::IndexDocumentsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudSearch", "IndexDocuments", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudSearch.IndexDocuments",
                "rpc.service" = "CloudSearch",
                "rpc.method" = "IndexDocuments",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IndexDocuments {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("IndexDocuments")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                IndexDocumentsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct IndexDocumentsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for IndexDocumentsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<IndexDocumentsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for IndexDocumentsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_index_documents::de_index_documents_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_index_documents::de_index_documents_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IndexDocumentsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::index_documents::IndexDocumentsInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_index_documents_input::ser_index_documents_input_input_input(&input)?,
        );
