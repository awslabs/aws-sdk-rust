...
impl DescribeAnalysisSchemesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAnalysisSchemes`](crate::operation::describe_analysis_schemes::DescribeAnalysisSchemes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_analysis_schemes::DescribeAnalysisSchemes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_analysis_schemes::DescribeAnalysisSchemes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAnalysisSchemes {
                type Output = std::result::Result<crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesOutput, crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesError>;
