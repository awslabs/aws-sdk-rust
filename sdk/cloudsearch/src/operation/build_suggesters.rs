...
impl BuildSuggestersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::build_suggesters::BuildSuggesters, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for BuildSuggesters {
    type Output =
        ::std::result::Result<crate::operation::build_suggesters::BuildSuggestersOutput, crate::operation::build_suggesters::BuildSuggestersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_build_suggesters::de_build_suggesters_http_response_with_props(status, headers, body)
        }
    }
}
