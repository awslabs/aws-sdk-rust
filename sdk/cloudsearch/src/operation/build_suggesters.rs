...
impl BuildSuggestersInput {
    /// Consumes the builder and constructs an Operation<[`BuildSuggesters`](crate::operation::build_suggesters::BuildSuggesters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::build_suggesters::BuildSuggesters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::build_suggesters::BuildSuggestersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::build_suggesters::BuildSuggesters::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BuildSuggesters {
                type Output = std::result::Result<crate::operation::build_suggesters::BuildSuggestersOutput, crate::operation::build_suggesters::BuildSuggestersError>;
