...
impl DescribeServiceAccessPoliciesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_service_access_policies::DescribeServiceAccessPolicies,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_service_access_policies::DescribeServiceAccessPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeServiceAccessPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_service_access_policies::de_describe_service_access_policies_http_response_with_props(
                status, headers, body,
            )
        }
    }
