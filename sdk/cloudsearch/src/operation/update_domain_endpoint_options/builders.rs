...
impl crate::operation::update_domain_endpoint_options::builders::UpdateDomainEndpointOptionsInputBuilder {
...
impl UpdateDomainEndpointOptionsFluentBuilder {
    /// Creates a new `UpdateDomainEndpointOptionsFluentBuilder`.
