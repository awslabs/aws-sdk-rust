...
#[allow(unused_mut)]
pub fn serialize_structure_analysis_scheme(
    ...
    if let Some(var_6) = &input.analysis_options {
        crate::query_ser::serialize_structure_analysis_options(scope_5, var_6);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_index_field(
    mut writer: smithy_query::QueryValueWriter,
...
pub fn serialize_structure_suggester(
    ...
    if let Some(var_40) = &input.document_suggester_options {
        crate::query_ser::serialize_structure_document_suggester_options(scope_39, var_40);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_scaling_parameters(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if input.desired_replication_count != 0 {
        scope_47.number(
            ...
            smithy_types::Number::NegInt((input.desired_replication_count).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if input.desired_partition_count != 0 {
        scope_48.number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.desired_partition_count).into()),
        );
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_analysis_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_int_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_double_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_literal_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_text_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_date_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_lat_lon_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_int_array_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_double_array_options(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_142) = &input.default_value {
        scope_141.number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_142).into()),
        );
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_literal_array_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_text_array_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_date_array_options(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_document_suggester_options(
    mut writer: smithy_query::QueryValueWriter,
