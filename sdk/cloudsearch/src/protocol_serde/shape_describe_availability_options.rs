...
pub fn de_describe_availability_options_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_availability_options::DescribeAvailabilityOptionsOutput, crate::operation::describe_availability_options::DescribeAvailabilityOptionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_availability_options_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_availability_options::DescribeAvailabilityOptionsOutput, crate::operation::describe_availability_options::DescribeAvailabilityOptionsError> {
    Ok({
        #[allow(unused_mut)]
