...
#[allow(unused_mut)]
pub fn ser_analysis_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AnalysisOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_analysis_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
