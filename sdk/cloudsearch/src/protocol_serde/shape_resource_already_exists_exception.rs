...
#[allow(unused_mut)]
pub fn de_resource_already_exists_exception_xml_err(inp: &[u8], mut builder: crate::error::resource_already_exists_exception::Builder) -> Result<crate::error::resource_already_exists_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
