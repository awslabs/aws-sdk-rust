...
#[allow(unused_mut)]
pub fn de_resource_already_exists_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::ResourceAlreadyExistsExceptionBuilder) -> Result<crate::types::error::builders::ResourceAlreadyExistsExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
