...
pub fn de_update_scaling_parameters_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, crate::operation::update_scaling_parameters::UpdateScalingParametersError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::update_scaling_parameters::UpdateScalingParametersError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_scaling_parameters_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, crate::operation::update_scaling_parameters::UpdateScalingParametersError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::update_scaling_parameters_output_output_correct_errors(output).build()
    })
}
