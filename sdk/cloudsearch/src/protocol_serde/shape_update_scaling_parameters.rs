...
pub fn de_update_scaling_parameters_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, crate::operation::update_scaling_parameters::UpdateScalingParametersError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_scaling_parameters_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_scaling_parameters::UpdateScalingParametersOutput, crate::operation::update_scaling_parameters::UpdateScalingParametersError> {
    Ok({
        #[allow(unused_mut)]
