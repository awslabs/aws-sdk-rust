...
pub fn ser_delete_suggester_input_input_input(input: &crate::operation::delete_suggester::DeleteSuggesterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
