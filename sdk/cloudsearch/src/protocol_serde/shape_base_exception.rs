...
#[allow(unused_mut)]
pub fn de_base_exception_xml_err(inp: &[u8], mut builder: crate::error::base_exception::Builder) -> Result<crate::error::base_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
