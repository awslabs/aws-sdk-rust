...
#[allow(unused_mut)]
pub fn de_base_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::BaseExceptionBuilder) -> Result<crate::types::error::builders::BaseExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
