...
#[allow(unused_mut)]
pub fn ser_date_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DateOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_date_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DateOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
