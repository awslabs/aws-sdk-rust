...
#[allow(unused_mut)]
pub fn ser_domain_endpoint_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DomainEndpointOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_domain_endpoint_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DomainEndpointOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
