...
#[allow(unused_mut)]
pub fn ser_domain_endpoint_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DomainEndpointOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
