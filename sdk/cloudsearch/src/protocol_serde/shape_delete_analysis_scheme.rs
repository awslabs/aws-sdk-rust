...
pub fn de_delete_analysis_scheme_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_analysis_scheme::DeleteAnalysisSchemeOutput, crate::operation::delete_analysis_scheme::DeleteAnalysisSchemeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_analysis_scheme::DeleteAnalysisSchemeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_analysis_scheme_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_analysis_scheme::DeleteAnalysisSchemeOutput, crate::operation::delete_analysis_scheme::DeleteAnalysisSchemeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_analysis_scheme::builders::DeleteAnalysisSchemeOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_analysis_scheme::de_delete_analysis_scheme(response.body().as_ref(), output).map_err(crate::operation::delete_analysis_scheme::DeleteAnalysisSchemeError::unhandled)?;
