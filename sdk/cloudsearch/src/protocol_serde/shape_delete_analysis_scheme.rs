...
pub fn de_delete_analysis_scheme_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteAnalysisSchemeOutput, crate::error::DeleteAnalysisSchemeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteAnalysisSchemeError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteAnalysisSchemeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_analysis_scheme_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteAnalysisSchemeOutput, crate::error::DeleteAnalysisSchemeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_analysis_scheme_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_analysis_scheme::de_delete_analysis_scheme(response.body().as_ref(), output).map_err(crate::error::DeleteAnalysisSchemeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_analysis_scheme(inp: &[u8], mut builder: crate::output::delete_analysis_scheme_output::Builder) -> Result<crate::output::delete_analysis_scheme_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
