...
#[allow(unused_mut)]
pub fn ser_index_field(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::IndexField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_index_field(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IndexField, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
