...
#[allow(unused_mut)]
pub fn ser_scaling_parameters(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ScalingParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_scaling_parameters(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScalingParameters, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
