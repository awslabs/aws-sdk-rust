...
pub fn de_domain_endpoint_options_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DomainEndpointOptionsStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
