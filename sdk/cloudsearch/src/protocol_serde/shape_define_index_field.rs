...
pub fn de_define_index_field_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::define_index_field::DefineIndexFieldOutput, crate::operation::define_index_field::DefineIndexFieldError> {
    #[allow(unused_mut)]
...
pub fn de_define_index_field(
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DefineIndexFieldResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DefineIndexFieldResult got {start_el:?}"
            )));
        }
