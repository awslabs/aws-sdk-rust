...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_suggesters::de_describe_suggesters(_response_body, output)
            .map_err(crate::operation::describe_suggesters::DescribeSuggestersError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_suggesters_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_suggesters::DescribeSuggestersError::unhandled)?
    })
}
...
pub fn de_describe_suggesters(
...
) -> std::result::Result<crate::operation::describe_suggesters::builders::DescribeSuggestersOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeSuggestersResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeSuggestersResult got {start_el:?}"
            )));
        }
