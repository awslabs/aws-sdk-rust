...
pub fn de_scaling_parameters_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScalingParametersStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
