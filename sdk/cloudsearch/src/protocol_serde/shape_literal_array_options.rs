...
#[allow(unused_mut)]
pub fn ser_literal_array_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LiteralArrayOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
