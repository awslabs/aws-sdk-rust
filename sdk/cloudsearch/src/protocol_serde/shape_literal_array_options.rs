...
#[allow(unused_mut)]
pub fn ser_literal_array_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LiteralArrayOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_literal_array_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LiteralArrayOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
