...
#[allow(unused_mut)]
pub fn ser_text_array_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TextArrayOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("HighlightEnabled");
    if let Some(var_8) = &input.highlight_enabled {
        scope_7.boolean(*var_8);
    }
    #[allow(unused_mut)]
    let mut scope_9 = writer.prefix("AnalysisScheme");
    if let Some(var_10) = &input.analysis_scheme {
...
pub fn de_text_array_options(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TextArrayOptions, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::TextArrayOptions::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("ReturnEnabled") /* ReturnEnabled com.amazonaws.cloudsearch#TextArrayOptions$ReturnEnabled */ =>  {
                ...
                ;
                builder = builder.set_return_enabled(var_13);
            }
            ,
            s if s.matches("HighlightEnabled") /* HighlightEnabled com.amazonaws.cloudsearch#TextArrayOptions$HighlightEnabled */ =>  {
                ...
                ;
                builder = builder.set_highlight_enabled(var_14);
            }
            ,
            s if s.matches("AnalysisScheme") /* AnalysisScheme com.amazonaws.cloudsearch#TextArrayOptions$AnalysisScheme */ =>  {
                ...
                ;
                builder = builder.set_analysis_scheme(var_15);
            }
            ,
            _ => {}
        }
