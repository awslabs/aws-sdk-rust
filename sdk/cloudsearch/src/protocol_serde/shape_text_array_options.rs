...
#[allow(unused_mut)]
pub fn ser_text_array_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::TextArrayOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
