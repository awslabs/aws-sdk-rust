...
pub fn de_delete_expression_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_expression::DeleteExpressionOutput, crate::operation::delete_expression::DeleteExpressionError> {
    #[allow(unused_mut)]
...
pub fn de_delete_expression_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_expression::de_delete_expression(_response_body, output)
            .map_err(crate::operation::delete_expression::DeleteExpressionError::unhandled)?;
...
pub fn de_delete_expression(
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DeleteExpressionResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DeleteExpressionResult got {start_el:?}"
            )));
        }
