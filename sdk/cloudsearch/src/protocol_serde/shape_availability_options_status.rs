...
pub fn de_availability_options_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AvailabilityOptionsStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
