...
#[allow(unused_mut)]
pub fn ser_lat_lon_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::LatLonOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
