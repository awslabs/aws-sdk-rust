...
#[allow(unused_mut)]
pub fn ser_lat_lon_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LatLonOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_lat_lon_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LatLonOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
