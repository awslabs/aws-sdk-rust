...
#[allow(unused_mut)]
pub fn ser_lat_lon_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LatLonOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_lat_lon_options(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LatLonOptions, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::LatLonOptions::builder();
