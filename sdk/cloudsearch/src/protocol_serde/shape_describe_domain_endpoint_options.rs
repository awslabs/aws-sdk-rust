...
pub fn de_describe_domain_endpoint_options_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsOutput, crate::operation::describe_domain_endpoint_options::DescribeDomainEndpointOptionsError> {
    #[allow(unused_mut)]
