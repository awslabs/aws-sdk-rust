...
#[allow(unused_mut)]
pub fn de_disabled_operation_exception_xml_err(inp: &[u8], mut builder: crate::error::disabled_operation_exception::Builder) -> Result<crate::error::disabled_operation_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
