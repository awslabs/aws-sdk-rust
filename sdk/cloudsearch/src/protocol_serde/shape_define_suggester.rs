...
#[allow(clippy::unnecessary_wraps)]
pub fn de_define_suggester_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError> {
    Ok({
        #[allow(unused_mut)]
