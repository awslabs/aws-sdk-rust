...
pub fn de_define_suggester_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_define_suggester_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError> {
    Ok({
        #[allow(unused_mut)]
