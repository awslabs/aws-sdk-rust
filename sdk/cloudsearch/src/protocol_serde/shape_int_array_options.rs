...
#[allow(unused_mut)]
pub fn ser_int_array_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::IntArrayOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
