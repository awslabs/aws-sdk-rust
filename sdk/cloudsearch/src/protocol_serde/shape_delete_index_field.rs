...
pub fn de_delete_index_field_http_error(
...
) -> std::result::Result<crate::output::DeleteIndexFieldOutput, crate::error::DeleteIndexFieldError>
{
    ...
    Err(match error_code {
        ...
        "InternalException" => {
            crate::error::DeleteIndexFieldError::InternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_index_field_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<crate::output::DeleteIndexFieldOutput, crate::error::DeleteIndexFieldError>
{
    Ok({
...
) -> Result<crate::output::delete_index_field_output::Builder, aws_smithy_xml::decode::XmlDecodeError>
{
