...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_index_field_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_index_field::DeleteIndexFieldOutput, crate::operation::delete_index_field::DeleteIndexFieldError> {
    Ok({
        #[allow(unused_mut)]
