...
pub fn de_delete_index_field_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_index_field::DeleteIndexFieldOutput, crate::operation::delete_index_field::DeleteIndexFieldError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_index_field_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_index_field::DeleteIndexFieldOutput, crate::operation::delete_index_field::DeleteIndexFieldError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::delete_index_field_output_output_correct_errors(output).build()
    })
}
