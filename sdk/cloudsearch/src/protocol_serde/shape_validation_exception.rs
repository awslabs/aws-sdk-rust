...
#[allow(unused_mut)]
pub fn de_validation_exception_xml_err(inp: &[u8], mut builder: crate::error::validation_exception::Builder) -> Result<crate::error::validation_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
