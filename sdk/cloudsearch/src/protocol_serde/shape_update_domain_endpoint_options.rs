...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_domain_endpoint_options::de_update_domain_endpoint_options(_response_body, output)
            .map_err(crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("UpdateDomainEndpointOptionsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected UpdateDomainEndpointOptionsResult got {start_el:?}"
            )));
        }
