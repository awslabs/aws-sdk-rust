...
pub fn de_update_availability_options_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_availability_options::UpdateAvailabilityOptionsOutput, crate::operation::update_availability_options::UpdateAvailabilityOptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::update_availability_options::UpdateAvailabilityOptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_availability_options_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_availability_options::UpdateAvailabilityOptionsOutput, crate::operation::update_availability_options::UpdateAvailabilityOptionsError> {
    Ok({
        #[allow(unused_mut)]
