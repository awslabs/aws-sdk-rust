...
pub fn de_update_availability_options_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateAvailabilityOptionsOutput, crate::error::UpdateAvailabilityOptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateAvailabilityOptionsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::UpdateAvailabilityOptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_availability_options_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateAvailabilityOptionsOutput, crate::error::UpdateAvailabilityOptionsError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_update_availability_options(inp: &[u8], mut builder: crate::output::update_availability_options_output::Builder) -> Result<crate::output::update_availability_options_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
