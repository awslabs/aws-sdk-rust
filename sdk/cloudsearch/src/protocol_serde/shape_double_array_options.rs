...
#[allow(unused_mut)]
pub fn ser_double_array_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DoubleArrayOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_double_array_options(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::DoubleArrayOptions, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
