...
#[allow(unused_mut)]
pub fn ser_analysis_scheme(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AnalysisScheme) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_analysis_scheme(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisScheme, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
