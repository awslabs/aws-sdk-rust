...
#[allow(unused_mut)]
pub fn de_internal_exception_xml_err(inp: &[u8], mut builder: crate::error::internal_exception::Builder) -> Result<crate::error::internal_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
