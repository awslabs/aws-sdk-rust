...
#[allow(unused_mut)]
pub fn de_internal_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::InternalExceptionBuilder) -> Result<crate::types::error::builders::InternalExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
