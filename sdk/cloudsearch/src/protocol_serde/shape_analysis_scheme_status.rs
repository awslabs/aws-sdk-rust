...
pub fn de_analysis_scheme_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisSchemeStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
