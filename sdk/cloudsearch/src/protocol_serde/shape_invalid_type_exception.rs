...
#[allow(unused_mut)]
pub fn de_invalid_type_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::InvalidTypeExceptionBuilder) -> Result<crate::types::error::builders::InvalidTypeExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
