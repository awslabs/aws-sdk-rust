...
pub fn de_describe_analysis_schemes_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesOutput, crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_analysis_schemes_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesOutput, crate::operation::describe_analysis_schemes::DescribeAnalysisSchemesError> {
    Ok({
        #[allow(unused_mut)]
