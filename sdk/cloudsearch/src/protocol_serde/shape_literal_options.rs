...
#[allow(unused_mut)]
pub fn ser_literal_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::LiteralOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
