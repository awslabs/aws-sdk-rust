...
#[allow(unused_mut)]
pub fn ser_literal_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LiteralOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_literal_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LiteralOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
