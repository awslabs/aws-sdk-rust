...
#[allow(unused_mut)]
pub fn ser_literal_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LiteralOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_literal_options(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LiteralOptions, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::LiteralOptions::builder();
