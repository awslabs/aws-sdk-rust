...
#[allow(unused_mut)]
pub fn ser_double_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DoubleOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_double_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DoubleOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
