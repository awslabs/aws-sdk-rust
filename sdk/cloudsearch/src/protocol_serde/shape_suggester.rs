...
#[allow(unused_mut)]
pub fn ser_suggester(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Suggester) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_suggester(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Suggester, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
