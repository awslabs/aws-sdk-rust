...
#[allow(unused_mut)]
pub fn ser_expression(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Expression) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_expression(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Expression, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
