...
#[allow(unused_mut)]
pub fn ser_text_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TextOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
