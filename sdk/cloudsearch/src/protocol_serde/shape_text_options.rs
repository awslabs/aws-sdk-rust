...
#[allow(unused_mut)]
pub fn ser_text_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TextOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_text_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TextOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
