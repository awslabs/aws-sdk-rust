...
#[allow(unused_mut)]
pub fn ser_int_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::IntOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_int_options(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::IntOptions, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
