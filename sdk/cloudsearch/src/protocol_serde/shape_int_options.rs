...
#[allow(unused_mut)]
pub fn ser_int_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::IntOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_int_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IntOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
