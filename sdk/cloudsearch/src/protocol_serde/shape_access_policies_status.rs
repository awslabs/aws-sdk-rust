...
pub fn de_access_policies_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessPoliciesStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
