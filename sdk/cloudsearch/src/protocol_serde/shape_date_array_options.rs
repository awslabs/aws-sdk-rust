...
#[allow(unused_mut)]
pub fn ser_date_array_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::DateArrayOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
