...
pub fn ser_define_index_field_input_input(input: &crate::input::DefineIndexFieldInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
