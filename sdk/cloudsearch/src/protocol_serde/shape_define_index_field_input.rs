...
pub fn ser_define_index_field_input_input_input(input: &crate::operation::define_index_field::DefineIndexFieldInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
