...
impl super::Client {
    ...
    ///   - [`multi_az(bool)`](crate::operation::update_availability_options::builders::UpdateAvailabilityOptionsFluentBuilder::multi_az) / [`set_multi_az(Option<bool>)`](crate::operation::update_availability_options::builders::UpdateAvailabilityOptionsFluentBuilder::set_multi_az):<br>required: **true**<br><p>You expand an existing search domain to a second Availability Zone by setting the Multi-AZ option to true. Similarly, you can turn off the Multi-AZ option to downgrade the domain to a single Availability Zone by setting the Multi-AZ option to <code>false</code>.</p><br>
