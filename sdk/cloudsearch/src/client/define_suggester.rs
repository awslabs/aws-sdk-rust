...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::define_suggester::builders::DefineSuggesterFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::define_suggester::builders::DefineSuggesterFluentBuilder::set_domain_name):<br>required: **true**<br><p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p><br>
    ///   - [`suggester(Suggester)`](crate::operation::define_suggester::builders::DefineSuggesterFluentBuilder::suggester) / [`set_suggester(Option<Suggester>)`](crate::operation::define_suggester::builders::DefineSuggesterFluentBuilder::set_suggester):<br>required: **true**<br><p>Configuration information for a search suggester. Each suggester has a unique name and specifies the text field you want to use for suggestions. The following options can be configured for a suggester: <code>FuzzyMatching</code>, <code>SortExpression</code>.</p><br>
