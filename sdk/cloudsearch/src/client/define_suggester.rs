...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::define_suggester::builders::DefineSuggesterFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::define_suggester::builders::DefineSuggesterFluentBuilder::set_domain_name): <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p>
