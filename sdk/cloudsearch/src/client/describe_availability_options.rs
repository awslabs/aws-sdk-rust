...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder::set_domain_name):<br>required: **true**<br><p>The name of the domain you want to describe.</p><br>
    ///   - [`deployed(bool)`](crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder::deployed) / [`set_deployed(Option<bool>)`](crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder::set_deployed):<br>required: **false**<br><p>Whether to display the deployed configuration (<code>true</code>) or include any pending changes (<code>false</code>). Defaults to <code>false</code>.</p><br>
    ...
    pub fn describe_availability_options(
        &self,
    ) -> crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder {
