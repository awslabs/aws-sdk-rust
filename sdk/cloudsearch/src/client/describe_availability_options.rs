...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::describe_availability_options::builders::DescribeAvailabilityOptionsFluentBuilder::set_domain_name): <p>The name of the domain you want to describe.</p>
