...
impl super::Client {
    ...
    ///   - [`index_field(IndexField)`](crate::operation::define_index_field::builders::DefineIndexFieldFluentBuilder::index_field) / [`set_index_field(Option<IndexField>)`](crate::operation::define_index_field::builders::DefineIndexFieldFluentBuilder::set_index_field):<br>required: **true**<br><p>The index field and field options you want to configure.</p><br>
