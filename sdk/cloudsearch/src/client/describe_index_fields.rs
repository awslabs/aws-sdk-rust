...
impl super::Client {
    ...
    ///   - [`field_names(impl Into<String>)`](crate::operation::describe_index_fields::builders::DescribeIndexFieldsFluentBuilder::field_names) / [`set_field_names(Option<Vec<String>>)`](crate::operation::describe_index_fields::builders::DescribeIndexFieldsFluentBuilder::set_field_names): <p>A list of the index fields you want to describe. If not specified, information is returned for all configured index fields.</p>
