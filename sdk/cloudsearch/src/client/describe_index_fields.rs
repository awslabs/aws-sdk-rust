...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::describe_index_fields::builders::DescribeIndexFieldsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::describe_index_fields::builders::DescribeIndexFieldsFluentBuilder::set_domain_name): <p>The name of the domain you want to describe.</p>
