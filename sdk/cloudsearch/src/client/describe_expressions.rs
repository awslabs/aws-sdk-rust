...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::describe_expressions::builders::DescribeExpressionsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::describe_expressions::builders::DescribeExpressionsFluentBuilder::set_domain_name): <p>The name of the domain you want to describe.</p>
