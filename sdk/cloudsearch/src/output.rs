...
pub struct UpdateScalingParametersOutput  {
    ...
    #[doc(hidden)]pub scaling_parameters: std::option::Option<crate::model::ScalingParametersStatus>,
}
...
pub struct UpdateAvailabilityOptionsOutput  {
    ...
    #[doc(hidden)]pub availability_options: std::option::Option<crate::model::AvailabilityOptionsStatus>,
}
...
pub struct ListDomainNamesOutput  {
    ...
    #[doc(hidden)]pub domain_names: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct DescribeSuggestersOutput  {
    ...
    #[doc(hidden)]pub suggesters: std::option::Option<std::vec::Vec<crate::model::SuggesterStatus>>,
}
...
pub struct DescribeIndexFieldsOutput  {
    ...
    #[doc(hidden)]pub index_fields: std::option::Option<std::vec::Vec<crate::model::IndexFieldStatus>>,
}
...
pub struct DescribeExpressionsOutput  {
    ...
    #[doc(hidden)]pub expressions: std::option::Option<std::vec::Vec<crate::model::ExpressionStatus>>,
}
...
pub struct DescribeAnalysisSchemesOutput  {
    ...
    #[doc(hidden)]pub analysis_schemes: std::option::Option<std::vec::Vec<crate::model::AnalysisSchemeStatus>>,
}
...
pub struct DeleteSuggesterOutput  {
    ...
    #[doc(hidden)]pub suggester: std::option::Option<crate::model::SuggesterStatus>,
}
...
pub struct DeleteIndexFieldOutput  {
    ...
    #[doc(hidden)]pub index_field: std::option::Option<crate::model::IndexFieldStatus>,
}
...
pub struct DeleteExpressionOutput  {
    ...
    #[doc(hidden)]pub expression: std::option::Option<crate::model::ExpressionStatus>,
}
...
pub struct DeleteAnalysisSchemeOutput  {
    ...
    #[doc(hidden)]pub analysis_scheme: std::option::Option<crate::model::AnalysisSchemeStatus>,
}
