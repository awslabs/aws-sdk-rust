...
if (api_type) == ("DataPlane") {
                                return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("Invalid Configuration: fips endpoint is not supported for this API"
.to_string()));
                            }
return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("Invalid Configuration: Unknown ApiType"
.to_string()));
                            }
                            }
