...
impl super::Client {
    ...
    ///   - [`provisioned_memory(i32)`](crate::operation::update_graph::builders::UpdateGraphFluentBuilder::provisioned_memory) / [`set_provisioned_memory(Option<i32>)`](crate::operation::update_graph::builders::UpdateGraphFluentBuilder::set_provisioned_memory):<br>required: **false**<br><p>The provisioned memory-optimized Neptune Capacity Units (m-NCUs) to use for the graph.</p> <p>Min = 128</p><br>
