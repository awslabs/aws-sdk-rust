...
impl super::Client {
    ...
    ///   - [`parquet_type(Option<ParquetType>)`](crate::operation::cancel_import_task::CancelImportTaskOutput::parquet_type): <p>The parquet type of the cancelled import task.</p>
