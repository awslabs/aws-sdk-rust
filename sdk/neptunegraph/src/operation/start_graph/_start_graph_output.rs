...
impl ::aws_types::request_id::RequestId for StartGraphOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartGraphOutput {
    /// Creates a new builder-style object to manufacture [`StartGraphOutput`](crate::operation::start_graph::StartGraphOutput).
    pub fn builder() -> crate::operation::start_graph::builders::StartGraphOutputBuilder {
        crate::operation::start_graph::builders::StartGraphOutputBuilder::default()
    }
}

/// A builder for [`StartGraphOutput`](crate::operation::start_graph::StartGraphOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartGraphOutputBuilder {
...
impl StartGraphOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartGraphOutput`](crate::operation::start_graph::StartGraphOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::start_graph::builders::StartGraphOutputBuilder::id)
    /// - [`name`](crate::operation::start_graph::builders::StartGraphOutputBuilder::name)
    /// - [`arn`](crate::operation::start_graph::builders::StartGraphOutputBuilder::arn)
    pub fn build(self) -> ::std::result::Result<crate::operation::start_graph::StartGraphOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::start_graph::StartGraphOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building StartGraphOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building StartGraphOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building StartGraphOutput",
                )
            })?,
            status: self.status,
