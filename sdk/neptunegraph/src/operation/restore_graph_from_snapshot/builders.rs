...
impl RestoreGraphFromSnapshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restore_graph_from_snapshot::RestoreGraphFromSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_graph_from_snapshot::RestoreGraphFromSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restore_graph_from_snapshot::RestoreGraphFromSnapshotOutput, crate::operation::restore_graph_from_snapshot::RestoreGraphFromSnapshotError, Self> {
