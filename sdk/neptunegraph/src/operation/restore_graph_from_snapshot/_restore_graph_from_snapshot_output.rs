...
impl RestoreGraphFromSnapshotOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_graph_from_snapshot::RestoreGraphFromSnapshotOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::restore_graph_from_snapshot::RestoreGraphFromSnapshotOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building RestoreGraphFromSnapshotOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building RestoreGraphFromSnapshotOutput")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building RestoreGraphFromSnapshotOutput")
                    )?
                ,
                status: self.status
                ,
