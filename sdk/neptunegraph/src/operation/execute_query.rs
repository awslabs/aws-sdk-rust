...
/// Orchestration and serialization glue logic for `ExecuteQuery`.
...
impl ExecuteQuery {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::execute_query::ExecuteQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::execute_query::ExecuteQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::execute_query::ExecuteQueryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::execute_query::ExecuteQueryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExecuteQuery {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExecuteQuery");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExecuteQueryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExecuteQueryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteQuery")
...
.with_interceptor(ExecuteQueryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::execute_query::ExecuteQueryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::execute_query::ExecuteQueryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::execute_query::ExecuteQueryError>::new());
...
#[derive(Debug)]
            struct ExecuteQueryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExecuteQueryResponseDeserializer {
                ...
                ::std::option::Option::Some(crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_execute_query::de_execute_query_http_response(response)))
            }
            ...
            crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_execute_query::de_execute_query_http_error(response.status().as_u16(), response.headers(), body))
                }
            }
#[derive(Debug)]
            struct ExecuteQueryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExecuteQueryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::execute_query::ExecuteQueryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::execute_query::ExecuteQueryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/queries").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_execute_query::ser_execute_query_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_execute_query::ser_execute_query_input(&input)?);
...
#[derive(Debug)]
            struct ExecuteQueryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExecuteQueryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExecuteQueryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExecuteQueryInput>()
                        .ok_or("failed to downcast to ExecuteQueryInput")?;
...
pub enum ExecuteQueryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExecuteQueryError) for what information is available for the error.")]
...
impl ExecuteQueryError {
    /// Creates the `ExecuteQueryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExecuteQueryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::UnprocessableException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `ExecuteQueryError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `ExecuteQueryError::UnprocessableException`.
    pub fn is_unprocessable_exception(&self) -> bool {
        matches!(self, Self::UnprocessableException(_))
    }
...
impl ::std::error::Error for ExecuteQueryError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::UnprocessableException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExecuteQueryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::execute_query::ExecuteQueryError {
