...
impl ListGraphSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_graph_snapshots::ListGraphSnapshotsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_graph_snapshots::ListGraphSnapshotsInput {
