...
impl CancelExportTask {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("neptunegraph", "CancelExportTask", input, runtime_plugins, stop_point)
            .await
    }
...
impl CancelExportTaskError {
    ...
    /// Returns `true` if the error kind is `CancelExportTaskError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `CancelExportTaskError::InternalServerException`.
    ...
    /// Returns `true` if the error kind is `CancelExportTaskError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `CancelExportTaskError::ValidationException`.
