...
impl ListImportTasksOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_import_tasks::ListImportTasksOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_import_tasks::ListImportTasksOutput {
                tasks: self.tasks
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("tasks", "tasks was not specified but it is required when building ListImportTasksOutput")
                    )?
                ,
