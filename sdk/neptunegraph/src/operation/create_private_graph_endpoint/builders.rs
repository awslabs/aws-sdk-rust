...
impl crate::operation::create_private_graph_endpoint::builders::CreatePrivateGraphEndpointInputBuilder {
...
impl CreatePrivateGraphEndpointFluentBuilder {
    /// Creates a new `CreatePrivateGraphEndpointFluentBuilder`.
