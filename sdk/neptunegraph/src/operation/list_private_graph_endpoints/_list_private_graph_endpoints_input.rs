...
impl ListPrivateGraphEndpointsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_private_graph_endpoints::ListPrivateGraphEndpointsInput, ::aws_smithy_types::error::operation::BuildError> {
