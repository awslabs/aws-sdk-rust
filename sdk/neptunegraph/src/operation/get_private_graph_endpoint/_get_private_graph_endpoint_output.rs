...
impl GetPrivateGraphEndpointOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_private_graph_endpoint::GetPrivateGraphEndpointOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_private_graph_endpoint::GetPrivateGraphEndpointOutput {
                vpc_id: self.vpc_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_id", "vpc_id was not specified but it is required when building GetPrivateGraphEndpointOutput")
                    )?
                ,
                subnet_ids: self.subnet_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("subnet_ids", "subnet_ids was not specified but it is required when building GetPrivateGraphEndpointOutput")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building GetPrivateGraphEndpointOutput")
                    )?
                ,
