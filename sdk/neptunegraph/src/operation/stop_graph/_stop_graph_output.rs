...
impl ::aws_types::request_id::RequestId for StopGraphOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StopGraphOutput {
    /// Creates a new builder-style object to manufacture [`StopGraphOutput`](crate::operation::stop_graph::StopGraphOutput).
    pub fn builder() -> crate::operation::stop_graph::builders::StopGraphOutputBuilder {
        crate::operation::stop_graph::builders::StopGraphOutputBuilder::default()
    }
}

/// A builder for [`StopGraphOutput`](crate::operation::stop_graph::StopGraphOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StopGraphOutputBuilder {
...
impl StopGraphOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StopGraphOutput`](crate::operation::stop_graph::StopGraphOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::stop_graph::builders::StopGraphOutputBuilder::id)
    /// - [`name`](crate::operation::stop_graph::builders::StopGraphOutputBuilder::name)
    /// - [`arn`](crate::operation::stop_graph::builders::StopGraphOutputBuilder::arn)
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_graph::StopGraphOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::stop_graph::StopGraphOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building StopGraphOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building StopGraphOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building StopGraphOutput",
                )
            })?,
            status: self.status,
