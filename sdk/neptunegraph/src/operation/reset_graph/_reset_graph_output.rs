...
impl ::aws_types::request_id::RequestId for ResetGraphOutput {
                                    fn request_id(&self) -> Option<&str> {
                                        self._request_id.as_deref()
                                    }
                                }
impl ResetGraphOutput {
    /// Creates a new builder-style object to manufacture [`ResetGraphOutput`](crate::operation::reset_graph::ResetGraphOutput).
    pub fn builder() -> crate::operation::reset_graph::builders::ResetGraphOutputBuilder {
        crate::operation::reset_graph::builders::ResetGraphOutputBuilder::default()
    }
}

/// A builder for [`ResetGraphOutput`](crate::operation::reset_graph::ResetGraphOutput).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct ResetGraphOutputBuilder {
...
impl ResetGraphOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ResetGraphOutput`](crate::operation::reset_graph::ResetGraphOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::reset_graph::builders::ResetGraphOutputBuilder::id)
    /// - [`name`](crate::operation::reset_graph::builders::ResetGraphOutputBuilder::name)
    /// - [`arn`](crate::operation::reset_graph::builders::ResetGraphOutputBuilder::arn)
    pub fn build(self) -> ::std::result::Result<crate::operation::reset_graph::ResetGraphOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::reset_graph::ResetGraphOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building ResetGraphOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building ResetGraphOutput")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building ResetGraphOutput")
                    )?
                ,
                status: self.status
                ,
