...
pub(crate) fn reflens_list_export_tasks_output_output_next_token(
    input: &crate::operation::list_export_tasks::ListExportTasksOutput,
...
pub(crate) fn lens_list_export_tasks_output_output_tasks(
    input: crate::operation::list_export_tasks::ListExportTasksOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ExportTaskSummary>> {
