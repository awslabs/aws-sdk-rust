...
///
/// Fluent builder for the `private_graph_endpoint_available` waiter.
///
...
pub struct PrivateGraphEndpointAvailableFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_private_graph_endpoint::builders::GetPrivateGraphEndpointInputBuilder,
}
impl PrivateGraphEndpointAvailableFluentBuilder {
    /// Creates a new `PrivateGraphEndpointAvailableFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::private_graph_endpoint_available::PrivateGraphEndpointAvailableFinalPoll,
        crate::waiters::private_graph_endpoint_available::WaitUntilPrivateGraphEndpointAvailableError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_get_private_graph_endpoint_ac9cf40eec4f10ab5(result) {
            ...
            if crate::waiters::matchers::match_get_private_graph_endpoint_f9c483f08ce8cb218(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"status","expected":"AVAILABLE","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_private_graph_endpoint_c07d78a200bcd8560(result) {
...
/// Successful return type for the `private_graph_endpoint_available` waiter.
pub type PrivateGraphEndpointAvailableFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::get_private_graph_endpoint::GetPrivateGraphEndpointOutput,
...
/// Error type for the `private_graph_endpoint_available` waiter.
pub type WaitUntilPrivateGraphEndpointAvailableError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_private_graph_endpoint::GetPrivateGraphEndpointOutput,
    crate::operation::get_private_graph_endpoint::GetPrivateGraphEndpointError,
>;
