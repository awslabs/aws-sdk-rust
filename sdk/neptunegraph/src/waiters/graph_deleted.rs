...
///
/// Fluent builder for the `graph_deleted` waiter.
///
...
pub struct GraphDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_graph::builders::GetGraphInputBuilder,
}
impl GraphDeletedFluentBuilder {
    /// Creates a new `GraphDeletedFluentBuilder`.
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<crate::waiters::graph_deleted::GraphDeletedFinalPoll, crate::waiters::graph_deleted::WaitUntilGraphDeletedError> {
        let input = self
            .inner
            .build()
        ...
        let acceptor =
            move |result: ::std::result::Result<&crate::operation::get_graph::GetGraphOutput, &crate::operation::get_graph::GetGraphError>| {
                ...
                if crate::waiters::matchers::match_get_graph_36cde75d8dc473dbc(result) {
                    return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
                }
                // Matches: {"errorType":"ResourceNotFoundException"}
                if crate::waiters::matchers::match_get_graph_1cce2c05524fb92d4(result) {
...
/// Successful return type for the `graph_deleted` waiter.
pub type GraphDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
...
/// Error type for the `graph_deleted` waiter.
pub type WaitUntilGraphDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_graph::GetGraphOutput,
    crate::operation::get_graph::GetGraphError,
>;
