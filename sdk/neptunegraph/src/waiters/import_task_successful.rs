...
///
/// Fluent builder for the `import_task_successful` waiter.
///
...
pub struct ImportTaskSuccessfulFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_import_task::builders::GetImportTaskInputBuilder,
}
impl ImportTaskSuccessfulFluentBuilder {
    /// Creates a new `ImportTaskSuccessfulFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::import_task_successful::ImportTaskSuccessfulFinalPoll,
        crate::waiters::import_task_successful::WaitUntilImportTaskSuccessfulError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_get_import_task_0ae5c8c61ddb0b59e(result) {
            ...
            // Matches: {"output":{"path":"status","expected":"ROLLING_BACK","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_import_task_ccf6617f1beb5de7c(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"status","expected":"FAILED","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_import_task_f9c483f08ce8cb218(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"status","expected":"SUCCEEDED","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_import_task_e109320ae7bd9fe98(result) {
...
/// Successful return type for the `import_task_successful` waiter.
pub type ImportTaskSuccessfulFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::get_import_task::GetImportTaskOutput,
...
/// Error type for the `import_task_successful` waiter.
pub type WaitUntilImportTaskSuccessfulError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_import_task::GetImportTaskOutput,
    crate::operation::get_import_task::GetImportTaskError,
>;
