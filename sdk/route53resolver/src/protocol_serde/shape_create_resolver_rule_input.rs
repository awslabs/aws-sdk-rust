...
pub fn ser_create_resolver_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateResolverRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
