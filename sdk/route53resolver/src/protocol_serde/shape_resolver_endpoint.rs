...
pub(crate) fn de_resolver_endpoint<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ResolverEndpoint>, aws_smithy_json::deserialize::error::DeserializeError>
