...
pub(crate) fn de_resolver_endpoint<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ResolverEndpoint>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Direction" => {
                                builder = builder.set_direction(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ResolverEndpointDirection::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "ResolverEndpointType" => {
                                builder = builder.set_resolver_endpoint_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ResolverEndpointType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
