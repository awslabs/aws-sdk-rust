...
pub(crate) fn de_resolver_endpoint<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ResolverEndpoint>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Direction" => {
                            builder = builder.set_direction(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ResolverEndpointDirection::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "IpAddressCount" => {
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ResolverEndpointStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "StatusMessage" => {
