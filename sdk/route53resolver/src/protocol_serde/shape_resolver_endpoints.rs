...
pub(crate) fn de_resolver_endpoints<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ResolverEndpoint>>, aws_smithy_json::deserialize::error::DeserializeError>
