...
pub fn ser_update_firewall_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFirewallRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
