...
pub fn ser_list_firewall_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFirewallRulesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
