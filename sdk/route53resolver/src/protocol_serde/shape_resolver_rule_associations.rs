...
pub(crate) fn de_resolver_rule_associations<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::ResolverRuleAssociation>>, aws_smithy_json::deserialize::error::DeserializeError>
