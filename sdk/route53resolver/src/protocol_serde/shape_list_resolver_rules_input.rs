...
pub fn ser_list_resolver_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_resolver_rules::ListResolverRulesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
