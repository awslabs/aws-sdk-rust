...
pub fn ser_list_resolver_dnssec_configs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_resolver_dnssec_configs::ListResolverDnssecConfigsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
