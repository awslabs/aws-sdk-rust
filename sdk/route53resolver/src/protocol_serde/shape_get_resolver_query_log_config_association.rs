...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_resolver_query_log_config_association::GetResolverQueryLogConfigAssociationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::get_resolver_query_log_config_association::GetResolverQueryLogConfigAssociationError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::get_resolver_query_log_config_association::GetResolverQueryLogConfigAssociationError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_resolver_query_log_config_association::de_get_resolver_query_log_config_association(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_resolver_query_log_config_association::GetResolverQueryLogConfigAssociationError::unhandled)?;
...
pub fn ser_get_resolver_query_log_config_association_input(
    ...
    crate::protocol_serde::shape_get_resolver_query_log_config_association_input::ser_get_resolver_query_log_config_association_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_get_resolver_query_log_config_association(
    _value: &[u8],
    mut builder: crate::operation::get_resolver_query_log_config_association::builders::GetResolverQueryLogConfigAssociationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_resolver_query_log_config_association::builders::GetResolverQueryLogConfigAssociationOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ResolverQueryLogConfigAssociation" => {
                    builder = builder.set_resolver_query_log_config_association(
                        crate::protocol_serde::shape_resolver_query_log_config_association::de_resolver_query_log_config_association(tokens, _value)?,
                    );
                }
