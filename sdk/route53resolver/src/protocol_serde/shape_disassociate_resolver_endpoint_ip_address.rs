...
pub fn de_disassociate_resolver_endpoint_ip_address_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InternalServiceErrorException" => {
            crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::InternalServiceErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => {
            crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceExistsException" => {
            crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::ResourceExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_resolver_endpoint_ip_address_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_resolver_endpoint_ip_address::de_disassociate_resolver_endpoint_ip_address(
            _response_body,
            output,
        )
        .map_err(crate::operation::disassociate_resolver_endpoint_ip_address::DisassociateResolverEndpointIpAddressError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ResolverEndpoint" => {
                    builder = builder.set_resolver_endpoint(crate::protocol_serde::shape_resolver_endpoint::de_resolver_endpoint(tokens)?);
                }
