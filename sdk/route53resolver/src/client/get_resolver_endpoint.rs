...
impl super::Client {
    ...
    ///   - [`resolver_endpoint_id(impl Into<String>)`](crate::operation::get_resolver_endpoint::builders::GetResolverEndpointFluentBuilder::resolver_endpoint_id) / [`set_resolver_endpoint_id(Option<String>)`](crate::operation::get_resolver_endpoint::builders::GetResolverEndpointFluentBuilder::set_resolver_endpoint_id):<br>required: **true**<br><p>The ID of the Resolver endpoint that you want to get information about.</p><br>
