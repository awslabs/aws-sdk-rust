...
impl super::Client {
    ...
    ///   - [`resolver_rule_id(impl Into<String>)`](crate::operation::delete_resolver_rule::builders::DeleteResolverRuleFluentBuilder::resolver_rule_id) / [`set_resolver_rule_id(Option<String>)`](crate::operation::delete_resolver_rule::builders::DeleteResolverRuleFluentBuilder::set_resolver_rule_id):<br>required: **true**<br><p>The ID of the Resolver rule that you want to delete.</p><br>
