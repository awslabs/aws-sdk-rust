...
impl super::Client {
    ...
    ///   - [`domain_file_url(impl ::std::convert::Into<String>)`](crate::operation::import_firewall_domains::builders::ImportFirewallDomainsFluentBuilder::domain_file_url) / [`set_domain_file_url(Option<String>)`](crate::operation::import_firewall_domains::builders::ImportFirewallDomainsFluentBuilder::set_domain_file_url): <p>The fully qualified URL or URI of the file stored in Amazon Simple Storage Service (Amazon S3) that contains the list of domains to import.</p>  <p>The file must be in an S3 bucket that's in the same Region as your DNS Firewall. The file must be a text file and must contain a single domain per line.</p>
