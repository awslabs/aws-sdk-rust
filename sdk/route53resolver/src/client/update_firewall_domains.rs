...
impl super::Client {
    ...
    ///   - [`firewall_domain_list_id(impl ::std::convert::Into<String>)`](crate::operation::update_firewall_domains::builders::UpdateFirewallDomainsFluentBuilder::firewall_domain_list_id) / [`set_firewall_domain_list_id(Option<String>)`](crate::operation::update_firewall_domains::builders::UpdateFirewallDomainsFluentBuilder::set_firewall_domain_list_id): <p>The ID of the domain list whose domains you want to update. </p>
