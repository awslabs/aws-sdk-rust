...
impl super::Client {
    ...
    ///   - [`resource_id(impl Into<String>)`](crate::operation::get_resolver_dnssec_config::builders::GetResolverDnssecConfigFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::get_resolver_dnssec_config::builders::GetResolverDnssecConfigFluentBuilder::set_resource_id):<br>required: **true**<br><p>The ID of the virtual private cloud (VPC) for the DNSSEC validation status.</p><br>
