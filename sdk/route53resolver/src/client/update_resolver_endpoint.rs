...
impl super::Client {
    ...
    ///   - [`resolver_endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::update_resolver_endpoint::builders::UpdateResolverEndpointFluentBuilder::resolver_endpoint_id) / [`set_resolver_endpoint_id(Option<String>)`](crate::operation::update_resolver_endpoint::builders::UpdateResolverEndpointFluentBuilder::set_resolver_endpoint_id): <p>The ID of the Resolver endpoint that you want to update.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_resolver_endpoint::builders::UpdateResolverEndpointFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_resolver_endpoint::builders::UpdateResolverEndpointFluentBuilder::set_name): <p>The name of the Resolver endpoint that you want to update.</p>
    ...
    ///   - [`update_ip_addresses(Vec<UpdateIpAddress>)`](crate::operation::update_resolver_endpoint::builders::UpdateResolverEndpointFluentBuilder::update_ip_addresses) / [`set_update_ip_addresses(Option<Vec<UpdateIpAddress>>)`](crate::operation::update_resolver_endpoint::builders::UpdateResolverEndpointFluentBuilder::set_update_ip_addresses): <p> Specifies the IPv6 address when you update the Resolver endpoint from IPv4 to dual-stack. If you don't specify an IPv6 address, one will be automatically chosen from your subnet. </p>
