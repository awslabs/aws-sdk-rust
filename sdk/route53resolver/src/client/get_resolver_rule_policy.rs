...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_resolver_rule_policy::builders::GetResolverRulePolicyFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_resolver_rule_policy::builders::GetResolverRulePolicyFluentBuilder::set_arn): <p>The ID of the Resolver rule that you want to get the Resolver rule policy for.</p>
