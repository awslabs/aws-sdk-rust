...
impl super::Client {
    /// Constructs a fluent builder for the [`PutResolverQueryLogConfigPolicy`](crate::operation::put_resolver_query_log_config_policy::builders::PutResolverQueryLogConfigPolicyFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`arn(impl Into<String>)`](crate::operation::put_resolver_query_log_config_policy::builders::PutResolverQueryLogConfigPolicyFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::put_resolver_query_log_config_policy::builders::PutResolverQueryLogConfigPolicyFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the account that you want to share rules with.</p><br>
    ///   - [`resolver_query_log_config_policy(impl Into<String>)`](crate::operation::put_resolver_query_log_config_policy::builders::PutResolverQueryLogConfigPolicyFluentBuilder::resolver_query_log_config_policy) / [`set_resolver_query_log_config_policy(Option<String>)`](crate::operation::put_resolver_query_log_config_policy::builders::PutResolverQueryLogConfigPolicyFluentBuilder::set_resolver_query_log_config_policy):<br>required: **true**<br><p>An Identity and Access Management policy statement that lists the query logging configurations that you want to share with another Amazon Web Services account and the operations that you want the account to be able to perform. You can specify the following operations in the <code>Actions</code> section of the statement:</p> <ul>  <li>   <p><code>route53resolver:AssociateResolverQueryLogConfig</code></p></li>  <li>   <p><code>route53resolver:DisassociateResolverQueryLogConfig</code></p></li>  <li>   <p><code>route53resolver:ListResolverQueryLogConfigs</code></p></li> </ul> <p>In the <code>Resource</code> section of the statement, you specify the ARNs for the query logging configurations that you want to share with the account that you specified in <code>Arn</code>.</p><br>
