...
impl super::Client {
    ...
    ///   - [`outpost_arn(impl Into<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::outpost_arn) / [`set_outpost_arn(Option<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::set_outpost_arn): <p>The Amazon Resource Name (ARN) of the Outpost.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::set_next_token): <p>For the first <code>ListOutpostResolver</code> request, omit this value.</p>  <p></p>
