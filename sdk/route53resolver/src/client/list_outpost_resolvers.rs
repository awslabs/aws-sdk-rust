...
impl super::Client {
    ...
    ///   - [`outpost_arn(impl ::std::convert::Into<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::outpost_arn) / [`set_outpost_arn(Option<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::set_outpost_arn): <p>The Amazon Resource Name (ARN) of the Outpost.</p>
    ///   - [`max_results(i32)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::set_max_results): <p>The maximum number of Resolvers on the Outpost that you want to return in the response to a <code>ListOutpostResolver</code> request. If you don't specify a value for <code>MaxResults</code>, the request returns up to 100 Resolvers.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_outpost_resolvers::builders::ListOutpostResolversFluentBuilder::set_next_token): <p>For the first <code>ListOutpostResolver</code> request, omit this value.</p>  <p></p>
