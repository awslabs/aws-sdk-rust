...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_resolver_endpoints::builders::ListResolverEndpointsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_resolver_endpoints::builders::ListResolverEndpointsFluentBuilder::set_max_results): <p>The maximum number of Resolver endpoints that you want to return in the response to a <code>ListResolverEndpoints</code> request. If you don't specify a value for <code>MaxResults</code>, Resolver returns up to 100 Resolver endpoints. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_resolver_endpoints::builders::ListResolverEndpointsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_resolver_endpoints::builders::ListResolverEndpointsFluentBuilder::set_next_token): <p>For the first <code>ListResolverEndpoints</code> request, omit this value.</p>  <p>If you have more than <code>MaxResults</code> Resolver endpoints, you can submit another <code>ListResolverEndpoints</code> request to get the next group of Resolver endpoints. In the next request, specify the value of <code>NextToken</code> from the previous response. </p>
    ///   - [`filters(Vec<Filter>)`](crate::operation::list_resolver_endpoints::builders::ListResolverEndpointsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_resolver_endpoints::builders::ListResolverEndpointsFluentBuilder::set_filters): <p>An optional specification to return a subset of Resolver endpoints, such as all inbound Resolver endpoints.</p> <note>   <p>If you submit a second or subsequent <code>ListResolverEndpoints</code> request and specify the <code>NextToken</code> parameter, you must use the same values for <code>Filters</code>, if any, as in the previous request.</p>  </note>
