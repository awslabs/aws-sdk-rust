...
impl super::Client {
    ...
    ///   - [`resolver_endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::associate_resolver_endpoint_ip_address::builders::AssociateResolverEndpointIpAddressFluentBuilder::resolver_endpoint_id) / [`set_resolver_endpoint_id(Option<String>)`](crate::operation::associate_resolver_endpoint_ip_address::builders::AssociateResolverEndpointIpAddressFluentBuilder::set_resolver_endpoint_id): <p>The ID of the Resolver endpoint that you want to associate IP addresses with.</p>
