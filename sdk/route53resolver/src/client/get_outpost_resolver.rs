...
impl super::Client {
    ...
    pub fn get_outpost_resolver(
        &self,
    ) -> crate::operation::get_outpost_resolver::builders::GetOutpostResolverFluentBuilder {
        crate::operation::get_outpost_resolver::builders::GetOutpostResolverFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
