...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_resolver_query_log_config_policy::builders::GetResolverQueryLogConfigPolicyFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_resolver_query_log_config_policy::builders::GetResolverQueryLogConfigPolicyFluentBuilder::set_arn): <p>The ARN of the query logging configuration that you want to get the query logging policy for.</p>
