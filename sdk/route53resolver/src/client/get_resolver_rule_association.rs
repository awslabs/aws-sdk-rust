...
impl super::Client {
    ...
    ///   - [`resolver_rule_association_id(impl ::std::convert::Into<String>)`](crate::operation::get_resolver_rule_association::builders::GetResolverRuleAssociationFluentBuilder::resolver_rule_association_id) / [`set_resolver_rule_association_id(Option<String>)`](crate::operation::get_resolver_rule_association::builders::GetResolverRuleAssociationFluentBuilder::set_resolver_rule_association_id): <p>The ID of the Resolver rule association that you want to get information about.</p>
