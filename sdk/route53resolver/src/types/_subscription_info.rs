...
/// <p>Identifies the Amazon Web Services Marketplace product that backs a partner-managed rule type. Returned as part of <code>FirewallRuleTypeDefinition</code> when the rule type variant requires an active customer subscription to the named product.</p>
#[non_exhaustive]
