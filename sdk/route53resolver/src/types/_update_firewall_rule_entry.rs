...
pub struct UpdateFirewallRuleEntry {
...
impl UpdateFirewallRuleEntry {
    /// Creates a new builder-style object to manufacture [`UpdateFirewallRuleEntry`](crate::types::UpdateFirewallRuleEntry).
    pub fn builder() -> crate::types::builders::UpdateFirewallRuleEntryBuilder {
        crate::types::builders::UpdateFirewallRuleEntryBuilder::default()
    }
}

/// A builder for [`UpdateFirewallRuleEntry`](crate::types::UpdateFirewallRuleEntry).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateFirewallRuleEntryBuilder {
...
impl UpdateFirewallRuleEntryBuilder {
    /// <p>The unique identifier of the firewall rule group for the rule.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateFirewallRuleEntry`](crate::types::UpdateFirewallRuleEntry).
    /// This method will fail if any of the following fields are not set:
    /// - [`firewall_rule_group_id`](crate::types::builders::UpdateFirewallRuleEntryBuilder::firewall_rule_group_id)
    pub fn build(self) -> ::std::result::Result<crate::types::UpdateFirewallRuleEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::UpdateFirewallRuleEntry {
            firewall_rule_group_id: self.firewall_rule_group_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "firewall_rule_group_id",
                    "firewall_rule_group_id was not specified but it is required when building UpdateFirewallRuleEntry",
                )
            })?,
