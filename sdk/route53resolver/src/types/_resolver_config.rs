...
pub struct ResolverConfig {
    ...
    /// <ul>
    /// <li>
    /// <p><b>ENABLING:</b> Autodefined rules for reverse DNS lookups are being enabled but are not complete.</p></li>
    /// <li>
    /// <p><b>ENABLED:</b> Autodefined rules for reverse DNS lookups are enabled.</p></li>
    /// <li>
    /// <p><b>DISABLING:</b> Autodefined rules for reverse DNS lookups are being disabled but are not complete.</p></li>
    /// <li>
    /// <p><b>DISABLED:</b> Autodefined rules for reverse DNS lookups are disabled.</p></li>
    /// </ul>
