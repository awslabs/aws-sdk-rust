...
impl IpAddressStatus {
    ...
    IpAddressStatus::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["ATTACHED", "ATTACHING", "CREATING", "DELETE_FAILED_FAS_EXPIRED", "DELETING", "DETACHING", "FAILED_CREATION", "FAILED_RESOURCE_GONE", "REMAP_ATTACHING", "REMAP_DETACHING", "UPDATING"]
                }
            }
