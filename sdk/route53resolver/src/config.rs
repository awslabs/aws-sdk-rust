...
impl Builder {
    ...
    /// use aws_sdk_route53resolver::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_route53resolver::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
