...
impl Builder {
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("route53resolver"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("route53resolver"));
        layer
