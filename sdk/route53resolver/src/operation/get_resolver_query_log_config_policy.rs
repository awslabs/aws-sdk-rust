...
impl GetResolverQueryLogConfigPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResolverQueryLogConfigPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resolver_query_log_config_policy::de_get_resolver_query_log_config_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
