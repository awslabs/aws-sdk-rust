...
impl ListResolverConfigsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_resolver_configs::paginator::ListResolverConfigsPaginator {
        crate::operation::list_resolver_configs::paginator::ListResolverConfigsPaginator::new(
            self.handle,
            self.inner,
        )
    }
