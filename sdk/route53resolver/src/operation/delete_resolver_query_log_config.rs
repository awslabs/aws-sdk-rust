...
impl DeleteResolverQueryLogConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_resolver_query_log_config::DeleteResolverQueryLogConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResolverQueryLogConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_resolver_query_log_config::de_delete_resolver_query_log_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
