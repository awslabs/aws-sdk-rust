        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_resolver_endpoint_ip_addresses::ListResolverEndpointIpAddresses::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl ListResolverEndpointIpAddressesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_resolver_endpoint_ip_addresses_output_output_ip_addresses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
