...
impl crate::operation::list_resolver_endpoint_ip_addresses::builders::ListResolverEndpointIpAddressesInputBuilder {
...
impl ListResolverEndpointIpAddressesFluentBuilder {
    /// Creates a new `ListResolverEndpointIpAddressesFluentBuilder`.
