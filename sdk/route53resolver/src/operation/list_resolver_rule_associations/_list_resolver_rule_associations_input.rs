...
impl ListResolverRuleAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resolver_rule_associations::ListResolverRuleAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
