...
impl AssociateFirewallRuleGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupInput, ::aws_smithy_types::error::operation::BuildError> {
