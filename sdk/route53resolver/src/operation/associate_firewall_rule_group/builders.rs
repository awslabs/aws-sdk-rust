...
impl AssociateFirewallRuleGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupOutput, crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupError, Self> {
