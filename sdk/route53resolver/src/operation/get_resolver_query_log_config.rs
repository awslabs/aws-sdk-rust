...
impl GetResolverQueryLogConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfig,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResolverQueryLogConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resolver_query_log_config::de_get_resolver_query_log_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
