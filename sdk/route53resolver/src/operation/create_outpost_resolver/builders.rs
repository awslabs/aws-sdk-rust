...
impl CreateOutpostResolverFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_outpost_resolver::CreateOutpostResolverOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_outpost_resolver::CreateOutpostResolverError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_outpost_resolver::CreateOutpostResolverOutput, crate::operation::create_outpost_resolver::CreateOutpostResolverError, Self> {
