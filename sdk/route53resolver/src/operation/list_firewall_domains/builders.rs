...
impl ListFirewallDomainsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_firewall_domains::ListFirewallDomainsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_firewall_domains::ListFirewallDomainsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_firewall_domains::ListFirewallDomainsOutput, crate::operation::list_firewall_domains::ListFirewallDomainsError, Self> {
