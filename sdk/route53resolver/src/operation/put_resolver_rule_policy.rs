...
impl PutResolverRulePolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutResolverRulePolicy`](crate::operation::put_resolver_rule_policy::PutResolverRulePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_resolver_rule_policy::PutResolverRulePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_resolver_rule_policy::PutResolverRulePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_resolver_rule_policy::PutResolverRulePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutResolverRulePolicy", "route53resolver"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutResolverRulePolicy {
                type Output = std::result::Result<crate::operation::put_resolver_rule_policy::PutResolverRulePolicyOutput, crate::operation::put_resolver_rule_policy::PutResolverRulePolicyError>;
