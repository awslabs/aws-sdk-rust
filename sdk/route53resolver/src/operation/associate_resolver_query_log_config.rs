...
impl AssociateResolverQueryLogConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_resolver_query_log_config::AssociateResolverQueryLogConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateResolverQueryLogConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_resolver_query_log_config::de_associate_resolver_query_log_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
