...
impl AssociateResolverQueryLogConfig {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_resolver_query_log_config::AssociateResolverQueryLogConfigOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateResolverQueryLogConfigResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateResolverQueryLogConfigRequestSerializer {
