...
impl DeleteFirewallRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_firewall_rule::ser_delete_firewall_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFirewallRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_firewall_rule::de_delete_firewall_rule_http_response_with_props(status, headers, body)
        }
    }
}
