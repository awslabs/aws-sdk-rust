...
impl ListFirewallRuleGroupAssociationsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_firewall_rule_group_associations::ListFirewallRuleGroupAssociationsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
