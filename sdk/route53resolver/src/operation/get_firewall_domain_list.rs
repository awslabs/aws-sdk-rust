...
impl GetFirewallDomainListInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_firewall_domain_list::GetFirewallDomainList,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFirewallDomainList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_firewall_domain_list::de_get_firewall_domain_list_http_response_with_props(status, headers, body)
        }
    }
}
