...
impl ListFirewallDomainListsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_firewall_domain_lists::ListFirewallDomainListsInput, ::aws_smithy_types::error::operation::BuildError> {
