...
impl GetResolverRulePolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::get_resolver_rule_policy::GetResolverRulePolicy::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyOutput, crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError, Self> {
