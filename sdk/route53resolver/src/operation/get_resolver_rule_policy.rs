...
/// Orchestration and serialization glue logic for `GetResolverRulePolicy`.
...
impl GetResolverRulePolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_resolver_rule_policy::GetResolverRulePolicyInput,
                    ) -> ::std::result::Result<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetResolverRulePolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetResolverRulePolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetResolverRulePolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetResolverRulePolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetResolverRulePolicy")
...
.with_interceptor(GetResolverRulePolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError>::new());
...
#[derive(Debug)]
            struct GetResolverRulePolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetResolverRulePolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_resolver_rule_policy::de_get_resolver_rule_policy_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetResolverRulePolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetResolverRulePolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_resolver_rule_policy::GetResolverRulePolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_resolver_rule_policy::GetResolverRulePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_resolver_rule_policy::ser_get_resolver_rule_policy_input(&input)?);
...
#[derive(Debug)]
            struct GetResolverRulePolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetResolverRulePolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetResolverRulePolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetResolverRulePolicyInput>()
                        .ok_or("failed to downcast to GetResolverRulePolicyInput")?;
...
pub enum GetResolverRulePolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetResolverRulePolicyError) for what information is available for the error.")]
...
impl GetResolverRulePolicyError {
    /// Creates the `GetResolverRulePolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetResolverRulePolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetResolverRulePolicyError::AccessDeniedException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetResolverRulePolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_resolver_rule_policy::GetResolverRulePolicyError {
...
mod _get_resolver_rule_policy_output;
