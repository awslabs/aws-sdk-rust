...
impl UpdateFirewallRuleGroupAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_firewall_rule_group_association::UpdateFirewallRuleGroupAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFirewallRuleGroupAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_firewall_rule_group_association::de_update_firewall_rule_group_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
