...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFirewallRuleGroupPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_firewall_rule_group_policy::de_get_firewall_rule_group_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_firewall_rule_group_policy::GetFirewallRuleGroupPolicyError
{
