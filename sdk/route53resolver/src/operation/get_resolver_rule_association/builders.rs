...
impl GetResolverRuleAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_resolver_rule_association::GetResolverRuleAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resolver_rule_association::GetResolverRuleAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_resolver_rule_association::GetResolverRuleAssociationOutput, crate::operation::get_resolver_rule_association::GetResolverRuleAssociationError, Self> {
