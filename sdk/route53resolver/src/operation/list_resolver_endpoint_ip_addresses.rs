...
impl ListResolverEndpointIpAddressesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resolver_endpoint_ip_addresses::ListResolverEndpointIpAddresses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResolverEndpointIpAddresses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resolver_endpoint_ip_addresses::de_list_resolver_endpoint_ip_addresses_http_response_with_props(
                status, headers, body,
            )
        }
    }
