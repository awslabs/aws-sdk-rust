...
pub use crate::operation::list_outpost_resolvers::_list_outpost_resolvers_output::ListOutpostResolversOutputBuilder;
...
pub struct ListOutpostResolversFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_outpost_resolvers::builders::ListOutpostResolversInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_outpost_resolvers::ListOutpostResolversOutput,
                    crate::operation::list_outpost_resolvers::ListOutpostResolversError,
                > for ListOutpostResolversFluentBuilder
            {
                fn send(
                    self,
...
impl ListOutpostResolversFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_outpost_resolvers::ListOutpostResolversOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_outpost_resolvers::ListOutpostResolversError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_outpost_resolvers::ListOutpostResolvers::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_outpost_resolvers::ListOutpostResolversOutput, crate::operation::list_outpost_resolvers::ListOutpostResolversError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_outpost_resolvers::paginator::ListOutpostResolversPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
