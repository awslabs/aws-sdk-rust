...
impl ListResolverDnssecConfigsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resolver_dnssec_configs::ListResolverDnssecConfigs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResolverDnssecConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resolver_dnssec_configs::de_list_resolver_dnssec_configs_http_response_with_props(status, headers, body)
        }
    }
}
