...
impl CreateFirewallDomainListFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_firewall_domain_list::CreateFirewallDomainListOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_firewall_domain_list::CreateFirewallDomainListError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_firewall_domain_list::CreateFirewallDomainListOutput, crate::operation::create_firewall_domain_list::CreateFirewallDomainListError, Self> {
