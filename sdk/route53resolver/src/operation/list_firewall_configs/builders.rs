...
impl ListFirewallConfigsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_firewall_configs::ListFirewallConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_firewall_configs::ListFirewallConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_firewall_configs::ListFirewallConfigsOutput, crate::operation::list_firewall_configs::ListFirewallConfigsError, Self> {
