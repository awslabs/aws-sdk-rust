...
impl ListFirewallConfigsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_firewall_configs::ListFirewallConfigsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_firewall_configs::ListFirewallConfigsInput {
