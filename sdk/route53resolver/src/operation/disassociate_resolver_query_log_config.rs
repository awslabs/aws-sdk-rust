...
impl DisassociateResolverQueryLogConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_resolver_query_log_config::DisassociateResolverQueryLogConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateResolverQueryLogConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_resolver_query_log_config::de_disassociate_resolver_query_log_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
