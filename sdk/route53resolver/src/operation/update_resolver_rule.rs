...
impl UpdateResolverRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_resolver_rule::UpdateResolverRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateResolverRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_resolver_rule::de_update_resolver_rule_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_resolver_rule::UpdateResolverRuleError
{
