...
impl UpdateResolverRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_resolver_rule::ser_update_resolver_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateResolverRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_resolver_rule::de_update_resolver_rule_http_response_with_props(status, headers, body)
        }
    }
}
