...
impl CreateResolverQueryLogConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_resolver_query_log_config::CreateResolverQueryLogConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResolverQueryLogConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_resolver_query_log_config::de_create_resolver_query_log_config_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateResolverQueryLogConfigError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_resolver_query_log_config::CreateResolverQueryLogConfigError
{
