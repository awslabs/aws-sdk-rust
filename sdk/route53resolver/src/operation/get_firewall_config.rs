...
impl GetFirewallConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_firewall_config::GetFirewallConfig,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_firewall_config::ser_get_firewall_config_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFirewallConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_firewall_config::de_get_firewall_config_http_response_with_props(status, headers, body)
        }
    }
}
