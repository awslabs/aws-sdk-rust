...
impl GetFirewallConfigInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_firewall_config::GetFirewallConfig::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetFirewallConfig {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_firewall_config::de_get_firewall_config_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_firewall_config::GetFirewallConfigError
{
