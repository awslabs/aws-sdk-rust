...
impl ListFirewallRulesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_firewall_rules::ListFirewallRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFirewallRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_firewall_rules::de_list_firewall_rules_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_firewall_rules::ListFirewallRulesError
{
