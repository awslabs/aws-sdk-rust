...
impl ListFirewallRulesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_firewall_rules::ser_list_firewall_rules_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFirewallRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_firewall_rules::de_list_firewall_rules_http_response_with_props(status, headers, body)
        }
    }
}
