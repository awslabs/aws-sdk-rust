...
impl ListResolverRulesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_resolver_rules::ser_list_resolver_rules_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResolverRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resolver_rules::de_list_resolver_rules_http_response_with_props(status, headers, body)
        }
    }
}
