...
impl ListResolverRulesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resolver_rules::ListResolverRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResolverRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_resolver_rules::de_list_resolver_rules_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_resolver_rules::ListResolverRulesError
{
