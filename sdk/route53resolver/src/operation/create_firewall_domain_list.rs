...
impl CreateFirewallDomainListInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_firewall_domain_list::CreateFirewallDomainList::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFirewallDomainList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_firewall_domain_list::de_create_firewall_domain_list_http_response_with_props(status, headers, body)
        }
    }
}
