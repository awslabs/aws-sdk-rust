...
impl ImportFirewallDomainsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::import_firewall_domains::ImportFirewallDomainsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_firewall_domains::ImportFirewallDomainsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::import_firewall_domains::ImportFirewallDomainsOutput, crate::operation::import_firewall_domains::ImportFirewallDomainsError, Self> {
