...
impl ListFirewallConfigsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_firewall_configs::ListFirewallConfigs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFirewallConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_firewall_configs::de_list_firewall_configs_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_firewall_configs::ListFirewallConfigsError
{
