...
pub use crate::operation::list_resolver_rules::_list_resolver_rules_output::ListResolverRulesOutputBuilder;

pub use crate::operation::list_resolver_rules::_list_resolver_rules_input::ListResolverRulesInputBuilder;
...
pub struct ListResolverRulesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_resolver_rules::builders::ListResolverRulesInputBuilder,
...
impl ListResolverRulesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_resolver_rules::ListResolverRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_resolver_rules::ListResolverRules::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_resolver_rules::ListResolverRulesOutput, crate::operation::list_resolver_rules::ListResolverRulesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_resolver_rules::paginator::ListResolverRulesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
