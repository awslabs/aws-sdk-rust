...
/// Paginator for [`ListResolverRules`](crate::operation::list_resolver_rules::ListResolverRules)
                ...
                impl ListResolverRulesPaginator {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::list_resolver_rules::ListResolverRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
...
/// Flattened paginator for `ListResolverRulesPaginator`
                    ...
                    impl ListResolverRulesPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::ResolverRule, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_resolver_rules_output_output_resolver_rules(page).unwrap_or_default().into_iter())
                        }
                    }
