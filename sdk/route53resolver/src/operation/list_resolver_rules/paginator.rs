...
impl ListResolverRulesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_resolver_rules::paginator::ListResolverRulesPaginatorItems {
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_resolver_rules_output_next_token(resp);
...
impl ListResolverRulesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_resolver_rules_output_resolver_rules(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
