...
/// Paginator for [`ListResolverRules`](crate::operation::list_resolver_rules::ListResolverRules)
            ...
            impl ListResolverRulesPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_resolver_rules::builders::ListResolverRulesInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_resolver_rules::ListResolverRulesOutput, aws_smithy_http::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_resolver_rules_output_next_token(resp);
...
/// Flattened paginator for `ListResolverRulesPaginator`
                ...
                impl  ListResolverRulesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::ResolverRule, aws_smithy_http::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_resolver_rules_output_resolver_rules(page).unwrap_or_default().into_iter())
                    }
                }
