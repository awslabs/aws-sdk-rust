...
impl AssociateResolverEndpointIpAddressInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_resolver_endpoint_ip_address::AssociateResolverEndpointIpAddress,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_resolver_endpoint_ip_address::AssociateResolverEndpointIpAddress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateResolverEndpointIpAddress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_resolver_endpoint_ip_address::de_associate_resolver_endpoint_ip_address_http_response_with_props(
                status, headers, body,
            )
        }
    }
