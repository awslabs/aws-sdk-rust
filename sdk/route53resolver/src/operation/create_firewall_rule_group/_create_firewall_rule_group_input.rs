...
impl CreateFirewallRuleGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_firewall_rule_group::CreateFirewallRuleGroupInput, ::aws_smithy_types::error::operation::BuildError> {
