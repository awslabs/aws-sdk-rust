...
impl UpdateResolverDnssecConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_resolver_dnssec_config::UpdateResolverDnssecConfigInput, ::aws_smithy_types::error::operation::BuildError> {
