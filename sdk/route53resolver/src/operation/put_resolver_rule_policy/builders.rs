...
impl PutResolverRulePolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_resolver_rule_policy::PutResolverRulePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_resolver_rule_policy::PutResolverRulePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_resolver_rule_policy::PutResolverRulePolicyOutput, crate::operation::put_resolver_rule_policy::PutResolverRulePolicyError, Self> {
