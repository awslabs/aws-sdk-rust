...
impl ListResolverConfigsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_resolver_configs::ListResolverConfigs,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResolverConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resolver_configs::de_list_resolver_configs_http_response_with_props(status, headers, body)
        }
    }
}
