    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_outpost_resolver::UpdateOutpostResolverError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_outpost_resolver::UpdateOutpostResolverOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateOutpostResolverResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateOutpostResolverRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_outpost_resolver::UpdateOutpostResolverInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_outpost_resolver::ser_update_outpost_resolver_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateOutpostResolverEndpointParamsInterceptor {
...
pub type UpdateOutpostResolverErrorKind = UpdateOutpostResolverError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateOutpostResolverError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_outpost_resolver::UpdateOutpostResolverError {
...
impl UpdateOutpostResolverError {
    ...
    /// Creates the `UpdateOutpostResolverError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
