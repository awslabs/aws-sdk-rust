...
impl UpdateResolverConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_resolver_config::UpdateResolverConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_resolver_config::UpdateResolverConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_resolver_config::UpdateResolverConfigOutput, crate::operation::update_resolver_config::UpdateResolverConfigError, Self> {
