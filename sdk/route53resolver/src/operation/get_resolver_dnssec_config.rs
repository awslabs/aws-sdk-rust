...
impl GetResolverDnssecConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_resolver_dnssec_config::GetResolverDnssecConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResolverDnssecConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resolver_dnssec_config::de_get_resolver_dnssec_config_http_response_with_props(status, headers, body)
        }
    }
}
