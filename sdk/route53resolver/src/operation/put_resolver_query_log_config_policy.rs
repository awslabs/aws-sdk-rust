...
impl PutResolverQueryLogConfigPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_resolver_query_log_config_policy::PutResolverQueryLogConfigPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutResolverQueryLogConfigPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_resolver_query_log_config_policy::de_put_resolver_query_log_config_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
