...
impl DeleteFirewallDomainListInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_firewall_domain_list::DeleteFirewallDomainListInput, ::aws_smithy_types::error::operation::BuildError> {
