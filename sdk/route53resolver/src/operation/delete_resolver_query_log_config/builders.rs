...
impl DeleteResolverQueryLogConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_resolver_query_log_config::DeleteResolverQueryLogConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_resolver_query_log_config::DeleteResolverQueryLogConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_resolver_query_log_config::DeleteResolverQueryLogConfigOutput, crate::operation::delete_resolver_query_log_config::DeleteResolverQueryLogConfigError, Self> {
