...
impl UpdateFirewallRuleFluentBuilder  {
    /// Creates a new `UpdateFirewallRule`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_firewall_rule::UpdateFirewallRule, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::update_firewall_rule::UpdateFirewallRuleError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_firewall_rule::UpdateFirewallRuleOutput, aws_smithy_http::result::SdkError<crate::operation::update_firewall_rule::UpdateFirewallRuleError>>
                     {
