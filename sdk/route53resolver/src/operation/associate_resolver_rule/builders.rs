...
impl AssociateResolverRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_resolver_rule::AssociateResolverRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_resolver_rule::AssociateResolverRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_resolver_rule::AssociateResolverRuleOutput, crate::operation::associate_resolver_rule::AssociateResolverRuleError, Self> {
