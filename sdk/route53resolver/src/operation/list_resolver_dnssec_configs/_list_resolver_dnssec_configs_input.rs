...
impl ListResolverDnssecConfigsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resolver_dnssec_configs::ListResolverDnssecConfigsInput, ::aws_smithy_types::error::operation::BuildError> {
