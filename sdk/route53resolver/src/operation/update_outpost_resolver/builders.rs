...
impl UpdateOutpostResolverFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_outpost_resolver::UpdateOutpostResolverOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_outpost_resolver::UpdateOutpostResolverError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_outpost_resolver::UpdateOutpostResolverOutput, crate::operation::update_outpost_resolver::UpdateOutpostResolverError, Self> {
