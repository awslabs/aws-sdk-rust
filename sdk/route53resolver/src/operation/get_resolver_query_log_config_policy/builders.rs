...
impl crate::operation::get_resolver_query_log_config_policy::builders::GetResolverQueryLogConfigPolicyInputBuilder {
...
impl GetResolverQueryLogConfigPolicyFluentBuilder {
    /// Creates a new `GetResolverQueryLogConfigPolicyFluentBuilder`.
