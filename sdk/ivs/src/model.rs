...
pub struct Channel  {
    ...
    #[doc(hidden)]pub ingest_endpoint: std::option::Option<std::string::String>,
...
pub struct StreamSessionSummary  {
    ...
    #[doc(hidden)]pub has_error_event: bool,
}
...
pub struct StreamSummary  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::StreamState>,
    /// <p>The stream’s health.</p>
    #[doc(hidden)]pub health: std::option::Option<crate::model::StreamHealth>,
    ...
    #[doc(hidden)]pub viewer_count: i64,
...
pub struct RecordingConfigurationSummary  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::RecordingConfigurationState>,
    /// <p>Array of 1-50 maps, each of the form <code>string:string (key:value)</code>. See <a href="https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html">Tagging Amazon Web Services Resources</a> for more information, including restrictions that apply to tags and "Tag naming limits and requirements"; Amazon IVS has no service-specific constraints beyond what is documented there.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct DestinationConfiguration  {
    ...
    #[doc(hidden)]pub s3: std::option::Option<crate::model::S3DestinationConfiguration>,
}
...
pub struct StreamSession  {
    ...
    #[doc(hidden)]pub ingest_configuration: std::option::Option<crate::model::IngestConfiguration>,
    ...
    #[doc(hidden)]pub truncated_events: std::option::Option<std::vec::Vec<crate::model::StreamEvent>>,
}
impl StreamSession {
    /// <p>Unique identifier for a live or previously live stream in the specified channel.</p>
    pub fn stream_id(&self) -> std::option::Option<& str> {
...
pub struct ThumbnailConfiguration  {
    ...
    #[doc(hidden)]pub recording_mode: std::option::Option<crate::model::RecordingMode>,
    ...
    #[doc(hidden)]pub target_interval_seconds: i64,
}
...
pub struct IngestConfiguration  {
    ...
    #[doc(hidden)]pub video: std::option::Option<crate::model::VideoConfiguration>,
    /// <p>Encoder settings for audio.</p>
    #[doc(hidden)]pub audio: std::option::Option<crate::model::AudioConfiguration>,
}
...
pub struct AudioConfiguration  {
    ...
    #[doc(hidden)]pub target_bitrate: i64,
    /// <p>Number of audio samples recorded per second.</p>
    #[doc(hidden)]pub sample_rate: i64,
    /// <p>Number of audio channels.</p>
    #[doc(hidden)]pub channels: i64,
}
...
pub struct VideoConfiguration  {
    ...
    #[doc(hidden)]pub avc_profile: std::option::Option<std::string::String>,
