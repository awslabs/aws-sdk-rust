...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_recording_configuration::builders::DeleteRecordingConfigurationFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::delete_recording_configuration::builders::DeleteRecordingConfigurationFluentBuilder::set_arn):<br>required: **true**<br><p>ARN of the recording configuration to be deleted.</p><br>
