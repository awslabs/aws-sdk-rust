...
impl super::Client {
    ...
    ///   - [`channel_arn(impl Into<String>)`](crate::operation::get_stream_session::builders::GetStreamSessionFluentBuilder::channel_arn) / [`set_channel_arn(impl Into<String>)`](crate::operation::get_stream_session::builders::GetStreamSessionFluentBuilder::set_channel_arn):<br>required: **true**<br><p>ARN of the channel resource</p><br>
