...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::get_stream_session::builders::GetStreamSessionFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::get_stream_session::builders::GetStreamSessionFluentBuilder::set_channel_arn): <p>ARN of the channel resource</p>
    ///   - [`stream_id(impl ::std::convert::Into<String>)`](crate::operation::get_stream_session::builders::GetStreamSessionFluentBuilder::stream_id) / [`set_stream_id(Option<String>)`](crate::operation::get_stream_session::builders::GetStreamSessionFluentBuilder::set_stream_id): <p>Unique identifier for a live or previously live stream in the specified channel. If no <code>streamId</code> is provided, this returns the most recent stream session for the channel, if it exists.</p>
