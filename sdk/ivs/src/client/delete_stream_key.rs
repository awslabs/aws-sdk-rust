...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_stream_key::builders::DeleteStreamKeyFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::delete_stream_key::builders::DeleteStreamKeyFluentBuilder::set_arn):<br>required: **true**<br><p>ARN of the stream key to be deleted.</p><br>
