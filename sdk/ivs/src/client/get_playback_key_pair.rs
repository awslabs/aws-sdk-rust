...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_playback_key_pair::builders::GetPlaybackKeyPairFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_playback_key_pair::builders::GetPlaybackKeyPairFluentBuilder::set_arn):<br>required: **true**<br><p>ARN of the key pair to be returned.</p><br>
