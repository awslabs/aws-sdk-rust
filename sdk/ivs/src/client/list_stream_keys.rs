...
impl super::Client {
    ...
    ///   - [`channel_arn(impl Into<String>)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::channel_arn) / [`set_channel_arn(impl Into<String>)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::set_channel_arn):<br>required: **true**<br><p>Channel ARN used to filter the list.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::set_max_results):<br>required: **false**<br><p>Maximum number of streamKeys to return. Default: 1.</p><br>
