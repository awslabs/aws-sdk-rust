...
impl super::Client {
    ...
    pub fn list_playback_restriction_policies(&self) -> crate::operation::list_playback_restriction_policies::builders::ListPlaybackRestrictionPoliciesFluentBuilder {
