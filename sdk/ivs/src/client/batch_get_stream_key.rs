...
impl super::Client {
    ...
    ///   - [`arns(impl Into<String>)`](crate::operation::batch_get_stream_key::builders::BatchGetStreamKeyFluentBuilder::arns) / [`set_arns(Vec<String>)`](crate::operation::batch_get_stream_key::builders::BatchGetStreamKeyFluentBuilder::set_arns):<br>required: **true**<br><p>Array of ARNs, one per stream key.</p><br>
