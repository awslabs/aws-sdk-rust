...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_channel::builders::GetChannelFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::get_channel::builders::GetChannelFluentBuilder::set_arn):<br>required: **true**<br><p>ARN of the channel for which the configuration is to be retrieved.</p><br>
