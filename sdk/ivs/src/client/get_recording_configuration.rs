...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_recording_configuration::builders::GetRecordingConfigurationFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_recording_configuration::builders::GetRecordingConfigurationFluentBuilder::set_arn): <p>ARN of the recording configuration to be retrieved.</p>
