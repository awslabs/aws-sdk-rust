...
impl super::Client {
    ...
    ///   - [`channel_arn(impl Into<String>)`](crate::operation::get_stream::builders::GetStreamFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::get_stream::builders::GetStreamFluentBuilder::set_channel_arn):<br>required: **true**<br><p>Channel ARN for stream to be accessed.</p><br>
