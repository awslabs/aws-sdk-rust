...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::create_stream_key::builders::CreateStreamKeyFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::create_stream_key::builders::CreateStreamKeyFluentBuilder::set_channel_arn): <p>ARN of the channel for which to create the stream key.</p>
