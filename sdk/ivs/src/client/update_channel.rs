...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_arn): <p>ARN of the channel to be updated.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_name): <p>Channel name.</p>
    ...
    ///   - [`recording_configuration_arn(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::recording_configuration_arn) / [`set_recording_configuration_arn(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_recording_configuration_arn): <p>Recording-configuration ARN. If this is set to an empty string, recording is disabled. A value other than an empty string indicates that recording is enabled</p>
