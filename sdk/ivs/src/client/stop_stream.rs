...
impl super::Client {
    ...
    ///   - [`channel_arn(impl Into<String>)`](crate::operation::stop_stream::builders::StopStreamFluentBuilder::channel_arn) / [`set_channel_arn(impl Into<String>)`](crate::operation::stop_stream::builders::StopStreamFluentBuilder::set_channel_arn):<br>required: **true**<br><p>ARN of the channel for which the stream is to be stopped.</p><br>
