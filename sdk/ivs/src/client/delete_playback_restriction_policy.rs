...
impl super::Client {
    ...
    pub fn delete_playback_restriction_policy(&self) -> crate::operation::delete_playback_restriction_policy::builders::DeletePlaybackRestrictionPolicyFluentBuilder {
