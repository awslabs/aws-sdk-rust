...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_stream_key::builders::GetStreamKeyFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::get_stream_key::builders::GetStreamKeyFluentBuilder::set_arn):<br>required: **true**<br><p>ARN for the stream key to be retrieved.</p><br>
