...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::unhandled)?;
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_import_playback_key_pair::de_import_playback_key_pair(_response_body, output)
            .map_err(crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::unhandled)?;
...
pub(crate) fn de_import_playback_key_pair(
    _value: &[u8],
    mut builder: crate::operation::import_playback_key_pair::builders::ImportPlaybackKeyPairOutputBuilder,
) -> ::std::result::Result<
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "keyPair" => {
                    builder = builder.set_key_pair(crate::protocol_serde::shape_playback_key_pair::de_playback_key_pair(tokens, _value)?);
                }
