...
pub fn ser_list_streams_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListStreamsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
