...
pub fn de_list_playback_restriction_policies_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_playback_restriction_policies::ListPlaybackRestrictionPoliciesError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::list_playback_restriction_policies::ListPlaybackRestrictionPoliciesError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = output.set_access_control_allow_origin(
                        crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(
                            |_| {
                                crate::operation::list_playback_restriction_policies::ListPlaybackRestrictionPoliciesError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_playback_restriction_policies_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_playback_restriction_policies::de_list_playback_restriction_policies(_response_body, output)
            .map_err(crate::operation::list_playback_restriction_policies::ListPlaybackRestrictionPoliciesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_playback_restriction_policies_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_playback_restriction_policies::ListPlaybackRestrictionPoliciesError::unhandled)?
    })
}

pub fn ser_list_playback_restriction_policies_input(
    input: &crate::operation::list_playback_restriction_policies::ListPlaybackRestrictionPoliciesInput,
...
pub(crate) fn de_list_playback_restriction_policies(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "playbackRestrictionPolicies" => {
                    builder = builder.set_playback_restriction_policies(
                        crate::protocol_serde::shape_playback_restriction_policy_list::de_playback_restriction_policy_list(tokens, _value)?,
                    );
                }
