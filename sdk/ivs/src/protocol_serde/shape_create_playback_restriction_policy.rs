            ...
            crate::operation::create_playback_restriction_policy::CreatePlaybackRestrictionPolicyError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = output.set_access_control_allow_origin(
                        crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(
                            |_| {
                    ...
                    output = output.set_strict_transport_security(
                        crate::protocol_serde::shape_access_denied_exception::de_strict_transport_security_header(_response_headers).map_err(
                            |_| {
                                crate::operation::create_playback_restriction_policy::CreatePlaybackRestrictionPolicyError::unhandled(
