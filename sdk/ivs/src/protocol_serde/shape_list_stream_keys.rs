...
pub fn de_list_stream_keys_http_error(
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_stream_keys::ListStreamKeysError::unhandled)?;
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_stream_keys::ListStreamKeysError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_stream_keys_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_list_stream_keys::de_list_stream_keys(_response_body, output)
            .map_err(crate::operation::list_stream_keys::ListStreamKeysError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_stream_keys_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_stream_keys::ListStreamKeysError::unhandled)?
    })
}
...
pub fn ser_list_stream_keys_input(
    ...
    crate::protocol_serde::shape_list_stream_keys_input::ser_list_stream_keys_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_list_stream_keys(
    _value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "streamKeys" => {
                    builder = builder.set_stream_keys(crate::protocol_serde::shape_stream_key_list::de_stream_key_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
