...
) -> Result<crate::operation::get_stream_session::builders::GetStreamSessionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "streamSession" => {
                    builder = builder.set_stream_session(crate::protocol_serde::shape_stream_session::de_stream_session(tokens)?);
                }
