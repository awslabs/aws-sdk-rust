...
) -> std::result::Result<crate::operation::delete_stream_key::DeleteStreamKeyOutput, crate::operation::delete_stream_key::DeleteStreamKeyError> {
    #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::delete_stream_key::DeleteStreamKeyError::unhandled(
