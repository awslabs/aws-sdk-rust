...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_recording_configuration::DeleteRecordingConfigurationError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::delete_recording_configuration::DeleteRecordingConfigurationError::unhandled(
        ...
        "ResourceNotFoundException" => {
            crate::operation::delete_recording_configuration::DeleteRecordingConfigurationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
