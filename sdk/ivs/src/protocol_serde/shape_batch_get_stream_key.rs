...
pub fn de_batch_get_stream_key_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::batch_get_stream_key::BatchGetStreamKeyError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
        ...
        "ServiceUnavailable" => crate::operation::batch_get_stream_key::BatchGetStreamKeyError::ServiceUnavailable({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::batch_get_stream_key::BatchGetStreamKeyError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::batch_get_stream_key::BatchGetStreamKeyError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_stream_key_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_stream_key::de_batch_get_stream_key(_response_body, output)
            .map_err(crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled)?;
        output = output.set_access_control_allow_origin(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
                    "Failed to parse accessControlAllowOrigin from header `Access-Control-Allow-Origin",
                )
            })?,
        ...
        output = output.set_access_control_expose_headers(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_access_control_expose_headers_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
                    "Failed to parse accessControlExposeHeaders from header `Access-Control-Expose-Headers",
                )
            })?,
        ...
        output = output.set_cache_control(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_cache_control_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled("Failed to parse cacheControl from header `Cache-Control")
            })?,
        );
        output = output.set_content_security_policy(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_content_security_policy_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
                    "Failed to parse contentSecurityPolicy from header `Content-Security-Policy",
                )
            })?,
        ...
        output = output.set_strict_transport_security(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_strict_transport_security_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
                    "Failed to parse strictTransportSecurity from header `Strict-Transport-Security",
                )
            })?,
        ...
        output = output.set_x_content_type_options(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_x_content_type_options_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
                    "Failed to parse xContentTypeOptions from header `X-Content-Type-Options",
                )
            })?,
        ...
        output = output.set_x_frame_options(
            crate::protocol_serde::shape_batch_get_stream_key_output::de_x_frame_options_header(_response_headers).map_err(|_| {
                crate::operation::batch_get_stream_key::BatchGetStreamKeyError::unhandled(
                    "Failed to parse xFrameOptions from header `X-Frame-Options",
                )
            })?,
...
pub fn ser_batch_get_stream_key_input(
    ...
    crate::protocol_serde::shape_batch_get_stream_key_input::ser_batch_get_stream_key_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "streamKeys" => {
                    builder = builder.set_stream_keys(crate::protocol_serde::shape_stream_keys::de_stream_keys(tokens, _value, depth + 1)?);
                }
