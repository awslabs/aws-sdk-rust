...
pub fn de_get_stream_key_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_stream_key::GetStreamKeyOutput, crate::operation::get_stream_key::GetStreamKeyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_stream_key::GetStreamKeyError::unhandled)?;
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::get_stream_key::GetStreamKeyError::unhandled(
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_access_denied_exception::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::get_stream_key::GetStreamKeyError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
                ...
                output = output.set_x_amzn_error_type(
                    crate::protocol_serde::shape_access_denied_exception::de_x_amzn_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::get_stream_key::GetStreamKeyError::unhandled("Failed to parse xAmznErrorType from header `x-amzn-ErrorType")
                    })?,
                );
                ...
                output = output.set_x_frame_options(
                    crate::protocol_serde::shape_access_denied_exception::de_x_frame_options_header(_response_headers).map_err(|_| {
                        crate::operation::get_stream_key::GetStreamKeyError::unhandled("Failed to parse xFrameOptions from header `X-Frame-Options")
                    })?,
                );
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_stream_key_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_stream_key::GetStreamKeyOutput, crate::operation::get_stream_key::GetStreamKeyError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_stream_key::de_get_stream_key(_response_body, output)
            .map_err(crate::operation::get_stream_key::GetStreamKeyError::unhandled)?;
...
pub(crate) fn de_get_stream_key(
    _value: &[u8],
    mut builder: crate::operation::get_stream_key::builders::GetStreamKeyOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_stream_key::builders::GetStreamKeyOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "streamKey" => {
                    builder = builder.set_stream_key(crate::protocol_serde::shape_stream_key::de_stream_key(tokens, _value, depth + 1)?);
                }
