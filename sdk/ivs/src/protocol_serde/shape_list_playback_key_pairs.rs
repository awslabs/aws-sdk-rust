                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_playback_key_pairs::ListPlaybackKeyPairsError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_playback_key_pairs::de_list_playback_key_pairs(_response_body, output)
            .map_err(crate::operation::list_playback_key_pairs::ListPlaybackKeyPairsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_playback_key_pairs_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_playback_key_pairs::ListPlaybackKeyPairsError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "keyPairs" => {
                    builder = builder.set_key_pairs(crate::protocol_serde::shape_playback_key_pair_list::de_playback_key_pair_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
