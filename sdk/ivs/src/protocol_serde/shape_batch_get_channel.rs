...
pub fn de_batch_get_channel_http_error(
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::batch_get_channel::BatchGetChannelError::unhandled(
        ...
        "ServiceUnavailable" => crate::operation::batch_get_channel::BatchGetChannelError::ServiceUnavailable({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_service_unavailable::de_service_unavailable_json_err(_response_body, output)
                    .map_err(crate::operation::batch_get_channel::BatchGetChannelError::unhandled)?;
                output = output.set_access_control_allow_origin(
                    match crate::protocol_serde::shape_service_unavailable::de_access_control_allow_origin_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_access_control_expose_headers(
                    match crate::protocol_serde::shape_service_unavailable::de_access_control_expose_headers_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_cache_control(
                    match crate::protocol_serde::shape_service_unavailable::de_cache_control_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_content_security_policy(
                    match crate::protocol_serde::shape_service_unavailable::de_content_security_policy_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_strict_transport_security(
                    match crate::protocol_serde::shape_service_unavailable::de_strict_transport_security_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_x_amzn_error_type(
                    match crate::protocol_serde::shape_service_unavailable::de_x_amzn_error_type_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_x_content_type_options(match crate::protocol_serde::shape_service_unavailable::de_x_content_type_options_header(
                    _response_headers,
                ) {
                    ::std::result::Result::Ok(value) => value,
                    ::std::result::Result::Err(err) => {
                ...
                output = output.set_x_frame_options(
                    match crate::protocol_serde::shape_service_unavailable::de_x_frame_options_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_channel_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_channel::de_batch_get_channel(_response_body, output)
            .map_err(crate::operation::batch_get_channel::BatchGetChannelError::unhandled)?;
        output = output.set_access_control_allow_origin(
            match crate::protocol_serde::shape_batch_get_channel_output::de_access_control_allow_origin_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_access_control_expose_headers(
            match crate::protocol_serde::shape_batch_get_channel_output::de_access_control_expose_headers_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_cache_control(
            match crate::protocol_serde::shape_batch_get_channel_output::de_cache_control_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_security_policy(
            match crate::protocol_serde::shape_batch_get_channel_output::de_content_security_policy_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_strict_transport_security(
            match crate::protocol_serde::shape_batch_get_channel_output::de_strict_transport_security_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_x_content_type_options(
            match crate::protocol_serde::shape_batch_get_channel_output::de_x_content_type_options_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_x_frame_options(
            match crate::protocol_serde::shape_batch_get_channel_output::de_x_frame_options_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
...
pub(crate) fn de_batch_get_channel(
    _value: &[u8],
    mut builder: crate::operation::batch_get_channel::builders::BatchGetChannelOutputBuilder,
) -> ::std::result::Result<
    crate::operation::batch_get_channel::builders::BatchGetChannelOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "errors" => {
                    builder = builder.set_errors(crate::protocol_serde::shape_batch_errors::de_batch_errors(tokens, _value, depth + 1)?);
                }
