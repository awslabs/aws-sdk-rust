...
pub fn de_get_ad_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_ad_configuration::GetAdConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_ad_configuration::GetAdConfigurationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_ad_configuration::GetAdConfigurationError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_ad_configuration::GetAdConfigurationError::unhandled(
        ...
        "InternalServerException" => crate::operation::get_ad_configuration::GetAdConfigurationError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::get_ad_configuration::GetAdConfigurationError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_ad_configuration::GetAdConfigurationError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::get_ad_configuration::GetAdConfigurationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ad_configuration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_ad_configuration::builders::GetAdConfigurationOutputBuilder::default();
        output = crate::protocol_serde::shape_get_ad_configuration::de_get_ad_configuration(_response_body, output)
            .map_err(crate::operation::get_ad_configuration::GetAdConfigurationError::unhandled)?;
...
pub fn ser_get_ad_configuration_input(
    input: &crate::operation::get_ad_configuration::GetAdConfigurationInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_get_ad_configuration_input::ser_get_ad_configuration_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_get_ad_configuration(
    _value: &[u8],
    mut builder: crate::operation::get_ad_configuration::builders::GetAdConfigurationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_ad_configuration::builders::GetAdConfigurationOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "adConfiguration" => {
                    builder = builder.set_ad_configuration(crate::protocol_serde::shape_ad_configuration::de_ad_configuration(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
