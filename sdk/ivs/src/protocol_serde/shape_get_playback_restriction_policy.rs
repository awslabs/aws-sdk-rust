...
pub fn de_get_playback_restriction_policy_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError::unhandled(
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = output.set_access_control_expose_headers(
                        crate::protocol_serde::shape_resource_not_found_exception::de_access_control_expose_headers_header(_response_headers)
                            .map_err(|_| {
                                crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError::unhandled(
                                    "Failed to parse accessControlExposeHeaders from header `Access-Control-Expose-Headers",
                                )
                    ...
                    output = output.set_x_content_type_options(
                        crate::protocol_serde::shape_resource_not_found_exception::de_x_content_type_options_header(_response_headers).map_err(
                            |_| {
                                crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError::unhandled(
                                    "Failed to parse xContentTypeOptions from header `X-Content-Type-Options",
                                )
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_playback_restriction_policy_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_playback_restriction_policy::de_get_playback_restriction_policy(_response_body, output)
            .map_err(crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError::unhandled)?;
...
pub fn ser_get_playback_restriction_policy_input(
...
pub(crate) fn de_get_playback_restriction_policy(
    _value: &[u8],
    mut builder: crate::operation::get_playback_restriction_policy::builders::GetPlaybackRestrictionPolicyOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_playback_restriction_policy::builders::GetPlaybackRestrictionPolicyOutputBuilder,
