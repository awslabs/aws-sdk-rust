...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_recording_configuration::GetRecordingConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_recording_configuration::GetRecordingConfigurationError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_recording_configuration::de_get_recording_configuration(_response_body, output)
            .map_err(crate::operation::get_recording_configuration::GetRecordingConfigurationError::unhandled)?;
...
pub fn ser_get_recording_configuration_input(
    ...
    crate::protocol_serde::shape_get_recording_configuration_input::ser_get_recording_configuration_input_input(&mut object, input)?;
    object.finish();
