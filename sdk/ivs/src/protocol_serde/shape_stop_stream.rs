                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::stop_stream::StopStreamError::unhandled(
        ...
        "StreamUnavailable" => crate::operation::stop_stream::StopStreamError::StreamUnavailable({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_stream_unavailable::de_stream_unavailable_json_err(_response_body, output)
                    .map_err(crate::operation::stop_stream::StopStreamError::unhandled)?;
                output = output.set_access_control_allow_origin(
                    match crate::protocol_serde::shape_stream_unavailable::de_access_control_allow_origin_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_access_control_expose_headers(
                    match crate::protocol_serde::shape_stream_unavailable::de_access_control_expose_headers_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_cache_control(
                    match crate::protocol_serde::shape_stream_unavailable::de_cache_control_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_content_security_policy(
                    match crate::protocol_serde::shape_stream_unavailable::de_content_security_policy_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_strict_transport_security(
                    match crate::protocol_serde::shape_stream_unavailable::de_strict_transport_security_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_x_amzn_error_type(
                    match crate::protocol_serde::shape_stream_unavailable::de_x_amzn_error_type_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_x_content_type_options(
                    match crate::protocol_serde::shape_stream_unavailable::de_x_content_type_options_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
                ...
                output = output.set_x_frame_options(
                    match crate::protocol_serde::shape_stream_unavailable::de_x_frame_options_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
