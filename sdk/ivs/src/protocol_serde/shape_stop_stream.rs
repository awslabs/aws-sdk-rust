            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled(
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_access_denied_exception::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
                ...
                output = output.set_x_amzn_error_type(
                    crate::protocol_serde::shape_access_denied_exception::de_x_amzn_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled("Failed to parse xAmznErrorType from header `x-amzn-ErrorType")
                    })?,
                );
                ...
                output = output.set_x_frame_options(
                    crate::protocol_serde::shape_access_denied_exception::de_x_frame_options_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled("Failed to parse xFrameOptions from header `X-Frame-Options")
                    })?,
                );
        ...
        "StreamUnavailable" => crate::operation::stop_stream::StopStreamError::StreamUnavailable({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_stream_unavailable::de_stream_unavailable_json_err(_response_body, output)
                    .map_err(crate::operation::stop_stream::StopStreamError::unhandled)?;
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_stream_unavailable::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled(
                            "Failed to parse accessControlAllowOrigin from header `Access-Control-Allow-Origin",
                        )
                    })?,
                ...
                output = output.set_access_control_expose_headers(
                    crate::protocol_serde::shape_stream_unavailable::de_access_control_expose_headers_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled(
                            "Failed to parse accessControlExposeHeaders from header `Access-Control-Expose-Headers",
                        )
                    })?,
                ...
                output = output.set_cache_control(
                    crate::protocol_serde::shape_stream_unavailable::de_cache_control_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled("Failed to parse cacheControl from header `Cache-Control")
                    })?,
                );
                output = output.set_content_security_policy(
                    crate::protocol_serde::shape_stream_unavailable::de_content_security_policy_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled(
                            "Failed to parse contentSecurityPolicy from header `Content-Security-Policy",
                        )
                    })?,
                ...
                output = output.set_strict_transport_security(
                    crate::protocol_serde::shape_stream_unavailable::de_strict_transport_security_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled(
                            "Failed to parse strictTransportSecurity from header `Strict-Transport-Security",
                        )
                    })?,
                ...
                output = output.set_x_amzn_error_type(
                    crate::protocol_serde::shape_stream_unavailable::de_x_amzn_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled("Failed to parse xAmznErrorType from header `x-amzn-ErrorType")
                    })?,
                );
                output = output.set_x_content_type_options(
                    crate::protocol_serde::shape_stream_unavailable::de_x_content_type_options_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled(
                            "Failed to parse xContentTypeOptions from header `X-Content-Type-Options",
                        )
                    })?,
                ...
                output = output.set_x_frame_options(
                    crate::protocol_serde::shape_stream_unavailable::de_x_frame_options_header(_response_headers).map_err(|_| {
                        crate::operation::stop_stream::StopStreamError::unhandled("Failed to parse xFrameOptions from header `X-Frame-Options")
                    })?,
                );
                let output = output.meta(generic);
