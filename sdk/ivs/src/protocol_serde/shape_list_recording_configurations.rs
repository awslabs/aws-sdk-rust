...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_recording_configurations::ListRecordingConfigurationsError::unhandled)?;
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::list_recording_configurations::ListRecordingConfigurationsError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_recording_configurations::de_list_recording_configurations(_response_body, output)
            .map_err(crate::operation::list_recording_configurations::ListRecordingConfigurationsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_recording_configurations_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_recording_configurations::ListRecordingConfigurationsError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "recordingConfigurations" => {
                    builder = builder.set_recording_configurations(
                        crate::protocol_serde::shape_recording_configuration_list::de_recording_configuration_list(tokens, _value, depth + 1)?,
                    );
                }
