...
) -> Result<Option<crate::types::StreamSession>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "truncatedEvents" => {
                            builder = builder.set_truncated_events(crate::protocol_serde::shape_stream_events::de_stream_events(tokens)?);
                        }
