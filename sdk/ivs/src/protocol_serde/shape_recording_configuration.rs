...
pub(crate) fn de_recording_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RecordingConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
