...
pub fn de_list_ad_configurations_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_ad_configurations::ListAdConfigurationsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_ad_configurations::ListAdConfigurationsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_ad_configurations::ListAdConfigurationsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_ad_configurations::ListAdConfigurationsError::unhandled(
        ...
        "InternalServerException" => crate::operation::list_ad_configurations::ListAdConfigurationsError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::list_ad_configurations::ListAdConfigurationsError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::list_ad_configurations::ListAdConfigurationsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_ad_configurations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_ad_configurations::builders::ListAdConfigurationsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_ad_configurations::de_list_ad_configurations(_response_body, output)
            .map_err(crate::operation::list_ad_configurations::ListAdConfigurationsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_ad_configurations_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_ad_configurations::ListAdConfigurationsError::unhandled)?
    })
}

pub fn ser_list_ad_configurations_input(
    input: &crate::operation::list_ad_configurations::ListAdConfigurationsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_list_ad_configurations_input::ser_list_ad_configurations_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_list_ad_configurations(
    _value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "adConfigurations" => {
                    builder = builder.set_ad_configurations(crate::protocol_serde::shape_ad_configuration_list::de_ad_configuration_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
