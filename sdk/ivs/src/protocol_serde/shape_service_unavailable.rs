...
pub(crate) fn de_service_unavailable_json_err(
    _value: &[u8],
    mut builder: crate::types::error::builders::ServiceUnavailableBuilder,
) -> ::std::result::Result<crate::types::error::builders::ServiceUnavailableBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
