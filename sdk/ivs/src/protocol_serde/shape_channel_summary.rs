                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "latencyMode" => {
                            builder = builder.set_latency_mode(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ChannelLatencyMode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "authorized" => {
                        ...
                        "preset" => {
                            builder = builder.set_preset(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TranscodePreset::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "adConfigurationArn" => {
                            builder = builder.set_ad_configuration_arn(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                                    .transpose()?,
                            );
