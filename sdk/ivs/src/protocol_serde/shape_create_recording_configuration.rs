...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_recording_configuration::CreateRecordingConfigurationError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_access_control_allow_origin(
                    crate::protocol_serde::shape_access_denied_exception::de_access_control_allow_origin_header(_response_headers).map_err(|_| {
                        crate::operation::create_recording_configuration::CreateRecordingConfigurationError::unhandled(
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_recording_configuration::CreateRecordingConfigurationError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_recording_configuration::de_create_recording_configuration(_response_body, output)
            .map_err(crate::operation::create_recording_configuration::CreateRecordingConfigurationError::unhandled)?;
...
pub(crate) fn de_create_recording_configuration(
    _value: &[u8],
    mut builder: crate::operation::create_recording_configuration::builders::CreateRecordingConfigurationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::create_recording_configuration::builders::CreateRecordingConfigurationOutputBuilder,
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "recordingConfiguration" => {
                    builder = builder.set_recording_configuration(crate::protocol_serde::shape_recording_configuration::de_recording_configuration(
                        tokens, _value,
                    )?);
                }
