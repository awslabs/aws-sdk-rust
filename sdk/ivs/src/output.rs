...
pub struct ListStreamSessionsOutput  {
    ...
    #[doc(hidden)]pub stream_sessions: std::option::Option<std::vec::Vec<crate::model::StreamSessionSummary>>,
...
pub struct ListStreamKeysOutput  {
    ...
    #[doc(hidden)]pub stream_keys: std::option::Option<std::vec::Vec<crate::model::StreamKeySummary>>,
...
pub struct ListRecordingConfigurationsOutput  {
    ...
    #[doc(hidden)]pub recording_configurations: std::option::Option<std::vec::Vec<crate::model::RecordingConfigurationSummary>>,
...
pub struct ListPlaybackKeyPairsOutput  {
    ...
    #[doc(hidden)]pub key_pairs: std::option::Option<std::vec::Vec<crate::model::PlaybackKeyPairSummary>>,
...
pub struct ImportPlaybackKeyPairOutput  {
    /// <p></p>
    #[doc(hidden)]pub key_pair: std::option::Option<crate::model::PlaybackKeyPair>,
}
...
pub struct GetStreamSessionOutput  {
    ...
    #[doc(hidden)]pub stream_session: std::option::Option<crate::model::StreamSession>,
}
...
pub struct GetStreamKeyOutput  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub stream_key: std::option::Option<crate::model::StreamKey>,
}
...
pub struct GetStreamOutput  {
    /// <p></p>
    #[doc(hidden)]pub stream: std::option::Option<crate::model::Stream>,
}
...
pub struct GetRecordingConfigurationOutput  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub recording_configuration: std::option::Option<crate::model::RecordingConfiguration>,
}
...
pub struct BatchGetStreamKeyOutput  {
    /// <p></p>
    #[doc(hidden)]pub stream_keys: std::option::Option<std::vec::Vec<crate::model::StreamKey>>,
    /// <p></p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchError>>,
}
