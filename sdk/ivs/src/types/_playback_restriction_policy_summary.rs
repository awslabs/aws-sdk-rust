...
impl PlaybackRestrictionPolicySummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::PlaybackRestrictionPolicySummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::PlaybackRestrictionPolicySummary {
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building PlaybackRestrictionPolicySummary")
                    )?
                ,
                allowed_countries: self.allowed_countries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("allowed_countries", "allowed_countries was not specified but it is required when building PlaybackRestrictionPolicySummary")
                    )?
                ,
                allowed_origins: self.allowed_origins
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("allowed_origins", "allowed_origins was not specified but it is required when building PlaybackRestrictionPolicySummary")
                    )?
                ,
