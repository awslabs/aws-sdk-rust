...
impl RenditionConfiguration {
    ...
    pub fn renditions(
        &self,
    ) -> ::std::option::Option<&[crate::types::RenditionConfigurationRendition]> {
...
pub struct RenditionConfigurationBuilder {
    pub(crate) rendition_selection:
        ::std::option::Option<crate::types::RenditionConfigurationRenditionSelection>,
    pub(crate) renditions:
        ::std::option::Option<::std::vec::Vec<crate::types::RenditionConfigurationRendition>>,
}
impl RenditionConfigurationBuilder {
    ...
    pub fn rendition_selection(
        mut self,
        input: crate::types::RenditionConfigurationRenditionSelection,
    ) -> Self {
        self.rendition_selection = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates which set of renditions are recorded for a stream. For <code>BASIC</code> channels, the <code>CUSTOM</code> value has no effect. If <code>CUSTOM</code> is specified, a set of renditions must be specified in the <code>renditions</code> field. Default: <code>ALL</code>.</p>
    pub fn set_rendition_selection(
        mut self,
        input: ::std::option::Option<crate::types::RenditionConfigurationRenditionSelection>,
    ) -> Self {
    ...
    pub fn set_renditions(
        ...
        input: ::std::option::Option<
            ::std::vec::Vec<crate::types::RenditionConfigurationRendition>,
        >,
    ) -> Self {
