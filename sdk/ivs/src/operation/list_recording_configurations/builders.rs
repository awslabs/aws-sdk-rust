...
pub use crate::operation::list_recording_configurations::_list_recording_configurations_output::ListRecordingConfigurationsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_recording_configurations::ListRecordingConfigurationsOutput,
                    crate::operation::list_recording_configurations::ListRecordingConfigurationsError,
                > for ListRecordingConfigurationsFluentBuilder
            {
                fn send(
                    self,
...
impl ListRecordingConfigurationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_recording_configurations::ListRecordingConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recording_configurations::ListRecordingConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_recording_configurations::ListRecordingConfigurations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_recording_configurations::ListRecordingConfigurationsOutput, crate::operation::list_recording_configurations::ListRecordingConfigurationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_recording_configurations::paginator::ListRecordingConfigurationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
