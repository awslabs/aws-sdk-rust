...
impl ListRecordingConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_recording_configurations::ListRecordingConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
