...
impl GetPlaybackRestrictionPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyOutput, crate::operation::get_playback_restriction_policy::GetPlaybackRestrictionPolicyError, Self> {
