...
impl UpdatePlaybackRestrictionPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_playback_restriction_policy::UpdatePlaybackRestrictionPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_playback_restriction_policy::UpdatePlaybackRestrictionPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_playback_restriction_policy::UpdatePlaybackRestrictionPolicyOutput, crate::operation::update_playback_restriction_policy::UpdatePlaybackRestrictionPolicyError, Self> {
