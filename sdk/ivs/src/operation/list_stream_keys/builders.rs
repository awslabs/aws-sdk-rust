...
impl ListStreamKeysFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_stream_keys::builders::ListStreamKeysInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_stream_keys::paginator::ListStreamKeysPaginator {
        crate::operation::list_stream_keys::paginator::ListStreamKeysPaginator::new(
            self.handle,
            self.inner,
        )
    }
