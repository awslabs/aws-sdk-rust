...
impl ListStreamSessionsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_stream_sessions::paginator::ListStreamSessionsPaginator {
        crate::operation::list_stream_sessions::paginator::ListStreamSessionsPaginator::new(
            self.handle,
            self.inner,
        )
    }
