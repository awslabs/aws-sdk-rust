...
pub struct UpgradeDomainOutput  {
    ...
    #[doc(hidden)]pub upgrade_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub change_progress_details: std::option::Option<crate::model::ChangeProgressDetails>,
}
...
pub struct UpdatePackageOutput  {
    ...
    #[doc(hidden)]pub package_details: std::option::Option<crate::model::PackageDetails>,
}
...
pub struct UpdateDomainConfigOutput  {
    ...
    #[doc(hidden)]pub domain_config: std::option::Option<crate::model::DomainConfig>,
    /// <p>Contains result of DryRun. </p>
    #[doc(hidden)]pub dry_run_results: std::option::Option<crate::model::DryRunResults>,
}
...
pub struct StartServiceSoftwareUpdateOutput  {
    ...
    #[doc(hidden)]pub service_software_options: std::option::Option<crate::model::ServiceSoftwareOptions>,
}
...
pub struct RejectInboundConnectionOutput  {
    ...
    #[doc(hidden)]pub connection: std::option::Option<crate::model::InboundConnection>,
}
...
pub struct ListPackagesForDomainOutput  {
    ...
    #[doc(hidden)]pub domain_package_details_list: std::option::Option<std::vec::Vec<crate::model::DomainPackageDetails>>,
...
impl  std::fmt::Debug for ListPackagesForDomainOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("domain_package_details_list", &self.domain_package_details_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListInstanceTypeDetailsOutput  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub instance_type_details: std::option::Option<std::vec::Vec<crate::model::InstanceTypeDetails>>,
    /// <p> Paginated APIs accept the NextToken input to return the next page of results and provide a NextToken output in the response, which you can use to retrieve more results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDomainNamesOutput  {
    ...
    #[doc(hidden)]pub domain_names: std::option::Option<std::vec::Vec<crate::model::DomainInfo>>,
}
...
pub struct GetUpgradeStatusOutput  {
    ...
    /// </ul> 
    /// <p></p>
    #[doc(hidden)]pub upgrade_step: std::option::Option<crate::model::UpgradeStep>,
    ...
    /// </ul> 
    /// <p></p>
    #[doc(hidden)]pub step_status: std::option::Option<crate::model::UpgradeStatus>,
    /// <p>A string that briefly describes the update.</p>
    #[doc(hidden)]pub upgrade_name: std::option::Option<std::string::String>,
}
...
pub struct GetUpgradeHistoryOutput  {
    ...
    #[doc(hidden)]pub upgrade_histories: std::option::Option<std::vec::Vec<crate::model::UpgradeHistory>>,
...
pub struct GetPackageVersionHistoryOutput  {
    ...
    #[doc(hidden)]pub package_version_history_list: std::option::Option<std::vec::Vec<crate::model::PackageVersionHistory>>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetPackageVersionHistoryOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("package_version_history_list", &self.package_version_history_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetCompatibleVersionsOutput  {
    ...
    #[doc(hidden)]pub compatible_versions: std::option::Option<std::vec::Vec<crate::model::CompatibleVersionsMap>>,
}
...
pub struct DissociatePackageOutput  {
    ...
    #[doc(hidden)]pub domain_package_details: std::option::Option<crate::model::DomainPackageDetails>,
}
...
pub struct DescribeReservedInstancesOutput  {
    ...
    #[doc(hidden)]pub reserved_instances: std::option::Option<std::vec::Vec<crate::model::ReservedInstance>>,
}
...
pub struct DescribeReservedInstanceOfferingsOutput  {
    ...
    #[doc(hidden)]pub reserved_instance_offerings: std::option::Option<std::vec::Vec<crate::model::ReservedInstanceOffering>>,
}
...
impl  std::fmt::Debug for DescribeReservedInstanceOfferingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("reserved_instance_offerings", &self.reserved_instance_offerings);
        formatter.finish()
    }
}
...
pub struct DescribePackagesOutput  {
    ...
    #[doc(hidden)]pub package_details_list: std::option::Option<std::vec::Vec<crate::model::PackageDetails>>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeOutboundConnectionsOutput  {
    ...
    #[doc(hidden)]pub connections: std::option::Option<std::vec::Vec<crate::model::OutboundConnection>>,
...
pub struct DescribeInstanceTypeLimitsOutput  {
    ...
    /// </ul> 
    /// <p></p>
    #[doc(hidden)]pub limits_by_role: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Limits>>,
}
...
pub struct DescribeInboundConnectionsOutput  {
    ...
    #[doc(hidden)]pub connections: std::option::Option<std::vec::Vec<crate::model::InboundConnection>>,
    /// <p>If more results are available and NextToken is present, make the next request to the same API with the received NextToken to paginate the remaining results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeDomainsOutput  {
    ...
    #[doc(hidden)]pub domain_status_list: std::option::Option<std::vec::Vec<crate::model::DomainStatus>>,
}
...
pub struct DescribeDomainChangeProgressOutput  {
    ...
    #[doc(hidden)]pub change_progress_status: std::option::Option<crate::model::ChangeProgressStatusDetails>,
}
...
pub struct DescribeDomainAutoTunesOutput  {
    ...
    #[doc(hidden)]pub auto_tunes: std::option::Option<std::vec::Vec<crate::model::AutoTune>>,
...
pub struct DeleteOutboundConnectionOutput  {
    ...
    #[doc(hidden)]pub connection: std::option::Option<crate::model::OutboundConnection>,
}
...
pub struct CreateOutboundConnectionOutput  {
    ...
    #[doc(hidden)]pub connection_status: std::option::Option<crate::model::OutboundConnectionStatus>,
