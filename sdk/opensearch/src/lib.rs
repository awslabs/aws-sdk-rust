...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("opensearch", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon OpenSearch Service.
pub mod client;
