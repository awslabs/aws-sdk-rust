...
pub fn ser_saml_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamlOptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
