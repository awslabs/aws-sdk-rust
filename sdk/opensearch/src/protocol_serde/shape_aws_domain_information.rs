...
pub(crate) fn de_aws_domain_information<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsDomainInformation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
