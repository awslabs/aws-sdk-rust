...
pub fn de_start_migration_http_error(
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::operation::start_migration::StartMigrationError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledOperationException" => crate::operation::start_migration::StartMigrationError::DisabledOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalException" => crate::operation::start_migration::StartMigrationError::InternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::start_migration::StartMigrationError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::start_migration::StartMigrationError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_migration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::start_migration::StartMigrationOutput, crate::operation::start_migration::StartMigrationError> {
...
pub fn ser_start_migration_input(
    ...
    crate::protocol_serde::shape_start_migration_input::ser_start_migration_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_start_migration(
    _value: &[u8],
