...
pub fn de_list_vpc_endpoints_for_domain_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListVpcEndpointsForDomainOutput, crate::error::ListVpcEndpointsForDomainError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListVpcEndpointsForDomainError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_json_err(response.body().as_ref(), output).map_err(crate::error::ListVpcEndpointsForDomainError::unhandled)?;
        ...
        "DisabledOperationException" => crate::error::ListVpcEndpointsForDomainError::DisabledOperationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::ListVpcEndpointsForDomainError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_vpc_endpoints_for_domain_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListVpcEndpointsForDomainOutput, crate::error::ListVpcEndpointsForDomainError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_list_vpc_endpoints_for_domain(value: &[u8], mut builder: crate::output::list_vpc_endpoints_for_domain_output::Builder) -> Result<crate::output::list_vpc_endpoints_for_domain_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
