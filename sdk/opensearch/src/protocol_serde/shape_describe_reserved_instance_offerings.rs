...
pub fn de_describe_reserved_instance_offerings_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsOutput, crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_reserved_instance_offerings_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsOutput, crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError> {
    Ok({
        #[allow(unused_mut)]
