...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError::unhandled)?;
    ...
    Err(match error_code {
        "DisabledOperationException" => {
            crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError::DisabledOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_reserved_instance_offerings::de_describe_reserved_instance_offerings(_response_body, output)
            .map_err(crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError::unhandled)?;
...
pub(crate) fn de_describe_reserved_instance_offerings(
    _value: &[u8],
    mut builder: crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsOutputBuilder,
) -> ::std::result::Result<
    crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ReservedInstanceOfferings" => {
                    builder = builder.set_reserved_instance_offerings(
                        crate::protocol_serde::shape_reserved_instance_offering_list::de_reserved_instance_offering_list(tokens, _value, depth + 1)?,
                    );
                }
