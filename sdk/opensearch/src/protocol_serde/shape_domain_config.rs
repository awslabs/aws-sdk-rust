            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "EngineVersion" => {
                            builder = builder.set_engine_version(crate::protocol_serde::shape_version_status::de_version_status(tokens)?);
                        }
                        "ClusterConfig" => {
                            builder =
                                builder.set_cluster_config(crate::protocol_serde::shape_cluster_config_status::de_cluster_config_status(tokens)?);
                        }
                        "EBSOptions" => {
                        ...
                        "AIMLOptions" => {
                            builder = builder.set_aiml_options(crate::protocol_serde::shape_aiml_options_status::de_aiml_options_status(tokens)?);
                        }
