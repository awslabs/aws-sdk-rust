...
pub fn de_describe_instance_type_limits_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeInstanceTypeLimitsOutput, crate::error::DescribeInstanceTypeLimitsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeInstanceTypeLimitsError::unhandled)?;
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeInstanceTypeLimitsError::unhandled)?;
        ...
        "InvalidTypeException" => crate::error::DescribeInstanceTypeLimitsError::InvalidTypeException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => crate::error::DescribeInstanceTypeLimitsError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::DescribeInstanceTypeLimitsError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::error::DescribeInstanceTypeLimitsError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_instance_type_limits_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeInstanceTypeLimitsOutput, crate::error::DescribeInstanceTypeLimitsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_instance_type_limits(value: &[u8], mut builder: crate::output::describe_instance_type_limits_output::Builder) -> Result<crate::output::describe_instance_type_limits_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
