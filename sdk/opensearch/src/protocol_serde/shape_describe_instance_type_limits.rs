...
pub fn de_describe_instance_type_limits_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsOutput, crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_instance_type_limits_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsOutput, crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError> {
    Ok({
        #[allow(unused_mut)]
