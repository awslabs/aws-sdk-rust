...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_instance_type_limits::de_describe_instance_type_limits(_response_body, output)
            .map_err(crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "LimitsByRole" => {
                    builder = builder.set_limits_by_role(crate::protocol_serde::shape_limits_by_role::de_limits_by_role(tokens, _value, depth + 1)?);
                }
