...
pub fn ser_cluster_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClusterConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cluster_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ClusterConfig>, aws_smithy_json::deserialize::error::DeserializeError>
