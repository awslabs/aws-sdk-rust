...
pub fn de_list_versions_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_versions::ListVersionsOutput, crate::operation::list_versions::ListVersionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_versions_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_versions::ListVersionsOutput, crate::operation::list_versions::ListVersionsError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_versions::de_list_versions(_response_body, output)
            .map_err(crate::operation::list_versions::ListVersionsError::unhandled)?;
...
) -> Result<crate::operation::list_versions::builders::ListVersionsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Versions" => {
                    builder = builder.set_versions(crate::protocol_serde::shape_version_list::de_version_list(tokens)?);
                }
