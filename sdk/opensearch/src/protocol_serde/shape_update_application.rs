...
) -> std::result::Result<crate::operation::update_application::UpdateApplicationOutput, crate::operation::update_application::UpdateApplicationError>
{
    ...
    Err(match error_code {
        ...
        "BaseException" => crate::operation::update_application::UpdateApplicationError::BaseException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "DisabledOperationException" => crate::operation::update_application::UpdateApplicationError::DisabledOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalException" => crate::operation::update_application::UpdateApplicationError::InternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "appConfigs" => {
                    builder = builder.set_app_configs(crate::protocol_serde::shape_app_configs::de_app_configs(tokens, _value, depth + 1)?);
                }
                "arn" => {
                ...
                "iamIdentityCenterOptions" => {
                    builder = builder.set_iam_identity_center_options(
                        crate::protocol_serde::shape_iam_identity_center_options::de_iam_identity_center_options(tokens, _value, depth + 1)?,
                    );
                }
                "id" => {
