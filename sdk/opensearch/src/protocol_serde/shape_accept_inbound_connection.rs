...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::accept_inbound_connection::AcceptInboundConnectionError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::accept_inbound_connection::AcceptInboundConnectionError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_accept_inbound_connection::de_accept_inbound_connection(_response_body, output)
            .map_err(crate::operation::accept_inbound_connection::AcceptInboundConnectionError::unhandled)?;
