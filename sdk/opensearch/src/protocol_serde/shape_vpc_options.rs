...
pub fn ser_vpc_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VpcOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
