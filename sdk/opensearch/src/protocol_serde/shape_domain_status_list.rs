...
pub(crate) fn de_domain_status_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DomainStatus>>, aws_smithy_json::deserialize::error::DeserializeError>
