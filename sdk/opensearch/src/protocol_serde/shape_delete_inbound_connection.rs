...
pub fn de_delete_inbound_connection_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_inbound_connection::DeleteInboundConnectionOutput, crate::operation::delete_inbound_connection::DeleteInboundConnectionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_inbound_connection::DeleteInboundConnectionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_inbound_connection_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_inbound_connection::DeleteInboundConnectionOutput, crate::operation::delete_inbound_connection::DeleteInboundConnectionError> {
    Ok({
        #[allow(unused_mut)]
