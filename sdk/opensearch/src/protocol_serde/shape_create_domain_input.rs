...
pub fn ser_create_domain_input_input(
    ...
    if let Some(var_21) = &input.ebs_options {
        ...
        crate::protocol_serde::shape_ebs_options::ser_ebs_options(&mut object_22, var_21)?;
        object_22.finish();
    }
    ...
    if let Some(var_25) = &input.engine_version {
        object.key("EngineVersion").string(var_25.as_str());
    }
        ...
        for item_44 in var_42 {
            {
                ...
                crate::protocol_serde::shape_tag::ser_tag(&mut object_45, item_44)?;
                object_45.finish();
            }
        }
        array_43.finish();
