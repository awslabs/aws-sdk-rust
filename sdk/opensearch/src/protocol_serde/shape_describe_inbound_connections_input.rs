...
pub fn ser_describe_inbound_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_inbound_connections::DescribeInboundConnectionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
