...
pub fn ser_describe_outbound_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeOutboundConnectionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
