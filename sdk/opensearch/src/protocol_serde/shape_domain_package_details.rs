...
pub(crate) fn de_domain_package_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DomainPackageDetails>, aws_smithy_json::deserialize::error::DeserializeError>
