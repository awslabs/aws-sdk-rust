    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2021-01-01/opensearch/compatibleVersions")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_compatible_versions::GetCompatibleVersions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_compatible_versions::GetCompatibleVersionsError
{
