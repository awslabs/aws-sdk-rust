...
impl GetCompatibleVersionsInput {
    /// Consumes the builder and constructs an Operation<[`GetCompatibleVersions`](crate::operation::get_compatible_versions::GetCompatibleVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_compatible_versions::GetCompatibleVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_compatible_versions::GetCompatibleVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2021-01-01/opensearch/compatibleVersions").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_compatible_versions::GetCompatibleVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_compatible_versions::GetCompatibleVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetCompatibleVersions {
                type Output = std::result::Result<crate::operation::get_compatible_versions::GetCompatibleVersionsOutput, crate::operation::get_compatible_versions::GetCompatibleVersionsError>;
