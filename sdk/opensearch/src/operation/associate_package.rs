...
impl AssociatePackage {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("opensearch", "AssociatePackage", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociatePackageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_package::ser_associate_package_input(&input)?);
