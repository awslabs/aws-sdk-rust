...
impl GetCompatibleVersionsFluentBuilder  {
    /// Creates a new `GetCompatibleVersions`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_compatible_versions::GetCompatibleVersionsOutput, aws_smithy_http::result::SdkError<crate::operation::get_compatible_versions::GetCompatibleVersionsError>>
                     {
