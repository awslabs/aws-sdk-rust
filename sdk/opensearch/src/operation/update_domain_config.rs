...
impl UpdateDomainConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_domain_config::UpdateDomainConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_domain_config::de_update_domain_config_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_domain_config::UpdateDomainConfigError
{
