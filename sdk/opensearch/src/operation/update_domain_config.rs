...
impl UpdateDomainConfigInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_domain_config::ser_update_domain_config_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_domain_config::de_update_domain_config_http_response_with_props(status, headers, body)
        }
    }
}
