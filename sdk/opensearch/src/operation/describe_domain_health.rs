    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_domain_health::DescribeDomainHealthError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_domain_health::DescribeDomainHealthOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDomainHealthResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDomainHealthRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_domain_health::DescribeDomainHealthInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDomainHealthEndpointParamsInterceptor {
...
pub type DescribeDomainHealthErrorKind = DescribeDomainHealthError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeDomainHealthError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_domain_health::DescribeDomainHealthError {
...
impl DescribeDomainHealthError {
    ...
    /// Creates the `DescribeDomainHealthError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
