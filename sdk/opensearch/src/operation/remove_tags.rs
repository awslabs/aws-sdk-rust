...
impl RemoveTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::remove_tags::RemoveTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_tags::ser_remove_tags_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_tags::de_remove_tags_http_response_with_props(status, headers, body)
        }
    }
}
