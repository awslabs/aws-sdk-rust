    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2021-01-01/opensearch/upgradeDomain")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::upgrade_domain::UpgradeDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpgradeDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_upgrade_domain::de_upgrade_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_upgrade_domain::de_upgrade_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
