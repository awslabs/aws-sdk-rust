...
impl UpgradeDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::upgrade_domain::UpgradeDomain, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_upgrade_domain::ser_upgrade_domain_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpgradeDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_upgrade_domain::de_upgrade_domain_http_response_with_props(status, headers, body)
        }
    }
}
