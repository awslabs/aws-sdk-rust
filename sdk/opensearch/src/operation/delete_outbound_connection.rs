...
/// Orchestration and serialization glue logic for `DeleteOutboundConnection`.
...
impl DeleteOutboundConnection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_outbound_connection::DeleteOutboundConnectionInput,
                    ) -> ::std::result::Result<crate::operation::delete_outbound_connection::DeleteOutboundConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_outbound_connection::DeleteOutboundConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_outbound_connection::DeleteOutboundConnectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_outbound_connection::DeleteOutboundConnectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteOutboundConnection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteOutboundConnection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteOutboundConnectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteOutboundConnectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteOutboundConnection")
...
.with_interceptor(DeleteOutboundConnectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_outbound_connection::DeleteOutboundConnectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_outbound_connection::DeleteOutboundConnectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_outbound_connection::DeleteOutboundConnectionError>::new());
...
#[derive(Debug)]
            struct DeleteOutboundConnectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteOutboundConnectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_outbound_connection::de_delete_outbound_connection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_outbound_connection::de_delete_outbound_connection_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteOutboundConnectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteOutboundConnectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_outbound_connection::DeleteOutboundConnectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_outbound_connection::DeleteOutboundConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2021-01-01/opensearch/cc/outboundConnection/{ConnectionId}", ConnectionId = connection_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteOutboundConnectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteOutboundConnectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteOutboundConnectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteOutboundConnectionInput>()
                        .ok_or("failed to downcast to DeleteOutboundConnectionInput")?;
...
pub enum DeleteOutboundConnectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteOutboundConnectionError) for what information is available for the error.")]
...
impl DeleteOutboundConnectionError {
    /// Creates the `DeleteOutboundConnectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteOutboundConnectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteOutboundConnectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_outbound_connection::DeleteOutboundConnectionError {
...
mod _delete_outbound_connection_output;
