...
impl DescribeDryRunProgressInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDryRunProgress`](crate::operation::describe_dry_run_progress::DescribeDryRunProgress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_dry_run_progress::DescribeDryRunProgress, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_dry_run_progress::DescribeDryRunProgressInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2021-01-01/opensearch/domain/{DomainName}/dryRun", DomainName = domain_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_dry_run_progress::DescribeDryRunProgressInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.dry_run_id {
                     {
                        query.push_kv("dryRunId", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.load_dry_run_config {
                    if *inner_3 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_dry_run_progress::DescribeDryRunProgress::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDryRunProgress", "opensearch"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDryRunProgress {
                type Output = std::result::Result<crate::operation::describe_dry_run_progress::DescribeDryRunProgressOutput, crate::operation::describe_dry_run_progress::DescribeDryRunProgressError>;
