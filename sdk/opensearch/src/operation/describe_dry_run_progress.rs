...
impl DescribeDryRunProgress {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_dry_run_progress::DescribeDryRunProgressError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_dry_run_progress::DescribeDryRunProgressOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("OpenSearch", "DescribeDryRunProgress", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "OpenSearch.DescribeDryRunProgress",
                "rpc.service" = "OpenSearch",
                "rpc.method" = "DescribeDryRunProgress",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDryRunProgress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeDryRunProgressRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeDryRunProgressResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeDryRunProgress")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDryRunProgress")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribeDryRunProgressTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeDryRunProgressTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDryRunProgressTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeDryRunProgressInput>() else {
        ...
        if requested.should_capture("DryRunId") {
            if let ::std::option::Option::Some(value) = input.dry_run_id.as_deref() {
                captured.insert("DryRunId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDryRunProgressResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_dry_run_progress::de_describe_dry_run_progress_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_dry_run_progress::de_describe_dry_run_progress_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDryRunProgressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_dry_run_progress::DescribeDryRunProgressInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::describe_dry_run_progress::DescribeDryRunProgressInput,
                ...
                ::std::write!(output, "/2021-01-01/opensearch/domain/{DomainName}/dryRun", DomainName = domain_name)
