...
impl CreateVpcEndpoint {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("OpenSearch", "CreateVpcEndpoint", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "OpenSearch.CreateVpcEndpoint",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateVpcEndpointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("DomainArn") {
            if let ::std::option::Option::Some(value) = input.domain_arn.as_deref() {
                captured.insert("DomainArn", value);
            }
        }
