...
impl GetUpgradeStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_upgrade_status::GetUpgradeStatus,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUpgradeStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_upgrade_status::de_get_upgrade_status_http_response_with_props(status, headers, body)
        }
    }
}
