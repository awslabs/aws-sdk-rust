...
impl DeleteDataSource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("opensearch", "DeleteDataSource", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDataSource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteDataSource", "opensearch"));
...
impl DeleteDataSourceError {
    ...
    /// Returns `true` if the error kind is `DeleteDataSourceError::BaseException`.
    pub fn is_base_exception(&self) -> bool {
        matches!(self, Self::BaseException(_))
    }
    /// Returns `true` if the error kind is `DeleteDataSourceError::DependencyFailureException`.
    pub fn is_dependency_failure_exception(&self) -> bool {
        matches!(self, Self::DependencyFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteDataSourceError::DisabledOperationException`.
    pub fn is_disabled_operation_exception(&self) -> bool {
        matches!(self, Self::DisabledOperationException(_))
    }
    /// Returns `true` if the error kind is `DeleteDataSourceError::InternalException`.
