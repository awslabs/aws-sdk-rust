...
impl ListPackagesForDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_packages_for_domain::ListPackagesForDomain,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackagesForDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_packages_for_domain::de_list_packages_for_domain_http_response_with_props(status, headers, body)
        }
    }
}
