...
impl AcceptInboundConnectionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_inbound_connection::AcceptInboundConnection::new(),
        )
...
/// `ParseStrictResponse` impl for `AcceptInboundConnection`.
...
impl aws_smithy_http::response::ParseStrictResponse for AcceptInboundConnection {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_accept_inbound_connection::de_accept_inbound_connection_http_error(response)
        } else {
            crate::protocol_serde::shape_accept_inbound_connection::de_accept_inbound_connection_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::accept_inbound_connection::AcceptInboundConnectionError
{
