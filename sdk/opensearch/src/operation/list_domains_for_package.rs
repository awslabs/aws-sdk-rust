...
impl ListDomainsForPackageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_domains_for_package::ListDomainsForPackage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDomainsForPackage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_domains_for_package::de_list_domains_for_package_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_domains_for_package::ListDomainsForPackageError
{
