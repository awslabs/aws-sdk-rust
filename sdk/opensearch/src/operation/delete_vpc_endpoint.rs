...
#[derive(Debug)]
    ...
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_endpoint_id", "cannot be empty or unset"))?;
    ...
    if vpc_endpoint_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("vpc_endpoint_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/2021-01-01/opensearch/vpcEndpoints/{VpcEndpointId}", VpcEndpointId = vpc_endpoint_id).expect("formatting should succeed");
