...
impl AuthorizeVpcEndpointAccessFluentBuilder  {
    /// Creates a new `AuthorizeVpcEndpointAccess`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccessOutput, aws_smithy_http::result::SdkError<crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccessError>>
                     {
