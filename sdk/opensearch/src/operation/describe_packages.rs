    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2021-01-01/packages/describe")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_packages::DescribePackages::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_packages::DescribePackagesError
{
