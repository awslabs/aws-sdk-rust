...
impl DeleteInboundConnection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_inbound_connection::DeleteInboundConnectionInput,
                    ) -> ::std::result::Result<crate::operation::delete_inbound_connection::DeleteInboundConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_inbound_connection::DeleteInboundConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_inbound_connection::DeleteInboundConnectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_inbound_connection::DeleteInboundConnectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteInboundConnection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteInboundConnection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteInboundConnectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteInboundConnectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteInboundConnection")
...
.with_interceptor(DeleteInboundConnectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_inbound_connection::DeleteInboundConnectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_inbound_connection::DeleteInboundConnectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_inbound_connection::DeleteInboundConnectionError>::new());
...
#[derive(Debug)]
            struct DeleteInboundConnectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteInboundConnectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_inbound_connection::de_delete_inbound_connection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_inbound_connection::de_delete_inbound_connection_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteInboundConnectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteInboundConnectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_inbound_connection::DeleteInboundConnectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_inbound_connection::DeleteInboundConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2021-01-01/opensearch/cc/inboundConnection/{ConnectionId}", ConnectionId = connection_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteInboundConnectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteInboundConnectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteInboundConnectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteInboundConnectionInput>()
                        .ok_or("failed to downcast to DeleteInboundConnectionInput")?;
...
pub enum DeleteInboundConnectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteInboundConnectionError) for what information is available for the error.")]
...
impl DeleteInboundConnectionError {
    /// Creates the `DeleteInboundConnectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteInboundConnectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteInboundConnectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_inbound_connection::DeleteInboundConnectionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_inbound_connection::_delete_inbound_connection_output::DeleteInboundConnectionOutput;

pub use crate::operation::delete_inbound_connection::_delete_inbound_connection_input::DeleteInboundConnectionInput;

mod _delete_inbound_connection_input;

mod _delete_inbound_connection_output;
