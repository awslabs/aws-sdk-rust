...
impl StartServiceSoftwareUpdateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_service_software_update::StartServiceSoftwareUpdate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartServiceSoftwareUpdate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_service_software_update::de_start_service_software_update_http_response_with_props(
                status, headers, body,
            )
        }
    }
