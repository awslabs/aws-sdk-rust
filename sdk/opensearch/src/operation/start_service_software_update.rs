...
impl StartServiceSoftwareUpdateInput {
    /// Consumes the builder and constructs an Operation<[`StartServiceSoftwareUpdate`](crate::operation::start_service_software_update::StartServiceSoftwareUpdate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_service_software_update::StartServiceSoftwareUpdate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_service_software_update::StartServiceSoftwareUpdateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_service_software_update::StartServiceSoftwareUpdate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartServiceSoftwareUpdate", "opensearch"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `StartServiceSoftwareUpdate`.
...
impl aws_smithy_http::response::ParseStrictResponse for StartServiceSoftwareUpdate {
                type Output = std::result::Result<crate::operation::start_service_software_update::StartServiceSoftwareUpdateOutput, crate::operation::start_service_software_update::StartServiceSoftwareUpdateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_service_software_update::de_start_service_software_update_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_service_software_update::de_start_service_software_update_http_response(response)
                     }
                }
            }
