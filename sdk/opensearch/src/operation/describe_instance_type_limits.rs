...
impl DescribeInstanceTypeLimitsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInstanceTypeLimits`](crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimits)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimits, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.engine_version;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("engine_version", "cannot be empty or unset"))?;
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("instance_type", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_3) = &_input.domain_name {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimits::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInstanceTypeLimits {
                type Output = std::result::Result<crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsOutput, crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_instance_type_limits::de_describe_instance_type_limits_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_instance_type_limits::de_describe_instance_type_limits_http_response(response)
                     }
                }
            }
