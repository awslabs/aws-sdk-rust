...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInstanceTypeLimits {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_instance_type_limits::de_describe_instance_type_limits_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_instance_type_limits::DescribeInstanceTypeLimitsError
{
