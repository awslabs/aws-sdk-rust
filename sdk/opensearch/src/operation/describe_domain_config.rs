...
impl DescribeDomainConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_domain_config::DescribeDomainConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDomainConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_domain_config::de_describe_domain_config_http_response_with_props(status, headers, body)
        }
    }
}
