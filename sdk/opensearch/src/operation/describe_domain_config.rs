...
/// Orchestration and serialization glue logic for `DescribeDomainConfig`.
...
impl DescribeDomainConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_domain_config::DescribeDomainConfigInput,
                    ) -> ::std::result::Result<crate::operation::describe_domain_config::DescribeDomainConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_domain_config::DescribeDomainConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_domain_config::DescribeDomainConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_domain_config::DescribeDomainConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDomainConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDomainConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDomainConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDomainConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDomainConfig")
...
.with_interceptor(DescribeDomainConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_domain_config::DescribeDomainConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_domain_config::DescribeDomainConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_domain_config::DescribeDomainConfigError>::new());
...
#[derive(Debug)]
            struct DescribeDomainConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDomainConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_domain_config::de_describe_domain_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_domain_config::de_describe_domain_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDomainConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDomainConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_domain_config::DescribeDomainConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_domain_config::DescribeDomainConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2021-01-01/opensearch/domain/{DomainName}/config", DomainName = domain_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribeDomainConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDomainConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDomainConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDomainConfigInput>()
                        .ok_or("failed to downcast to DescribeDomainConfigInput")?;
...
pub enum DescribeDomainConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDomainConfigError) for what information is available for the error.")]
...
impl DescribeDomainConfigError {
    /// Creates the `DescribeDomainConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDomainConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDomainConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_domain_config::DescribeDomainConfigError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_domain_config::_describe_domain_config_output::DescribeDomainConfigOutput;

pub use crate::operation::describe_domain_config::_describe_domain_config_input::DescribeDomainConfigInput;

mod _describe_domain_config_input;

mod _describe_domain_config_output;
