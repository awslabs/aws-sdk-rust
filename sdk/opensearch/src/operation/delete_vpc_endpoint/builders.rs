...
impl DeleteVpcEndpointInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_vpc_endpoint();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_vpc_endpoint::DeleteVpcEndpointOutput,
                    crate::operation::delete_vpc_endpoint::DeleteVpcEndpointError,
                > for DeleteVpcEndpointFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteVpcEndpointFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_vpc_endpoint::builders::DeleteVpcEndpointInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_vpc_endpoint::DeleteVpcEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_vpc_endpoint::DeleteVpcEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_vpc_endpoint::DeleteVpcEndpoint::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_vpc_endpoint::DeleteVpcEndpoint::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_vpc_endpoint::DeleteVpcEndpointOutput, crate::operation::delete_vpc_endpoint::DeleteVpcEndpointError, Self> {
