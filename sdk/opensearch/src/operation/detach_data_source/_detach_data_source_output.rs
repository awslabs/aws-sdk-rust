...
pub struct DetachDataSourceOutput {
...
impl ::aws_types::request_id::RequestId for DetachDataSourceOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DetachDataSourceOutput {
    /// Creates a new builder-style object to manufacture [`DetachDataSourceOutput`](crate::operation::detach_data_source::DetachDataSourceOutput).
    pub fn builder() -> crate::operation::detach_data_source::builders::DetachDataSourceOutputBuilder {
        crate::operation::detach_data_source::builders::DetachDataSourceOutputBuilder::default()
    }
}

/// A builder for [`DetachDataSourceOutput`](crate::operation::detach_data_source::DetachDataSourceOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DetachDataSourceOutputBuilder {
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) arn: ::std::option::Option<::std::string::String>,
    pub(crate) data_source_arn: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl DetachDataSourceOutputBuilder {
    /// <p>The unique identifier of the OpenSearch application.</p>
    ...
    /// Consumes the builder and constructs a [`DetachDataSourceOutput`](crate::operation::detach_data_source::DetachDataSourceOutput).
    pub fn build(self) -> crate::operation::detach_data_source::DetachDataSourceOutput {
