...
impl ListApplicationsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `application_summaries`. Queries to the underlying service
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_applications_output_output_next_token(resp);
...
impl ListApplicationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_applications_output_output_application_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
