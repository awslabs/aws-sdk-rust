    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2021-01-01/opensearch/cc/outboundConnection")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_outbound_connection::CreateOutboundConnection::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_outbound_connection::CreateOutboundConnectionError
{
