...
impl CreateIndex {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("OpenSearch", "CreateIndex", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateIndex {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateIndex", "OpenSearch"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/2021-01-01/opensearch/domain/{DomainName}/index", DomainName = domain_name)
...
impl CreateIndexError {
    ...
    /// Returns `true` if the error kind is `CreateIndexError::DependencyFailureException`.
    pub fn is_dependency_failure_exception(&self) -> bool {
        matches!(self, Self::DependencyFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateIndexError::DisabledOperationException`.
    pub fn is_disabled_operation_exception(&self) -> bool {
        matches!(self, Self::DisabledOperationException(_))
    }
    /// Returns `true` if the error kind is `CreateIndexError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `CreateIndexError::ResourceAlreadyExistsException`.
