...
impl  DescribeDomainsOutput  {
    ...
    pub fn domain_status_list(&self) -> & [crate::types::DomainStatus] {
        use std::ops::Deref; self.domain_status_list.deref()
    }
}
...
impl DescribeDomainsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_domains::DescribeDomainsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_domains::DescribeDomainsOutput {
                domain_status_list: self.domain_status_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domain_status_list", "domain_status_list was not specified but it is required when building DescribeDomainsOutput")
                    )?
                ,
