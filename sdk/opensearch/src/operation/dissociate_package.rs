...
/// Orchestration and serialization glue logic for `DissociatePackage`.
...
impl DissociatePackage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::dissociate_package::DissociatePackageInput,
                    ) -> ::std::result::Result<crate::operation::dissociate_package::DissociatePackageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::dissociate_package::DissociatePackageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::dissociate_package::DissociatePackageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::dissociate_package::DissociatePackageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DissociatePackage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DissociatePackage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DissociatePackageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DissociatePackageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DissociatePackage")
...
.with_interceptor(DissociatePackageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::dissociate_package::DissociatePackageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::dissociate_package::DissociatePackageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::dissociate_package::DissociatePackageError>::new());
...
#[derive(Debug)]
            struct DissociatePackageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DissociatePackageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_dissociate_package::de_dissociate_package_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_dissociate_package::de_dissociate_package_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DissociatePackageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DissociatePackageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::dissociate_package::DissociatePackageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::dissociate_package::DissociatePackageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.package_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("package_id", "cannot be empty or unset"))?;
    let package_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if package_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("package_id", "cannot be empty or unset"))
                }
    let input_2 = &_input.domain_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("domain_name", "cannot be empty or unset"))?;
    ...
    ::std::write!(output, "/2021-01-01/packages/dissociate/{PackageID}/{DomainName}", PackageID = package_id, DomainName = domain_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DissociatePackageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DissociatePackageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DissociatePackageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DissociatePackageInput>()
                        .ok_or("failed to downcast to DissociatePackageInput")?;
...
pub enum DissociatePackageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DissociatePackageError) for what information is available for the error.")]
...
impl DissociatePackageError {
    /// Creates the `DissociatePackageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DissociatePackageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DissociatePackageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::dissociate_package::DissociatePackageError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::dissociate_package::_dissociate_package_output::DissociatePackageOutput;

pub use crate::operation::dissociate_package::_dissociate_package_input::DissociatePackageInput;

mod _dissociate_package_input;

mod _dissociate_package_output;
