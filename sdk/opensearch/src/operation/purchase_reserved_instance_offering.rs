...
impl PurchaseReservedInstanceOfferingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::purchase_reserved_instance_offering::PurchaseReservedInstanceOffering::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseReservedInstanceOffering {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_purchase_reserved_instance_offering::de_purchase_reserved_instance_offering_http_response_with_props(
                status, headers, body,
            )
        }
    }
