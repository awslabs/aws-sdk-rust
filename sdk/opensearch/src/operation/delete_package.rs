...
impl DeletePackageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_package::DeletePackage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePackage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_package::de_delete_package_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_package::de_delete_package_http_response_with_props(
                status, headers, body,
            )
        }
    }
