...
impl ListDomainMaintenancesOutput {
    /// <p>List of the submitted maintenance actions.</p>
    pub fn domain_maintenances(&self) -> ::std::option::Option<&[crate::types::DomainMaintenanceDetails]> {
...
impl ::aws_http::request_id::RequestId for ListDomainMaintenancesOutput {
