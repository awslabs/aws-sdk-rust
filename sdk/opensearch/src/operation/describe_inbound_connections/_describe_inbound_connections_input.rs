...
impl DescribeInboundConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_inbound_connections::DescribeInboundConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
