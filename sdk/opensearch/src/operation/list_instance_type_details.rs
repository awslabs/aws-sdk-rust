...
impl ListInstanceTypeDetails {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_instance_type_details::ListInstanceTypeDetailsInput,
                    ) -> ::std::result::Result<crate::operation::list_instance_type_details::ListInstanceTypeDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_instance_type_details::ListInstanceTypeDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_instance_type_details::ListInstanceTypeDetailsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_instance_type_details::ListInstanceTypeDetailsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListInstanceTypeDetails {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListInstanceTypeDetails");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListInstanceTypeDetailsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListInstanceTypeDetailsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListInstanceTypeDetails")
...
.with_interceptor(ListInstanceTypeDetailsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_instance_type_details::ListInstanceTypeDetailsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_instance_type_details::ListInstanceTypeDetailsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_instance_type_details::ListInstanceTypeDetailsError>::new());
...
#[derive(Debug)]
            struct ListInstanceTypeDetailsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListInstanceTypeDetailsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_instance_type_details::de_list_instance_type_details_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListInstanceTypeDetailsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListInstanceTypeDetailsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_instance_type_details::ListInstanceTypeDetailsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_instance_type_details::ListInstanceTypeDetailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2021-01-01/opensearch/instanceTypeDetails/{EngineVersion}", EngineVersion = engine_version).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_instance_type_details::ListInstanceTypeDetailsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_6) = &_input.instance_type {
         {
            query.push_kv("instanceType", &::aws_smithy_http::query::fmt_string(inner_6));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ListInstanceTypeDetailsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListInstanceTypeDetailsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListInstanceTypeDetailsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListInstanceTypeDetailsInput>()
                        .ok_or("failed to downcast to ListInstanceTypeDetailsInput")?;
...
pub enum ListInstanceTypeDetailsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListInstanceTypeDetailsError) for what information is available for the error.")]
...
impl ListInstanceTypeDetailsError {
    /// Creates the `ListInstanceTypeDetailsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListInstanceTypeDetailsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListInstanceTypeDetailsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_instance_type_details::ListInstanceTypeDetailsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_instance_type_details::_list_instance_type_details_output::ListInstanceTypeDetailsOutput;

pub use crate::operation::list_instance_type_details::_list_instance_type_details_input::ListInstanceTypeDetailsInput;

mod _list_instance_type_details_input;

mod _list_instance_type_details_output;
