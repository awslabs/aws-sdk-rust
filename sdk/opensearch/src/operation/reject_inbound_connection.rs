...
impl RejectInboundConnectionInput {
    /// Consumes the builder and constructs an Operation<[`RejectInboundConnection`](crate::operation::reject_inbound_connection::RejectInboundConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reject_inbound_connection::RejectInboundConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reject_inbound_connection::RejectInboundConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reject_inbound_connection::RejectInboundConnection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RejectInboundConnection {
                type Output = std::result::Result<crate::operation::reject_inbound_connection::RejectInboundConnectionOutput, crate::operation::reject_inbound_connection::RejectInboundConnectionError>;
