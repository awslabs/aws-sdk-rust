...
impl RejectInboundConnectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reject_inbound_connection::RejectInboundConnection,
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectInboundConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_inbound_connection::de_reject_inbound_connection_http_response_with_props(status, headers, body)
        }
    }
}
