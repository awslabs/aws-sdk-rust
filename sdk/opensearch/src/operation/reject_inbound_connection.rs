...
impl RejectInboundConnection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::reject_inbound_connection::RejectInboundConnectionInput,
                    ) -> ::std::result::Result<crate::operation::reject_inbound_connection::RejectInboundConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_inbound_connection::RejectInboundConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reject_inbound_connection::RejectInboundConnectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reject_inbound_connection::RejectInboundConnectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectInboundConnection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RejectInboundConnection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RejectInboundConnectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RejectInboundConnectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RejectInboundConnection")
...
.with_interceptor(RejectInboundConnectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reject_inbound_connection::RejectInboundConnectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reject_inbound_connection::RejectInboundConnectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reject_inbound_connection::RejectInboundConnectionError>::new());
...
#[derive(Debug)]
            struct RejectInboundConnectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RejectInboundConnectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reject_inbound_connection::de_reject_inbound_connection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reject_inbound_connection::de_reject_inbound_connection_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RejectInboundConnectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RejectInboundConnectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reject_inbound_connection::RejectInboundConnectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reject_inbound_connection::RejectInboundConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2021-01-01/opensearch/cc/inboundConnection/{ConnectionId}/reject", ConnectionId = connection_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct RejectInboundConnectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RejectInboundConnectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RejectInboundConnectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RejectInboundConnectionInput>()
                        .ok_or("failed to downcast to RejectInboundConnectionInput")?;
...
pub enum RejectInboundConnectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RejectInboundConnectionError) for what information is available for the error.")]
...
impl RejectInboundConnectionError {
    /// Creates the `RejectInboundConnectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RejectInboundConnectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RejectInboundConnectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reject_inbound_connection::RejectInboundConnectionError {
...
mod _reject_inbound_connection_output;
