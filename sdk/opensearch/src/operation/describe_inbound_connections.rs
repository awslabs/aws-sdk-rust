...
impl DescribeInboundConnectionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_inbound_connections::DescribeInboundConnections,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_inbound_connections::DescribeInboundConnections::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInboundConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_inbound_connections::de_describe_inbound_connections_http_response_with_props(status, headers, body)
        }
    }
}
