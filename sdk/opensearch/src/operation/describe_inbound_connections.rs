...
/// Orchestration and serialization glue logic for `DescribeInboundConnections`.
...
impl DescribeInboundConnections {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_inbound_connections::DescribeInboundConnectionsInput,
                    ) -> ::std::result::Result<crate::operation::describe_inbound_connections::DescribeInboundConnectionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_inbound_connections::DescribeInboundConnectionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_inbound_connections::DescribeInboundConnectionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_inbound_connections::DescribeInboundConnectionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInboundConnections {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeInboundConnections");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeInboundConnectionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeInboundConnectionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInboundConnections")
...
.with_interceptor(DescribeInboundConnectionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_inbound_connections::DescribeInboundConnectionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_inbound_connections::DescribeInboundConnectionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_inbound_connections::DescribeInboundConnectionsError>::new());
...
#[derive(Debug)]
            struct DescribeInboundConnectionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeInboundConnectionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_inbound_connections::de_describe_inbound_connections_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_inbound_connections::de_describe_inbound_connections_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeInboundConnectionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeInboundConnectionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_inbound_connections::DescribeInboundConnectionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_inbound_connections::DescribeInboundConnectionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2021-01-01/opensearch/cc/inboundConnection/search").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_inbound_connections::ser_describe_inbound_connections_input(&input)?);
...
#[derive(Debug)]
            struct DescribeInboundConnectionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeInboundConnectionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeInboundConnectionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeInboundConnectionsInput>()
                        .ok_or("failed to downcast to DescribeInboundConnectionsInput")?;
...
pub enum DescribeInboundConnectionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeInboundConnectionsError) for what information is available for the error.")]
...
impl DescribeInboundConnectionsError {
    /// Creates the `DescribeInboundConnectionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeInboundConnectionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeInboundConnectionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_inbound_connections::DescribeInboundConnectionsError {
...
mod _describe_inbound_connections_output;
