    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2021-01-01/opensearch/cc/inboundConnection/search")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_inbound_connections::DescribeInboundConnections::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_inbound_connections::DescribeInboundConnectionsError
{
