...
impl DescribeOutboundConnectionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_outbound_connections::DescribeOutboundConnections,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_outbound_connections::DescribeOutboundConnections::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOutboundConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_outbound_connections::de_describe_outbound_connections_http_response_with_props(
                status, headers, body,
            )
        }
    }
