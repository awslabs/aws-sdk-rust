...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOutboundConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_outbound_connections::de_describe_outbound_connections_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeOutboundConnectionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_outbound_connections::DescribeOutboundConnectionsError
{
