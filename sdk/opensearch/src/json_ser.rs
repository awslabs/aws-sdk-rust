...
pub fn serialize_structure_crate_input_update_domain_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDomainConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_107) = &input.encryption_at_rest_options {
        ...
        crate::json_ser::serialize_structure_crate_model_encryption_at_rest_options(&mut object_108, var_107)?;
        object_108.finish();
    }
        ...
        for (key_111, value_112) in var_109 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_log_publishing_option(&mut object_113, value_112)?;
                object_113.finish();
            }
        }
        object_110.finish();
    ...
    if let Some(var_114) = &input.node_to_node_encryption_options {
        ...
        crate::json_ser::serialize_structure_crate_model_node_to_node_encryption_options(&mut object_115, var_114)?;
        object_115.finish();
    }
    if let Some(var_116) = &input.snapshot_options {
        #[allow(unused_mut)]
        let mut object_117 = object.key("SnapshotOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_snapshot_options(&mut object_117, var_116)?;
        object_117.finish();
    }
...
pub fn serialize_structure_crate_model_advanced_security_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AdvancedSecurityOptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_139) = &input.master_user_options {
        ...
        crate::json_ser::serialize_structure_crate_model_master_user_options(&mut object_140, var_139)?;
        object_140.finish();
    }
    if let Some(var_141) = &input.saml_options {
        #[allow(unused_mut)]
        let mut object_142 = object.key("SAMLOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_saml_options_input(&mut object_142, var_141)?;
        object_142.finish();
    }
        ...
        for item_147 in var_145 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_auto_tune_maintenance_schedule(&mut object_148, item_147)?;
                object_148.finish();
            }
        }
        array_146.finish();
...
pub fn serialize_structure_crate_model_cluster_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClusterConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_150) = &input.instance_count {
        object.key("InstanceCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_150).into()));
    }
    ...
    if let Some(var_153) = &input.zone_awareness_config {
        ...
        crate::json_ser::serialize_structure_crate_model_zone_awareness_config(&mut object_154, var_153)?;
        object_154.finish();
    }
    ...
    if let Some(var_156) = &input.dedicated_master_count {
        object.key("DedicatedMasterCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_156).into()));
    }
    ...
    if let Some(var_159) = &input.warm_count {
        object.key("WarmCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_159).into()));
    }
    if let Some(var_160) = &input.cold_storage_options {
        #[allow(unused_mut)]
        let mut object_161 = object.key("ColdStorageOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_cold_storage_options(&mut object_161, var_160)?;
        object_161.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_domain_endpoint_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainEndpointOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_170) = &input.custom_endpoint_certificate_arn {
        object.key("CustomEndpointCertificateArn").string(var_170.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_ebs_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EbsOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_173) = &input.volume_size {
        object.key("VolumeSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_173).into()));
    }
    if let Some(var_174) = &input.iops {
        object.key("Iops").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_174).into()));
    }
    if let Some(var_175) = &input.throughput {
        object.key("Throughput").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_175).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_log_publishing_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogPublishingOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_178) = &input.cloud_watch_logs_log_group_arn {
        object.key("CloudWatchLogsLogGroupArn").string(var_178.as_str());
    }
...
pub fn serialize_structure_crate_model_snapshot_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SnapshotOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_181) = &input.automated_snapshot_start_hour {
        object.key("AutomatedSnapshotStartHour").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_181).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_domain_information_container(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainInformationContainer) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_188) = &input.aws_domain_information {
        ...
        crate::json_ser::serialize_structure_crate_model_aws_domain_information(&mut object_189, var_188)?;
        object_189.finish();
    }
    Ok(())
}
        ...
        for item_204 in var_202 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_auto_tune_maintenance_schedule(&mut object_205, item_204)?;
                object_205.finish();
            }
        }
        array_203.finish();
...
pub fn serialize_structure_crate_model_saml_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamlOptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_216) = &input.session_timeout_minutes {
        object.key("SessionTimeoutMinutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_216).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_auto_tune_maintenance_schedule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoTuneMaintenanceSchedule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_217) = &input.start_at {
        object.key("StartAt").date_time(var_217, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_220) = &input.cron_expression_for_recurrence {
        object.key("CronExpressionForRecurrence").string(var_220.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_zone_awareness_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZoneAwarenessConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_221) = &input.availability_zone_count {
        object.key("AvailabilityZoneCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_221).into()));
    }
    Ok(())
}
