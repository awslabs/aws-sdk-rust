...
pub fn serialize_structure_crate_input_cancel_service_software_update_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CancelServiceSoftwareUpdateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDomainInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_20) = &input.domain_endpoint_options {
        ...
        crate::json_ser::serialize_structure_crate_model_domain_endpoint_options(&mut object_21, var_20)?;
        object_21.finish();
    }
    ...
    if let Some(var_25) = &input.encryption_at_rest_options {
        ...
        crate::json_ser::serialize_structure_crate_model_encryption_at_rest_options(&mut object_26, var_25)?;
        object_26.finish();
    }
...
pub fn serialize_structure_crate_input_create_outbound_connection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOutboundConnectionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_44) = &input.local_domain_info {
        ...
        crate::json_ser::serialize_structure_crate_model_domain_information_container(&mut object_45, var_44)?;
        object_45.finish();
    }
    if let Some(var_46) = &input.remote_domain_info {
        let mut object_47 = object.key("RemoteDomainInfo").start_object();
        crate::json_ser::serialize_structure_crate_model_domain_information_container(&mut object_47, var_46)?;
        object_47.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_describe_domains_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeDomainsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_inbound_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeInboundConnectionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_outbound_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeOutboundConnectionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_purchase_reserved_instance_offering_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PurchaseReservedInstanceOfferingInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_73) = &input.reserved_instance_offering_id {
        object.key("ReservedInstanceOfferingId").string(var_73.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_start_service_software_update_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartServiceSoftwareUpdateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_domain_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDomainConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_92) = &input.domain_endpoint_options {
        ...
        crate::json_ser::serialize_structure_crate_model_domain_endpoint_options(&mut object_93, var_92)?;
        object_93.finish();
    }
...
pub fn serialize_structure_crate_input_upgrade_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpgradeDomainInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_advanced_security_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AdvancedSecurityOptionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_126) = &input.master_user_options {
        ...
        crate::json_ser::serialize_structure_crate_model_master_user_options(&mut object_127, var_126)?;
        object_127.finish();
    }
    if let Some(var_128) = &input.saml_options {
        let mut object_129 = object.key("SAMLOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_saml_options_input(&mut object_129, var_128)?;
        object_129.finish();
    }
        ...
        for item_134 in var_132 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_auto_tune_maintenance_schedule(&mut object_135, item_134)?;
                object_135.finish();
            }
        }
        array_133.finish();
...
pub fn serialize_structure_crate_model_cluster_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClusterConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_137) = &input.instance_count {
        object.key("InstanceCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_137).into()));
    }
    ...
    if let Some(var_140) = &input.zone_awareness_config {
        ...
        crate::json_ser::serialize_structure_crate_model_zone_awareness_config(&mut object_141, var_140)?;
        object_141.finish();
    }
    ...
    if let Some(var_143) = &input.dedicated_master_count {
        object.key("DedicatedMasterCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_143).into()));
    }
    ...
    if let Some(var_146) = &input.warm_count {
        object.key("WarmCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_146).into()));
    }
    if let Some(var_147) = &input.cold_storage_options {
        let mut object_148 = object.key("ColdStorageOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_cold_storage_options(&mut object_148, var_147)?;
        object_148.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_domain_endpoint_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainEndpointOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_157) = &input.custom_endpoint_certificate_arn {
        object.key("CustomEndpointCertificateArn").string(var_157.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_ebs_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EbsOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_160) = &input.volume_size {
        object.key("VolumeSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_160).into()));
    }
    ...
    if let Some(var_162) = &input.throughput {
        object.key("Throughput").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_162).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_log_publishing_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogPublishingOption) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_165) = &input.cloud_watch_logs_log_group_arn {
        object.key("CloudWatchLogsLogGroupArn").string(var_165.as_str());
    }
...
pub fn serialize_structure_crate_model_snapshot_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SnapshotOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_168) = &input.automated_snapshot_start_hour {
        object.key("AutomatedSnapshotStartHour").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_168).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_domain_information_container(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainInformationContainer) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_175) = &input.aws_domain_information {
        let mut object_176 = object.key("AWSDomainInformation").start_object();
        crate::json_ser::serialize_structure_crate_model_aws_domain_information(&mut object_176, var_175)?;
        object_176.finish();
    }
    Ok(())
}
        ...
        for item_191 in var_189 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_auto_tune_maintenance_schedule(&mut object_192, item_191)?;
                object_192.finish();
            }
        }
        array_190.finish();
...
pub fn serialize_structure_crate_model_master_user_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MasterUserOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_193) = &input.master_user_arn {
        object.key("MasterUserARN").string(var_193.as_str());
    }
    if let Some(var_194) = &input.master_user_name {
        object.key("MasterUserName").string(var_194.as_str());
    }
    if let Some(var_195) = &input.master_user_password {
        object.key("MasterUserPassword").string(var_195.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_saml_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamlOptionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_197) = &input.idp {
        let mut object_198 = object.key("Idp").start_object();
        crate::json_ser::serialize_structure_crate_model_saml_idp(&mut object_198, var_197)?;
        object_198.finish();
    }
    if let Some(var_199) = &input.master_user_name {
        object.key("MasterUserName").string(var_199.as_str());
    }
    if let Some(var_200) = &input.master_backend_role {
        object.key("MasterBackendRole").string(var_200.as_str());
    }
    if let Some(var_201) = &input.subject_key {
        object.key("SubjectKey").string(var_201.as_str());
    }
    if let Some(var_202) = &input.roles_key {
        object.key("RolesKey").string(var_202.as_str());
    }
    if let Some(var_203) = &input.session_timeout_minutes {
        object.key("SessionTimeoutMinutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_203).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_auto_tune_maintenance_schedule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoTuneMaintenanceSchedule) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_204) = &input.start_at {
        object.key("StartAt").date_time(var_204, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_205) = &input.duration {
        let mut object_206 = object.key("Duration").start_object();
        crate::json_ser::serialize_structure_crate_model_duration(&mut object_206, var_205)?;
        object_206.finish();
    }
    if let Some(var_207) = &input.cron_expression_for_recurrence {
        object.key("CronExpressionForRecurrence").string(var_207.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_zone_awareness_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ZoneAwarenessConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_208) = &input.availability_zone_count {
        object.key("AvailabilityZoneCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_208).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_aws_domain_information(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsDomainInformation) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_210) = &input.owner_id {
        object.key("OwnerId").string(var_210.as_str());
    }
    if let Some(var_211) = &input.domain_name {
        object.key("DomainName").string(var_211.as_str());
    }
    if let Some(var_212) = &input.region {
        object.key("Region").string(var_212.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_saml_idp(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamlIdp) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_213) = &input.metadata_content {
        object.key("MetadataContent").string(var_213.as_str());
    }
    if let Some(var_214) = &input.entity_id {
        object.key("EntityId").string(var_214.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_duration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Duration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_215) = &input.unit {
        object.key("Unit").string(var_215.as_str());
    }
    Ok(())
}
