...
impl super::Client {
    ...
    ///   - [`reserved_instance_id(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesFluentBuilder::reserved_instance_id) / [`set_reserved_instance_id(Option<String>)`](crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesFluentBuilder::set_reserved_instance_id): <p>The reserved instance identifier filter value. Use this parameter to show only the reservation that matches the specified reserved OpenSearch instance ID.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesFluentBuilder::set_max_results): <p>An optional parameter that specifies the maximum number of results to return. You can use <code>nextToken</code> to get the next page of results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesFluentBuilder::set_next_token): <p>If your initial <code>DescribeReservedInstances</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>DescribeReservedInstances</code> operations, which returns results in the next page.</p>
