...
impl super::Client {
    ...
    ///   - [`advanced_options(impl Into<String>, impl Into<String>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::advanced_options) / [`set_advanced_options(Option<HashMap<String, String>>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::set_advanced_options): <p>Only supports the <code>override_main_response_version</code> parameter and not other advanced options. You can only include this option when upgrading to an OpenSearch version. Specifies whether the domain reports its version as 7.10 so that it continues to work with Elasticsearch OSS clients and plugins.</p>
