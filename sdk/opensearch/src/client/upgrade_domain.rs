...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::set_domain_name):<br>required: **true**<br><p>Name of the OpenSearch Service domain that you want to upgrade.</p><br>
    ///   - [`target_version(impl Into<String>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::target_version) / [`set_target_version(Option<String>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::set_target_version):<br>required: **true**<br><p>OpenSearch or Elasticsearch version to which you want to upgrade, in the format Opensearch_X.Y or Elasticsearch_X.Y.</p><br>
    ///   - [`perform_check_only(bool)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::perform_check_only) / [`set_perform_check_only(Option<bool>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::set_perform_check_only):<br>required: **false**<br><p>When true, indicates that an upgrade eligibility check needs to be performed. Does not actually perform the upgrade.</p><br>
    ///   - [`advanced_options(impl Into<String>, impl Into<String>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::advanced_options) / [`set_advanced_options(Option<HashMap::<String, String>>)`](crate::operation::upgrade_domain::builders::UpgradeDomainFluentBuilder::set_advanced_options):<br>required: **false**<br><p>Only supports the <code>override_main_response_version</code> parameter and not other advanced options. You can only include this option when upgrading to an OpenSearch version. Specifies whether the domain reports its version as 7.10 so that it continues to work with Elasticsearch OSS clients and plugins.</p><br>
