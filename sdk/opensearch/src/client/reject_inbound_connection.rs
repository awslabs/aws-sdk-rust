...
impl super::Client {
    ...
    ///   - [`connection_id(impl ::std::convert::Into<String>)`](crate::operation::reject_inbound_connection::builders::RejectInboundConnectionFluentBuilder::connection_id) / [`set_connection_id(Option<String>)`](crate::operation::reject_inbound_connection::builders::RejectInboundConnectionFluentBuilder::set_connection_id): <p>The unique identifier of the inbound connection to reject.</p>
