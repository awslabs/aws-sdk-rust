...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::list_scheduled_actions::builders::ListScheduledActionsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::list_scheduled_actions::builders::ListScheduledActionsFluentBuilder::set_domain_name): <p>The name of the domain.</p>
