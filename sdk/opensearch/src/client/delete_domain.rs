...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::set_domain_name):<br>required: **true**<br><p>The name of the domain you want to permanently delete.</p><br>
                            /// - On success, responds with [`DeleteDomainOutput`](crate::operation::delete_domain::DeleteDomainOutput) with field(s):
    ///   - [`domain_status(Option<DomainStatus>)`](crate::operation::delete_domain::DeleteDomainOutput::domain_status): <p>The status of the domain being deleted.</p>
