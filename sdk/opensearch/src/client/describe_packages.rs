...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::set_max_results): <p>An optional parameter that specifies the maximum number of results to return. You can use <code>nextToken</code> to get the next page of results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::set_next_token): <p>If your initial <code>DescribePackageFilters</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>DescribePackageFilters</code> operations, which returns results in the next page.</p>
