...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::describe_dry_run_progress::builders::DescribeDryRunProgressFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::describe_dry_run_progress::builders::DescribeDryRunProgressFluentBuilder::set_domain_name): <p>The name of the domain.</p>
    ///   - [`dry_run_id(impl ::std::convert::Into<String>)`](crate::operation::describe_dry_run_progress::builders::DescribeDryRunProgressFluentBuilder::dry_run_id) / [`set_dry_run_id(Option<String>)`](crate::operation::describe_dry_run_progress::builders::DescribeDryRunProgressFluentBuilder::set_dry_run_id): <p>The unique identifier of the dry run.</p>
