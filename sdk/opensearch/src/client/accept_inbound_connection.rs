...
impl super::Client {
    ...
    pub fn accept_inbound_connection(
        &self,
    ) -> crate::operation::accept_inbound_connection::builders::AcceptInboundConnectionFluentBuilder
    {
