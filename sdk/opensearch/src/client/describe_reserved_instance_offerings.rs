...
impl super::Client {
    ...
    ///   - [`reserved_instance_offering_id(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsFluentBuilder::reserved_instance_offering_id) / [`set_reserved_instance_offering_id(Option<String>)`](crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsFluentBuilder::set_reserved_instance_offering_id): <p>The Reserved Instance identifier filter value. Use this parameter to show only the available instance types that match the specified reservation identifier.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsFluentBuilder::set_max_results): <p>An optional parameter that specifies the maximum number of results to return. You can use <code>nextToken</code> to get the next page of results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_reserved_instance_offerings::builders::DescribeReservedInstanceOfferingsFluentBuilder::set_next_token): <p>If your initial <code>DescribeReservedInstanceOfferings</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>DescribeReservedInstanceOfferings</code> operations, which returns results in the next page.</p>
