...
impl super::Client {
    ...
    ///   - [`domain_names(impl Into<String>)`](crate::operation::describe_domains::builders::DescribeDomainsFluentBuilder::domain_names) / [`set_domain_names(Option<Vec<String>>)`](crate::operation::describe_domains::builders::DescribeDomainsFluentBuilder::set_domain_names): <p>Array of OpenSearch Service domain names that you want information about. You must specify at least one domain name.</p>
