...
impl super::Client {
    ...
    ///   - [`domain_names(impl Into<String>)`](crate::operation::describe_domains::builders::DescribeDomainsFluentBuilder::domain_names) / [`set_domain_names(Option<Vec<String>>)`](crate::operation::describe_domains::builders::DescribeDomainsFluentBuilder::set_domain_names): <p>Array of OpenSearch Service domain names that you want information about. If you don't specify any domains, OpenSearch Service returns information about all domains owned by the account.</p>
