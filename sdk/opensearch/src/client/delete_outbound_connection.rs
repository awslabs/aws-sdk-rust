...
impl super::Client {
    ...
    ///   - [`connection_id(impl Into<String>)`](crate::operation::delete_outbound_connection::builders::DeleteOutboundConnectionFluentBuilder::connection_id) / [`set_connection_id(Option<String>)`](crate::operation::delete_outbound_connection::builders::DeleteOutboundConnectionFluentBuilder::set_connection_id):<br>required: **true**<br><p>The ID of the outbound connection you want to permanently delete.</p><br>
