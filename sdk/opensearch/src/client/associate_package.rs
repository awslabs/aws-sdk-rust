...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::set_domain_name): <p>Name of the domain to associate the package with.</p>
