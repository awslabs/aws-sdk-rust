...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::cancel_domain_config_change::builders::CancelDomainConfigChangeFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::cancel_domain_config_change::builders::CancelDomainConfigChangeFluentBuilder::set_domain_name):<br>required: **true**<br><p>The name of an OpenSearch Service domain. Domain names are unique across the domains owned by an account within an Amazon Web Services Region.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::cancel_domain_config_change::builders::CancelDomainConfigChangeFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::cancel_domain_config_change::builders::CancelDomainConfigChangeFluentBuilder::set_dry_run):<br>required: **false**<br><p>When set to <code>True</code>, returns the list of change IDs and properties that will be cancelled without actually cancelling the change.</p><br>
    ...
    ///   - [`dry_run(Option<bool>)`](crate::operation::cancel_domain_config_change::CancelDomainConfigChangeOutput::dry_run): <p>Whether or not the request was a dry run. If <code>True</code>, the changes were not actually cancelled.</p>
