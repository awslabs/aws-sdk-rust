...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::get_upgrade_history::builders::GetUpgradeHistoryFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_upgrade_history::builders::GetUpgradeHistoryFluentBuilder::set_domain_name): <p>The name of an existing domain.</p>
    ///   - [`max_results(i32)`](crate::operation::get_upgrade_history::builders::GetUpgradeHistoryFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_upgrade_history::builders::GetUpgradeHistoryFluentBuilder::set_max_results): <p>An optional parameter that specifies the maximum number of results to return. You can use <code>nextToken</code> to get the next page of results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_upgrade_history::builders::GetUpgradeHistoryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_upgrade_history::builders::GetUpgradeHistoryFluentBuilder::set_next_token): <p>If your initial <code>GetUpgradeHistory</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>GetUpgradeHistory</code> operations, which returns results in the next page.</p>
