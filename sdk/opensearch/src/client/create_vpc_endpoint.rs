...
impl super::Client {
    ...
    ///   - [`domain_arn(impl Into<String>)`](crate::operation::create_vpc_endpoint::builders::CreateVpcEndpointFluentBuilder::domain_arn) / [`set_domain_arn(Option<String>)`](crate::operation::create_vpc_endpoint::builders::CreateVpcEndpointFluentBuilder::set_domain_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the domain to create the endpoint for.</p><br>
