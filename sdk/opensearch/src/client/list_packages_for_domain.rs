...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_packages_for_domain::builders::ListPackagesForDomainFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_packages_for_domain::builders::ListPackagesForDomainFluentBuilder::set_max_results):<br>required: **false**<br><p>An optional parameter that specifies the maximum number of results to return. You can use <code>nextToken</code> to get the next page of results.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_packages_for_domain::builders::ListPackagesForDomainFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_packages_for_domain::builders::ListPackagesForDomainFluentBuilder::set_next_token):<br>required: **false**<br><p>If your initial <code>ListPackagesForDomain</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>ListPackagesForDomain</code> operations, which returns results in the next page.</p><br>
