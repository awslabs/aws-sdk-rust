...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::retrieve_domain_auth_code::builders::RetrieveDomainAuthCodeFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::retrieve_domain_auth_code::builders::RetrieveDomainAuthCodeFluentBuilder::set_domain_name):<br>required: **true**<br><p>The name of the domain that you want to get an authorization code for.</p><br>
