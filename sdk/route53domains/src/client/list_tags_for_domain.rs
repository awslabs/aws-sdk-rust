...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::list_tags_for_domain::builders::ListTagsForDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::list_tags_for_domain::builders::ListTagsForDomainFluentBuilder::set_domain_name):<br>required: **true**<br><p>The domain for which you want to get a list of tags.</p><br>
