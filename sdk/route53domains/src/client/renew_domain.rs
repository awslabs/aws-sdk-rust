...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::renew_domain::builders::RenewDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::renew_domain::builders::RenewDomainFluentBuilder::set_domain_name): <p>The name of the domain that you want to renew.</p>
    ...
    ///   - [`current_expiry_year(i32)`](crate::operation::renew_domain::builders::RenewDomainFluentBuilder::current_expiry_year) / [`set_current_expiry_year(Option<i32>)`](crate::operation::renew_domain::builders::RenewDomainFluentBuilder::set_current_expiry_year): <p>The year when the registration for the domain is set to expire. This value must match the current expiration date for the domain.</p>
