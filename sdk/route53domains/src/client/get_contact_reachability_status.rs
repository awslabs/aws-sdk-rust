...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::get_contact_reachability_status::builders::GetContactReachabilityStatusFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_contact_reachability_status::builders::GetContactReachabilityStatusFluentBuilder::set_domain_name):<br>required: **false**<br><p>The name of the domain for which you want to know whether the registrant contact has confirmed that the email address is valid.</p><br>
