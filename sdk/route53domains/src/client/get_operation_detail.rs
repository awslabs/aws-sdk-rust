...
impl super::Client {
    ...
    pub fn get_operation_detail(
        &self,
    ) -> crate::operation::get_operation_detail::builders::GetOperationDetailFluentBuilder {
        crate::operation::get_operation_detail::builders::GetOperationDetailFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
