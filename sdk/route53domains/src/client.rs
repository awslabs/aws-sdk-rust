    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AcceptDomainTransferFromAnotherAwsAccountInput`](crate::input::AcceptDomainTransferFromAnotherAwsAccountInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::AcceptDomainTransferFromAnotherAwsAccountInput::domain_name): <p>The name of the domain that was specified when another Amazon Web Services account submitted a <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_TransferDomainToAnotherAwsAccount.html">TransferDomainToAnotherAwsAccount</a> request. </p>
    ///   - [`password(Option<String>)`](crate::input::AcceptDomainTransferFromAnotherAwsAccountInput::password): <p>The password that was returned by the <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_TransferDomainToAnotherAwsAccount.html">TransferDomainToAnotherAwsAccount</a> request. </p>
    ...
    ///
    /// - Takes [`CancelDomainTransferToAnotherAwsAccountInput`](crate::input::CancelDomainTransferToAnotherAwsAccountInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::CancelDomainTransferToAnotherAwsAccountInput::domain_name): <p>The name of the domain for which you want to cancel the transfer to another Amazon Web Services account.</p>
    ...
    ///
    /// - Takes [`CheckDomainTransferabilityInput`](crate::input::CheckDomainTransferabilityInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::CheckDomainTransferabilityInput::domain_name): <p>The name of the domain that you want to transfer to Route 53. The top-level domain (TLD), such as .com, must be a TLD that Route 53 supports. For a list of supported TLDs, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html">Domains that You Can Register with Amazon Route 53</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>  <p>The domain name can contain only the following characters:</p>  <ul>   <li> <p>Letters a through z. Domain names are not case sensitive.</p> </li>   <li> <p>Numbers 0 through 9.</p> </li>   <li> <p>Hyphen (-). You can't specify a hyphen at the beginning or end of a label. </p> </li>   <li> <p>Period (.) to separate the labels in the name, such as the <code>.</code> in <code>example.com</code>.</p> </li>  </ul>
    ///   - [`auth_code(Option<String>)`](crate::input::CheckDomainTransferabilityInput::auth_code): <p>If the registrar for the top-level domain (TLD) requires an authorization code to transfer the domain, the code that you got from the current registrar for the domain.</p>
    ...
    ///   - [`domain_name(Option<String>)`](crate::input::DeleteDomainInput::domain_name): <p>Name of the domain to be deleted.</p>
    ...
    ///
    /// - Takes [`DeleteTagsForDomainInput`](crate::input::DeleteTagsForDomainInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::DeleteTagsForDomainInput::domain_name): <p>The domain for which you want to delete one or more tags.</p>
    ///   - [`tags_to_delete(Option<Vec<String>>)`](crate::input::DeleteTagsForDomainInput::tags_to_delete): <p>A list of tag keys to delete.</p>
    ...
    ///
    /// - Takes [`DisableDomainAutoRenewInput`](crate::input::DisableDomainAutoRenewInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::DisableDomainAutoRenewInput::domain_name): <p>The name of the domain that you want to disable automatic renewal for.</p>
    ...
    ///
    /// - Takes [`DisableDomainTransferLockInput`](crate::input::DisableDomainTransferLockInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::DisableDomainTransferLockInput::domain_name): <p>The name of the domain that you want to remove the transfer lock for.</p>
    ...
    ///
    /// - Takes [`EnableDomainAutoRenewInput`](crate::input::EnableDomainAutoRenewInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::EnableDomainAutoRenewInput::domain_name): <p>The name of the domain that you want to enable automatic renewal for.</p>
    ...
    ///
    /// - Takes [`EnableDomainTransferLockInput`](crate::input::EnableDomainTransferLockInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::EnableDomainTransferLockInput::domain_name): <p>The name of the domain that you want to set the transfer lock for.</p>
    ...
    ///
    /// - Takes [`GetContactReachabilityStatusInput`](crate::input::GetContactReachabilityStatusInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::GetContactReachabilityStatusInput::domain_name): <p>The name of the domain for which you want to know whether the registrant contact has confirmed that the email address is valid.</p>
    ...
    ///
    /// - Takes [`GetDomainDetailInput`](crate::input::GetDomainDetailInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::GetDomainDetailInput::domain_name): <p>The name of the domain that you want to get detailed information about.</p>
    ...
    ///
    /// - Takes [`GetOperationDetailInput`](crate::input::GetOperationDetailInput) with field(s):
    ///   - [`operation_id(Option<String>)`](crate::input::GetOperationDetailInput::operation_id): <p>The identifier for the operation for which you want to get the status. Route 53 returned the identifier in the response to the original request.</p>
    ...
    ///   - [`filter_conditions(Option<Vec<FilterCondition>>)`](crate::input::ListDomainsInput::filter_conditions): <p>A complex type that contains information about the filters applied during the <code>ListDomains</code> request. The filter conditions can include domain name and domain expiration.</p>
    ///   - [`sort_condition(Option<SortCondition>)`](crate::input::ListDomainsInput::sort_condition): <p>A complex type that contains information about the requested ordering of domains in the returned list.</p>
    ///   - [`marker(Option<String>)`](crate::input::ListDomainsInput::marker): <p>For an initial request for a list of domains, omit this element. If the number of domains that are associated with the current Amazon Web Services account is greater than the value that you specified for <code>MaxItems</code>, you can use <code>Marker</code> to return additional domains. Get the value of <code>NextPageMarker</code> from the previous response, and submit another request that includes the value of <code>NextPageMarker</code> in the <code>Marker</code> element.</p>  <p>Constraints: The marker must match the value specified in the previous request.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListDomainsInput::max_items): <p>Number of domains to be returned.</p>  <p>Default: 20</p>
    ...
    ///   - [`submitted_since(Option<DateTime>)`](crate::input::ListOperationsInput::submitted_since): <p>An optional parameter that lets you get information about all the operations that you submitted after a specified date and time. Specify the date and time in Unix time format and Coordinated Universal time (UTC).</p>
    ///   - [`marker(Option<String>)`](crate::input::ListOperationsInput::marker): <p>For an initial request for a list of operations, omit this element. If the number of operations that are not yet complete is greater than the value that you specified for <code>MaxItems</code>, you can use <code>Marker</code> to return additional operations. Get the value of <code>NextPageMarker</code> from the previous response, and submit another request that includes the value of <code>NextPageMarker</code> in the <code>Marker</code> element.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListOperationsInput::max_items): <p>Number of domains to be returned.</p>  <p>Default: 20</p>
    ...
    ///
    /// - Takes [`ListPricesInput`](crate::input::ListPricesInput) with field(s):
    ///   - [`tld(Option<String>)`](crate::input::ListPricesInput::tld): <p>The TLD for which you want to receive the pricing information. For example. <code>.net</code>.</p>  <p>If a <code>Tld</code> value is not provided, a list of prices for all TLDs supported by Route&nbsp;53 is returned.</p>
    ///   - [`marker(Option<String>)`](crate::input::ListPricesInput::marker): <p>For an initial request for a list of prices, omit this element. If the number of prices that are not yet complete is greater than the value that you specified for <code>MaxItems</code>, you can use <code>Marker</code> to return additional prices. Get the value of <code>NextPageMarker</code> from the previous response, and submit another request that includes the value of <code>NextPageMarker</code> in the <code>Marker</code> element. </p>  <p>Used only for all TLDs. If you specify a TLD, don't specify a <code>Marker</code>.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ListPricesInput::max_items): <p>Number of <code>Prices</code> to be returned.</p>  <p>Used only for all TLDs. If you specify a TLD, don't specify a <code>MaxItems</code>.</p>
    ...
    ///
    /// - Takes [`ListTagsForDomainInput`](crate::input::ListTagsForDomainInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::ListTagsForDomainInput::domain_name): <p>The domain for which you want to get a list of tags.</p>
    ...
    ///   - [`domain_name(Option<String>)`](crate::input::RegisterDomainInput::domain_name): <p>The domain name that you want to register. The top-level domain (TLD), such as .com, must be a TLD that Route 53 supports. For a list of supported TLDs, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html">Domains that You Can Register with Amazon Route 53</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>  <p>The domain name can contain only the following characters:</p>  <ul>   <li> <p>Letters a through z. Domain names are not case sensitive.</p> </li>   <li> <p>Numbers 0 through 9.</p> </li>   <li> <p>Hyphen (-). You can't specify a hyphen at the beginning or end of a label. </p> </li>   <li> <p>Period (.) to separate the labels in the name, such as the <code>.</code> in <code>example.com</code>.</p> </li>  </ul>  <p>Internationalized domain names are not supported for some top-level domains. To determine whether the TLD that you want to use supports internationalized domain names, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html">Domains that You Can Register with Amazon Route 53</a>. For more information, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DomainNameFormat.html#domain-name-format-idns">Formatting Internationalized Domain Names</a>. </p>
    ///   - [`idn_lang_code(Option<String>)`](crate::input::RegisterDomainInput::idn_lang_code): <p>Reserved for future use.</p>
    ///   - [`duration_in_years(Option<i32>)`](crate::input::RegisterDomainInput::duration_in_years): <p>The number of years that you want to register the domain for. Domains are registered for a minimum of one year. The maximum period depends on the top-level domain. For the range of valid values for your domain, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html">Domains that You Can Register with Amazon Route 53</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>  <p>Default: 1</p>
    ///   - [`auto_renew(Option<bool>)`](crate::input::RegisterDomainInput::auto_renew): <p>Indicates whether the domain will be automatically renewed (<code>true</code>) or not (<code>false</code>). Autorenewal only takes effect after the account is charged.</p>  <p>Default: <code>true</code> </p>
    ///   - [`admin_contact(Option<ContactDetail>)`](crate::input::RegisterDomainInput::admin_contact): <p>Provides detailed contact information. For information about the values that you specify for each element, see <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html">ContactDetail</a>.</p>
    ///   - [`registrant_contact(Option<ContactDetail>)`](crate::input::RegisterDomainInput::registrant_contact): <p>Provides detailed contact information. For information about the values that you specify for each element, see <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html">ContactDetail</a>.</p>
    ///   - [`tech_contact(Option<ContactDetail>)`](crate::input::RegisterDomainInput::tech_contact): <p>Provides detailed contact information. For information about the values that you specify for each element, see <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html">ContactDetail</a>.</p>
    ///   - [`privacy_protect_admin_contact(Option<bool>)`](crate::input::RegisterDomainInput::privacy_protect_admin_contact): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the admin contact.</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>  <p>Default: <code>true</code> </p>
    ///   - [`privacy_protect_registrant_contact(Option<bool>)`](crate::input::RegisterDomainInput::privacy_protect_registrant_contact): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the registrant contact (the domain owner).</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>  <p>Default: <code>true</code> </p>
    ///   - [`privacy_protect_tech_contact(Option<bool>)`](crate::input::RegisterDomainInput::privacy_protect_tech_contact): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the technical contact.</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>  <p>Default: <code>true</code> </p>
    ...
    ///
    /// - Takes [`RejectDomainTransferFromAnotherAwsAccountInput`](crate::input::RejectDomainTransferFromAnotherAwsAccountInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::RejectDomainTransferFromAnotherAwsAccountInput::domain_name): <p>The name of the domain that was specified when another Amazon Web Services account submitted a <a href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_TransferDomainToAnotherAwsAccount.html">TransferDomainToAnotherAwsAccount</a> request. </p>
    ...
    ///
    /// - Takes [`RenewDomainInput`](crate::input::RenewDomainInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::RenewDomainInput::domain_name): <p>The name of the domain that you want to renew.</p>
    ///   - [`duration_in_years(Option<i32>)`](crate::input::RenewDomainInput::duration_in_years): <p>The number of years that you want to renew the domain for. The maximum number of years depends on the top-level domain. For the range of valid values for your domain, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html">Domains that You Can Register with Amazon Route 53</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>  <p>Default: 1</p>
    ///   - [`current_expiry_year(i32)`](crate::input::RenewDomainInput::current_expiry_year): <p>The year when the registration for the domain is set to expire. This value must match the current expiration date for the domain.</p>
    ...
    ///
    /// - Takes [`ResendContactReachabilityEmailInput`](crate::input::ResendContactReachabilityEmailInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::ResendContactReachabilityEmailInput::domain_name): <p>The name of the domain for which you want Route 53 to resend a confirmation email to the registrant contact.</p>
    ...
    ///
    /// - Takes [`RetrieveDomainAuthCodeInput`](crate::input::RetrieveDomainAuthCodeInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::RetrieveDomainAuthCodeInput::domain_name): <p>The name of the domain that you want to get an authorization code for.</p>
    ...
    ///
    /// - Takes [`TransferDomainInput`](crate::input::TransferDomainInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::TransferDomainInput::domain_name): <p>The name of the domain that you want to transfer to Route 53. The top-level domain (TLD), such as .com, must be a TLD that Route 53 supports. For a list of supported TLDs, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/registrar-tld-list.html">Domains that You Can Register with Amazon Route 53</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>  <p>The domain name can contain only the following characters:</p>  <ul>   <li> <p>Letters a through z. Domain names are not case sensitive.</p> </li>   <li> <p>Numbers 0 through 9.</p> </li>   <li> <p>Hyphen (-). You can't specify a hyphen at the beginning or end of a label. </p> </li>   <li> <p>Period (.) to separate the labels in the name, such as the <code>.</code> in <code>example.com</code>.</p> </li>  </ul>
    ///   - [`idn_lang_code(Option<String>)`](crate::input::TransferDomainInput::idn_lang_code): <p>Reserved for future use.</p>
    ///   - [`duration_in_years(Option<i32>)`](crate::input::TransferDomainInput::duration_in_years): <p>The number of years that you want to register the domain for. Domains are registered for a minimum of one year. The maximum period depends on the top-level domain.</p>  <p>Default: 1</p>
    ///   - [`nameservers(Option<Vec<Nameserver>>)`](crate::input::TransferDomainInput::nameservers): <p>Contains details for the host and glue IP addresses.</p>
    ///   - [`auth_code(Option<String>)`](crate::input::TransferDomainInput::auth_code): <p>The authorization code for the domain. You get this value from the current registrar.</p>
    ///   - [`auto_renew(Option<bool>)`](crate::input::TransferDomainInput::auto_renew): <p>Indicates whether the domain will be automatically renewed (true) or not (false). Autorenewal only takes effect after the account is charged.</p>  <p>Default: true</p>
    ///   - [`admin_contact(Option<ContactDetail>)`](crate::input::TransferDomainInput::admin_contact): <p>Provides detailed contact information.</p>
    ///   - [`registrant_contact(Option<ContactDetail>)`](crate::input::TransferDomainInput::registrant_contact): <p>Provides detailed contact information.</p>
    ///   - [`tech_contact(Option<ContactDetail>)`](crate::input::TransferDomainInput::tech_contact): <p>Provides detailed contact information.</p>
    ///   - [`privacy_protect_admin_contact(Option<bool>)`](crate::input::TransferDomainInput::privacy_protect_admin_contact): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the admin contact.</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>  <p>Default: <code>true</code> </p>
    ///   - [`privacy_protect_registrant_contact(Option<bool>)`](crate::input::TransferDomainInput::privacy_protect_registrant_contact): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the registrant contact (domain owner).</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>  <p>Default: <code>true</code> </p>
    ///   - [`privacy_protect_tech_contact(Option<bool>)`](crate::input::TransferDomainInput::privacy_protect_tech_contact): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the technical contact.</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>  <p>Default: <code>true</code> </p>
    ...
    ///
    /// - Takes [`TransferDomainToAnotherAwsAccountInput`](crate::input::TransferDomainToAnotherAwsAccountInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::TransferDomainToAnotherAwsAccountInput::domain_name): <p>The name of the domain that you want to transfer from the current Amazon Web Services account to another account.</p>
    ///   - [`account_id(Option<String>)`](crate::input::TransferDomainToAnotherAwsAccountInput::account_id): <p>The account ID of the Amazon Web Services account that you want to transfer the domain to, for example, <code>111122223333</code>.</p>
    ...
    ///
    /// - Takes [`UpdateDomainContactInput`](crate::input::UpdateDomainContactInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::UpdateDomainContactInput::domain_name): <p>The name of the domain that you want to update contact information for.</p>
    ///   - [`admin_contact(Option<ContactDetail>)`](crate::input::UpdateDomainContactInput::admin_contact): <p>Provides detailed contact information.</p>
    ///   - [`registrant_contact(Option<ContactDetail>)`](crate::input::UpdateDomainContactInput::registrant_contact): <p>Provides detailed contact information.</p>
    ///   - [`tech_contact(Option<ContactDetail>)`](crate::input::UpdateDomainContactInput::tech_contact): <p>Provides detailed contact information.</p>
    ...
    ///
    /// - Takes [`UpdateDomainContactPrivacyInput`](crate::input::UpdateDomainContactPrivacyInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::UpdateDomainContactPrivacyInput::domain_name): <p>The name of the domain that you want to update the privacy setting for.</p>
    ///   - [`admin_privacy(Option<bool>)`](crate::input::UpdateDomainContactPrivacyInput::admin_privacy): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the admin contact.</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>
    ///   - [`registrant_privacy(Option<bool>)`](crate::input::UpdateDomainContactPrivacyInput::registrant_privacy): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the registrant contact (domain owner).</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>
    ///   - [`tech_privacy(Option<bool>)`](crate::input::UpdateDomainContactPrivacyInput::tech_privacy): <p>Whether you want to conceal contact information from WHOIS queries. If you specify <code>true</code>, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify <code>false</code>, WHOIS queries return the information that you entered for the technical contact.</p> <note>   <p>You must specify the same privacy setting for the administrative, registrant, and technical contacts.</p>  </note>
    ...
    ///
    /// - Takes [`UpdateDomainNameserversInput`](crate::input::UpdateDomainNameserversInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::UpdateDomainNameserversInput::domain_name): <p>The name of the domain that you want to change name servers for.</p>
    ///   - [`fi_auth_key(Option<String>)`](crate::input::UpdateDomainNameserversInput::fi_auth_key): <p>The authorization key for .fi domains</p>
    ///   - [`nameservers(Option<Vec<Nameserver>>)`](crate::input::UpdateDomainNameserversInput::nameservers): <p>A list of new name servers for the domain.</p>
    ...
    ///
    /// - Takes [`UpdateTagsForDomainInput`](crate::input::UpdateTagsForDomainInput) with field(s):
    ///   - [`domain_name(Option<String>)`](crate::input::UpdateTagsForDomainInput::domain_name): <p>The domain for which you want to add or update tags.</p>
    ///   - [`tags_to_update(Option<Vec<Tag>>)`](crate::input::UpdateTagsForDomainInput::tags_to_update): <p>A list of the tag keys and values that you want to add or update. If you specify a key that already exists, the corresponding value will be replaced.</p>
    ...
    ///
    /// - Takes [`ViewBillingInput`](crate::input::ViewBillingInput) with field(s):
    ///   - [`start(Option<DateTime>)`](crate::input::ViewBillingInput::start): <p>The beginning date and time for the time period for which you want a list of billing records. Specify the date and time in Unix time format and Coordinated Universal time (UTC).</p>
    ///   - [`end(Option<DateTime>)`](crate::input::ViewBillingInput::end): <p>The end date and time for the time period for which you want a list of billing records. Specify the date and time in Unix time format and Coordinated Universal time (UTC).</p>
    ///   - [`marker(Option<String>)`](crate::input::ViewBillingInput::marker): <p>For an initial request for a list of billing records, omit this element. If the number of billing records that are associated with the current Amazon Web Services account during the specified period is greater than the value that you specified for <code>MaxItems</code>, you can use <code>Marker</code> to return additional billing records. Get the value of <code>NextPageMarker</code> from the previous response, and submit another request that includes the value of <code>NextPageMarker</code> in the <code>Marker</code> element. </p>  <p>Constraints: The marker must match the value of <code>NextPageMarker</code> that was returned in the previous response.</p>
    ///   - [`max_items(Option<i32>)`](crate::input::ViewBillingInput::max_items): <p>The number of billing records to be returned.</p>  <p>Default: 20</p>
