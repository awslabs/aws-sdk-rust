...
pub fn ser_update_domain_contact_privacy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDomainContactPrivacyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
