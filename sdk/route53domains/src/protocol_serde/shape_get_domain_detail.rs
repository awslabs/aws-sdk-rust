...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_domain_detail_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_domain_detail::GetDomainDetailOutput, crate::operation::get_domain_detail::GetDomainDetailError> {
...
) -> Result<crate::operation::get_domain_detail::builders::GetDomainDetailOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
