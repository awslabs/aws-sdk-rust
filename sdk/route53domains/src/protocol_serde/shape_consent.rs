...
pub fn ser_consent(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Consent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
