...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_retrieve_domain_auth_code::de_retrieve_domain_auth_code(_response_body, output)
            .map_err(crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError::unhandled)?;
