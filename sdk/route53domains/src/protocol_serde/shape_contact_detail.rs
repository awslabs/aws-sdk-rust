...
pub(crate) fn de_contact_detail<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ContactDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ExtraParams" => {
                            builder = builder.set_extra_params(crate::protocol_serde::shape_extra_param_list::de_extra_param_list(tokens, _value)?);
                        }
