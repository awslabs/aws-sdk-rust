...
pub(crate) fn de_contact_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContactDetail>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_contact_detail(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContactDetail) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
