...
pub fn de_delete_tags_for_domain_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_tags_for_domain::DeleteTagsForDomainOutput, crate::operation::delete_tags_for_domain::DeleteTagsForDomainError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_tags_for_domain::DeleteTagsForDomainError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_tags_for_domain_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_tags_for_domain::DeleteTagsForDomainOutput, crate::operation::delete_tags_for_domain::DeleteTagsForDomainError> {
    Ok({
        #[allow(unused_mut)]
