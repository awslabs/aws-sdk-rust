...
pub fn ser_transfer_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TransferDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
