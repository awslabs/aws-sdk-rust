...
pub(crate) fn deser_structure_crate_error_operation_limit_exceeded_json_err(
    ...
    crate::error::operation_limit_exceeded::Builder,
    aws_smithy_json::deserialize::error::DeserializeError,
> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value))
...
pub(crate) fn deser_structure_crate_error_unsupported_tld_json_err(
    ...
    crate::error::unsupported_tld::Builder,
    aws_smithy_json::deserialize::error::DeserializeError,
> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value))
...
pub(crate) fn deser_structure_crate_error_dnssec_limit_exceeded_json_err(
    value: &[u8],
...
pub(crate) fn deser_operation_crate_operation_associate_delegation_signer_to_domain(
    value: &[u8],
...
pub(crate) fn deser_operation_crate_operation_disassociate_delegation_signer_from_domain(
    value: &[u8],
...
pub(crate) fn deser_operation_crate_operation_list_tags_for_domain(
    ...
    crate::output::list_tags_for_domain_output::Builder,
    aws_smithy_json::deserialize::error::DeserializeError,
> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value))
...
#[allow(non_snake_case)]
pub(crate) fn deser_list_com_amazonaws_route53domains_dnssec_key_list<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<
...
pub(crate) fn deser_structure_crate_model_dnssec_key<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
...
pub(crate) fn deser_structure_crate_model_domain_suggestion<'a, I>(
    ...
    Option<crate::model::DomainSuggestion>,
    aws_smithy_json::deserialize::error::DeserializeError,
>
where
    I: Iterator<
...
pub(crate) fn deser_structure_crate_model_domain_price<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<Option<crate::model::DomainPrice>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
            aws_smithy_json::deserialize::Token<'a>,
...
pub(crate) fn deser_structure_crate_model_billing_record<'a, I>(
    ...
    Option<crate::model::BillingRecord>,
    aws_smithy_json::deserialize::error::DeserializeError,
>
where
    I: Iterator<
...
pub(crate) fn deser_structure_crate_model_price_with_currency<'a, I>(
    ...
    Option<crate::model::PriceWithCurrency>,
    aws_smithy_json::deserialize::error::DeserializeError,
>
where
    I: Iterator<
