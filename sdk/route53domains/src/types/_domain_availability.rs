...
impl DomainAvailability {
    ...
    DomainAvailability::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AVAILABLE", "AVAILABLE_PREORDER", "AVAILABLE_RESERVED", "DONT_KNOW", "INVALID_NAME_FOR_TLD", "PENDING", "RESERVED", "UNAVAILABLE", "UNAVAILABLE_PREMIUM", "UNAVAILABLE_RESTRICTED"]
                }
            }
