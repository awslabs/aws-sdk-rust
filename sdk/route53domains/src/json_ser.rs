...
pub fn serialize_structure_accept_domain_transfer_from_another_aws_account_input(
...
pub fn serialize_structure_cancel_domain_transfer_to_another_aws_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_check_domain_availability_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_check_domain_transferability_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_tags_for_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disable_domain_auto_renew_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disable_domain_transfer_lock_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_enable_domain_auto_renew_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_enable_domain_transfer_lock_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_contact_reachability_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_domain_detail_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_domain_suggestions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_operation_detail_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_tags_for_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_register_domain_input(
    ...
    if let Some(var_31) = &input.admin_contact {
        ...
        crate::json_ser::serialize_structure_contact_detail(&mut object_32, var_31);
        object_32.finish();
    }
    if let Some(var_33) = &input.registrant_contact {
        let mut object_34 = object.key("RegistrantContact").start_object();
        crate::json_ser::serialize_structure_contact_detail(&mut object_34, var_33);
        object_34.finish();
    }
    if let Some(var_35) = &input.tech_contact {
        let mut object_36 = object.key("TechContact").start_object();
        crate::json_ser::serialize_structure_contact_detail(&mut object_36, var_35);
        object_36.finish();
    }
...
pub fn serialize_structure_reject_domain_transfer_from_another_aws_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_renew_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_resend_contact_reachability_email_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_retrieve_domain_auth_code_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_transfer_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_50 in var_48 {
            {
                ...
                crate::json_ser::serialize_structure_nameserver(&mut object_51, item_50);
                object_51.finish();
            }
        }
        array_49.finish();
    ...
    if let Some(var_54) = &input.admin_contact {
        ...
        crate::json_ser::serialize_structure_contact_detail(&mut object_55, var_54);
        object_55.finish();
    }
    if let Some(var_56) = &input.registrant_contact {
        let mut object_57 = object.key("RegistrantContact").start_object();
        crate::json_ser::serialize_structure_contact_detail(&mut object_57, var_56);
        object_57.finish();
    }
    if let Some(var_58) = &input.tech_contact {
        let mut object_59 = object.key("TechContact").start_object();
        crate::json_ser::serialize_structure_contact_detail(&mut object_59, var_58);
        object_59.finish();
    }
...
pub fn serialize_structure_transfer_domain_to_another_aws_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_domain_contact_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_66) = &input.admin_contact {
        ...
        crate::json_ser::serialize_structure_contact_detail(&mut object_67, var_66);
        object_67.finish();
    }
    if let Some(var_68) = &input.registrant_contact {
        let mut object_69 = object.key("RegistrantContact").start_object();
        crate::json_ser::serialize_structure_contact_detail(&mut object_69, var_68);
        object_69.finish();
    }
    if let Some(var_70) = &input.tech_contact {
        let mut object_71 = object.key("TechContact").start_object();
        crate::json_ser::serialize_structure_contact_detail(&mut object_71, var_70);
        object_71.finish();
    }
}

pub fn serialize_structure_update_domain_contact_privacy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_domain_nameservers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_80 in var_78 {
            {
                ...
                crate::json_ser::serialize_structure_nameserver(&mut object_81, item_80);
                object_81.finish();
            }
        }
        array_79.finish();
...
pub fn serialize_structure_update_tags_for_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_view_billing_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_contact_detail(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_106 in var_104 {
            {
                ...
                crate::json_ser::serialize_structure_extra_param(&mut object_107, item_106);
                object_107.finish();
            }
        }
        array_105.finish();
...
pub fn serialize_structure_nameserver(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_extra_param(
    object: &mut smithy_json::serialize::JsonObjectWriter,
