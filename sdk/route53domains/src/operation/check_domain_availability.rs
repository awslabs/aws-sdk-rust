...
impl CheckDomainAvailability {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::check_domain_availability::CheckDomainAvailabilityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::check_domain_availability::CheckDomainAvailabilityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CheckDomainAvailability",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CheckDomainAvailability {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CheckDomainAvailabilityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CheckDomainAvailabilityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CheckDomainAvailability")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CheckDomainAvailability")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CheckDomainAvailabilityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CheckDomainAvailabilityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CheckDomainAvailabilityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CheckDomainAvailabilityInput>() else {
        ...
        if requested.should_capture("IdnLangCode") {
            if let ::std::option::Option::Some(value) = input.idn_lang_code.as_deref() {
                captured.insert("IdnLangCode", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CheckDomainAvailabilityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_check_domain_availability::de_check_domain_availability_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_check_domain_availability::de_check_domain_availability_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CheckDomainAvailabilityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::check_domain_availability::CheckDomainAvailabilityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::check_domain_availability::CheckDomainAvailabilityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_check_domain_availability::ser_check_domain_availability_input(&input)?,
        );
...
impl CheckDomainAvailabilityError {
    ...
    /// Returns `true` if the error kind is `CheckDomainAvailabilityError::TldInMaintenance`.
