...
impl CheckDomainAvailabilityInput {
    /// Consumes the builder and constructs an Operation<[`CheckDomainAvailability`](crate::operation::check_domain_availability::CheckDomainAvailability)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::check_domain_availability::CheckDomainAvailability, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::check_domain_availability::CheckDomainAvailabilityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::check_domain_availability::CheckDomainAvailability::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CheckDomainAvailability {
                type Output = std::result::Result<crate::operation::check_domain_availability::CheckDomainAvailabilityOutput, crate::operation::check_domain_availability::CheckDomainAvailabilityError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_check_domain_availability::de_check_domain_availability_http_error(response)
                     } else {
                        crate::protocol_serde::shape_check_domain_availability::de_check_domain_availability_http_response(response)
                     }
                }
            }
