...
impl UpdateTagsForDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_tags_for_domain::UpdateTagsForDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_tags_for_domain::UpdateTagsForDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_tags_for_domain::UpdateTagsForDomainOutput, crate::operation::update_tags_for_domain::UpdateTagsForDomainError, Self> {
