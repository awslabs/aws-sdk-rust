...
impl DisableDomainAutoRenew {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableDomainAutoRenew {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableDomainAutoRenew");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableDomainAutoRenewRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableDomainAutoRenewResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableDomainAutoRenew")
...
.with_interceptor(DisableDomainAutoRenewEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError>::new());
...
#[derive(Debug)]
            struct DisableDomainAutoRenewResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableDomainAutoRenewResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_disable_domain_auto_renew::de_disable_domain_auto_renew_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisableDomainAutoRenewRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableDomainAutoRenewRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_domain_auto_renew::ser_disable_domain_auto_renew_input(&input)?);
...
#[derive(Debug)]
            struct DisableDomainAutoRenewEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableDomainAutoRenewEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableDomainAutoRenewEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableDomainAutoRenewInput>()
                        .ok_or("failed to downcast to DisableDomainAutoRenewInput")?;
...
pub enum DisableDomainAutoRenewError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableDomainAutoRenewError) for what information is available for the error.")]
...
impl DisableDomainAutoRenewError {
    /// Creates the `DisableDomainAutoRenewError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableDomainAutoRenewError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableDomainAutoRenewError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError {
