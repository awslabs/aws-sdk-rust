...
impl UpdateTagsForDomainInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_tags_for_domain::ser_update_tags_for_domain_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_tags_for_domain::UpdateTagsForDomain::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_tags_for_domain::UpdateTagsForDomainError
{
