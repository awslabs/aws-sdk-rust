...
impl UpdateDomainContactPrivacyInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacy::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDomainContactPrivacy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_domain_contact_privacy::de_update_domain_contact_privacy_http_error(response)
        } else {
            crate::protocol_serde::shape_update_domain_contact_privacy::de_update_domain_contact_privacy_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacyError
{
