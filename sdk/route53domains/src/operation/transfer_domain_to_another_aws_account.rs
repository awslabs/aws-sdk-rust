    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TransferDomainToAnotherAwsAccount {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TransferDomainToAnotherAwsAccount");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TransferDomainToAnotherAwsAccountRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TransferDomainToAnotherAwsAccountResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TransferDomainToAnotherAwsAccount")
...
.with_interceptor(TransferDomainToAnotherAwsAccountEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError>::new());
...
#[derive(Debug)]
            struct TransferDomainToAnotherAwsAccountResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TransferDomainToAnotherAwsAccountResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_transfer_domain_to_another_aws_account::de_transfer_domain_to_another_aws_account_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct TransferDomainToAnotherAwsAccountRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TransferDomainToAnotherAwsAccountRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_transfer_domain_to_another_aws_account::ser_transfer_domain_to_another_aws_account_input(&input)?);
...
#[derive(Debug)]
            struct TransferDomainToAnotherAwsAccountEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TransferDomainToAnotherAwsAccountEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TransferDomainToAnotherAwsAccountEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TransferDomainToAnotherAwsAccountInput>()
                        .ok_or("failed to downcast to TransferDomainToAnotherAwsAccountInput")?;
...
pub enum TransferDomainToAnotherAwsAccountError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TransferDomainToAnotherAwsAccountError) for what information is available for the error.")]
...
impl TransferDomainToAnotherAwsAccountError {
    /// Creates the `TransferDomainToAnotherAwsAccountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TransferDomainToAnotherAwsAccountError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TransferDomainToAnotherAwsAccountError {
...
impl ::aws_types::request_id::RequestId for crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError {
