...
impl TransferDomainToAnotherAwsAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TransferDomainToAnotherAwsAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_transfer_domain_to_another_aws_account::de_transfer_domain_to_another_aws_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
