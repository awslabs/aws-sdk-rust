...
impl EnableDomainAutoRenewInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::enable_domain_auto_renew::EnableDomainAutoRenew,
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableDomainAutoRenew {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_domain_auto_renew::de_enable_domain_auto_renew_http_response_with_props(status, headers, body)
        }
    }
}
