...
impl EnableDomainAutoRenewInput {
    /// Consumes the builder and constructs an Operation<[`EnableDomainAutoRenew`](crate::operation::enable_domain_auto_renew::EnableDomainAutoRenew)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenew, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_domain_auto_renew::EnableDomainAutoRenew::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EnableDomainAutoRenew {
                type Output = std::result::Result<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewOutput, crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_enable_domain_auto_renew::de_enable_domain_auto_renew_http_error(response)
                     } else {
                        crate::protocol_serde::shape_enable_domain_auto_renew::de_enable_domain_auto_renew_http_response(response)
                     }
                }
            }
