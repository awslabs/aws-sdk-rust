...
impl EnableDomainAutoRenew {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableDomainAutoRenew {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableDomainAutoRenew");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableDomainAutoRenewRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableDomainAutoRenewResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableDomainAutoRenew")
...
.with_interceptor(EnableDomainAutoRenewEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError>::new());
...
#[derive(Debug)]
            struct EnableDomainAutoRenewResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableDomainAutoRenewResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_domain_auto_renew::de_enable_domain_auto_renew_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct EnableDomainAutoRenewRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableDomainAutoRenewRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_domain_auto_renew::ser_enable_domain_auto_renew_input(&input)?);
...
#[derive(Debug)]
            struct EnableDomainAutoRenewEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableDomainAutoRenewEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableDomainAutoRenewEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableDomainAutoRenewInput>()
                        .ok_or("failed to downcast to EnableDomainAutoRenewInput")?;
...
pub enum EnableDomainAutoRenewError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableDomainAutoRenewError) for what information is available for the error.")]
...
impl EnableDomainAutoRenewError {
    /// Creates the `EnableDomainAutoRenewError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableDomainAutoRenewError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableDomainAutoRenewError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError {
...
mod _enable_domain_auto_renew_output;
