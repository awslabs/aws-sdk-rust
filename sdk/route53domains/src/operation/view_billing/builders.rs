...
impl ViewBillingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::view_billing::ViewBillingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::view_billing::ViewBillingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::view_billing::ViewBillingOutput, crate::operation::view_billing::ViewBillingError, Self> {
