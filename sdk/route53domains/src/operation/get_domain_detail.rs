...
impl GetDomainDetailInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_domain_detail::GetDomainDetail::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetDomainDetail {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_domain_detail::de_get_domain_detail_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_domain_detail::de_get_domain_detail_http_response(
                status, headers, body,
            )
        }
    }
