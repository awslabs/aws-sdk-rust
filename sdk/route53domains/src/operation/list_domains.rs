...
impl ListDomainsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_domains::ListDomains, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_domains::ser_list_domains_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDomains {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_domains::de_list_domains_http_response_with_props(status, headers, body)
        }
    }
}
