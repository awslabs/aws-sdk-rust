...
impl CheckDomainTransferabilityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::check_domain_transferability::CheckDomainTransferabilityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::check_domain_transferability::CheckDomainTransferabilityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::check_domain_transferability::CheckDomainTransferabilityOutput, crate::operation::check_domain_transferability::CheckDomainTransferabilityError, Self> {
