...
impl crate::operation::check_domain_transferability::builders::CheckDomainTransferabilityInputBuilder {
...
impl CheckDomainTransferabilityFluentBuilder {
    /// Creates a new `CheckDomainTransferabilityFluentBuilder`.
