...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::resend_operation_authorization::ResendOperationAuthorizationOutput,
                    crate::operation::resend_operation_authorization::ResendOperationAuthorizationError,
                > for ResendOperationAuthorizationFluentBuilder
            {
                fn send(
                    self,
...
impl ResendOperationAuthorizationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::resend_operation_authorization::ResendOperationAuthorizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resend_operation_authorization::ResendOperationAuthorizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::resend_operation_authorization::ResendOperationAuthorization::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::resend_operation_authorization::ResendOperationAuthorization::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::resend_operation_authorization::ResendOperationAuthorizationOutput, crate::operation::resend_operation_authorization::ResendOperationAuthorizationError, Self> {
