...
impl DisableDomainTransferLockInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_domain_transfer_lock::DisableDomainTransferLock::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DisableDomainTransferLock {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_disable_domain_transfer_lock::de_disable_domain_transfer_lock_http_error(response)
        } else {
            crate::protocol_serde::shape_disable_domain_transfer_lock::de_disable_domain_transfer_lock_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockError
{
