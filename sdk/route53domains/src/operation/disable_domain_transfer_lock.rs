...
impl DisableDomainTransferLock {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.DisableDomainTransferLock",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "DisableDomainTransferLock",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableDomainTransferLock {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisableDomainTransferLockRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisableDomainTransferLockResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisableDomainTransferLock")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableDomainTransferLock")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisableDomainTransferLockTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisableDomainTransferLockTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableDomainTransferLockTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisableDomainTransferLockInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableDomainTransferLockResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disable_domain_transfer_lock::de_disable_domain_transfer_lock_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_disable_domain_transfer_lock::de_disable_domain_transfer_lock_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableDomainTransferLockRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disable_domain_transfer_lock::ser_disable_domain_transfer_lock_input(&input)?,
        );
