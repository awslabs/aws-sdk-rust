...
impl ListTagsForDomainInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_tags_for_domain::ser_list_tags_for_domain_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_tags_for_domain::ListTagsForDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTagsForDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_tags_for_domain::de_list_tags_for_domain_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_tags_for_domain::ListTagsForDomainError
{
