...
impl ListTagsForDomainInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tags_for_domain::ser_list_tags_for_domain_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTagsForDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tags_for_domain::de_list_tags_for_domain_http_response_with_props(status, headers, body)
        }
    }
}
