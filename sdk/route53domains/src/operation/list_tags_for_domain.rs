...
impl ListTagsForDomain {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_tags_for_domain::ListTagsForDomainError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_tags_for_domain::ListTagsForDomainOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.ListTagsForDomain",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "ListTagsForDomain",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTagsForDomain {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListTagsForDomainRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListTagsForDomainResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListTagsForDomain")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTagsForDomain")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListTagsForDomainTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListTagsForDomainTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTagsForDomainTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListTagsForDomainInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTagsForDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_tags_for_domain::de_list_tags_for_domain_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_tags_for_domain::de_list_tags_for_domain_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTagsForDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_tags_for_domain::ListTagsForDomainInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_tags_for_domain::ListTagsForDomainInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_tags_for_domain::ser_list_tags_for_domain_input(&input)?);
