...
impl CheckDomainTransferabilityInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::check_domain_transferability::CheckDomainTransferability::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckDomainTransferability {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_check_domain_transferability::de_check_domain_transferability_http_response_with_props(status, headers, body)
        }
    }
}
