...
impl CheckDomainTransferabilityInput {
    /// Consumes the builder and constructs an Operation<[`CheckDomainTransferability`](crate::operation::check_domain_transferability::CheckDomainTransferability)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::check_domain_transferability::CheckDomainTransferability, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::check_domain_transferability::CheckDomainTransferabilityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::check_domain_transferability::CheckDomainTransferability::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CheckDomainTransferability {
                type Output = std::result::Result<crate::operation::check_domain_transferability::CheckDomainTransferabilityOutput, crate::operation::check_domain_transferability::CheckDomainTransferabilityError>;
