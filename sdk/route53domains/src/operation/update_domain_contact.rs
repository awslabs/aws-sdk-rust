...
impl UpdateDomainContactInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_domain_contact::ser_update_domain_contact_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_domain_contact::UpdateDomainContact::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainContact {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_domain_contact::de_update_domain_contact_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_domain_contact::UpdateDomainContactError
{
