...
impl UpdateDomainContactInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDomainContact`](crate::operation::update_domain_contact::UpdateDomainContact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_domain_contact::UpdateDomainContact, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_domain_contact::UpdateDomainContactInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_domain_contact::UpdateDomainContact::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDomainContact {
                type Output = std::result::Result<crate::operation::update_domain_contact::UpdateDomainContactOutput, crate::operation::update_domain_contact::UpdateDomainContactError>;
