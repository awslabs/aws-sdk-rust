...
impl DisassociateDelegationSignerFromDomain {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.DisassociateDelegationSignerFromDomain",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "DisassociateDelegationSignerFromDomain",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateDelegationSignerFromDomain {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociateDelegationSignerFromDomainRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateDelegationSignerFromDomainResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociateDelegationSignerFromDomain")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateDelegationSignerFromDomain")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisassociateDelegationSignerFromDomainTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisassociateDelegationSignerFromDomainTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateDelegationSignerFromDomainTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisassociateDelegationSignerFromDomainInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateDelegationSignerFromDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_delegation_signer_from_domain::de_disassociate_delegation_signer_from_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_disassociate_delegation_signer_from_domain::de_disassociate_delegation_signer_from_domain_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateDelegationSignerFromDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_delegation_signer_from_domain::ser_disassociate_delegation_signer_from_domain_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError
{
