...
impl GetDomainSuggestionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_domain_suggestions::ser_get_domain_suggestions_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_domain_suggestions::GetDomainSuggestions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_domain_suggestions::GetDomainSuggestionsError
{
