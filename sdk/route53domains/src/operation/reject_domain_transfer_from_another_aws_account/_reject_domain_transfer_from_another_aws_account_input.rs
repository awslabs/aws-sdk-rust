...
impl RejectDomainTransferFromAnotherAwsAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_domain_transfer_from_another_aws_account::RejectDomainTransferFromAnotherAwsAccountInput, ::aws_smithy_types::error::operation::BuildError> {
