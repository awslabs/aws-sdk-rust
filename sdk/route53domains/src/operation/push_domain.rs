...
impl PushDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::push_domain::PushDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PushDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_push_domain::de_push_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_push_domain::de_push_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
