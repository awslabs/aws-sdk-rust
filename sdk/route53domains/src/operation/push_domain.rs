...
impl PushDomainInput {
    /// Consumes the builder and constructs an Operation<[`PushDomain`](crate::operation::push_domain::PushDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::push_domain::PushDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::push_domain::PushDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::push_domain::PushDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PushDomain", "route53domains"));
...
impl aws_smithy_http::response::ParseStrictResponse for PushDomain {
                type Output = std::result::Result<crate::operation::push_domain::PushDomainOutput, crate::operation::push_domain::PushDomainError>;
