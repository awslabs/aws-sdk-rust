...
impl PushDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::push_domain::PushDomain, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_push_domain::ser_push_domain_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PushDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_push_domain::de_push_domain_http_response_with_props(status, headers, body)
        }
    }
}
