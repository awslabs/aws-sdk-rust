...
impl GetOperationDetailInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_operation_detail::ser_get_operation_detail_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_operation_detail::GetOperationDetail::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOperationDetail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_operation_detail::de_get_operation_detail_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_operation_detail::GetOperationDetailError
{
