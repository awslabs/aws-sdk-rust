...
impl GetOperationDetailInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_operation_detail::ser_get_operation_detail_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOperationDetail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_operation_detail::de_get_operation_detail_http_response_with_props(status, headers, body)
        }
    }
}
