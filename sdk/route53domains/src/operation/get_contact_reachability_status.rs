...
impl GetContactReachabilityStatus {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_contact_reachability_status::GetContactReachabilityStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_contact_reachability_status::GetContactReachabilityStatusOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.GetContactReachabilityStatus",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "GetContactReachabilityStatus",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContactReachabilityStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetContactReachabilityStatusRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetContactReachabilityStatusResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetContactReachabilityStatus")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContactReachabilityStatus")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetContactReachabilityStatusTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetContactReachabilityStatusTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContactReachabilityStatusTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetContactReachabilityStatusInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContactReachabilityStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_contact_reachability_status::de_get_contact_reachability_status_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_contact_reachability_status::de_get_contact_reachability_status_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContactReachabilityStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_contact_reachability_status::GetContactReachabilityStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_contact_reachability_status::GetContactReachabilityStatusInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_contact_reachability_status::ser_get_contact_reachability_status_input(&input)?,
        );
