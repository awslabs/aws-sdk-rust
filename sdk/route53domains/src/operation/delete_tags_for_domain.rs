...
impl DeleteTagsForDomainInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_tags_for_domain::ser_delete_tags_for_domain_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_tags_for_domain::DeleteTagsForDomain::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTagsForDomain {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_tags_for_domain::de_delete_tags_for_domain_http_error(response)
        } else {
            crate::protocol_serde::shape_delete_tags_for_domain::de_delete_tags_for_domain_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_tags_for_domain::DeleteTagsForDomainError
{
