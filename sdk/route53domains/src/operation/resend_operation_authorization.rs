...
impl ResendOperationAuthorizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resend_operation_authorization::ResendOperationAuthorization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResendOperationAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resend_operation_authorization::de_resend_operation_authorization_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ResendOperationAuthorizationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::resend_operation_authorization::ResendOperationAuthorizationError
{
