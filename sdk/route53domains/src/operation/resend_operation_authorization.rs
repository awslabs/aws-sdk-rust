...
impl ResendOperationAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`ResendOperationAuthorization`](crate::operation::resend_operation_authorization::ResendOperationAuthorization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::resend_operation_authorization::ResendOperationAuthorization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resend_operation_authorization::ResendOperationAuthorizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::resend_operation_authorization::ResendOperationAuthorization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResendOperationAuthorization", "route53domains"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResendOperationAuthorization {
                type Output = std::result::Result<crate::operation::resend_operation_authorization::ResendOperationAuthorizationOutput, crate::operation::resend_operation_authorization::ResendOperationAuthorizationError>;
