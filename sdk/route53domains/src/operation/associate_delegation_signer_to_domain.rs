...
impl AssociateDelegationSignerToDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDelegationSignerToDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_delegation_signer_to_domain::de_associate_delegation_signer_to_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
