...
impl AssociateDelegationSignerToDomain {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.AssociateDelegationSignerToDomain",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "AssociateDelegationSignerToDomain",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateDelegationSignerToDomain {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateDelegationSignerToDomainRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateDelegationSignerToDomainResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AssociateDelegationSignerToDomain")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateDelegationSignerToDomain")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AssociateDelegationSignerToDomainTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AssociateDelegationSignerToDomainTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateDelegationSignerToDomainTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AssociateDelegationSignerToDomainInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateDelegationSignerToDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_delegation_signer_to_domain::de_associate_delegation_signer_to_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_delegation_signer_to_domain::de_associate_delegation_signer_to_domain_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateDelegationSignerToDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_delegation_signer_to_domain::ser_associate_delegation_signer_to_domain_input(&input)?,
        );
...
impl ::std::error::Error for AssociateDelegationSignerToDomainError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::DnssecLimitExceeded(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateDelegationSignerToDomainError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DnssecLimitExceeded(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
