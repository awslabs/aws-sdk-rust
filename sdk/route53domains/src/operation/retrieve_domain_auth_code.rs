...
impl RetrieveDomainAuthCode {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RetrieveDomainAuthCode {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RetrieveDomainAuthCode");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RetrieveDomainAuthCodeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RetrieveDomainAuthCodeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RetrieveDomainAuthCode")
...
.with_interceptor(RetrieveDomainAuthCodeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError>::new());
...
#[derive(Debug)]
            struct RetrieveDomainAuthCodeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RetrieveDomainAuthCodeResponseDeserializer {
...
#[derive(Debug)]
            struct RetrieveDomainAuthCodeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RetrieveDomainAuthCodeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_retrieve_domain_auth_code::ser_retrieve_domain_auth_code_input(&input)?);
...
#[derive(Debug)]
            struct RetrieveDomainAuthCodeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RetrieveDomainAuthCodeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RetrieveDomainAuthCodeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RetrieveDomainAuthCodeInput>()
                        .ok_or("failed to downcast to RetrieveDomainAuthCodeInput")?;
...
pub enum RetrieveDomainAuthCodeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RetrieveDomainAuthCodeError) for what information is available for the error.")]
...
impl RetrieveDomainAuthCodeError {
    /// Creates the `RetrieveDomainAuthCodeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RetrieveDomainAuthCodeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RetrieveDomainAuthCodeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError {
