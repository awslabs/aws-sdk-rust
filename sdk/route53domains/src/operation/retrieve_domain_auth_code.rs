...
impl RetrieveDomainAuthCode {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.RetrieveDomainAuthCode",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "RetrieveDomainAuthCode",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RetrieveDomainAuthCode {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RetrieveDomainAuthCodeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RetrieveDomainAuthCodeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RetrieveDomainAuthCode")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RetrieveDomainAuthCode")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RetrieveDomainAuthCodeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RetrieveDomainAuthCodeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RetrieveDomainAuthCodeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RetrieveDomainAuthCodeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RetrieveDomainAuthCodeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_retrieve_domain_auth_code::de_retrieve_domain_auth_code_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_retrieve_domain_auth_code::de_retrieve_domain_auth_code_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RetrieveDomainAuthCodeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeInput>()
            .expect("correct type");
...
impl RetrieveDomainAuthCodeError {
    ...
    /// Returns `true` if the error kind is `RetrieveDomainAuthCodeError::TldInMaintenance`.
