...
impl AcceptDomainTransferFromAnotherAwsAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::accept_domain_transfer_from_another_aws_account::AcceptDomainTransferFromAnotherAwsAccount,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_domain_transfer_from_another_aws_account::AcceptDomainTransferFromAnotherAwsAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptDomainTransferFromAnotherAwsAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_domain_transfer_from_another_aws_account::de_accept_domain_transfer_from_another_aws_account_http_response_with_props(status, headers, body)
        }
    }
}
