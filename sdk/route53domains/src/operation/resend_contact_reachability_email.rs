...
impl ResendContactReachabilityEmail {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Route 53 Domains.ResendContactReachabilityEmail",
            "rpc.service" = "Route 53 Domains",
            "rpc.method" = "ResendContactReachabilityEmail",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResendContactReachabilityEmail {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ResendContactReachabilityEmailRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ResendContactReachabilityEmailResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ResendContactReachabilityEmail")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResendContactReachabilityEmail")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ResendContactReachabilityEmailTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ResendContactReachabilityEmailTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResendContactReachabilityEmailTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ResendContactReachabilityEmailInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResendContactReachabilityEmailResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_resend_contact_reachability_email::de_resend_contact_reachability_email_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_resend_contact_reachability_email::de_resend_contact_reachability_email_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResendContactReachabilityEmailRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_resend_contact_reachability_email::ser_resend_contact_reachability_email_input(&input)?,
        );
...
impl ResendContactReachabilityEmailError {
    ...
    /// Returns `true` if the error kind is `ResendContactReachabilityEmailError::TldInMaintenance`.
