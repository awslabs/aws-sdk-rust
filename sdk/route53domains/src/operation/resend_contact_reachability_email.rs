...
impl ResendContactReachabilityEmailInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmail::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResendContactReachabilityEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resend_contact_reachability_email::de_resend_contact_reachability_email_http_response_with_props(
                status, headers, body,
            )
        }
    }
