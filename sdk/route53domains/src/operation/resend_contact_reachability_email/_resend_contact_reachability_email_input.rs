...
impl ResendContactReachabilityEmailInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailInput, ::aws_smithy_types::error::operation::BuildError> {
