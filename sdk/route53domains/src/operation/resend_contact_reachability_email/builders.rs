...
impl crate::operation::resend_contact_reachability_email::builders::ResendContactReachabilityEmailInputBuilder {
...
impl ResendContactReachabilityEmailFluentBuilder {
    /// Creates a new `ResendContactReachabilityEmailFluentBuilder`.
