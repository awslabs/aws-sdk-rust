...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for TransferDomainToAnotherAwsAccountError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DuplicateRequest(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for ResendContactReachabilityEmailError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InvalidInput(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::RejectDomainTransferFromAnotherAwsAccountError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DisassociateDelegationSignerFromDomainErrorKind = DisassociateDelegationSignerFromDomainError;
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateDelegationSignerFromDomainError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DuplicateRequest(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type CancelDomainTransferToAnotherAwsAccountErrorKind = CancelDomainTransferToAnotherAwsAccountError;
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelDomainTransferToAnotherAwsAccountError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InvalidInput(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::CancelDomainTransferToAnotherAwsAccountError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateDelegationSignerToDomainError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DnssecLimitExceeded(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::AcceptDomainTransferFromAnotherAwsAccountError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
