...
pub struct BillingRecord  {
    ...
    #[doc(hidden)]pub operation: std::option::Option<crate::model::OperationType>,
    /// <p>The ID of the invoice that is associated with the billing record.</p>
    #[doc(hidden)]pub invoice_id: std::option::Option<std::string::String>,
    /// <p>The date that the operation was billed, in Unix format.</p>
    #[doc(hidden)]pub bill_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The price that you were charged for the operation, in US dollars.</p> 
    /// <p>Example value: 12.0</p>
    #[doc(hidden)]pub price: f64,
}
impl BillingRecord {
    /// <p>The name of the domain that the billing record applies to. If the domain name contains characters other than a-z, 0-9, and - (hyphen), such as an internationalized domain name, then this value is in Punycode. For more information, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DomainNameFormat.html">DNS Domain Name Format</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>
...
pub struct Nameserver  {
    ...
    #[doc(hidden)]pub glue_ips: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Nameserver {
    /// <p>The fully qualified host name of the name server.</p> 
    /// <p>Constraint: Maximum 255 characters</p>
...
pub struct ContactDetail  {
    ...
    /// </ul>
    #[doc(hidden)]pub contact_type: std::option::Option<crate::model::ContactType>,
    ...
    #[doc(hidden)]pub country_code: std::option::Option<crate::model::CountryCode>,
    /// <p>The zip or postal code of the contact's address.</p>
    #[doc(hidden)]pub zip_code: std::option::Option<std::string::String>,
    ...
    /// <p>Constraints: Phone number must be specified in the format "+[country dialing code].[number including any area code]". For example, a US phone number might appear as <code>"+1.1234567890"</code>.</p>
    #[doc(hidden)]pub fax: std::option::Option<std::string::String>,
    /// <p>A list of name-value pairs for parameters required by certain top-level domains.</p>
    #[doc(hidden)]pub extra_params: std::option::Option<std::vec::Vec<crate::model::ExtraParam>>,
}
impl ContactDetail {
    /// <p>First name of contact.</p>
...
pub struct ExtraParam  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::ExtraParamName>,
...
impl ExtraParamName {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "AU_ID_NUMBER", "AU_ID_TYPE", "BIRTH_CITY", "BIRTH_COUNTRY", "BIRTH_DATE_IN_YYYY_MM_DD", "BIRTH_DEPARTMENT", "BRAND_NUMBER", "CA_BUSINESS_ENTITY_TYPE", "CA_LEGAL_REPRESENTATIVE", "CA_LEGAL_REPRESENTATIVE_CAPACITY", "CA_LEGAL_TYPE", "DOCUMENT_NUMBER", "DUNS_NUMBER", "ES_IDENTIFICATION", "ES_IDENTIFICATION_TYPE", "ES_LEGAL_FORM", "EU_COUNTRY_OF_CITIZENSHIP", "FI_BUSINESS_NUMBER", "FI_ID_NUMBER", "FI_NATIONALITY", "FI_ORGANIZATION_TYPE", "IT_NATIONALITY", "IT_PIN", "IT_REGISTRANT_ENTITY_TYPE", "RU_PASSPORT_DATA", "SE_ID_NUMBER", "SG_ID_NUMBER", "UK_COMPANY_NUMBER", "UK_CONTACT_TYPE", "VAT_NUMBER"
        ]
    }
}
...
pub struct DomainPrice  {
    ...
    #[doc(hidden)]pub registration_price: std::option::Option<crate::model::PriceWithCurrency>,
    /// <p>The price for transferring the domain registration to Route&nbsp;53.</p>
    #[doc(hidden)]pub transfer_price: std::option::Option<crate::model::PriceWithCurrency>,
    /// <p>The price for renewing domain registration with Route&nbsp;53.</p>
    #[doc(hidden)]pub renewal_price: std::option::Option<crate::model::PriceWithCurrency>,
    /// <p>The price for changing domain ownership.</p>
    #[doc(hidden)]pub change_ownership_price: std::option::Option<crate::model::PriceWithCurrency>,
    /// <p>The price for restoring the domain with Route&nbsp;53.</p>
    #[doc(hidden)]pub restoration_price: std::option::Option<crate::model::PriceWithCurrency>,
}
impl DomainPrice {
    /// <p>The name of the TLD for which the prices apply.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct OperationSummary  {
    ...
    #[doc(hidden)]pub submitted_date: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct DomainSummary  {
    ...
    #[doc(hidden)]pub transfer_lock: std::option::Option<bool>,
    /// <p>Expiration date of the domain in Unix time format and Coordinated Universal Time (UTC).</p>
    #[doc(hidden)]pub expiry: std::option::Option<aws_smithy_types::DateTime>,
}
impl DomainSummary {
    /// <p>The name of the domain that the summary information applies to.</p>
    pub fn domain_name(&self) -> std::option::Option<& str> {
...
pub struct SortCondition  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::ListDomainsAttributeName>,
...
pub struct FilterCondition  {
    ...
    /// </ul>
    #[doc(hidden)]pub operator: std::option::Option<crate::model::Operator>,
...
pub struct DomainSuggestion  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub availability: std::option::Option<std::string::String>,
}
...
pub struct DomainTransferability  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub transferable: std::option::Option<crate::model::Transferable>,
}
