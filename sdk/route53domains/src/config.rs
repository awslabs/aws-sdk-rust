...
impl Builder {
    ...
    /// use aws_sdk_route53domains::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_route53domains::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
