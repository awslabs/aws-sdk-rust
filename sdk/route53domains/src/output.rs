...
pub struct ViewBillingOutput  {
    ...
    #[doc(hidden)]pub next_page_marker: std::option::Option<std::string::String>,
    /// <p>A summary of billing records.</p>
    #[doc(hidden)]pub billing_records: std::option::Option<std::vec::Vec<crate::model::BillingRecord>>,
}
...
pub struct ResendContactReachabilityEmailOutput  {
    ...
    #[doc(hidden)]pub is_already_verified: std::option::Option<bool>,
}
...
impl RejectDomainTransferFromAnotherAwsAccountOutput {
    ...
    pub fn builder() -> crate::output::reject_domain_transfer_from_another_aws_account_output::Builder {
...
pub struct ListPricesOutput  {
    ...
    #[doc(hidden)]pub prices: std::option::Option<std::vec::Vec<crate::model::DomainPrice>>,
...
pub mod list_prices_output {
    ...
    impl Builder {
        ...
        /// <p>A complex type that includes all the pricing information. If you specify a TLD, this array contains only the pricing for that TLD.</p>
        pub fn set_prices(mut self, input: std::option::Option<std::vec::Vec<crate::model::DomainPrice>>) -> Self {
...
pub struct ListOperationsOutput  {
    ...
    #[doc(hidden)]pub operations: std::option::Option<std::vec::Vec<crate::model::OperationSummary>>,
...
pub mod list_operations_output {
    ...
    impl Builder {
        ...
        /// <p>Lists summaries of the operations.</p>
        pub fn set_operations(mut self, input: std::option::Option<std::vec::Vec<crate::model::OperationSummary>>) -> Self {
...
pub struct GetDomainSuggestionsOutput  {
    ...
    #[doc(hidden)]pub suggestions_list: std::option::Option<std::vec::Vec<crate::model::DomainSuggestion>>,
}
...
pub struct GetDomainDetailOutput  {
    ...
    #[doc(hidden)]pub registrar_name: std::option::Option<std::string::String>,
    /// <p>The fully qualified name of the WHOIS server that can answer the WHOIS query for the domain.</p>
    #[doc(hidden)]pub who_is_server: std::option::Option<std::string::String>,
    /// <p>Web address of the registrar.</p>
    #[doc(hidden)]pub registrar_url: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub abuse_contact_email: std::option::Option<std::string::String>,
    /// <p>Phone number for reporting abuse.</p>
    #[doc(hidden)]pub abuse_contact_phone: std::option::Option<std::string::String>,
    /// <p>Reserved for future use.</p>
    #[doc(hidden)]pub registry_domain_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub reseller: std::option::Option<std::string::String>,
    /// <p>Deprecated.</p>
    #[doc(hidden)]pub dns_sec: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status_list: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct GetContactReachabilityStatusOutput  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ReachabilityStatus>,
}
...
pub struct CheckDomainTransferabilityOutput  {
    ...
    #[doc(hidden)]pub transferability: std::option::Option<crate::model::DomainTransferability>,
}
...
pub struct CheckDomainAvailabilityOutput  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub availability: std::option::Option<crate::model::DomainAvailability>,
}
...
impl AcceptDomainTransferFromAnotherAwsAccountOutput {
    ...
    pub fn builder() -> crate::output::accept_domain_transfer_from_another_aws_account_output::Builder {
