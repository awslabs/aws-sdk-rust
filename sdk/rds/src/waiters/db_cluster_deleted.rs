...
///
/// Fluent builder for the `db_cluster_deleted` waiter.
///
...
pub struct DbClusterDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_db_clusters::builders::DescribeDbClustersInputBuilder,
}
impl DbClusterDeletedFluentBuilder {
    /// Creates a new `DbClusterDeletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::db_cluster_deleted::DbClusterDeletedFinalPoll,
        crate::waiters::db_cluster_deleted::WaitUntilDbClusterDeletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"length(DBClusters) == `0`","expected":"true","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_db_clusters_d1257803ad6a9c0fa(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"DBClusterNotFoundFault"}
            if crate::waiters::matchers::match_describe_db_clusters_7ee19a877ad11187a(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"DBClusters[].Status","expected":"creating","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_clusters_ed1511295bec054f2(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusters[].Status","expected":"modifying","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_clusters_d81b652414f522708(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusters[].Status","expected":"rebooting","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_clusters_0e021dbb7f83368b4(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusters[].Status","expected":"resetting-master-credentials","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_clusters_da3894151799a4aff(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
...
/// Successful return type for the `db_cluster_deleted` waiter.
pub type DbClusterDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_db_clusters::DescribeDbClustersOutput,
...
/// Error type for the `db_cluster_deleted` waiter.
pub type WaitUntilDbClusterDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_db_clusters::DescribeDbClustersOutput,
    crate::operation::describe_db_clusters::DescribeDBClustersError,
>;
