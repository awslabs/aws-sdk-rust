...
///
/// Fluent builder for the `db_snapshot_deleted` waiter.
///
...
pub struct DbSnapshotDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_db_snapshots::builders::DescribeDbSnapshotsInputBuilder,
}
impl DbSnapshotDeletedFluentBuilder {
    /// Creates a new `DbSnapshotDeletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::db_snapshot_deleted::DbSnapshotDeletedFinalPoll,
        crate::waiters::db_snapshot_deleted::WaitUntilDbSnapshotDeletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"length(DBSnapshots) == `0`","expected":"true","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_db_snapshots_c5cf2be8e8581fdf2(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"DBSnapshotNotFound"}
            if crate::waiters::matchers::match_describe_db_snapshots_0b1f7f3adf04a2b45(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"DBSnapshots[].Status","expected":"creating","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_snapshots_73d0c7884e6e6eb30(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBSnapshots[].Status","expected":"modifying","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_snapshots_3227ee4bf80486f2b(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBSnapshots[].Status","expected":"rebooting","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_snapshots_38d2148802bb57762(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBSnapshots[].Status","expected":"resetting-master-credentials","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_snapshots_809c568fd032effd9(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
...
/// Successful return type for the `db_snapshot_deleted` waiter.
pub type DbSnapshotDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_db_snapshots::DescribeDbSnapshotsOutput,
...
/// Error type for the `db_snapshot_deleted` waiter.
pub type WaitUntilDbSnapshotDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_db_snapshots::DescribeDbSnapshotsOutput,
    crate::operation::describe_db_snapshots::DescribeDBSnapshotsError,
>;
