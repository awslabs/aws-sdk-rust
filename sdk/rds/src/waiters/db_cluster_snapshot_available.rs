...
///
/// Fluent builder for the `db_cluster_snapshot_available` waiter.
///
...
pub struct DbClusterSnapshotAvailableFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_db_cluster_snapshots::builders::DescribeDbClusterSnapshotsInputBuilder,
}
impl DbClusterSnapshotAvailableFluentBuilder {
    /// Creates a new `DbClusterSnapshotAvailableFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::db_cluster_snapshot_available::DbClusterSnapshotAvailableFinalPoll,
        crate::waiters::db_cluster_snapshot_available::WaitUntilDbClusterSnapshotAvailableError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"DBClusterSnapshots[].Status","expected":"available","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_db_cluster_snapshots_24cd583c41e1b6f5b(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"DBClusterSnapshots[].Status","expected":"deleted","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_cluster_snapshots_5427b6f5e4914268c(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusterSnapshots[].Status","expected":"deleting","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_cluster_snapshots_af7eba9c0acf7a132(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusterSnapshots[].Status","expected":"failed","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_cluster_snapshots_7dfe0a1282e024903(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusterSnapshots[].Status","expected":"incompatible-restore","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_cluster_snapshots_cdbd4a65a155a7bf7(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"DBClusterSnapshots[].Status","expected":"incompatible-parameters","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_db_cluster_snapshots_48db92f438f307f0d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
...
/// Successful return type for the `db_cluster_snapshot_available` waiter.
pub type DbClusterSnapshotAvailableFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsOutput,
...
/// Error type for the `db_cluster_snapshot_available` waiter.
pub type WaitUntilDbClusterSnapshotAvailableError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsOutput,
    crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError,
>;
