...
impl DbInstanceBuilder {
    ...
    /// <p>Contains the identifier of the source DB cluster if this DB instance is a read replica.</p>
    pub fn read_replica_source_db_cluster_identifier(mut self, input: impl Into<std::string::String>) -> Self {
    ...
    pub fn set_read_replica_source_db_cluster_identifier(mut self, input: std::option::Option<std::string::String>) -> Self {
        self.read_replica_source_db_cluster_identifier = input; self
    }
