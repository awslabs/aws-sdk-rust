...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidCustomDbEngineVersionStateFault {
...
impl InvalidCustomDbEngineVersionStateFaultBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`InvalidCustomDbEngineVersionStateFault`](crate::types::error::InvalidCustomDbEngineVersionStateFault).
    pub fn build(self) -> crate::types::error::InvalidCustomDbEngineVersionStateFault {
        crate::types::error::InvalidCustomDbEngineVersionStateFault {
