...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_scaling_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ScalingConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_serverless_v2_scaling_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ServerlessV2ScalingConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_processor_feature(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ProcessorFeature) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_user_auth_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::UserAuthConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_connection_pool_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ConnectionPoolConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_option_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::OptionConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
#[allow(unused_mut)]pub fn serialize_structure_crate_model_option_setting(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::OptionSetting) -> Result<(), aws_smithy_http::operation::SerializationError> {
