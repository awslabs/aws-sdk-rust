...
pub fn ser_describe_db_log_files_input_input(input: &crate::input::DescribeDbLogFilesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
