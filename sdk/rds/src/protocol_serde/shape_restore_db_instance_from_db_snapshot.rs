...
pub fn de_restore_db_instance_from_db_snapshot_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RestoreDbInstanceFromDbSnapshotOutput, crate::error::RestoreDBInstanceFromDBSnapshotError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::RestoreDBInstanceFromDBSnapshotError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_subnet::de_invalid_subnet_xml_err(response.body().as_ref(), output).map_err(crate::error::RestoreDBInstanceFromDBSnapshotError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_restore_db_instance_from_db_snapshot_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RestoreDbInstanceFromDbSnapshotOutput, crate::error::RestoreDBInstanceFromDBSnapshotError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_restore_db_instance_from_db_snapshot(inp: &[u8], mut builder: crate::output::restore_db_instance_from_db_snapshot_output::Builder) -> Result<crate::output::restore_db_instance_from_db_snapshot_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
