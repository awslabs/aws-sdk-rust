...
pub fn de_delete_db_instance_http_error(
    ...
    Err(match error_code {
        "DBInstanceAutomatedBackupQuotaExceeded" => {
            crate::operation::delete_db_instance::DeleteDBInstanceError::DbInstanceAutomatedBackupQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSKeyNotAccessibleFault" => crate::operation::delete_db_instance::DeleteDBInstanceError::KmsKeyNotAccessibleFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
