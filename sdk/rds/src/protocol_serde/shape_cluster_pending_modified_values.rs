...
pub fn de_cluster_pending_modified_values(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClusterPendingModifiedValues, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
