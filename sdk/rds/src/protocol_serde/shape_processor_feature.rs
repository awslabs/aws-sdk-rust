...
#[allow(unused_mut)]
pub fn ser_processor_feature(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::ProcessorFeature) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
