...
#[allow(unused_mut)]
pub fn ser_processor_feature(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ProcessorFeature) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_processor_feature(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ProcessorFeature, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
