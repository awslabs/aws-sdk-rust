...
pub fn de_option_group_option(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OptionGroupOption, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
