...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_db_cluster_parameter_group::ModifyDBClusterParameterGroupError::unhandled)?;
    ...
    Err(match error_code {
        "DBParameterGroupNotFound" => {
            crate::operation::modify_db_cluster_parameter_group::ModifyDBClusterParameterGroupError::DbParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidDBParameterGroupState" => {
            crate::operation::modify_db_cluster_parameter_group::ModifyDBClusterParameterGroupError::InvalidDbParameterGroupStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidDbParameterGroupStateFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_db_parameter_group_state_fault::de_invalid_db_parameter_group_state_fault_xml_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::modify_db_cluster_parameter_group::ModifyDBClusterParameterGroupError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_db_cluster_parameter_group::de_modify_db_cluster_parameter_group(_response_body, output)
            .map_err(crate::operation::modify_db_cluster_parameter_group::ModifyDBClusterParameterGroupError::unhandled)?;
