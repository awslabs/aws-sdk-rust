...
pub fn ser_stop_db_instance_input_input(input: &crate::input::StopDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
