...
pub fn ser_stop_db_instance_input_input_input(input: &crate::operation::stop_db_instance::StopDbInstanceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
