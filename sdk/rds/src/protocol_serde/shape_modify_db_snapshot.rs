...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::modify_db_snapshot::ModifyDBSnapshotError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "DBSnapshotNotFound" => {
            crate::operation::modify_db_snapshot::ModifyDBSnapshotError::DbSnapshotNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_db_snapshot_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_db_snapshot::de_modify_db_snapshot(
            _response_body,
            output,
        )
        .map_err(crate::operation::modify_db_snapshot::ModifyDBSnapshotError::unhandled)?;
...
pub fn de_modify_db_snapshot(
    ...
    crate::operation::modify_db_snapshot::builders::ModifyDbSnapshotOutputBuilder,
