...
pub fn de_restore_db_cluster_to_point_in_time_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::restore_db_cluster_to_point_in_time::RestoreDbClusterToPointInTimeOutput, crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "DBClusterAutomatedBackupNotFoundFault" => crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::DbClusterAutomatedBackupNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::DbClusterAutomatedBackupNotFoundFaultBuilder::default();
                    output = crate::protocol_serde::shape_db_cluster_automated_backup_not_found_fault::de_db_cluster_automated_backup_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "InsufficientDBInstanceCapacity" => crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::InsufficientDbInstanceCapacityFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InsufficientDbInstanceCapacityFaultBuilder::default();
                    output = crate::protocol_serde::shape_insufficient_db_instance_capacity_fault::de_insufficient_db_instance_capacity_fault_xml_err(_response_body, output).map_err(crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_restore_db_cluster_to_point_in_time_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::restore_db_cluster_to_point_in_time::RestoreDbClusterToPointInTimeOutput, crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError> {
    Ok({
        #[allow(unused_mut)]
