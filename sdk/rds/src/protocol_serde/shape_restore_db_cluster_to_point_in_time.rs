...
> {
    ...
    Err(match error_code {
        ...
        "DBClusterRoleQuotaExceeded" => {
            crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::DbClusterRoleQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InsufficientDBInstanceCapacity" => {
            crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::InsufficientDbInstanceCapacityFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "VpcEncryptionControlViolationException" => {
            crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::VpcEncryptionControlViolationException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_vpc_encryption_control_violation_exception::de_vpc_encryption_control_violation_exception_xml_err(_response_body, output).map_err(crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTimeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("RestoreDBClusterToPointInTimeResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected RestoreDBClusterToPointInTimeResult got {start_el:?}"
            )));
        }
