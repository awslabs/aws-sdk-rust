...
pub fn de_minimum_engine_version_per_allowed_value(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MinimumEngineVersionPerAllowedValue, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
