...
#[allow(unused_mut)]
pub fn ser_rds_custom_cluster_configuration(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::RdsCustomClusterConfiguration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_rds_custom_cluster_configuration(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::RdsCustomClusterConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
