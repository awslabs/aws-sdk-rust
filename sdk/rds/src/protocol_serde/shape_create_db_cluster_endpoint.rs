...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DBClusterEndpointAlreadyExistsFault" => {
            crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::DbClusterEndpointAlreadyExistsFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::DbClusterEndpointAlreadyExistsFaultBuilder::default();
                    output =
                        crate::protocol_serde::shape_db_cluster_endpoint_already_exists_fault::de_db_cluster_endpoint_already_exists_fault_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::unhandled)?;
        ...
        "DBClusterEndpointQuotaExceededFault" => {
            crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::DbClusterEndpointQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::DbClusterEndpointQuotaExceededFaultBuilder::default();
                    output =
                        crate::protocol_serde::shape_db_cluster_endpoint_quota_exceeded_fault::de_db_cluster_endpoint_quota_exceeded_fault_xml_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_db_cluster_endpoint::de_create_db_cluster_endpoint(_response_body, output)
            .map_err(crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError::unhandled)?;
...
) -> Result<crate::operation::create_db_cluster_endpoint::builders::CreateDbClusterEndpointOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
