...
pub fn de_limitless_database(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LimitlessDatabase, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
