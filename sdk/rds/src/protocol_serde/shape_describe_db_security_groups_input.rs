...
pub fn ser_describe_db_security_groups_input_input(input: &crate::input::DescribeDbSecurityGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
