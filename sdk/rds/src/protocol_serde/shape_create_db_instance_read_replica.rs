...
pub fn de_create_db_instance_read_replica_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaOutput, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError> {
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_subnet_group_does_not_cover_enough_azs::de_db_subnet_group_does_not_cover_enough_azs_xml_err(_response_body, output).map_err(crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "TenantDatabaseQuotaExceeded" => crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError::TenantDatabaseQuotaExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::TenantDatabaseQuotaExceededFaultBuilder::default();
                    output = crate::protocol_serde::shape_tenant_database_quota_exceeded_fault::de_tenant_database_quota_exceeded_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_db_instance_read_replica_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaOutput, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError> {
    Ok({
        #[allow(unused_mut)]
