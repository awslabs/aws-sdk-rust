...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_db_instance_read_replica_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaOutput, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError> {
    Ok({
        #[allow(unused_mut)]
