...
pub fn ser_describe_reserved_db_instances_input_input(input: &crate::input::DescribeReservedDbInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
