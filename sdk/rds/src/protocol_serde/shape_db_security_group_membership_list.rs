...
pub fn de_db_security_group_membership_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::DbSecurityGroupMembership>, aws_smithy_xml::decode::XmlDecodeError> {
