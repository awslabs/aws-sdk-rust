...
pub fn de_delete_db_security_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_security_group::DeleteDbSecurityGroupOutput, crate::operation::delete_db_security_group::DeleteDBSecurityGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_security_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_security_group::DeleteDbSecurityGroupOutput, crate::operation::delete_db_security_group::DeleteDBSecurityGroupError> {
    Ok({
        #[allow(unused_mut)]
