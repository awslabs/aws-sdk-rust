...
pub fn de_delete_db_cluster_snapshot_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteDbClusterSnapshotOutput, crate::error::DeleteDBClusterSnapshotError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteDBClusterSnapshotError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_cluster_snapshot_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteDbClusterSnapshotOutput, crate::error::DeleteDBClusterSnapshotError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_db_cluster_snapshot_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_db_cluster_snapshot::de_delete_db_cluster_snapshot(response.body().as_ref(), output).map_err(crate::error::DeleteDBClusterSnapshotError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_db_cluster_snapshot(inp: &[u8], mut builder: crate::output::delete_db_cluster_snapshot_output::Builder) -> Result<crate::output::delete_db_cluster_snapshot_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
