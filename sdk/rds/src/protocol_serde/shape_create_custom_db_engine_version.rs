...
pub fn de_create_custom_db_engine_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateCustomDbEngineVersionOutput, crate::error::CreateCustomDBEngineVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateCustomDBEngineVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_custom_db_engine_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateCustomDbEngineVersionOutput, crate::error::CreateCustomDBEngineVersionError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_create_custom_db_engine_version(inp: &[u8], mut builder: crate::output::create_custom_db_engine_version_output::Builder) -> Result<crate::output::create_custom_db_engine_version_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
