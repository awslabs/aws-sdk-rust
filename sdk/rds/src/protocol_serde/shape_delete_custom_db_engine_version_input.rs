...
pub fn ser_delete_custom_db_engine_version_input_input(input: &crate::input::DeleteCustomDbEngineVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
