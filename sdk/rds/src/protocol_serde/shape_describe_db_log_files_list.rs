...
pub fn de_describe_db_log_files_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::DescribeDbLogFilesDetails>, aws_smithy_xml::decode::XmlDecodeError> {
