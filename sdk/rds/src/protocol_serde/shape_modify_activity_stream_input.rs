...
pub fn ser_modify_activity_stream_input_input_input(input: &crate::operation::modify_activity_stream::ModifyActivityStreamInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
