...
pub fn ser_describe_db_parameters_input_input(input: &crate::input::DescribeDbParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
