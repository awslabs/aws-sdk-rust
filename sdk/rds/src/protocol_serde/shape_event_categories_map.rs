...
pub fn de_event_categories_map(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EventCategoriesMap, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
