...
pub fn ser_add_role_to_db_instance_input_input(input: &crate::operation::add_role_to_db_instance::AddRoleToDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
