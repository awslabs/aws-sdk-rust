...
pub fn de_reserved_db_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedDbInstance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
