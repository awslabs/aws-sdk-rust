...
pub fn de_db_proxy_target_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbProxyTargetGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
