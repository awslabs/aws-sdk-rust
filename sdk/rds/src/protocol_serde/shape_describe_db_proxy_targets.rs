...
pub fn de_describe_db_proxy_targets_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_db_proxy_targets::DescribeDbProxyTargetsOutput, crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_proxy_targets_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_db_proxy_targets::DescribeDbProxyTargetsOutput, crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError> {
    Ok({
        #[allow(unused_mut)]
