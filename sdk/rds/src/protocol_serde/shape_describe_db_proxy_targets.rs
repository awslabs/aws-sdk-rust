...
pub fn de_describe_db_proxy_targets_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_db_proxy_targets::DescribeDbProxyTargetsOutput, crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_proxy_targets_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_db_proxy_targets::DescribeDbProxyTargetsOutput, crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_db_proxy_targets::builders::DescribeDbProxyTargetsOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_db_proxy_targets::de_describe_db_proxy_targets(_response_body, output).map_err(crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError::unhandled)?;
