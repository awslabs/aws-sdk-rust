...
pub fn ser_create_db_snapshot_input_input(input: &crate::operation::create_db_snapshot::CreateDbSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
