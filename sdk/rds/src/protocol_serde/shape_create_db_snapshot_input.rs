...
pub fn ser_create_db_snapshot_input_input_input(input: &crate::operation::create_db_snapshot::CreateDbSnapshotInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
