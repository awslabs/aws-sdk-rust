...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_option_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_option_group::CreateOptionGroupOutput, crate::operation::create_option_group::CreateOptionGroupError>
...
) -> Result<crate::operation::create_option_group::builders::CreateOptionGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
