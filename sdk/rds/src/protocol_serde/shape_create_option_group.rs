...
pub fn de_create_option_group_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_option_group::CreateOptionGroupOutput, crate::operation::create_option_group::CreateOptionGroupError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::create_option_group::CreateOptionGroupOutput, crate::operation::create_option_group::CreateOptionGroupError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_create_option_group::de_create_option_group(_response_body, output)
            .map_err(crate::operation::create_option_group::CreateOptionGroupError::unhandled)?;
...
pub fn de_create_option_group(
...
) -> std::result::Result<crate::operation::create_option_group::builders::CreateOptionGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateOptionGroupResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateOptionGroupResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateOptionGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateOptionGroupResult got {start_el:?}"
            )));
        }
