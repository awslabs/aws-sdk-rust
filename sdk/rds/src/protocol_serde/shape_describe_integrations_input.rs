...
pub fn ser_describe_integrations_input_input_input(input: &crate::operation::describe_integrations::DescribeIntegrationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeIntegrations", "2014-10-31");
    #[allow(unused_mut)]
