...
pub fn de_blue_green_deployment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BlueGreenDeployment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
