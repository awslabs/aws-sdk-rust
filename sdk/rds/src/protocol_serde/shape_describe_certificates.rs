...
#[allow(unused_mut)]
pub fn de_describe_certificates(
    inp: &[u8],
    mut builder: crate::operation::describe_certificates::builders::DescribeCertificatesOutputBuilder,
) -> std::result::Result<crate::operation::describe_certificates::builders::DescribeCertificatesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("DescribeCertificatesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeCertificatesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeCertificatesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeCertificatesResult got {start_el:?}"
            )));
        }
