...
pub fn de_restore_db_instance_from_s3_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::restore_db_instance_from_s3::RestoreDbInstanceFromS3Output, crate::operation::restore_db_instance_from_s3::RestoreDBInstanceFromS3Error> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_restore_db_instance_from_s3_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::restore_db_instance_from_s3::RestoreDbInstanceFromS3Output, crate::operation::restore_db_instance_from_s3::RestoreDBInstanceFromS3Error> {
    Ok({
        #[allow(unused_mut)]
