...
pub fn de_create_db_cluster_http_error(
    ...
    Err(match error_code {
        ...
        "DBClusterRoleQuotaExceeded" => crate::operation::create_db_cluster::CreateDBClusterError::DbClusterRoleQuotaExceededFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "VpcEncryptionControlViolationException" => {
            crate::operation::create_db_cluster::CreateDBClusterError::VpcEncryptionControlViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::VpcEncryptionControlViolationExceptionBuilder::default();
                    output = crate::protocol_serde::shape_vpc_encryption_control_violation_exception::de_vpc_encryption_control_violation_exception_xml_err(_response_body, output).map_err(crate::operation::create_db_cluster::CreateDBClusterError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
