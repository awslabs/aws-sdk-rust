...
pub fn ser_start_export_task_input_input_input(input: &crate::operation::start_export_task::StartExportTaskInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
