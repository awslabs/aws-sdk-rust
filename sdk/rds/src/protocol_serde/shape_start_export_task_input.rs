...
pub fn ser_start_export_task_input_input(input: &crate::input::StartExportTaskInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
