...
pub fn ser_start_db_instance_automated_backups_replication_input_input(input: &crate::input::StartDbInstanceAutomatedBackupsReplicationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
