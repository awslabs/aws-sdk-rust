...
pub fn ser_describe_db_snapshots_input_input_input(input: &crate::operation::describe_db_snapshots::DescribeDbSnapshotsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_20 = writer.prefix("DbiResourceId");
    if let Some(var_21) = &input.dbi_resource_id {
