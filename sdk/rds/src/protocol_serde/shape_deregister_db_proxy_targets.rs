...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_db_proxy_targets_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsOutput, crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError> {
    Ok({
        #[allow(unused_mut)]
