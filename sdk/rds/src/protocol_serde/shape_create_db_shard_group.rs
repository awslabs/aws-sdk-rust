...
pub fn de_create_db_shard_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_shard_group::CreateDbShardGroupOutput, crate::operation::create_db_shard_group::CreateDBShardGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_cluster_not_found_fault::de_db_cluster_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_shard_group_already_exists_fault::de_db_shard_group_already_exists_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_db_cluster_state_fault::de_invalid_db_cluster_state_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_max_acu_fault::de_invalid_max_acu_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_vpc_network_state_fault::de_invalid_vpc_network_state_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_max_db_shard_group_limit_reached::de_max_db_shard_group_limit_reached_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unsupported_db_engine_version_fault::de_unsupported_db_engine_version_fault_xml_err(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_db_shard_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_shard_group::CreateDbShardGroupOutput, crate::operation::create_db_shard_group::CreateDBShardGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_db_shard_group::builders::CreateDbShardGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_create_db_shard_group::de_create_db_shard_group(_response_body, output).map_err(crate::operation::create_db_shard_group::CreateDBShardGroupError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_db_shard_group(inp: &[u8], mut builder: crate::operation::create_db_shard_group::builders::CreateDbShardGroupOutputBuilder) -> Result<crate::operation::create_db_shard_group::builders::CreateDbShardGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateDBShardGroupResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected CreateDBShardGroupResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("CreateDBShardGroupResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected CreateDBShardGroupResult got {:?}", start_el)))
                        }
