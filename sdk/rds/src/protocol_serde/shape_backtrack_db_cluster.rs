...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_backtrack_db_cluster::de_backtrack_db_cluster(_response_body, output)
            .map_err(crate::operation::backtrack_db_cluster::BacktrackDBClusterError::unhandled)?;
...
) -> std::result::Result<crate::operation::backtrack_db_cluster::builders::BacktrackDbClusterOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("BacktrackDBClusterResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected BacktrackDBClusterResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("BacktrackDBClusterResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected BacktrackDBClusterResult got {start_el:?}"
            )));
        }
