...
pub fn de_backtrack_db_cluster_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::BacktrackDbClusterOutput, crate::error::BacktrackDBClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::BacktrackDBClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_backtrack_db_cluster_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::BacktrackDbClusterOutput, crate::error::BacktrackDBClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::backtrack_db_cluster_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_backtrack_db_cluster::de_backtrack_db_cluster(response.body().as_ref(), output).map_err(crate::error::BacktrackDBClusterError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_backtrack_db_cluster(inp: &[u8], mut builder: crate::output::backtrack_db_cluster_output::Builder) -> Result<crate::output::backtrack_db_cluster_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
