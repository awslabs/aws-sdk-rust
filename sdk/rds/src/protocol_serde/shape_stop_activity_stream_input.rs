...
pub fn ser_stop_activity_stream_input_input_input(input: &crate::operation::stop_activity_stream::StopActivityStreamInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
