...
pub fn ser_describe_option_group_options_input_input(input: &crate::input::DescribeOptionGroupOptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
