...
pub fn de_scaling_configuration_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScalingConfigurationInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
