...
pub fn de_reserved_db_instances_offering(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedDbInstancesOffering, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
