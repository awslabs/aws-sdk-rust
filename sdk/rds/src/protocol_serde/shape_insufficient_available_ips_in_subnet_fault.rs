...
#[allow(unused_mut)]
pub fn de_insufficient_available_ips_in_subnet_fault_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::InsufficientAvailableIPsInSubnetFaultBuilder,
) -> std::result::Result<crate::types::error::builders::InsufficientAvailableIPsInSubnetFaultBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
