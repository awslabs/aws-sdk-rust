...
pub fn ser_copy_db_parameter_group_input_input_input(input: &crate::operation::copy_db_parameter_group::CopyDbParameterGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
