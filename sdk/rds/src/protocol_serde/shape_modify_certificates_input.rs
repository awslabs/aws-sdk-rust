...
pub fn ser_modify_certificates_input_input(input: &crate::input::ModifyCertificatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
