...
pub fn ser_modify_certificates_input_input_input(input: &crate::operation::modify_certificates::ModifyCertificatesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
