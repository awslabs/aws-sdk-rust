...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_instances::de_describe_db_instances(_response_body, output)
            .map_err(crate::operation::describe_db_instances::DescribeDBInstancesError::unhandled)?;
...
) -> std::result::Result<crate::operation::describe_db_instances::builders::DescribeDbInstancesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBInstancesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBInstancesResult got {start_el:?}"
            )));
        }
