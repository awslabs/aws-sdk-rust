...
pub fn de_describe_db_instances_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_db_instances::DescribeDbInstancesOutput, crate::operation::describe_db_instances::DescribeDBInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_db_instances::DescribeDBInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_instances_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_db_instances::DescribeDbInstancesOutput, crate::operation::describe_db_instances::DescribeDBInstancesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_db_instances::builders::DescribeDbInstancesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_db_instances::de_describe_db_instances(response.body().as_ref(), output).map_err(crate::operation::describe_db_instances::DescribeDBInstancesError::unhandled)?;
