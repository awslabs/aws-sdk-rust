...
pub fn de_modify_certificates_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_certificates::ModifyCertificatesOutput, crate::operation::modify_certificates::ModifyCertificatesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_certificates_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_certificates::ModifyCertificatesOutput, crate::operation::modify_certificates::ModifyCertificatesError> {
    Ok({
        #[allow(unused_mut)]
