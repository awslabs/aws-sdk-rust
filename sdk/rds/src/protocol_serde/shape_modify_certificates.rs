...
pub fn de_modify_certificates_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_certificates::ModifyCertificatesOutput, crate::operation::modify_certificates::ModifyCertificatesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_certificates::ModifyCertificatesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_certificates_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_certificates::ModifyCertificatesOutput, crate::operation::modify_certificates::ModifyCertificatesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_certificates::builders::ModifyCertificatesOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_certificates::de_modify_certificates(_response_body, output).map_err(crate::operation::modify_certificates::ModifyCertificatesError::unhandled)?;
