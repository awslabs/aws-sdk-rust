...
pub fn ser_describe_db_cluster_parameter_groups_input_input_input(input: &crate::operation::describe_db_cluster_parameter_groups::DescribeDbClusterParameterGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
