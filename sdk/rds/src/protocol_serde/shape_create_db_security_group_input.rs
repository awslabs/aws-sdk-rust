...
pub fn ser_create_db_security_group_input_input(input: &crate::input::CreateDbSecurityGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
