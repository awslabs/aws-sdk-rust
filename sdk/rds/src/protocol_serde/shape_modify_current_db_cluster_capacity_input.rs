...
pub fn ser_modify_current_db_cluster_capacity_input_input(input: &crate::input::ModifyCurrentDbClusterCapacityInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
