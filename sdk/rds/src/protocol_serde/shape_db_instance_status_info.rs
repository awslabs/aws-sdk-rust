...
pub fn de_db_instance_status_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbInstanceStatusInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
