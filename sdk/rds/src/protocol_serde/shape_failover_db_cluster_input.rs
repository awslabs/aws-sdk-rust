...
pub fn ser_failover_db_cluster_input_input(input: &crate::input::FailoverDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
