...
pub fn de_describe_db_cluster_snapshot_attributes_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_db_cluster_snapshot_attributes::DescribeDBClusterSnapshotAttributesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_cluster_snapshot_attributes_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_db_cluster_snapshot_attributes::de_describe_db_cluster_snapshot_attributes(_response_body, output)
                .map_err(crate::operation::describe_db_cluster_snapshot_attributes::DescribeDBClusterSnapshotAttributesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_db_cluster_snapshot_attributes(
    inp: &[u8],
    mut builder: crate::operation::describe_db_cluster_snapshot_attributes::builders::DescribeDbClusterSnapshotAttributesOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_db_cluster_snapshot_attributes::builders::DescribeDbClusterSnapshotAttributesOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeDBClusterSnapshotAttributesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeDBClusterSnapshotAttributesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBClusterSnapshotAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBClusterSnapshotAttributesResult got {start_el:?}"
            )));
        }
