...
pub fn ser_describe_option_groups_input_input(input: &crate::input::DescribeOptionGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
