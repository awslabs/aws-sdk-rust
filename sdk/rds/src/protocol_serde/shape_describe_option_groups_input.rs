...
pub fn ser_describe_option_groups_input_input_input(input: &crate::operation::describe_option_groups::DescribeOptionGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
