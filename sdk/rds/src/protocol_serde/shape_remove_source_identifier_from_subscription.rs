...
pub fn de_remove_source_identifier_from_subscription_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "SourceNotFound" => {
            crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::SourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::SourceNotFoundFaultBuilder::default();
                    output = crate::protocol_serde::shape_source_not_found_fault::de_source_not_found_fault_xml_err(_response_body, output).map_err(
                        crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::unhandled,
                    )?;
        ...
        "SubscriptionNotFound" => {
            crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::SubscriptionNotFoundFault({
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_subscription_not_found_fault::de_subscription_not_found_fault_xml_err(_response_body, output)
                            .map_err(
                                crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::unhandled,
                            )?;
                    let output = output.meta(generic);
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_source_identifier_from_subscription_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_remove_source_identifier_from_subscription::de_remove_source_identifier_from_subscription(
            _response_body,
            output,
        )
        .map_err(crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionError::unhandled)?;
