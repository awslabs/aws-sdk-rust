...
pub fn de_start_db_instance_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StartDbInstanceOutput, crate::error::StartDBInstanceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::StartDBInstanceError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_subnet::de_invalid_subnet_xml_err(response.body().as_ref(), output).map_err(crate::error::StartDBInstanceError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_db_instance_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StartDbInstanceOutput, crate::error::StartDBInstanceError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::start_db_instance_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_start_db_instance::de_start_db_instance(response.body().as_ref(), output).map_err(crate::error::StartDBInstanceError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_start_db_instance(inp: &[u8], mut builder: crate::output::start_db_instance_output::Builder) -> Result<crate::output::start_db_instance_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
