...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_stop_activity_stream::de_stop_activity_stream(_response_body, output)
            .map_err(crate::operation::stop_activity_stream::StopActivityStreamError::unhandled)?;
...
) -> std::result::Result<crate::operation::stop_activity_stream::builders::StopActivityStreamOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("StopActivityStreamResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected StopActivityStreamResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("StopActivityStreamResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected StopActivityStreamResult got {start_el:?}"
            )));
        }
