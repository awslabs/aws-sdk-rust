...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_log_files::de_describe_db_log_files(_response_body, output)
            .map_err(crate::operation::describe_db_log_files::DescribeDBLogFilesError::unhandled)?;
...
) -> std::result::Result<crate::operation::describe_db_log_files::builders::DescribeDbLogFilesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBLogFilesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBLogFilesResult got {start_el:?}"
            )));
        }
