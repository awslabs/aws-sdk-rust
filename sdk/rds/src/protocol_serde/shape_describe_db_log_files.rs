...
pub fn de_describe_db_log_files_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_db_log_files::DescribeDBLogFilesError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_log_files_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::operation::describe_db_log_files::DescribeDbLogFilesOutput,
    crate::operation::describe_db_log_files::DescribeDBLogFilesError,
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_describe_db_log_files::de_describe_db_log_files(
...
#[allow(unused_mut)]
pub fn de_describe_db_log_files(
    inp: &[u8],
    mut builder: crate::operation::describe_db_log_files::builders::DescribeDbLogFilesOutputBuilder,
) -> Result<
