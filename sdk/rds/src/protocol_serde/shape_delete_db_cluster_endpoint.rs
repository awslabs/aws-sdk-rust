...
pub fn de_delete_db_cluster_endpoint_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput, crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_cluster_endpoint_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput, crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError> {
    Ok({
        #[allow(unused_mut)]
