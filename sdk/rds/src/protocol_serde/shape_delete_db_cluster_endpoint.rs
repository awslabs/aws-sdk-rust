...
pub fn de_delete_db_cluster_endpoint_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput, crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled(generic))
                            };
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_cluster_endpoint_not_found_fault::de_db_cluster_endpoint_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_db_cluster_endpoint_state_fault::de_invalid_db_cluster_endpoint_state_fault_xml_err(_response_body, output).map_err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_db_cluster_state_fault::de_invalid_db_cluster_state_fault_xml_err(_response_body, output).map_err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_cluster_endpoint_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput, crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_db_cluster_endpoint::builders::DeleteDbClusterEndpointOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_db_cluster_endpoint::de_delete_db_cluster_endpoint(_response_body, output).map_err(crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_db_cluster_endpoint(inp: &[u8], mut builder: crate::operation::delete_db_cluster_endpoint::builders::DeleteDbClusterEndpointOutputBuilder) -> Result<crate::operation::delete_db_cluster_endpoint::builders::DeleteDbClusterEndpointOutputBuilder, aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DeleteDBClusterEndpointResponse")) {
                        return Err(aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected DeleteDBClusterEndpointResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DeleteDBClusterEndpointResult")) {
                            return Err(aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected DeleteDBClusterEndpointResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlDecodeError::custom("expected DeleteDBClusterEndpointResult tag"))
                    };
    Ok(builder)
}
