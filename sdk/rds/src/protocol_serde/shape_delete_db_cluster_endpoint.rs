...
pub fn de_delete_db_cluster_endpoint_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteDbClusterEndpointOutput, crate::error::DeleteDBClusterEndpointError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteDBClusterEndpointError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_cluster_endpoint_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteDbClusterEndpointOutput, crate::error::DeleteDBClusterEndpointError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_db_cluster_endpoint_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_db_cluster_endpoint::de_delete_db_cluster_endpoint(response.body().as_ref(), output).map_err(crate::error::DeleteDBClusterEndpointError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_db_cluster_endpoint(inp: &[u8], mut builder: crate::output::delete_db_cluster_endpoint_output::Builder) -> Result<crate::output::delete_db_cluster_endpoint_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
