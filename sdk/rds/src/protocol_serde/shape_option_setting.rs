...
#[allow(unused_mut)]
pub fn ser_option_setting(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::OptionSetting) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
