...
#[allow(unused_mut)]
pub fn ser_option_setting(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::OptionSetting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_option_setting(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OptionSetting, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
