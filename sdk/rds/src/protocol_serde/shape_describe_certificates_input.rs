...
pub fn ser_describe_certificates_input_input(input: &crate::operation::describe_certificates::DescribeCertificatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
