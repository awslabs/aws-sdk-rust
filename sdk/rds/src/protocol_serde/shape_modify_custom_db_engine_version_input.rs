...
pub fn ser_modify_custom_db_engine_version_input_input_input(input: &crate::operation::modify_custom_db_engine_version::ModifyCustomDbEngineVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
