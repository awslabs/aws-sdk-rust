...
pub fn ser_modify_custom_db_engine_version_input_input(input: &crate::input::ModifyCustomDbEngineVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
