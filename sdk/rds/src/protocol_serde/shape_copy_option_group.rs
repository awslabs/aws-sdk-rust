...
pub fn de_copy_option_group_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_option_group::CopyOptionGroupOutput, crate::operation::copy_option_group::CopyOptionGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_option_group_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_option_group::CopyOptionGroupOutput, crate::operation::copy_option_group::CopyOptionGroupError> {
    Ok({
        #[allow(unused_mut)]
