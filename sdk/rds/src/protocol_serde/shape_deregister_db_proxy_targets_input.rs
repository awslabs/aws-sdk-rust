...
pub fn ser_deregister_db_proxy_targets_input_input(input: &crate::input::DeregisterDbProxyTargetsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
