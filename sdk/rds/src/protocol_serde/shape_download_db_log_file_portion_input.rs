...
pub fn ser_download_db_log_file_portion_input_input_input(input: &crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
