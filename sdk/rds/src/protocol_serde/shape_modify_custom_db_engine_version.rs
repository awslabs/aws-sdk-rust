...
pub fn de_modify_custom_db_engine_version_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_custom_db_engine_version::ModifyCustomDbEngineVersionOutput, crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_custom_db_engine_version_not_found_fault::de_custom_db_engine_version_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_custom_db_engine_version_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_custom_db_engine_version::ModifyCustomDbEngineVersionOutput, crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_custom_db_engine_version::builders::ModifyCustomDbEngineVersionOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_custom_db_engine_version::de_modify_custom_db_engine_version(_response_body, output).map_err(crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersionError::unhandled)?;
