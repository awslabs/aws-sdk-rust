...
pub fn de_modify_custom_db_engine_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyCustomDbEngineVersionOutput, crate::error::ModifyCustomDBEngineVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyCustomDBEngineVersionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_custom_db_engine_version_not_found_fault::de_custom_db_engine_version_not_found_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::ModifyCustomDBEngineVersionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_custom_db_engine_version_state_fault::de_invalid_custom_db_engine_version_state_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::ModifyCustomDBEngineVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_custom_db_engine_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyCustomDbEngineVersionOutput, crate::error::ModifyCustomDBEngineVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::modify_custom_db_engine_version_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_modify_custom_db_engine_version::de_modify_custom_db_engine_version(response.body().as_ref(), output).map_err(crate::error::ModifyCustomDBEngineVersionError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_custom_db_engine_version(inp: &[u8], mut builder: crate::output::modify_custom_db_engine_version_output::Builder) -> Result<crate::output::modify_custom_db_engine_version_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
