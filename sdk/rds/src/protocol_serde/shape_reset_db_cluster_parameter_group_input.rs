...
pub fn ser_reset_db_cluster_parameter_group_input_input(input: &crate::input::ResetDbClusterParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
