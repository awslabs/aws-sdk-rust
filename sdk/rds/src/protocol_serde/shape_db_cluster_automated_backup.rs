...
pub fn de_db_cluster_automated_backup(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::DbClusterAutomatedBackup, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
