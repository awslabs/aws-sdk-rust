...
pub fn de_stop_db_instance_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_stop_db_instance::de_stop_db_instance(_response_body, output)
            .map_err(crate::operation::stop_db_instance::StopDBInstanceError::unhandled)?;
...
) -> std::result::Result<crate::operation::stop_db_instance::builders::StopDbInstanceOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
