...
pub fn de_stop_db_instance_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StopDbInstanceOutput, crate::error::StopDBInstanceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::StopDBInstanceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_db_instance_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StopDbInstanceOutput, crate::error::StopDBInstanceError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::stop_db_instance_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_stop_db_instance::de_stop_db_instance(response.body().as_ref(), output).map_err(crate::error::StopDBInstanceError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_stop_db_instance(inp: &[u8], mut builder: crate::output::stop_db_instance_output::Builder) -> Result<crate::output::stop_db_instance_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
