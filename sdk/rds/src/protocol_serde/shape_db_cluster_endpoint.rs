...
pub fn de_db_cluster_endpoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbClusterEndpoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
