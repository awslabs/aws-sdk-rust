...
pub fn ser_create_custom_db_engine_version_input_input(input: &crate::input::CreateCustomDbEngineVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
