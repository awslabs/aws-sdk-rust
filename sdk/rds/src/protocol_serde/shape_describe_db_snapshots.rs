...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_snapshots::de_describe_db_snapshots(_response_body, output)
            .map_err(crate::operation::describe_db_snapshots::DescribeDBSnapshotsError::unhandled)?;
...
) -> std::result::Result<crate::operation::describe_db_snapshots::builders::DescribeDbSnapshotsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBSnapshotsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBSnapshotsResult got {start_el:?}"
            )));
        }
