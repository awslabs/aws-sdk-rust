...
pub fn de_db_instance_automated_backup(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbInstanceAutomatedBackup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
