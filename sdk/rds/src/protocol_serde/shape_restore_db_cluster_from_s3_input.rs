...
pub fn ser_restore_db_cluster_from_s3_input_input(input: &crate::input::RestoreDbClusterFromS3Input) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
