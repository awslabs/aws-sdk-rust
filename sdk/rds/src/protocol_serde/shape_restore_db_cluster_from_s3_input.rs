...
pub fn ser_restore_db_cluster_from_s3_input_input_input(input: &crate::operation::restore_db_cluster_from_s3::RestoreDbClusterFromS3Input) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
