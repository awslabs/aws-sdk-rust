...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_activity_stream::de_modify_activity_stream(_response_body, output)
            .map_err(crate::operation::modify_activity_stream::ModifyActivityStreamError::unhandled)?;
...
) -> Result<crate::operation::modify_activity_stream::builders::ModifyActivityStreamOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
