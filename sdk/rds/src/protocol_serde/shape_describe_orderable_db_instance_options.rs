...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_orderable_db_instance_options::DescribeOrderableDBInstanceOptionsError::unhandled)?;
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_orderable_db_instance_options::de_describe_orderable_db_instance_options(_response_body, output)
                .map_err(crate::operation::describe_orderable_db_instance_options::DescribeOrderableDBInstanceOptionsError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeOrderableDBInstanceOptionsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeOrderableDBInstanceOptionsResult got {start_el:?}"
            )));
        }
