...
pub fn ser_promote_read_replica_input_input_input(input: &crate::operation::promote_read_replica::PromoteReadReplicaInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
