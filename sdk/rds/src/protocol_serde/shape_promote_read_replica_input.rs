...
pub fn ser_promote_read_replica_input_input(input: &crate::input::PromoteReadReplicaInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
