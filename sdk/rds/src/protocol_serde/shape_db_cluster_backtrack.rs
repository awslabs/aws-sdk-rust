...
pub fn de_db_cluster_backtrack(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbClusterBacktrack, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
