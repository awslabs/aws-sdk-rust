...
pub fn de_db_snapshot_attributes_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbSnapshotAttributesResult, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
