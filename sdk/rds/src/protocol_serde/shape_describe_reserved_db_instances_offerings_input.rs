...
pub fn ser_describe_reserved_db_instances_offerings_input_input(input: &crate::input::DescribeReservedDbInstancesOfferingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
