...
pub fn de_db_snapshot_attribute(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbSnapshotAttribute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
