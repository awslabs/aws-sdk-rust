...
pub fn de_failover_global_cluster_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::failover_global_cluster::FailoverGlobalClusterOutput, crate::operation::failover_global_cluster::FailoverGlobalClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::failover_global_cluster::FailoverGlobalClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_failover_global_cluster_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::failover_global_cluster::FailoverGlobalClusterOutput, crate::operation::failover_global_cluster::FailoverGlobalClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::failover_global_cluster::builders::FailoverGlobalClusterOutputBuilder::default();
        output = crate::protocol_serde::shape_failover_global_cluster::de_failover_global_cluster(_response_body, output).map_err(crate::operation::failover_global_cluster::FailoverGlobalClusterError::unhandled)?;
