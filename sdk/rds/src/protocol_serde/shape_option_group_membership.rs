...
pub fn de_option_group_membership(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OptionGroupMembership, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
