    ...
    Err(match error_code {
        ...
        "DBInstanceRoleAlreadyExists" => crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError::DbInstanceRoleAlreadyExistsFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_db_instance_role_already_exists_fault::de_db_instance_role_already_exists_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError::unhandled)?;
        ...
        "DBInstanceRoleQuotaExceeded" => crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError::DbInstanceRoleQuotaExceededFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_db_instance_role_quota_exceeded_fault::de_db_instance_role_quota_exceeded_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_role_to_db_instance_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
