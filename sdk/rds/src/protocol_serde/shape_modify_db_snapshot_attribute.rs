...
pub fn de_modify_db_snapshot_attribute_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyDbSnapshotAttributeOutput, crate::error::ModifyDBSnapshotAttributeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyDBSnapshotAttributeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_db_snapshot_attribute_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyDbSnapshotAttributeOutput, crate::error::ModifyDBSnapshotAttributeError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_modify_db_snapshot_attribute(inp: &[u8], mut builder: crate::output::modify_db_snapshot_attribute_output::Builder) -> Result<crate::output::modify_db_snapshot_attribute_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
