...
pub fn de_modify_db_snapshot_attribute_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeOutput, crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_db_snapshot_attribute_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeOutput, crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError> {
    Ok({
        #[allow(unused_mut)]
