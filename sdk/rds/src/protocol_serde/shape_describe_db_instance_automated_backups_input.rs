...
pub fn ser_describe_db_instance_automated_backups_input_input(input: &crate::input::DescribeDbInstanceAutomatedBackupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
