            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_integration_conflict_operation_fault::de_integration_conflict_operation_fault_xml_err(_response_body, output).map_err(crate::operation::delete_integration::DeleteIntegrationError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_integration_not_found_fault::de_integration_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::delete_integration::DeleteIntegrationError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_integration_state_fault::de_invalid_integration_state_fault_xml_err(_response_body, output).map_err(crate::operation::delete_integration::DeleteIntegrationError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(unused_mut)]
pub fn de_delete_integration(inp: &[u8], mut builder: crate::operation::delete_integration::builders::DeleteIntegrationOutputBuilder) -> Result<crate::operation::delete_integration::builders::DeleteIntegrationOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DeleteIntegrationResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected DeleteIntegrationResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DeleteIntegrationResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected DeleteIntegrationResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("DataFilter") /* DataFilter com.amazonaws.rds.synthetic#DeleteIntegrationOutput$DataFilter */ =>  {
                let var_11 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            ,
            s if s.matches("Description") /* Description com.amazonaws.rds.synthetic#DeleteIntegrationOutput$Description */ =>  {
                let var_12 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
