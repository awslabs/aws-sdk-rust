...
pub fn ser_describe_db_engine_versions_input_input_input(input: &crate::operation::describe_db_engine_versions::DescribeDbEngineVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
