...
pub fn de_available_processor_feature(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AvailableProcessorFeature, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
