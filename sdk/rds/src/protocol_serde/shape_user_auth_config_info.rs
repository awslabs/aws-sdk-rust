...
pub fn de_user_auth_config_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::UserAuthConfigInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
