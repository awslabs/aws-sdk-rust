...
pub fn ser_delete_db_cluster_input_input(input: &crate::input::DeleteDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
