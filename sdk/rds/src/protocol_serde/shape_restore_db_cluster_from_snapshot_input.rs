...
pub fn ser_restore_db_cluster_from_snapshot_input_input(input: &crate::input::RestoreDbClusterFromSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
