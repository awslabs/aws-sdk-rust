...
pub fn de_start_activity_stream_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_activity_stream::StartActivityStreamOutput, crate::operation::start_activity_stream::StartActivityStreamError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_activity_stream_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_activity_stream::StartActivityStreamOutput, crate::operation::start_activity_stream::StartActivityStreamError> {
    Ok({
        #[allow(unused_mut)]
