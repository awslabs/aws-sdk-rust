...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_activity_stream_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::start_activity_stream::StartActivityStreamOutput, crate::operation::start_activity_stream::StartActivityStreamError> {
    Ok({
        #[allow(unused_mut)]
