...
pub fn ser_create_blue_green_deployment_input_input_input(input: &crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
