...
pub fn ser_remove_role_from_db_cluster_input_input_input(input: &crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
