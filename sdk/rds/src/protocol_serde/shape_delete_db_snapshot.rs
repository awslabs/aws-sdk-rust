...
pub fn de_delete_db_snapshot_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_snapshot::DeleteDbSnapshotOutput, crate::operation::delete_db_snapshot::DeleteDBSnapshotError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_db_snapshot::DeleteDBSnapshotError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_snapshot_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_snapshot::DeleteDbSnapshotOutput, crate::operation::delete_db_snapshot::DeleteDBSnapshotError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_db_snapshot::builders::DeleteDbSnapshotOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_db_snapshot::de_delete_db_snapshot(_response_body, output).map_err(crate::operation::delete_db_snapshot::DeleteDBSnapshotError::unhandled)?;
