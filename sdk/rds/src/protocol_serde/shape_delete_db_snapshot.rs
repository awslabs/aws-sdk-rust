...
pub fn de_delete_db_snapshot_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_snapshot::DeleteDbSnapshotOutput, crate::operation::delete_db_snapshot::DeleteDBSnapshotError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_snapshot_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_snapshot::DeleteDbSnapshotOutput, crate::operation::delete_db_snapshot::DeleteDBSnapshotError> {
    Ok({
        #[allow(unused_mut)]
