...
pub fn de_authorize_db_security_group_ingress_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AuthorizeDbSecurityGroupIngressOutput, crate::error::AuthorizeDBSecurityGroupIngressError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AuthorizeDBSecurityGroupIngressError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_db_security_group_ingress_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AuthorizeDbSecurityGroupIngressOutput, crate::error::AuthorizeDBSecurityGroupIngressError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_authorize_db_security_group_ingress(inp: &[u8], mut builder: crate::output::authorize_db_security_group_ingress_output::Builder) -> Result<crate::output::authorize_db_security_group_ingress_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
