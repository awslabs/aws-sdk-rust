...
> {
    ...
    Err(match error_code {
        ...
        "InvalidDBProxyEndpointStateFault" => {
            crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError::InvalidDbProxyEndpointStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidDbProxyEndpointStateFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_db_proxy_endpoint_state_fault::de_invalid_db_proxy_endpoint_state_fault_xml_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_db_proxy_endpoint::de_delete_db_proxy_endpoint(_response_body, output)
            .map_err(crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DeleteDBProxyEndpointResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DeleteDBProxyEndpointResult got {start_el:?}"
            )));
        }
