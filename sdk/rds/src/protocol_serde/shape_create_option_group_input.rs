...
pub fn ser_create_option_group_input_input_input(input: &crate::operation::create_option_group::CreateOptionGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
