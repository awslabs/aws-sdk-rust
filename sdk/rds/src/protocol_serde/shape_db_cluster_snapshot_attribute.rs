...
pub fn de_db_cluster_snapshot_attribute(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbClusterSnapshotAttribute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
