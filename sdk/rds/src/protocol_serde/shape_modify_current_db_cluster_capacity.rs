...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError::unhandled)?;
    ...
    Err(match error_code {
        "DBClusterNotFoundFault" => {
            crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError::DbClusterNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidDBClusterCapacityFault" => {
            crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError::InvalidDbClusterCapacityFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidDbClusterCapacityFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_db_cluster_capacity_fault::de_invalid_db_cluster_capacity_fault_xml_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError::unhandled)?;
        ...
        "InvalidDBClusterStateFault" => {
            crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError::InvalidDbClusterStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_current_db_cluster_capacity::de_modify_current_db_cluster_capacity(_response_body, output)
            .map_err(crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError::unhandled)?;
