...
pub fn de_modify_current_db_cluster_capacity_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyCurrentDbClusterCapacityOutput, crate::error::ModifyCurrentDBClusterCapacityError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ModifyCurrentDBClusterCapacityError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_current_db_cluster_capacity_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ModifyCurrentDbClusterCapacityOutput, crate::error::ModifyCurrentDBClusterCapacityError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_modify_current_db_cluster_capacity(inp: &[u8], mut builder: crate::output::modify_current_db_cluster_capacity_output::Builder) -> Result<crate::output::modify_current_db_cluster_capacity_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
