...
#[allow(unused_mut)]
pub fn de_start_export_task(inp: &[u8], mut builder: crate::output::start_export_task_output::Builder) -> Result<crate::output::start_export_task_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
