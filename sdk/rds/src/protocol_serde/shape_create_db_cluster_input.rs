...
pub fn ser_create_db_cluster_input_input_input(input: &crate::operation::create_db_cluster::CreateDbClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_88) = &input.iops {
        scope_87.number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_88).into()));
    }
    #[allow(unused_mut)]
