...
pub fn ser_restore_db_instance_to_point_in_time_input_input(input: &crate::input::RestoreDbInstanceToPointInTimeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
