...
pub fn ser_describe_orderable_db_instance_options_input_input_input(input: &crate::operation::describe_orderable_db_instance_options::DescribeOrderableDbInstanceOptionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
