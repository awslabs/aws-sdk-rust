...
pub fn ser_switchover_read_replica_input_input(input: &crate::input::SwitchoverReadReplicaInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
