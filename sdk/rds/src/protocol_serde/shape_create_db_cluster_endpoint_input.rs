...
pub fn ser_create_db_cluster_endpoint_input_input_input(input: &crate::operation::create_db_cluster_endpoint::CreateDbClusterEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
