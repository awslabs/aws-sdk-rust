...
pub fn ser_restore_db_instance_from_db_snapshot_input_input(input: &crate::input::RestoreDbInstanceFromDbSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
