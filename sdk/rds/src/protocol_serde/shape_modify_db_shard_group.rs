...
pub fn de_modify_db_shard_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_db_shard_group::ModifyDbShardGroupOutput, crate::operation::modify_db_shard_group::ModifyDBShardGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_db_shard_group::ModifyDBShardGroupError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_shard_group_already_exists_fault::de_db_shard_group_already_exists_fault_xml_err(_response_body, output).map_err(crate::operation::modify_db_shard_group::ModifyDBShardGroupError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_shard_group_not_found_fault::de_db_shard_group_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::modify_db_shard_group::ModifyDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_db_cluster_state_fault::de_invalid_db_cluster_state_fault_xml_err(_response_body, output).map_err(crate::operation::modify_db_shard_group::ModifyDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_max_acu_fault::de_invalid_max_acu_fault_xml_err(_response_body, output).map_err(crate::operation::modify_db_shard_group::ModifyDBShardGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_db_shard_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_db_shard_group::ModifyDbShardGroupOutput, crate::operation::modify_db_shard_group::ModifyDBShardGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_db_shard_group::builders::ModifyDbShardGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_db_shard_group::de_modify_db_shard_group(_response_body, output).map_err(crate::operation::modify_db_shard_group::ModifyDBShardGroupError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_db_shard_group(inp: &[u8], mut builder: crate::operation::modify_db_shard_group::builders::ModifyDbShardGroupOutputBuilder) -> Result<crate::operation::modify_db_shard_group::builders::ModifyDbShardGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ModifyDBShardGroupResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected ModifyDBShardGroupResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ModifyDBShardGroupResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected ModifyDBShardGroupResult got {:?}", start_el)))
                        }
