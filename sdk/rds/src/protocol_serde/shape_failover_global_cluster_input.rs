...
pub fn ser_failover_global_cluster_input_input(input: &crate::input::FailoverGlobalClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
