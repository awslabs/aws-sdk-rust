...
pub fn ser_remove_role_from_db_instance_input_input(input: &crate::input::RemoveRoleFromDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
