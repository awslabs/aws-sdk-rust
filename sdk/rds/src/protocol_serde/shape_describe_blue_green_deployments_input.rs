...
pub fn ser_describe_blue_green_deployments_input_input_input(input: &crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
