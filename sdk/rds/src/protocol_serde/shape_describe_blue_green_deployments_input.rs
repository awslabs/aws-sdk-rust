...
pub fn ser_describe_blue_green_deployments_input_input(input: &crate::input::DescribeBlueGreenDeploymentsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
