...
pub fn de_create_db_subnet_group_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_subnet_group::CreateDbSubnetGroupOutput, crate::operation::create_db_subnet_group::CreateDBSubnetGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_db_subnet_group_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_subnet_group::CreateDbSubnetGroupOutput, crate::operation::create_db_subnet_group::CreateDBSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
