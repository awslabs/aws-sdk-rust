...
pub fn de_create_db_subnet_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_subnet_group::CreateDbSubnetGroupOutput, crate::operation::create_db_subnet_group::CreateDBSubnetGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_db_subnet_group::CreateDBSubnetGroupError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_subnet_group_does_not_cover_enough_azs::de_db_subnet_group_does_not_cover_enough_azs_xml_err(_response_body, output).map_err(crate::operation::create_db_subnet_group::CreateDBSubnetGroupError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_db_subnet_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_subnet_group::CreateDbSubnetGroupOutput, crate::operation::create_db_subnet_group::CreateDBSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_db_subnet_group::builders::CreateDbSubnetGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_create_db_subnet_group::de_create_db_subnet_group(_response_body, output).map_err(crate::operation::create_db_subnet_group::CreateDBSubnetGroupError::unhandled)?;
