...
pub fn ser_add_role_to_db_cluster_input_input_input(input: &crate::operation::add_role_to_db_cluster::AddRoleToDbClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
