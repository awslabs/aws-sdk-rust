...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_db_instance_automated_backups_replication::de_start_db_instance_automated_backups_replication(
            _response_body,
            output,
        )
        .map_err(crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("StartDBInstanceAutomatedBackupsReplicationResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected StartDBInstanceAutomatedBackupsReplicationResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("StartDBInstanceAutomatedBackupsReplicationResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected StartDBInstanceAutomatedBackupsReplicationResult got {start_el:?}"
            )));
        }
