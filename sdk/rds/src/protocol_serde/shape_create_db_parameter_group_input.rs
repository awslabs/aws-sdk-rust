...
pub fn ser_create_db_parameter_group_input_input(input: &crate::operation::create_db_parameter_group::CreateDbParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
