...
pub fn ser_modify_db_proxy_input_input(input: &crate::input::ModifyDbProxyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
