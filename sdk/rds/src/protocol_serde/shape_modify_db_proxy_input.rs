...
pub fn ser_modify_db_proxy_input_input_input(input: &crate::operation::modify_db_proxy::ModifyDbProxyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
