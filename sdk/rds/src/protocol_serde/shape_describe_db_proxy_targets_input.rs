...
pub fn ser_describe_db_proxy_targets_input_input(input: &crate::operation::describe_db_proxy_targets::DescribeDbProxyTargetsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
