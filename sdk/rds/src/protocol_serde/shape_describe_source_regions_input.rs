...
pub fn ser_describe_source_regions_input_input_input(input: &crate::operation::describe_source_regions::DescribeSourceRegionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
