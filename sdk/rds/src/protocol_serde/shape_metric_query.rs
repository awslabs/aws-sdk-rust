...
pub fn de_metric_query(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MetricQuery, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("PerformanceInsightsMetricQuery") /* PerformanceInsightsMetricQuery com.amazonaws.rds#MetricQuery$PerformanceInsightsMetricQuery */ =>  {
                ...
                ;
                builder = builder.set_performance_insights_metric_query(var_1);
            }
            ,
            _ => {}
        }
