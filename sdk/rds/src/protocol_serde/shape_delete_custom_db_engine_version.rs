...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersionError::unhandled)?;
    ...
    Err(match error_code {
        "CustomDBEngineVersionNotFoundFault" => {
            crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersionError::CustomDbEngineVersionNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidCustomDBEngineVersionStateFault" => {
            crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersionError::InvalidCustomDbEngineVersionStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_custom_db_engine_version::de_delete_custom_db_engine_version(_response_body, output)
            .map_err(crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersionError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            ,
            s if s.matches("SupportsLimitlessDatabase") /* SupportsLimitlessDatabase com.amazonaws.rds.synthetic#DeleteCustomDBEngineVersionOutput$SupportsLimitlessDatabase */ =>  {
                let var_30 =
                    Some(
                         {
                            <bool as ::aws_smithy_types::primitive::Parse>::parse_smithy_primitive(
            ...
            ,
            s if s.matches("ServerlessV2FeaturesSupport") /* ServerlessV2FeaturesSupport com.amazonaws.rds.synthetic#DeleteCustomDBEngineVersionOutput$ServerlessV2FeaturesSupport */ =>  {
                let var_35 =
                    Some(
            ...
            ,
            s if s.matches("DatabaseInstallationFiles") /* DatabaseInstallationFiles com.amazonaws.rds.synthetic#DeleteCustomDBEngineVersionOutput$DatabaseInstallationFiles */ =>  {
                let var_36 =
                    Some(
            ...
            ,
            s if s.matches("FailureReason") /* FailureReason com.amazonaws.rds.synthetic#DeleteCustomDBEngineVersionOutput$FailureReason */ =>  {
                let var_37 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
