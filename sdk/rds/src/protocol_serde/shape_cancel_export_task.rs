...
pub fn de_cancel_export_task_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CancelExportTaskOutput, crate::error::CancelExportTaskError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CancelExportTaskError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_export_task_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CancelExportTaskOutput, crate::error::CancelExportTaskError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::cancel_export_task_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_cancel_export_task::de_cancel_export_task(response.body().as_ref(), output).map_err(crate::error::CancelExportTaskError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_cancel_export_task(inp: &[u8], mut builder: crate::output::cancel_export_task_output::Builder) -> Result<crate::output::cancel_export_task_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
