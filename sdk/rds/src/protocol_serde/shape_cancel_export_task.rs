...
pub fn de_cancel_export_task_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_export_task::CancelExportTaskOutput, crate::operation::cancel_export_task::CancelExportTaskError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::cancel_export_task::CancelExportTaskError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_export_task_not_found_fault::de_export_task_not_found_fault_xml_err(_response_body, output).map_err(crate::operation::cancel_export_task::CancelExportTaskError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_export_task_state_fault::de_invalid_export_task_state_fault_xml_err(_response_body, output).map_err(crate::operation::cancel_export_task::CancelExportTaskError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_export_task_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_export_task::CancelExportTaskOutput, crate::operation::cancel_export_task::CancelExportTaskError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::default();
        output = crate::protocol_serde::shape_cancel_export_task::de_cancel_export_task(_response_body, output).map_err(crate::operation::cancel_export_task::CancelExportTaskError::unhandled)?;
