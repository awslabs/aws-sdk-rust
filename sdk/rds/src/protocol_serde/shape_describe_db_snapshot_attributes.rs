...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_db_snapshot_attributes::DescribeDBSnapshotAttributesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_snapshot_attributes::de_describe_db_snapshot_attributes(_response_body, output)
            .map_err(crate::operation::describe_db_snapshot_attributes::DescribeDBSnapshotAttributesError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBSnapshotAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBSnapshotAttributesResult got {start_el:?}"
            )));
        }
