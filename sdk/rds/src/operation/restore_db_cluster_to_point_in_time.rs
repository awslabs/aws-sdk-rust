...
impl RestoreDBClusterToPointInTime {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "RestoreDBClusterToPointInTime", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreDBClusterToPointInTimeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("SourceDbClusterResourceId") {
            if let ::std::option::Option::Some(value) = input.source_db_cluster_resource_id.as_deref() {
                captured.insert("SourceDbClusterResourceId", value);
            }
        }
...
impl RestoreDBClusterToPointInTimeError {
    ...
    /// Returns `true` if the error kind is `RestoreDBClusterToPointInTimeError::VpcEncryptionControlViolationException`.
