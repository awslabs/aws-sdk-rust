...
impl CreateDBShardGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_db_shard_group::CreateDbShardGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_db_shard_group::CreateDBShardGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_db_shard_group::CreateDbShardGroupOutput, crate::operation::create_db_shard_group::CreateDBShardGroupError, Self> {
