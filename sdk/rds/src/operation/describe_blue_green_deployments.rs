...
impl DescribeBlueGreenDeploymentsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeBlueGreenDeployments`](crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeployments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeployments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_blue_green_deployments_input::ser_describe_blue_green_deployments_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeployments::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeBlueGreenDeployments", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeBlueGreenDeployments {
                type Output = std::result::Result<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsOutput, crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_blue_green_deployments::de_describe_blue_green_deployments_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_blue_green_deployments::de_describe_blue_green_deployments_http_response(response)
                     }
                }
            }
