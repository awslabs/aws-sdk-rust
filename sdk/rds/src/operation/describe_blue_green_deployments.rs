...
/// Orchestration and serialization glue logic for `DescribeBlueGreenDeployments`.
...
impl DescribeBlueGreenDeployments {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBlueGreenDeployments {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeBlueGreenDeployments");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeBlueGreenDeploymentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeBlueGreenDeploymentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBlueGreenDeployments")
...
.with_interceptor(DescribeBlueGreenDeploymentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError>::new());
...
#[derive(Debug)]
            struct DescribeBlueGreenDeploymentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeBlueGreenDeploymentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_blue_green_deployments::de_describe_blue_green_deployments_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeBlueGreenDeploymentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeBlueGreenDeploymentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_blue_green_deployments_input::ser_describe_blue_green_deployments_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeBlueGreenDeploymentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeBlueGreenDeploymentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeBlueGreenDeploymentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeBlueGreenDeploymentsInput>()
                        .ok_or("failed to downcast to DescribeBlueGreenDeploymentsInput")?;
...
pub enum DescribeBlueGreenDeploymentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeBlueGreenDeploymentsError) for what information is available for the error.")]
...
impl DescribeBlueGreenDeploymentsError {
    /// Creates the `DescribeBlueGreenDeploymentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeBlueGreenDeploymentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeBlueGreenDeploymentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError {
...
mod _describe_blue_green_deployments_output;
