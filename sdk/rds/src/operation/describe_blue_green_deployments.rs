...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBlueGreenDeployments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_blue_green_deployments::de_describe_blue_green_deployments_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeBlueGreenDeploymentsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsError
{
