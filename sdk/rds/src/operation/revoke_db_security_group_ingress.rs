...
impl RevokeDbSecurityGroupIngressInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::revoke_db_security_group_ingress::RevokeDBSecurityGroupIngress::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::revoke_db_security_group_ingress::RevokeDBSecurityGroupIngressError
{
