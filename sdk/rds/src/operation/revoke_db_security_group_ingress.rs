...
impl RevokeDbSecurityGroupIngressInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::revoke_db_security_group_ingress::RevokeDBSecurityGroupIngress, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_db_security_group_ingress::RevokeDbSecurityGroupIngressInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
