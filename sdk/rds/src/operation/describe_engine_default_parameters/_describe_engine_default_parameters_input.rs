...
impl DescribeEngineDefaultParametersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_engine_default_parameters::DescribeEngineDefaultParametersInput, ::aws_smithy_types::error::operation::BuildError> {
