...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDBInstanceReadReplicaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_db_instance_read_replica::de_create_db_instance_read_replica_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_db_instance_read_replica::de_create_db_instance_read_replica_http_response(
