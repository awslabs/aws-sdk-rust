...
impl CreateDbInstanceReadReplicaInput {
    /// Consumes the builder and constructs an Operation<[`CreateDBInstanceReadReplica`](crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplica)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplica, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_db_instance_read_replica_input::ser_create_db_instance_read_replica_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplica::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDBInstanceReadReplica", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDBInstanceReadReplica {
                type Output = std::result::Result<crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaOutput, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError>;
