    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "CreateDBInstanceReadReplica", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.service" = "RDS",
                "rpc.method" = "CreateDBInstanceReadReplica",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateDBInstanceReadReplica")
                .build()
...
impl CreateDBInstanceReadReplicaError {
    ...
    /// Returns `true` if the error kind is `CreateDBInstanceReadReplicaError::VpcEncryptionControlViolationException`.
