...
/// Orchestration and serialization glue logic for `CreateDBShardGroup`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateDBShardGroup;
impl CreateDBShardGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_db_shard_group::CreateDbShardGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_db_shard_group::CreateDBShardGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_db_shard_group::CreateDBShardGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_db_shard_group::CreateDbShardGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDBShardGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateDBShardGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateDBShardGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateDBShardGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDBShardGroup")
...
.with_interceptor(CreateDBShardGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_db_shard_group::CreateDBShardGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_db_shard_group::CreateDBShardGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_db_shard_group::CreateDBShardGroupError>::new());
...
#[derive(Debug)]
            struct CreateDBShardGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDBShardGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_db_shard_group::de_create_db_shard_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_db_shard_group::de_create_db_shard_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateDBShardGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDBShardGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_db_shard_group::CreateDbShardGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_db_shard_group::CreateDbShardGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_db_shard_group_input::ser_create_db_shard_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateDBShardGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDBShardGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateDBShardGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateDbShardGroupInput>()
                        .ok_or("failed to downcast to CreateDbShardGroupInput")?;
...
/// Error type for the `CreateDBShardGroupError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateDBShardGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateDBShardGroupError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateDBShardGroupError {
    /// Creates the `CreateDBShardGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDBShardGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateDBShardGroupError::DbClusterNotFoundFault`.
    pub fn is_db_cluster_not_found_fault(&self) -> bool {
        matches!(self, Self::DbClusterNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `CreateDBShardGroupError::DbShardGroupAlreadyExistsFault`.
    ...
    /// Returns `true` if the error kind is `CreateDBShardGroupError::MaxDbShardGroupLimitReached`.
...
impl ::std::error::Error for CreateDBShardGroupError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::MaxDbShardGroupLimitReached(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::UnsupportedDbEngineVersionFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for CreateDBShardGroupError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateDBShardGroupError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateDBShardGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateDBShardGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_db_shard_group::CreateDBShardGroupError {
...
mod _create_db_shard_group_output;
