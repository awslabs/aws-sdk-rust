...
impl RebootDbClusterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reboot_db_cluster::RebootDBCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootDBCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reboot_db_cluster::de_reboot_db_cluster_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::reboot_db_cluster::RebootDBClusterError
{
