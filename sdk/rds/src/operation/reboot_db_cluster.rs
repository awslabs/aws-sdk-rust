...
impl RebootDbClusterInput {
    /// Consumes the builder and constructs an Operation<[`RebootDBCluster`](crate::operation::reboot_db_cluster::RebootDBCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reboot_db_cluster::RebootDBCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_db_cluster::RebootDbClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_db_cluster_input::ser_reboot_db_cluster_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_db_cluster::RebootDBCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RebootDBCluster", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for RebootDBCluster {
                type Output = std::result::Result<crate::operation::reboot_db_cluster::RebootDbClusterOutput, crate::operation::reboot_db_cluster::RebootDBClusterError>;
