...
impl RebootDbClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reboot_db_cluster::RebootDBCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootDBCluster {
    type Output =
        ::std::result::Result<crate::operation::reboot_db_cluster::RebootDbClusterOutput, crate::operation::reboot_db_cluster::RebootDBClusterError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reboot_db_cluster::de_reboot_db_cluster_http_response_with_props(status, headers, body)
        }
    }
}
