...
impl ModifyCurrentDBClusterCapacity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDbClusterCapacityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "RDS",
            "rpc.method" = "ModifyCurrentDBClusterCapacity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyCurrentDBClusterCapacity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyCurrentDBClusterCapacityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyCurrentDBClusterCapacityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyCurrentDBClusterCapacity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyCurrentDBClusterCapacity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyCurrentDBClusterCapacityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyCurrentDBClusterCapacityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyCurrentDBClusterCapacityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyCurrentDbClusterCapacityInput>() else {
        ...
        if requested.should_capture("TimeoutAction") {
            if let ::std::option::Option::Some(value) = input.timeout_action.as_deref() {
                captured.insert("TimeoutAction", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyCurrentDBClusterCapacityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_modify_current_db_cluster_capacity::de_modify_current_db_cluster_capacity_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyCurrentDBClusterCapacityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDbClusterCapacityInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_current_db_cluster_capacity_input::ser_modify_current_db_cluster_capacity_input_input_input(&input)?,
        );
...
impl ::std::error::Error for ModifyCurrentDBClusterCapacityError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidDbClusterCapacityFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyCurrentDBClusterCapacityError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidDbClusterCapacityFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
