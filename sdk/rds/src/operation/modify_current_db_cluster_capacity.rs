...
impl ModifyCurrentDbClusterCapacityInput {
    /// Consumes the builder and constructs an Operation<[`ModifyCurrentDBClusterCapacity`](crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDbClusterCapacityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_current_db_cluster_capacity_input::ser_modify_current_db_cluster_capacity_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyCurrentDBClusterCapacity", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyCurrentDBClusterCapacity {
                type Output = std::result::Result<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDbClusterCapacityOutput, crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError>;
