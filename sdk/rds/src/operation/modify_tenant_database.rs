...
impl ModifyTenantDatabase {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_tenant_database::ModifyTenantDatabaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_tenant_database::ModifyTenantDatabaseOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "ModifyTenantDatabase", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.ModifyTenantDatabase",
                "rpc.service" = "RDS",
                "rpc.method" = "ModifyTenantDatabase",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyTenantDatabase {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyTenantDatabaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyTenantDatabaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyTenantDatabase")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyTenantDatabase")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyTenantDatabaseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyTenantDatabaseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyTenantDatabaseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyTenantDatabaseInput>() else {
        ...
        if requested.should_capture("TenantDBName") {
            if let ::std::option::Option::Some(value) = input.tenant_db_name.as_deref() {
                captured.insert("TenantDBName", value);
            }
        }
        if requested.should_capture("NewTenantDBName") {
            if let ::std::option::Option::Some(value) = input.new_tenant_db_name.as_deref() {
                captured.insert("NewTenantDBName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyTenantDatabaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_tenant_database::de_modify_tenant_database_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_modify_tenant_database::de_modify_tenant_database_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyTenantDatabaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_tenant_database::ModifyTenantDatabaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::modify_tenant_database::ModifyTenantDatabaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_tenant_database_input::ser_modify_tenant_database_input_input_input(&input)?,
        );
