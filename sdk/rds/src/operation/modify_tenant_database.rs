...
/// Orchestration and serialization glue logic for `ModifyTenantDatabase`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ModifyTenantDatabase;
impl ModifyTenantDatabase {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_tenant_database::ModifyTenantDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_tenant_database::ModifyTenantDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_tenant_database::ModifyTenantDatabaseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_tenant_database::ModifyTenantDatabaseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyTenantDatabase {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyTenantDatabase");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyTenantDatabaseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyTenantDatabaseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyTenantDatabase")
...
.with_interceptor(ModifyTenantDatabaseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_tenant_database::ModifyTenantDatabaseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_tenant_database::ModifyTenantDatabaseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_tenant_database::ModifyTenantDatabaseError>::new());
...
#[derive(Debug)]
            struct ModifyTenantDatabaseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyTenantDatabaseResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_tenant_database::de_modify_tenant_database_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_tenant_database::de_modify_tenant_database_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyTenantDatabaseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyTenantDatabaseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_tenant_database::ModifyTenantDatabaseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_tenant_database::ModifyTenantDatabaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_tenant_database_input::ser_modify_tenant_database_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyTenantDatabaseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyTenantDatabaseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyTenantDatabaseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyTenantDatabaseInput>()
                        .ok_or("failed to downcast to ModifyTenantDatabaseInput")?;
...
/// Error type for the `ModifyTenantDatabaseError` operation.
#[non_exhaustive]
...
pub enum ModifyTenantDatabaseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyTenantDatabaseError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ModifyTenantDatabaseError {
    /// Creates the `ModifyTenantDatabaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyTenantDatabaseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ModifyTenantDatabaseError::DbInstanceNotFoundFault`.
    ...
    pub fn is_tenant_database_already_exists_fault(&self) -> bool {
        matches!(self, Self::TenantDatabaseAlreadyExistsFault(_))
    }
    /// Returns `true` if the error kind is `ModifyTenantDatabaseError::TenantDatabaseNotFoundFault`.
    pub fn is_tenant_database_not_found_fault(&self) -> bool {
        matches!(self, Self::TenantDatabaseNotFoundFault(_))
    }
}
impl ::std::error::Error for ModifyTenantDatabaseError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::TenantDatabaseAlreadyExistsFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::TenantDatabaseNotFoundFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for ModifyTenantDatabaseError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ModifyTenantDatabaseError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyTenantDatabaseError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyTenantDatabaseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_tenant_database::ModifyTenantDatabaseError {
...
mod _modify_tenant_database_output;
