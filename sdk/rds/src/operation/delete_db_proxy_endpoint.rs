...
/// Orchestration and serialization glue logic for `DeleteDBProxyEndpoint`.
...
impl DeleteDBProxyEndpoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_db_proxy_endpoint::DeleteDbProxyEndpointInput,
                    ) -> ::std::result::Result<crate::operation::delete_db_proxy_endpoint::DeleteDbProxyEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_db_proxy_endpoint::DeleteDbProxyEndpointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDBProxyEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDBProxyEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDBProxyEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDBProxyEndpointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDBProxyEndpoint")
...
.with_interceptor(DeleteDBProxyEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDBProxyEndpointResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_db_proxy_endpoint::de_delete_db_proxy_endpoint_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_db_proxy_endpoint::de_delete_db_proxy_endpoint_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDBProxyEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_db_proxy_endpoint::DeleteDbProxyEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_db_proxy_endpoint::DeleteDbProxyEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_db_proxy_endpoint_input::ser_delete_db_proxy_endpoint_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteDBProxyEndpointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDBProxyEndpointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteDBProxyEndpointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteDbProxyEndpointInput>()
                        .ok_or("failed to downcast to DeleteDbProxyEndpointInput")?;
...
pub enum DeleteDBProxyEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDBProxyEndpointError) for what information is available for the error.")]
...
impl DeleteDBProxyEndpointError {
    /// Creates the `DeleteDBProxyEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDBProxyEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidDbProxyEndpointStateFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDBProxyEndpointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError {
...
mod _delete_db_proxy_endpoint_output;
