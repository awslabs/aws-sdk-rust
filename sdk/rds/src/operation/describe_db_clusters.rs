...
impl DescribeDbClustersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBClusters`](crate::operation::describe_db_clusters::DescribeDBClusters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_clusters::DescribeDBClusters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_clusters::DescribeDbClustersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_clusters::DescribeDBClusters::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBClusters", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBClusters {
                type Output = std::result::Result<crate::operation::describe_db_clusters::DescribeDbClustersOutput, crate::operation::describe_db_clusters::DescribeDBClustersError>;
