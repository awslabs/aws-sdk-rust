...
impl DownloadDbLogFilePortionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::download_db_log_file_portion::DownloadDBLogFilePortion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DownloadDBLogFilePortion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_download_db_log_file_portion::de_download_db_log_file_portion_http_response_with_props(status, headers, body)
        }
    }
}
