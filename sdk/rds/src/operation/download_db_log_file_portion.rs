...
impl DownloadDbLogFilePortionInput {
    /// Consumes the builder and constructs an Operation<[`DownloadDBLogFilePortion`](crate::operation::download_db_log_file_portion::DownloadDBLogFilePortion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::download_db_log_file_portion::DownloadDBLogFilePortion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_download_db_log_file_portion_input::ser_download_db_log_file_portion_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::download_db_log_file_portion::DownloadDBLogFilePortion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DownloadDBLogFilePortion", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DownloadDBLogFilePortion {
                type Output = std::result::Result<crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionOutput, crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_download_db_log_file_portion::de_download_db_log_file_portion_http_error(response)
                     } else {
                        crate::protocol_serde::shape_download_db_log_file_portion::de_download_db_log_file_portion_http_response(response)
                     }
                }
            }
