...
/// Orchestration and serialization glue logic for `DownloadDBLogFilePortion`.
...
impl DownloadDBLogFilePortion {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionInput,
                    ) -> ::std::result::Result<crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DownloadDBLogFilePortion {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DownloadDBLogFilePortion");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DownloadDBLogFilePortionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DownloadDBLogFilePortionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DownloadDBLogFilePortion")
...
.with_interceptor(DownloadDBLogFilePortionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError>::new());
...
#[derive(Debug)]
            struct DownloadDBLogFilePortionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DownloadDBLogFilePortionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_download_db_log_file_portion::de_download_db_log_file_portion_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DownloadDBLogFilePortionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DownloadDBLogFilePortionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_download_db_log_file_portion_input::ser_download_db_log_file_portion_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DownloadDBLogFilePortionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DownloadDBLogFilePortionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DownloadDBLogFilePortionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DownloadDbLogFilePortionInput>()
                        .ok_or("failed to downcast to DownloadDbLogFilePortionInput")?;
...
pub enum DownloadDBLogFilePortionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DownloadDBLogFilePortionError) for what information is available for the error.")]
...
impl DownloadDBLogFilePortionError {
    /// Creates the `DownloadDBLogFilePortionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DownloadDBLogFilePortionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DbLogFileNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DownloadDBLogFilePortionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::download_db_log_file_portion::DownloadDBLogFilePortionError {
...
mod _download_db_log_file_portion_output;
