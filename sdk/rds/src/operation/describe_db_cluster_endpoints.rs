...
impl DescribeDbClusterEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBClusterEndpoints`](crate::operation::describe_db_cluster_endpoints::DescribeDBClusterEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_cluster_endpoints::DescribeDBClusterEndpoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_cluster_endpoints::DescribeDbClusterEndpointsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_cluster_endpoints::DescribeDBClusterEndpoints::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBClusterEndpoints", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterEndpoints {
                type Output = std::result::Result<crate::operation::describe_db_cluster_endpoints::DescribeDbClusterEndpointsOutput, crate::operation::describe_db_cluster_endpoints::DescribeDBClusterEndpointsError>;
