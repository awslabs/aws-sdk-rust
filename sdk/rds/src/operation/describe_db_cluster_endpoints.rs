...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_cluster_endpoints::de_describe_db_cluster_endpoints_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_db_cluster_endpoints::DescribeDBClusterEndpointsError
{
