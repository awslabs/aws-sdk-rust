...
impl DescribeDbProxyTargetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_db_proxy_targets::DescribeDBProxyTargets,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBProxyTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_proxy_targets::de_describe_db_proxy_targets_http_response_with_props(status, headers, body)
        }
    }
}
