...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDBInstanceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("AwsBackupRecoveryPointArn") {
            if let ::std::option::Option::Some(value) = input.aws_backup_recovery_point_arn.as_deref() {
                captured.insert("AwsBackupRecoveryPointArn", value);
            }
        }
...
impl ModifyDBInstanceError {
    ...
    /// Returns `true` if the error kind is `ModifyDBInstanceError::VpcEncryptionControlViolationException`.
