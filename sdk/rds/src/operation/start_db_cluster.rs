...
impl StartDBCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "StartDBCluster", input, runtime_plugins, stop_point)
...
impl StartDBClusterError {
    ...
    /// Returns `true` if the error kind is `StartDBClusterError::VpcEncryptionControlViolationException`.
