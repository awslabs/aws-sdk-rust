...
impl DescribeDbClusterParametersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBClusterParameters`](crate::operation::describe_db_cluster_parameters::DescribeDBClusterParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_cluster_parameters::DescribeDBClusterParameters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_cluster_parameters::DescribeDbClusterParametersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_cluster_parameters::DescribeDBClusterParameters::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBClusterParameters", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterParameters {
                type Output = std::result::Result<crate::operation::describe_db_cluster_parameters::DescribeDbClusterParametersOutput, crate::operation::describe_db_cluster_parameters::DescribeDBClusterParametersError>;
