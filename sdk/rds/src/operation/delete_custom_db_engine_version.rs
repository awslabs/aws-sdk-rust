...
impl DeleteCustomDbEngineVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomDBEngineVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_custom_db_engine_version::de_delete_custom_db_engine_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
