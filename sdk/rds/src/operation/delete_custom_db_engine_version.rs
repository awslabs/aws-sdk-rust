...
impl DeleteCustomDbEngineVersionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCustomDBEngineVersion`](crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_custom_db_engine_version::DeleteCustomDbEngineVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_custom_db_engine_version_input::ser_delete_custom_db_engine_version_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteCustomDBEngineVersion", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCustomDBEngineVersion {
                type Output = std::result::Result<crate::operation::delete_custom_db_engine_version::DeleteCustomDbEngineVersionOutput, crate::operation::delete_custom_db_engine_version::DeleteCustomDBEngineVersionError>;
