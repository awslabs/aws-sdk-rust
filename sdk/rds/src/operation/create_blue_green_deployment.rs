...
impl CreateBlueGreenDeploymentInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_blue_green_deployment::CreateBlueGreenDeployment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBlueGreenDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_blue_green_deployment::de_create_blue_green_deployment_http_response_with_props(status, headers, body)
        }
    }
}
