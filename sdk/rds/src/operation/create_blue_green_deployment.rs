...
/// Orchestration and serialization glue logic for `CreateBlueGreenDeployment`.
...
impl CreateBlueGreenDeployment {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateBlueGreenDeployment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateBlueGreenDeployment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateBlueGreenDeploymentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateBlueGreenDeploymentResponseDeserializer));
...
.with_interceptor(CreateBlueGreenDeploymentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_blue_green_deployment::de_create_blue_green_deployment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_blue_green_deployment::de_create_blue_green_deployment_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateBlueGreenDeploymentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBlueGreenDeploymentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_blue_green_deployment_input::ser_create_blue_green_deployment_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateBlueGreenDeploymentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateBlueGreenDeploymentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateBlueGreenDeploymentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateBlueGreenDeploymentInput>()
                        .ok_or("failed to downcast to CreateBlueGreenDeploymentInput")?;
...
pub enum CreateBlueGreenDeploymentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateBlueGreenDeploymentError) for what information is available for the error.")]
...
impl CreateBlueGreenDeploymentError {
    /// Creates the `CreateBlueGreenDeploymentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateBlueGreenDeploymentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BlueGreenDeploymentAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateBlueGreenDeploymentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError {
...
mod _create_blue_green_deployment_output;
