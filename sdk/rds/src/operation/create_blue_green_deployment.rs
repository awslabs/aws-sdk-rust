...
impl CreateBlueGreenDeploymentInput {
    /// Consumes the builder and constructs an Operation<[`CreateBlueGreenDeployment`](crate::operation::create_blue_green_deployment::CreateBlueGreenDeployment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_blue_green_deployment::CreateBlueGreenDeployment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_blue_green_deployment_input::ser_create_blue_green_deployment_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_blue_green_deployment::CreateBlueGreenDeployment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateBlueGreenDeployment", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBlueGreenDeployment {
                type Output = std::result::Result<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentOutput, crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError>;
