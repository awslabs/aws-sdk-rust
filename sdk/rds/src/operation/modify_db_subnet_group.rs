...
impl ModifyDbSubnetGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyDBSubnetGroup`](crate::operation::modify_db_subnet_group::ModifyDBSubnetGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_db_subnet_group::ModifyDBSubnetGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_db_subnet_group::ModifyDbSubnetGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_subnet_group::ModifyDBSubnetGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyDBSubnetGroup", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyDBSubnetGroup {
                type Output = std::result::Result<crate::operation::modify_db_subnet_group::ModifyDbSubnetGroupOutput, crate::operation::modify_db_subnet_group::ModifyDBSubnetGroupError>;
