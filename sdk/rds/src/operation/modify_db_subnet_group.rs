...
impl ModifyDbSubnetGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_db_subnet_group::ModifyDBSubnetGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyDBSubnetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_db_subnet_group::de_modify_db_subnet_group_http_response_with_props(status, headers, body)
        }
    }
}
