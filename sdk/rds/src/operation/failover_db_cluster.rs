...
impl FailoverDbClusterInput {
    /// Consumes the builder and constructs an Operation<[`FailoverDBCluster`](crate::operation::failover_db_cluster::FailoverDBCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::failover_db_cluster::FailoverDBCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::failover_db_cluster::FailoverDbClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::failover_db_cluster::FailoverDBCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("FailoverDBCluster", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for FailoverDBCluster {
                type Output = std::result::Result<crate::operation::failover_db_cluster::FailoverDbClusterOutput, crate::operation::failover_db_cluster::FailoverDBClusterError>;
