...
impl FailoverDBCluster {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::failover_db_cluster::FailoverDBClusterError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::failover_db_cluster::FailoverDbClusterOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "FailoverDBCluster", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.FailoverDBCluster",
                "rpc.service" = "RDS",
                "rpc.method" = "FailoverDBCluster",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for FailoverDBCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            FailoverDBClusterRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            FailoverDBClusterResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("FailoverDBCluster")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SensitiveOutput);
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("FailoverDBCluster", "RDS"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("FailoverDBCluster")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                FailoverDBClusterTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct FailoverDBClusterTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for FailoverDBClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<FailoverDbClusterInput>() else {
        ...
        if requested.should_capture("TargetDBInstanceIdentifier") {
            if let ::std::option::Option::Some(value) = input.target_db_instance_identifier.as_deref() {
                captured.insert("TargetDBInstanceIdentifier", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for FailoverDBClusterResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_failover_db_cluster::de_failover_db_cluster_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_failover_db_cluster::de_failover_db_cluster_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for FailoverDBClusterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::failover_db_cluster::FailoverDbClusterInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::failover_db_cluster::FailoverDbClusterInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_failover_db_cluster_input::ser_failover_db_cluster_input_input_input(&input)?,
        );
