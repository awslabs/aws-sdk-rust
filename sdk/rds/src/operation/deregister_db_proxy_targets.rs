...
impl DeregisterDbProxyTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterDBProxyTargets`](crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_db_proxy_targets_input::ser_deregister_db_proxy_targets_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargets::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeregisterDBProxyTargets", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterDBProxyTargets {
                type Output = std::result::Result<crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsOutput, crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError>;
