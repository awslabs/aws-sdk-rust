...
/// Orchestration and serialization glue logic for `DeregisterDBProxyTargets`.
...
impl DeregisterDBProxyTargets {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsInput,
                    ) -> ::std::result::Result<crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterDBProxyTargets {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeregisterDBProxyTargets");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeregisterDBProxyTargetsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeregisterDBProxyTargetsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterDBProxyTargets")
...
.with_interceptor(DeregisterDBProxyTargetsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterDBProxyTargetsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_deregister_db_proxy_targets::de_deregister_db_proxy_targets_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_deregister_db_proxy_targets::de_deregister_db_proxy_targets_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterDBProxyTargetsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deregister_db_proxy_targets_input::ser_deregister_db_proxy_targets_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeregisterDBProxyTargetsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterDBProxyTargetsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeregisterDBProxyTargetsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeregisterDbProxyTargetsInput>()
                        .ok_or("failed to downcast to DeregisterDbProxyTargetsInput")?;
...
pub enum DeregisterDBProxyTargetsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeregisterDBProxyTargetsError) for what information is available for the error.")]
...
impl DeregisterDBProxyTargetsError {
    /// Creates the `DeregisterDBProxyTargetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeregisterDBProxyTargetsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DbProxyTargetNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeregisterDBProxyTargetsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargetsError {
...
mod _deregister_db_proxy_targets_output;
