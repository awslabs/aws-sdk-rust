...
impl DeregisterDbProxyTargetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargets,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_db_proxy_targets::DeregisterDBProxyTargets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterDBProxyTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_db_proxy_targets::de_deregister_db_proxy_targets_http_response_with_props(status, headers, body)
        }
    }
}
