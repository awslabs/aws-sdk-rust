...
impl DeleteGlobalClusterInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGlobalCluster`](crate::operation::delete_global_cluster::DeleteGlobalCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_global_cluster::DeleteGlobalCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_global_cluster::DeleteGlobalClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_global_cluster::DeleteGlobalCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteGlobalCluster", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteGlobalCluster {
                type Output = std::result::Result<crate::operation::delete_global_cluster::DeleteGlobalClusterOutput, crate::operation::delete_global_cluster::DeleteGlobalClusterError>;
