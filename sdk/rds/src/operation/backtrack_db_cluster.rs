...
impl BacktrackDbClusterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::backtrack_db_cluster::BacktrackDBCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BacktrackDBCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_backtrack_db_cluster::de_backtrack_db_cluster_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::backtrack_db_cluster::BacktrackDBClusterError
{
