...
/// Orchestration and serialization glue logic for `BacktrackDBCluster`.
...
impl BacktrackDBCluster {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::backtrack_db_cluster::BacktrackDbClusterInput,
                    ) -> ::std::result::Result<crate::operation::backtrack_db_cluster::BacktrackDbClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::backtrack_db_cluster::BacktrackDBClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::backtrack_db_cluster::BacktrackDBClusterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::backtrack_db_cluster::BacktrackDbClusterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BacktrackDBCluster {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BacktrackDBCluster");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BacktrackDBClusterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BacktrackDBClusterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BacktrackDBCluster")
...
.with_interceptor(BacktrackDBClusterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::backtrack_db_cluster::BacktrackDBClusterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::backtrack_db_cluster::BacktrackDBClusterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::backtrack_db_cluster::BacktrackDBClusterError>::new());
...
#[derive(Debug)]
            struct BacktrackDBClusterResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BacktrackDBClusterResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_backtrack_db_cluster::de_backtrack_db_cluster_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_backtrack_db_cluster::de_backtrack_db_cluster_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BacktrackDBClusterRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BacktrackDBClusterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::backtrack_db_cluster::BacktrackDbClusterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::backtrack_db_cluster::BacktrackDbClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_backtrack_db_cluster_input::ser_backtrack_db_cluster_input_input_input(&input)?);
...
#[derive(Debug)]
            struct BacktrackDBClusterEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BacktrackDBClusterEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BacktrackDBClusterEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BacktrackDbClusterInput>()
                        .ok_or("failed to downcast to BacktrackDbClusterInput")?;
...
pub enum BacktrackDBClusterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BacktrackDBClusterError) for what information is available for the error.")]
...
impl BacktrackDBClusterError {
    /// Creates the `BacktrackDBClusterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BacktrackDBClusterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BacktrackDBClusterError {
...
impl ::aws_types::request_id::RequestId for crate::operation::backtrack_db_cluster::BacktrackDBClusterError {
...
mod _backtrack_db_cluster_output;
