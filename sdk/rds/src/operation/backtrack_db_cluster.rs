...
impl BacktrackDbClusterInput {
    /// Consumes the builder and constructs an Operation<[`BacktrackDBCluster`](crate::operation::backtrack_db_cluster::BacktrackDBCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::backtrack_db_cluster::BacktrackDBCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::backtrack_db_cluster::BacktrackDbClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_backtrack_db_cluster_input::ser_backtrack_db_cluster_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::backtrack_db_cluster::BacktrackDBCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BacktrackDBCluster", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for BacktrackDBCluster {
                type Output = std::result::Result<crate::operation::backtrack_db_cluster::BacktrackDbClusterOutput, crate::operation::backtrack_db_cluster::BacktrackDBClusterError>;
