...
impl StartActivityStreamInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_activity_stream::StartActivityStream::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StartActivityStream {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_start_activity_stream::de_start_activity_stream_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::start_activity_stream::StartActivityStreamError
{
