...
impl ModifyDbProxyInput {
    /// Consumes the builder and constructs an Operation<[`ModifyDBProxy`](crate::operation::modify_db_proxy::ModifyDBProxy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_db_proxy::ModifyDBProxy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_db_proxy::ModifyDbProxyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_db_proxy_input::ser_modify_db_proxy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_proxy::ModifyDBProxy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyDBProxy", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyDBProxy {
                type Output = std::result::Result<crate::operation::modify_db_proxy::ModifyDbProxyOutput, crate::operation::modify_db_proxy::ModifyDBProxyError>;
