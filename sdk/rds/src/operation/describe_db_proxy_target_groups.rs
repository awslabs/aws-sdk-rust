...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBProxyTargetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_proxy_target_groups::de_describe_db_proxy_target_groups_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeDBProxyTargetGroupsError
{
