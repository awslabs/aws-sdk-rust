...
/// Orchestration and serialization glue logic for `DescribeDBProxyTargetGroups`.
...
impl DescribeDBProxyTargetGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsInput,
                    ) -> ::std::result::Result<crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_proxy_target_groups::DescribeDBProxyTargetGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_db_proxy_target_groups::DescribeDBProxyTargetGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDBProxyTargetGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDBProxyTargetGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDBProxyTargetGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDBProxyTargetGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDBProxyTargetGroups")
...
.with_interceptor(DescribeDBProxyTargetGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_db_proxy_target_groups::DescribeDBProxyTargetGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_db_proxy_target_groups::DescribeDBProxyTargetGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_db_proxy_target_groups::DescribeDBProxyTargetGroupsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDBProxyTargetGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_db_proxy_target_groups::de_describe_db_proxy_target_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_db_proxy_target_groups::de_describe_db_proxy_target_groups_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDBProxyTargetGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_db_proxy_target_groups_input::ser_describe_db_proxy_target_groups_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDBProxyTargetGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDBProxyTargetGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDBProxyTargetGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDbProxyTargetGroupsInput>()
                        .ok_or("failed to downcast to DescribeDbProxyTargetGroupsInput")?;
...
pub enum DescribeDBProxyTargetGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDBProxyTargetGroupsError) for what information is available for the error.")]
...
impl DescribeDBProxyTargetGroupsError {
    /// Creates the `DescribeDBProxyTargetGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDBProxyTargetGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDBProxyTargetGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_db_proxy_target_groups::DescribeDBProxyTargetGroupsError {
...
mod _describe_db_proxy_target_groups_output;
