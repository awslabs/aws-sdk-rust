...
impl StopDbInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_db_instance::StopDBInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDBInstance {
    type Output =
        ::std::result::Result<crate::operation::stop_db_instance::StopDbInstanceOutput, crate::operation::stop_db_instance::StopDBInstanceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_db_instance::de_stop_db_instance_http_response_with_props(status, headers, body)
        }
    }
}
