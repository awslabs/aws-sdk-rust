...
impl DescribeDbLogFilesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBLogFiles`](crate::operation::describe_db_log_files::DescribeDBLogFiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_log_files::DescribeDBLogFiles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_log_files::DescribeDbLogFilesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_db_log_files_input::ser_describe_db_log_files_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_log_files::DescribeDBLogFiles::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBLogFiles", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBLogFiles {
                type Output = std::result::Result<crate::operation::describe_db_log_files::DescribeDbLogFilesOutput, crate::operation::describe_db_log_files::DescribeDBLogFilesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_db_log_files::de_describe_db_log_files_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_db_log_files::de_describe_db_log_files_http_response(response)
                     }
                }
            }
