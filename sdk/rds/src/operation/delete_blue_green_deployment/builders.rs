...
impl DeleteBlueGreenDeploymentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentOutput, crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentError, Self> {
