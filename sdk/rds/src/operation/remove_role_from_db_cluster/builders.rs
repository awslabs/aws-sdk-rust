...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterOutput,
                    crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError,
                > for RemoveRoleFromDBClusterFluentBuilder
            {
                fn send(
                    self,
...
impl RemoveRoleFromDBClusterFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::remove_role_from_db_cluster::builders::RemoveRoleFromDbClusterInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBCluster::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBCluster::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterOutput, crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError, Self> {
