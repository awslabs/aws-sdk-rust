...
impl PurchaseReservedDbInstancesOfferingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDbInstancesOfferingInput, ::aws_smithy_types::error::operation::BuildError> {
