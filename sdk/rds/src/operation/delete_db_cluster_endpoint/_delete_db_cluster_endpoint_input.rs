...
impl DeleteDbClusterEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointInput, ::aws_smithy_types::error::operation::BuildError> {
