...
impl StopActivityStreamInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_activity_stream::StopActivityStream::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopActivityStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_activity_stream::de_stop_activity_stream_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_activity_stream::StopActivityStreamError
{
