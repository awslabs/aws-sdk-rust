...
impl StopActivityStreamInput {
    /// Consumes the builder and constructs an Operation<[`StopActivityStream`](crate::operation::stop_activity_stream::StopActivityStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_activity_stream::StopActivityStream, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_activity_stream::StopActivityStreamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_activity_stream_input::ser_stop_activity_stream_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_activity_stream::StopActivityStream::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopActivityStream", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopActivityStream {
                type Output = std::result::Result<crate::operation::stop_activity_stream::StopActivityStreamOutput, crate::operation::stop_activity_stream::StopActivityStreamError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_stop_activity_stream::de_stop_activity_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_stop_activity_stream::de_stop_activity_stream_http_response(response)
                     }
                }
            }
