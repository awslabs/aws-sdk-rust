...
impl StartDBInstanceAutomatedBackupsReplication {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_db_instance_automated_backups_replication::StartDbInstanceAutomatedBackupsReplicationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "RDS",
            "rpc.method" = "StartDBInstanceAutomatedBackupsReplication",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDBInstanceAutomatedBackupsReplication {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartDBInstanceAutomatedBackupsReplicationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartDBInstanceAutomatedBackupsReplicationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartDBInstanceAutomatedBackupsReplication")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDBInstanceAutomatedBackupsReplication")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    StartDBInstanceAutomatedBackupsReplicationTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartDBInstanceAutomatedBackupsReplicationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartDBInstanceAutomatedBackupsReplicationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartDbInstanceAutomatedBackupsReplicationInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("SourceDBInstanceArn") {
            if let ::std::option::Option::Some(value) = input.source_db_instance_arn.as_deref() {
                captured.insert("SourceDBInstanceArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartDBInstanceAutomatedBackupsReplicationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_db_instance_automated_backups_replication::de_start_db_instance_automated_backups_replication_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_db_instance_automated_backups_replication::de_start_db_instance_automated_backups_replication_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartDBInstanceAutomatedBackupsReplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_db_instance_automated_backups_replication::StartDbInstanceAutomatedBackupsReplicationInput>()
            .expect("correct type");
...
impl ::aws_types::request_id::RequestId
    for crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError
{
