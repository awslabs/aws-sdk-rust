...
impl StartDBInstanceAutomatedBackupsReplication {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_db_instance_automated_backups_replication::StartDbInstanceAutomatedBackupsReplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_db_instance_automated_backups_replication::StartDbInstanceAutomatedBackupsReplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDBInstanceAutomatedBackupsReplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartDBInstanceAutomatedBackupsReplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartDBInstanceAutomatedBackupsReplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartDBInstanceAutomatedBackupsReplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDBInstanceAutomatedBackupsReplication")
...
.with_interceptor(StartDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_db_instance_automated_backups_replication::de_start_db_instance_automated_backups_replication_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_db_instance_automated_backups_replication::de_start_db_instance_automated_backups_replication_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartDBInstanceAutomatedBackupsReplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_db_instance_automated_backups_replication::StartDbInstanceAutomatedBackupsReplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_db_instance_automated_backups_replication::StartDbInstanceAutomatedBackupsReplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_db_instance_automated_backups_replication_input::ser_start_db_instance_automated_backups_replication_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartDbInstanceAutomatedBackupsReplicationInput>()
                        .ok_or("failed to downcast to StartDbInstanceAutomatedBackupsReplicationInput")?;
...
pub enum StartDBInstanceAutomatedBackupsReplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartDBInstanceAutomatedBackupsReplicationError) for what information is available for the error.")]
...
impl StartDBInstanceAutomatedBackupsReplicationError {
    /// Creates the `StartDBInstanceAutomatedBackupsReplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartDBInstanceAutomatedBackupsReplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartDBInstanceAutomatedBackupsReplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_db_instance_automated_backups_replication::StartDBInstanceAutomatedBackupsReplicationError {
