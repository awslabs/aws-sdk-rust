...
impl ::aws_smithy_http::response::ParseStrictResponse
    for StartDBInstanceAutomatedBackupsReplication
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_db_instance_automated_backups_replication::de_start_db_instance_automated_backups_replication_http_response_with_props(status, headers, body)
        }
    }
}
