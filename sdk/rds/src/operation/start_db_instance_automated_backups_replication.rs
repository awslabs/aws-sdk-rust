...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for StartDBInstanceAutomatedBackupsReplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_db_instance_automated_backups_replication_input::ser_start_db_instance_automated_backups_replication_input_input(&input)?);
