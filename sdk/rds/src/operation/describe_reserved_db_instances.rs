...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedDBInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_db_instances::de_describe_reserved_db_instances_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeReservedDBInstancesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_reserved_db_instances::DescribeReservedDBInstancesError
{
