...
impl DescribeReservedDbInstancesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_reserved_db_instances::DescribeReservedDBInstances,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_reserved_db_instances::DescribeReservedDBInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedDBInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_db_instances::de_describe_reserved_db_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
