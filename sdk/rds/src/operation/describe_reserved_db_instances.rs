...
impl DescribeReservedDbInstancesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReservedDBInstances`](crate::operation::describe_reserved_db_instances::DescribeReservedDBInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_reserved_db_instances::DescribeReservedDBInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_reserved_db_instances::DescribeReservedDbInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_reserved_db_instances_input::ser_describe_reserved_db_instances_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_reserved_db_instances::DescribeReservedDBInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeReservedDBInstances", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReservedDBInstances {
                type Output = std::result::Result<crate::operation::describe_reserved_db_instances::DescribeReservedDbInstancesOutput, crate::operation::describe_reserved_db_instances::DescribeReservedDBInstancesError>;
