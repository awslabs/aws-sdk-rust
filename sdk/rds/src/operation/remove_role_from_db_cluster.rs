...
/// Orchestration and serialization glue logic for `RemoveRoleFromDBCluster`.
...
impl RemoveRoleFromDBCluster {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterInput,
                    ) -> ::std::result::Result<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveRoleFromDBCluster {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveRoleFromDBCluster");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveRoleFromDBClusterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveRoleFromDBClusterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveRoleFromDBCluster")
...
.with_interceptor(RemoveRoleFromDBClusterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError>::new());
...
#[derive(Debug)]
            struct RemoveRoleFromDBClusterResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveRoleFromDBClusterResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_role_from_db_cluster::de_remove_role_from_db_cluster_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_remove_role_from_db_cluster::de_remove_role_from_db_cluster_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveRoleFromDBClusterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_role_from_db_cluster_input::ser_remove_role_from_db_cluster_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RemoveRoleFromDBClusterEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveRoleFromDBClusterEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveRoleFromDBClusterEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveRoleFromDbClusterInput>()
                        .ok_or("failed to downcast to RemoveRoleFromDbClusterInput")?;
...
pub enum RemoveRoleFromDBClusterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveRoleFromDBClusterError) for what information is available for the error.")]
...
impl RemoveRoleFromDBClusterError {
    /// Creates the `RemoveRoleFromDBClusterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveRoleFromDBClusterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DbClusterRoleNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveRoleFromDBClusterError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError {
...
mod _remove_role_from_db_cluster_output;
