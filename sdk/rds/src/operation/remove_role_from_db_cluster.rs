...
impl RemoveRoleFromDbClusterInput {
    /// Consumes the builder and constructs an Operation<[`RemoveRoleFromDBCluster`](crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RemoveRoleFromDBCluster", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveRoleFromDBCluster {
                type Output = std::result::Result<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterOutput, crate::operation::remove_role_from_db_cluster::RemoveRoleFromDBClusterError>;
