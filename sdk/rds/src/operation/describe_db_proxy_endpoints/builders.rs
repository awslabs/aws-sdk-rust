...
impl DescribeDBProxyEndpointsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_db_proxy_endpoints::DescribeDbProxyEndpointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_proxy_endpoints::DescribeDBProxyEndpointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_db_proxy_endpoints::DescribeDbProxyEndpointsOutput, crate::operation::describe_db_proxy_endpoints::DescribeDBProxyEndpointsError, Self> {
