...
impl RestoreDBClusterFromS3 {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "RestoreDBClusterFromS3", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.RestoreDBClusterFromS3",
                "rpc.service" = "RDS",
                "rpc.method" = "RestoreDBClusterFromS3",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RestoreDBClusterFromS3")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreDBClusterFromS3")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RestoreDBClusterFromS3TelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RestoreDBClusterFromS3TelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreDBClusterFromS3TelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RestoreDbClusterFromS3Input>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreDBClusterFromS3ResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_restore_db_cluster_from_s3::de_restore_db_cluster_from_s3_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_restore_db_cluster_from_s3::de_restore_db_cluster_from_s3_http_response(status, headers, body, _cfg)
        };
...
impl RestoreDBClusterFromS3Error {
    ...
    /// Returns `true` if the error kind is `RestoreDBClusterFromS3Error::DbClusterRoleQuotaExceededFault`.
    ...
    /// Returns `true` if the error kind is `RestoreDBClusterFromS3Error::NetworkTypeNotSupported`.
