...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBInstanceAutomatedBackups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_instance_automated_backups::de_describe_db_instance_automated_backups_http_response_with_props(status, headers, body)
        }
    }
}
