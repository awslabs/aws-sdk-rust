...
impl RemoveFromGlobalClusterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_from_global_cluster::RemoveFromGlobalCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveFromGlobalCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_from_global_cluster::de_remove_from_global_cluster_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError
{
