...
impl StartDbInstanceInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::start_db_instance::StartDBInstance,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_db_instance::StartDBInstance::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StartDBInstance {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_db_instance::de_start_db_instance_http_error(
                status, headers, body,
            )
        } else {
