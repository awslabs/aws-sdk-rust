...
impl StartDbInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_db_instance::StartDBInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDBInstance {
    type Output =
        ::std::result::Result<crate::operation::start_db_instance::StartDbInstanceOutput, crate::operation::start_db_instance::StartDBInstanceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_db_instance::de_start_db_instance_http_response_with_props(status, headers, body)
        }
    }
}
