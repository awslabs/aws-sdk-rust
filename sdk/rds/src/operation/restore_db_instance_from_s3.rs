...
impl RestoreDBInstanceFromS3 {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "RestoreDBInstanceFromS3", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.RestoreDBInstanceFromS3",
                "rpc.service" = "RDS",
                "rpc.method" = "RestoreDBInstanceFromS3",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RestoreDBInstanceFromS3")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreDBInstanceFromS3")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RestoreDBInstanceFromS3TelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RestoreDBInstanceFromS3TelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreDBInstanceFromS3TelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RestoreDbInstanceFromS3Input>() else {
        ...
        if requested.should_capture("SourceEngine") {
            if let ::std::option::Option::Some(value) = input.source_engine.as_deref() {
                captured.insert("SourceEngine", value);
            }
        }
        if requested.should_capture("SourceEngineVersion") {
            if let ::std::option::Option::Some(value) = input.source_engine_version.as_deref() {
                captured.insert("SourceEngineVersion", value);
            }
        }
        ...
        if requested.should_capture("S3IngestionRoleArn") {
            if let ::std::option::Option::Some(value) = input.s3_ingestion_role_arn.as_deref() {
                captured.insert("S3IngestionRoleArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreDBInstanceFromS3ResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_restore_db_instance_from_s3::de_restore_db_instance_from_s3_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_restore_db_instance_from_s3::de_restore_db_instance_from_s3_http_response(status, headers, body, _cfg)
        };
...
impl RestoreDBInstanceFromS3Error {
    ...
    /// Returns `true` if the error kind is `RestoreDBInstanceFromS3Error::VpcEncryptionControlViolationException`.
