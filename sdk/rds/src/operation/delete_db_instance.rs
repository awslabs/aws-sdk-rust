...
impl DeleteDbInstanceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_db_instance::DeleteDBInstance::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDBInstance", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_db_instance::de_delete_db_instance_http_response_with_props(status, headers, body)
        }
    }
}
