...
impl DeleteDBInstanceAutomatedBackup {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteDBInstanceAutomatedBackupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteDBInstanceAutomatedBackupRequestSerializer {
