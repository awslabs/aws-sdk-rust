...
impl DeleteDBInstanceAutomatedBackup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupInput,
                    ) -> ::std::result::Result<crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDBInstanceAutomatedBackup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDBInstanceAutomatedBackup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDBInstanceAutomatedBackupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDBInstanceAutomatedBackupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDBInstanceAutomatedBackup")
...
.with_interceptor(DeleteDBInstanceAutomatedBackupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackupError>::new());
...
#[derive(Debug)]
            struct DeleteDBInstanceAutomatedBackupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDBInstanceAutomatedBackupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_db_instance_automated_backup::de_delete_db_instance_automated_backup_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteDBInstanceAutomatedBackupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDBInstanceAutomatedBackupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_db_instance_automated_backup_input::ser_delete_db_instance_automated_backup_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteDBInstanceAutomatedBackupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDBInstanceAutomatedBackupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteDBInstanceAutomatedBackupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteDbInstanceAutomatedBackupInput>()
                        .ok_or("failed to downcast to DeleteDbInstanceAutomatedBackupInput")?;
...
pub enum DeleteDBInstanceAutomatedBackupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDBInstanceAutomatedBackupError) for what information is available for the error.")]
...
impl DeleteDBInstanceAutomatedBackupError {
    /// Creates the `DeleteDBInstanceAutomatedBackupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDBInstanceAutomatedBackupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteDBInstanceAutomatedBackupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDBInstanceAutomatedBackupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_db_instance_automated_backup::_delete_db_instance_automated_backup_output::DeleteDbInstanceAutomatedBackupOutput;

pub use crate::operation::delete_db_instance_automated_backup::_delete_db_instance_automated_backup_input::DeleteDbInstanceAutomatedBackupInput;

mod _delete_db_instance_automated_backup_input;

mod _delete_db_instance_automated_backup_output;
