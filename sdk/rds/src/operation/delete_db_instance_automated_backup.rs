...
impl DeleteDbInstanceAutomatedBackupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_db_instance_automated_backup::DeleteDBInstanceAutomatedBackup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBInstanceAutomatedBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_db_instance_automated_backup::de_delete_db_instance_automated_backup_http_response_with_props(
                status, headers, body,
            )
        }
    }
