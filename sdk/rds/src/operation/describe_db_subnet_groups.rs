...
impl DescribeDbSubnetGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBSubnetGroups`](crate::operation::describe_db_subnet_groups::DescribeDBSubnetGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_subnet_groups::DescribeDBSubnetGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_subnet_groups::DescribeDbSubnetGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_subnet_groups::DescribeDBSubnetGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBSubnetGroups", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBSubnetGroups {
                type Output = std::result::Result<crate::operation::describe_db_subnet_groups::DescribeDbSubnetGroupsOutput, crate::operation::describe_db_subnet_groups::DescribeDBSubnetGroupsError>;
