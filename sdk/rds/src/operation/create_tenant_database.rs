...
/// Orchestration and serialization glue logic for `CreateTenantDatabase`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateTenantDatabase;
impl CreateTenantDatabase {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_tenant_database::CreateTenantDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_tenant_database::CreateTenantDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_tenant_database::CreateTenantDatabaseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_tenant_database::CreateTenantDatabaseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTenantDatabase {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateTenantDatabase");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateTenantDatabaseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateTenantDatabaseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTenantDatabase")
...
.with_interceptor(CreateTenantDatabaseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_tenant_database::CreateTenantDatabaseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_tenant_database::CreateTenantDatabaseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_tenant_database::CreateTenantDatabaseError>::new());
...
#[derive(Debug)]
            struct CreateTenantDatabaseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTenantDatabaseResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_tenant_database::de_create_tenant_database_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_tenant_database::de_create_tenant_database_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateTenantDatabaseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTenantDatabaseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_tenant_database::CreateTenantDatabaseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_tenant_database::CreateTenantDatabaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_tenant_database_input::ser_create_tenant_database_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateTenantDatabaseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTenantDatabaseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateTenantDatabaseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateTenantDatabaseInput>()
                        .ok_or("failed to downcast to CreateTenantDatabaseInput")?;
...
/// Error type for the `CreateTenantDatabaseError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateTenantDatabaseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateTenantDatabaseError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateTenantDatabaseError {
    /// Creates the `CreateTenantDatabaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTenantDatabaseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateTenantDatabaseError::DbInstanceNotFoundFault`.
    pub fn is_db_instance_not_found_fault(&self) -> bool {
        matches!(self, Self::DbInstanceNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `CreateTenantDatabaseError::InvalidDbInstanceStateFault`.
    pub fn is_invalid_db_instance_state_fault(&self) -> bool {
        matches!(self, Self::InvalidDbInstanceStateFault(_))
    }
    /// Returns `true` if the error kind is `CreateTenantDatabaseError::TenantDatabaseAlreadyExistsFault`.
    pub fn is_tenant_database_already_exists_fault(&self) -> bool {
        matches!(self, Self::TenantDatabaseAlreadyExistsFault(_))
    }
    /// Returns `true` if the error kind is `CreateTenantDatabaseError::TenantDatabaseQuotaExceededFault`.
    pub fn is_tenant_database_quota_exceeded_fault(&self) -> bool {
        matches!(self, Self::TenantDatabaseQuotaExceededFault(_))
    }
}
impl ::std::error::Error for CreateTenantDatabaseError {
...
impl ::std::fmt::Display for CreateTenantDatabaseError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateTenantDatabaseError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTenantDatabaseError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateTenantDatabaseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_tenant_database::CreateTenantDatabaseError {
...
mod _create_tenant_database_output;
