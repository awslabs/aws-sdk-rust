...
impl DescribeDbParametersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBParameters`](crate::operation::describe_db_parameters::DescribeDBParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_parameters::DescribeDBParameters, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_parameters::DescribeDbParametersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_parameters::DescribeDBParameters::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBParameters", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBParameters {
                type Output = std::result::Result<crate::operation::describe_db_parameters::DescribeDbParametersOutput, crate::operation::describe_db_parameters::DescribeDBParametersError>;
