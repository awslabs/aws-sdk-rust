...
impl ModifyDbSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_db_snapshot::ModifyDBSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyDBSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_modify_db_snapshot::de_modify_db_snapshot_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_db_snapshot::ModifyDBSnapshotError
{
