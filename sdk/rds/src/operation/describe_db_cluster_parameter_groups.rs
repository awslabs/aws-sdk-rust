...
impl DescribeDbClusterParameterGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_db_cluster_parameter_groups::DescribeDBClusterParameterGroups,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_db_cluster_parameter_groups::DescribeDBClusterParameterGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterParameterGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_cluster_parameter_groups::de_describe_db_cluster_parameter_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
