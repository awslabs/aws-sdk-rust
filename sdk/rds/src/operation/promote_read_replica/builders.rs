...
impl PromoteReadReplicaFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::promote_read_replica::PromoteReadReplicaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::promote_read_replica::PromoteReadReplicaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::promote_read_replica::PromoteReadReplicaOutput, crate::operation::promote_read_replica::PromoteReadReplicaError, Self> {
