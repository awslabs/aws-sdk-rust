...
impl CreateTenantDatabaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_tenant_database::CreateTenantDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_tenant_database::CreateTenantDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_tenant_database::CreateTenantDatabaseOutput, crate::operation::create_tenant_database::CreateTenantDatabaseError, Self> {
