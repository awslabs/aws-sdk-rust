...
impl DescribeDbProxyEndpointsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_db_proxy_endpoints::DescribeDBProxyEndpoints::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBProxyEndpoints {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_db_proxy_endpoints::de_describe_db_proxy_endpoints_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_db_proxy_endpoints::de_describe_db_proxy_endpoints_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_db_proxy_endpoints::DescribeDBProxyEndpointsError
{
