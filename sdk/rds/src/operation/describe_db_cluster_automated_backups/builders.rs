...
impl DescribeDBClusterAutomatedBackupsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::describe_db_cluster_automated_backups::DescribeDBClusterAutomatedBackupsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::describe_db_cluster_automated_backups::paginator::DescribeDbClusterAutomatedBackupsPaginator::send) which returns a `Stream`.
