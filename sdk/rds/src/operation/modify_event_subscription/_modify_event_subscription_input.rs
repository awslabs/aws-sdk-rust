...
impl ModifyEventSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_event_subscription::ModifyEventSubscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
