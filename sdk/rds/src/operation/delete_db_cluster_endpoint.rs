...
impl DeleteDbClusterEndpointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDBClusterEndpoint`](crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDBClusterEndpoint", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDBClusterEndpoint {
                type Output = std::result::Result<crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput, crate::operation::delete_db_cluster_endpoint::DeleteDBClusterEndpointError>;
