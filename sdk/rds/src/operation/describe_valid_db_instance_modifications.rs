...
impl DescribeValidDbInstanceModificationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeValidDBInstanceModifications`](crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModifications, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModifications::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeValidDBInstanceModifications", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeValidDBInstanceModifications {
    type Output = ::std::result::Result<crate::operation::describe_valid_db_instance_modifications::DescribeValidDbInstanceModificationsOutput, crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModificationsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_valid_db_instance_modifications::de_describe_valid_db_instance_modifications_http_response_with_props(status, headers, body)
        }
    }
}
