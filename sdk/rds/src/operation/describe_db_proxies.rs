...
impl DescribeDbProxiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_db_proxies::DescribeDBProxies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBProxies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_db_proxies::de_describe_db_proxies_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_db_proxies::DescribeDBProxiesError
{
