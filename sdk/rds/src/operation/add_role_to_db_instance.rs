...
/// Orchestration and serialization glue logic for `AddRoleToDBInstance`.
...
impl AddRoleToDBInstance {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::add_role_to_db_instance::AddRoleToDbInstanceInput,
                    ) -> ::std::result::Result<crate::operation::add_role_to_db_instance::AddRoleToDbInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_role_to_db_instance::AddRoleToDbInstanceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddRoleToDBInstance {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddRoleToDBInstance");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddRoleToDBInstanceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddRoleToDBInstanceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddRoleToDBInstance")
...
.with_interceptor(AddRoleToDBInstanceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError>::new());
...
#[derive(Debug)]
            struct AddRoleToDBInstanceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddRoleToDBInstanceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_add_role_to_db_instance::de_add_role_to_db_instance_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AddRoleToDBInstanceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddRoleToDBInstanceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_role_to_db_instance::AddRoleToDbInstanceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_role_to_db_instance::AddRoleToDbInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_role_to_db_instance_input::ser_add_role_to_db_instance_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AddRoleToDBInstanceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddRoleToDBInstanceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddRoleToDBInstanceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddRoleToDbInstanceInput>()
                        .ok_or("failed to downcast to AddRoleToDbInstanceInput")?;
...
pub enum AddRoleToDBInstanceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddRoleToDBInstanceError) for what information is available for the error.")]
...
impl AddRoleToDBInstanceError {
    /// Creates the `AddRoleToDBInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddRoleToDBInstanceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DbInstanceRoleAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::DbInstanceRoleQuotaExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddRoleToDBInstanceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError {
...
mod _add_role_to_db_instance_output;
