...
impl AddRoleToDbInstanceInput {
    /// Consumes the builder and constructs an Operation<[`AddRoleToDBInstance`](crate::operation::add_role_to_db_instance::AddRoleToDBInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_role_to_db_instance::AddRoleToDBInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_role_to_db_instance::AddRoleToDbInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_role_to_db_instance_input::ser_add_role_to_db_instance_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_role_to_db_instance::AddRoleToDBInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddRoleToDBInstance", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for AddRoleToDBInstance {
                type Output = std::result::Result<crate::operation::add_role_to_db_instance::AddRoleToDbInstanceOutput, crate::operation::add_role_to_db_instance::AddRoleToDBInstanceError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_add_role_to_db_instance::de_add_role_to_db_instance_http_error(response)
                     } else {
                        crate::protocol_serde::shape_add_role_to_db_instance::de_add_role_to_db_instance_http_response(response)
                     }
                }
            }
