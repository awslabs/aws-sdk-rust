...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterBacktracks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_cluster_backtracks::de_describe_db_cluster_backtracks_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeDBClusterBacktracksError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError
{
