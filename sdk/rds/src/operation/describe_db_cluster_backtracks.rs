...
impl DescribeDbClusterBacktracksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBClusterBacktracks`](crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_db_cluster_backtracks_input::ser_describe_db_cluster_backtracks_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBClusterBacktracks", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterBacktracks {
                type Output = std::result::Result<crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksOutput, crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError>;
