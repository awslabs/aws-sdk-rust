...
/// Orchestration and serialization glue logic for `DescribeDBClusterBacktracks`.
...
impl DescribeDBClusterBacktracks {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksInput,
                    ) -> ::std::result::Result<crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDBClusterBacktracks {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDBClusterBacktracks");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDBClusterBacktracksRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDBClusterBacktracksResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDBClusterBacktracks")
...
.with_interceptor(DescribeDBClusterBacktracksEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError>::new());
...
#[derive(Debug)]
            struct DescribeDBClusterBacktracksResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDBClusterBacktracksResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_db_cluster_backtracks::de_describe_db_cluster_backtracks_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_db_cluster_backtracks::de_describe_db_cluster_backtracks_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDBClusterBacktracksRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDBClusterBacktracksRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_db_cluster_backtracks_input::ser_describe_db_cluster_backtracks_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDBClusterBacktracksEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDBClusterBacktracksEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDBClusterBacktracksEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDbClusterBacktracksInput>()
                        .ok_or("failed to downcast to DescribeDbClusterBacktracksInput")?;
...
pub enum DescribeDBClusterBacktracksError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDBClusterBacktracksError) for what information is available for the error.")]
...
impl DescribeDBClusterBacktracksError {
    /// Creates the `DescribeDBClusterBacktracksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDBClusterBacktracksError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DbClusterBacktrackNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDBClusterBacktracksError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_db_cluster_backtracks::DescribeDBClusterBacktracksError {
...
mod _describe_db_cluster_backtracks_output;
