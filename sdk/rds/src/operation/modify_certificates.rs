...
impl ModifyCertificatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_certificates::ModifyCertificates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_modify_certificates::de_modify_certificates_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_certificates::ModifyCertificatesError
{
