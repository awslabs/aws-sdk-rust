...
impl ResetDbParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`ResetDBParameterGroup`](crate::operation::reset_db_parameter_group::ResetDBParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_db_parameter_group::ResetDBParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_db_parameter_group::ResetDbParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_db_parameter_group::ResetDBParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResetDBParameterGroup", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResetDBParameterGroup {
                type Output = std::result::Result<crate::operation::reset_db_parameter_group::ResetDbParameterGroupOutput, crate::operation::reset_db_parameter_group::ResetDBParameterGroupError>;
