...
/// Orchestration and serialization glue logic for `ModifyDBShardGroup`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ModifyDBShardGroup;
impl ModifyDBShardGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_db_shard_group::ModifyDbShardGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_db_shard_group::ModifyDBShardGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_db_shard_group::ModifyDBShardGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_db_shard_group::ModifyDbShardGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyDBShardGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyDBShardGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyDBShardGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyDBShardGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDBShardGroup")
...
.with_interceptor(ModifyDBShardGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_db_shard_group::ModifyDBShardGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_db_shard_group::ModifyDBShardGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_db_shard_group::ModifyDBShardGroupError>::new());
...
#[derive(Debug)]
            struct ModifyDBShardGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyDBShardGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_db_shard_group::de_modify_db_shard_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_db_shard_group::de_modify_db_shard_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyDBShardGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyDBShardGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_db_shard_group::ModifyDbShardGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_db_shard_group::ModifyDbShardGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_db_shard_group_input::ser_modify_db_shard_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyDBShardGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDBShardGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyDBShardGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyDbShardGroupInput>()
                        .ok_or("failed to downcast to ModifyDbShardGroupInput")?;
...
/// Error type for the `ModifyDBShardGroupError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ModifyDBShardGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyDBShardGroupError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ModifyDBShardGroupError {
    /// Creates the `ModifyDBShardGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyDBShardGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ModifyDBShardGroupError::DbShardGroupAlreadyExistsFault`.
    pub fn is_db_shard_group_already_exists_fault(&self) -> bool {
        matches!(self, Self::DbShardGroupAlreadyExistsFault(_))
    }
    /// Returns `true` if the error kind is `ModifyDBShardGroupError::DbShardGroupNotFoundFault`.
    pub fn is_db_shard_group_not_found_fault(&self) -> bool {
        matches!(self, Self::DbShardGroupNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `ModifyDBShardGroupError::InvalidDbClusterStateFault`.
...
impl ::std::error::Error for ModifyDBShardGroupError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::DbShardGroupAlreadyExistsFault(_inner) =>
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::InvalidMaxAcuFault(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for ModifyDBShardGroupError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ModifyDBShardGroupError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyDBShardGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyDBShardGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_db_shard_group::ModifyDBShardGroupError {
...
mod _modify_db_shard_group_output;
