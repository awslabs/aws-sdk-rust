...
impl CreateDbProxyEndpointInput {
    /// Consumes the builder and constructs an Operation<[`CreateDBProxyEndpoint`](crate::operation::create_db_proxy_endpoint::CreateDBProxyEndpoint)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_db_proxy_endpoint_input::ser_create_db_proxy_endpoint_input_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_db_proxy_endpoint::CreateDBProxyEndpoint::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDBProxyEndpoint", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDBProxyEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_db_proxy_endpoint::de_create_db_proxy_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
