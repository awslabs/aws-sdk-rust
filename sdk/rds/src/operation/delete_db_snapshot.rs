...
impl DeleteDbSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_db_snapshot::DeleteDBSnapshot,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_db_snapshot::de_delete_db_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
