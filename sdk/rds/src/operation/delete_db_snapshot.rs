...
impl DeleteDbSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_db_snapshot::DeleteDBSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_db_snapshot::de_delete_db_snapshot_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_db_snapshot::DeleteDBSnapshotError
{
