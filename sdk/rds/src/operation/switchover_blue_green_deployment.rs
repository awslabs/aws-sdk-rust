...
impl SwitchoverBlueGreenDeploymentInput {
    /// Consumes the builder and constructs an Operation<[`SwitchoverBlueGreenDeployment`](crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeployment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeployment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeploymentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_switchover_blue_green_deployment_input::ser_switchover_blue_green_deployment_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeployment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SwitchoverBlueGreenDeployment", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for SwitchoverBlueGreenDeployment {
                type Output = std::result::Result<crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeploymentOutput, crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeploymentError>;
