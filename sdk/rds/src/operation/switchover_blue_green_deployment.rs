...
impl ::aws_smithy_http::response::ParseStrictResponse for SwitchoverBlueGreenDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_switchover_blue_green_deployment::de_switchover_blue_green_deployment_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeploymentError
{
