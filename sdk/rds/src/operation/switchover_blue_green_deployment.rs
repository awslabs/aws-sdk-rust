...
impl SwitchoverBlueGreenDeploymentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::switchover_blue_green_deployment::SwitchoverBlueGreenDeployment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SwitchoverBlueGreenDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_switchover_blue_green_deployment::de_switchover_blue_green_deployment_http_response_with_props(
                status, headers, body,
            )
        }
    }
