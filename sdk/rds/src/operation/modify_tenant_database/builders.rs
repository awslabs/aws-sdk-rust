...
impl ModifyTenantDatabaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_tenant_database::ModifyTenantDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_tenant_database::ModifyTenantDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_tenant_database::ModifyTenantDatabaseOutput, crate::operation::modify_tenant_database::ModifyTenantDatabaseError, Self> {
