...
impl CreateDbParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateDBParameterGroup`](crate::operation::create_db_parameter_group::CreateDBParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_db_parameter_group::CreateDBParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_db_parameter_group::CreateDbParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_db_parameter_group::CreateDBParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDBParameterGroup", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDBParameterGroup {
                type Output = std::result::Result<crate::operation::create_db_parameter_group::CreateDbParameterGroupOutput, crate::operation::create_db_parameter_group::CreateDBParameterGroupError>;
