...
impl ListTagsForResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("rds", "ListTagsForResource", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTagsForResource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListTagsForResource", "rds"));
...
impl ListTagsForResourceError {
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::DbSnapshotTenantDatabaseNotFoundFault`.
    pub fn is_db_snapshot_tenant_database_not_found_fault(&self) -> bool {
        matches!(self, Self::DbSnapshotTenantDatabaseNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `ListTagsForResourceError::IntegrationNotFoundFault`.
    pub fn is_integration_not_found_fault(&self) -> bool {
        matches!(self, Self::IntegrationNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `ListTagsForResourceError::TenantDatabaseNotFoundFault`.
