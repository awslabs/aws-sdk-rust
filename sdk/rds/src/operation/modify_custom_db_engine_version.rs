...
impl ModifyCustomDbEngineVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyCustomDBEngineVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_custom_db_engine_version::de_modify_custom_db_engine_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
