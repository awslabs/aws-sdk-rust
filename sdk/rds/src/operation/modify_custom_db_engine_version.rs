...
impl ModifyCustomDbEngineVersionInput {
    /// Consumes the builder and constructs an Operation<[`ModifyCustomDBEngineVersion`](crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_custom_db_engine_version::ModifyCustomDbEngineVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_custom_db_engine_version_input::ser_modify_custom_db_engine_version_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyCustomDBEngineVersion", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyCustomDBEngineVersion {
                type Output = std::result::Result<crate::operation::modify_custom_db_engine_version::ModifyCustomDbEngineVersionOutput, crate::operation::modify_custom_db_engine_version::ModifyCustomDBEngineVersionError>;
