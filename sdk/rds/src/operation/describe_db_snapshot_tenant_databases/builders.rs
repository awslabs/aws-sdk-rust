...
impl DescribeDBSnapshotTenantDatabasesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_db_snapshot_tenant_databases::DescribeDbSnapshotTenantDatabasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_snapshot_tenant_databases::DescribeDBSnapshotTenantDatabasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_db_snapshot_tenant_databases::DescribeDbSnapshotTenantDatabasesOutput, crate::operation::describe_db_snapshot_tenant_databases::DescribeDBSnapshotTenantDatabasesError, Self> {
