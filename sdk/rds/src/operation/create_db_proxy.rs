...
impl CreateDbProxyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_db_proxy_input::ser_create_db_proxy_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_db_proxy::CreateDBProxy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDBProxy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_db_proxy::de_create_db_proxy_http_error(
                status, headers, body,
            )
        } else {
