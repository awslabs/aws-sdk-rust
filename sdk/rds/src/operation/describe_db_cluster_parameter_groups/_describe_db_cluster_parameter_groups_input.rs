...
impl DescribeDbClusterParameterGroupsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_db_cluster_parameter_groups::DescribeDbClusterParameterGroupsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
