...
impl DescribeDbClusterParameterGroupsPaginator {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::describe_db_cluster_parameter_groups::DescribeDBClusterParameterGroups::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_db_cluster_parameter_groups::DescribeDBClusterParameterGroups::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_db_cluster_parameter_groups_output_output_marker(resp);
...
impl DescribeDbClusterParameterGroupsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_db_cluster_parameter_groups_output_output_db_cluster_parameter_groups(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
