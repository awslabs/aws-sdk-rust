...
impl SwitchoverReadReplica {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::switchover_read_replica::SwitchoverReadReplicaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::switchover_read_replica::SwitchoverReadReplicaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::switchover_read_replica::SwitchoverReadReplicaError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::switchover_read_replica::SwitchoverReadReplicaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SwitchoverReadReplica {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SwitchoverReadReplica");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SwitchoverReadReplicaRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SwitchoverReadReplicaResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SwitchoverReadReplica")
...
.with_interceptor(SwitchoverReadReplicaEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::switchover_read_replica::SwitchoverReadReplicaError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::switchover_read_replica::SwitchoverReadReplicaError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::switchover_read_replica::SwitchoverReadReplicaError>::new());
...
#[derive(Debug)]
            struct SwitchoverReadReplicaResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SwitchoverReadReplicaResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_switchover_read_replica::de_switchover_read_replica_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SwitchoverReadReplicaRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SwitchoverReadReplicaRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::switchover_read_replica::SwitchoverReadReplicaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::switchover_read_replica::SwitchoverReadReplicaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_switchover_read_replica_input::ser_switchover_read_replica_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SwitchoverReadReplicaEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SwitchoverReadReplicaEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SwitchoverReadReplicaEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SwitchoverReadReplicaInput>()
                        .ok_or("failed to downcast to SwitchoverReadReplicaInput")?;
...
pub enum SwitchoverReadReplicaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SwitchoverReadReplicaError) for what information is available for the error.")]
...
impl SwitchoverReadReplicaError {
    /// Creates the `SwitchoverReadReplicaError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SwitchoverReadReplicaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SwitchoverReadReplicaError {
...
impl ::aws_types::request_id::RequestId for crate::operation::switchover_read_replica::SwitchoverReadReplicaError {
