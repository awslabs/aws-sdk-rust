...
impl SwitchoverReadReplicaInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::switchover_read_replica::SwitchoverReadReplica::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for SwitchoverReadReplica {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_switchover_read_replica::de_switchover_read_replica_http_error(response)
        } else {
            crate::protocol_serde::shape_switchover_read_replica::de_switchover_read_replica_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::switchover_read_replica::SwitchoverReadReplicaError
{
