...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for RemoveSourceIdentifierFromSubscriptionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for RemoveSourceIdentifierFromSubscriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_source_identifier_from_subscription_input::ser_remove_source_identifier_from_subscription_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RemoveSourceIdentifierFromSubscriptionEndpointParamsInterceptor {
