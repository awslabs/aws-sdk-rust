...
impl DescribeOptionGroupOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_option_group_options::DescribeOptionGroupOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_option_group_options::DescribeOptionGroupOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_option_group_options::DescribeOptionGroupOptionsOutput, crate::operation::describe_option_group_options::DescribeOptionGroupOptionsError, Self> {
