...
impl PromoteReadReplica {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::promote_read_replica::PromoteReadReplicaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::promote_read_replica::PromoteReadReplicaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::promote_read_replica::PromoteReadReplicaError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::promote_read_replica::PromoteReadReplicaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PromoteReadReplica {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PromoteReadReplica");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PromoteReadReplicaRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PromoteReadReplicaResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PromoteReadReplica")
...
.with_interceptor(PromoteReadReplicaEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::promote_read_replica::PromoteReadReplicaError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::promote_read_replica::PromoteReadReplicaError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::promote_read_replica::PromoteReadReplicaError>::new());
...
#[derive(Debug)]
            struct PromoteReadReplicaResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PromoteReadReplicaResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_promote_read_replica::de_promote_read_replica_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PromoteReadReplicaRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PromoteReadReplicaRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::promote_read_replica::PromoteReadReplicaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::promote_read_replica::PromoteReadReplicaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_promote_read_replica_input::ser_promote_read_replica_input_input_input(&input)?);
...
#[derive(Debug)]
            struct PromoteReadReplicaEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PromoteReadReplicaEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PromoteReadReplicaEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PromoteReadReplicaInput>()
                        .ok_or("failed to downcast to PromoteReadReplicaInput")?;
...
pub enum PromoteReadReplicaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PromoteReadReplicaError) for what information is available for the error.")]
...
impl PromoteReadReplicaError {
    /// Creates the `PromoteReadReplicaError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PromoteReadReplicaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PromoteReadReplicaError {
...
impl ::aws_types::request_id::RequestId for crate::operation::promote_read_replica::PromoteReadReplicaError {
