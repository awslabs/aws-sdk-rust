...
impl DeleteOptionGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_option_group::DeleteOptionGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOptionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_option_group::de_delete_option_group_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_option_group::DeleteOptionGroupError
{
