...
impl DescribeDbProxyTargetGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
