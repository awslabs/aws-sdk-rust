...
impl CreateDBInstance {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_db_instance::CreateDBInstanceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_db_instance::CreateDbInstanceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "CreateDBInstance", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.CreateDBInstance",
                "rpc.service" = "RDS",
                "rpc.method" = "CreateDBInstance",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDBInstance {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateDBInstanceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateDBInstanceResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateDBInstance", "RDS"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDBInstanceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("NcharCharacterSetName") {
            if let ::std::option::Option::Some(value) = input.nchar_character_set_name.as_deref() {
                captured.insert("NcharCharacterSetName", value);
            }
        }
        ...
        if requested.should_capture("DBSystemId") {
            if let ::std::option::Option::Some(value) = input.db_system_id.as_deref() {
                captured.insert("DBSystemId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDBInstanceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_db_instance::de_create_db_instance_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_db_instance::de_create_db_instance_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDBInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_db_instance::CreateDbInstanceInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_db_instance_input::ser_create_db_instance_input_input_input(&input)?,
        );
