...
impl CopyDbSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::copy_db_snapshot::CopyDBSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyDBSnapshot {
    type Output =
        ::std::result::Result<crate::operation::copy_db_snapshot::CopyDbSnapshotOutput, crate::operation::copy_db_snapshot::CopyDBSnapshotError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_db_snapshot::de_copy_db_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
