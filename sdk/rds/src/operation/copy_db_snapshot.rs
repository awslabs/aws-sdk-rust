...
impl CopyDBSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::copy_db_snapshot::CopyDBSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::copy_db_snapshot::CopyDbSnapshotOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "CopyDBSnapshot", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.CopyDBSnapshot",
                "rpc.service" = "RDS",
                "rpc.method" = "CopyDBSnapshot",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CopyDBSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CopyDBSnapshot");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CopyDBSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CopyDBSnapshotResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CopyDBSnapshot", "RDS"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyDBSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CopyDBSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CopyDBSnapshotEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CopyDBSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopyDBSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CopyDbSnapshotInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("SourceDBSnapshotIdentifier") {
            if let ::std::option::Option::Some(value) = input.source_db_snapshot_identifier.as_deref() {
                captured.insert("SourceDBSnapshotIdentifier", value);
            }
        }
        if requested.should_capture("TargetDBSnapshotIdentifier") {
            if let ::std::option::Option::Some(value) = input.target_db_snapshot_identifier.as_deref() {
                captured.insert("TargetDBSnapshotIdentifier", value);
            }
        }
        ...
        if requested.should_capture("TargetCustomAvailabilityZone") {
            if let ::std::option::Option::Some(value) = input.target_custom_availability_zone.as_deref() {
                captured.insert("TargetCustomAvailabilityZone", value);
            }
        }
        if requested.should_capture("SnapshotTarget") {
            if let ::std::option::Option::Some(value) = input.snapshot_target.as_deref() {
                captured.insert("SnapshotTarget", value);
            }
        }
        if requested.should_capture("SnapshotAvailabilityZone") {
            if let ::std::option::Option::Some(value) = input.snapshot_availability_zone.as_deref() {
                captured.insert("SnapshotAvailabilityZone", value);
            }
        }
...
#[derive(Debug)]
struct CopyDBSnapshotResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyDBSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_copy_db_snapshot::de_copy_db_snapshot_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_copy_db_snapshot::de_copy_db_snapshot_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CopyDBSnapshotRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyDBSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::copy_db_snapshot::CopyDbSnapshotInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::copy_db_snapshot::CopyDbSnapshotInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_copy_db_snapshot_input::ser_copy_db_snapshot_input_input_input(&input)?,
        );
...
#[derive(Debug)]
struct CopyDBSnapshotEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopyDBSnapshotEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CopyDBSnapshotEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CopyDbSnapshotInput>()
            .ok_or("failed to downcast to CopyDbSnapshotInput")?;
...
pub enum CopyDBSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CopyDBSnapshotError) for what information is available for the error.")]
...
impl CopyDBSnapshotError {
    ...
    /// Creates the `CopyDBSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CustomAvailabilityZoneNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for CopyDBSnapshotError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::CustomAvailabilityZoneNotFoundFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CopyDBSnapshotError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CustomAvailabilityZoneNotFoundFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CopyDBSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::copy_db_snapshot::CopyDBSnapshotError {
