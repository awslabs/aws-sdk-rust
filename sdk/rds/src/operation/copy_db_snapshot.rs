...
impl CopyDbSnapshotInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_copy_db_snapshot_input::ser_copy_db_snapshot_input_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_db_snapshot::CopyDBSnapshot::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CopyDBSnapshot {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_copy_db_snapshot::de_copy_db_snapshot_http_error(
                status, headers, body,
            )
        } else {
