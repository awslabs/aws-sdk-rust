...
impl CopyDbParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`CopyDBParameterGroup`](crate::operation::copy_db_parameter_group::CopyDBParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::copy_db_parameter_group::CopyDBParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_db_parameter_group::CopyDbParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::copy_db_parameter_group::CopyDBParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CopyDBParameterGroup", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for CopyDBParameterGroup {
                type Output = std::result::Result<crate::operation::copy_db_parameter_group::CopyDbParameterGroupOutput, crate::operation::copy_db_parameter_group::CopyDBParameterGroupError>;
