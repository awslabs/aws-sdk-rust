...
impl ModifyDBCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "ModifyDBCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDBClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("DBInstanceParameterGroupName") {
            if let ::std::option::Option::Some(value) = input.db_instance_parameter_group_name.as_deref() {
                captured.insert("DBInstanceParameterGroupName", value);
            }
        }
...
impl ModifyDBClusterError {
    ...
    /// Returns `true` if the error kind is `ModifyDBClusterError::VpcEncryptionControlViolationException`.
