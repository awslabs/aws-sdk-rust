...
impl StopDbClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_db_cluster::StopDBCluster,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_db_cluster::StopDBCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDBCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_db_cluster::de_stop_db_cluster_http_error(
                status, headers, body,
            )
        } else {
