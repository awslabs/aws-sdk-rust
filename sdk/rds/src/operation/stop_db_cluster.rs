...
impl StopDBCluster {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_db_cluster::StopDBClusterError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_db_cluster::StopDbClusterOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "StopDBCluster", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.StopDBCluster",
                "rpc.service" = "RDS",
                "rpc.method" = "StopDBCluster",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopDBCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopDBClusterRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StopDBClusterResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("StopDBCluster", "RDS"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopDBCluster")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StopDBClusterTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StopDBClusterTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopDBClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopDbClusterInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopDBClusterResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_db_cluster::de_stop_db_cluster_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_stop_db_cluster::de_stop_db_cluster_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopDBClusterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::stop_db_cluster::StopDbClusterInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::stop_db_cluster::StopDbClusterInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_stop_db_cluster_input::ser_stop_db_cluster_input_input_input(&input)?,
        );
...
impl StopDBClusterError {
    ...
    /// Returns `true` if the error kind is `StopDBClusterError::InvalidDbShardGroupStateFault`.
