...
pub struct CreateDbInstanceReadReplicaInput {
    ...
    /// </dt>
    /// <dd>
    /// <p>Standby DB replicas are included in Db2 Advanced Edition (AE), Db2 Community Edition (CE), and Db2 Standard Edition (SE). The main use case for standby replicas is cross-Region disaster recovery. Because it doesn't accept user connections, a standby replica can't serve a read-only workload.</p>
...
impl ::std::fmt::Debug for CreateDbInstanceReadReplicaInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("source_db_cluster_identifier", &self.source_db_cluster_identifier);
...
impl ::std::fmt::Debug for CreateDbInstanceReadReplicaInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateDbInstanceReadReplicaInputBuilder");
        formatter.field("db_instance_identifier", &self.db_instance_identifier);
        formatter.field("source_db_instance_identifier", &self.source_db_instance_identifier);
        formatter.field("db_instance_class", &self.db_instance_class);
        formatter.field("availability_zone", &self.availability_zone);
