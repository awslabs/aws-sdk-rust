...
impl CreateDbSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_db_snapshot::CreateDBSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDBSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_db_snapshot::de_create_db_snapshot_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_db_snapshot::CreateDBSnapshotError
{
