...
impl AuthorizeDBSecurityGroupIngress {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::authorize_db_security_group_ingress::AuthorizeDbSecurityGroupIngressOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AuthorizeDBSecurityGroupIngressResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AuthorizeDBSecurityGroupIngressRequestSerializer {
