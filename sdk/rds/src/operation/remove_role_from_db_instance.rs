...
/// Orchestration and serialization glue logic for `RemoveRoleFromDBInstance`.
...
impl RemoveRoleFromDBInstance {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceInput,
                    ) -> ::std::result::Result<crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveRoleFromDBInstance {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveRoleFromDBInstance");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveRoleFromDBInstanceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveRoleFromDBInstanceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveRoleFromDBInstance")
...
.with_interceptor(RemoveRoleFromDBInstanceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError>::new());
...
#[derive(Debug)]
            struct RemoveRoleFromDBInstanceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveRoleFromDBInstanceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_role_from_db_instance::de_remove_role_from_db_instance_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_remove_role_from_db_instance::de_remove_role_from_db_instance_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RemoveRoleFromDBInstanceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveRoleFromDBInstanceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_role_from_db_instance_input::ser_remove_role_from_db_instance_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RemoveRoleFromDBInstanceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveRoleFromDBInstanceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveRoleFromDBInstanceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveRoleFromDbInstanceInput>()
                        .ok_or("failed to downcast to RemoveRoleFromDbInstanceInput")?;
...
pub enum RemoveRoleFromDBInstanceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveRoleFromDBInstanceError) for what information is available for the error.")]
...
impl RemoveRoleFromDBInstanceError {
    /// Creates the `RemoveRoleFromDBInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveRoleFromDBInstanceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DbInstanceRoleNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveRoleFromDBInstanceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError {
...
mod _remove_role_from_db_instance_output;
