...
impl RemoveRoleFromDbInstanceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveRoleFromDBInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_role_from_db_instance::de_remove_role_from_db_instance_http_response_with_props(status, headers, body)
        }
    }
}
