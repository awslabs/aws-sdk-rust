...
impl RemoveRoleFromDbInstanceInput {
    /// Consumes the builder and constructs an Operation<[`RemoveRoleFromDBInstance`](crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_remove_role_from_db_instance_input::ser_remove_role_from_db_instance_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RemoveRoleFromDBInstance", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveRoleFromDBInstance {
                type Output = std::result::Result<crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceOutput, crate::operation::remove_role_from_db_instance::RemoveRoleFromDBInstanceError>;
