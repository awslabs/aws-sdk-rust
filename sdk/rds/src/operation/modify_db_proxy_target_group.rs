...
impl ModifyDbProxyTargetGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_proxy_target_group::ModifyDBProxyTargetGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyDBProxyTargetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_db_proxy_target_group::de_modify_db_proxy_target_group_http_response_with_props(status, headers, body)
        }
    }
}
