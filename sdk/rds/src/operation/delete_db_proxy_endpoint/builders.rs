...
impl DeleteDBProxyEndpointFluentBuilder  {
    /// Creates a new `DeleteDBProxyEndpoint`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_db_proxy_endpoint::DeleteDbProxyEndpointOutput, aws_smithy_http::result::SdkError<crate::operation::delete_db_proxy_endpoint::DeleteDBProxyEndpointError>>
                     {
