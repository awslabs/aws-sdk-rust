...
/// Orchestration and serialization glue logic for `RegisterDBProxyTargets`.
...
impl RegisterDBProxyTargets {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_db_proxy_targets::RegisterDbProxyTargetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_db_proxy_targets::RegisterDBProxyTargetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_db_proxy_targets::RegisterDBProxyTargetsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_db_proxy_targets::RegisterDbProxyTargetsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterDBProxyTargets {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterDBProxyTargets");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterDBProxyTargetsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterDBProxyTargetsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterDBProxyTargets")
...
.with_interceptor(RegisterDBProxyTargetsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_db_proxy_targets::RegisterDBProxyTargetsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_db_proxy_targets::RegisterDBProxyTargetsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_db_proxy_targets::RegisterDBProxyTargetsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterDBProxyTargetsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_db_proxy_targets::de_register_db_proxy_targets_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterDBProxyTargetsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_db_proxy_targets::RegisterDbProxyTargetsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_db_proxy_targets::RegisterDbProxyTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_db_proxy_targets_input::ser_register_db_proxy_targets_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RegisterDBProxyTargetsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterDBProxyTargetsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterDBProxyTargetsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterDbProxyTargetsInput>()
                        .ok_or("failed to downcast to RegisterDbProxyTargetsInput")?;
...
pub enum RegisterDBProxyTargetsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterDBProxyTargetsError) for what information is available for the error.")]
...
impl RegisterDBProxyTargetsError {
    /// Creates the `RegisterDBProxyTargetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterDBProxyTargetsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DbProxyTargetAlreadyRegisteredFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::DbProxyTargetGroupNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InsufficientAvailableIPsInSubnetFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    pub fn is_insufficient_available_ips_in_subnet_fault(&self) -> bool {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterDBProxyTargetsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_db_proxy_targets::RegisterDBProxyTargetsError {
