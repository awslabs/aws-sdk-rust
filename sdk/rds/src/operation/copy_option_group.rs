...
impl CopyOptionGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::copy_option_group::CopyOptionGroup,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_option_group::CopyOptionGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyOptionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_copy_option_group::de_copy_option_group_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::copy_option_group::CopyOptionGroupError
{
