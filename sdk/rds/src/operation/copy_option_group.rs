...
impl CopyOptionGroupInput {
    /// Consumes the builder and constructs an Operation<[`CopyOptionGroup`](crate::operation::copy_option_group::CopyOptionGroup)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::copy_option_group::CopyOptionGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::copy_option_group::CopyOptionGroup::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CopyOptionGroup", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyOptionGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_option_group::de_copy_option_group_http_response_with_props(status, headers, body)
        }
    }
}
