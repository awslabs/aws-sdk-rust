...
impl CopyOptionGroupInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::copy_option_group::CopyOptionGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_option_group::CopyOptionGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_copy_option_group_input::ser_copy_option_group_input_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for CopyOptionGroup {
                type Output = std::result::Result<crate::operation::copy_option_group::CopyOptionGroupOutput, crate::operation::copy_option_group::CopyOptionGroupError>;
