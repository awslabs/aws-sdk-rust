    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "RestoreDBClusterFromSnapshot", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.service" = "RDS",
                "rpc.method" = "RestoreDBClusterFromSnapshot",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RestoreDBClusterFromSnapshot")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreDBClusterFromSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_restore_db_cluster_from_snapshot::de_restore_db_cluster_from_snapshot_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_restore_db_cluster_from_snapshot::de_restore_db_cluster_from_snapshot_http_response(
...
impl RestoreDBClusterFromSnapshotError {
    ...
    /// Returns `true` if the error kind is `RestoreDBClusterFromSnapshotError::NetworkTypeNotSupported`.
    ...
    /// Returns `true` if the error kind is `RestoreDBClusterFromSnapshotError::StorageTypeNotSupportedFault`.
