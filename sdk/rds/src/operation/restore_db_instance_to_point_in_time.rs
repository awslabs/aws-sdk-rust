...
impl RestoreDBInstanceToPointInTime {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_db_instance_to_point_in_time::RestoreDbInstanceToPointInTimeOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RestoreDBInstanceToPointInTimeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RestoreDBInstanceToPointInTimeRequestSerializer {
