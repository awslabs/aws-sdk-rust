...
impl RestoreDbInstanceToPointInTimeInput {
    /// Consumes the builder and constructs an Operation<[`RestoreDBInstanceToPointInTime`](crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTime)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTime, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_db_instance_to_point_in_time::RestoreDbInstanceToPointInTimeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreDBInstanceToPointInTime {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_restore_db_instance_to_point_in_time::de_restore_db_instance_to_point_in_time_http_error(response)
                     } else {
                        crate::protocol_serde::shape_restore_db_instance_to_point_in_time::de_restore_db_instance_to_point_in_time_http_response(response)
                     }
                }
            }
