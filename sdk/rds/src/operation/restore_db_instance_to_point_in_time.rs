...
impl RestoreDBInstanceToPointInTime {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::restore_db_instance_to_point_in_time::RestoreDbInstanceToPointInTimeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTimeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTimeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::restore_db_instance_to_point_in_time::RestoreDbInstanceToPointInTimeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreDBInstanceToPointInTime {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RestoreDBInstanceToPointInTime");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RestoreDBInstanceToPointInTimeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RestoreDBInstanceToPointInTimeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreDBInstanceToPointInTime")
...
.with_interceptor(RestoreDBInstanceToPointInTimeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTimeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTimeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTimeError>::new());
...
#[derive(Debug)]
            struct RestoreDBInstanceToPointInTimeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreDBInstanceToPointInTimeResponseDeserializer {
...
#[derive(Debug)]
            struct RestoreDBInstanceToPointInTimeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreDBInstanceToPointInTimeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::restore_db_instance_to_point_in_time::RestoreDbInstanceToPointInTimeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::restore_db_instance_to_point_in_time::RestoreDbInstanceToPointInTimeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_restore_db_instance_to_point_in_time_input::ser_restore_db_instance_to_point_in_time_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RestoreDBInstanceToPointInTimeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreDBInstanceToPointInTimeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RestoreDBInstanceToPointInTimeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RestoreDbInstanceToPointInTimeInput>()
                        .ok_or("failed to downcast to RestoreDbInstanceToPointInTimeInput")?;
...
pub enum RestoreDBInstanceToPointInTimeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RestoreDBInstanceToPointInTimeError) for what information is available for the error.")]
...
impl RestoreDBInstanceToPointInTimeError {
    /// Creates the `RestoreDBInstanceToPointInTimeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreDBInstanceToPointInTimeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PointInTimeRestoreNotEnabledFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `RestoreDBInstanceToPointInTimeError::TenantDatabaseQuotaExceededFault`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RestoreDBInstanceToPointInTimeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::restore_db_instance_to_point_in_time::RestoreDBInstanceToPointInTimeError {
...
mod _restore_db_instance_to_point_in_time_output;
