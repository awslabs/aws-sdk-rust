...
impl StopActivityStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_activity_stream::StopActivityStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_activity_stream::StopActivityStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_activity_stream::StopActivityStreamOutput, crate::operation::stop_activity_stream::StopActivityStreamError, Self> {
