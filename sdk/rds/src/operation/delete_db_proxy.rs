...
impl DeleteDbProxyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_db_proxy::DeleteDBProxy, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBProxy {
    type Output =
        ::std::result::Result<crate::operation::delete_db_proxy::DeleteDbProxyOutput, crate::operation::delete_db_proxy::DeleteDBProxyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_db_proxy::de_delete_db_proxy_http_response_with_props(status, headers, body)
        }
    }
}
