...
impl DeleteDbProxyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_db_proxy::DeleteDBProxy,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_db_proxy_input::ser_delete_db_proxy_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_db_proxy::DeleteDBProxy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBProxy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_db_proxy::de_delete_db_proxy_http_error(
                status, headers, body,
            )
        } else {
