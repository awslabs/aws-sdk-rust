...
impl DeleteBlueGreenDeploymentInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeployment::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBlueGreenDeployment {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_blue_green_deployment::de_delete_blue_green_deployment_http_error(response)
        } else {
            crate::protocol_serde::shape_delete_blue_green_deployment::de_delete_blue_green_deployment_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentError
{
