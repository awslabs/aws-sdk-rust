...
impl RestoreDbInstanceFromS3InputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_db_instance_from_s3::RestoreDbInstanceFromS3Input, ::aws_smithy_types::error::operation::BuildError> {
