...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateIntegrationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateIntegrationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_integration_input::ser_create_integration_input_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateIntegrationEndpointParamsInterceptor {
