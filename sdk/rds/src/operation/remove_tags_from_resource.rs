...
impl RemoveTagsFromResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "RemoveTagsFromResource", input, runtime_plugins, stop_point)
...
impl RemoveTagsFromResourceError {
    ...
    /// Returns `true` if the error kind is `RemoveTagsFromResourceError::DbProxyEndpointNotFoundFault`.
    ...
    /// Returns `true` if the error kind is `RemoveTagsFromResourceError::DbShardGroupNotFoundFault`.
    ...
    /// Returns `true` if the error kind is `RemoveTagsFromResourceError::InvalidDbClusterEndpointStateFault`.
    pub fn is_invalid_db_cluster_endpoint_state_fault(&self) -> bool {
        matches!(self, Self::InvalidDbClusterEndpointStateFault(_))
    }
    /// Returns `true` if the error kind is `RemoveTagsFromResourceError::InvalidDbClusterStateFault`.
    pub fn is_invalid_db_cluster_state_fault(&self) -> bool {
        matches!(self, Self::InvalidDbClusterStateFault(_))
    }
    /// Returns `true` if the error kind is `RemoveTagsFromResourceError::InvalidDbInstanceStateFault`.
