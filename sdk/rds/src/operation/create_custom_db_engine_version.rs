...
impl CreateCustomDBEngineVersion {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_custom_db_engine_version::CreateCustomDBEngineVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_custom_db_engine_version::CreateCustomDbEngineVersionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RDS", "CreateCustomDBEngineVersion", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RDS.CreateCustomDBEngineVersion",
                "rpc.service" = "RDS",
                "rpc.method" = "CreateCustomDBEngineVersion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCustomDBEngineVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateCustomDBEngineVersionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateCustomDBEngineVersionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateCustomDBEngineVersion")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCustomDBEngineVersion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateCustomDBEngineVersionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateCustomDBEngineVersionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCustomDBEngineVersionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateCustomDbEngineVersionInput>() else {
        ...
        if requested.should_capture("DatabaseInstallationFilesS3BucketName") {
            if let ::std::option::Option::Some(value) = input.database_installation_files_s3_bucket_name.as_deref() {
                captured.insert("DatabaseInstallationFilesS3BucketName", value);
            }
        }
        if requested.should_capture("DatabaseInstallationFilesS3Prefix") {
            if let ::std::option::Option::Some(value) = input.database_installation_files_s3_prefix.as_deref() {
                captured.insert("DatabaseInstallationFilesS3Prefix", value);
            }
        }
        ...
        if requested.should_capture("SourceCustomDbEngineVersionIdentifier") {
            if let ::std::option::Option::Some(value) = input.source_custom_db_engine_version_identifier.as_deref() {
                captured.insert("SourceCustomDbEngineVersionIdentifier", value);
            }
        }
        ...
        if requested.should_capture("Manifest") {
            if let ::std::option::Option::Some(value) = input.manifest.as_deref() {
                captured.insert("Manifest", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCustomDBEngineVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_custom_db_engine_version::de_create_custom_db_engine_version_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_custom_db_engine_version::de_create_custom_db_engine_version_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCustomDBEngineVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_custom_db_engine_version::CreateCustomDbEngineVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_custom_db_engine_version::CreateCustomDbEngineVersionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_custom_db_engine_version_input::ser_create_custom_db_engine_version_input_input_input(&input)?,
        );
