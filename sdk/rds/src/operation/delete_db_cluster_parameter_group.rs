...
impl DeleteDbClusterParameterGroupInput {
    ...
    > {
        ...
        .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDBClusterParameterGroup", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDBClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_db_cluster_parameter_group::de_delete_db_cluster_parameter_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
