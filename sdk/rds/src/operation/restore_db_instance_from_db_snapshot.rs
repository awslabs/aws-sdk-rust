...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreDBInstanceFromDBSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_db_instance_from_db_snapshot::de_restore_db_instance_from_db_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshotError
{
