...
impl RestoreDbInstanceFromDbSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreDBInstanceFromDBSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_db_instance_from_db_snapshot::de_restore_db_instance_from_db_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
