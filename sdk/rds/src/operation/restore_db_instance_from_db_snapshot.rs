...
impl RestoreDbInstanceFromDbSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`RestoreDBInstanceFromDBSnapshot`](crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_db_instance_from_db_snapshot::RestoreDbInstanceFromDbSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_db_instance_from_db_snapshot_input::ser_restore_db_instance_from_db_snapshot_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RestoreDBInstanceFromDBSnapshot", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreDBInstanceFromDBSnapshot {
                type Output = std::result::Result<crate::operation::restore_db_instance_from_db_snapshot::RestoreDbInstanceFromDbSnapshotOutput, crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshotError>;
...
impl aws_http::request_id::RequestId for crate::operation::restore_db_instance_from_db_snapshot::RestoreDBInstanceFromDBSnapshotError {
