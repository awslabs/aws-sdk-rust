...
impl RebootDBShardGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reboot_db_shard_group::RebootDbShardGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reboot_db_shard_group::RebootDBShardGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reboot_db_shard_group::RebootDbShardGroupOutput, crate::operation::reboot_db_shard_group::RebootDBShardGroupError, Self> {
