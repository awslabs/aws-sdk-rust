...
impl ModifyDbSnapshotAttributeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttribute::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError
{
