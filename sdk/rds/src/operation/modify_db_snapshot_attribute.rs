...
/// Orchestration and serialization glue logic for `ModifyDBSnapshotAttribute`.
...
impl ModifyDBSnapshotAttribute {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeInput,
                    ) -> ::std::result::Result<crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyDBSnapshotAttribute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyDBSnapshotAttribute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyDBSnapshotAttributeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyDBSnapshotAttributeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDBSnapshotAttribute")
...
.with_interceptor(ModifyDBSnapshotAttributeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError>::new());
...
#[derive(Debug)]
            struct ModifyDBSnapshotAttributeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyDBSnapshotAttributeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_db_snapshot_attribute::de_modify_db_snapshot_attribute_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ModifyDBSnapshotAttributeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyDBSnapshotAttributeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_db_snapshot_attribute_input::ser_modify_db_snapshot_attribute_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyDBSnapshotAttributeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDBSnapshotAttributeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyDBSnapshotAttributeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyDbSnapshotAttributeInput>()
                        .ok_or("failed to downcast to ModifyDbSnapshotAttributeInput")?;
...
pub enum ModifyDBSnapshotAttributeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyDBSnapshotAttributeError) for what information is available for the error.")]
...
impl ModifyDBSnapshotAttributeError {
    /// Creates the `ModifyDBSnapshotAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyDBSnapshotAttributeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyDBSnapshotAttributeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_db_snapshot_attribute::_modify_db_snapshot_attribute_output::ModifyDbSnapshotAttributeOutput;

pub use crate::operation::modify_db_snapshot_attribute::_modify_db_snapshot_attribute_input::ModifyDbSnapshotAttributeInput;

mod _modify_db_snapshot_attribute_input;

mod _modify_db_snapshot_attribute_output;
