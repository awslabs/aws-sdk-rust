...
impl ModifyDbSnapshotAttributeInput {
    /// Consumes the builder and constructs an Operation<[`ModifyDBSnapshotAttribute`](crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttribute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_db_snapshot_attribute_input::ser_modify_db_snapshot_attribute_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttribute::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyDBSnapshotAttribute", "rds"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyDBSnapshotAttribute {
                type Output = std::result::Result<crate::operation::modify_db_snapshot_attribute::ModifyDbSnapshotAttributeOutput, crate::operation::modify_db_snapshot_attribute::ModifyDBSnapshotAttributeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_modify_db_snapshot_attribute::de_modify_db_snapshot_attribute_http_error(response)
                     } else {
                        crate::protocol_serde::shape_modify_db_snapshot_attribute::de_modify_db_snapshot_attribute_http_response(response)
                     }
                }
            }
