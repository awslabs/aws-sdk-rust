...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for StopDBInstanceAutomatedBackupsReplicationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for StopDBInstanceAutomatedBackupsReplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_db_instance_automated_backups_replication_input::ser_stop_db_instance_automated_backups_replication_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor {
