...
impl AddTagsToResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("rds", "AddTagsToResource", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddTagsToResource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("AddTagsToResource", "rds"));
...
impl AddTagsToResourceError {
    ...
    /// Returns `true` if the error kind is `AddTagsToResourceError::DbSnapshotTenantDatabaseNotFoundFault`.
    pub fn is_db_snapshot_tenant_database_not_found_fault(&self) -> bool {
        matches!(self, Self::DbSnapshotTenantDatabaseNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `AddTagsToResourceError::IntegrationNotFoundFault`.
