...
impl super::Client  {
    ...
    ///   - [`delete_target(bool)`](crate::operation::delete_blue_green_deployment::builders::DeleteBlueGreenDeploymentFluentBuilder::delete_target) / [`set_delete_target(Option<bool>)`](crate::operation::delete_blue_green_deployment::builders::DeleteBlueGreenDeploymentFluentBuilder::set_delete_target): <p>A value that indicates whether to delete the resources in the green environment. You can't specify this option if the blue/green deployment <a href="https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_BlueGreenDeployment.html">status</a> is <code>SWITCHOVER_COMPLETED</code>.</p>
