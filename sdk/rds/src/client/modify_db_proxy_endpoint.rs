...
impl super::Client {
    ...
    ///   - [`new_db_proxy_endpoint_name(impl Into<String>)`](crate::operation::modify_db_proxy_endpoint::builders::ModifyDBProxyEndpointFluentBuilder::new_db_proxy_endpoint_name) / [`set_new_db_proxy_endpoint_name(Option<String>)`](crate::operation::modify_db_proxy_endpoint::builders::ModifyDBProxyEndpointFluentBuilder::set_new_db_proxy_endpoint_name):<br>required: **false**<br><p>The new identifier for the <code>DBProxyEndpoint</code>. An identifier must begin with a letter and must contain only ASCII letters, digits, and hyphens; it can't end with a hyphen or contain two consecutive hyphens.</p><br>
