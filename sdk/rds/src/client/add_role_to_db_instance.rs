...
impl super::Client {
    ...
    ///   - [`db_instance_identifier(impl ::std::convert::Into<String>)`](crate::operation::add_role_to_db_instance::builders::AddRoleToDBInstanceFluentBuilder::db_instance_identifier) / [`set_db_instance_identifier(Option<String>)`](crate::operation::add_role_to_db_instance::builders::AddRoleToDBInstanceFluentBuilder::set_db_instance_identifier): <p>The name of the DB instance to associate the IAM role with.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::add_role_to_db_instance::builders::AddRoleToDBInstanceFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::add_role_to_db_instance::builders::AddRoleToDBInstanceFluentBuilder::set_role_arn): <p>The Amazon Resource Name (ARN) of the IAM role to associate with the DB instance, for example <code>arn:aws:iam::123456789012:role/AccessRole</code>.</p>
