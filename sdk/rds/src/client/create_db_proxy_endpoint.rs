...
impl super::Client  {
    ...
    ///   - [`target_role(DbProxyEndpointTargetRole)`](crate::client::fluent_builders::CreateDBProxyEndpoint::target_role) / [`set_target_role(Option<DbProxyEndpointTargetRole>)`](crate::client::fluent_builders::CreateDBProxyEndpoint::set_target_role): <p>A value that indicates whether the DB proxy endpoint can be used for read/write or read-only operations. The default is <code>READ_WRITE</code>. The only role that proxies for RDS for Microsoft SQL Server support is <code>READ_WRITE</code>.</p>
    ...
    pub fn create_db_proxy_endpoint(&self) -> crate::client::fluent_builders::CreateDBProxyEndpoint {
                                crate::client::fluent_builders::CreateDBProxyEndpoint::new(self.handle.clone())
                            }
}
