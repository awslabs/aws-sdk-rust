...
impl super::Client {
    ...
    ///   - [`db_proxy_name(impl Into<String>)`](crate::operation::describe_db_proxy_targets::builders::DescribeDBProxyTargetsFluentBuilder::db_proxy_name) / [`set_db_proxy_name(Option<String>)`](crate::operation::describe_db_proxy_targets::builders::DescribeDBProxyTargetsFluentBuilder::set_db_proxy_name): <p>The identifier of the <code>DBProxyTarget</code> to describe.</p>
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::describe_db_proxy_targets::builders::DescribeDBProxyTargetsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_db_proxy_targets::builders::DescribeDBProxyTargetsFluentBuilder::set_marker): <p>An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>
