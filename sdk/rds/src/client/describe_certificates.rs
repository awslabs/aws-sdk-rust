...
impl super::Client {
    ...
    ///   - [`filters(Vec<Filter>)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::set_filters): <p>This parameter isn't currently supported.</p>
    ///   - [`max_records(i32)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::set_max_records): <p>The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a pagination token called a marker is included in the response so you can retrieve the remaining results.</p>  <p>Default: 100</p>  <p>Constraints: Minimum 20, maximum 100.</p>
