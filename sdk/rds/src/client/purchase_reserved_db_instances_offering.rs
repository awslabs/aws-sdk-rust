...
impl super::Client  {
    ...
    pub fn purchase_reserved_db_instances_offering(&self) -> crate::client::fluent_builders::PurchaseReservedDBInstancesOffering {
                                crate::client::fluent_builders::PurchaseReservedDBInstancesOffering::new(self.handle.clone())
                            }
}
