...
impl super::Client {
    ...
    ///   - [`subnet_ids(impl Into<String>)`](crate::operation::create_db_subnet_group::builders::CreateDBSubnetGroupFluentBuilder::subnet_ids) / [`set_subnet_ids(Option<Vec<String>>)`](crate::operation::create_db_subnet_group::builders::CreateDBSubnetGroupFluentBuilder::set_subnet_ids): <p>The EC2 Subnet IDs for the DB subnet group.</p>
    ///   - [`tags(Tag)`](crate::operation::create_db_subnet_group::builders::CreateDBSubnetGroupFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_db_subnet_group::builders::CreateDBSubnetGroupFluentBuilder::set_tags): <p>Tags to assign to the DB subnet group.</p>
