...
impl super::Client  {
    ...
    pub fn stop_db_instance_automated_backups_replication(&self) -> crate::client::fluent_builders::StopDBInstanceAutomatedBackupsReplication {
                                crate::client::fluent_builders::StopDBInstanceAutomatedBackupsReplication::new(self.handle.clone())
                            }
}
