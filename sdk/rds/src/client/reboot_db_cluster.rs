...
impl super::Client {
    ...
    pub fn reboot_db_cluster(
        &self,
    ) -> crate::operation::reboot_db_cluster::builders::RebootDBClusterFluentBuilder {
        crate::operation::reboot_db_cluster::builders::RebootDBClusterFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
