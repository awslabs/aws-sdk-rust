...
impl super::Client {
    ...
    ///   - [`subscription_name(impl ::std::convert::Into<String>)`](crate::operation::add_source_identifier_to_subscription::builders::AddSourceIdentifierToSubscriptionFluentBuilder::subscription_name) / [`set_subscription_name(Option<String>)`](crate::operation::add_source_identifier_to_subscription::builders::AddSourceIdentifierToSubscriptionFluentBuilder::set_subscription_name): <p>The name of the RDS event notification subscription you want to add a source identifier to.</p>
    ///   - [`source_identifier(impl ::std::convert::Into<String>)`](crate::operation::add_source_identifier_to_subscription::builders::AddSourceIdentifierToSubscriptionFluentBuilder::source_identifier) / [`set_source_identifier(Option<String>)`](crate::operation::add_source_identifier_to_subscription::builders::AddSourceIdentifierToSubscriptionFluentBuilder::set_source_identifier): <p>The identifier of the event source to be added.</p>  <p>Constraints:</p>  <ul>   <li> <p>If the source type is a DB instance, a <code>DBInstanceIdentifier</code> value must be supplied.</p> </li>   <li> <p>If the source type is a DB cluster, a <code>DBClusterIdentifier</code> value must be supplied.</p> </li>   <li> <p>If the source type is a DB parameter group, a <code>DBParameterGroupName</code> value must be supplied.</p> </li>   <li> <p>If the source type is a DB security group, a <code>DBSecurityGroupName</code> value must be supplied.</p> </li>   <li> <p>If the source type is a DB snapshot, a <code>DBSnapshotIdentifier</code> value must be supplied.</p> </li>   <li> <p>If the source type is a DB cluster snapshot, a <code>DBClusterSnapshotIdentifier</code> value must be supplied.</p> </li>   <li> <p>If the source type is an RDS Proxy, a <code>DBProxyName</code> value must be supplied.</p> </li>  </ul>
