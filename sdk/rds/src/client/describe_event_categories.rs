...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_event_categories::builders::DescribeEventCategoriesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_event_categories::builders::DescribeEventCategoriesFluentBuilder::set_filters): <p>This parameter isn't currently supported.</p>
