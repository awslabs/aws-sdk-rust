...
impl super::Client {
    ...
    ///   - [`filename_contains(impl Into<String>)`](crate::operation::describe_db_log_files::builders::DescribeDBLogFilesFluentBuilder::filename_contains) / [`set_filename_contains(Option<String>)`](crate::operation::describe_db_log_files::builders::DescribeDBLogFilesFluentBuilder::set_filename_contains): <p>Filters the available log files for log file names that contain the specified string.</p>
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::describe_db_log_files::builders::DescribeDBLogFilesFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_db_log_files::builders::DescribeDBLogFilesFluentBuilder::set_marker): <p>The pagination token provided in the previous request. If this parameter is specified the response includes only records beyond the marker, up to MaxRecords.</p>
