...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::modify_activity_stream::builders::ModifyActivityStreamFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::modify_activity_stream::builders::ModifyActivityStreamFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the RDS for Oracle or Microsoft SQL Server DB instance. For example, <code>arn:aws:rds:us-east-1:12345667890:instance:my-orcl-db</code>.</p>
