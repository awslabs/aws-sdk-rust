...
impl super::Client {
    ...
    pub fn modify_certificates(
        &self,
    ) -> crate::operation::modify_certificates::builders::ModifyCertificatesFluentBuilder {
        crate::operation::modify_certificates::builders::ModifyCertificatesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
