...
pub(crate) fn reflens_list_deployment_events_output_next_token(
...
pub(crate) fn reflens_list_workload_deployment_patterns_output_next_token(
...
pub(crate) fn lens_list_deployment_events_output_deployment_events(
    input: crate::operation::list_deployment_events::ListDeploymentEventsOutput,
...
pub(crate) fn lens_list_workload_deployment_patterns_output_workload_deployment_patterns(
    input: crate::operation::list_workload_deployment_patterns::ListWorkloadDeploymentPatternsOutput,
...
pub(crate) fn lens_list_workloads_output_workloads(
    input: crate::operation::list_workloads::ListWorkloadsOutput,
