...
pub use crate::operation::get_deployment_pattern_version::_get_deployment_pattern_version_output::GetDeploymentPatternVersionOutputBuilder;

pub use crate::operation::get_deployment_pattern_version::_get_deployment_pattern_version_input::GetDeploymentPatternVersionInputBuilder;

impl crate::operation::get_deployment_pattern_version::builders::GetDeploymentPatternVersionInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_deployment_pattern_version();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `GetDeploymentPatternVersion`.
///
/// <p>Returns information about a deployment pattern version.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct GetDeploymentPatternVersionFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_deployment_pattern_version::builders::GetDeploymentPatternVersionInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_deployment_pattern_version::GetDeploymentPatternVersionOutput,
        crate::operation::get_deployment_pattern_version::GetDeploymentPatternVersionError,
    > for GetDeploymentPatternVersionFluentBuilder
{
    fn send(
        self,
...
impl GetDeploymentPatternVersionFluentBuilder {
    /// Creates a new `GetDeploymentPatternVersionFluentBuilder`.
    ...
    /// Access the GetDeploymentPatternVersion as a reference.
    pub fn as_input(&self) -> &crate::operation::get_deployment_pattern_version::builders::GetDeploymentPatternVersionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_deployment_pattern_version::GetDeploymentPatternVersion::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_deployment_pattern_version::GetDeploymentPatternVersion::orchestrate(&runtime_plugins, input).await
    }
