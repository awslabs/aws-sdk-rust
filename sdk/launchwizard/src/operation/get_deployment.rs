...
#[derive(Debug)]
    ...
    ::std::write!(output, "/getDeployment").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_deployment::ser_get_deployment_input(&input)?);
