...
pub struct ListDeploymentPatternVersionsInput {
    ...
    pub filters: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentPatternVersionFilter>>,
}
impl ListDeploymentPatternVersionsInput {
    ...
    pub fn filters(&self) -> &[crate::types::DeploymentPatternVersionFilter] {
        self.filters.as_deref().unwrap_or_default()
    }
}
impl ListDeploymentPatternVersionsInput {
    /// Creates a new builder-style object to manufacture [`ListDeploymentPatternVersionsInput`](crate::operation::list_deployment_pattern_versions::ListDeploymentPatternVersionsInput).
    pub fn builder() -> crate::operation::list_deployment_pattern_versions::builders::ListDeploymentPatternVersionsInputBuilder {
        crate::operation::list_deployment_pattern_versions::builders::ListDeploymentPatternVersionsInputBuilder::default()
    }
}

/// A builder for [`ListDeploymentPatternVersionsInput`](crate::operation::list_deployment_pattern_versions::ListDeploymentPatternVersionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListDeploymentPatternVersionsInputBuilder {
    ...
    pub(crate) filters: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentPatternVersionFilter>>,
}
impl ListDeploymentPatternVersionsInputBuilder {
    /// <p>The name of the workload. You can use the <a href="https://docs.aws.amazon.com/launchwizard/latest/APIReference/API_ListWorkloads.html"> <code>ListWorkloads</code> </a> operation to discover supported values for this parameter.</p>
    ...
    ///
    /// <p>Filters to apply when listing deployment pattern versions.</p>
    pub fn filters(mut self, input: crate::types::DeploymentPatternVersionFilter) -> Self {
    ...
    /// <p>Filters to apply when listing deployment pattern versions.</p>
    pub fn set_filters(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentPatternVersionFilter>>) -> Self {
        self.filters = input;
        self
    }
    /// <p>Filters to apply when listing deployment pattern versions.</p>
    pub fn get_filters(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::DeploymentPatternVersionFilter>> {
        &self.filters
    }
    /// Consumes the builder and constructs a [`ListDeploymentPatternVersionsInput`](crate::operation::list_deployment_pattern_versions::ListDeploymentPatternVersionsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::list_deployment_pattern_versions::ListDeploymentPatternVersionsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::list_deployment_pattern_versions::ListDeploymentPatternVersionsInput {
