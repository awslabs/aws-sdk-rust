...
impl From<crate::operation::delete_deployment::DeleteDeploymentError> for Error {
    fn from(err: crate::operation::delete_deployment::DeleteDeploymentError) -> Self {
        match err {
            ...
            crate::operation::delete_deployment::DeleteDeploymentError::ResourceLimitException(inner) => Error::ResourceLimitException(inner),
...
impl<R>
    From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl From<crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError> for Error {
    fn from(err: crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError) -> Self {
        match err {
            crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
            crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError::ValidationException(inner) => {
                Error::ValidationException(inner)
            }
            crate::operation::get_workload_deployment_pattern::GetWorkloadDeploymentPatternError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_deployment_events::ListDeploymentEventsError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl From<crate::operation::list_deployment_events::ListDeploymentEventsError> for Error {
    fn from(err: crate::operation::list_deployment_events::ListDeploymentEventsError) -> Self {
        match err {
            crate::operation::list_deployment_events::ListDeploymentEventsError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::list_deployment_events::ListDeploymentEventsError::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
...
impl From<crate::operation::list_workload_deployment_patterns::ListWorkloadDeploymentPatternsError> for Error {
    fn from(err: crate::operation::list_workload_deployment_patterns::ListWorkloadDeploymentPatternsError) -> Self {
        match err {
            crate::operation::list_workload_deployment_patterns::ListWorkloadDeploymentPatternsError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::list_workload_deployment_patterns::ListWorkloadDeploymentPatternsError::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
            crate::operation::list_workload_deployment_patterns::ListWorkloadDeploymentPatternsError::ValidationException(inner) => {
                Error::ValidationException(inner)
            }
