...
impl CreateRescoreExecutionPlan {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanInput,
                    ) -> ::std::result::Result<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateRescoreExecutionPlan {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateRescoreExecutionPlan");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateRescoreExecutionPlanRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateRescoreExecutionPlanResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateRescoreExecutionPlan")
...
.with_interceptor(CreateRescoreExecutionPlanEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanError>::new());
...
#[derive(Debug)]
            struct CreateRescoreExecutionPlanResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRescoreExecutionPlanResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_rescore_execution_plan::de_create_rescore_execution_plan_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_rescore_execution_plan::de_create_rescore_execution_plan_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateRescoreExecutionPlanRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRescoreExecutionPlanRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_rescore_execution_plan::ser_create_rescore_execution_plan_input(&input)?);
...
#[derive(Debug)]
            struct CreateRescoreExecutionPlanEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRescoreExecutionPlanEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateRescoreExecutionPlanEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateRescoreExecutionPlanInput>()
                        .ok_or("failed to downcast to CreateRescoreExecutionPlanInput")?;
...
pub enum CreateRescoreExecutionPlanError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateRescoreExecutionPlanError) for what information is available for the error.")]
...
impl CreateRescoreExecutionPlanError {
    /// Creates the `CreateRescoreExecutionPlanError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateRescoreExecutionPlanError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateRescoreExecutionPlanError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlanError {
...
mod _create_rescore_execution_plan_output;
