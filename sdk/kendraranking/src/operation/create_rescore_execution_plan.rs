...
impl CreateRescoreExecutionPlanInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_rescore_execution_plan::CreateRescoreExecutionPlan::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRescoreExecutionPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_rescore_execution_plan::de_create_rescore_execution_plan_http_response_with_props(
                status, headers, body,
            )
        }
    }
