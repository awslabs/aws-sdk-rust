...
impl DescribeRescoreExecutionPlanInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_rescore_execution_plan::DescribeRescoreExecutionPlan::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRescoreExecutionPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_rescore_execution_plan::de_describe_rescore_execution_plan_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeRescoreExecutionPlanError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_rescore_execution_plan::DescribeRescoreExecutionPlanError
{
