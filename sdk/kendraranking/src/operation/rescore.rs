...
impl RescoreInput {
    /// Consumes the builder and constructs an Operation<[`Rescore`](crate::operation::rescore::Rescore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::rescore::Rescore, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rescore::RescoreInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_rescore::ser_rescore_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::rescore::Rescore::new())
...
impl aws_smithy_http::response::ParseStrictResponse for Rescore {
                type Output = std::result::Result<crate::operation::rescore::RescoreOutput, crate::operation::rescore::RescoreError>;
