...
impl RescoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::rescore::Rescore, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_rescore::ser_rescore_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for Rescore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_rescore::de_rescore_http_response_with_props(status, headers, body)
        }
    }
}
