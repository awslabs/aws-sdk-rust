...
impl ListRescoreExecutionPlansInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_rescore_execution_plans::ListRescoreExecutionPlansInput, ::aws_smithy_types::error::operation::BuildError> {
