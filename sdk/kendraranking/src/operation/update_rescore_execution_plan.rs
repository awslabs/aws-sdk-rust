...
impl UpdateRescoreExecutionPlanInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_rescore_execution_plan::UpdateRescoreExecutionPlan::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRescoreExecutionPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_rescore_execution_plan::de_update_rescore_execution_plan_http_response_with_props(
                status, headers, body,
            )
        }
    }
