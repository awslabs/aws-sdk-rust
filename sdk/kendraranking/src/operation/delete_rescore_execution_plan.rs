...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRescoreExecutionPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_rescore_execution_plan::de_delete_rescore_execution_plan_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_rescore_execution_plan::DeleteRescoreExecutionPlanError
{
