...
impl super::Client {
    ...
    ///   - [`rescore_execution_plan_id(impl ::std::convert::Into<String>)`](crate::operation::rescore::builders::RescoreFluentBuilder::rescore_execution_plan_id) / [`set_rescore_execution_plan_id(Option<String>)`](crate::operation::rescore::builders::RescoreFluentBuilder::set_rescore_execution_plan_id): <p>The identifier of the rescore execution plan. A rescore execution plan is an Amazon Kendra Intelligent Ranking resource used for provisioning the <code>Rescore</code> API.</p>
    ///   - [`search_query(impl ::std::convert::Into<String>)`](crate::operation::rescore::builders::RescoreFluentBuilder::search_query) / [`set_search_query(Option<String>)`](crate::operation::rescore::builders::RescoreFluentBuilder::set_search_query): <p>The input query from the search service.</p>
