...
impl super::Client {
    ...
    ///   - [`documents(Document)`](crate::operation::rescore::builders::RescoreFluentBuilder::documents) / [`set_documents(Option<Vec<Document>>)`](crate::operation::rescore::builders::RescoreFluentBuilder::set_documents): <p>The list of documents for Amazon Kendra Intelligent Ranking to rescore or rank on.</p>
