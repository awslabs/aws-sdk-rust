...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_rescore_execution_plans::builders::ListRescoreExecutionPlansFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_rescore_execution_plans::builders::ListRescoreExecutionPlansFluentBuilder::set_next_token):<br>required: **false**<br><p>If the response is truncated, Amazon Kendra Intelligent Ranking returns a pagination token in the response. You can use this pagination token to retrieve the next set of rescore execution plans.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_rescore_execution_plans::builders::ListRescoreExecutionPlansFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_rescore_execution_plans::builders::ListRescoreExecutionPlansFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of rescore execution plans to return.</p><br>
