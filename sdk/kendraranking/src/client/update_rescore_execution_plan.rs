...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_rescore_execution_plan::builders::UpdateRescoreExecutionPlanFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_rescore_execution_plan::builders::UpdateRescoreExecutionPlanFluentBuilder::set_id): <p>The identifier of the rescore execution plan that you want to update.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_rescore_execution_plan::builders::UpdateRescoreExecutionPlanFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_rescore_execution_plan::builders::UpdateRescoreExecutionPlanFluentBuilder::set_name): <p>A new name for the rescore execution plan.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_rescore_execution_plan::builders::UpdateRescoreExecutionPlanFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_rescore_execution_plan::builders::UpdateRescoreExecutionPlanFluentBuilder::set_description): <p>A new description for the rescore execution plan.</p>
