...
impl Client  {
    ...
    pub fn create_source_repository_branch(&self) -> crate::client::fluent_builders::CreateSourceRepositoryBranch {
    ...
    pub fn list_source_repositories(&self) -> crate::client::fluent_builders::ListSourceRepositories {
