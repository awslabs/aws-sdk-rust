...
impl From<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsError>
    for Error
{
    fn from(
        err: crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsError,
    ) -> Self {
        match err {
