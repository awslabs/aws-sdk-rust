...
impl CreateAccessTokenInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_access_token::ser_create_access_token_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccessToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_access_token::de_create_access_token_http_response_with_props(status, headers, body)
        }
    }
