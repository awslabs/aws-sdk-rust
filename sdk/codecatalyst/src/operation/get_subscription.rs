...
impl GetSubscriptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_subscription::GetSubscription,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_subscription::GetSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_subscription::de_get_subscription_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_subscription::GetSubscriptionError
{
