...
impl ListDevEnvironmentsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_dev_environments::ser_list_dev_environments_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_dev_environments::ListDevEnvironments::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::list_dev_environments::ListDevEnvironmentsError
{
