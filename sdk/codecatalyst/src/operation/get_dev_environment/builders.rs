...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_dev_environment::GetDevEnvironmentOutput,
                    crate::operation::get_dev_environment::GetDevEnvironmentError,
                > for GetDevEnvironmentFluentBuilder
            {
                fn send(
                    self,
...
impl GetDevEnvironmentFluentBuilder {
    ...
    /// Access the GetDevEnvironment as a reference.
    pub fn as_input(&self) -> &crate::operation::get_dev_environment::builders::GetDevEnvironmentInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_dev_environment::GetDevEnvironmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_dev_environment::GetDevEnvironmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_dev_environment::GetDevEnvironment::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_dev_environment::GetDevEnvironment::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_dev_environment::GetDevEnvironmentOutput, crate::operation::get_dev_environment::GetDevEnvironmentError, Self> {
