...
impl GetDevEnvironmentInputBuilder {
    ...
    /// - [`space_name`](crate::operation::get_dev_environment::builders::GetDevEnvironmentInputBuilder::space_name)
    /// - [`project_name`](crate::operation::get_dev_environment::builders::GetDevEnvironmentInputBuilder::project_name)
    /// - [`id`](crate::operation::get_dev_environment::builders::GetDevEnvironmentInputBuilder::id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::get_dev_environment::GetDevEnvironmentInput {
            space_name: self.space_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "space_name",
                    "space_name was not specified but it is required when building GetDevEnvironmentInput",
                )
            })?,
            project_name: self.project_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "project_name",
                    "project_name was not specified but it is required when building GetDevEnvironmentInput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetDevEnvironmentInput",
                )
            })?,
        })
    }
