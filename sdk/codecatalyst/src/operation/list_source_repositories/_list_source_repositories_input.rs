...
impl ListSourceRepositoriesInputBuilder {
    ...
    /// - [`space_name`](crate::operation::list_source_repositories::builders::ListSourceRepositoriesInputBuilder::space_name)
    /// - [`project_name`](crate::operation::list_source_repositories::builders::ListSourceRepositoriesInputBuilder::project_name)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_source_repositories::ListSourceRepositoriesInput {
            space_name: self.space_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "space_name",
                    "space_name was not specified but it is required when building ListSourceRepositoriesInput",
                )
            })?,
            project_name: self.project_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "project_name",
                    "project_name was not specified but it is required when building ListSourceRepositoriesInput",
                )
            })?,
