...
impl ListSourceRepositoriesFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_source_repositories::paginator::ListSourceRepositoriesPaginator
    {
        crate::operation::list_source_repositories::paginator::ListSourceRepositoriesPaginator::new(
            self.handle,
            self.inner,
        )
    }
