...
impl ListSourceRepositoryBranchesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_source_repository_branches::ListSourceRepositoryBranches::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSourceRepositoryBranches {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_source_repository_branches::de_list_source_repository_branches_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListSourceRepositoryBranchesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesError
{
