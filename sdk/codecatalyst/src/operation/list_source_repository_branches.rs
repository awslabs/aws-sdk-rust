...
impl ListSourceRepositoryBranchesInput {
    /// Consumes the builder and constructs an Operation<[`ListSourceRepositoryBranches`](crate::operation::list_source_repository_branches::ListSourceRepositoryBranches)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_source_repository_branches::ListSourceRepositoryBranches, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_source_repository_branches::ser_list_source_repository_branches_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_source_repository_branches::ListSourceRepositoryBranches::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSourceRepositoryBranches {
                type Output = std::result::Result<crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesOutput, crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesError>;
