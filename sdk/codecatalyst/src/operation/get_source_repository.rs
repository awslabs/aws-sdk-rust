...
impl GetSourceRepositoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_source_repository::GetSourceRepository::new(),
        )
...
/// `ParseStrictResponse` impl for `GetSourceRepository`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSourceRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_source_repository::de_get_source_repository_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_source_repository::GetSourceRepositoryError
{
