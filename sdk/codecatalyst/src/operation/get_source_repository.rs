...
impl GetSourceRepositoryInput {
    /// Consumes the builder and constructs an Operation<[`GetSourceRepository`](crate::operation::get_source_repository::GetSourceRepository)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_source_repository::GetSourceRepository::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSourceRepository", "codecatalyst"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSourceRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_source_repository::de_get_source_repository_http_response_with_props(status, headers, body)
        }
    }
}
