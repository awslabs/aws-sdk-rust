    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_dev_environment::StartDevEnvironmentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_dev_environment::StartDevEnvironmentOutput>()
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartDevEnvironment")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDevEnvironment")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartDevEnvironmentTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartDevEnvironmentTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartDevEnvironmentTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartDevEnvironmentInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartDevEnvironmentResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_dev_environment::de_start_dev_environment_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_dev_environment::de_start_dev_environment_http_response(status, headers, body, _cfg)
        };
