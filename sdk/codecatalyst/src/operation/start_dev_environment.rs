...
impl StartDevEnvironmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_dev_environment::ser_start_dev_environment_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_dev_environment::StartDevEnvironment::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_dev_environment::StartDevEnvironmentError
{
