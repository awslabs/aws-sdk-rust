...
impl GetSourceRepositoryCloneUrlsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrls::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSourceRepositoryCloneUrls {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_source_repository_clone_urls::de_get_source_repository_clone_urls_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetSourceRepositoryCloneUrlsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsError
{
