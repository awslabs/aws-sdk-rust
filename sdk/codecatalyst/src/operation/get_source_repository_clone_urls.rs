    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSourceRepositoryCloneUrls {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetSourceRepositoryCloneUrlsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetSourceRepositoryCloneUrlsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetSourceRepositoryCloneUrls")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSourceRepositoryCloneUrls")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetSourceRepositoryCloneUrlsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetSourceRepositoryCloneUrlsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSourceRepositoryCloneUrlsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetSourceRepositoryCloneUrlsInput>() else {
        ...
        if requested.should_capture("sourceRepositoryName") {
            if let ::std::option::Option::Some(value) = input.source_repository_name.as_deref() {
                captured.insert("sourceRepositoryName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSourceRepositoryCloneUrlsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_source_repository_clone_urls::de_get_source_repository_clone_urls_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_source_repository_clone_urls::de_get_source_repository_clone_urls_http_response(
