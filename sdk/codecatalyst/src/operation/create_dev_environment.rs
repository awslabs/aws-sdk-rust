...
impl CreateDevEnvironmentInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_dev_environment::ser_create_dev_environment_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_dev_environment::CreateDevEnvironment::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_dev_environment::CreateDevEnvironmentError
{
