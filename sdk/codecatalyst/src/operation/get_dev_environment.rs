...
impl GetDevEnvironmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_dev_environment::GetDevEnvironment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDevEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_dev_environment::de_get_dev_environment_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_dev_environment::GetDevEnvironmentError
{
