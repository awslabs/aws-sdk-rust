...
impl GetDevEnvironmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_dev_environment::GetDevEnvironment,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDevEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_dev_environment::de_get_dev_environment_http_response_with_props(status, headers, body)
        }
    }
}
