...
impl GetDevEnvironmentInput {
    /// Consumes the builder and constructs an Operation<[`GetDevEnvironment`](crate::operation::get_dev_environment::GetDevEnvironment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_dev_environment::GetDevEnvironment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_dev_environment::GetDevEnvironmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_dev_environment::GetDevEnvironment::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDevEnvironment {
                type Output = std::result::Result<crate::operation::get_dev_environment::GetDevEnvironmentOutput, crate::operation::get_dev_environment::GetDevEnvironmentError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_dev_environment::de_get_dev_environment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_dev_environment::de_get_dev_environment_http_response(response)
                     }
                }
            }
