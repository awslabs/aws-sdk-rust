    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_source_repository::CreateSourceRepositoryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_source_repository::CreateSourceRepositoryOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSourceRepository {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateSourceRepository", "codecatalyst"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSourceRepository")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateSourceRepositoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateSourceRepositoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_source_repository::CreateSourceRepositoryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_source_repository::ser_create_source_repository_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateSourceRepositoryEndpointParamsInterceptor {
...
pub type CreateSourceRepositoryErrorKind = CreateSourceRepositoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateSourceRepositoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_source_repository::CreateSourceRepositoryError {
...
impl CreateSourceRepositoryError {
    ...
    /// Creates the `CreateSourceRepositoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
