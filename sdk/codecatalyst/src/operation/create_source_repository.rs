...
impl CreateSourceRepositoryInput {
    /// Consumes the builder and constructs an Operation<[`CreateSourceRepository`](crate::operation::create_source_repository::CreateSourceRepository)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_source_repository::CreateSourceRepository::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSourceRepository", "codecatalyst"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSourceRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_source_repository::de_create_source_repository_http_response_with_props(status, headers, body)
        }
    }
}
