...
impl ListAccessTokensInput {
    /// Consumes the builder and constructs an Operation<[`ListAccessTokens`](crate::operation::list_access_tokens::ListAccessTokens)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_access_tokens::ListAccessTokens, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_access_tokens::ListAccessTokensInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_access_tokens::ser_list_access_tokens_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_access_tokens::ListAccessTokens::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessTokens {
                type Output = std::result::Result<crate::operation::list_access_tokens::ListAccessTokensOutput, crate::operation::list_access_tokens::ListAccessTokensError>;
