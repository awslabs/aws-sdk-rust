...
impl StartDevEnvironmentSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_dev_environment_session::StartDevEnvironmentSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDevEnvironmentSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_dev_environment_session::de_start_dev_environment_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
