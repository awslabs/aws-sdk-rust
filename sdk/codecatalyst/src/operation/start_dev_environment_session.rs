...
impl StartDevEnvironmentSessionInput {
    /// Consumes the builder and constructs an Operation<[`StartDevEnvironmentSession`](crate::operation::start_dev_environment_session::StartDevEnvironmentSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_dev_environment_session::StartDevEnvironmentSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_dev_environment_session::StartDevEnvironmentSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_dev_environment_session::ser_start_dev_environment_session_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_dev_environment_session::StartDevEnvironmentSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartDevEnvironmentSession {
                type Output = std::result::Result<crate::operation::start_dev_environment_session::StartDevEnvironmentSessionOutput, crate::operation::start_dev_environment_session::StartDevEnvironmentSessionError>;
