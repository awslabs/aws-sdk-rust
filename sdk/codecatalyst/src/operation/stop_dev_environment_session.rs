    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopDevEnvironmentSession {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StopDevEnvironmentSession")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopDevEnvironmentSession")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StopDevEnvironmentSessionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StopDevEnvironmentSessionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopDevEnvironmentSessionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopDevEnvironmentSessionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopDevEnvironmentSessionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_dev_environment_session::de_stop_dev_environment_session_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_stop_dev_environment_session::de_stop_dev_environment_session_http_response(status, headers, body, _cfg)
        };
