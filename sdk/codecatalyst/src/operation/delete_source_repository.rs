...
impl DeleteSourceRepositoryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSourceRepository`](crate::operation::delete_source_repository::DeleteSourceRepository)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_source_repository::DeleteSourceRepository,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_source_repository::DeleteSourceRepository::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteSourceRepository", "codecatalyst"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSourceRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_source_repository::de_delete_source_repository_http_response_with_props(status, headers, body)
        }
    }
}
