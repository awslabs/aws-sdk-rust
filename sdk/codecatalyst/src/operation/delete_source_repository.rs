...
impl DeleteSourceRepositoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_source_repository::DeleteSourceRepository::new(),
        )
...
/// `ParseStrictResponse` impl for `DeleteSourceRepository`.
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_source_repository::DeleteSourceRepositoryError
{
