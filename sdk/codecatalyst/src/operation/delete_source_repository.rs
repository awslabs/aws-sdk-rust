    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_source_repository::DeleteSourceRepositoryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_source_repository::DeleteSourceRepositoryOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSourceRepository {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSourceRepository")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteSourceRepositoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteSourceRepositoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_source_repository::DeleteSourceRepositoryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteSourceRepositoryEndpointParamsInterceptor {
...
pub type DeleteSourceRepositoryErrorKind = DeleteSourceRepositoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteSourceRepositoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_source_repository::DeleteSourceRepositoryError {
...
impl DeleteSourceRepositoryError {
    ...
    /// Creates the `DeleteSourceRepositoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
