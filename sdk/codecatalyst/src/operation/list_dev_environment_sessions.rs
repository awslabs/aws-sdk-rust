    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsOutput>()
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListDevEnvironmentSessions")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDevEnvironmentSessions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListDevEnvironmentSessionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListDevEnvironmentSessionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDevEnvironmentSessionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListDevEnvironmentSessionsInput>() else {
        ...
        if requested.should_capture("devEnvironmentId") {
            if let ::std::option::Option::Some(value) = input.dev_environment_id.as_deref() {
                captured.insert("devEnvironmentId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDevEnvironmentSessionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_dev_environment_sessions::de_list_dev_environment_sessions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_dev_environment_sessions::de_list_dev_environment_sessions_http_response(status, headers, body, _cfg)
        };
