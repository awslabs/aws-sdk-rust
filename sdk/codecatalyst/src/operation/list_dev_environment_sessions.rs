...
impl ListDevEnvironmentSessionsInput {
    ...
    > {
        ...
        .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDevEnvironmentSessions", "codecatalyst"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDevEnvironmentSessions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_dev_environment_sessions::de_list_dev_environment_sessions_http_response_with_props(
                status, headers, body,
            )
        }
    }
