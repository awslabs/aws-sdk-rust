    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDevEnvironmentSessions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            ListDevEnvironmentSessionsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            ListDevEnvironmentSessionsResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListDevEnvironmentSessions", "codecatalyst"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDevEnvironmentSessions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListDevEnvironmentSessionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListDevEnvironmentSessionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("dev_environment_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListDevEnvironmentSessionsEndpointParamsInterceptor {
...
pub type ListDevEnvironmentSessionsErrorKind = ListDevEnvironmentSessionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListDevEnvironmentSessionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsError {
...
impl ListDevEnvironmentSessionsError {
    ...
    /// Creates the `ListDevEnvironmentSessionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
