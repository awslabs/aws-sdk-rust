...
pub struct CreateSourceRepositoryFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_source_repository::builders::CreateSourceRepositoryInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_source_repository::CreateSourceRepositoryOutput,
                    crate::operation::create_source_repository::CreateSourceRepositoryError,
                > for CreateSourceRepositoryFluentBuilder
            {
                fn send(
                    self,
...
impl CreateSourceRepositoryFluentBuilder {
    ...
    /// Access the CreateSourceRepository as a reference.
    pub fn as_input(&self) -> &crate::operation::create_source_repository::builders::CreateSourceRepositoryInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_source_repository::CreateSourceRepositoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_source_repository::CreateSourceRepositoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_source_repository::CreateSourceRepository::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_source_repository::CreateSourceRepository::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_source_repository::CreateSourceRepositoryOutput, crate::operation::create_source_repository::CreateSourceRepositoryError, Self> {
