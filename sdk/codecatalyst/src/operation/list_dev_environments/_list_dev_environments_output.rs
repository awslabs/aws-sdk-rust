...
impl ListDevEnvironmentsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_dev_environments::ListDevEnvironmentsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_dev_environments::ListDevEnvironmentsOutput {
                items: self.items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("items", "items was not specified but it is required when building ListDevEnvironmentsOutput")
                    )?
                ,
