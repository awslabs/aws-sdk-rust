...
impl StopDevEnvironmentOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_dev_environment::StopDevEnvironmentOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::stop_dev_environment::StopDevEnvironmentOutput {
                space_name: self.space_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("space_name", "space_name was not specified but it is required when building StopDevEnvironmentOutput")
                    )?
                ,
                project_name: self.project_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("project_name", "project_name was not specified but it is required when building StopDevEnvironmentOutput")
                    )?
                ,
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building StopDevEnvironmentOutput")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building StopDevEnvironmentOutput")
                    )?
                ,
