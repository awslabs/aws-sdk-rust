...
impl StopDevEnvironmentInputBuilder {
    ...
    /// - [`space_name`](crate::operation::stop_dev_environment::builders::StopDevEnvironmentInputBuilder::space_name)
    /// - [`project_name`](crate::operation::stop_dev_environment::builders::StopDevEnvironmentInputBuilder::project_name)
    /// - [`id`](crate::operation::stop_dev_environment::builders::StopDevEnvironmentInputBuilder::id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::stop_dev_environment::StopDevEnvironmentInput {
            space_name: self.space_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "space_name",
                    "space_name was not specified but it is required when building StopDevEnvironmentInput",
                )
            })?,
            project_name: self.project_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "project_name",
                    "project_name was not specified but it is required when building StopDevEnvironmentInput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building StopDevEnvironmentInput",
                )
            })?,
        })
    }
