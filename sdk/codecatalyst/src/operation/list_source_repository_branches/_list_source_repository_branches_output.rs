...
impl ListSourceRepositoryBranchesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesOutput {
                ...
                items: self.items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("items", "items was not specified but it is required when building ListSourceRepositoryBranchesOutput")
                    )?
                ,
