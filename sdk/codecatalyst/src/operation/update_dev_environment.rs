...
impl UpdateDevEnvironmentInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDevEnvironment`](crate::operation::update_dev_environment::UpdateDevEnvironment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_dev_environment::UpdateDevEnvironment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_dev_environment::UpdateDevEnvironmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_dev_environment::ser_update_dev_environment_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_dev_environment::UpdateDevEnvironment::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDevEnvironment {
                type Output = std::result::Result<crate::operation::update_dev_environment::UpdateDevEnvironmentOutput, crate::operation::update_dev_environment::UpdateDevEnvironmentError>;
