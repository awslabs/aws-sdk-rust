...
impl GetSpaceInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.get_space();
...
pub struct GetSpaceFluentBuilder {
...
impl GetSpaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_space::GetSpaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_space::GetSpaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::get_space::GetSpace::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_space::GetSpaceOutput, crate::operation::get_space::GetSpaceError, Self> {
