...
impl ListEventLogsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_event_logs::ListEventLogs::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListEventLogs {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_event_logs::de_list_event_logs_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_event_logs::de_list_event_logs_http_response(
                status, headers, body,
            )
        }
    }
