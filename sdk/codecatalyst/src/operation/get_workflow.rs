...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v1/spaces/{spaceName}/projects/{projectName}/workflows/{id}", spaceName = space_name, projectName = project_name, id = id).expect("formatting should succeed");
