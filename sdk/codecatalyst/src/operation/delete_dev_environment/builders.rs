...
impl DeleteDevEnvironmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_dev_environment::DeleteDevEnvironmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_dev_environment::DeleteDevEnvironmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_dev_environment::DeleteDevEnvironmentOutput, crate::operation::delete_dev_environment::DeleteDevEnvironmentError, Self> {
