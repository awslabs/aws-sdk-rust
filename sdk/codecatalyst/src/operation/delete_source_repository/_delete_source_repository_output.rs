...
impl DeleteSourceRepositoryOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_source_repository::DeleteSourceRepositoryOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_source_repository::DeleteSourceRepositoryOutput {
                space_name: self.space_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("space_name", "space_name was not specified but it is required when building DeleteSourceRepositoryOutput")
                    )?
                ,
                project_name: self.project_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("project_name", "project_name was not specified but it is required when building DeleteSourceRepositoryOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building DeleteSourceRepositoryOutput")
                    )?
                ,
