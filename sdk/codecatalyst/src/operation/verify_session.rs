...
impl VerifySession {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::verify_session::VerifySessionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::verify_session::VerifySessionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeCatalyst", "VerifySession", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for VerifySession {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("VerifySession")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifySessionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_verify_session::de_verify_session_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_verify_session::de_verify_session_http_response(status, headers, body, _cfg)
        };
