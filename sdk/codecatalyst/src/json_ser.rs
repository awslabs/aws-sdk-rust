...
pub fn serialize_structure_crate_input_create_access_token_input(
...
pub fn serialize_structure_crate_input_create_dev_environment_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
        ...
        for item_7 in var_5 {
            {
                ...
                crate::json_ser::serialize_structure_crate_model_ide_configuration(
                    &mut object_8,
                    item_7,
                )?;
                object_8.finish();
    ...
    if let Some(var_10) = &input.persistent_storage {
        ...
        crate::json_ser::serialize_structure_crate_model_persistent_storage_configuration(
            &mut object_11,
            var_10,
        )?;
        object_11.finish();
        ...
        for item_14 in var_12 {
            {
                ...
                crate::json_ser::serialize_structure_crate_model_repository_input(
                    &mut object_15,
                    item_14,
                )?;
                object_15.finish();
...
pub fn serialize_structure_crate_input_create_source_repository_branch_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_list_access_tokens_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_list_dev_environments_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_list_event_logs_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_27) = &input.end_time {
        object
            .key("endTime")
            .date_time(var_27, aws_smithy_types::date_time::Format::DateTime)?;
    }
    ...
    if let Some(var_31) = &input.start_time {
        object
            .key("startTime")
            .date_time(var_31, aws_smithy_types::date_time::Format::DateTime)?;
    }
    Ok(())
}
        ...
        for item_34 in var_32 {
            {
                ...
                crate::json_ser::serialize_structure_crate_model_project_list_filter(
                    &mut object_35,
                    item_34,
                )?;
                object_35.finish();
...
pub fn serialize_structure_crate_input_list_source_repositories_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_list_source_repository_branches_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_start_dev_environment_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_start_dev_environment_session_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_48) = &input.session_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_dev_environment_session_configuration(
            &mut object_49,
            var_48,
        )?;
        object_49.finish();
...
pub fn serialize_structure_crate_input_update_dev_environment_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_ide_configuration(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::IdeConfiguration,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_persistent_storage_configuration(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_repository_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::RepositoryInput,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_project_list_filter(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_dev_environment_session_configuration(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_73) = &input.execute_command_session_configuration {
        ...
        let mut object_74 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_crate_model_execute_command_session_configuration(
            &mut object_74,
            var_73,
        )?;
        object_74.finish();
...
pub fn serialize_structure_crate_model_execute_command_session_configuration(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
