...
impl Builder {
    ...
    /// Sets the access token provider for this service
                            ...
                            pub fn token_provider(mut self, token_provider: impl crate::config::ProvideToken + 'static) -> Self {
                                self.set_token_provider(::std::option::Option::Some(::aws_smithy_runtime_api::shared::IntoShared::<crate::config::SharedTokenProvider>::into_shared(token_provider)));
                                self
                            }
                            ...
                            pub fn set_token_provider(&mut self, token_provider: ::std::option::Option<crate::config::SharedTokenProvider>) -> &mut Self {
                                if let Some(token_provider) = token_provider {
                                    self.runtime_components.set_identity_resolver(::aws_smithy_runtime_api::client::auth::http::HTTP_BEARER_AUTH_SCHEME_ID, token_provider);
                                }
                                self
                            }
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("aws_sdk_codecatalyst::config::Config").freeze(),
                                    cloneable: layer,
...
#[derive(::std::fmt::Debug)]
            ...
            impl ServiceRuntimePlugin {
                pub fn new(_service_config: crate::config::Config) -> Self {
                    let config = { let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CodeCatalyst");
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_codecatalyst::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
                    ...
                    let mut plugins = ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins::new()
                        ...
                        .with_client_plugins(::aws_smithy_runtime::client::defaults::default_plugins(
                            ::aws_smithy_runtime::client::defaults::DefaultPluginParams::new()
                                .with_retry_partition_name("codecatalyst")
