...
impl super::Client {
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::delete_dev_environment::builders::DeleteDevEnvironmentFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::delete_dev_environment::builders::DeleteDevEnvironmentFluentBuilder::set_space_name): <p>The name of the space.</p>
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::delete_dev_environment::builders::DeleteDevEnvironmentFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::delete_dev_environment::builders::DeleteDevEnvironmentFluentBuilder::set_project_name): <p>The name of the project in the space.</p>
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_dev_environment::builders::DeleteDevEnvironmentFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_dev_environment::builders::DeleteDevEnvironmentFluentBuilder::set_id): <p>The system-generated unique ID of the Dev Environment you want to delete. To retrieve a list of Dev Environment IDs, use <code>ListDevEnvironments</code>.</p>
