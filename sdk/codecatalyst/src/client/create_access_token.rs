...
impl super::Client {
    ...
    ///   - [`name(String)`](crate::operation::create_access_token::CreateAccessTokenOutput::name): <p>The friendly name of the personal access token.</p>
    ...
    ///   - [`access_token_id(String)`](crate::operation::create_access_token::CreateAccessTokenOutput::access_token_id): <p>The system-generated unique ID of the access token.</p>
