...
impl super::Client {
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::get_subscription::builders::GetSubscriptionFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::get_subscription::builders::GetSubscriptionFluentBuilder::set_space_name): <p>The name of the space.</p>
