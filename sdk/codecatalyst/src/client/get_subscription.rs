...
impl super::Client {
    ...
    ///   - [`space_name(impl Into<String>)`](crate::operation::get_subscription::builders::GetSubscriptionFluentBuilder::space_name) / [`set_space_name(impl Into<String>)`](crate::operation::get_subscription::builders::GetSubscriptionFluentBuilder::set_space_name):<br>required: **true**<br><p>The name of the space.</p><br>
