...
impl super::Client {
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::set_space_name): <p>The name of the space.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::set_display_name): <p>The friendly name of the project that will be displayed to users.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::set_description): <p>The description of the project. This description will be displayed to all users of the project. We recommend providing a brief description of the project and its intended purpose.</p>
