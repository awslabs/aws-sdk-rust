...
impl super::Client {
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::list_projects::builders::ListProjectsFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::list_projects::builders::ListProjectsFluentBuilder::set_space_name): <p>The name of the space.</p>
