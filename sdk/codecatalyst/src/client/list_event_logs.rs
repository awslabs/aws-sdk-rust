...
impl super::Client {
    ...
    ///   - [`space_name(impl Into<String>)`](crate::operation::list_event_logs::builders::ListEventLogsFluentBuilder::space_name) / [`set_space_name(impl Into<String>)`](crate::operation::list_event_logs::builders::ListEventLogsFluentBuilder::set_space_name):<br>required: **true**<br><p>The name of the space.</p><br>
