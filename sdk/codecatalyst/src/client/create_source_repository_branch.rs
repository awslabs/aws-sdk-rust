...
impl super::Client {
    ...
    ///   - [`space_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::space_name) / [`set_space_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::set_space_name):<br>required: **true**<br><p>The name of the space.</p><br>
    ///   - [`project_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::project_name) / [`set_project_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::set_project_name):<br>required: **true**<br><p>The name of the project in the space.</p><br>
    ///   - [`source_repository_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::source_repository_name) / [`set_source_repository_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::set_source_repository_name):<br>required: **true**<br><p>The name of the repository where you want to create a branch.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::set_name):<br>required: **true**<br><p>The name for the branch you're creating.</p><br>
    ///   - [`head_commit_id(impl Into<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::head_commit_id) / [`set_head_commit_id(Option<String>)`](crate::operation::create_source_repository_branch::builders::CreateSourceRepositoryBranchFluentBuilder::set_head_commit_id):<br>required: **false**<br><p>The commit ID in an existing branch from which you want to create the new branch.</p><br>
