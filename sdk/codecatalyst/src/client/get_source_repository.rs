...
impl super::Client {
    ...
    ///   - [`space_name(impl Into<String>)`](crate::operation::get_source_repository::builders::GetSourceRepositoryFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::get_source_repository::builders::GetSourceRepositoryFluentBuilder::set_space_name): <p>The name of the space.</p>
    ///   - [`project_name(impl Into<String>)`](crate::operation::get_source_repository::builders::GetSourceRepositoryFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::get_source_repository::builders::GetSourceRepositoryFluentBuilder::set_project_name): <p>The name of the project in the space.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::get_source_repository::builders::GetSourceRepositoryFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_source_repository::builders::GetSourceRepositoryFluentBuilder::set_name): <p>The name of the source repository.</p>
    ...
    ///   - [`space_name(Option<String>)`](crate::operation::get_source_repository::GetSourceRepositoryOutput::space_name): <p>The name of the space.</p>
    ///   - [`project_name(Option<String>)`](crate::operation::get_source_repository::GetSourceRepositoryOutput::project_name): <p>The name of the project in the space.</p>
    ///   - [`name(Option<String>)`](crate::operation::get_source_repository::GetSourceRepositoryOutput::name): <p>The name of the source repository.</p>
