...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::set_name): <p>The name of the space.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_space::builders::UpdateSpaceFluentBuilder::set_description): <p>The description of the space.</p>
