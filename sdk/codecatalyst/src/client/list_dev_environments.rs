...
impl super::Client {
    ...
    ///   - [`space_name(impl Into<String>)`](crate::operation::list_dev_environments::builders::ListDevEnvironmentsFluentBuilder::space_name) / [`set_space_name(impl Into<String>)`](crate::operation::list_dev_environments::builders::ListDevEnvironmentsFluentBuilder::set_space_name):<br>required: **true**<br><p>The name of the space.</p><br>
    ///   - [`project_name(impl Into<String>)`](crate::operation::list_dev_environments::builders::ListDevEnvironmentsFluentBuilder::project_name) / [`set_project_name(impl Into<String>)`](crate::operation::list_dev_environments::builders::ListDevEnvironmentsFluentBuilder::set_project_name):<br>required: **true**<br><p>The name of the project in the space.</p><br>
