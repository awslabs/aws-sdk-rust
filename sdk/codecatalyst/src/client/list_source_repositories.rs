...
impl super::Client {
    ...
    ///   - [`space_name(impl Into<String>)`](crate::operation::list_source_repositories::builders::ListSourceRepositoriesFluentBuilder::space_name) / [`set_space_name(impl Into<String>)`](crate::operation::list_source_repositories::builders::ListSourceRepositoriesFluentBuilder::set_space_name):<br>required: **true**<br><p>The name of the space.</p><br>
    ///   - [`project_name(impl Into<String>)`](crate::operation::list_source_repositories::builders::ListSourceRepositoriesFluentBuilder::project_name) / [`set_project_name(impl Into<String>)`](crate::operation::list_source_repositories::builders::ListSourceRepositoriesFluentBuilder::set_project_name):<br>required: **true**<br><p>The name of the project in the space.</p><br>
