...
impl super::Client {
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::get_dev_environment::builders::GetDevEnvironmentFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::get_dev_environment::builders::GetDevEnvironmentFluentBuilder::set_space_name): <p>The name of the space.</p>
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::get_dev_environment::builders::GetDevEnvironmentFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::get_dev_environment::builders::GetDevEnvironmentFluentBuilder::set_project_name): <p>The name of the project in the space.</p>
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_dev_environment::builders::GetDevEnvironmentFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_dev_environment::builders::GetDevEnvironmentFluentBuilder::set_id): <p>The system-generated unique ID of the Dev Environment for which you want to view information. To retrieve a list of Dev Environment IDs, use <code>ListDevEnvironments</code>.</p>
