...
impl super::Client  {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_access_token::builders::DeleteAccessTokenFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_access_token::builders::DeleteAccessTokenFluentBuilder::set_id): <p>The ID of the personal access token to delete. You can find the IDs of all PATs associated with your Amazon Web Services Builder ID in a space by calling <code>ListAccessTokens</code>.</p>
