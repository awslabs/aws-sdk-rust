...
pub fn ser_list_dev_environments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_dev_environments::ListDevEnvironmentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
