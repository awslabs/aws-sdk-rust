...
) -> Result<Option<crate::types::EventLogEntry>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "projectInformation" => {
                            builder =
                                builder.set_project_information(crate::protocol_serde::shape_project_information::de_project_information(tokens)?);
                        }
                        "requestId" => {
                        ...
                        "requestPayload" => {
                            builder = builder.set_request_payload(crate::protocol_serde::shape_event_payload::de_event_payload(tokens)?);
                        }
                        "responsePayload" => {
                            builder = builder.set_response_payload(crate::protocol_serde::shape_event_payload::de_event_payload(tokens)?);
                        }
                        "errorCode" => {
