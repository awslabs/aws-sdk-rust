...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_dev_environment::de_start_dev_environment(_response_body, output)
            .map_err(crate::operation::start_dev_environment::StartDevEnvironmentError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::start_dev_environment_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::start_dev_environment::StartDevEnvironmentError::unhandled)?
    })
}
