...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_dev_environment_session::StartDevEnvironmentSessionError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_dev_environment_session::de_start_dev_environment_session(_response_body, output)
            .map_err(crate::operation::start_dev_environment_session::StartDevEnvironmentSessionError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::start_dev_environment_session_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::start_dev_environment_session::StartDevEnvironmentSessionError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "accessDetails" => {
                    builder = builder
                        .set_access_details(crate::protocol_serde::shape_dev_environment_access_details::de_dev_environment_access_details(tokens)?);
                }
                "id" => {
