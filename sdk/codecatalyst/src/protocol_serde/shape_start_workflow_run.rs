...
pub fn de_start_workflow_run_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::start_workflow_run::StartWorkflowRunOutput, crate::operation::start_workflow_run::StartWorkflowRunError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_workflow_run::StartWorkflowRunError::unhandled)?;
...
pub fn de_start_workflow_run_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_start_workflow_run::de_start_workflow_run(_response_body, output)
            .map_err(crate::operation::start_workflow_run::StartWorkflowRunError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::start_workflow_run_output_correct_errors(output)
            .build()
            .map_err(crate::operation::start_workflow_run::StartWorkflowRunError::unhandled)?
    })
}
...
pub fn ser_start_workflow_run_input(
    ...
    crate::protocol_serde::shape_start_workflow_run_input::ser_start_workflow_run_input(&mut object, input)?;
    object.finish();
