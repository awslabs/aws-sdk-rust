...
pub fn ser_create_dev_environment_input(
    ...
    crate::protocol_serde::shape_create_dev_environment_input::ser_create_dev_environment_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_dev_environment::CreateDevEnvironmentError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_create_dev_environment::de_create_dev_environment(
