...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_dev_environment::de_update_dev_environment(_response_body, output)
            .map_err(crate::operation::update_dev_environment::UpdateDevEnvironmentError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::update_dev_environment_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::update_dev_environment::UpdateDevEnvironmentError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ides" => {
                    builder = builder.set_ides(crate::protocol_serde::shape_ide_configuration_list::de_ide_configuration_list(tokens)?);
                }
