...
pub fn ser_project_list_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProjectListFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
