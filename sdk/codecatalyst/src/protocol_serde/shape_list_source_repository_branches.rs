...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_source_repository_branches::de_list_source_repository_branches(_response_body, output)
            .map_err(crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_source_repository_branches_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_source_repository_branches::ListSourceRepositoryBranchesError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "items" => {
                    builder = builder.set_items(
                        crate::protocol_serde::shape_list_source_repository_branches_items::de_list_source_repository_branches_items(tokens, _value)?,
                    );
                }
                "nextToken" => {
