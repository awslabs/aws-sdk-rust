...
pub fn de_get_source_repository_clone_urls_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSourceRepositoryCloneUrlsOutput, crate::error::GetSourceRepositoryCloneUrlsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetSourceRepositoryCloneUrlsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_source_repository_clone_urls_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSourceRepositoryCloneUrlsOutput, crate::error::GetSourceRepositoryCloneUrlsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_source_repository_clone_urls(value: &[u8], mut builder: crate::output::get_source_repository_clone_urls_output::Builder) -> Result<crate::output::get_source_repository_clone_urls_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
