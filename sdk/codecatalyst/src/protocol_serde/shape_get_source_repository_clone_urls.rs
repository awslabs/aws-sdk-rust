...
pub fn de_get_source_repository_clone_urls_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsOutput, crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_source_repository_clone_urls_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsOutput, crate::operation::get_source_repository_clone_urls::GetSourceRepositoryCloneUrlsError> {
    Ok({
        #[allow(unused_mut)]
