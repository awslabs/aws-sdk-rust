...
pub fn ser_update_dev_environment_input_input(
    ...
    if let Some(var_7) = &input.inactivity_timeout_minutes {
        object.key("inactivityTimeoutMinutes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
