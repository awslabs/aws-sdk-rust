...
pub fn de_get_workflow_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_workflow_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_workflow::GetWorkflowError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_workflow::builders::GetWorkflowOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "definition" => {
                    builder = builder.set_definition(crate::protocol_serde::shape_workflow_definition::de_workflow_definition(tokens)?);
                }
                "id" => {
