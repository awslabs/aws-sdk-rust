...
impl aws_smithy_http::response::ParseStrictResponse for StartFraudsterRegistrationJob {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_fraudster_registration_job::de_start_fraudster_registration_job_http_response_with_props(status, headers, body)
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::start_fraudster_registration_job::StartFraudsterRegistrationJobError
{
