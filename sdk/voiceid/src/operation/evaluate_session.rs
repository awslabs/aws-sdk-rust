...
impl EvaluateSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::evaluate_session::EvaluateSession, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_evaluate_session::ser_evaluate_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EvaluateSession {
    type Output =
        ::std::result::Result<crate::operation::evaluate_session::EvaluateSessionOutput, crate::operation::evaluate_session::EvaluateSessionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_evaluate_session::de_evaluate_session_http_response_with_props(status, headers, body)
        }
    }
