...
impl StartFraudsterRegistrationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_fraudster_registration_job::StartFraudsterRegistrationJobInput, ::aws_smithy_types::error::operation::BuildError> {
