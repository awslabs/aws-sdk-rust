...
impl DeleteSpeakerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_speaker::DeleteSpeaker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSpeaker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_speaker::de_delete_speaker_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_speaker::de_delete_speaker_http_response_with_props(
                status, headers, body,
            )
        }
    }
