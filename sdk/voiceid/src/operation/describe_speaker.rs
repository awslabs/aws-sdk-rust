...
impl DescribeSpeakerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_speaker::DescribeSpeaker, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_speaker::ser_describe_speaker_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpeaker {
    type Output =
        ::std::result::Result<crate::operation::describe_speaker::DescribeSpeakerOutput, crate::operation::describe_speaker::DescribeSpeakerError>;
