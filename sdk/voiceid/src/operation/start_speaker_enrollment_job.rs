...
impl StartSpeakerEnrollmentJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError
{
