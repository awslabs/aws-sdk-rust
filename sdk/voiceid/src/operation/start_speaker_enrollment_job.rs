...
impl StartSpeakerEnrollmentJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSpeakerEnrollmentJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_speaker_enrollment_job::de_start_speaker_enrollment_job_http_response_with_props(status, headers, body)
        }
    }
