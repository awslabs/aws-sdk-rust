...
/// Orchestration and serialization glue logic for `StartSpeakerEnrollmentJob`.
...
impl StartSpeakerEnrollmentJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobInput,
                    ) -> ::std::result::Result<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartSpeakerEnrollmentJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartSpeakerEnrollmentJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartSpeakerEnrollmentJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartSpeakerEnrollmentJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartSpeakerEnrollmentJob")
...
.with_interceptor(StartSpeakerEnrollmentJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError>::new());
...
#[derive(Debug)]
            struct StartSpeakerEnrollmentJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartSpeakerEnrollmentJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_speaker_enrollment_job::de_start_speaker_enrollment_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StartSpeakerEnrollmentJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartSpeakerEnrollmentJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_speaker_enrollment_job::ser_start_speaker_enrollment_job_input(&input)?);
...
#[derive(Debug)]
            struct StartSpeakerEnrollmentJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartSpeakerEnrollmentJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartSpeakerEnrollmentJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartSpeakerEnrollmentJobInput>()
                        .ok_or("failed to downcast to StartSpeakerEnrollmentJobInput")?;
...
pub enum StartSpeakerEnrollmentJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartSpeakerEnrollmentJobError) for what information is available for the error.")]
...
impl StartSpeakerEnrollmentJobError {
    /// Creates the `StartSpeakerEnrollmentJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartSpeakerEnrollmentJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartSpeakerEnrollmentJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobError {
...
mod _start_speaker_enrollment_job_output;
