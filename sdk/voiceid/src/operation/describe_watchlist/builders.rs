...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_watchlist::DescribeWatchlistOutput,
                    crate::operation::describe_watchlist::DescribeWatchlistError,
                > for DescribeWatchlistFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeWatchlistFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_watchlist::DescribeWatchlistOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_watchlist::DescribeWatchlistError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_watchlist::DescribeWatchlistOutput, crate::operation::describe_watchlist::DescribeWatchlistError, Self> {
