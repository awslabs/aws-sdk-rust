...
impl DisassociateFraudsterFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::disassociate_fraudster::DisassociateFraudsterOutput, aws_smithy_http::result::SdkError<crate::operation::disassociate_fraudster::DisassociateFraudsterError>>
                     {
