...
impl DescribeFraudsterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_fraudster::ser_describe_fraudster_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFraudster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fraudster::de_describe_fraudster_http_response_with_props(status, headers, body)
        }
    }
}
