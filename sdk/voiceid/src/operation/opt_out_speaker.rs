...
impl OptOutSpeakerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::opt_out_speaker::OptOutSpeaker, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_opt_out_speaker::ser_opt_out_speaker_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for OptOutSpeaker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_opt_out_speaker::de_opt_out_speaker_http_response_with_props(status, headers, body)
        }
    }
