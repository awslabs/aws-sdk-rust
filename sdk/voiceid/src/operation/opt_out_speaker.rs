...
impl OptOutSpeakerInput {
    /// Consumes the builder and constructs an Operation<[`OptOutSpeaker`](crate::operation::opt_out_speaker::OptOutSpeaker)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::opt_out_speaker::OptOutSpeaker, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::opt_out_speaker::OptOutSpeakerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_opt_out_speaker::ser_opt_out_speaker_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::opt_out_speaker::OptOutSpeaker::new())
...
impl aws_smithy_http::response::ParseStrictResponse for OptOutSpeaker {
                type Output = std::result::Result<crate::operation::opt_out_speaker::OptOutSpeakerOutput, crate::operation::opt_out_speaker::OptOutSpeakerError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_opt_out_speaker::de_opt_out_speaker_http_error(response)
                     } else {
                        crate::protocol_serde::shape_opt_out_speaker::de_opt_out_speaker_http_response(response)
                     }
                }
            }
