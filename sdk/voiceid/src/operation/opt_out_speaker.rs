...
impl OptOutSpeakerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::opt_out_speaker::OptOutSpeaker,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::opt_out_speaker::OptOutSpeaker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for OptOutSpeaker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_opt_out_speaker::de_opt_out_speaker_http_error(
                status, headers, body,
            )
        } else {
