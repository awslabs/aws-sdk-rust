...
impl ListFraudsterRegistrationJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_fraudster_registration_jobs::ListFraudsterRegistrationJobsInput, ::aws_smithy_types::error::operation::BuildError> {
