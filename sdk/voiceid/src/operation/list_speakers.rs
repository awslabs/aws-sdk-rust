...
impl ListSpeakersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_speakers::ListSpeakers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_speakers::ser_list_speakers_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSpeakers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_speakers::de_list_speakers_http_response_with_props(status, headers, body)
        }
    }
