...
impl ListSpeakerEnrollmentJobsInputBuilder {
    ...
    /// - [`domain_id`](crate::operation::list_speaker_enrollment_jobs::builders::ListSpeakerEnrollmentJobsInputBuilder::domain_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<
        ...
        ::std::result::Result::Ok(crate::operation::list_speaker_enrollment_jobs::ListSpeakerEnrollmentJobsInput {
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building ListSpeakerEnrollmentJobsInput",
                )
            })?,
