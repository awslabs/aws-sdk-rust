...
impl DescribeFraudsterRegistrationJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fraudster_registration_job::DescribeFraudsterRegistrationJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFraudsterRegistrationJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fraudster_registration_job::de_describe_fraudster_registration_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
