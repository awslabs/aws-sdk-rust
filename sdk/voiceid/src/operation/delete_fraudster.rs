...
impl DeleteFraudsterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_fraudster::DeleteFraudster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_fraudster::ser_delete_fraudster_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFraudster {
    type Output =
        ::std::result::Result<crate::operation::delete_fraudster::DeleteFraudsterOutput, crate::operation::delete_fraudster::DeleteFraudsterError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_fraudster::de_delete_fraudster_http_response_with_props(status, headers, body)
        }
    }
}
