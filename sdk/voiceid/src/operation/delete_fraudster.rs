...
impl DeleteFraudsterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_fraudster::DeleteFraudster,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_fraudster::DeleteFraudster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFraudster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_fraudster::de_delete_fraudster_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_fraudster::DeleteFraudsterError
{
