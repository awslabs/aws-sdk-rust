...
impl ListSpeakerEnrollmentJobsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_speaker_enrollment_jobs::ListSpeakerEnrollmentJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSpeakerEnrollmentJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_speaker_enrollment_jobs::de_list_speaker_enrollment_jobs_http_response_with_props(status, headers, body)
        }
    }
