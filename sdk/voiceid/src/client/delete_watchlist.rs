...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::delete_watchlist::builders::DeleteWatchlistFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::delete_watchlist::builders::DeleteWatchlistFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the watchlist.</p>
