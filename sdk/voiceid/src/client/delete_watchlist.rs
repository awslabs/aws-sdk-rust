...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::delete_watchlist::builders::DeleteWatchlistFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::delete_watchlist::builders::DeleteWatchlistFluentBuilder::set_domain_id):<br>required: **true**<br><p>The identifier of the domain that contains the watchlist.</p><br>
    ///   - [`watchlist_id(impl Into<String>)`](crate::operation::delete_watchlist::builders::DeleteWatchlistFluentBuilder::watchlist_id) / [`set_watchlist_id(impl Into<String>)`](crate::operation::delete_watchlist::builders::DeleteWatchlistFluentBuilder::set_watchlist_id):<br>required: **true**<br><p>The identifier of the watchlist to be deleted.</p><br>
