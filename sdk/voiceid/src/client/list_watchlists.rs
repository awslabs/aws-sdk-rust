...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::set_domain_id): <p>The identifier of the domain.</p>
    ...
    pub fn list_watchlists(
        &self,
    ) -> crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder {
        crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
