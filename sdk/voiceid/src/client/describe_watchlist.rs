...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::describe_watchlist::builders::DescribeWatchlistFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::describe_watchlist::builders::DescribeWatchlistFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the watchlist.</p>
    ///   - [`watchlist_id(impl Into<String>)`](crate::operation::describe_watchlist::builders::DescribeWatchlistFluentBuilder::watchlist_id) / [`set_watchlist_id(Option<String>)`](crate::operation::describe_watchlist::builders::DescribeWatchlistFluentBuilder::set_watchlist_id): <p>The identifier of the watchlist that you are describing.</p>
