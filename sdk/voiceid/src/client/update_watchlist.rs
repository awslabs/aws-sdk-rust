...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::update_watchlist::builders::UpdateWatchlistFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::update_watchlist::builders::UpdateWatchlistFluentBuilder::set_domain_id):<br>required: **true**<br><p>The identifier of the domain that contains the watchlist.</p><br>
    ///   - [`watchlist_id(impl Into<String>)`](crate::operation::update_watchlist::builders::UpdateWatchlistFluentBuilder::watchlist_id) / [`set_watchlist_id(impl Into<String>)`](crate::operation::update_watchlist::builders::UpdateWatchlistFluentBuilder::set_watchlist_id):<br>required: **true**<br><p>The identifier of the watchlist to be updated.</p><br>
