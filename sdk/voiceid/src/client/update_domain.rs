...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::update_domain::builders::UpdateDomainFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_domain::builders::UpdateDomainFluentBuilder::set_description): <p>A brief description about this domain.</p>
