...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the fraudster registration Jobs.</p>
    ///   - [`job_status(FraudsterRegistrationJobStatus)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::job_status) / [`set_job_status(Option<FraudsterRegistrationJobStatus>)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::set_job_status): <p>Provides the status of your fraudster registration job.</p>
    ///   - [`max_results(i32)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::set_max_results): <p>The maximum number of results that are returned per call. You can use <code>NextToken</code> to obtain more pages of results. The default is 100; the maximum allowed page size is also 100. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_fraudster_registration_jobs::builders::ListFraudsterRegistrationJobsFluentBuilder::set_next_token): <p>If <code>NextToken</code> is returned, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours.</p>
