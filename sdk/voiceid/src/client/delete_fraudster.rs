...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::delete_fraudster::builders::DeleteFraudsterFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::delete_fraudster::builders::DeleteFraudsterFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the fraudster.</p>
