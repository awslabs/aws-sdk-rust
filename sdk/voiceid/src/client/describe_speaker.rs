...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::describe_speaker::builders::DescribeSpeakerFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::describe_speaker::builders::DescribeSpeakerFluentBuilder::set_domain_id):<br>required: **true**<br><p>The identifier of the domain that contains the speaker.</p><br>
    ///   - [`speaker_id(impl Into<String>)`](crate::operation::describe_speaker::builders::DescribeSpeakerFluentBuilder::speaker_id) / [`set_speaker_id(impl Into<String>)`](crate::operation::describe_speaker::builders::DescribeSpeakerFluentBuilder::set_speaker_id):<br>required: **true**<br><p>The identifier of the speaker you are describing.</p><br>
