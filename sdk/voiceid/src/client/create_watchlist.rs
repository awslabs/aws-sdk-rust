...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::create_watchlist::builders::CreateWatchlistFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::create_watchlist::builders::CreateWatchlistFluentBuilder::set_domain_id):<br>required: **true**<br><p>The identifier of the domain that contains the watchlist.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_watchlist::builders::CreateWatchlistFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_watchlist::builders::CreateWatchlistFluentBuilder::set_name):<br>required: **true**<br><p>The name of the watchlist.</p><br>
