...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::describe_fraudster_registration_job::builders::DescribeFraudsterRegistrationJobFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::describe_fraudster_registration_job::builders::DescribeFraudsterRegistrationJobFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the fraudster registration job.</p>
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_fraudster_registration_job::builders::DescribeFraudsterRegistrationJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_fraudster_registration_job::builders::DescribeFraudsterRegistrationJobFluentBuilder::set_job_id): <p>The identifier of the fraudster registration job you are describing.</p>
