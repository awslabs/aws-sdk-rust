...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::associate_fraudster::builders::AssociateFraudsterFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::associate_fraudster::builders::AssociateFraudsterFluentBuilder::set_domain_id):<br>required: **true**<br><p>The identifier of the domain that contains the fraudster.</p><br>
    ///   - [`watchlist_id(impl Into<String>)`](crate::operation::associate_fraudster::builders::AssociateFraudsterFluentBuilder::watchlist_id) / [`set_watchlist_id(impl Into<String>)`](crate::operation::associate_fraudster::builders::AssociateFraudsterFluentBuilder::set_watchlist_id):<br>required: **true**<br><p>The identifier of the watchlist you want to associate with the fraudster.</p><br>
    ///   - [`fraudster_id(impl Into<String>)`](crate::operation::associate_fraudster::builders::AssociateFraudsterFluentBuilder::fraudster_id) / [`set_fraudster_id(impl Into<String>)`](crate::operation::associate_fraudster::builders::AssociateFraudsterFluentBuilder::set_fraudster_id):<br>required: **true**<br><p>The identifier of the fraudster to be associated with the watchlist.</p><br>
