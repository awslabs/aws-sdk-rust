...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::opt_out_speaker::builders::OptOutSpeakerFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::opt_out_speaker::builders::OptOutSpeakerFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the speaker.</p>
    ///   - [`speaker_id(impl ::std::convert::Into<String>)`](crate::operation::opt_out_speaker::builders::OptOutSpeakerFluentBuilder::speaker_id) / [`set_speaker_id(Option<String>)`](crate::operation::opt_out_speaker::builders::OptOutSpeakerFluentBuilder::set_speaker_id): <p>The identifier of the speaker you want opted-out.</p>
