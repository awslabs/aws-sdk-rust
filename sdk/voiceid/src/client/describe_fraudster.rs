...
impl super::Client {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::describe_fraudster::builders::DescribeFraudsterFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::describe_fraudster::builders::DescribeFraudsterFluentBuilder::set_domain_id): <p>The identifier of the domain that contains the fraudster.</p>
    ///   - [`fraudster_id(impl ::std::convert::Into<String>)`](crate::operation::describe_fraudster::builders::DescribeFraudsterFluentBuilder::fraudster_id) / [`set_fraudster_id(Option<String>)`](crate::operation::describe_fraudster::builders::DescribeFraudsterFluentBuilder::set_fraudster_id): <p>The identifier of the fraudster you are describing.</p>
