...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::domain_id) / [`set_domain_id(impl Into<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::set_domain_id):<br>required: **true**<br><p>The identifier of the domain where the session started.</p><br>
    ///   - [`session_name_or_id(impl Into<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::session_name_or_id) / [`set_session_name_or_id(impl Into<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::set_session_name_or_id):<br>required: **true**<br><p>The session identifier, or name of the session, that you want to evaluate. In Voice ID integration, this is the Contact-Id.</p><br>
