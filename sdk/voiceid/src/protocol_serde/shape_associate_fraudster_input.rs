...
pub fn ser_associate_fraudster_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::associate_fraudster::AssociateFraudsterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
