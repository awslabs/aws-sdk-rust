...
pub fn ser_list_fraudsters_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_fraudsters::ListFraudstersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
