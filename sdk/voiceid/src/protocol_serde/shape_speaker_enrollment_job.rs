...
pub(crate) fn de_speaker_enrollment_job<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SpeakerEnrollmentJob>, aws_smithy_json::deserialize::error::DeserializeError>
