...
pub fn ser_list_speaker_enrollment_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSpeakerEnrollmentJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
