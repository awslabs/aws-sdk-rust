            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RegistrationConfig" => {
                            builder = builder
                                .set_registration_config(crate::protocol_serde::shape_registration_config::de_registration_config(tokens, _value)?);
                        }
                        "InputDataConfig" => {
                            builder =
                        ...
                        "JobProgress" => {
                            builder = builder.set_job_progress(crate::protocol_serde::shape_job_progress::de_job_progress(tokens, _value)?);
                        }
