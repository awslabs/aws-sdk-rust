...
pub fn ser_disassociate_fraudster_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::disassociate_fraudster::DisassociateFraudsterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
