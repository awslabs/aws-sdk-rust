...
pub(crate) fn de_fraud_detection_result<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::FraudDetectionResult>, aws_smithy_json::deserialize::error::DeserializeError>
