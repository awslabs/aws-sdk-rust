...
pub struct DomainSummary  {
    ...
    #[doc(hidden)]pub server_side_encryption_update_details: std::option::Option<crate::model::ServerSideEncryptionUpdateDetails>,
}
impl DomainSummary {
    /// <p>The service-generated identifier for the domain.</p>
...
pub struct ServerSideEncryptionUpdateDetails  {
    ...
    #[doc(hidden)]pub old_kms_key_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub update_status: std::option::Option<crate::model::ServerSideEncryptionUpdateStatus>,
...
pub struct SpeakerEnrollmentJob  {
    ...
    #[doc(hidden)]pub job_status: std::option::Option<crate::model::SpeakerEnrollmentJobStatus>,
    ...
    #[doc(hidden)]pub enrollment_config: std::option::Option<crate::model::EnrollmentConfig>,
    ...
    #[doc(hidden)]pub job_progress: std::option::Option<crate::model::JobProgress>,
}
...
pub struct EnrollmentConfig  {
    ...
    #[doc(hidden)]pub existing_enrollment_action: std::option::Option<crate::model::ExistingEnrollmentAction>,
    /// <p>The fraud detection configuration to use for the speaker enrollment job.</p>
    #[doc(hidden)]pub fraud_detection_config: std::option::Option<crate::model::EnrollmentJobFraudDetectionConfig>,
}
...
impl  std::fmt::Debug for EnrollmentConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("existing_enrollment_action", &self.existing_enrollment_action);
...
pub struct EnrollmentJobFraudDetectionConfig  {
    ...
    #[doc(hidden)]pub fraud_detection_action: std::option::Option<crate::model::FraudDetectionAction>,
    ...
    #[doc(hidden)]pub risk_threshold: std::option::Option<i32>,
}
...
pub struct FraudsterRegistrationJob  {
    ...
    #[doc(hidden)]pub job_status: std::option::Option<crate::model::FraudsterRegistrationJobStatus>,
...
pub struct RegistrationConfig  {
    ...
    #[doc(hidden)]pub duplicate_registration_action: std::option::Option<crate::model::DuplicateRegistrationAction>,
    /// <p>The minimum similarity score between the new and old fraudsters in order to consider the new fraudster a duplicate.</p>
    #[doc(hidden)]pub fraudster_similarity_threshold: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for RegistrationConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("duplicate_registration_action", &self.duplicate_registration_action);
        formatter.field("fraudster_similarity_threshold", &self.fraudster_similarity_threshold);
        formatter.finish()
    }
}
...
pub struct Speaker  {
    ...
    #[doc(hidden)]pub customer_speaker_id: std::option::Option<std::string::String>,
    /// <p>The service-generated identifier for the speaker.</p>
    #[doc(hidden)]pub generated_speaker_id: std::option::Option<std::string::String>,
    /// <p>The current status of the speaker.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::SpeakerStatus>,
    ...
    #[doc(hidden)]pub last_accessed_at: std::option::Option<aws_smithy_types::DateTime>,
}
impl Speaker {
    /// <p>The identifier of the domain that contains the speaker.</p>
    pub fn domain_id(&self) -> std::option::Option<& str> {
...
pub struct FraudDetectionResult  {
    ...
    #[doc(hidden)]pub fraud_detection_result_id: std::option::Option<std::string::String>,
    /// <p>A timestamp indicating when audio aggregation started for this fraud detection result.</p>
    #[doc(hidden)]pub audio_aggregation_started_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A timestamp indicating when audio aggregation ended for this fraud detection result.</p>
    #[doc(hidden)]pub audio_aggregation_ended_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The <code>FraudDetectionConfiguration</code> used to generate this fraud detection result.</p>
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::FraudDetectionConfiguration>,
    ...
    #[doc(hidden)]pub decision: std::option::Option<crate::model::FraudDetectionDecision>,
    ...
    #[doc(hidden)]pub reasons: std::option::Option<std::vec::Vec<crate::model::FraudDetectionReason>>,
    ...
    #[doc(hidden)]pub risk_details: std::option::Option<crate::model::FraudRiskDetails>,
}
...
pub struct FraudRiskDetails  {
    ...
    #[doc(hidden)]pub known_fraudster_risk: std::option::Option<crate::model::KnownFraudsterRisk>,
    /// <p>The details resulting from 'Voice Spoofing Risk' analysis of the speaker.</p>
    #[doc(hidden)]pub voice_spoofing_risk: std::option::Option<crate::model::VoiceSpoofingRisk>,
}
...
pub struct VoiceSpoofingRisk  {
    ...
    #[doc(hidden)]pub risk_score: std::option::Option<i32>,
}
...
pub struct KnownFraudsterRisk  {
    ...
    #[doc(hidden)]pub generated_fraudster_id: std::option::Option<std::string::String>,
}
...
pub struct AuthenticationResult  {
    ...
    #[doc(hidden)]pub authentication_result_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub decision: std::option::Option<crate::model::AuthenticationDecision>,
    ...
    #[doc(hidden)]pub score: std::option::Option<i32>,
    /// <p>The <code>AuthenticationConfiguration</code> used to generate this authentication result.</p>
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::AuthenticationConfiguration>,
}
...
pub struct AuthenticationConfiguration  {
    ...
    #[doc(hidden)]pub acceptance_threshold: std::option::Option<i32>,
}
