...
pub fn serialize_structure_crate_input_list_linux_subscription_instances_input(
...
pub fn serialize_structure_crate_input_list_linux_subscriptions_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_update_service_settings_input(
    ...
    if let Some(var_15) = &input.linux_subscriptions_discovery_settings {
        ...
        let mut object_16 = object
            .key("LinuxSubscriptionsDiscoverySettings")
            .start_object();
        crate::json_ser::serialize_structure_crate_model_linux_subscriptions_discovery_settings(
            &mut object_16,
            var_15,
        )?;
        object_16.finish();
...
pub fn serialize_structure_crate_model_linux_subscriptions_discovery_settings(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
