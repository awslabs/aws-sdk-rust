...
impl ListLinuxSubscriptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_linux_subscriptions::ListLinuxSubscriptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_linux_subscriptions::ListLinuxSubscriptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_linux_subscriptions::ListLinuxSubscriptionsOutput, crate::operation::list_linux_subscriptions::ListLinuxSubscriptionsError, Self> {
