...
impl ListLinuxSubscriptionsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_linux_subscriptions::paginator::ListLinuxSubscriptionsPaginator
    {
        crate::operation::list_linux_subscriptions::paginator::ListLinuxSubscriptionsPaginator::new(
            self.handle,
            self.inner,
        )
    }
