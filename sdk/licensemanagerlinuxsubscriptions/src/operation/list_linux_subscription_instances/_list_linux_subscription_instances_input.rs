...
impl ListLinuxSubscriptionInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_linux_subscription_instances::ListLinuxSubscriptionInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
