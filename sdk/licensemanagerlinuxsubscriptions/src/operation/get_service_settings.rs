...
impl GetServiceSettingsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_service_settings::GetServiceSettings::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetServiceSettings", "licensemanagerlinuxsubscriptions"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_settings::de_get_service_settings_http_response_with_props(status, headers, body)
        }
    }
}
