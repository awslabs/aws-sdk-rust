    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/subscription/GetServiceSettings")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_service_settings::GetServiceSettings::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_service_settings::GetServiceSettingsError
{
