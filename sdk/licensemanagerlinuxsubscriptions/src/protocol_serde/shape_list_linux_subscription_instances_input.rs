...
pub fn ser_list_linux_subscription_instances_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_linux_subscription_instances::ListLinuxSubscriptionInstancesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
