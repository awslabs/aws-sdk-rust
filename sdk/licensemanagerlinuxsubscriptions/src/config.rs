...
/// Configuration for a aws_sdk_licensemanagerlinuxsubscriptions service client.
///
...
impl Builder {
    ...
    /// impl aws_sdk_licensemanagerlinuxsubscriptions::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_licensemanagerlinuxsubscriptions::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_licensemanagerlinuxsubscriptions::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_licensemanagerlinuxsubscriptions::Client::from_conf(config);
    /// ```
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `licensemanagerlinuxsubscriptions`
    /// (or `licensemanagerlinuxsubscriptions-<region>` if a region is configured).
    /// All License Manager Linux Subscriptions clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::Config;
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::Config;
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::IdentityCache;
    ///
    /// let config = aws_sdk_licensemanagerlinuxsubscriptions::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_licensemanagerlinuxsubscriptions::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerlinuxsubscriptions::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_licensemanagerlinuxsubscriptions::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("license-manager-linux-subscriptions"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_licensemanagerlinuxsubscriptions::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("LicenseManagerLinuxSubscriptions");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_licensemanagerlinuxsubscriptions::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "licensemanagerlinuxsubscriptions";
    ...
    let scope = "aws-sdk-licensemanagerlinuxsubscriptions";
