...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_linux_subscriptions::builders::ListLinuxSubscriptionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_linux_subscriptions::builders::ListLinuxSubscriptionsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum items to return in a request.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_linux_subscriptions::builders::ListLinuxSubscriptionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_linux_subscriptions::builders::ListLinuxSubscriptionsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token to specify where to start paginating. This is the nextToken from a previously truncated response.</p><br>
