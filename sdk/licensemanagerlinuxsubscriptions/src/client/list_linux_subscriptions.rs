...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_linux_subscriptions::builders::ListLinuxSubscriptionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_linux_subscriptions::builders::ListLinuxSubscriptionsFluentBuilder::set_next_token): <p>Token for the next set of results.</p>
