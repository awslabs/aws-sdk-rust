...
impl ::std::convert::From<&str> for Destination {
    fn from(s: &str) -> Self {
        match s {
            ...
            "S3" => Destination::S3,
            other => Destination::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Destination {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Destination::from(s))
    }
}
impl Destination {
...
impl ::std::convert::AsRef<str> for Destination {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
