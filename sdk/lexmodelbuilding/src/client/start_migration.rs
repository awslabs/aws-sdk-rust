...
impl super::Client {
    ...
    ///   - [`v1_bot_name(impl ::std::convert::Into<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::v1_bot_name) / [`set_v1_bot_name(Option<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::set_v1_bot_name): <p>The name of the Amazon Lex V1 bot that you are migrating to Amazon Lex V2.</p>
    ///   - [`v1_bot_version(impl ::std::convert::Into<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::v1_bot_version) / [`set_v1_bot_version(Option<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::set_v1_bot_version): <p>The version of the bot to migrate to Amazon Lex V2. You can migrate the <code>$LATEST</code> version as well as any numbered version.</p>
    ///   - [`v2_bot_name(impl ::std::convert::Into<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::v2_bot_name) / [`set_v2_bot_name(Option<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::set_v2_bot_name): <p>The name of the Amazon Lex V2 bot that you are migrating the Amazon Lex V1 bot to. </p>  <ul>   <li> <p>If the Amazon Lex V2 bot doesn't exist, you must use the <code>CREATE_NEW</code> migration strategy.</p> </li>   <li> <p>If the Amazon Lex V2 bot exists, you must use the <code>UPDATE_EXISTING</code> migration strategy to change the contents of the Amazon Lex V2 bot.</p> </li>  </ul>
    ///   - [`v2_bot_role(impl ::std::convert::Into<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::v2_bot_role) / [`set_v2_bot_role(Option<String>)`](crate::operation::start_migration::builders::StartMigrationFluentBuilder::set_v2_bot_role): <p>The IAM role that Amazon Lex uses to run the Amazon Lex V2 bot.</p>
