...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_slot_type_version::builders::DeleteSlotTypeVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_slot_type_version::builders::DeleteSlotTypeVersionFluentBuilder::set_name):<br>required: **true**<br><p>The name of the slot type.</p><br>
