...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_slot_type_version::builders::CreateSlotTypeVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_slot_type_version::builders::CreateSlotTypeVersionFluentBuilder::set_name): <p>The name of the slot type that you want to create a new version for. The name is case sensitive. </p>
    ///   - [`checksum(impl ::std::convert::Into<String>)`](crate::operation::create_slot_type_version::builders::CreateSlotTypeVersionFluentBuilder::checksum) / [`set_checksum(Option<String>)`](crate::operation::create_slot_type_version::builders::CreateSlotTypeVersionFluentBuilder::set_checksum): <p>Checksum for the <code>$LATEST</code> version of the slot type that you want to publish. If you specify a checksum and the <code>$LATEST</code> version of the slot type has a different checksum, Amazon Lex returns a <code>PreconditionFailedException</code> exception and doesn't publish the new version. If you don't specify a checksum, Amazon Lex publishes the <code>$LATEST</code> version.</p>
