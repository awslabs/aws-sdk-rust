...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::start_import::builders::StartImportFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_tags): <p>A list of tags to add to the imported bot. You can only add tags when you import a bot, you can't add tags to an intent or slot type.</p>
