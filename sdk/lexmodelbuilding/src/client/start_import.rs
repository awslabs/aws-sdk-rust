...
impl super::Client {
    ...
    ///   - [`payload(Blob)`](crate::operation::start_import::builders::StartImportFluentBuilder::payload) / [`set_payload(Option<Blob>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_payload):<br>required: **true**<br><p>A zip archive in binary format. The archive should contain one file, a JSON file containing the resource to import. The resource should match the type specified in the <code>resourceType</code> field.</p><br>
    ...
    ///   - [`tags(Tag)`](crate::operation::start_import::builders::StartImportFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_tags):<br>required: **false**<br><p>A list of tags to add to the imported bot. You can only add tags when you import a bot, you can't add tags to an intent or slot type.</p><br>
