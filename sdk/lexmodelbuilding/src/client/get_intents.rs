...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::get_intents::builders::GetIntentsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_intents::builders::GetIntentsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of intents to return in the response. The default is 10.</p><br>
