...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_bots::builders::GetBotsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_bots::builders::GetBotsFluentBuilder::set_next_token): <p>A pagination token that fetches the next page of bots. If the response to this call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of bots, specify the pagination token in the next request. </p>
    ...
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::get_bots::builders::GetBotsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::get_bots::builders::GetBotsFluentBuilder::set_name_contains): <p>Substring to match in bot names. A bot will be returned if any part of its name matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz."</p>
