...
impl super::Client {
    ...
    ///   - [`bot_name(impl Into<String>)`](crate::operation::get_utterances_view::builders::GetUtterancesViewFluentBuilder::bot_name) / [`set_bot_name(Option<String>)`](crate::operation::get_utterances_view::builders::GetUtterancesViewFluentBuilder::set_bot_name):<br>required: **true**<br><p>The name of the bot for which utterance information should be returned.</p><br>
    ///   - [`bot_versions(impl Into<String>)`](crate::operation::get_utterances_view::builders::GetUtterancesViewFluentBuilder::bot_versions) / [`set_bot_versions(Option<Vec::<String>>)`](crate::operation::get_utterances_view::builders::GetUtterancesViewFluentBuilder::set_bot_versions):<br>required: **true**<br><p>An array of bot versions for which utterance information should be returned. The limit is 5 versions per request.</p><br>
    ///   - [`status_type(StatusType)`](crate::operation::get_utterances_view::builders::GetUtterancesViewFluentBuilder::status_type) / [`set_status_type(Option<StatusType>)`](crate::operation::get_utterances_view::builders::GetUtterancesViewFluentBuilder::set_status_type):<br>required: **true**<br><p>To return utterances that were recognized and handled, use <code>Detected</code>. To return utterances that were not recognized, use <code>Missed</code>.</p><br>
