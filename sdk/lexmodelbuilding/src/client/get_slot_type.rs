...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_slot_type::builders::GetSlotTypeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_slot_type::builders::GetSlotTypeFluentBuilder::set_name):<br>required: **true**<br><p>The name of the slot type. The name is case sensitive.</p><br>
    ///   - [`version(impl Into<String>)`](crate::operation::get_slot_type::builders::GetSlotTypeFluentBuilder::version) / [`set_version(Option<String>)`](crate::operation::get_slot_type::builders::GetSlotTypeFluentBuilder::set_version):<br>required: **true**<br><p>The version of the slot type.</p><br>
