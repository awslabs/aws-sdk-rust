...
impl super::Client {
    ...
    ///   - [`signature_contains(impl ::std::convert::Into<String>)`](crate::operation::get_builtin_intents::builders::GetBuiltinIntentsFluentBuilder::signature_contains) / [`set_signature_contains(Option<String>)`](crate::operation::get_builtin_intents::builders::GetBuiltinIntentsFluentBuilder::set_signature_contains): <p>Substring to match in built-in intent signatures. An intent will be returned if any part of its signature matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz." To find the signature for an intent, see <a href="https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/built-in-intent-ref/standard-intents">Standard Built-in Intents</a> in the <i>Alexa Skills Kit</i>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_builtin_intents::builders::GetBuiltinIntentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_builtin_intents::builders::GetBuiltinIntentsFluentBuilder::set_next_token): <p>A pagination token that fetches the next page of intents. If this API call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of intents, use the pagination token in the next request.</p>
