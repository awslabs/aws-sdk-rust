...
impl super::Client {
    ...
    ///   - [`import_id(impl ::std::convert::Into<String>)`](crate::operation::get_import::builders::GetImportFluentBuilder::import_id) / [`set_import_id(Option<String>)`](crate::operation::get_import::builders::GetImportFluentBuilder::set_import_id): <p>The identifier of the import job information to return.</p>
