...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::set_name): <p>The name of the alias to delete. The name is case sensitive. </p>
