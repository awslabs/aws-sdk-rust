...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_slot_types::builders::GetSlotTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_slot_types::builders::GetSlotTypesFluentBuilder::set_next_token): <p>A pagination token that fetches the next page of slot types. If the response to this API call is truncated, Amazon Lex returns a pagination token in the response. To fetch next page of slot types, specify the pagination token in the next request.</p>
    ...
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::get_slot_types::builders::GetSlotTypesFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::get_slot_types::builders::GetSlotTypesFluentBuilder::set_name_contains): <p>Substring to match in slot type names. A slot type will be returned if any part of its name matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz."</p>
