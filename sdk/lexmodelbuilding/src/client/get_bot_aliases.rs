...
impl super::Client {
    ...
    ///   - [`bot_name(impl ::std::convert::Into<String>)`](crate::operation::get_bot_aliases::builders::GetBotAliasesFluentBuilder::bot_name) / [`set_bot_name(Option<String>)`](crate::operation::get_bot_aliases::builders::GetBotAliasesFluentBuilder::set_bot_name): <p>The name of the bot.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_bot_aliases::builders::GetBotAliasesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_bot_aliases::builders::GetBotAliasesFluentBuilder::set_next_token): <p>A pagination token for fetching the next page of aliases. If the response to this call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of aliases, specify the pagination token in the next request. </p>
    ...
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::get_bot_aliases::builders::GetBotAliasesFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::get_bot_aliases::builders::GetBotAliasesFluentBuilder::set_name_contains): <p>Substring to match in bot alias names. An alias will be returned if any part of its name matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz."</p>
