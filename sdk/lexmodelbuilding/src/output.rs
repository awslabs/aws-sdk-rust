...
pub struct GetUtterancesViewOutput  {
    ...
    #[doc(hidden)]pub utterances: std::option::Option<std::vec::Vec<crate::model::UtteranceList>>,
}
...
pub struct GetSlotTypeVersionsOutput  {
    ...
    #[doc(hidden)]pub slot_types: std::option::Option<std::vec::Vec<crate::model::SlotTypeMetadata>>,
...
pub struct GetMigrationsOutput  {
    ...
    #[doc(hidden)]pub migration_summaries: std::option::Option<std::vec::Vec<crate::model::MigrationSummary>>,
...
pub struct GetMigrationOutput  {
    ...
    #[doc(hidden)]pub alerts: std::option::Option<std::vec::Vec<crate::model::MigrationAlert>>,
}
...
pub struct GetIntentVersionsOutput  {
    ...
    #[doc(hidden)]pub intents: std::option::Option<std::vec::Vec<crate::model::IntentMetadata>>,
...
pub struct GetBuiltinSlotTypesOutput  {
    ...
    #[doc(hidden)]pub slot_types: std::option::Option<std::vec::Vec<crate::model::BuiltinSlotTypeMetadata>>,
...
pub struct GetBuiltinIntentsOutput  {
    ...
    #[doc(hidden)]pub intents: std::option::Option<std::vec::Vec<crate::model::BuiltinIntentMetadata>>,
...
pub struct GetBuiltinIntentOutput  {
    ...
    #[doc(hidden)]pub slots: std::option::Option<std::vec::Vec<crate::model::BuiltinIntentSlot>>,
}
...
pub struct GetBotVersionsOutput  {
    ...
    #[doc(hidden)]pub bots: std::option::Option<std::vec::Vec<crate::model::BotMetadata>>,
...
pub struct GetBotChannelAssociationsOutput  {
    ...
    #[doc(hidden)]pub bot_channel_associations: std::option::Option<std::vec::Vec<crate::model::BotChannelAssociation>>,
...
pub struct GetBotAliasesOutput  {
    ...
    #[doc(hidden)]pub bot_aliases: std::option::Option<std::vec::Vec<crate::model::BotAliasMetadata>>,
