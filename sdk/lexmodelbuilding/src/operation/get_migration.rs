    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let migration_id = ::aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_migration::GetMigration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMigration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_migration::de_get_migration_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_migration::de_get_migration_http_response_with_props(
                status, headers, body,
            )
        }
    }
