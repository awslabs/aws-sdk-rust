...
impl GetBuiltinSlotTypes {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesInput,
                    ) -> ::std::result::Result<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBuiltinSlotTypes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBuiltinSlotTypes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBuiltinSlotTypesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBuiltinSlotTypesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBuiltinSlotTypes")
...
.with_interceptor(GetBuiltinSlotTypesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError>::new());
...
#[derive(Debug)]
            struct GetBuiltinSlotTypesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBuiltinSlotTypesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_builtin_slot_types::de_get_builtin_slot_types_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_builtin_slot_types::de_get_builtin_slot_types_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBuiltinSlotTypesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBuiltinSlotTypesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/builtins/slottypes").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.locale {
         {
            query.push_kv("locale", &::aws_smithy_http::query::fmt_string(inner_1));
        }
    }
    if let ::std::option::Option::Some(inner_2) = &_input.signature_contains {
         {
            query.push_kv("signatureContains", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
...
#[derive(Debug)]
            struct GetBuiltinSlotTypesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBuiltinSlotTypesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBuiltinSlotTypesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBuiltinSlotTypesInput>()
                        .ok_or("failed to downcast to GetBuiltinSlotTypesInput")?;
...
pub enum GetBuiltinSlotTypesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBuiltinSlotTypesError) for what information is available for the error.")]
...
impl GetBuiltinSlotTypesError {
    /// Creates the `GetBuiltinSlotTypesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBuiltinSlotTypesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBuiltinSlotTypesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError {
...
mod _get_builtin_slot_types_output;
