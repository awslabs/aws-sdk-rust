...
impl StartImportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_import::StartImport, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_import::ser_start_import_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_import::StartImport::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartImport", "lexmodelbuildingservice"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartImport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_start_import::de_start_import_http_response_with_props(status, headers, body)
        }
    }
}
