...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMigration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartMigration", "lexmodelbuildingservice"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for StartMigrationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_migration::ser_start_migration_input(&input)?);
