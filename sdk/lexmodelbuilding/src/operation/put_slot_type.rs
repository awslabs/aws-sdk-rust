    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/slottypes/{name}/versions/$LATEST", name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_slot_type::PutSlotType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSlotType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_slot_type::de_put_slot_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_slot_type::de_put_slot_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
