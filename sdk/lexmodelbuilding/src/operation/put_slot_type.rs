...
impl PutSlotTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_slot_type::PutSlotType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_slot_type::ser_put_slot_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSlotType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_slot_type::de_put_slot_type_http_response_with_props(status, headers, body)
        }
    }
}
