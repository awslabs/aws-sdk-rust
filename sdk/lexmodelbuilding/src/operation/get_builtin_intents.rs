...
impl GetBuiltinIntentsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_builtin_intents::GetBuiltinIntents::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetBuiltinIntents", "lexmodelbuildingservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBuiltinIntents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_builtin_intents::de_get_builtin_intents_http_response_with_props(status, headers, body)
        }
    }
}
