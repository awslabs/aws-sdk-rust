...
impl GetBotAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_bot_alias::GetBotAlias,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bot_alias::GetBotAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBotAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_bot_alias::de_get_bot_alias_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_bot_alias::de_get_bot_alias_http_response_with_props(
                status, headers, body,
            )
        }
    }
