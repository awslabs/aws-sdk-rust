...
impl GetIntentVersionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_intent_versions::GetIntentVersions::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetIntentVersions", "lexmodelbuildingservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIntentVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_intent_versions::de_get_intent_versions_http_response_with_props(status, headers, body)
        }
    }
}
