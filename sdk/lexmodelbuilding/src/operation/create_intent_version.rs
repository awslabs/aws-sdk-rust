...
impl CreateIntentVersionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_intent_version::CreateIntentVersion::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("CreateIntentVersion", "lexmodelbuildingservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIntentVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_intent_version::de_create_intent_version_http_response_with_props(status, headers, body)
        }
    }
}
