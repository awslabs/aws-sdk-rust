...
impl CreateIntentVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreateIntentVersion`](crate::operation::create_intent_version::CreateIntentVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_intent_version::CreateIntentVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_intent_version::CreateIntentVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_intent_version::ser_create_intent_version_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_intent_version::CreateIntentVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateIntentVersion", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateIntentVersion {
                type Output = std::result::Result<crate::operation::create_intent_version::CreateIntentVersionOutput, crate::operation::create_intent_version::CreateIntentVersionError>;
