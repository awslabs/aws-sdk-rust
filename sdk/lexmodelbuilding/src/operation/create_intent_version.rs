    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/intents/{name}/versions", name = name)
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_intent_version::ser_create_intent_version_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_intent_version::CreateIntentVersion::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_intent_version::CreateIntentVersionError
{
