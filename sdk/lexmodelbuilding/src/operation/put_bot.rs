...
impl PutBotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_bot::PutBot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_bot::ser_put_bot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bot::de_put_bot_http_response_with_props(status, headers, body)
        }
    }
}
