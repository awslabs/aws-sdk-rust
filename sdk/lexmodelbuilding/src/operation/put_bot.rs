    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bots/{name}/versions/$LATEST", name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bot::PutBot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bot::de_put_bot_http_response_with_props(
                status, headers, body,
            )
        }
    }
