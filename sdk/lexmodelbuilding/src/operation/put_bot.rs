...
impl PutBotInput {
    /// Consumes the builder and constructs an Operation<[`PutBot`](crate::operation::put_bot::PutBot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bot::PutBot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bot::PutBotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/bots/{name}/versions/$LATEST", name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bot::ser_put_bot_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bot::PutBot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBot", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBot {
                type Output = std::result::Result<crate::operation::put_bot::PutBotOutput, crate::operation::put_bot::PutBotError>;
