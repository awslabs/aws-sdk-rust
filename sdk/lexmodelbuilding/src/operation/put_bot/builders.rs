...
impl PutBotInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::put_bot::PutBotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>,
    > {
...
impl PutBotFluentBuilder {
    ...
    /// Access the PutBot as a reference.
    pub fn as_input(&self) -> &crate::operation::put_bot::builders::PutBotInputBuilder {
        &self.inner
    }
    #[doc(hidden)]
    ...
    > {
        ...
        let runtime_plugins = crate::operation::put_bot::PutBot::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::put_bot::PutBot::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub async fn customize_orchestrator(
        self,
    ) -> crate::client::customize::orchestrator::CustomizableOperation<crate::operation::put_bot::PutBotOutput, crate::operation::put_bot::PutBotError>
    {
    ...
    pub fn get_enable_model_improvements(&self) -> &::std::option::Option<bool> {
        self.inner.get_enable_model_improvements()
    }
    ...
    pub fn get_abort_statement(&self) -> &::std::option::Option<crate::types::Statement> {
        self.inner.get_abort_statement()
    }
    ...
    pub fn get_process_behavior(&self) -> &::std::option::Option<crate::types::ProcessBehavior> {
        self.inner.get_process_behavior()
    }
    ...
    pub fn get_detect_sentiment(&self) -> &::std::option::Option<bool> {
        self.inner.get_detect_sentiment()
    }
