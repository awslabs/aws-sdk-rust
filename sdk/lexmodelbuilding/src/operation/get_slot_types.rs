...
impl GetSlotTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_slot_types::GetSlotTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSlotTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_slot_types::de_get_slot_types_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_slot_types::de_get_slot_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
