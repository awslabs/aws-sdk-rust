...
impl GetBotAliasesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bot_aliases::GetBotAliases::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetBotAliases {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_bot_aliases::de_get_bot_aliases_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_bot_aliases::de_get_bot_aliases_http_response(
                status, headers, body,
            )
        }
    }
