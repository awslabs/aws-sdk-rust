...
impl DeleteIntentInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_intent::DeleteIntent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_intent::DeleteIntentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_intent::DeleteIntent::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteIntent", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteIntent {
                type Output = std::result::Result<crate::operation::delete_intent::DeleteIntentOutput, crate::operation::delete_intent::DeleteIntentError>;
