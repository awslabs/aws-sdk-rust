...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBotAlias {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteBotAlias", "lexmodelbuildingservice"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/bots/{botName}/aliases/{name}", botName = bot_name, name = name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
