...
impl GetSlotTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_slot_type::GetSlotType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSlotType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_slot_type::de_get_slot_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_slot_type::de_get_slot_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
