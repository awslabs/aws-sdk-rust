...
impl GetBotChannelAssociationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_bot_channel_associations::GetBotChannelAssociations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBotChannelAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bot_channel_associations::de_get_bot_channel_associations_http_response_with_props(status, headers, body)
        }
    }
