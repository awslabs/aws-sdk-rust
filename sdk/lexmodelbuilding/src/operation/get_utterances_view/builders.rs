...
impl GetUtterancesViewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_utterances_view::GetUtterancesViewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_utterances_view::GetUtterancesViewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_utterances_view::GetUtterancesViewOutput, crate::operation::get_utterances_view::GetUtterancesViewError, Self> {
