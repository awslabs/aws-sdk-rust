...
impl PutIntentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_intent::PutIntent, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_intent::ser_put_intent_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutIntent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_intent::de_put_intent_http_response_with_props(status, headers, body)
        }
    }
}
