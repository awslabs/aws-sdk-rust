    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/intents/{name}/versions/$LATEST", name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_intent::PutIntent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutIntent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_intent::de_put_intent_http_response_with_props(
                status, headers, body,
            )
        }
    }
