...
impl PutIntentInput {
    /// Consumes the builder and constructs an Operation<[`PutIntent`](crate::operation::put_intent::PutIntent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_intent::PutIntent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_intent::PutIntentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/intents/{name}/versions/$LATEST", name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_intent::ser_put_intent_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_intent::PutIntent::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutIntent", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutIntent {
                type Output = std::result::Result<crate::operation::put_intent::PutIntentOutput, crate::operation::put_intent::PutIntentError>;
