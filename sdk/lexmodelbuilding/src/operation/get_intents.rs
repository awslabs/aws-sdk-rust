...
impl GetIntentsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_intents::GetIntents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIntents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_intents::de_get_intents_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_intents::de_get_intents_http_response_with_props(
                status, headers, body,
            )
        }
    }
