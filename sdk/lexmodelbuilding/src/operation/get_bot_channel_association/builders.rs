...
impl GetBotChannelAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_bot_channel_association::GetBotChannelAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_bot_channel_association::GetBotChannelAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_bot_channel_association::GetBotChannelAssociationOutput, crate::operation::get_bot_channel_association::GetBotChannelAssociationError, Self> {
