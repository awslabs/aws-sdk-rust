...
impl GetBotInput {
    /// Consumes the builder and constructs an Operation<[`GetBot`](crate::operation::get_bot::GetBot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_bot::GetBot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bot::GetBotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("version_or_alias", "cannot be empty or unset"))?;
                ...
                if version_or_alias.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("version_or_alias", "cannot be empty or unset"))
                            }
                write!(output, "/bots/{name}/versions/{versionOrAlias}", name = name, versionOrAlias = version_or_alias).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_bot::GetBot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBot", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBot {
                type Output = std::result::Result<crate::operation::get_bot::GetBotOutput, crate::operation::get_bot::GetBotError>;
