...
impl GetUtterancesViewInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_utterances_view::GetUtterancesView::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetUtterancesView", "lexmodelbuildingservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUtterancesView {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_utterances_view::de_get_utterances_view_http_response_with_props(status, headers, body)
        }
    }
}
