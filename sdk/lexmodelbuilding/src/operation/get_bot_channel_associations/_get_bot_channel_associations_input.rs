...
impl GetBotChannelAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_bot_channel_associations::GetBotChannelAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
