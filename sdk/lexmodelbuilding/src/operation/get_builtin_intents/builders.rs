...
impl GetBuiltinIntentsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_builtin_intents::GetBuiltinIntentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_builtin_intents::GetBuiltinIntentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_builtin_intents::GetBuiltinIntentsOutput, crate::operation::get_builtin_intents::GetBuiltinIntentsError, Self> {
