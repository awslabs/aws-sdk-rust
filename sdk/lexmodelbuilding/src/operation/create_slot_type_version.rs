...
impl CreateSlotTypeVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreateSlotTypeVersion`](crate::operation::create_slot_type_version::CreateSlotTypeVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_slot_type_version::CreateSlotTypeVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_slot_type_version::CreateSlotTypeVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/slottypes/{name}/versions", name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_slot_type_version::ser_create_slot_type_version_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_slot_type_version::CreateSlotTypeVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSlotTypeVersion", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSlotTypeVersion {
                type Output = std::result::Result<crate::operation::create_slot_type_version::CreateSlotTypeVersionOutput, crate::operation::create_slot_type_version::CreateSlotTypeVersionError>;
