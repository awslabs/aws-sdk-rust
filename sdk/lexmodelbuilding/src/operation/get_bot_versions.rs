...
impl GetBotVersionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_bot_versions::GetBotVersions,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bots/{name}/versions", name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bot_versions::GetBotVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBotVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_bot_versions::de_get_bot_versions_http_error(
                status, headers, body,
            )
        } else {
