...
impl DeleteIntentVersionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_intent_version::DeleteIntentVersion::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("DeleteIntentVersion", "lexmodelbuildingservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIntentVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_intent_version::de_delete_intent_version_http_response_with_props(status, headers, body)
        }
    }
}
