...
impl PutBotAliasInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bot_alias::PutBotAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBotAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_bot_alias::de_put_bot_alias_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_bot_alias::de_put_bot_alias_http_response_with_props(
                status, headers, body,
            )
        }
    }
