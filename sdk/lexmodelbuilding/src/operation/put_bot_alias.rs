...
impl PutBotAlias {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_bot_alias::PutBotAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_bot_alias::PutBotAliasOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Lex Model Building Service.PutBotAlias",
            "rpc.service" = "Lex Model Building Service",
            "rpc.method" = "PutBotAlias",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBotAlias {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutBotAliasRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutBotAliasResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutBotAlias")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBotAlias")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutBotAliasTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutBotAliasTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutBotAliasTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutBotAliasInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBotAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_bot_alias::de_put_bot_alias_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_bot_alias::de_put_bot_alias_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBotAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_bot_alias::PutBotAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_bot_alias::PutBotAliasInput,
