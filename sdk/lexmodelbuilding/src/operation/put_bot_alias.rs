...
impl PutBotAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_bot_alias::PutBotAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_bot_alias::ser_put_bot_alias_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBotAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bot_alias::de_put_bot_alias_http_response_with_props(status, headers, body)
        }
    }
}
