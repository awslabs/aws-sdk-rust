...
impl PutBotAliasInput {
    /// Consumes the builder and constructs an Operation<[`PutBotAlias`](crate::operation::put_bot_alias::PutBotAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bot_alias::PutBotAlias, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bot_alias::PutBotAliasInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bot_alias::ser_put_bot_alias_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bot_alias::PutBotAlias::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBotAlias", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBotAlias {
                type Output = std::result::Result<crate::operation::put_bot_alias::PutBotAliasOutput, crate::operation::put_bot_alias::PutBotAliasError>;
