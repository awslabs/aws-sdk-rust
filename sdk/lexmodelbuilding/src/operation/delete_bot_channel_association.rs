...
impl DeleteBotChannelAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_bot_channel_association::DeleteBotChannelAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBotChannelAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_bot_channel_association::de_delete_bot_channel_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
