...
impl DeleteBotChannelAssociationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBotChannelAssociation`](crate::operation::delete_bot_channel_association::DeleteBotChannelAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/bots/{botName}/aliases/{botAlias}/channels/{name}", botName = bot_name, botAlias = bot_alias, name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bot_channel_association::DeleteBotChannelAssociation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBotChannelAssociation", "lexmodelbuildingservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBotChannelAssociation {
                type Output = std::result::Result<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationOutput, crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError>;
