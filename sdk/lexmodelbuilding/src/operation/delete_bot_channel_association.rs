...
/// Orchestration and serialization glue logic for `DeleteBotChannelAssociation`.
...
impl DeleteBotChannelAssociation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBotChannelAssociation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteBotChannelAssociation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteBotChannelAssociationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteBotChannelAssociationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteBotChannelAssociation")
...
.with_interceptor(DeleteBotChannelAssociationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError>::new());
...
#[derive(Debug)]
            struct DeleteBotChannelAssociationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBotChannelAssociationResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteBotChannelAssociationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBotChannelAssociationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/bots/{botName}/aliases/{botAlias}/channels/{name}", botName = bot_name, botAlias = bot_alias, name = name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteBotChannelAssociationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteBotChannelAssociationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteBotChannelAssociationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteBotChannelAssociationInput>()
                        .ok_or("failed to downcast to DeleteBotChannelAssociationInput")?;
...
pub enum DeleteBotChannelAssociationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteBotChannelAssociationError) for what information is available for the error.")]
...
impl DeleteBotChannelAssociationError {
    /// Creates the `DeleteBotChannelAssociationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteBotChannelAssociationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteBotChannelAssociationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_bot_channel_association::DeleteBotChannelAssociationError {
...
mod _delete_bot_channel_association_output;
