...
pub fn ser_put_bot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutBotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
