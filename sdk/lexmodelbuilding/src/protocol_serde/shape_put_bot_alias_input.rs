...
pub fn ser_put_bot_alias_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutBotAliasInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
