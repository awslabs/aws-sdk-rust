...
pub fn ser_log_settings_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogSettingsRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
