...
pub fn ser_put_intent_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutIntentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
