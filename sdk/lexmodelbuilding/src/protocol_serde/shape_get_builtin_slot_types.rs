                    ...
                    match crate::protocol_serde::shape_limit_exceeded_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_builtin_slot_types::de_get_builtin_slot_types(_response_body, output)
            .map_err(crate::operation::get_builtin_slot_types::GetBuiltinSlotTypesError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "slotTypes" => {
                    builder = builder.set_slot_types(
                        crate::protocol_serde::shape_builtin_slot_type_metadata_list::de_builtin_slot_type_metadata_list(tokens, _value, depth + 1)?,
                    );
                }
