                    ...
                    match crate::protocol_serde::shape_limit_exceeded_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::create_intent_version::CreateIntentVersionError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_intent_version::de_create_intent_version(_response_body, output)
            .map_err(crate::operation::create_intent_version::CreateIntentVersionError::unhandled)?;
