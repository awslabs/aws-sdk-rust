...
pub fn ser_put_slot_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutSlotTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
