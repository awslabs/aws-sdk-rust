                    ...
                    match crate::protocol_serde::shape_limit_exceeded_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_builtin_intents::GetBuiltinIntentsError::unhandled(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "intents" => {
                    builder = builder.set_intents(
                        crate::protocol_serde::shape_builtin_intent_metadata_list::de_builtin_intent_metadata_list(tokens, _value, depth + 1)?,
                    );
                }
                "nextToken" => {
