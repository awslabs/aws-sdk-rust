...
impl super::Client {
    ...
    ///   - [`replay_name(impl ::std::convert::Into<String>)`](crate::operation::start_replay::builders::StartReplayFluentBuilder::replay_name) / [`set_replay_name(Option<String>)`](crate::operation::start_replay::builders::StartReplayFluentBuilder::set_replay_name): <p>The name of the replay to start.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::start_replay::builders::StartReplayFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::start_replay::builders::StartReplayFluentBuilder::set_description): <p>A description for the replay to start.</p>
    ///   - [`event_source_arn(impl ::std::convert::Into<String>)`](crate::operation::start_replay::builders::StartReplayFluentBuilder::event_source_arn) / [`set_event_source_arn(Option<String>)`](crate::operation::start_replay::builders::StartReplayFluentBuilder::set_event_source_arn): <p>The ARN of the archive to replay events from.</p>
