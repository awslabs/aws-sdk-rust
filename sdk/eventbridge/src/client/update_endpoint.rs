...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_name): <p>The name of the endpoint you want to update.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_description): <p>A description for the endpoint.</p>
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::update_endpoint::builders::UpdateEndpointFluentBuilder::set_role_arn): <p>The ARN of the role used by event replication for this request.</p>
