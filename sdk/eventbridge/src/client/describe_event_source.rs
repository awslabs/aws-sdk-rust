...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::describe_event_source::builders::DescribeEventSourceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_event_source::builders::DescribeEventSourceFluentBuilder::set_name): <p>The name of the partner event source to display the details of.</p>
