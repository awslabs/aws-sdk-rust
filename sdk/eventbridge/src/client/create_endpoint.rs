...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_name): <p>The name of the global endpoint. For example, <code>"Name":"us-east-2-custom_bus_A-endpoint"</code>.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_description): <p>A description of the global endpoint.</p>
    ...
    ///   - [`replication_config(ReplicationConfig)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::replication_config) / [`set_replication_config(Option<ReplicationConfig>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_replication_config): <p>Enable or disable event replication. The default state is <code>ENABLED</code> which means you must supply a <code>RoleArn</code>. If you don't have a <code>RoleArn</code> or you don't want event replication enabled, set the state to <code>DISABLED</code>.</p>
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::create_endpoint::builders::CreateEndpointFluentBuilder::set_role_arn): <p>The ARN of the role used for replication.</p>
