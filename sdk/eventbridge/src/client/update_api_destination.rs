...
impl super::Client {
    ...
    pub fn update_api_destination(
        &self,
    ) -> crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder {
        crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
