...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_partner_event_source::builders::DeletePartnerEventSourceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_partner_event_source::builders::DeletePartnerEventSourceFluentBuilder::set_name): <p>The name of the event source to delete.</p>
