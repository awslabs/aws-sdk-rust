...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_event_bus::builders::CreateEventBusFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_event_bus::builders::CreateEventBusFluentBuilder::set_tags): <p>Tags to associate with the event bus.</p>
