...
impl super::Client {
    ...
    ///   - [`endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::put_events::builders::PutEventsFluentBuilder::endpoint_id) / [`set_endpoint_id(Option<String>)`](crate::operation::put_events::builders::PutEventsFluentBuilder::set_endpoint_id): <p>The URL subdomain of the endpoint. For example, if the URL for Endpoint is https://abcde.veo.endpoints.event.amazonaws.com, then the EndpointId is <code>abcde.veo</code>.</p> <important>   <p>When using Java, you must include <code>auth-crt</code> on the class path.</p>  </important>
