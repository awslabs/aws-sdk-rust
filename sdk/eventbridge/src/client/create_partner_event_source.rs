...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_partner_event_source::builders::CreatePartnerEventSourceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_partner_event_source::builders::CreatePartnerEventSourceFluentBuilder::set_name): <p>The name of the partner event source. This name must be unique and must be in the format <code> <i>partner_name</i>/<i>event_namespace</i>/<i>event_name</i> </code>. The Amazon Web Services account that wants to use this partner event source must create a partner event bus with a name that matches the name of the partner event source.</p>
    ///   - [`account(impl ::std::convert::Into<String>)`](crate::operation::create_partner_event_source::builders::CreatePartnerEventSourceFluentBuilder::account) / [`set_account(Option<String>)`](crate::operation::create_partner_event_source::builders::CreatePartnerEventSourceFluentBuilder::set_account): <p>The Amazon Web Services account ID that is permitted to create a matching partner event bus for this partner event source.</p>
