...
impl super::Client {
    ...
    ///   - [`archive_name(impl Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::archive_name) / [`set_archive_name(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_archive_name):<br>required: **true**<br><p>The name for the archive to create.</p><br>
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_description):<br>required: **false**<br><p>A description for the archive.</p><br>
    ///   - [`event_pattern(impl Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::event_pattern) / [`set_event_pattern(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_event_pattern):<br>required: **false**<br><p>An event pattern to use to filter events sent to the archive.</p><br>
