...
impl super::Client {
    ...
    ///   - [`statement_id(impl ::std::convert::Into<String>)`](crate::operation::remove_permission::builders::RemovePermissionFluentBuilder::statement_id) / [`set_statement_id(Option<String>)`](crate::operation::remove_permission::builders::RemovePermissionFluentBuilder::set_statement_id): <p>The statement ID corresponding to the account that is no longer allowed to put events to the default event bus.</p>
    ///   - [`remove_all_permissions(bool)`](crate::operation::remove_permission::builders::RemovePermissionFluentBuilder::remove_all_permissions) / [`set_remove_all_permissions(Option<bool>)`](crate::operation::remove_permission::builders::RemovePermissionFluentBuilder::set_remove_all_permissions): <p>Specifies whether to remove all permissions.</p>
