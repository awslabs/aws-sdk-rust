...
impl super::Client {
    ...
    ///   - [`managed_by(Option<String>)`](crate::operation::describe_event_bus::DescribeEventBusOutput::managed_by): <p>If the event bus was created on behalf of your account by an Amazon Web Services service, this field displays the principal name of the service that created the event bus.</p>
