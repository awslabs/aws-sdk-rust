...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::describe_connection::builders::DescribeConnectionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_connection::builders::DescribeConnectionFluentBuilder::set_name): <p>The name of the connection to retrieve.</p>
