...
impl super::Client {
    ...
    ///   - [`invocation_connectivity_parameters(Option<DescribeConnectionConnectivityParameters>)`](crate::operation::describe_connection::DescribeConnectionOutput::invocation_connectivity_parameters): <p>For connections to private resource endpoints. The parameters EventBridge uses to invoke the resource endpoint.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-target-connection-private.html">Connecting to private resources</a> in the <i> <i>Amazon EventBridge User Guide</i> </i>.</p>
