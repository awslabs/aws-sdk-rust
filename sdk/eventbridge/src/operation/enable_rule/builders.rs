...
impl EnableRuleFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::enable_rule::EnableRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::enable_rule::EnableRule::orchestrate(&runtime_plugins, input).await
    }
