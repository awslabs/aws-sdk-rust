...
impl ListReplaysInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_replays::ListReplays, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_replays::ser_list_replays_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReplays {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_replays::de_list_replays_http_response_with_props(status, headers, body)
        }
    }
}
