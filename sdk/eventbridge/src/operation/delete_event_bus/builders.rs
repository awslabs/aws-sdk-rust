...
impl DeleteEventBusFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_event_bus::DeleteEventBusOutput, aws_smithy_http::result::SdkError<crate::operation::delete_event_bus::DeleteEventBusError>>
                     {
