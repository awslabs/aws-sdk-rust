...
impl DeactivateEventSourceFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::deactivate_event_source::DeactivateEventSourceOutput, aws_smithy_http::result::SdkError<crate::operation::deactivate_event_source::DeactivateEventSourceError>>
                     {
