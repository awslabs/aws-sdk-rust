...
impl DeauthorizeConnection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::deauthorize_connection::DeauthorizeConnectionInput,
                    ) -> ::std::result::Result<crate::operation::deauthorize_connection::DeauthorizeConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deauthorize_connection::DeauthorizeConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deauthorize_connection::DeauthorizeConnectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deauthorize_connection::DeauthorizeConnectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeauthorizeConnection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeauthorizeConnection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeauthorizeConnectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeauthorizeConnectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeauthorizeConnection")
...
.with_interceptor(DeauthorizeConnectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deauthorize_connection::DeauthorizeConnectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deauthorize_connection::DeauthorizeConnectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deauthorize_connection::DeauthorizeConnectionError>::new());
...
#[derive(Debug)]
            struct DeauthorizeConnectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeauthorizeConnectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_deauthorize_connection::de_deauthorize_connection_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeauthorizeConnectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeauthorizeConnectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deauthorize_connection::DeauthorizeConnectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deauthorize_connection::DeauthorizeConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deauthorize_connection::ser_deauthorize_connection_input(&input)?);
...
#[derive(Debug)]
            struct DeauthorizeConnectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeauthorizeConnectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeauthorizeConnectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeauthorizeConnectionInput>()
                        .ok_or("failed to downcast to DeauthorizeConnectionInput")?;
...
pub enum DeauthorizeConnectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeauthorizeConnectionError) for what information is available for the error.")]
...
impl DeauthorizeConnectionError {
    /// Creates the `DeauthorizeConnectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeauthorizeConnectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeauthorizeConnectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deauthorize_connection::DeauthorizeConnectionError {
...
mod _deauthorize_connection_output;
