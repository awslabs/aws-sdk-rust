...
impl EnableRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::enable_rule::EnableRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enable_rule::ser_enable_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_rule::de_enable_rule_http_response_with_props(status, headers, body)
        }
    }
}
