...
impl EnableRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_rule::EnableRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_rule::de_enable_rule_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enable_rule::de_enable_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
