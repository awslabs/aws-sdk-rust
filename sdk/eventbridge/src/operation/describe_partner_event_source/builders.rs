...
impl crate::operation::describe_partner_event_source::builders::DescribePartnerEventSourceInputBuilder {
...
impl DescribePartnerEventSourceFluentBuilder {
    /// Creates a new `DescribePartnerEventSourceFluentBuilder`.
