...
impl DescribePartnerEventSourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_partner_event_source::DescribePartnerEventSourceInput, ::aws_smithy_types::error::operation::BuildError> {
