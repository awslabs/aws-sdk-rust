...
impl StartReplayInput {
    /// Consumes the builder and constructs an Operation<[`StartReplay`](crate::operation::start_replay::StartReplay)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_replay::StartReplay, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_replay::ser_start_replay_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_replay::StartReplay::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartReplay", "eventbridge"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReplay {
    type Output = ::std::result::Result<crate::operation::start_replay::StartReplayOutput, crate::operation::start_replay::StartReplayError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_replay::de_start_replay_http_response_with_props(status, headers, body)
        }
    }
}
