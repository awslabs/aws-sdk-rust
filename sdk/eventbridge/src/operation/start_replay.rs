...
impl StartReplayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_replay::StartReplay::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReplay {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_replay::de_start_replay_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_replay::de_start_replay_http_response_with_props(
                status, headers, body,
            )
        }
    }
