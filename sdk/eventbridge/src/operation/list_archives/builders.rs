...
impl ListArchivesFluentBuilder  {
    /// Creates a new `ListArchives`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_archives::ListArchivesOutput, aws_smithy_http::result::SdkError<crate::operation::list_archives::ListArchivesError>>
                     {
