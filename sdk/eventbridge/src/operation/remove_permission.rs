...
impl RemovePermissionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_permission::ser_remove_permission_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_permission::RemovePermission::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RemovePermission", "eventbridge"));
