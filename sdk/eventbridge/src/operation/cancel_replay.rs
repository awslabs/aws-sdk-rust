...
impl CancelReplayInput {
    /// Consumes the builder and constructs an Operation<[`CancelReplay`](crate::operation::cancel_replay::CancelReplay)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_replay::CancelReplay, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_replay::ser_cancel_replay_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_replay::CancelReplay::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelReplay", "eventbridge"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelReplay {
    type Output = ::std::result::Result<crate::operation::cancel_replay::CancelReplayOutput, crate::operation::cancel_replay::CancelReplayError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_replay::de_cancel_replay_http_response_with_props(status, headers, body)
        }
    }
}
