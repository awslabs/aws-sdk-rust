...
impl DescribeRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_rule::DescribeRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_rule::ser_describe_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_rule::de_describe_rule_http_response_with_props(status, headers, body)
        }
    }
}
