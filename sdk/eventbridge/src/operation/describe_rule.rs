...
impl DescribeRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_rule::DescribeRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_rule::de_describe_rule_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_rule::de_describe_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
