...
impl DeleteArchiveInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_archive::DeleteArchive, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_archive::ser_delete_archive_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteArchive {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_archive::de_delete_archive_http_response_with_props(status, headers, body)
        }
    }
}
