...
impl Builder {
    ...
    /// use aws_sdk_eventbridge::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_eventbridge::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("eventbridge"));
        }
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        ...
        if let Some(credentials_cache) = _service_config.credentials_cache() {
            ...
            #[cfg(feature = "sigv4a")]
            {
                runtime_components.push_identity_resolver(::aws_runtime::auth::sigv4a::SCHEME_ID, shared_identity_resolver.clone());
            }
