...
pub(super) fn resolve_endpoint(_params: &crate::config::endpoint::Params, _diagnostic_collector: &mut crate::endpoint_lib::diagnostic::DiagnosticCollector, partition_resolver: &crate::endpoint_lib::partition::PartitionResolver) -> ::aws_smithy_http::endpoint::Result {
...
#[allow(unused_variables)]
if let Some(endpoint_id) = endpoint_id { #[allow(unused_variables)]
if let Some(region) = region { #[allow(unused_variables)]
if let Some(partition_result) = partition_resolver.resolve_partition(region, _diagnostic_collector) { if crate::endpoint_lib::host::is_valid_host_label(endpoint_id
...
.property("authSchemes", vec![::aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "events"
    .to_string().into());
...
return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("EndpointId must be a valid host label."
.to_string())); } } }
#[allow(unused_variables)]
...
if (*use_fips) == (true) {
                                ...
                                return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url("https://events.us-gov-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-gov-west-1") {
                                return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url("https://events.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
...
return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("Invalid Configuration: Missing Region"
.to_string()));
                }
