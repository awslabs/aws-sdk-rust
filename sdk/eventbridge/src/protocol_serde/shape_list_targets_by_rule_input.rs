...
pub fn ser_list_targets_by_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTargetsByRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
