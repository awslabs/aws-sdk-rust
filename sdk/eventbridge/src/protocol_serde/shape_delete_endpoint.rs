...
> {
    ...
    Err(match error_code {
        "ConcurrentModificationException" => {
            crate::operation::delete_endpoint::DeleteEndpointError::ConcurrentModificationException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "InternalException" => {
            crate::operation::delete_endpoint::DeleteEndpointError::InternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
