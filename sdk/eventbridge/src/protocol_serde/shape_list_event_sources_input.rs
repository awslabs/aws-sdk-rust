...
pub fn ser_list_event_sources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEventSourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
