...
> {
    ...
    Err(match error_code {
        "ConcurrentModificationException" => {
            crate::operation::put_rule::PutRuleError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidEventPatternException" => {
            crate::operation::put_rule::PutRuleError::InvalidEventPatternException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "LimitExceededException" => {
            crate::operation::put_rule::PutRuleError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundException" => {
            crate::operation::put_rule::PutRuleError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_rule_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_put_rule(
    ...
    crate::operation::put_rule::builders::PutRuleOutputBuilder,
