...
> {
    ...
    Err(match error_code {
        "InternalException" => {
            crate::operation::describe_endpoint::DescribeEndpointError::InternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_endpoint::DescribeEndpointError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
