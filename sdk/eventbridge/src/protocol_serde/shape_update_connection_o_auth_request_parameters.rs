...
pub fn ser_update_connection_o_auth_request_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateConnectionOAuthRequestParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
