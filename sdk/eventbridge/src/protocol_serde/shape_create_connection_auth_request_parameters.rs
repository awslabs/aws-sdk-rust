...
pub fn ser_create_connection_auth_request_parameters(
    ...
    if let Some(var_1) = &input.basic_auth_parameters {
        ...
        crate::protocol_serde::shape_create_connection_basic_auth_request_parameters::ser_create_connection_basic_auth_request_parameters(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.o_auth_parameters {
        ...
        crate::protocol_serde::shape_create_connection_o_auth_request_parameters::ser_create_connection_o_auth_request_parameters(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_5) = &input.api_key_auth_parameters {
        ...
        crate::protocol_serde::shape_create_connection_api_key_auth_request_parameters::ser_create_connection_api_key_auth_request_parameters(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
