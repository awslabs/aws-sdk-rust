...
pub fn ser_create_event_bus_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEventBusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
