...
pub fn ser_list_api_destinations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_api_destinations::ListApiDestinationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
