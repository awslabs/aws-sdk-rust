...
pub fn ser_update_connection_auth_request_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateConnectionAuthRequestParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
