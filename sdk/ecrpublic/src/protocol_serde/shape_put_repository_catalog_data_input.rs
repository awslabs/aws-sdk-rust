...
pub fn ser_put_repository_catalog_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutRepositoryCatalogDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
