...
pub fn ser_set_repository_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::set_repository_policy::SetRepositoryPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
