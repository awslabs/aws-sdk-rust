...
pub fn ser_describe_image_tags_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeImageTagsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
