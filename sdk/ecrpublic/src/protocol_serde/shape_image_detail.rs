...
pub(crate) fn de_image_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ImageDetail>, aws_smithy_json::deserialize::error::DeserializeError>
