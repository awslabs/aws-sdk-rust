...
pub fn ser_batch_delete_image_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchDeleteImageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
