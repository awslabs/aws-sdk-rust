...
/// Operation shape for `DescribeImageTags`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_image_tags`](crate::client::fluent_builders::DescribeImageTags).
            ///
            /// `ParseStrictResponse` impl for `DescribeImageTags`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeImageTags {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_image_tags::de_describe_image_tags_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_image_tags::de_describe_image_tags_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DescribeRegistries`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`describe_registries`](crate::client::fluent_builders::DescribeRegistries).
            ///
            /// `ParseStrictResponse` impl for `DescribeRegistries`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRegistries {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_registries::de_describe_registries_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_registries::de_describe_registries_http_response(response)
                     }
                }
            }
...
/// Operation shape for `GetRegistryCatalogData`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_registry_catalog_data`](crate::client::fluent_builders::GetRegistryCatalogData).
            ///
...
/// Operation shape for `GetRepositoryCatalogData`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_repository_catalog_data`](crate::client::fluent_builders::GetRepositoryCatalogData).
            ///
...
/// Operation shape for `PutRegistryCatalogData`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`put_registry_catalog_data`](crate::client::fluent_builders::PutRegistryCatalogData).
            ///
            /// `ParseStrictResponse` impl for `PutRegistryCatalogData`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for PutRegistryCatalogData {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_registry_catalog_data::de_put_registry_catalog_data_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_registry_catalog_data::de_put_registry_catalog_data_http_response(response)
                     }
                }
            }
...
/// Operation shape for `PutRepositoryCatalogData`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`put_repository_catalog_data`](crate::client::fluent_builders::PutRepositoryCatalogData).
            ///
            /// `ParseStrictResponse` impl for `PutRepositoryCatalogData`.
#[derive(std::clone::Clone, std::default::Default, std::fmt::Debug)]
...
impl aws_smithy_http::response::ParseStrictResponse for PutRepositoryCatalogData {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_repository_catalog_data::de_put_repository_catalog_data_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_repository_catalog_data::de_put_repository_catalog_data_http_response(response)
                     }
                }
            }
