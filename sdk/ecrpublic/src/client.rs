    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`BatchCheckLayerAvailabilityInput`](crate::input::BatchCheckLayerAvailabilityInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::BatchCheckLayerAvailabilityInput::registry_id): <p>The AWS account ID associated with the public registry that contains the image layers to check. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::BatchCheckLayerAvailabilityInput::repository_name): <p>The name of the repository that is associated with the image layers to check.</p>
    ///   - [`layer_digests(Option<Vec<String>>)`](crate::input::BatchCheckLayerAvailabilityInput::layer_digests): <p>The digests of the image layers to check.</p>
    ...
    ///
    /// - Takes [`BatchDeleteImageInput`](crate::input::BatchDeleteImageInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::BatchDeleteImageInput::registry_id): <p>The AWS account ID associated with the registry that contains the image to delete. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::BatchDeleteImageInput::repository_name): <p>The repository in a public registry that contains the image to delete.</p>
    ///   - [`image_ids(Option<Vec<ImageIdentifier>>)`](crate::input::BatchDeleteImageInput::image_ids): <p>A list of image ID references that correspond to images to delete. The format of the <code>imageIds</code> reference is <code>imageTag=tag</code> or <code>imageDigest=digest</code>.</p>
    ...
    ///
    /// - Takes [`CompleteLayerUploadInput`](crate::input::CompleteLayerUploadInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::CompleteLayerUploadInput::registry_id): <p>The AWS account ID associated with the registry to which to upload layers. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::CompleteLayerUploadInput::repository_name): <p>The name of the repository in a public registry to associate with the image layer.</p>
    ///   - [`upload_id(Option<String>)`](crate::input::CompleteLayerUploadInput::upload_id): <p>The upload ID from a previous <code>InitiateLayerUpload</code> operation to associate with the image layer.</p>
    ///   - [`layer_digests(Option<Vec<String>>)`](crate::input::CompleteLayerUploadInput::layer_digests): <p>The <code>sha256</code> digest of the image layer.</p>
    ...
    ///   - [`repository_name(Option<String>)`](crate::input::CreateRepositoryInput::repository_name): <p>The name to use for the repository. This appears publicly in the Amazon ECR Public Gallery. The repository name may be specified on its own (such as <code>nginx-web-app</code>) or it can be prepended with a namespace to group the repository into a category (such as <code>project-a/nginx-web-app</code>).</p>
    ///   - [`catalog_data(Option<RepositoryCatalogDataInput>)`](crate::input::CreateRepositoryInput::catalog_data): <p>The details about the repository that are publicly visible in the Amazon ECR Public Gallery.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateRepositoryInput::tags): <p>The metadata that you apply to the repository to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.</p>
    ...
    ///   - [`registry_id(Option<String>)`](crate::input::DeleteRepositoryInput::registry_id): <p>The AWS account ID associated with the public registry that contains the repository to delete. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::DeleteRepositoryInput::repository_name): <p>The name of the repository to delete.</p>
    ///   - [`force(bool)`](crate::input::DeleteRepositoryInput::force): <p> If a repository contains images, forces the deletion.</p>
    ...
    ///
    /// - Takes [`DeleteRepositoryPolicyInput`](crate::input::DeleteRepositoryPolicyInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::DeleteRepositoryPolicyInput::registry_id): <p>The AWS account ID associated with the public registry that contains the repository policy to delete. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::DeleteRepositoryPolicyInput::repository_name): <p>The name of the repository that is associated with the repository policy to delete.</p>
    ...
    ///
    /// - Takes [`DescribeImageTagsInput`](crate::input::DescribeImageTagsInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::DescribeImageTagsInput::registry_id): <p>The AWS account ID associated with the public registry that contains the repository in which to describe images. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::DescribeImageTagsInput::repository_name): <p>The name of the repository that contains the image tag details to describe.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeImageTagsInput::next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>DescribeImageTags</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. This value is <code>null</code> when there are no more results to return. This option cannot be used when you specify images with <code>imageIds</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeImageTagsInput::max_results): <p>The maximum number of repository results returned by <code>DescribeImageTags</code> in paginated output. When this parameter is used, <code>DescribeImageTags</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>DescribeImageTags</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 1000. If this parameter is not used, then <code>DescribeImageTags</code> returns up to 100 results and a <code>nextToken</code> value, if applicable. This option cannot be used when you specify images with <code>imageIds</code>.</p>
    ...
    ///
    /// - Takes [`DescribeRepositoriesInput`](crate::input::DescribeRepositoriesInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::DescribeRepositoriesInput::registry_id): <p>The AWS account ID associated with the registry that contains the repositories to be described. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_names(Option<Vec<String>>)`](crate::input::DescribeRepositoriesInput::repository_names): <p>A list of repositories to describe. If this parameter is omitted, then all repositories in a registry are described.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeRepositoriesInput::next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>DescribeRepositories</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. This value is <code>null</code> when there are no more results to return. This option cannot be used when you specify repositories with <code>repositoryNames</code>.</p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeRepositoriesInput::max_results): <p>The maximum number of repository results returned by <code>DescribeRepositories</code> in paginated output. When this parameter is used, <code>DescribeRepositories</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>DescribeRepositories</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 1000. If this parameter is not used, then <code>DescribeRepositories</code> returns up to 100 results and a <code>nextToken</code> value, if applicable. This option cannot be used when you specify repositories with <code>repositoryNames</code>.</p>
    ...
    ///
    /// - Takes [`GetAuthorizationTokenInput`](crate::input::GetAuthorizationTokenInput)
    ...
    ///
    /// - Takes [`GetRegistryCatalogDataInput`](crate::input::GetRegistryCatalogDataInput)
    ...
    ///
    /// - Takes [`GetRepositoryCatalogDataInput`](crate::input::GetRepositoryCatalogDataInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::GetRepositoryCatalogDataInput::registry_id): <p>The AWS account ID associated with the registry that contains the repositories to be described. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::GetRepositoryCatalogDataInput::repository_name): <p>The name of the repository to retrieve the catalog metadata for.</p>
    ...
    ///
    /// - Takes [`GetRepositoryPolicyInput`](crate::input::GetRepositoryPolicyInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::GetRepositoryPolicyInput::registry_id): <p>The AWS account ID associated with the public registry that contains the repository. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::GetRepositoryPolicyInput::repository_name): <p>The name of the repository with the policy to retrieve.</p>
    ...
    ///
    /// - Takes [`InitiateLayerUploadInput`](crate::input::InitiateLayerUploadInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::InitiateLayerUploadInput::registry_id): <p>The AWS account ID associated with the registry to which you intend to upload layers. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::InitiateLayerUploadInput::repository_name): <p>The name of the repository to which you intend to upload layers.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) that identifies the resource for which to list the tags. Currently, the supported resource is an Amazon ECR Public repository.</p>
    ...
    ///
    /// - Takes [`PutImageInput`](crate::input::PutImageInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::PutImageInput::registry_id): <p>The AWS account ID associated with the public registry that contains the repository in which to put the image. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::PutImageInput::repository_name): <p>The name of the repository in which to put the image.</p>
    ///   - [`image_manifest(Option<String>)`](crate::input::PutImageInput::image_manifest): <p>The image manifest corresponding to the image to be uploaded.</p>
    ///   - [`image_manifest_media_type(Option<String>)`](crate::input::PutImageInput::image_manifest_media_type): <p>The media type of the image manifest. If you push an image manifest that does not contain the <code>mediaType</code> field, you must specify the <code>imageManifestMediaType</code> in the request.</p>
    ///   - [`image_tag(Option<String>)`](crate::input::PutImageInput::image_tag): <p>The tag to associate with the image. This parameter is required for images that use the Docker Image Manifest V2 Schema 2 or Open Container Initiative (OCI) formats.</p>
    ///   - [`image_digest(Option<String>)`](crate::input::PutImageInput::image_digest): <p>The image digest of the image manifest corresponding to the image.</p>
    ...
    ///
    /// - Takes [`PutRegistryCatalogDataInput`](crate::input::PutRegistryCatalogDataInput) with field(s):
    ///   - [`display_name(Option<String>)`](crate::input::PutRegistryCatalogDataInput::display_name): <p>The display name for a public registry. The display name is shown as the repository author in the Amazon ECR Public Gallery.</p> <note>   <p>The registry display name is only publicly visible in the Amazon ECR Public Gallery for verified accounts.</p>  </note>
    ...
    ///
    /// - Takes [`PutRepositoryCatalogDataInput`](crate::input::PutRepositoryCatalogDataInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::PutRepositoryCatalogDataInput::registry_id): <p>The AWS account ID associated with the public registry the repository is in. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::PutRepositoryCatalogDataInput::repository_name): <p>The name of the repository to create or update the catalog data for.</p>
    ///   - [`catalog_data(Option<RepositoryCatalogDataInput>)`](crate::input::PutRepositoryCatalogDataInput::catalog_data): <p>An object containing the catalog data for a repository. This data is publicly visible in the Amazon ECR Public Gallery.</p>
    ...
    ///
    /// - Takes [`SetRepositoryPolicyInput`](crate::input::SetRepositoryPolicyInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::SetRepositoryPolicyInput::registry_id): <p>The AWS account ID associated with the registry that contains the repository. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::SetRepositoryPolicyInput::repository_name): <p>The name of the repository to receive the policy.</p>
    ///   - [`policy_text(Option<String>)`](crate::input::SetRepositoryPolicyInput::policy_text): <p>The JSON repository policy text to apply to the repository. For more information, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/repository-policy-examples.html">Amazon ECR Repository Policies</a> in the <i>Amazon Elastic Container Registry User Guide</i>.</p>
    ///   - [`force(bool)`](crate::input::SetRepositoryPolicyInput::force): <p>If the policy you are attempting to set on a repository policy would prevent you from setting another policy in the future, you must force the <code>SetRepositoryPolicy</code> operation. This is intended to prevent accidental repository lock outs.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the resource to which to add tags. Currently, the supported resource is an Amazon ECR Public repository.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p>The tags to add to the resource. A tag is an array of key-value pairs. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the resource from which to delete tags. Currently, the supported resource is an Amazon ECR Public repository.</p>
    ...
    ///
    /// - Takes [`UploadLayerPartInput`](crate::input::UploadLayerPartInput) with field(s):
    ///   - [`registry_id(Option<String>)`](crate::input::UploadLayerPartInput::registry_id): <p>The AWS account ID associated with the registry to which you are uploading layer parts. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(Option<String>)`](crate::input::UploadLayerPartInput::repository_name): <p>The name of the repository to which you are uploading layer parts.</p>
    ///   - [`upload_id(Option<String>)`](crate::input::UploadLayerPartInput::upload_id): <p>The upload ID from a previous <code>InitiateLayerUpload</code> operation to associate with the layer part upload.</p>
    ///   - [`part_first_byte(Option<i64>)`](crate::input::UploadLayerPartInput::part_first_byte): <p>The position of the first byte of the layer part witin the overall image layer.</p>
    ///   - [`part_last_byte(Option<i64>)`](crate::input::UploadLayerPartInput::part_last_byte): <p>The position of the last byte of the layer part within the overall image layer.</p>
    ///   - [`layer_part_blob(Option<Blob>)`](crate::input::UploadLayerPartInput::layer_part_blob): <p>The base64-encoded layer part payload.</p>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeImageTagsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeRegistriesPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeRepositoriesPaginator<C, M, R> {
