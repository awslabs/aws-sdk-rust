...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_ecrpublic::Error> {
/// # let client: aws_sdk_ecrpublic::Client = unimplemented!();
...
mod describe_image_tags;

mod describe_images;

mod describe_registries;

mod describe_repositories;

mod get_authorization_token;

mod get_registry_catalog_data;

mod get_repository_catalog_data;
...
mod put_registry_catalog_data;

mod put_repository_catalog_data;
