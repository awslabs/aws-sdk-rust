...
pub(crate) fn describe_registries_output_output_correct_errors(
...
pub(crate) fn get_registry_catalog_data_output_output_correct_errors(
...
pub(crate) fn put_registry_catalog_data_output_output_correct_errors(
