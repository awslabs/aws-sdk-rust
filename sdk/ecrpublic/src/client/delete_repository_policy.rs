...
impl super::Client {
    ...
    ///   - [`repository_name(impl Into<String>)`](crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyFluentBuilder::set_repository_name):<br>required: **true**<br><p>The name of the repository that's associated with the repository policy to delete.</p><br>
