...
impl super::Client {
    ...
    ///   - [`registry_id(impl Into<String>)`](crate::operation::upload_layer_part::builders::UploadLayerPartFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::upload_layer_part::builders::UploadLayerPartFluentBuilder::set_registry_id):<br>required: **false**<br><p>The Amazon Web Services account ID, or registry alias, that's associated with the registry that you're uploading layer parts to. If you do not specify a registry, the default public registry is assumed.</p><br>
    ///   - [`repository_name(impl Into<String>)`](crate::operation::upload_layer_part::builders::UploadLayerPartFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::upload_layer_part::builders::UploadLayerPartFluentBuilder::set_repository_name):<br>required: **true**<br><p>The name of the repository that you're uploading layer parts to.</p><br>
