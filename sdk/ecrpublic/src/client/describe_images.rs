...
impl super::Client {
    ...
    ///   - [`registry_id(impl ::std::convert::Into<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::set_registry_id): <p>The Amazon Web Services account ID that's associated with the public registry that contains the repository where images are described. If you do not specify a registry, the default public registry is assumed.</p>
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::describe_images::builders::DescribeImagesFluentBuilder::set_repository_name): <p>The repository that contains the images to describe.</p>
