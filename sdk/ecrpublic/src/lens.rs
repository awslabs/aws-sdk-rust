...
pub(crate) fn reflens_describe_image_tags_output_output_next_token(
...
pub(crate) fn reflens_describe_registries_output_output_next_token(
...
pub(crate) fn lens_describe_registries_output_output_registries(
    input: crate::operation::describe_registries::DescribeRegistriesOutput,
