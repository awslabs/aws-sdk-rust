...
pub fn serialize_structure_batch_check_layer_availability_input(
...
pub fn serialize_structure_batch_delete_image_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_10 in var_8 {
            {
                ...
                crate::json_ser::serialize_structure_image_identifier(&mut object_11, item_10);
                object_11.finish();
            }
        }
        array_9.finish();
...
pub fn serialize_structure_complete_layer_upload_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_repository_input(
    ...
    if let Some(var_19) = &input.catalog_data {
        ...
        crate::json_ser::serialize_structure_repository_catalog_data_input(&mut object_20, var_19);
        object_20.finish();
    }
...
pub fn serialize_structure_delete_repository_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_repository_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_33 in var_31 {
            {
                ...
                crate::json_ser::serialize_structure_image_identifier(&mut object_34, item_33);
                object_34.finish();
            }
        }
        array_32.finish();
...
pub fn serialize_structure_describe_image_tags_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_registries_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_repositories_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_repository_catalog_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_repository_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_initiate_layer_upload_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_image_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_registry_catalog_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_repository_catalog_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_65) = &input.catalog_data {
        ...
        crate::json_ser::serialize_structure_repository_catalog_data_input(&mut object_66, var_65);
        object_66.finish();
    }
}

pub fn serialize_structure_set_repository_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_upload_layer_part_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_image_identifier(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_repository_catalog_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
