...
impl UploadLayerPartFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::upload_layer_part::UploadLayerPartOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upload_layer_part::UploadLayerPartError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::upload_layer_part::UploadLayerPartOutput, crate::operation::upload_layer_part::UploadLayerPartError, Self> {
