...
impl DescribeRegistriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_registries::ser_describe_registries_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRegistries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_registries::de_describe_registries_http_response_with_props(status, headers, body)
        }
    }
}
