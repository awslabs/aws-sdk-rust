...
impl InitiateLayerUploadFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::initiate_layer_upload::InitiateLayerUploadOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::initiate_layer_upload::InitiateLayerUploadError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::initiate_layer_upload::InitiateLayerUploadOutput, crate::operation::initiate_layer_upload::InitiateLayerUploadError, Self> {
