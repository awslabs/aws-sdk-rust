...
impl CompleteLayerUploadFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::complete_layer_upload::CompleteLayerUploadOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::complete_layer_upload::CompleteLayerUploadError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::complete_layer_upload::CompleteLayerUploadOutput, crate::operation::complete_layer_upload::CompleteLayerUploadError, Self> {
