...
impl BatchCheckLayerAvailability {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchCheckLayerAvailability {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchCheckLayerAvailability");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchCheckLayerAvailabilityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchCheckLayerAvailabilityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchCheckLayerAvailability")
...
.with_interceptor(BatchCheckLayerAvailabilityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError>::new());
...
#[derive(Debug)]
            struct BatchCheckLayerAvailabilityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchCheckLayerAvailabilityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_batch_check_layer_availability::de_batch_check_layer_availability_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchCheckLayerAvailabilityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchCheckLayerAvailabilityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_check_layer_availability::ser_batch_check_layer_availability_input(&input)?);
...
#[derive(Debug)]
            struct BatchCheckLayerAvailabilityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchCheckLayerAvailabilityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchCheckLayerAvailabilityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchCheckLayerAvailabilityInput>()
                        .ok_or("failed to downcast to BatchCheckLayerAvailabilityInput")?;
...
pub enum BatchCheckLayerAvailabilityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchCheckLayerAvailabilityError) for what information is available for the error.")]
...
impl BatchCheckLayerAvailabilityError {
    /// Creates the `BatchCheckLayerAvailabilityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchCheckLayerAvailabilityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchCheckLayerAvailabilityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError {
