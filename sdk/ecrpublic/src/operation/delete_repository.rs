...
impl DeleteRepositoryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRepository`](crate::operation::delete_repository::DeleteRepository)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_repository::DeleteRepository, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_repository::ser_delete_repository_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_repository::DeleteRepository::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteRepository", "ecrpublic"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_repository::de_delete_repository_http_response_with_props(status, headers, body)
        }
    }
}
