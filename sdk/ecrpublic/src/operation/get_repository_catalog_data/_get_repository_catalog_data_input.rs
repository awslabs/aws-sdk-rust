...
impl GetRepositoryCatalogDataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_repository_catalog_data::GetRepositoryCatalogDataInput, ::aws_smithy_types::error::operation::BuildError> {
