...
/// Orchestration and serialization glue logic for `GetRegistryCatalogData`.
...
impl GetRegistryCatalogData {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_registry_catalog_data::GetRegistryCatalogDataInput,
                    ) -> ::std::result::Result<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRegistryCatalogData {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRegistryCatalogDataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRegistryCatalogDataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRegistryCatalogData")
...
.with_interceptor(GetRegistryCatalogDataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRegistryCatalogDataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_registry_catalog_data::de_get_registry_catalog_data_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_registry_catalog_data::de_get_registry_catalog_data_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRegistryCatalogDataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_registry_catalog_data::GetRegistryCatalogDataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_registry_catalog_data::GetRegistryCatalogDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_registry_catalog_data::ser_get_registry_catalog_data_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct GetRegistryCatalogDataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRegistryCatalogDataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRegistryCatalogDataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        ...
                        .ok_or("failed to downcast to GetRegistryCatalogDataInput")?;
...
pub enum GetRegistryCatalogDataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRegistryCatalogDataError) for what information is available for the error.")]
...
impl GetRegistryCatalogDataError {
    /// Creates the `GetRegistryCatalogDataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRegistryCatalogDataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRegistryCatalogDataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_registry_catalog_data::GetRegistryCatalogDataError {
...
mod _get_registry_catalog_data_output;
