...
impl GetRepositoryCatalogDataInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_repository_catalog_data::GetRepositoryCatalogData::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRepositoryCatalogData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_repository_catalog_data::de_get_repository_catalog_data_http_response_with_props(status, headers, body)
        }
    }
}
