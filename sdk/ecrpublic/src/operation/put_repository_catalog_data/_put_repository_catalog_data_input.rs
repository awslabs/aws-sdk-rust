...
impl PutRepositoryCatalogDataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataInput, ::aws_smithy_types::error::operation::BuildError> {
