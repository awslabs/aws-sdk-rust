...
pub use crate::operation::delete_repository_policy::_delete_repository_policy_output::DeleteRepositoryPolicyOutputBuilder;
...
pub struct DeleteRepositoryPolicyFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_repository_policy::builders::DeleteRepositoryPolicyInputBuilder,
...
impl DeleteRepositoryPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_repository_policy::DeleteRepositoryPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_repository_policy::DeleteRepositoryPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_repository_policy::DeleteRepositoryPolicy::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_repository_policy::DeleteRepositoryPolicy::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_repository_policy::DeleteRepositoryPolicyOutput, crate::operation::delete_repository_policy::DeleteRepositoryPolicyError, Self> {
