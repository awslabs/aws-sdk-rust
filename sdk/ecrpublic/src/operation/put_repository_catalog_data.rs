...
/// Orchestration and serialization glue logic for `PutRepositoryCatalogData`.
...
impl PutRepositoryCatalogData {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutRepositoryCatalogData {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutRepositoryCatalogData");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutRepositoryCatalogDataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutRepositoryCatalogDataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutRepositoryCatalogData")
...
.with_interceptor(PutRepositoryCatalogDataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataError>::new());
...
#[derive(Debug)]
            struct PutRepositoryCatalogDataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRepositoryCatalogDataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_repository_catalog_data::de_put_repository_catalog_data_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutRepositoryCatalogDataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRepositoryCatalogDataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_repository_catalog_data::ser_put_repository_catalog_data_input(&input)?);
...
#[derive(Debug)]
            struct PutRepositoryCatalogDataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutRepositoryCatalogDataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutRepositoryCatalogDataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutRepositoryCatalogDataInput>()
                        .ok_or("failed to downcast to PutRepositoryCatalogDataInput")?;
...
pub enum PutRepositoryCatalogDataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutRepositoryCatalogDataError) for what information is available for the error.")]
...
impl PutRepositoryCatalogDataError {
    /// Creates the `PutRepositoryCatalogDataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutRepositoryCatalogDataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutRepositoryCatalogDataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_repository_catalog_data::PutRepositoryCatalogDataError {
...
mod _put_repository_catalog_data_output;
