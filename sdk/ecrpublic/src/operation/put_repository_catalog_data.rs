...
impl PutRepositoryCatalogDataInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_repository_catalog_data::PutRepositoryCatalogData::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRepositoryCatalogData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_repository_catalog_data::de_put_repository_catalog_data_http_response_with_props(status, headers, body)
        }
    }
}
