...
/// Paginator for [`DescribeRepositories`](crate::operation::describe_repositories::DescribeRepositories)
pub struct DescribeRepositoriesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::describe_repositories::builders::DescribeRepositoriesInputBuilder,
...
impl DescribeRepositoriesPaginator {
    ...
    pub fn items(self) -> crate::operation::describe_repositories::paginator::DescribeRepositoriesPaginatorItems {
        crate::operation::describe_repositories::paginator::DescribeRepositoriesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_repositories::DescribeRepositories::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_repositories_output_output_next_token(resp);
...
impl DescribeRepositoriesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_repositories_output_output_repositories(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
