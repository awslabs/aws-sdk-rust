...
impl StartObjectInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_object::StartObject::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartObject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_object::de_start_object_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_object::de_start_object_http_response_with_props(
                status, headers, body,
            )
        }
    }
