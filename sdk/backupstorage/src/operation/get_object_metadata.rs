...
/// Orchestration and serialization glue logic for `GetObjectMetadata`.
...
impl GetObjectMetadata {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_object_metadata::GetObjectMetadataInput,
                    ) -> ::std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_object_metadata::GetObjectMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_object_metadata::GetObjectMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_object_metadata::GetObjectMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetObjectMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetObjectMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetObjectMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetObjectMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetObjectMetadata")
...
.with_interceptor(GetObjectMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_object_metadata::GetObjectMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_object_metadata::GetObjectMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_object_metadata::GetObjectMetadataError>::new());
...
#[derive(Debug)]
            struct GetObjectMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetObjectMetadataResponseDeserializer {
                ...
                ::std::option::Option::Some(crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_get_object_metadata::de_get_object_metadata_http_response(response)))
            }
            ...
            crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_get_object_metadata::de_get_object_metadata_http_error(response.status().as_u16(), response.headers(), body))
                }
            }
#[derive(Debug)]
            struct GetObjectMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_object_metadata::GetObjectMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_object_metadata::GetObjectMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/restore-jobs/{StorageJobId}/object/{ObjectToken}/metadata", StorageJobId = storage_job_id, ObjectToken = object_token).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetObjectMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetObjectMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetObjectMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetObjectMetadataInput>()
                        .ok_or("failed to downcast to GetObjectMetadataInput")?;
...
pub enum GetObjectMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetObjectMetadataError) for what information is available for the error.")]
...
impl GetObjectMetadataError {
    /// Creates the `GetObjectMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetObjectMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetObjectMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_object_metadata::GetObjectMetadataError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_object_metadata::_get_object_metadata_output::GetObjectMetadataOutput;

pub use crate::operation::get_object_metadata::_get_object_metadata_input::GetObjectMetadataInput;

mod _get_object_metadata_input;

mod _get_object_metadata_output;
