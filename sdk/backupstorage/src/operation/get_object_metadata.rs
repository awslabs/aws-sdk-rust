...
impl GetObjectMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetObjectMetadata`](crate::operation::get_object_metadata::GetObjectMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_object_metadata::GetObjectMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object_metadata::GetObjectMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_object_metadata::GetObjectMetadata::new())
...
impl aws_smithy_http::response::ParseHttpResponse for GetObjectMetadata {
                type Output = std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError>;
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    ...
                    Some(crate::protocol_serde::shape_get_object_metadata::de_get_object_metadata_http_response_(response))
                }
                fn parse_loaded(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_object_metadata::de_get_object_metadata_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
