...
impl GetChunkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_chunk::GetChunk, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetChunk {
    ...
    fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
        ...
        ::std::option::Option::Some(crate::protocol_serde::shape_get_chunk::de_get_chunk_op_response(response))
    }
