...
impl crate::operation::get_chunk::builders::GetChunkInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_chunk::GetChunkOutput, crate::operation::get_chunk::GetChunkError>
    for GetChunkFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_chunk::GetChunkOutput, crate::operation::get_chunk::GetChunkError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetChunkFluentBuilder {
    /// Creates a new `GetChunkFluentBuilder`.
