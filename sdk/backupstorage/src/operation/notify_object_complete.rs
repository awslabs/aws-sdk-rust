    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::notify_object_complete::NotifyObjectCompleteError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::notify_object_complete::NotifyObjectCompleteOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for NotifyObjectCompleteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::notify_object_complete::NotifyObjectCompleteInput>()
            .expect("correct type");
