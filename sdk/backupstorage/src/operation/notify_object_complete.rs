...
impl NotifyObjectComplete {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::notify_object_complete::NotifyObjectCompleteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::notify_object_complete::NotifyObjectCompleteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::notify_object_complete::NotifyObjectCompleteError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::notify_object_complete::NotifyObjectCompleteOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for NotifyObjectComplete {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("NotifyObjectComplete");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(NotifyObjectCompleteRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(NotifyObjectCompleteResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("NotifyObjectComplete")
...
.with_interceptor(NotifyObjectCompleteEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::notify_object_complete::NotifyObjectCompleteError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::notify_object_complete::NotifyObjectCompleteError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::notify_object_complete::NotifyObjectCompleteError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_notify_object_complete::de_notify_object_complete_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for NotifyObjectCompleteRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::notify_object_complete::NotifyObjectCompleteInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::notify_object_complete::NotifyObjectCompleteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backup-jobs/{BackupJobId}/object/{UploadId}/complete", BackupJobId = backup_job_id, UploadId = upload_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::notify_object_complete::NotifyObjectCompleteInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_3 = &_input.object_checksum;
    let inner_3 = inner_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("object_checksum", "cannot be empty or unset"))?;
    if inner_3.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("object_checksum", "cannot be empty or unset"));
    }
    query.push_kv("checksum", &::aws_smithy_http::query::fmt_string(inner_3));
    let inner_4 = &_input.object_checksum_algorithm;
    let inner_4 = inner_4.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("object_checksum_algorithm", "cannot be empty or unset"))?;
...
builder
                    ...
                    let body = crate::protocol_serde::shape_notify_object_complete_input::ser_metadata_blob_http_payload( input.metadata_blob)?.into_inner();
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for NotifyObjectCompleteEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<NotifyObjectCompleteInput>()
                        .ok_or("failed to downcast to NotifyObjectCompleteInput")?;
...
pub enum NotifyObjectCompleteError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-NotifyObjectCompleteError) for what information is available for the error.")]
...
impl NotifyObjectCompleteError {
    /// Creates the `NotifyObjectCompleteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `NotifyObjectCompleteError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
