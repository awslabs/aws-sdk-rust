...
#[derive(Debug)]
    ...
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("object_name", "cannot be empty or unset"))?;
    let object_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if object_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("object_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/backup-jobs/{BackupJobId}/object/{ObjectName}", BackupJobId = backup_job_id, ObjectName = object_name).expect("formatting should succeed");
