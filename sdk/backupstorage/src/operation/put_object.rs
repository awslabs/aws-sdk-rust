...
impl PutObject {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("backupstorage", "PutObject", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutObject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutObject", "backupstorage"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for PutObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = crate::protocol_serde::shape_put_object_input::ser_inline_chunk_http_payload(input.inline_chunk)?.into_inner();
