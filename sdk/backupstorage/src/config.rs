...
impl Builder {
    ...
    /// use aws_sdk_backupstorage::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("backupstorage"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("backup-storage"));
        layer
        ...
        Config {
            config: ::aws_smithy_types::config_bag::Layer::from(layer.clone())
                .with_name("aws_sdk_backupstorage::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_backupstorage::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
