...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_backupstorage::Error> {
/// # let client: aws_sdk_backupstorage::Client = unimplemented!();
...
mod get_object_metadata;

mod list_chunks;

mod list_objects;

mod notify_object_complete;
