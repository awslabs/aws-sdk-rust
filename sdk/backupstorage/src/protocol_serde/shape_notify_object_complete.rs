...
pub fn de_notify_object_complete_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::NotifyObjectCompleteOutput, crate::error::NotifyObjectCompleteError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::NotifyObjectCompleteError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::error::NotifyObjectCompleteError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "IllegalArgumentException" => crate::error::NotifyObjectCompleteError::IllegalArgumentException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "KMSInvalidKeyUsageException" => crate::error::NotifyObjectCompleteError::KmsInvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NotReadableInputStreamException" => crate::error::NotifyObjectCompleteError::NotReadableInputStreamException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceInternalException" => crate::error::NotifyObjectCompleteError::ServiceInternalException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::NotifyObjectCompleteError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_notify_object_complete_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::NotifyObjectCompleteOutput, crate::error::NotifyObjectCompleteError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::notify_object_complete_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_notify_object_complete::de_notify_object_complete(response.body().as_ref(), output).map_err(crate::error::NotifyObjectCompleteError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_notify_object_complete(value: &[u8], mut builder: crate::output::notify_object_complete_output::Builder) -> Result<crate::output::notify_object_complete_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
