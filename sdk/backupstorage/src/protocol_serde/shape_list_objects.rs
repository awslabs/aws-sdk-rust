...
pub(crate) fn de_list_objects(value: &[u8], mut builder: crate::output::list_objects_output::Builder) -> Result<crate::output::list_objects_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
