...
pub fn de_get_object_metadata_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_object_metadata_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError> {
    #[allow(unused_mut)]
