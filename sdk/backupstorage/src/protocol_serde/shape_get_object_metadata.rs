...
) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError>
{
    ...
    Ok({
        ...
        output = output.set_metadata_blob(Some(crate::protocol_serde::shape_get_object_metadata_output::de_metadata_blob_payload(
            _response_body,
        )?));
        output = output.set_metadata_blob_checksum(
            crate::protocol_serde::shape_get_object_metadata_output::de_metadata_blob_checksum_header(_response_headers).map_err(|_| {
                crate::operation::get_object_metadata::GetObjectMetadataError::unhandled(
                    "Failed to parse MetadataBlobChecksum from header `x-amz-checksum",
                )
            })?,
        );
        output = output.set_metadata_blob_checksum_algorithm(
            crate::protocol_serde::shape_get_object_metadata_output::de_metadata_blob_checksum_algorithm_header(_response_headers).map_err(|_| {
                crate::operation::get_object_metadata::GetObjectMetadataError::unhandled(
                    "Failed to parse MetadataBlobChecksumAlgorithm from header `x-amz-checksum-algorithm",
                )
            })?,
        );
        output = output.set_metadata_blob_length(
            crate::protocol_serde::shape_get_object_metadata_output::de_metadata_blob_length_header(_response_headers).map_err(|_| {
                crate::operation::get_object_metadata::GetObjectMetadataError::unhandled(
                    "Failed to parse MetadataBlobLength from header `x-amz-data-length",
                )
            })?,
        );
        output = output.set_metadata_string(
            crate::protocol_serde::shape_get_object_metadata_output::de_metadata_string_header(_response_headers).map_err(|_| {
                crate::operation::get_object_metadata::GetObjectMetadataError::unhandled(
