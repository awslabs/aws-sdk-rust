...
pub fn de_get_object_metadata_http_response_(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError> {
