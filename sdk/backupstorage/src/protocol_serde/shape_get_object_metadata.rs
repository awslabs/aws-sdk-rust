...
pub fn de_get_object_metadata_op_response(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_object_metadata_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_object_metadata::GetObjectMetadataError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_get_object_metadata_http_response_with_props(response: &mut http::Response<aws_smithy_http::body::SdkBody>, properties: &aws_smithy_http::property_bag::PropertyBag) -> std::result::Result<crate::operation::get_object_metadata::GetObjectMetadataOutput, crate::operation::get_object_metadata::GetObjectMetadataError> {
    ...
    Ok({
        ...
        output = output.set_metadata_blob(
            Some(crate::protocol_serde::shape_get_object_metadata_output::de_metadata_blob_payload(_response_body)?)
        );
        ...
        output = output.set_metadata_string(
            crate::protocol_serde::shape_get_object_metadata_output::de_metadata_string_header(_response_headers)
