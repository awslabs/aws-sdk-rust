...
pub fn de_get_object_metadata_http_response(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::output::GetObjectMetadataOutput, crate::error::GetObjectMetadataError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_object_metadata_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetObjectMetadataOutput, crate::error::GetObjectMetadataError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetObjectMetadataError::unhandled)?;
