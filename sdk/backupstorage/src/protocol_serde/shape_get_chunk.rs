...
pub fn de_get_chunk_http_response(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::output::GetChunkOutput, crate::error::GetChunkError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_chunk_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetChunkOutput, crate::error::GetChunkError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetChunkError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "KMSInvalidKeyUsageException" => crate::error::GetChunkError::KmsInvalidKeyUsageException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
