...
pub fn de_put_chunk_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutChunkOutput, crate::error::PutChunkError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutChunkError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_chunk_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutChunkOutput, crate::error::PutChunkError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::put_chunk_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_put_chunk::de_put_chunk(response.body().as_ref(), output).map_err(crate::error::PutChunkError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_put_chunk(value: &[u8], mut builder: crate::output::put_chunk_output::Builder) -> Result<crate::output::put_chunk_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
