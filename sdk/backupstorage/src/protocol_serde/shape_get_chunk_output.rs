...
pub(crate) fn de_checksum_algorithm_header(header_map: &http::HeaderMap) -> std::result::Result<std::option::Option<crate::model::DataChecksumAlgorithm>, aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-checksum-algorithm").iter();
    aws_smithy_http::header::one_or_none(headers)
}

pub fn de_data_payload(body: &mut aws_smithy_http::body::SdkBody) -> std::result::Result<aws_smithy_http::byte_stream::ByteStream, crate::error::GetChunkError> {
