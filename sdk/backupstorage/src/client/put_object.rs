...
impl super::Client {
    ...
    ///   - [`inline_chunk_length(i64)`](crate::operation::put_object::builders::PutObjectFluentBuilder::inline_chunk_length) / [`set_inline_chunk_length(Option<i64>)`](crate::operation::put_object::builders::PutObjectFluentBuilder::set_inline_chunk_length): Length of the inline chunk data.
    ...
    ///   - [`throw_on_duplicate(bool)`](crate::operation::put_object::builders::PutObjectFluentBuilder::throw_on_duplicate) / [`set_throw_on_duplicate(Option<bool>)`](crate::operation::put_object::builders::PutObjectFluentBuilder::set_throw_on_duplicate): Throw an exception if Object name is already exist.
