...
impl super::Client {
    ...
    ///   - [`backup_job_id(impl ::std::convert::Into<String>)`](crate::operation::notify_object_complete::builders::NotifyObjectCompleteFluentBuilder::backup_job_id) / [`set_backup_job_id(Option<String>)`](crate::operation::notify_object_complete::builders::NotifyObjectCompleteFluentBuilder::set_backup_job_id): Backup job Id for the in-progress backup
    ///   - [`upload_id(impl ::std::convert::Into<String>)`](crate::operation::notify_object_complete::builders::NotifyObjectCompleteFluentBuilder::upload_id) / [`set_upload_id(Option<String>)`](crate::operation::notify_object_complete::builders::NotifyObjectCompleteFluentBuilder::set_upload_id): Upload Id for the in-progress upload
    ///   - [`object_checksum(impl ::std::convert::Into<String>)`](crate::operation::notify_object_complete::builders::NotifyObjectCompleteFluentBuilder::object_checksum) / [`set_object_checksum(Option<String>)`](crate::operation::notify_object_complete::builders::NotifyObjectCompleteFluentBuilder::set_object_checksum): Object checksum
