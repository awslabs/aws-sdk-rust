...
impl super::Client {
    ...
    ///   - [`backup_job_id(impl ::std::convert::Into<String>)`](crate::operation::delete_object::builders::DeleteObjectFluentBuilder::backup_job_id) / [`set_backup_job_id(Option<String>)`](crate::operation::delete_object::builders::DeleteObjectFluentBuilder::set_backup_job_id): Backup job Id for the in-progress backup.
