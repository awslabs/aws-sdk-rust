...
impl super::Client {
    ...
    ///   - [`backup_job_id(impl ::std::convert::Into<String>)`](crate::operation::start_object::builders::StartObjectFluentBuilder::backup_job_id) / [`set_backup_job_id(Option<String>)`](crate::operation::start_object::builders::StartObjectFluentBuilder::set_backup_job_id): Backup job Id for the in-progress backup
    ///   - [`object_name(impl ::std::convert::Into<String>)`](crate::operation::start_object::builders::StartObjectFluentBuilder::object_name) / [`set_object_name(Option<String>)`](crate::operation::start_object::builders::StartObjectFluentBuilder::set_object_name): Name for the object.
