...
impl super::Client {
    ...
    ///   - [`storage_job_id(impl ::std::convert::Into<String>)`](crate::operation::get_object_metadata::builders::GetObjectMetadataFluentBuilder::storage_job_id) / [`set_storage_job_id(Option<String>)`](crate::operation::get_object_metadata::builders::GetObjectMetadataFluentBuilder::set_storage_job_id): Backup job id for the in-progress backup.
    ///   - [`object_token(impl ::std::convert::Into<String>)`](crate::operation::get_object_metadata::builders::GetObjectMetadataFluentBuilder::object_token) / [`set_object_token(Option<String>)`](crate::operation::get_object_metadata::builders::GetObjectMetadataFluentBuilder::set_object_token): Object token.
