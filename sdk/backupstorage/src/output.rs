...
impl  std::fmt::Debug for StartObjectOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("StartObjectOutput");
...
pub struct PutObjectOutput  {
    ...
    #[doc(hidden)]pub inline_chunk_checksum_algorithm: std::option::Option<crate::model::DataChecksumAlgorithm>,
    /// object checksum
...
pub struct PutChunkOutput  {
    /// Chunk checksum
    #[doc(hidden)]pub chunk_checksum: std::option::Option<std::string::String>,
    /// Checksum algorithm
    #[doc(hidden)]pub chunk_checksum_algorithm: std::option::Option<crate::model::DataChecksumAlgorithm>,
}
impl PutChunkOutput {
    /// Chunk checksum
...
impl  std::fmt::Debug for PutChunkOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("PutChunkOutput");
        formatter.field("chunk_checksum", &self.chunk_checksum);
        formatter.field("chunk_checksum_algorithm", &self.chunk_checksum_algorithm);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for NotifyObjectCompleteOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("NotifyObjectCompleteOutput");
        formatter.field("object_checksum", &self.object_checksum);
        formatter.field("object_checksum_algorithm", &self.object_checksum_algorithm);
        formatter.finish()
    }
...
pub struct ListObjectsOutput  {
    /// Object list
    #[doc(hidden)]pub object_list: std::option::Option<std::vec::Vec<crate::model::BackupObject>>,
    /// Pagination token
...
impl  std::fmt::Debug for ListObjectsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("object_list", &self.object_list);
...
pub struct ListChunksOutput  {
    /// List of chunks
    #[doc(hidden)]pub chunk_list: std::option::Option<std::vec::Vec<crate::model::Chunk>>,
    /// Pagination token
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListChunksOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListChunksOutput");
        formatter.field("chunk_list", &self.chunk_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for GetObjectMetadataOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetObjectMetadataOutput");
...
#[allow(missing_docs)] // documentation missing in model
#[non_exhaustive]pub struct GetChunkOutput  {
    /// Chunk data
...
impl  std::fmt::Debug for GetChunkOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetChunkOutput");
