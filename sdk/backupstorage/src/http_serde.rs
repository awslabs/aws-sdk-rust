...
pub fn deser_header_get_chunk_get_chunk_output_checksum(
...
pub fn deser_header_get_chunk_get_chunk_output_checksum_algorithm(
    header_map: &http::HeaderMap,
) -> std::result::Result<
...
pub fn deser_header_get_chunk_get_chunk_output_length(
    header_map: &http::HeaderMap,
...
pub fn deser_header_get_object_metadata_get_object_metadata_output_metadata_blob_checksum(
    header_map: &http::HeaderMap,
) -> std::result::Result<
    std::option::Option<std::string::String>,
    aws_smithy_http::header::ParseError,
...
pub fn deser_header_get_object_metadata_get_object_metadata_output_metadata_blob_checksum_algorithm(
    header_map: &http::HeaderMap,
) -> std::result::Result<
    std::option::Option<crate::model::DataChecksumAlgorithm>,
    aws_smithy_http::header::ParseError,
...
pub fn deser_header_get_object_metadata_get_object_metadata_output_metadata_blob_length(
    header_map: &http::HeaderMap,
) -> std::result::Result<std::option::Option<i64>, aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amz-data-length").iter();
...
pub fn deser_header_get_object_metadata_get_object_metadata_output_metadata_string(
    header_map: &http::HeaderMap,
) -> std::result::Result<
    std::option::Option<std::string::String>,
    aws_smithy_http::header::ParseError,
