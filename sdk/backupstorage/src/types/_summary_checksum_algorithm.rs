...
impl ::std::convert::From<&str> for SummaryChecksumAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SummaryChecksumAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SummaryChecksumAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SummaryChecksumAlgorithm::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SummaryChecksumAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
