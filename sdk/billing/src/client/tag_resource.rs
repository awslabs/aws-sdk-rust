...
impl super::Client {
    ...
    ///   - [`resource_tags(ResourceTag)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::resource_tags) / [`set_resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::set_resource_tags):<br>required: **true**<br><p>A list of tag key value pairs that are associated with the resource.</p><br>
