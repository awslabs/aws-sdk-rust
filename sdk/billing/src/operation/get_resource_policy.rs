...
impl GetResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Billing", "GetResourcePolicy", input, runtime_plugins, stop_point).await
    }
