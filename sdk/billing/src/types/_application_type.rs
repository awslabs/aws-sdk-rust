...
///     ApplicationType::BeforeCrossServiceDiscounts => { /* ... */ },
...
impl ::std::convert::From<&str> for ApplicationType {
    fn from(s: &str) -> Self {
        match s {
            "AFTER_DISCOUNTS" => ApplicationType::AfterDiscounts,
            "BEFORE_CROSS_SERVICE_DISCOUNTS" => ApplicationType::BeforeCrossServiceDiscounts,
            other => ApplicationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationType::from(s))
    }
}
impl ApplicationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ApplicationType::AfterDiscounts => "AFTER_DISCOUNTS",
            ApplicationType::BeforeCrossServiceDiscounts => "BEFORE_CROSS_SERVICE_DISCOUNTS",
            ApplicationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["AFTER_DISCOUNTS", "BEFORE_CROSS_SERVICE_DISCOUNTS"]
    }
}
...
impl ::std::fmt::Display for ApplicationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ApplicationType::AfterDiscounts => write!(f, "AFTER_DISCOUNTS"),
            ApplicationType::BeforeCrossServiceDiscounts => write!(f, "BEFORE_CROSS_SERVICE_DISCOUNTS"),
