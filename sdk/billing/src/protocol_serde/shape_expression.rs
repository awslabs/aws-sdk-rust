            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "dimensions" => {
                            builder = builder.set_dimensions(crate::protocol_serde::shape_dimension_values::de_dimension_values(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "tags" => {
                            builder = builder.set_tags(crate::protocol_serde::shape_tag_values::de_tag_values(tokens, _value, depth + 1)?);
                        }
                        "costCategories" => {
