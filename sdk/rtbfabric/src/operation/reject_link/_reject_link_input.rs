...
impl RejectLinkInput {
    /// Creates a new builder-style object to manufacture [`RejectLinkInput`](crate::operation::reject_link::RejectLinkInput).
...
/// A builder for [`RejectLinkInput`](crate::operation::reject_link::RejectLinkInput).
...
impl RejectLinkInputBuilder {
    ...
    /// Consumes the builder and constructs a [`RejectLinkInput`](crate::operation::reject_link::RejectLinkInput).
