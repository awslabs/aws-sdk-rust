...
impl RejectLinkOutput {
    /// Creates a new builder-style object to manufacture [`RejectLinkOutput`](crate::operation::reject_link::RejectLinkOutput).
...
/// A builder for [`RejectLinkOutput`](crate::operation::reject_link::RejectLinkOutput).
...
impl RejectLinkOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`RejectLinkOutput`](crate::operation::reject_link::RejectLinkOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`gateway_id`](crate::operation::reject_link::builders::RejectLinkOutputBuilder::gateway_id)
    /// - [`peer_gateway_id`](crate::operation::reject_link::builders::RejectLinkOutputBuilder::peer_gateway_id)
    /// - [`status`](crate::operation::reject_link::builders::RejectLinkOutputBuilder::status)
    /// - [`created_at`](crate::operation::reject_link::builders::RejectLinkOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::reject_link::builders::RejectLinkOutputBuilder::updated_at)
    /// - [`link_id`](crate::operation::reject_link::builders::RejectLinkOutputBuilder::link_id)
