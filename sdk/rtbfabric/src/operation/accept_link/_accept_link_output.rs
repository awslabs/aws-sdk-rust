...
impl ::aws_types::request_id::RequestId for AcceptLinkOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl AcceptLinkOutput {
    /// Creates a new builder-style object to manufacture [`AcceptLinkOutput`](crate::operation::accept_link::AcceptLinkOutput).
    pub fn builder() -> crate::operation::accept_link::builders::AcceptLinkOutputBuilder {
        crate::operation::accept_link::builders::AcceptLinkOutputBuilder::default()
    }
}

/// A builder for [`AcceptLinkOutput`](crate::operation::accept_link::AcceptLinkOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AcceptLinkOutputBuilder {
...
impl AcceptLinkOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`AcceptLinkOutput`](crate::operation::accept_link::AcceptLinkOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`gateway_id`](crate::operation::accept_link::builders::AcceptLinkOutputBuilder::gateway_id)
    /// - [`peer_gateway_id`](crate::operation::accept_link::builders::AcceptLinkOutputBuilder::peer_gateway_id)
    /// - [`status`](crate::operation::accept_link::builders::AcceptLinkOutputBuilder::status)
    /// - [`created_at`](crate::operation::accept_link::builders::AcceptLinkOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::accept_link::builders::AcceptLinkOutputBuilder::updated_at)
    /// - [`link_id`](crate::operation::accept_link::builders::AcceptLinkOutputBuilder::link_id)
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_link::AcceptLinkOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::accept_link::AcceptLinkOutput {
            gateway_id: self.gateway_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "gateway_id",
                    "gateway_id was not specified but it is required when building AcceptLinkOutput",
                )
            })?,
            peer_gateway_id: self.peer_gateway_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "peer_gateway_id",
                    "peer_gateway_id was not specified but it is required when building AcceptLinkOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building AcceptLinkOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building AcceptLinkOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building AcceptLinkOutput",
                )
            })?,
            ...
            link_id: self.link_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "link_id",
                    "link_id was not specified but it is required when building AcceptLinkOutput",
                )
            })?,
