...
impl DisassociateCertificateOutputBuilder {
    ...
    /// - [`gateway_id`](crate::operation::disassociate_certificate::builders::DisassociateCertificateOutputBuilder::gateway_id)
    /// - [`acm_certificate_arn`](crate::operation::disassociate_certificate::builders::DisassociateCertificateOutputBuilder::acm_certificate_arn)
    /// - [`status`](crate::operation::disassociate_certificate::builders::DisassociateCertificateOutputBuilder::status)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::disassociate_certificate::DisassociateCertificateOutput {
            gateway_id: self.gateway_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "gateway_id",
                    "gateway_id was not specified but it is required when building DisassociateCertificateOutput",
                )
            })?,
            acm_certificate_arn: self.acm_certificate_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "acm_certificate_arn",
                    "acm_certificate_arn was not specified but it is required when building DisassociateCertificateOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building DisassociateCertificateOutput",
                )
            })?,
