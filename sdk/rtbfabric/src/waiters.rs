...
/// Supporting types for the `certificate_associated` waiter.
pub mod certificate_associated;

/// Supporting types for the `certificate_disassociated` waiter.
pub mod certificate_disassociated;
...
/// Supporting types for the `link_routing_rule_active` waiter.
pub mod link_routing_rule_active;

/// Supporting types for the `link_routing_rule_deleted` waiter.
pub mod link_routing_rule_deleted;
