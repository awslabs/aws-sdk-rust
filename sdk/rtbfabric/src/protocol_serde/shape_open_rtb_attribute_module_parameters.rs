...
pub fn ser_open_rtb_attribute_module_parameters(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::OpenRtbAttributeModuleParameters,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    {
        object.key("filterType").string(input.filter_type.as_str());
    }
    {
        let mut array_1 = object.key("filterConfiguration").start_array();
        for item_2 in &input.filter_configuration {
            {
                #[allow(unused_mut)]
    ...
    if let Some(var_4) = &input.action {
        ...
        crate::protocol_serde::shape_action::ser_action(&mut object_5, var_4)?;
        object_5.finish();
    }
    {
        object.key("holdbackPercentage").number(
            #[allow(clippy::useless_conversion)]
            ::aws_smithy_types::Number::Float((input.holdback_percentage).into()),
        );
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::OpenRtbAttributeModuleParametersBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::open_rtb_attribute_module_parameters_correct_errors(builder)
                    .build()
