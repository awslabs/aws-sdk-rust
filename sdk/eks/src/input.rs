...
impl CreateFargateProfileInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_fargate_profile::ser_create_fargate_profile_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateClusterVersionInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_cluster_version::ser_update_cluster_version_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
