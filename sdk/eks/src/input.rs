...
#[doc(hidden)]
pub type AssociateEncryptionConfigInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type AssociateIdentityProviderConfigInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
pub mod create_addon_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::CreateAddonInput, smithy_http::operation::BuildError>
        {
...
#[doc(hidden)]
pub type CreateAddonInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl CreateAddonInput {
    ...
    > {
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::CreateAddon::new())
                .with_metadata(smithy_http::operation::Metadata::new("CreateAddon", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
...
#[doc(hidden)]
pub type CreateFargateProfileInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type CreateNodegroupInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
pub mod delete_addon_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::DeleteAddonInput, smithy_http::operation::BuildError>
        {
...
#[doc(hidden)]
pub type DeleteAddonInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl DeleteAddonInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::DeleteAddonInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
            if _input.preserve {
                query.push_kv(
                    "preserve",
                    &smithy_types::primitive::Encoder::from(_input.preserve).encode(),
                );
            }
        }
        #[allow(clippy::unnecessary_wraps)]
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::DeleteAddon::new())
                .with_metadata(smithy_http::operation::Metadata::new("DeleteAddon", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
...
#[doc(hidden)]
pub type DeleteFargateProfileInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type DeleteNodegroupInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
pub mod describe_addon_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::DescribeAddonInput, smithy_http::operation::BuildError>
        {
...
#[doc(hidden)]
pub type DescribeAddonInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl DescribeAddonInput {
    ...
    > {
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::DescribeAddon::new())
                .with_metadata(smithy_http::operation::Metadata::new(
                    "DescribeAddon",
                    "eks",
                ));
...
#[doc(hidden)]
pub type DescribeAddonVersionsInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl DescribeAddonVersionsInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::DescribeAddonVersionsInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
...
#[doc(hidden)]
pub type DescribeFargateProfileInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type DescribeIdentityProviderConfigInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type DescribeNodegroupInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type DescribeUpdateInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl DescribeUpdateInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::DescribeUpdateInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
...
#[doc(hidden)]
pub type DisassociateIdentityProviderConfigInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
pub mod list_addons_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::ListAddonsInput, smithy_http::operation::BuildError>
        {
...
#[doc(hidden)]
pub type ListAddonsInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl ListAddonsInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::ListAddonsInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::ListAddons::new())
                .with_metadata(smithy_http::operation::Metadata::new("ListAddons", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
    ...
    > {
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::ListClusters::new())
                .with_metadata(smithy_http::operation::Metadata::new("ListClusters", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
...
#[doc(hidden)]
pub type ListFargateProfilesInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl ListFargateProfilesInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::ListFargateProfilesInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
...
#[doc(hidden)]
pub type ListIdentityProviderConfigsInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type ListNodegroupsInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl ListNodegroupsInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::ListNodegroupsInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
...
pub mod list_updates_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::ListUpdatesInput, smithy_http::operation::BuildError>
        {
...
#[doc(hidden)]
pub type ListUpdatesInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl ListUpdatesInput {
    ...
    > {
        ...
        fn uri_query(_input: &crate::input::ListUpdatesInput, mut output: &mut String) {
            let mut query = smithy_http::query::Writer::new(&mut output);
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::ListUpdates::new())
                .with_metadata(smithy_http::operation::Metadata::new("ListUpdates", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
    ...
    > {
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::TagResource::new())
                .with_metadata(smithy_http::operation::Metadata::new("TagResource", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
...
pub mod update_addon_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::UpdateAddonInput, smithy_http::operation::BuildError>
        {
...
#[doc(hidden)]
pub type UpdateAddonInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
impl UpdateAddonInput {
    ...
    > {
        ...
        let op =
            smithy_http::operation::Operation::new(request, crate::operation::UpdateAddon::new())
                .with_metadata(smithy_http::operation::Metadata::new("UpdateAddon", "eks"));
        let op = op.with_retry_policy(aws_http::AwsErrorRetryPolicy::new());
        Ok(op)
    }
    fn assemble(
...
#[doc(hidden)]
pub type UpdateClusterConfigInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type UpdateClusterVersionInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type UpdateNodegroupConfigInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
...
#[doc(hidden)]
pub type UpdateNodegroupVersionInputOperationRetryAlias = aws_http::AwsErrorRetryPolicy;
