...
impl ListNodegroupsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_nodegroups::ListNodegroups::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListNodegroups {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_nodegroups::de_list_nodegroups_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_nodegroups::de_list_nodegroups_http_response(
                status, headers, body,
            )
        }
    }
