...
impl UpdateAddonFluentBuilder  {
    /// Creates a new `UpdateAddon`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_addon::UpdateAddonOutput, aws_smithy_http::result::SdkError<crate::operation::update_addon::UpdateAddonError>>
                     {
