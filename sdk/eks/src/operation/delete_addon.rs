...
impl DeleteAddonInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAddon`](crate::operation::delete_addon::DeleteAddon)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_addon::DeleteAddon, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_addon::DeleteAddonInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("addon_name", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::delete_addon::DeleteAddonInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_addon::DeleteAddon::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAddon {
                type Output = std::result::Result<crate::operation::delete_addon::DeleteAddonOutput, crate::operation::delete_addon::DeleteAddonError>;
