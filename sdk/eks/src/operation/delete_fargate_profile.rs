...
impl DeleteFargateProfileInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFargateProfile`](crate::operation::delete_fargate_profile::DeleteFargateProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_fargate_profile::DeleteFargateProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_fargate_profile::DeleteFargateProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("fargate_profile_name", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_fargate_profile::DeleteFargateProfile::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFargateProfile {
                type Output = std::result::Result<crate::operation::delete_fargate_profile::DeleteFargateProfileOutput, crate::operation::delete_fargate_profile::DeleteFargateProfileError>;
