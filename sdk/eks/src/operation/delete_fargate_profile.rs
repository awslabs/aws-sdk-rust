...
impl DeleteFargateProfile {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_fargate_profile::DeleteFargateProfileInput,
                    ) -> ::std::result::Result<crate::operation::delete_fargate_profile::DeleteFargateProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_fargate_profile::DeleteFargateProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_fargate_profile::DeleteFargateProfileError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_fargate_profile::DeleteFargateProfileOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFargateProfile {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFargateProfile");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFargateProfileRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFargateProfileResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFargateProfile")
...
.with_interceptor(DeleteFargateProfileEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_fargate_profile::DeleteFargateProfileError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_fargate_profile::DeleteFargateProfileError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_fargate_profile::DeleteFargateProfileError>::new());
...
#[derive(Debug)]
            struct DeleteFargateProfileResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFargateProfileResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_fargate_profile::de_delete_fargate_profile_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_fargate_profile::de_delete_fargate_profile_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFargateProfileRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFargateProfileRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_fargate_profile::DeleteFargateProfileInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_fargate_profile::DeleteFargateProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.fargate_profile_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("fargate_profile_name", "cannot be empty or unset"))?;
    let fargate_profile_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if fargate_profile_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("fargate_profile_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/clusters/{clusterName}/fargate-profiles/{fargateProfileName}", clusterName = cluster_name, fargateProfileName = fargate_profile_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteFargateProfileEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFargateProfileEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFargateProfileEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFargateProfileInput>()
                        .ok_or("failed to downcast to DeleteFargateProfileInput")?;
...
pub enum DeleteFargateProfileError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFargateProfileError) for what information is available for the error.")]
...
impl DeleteFargateProfileError {
    /// Creates the `DeleteFargateProfileError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFargateProfileError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFargateProfileError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_fargate_profile::DeleteFargateProfileError {
...
mod _delete_fargate_profile_output;
