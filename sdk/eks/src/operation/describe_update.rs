...
impl DescribeUpdateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_update::DescribeUpdate::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeUpdate {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_update::de_describe_update_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_update::de_describe_update_http_response(
                status, headers, body,
            )
        }
    }
