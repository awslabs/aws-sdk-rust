...
impl RegisterClusterInput {
    /// Consumes the builder and constructs an Operation<[`RegisterCluster`](crate::operation::register_cluster::RegisterCluster)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_cluster::RegisterCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_cluster::ser_register_cluster_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_cluster::RegisterCluster::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_cluster::de_register_cluster_http_response_with_props(status, headers, body)
        }
    }
}
