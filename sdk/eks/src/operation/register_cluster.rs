...
impl RegisterClusterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_cluster::RegisterCluster::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_cluster::de_register_cluster_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_cluster::RegisterClusterError
{
