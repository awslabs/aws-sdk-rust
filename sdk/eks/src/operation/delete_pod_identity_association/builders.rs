...
impl DeletePodIdentityAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_pod_identity_association::DeletePodIdentityAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_pod_identity_association::DeletePodIdentityAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_pod_identity_association::DeletePodIdentityAssociationOutput, crate::operation::delete_pod_identity_association::DeletePodIdentityAssociationError, Self> {
