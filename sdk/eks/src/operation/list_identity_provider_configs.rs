...
impl ListIdentityProviderConfigs {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EKS", "ListIdentityProviderConfigs", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "EKS.ListIdentityProviderConfigs",
                "rpc.service" = "EKS",
                "rpc.method" = "ListIdentityProviderConfigs",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListIdentityProviderConfigs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListIdentityProviderConfigsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListIdentityProviderConfigsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListIdentityProviderConfigs")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListIdentityProviderConfigs")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListIdentityProviderConfigsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListIdentityProviderConfigsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListIdentityProviderConfigsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListIdentityProviderConfigsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListIdentityProviderConfigsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_identity_provider_configs::de_list_identity_provider_configs_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_identity_provider_configs::de_list_identity_provider_configs_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListIdentityProviderConfigsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsInput,
                ...
                ::std::write!(output, "/clusters/{clusterName}/identity-provider-configs", clusterName = cluster_name)
