...
impl ListIdentityProviderConfigsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_identity_provider_configs::ListIdentityProviderConfigs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentityProviderConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_identity_provider_configs::de_list_identity_provider_configs_http_response_with_props(
                status, headers, body,
            )
        }
    }
