...
impl DeleteNodegroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_nodegroup::DeleteNodegroup, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNodegroup {
    type Output =
        ::std::result::Result<crate::operation::delete_nodegroup::DeleteNodegroupOutput, crate::operation::delete_nodegroup::DeleteNodegroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_nodegroup::de_delete_nodegroup_http_response_with_props(status, headers, body)
        }
    }
}
