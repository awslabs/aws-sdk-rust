...
/// Orchestration and serialization glue logic for `DescribeNodegroup`.
...
impl DescribeNodegroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_nodegroup::DescribeNodegroupInput,
                    ) -> ::std::result::Result<crate::operation::describe_nodegroup::DescribeNodegroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_nodegroup::DescribeNodegroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_nodegroup::DescribeNodegroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_nodegroup::DescribeNodegroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeNodegroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeNodegroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeNodegroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeNodegroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeNodegroup")
...
.with_interceptor(DescribeNodegroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_nodegroup::DescribeNodegroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_nodegroup::DescribeNodegroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_nodegroup::DescribeNodegroupError>::new());
...
#[derive(Debug)]
            struct DescribeNodegroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeNodegroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_nodegroup::de_describe_nodegroup_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_nodegroup::de_describe_nodegroup_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeNodegroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeNodegroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_nodegroup::DescribeNodegroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_nodegroup::DescribeNodegroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/clusters/{clusterName}/node-groups/{nodegroupName}", clusterName = cluster_name, nodegroupName = nodegroup_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribeNodegroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeNodegroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeNodegroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeNodegroupInput>()
                        .ok_or("failed to downcast to DescribeNodegroupInput")?;
...
pub enum DescribeNodegroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeNodegroupError) for what information is available for the error.")]
...
impl DescribeNodegroupError {
    /// Creates the `DescribeNodegroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeNodegroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeNodegroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_nodegroup::DescribeNodegroupError {
...
mod _describe_nodegroup_output;
