...
impl ListUpdatesFluentBuilder  {
    /// Creates a new `ListUpdates`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_updates::ListUpdatesOutput, aws_smithy_http::result::SdkError<crate::operation::list_updates::ListUpdatesError>>
                     {
