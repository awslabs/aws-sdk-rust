...
pub use crate::operation::list_updates::_list_updates_output::ListUpdatesOutputBuilder;
...
pub struct ListUpdatesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_updates::builders::ListUpdatesInputBuilder,
...
impl ListUpdatesFluentBuilder {
    ...
    /// Access the ListUpdates as a reference.
    pub fn as_input(&self) -> &crate::operation::list_updates::builders::ListUpdatesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_updates::ListUpdatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_updates::ListUpdatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_updates::ListUpdates::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_updates::ListUpdates::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_updates::ListUpdatesOutput, crate::operation::list_updates::ListUpdatesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_updates::paginator::ListUpdatesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_updates::paginator::ListUpdatesPaginator {
                                crate::operation::list_updates::paginator::ListUpdatesPaginator::new(self.handle, self.inner)
                            }
