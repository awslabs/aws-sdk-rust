...
impl ListUpdatesInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::list_updates::ListUpdatesError, ::aws_smithy_http::operation::Response>,
    > {
...
impl ListUpdatesFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        crate::client::customize::CustomizableOperation<crate::operation::list_updates::ListUpdates, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_updates::paginator::ListUpdatesPaginator::send) which returns a `Stream`.
