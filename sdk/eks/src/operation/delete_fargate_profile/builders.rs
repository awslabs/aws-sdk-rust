...
impl DeleteFargateProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_fargate_profile::DeleteFargateProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_fargate_profile::DeleteFargateProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_fargate_profile::DeleteFargateProfileOutput, crate::operation::delete_fargate_profile::DeleteFargateProfileError, Self> {
