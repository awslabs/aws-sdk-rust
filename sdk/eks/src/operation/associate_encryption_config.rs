...
impl AssociateEncryptionConfigInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_encryption_config::AssociateEncryptionConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateEncryptionConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_encryption_config::de_associate_encryption_config_http_response_with_props(status, headers, body)
        }
    }
}
