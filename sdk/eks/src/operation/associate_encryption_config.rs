...
impl AssociateEncryptionConfigInput {
    /// Consumes the builder and constructs an Operation<[`AssociateEncryptionConfig`](crate::operation::associate_encryption_config::AssociateEncryptionConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_encryption_config::AssociateEncryptionConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_encryption_config::AssociateEncryptionConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_encryption_config::ser_associate_encryption_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_encryption_config::AssociateEncryptionConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateEncryptionConfig {
                type Output = std::result::Result<crate::operation::associate_encryption_config::AssociateEncryptionConfigOutput, crate::operation::associate_encryption_config::AssociateEncryptionConfigError>;
