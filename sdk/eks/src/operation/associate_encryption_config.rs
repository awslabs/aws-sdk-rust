...
/// Orchestration and serialization glue logic for `AssociateEncryptionConfig`.
...
impl AssociateEncryptionConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_encryption_config::AssociateEncryptionConfigInput,
                    ) -> ::std::result::Result<crate::operation::associate_encryption_config::AssociateEncryptionConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_encryption_config::AssociateEncryptionConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_encryption_config::AssociateEncryptionConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_encryption_config::AssociateEncryptionConfigOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::associate_encryption_config::AssociateEncryptionConfigInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateEncryptionConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateEncryptionConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateEncryptionConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateEncryptionConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateEncryptionConfig")
...
.with_interceptor(AssociateEncryptionConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_encryption_config::AssociateEncryptionConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_encryption_config::AssociateEncryptionConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_encryption_config::AssociateEncryptionConfigError>::new());
...
#[derive(Debug)]
            struct AssociateEncryptionConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateEncryptionConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_encryption_config::de_associate_encryption_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_encryption_config::de_associate_encryption_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateEncryptionConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateEncryptionConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_encryption_config::AssociateEncryptionConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_encryption_config::AssociateEncryptionConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/clusters/{clusterName}/encryption-config/associate", clusterName = cluster_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_encryption_config::ser_associate_encryption_config_input(&input)?);
...
#[derive(Debug)]
            struct AssociateEncryptionConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateEncryptionConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateEncryptionConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateEncryptionConfigInput>()
                        .ok_or("failed to downcast to AssociateEncryptionConfigInput")?;
...
pub enum AssociateEncryptionConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateEncryptionConfigError) for what information is available for the error.")]
...
impl AssociateEncryptionConfigError {
    /// Creates the `AssociateEncryptionConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateEncryptionConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateEncryptionConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_encryption_config::AssociateEncryptionConfigError {
...
mod _associate_encryption_config_output;
