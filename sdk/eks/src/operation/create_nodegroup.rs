...
impl CreateNodegroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateNodegroup`](crate::operation::create_nodegroup::CreateNodegroup)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_nodegroup::CreateNodegroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_nodegroup::ser_create_nodegroup_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_nodegroup::CreateNodegroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNodegroup {
    type Output =
        ::std::result::Result<crate::operation::create_nodegroup::CreateNodegroupOutput, crate::operation::create_nodegroup::CreateNodegroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_nodegroup::de_create_nodegroup_http_response_with_props(status, headers, body)
        }
    }
}
