...
impl CreateNodegroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_nodegroup::CreateNodegroup,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_nodegroup::CreateNodegroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNodegroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_nodegroup::de_create_nodegroup_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_nodegroup::CreateNodegroupError
{
