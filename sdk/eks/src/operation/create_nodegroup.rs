...
impl CreateNodegroupInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_nodegroup::CreateNodegroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_nodegroup::CreateNodegroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNodegroup {
                type Output = std::result::Result<crate::operation::create_nodegroup::CreateNodegroupOutput, crate::operation::create_nodegroup::CreateNodegroupError>;
