...
impl DescribeAccessEntryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_access_entry::DescribeAccessEntryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_access_entry::DescribeAccessEntryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_access_entry::DescribeAccessEntryOutput, crate::operation::describe_access_entry::DescribeAccessEntryError, Self> {
