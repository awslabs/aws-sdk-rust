...
impl UpdateNodegroupConfigInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNodegroupConfig`](crate::operation::update_nodegroup_config::UpdateNodegroupConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_nodegroup_config::UpdateNodegroupConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_nodegroup_config::UpdateNodegroupConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("nodegroup_name", "cannot be empty or unset"))?;
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_nodegroup_config::ser_update_nodegroup_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_nodegroup_config::UpdateNodegroupConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNodegroupConfig {
                type Output = std::result::Result<crate::operation::update_nodegroup_config::UpdateNodegroupConfigOutput, crate::operation::update_nodegroup_config::UpdateNodegroupConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_nodegroup_config::de_update_nodegroup_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_nodegroup_config::de_update_nodegroup_config_http_response(response)
                     }
                }
            }
