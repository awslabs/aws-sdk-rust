...
/// Orchestration and serialization glue logic for `UpdateNodegroupConfig`.
...
impl UpdateNodegroupConfig {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_nodegroup_config::UpdateNodegroupConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_nodegroup_config::UpdateNodegroupConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_nodegroup_config::UpdateNodegroupConfigInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateNodegroupConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateNodegroupConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateNodegroupConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateNodegroupConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateNodegroupConfig")
...
.with_interceptor(UpdateNodegroupConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigError>::new());
...
#[derive(Debug)]
            struct UpdateNodegroupConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateNodegroupConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_nodegroup_config::de_update_nodegroup_config_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateNodegroupConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateNodegroupConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_nodegroup_config::UpdateNodegroupConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.nodegroup_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("nodegroup_name", "cannot be empty or unset"))?;
    let nodegroup_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if nodegroup_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("nodegroup_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/clusters/{clusterName}/node-groups/{nodegroupName}/update-config", clusterName = cluster_name, nodegroupName = nodegroup_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_nodegroup_config::ser_update_nodegroup_config_input(&input)?);
...
#[derive(Debug)]
            struct UpdateNodegroupConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateNodegroupConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateNodegroupConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateNodegroupConfigInput>()
                        .ok_or("failed to downcast to UpdateNodegroupConfigInput")?;
...
pub enum UpdateNodegroupConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateNodegroupConfigError) for what information is available for the error.")]
...
impl UpdateNodegroupConfigError {
    /// Creates the `UpdateNodegroupConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateNodegroupConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateNodegroupConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_nodegroup_config::UpdateNodegroupConfigError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_nodegroup_config::_update_nodegroup_config_output::UpdateNodegroupConfigOutput;

pub use crate::operation::update_nodegroup_config::_update_nodegroup_config_input::UpdateNodegroupConfigInput;

mod _update_nodegroup_config_input;

mod _update_nodegroup_config_output;
