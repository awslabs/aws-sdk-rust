...
impl UpdateNodegroupConfig {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EKS", "UpdateNodegroupConfig", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "EKS.UpdateNodegroupConfig",
                "rpc.service" = "EKS",
                "rpc.method" = "UpdateNodegroupConfig",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateNodegroupConfig {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateNodegroupConfigRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateNodegroupConfigResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateNodegroupConfig")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateNodegroupConfigTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateNodegroupConfigTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateNodegroupConfigTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateNodegroupConfigInput>() else {
        ...
        if requested.should_capture("nodegroupName") {
            if let ::std::option::Option::Some(value) = input.nodegroup_name.as_deref() {
                captured.insert("nodegroupName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateNodegroupConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_nodegroup_config::de_update_nodegroup_config_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_nodegroup_config::de_update_nodegroup_config_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateNodegroupConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_nodegroup_config::UpdateNodegroupConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_nodegroup_config::UpdateNodegroupConfigInput,
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("nodegroup_name", "cannot be empty or unset"))?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_nodegroup_config::ser_update_nodegroup_config_input(
            &input,
        )?);
