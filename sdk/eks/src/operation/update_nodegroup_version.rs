...
impl UpdateNodegroupVersion {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("eks", "UpdateNodegroupVersion", input, runtime_plugins, stop_point).await
    }
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::update_nodegroup_version::UpdateNodegroupVersionInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateNodegroupVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateNodegroupVersion", "eks"));
