...
impl UpdateNodegroupVersionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNodegroupVersion`](crate::operation::update_nodegroup_version::UpdateNodegroupVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_nodegroup_version::UpdateNodegroupVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_nodegroup_version::UpdateNodegroupVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_nodegroup_version::UpdateNodegroupVersion::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNodegroupVersion {
                type Output = std::result::Result<crate::operation::update_nodegroup_version::UpdateNodegroupVersionOutput, crate::operation::update_nodegroup_version::UpdateNodegroupVersionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_nodegroup_version::de_update_nodegroup_version_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_nodegroup_version::de_update_nodegroup_version_http_response(response)
                     }
                }
            }
