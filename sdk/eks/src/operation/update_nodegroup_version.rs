...
/// Orchestration and serialization glue logic for `UpdateNodegroupVersion`.
...
impl UpdateNodegroupVersion {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_nodegroup_version::UpdateNodegroupVersionInput,
                    ) -> ::std::result::Result<crate::operation::update_nodegroup_version::UpdateNodegroupVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_nodegroup_version::UpdateNodegroupVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_nodegroup_version::UpdateNodegroupVersionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_nodegroup_version::UpdateNodegroupVersionOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_nodegroup_version::UpdateNodegroupVersionInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateNodegroupVersion {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateNodegroupVersion");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateNodegroupVersionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateNodegroupVersionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateNodegroupVersion")
...
.with_interceptor(UpdateNodegroupVersionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_nodegroup_version::UpdateNodegroupVersionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_nodegroup_version::UpdateNodegroupVersionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_nodegroup_version::UpdateNodegroupVersionError>::new());
...
#[derive(Debug)]
            struct UpdateNodegroupVersionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateNodegroupVersionResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateNodegroupVersionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateNodegroupVersionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_nodegroup_version::UpdateNodegroupVersionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_nodegroup_version::UpdateNodegroupVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/clusters/{clusterName}/node-groups/{nodegroupName}/update-version", clusterName = cluster_name, nodegroupName = nodegroup_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_nodegroup_version::ser_update_nodegroup_version_input(&input)?);
...
#[derive(Debug)]
            struct UpdateNodegroupVersionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateNodegroupVersionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateNodegroupVersionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateNodegroupVersionInput>()
                        .ok_or("failed to downcast to UpdateNodegroupVersionInput")?;
...
pub enum UpdateNodegroupVersionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateNodegroupVersionError) for what information is available for the error.")]
...
impl UpdateNodegroupVersionError {
    /// Creates the `UpdateNodegroupVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateNodegroupVersionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateNodegroupVersionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_nodegroup_version::UpdateNodegroupVersionError {
...
mod _update_nodegroup_version_output;
