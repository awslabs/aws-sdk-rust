...
impl UpdateAccessEntryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_access_entry::UpdateAccessEntryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_access_entry::UpdateAccessEntryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_access_entry::UpdateAccessEntryOutput, crate::operation::update_access_entry::UpdateAccessEntryError, Self> {
