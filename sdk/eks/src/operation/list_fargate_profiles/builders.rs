...
impl ListFargateProfilesFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_fargate_profiles::paginator::ListFargateProfilesPaginator {
        crate::operation::list_fargate_profiles::paginator::ListFargateProfilesPaginator::new(
            self.handle,
            self.inner,
        )
    }
