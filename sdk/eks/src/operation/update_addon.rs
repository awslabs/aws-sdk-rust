...
impl UpdateAddonInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAddon`](crate::operation::update_addon::UpdateAddon)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_addon::UpdateAddon, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_addon::UpdateAddonInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_addon::UpdateAddon::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAddon {
                type Output = std::result::Result<crate::operation::update_addon::UpdateAddonOutput, crate::operation::update_addon::UpdateAddonError>;
