...
/// Orchestration and serialization glue logic for `ListEksAnywhereSubscriptions`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListEksAnywhereSubscriptions;
impl ListEksAnywhereSubscriptions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsInput,
                    ) -> ::std::result::Result<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEksAnywhereSubscriptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEksAnywhereSubscriptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEksAnywhereSubscriptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEksAnywhereSubscriptionsResponseDeserializer));
...
.with_interceptor(ListEksAnywhereSubscriptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsError>::new());
...
#[derive(Debug)]
            struct ListEksAnywhereSubscriptionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEksAnywhereSubscriptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_eks_anywhere_subscriptions::de_list_eks_anywhere_subscriptions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_eks_anywhere_subscriptions::de_list_eks_anywhere_subscriptions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListEksAnywhereSubscriptionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEksAnywhereSubscriptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/eks-anywhere-subscriptions").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEksAnywhereSubscriptionsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEksAnywhereSubscriptionsInput>()
                        .ok_or("failed to downcast to ListEksAnywhereSubscriptionsInput")?;
...
pub enum ListEksAnywhereSubscriptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEksAnywhereSubscriptionsError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListEksAnywhereSubscriptionsError {
    /// Creates the `ListEksAnywhereSubscriptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEksAnywhereSubscriptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListEksAnywhereSubscriptionsError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `ListEksAnywhereSubscriptionsError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `ListEksAnywhereSubscriptionsError::ServerException`.
    pub fn is_server_exception(&self) -> bool {
        matches!(self, Self::ServerException(_))
    }
    /// Returns `true` if the error kind is `ListEksAnywhereSubscriptionsError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
}
impl ::std::error::Error for ListEksAnywhereSubscriptionsError {
...
impl ::std::fmt::Display for ListEksAnywhereSubscriptionsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListEksAnywhereSubscriptionsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListEksAnywhereSubscriptionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEksAnywhereSubscriptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_eks_anywhere_subscriptions::ListEksAnywhereSubscriptionsError {
...
mod _list_eks_anywhere_subscriptions_output;
