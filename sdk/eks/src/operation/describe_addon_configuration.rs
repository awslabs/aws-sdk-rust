...
impl DescribeAddonConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAddonConfiguration`](crate::operation::describe_addon_configuration::DescribeAddonConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_addon_configuration::DescribeAddonConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_addon_configuration::DescribeAddonConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/addons/configuration-schemas").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_addon_configuration::DescribeAddonConfigurationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.addon_name;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("addon_name", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                ...
                let inner_2 = inner_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("addon_version", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_addon_configuration::DescribeAddonConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAddonConfiguration {
                type Output = std::result::Result<crate::operation::describe_addon_configuration::DescribeAddonConfigurationOutput, crate::operation::describe_addon_configuration::DescribeAddonConfigurationError>;
