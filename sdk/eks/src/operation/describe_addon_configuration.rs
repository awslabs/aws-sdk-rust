...
impl DescribeAddonConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_addon_configuration::DescribeAddonConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAddonConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_addon_configuration::de_describe_addon_configuration_http_response_with_props(status, headers, body)
        }
    }
}
