...
impl ListNodegroupsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::list_nodegroups::ListNodegroupsError, ::aws_smithy_http::operation::Response>,
    > {
...
impl ListNodegroupsFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::list_nodegroups::ListNodegroups,
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_nodegroups::paginator::ListNodegroupsPaginator::send) which returns a `Stream`.
