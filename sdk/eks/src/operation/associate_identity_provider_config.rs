...
impl AssociateIdentityProviderConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_identity_provider_config::AssociateIdentityProviderConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateIdentityProviderConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_identity_provider_config::de_associate_identity_provider_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
