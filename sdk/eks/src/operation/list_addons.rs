...
impl ListAddonsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_addons::ListAddons::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAddons {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_addons::de_list_addons_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_addons::de_list_addons_http_response_with_props(
                status, headers, body,
            )
        }
    }
