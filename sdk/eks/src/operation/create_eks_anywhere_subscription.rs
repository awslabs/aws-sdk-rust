...
/// Orchestration and serialization glue logic for `CreateEksAnywhereSubscription`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateEksAnywhereSubscription;
impl CreateEksAnywhereSubscription {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateEksAnywhereSubscription {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateEksAnywhereSubscription");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateEksAnywhereSubscriptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateEksAnywhereSubscriptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateEksAnywhereSubscription")
...
.with_interceptor(CreateEksAnywhereSubscriptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionError>::new());
...
#[derive(Debug)]
            struct CreateEksAnywhereSubscriptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEksAnywhereSubscriptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_eks_anywhere_subscription::de_create_eks_anywhere_subscription_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_eks_anywhere_subscription::de_create_eks_anywhere_subscription_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateEksAnywhereSubscriptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateEksAnywhereSubscriptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_eks_anywhere_subscription::ser_create_eks_anywhere_subscription_input(&input)?);
...
#[derive(Debug)]
            struct CreateEksAnywhereSubscriptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateEksAnywhereSubscriptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateEksAnywhereSubscriptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateEksAnywhereSubscriptionInput>()
                        .ok_or("failed to downcast to CreateEksAnywhereSubscriptionInput")?;
...
pub enum CreateEksAnywhereSubscriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateEksAnywhereSubscriptionError) for what information is available for the error.")]
...
impl CreateEksAnywhereSubscriptionError {
    /// Creates the `CreateEksAnywhereSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateEksAnywhereSubscriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for CreateEksAnywhereSubscriptionError {
...
impl ::std::fmt::Display for CreateEksAnywhereSubscriptionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateEksAnywhereSubscriptionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateEksAnywhereSubscriptionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateEksAnywhereSubscriptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_eks_anywhere_subscription::CreateEksAnywhereSubscriptionError {
...
mod _create_eks_anywhere_subscription_output;
