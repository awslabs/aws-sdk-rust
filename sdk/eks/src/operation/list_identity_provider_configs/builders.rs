...
impl ListIdentityProviderConfigsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_identity_provider_configs();
...
impl ListIdentityProviderConfigsFluentBuilder {
    ...
    /// Access the ListIdentityProviderConfigs as a reference.
    pub fn as_input(&self) -> &crate::operation::list_identity_provider_configs::builders::ListIdentityProviderConfigsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_identity_provider_configs::ListIdentityProviderConfigs::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_identity_provider_configs::ListIdentityProviderConfigs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsOutput, crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_identity_provider_configs::paginator::ListIdentityProviderConfigsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
