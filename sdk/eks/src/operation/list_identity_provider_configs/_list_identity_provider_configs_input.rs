...
impl ListIdentityProviderConfigsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsInput, ::aws_smithy_types::error::operation::BuildError> {
