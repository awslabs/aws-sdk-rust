...
impl CreatePodIdentityAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_pod_identity_association::CreatePodIdentityAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_pod_identity_association::CreatePodIdentityAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_pod_identity_association::CreatePodIdentityAssociationOutput, crate::operation::create_pod_identity_association::CreatePodIdentityAssociationError, Self> {
