...
impl CreateAddonInput {
    /// Consumes the builder and constructs an Operation<[`CreateAddon`](crate::operation::create_addon::CreateAddon)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_addon::CreateAddon, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_addon::ser_create_addon_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_addon::CreateAddon::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAddon {
    type Output = ::std::result::Result<crate::operation::create_addon::CreateAddonOutput, crate::operation::create_addon::CreateAddonError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_addon::de_create_addon_http_response_with_props(status, headers, body)
        }
    }
}
