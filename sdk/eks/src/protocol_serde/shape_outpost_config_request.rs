...
pub fn ser_outpost_config_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutpostConfigRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
