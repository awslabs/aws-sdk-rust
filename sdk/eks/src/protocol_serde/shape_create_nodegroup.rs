...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_nodegroup::CreateNodegroupError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "ClientException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidParameterException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidRequestException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceInUseException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::ResourceInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceLimitExceededException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::ResourceLimitExceededException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ServerException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceUnavailableException" => {
            crate::operation::create_nodegroup::CreateNodegroupError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
