...
) -> Result<crate::operation::list_clusters::builders::ListClustersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "clusters" => {
                    builder = builder.set_clusters(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                }
                "nextToken" => {
