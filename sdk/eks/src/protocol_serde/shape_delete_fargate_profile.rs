...
pub fn de_delete_fargate_profile_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteFargateProfileOutput, crate::error::DeleteFargateProfileError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteFargateProfileError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_fargate_profile_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteFargateProfileOutput, crate::error::DeleteFargateProfileError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_fargate_profile_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_fargate_profile::de_delete_fargate_profile(response.body().as_ref(), output).map_err(crate::error::DeleteFargateProfileError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_fargate_profile(value: &[u8], mut builder: crate::output::delete_fargate_profile_output::Builder) -> Result<crate::output::delete_fargate_profile_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
