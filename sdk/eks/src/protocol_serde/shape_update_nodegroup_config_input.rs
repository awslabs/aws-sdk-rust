...
pub fn ser_update_nodegroup_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNodegroupConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
