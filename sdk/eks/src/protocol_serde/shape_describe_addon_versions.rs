...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_addon_versions::DescribeAddonVersionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_addon_versions_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_addon_versions::de_describe_addon_versions(_response_body, output)
            .map_err(crate::operation::describe_addon_versions::DescribeAddonVersionsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "addons" => {
                    builder = builder.set_addons(crate::protocol_serde::shape_addons::de_addons(tokens)?);
                }
                "nextToken" => {
