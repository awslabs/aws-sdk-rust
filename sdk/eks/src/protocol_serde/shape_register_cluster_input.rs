...
pub fn ser_register_cluster_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterClusterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
