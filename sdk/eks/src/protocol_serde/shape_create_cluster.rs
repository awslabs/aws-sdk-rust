    ...
    Err(match error_code {
        ...
        "UnsupportedAvailabilityZoneException" => crate::operation::create_cluster::CreateClusterError::UnsupportedAvailabilityZoneException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_unsupported_availability_zone_exception::de_unsupported_availability_zone_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_cluster::CreateClusterError::unhandled)?;
...
) -> Result<crate::operation::create_cluster::builders::CreateClusterOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
