...
pub fn ser_update_nodegroup_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNodegroupVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
