...
pub fn ser_update_labels_payload(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateLabelsPayload) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
