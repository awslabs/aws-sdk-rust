...
pub fn de_describe_addon_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeAddonOutput, crate::error::DescribeAddonError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeAddonError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidParameterException" => crate::error::DescribeAddonError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::DescribeAddonError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_addon_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeAddonOutput, crate::error::DescribeAddonError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_addon_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_addon::de_describe_addon(response.body().as_ref(), output).map_err(crate::error::DescribeAddonError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_addon(value: &[u8], mut builder: crate::output::describe_addon_output::Builder) -> Result<crate::output::describe_addon_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
