...
pub fn ser_create_nodegroup_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNodegroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
