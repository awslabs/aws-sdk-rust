...
pub fn de_delete_nodegroup_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteNodegroupOutput, crate::error::DeleteNodegroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteNodegroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_nodegroup_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteNodegroupOutput, crate::error::DeleteNodegroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_nodegroup_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_nodegroup::de_delete_nodegroup(response.body().as_ref(), output).map_err(crate::error::DeleteNodegroupError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_nodegroup(value: &[u8], mut builder: crate::output::delete_nodegroup_output::Builder) -> Result<crate::output::delete_nodegroup_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
