...
pub fn ser_update_addon_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAddonInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
