...
impl super::Client {
    ...
    ///   - [`cluster_name(impl Into<String>)`](crate::operation::describe_addon::builders::DescribeAddonFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::describe_addon::builders::DescribeAddonFluentBuilder::set_cluster_name):<br>required: **true**<br><p>The name of your cluster.</p><br>
