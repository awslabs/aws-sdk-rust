...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::set_name): <p>The name of the Amazon EKS cluster associated with the update.</p>
    ///   - [`update_id(impl ::std::convert::Into<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::update_id) / [`set_update_id(Option<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::set_update_id): <p>The ID of the update to describe.</p>
    ///   - [`nodegroup_name(impl ::std::convert::Into<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::nodegroup_name) / [`set_nodegroup_name(Option<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::set_nodegroup_name): <p>The name of the Amazon EKS node group associated with the update. This parameter is required if the update is a node group update.</p>
    ///   - [`addon_name(impl ::std::convert::Into<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::addon_name) / [`set_addon_name(Option<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::set_addon_name): <p>The name of the add-on. The name must match one of the names returned by <a href="https://docs.aws.amazon.com/eks/latest/APIReference/API_ListAddons.html"> <code>ListAddons</code> </a>. This parameter is required if the update is an add-on update.</p>
