...
impl super::Client {
    ...
    ///   - [`capability_name(impl Into<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::capability_name) / [`set_capability_name(Option<String>)`](crate::operation::describe_update::builders::DescribeUpdateFluentBuilder::set_capability_name):<br>required: **false**<br><p>The name of the capability for which you want to describe updates.</p><br>
