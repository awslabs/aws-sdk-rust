...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_cluster_config::builders::UpdateClusterConfigFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_cluster_config::builders::UpdateClusterConfigFluentBuilder::set_name): <p>The name of the Amazon EKS cluster to update.</p>
    ...
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::update_cluster_config::builders::UpdateClusterConfigFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::update_cluster_config::builders::UpdateClusterConfigFluentBuilder::set_client_request_token): <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
