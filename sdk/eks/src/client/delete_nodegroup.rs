...
impl super::Client {
    ...
    ///   - [`cluster_name(impl Into<String>)`](crate::operation::delete_nodegroup::builders::DeleteNodegroupFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::delete_nodegroup::builders::DeleteNodegroupFluentBuilder::set_cluster_name):<br>required: **true**<br><p>The name of your cluster.</p><br>
    ///   - [`nodegroup_name(impl Into<String>)`](crate::operation::delete_nodegroup::builders::DeleteNodegroupFluentBuilder::nodegroup_name) / [`set_nodegroup_name(Option<String>)`](crate::operation::delete_nodegroup::builders::DeleteNodegroupFluentBuilder::set_nodegroup_name):<br>required: **true**<br><p>The name of the node group to delete.</p><br>
