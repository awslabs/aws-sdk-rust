...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::set_name): <p>Define a unique name for this cluster for your Region.</p>
