...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::set_name):<br>required: **true**<br><p>Define a unique name for this cluster for your Region.</p><br>
    ...
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::set_client_request_token):<br>required: **false**<br><p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::register_cluster::builders::RegisterClusterFluentBuilder::set_tags):<br>required: **false**<br><p>The metadata that you apply to the cluster to assist with categorization and organization. Each tag consists of a key and an optional value, both of which you define. Cluster tags do not propagate to any other resources associated with the cluster.</p><br>
