...
impl super::Client {
    ...
    ///   - [`cluster_name(impl ::std::convert::Into<String>)`](crate::operation::delete_fargate_profile::builders::DeleteFargateProfileFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::delete_fargate_profile::builders::DeleteFargateProfileFluentBuilder::set_cluster_name): <p>The name of the Amazon EKS cluster associated with the Fargate profile to delete.</p>
    ///   - [`fargate_profile_name(impl ::std::convert::Into<String>)`](crate::operation::delete_fargate_profile::builders::DeleteFargateProfileFluentBuilder::fargate_profile_name) / [`set_fargate_profile_name(Option<String>)`](crate::operation::delete_fargate_profile::builders::DeleteFargateProfileFluentBuilder::set_fargate_profile_name): <p>The name of the Fargate profile to delete.</p>
