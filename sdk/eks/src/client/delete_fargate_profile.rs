...
impl super::Client {
    ...
    ///   - [`cluster_name(impl Into<String>)`](crate::operation::delete_fargate_profile::builders::DeleteFargateProfileFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::delete_fargate_profile::builders::DeleteFargateProfileFluentBuilder::set_cluster_name):<br>required: **true**<br><p>The name of the Amazon EKS cluster associated with the Fargate profile to delete.</p><br>
