...
pub fn de_untag_resource_http_error(
    ...
    Err(match error_code {
        ...
        "InvalidTokenException" => crate::operation::untag_resource::UntagResourceError::InvalidTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "SecurityIncidentResponseNotActiveException" => {
            crate::operation::untag_resource::UntagResourceError::SecurityIncidentResponseNotActiveException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::SecurityIncidentResponseNotActiveExceptionBuilder::default();
                    output = crate::protocol_serde::shape_security_incident_response_not_active_exception::de_security_incident_response_not_active_exception_json_err(_response_body, output).map_err(crate::operation::untag_resource::UntagResourceError::unhandled)?;
                    let output = output.meta(generic);
