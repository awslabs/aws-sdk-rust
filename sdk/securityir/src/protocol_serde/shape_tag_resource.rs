...
pub fn de_tag_resource_http_error(
    ...
    Err(match error_code {
        ...
        "InvalidTokenException" => crate::operation::tag_resource::TagResourceError::InvalidTokenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "SecurityIncidentResponseNotActiveException" => {
            crate::operation::tag_resource::TagResourceError::SecurityIncidentResponseNotActiveException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::SecurityIncidentResponseNotActiveExceptionBuilder::default();
                    output = crate::protocol_serde::shape_security_incident_response_not_active_exception::de_security_incident_response_not_active_exception_json_err(_response_body, output).map_err(crate::operation::tag_resource::TagResourceError::unhandled)?;
                    let output = output.meta(generic);
