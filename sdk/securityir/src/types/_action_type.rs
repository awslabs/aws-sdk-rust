...
///     ActionType::InvestigationAnalysis => { /* ... */ },
...
impl ::std::convert::From<&str> for ActionType {
    fn from(s: &str) -> Self {
        match s {
            "Evidence" => ActionType::EvidenceCollection,
            "Investigation" => ActionType::InvestigationAnalysis,
            "Summarization" => ActionType::Summarization,
...
impl ActionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ActionType::EvidenceCollection => "Evidence",
            ActionType::InvestigationAnalysis => "Investigation",
            ActionType::Summarization => "Summarization",
            ActionType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["Evidence", "Investigation", "Summarization"]
    }
}
...
impl ::std::fmt::Display for ActionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ActionType::EvidenceCollection => write!(f, "Evidence"),
            ActionType::InvestigationAnalysis => write!(f, "Investigation"),
            ActionType::Summarization => write!(f, "Summarization"),
