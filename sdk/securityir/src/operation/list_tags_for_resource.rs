...
impl ListTagsForResource {
    ...
    > {
        ...
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            ...
            .instrument(::tracing::debug_span!(
                "securityir.ListTagsForResource",
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("securityir", "ListTagsForResource", input, runtime_plugins, stop_point)
            .await
    }
...
impl ListTagsForResourceError {
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::InvalidTokenException`.
    pub fn is_invalid_token_exception(&self) -> bool {
        matches!(self, Self::InvalidTokenException(_))
    }
    /// Returns `true` if the error kind is `ListTagsForResourceError::SecurityIncidentResponseNotActiveException`.
