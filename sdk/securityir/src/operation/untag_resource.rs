...
impl UntagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Security IR", "UntagResource", input, runtime_plugins, stop_point)
...
impl UntagResourceError {
    ...
    /// Returns `true` if the error kind is `UntagResourceError::InvalidTokenException`.
    pub fn is_invalid_token_exception(&self) -> bool {
        matches!(self, Self::InvalidTokenException(_))
    }
    /// Returns `true` if the error kind is `UntagResourceError::SecurityIncidentResponseNotActiveException`.
