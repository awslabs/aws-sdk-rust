...
/// For example, the [`BatchGetMemberAccountDetails`](crate::operation::batch_get_member_account_details) operation has
/// a [`Client::batch_get_member_account_details`], function which returns a builder for that operation.
...
mod batch_get_member_account_details;
...
mod get_case_attachment_download_url;
...
mod update_case_comment;

mod update_case_status;

mod update_membership;

mod update_resolver_type;
