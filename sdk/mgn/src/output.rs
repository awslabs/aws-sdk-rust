...
pub struct DescribeVcenterClientsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::VcenterClient>>,
...
pub struct DescribeLaunchConfigurationTemplatesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::LaunchConfigurationTemplate>>,
    /// <p>Request to disconnect Source Server from service by Server ID.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
