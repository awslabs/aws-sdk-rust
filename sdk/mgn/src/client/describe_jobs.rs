...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_jobs::builders::DescribeJobsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::describe_jobs::builders::DescribeJobsFluentBuilder::set_max_results):<br>required: **false**<br><p>Request to describe job log items by max results.</p><br>
