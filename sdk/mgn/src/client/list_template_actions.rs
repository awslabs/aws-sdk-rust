...
impl super::Client {
    ...
    ///   - [`launch_configuration_template_id(impl Into<String>)`](crate::operation::list_template_actions::builders::ListTemplateActionsFluentBuilder::launch_configuration_template_id) / [`set_launch_configuration_template_id(impl Into<String>)`](crate::operation::list_template_actions::builders::ListTemplateActionsFluentBuilder::set_launch_configuration_template_id):<br>required: **true**<br><p>Launch configuration template ID.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_template_actions::builders::ListTemplateActionsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_template_actions::builders::ListTemplateActionsFluentBuilder::set_max_results):<br>required: **false**<br><p>Maximum amount of items to return when listing template post migration custom actions.</p><br>
