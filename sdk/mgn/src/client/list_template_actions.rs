...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_template_actions::builders::ListTemplateActionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_template_actions::builders::ListTemplateActionsFluentBuilder::set_next_token): <p>Next token to use when listing template post migration custom actions.</p>
