...
impl super::Client {
    ...
    ///   - [`import_id(impl Into<String>)`](crate::operation::list_import_errors::builders::ListImportErrorsFluentBuilder::import_id) / [`set_import_id(impl Into<String>)`](crate::operation::list_import_errors::builders::ListImportErrorsFluentBuilder::set_import_id):<br>required: **true**<br><p>List import errors request import id.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_import_errors::builders::ListImportErrorsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_import_errors::builders::ListImportErrorsFluentBuilder::set_max_results):<br>required: **false**<br><p>List import errors request max results.</p><br>
