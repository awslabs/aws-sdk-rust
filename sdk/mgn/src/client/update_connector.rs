...
impl super::Client {
    ...
    ///   - [`connector_id(impl Into<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::connector_id) / [`set_connector_id(Option<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::set_connector_id): <p>Update Connector request connector ID.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::set_name): <p>Update Connector request name.</p>
