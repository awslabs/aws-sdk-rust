...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_managed_accounts::builders::ListManagedAccountsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_managed_accounts::builders::ListManagedAccountsFluentBuilder::set_max_results): <p>List managed accounts request max results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_managed_accounts::builders::ListManagedAccountsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_managed_accounts::builders::ListManagedAccountsFluentBuilder::set_next_token): <p>List managed accounts request next token.</p>
