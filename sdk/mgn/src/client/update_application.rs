...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::set_application_id):<br>required: **true**<br><p>Application ID.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::set_name):<br>required: **false**<br><p>Application name.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::set_description):<br>required: **false**<br><p>Application description.</p><br>
    ///   - [`account_id(impl Into<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::set_account_id):<br>required: **false**<br><p>Account ID.</p><br>
