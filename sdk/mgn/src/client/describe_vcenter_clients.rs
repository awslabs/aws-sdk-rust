...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_vcenter_clients::builders::DescribeVcenterClientsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_vcenter_clients::builders::DescribeVcenterClientsFluentBuilder::set_next_token): <p>Next pagination token to be provided for DescribeVcenterClients.</p>
