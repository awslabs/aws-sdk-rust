...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::delete_wave::builders::DeleteWaveFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::delete_wave::builders::DeleteWaveFluentBuilder::set_account_id): <p>Account ID.</p>
