...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_replication_configuration_templates::builders::DescribeReplicationConfigurationTemplatesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_replication_configuration_templates::builders::DescribeReplicationConfigurationTemplatesFluentBuilder::set_next_token): <p>Request to describe Replication Configuration template by next token.</p>
