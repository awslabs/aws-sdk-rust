...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::set_account_id): <p>Applications list Account ID.</p>
