...
impl super::Client {
    ...
    ///   - [`source_server_id(impl Into<String>)`](crate::operation::delete_source_server::builders::DeleteSourceServerFluentBuilder::source_server_id) / [`set_source_server_id(impl Into<String>)`](crate::operation::delete_source_server::builders::DeleteSourceServerFluentBuilder::set_source_server_id):<br>required: **true**<br><p>Request to delete Source Server from service by Server ID.</p><br>
    ///   - [`account_id(impl Into<String>)`](crate::operation::delete_source_server::builders::DeleteSourceServerFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::delete_source_server::builders::DeleteSourceServerFluentBuilder::set_account_id):<br>required: **false**<br><p>Request to delete Source Server from service by Account ID.</p><br>
