...
impl super::Client {
    ...
    pub fn delete_launch_configuration_template(
        &self,
    ) -> crate::operation::delete_launch_configuration_template::builders::DeleteLaunchConfigurationTemplateFluentBuilder {
