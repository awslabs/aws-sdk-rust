...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::job_id) / [`set_job_id(impl Into<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::set_job_id):<br>required: **true**<br><p>Request to describe Job log job ID.</p><br>
    ///   - [`max_results(i32)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::set_max_results):<br>required: **false**<br><p>Request to describe Job log item maximum results.</p><br>
