...
impl super::Client {
    ...
    ///   - [`export_id(impl Into<String>)`](crate::operation::list_export_errors::builders::ListExportErrorsFluentBuilder::export_id) / [`set_export_id(impl Into<String>)`](crate::operation::list_export_errors::builders::ListExportErrorsFluentBuilder::set_export_id):<br>required: **true**<br><p>List export errors request export id.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_export_errors::builders::ListExportErrorsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_export_errors::builders::ListExportErrorsFluentBuilder::set_max_results):<br>required: **false**<br><p>List export errors request max results.</p><br>
