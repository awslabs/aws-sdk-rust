...
impl DeleteWaveFluentBuilder  {
    /// Creates a new `DeleteWave`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_wave::DeleteWaveOutput, aws_smithy_http::result::SdkError<crate::operation::delete_wave::DeleteWaveError>>
                     {
