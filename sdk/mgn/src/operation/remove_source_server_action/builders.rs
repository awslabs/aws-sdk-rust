...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::remove_source_server_action::RemoveSourceServerActionOutput,
                    crate::operation::remove_source_server_action::RemoveSourceServerActionError,
                > for RemoveSourceServerActionFluentBuilder
            {
                fn send(
                    self,
...
impl RemoveSourceServerActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_source_server_action::RemoveSourceServerActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_source_server_action::RemoveSourceServerActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::remove_source_server_action::RemoveSourceServerAction::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::remove_source_server_action::RemoveSourceServerAction::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_source_server_action::RemoveSourceServerActionOutput, crate::operation::remove_source_server_action::RemoveSourceServerActionError, Self> {
