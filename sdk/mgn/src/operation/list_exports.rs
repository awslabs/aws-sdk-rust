...
impl ListExportsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_exports::ListExports, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_exports::ser_list_exports_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListExports {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_exports::de_list_exports_http_response_with_props(status, headers, body)
        }
    }
}
