...
impl  UpdateLaunchConfigurationTemplateOutput  {
    ...
    pub fn launch_configuration_template_id(&self) -> & str {
        use std::ops::Deref; self.launch_configuration_template_id.deref()
    }
    /// <p>ARN of the Launch Configuration Template.</p>
...
impl UpdateLaunchConfigurationTemplateOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_launch_configuration_template::UpdateLaunchConfigurationTemplateOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_launch_configuration_template::UpdateLaunchConfigurationTemplateOutput {
                launch_configuration_template_id: self.launch_configuration_template_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("launch_configuration_template_id", "launch_configuration_template_id was not specified but it is required when building UpdateLaunchConfigurationTemplateOutput")
                    )?
                ,
                arn: self.arn
                ,
