...
impl crate::operation::change_server_life_cycle_state::builders::ChangeServerLifeCycleStateInputBuilder {
...
impl ChangeServerLifeCycleStateFluentBuilder {
    /// Creates a new `ChangeServerLifeCycleStateFluentBuilder`.
