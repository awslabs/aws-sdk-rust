...
impl UpdateLaunchConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_launch_configuration::UpdateLaunchConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLaunchConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_launch_configuration::de_update_launch_configuration_http_response_with_props(status, headers, body)
        }
    }
}
