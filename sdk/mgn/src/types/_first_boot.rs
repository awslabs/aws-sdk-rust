...
impl ::std::convert::From<&str> for FirstBoot {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FirstBoot::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FirstBoot {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FirstBoot::from(s))
    }
}
impl FirstBoot {
...
impl ::std::convert::AsRef<str> for FirstBoot {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
