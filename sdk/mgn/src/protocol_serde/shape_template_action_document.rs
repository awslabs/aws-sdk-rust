...
pub(crate) fn de_template_action_document<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::TemplateActionDocument>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
