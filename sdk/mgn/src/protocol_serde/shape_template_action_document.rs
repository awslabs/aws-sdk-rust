...
pub(crate) fn de_template_action_document<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TemplateActionDocument>, aws_smithy_json::deserialize::error::DeserializeError>
