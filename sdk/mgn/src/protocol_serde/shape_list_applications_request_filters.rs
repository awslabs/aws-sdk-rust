...
pub fn ser_list_applications_request_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListApplicationsRequestFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
