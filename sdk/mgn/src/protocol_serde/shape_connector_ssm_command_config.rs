...
pub(crate) fn de_connector_ssm_command_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ConnectorSsmCommandConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "s3OutputEnabled" => {
                                builder = builder.set_s3_output_enabled(
            ...
            Ok(Some(crate::serde_util::connector_ssm_command_config_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
