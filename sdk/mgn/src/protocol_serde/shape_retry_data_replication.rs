...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_retry_data_replication_input::ser_retry_data_replication_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_retry_data_replication_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::retry_data_replication::RetryDataReplicationError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_retry_data_replication_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_retry_data_replication::de_retry_data_replication(
            _response_body,
            output,
        )
        .map_err(crate::operation::retry_data_replication::RetryDataReplicationError::unhandled)?;
...
pub(crate) fn de_retry_data_replication(
    value: &[u8],
    mut builder: crate::operation::retry_data_replication::builders::RetryDataReplicationOutputBuilder,
) -> Result<
