...
pub(crate) fn de_application<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Application>, aws_smithy_json::deserialize::error::DeserializeError>
