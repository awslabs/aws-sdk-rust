            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_uninitialized_account_exception::de_uninitialized_account_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_applications::ListApplicationsError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "items" => {
                        builder = builder.set_items(
                            crate::protocol_serde::shape_applications_list::de_applications_list(
                                tokens,
                            )?,
                        );
                    }
