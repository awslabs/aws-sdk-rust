...
pub(crate) fn de_vcenter_client<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::VcenterClient>, aws_smithy_json::deserialize::error::DeserializeError>
