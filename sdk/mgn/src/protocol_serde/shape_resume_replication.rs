...
pub fn ser_resume_replication_input(
    ...
    crate::protocol_serde::shape_resume_replication_input::ser_resume_replication_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::resume_replication::builders::ResumeReplicationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
