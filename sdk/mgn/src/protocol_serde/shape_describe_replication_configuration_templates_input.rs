...
pub fn ser_describe_replication_configuration_templates_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationConfigurationTemplatesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
