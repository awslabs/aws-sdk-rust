...
pub(crate) fn de_source_server<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SourceServer>, aws_smithy_json::deserialize::error::DeserializeError>
