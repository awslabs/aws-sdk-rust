...
pub fn ser_ssm_document(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SsmDocument) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_ssm_document<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SsmDocument>, aws_smithy_json::deserialize::error::DeserializeError>
