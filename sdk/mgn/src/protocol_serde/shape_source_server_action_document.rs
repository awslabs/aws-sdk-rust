...
pub(crate) fn de_source_server_action_document<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SourceServerActionDocument>, aws_smithy_json::deserialize::error::DeserializeError>
