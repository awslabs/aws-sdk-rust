...
pub(crate) fn de_source_server_action_document<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SourceServerActionDocument>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
