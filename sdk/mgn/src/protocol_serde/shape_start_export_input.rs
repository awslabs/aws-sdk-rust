...
pub fn ser_start_export_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_export::StartExportInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
