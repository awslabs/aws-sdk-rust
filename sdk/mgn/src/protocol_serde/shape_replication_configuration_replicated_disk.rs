...
pub fn ser_replication_configuration_replicated_disk(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplicationConfigurationReplicatedDisk) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_replication_configuration_replicated_disk<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicationConfigurationReplicatedDisk>, aws_smithy_json::deserialize::error::DeserializeError>
