...
pub fn ser_put_source_server_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutSourceServerActionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
