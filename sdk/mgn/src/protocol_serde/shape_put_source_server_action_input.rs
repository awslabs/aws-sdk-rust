...
pub fn ser_put_source_server_action_input_input(
    ...
    if let Some(var_15) = &input.order {
        object.key("order").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    ...
    if let Some(var_24) = &input.timeout_seconds {
        object.key("timeoutSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_24).into()));
    }
    Ok(())
}
