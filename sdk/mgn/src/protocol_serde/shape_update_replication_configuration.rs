...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::update_replication_configuration::UpdateReplicationConfigurationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UninitializedAccountException" => {
            crate::operation::update_replication_configuration::UpdateReplicationConfigurationError::UninitializedAccountException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_replication_configuration::de_update_replication_configuration(_response_body, output)
            .map_err(crate::operation::update_replication_configuration::UpdateReplicationConfigurationError::unhandled)?;
...
pub(crate) fn de_update_replication_configuration(
    value: &[u8],
    mut builder: crate::operation::update_replication_configuration::builders::UpdateReplicationConfigurationOutputBuilder,
) -> Result<
    crate::operation::update_replication_configuration::builders::UpdateReplicationConfigurationOutputBuilder,
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "associateDefaultSecurityGroup" => {
                    builder =
                        builder.set_associate_default_security_group(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                "bandwidthThrottling" => {
