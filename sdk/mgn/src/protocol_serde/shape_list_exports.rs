        ...
        "UninitializedAccountException" => {
            crate::operation::list_exports::ListExportsError::UninitializedAccountException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_uninitialized_account_exception::de_uninitialized_account_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_exports::ListExportsError::unhandled)?;
