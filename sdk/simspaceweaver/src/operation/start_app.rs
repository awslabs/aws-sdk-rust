...
impl StartAppInput {
    /// Consumes the builder and constructs an Operation<[`StartApp`](crate::operation::start_app::StartApp)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_app::StartApp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_app::ser_start_app_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_app::StartApp::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartApp {
    type Output = ::std::result::Result<crate::operation::start_app::StartAppOutput, crate::operation::start_app::StartAppError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_app::de_start_app_http_response_with_props(status, headers, body)
        }
    }
}
