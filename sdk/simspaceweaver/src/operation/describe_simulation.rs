...
impl DescribeSimulationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_simulation::DescribeSimulation,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSimulation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_simulation::de_describe_simulation_http_response_with_props(status, headers, body)
        }
    }
}
