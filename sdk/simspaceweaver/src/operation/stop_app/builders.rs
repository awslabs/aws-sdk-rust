...
impl StopAppInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::stop_app::StopAppError, ::aws_smithy_http::operation::Response>,
    > {
...
impl StopAppFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::stop_app::StopAppOutput, ::aws_smithy_http::result::SdkError<crate::operation::stop_app::StopAppError>>
    {
        let op = self
            .inner
            .build()
