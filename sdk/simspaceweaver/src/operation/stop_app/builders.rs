...
impl StopAppInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::stop_app::StopAppError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>,
    > {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::stop_app::StopAppOutput, crate::operation::stop_app::StopAppError>
    for StopAppFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::stop_app::StopAppOutput, crate::operation::stop_app::StopAppError>,
    > {
...
impl StopAppFluentBuilder {
    ...
    /// Access the StopApp as a reference.
    pub fn as_input(&self) -> &crate::operation::stop_app::builders::StopAppInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::stop_app::StopApp::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::stop_app::StopApp::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<crate::operation::stop_app::StopAppOutput, crate::operation::stop_app::StopAppError, Self>,
