...
impl StopAppFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_app::StopAppOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_app::StopAppError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
