...
impl Builder {
    ...
    /// use aws_sdk_simspaceweaver::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_simspaceweaver::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
