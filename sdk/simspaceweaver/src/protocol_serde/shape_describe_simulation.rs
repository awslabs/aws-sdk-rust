...
pub fn de_describe_simulation_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeSimulationOutput, crate::error::DescribeSimulationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeSimulationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_simulation_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeSimulationOutput, crate::error::DescribeSimulationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_simulation_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_simulation::de_describe_simulation(response.body().as_ref(), output).map_err(crate::error::DescribeSimulationError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_simulation(value: &[u8], mut builder: crate::output::describe_simulation_output::Builder) -> Result<crate::output::describe_simulation_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
