...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_simulation::de_describe_simulation(_response_body, output)
            .map_err(crate::operation::describe_simulation::DescribeSimulationError::unhandled)?;
...
) -> Result<crate::operation::describe_simulation::builders::DescribeSimulationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::SimulationStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "TargetStatus" => {
                    builder = builder.set_target_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::SimulationTargetStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
