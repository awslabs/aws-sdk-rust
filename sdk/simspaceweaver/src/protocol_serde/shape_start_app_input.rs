...
pub fn ser_start_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartAppInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
