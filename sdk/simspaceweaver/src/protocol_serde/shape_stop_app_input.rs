...
pub fn ser_stop_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopAppInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
