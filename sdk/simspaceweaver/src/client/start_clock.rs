...
impl super::Client {
    ...
    ///   - [`simulation(impl Into<String>)`](crate::operation::start_clock::builders::StartClockFluentBuilder::simulation) / [`set_simulation(Option<String>)`](crate::operation::start_clock::builders::StartClockFluentBuilder::set_simulation):<br>required: **true**<br><p>The name of the simulation.</p><br>
