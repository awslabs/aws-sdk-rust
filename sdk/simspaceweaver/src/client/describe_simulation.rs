...
impl super::Client {
    ...
    ///   - [`simulation(impl ::std::convert::Into<String>)`](crate::operation::describe_simulation::builders::DescribeSimulationFluentBuilder::simulation) / [`set_simulation(Option<String>)`](crate::operation::describe_simulation::builders::DescribeSimulationFluentBuilder::set_simulation): <p>The name of the simulation.</p>
