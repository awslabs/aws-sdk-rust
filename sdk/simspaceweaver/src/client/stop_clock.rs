...
impl super::Client {
    ...
    ///   - [`simulation(impl Into<String>)`](crate::operation::stop_clock::builders::StopClockFluentBuilder::simulation) / [`set_simulation(Option<String>)`](crate::operation::stop_clock::builders::StopClockFluentBuilder::set_simulation):<br>required: **true**<br><p>The name of the simulation.</p><br>
