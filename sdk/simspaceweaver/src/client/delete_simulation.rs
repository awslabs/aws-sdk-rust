...
impl super::Client {
    ...
    ///   - [`simulation(impl Into<String>)`](crate::operation::delete_simulation::builders::DeleteSimulationFluentBuilder::simulation) / [`set_simulation(Option<String>)`](crate::operation::delete_simulation::builders::DeleteSimulationFluentBuilder::set_simulation):<br>required: **true**<br><p>The name of the simulation.</p><br>
