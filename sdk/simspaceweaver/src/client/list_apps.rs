...
impl super::Client {
    ...
    ///   - [`simulation(impl Into<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::simulation) / [`set_simulation(impl Into<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::set_simulation):<br>required: **true**<br><p>The name of the simulation that you want to list apps for.</p><br>
