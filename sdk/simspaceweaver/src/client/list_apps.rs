...
impl super::Client {
    ...
    ///   - [`simulation(impl ::std::convert::Into<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::simulation) / [`set_simulation(Option<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::set_simulation): <p>The name of the simulation that you want to list apps for.</p>
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::list_apps::builders::ListAppsFluentBuilder::set_domain): <p>The name of the domain that you want to list apps for.</p>
