...
pub fn serialize_structure_create_config_input(
    ...
    if let Some(var_1) = &input.config_data {
        ...
        crate::json_ser::serialize_union_config_type_data(&mut object_2, var_1);
        object_2.finish();
    }
...
pub fn serialize_structure_create_dataflow_endpoint_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_10 in var_8 {
            {
                ...
                crate::json_ser::serialize_structure_endpoint_details(&mut object_11, item_10);
                object_11.finish();
            }
        }
        array_9.finish();
...
pub fn serialize_structure_create_mission_profile_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_29) = &input.tracking_config_arn {
        object.key("trackingConfigArn").string(var_29);
    }
}

pub fn serialize_structure_get_minute_usage_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_reserve_contact_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_44) = &input.mission_profile_arn {
        object.key("missionProfileArn").string(var_44);
    }
    if let Some(var_45) = &input.satellite_arn {
        object.key("satelliteArn").string(var_45);
    }
...
pub fn serialize_structure_tag_resource_input(
    ...
    if let Some(var_51) = &input.tags {
        ...
        for (key_53, value_54) in var_51 {
            {
                object_52.key(key_53).string(value_54);
            }
        }
        object_52.finish();
    }
...
pub fn serialize_structure_update_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_55) = &input.config_data {
        ...
        crate::json_ser::serialize_union_config_type_data(&mut object_56, var_55);
        object_56.finish();
    }
...
pub fn serialize_structure_update_mission_profile_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_67) = &input.tracking_config_arn {
        object.key("trackingConfigArn").string(var_67);
    }
}

pub fn serialize_union_config_type_data(
    ...
    match input {
        crate::model::ConfigTypeData::AntennaDownlinkConfig(inner) => {
            ...
            crate::json_ser::serialize_structure_antenna_downlink_config(&mut object_68, inner);
            object_68.finish();
        }
        crate::model::ConfigTypeData::TrackingConfig(inner) => {
            let mut object_69 = object_2.key("trackingConfig").start_object();
            crate::json_ser::serialize_structure_tracking_config(&mut object_69, inner);
            object_69.finish();
        }
        crate::model::ConfigTypeData::DataflowEndpointConfig(inner) => {
            ...
            crate::json_ser::serialize_structure_dataflow_endpoint_config(&mut object_70, inner);
            object_70.finish();
        }
        crate::model::ConfigTypeData::AntennaDownlinkDemodDecodeConfig(inner) => {
            let mut object_71 = object_2
                ...
                .start_object();
            crate::json_ser::serialize_structure_antenna_downlink_demod_decode_config(
                &mut object_71,
                inner,
            );
            object_71.finish();
        ...
        crate::model::ConfigTypeData::AntennaUplinkConfig(inner) => {
            ...
            crate::json_ser::serialize_structure_antenna_uplink_config(&mut object_72, inner);
            object_72.finish();
        }
        crate::model::ConfigTypeData::UplinkEchoConfig(inner) => {
            let mut object_73 = object_2.key("uplinkEchoConfig").start_object();
            crate::json_ser::serialize_structure_uplink_echo_config(&mut object_73, inner);
            object_73.finish();
        }
        crate::model::ConfigTypeData::S3RecordingConfig(inner) => {
            let mut object_74 = object_2.key("s3RecordingConfig").start_object();
            crate::json_ser::serialize_structure_s3_recording_config(&mut object_74, inner);
            object_74.finish();
        }
    }
}
...
pub fn serialize_structure_endpoint_details(
    ...
    if let Some(var_75) = &input.security_details {
        ...
        crate::json_ser::serialize_structure_security_details(&mut object_76, var_75);
        object_76.finish();
    }
    if let Some(var_77) = &input.endpoint {
        let mut object_78 = object.key("endpoint").start_object();
        crate::json_ser::serialize_structure_dataflow_endpoint(&mut object_78, var_77);
        object_78.finish();
    }
}

pub fn serialize_structure_antenna_downlink_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_79) = &input.spectrum_config {
        ...
        crate::json_ser::serialize_structure_spectrum_config(&mut object_80, var_79);
        object_80.finish();
    }
}

pub fn serialize_structure_tracking_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_dataflow_endpoint_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::DataflowEndpointConfig,
) {
    if let Some(var_82) = &input.dataflow_endpoint_name {
        object.key("dataflowEndpointName").string(var_82);
    }
    if let Some(var_83) = &input.dataflow_endpoint_region {
        object.key("dataflowEndpointRegion").string(var_83);
    }
}

pub fn serialize_structure_antenna_downlink_demod_decode_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_84) = &input.spectrum_config {
        ...
        crate::json_ser::serialize_structure_spectrum_config(&mut object_85, var_84);
        object_85.finish();
    }
    if let Some(var_86) = &input.demodulation_config {
        let mut object_87 = object.key("demodulationConfig").start_object();
        crate::json_ser::serialize_structure_demodulation_config(&mut object_87, var_86);
        object_87.finish();
    }
    if let Some(var_88) = &input.decode_config {
        let mut object_89 = object.key("decodeConfig").start_object();
        crate::json_ser::serialize_structure_decode_config(&mut object_89, var_88);
        object_89.finish();
    }
}

pub fn serialize_structure_antenna_uplink_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_91) = &input.spectrum_config {
        ...
        crate::json_ser::serialize_structure_uplink_spectrum_config(&mut object_92, var_91);
        object_92.finish();
    }
    if let Some(var_93) = &input.target_eirp {
        let mut object_94 = object.key("targetEirp").start_object();
        crate::json_ser::serialize_structure_eirp(&mut object_94, var_93);
        object_94.finish();
    }
}

pub fn serialize_structure_uplink_echo_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_96) = &input.antenna_uplink_config_arn {
        object.key("antennaUplinkConfigArn").string(var_96);
    }
}

pub fn serialize_structure_s3_recording_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::S3RecordingConfig,
) {
    if let Some(var_97) = &input.bucket_arn {
        object.key("bucketArn").string(var_97);
    }
    if let Some(var_98) = &input.role_arn {
        object.key("roleArn").string(var_98);
    }
    if let Some(var_99) = &input.prefix {
        object.key("prefix").string(var_99);
    }
}

pub fn serialize_structure_security_details(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_dataflow_endpoint(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_108) = &input.address {
        ...
        crate::json_ser::serialize_structure_socket_address(&mut object_109, var_108);
        object_109.finish();
    }
...
pub fn serialize_structure_spectrum_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_112) = &input.center_frequency {
        ...
        crate::json_ser::serialize_structure_frequency(&mut object_113, var_112);
        object_113.finish();
    }
    if let Some(var_114) = &input.bandwidth {
        let mut object_115 = object.key("bandwidth").start_object();
        crate::json_ser::serialize_structure_frequency_bandwidth(&mut object_115, var_114);
        object_115.finish();
    }
...
pub fn serialize_structure_demodulation_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::DemodulationConfig,
) {
    if let Some(var_117) = &input.unvalidated_json {
        object.key("unvalidatedJSON").string(var_117);
    }
}

pub fn serialize_structure_decode_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::DecodeConfig,
) {
    if let Some(var_118) = &input.unvalidated_json {
        object.key("unvalidatedJSON").string(var_118);
    }
}

pub fn serialize_structure_uplink_spectrum_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_119) = &input.center_frequency {
        ...
        crate::json_ser::serialize_structure_frequency(&mut object_120, var_119);
        object_120.finish();
    }
...
pub fn serialize_structure_eirp(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_122) = &input.value {
        object.key("value").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_122).into()),
        );
    }
...
pub fn serialize_structure_socket_address(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_frequency(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_126) = &input.value {
        object.key("value").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_126).into()),
        );
    }
...
pub fn serialize_structure_frequency_bandwidth(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_128) = &input.value {
        object.key("value").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_128).into()),
        );
    }
