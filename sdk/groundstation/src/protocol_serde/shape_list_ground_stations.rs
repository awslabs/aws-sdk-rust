...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_ground_stations::de_list_ground_stations(_response_body, output)
            .map_err(crate::operation::list_ground_stations::ListGroundStationsError::unhandled)?;
...
) -> Result<crate::operation::list_ground_stations::builders::ListGroundStationsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "groundStationList" => {
                    builder = builder.set_ground_station_list(crate::protocol_serde::shape_ground_station_list::de_ground_station_list(tokens)?);
                }
                "nextToken" => {
