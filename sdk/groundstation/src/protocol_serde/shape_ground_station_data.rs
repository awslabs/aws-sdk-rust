...
pub(crate) fn de_ground_station_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GroundStationData>, aws_smithy_json::deserialize::error::DeserializeError>
