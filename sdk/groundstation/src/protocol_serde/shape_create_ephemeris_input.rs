...
pub fn ser_create_ephemeris_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEphemerisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
