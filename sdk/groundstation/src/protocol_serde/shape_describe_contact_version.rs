...
pub fn de_describe_contact_version_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_contact_version::DescribeContactVersionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_contact_version::DescribeContactVersionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DependencyException" => crate::operation::describe_contact_version::DescribeContactVersionError::DependencyException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => crate::operation::describe_contact_version::DescribeContactVersionError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::describe_contact_version::DescribeContactVersionError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_contact_version::DescribeContactVersionError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_contact_version_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_contact_version::builders::DescribeContactVersionOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_contact_version::de_describe_contact_version(_response_body, output)
            .map_err(crate::operation::describe_contact_version::DescribeContactVersionError::unhandled)?;
...
pub(crate) fn de_describe_contact_version(
    _value: &[u8],
    mut builder: crate::operation::describe_contact_version::builders::DescribeContactVersionOutputBuilder,
) -> ::std::result::Result<
    crate::operation::describe_contact_version::builders::DescribeContactVersionOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "contactStatus" => {
                    builder = builder.set_contact_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ContactStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "dataflowList" => {
                ...
                "postPassEndTime" => {
                    builder = builder.set_post_pass_end_time(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                        tokens.next(),
                        ::aws_smithy_types::date_time::Format::EpochSeconds,
                    )?);
                }
                "prePassStartTime" => {
                    builder = builder.set_pre_pass_start_time(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                        tokens.next(),
                        ::aws_smithy_types::date_time::Format::EpochSeconds,
                    )?);
                }
