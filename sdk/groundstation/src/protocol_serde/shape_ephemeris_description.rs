...
pub(crate) fn de_ephemeris_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EphemerisDescription>, aws_smithy_json::deserialize::error::DeserializeError>
