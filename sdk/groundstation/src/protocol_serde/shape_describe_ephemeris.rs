...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_ephemeris_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_ephemeris::DescribeEphemerisOutput, crate::operation::describe_ephemeris::DescribeEphemerisError> {
    Ok({
        #[allow(unused_mut)]
