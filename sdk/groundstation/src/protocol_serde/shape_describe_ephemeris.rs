...
pub fn de_describe_ephemeris_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_ephemeris::DescribeEphemerisOutput, crate::operation::describe_ephemeris::DescribeEphemerisError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_ephemeris_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_ephemeris::DescribeEphemerisOutput, crate::operation::describe_ephemeris::DescribeEphemerisError> {
    Ok({
        #[allow(unused_mut)]
