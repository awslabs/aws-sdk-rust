...
pub(crate) fn de_eirp<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::Eirp>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "units" => {
                            builder = builder.set_units(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::EirpUnits::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
