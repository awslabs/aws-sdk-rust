...
pub fn ser_agent_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AgentDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
