...
pub(crate) fn de_endpoint_details_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::EndpointDetails>>, aws_smithy_json::deserialize::error::DeserializeError>
