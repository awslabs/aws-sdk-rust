...
pub fn ser_config_type_data(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfigTypeData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_config_type_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfigTypeData>, aws_smithy_json::deserialize::error::DeserializeError>
