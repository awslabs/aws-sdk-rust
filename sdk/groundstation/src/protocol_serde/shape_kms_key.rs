...
pub fn ser_kms_key(object_11: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::KmsKey) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
