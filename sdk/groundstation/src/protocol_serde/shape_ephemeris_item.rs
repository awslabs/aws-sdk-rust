...
pub(crate) fn de_ephemeris_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EphemerisItem>, aws_smithy_json::deserialize::error::DeserializeError>
