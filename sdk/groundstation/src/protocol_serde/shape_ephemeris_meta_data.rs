...
pub(crate) fn de_ephemeris_meta_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EphemerisMetaData>, aws_smithy_json::deserialize::error::DeserializeError>
