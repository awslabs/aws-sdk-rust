...
pub fn ser_aws_ground_station_agent_endpoint(
    ...
    if let Some(var_2) = &input.egress_address {
        ...
        crate::protocol_serde::shape_connection_details::ser_connection_details(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
    ...
    if let Some(var_4) = &input.ingress_address {
        ...
        crate::protocol_serde::shape_ranged_connection_details::ser_ranged_connection_details(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
...
pub(crate) fn de_aws_ground_station_agent_endpoint<'a, I>(
    ...
    Option<crate::types::AwsGroundStationAgentEndpoint>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "auditResults" => {
                                builder = builder.set_audit_results(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::AuditResults::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
