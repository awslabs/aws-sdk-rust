...
) -> Result<Option<crate::types::ConfigDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "endpointDetails" => Some(crate::types::ConfigDetails::EndpointDetails(
                            crate::protocol_serde::shape_endpoint_details::de_endpoint_details(tokens)?.ok_or_else(|| {
                        ...
                        "antennaDemodDecodeDetails" => Some(crate::types::ConfigDetails::AntennaDemodDecodeDetails(
                            crate::protocol_serde::shape_antenna_demod_decode_details::de_antenna_demod_decode_details(tokens)?.ok_or_else(|| {
                        ...
                        "s3RecordingDetails" => Some(crate::types::ConfigDetails::S3RecordingDetails(
                            crate::protocol_serde::shape_s3_recording_details::de_s3_recording_details(tokens)?.ok_or_else(|| {
