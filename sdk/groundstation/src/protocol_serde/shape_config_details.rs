...
pub(crate) fn de_config_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfigDetails>, aws_smithy_json::deserialize::error::DeserializeError>
