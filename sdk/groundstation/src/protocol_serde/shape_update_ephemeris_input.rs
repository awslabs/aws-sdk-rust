...
pub fn ser_update_ephemeris_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEphemerisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
