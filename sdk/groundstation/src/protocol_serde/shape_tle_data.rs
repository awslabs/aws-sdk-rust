...
pub fn ser_tle_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TleData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
