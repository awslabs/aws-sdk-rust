...
pub fn ser_list_ephemerides_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEphemeridesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
