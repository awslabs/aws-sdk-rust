...
pub(crate) fn de_ephemeris_type_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EphemerisTypeDescription>, aws_smithy_json::deserialize::error::DeserializeError>
