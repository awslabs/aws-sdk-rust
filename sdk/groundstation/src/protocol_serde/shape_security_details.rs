...
pub fn ser_security_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SecurityDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_security_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SecurityDetails>, aws_smithy_json::deserialize::error::DeserializeError>
