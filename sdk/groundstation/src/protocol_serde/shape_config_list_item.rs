...
pub(crate) fn de_config_list_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfigListItem>, aws_smithy_json::deserialize::error::DeserializeError>
