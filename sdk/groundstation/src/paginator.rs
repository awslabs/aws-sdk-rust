...
/// Paginator for [`ListConfigs`](crate::operation::ListConfigs)
            ...
            impl ListConfigsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_configs_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListConfigsOutput, aws_smithy_http::result::SdkError<crate::error::ListConfigsError>>> + Unpin
                 {
...
/// Paginator for [`ListDataflowEndpointGroups`](crate::operation::ListDataflowEndpointGroups)
            ...
            impl ListDataflowEndpointGroupsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_dataflow_endpoint_groups_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListDataflowEndpointGroupsOutput, aws_smithy_http::result::SdkError<crate::error::ListDataflowEndpointGroupsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListEphemerides`](crate::operation::ListEphemerides)
            pub struct ListEphemeridesPaginator {
                handle: std::sync::Arc<crate::client::Handle>,
                builder: crate::input::list_ephemerides_input::Builder,
                stop_on_duplicate_token: bool,
            }

            impl ListEphemeridesPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_ephemerides_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                /// Create a flattened paginator
                    ...
                    /// are dispatched lazily.
                    pub fn items(self) -> crate::paginator::ListEphemeridesPaginatorItems {
                        crate::paginator::ListEphemeridesPaginatorItems(self)
                    }
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListEphemeridesOutput, aws_smithy_http::result::SdkError<crate::error::ListEphemeridesError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_structure_crate_output_list_ephemerides_output_next_token(resp);
                                    let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                                    if !is_empty && new_token == input.next_token.as_ref() && self.stop_on_duplicate_token {
                                        true
                                    } else {
...
/// Paginator for [`ListGroundStations`](crate::operation::ListGroundStations)
            ...
            impl ListGroundStationsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_ground_stations_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListGroundStationsOutput, aws_smithy_http::result::SdkError<crate::error::ListGroundStationsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListMissionProfiles`](crate::operation::ListMissionProfiles)
            ...
            impl ListMissionProfilesPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_mission_profiles_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListMissionProfilesOutput, aws_smithy_http::result::SdkError<crate::error::ListMissionProfilesError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListSatellites`](crate::operation::ListSatellites)
            ...
            impl ListSatellitesPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_satellites_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListSatellitesOutput, aws_smithy_http::result::SdkError<crate::error::ListSatellitesError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `ListConfigsPaginator`
                ...
                impl  ListConfigsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ConfigListItem, aws_smithy_http::result::SdkError<crate::error::ListConfigsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_configs_output_config_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListContactsPaginator`
                ...
                impl  ListContactsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ContactData, aws_smithy_http::result::SdkError<crate::error::ListContactsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_contacts_output_contact_list(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListDataflowEndpointGroupsPaginator`
                ...
                impl  ListDataflowEndpointGroupsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::DataflowEndpointListItem, aws_smithy_http::result::SdkError<crate::error::ListDataflowEndpointGroupsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListEphemeridesPaginator`
                ...
                impl  ListEphemeridesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::EphemerisItem, aws_smithy_http::result::SdkError<crate::error::ListEphemeridesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_ephemerides_output_ephemerides(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListGroundStationsPaginator`
                ...
                impl  ListGroundStationsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::GroundStationData, aws_smithy_http::result::SdkError<crate::error::ListGroundStationsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListMissionProfilesPaginator`
                ...
                impl  ListMissionProfilesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::MissionProfileListItem, aws_smithy_http::result::SdkError<crate::error::ListMissionProfilesError>>> + Unpin
                     {
...
/// Flattened paginator for `ListSatellitesPaginator`
                ...
                impl  ListSatellitesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::SatelliteListItem, aws_smithy_http::result::SdkError<crate::error::ListSatellitesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_satellites_output_satellites(page).unwrap_or_default().into_iter())
                    }
                }
