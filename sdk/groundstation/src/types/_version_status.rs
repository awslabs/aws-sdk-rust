...
impl ::std::convert::From<&str> for VersionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "FAILED_TO_UPDATE" => VersionStatus::FailedToUpdate,
            "SUPERSEDED" => VersionStatus::Superseded,
            "UPDATING" => VersionStatus::Updating,
            other => VersionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VersionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VersionStatus::from(s))
    }
}
impl VersionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VersionStatus::FailedToUpdate => "FAILED_TO_UPDATE",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ACTIVE", "FAILED_TO_UPDATE", "SUPERSEDED", "UPDATING"]
    }
}
...
impl ::std::fmt::Display for VersionStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            VersionStatus::FailedToUpdate => write!(f, "FAILED_TO_UPDATE"),
            VersionStatus::Superseded => write!(f, "SUPERSEDED"),
