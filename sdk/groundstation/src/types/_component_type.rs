...
/// match componenttype {
///     ComponentType::Digitizer => { /* ... */ },
///     ComponentType::LaminarFlow => { /* ... */ },
///     ComponentType::Prism => { /* ... */ },
...
impl std::convert::From<&str> for ComponentType {
    fn from(s: &str) -> Self {
        match s {
            "DIGITIZER" => ComponentType::Digitizer,
            "LAMINAR_FLOW" => ComponentType::LaminarFlow,
            "PRISM" => ComponentType::Prism,
            other => {
...
impl ComponentType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ComponentType::LaminarFlow => "LAMINAR_FLOW",
