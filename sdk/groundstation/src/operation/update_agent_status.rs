...
impl UpdateAgentStatusInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_agent_status::ser_update_agent_status_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAgentStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_agent_status::de_update_agent_status_http_response_with_props(status, headers, body)
        }
    }
}
