    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let agent_id = ::aws_smithy_http::label::fmt_string(
                    input_1,
                ...
                ::std::write!(output, "/agent/{agentId}", agentId = agent_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_agent_status::UpdateAgentStatus::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_agent_status::UpdateAgentStatusError
{
