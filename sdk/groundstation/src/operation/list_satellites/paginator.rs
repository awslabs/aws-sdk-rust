...
impl ListSatellitesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_satellites::paginator::ListSatellitesPaginatorItems {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_satellites_output_next_token(resp);
...
impl ListSatellitesPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_satellites_output_satellites(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
