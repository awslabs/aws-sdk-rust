...
impl ReserveContactInput {
    /// Consumes the builder and constructs an Operation<[`ReserveContact`](crate::operation::reserve_contact::ReserveContact)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reserve_contact::ReserveContact, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reserve_contact::ser_reserve_contact_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reserve_contact::ReserveContact::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReserveContact {
    type Output =
        ::std::result::Result<crate::operation::reserve_contact::ReserveContactOutput, crate::operation::reserve_contact::ReserveContactError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reserve_contact::de_reserve_contact_http_response_with_props(status, headers, body)
        }
    }
}
