...
impl CancelContactFluentBuilder  {
    /// Creates a new `CancelContact`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::cancel_contact::CancelContact, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::cancel_contact::CancelContactError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::cancel_contact::CancelContactOutput, aws_smithy_http::result::SdkError<crate::operation::cancel_contact::CancelContactError>>
                     {
