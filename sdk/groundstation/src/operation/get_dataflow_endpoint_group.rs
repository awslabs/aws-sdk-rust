...
impl GetDataflowEndpointGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_dataflow_endpoint_group::GetDataflowEndpointGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataflowEndpointGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_dataflow_endpoint_group::de_get_dataflow_endpoint_group_http_response_with_props(status, headers, body)
        }
    }
}
