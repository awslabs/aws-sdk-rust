    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_mission_profile::DeleteMissionProfileError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_mission_profile::DeleteMissionProfileOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteMissionProfileResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteMissionProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_mission_profile::DeleteMissionProfileInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteMissionProfileEndpointParamsInterceptor {
