...
/// Orchestration and serialization glue logic for `ListMissionProfiles`.
...
impl ListMissionProfiles {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_mission_profiles::ListMissionProfilesInput,
                    ) -> ::std::result::Result<crate::operation::list_mission_profiles::ListMissionProfilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_mission_profiles::ListMissionProfilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_mission_profiles::ListMissionProfilesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_mission_profiles::ListMissionProfilesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMissionProfiles {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListMissionProfiles");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListMissionProfilesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListMissionProfilesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMissionProfiles")
...
.with_interceptor(ListMissionProfilesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_mission_profiles::ListMissionProfilesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_mission_profiles::ListMissionProfilesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_mission_profiles::ListMissionProfilesError>::new());
...
#[derive(Debug)]
            struct ListMissionProfilesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMissionProfilesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_mission_profiles::de_list_mission_profiles_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListMissionProfilesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMissionProfilesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_mission_profiles::ListMissionProfilesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_mission_profiles::ListMissionProfilesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/missionprofile").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_mission_profiles::ListMissionProfilesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListMissionProfilesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMissionProfilesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListMissionProfilesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListMissionProfilesInput>()
                        .ok_or("failed to downcast to ListMissionProfilesInput")?;
...
pub enum ListMissionProfilesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListMissionProfilesError) for what information is available for the error.")]
...
impl ListMissionProfilesError {
    /// Creates the `ListMissionProfilesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListMissionProfilesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListMissionProfilesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_mission_profiles::ListMissionProfilesError {
...
mod _list_mission_profiles_output;
