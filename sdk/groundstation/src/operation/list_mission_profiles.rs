...
impl ListMissionProfilesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_mission_profiles::ListMissionProfiles,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMissionProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_mission_profiles::de_list_mission_profiles_http_response_with_props(status, headers, body)
        }
    }
}
