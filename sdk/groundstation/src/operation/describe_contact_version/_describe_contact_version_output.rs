...
pub struct DescribeContactVersionOutput {
...
impl DescribeContactVersionOutput {
    /// <p>UUID of a contact.</p>
...
impl ::aws_types::request_id::RequestId for DescribeContactVersionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeContactVersionOutput {
    /// Creates a new builder-style object to manufacture [`DescribeContactVersionOutput`](crate::operation::describe_contact_version::DescribeContactVersionOutput).
    pub fn builder() -> crate::operation::describe_contact_version::builders::DescribeContactVersionOutputBuilder {
        crate::operation::describe_contact_version::builders::DescribeContactVersionOutputBuilder::default()
    }
}

/// A builder for [`DescribeContactVersionOutput`](crate::operation::describe_contact_version::DescribeContactVersionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeContactVersionOutputBuilder {
...
impl DescribeContactVersionOutputBuilder {
    /// <p>UUID of a contact.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeContactVersionOutput`](crate::operation::describe_contact_version::DescribeContactVersionOutput).
    pub fn build(self) -> crate::operation::describe_contact_version::DescribeContactVersionOutput {
