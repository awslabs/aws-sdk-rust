        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_dataflow_endpoint_groups::ListDataflowEndpointGroups::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl ListDataflowEndpointGroupsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_dataflow_endpoint_groups_output_output_dataflow_endpoint_group_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
