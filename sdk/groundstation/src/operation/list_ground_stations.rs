...
impl ListGroundStationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_ground_stations::ListGroundStations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroundStations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_ground_stations::de_list_ground_stations_http_response_with_props(status, headers, body)
        }
    }
}
