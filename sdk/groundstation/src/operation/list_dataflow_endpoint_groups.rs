...
impl ListDataflowEndpointGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_dataflow_endpoint_groups::ListDataflowEndpointGroups,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_dataflow_endpoint_groups::ListDataflowEndpointGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDataflowEndpointGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_dataflow_endpoint_groups::de_list_dataflow_endpoint_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
