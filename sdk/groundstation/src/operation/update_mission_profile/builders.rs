...
impl UpdateMissionProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_mission_profile::UpdateMissionProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_mission_profile::UpdateMissionProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_mission_profile::UpdateMissionProfileOutput, crate::operation::update_mission_profile::UpdateMissionProfileError, Self> {
