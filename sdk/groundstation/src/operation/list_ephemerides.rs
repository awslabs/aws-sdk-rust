...
impl ListEphemeridesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_ephemerides::ListEphemerides::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEphemerides {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_ephemerides::de_list_ephemerides_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_ephemerides::ListEphemeridesError
{
