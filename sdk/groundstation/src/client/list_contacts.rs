...
impl super::Client {
    ...
    ///   - [`ephemeris(EphemerisFilter)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::ephemeris) / [`set_ephemeris(Option<EphemerisFilter>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_ephemeris):<br>required: **false**<br><p>Filter for selecting contacts that use a specific ephemeris".</p><br>
