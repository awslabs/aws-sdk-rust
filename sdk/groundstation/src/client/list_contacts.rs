...
impl super::Client {
    ...
    ///   - [`status_list(ContactStatus)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::status_list) / [`set_status_list(Vec<ContactStatus>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_status_list):<br>required: **true**<br><p>Status of a contact reservation.</p><br>
    ///   - [`start_time(DateTime)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::start_time) / [`set_start_time(DateTime)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_start_time):<br>required: **true**<br><p>Start time of a contact in UTC.</p><br>
    ///   - [`end_time(DateTime)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::end_time) / [`set_end_time(DateTime)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_end_time):<br>required: **true**<br><p>End time of a contact in UTC.</p><br>
