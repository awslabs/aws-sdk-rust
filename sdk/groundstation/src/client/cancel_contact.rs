...
impl super::Client {
    ...
    ///   - [`contact_id(impl Into<String>)`](crate::operation::cancel_contact::builders::CancelContactFluentBuilder::contact_id) / [`set_contact_id(impl Into<String>)`](crate::operation::cancel_contact::builders::CancelContactFluentBuilder::set_contact_id):<br>required: **true**<br><p>UUID of a contact.</p><br>
