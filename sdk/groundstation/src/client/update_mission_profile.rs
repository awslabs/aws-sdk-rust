...
impl super::Client {
    ...
    ///   - [`mission_profile_id(impl Into<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::mission_profile_id) / [`set_mission_profile_id(Option<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::set_mission_profile_id): <p>UUID of a mission profile.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::set_name): <p>Name of a mission profile.</p>
    ...
    ///   - [`tracking_config_arn(impl Into<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::tracking_config_arn) / [`set_tracking_config_arn(Option<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::set_tracking_config_arn): <p>ARN of a tracking <code>Config</code>.</p>
    ...
    ///   - [`streams_kms_role(impl Into<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::streams_kms_role) / [`set_streams_kms_role(Option<String>)`](crate::operation::update_mission_profile::builders::UpdateMissionProfileFluentBuilder::set_streams_kms_role): <p>Role to use for encrypting streams with KMS key.</p>
