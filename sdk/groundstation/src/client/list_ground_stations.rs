...
impl super::Client {
    ...
    pub fn list_ground_stations(
        &self,
    ) -> crate::operation::list_ground_stations::builders::ListGroundStationsFluentBuilder {
        crate::operation::list_ground_stations::builders::ListGroundStationsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
