...
impl super::Client {
    ...
    ///   - [`status_list(EphemerisStatus)`](crate::operation::list_ephemerides::builders::ListEphemeridesFluentBuilder::status_list) / [`set_status_list(Option<Vec<EphemerisStatus>>)`](crate::operation::list_ephemerides::builders::ListEphemeridesFluentBuilder::set_status_list): <p>The list of ephemeris status to return.</p>
