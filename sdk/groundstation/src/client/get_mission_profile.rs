...
impl super::Client {
    ...
    ///   - [`telemetry_sink_config_arn(Option<String>)`](crate::operation::get_mission_profile::GetMissionProfileOutput::telemetry_sink_config_arn): <p>ARN of a telemetry sink <code>Config</code>.</p>
