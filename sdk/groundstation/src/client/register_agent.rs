...
impl super::Client {
    ...
    ///   - [`discovery_data(DiscoveryData)`](crate::operation::register_agent::builders::RegisterAgentFluentBuilder::discovery_data) / [`set_discovery_data(Option<DiscoveryData>)`](crate::operation::register_agent::builders::RegisterAgentFluentBuilder::set_discovery_data): <p>Data for associating and agent with the capabilities it is managing.</p>
    ///   - [`agent_details(AgentDetails)`](crate::operation::register_agent::builders::RegisterAgentFluentBuilder::agent_details) / [`set_agent_details(Option<AgentDetails>)`](crate::operation::register_agent::builders::RegisterAgentFluentBuilder::set_agent_details): <p>Detailed information about the agent being registered.</p>
