...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_ephemeris::builders::CreateEphemerisFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_ephemeris::builders::CreateEphemerisFluentBuilder::set_tags): <p>Tags assigned to an ephemeris.</p>
