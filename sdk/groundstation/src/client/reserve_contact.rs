...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::reserve_contact::builders::ReserveContactFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::reserve_contact::builders::ReserveContactFluentBuilder::set_tags): <p>Tags assigned to a contact.</p>
