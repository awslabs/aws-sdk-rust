...
impl super::Client {
    ...
    ///   - [`ephemeris_id(impl Into<String>)`](crate::operation::update_ephemeris::builders::UpdateEphemerisFluentBuilder::ephemeris_id) / [`set_ephemeris_id(impl Into<String>)`](crate::operation::update_ephemeris::builders::UpdateEphemerisFluentBuilder::set_ephemeris_id):<br>required: **true**<br><p>The AWS Ground Station ephemeris ID.</p><br>
    ///   - [`enabled(bool)`](crate::operation::update_ephemeris::builders::UpdateEphemerisFluentBuilder::enabled) / [`set_enabled(bool)`](crate::operation::update_ephemeris::builders::UpdateEphemerisFluentBuilder::set_enabled):<br>required: **true**<br><p>Whether the ephemeris is enabled or not. Changing this value will not require the ephemeris to be re-validated.</p><br>
