...
impl super::Client {
    ...
    ///   - [`config_id(impl Into<String>)`](crate::operation::delete_config::builders::DeleteConfigFluentBuilder::config_id) / [`set_config_id(Option<String>)`](crate::operation::delete_config::builders::DeleteConfigFluentBuilder::set_config_id):<br>required: **true**<br><p>UUID of a <code>Config</code>.</p><br>
    ///   - [`config_type(ConfigCapabilityType)`](crate::operation::delete_config::builders::DeleteConfigFluentBuilder::config_type) / [`set_config_type(Option<ConfigCapabilityType>)`](crate::operation::delete_config::builders::DeleteConfigFluentBuilder::set_config_type):<br>required: **true**<br><p>Type of a <code>Config</code>.</p><br>
