...
impl super::Client {
    ...
    ///   - [`dataflow_endpoint_group_id(impl ::std::convert::Into<String>)`](crate::operation::delete_dataflow_endpoint_group::builders::DeleteDataflowEndpointGroupFluentBuilder::dataflow_endpoint_group_id) / [`set_dataflow_endpoint_group_id(Option<String>)`](crate::operation::delete_dataflow_endpoint_group::builders::DeleteDataflowEndpointGroupFluentBuilder::set_dataflow_endpoint_group_id): <p>UUID of a dataflow endpoint group.</p>
