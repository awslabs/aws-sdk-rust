...
impl super::Client {
    ...
    ///   - [`ephemeris_id(impl Into<String>)`](crate::operation::delete_ephemeris::builders::DeleteEphemerisFluentBuilder::ephemeris_id) / [`set_ephemeris_id(Option<String>)`](crate::operation::delete_ephemeris::builders::DeleteEphemerisFluentBuilder::set_ephemeris_id):<br>required: **true**<br><p>The AWS Ground Station ephemeris ID.</p><br>
