...
pub trait Waiters {
    ...
    fn wait_until_transformer_job_succeeded(&self) -> crate::waiters::transformer_job_succeeded::TransformerJobSucceededFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_transformer_job_succeeded(&self) -> crate::waiters::transformer_job_succeeded::TransformerJobSucceededFluentBuilder {
        crate::waiters::transformer_job_succeeded::TransformerJobSucceededFluentBuilder::new(self.handle.clone())
    }
}
...
mod get_transformer_job;

mod list_capabilities;

mod list_partnerships;

mod list_profiles;

mod list_tags_for_resource;

mod list_transformers;
