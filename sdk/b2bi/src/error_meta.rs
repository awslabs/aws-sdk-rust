...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_capability::CreateCapabilityError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::create_capability::CreateCapabilityError> for Error {
    fn from(err: crate::operation::create_capability::CreateCapabilityError) -> Self {
        match err {
            ...
            crate::operation::create_capability::CreateCapabilityError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_partnership::CreatePartnershipError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::create_partnership::CreatePartnershipError> for Error {
    fn from(err: crate::operation::create_partnership::CreatePartnershipError) -> Self {
        match err {
            ...
            crate::operation::create_partnership::CreatePartnershipError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_transformer::CreateTransformerError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::create_transformer::CreateTransformerError> for Error {
    fn from(err: crate::operation::create_transformer::CreateTransformerError) -> Self {
        match err {
            ...
            crate::operation::create_transformer::CreateTransformerError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_capability::DeleteCapabilityError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_partnership::DeletePartnershipError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_transformer::DeleteTransformerError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_capability::GetCapabilityError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_partnership::GetPartnershipError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_transformer::GetTransformerError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_transformer_job::GetTransformerJobError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::get_transformer_job::GetTransformerJobError> for Error {
    fn from(err: crate::operation::get_transformer_job::GetTransformerJobError) -> Self {
        match err {
            ...
            crate::operation::get_transformer_job::GetTransformerJobError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_capabilities::ListCapabilitiesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_partnerships::ListPartnershipsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_transformers::ListTransformersError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_transformer_job::StartTransformerJobError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::start_transformer_job::StartTransformerJobError> for Error {
    fn from(err: crate::operation::start_transformer_job::StartTransformerJobError) -> Self {
        match err {
            ...
            crate::operation::start_transformer_job::StartTransformerJobError::InternalServerException(inner) => Error::InternalServerException(inner),
            crate::operation::start_transformer_job::StartTransformerJobError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_mapping::TestMappingError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_parsing::TestParsingError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_capability::UpdateCapabilityError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::update_capability::UpdateCapabilityError> for Error {
    fn from(err: crate::operation::update_capability::UpdateCapabilityError) -> Self {
        match err {
            ...
            crate::operation::update_capability::UpdateCapabilityError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_partnership::UpdatePartnershipError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::update_partnership::UpdatePartnershipError> for Error {
    fn from(err: crate::operation::update_partnership::UpdatePartnershipError) -> Self {
        match err {
            ...
            crate::operation::update_partnership::UpdatePartnershipError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_transformer::UpdateTransformerError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::update_transformer::UpdateTransformerError> for Error {
    fn from(err: crate::operation::update_transformer::UpdateTransformerError) -> Self {
        match err {
            ...
            crate::operation::update_transformer::UpdateTransformerError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
