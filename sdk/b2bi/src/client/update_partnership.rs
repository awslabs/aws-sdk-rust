...
impl super::Client {
    ...
    ///   - [`capability_options(CapabilityOptions)`](crate::operation::update_partnership::builders::UpdatePartnershipFluentBuilder::capability_options) / [`set_capability_options(Option<CapabilityOptions>)`](crate::operation::update_partnership::builders::UpdatePartnershipFluentBuilder::set_capability_options):<br>required: **false**<br><p>To update, specify the structure that contains the details for the associated capabilities.</p><br>
    ...
    ///   - [`capability_options(Option<CapabilityOptions>)`](crate::operation::update_partnership::UpdatePartnershipOutput::capability_options): <p>Returns the structure that contains the details for the associated capabilities.</p>
