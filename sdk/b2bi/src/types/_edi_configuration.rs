        ...
        ::std::result::Result::Ok(
            crate::types::EdiConfiguration {
                ...
                transformer_id: self.transformer_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("transformer_id", "transformer_id was not specified but it is required when building EdiConfiguration")
                    )?
                ,
            }
        )
