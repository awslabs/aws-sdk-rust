            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "inputLocation" => {
                            builder = builder.set_input_location(crate::protocol_serde::shape_s3_location::de_s3_location(tokens)?);
                        }
                        "outputLocation" => {
                            builder = builder.set_output_location(crate::protocol_serde::shape_s3_location::de_s3_location(tokens)?);
                        }
                        "transformerId" => {
