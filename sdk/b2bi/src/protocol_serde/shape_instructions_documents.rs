...
pub(crate) fn de_instructions_documents<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::S3Location>>, ::aws_smithy_json::deserialize::error::DeserializeError>
