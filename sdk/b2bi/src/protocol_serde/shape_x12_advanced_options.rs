                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            "splitOptions" => {
                                builder = builder.set_split_options(crate::protocol_serde::shape_x12_split_options::de_x12_split_options(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "validationOptions" => {
                                builder = builder.set_validation_options(
                                    crate::protocol_serde::shape_x12_validation_options::de_x12_validation_options(tokens, _value, depth + 1)?,
                                );
                            }
