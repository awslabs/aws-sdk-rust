...
) -> Result<Option<crate::types::Mapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        "templateLanguage" => {
                            builder = builder.set_template_language(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MappingTemplateLanguage::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "template" => {
            ...
            Ok(Some(crate::serde_util::mapping_correct_errors(builder).build().map_err(|err| {
