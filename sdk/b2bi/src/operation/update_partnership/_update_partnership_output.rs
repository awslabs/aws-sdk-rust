...
impl UpdatePartnershipOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_partnership::UpdatePartnershipOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_partnership::UpdatePartnershipOutput {
                profile_id: self.profile_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("profile_id", "profile_id was not specified but it is required when building UpdatePartnershipOutput")
                    )?
                ,
                partnership_id: self.partnership_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("partnership_id", "partnership_id was not specified but it is required when building UpdatePartnershipOutput")
                    )?
                ,
                partnership_arn: self.partnership_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("partnership_arn", "partnership_arn was not specified but it is required when building UpdatePartnershipOutput")
                    )?
                ,
                name: self.name
                ,
                ...
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building UpdatePartnershipOutput")
                    )?
                ,
