...
impl TestParsingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::test_parsing::TestParsingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_parsing::TestParsingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::test_parsing::TestParsingOutput, crate::operation::test_parsing::TestParsingError, Self> {
