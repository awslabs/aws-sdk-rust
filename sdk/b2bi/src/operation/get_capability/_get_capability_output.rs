...
impl GetCapabilityOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_capability::GetCapabilityOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_capability::GetCapabilityOutput {
                capability_id: self.capability_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("capability_id", "capability_id was not specified but it is required when building GetCapabilityOutput")
                    )?
                ,
                capability_arn: self.capability_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("capability_arn", "capability_arn was not specified but it is required when building GetCapabilityOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building GetCapabilityOutput")
                    )?
                ,
                r#type: self.r#type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "r#type was not specified but it is required when building GetCapabilityOutput")
                    )?
                ,
                ...
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building GetCapabilityOutput")
                    )?
                ,
