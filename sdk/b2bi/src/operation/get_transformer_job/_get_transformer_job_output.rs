...
impl GetTransformerJobOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_transformer_job::GetTransformerJobOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_transformer_job::GetTransformerJobOutput {
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building GetTransformerJobOutput")
                    )?
                ,
