...
impl  StartTransformerJobOutput  {
    ...
    pub fn transformer_job_id(&self) -> & str {
        use std::ops::Deref; self.transformer_job_id.deref()
    }
}
...
impl StartTransformerJobOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_transformer_job::StartTransformerJobOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::start_transformer_job::StartTransformerJobOutput {
                transformer_job_id: self.transformer_job_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("transformer_job_id", "transformer_job_id was not specified but it is required when building StartTransformerJobOutput")
                    )?
                ,
