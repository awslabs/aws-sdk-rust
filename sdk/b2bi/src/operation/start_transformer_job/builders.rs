...
impl StartTransformerJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_transformer_job::StartTransformerJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_transformer_job::StartTransformerJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_transformer_job::StartTransformerJobOutput, crate::operation::start_transformer_job::StartTransformerJobError, Self> {
