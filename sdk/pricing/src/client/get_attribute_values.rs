...
impl super::Client {
    ...
    ///   - [`service_code(impl ::std::convert::Into<String>)`](crate::operation::get_attribute_values::builders::GetAttributeValuesFluentBuilder::service_code) / [`set_service_code(Option<String>)`](crate::operation::get_attribute_values::builders::GetAttributeValuesFluentBuilder::set_service_code): <p>The service code for the service whose attributes you want to retrieve. For example, if you want the retrieve an EC2 attribute, use <code>AmazonEC2</code>.</p>
    ///   - [`attribute_name(impl ::std::convert::Into<String>)`](crate::operation::get_attribute_values::builders::GetAttributeValuesFluentBuilder::attribute_name) / [`set_attribute_name(Option<String>)`](crate::operation::get_attribute_values::builders::GetAttributeValuesFluentBuilder::set_attribute_name): <p>The name of the attribute that you want to retrieve the values for, such as <code>volumeType</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_attribute_values::builders::GetAttributeValuesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_attribute_values::builders::GetAttributeValuesFluentBuilder::set_next_token): <p>The pagination token that indicates the next set of results that you want to retrieve.</p>
