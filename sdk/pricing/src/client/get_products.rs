...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::get_products::builders::GetProductsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::get_products::builders::GetProductsFluentBuilder::set_filters): <p>The list of filters that limit the returned products. only products that match all filters are returned.</p>
