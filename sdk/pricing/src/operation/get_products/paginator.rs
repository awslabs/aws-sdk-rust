...
impl GetProductsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<::std::string::String, ::aws_smithy_http::result::SdkError<crate::operation::get_products::GetProductsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_products_output_price_list(page).unwrap_or_default().into_iter())
    }
}
