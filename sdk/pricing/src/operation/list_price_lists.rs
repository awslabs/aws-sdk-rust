    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_price_lists::ListPriceListsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_price_lists::ListPriceListsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListPriceLists {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListPriceLists", "pricing"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListPriceLists")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListPriceListsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListPriceListsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListPriceListsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_price_lists::ListPriceListsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_price_lists::ser_list_price_lists_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListPriceListsEndpointParamsInterceptor {
...
pub type ListPriceListsErrorKind = ListPriceListsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListPriceListsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_price_lists::ListPriceListsError {
...
impl ListPriceListsError {
    ...
    /// Creates the `ListPriceListsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
