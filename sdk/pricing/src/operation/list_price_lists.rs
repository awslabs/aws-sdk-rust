...
impl ListPriceListsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_price_lists::ListPriceLists, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_price_lists::ser_list_price_lists_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPriceLists {
    type Output =
        ::std::result::Result<crate::operation::list_price_lists::ListPriceListsOutput, crate::operation::list_price_lists::ListPriceListsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_price_lists::de_list_price_lists_http_response_with_props(status, headers, body)
        }
    }
}
