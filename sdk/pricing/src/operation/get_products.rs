...
impl GetProductsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_products::GetProducts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProducts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_products::de_get_products_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_products::de_get_products_http_response_with_props(
                status, headers, body,
            )
        }
    }
