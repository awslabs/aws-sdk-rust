...
impl GetAttributeValuesInput {
    /// Consumes the builder and constructs an Operation<[`GetAttributeValues`](crate::operation::get_attribute_values::GetAttributeValues)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_attribute_values::GetAttributeValues, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_attribute_values::GetAttributeValuesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_attribute_values::ser_get_attribute_values_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_attribute_values::GetAttributeValues::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetAttributeValues {
                type Output = std::result::Result<crate::operation::get_attribute_values::GetAttributeValuesOutput, crate::operation::get_attribute_values::GetAttributeValuesError>;
