...
/// Orchestration and serialization glue logic for `GetAttributeValues`.
...
impl GetAttributeValues {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_attribute_values::GetAttributeValuesInput,
                    ) -> ::std::result::Result<crate::operation::get_attribute_values::GetAttributeValuesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_attribute_values::GetAttributeValuesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_attribute_values::GetAttributeValuesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_attribute_values::GetAttributeValuesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAttributeValues {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAttributeValues");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAttributeValuesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAttributeValuesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAttributeValues")
...
.with_interceptor(GetAttributeValuesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_attribute_values::GetAttributeValuesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_attribute_values::GetAttributeValuesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_attribute_values::GetAttributeValuesError>::new());
...
#[derive(Debug)]
            struct GetAttributeValuesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAttributeValuesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_attribute_values::de_get_attribute_values_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_attribute_values::de_get_attribute_values_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetAttributeValuesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAttributeValuesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_attribute_values::GetAttributeValuesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_attribute_values::GetAttributeValuesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_attribute_values::ser_get_attribute_values_input(&input)?);
...
#[derive(Debug)]
            struct GetAttributeValuesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAttributeValuesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAttributeValuesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAttributeValuesInput>()
                        .ok_or("failed to downcast to GetAttributeValuesInput")?;
...
pub enum GetAttributeValuesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAttributeValuesError) for what information is available for the error.")]
...
impl GetAttributeValuesError {
    /// Creates the `GetAttributeValuesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAttributeValuesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAttributeValuesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_attribute_values::GetAttributeValuesError {
...
mod _get_attribute_values_output;
