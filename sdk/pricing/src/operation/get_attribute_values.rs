...
impl GetAttributeValuesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_attribute_values::ser_get_attribute_values_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_attribute_values::GetAttributeValues::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_attribute_values::GetAttributeValuesError
{
