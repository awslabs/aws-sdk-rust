...
impl DescribeServices {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Pricing", "DescribeServices", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeServicesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("FormatVersion") {
            if let ::std::option::Option::Some(value) = input.format_version.as_deref() {
                captured.insert("FormatVersion", value);
            }
        }
...
impl DescribeServicesError {
    ...
    /// Returns `true` if the error kind is `DescribeServicesError::ThrottlingException`.
