...
pub fn ser_get_attribute_values_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_attribute_values::GetAttributeValuesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
