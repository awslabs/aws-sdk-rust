...
pub fn ser_get_products_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetProductsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
