...
/// For example, the [`DescribeServices`](crate::operation::describe_services) operation has
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_pricing::Error> {
/// # let client: aws_sdk_pricing::Client = unimplemented!();
