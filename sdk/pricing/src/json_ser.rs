...
pub fn serialize_structure_crate_input_get_attribute_values_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAttributeValuesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_products_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetProductsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
