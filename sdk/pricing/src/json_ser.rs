...
pub fn serialize_structure_get_attribute_values_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_products_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_12 in var_10 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_13, item_12);
                object_13.finish();
            }
        }
        array_11.finish();
