...
pub struct GetProductsOutput  {
    ...
    #[doc(hidden)]pub price_list: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct GetAttributeValuesOutput  {
    ...
    #[doc(hidden)]pub attribute_values: std::option::Option<std::vec::Vec<crate::model::AttributeValue>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
