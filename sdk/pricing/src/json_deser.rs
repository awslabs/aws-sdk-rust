...
pub(crate) fn deser_operation_crate_operation_get_attribute_values(
    value: &[u8],
...
pub(crate) fn deser_operation_crate_operation_get_products(
    value: &[u8],
...
pub(crate) fn deser_list_com_amazonaws_pricing_service_list<'a, I>(
...
#[allow(non_snake_case)]
pub(crate) fn deser_list_com_amazonaws_pricing_attribute_value_list<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
...
#[allow(non_snake_case)]
pub(crate) fn deser_list_com_amazonaws_pricing_price_list_json_items<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
...
#[allow(non_snake_case)]
pub(crate) fn deser_list_com_amazonaws_pricing_attribute_name_list<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<Option<std::vec::Vec<std::string::String>>, aws_smithy_json::deserialize::Error>
where
    I: Iterator<
