...
pub mod create_host_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::CreateHostInput, smithy_http::operation::BuildError>
        {
...
impl CreateHostInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_host(&self).map_err(|err| {
...
pub mod delete_host_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::DeleteHostInput, smithy_http::operation::BuildError>
        {
...
impl DeleteHostInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_delete_host(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl GetConnectionInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_connection(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
pub mod get_host_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::GetHostInput, smithy_http::operation::BuildError>
        {
...
impl GetHostInput {
    ...
    pub fn make_operation(
        ...
        smithy_http::operation::Operation<crate::operation::GetHost, aws_http::AwsErrorRetryPolicy>,
        smithy_http::operation::BuildError,
    > {
        Ok({
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_host(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            ...
            let op =
                smithy_http::operation::Operation::new(request, crate::operation::GetHost::new())
                    .with_metadata(smithy_http::operation::Metadata::new(
                        "GetHost",
                        "codestarconnections",
                    ));
...
pub mod list_hosts_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::ListHostsInput, smithy_http::operation::BuildError>
        {
...
impl ListHostsInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_list_hosts(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            ...
            let op =
                smithy_http::operation::Operation::new(request, crate::operation::ListHosts::new())
                    .with_metadata(smithy_http::operation::Metadata::new(
                        "ListHosts",
                        "codestarconnections",
                    ));
...
pub mod update_host_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::UpdateHostInput, smithy_http::operation::BuildError>
        {
...
impl UpdateHostInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_host(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
