...
impl UpdateHostInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_host::UpdateHost, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_host::ser_update_host_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateHost {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_host::de_update_host_http_response_with_props(status, headers, body)
        }
    }
}
