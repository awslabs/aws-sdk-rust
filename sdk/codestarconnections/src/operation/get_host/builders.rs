...
impl GetHostInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_host::GetHostError, ::aws_smithy_http::operation::Response>,
    > {
...
impl GetHostFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::get_host::GetHostOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_host::GetHostError>>
    {
        let op = self
            .inner
            .build()
