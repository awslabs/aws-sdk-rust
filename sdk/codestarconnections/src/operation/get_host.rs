...
impl GetHostInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_host::GetHost, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_host::ser_get_host_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHost {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_host::de_get_host_http_response_with_props(status, headers, body)
        }
    }
}
