...
pub use crate::types::_trigger_resource_update_on::TriggerResourceUpdateOn;

pub use crate::types::_publish_deployment_status::PublishDeploymentStatus;
...
mod _publish_deployment_status;
...
mod _trigger_resource_update_on;
