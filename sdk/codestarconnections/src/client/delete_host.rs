...
impl super::Client {
    ...
    ///   - [`host_arn(impl Into<String>)`](crate::operation::delete_host::builders::DeleteHostFluentBuilder::host_arn) / [`set_host_arn(Option<String>)`](crate::operation::delete_host::builders::DeleteHostFluentBuilder::set_host_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the host to be deleted.</p><br>
