...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_hosts::builders::ListHostsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_hosts::builders::ListHostsFluentBuilder::set_max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p>
