...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_hosts::builders::ListHostsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_hosts::builders::ListHostsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_hosts::builders::ListHostsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_hosts::builders::ListHostsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token that was returned from the previous <code>ListHosts</code> call, which can be used to return the next set of hosts in the list.</p><br>
