...
pub fn ser_update_host_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_host::UpdateHostInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
