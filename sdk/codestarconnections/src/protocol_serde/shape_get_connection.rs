        ...
        "ResourceNotFoundException" => {
            crate::operation::get_connection::GetConnectionError::ResourceNotFoundException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_connection::GetConnectionError::unhandled)?;
        ...
        "ResourceUnavailableException" => {
            crate::operation::get_connection::GetConnectionError::ResourceUnavailableException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_unavailable_exception::de_resource_unavailable_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_connection::GetConnectionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
