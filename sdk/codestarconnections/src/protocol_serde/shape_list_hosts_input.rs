...
pub fn ser_list_hosts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListHostsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
