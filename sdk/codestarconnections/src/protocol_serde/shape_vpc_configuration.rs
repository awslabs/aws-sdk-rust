...
pub fn ser_vpc_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VpcConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_vpc_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VpcConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
