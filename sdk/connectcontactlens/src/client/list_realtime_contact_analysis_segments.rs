...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximimum number of results to return per page.</p><br>
