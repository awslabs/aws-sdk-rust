...
impl super::Client {
    ...
    ///   - [`contact_id(impl Into<String>)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::set_contact_id): <p>The identifier of the contact.</p>
    ///   - [`max_results(i32)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::set_max_results): <p>The maximimum number of results to return per page.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_realtime_contact_analysis_segments::builders::ListRealtimeContactAnalysisSegmentsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
