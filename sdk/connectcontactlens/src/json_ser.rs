...
pub fn serialize_structure_crate_input_list_realtime_contact_analysis_segments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRealtimeContactAnalysisSegmentsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
