...
#[allow(clippy::unnecessary_wraps)]pub fn parse_list_realtime_contact_analysis_segments_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRealtimeContactAnalysisSegmentsOutput, crate::error::ListRealtimeContactAnalysisSegmentsError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_list_realtime_contact_analysis_segments_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRealtimeContactAnalysisSegmentsOutput, crate::error::ListRealtimeContactAnalysisSegmentsError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::list_realtime_contact_analysis_segments_output::Builder::default();
        let _ = response;
