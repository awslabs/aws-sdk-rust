...
pub struct RealtimeContactAnalysisSegment  {
    ...
    #[doc(hidden)]pub transcript: std::option::Option<crate::model::Transcript>,
    /// <p>The matched category rules.</p>
    #[doc(hidden)]pub categories: std::option::Option<crate::model::Categories>,
}
...
pub struct Categories  {
    ...
    #[doc(hidden)]pub matched_categories: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The category rule that was matched and when it occurred in the transcript.</p>
    #[doc(hidden)]pub matched_details: std::option::Option<std::collections::HashMap<std::string::String, crate::model::CategoryDetails>>,
}
impl Categories {
    /// <p>The category rules that have been matched in the analyzed segment.</p>
...
pub struct CategoryDetails  {
    ...
    #[doc(hidden)]pub points_of_interest: std::option::Option<std::vec::Vec<crate::model::PointOfInterest>>,
}
...
pub struct PointOfInterest  {
    ...
    #[doc(hidden)]pub begin_offset_millis: i32,
    /// <p>The ending offset in milliseconds where the category rule was detected.</p>
    #[doc(hidden)]pub end_offset_millis: i32,
}
...
pub struct Transcript  {
    ...
    #[doc(hidden)]pub participant_id: std::option::Option<std::string::String>,
    /// <p>The role of participant. For example, is it a customer, agent, or system.</p>
    #[doc(hidden)]pub participant_role: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub sentiment: std::option::Option<crate::model::SentimentValue>,
    /// <p>List of positions where issues were detected on the transcript.</p>
    #[doc(hidden)]pub issues_detected: std::option::Option<std::vec::Vec<crate::model::IssueDetected>>,
}
impl Transcript {
    /// <p>The identifier of the transcript.</p>
...
pub struct IssueDetected  {
    ...
    #[doc(hidden)]pub character_offsets: std::option::Option<crate::model::CharacterOffsets>,
}
impl IssueDetected {
    /// <p>The offset for when the issue was detected in the segment.</p>
...
pub struct CharacterOffsets  {
    ...
    #[doc(hidden)]pub begin_offset_char: i32,
    /// <p>The end of the issue.</p>
    #[doc(hidden)]pub end_offset_char: i32,
}
