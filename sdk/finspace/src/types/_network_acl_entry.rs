...
impl  NetworkAclEntry  {
    ...
    pub fn cidr_block(&self) -> & str {
        use std::ops::Deref; self.cidr_block.deref()
    }
}
impl NetworkAclEntry {
        ...
        ::std::result::Result::Ok(
            crate::types::NetworkAclEntry {
                rule_number: self.rule_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("rule_number", "rule_number was not specified but it is required when building NetworkAclEntry")
                    )?
                ,
                protocol: self.protocol
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("protocol", "protocol was not specified but it is required when building NetworkAclEntry")
                    )?
                ,
                rule_action: self.rule_action
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("rule_action", "rule_action was not specified but it is required when building NetworkAclEntry")
                    )?
                ,
                ...
                cidr_block: self.cidr_block
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("cidr_block", "cidr_block was not specified but it is required when building NetworkAclEntry")
                    )?
                ,
            }
        )
