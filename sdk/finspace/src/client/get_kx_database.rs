...
impl super::Client {
    ...
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::get_kx_database::builders::GetKxDatabaseFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::get_kx_database::builders::GetKxDatabaseFluentBuilder::set_environment_id): <p>A unique identifier for the kdb environment.</p>
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::get_kx_database::builders::GetKxDatabaseFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::get_kx_database::builders::GetKxDatabaseFluentBuilder::set_database_name): <p>The name of the kdb database.</p>
