...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_kx_environments::builders::ListKxEnvironmentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_kx_environments::builders::ListKxEnvironmentsFluentBuilder::set_next_token): <p>A token that indicates where a results page should begin.</p>
    ///   - [`max_results(i32)`](crate::operation::list_kx_environments::builders::ListKxEnvironmentsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_kx_environments::builders::ListKxEnvironmentsFluentBuilder::set_max_results): <p>The maximum number of results to return in this request.</p>
