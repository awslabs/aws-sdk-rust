...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_kx_environments::builders::ListKxEnvironmentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_kx_environments::builders::ListKxEnvironmentsFluentBuilder::set_next_token): <p>A token that indicates where a results page should begin.</p>
