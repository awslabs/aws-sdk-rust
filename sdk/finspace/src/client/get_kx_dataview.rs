...
impl super::Client {
    ...
    ///   - [`az_mode(Option<KxAzMode>)`](crate::operation::get_kx_dataview::GetKxDataviewOutput::az_mode): <p>The number of availability zones you want to assign per volume. Currently, FinSpace only supports <code>SINGLE</code> for volumes. This places dataview in a single AZ.</p>
    ...
    ///   - [`read_write(bool)`](crate::operation::get_kx_dataview::GetKxDataviewOutput::read_write): <p>Returns True if the dataview is created as writeable and False otherwise.</p>
