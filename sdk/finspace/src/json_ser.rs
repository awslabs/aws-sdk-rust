...
pub fn serialize_structure_crate_input_create_environment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEnvironmentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_6) = &input.federation_parameters {
        ...
        crate::json_ser::serialize_structure_crate_model_federation_parameters(&mut object_7, var_6)?;
        object_7.finish();
    }
    ...
    if let Some(var_10) = &input.superuser_parameters {
        ...
        crate::json_ser::serialize_structure_crate_model_superuser_parameters(&mut object_11, var_10)?;
        object_11.finish();
    }
...
pub fn serialize_structure_crate_input_update_environment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEnvironmentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_22) = &input.federation_parameters {
        ...
        crate::json_ser::serialize_structure_crate_model_federation_parameters(&mut object_23, var_22)?;
        object_23.finish();
    }
...
pub fn serialize_structure_crate_model_federation_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FederationParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_superuser_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SuperuserParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
