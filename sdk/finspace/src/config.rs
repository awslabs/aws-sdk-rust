...
impl Builder {
    ...
    /// use aws_sdk_finspace::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_finspace::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
