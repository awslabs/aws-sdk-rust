...
pub struct Environment  {
    ...
    #[doc(hidden)]pub sage_maker_studio_domain_url: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub dedicated_service_account_id: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for Environment  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("sage_maker_studio_domain_url", &self.sage_maker_studio_domain_url);
        formatter.field("kms_key_id", &self.kms_key_id);
        formatter.field("dedicated_service_account_id", &self.dedicated_service_account_id);
...
pub struct FederationParameters  {
    ...
    #[doc(hidden)]pub saml_metadata_url: std::option::Option<std::string::String>,
    /// <p>The redirect or sign-in URL that should be entered into the SAML 2.0 compliant identity provider configuration (IdP).</p>
    #[doc(hidden)]pub application_call_back_url: std::option::Option<std::string::String>,
    /// <p>The Uniform Resource Name (URN). Also referred as Service Provider URN or Audience URI or Service Provider Entity ID.</p>
    #[doc(hidden)]pub federation_urn: std::option::Option<std::string::String>,
    /// <p>Name of the identity provider (IdP).</p>
    #[doc(hidden)]pub federation_provider_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub attribute_map: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
