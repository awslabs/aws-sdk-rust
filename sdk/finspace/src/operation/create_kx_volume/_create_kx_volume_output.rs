...
pub struct CreateKxVolumeOutput {
...
impl ::aws_types::request_id::RequestId for CreateKxVolumeOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateKxVolumeOutput {
    /// Creates a new builder-style object to manufacture [`CreateKxVolumeOutput`](crate::operation::create_kx_volume::CreateKxVolumeOutput).
    pub fn builder() -> crate::operation::create_kx_volume::builders::CreateKxVolumeOutputBuilder {
        crate::operation::create_kx_volume::builders::CreateKxVolumeOutputBuilder::default()
    }
}
...
impl CreateKxVolumeOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateKxVolumeOutput`](crate::operation::create_kx_volume::CreateKxVolumeOutput).
    pub fn build(self) -> crate::operation::create_kx_volume::CreateKxVolumeOutput {
