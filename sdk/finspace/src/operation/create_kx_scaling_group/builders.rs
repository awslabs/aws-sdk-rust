...
impl CreateKxScalingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_kx_scaling_group::CreateKxScalingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_kx_scaling_group::CreateKxScalingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_kx_scaling_group::CreateKxScalingGroupOutput, crate::operation::create_kx_scaling_group::CreateKxScalingGroupError, Self> {
