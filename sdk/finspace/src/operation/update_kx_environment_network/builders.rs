...
impl UpdateKxEnvironmentNetworkFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_kx_environment_network::UpdateKxEnvironmentNetworkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_kx_environment_network::UpdateKxEnvironmentNetworkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_kx_environment_network::UpdateKxEnvironmentNetworkOutput, crate::operation::update_kx_environment_network::UpdateKxEnvironmentNetworkError, Self> {
