...
pub(crate) fn de_tickerplant_log_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TickerplantLogConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
