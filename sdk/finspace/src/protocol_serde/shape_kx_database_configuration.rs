...
pub(crate) fn de_kx_database_configuration<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::KxDatabaseConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "cacheConfigurations" => {
                            builder = builder.set_cache_configurations(
                                crate::protocol_serde::shape_kx_database_cache_configurations::de_kx_database_cache_configurations(tokens, _value)?,
                            );
                        }
                        "changesetId" => {
                        ...
                        "dataviewConfiguration" => {
                            builder = builder.set_dataview_configuration(
                                crate::protocol_serde::shape_kx_dataview_configuration::de_kx_dataview_configuration(tokens, _value)?,
                            );
                        }
