...
pub fn ser_superuser_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SuperuserParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
