...
pub(crate) fn de_transit_gateway_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::TransitGatewayConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "attachmentNetworkAclConfiguration" => {
                            builder = builder.set_attachment_network_acl_configuration(
                                crate::protocol_serde::shape_network_acl_configuration::de_network_acl_configuration(tokens, _value, depth + 1)?,
                            );
                        }
