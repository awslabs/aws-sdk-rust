...
impl super::Client {
    ...
    ///   - [`network_type(Option<NetworkType>)`](crate::operation::delete_db_instance::DeleteDbInstanceOutput::network_type): <p>Specifies whether the networkType of the Timestream for InfluxDB instance is IPV4, which can communicate over IPv4 protocol only, or DUAL, which can communicate over both IPv4 and IPv6 protocols.</p>
