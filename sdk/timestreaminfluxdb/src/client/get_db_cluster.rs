...
impl super::Client {
    ...
    ///   - [`influx_auth_parameters_secret_arn(Option<String>)`](crate::operation::get_db_cluster::GetDbClusterOutput::influx_auth_parameters_secret_arn): <p>The Amazon Resource Name (ARN) of the Amazon Web Services Secrets Manager secret containing the initial InfluxDB authorization parameters. The secret value is a JSON formatted key-value pair holding InfluxDB authorization values: organization, bucket, username, and password.</p>
