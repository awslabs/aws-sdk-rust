...
impl UpdateDbInstanceOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_db_instance::UpdateDbInstanceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_db_instance::UpdateDbInstanceOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building UpdateDbInstanceOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building UpdateDbInstanceOutput")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building UpdateDbInstanceOutput")
                    )?
                ,
                status: self.status
                ,
                ...
                vpc_subnet_ids: self.vpc_subnet_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_subnet_ids", "vpc_subnet_ids was not specified but it is required when building UpdateDbInstanceOutput")
                    )?
                ,
