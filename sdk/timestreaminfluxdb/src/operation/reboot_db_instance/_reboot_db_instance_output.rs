...
impl RebootDbInstanceOutputBuilder {
    ...
    /// - [`id`](crate::operation::reboot_db_instance::builders::RebootDbInstanceOutputBuilder::id)
    /// - [`name`](crate::operation::reboot_db_instance::builders::RebootDbInstanceOutputBuilder::name)
    /// - [`arn`](crate::operation::reboot_db_instance::builders::RebootDbInstanceOutputBuilder::arn)
    /// - [`vpc_subnet_ids`](crate::operation::reboot_db_instance::builders::RebootDbInstanceOutputBuilder::vpc_subnet_ids)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::reboot_db_instance::RebootDbInstanceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::reboot_db_instance::RebootDbInstanceOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building RebootDbInstanceOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building RebootDbInstanceOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building RebootDbInstanceOutput",
                )
            })?,
            status: self.status,
            ...
            vpc_subnet_ids: self.vpc_subnet_ids.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "vpc_subnet_ids",
                    "vpc_subnet_ids was not specified but it is required when building RebootDbInstanceOutput",
                )
            })?,
