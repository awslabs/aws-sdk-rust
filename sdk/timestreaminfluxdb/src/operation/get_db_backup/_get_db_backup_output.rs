...
impl ::aws_types::request_id::RequestId for GetDbBackupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetDbBackupOutput {
    /// Creates a new builder-style object to manufacture [`GetDbBackupOutput`](crate::operation::get_db_backup::GetDbBackupOutput).
    pub fn builder() -> crate::operation::get_db_backup::builders::GetDbBackupOutputBuilder {
        crate::operation::get_db_backup::builders::GetDbBackupOutputBuilder::default()
    }
}

/// A builder for [`GetDbBackupOutput`](crate::operation::get_db_backup::GetDbBackupOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetDbBackupOutputBuilder {
...
impl GetDbBackupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetDbBackupOutput`](crate::operation::get_db_backup::GetDbBackupOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::get_db_backup::builders::GetDbBackupOutputBuilder::id)
    /// - [`arn`](crate::operation::get_db_backup::builders::GetDbBackupOutputBuilder::arn)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_db_backup::GetDbBackupOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_db_backup::GetDbBackupOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetDbBackupOutput",
                )
            })?,
            name: self.name,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building GetDbBackupOutput",
                )
            })?,
            status: self.status,
