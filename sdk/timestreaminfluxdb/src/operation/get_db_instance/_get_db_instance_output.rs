...
impl  GetDbInstanceOutput  {
    ...
    pub fn vpc_subnet_ids(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.vpc_subnet_ids.deref()
    }
    /// <p>Indicates if the DB instance has a public IP to facilitate access.</p>
...
impl GetDbInstanceOutputBuilder {
    ...
    pub fn set_influx_auth_parameters_secret_arn(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.influx_auth_parameters_secret_arn = input; self
    }
    /// <p>The Amazon Resource Name (ARN) of the AWS Secrets Manager secret containing the initial InfluxDB authorization parameters. The secret value is a JSON formatted key-value pair holding InfluxDB authorization values: organization, bucket, username, and password.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_db_instance::GetDbInstanceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_db_instance::GetDbInstanceOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building GetDbInstanceOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building GetDbInstanceOutput")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building GetDbInstanceOutput")
                    )?
                ,
                status: self.status
                ,
                ...
                vpc_subnet_ids: self.vpc_subnet_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_subnet_ids", "vpc_subnet_ids was not specified but it is required when building GetDbInstanceOutput")
                    )?
                ,
