...
impl DeleteDbInstanceOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_db_instance::DeleteDbInstanceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_db_instance::DeleteDbInstanceOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building DeleteDbInstanceOutput")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building DeleteDbInstanceOutput")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building DeleteDbInstanceOutput")
                    )?
                ,
                status: self.status
                ,
                ...
                vpc_subnet_ids: self.vpc_subnet_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_subnet_ids", "vpc_subnet_ids was not specified but it is required when building DeleteDbInstanceOutput")
                    )?
                ,
