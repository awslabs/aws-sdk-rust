...
pub fn de_delete_db_instance_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_instance_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_db_instance::DeleteDbInstanceOutput, crate::operation::delete_db_instance::DeleteDbInstanceError> {
    Ok({
        ...
        crate::serde_util::delete_db_instance_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::delete_db_instance::DeleteDbInstanceError::unhandled)?
    })
}

pub fn ser_delete_db_instance_input(
...
pub(crate) fn de_delete_db_instance(
    value: &[u8],
    mut builder: crate::operation::delete_db_instance::builders::DeleteDbInstanceOutputBuilder,
) -> Result<crate::operation::delete_db_instance::builders::DeleteDbInstanceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
