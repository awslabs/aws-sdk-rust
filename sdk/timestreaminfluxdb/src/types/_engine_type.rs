...
///     EngineType::InfluxdbV3Core => { /* ... */ },
///     EngineType::InfluxdbV3Enterprise => { /* ... */ },
...
impl ::std::convert::From<&str> for EngineType {
    fn from(s: &str) -> Self {
        match s {
            "INFLUXDB_V2" => EngineType::InfluxdbV2,
            "INFLUXDB_V3_CORE" => EngineType::InfluxdbV3Core,
            "INFLUXDB_V3_ENTERPRISE" => EngineType::InfluxdbV3Enterprise,
...
impl EngineType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EngineType::InfluxdbV2 => "INFLUXDB_V2",
            EngineType::InfluxdbV3Core => "INFLUXDB_V3_CORE",
            EngineType::InfluxdbV3Enterprise => "INFLUXDB_V3_ENTERPRISE",
