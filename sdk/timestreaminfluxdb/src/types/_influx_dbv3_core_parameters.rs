...
impl InfluxDBv3CoreParameters {
    ...
    pub fn builder() -> crate::types::builders::InfluxDBv3CoreParametersBuilder {
        crate::types::builders::InfluxDBv3CoreParametersBuilder::default()
    }
}

/// A builder for [`InfluxDBv3CoreParameters`](crate::types::InfluxDBv3CoreParameters).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InfluxDBv3CoreParametersBuilder {
