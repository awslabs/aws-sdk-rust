...
impl ::std::convert::From<&str> for ResourceType {
    fn from(s: &str) -> Self {
        match s {
            "DB_CLUSTER" => ResourceType::DbCluster,
            "DB_INSTANCE" => ResourceType::DbInstance,
...
impl ResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceType::DbCluster => "DB_CLUSTER",
            ResourceType::DbInstance => "DB_INSTANCE",
...
impl ::std::fmt::Display for ResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ResourceType::DbCluster => write!(f, "DB_CLUSTER"),
            ResourceType::DbInstance => write!(f, "DB_INSTANCE"),
