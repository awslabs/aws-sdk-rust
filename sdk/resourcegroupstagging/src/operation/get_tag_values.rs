...
impl GetTagValuesInput {
    /// Consumes the builder and constructs an Operation<[`GetTagValues`](crate::operation::get_tag_values::GetTagValues)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_tag_values::GetTagValues, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_tag_values::GetTagValuesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_tag_values::ser_get_tag_values_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_tag_values::GetTagValues::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTagValues", "resourcegroupstaggingapi"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetTagValues {
                type Output = std::result::Result<crate::operation::get_tag_values::GetTagValuesOutput, crate::operation::get_tag_values::GetTagValuesError>;
