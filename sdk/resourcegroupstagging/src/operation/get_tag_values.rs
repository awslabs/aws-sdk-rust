...
impl GetTagValuesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_tag_values::GetTagValues, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_tag_values::ser_get_tag_values_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTagValues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_tag_values::de_get_tag_values_http_response_with_props(status, headers, body)
        }
    }
}
