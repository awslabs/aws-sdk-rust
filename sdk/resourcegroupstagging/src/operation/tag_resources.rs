...
impl TagResourcesInput {
    /// Consumes the builder and constructs an Operation<[`TagResources`](crate::operation::tag_resources::TagResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_resources::TagResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_resources::TagResourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_tag_resources::ser_tag_resources_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_resources::TagResources::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagResources", "resourcegroupstaggingapi"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagResources {
                type Output = std::result::Result<crate::operation::tag_resources::TagResourcesOutput, crate::operation::tag_resources::TagResourcesError>;
