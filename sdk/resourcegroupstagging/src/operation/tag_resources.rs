...
impl TagResources {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::tag_resources::TagResourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::tag_resources::TagResourcesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Resource Groups Tagging API.TagResources",
            "rpc.service" = "Resource Groups Tagging API",
            "rpc.method" = "TagResources",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TagResources {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            TagResourcesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            TagResourcesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("TagResources")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::tag_resources::TagResourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::tag_resources::TagResourcesInput,
