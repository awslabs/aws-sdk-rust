...
impl TagResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_resources::TagResources, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_resources::ser_tag_resources_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_tag_resources::de_tag_resources_http_response_with_props(status, headers, body)
        }
    }
}
