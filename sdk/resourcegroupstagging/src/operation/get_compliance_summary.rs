...
impl GetComplianceSummary {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_compliance_summary::GetComplianceSummaryInput,
                    ) -> ::std::result::Result<crate::operation::get_compliance_summary::GetComplianceSummaryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_compliance_summary::GetComplianceSummaryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_compliance_summary::GetComplianceSummaryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_compliance_summary::GetComplianceSummaryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetComplianceSummary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetComplianceSummary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetComplianceSummaryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetComplianceSummaryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetComplianceSummary")
...
.with_interceptor(GetComplianceSummaryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_compliance_summary::GetComplianceSummaryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_compliance_summary::GetComplianceSummaryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_compliance_summary::GetComplianceSummaryError>::new());
...
#[derive(Debug)]
            struct GetComplianceSummaryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetComplianceSummaryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_compliance_summary::de_get_compliance_summary_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_compliance_summary::de_get_compliance_summary_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetComplianceSummaryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetComplianceSummaryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_compliance_summary::GetComplianceSummaryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_compliance_summary::GetComplianceSummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_compliance_summary::ser_get_compliance_summary_input(&input)?);
...
#[derive(Debug)]
            struct GetComplianceSummaryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetComplianceSummaryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetComplianceSummaryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetComplianceSummaryInput>()
                        .ok_or("failed to downcast to GetComplianceSummaryInput")?;
...
pub enum GetComplianceSummaryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetComplianceSummaryError) for what information is available for the error.")]
...
impl GetComplianceSummaryError {
    /// Creates the `GetComplianceSummaryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetComplianceSummaryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetComplianceSummaryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_compliance_summary::GetComplianceSummaryError {
...
mod _get_compliance_summary_output;
