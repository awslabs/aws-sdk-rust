...
impl GetComplianceSummaryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_compliance_summary::ser_get_compliance_summary_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_compliance_summary::GetComplianceSummary::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_compliance_summary::GetComplianceSummaryError
{
