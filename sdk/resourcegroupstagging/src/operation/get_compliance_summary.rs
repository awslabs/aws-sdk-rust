...
impl GetComplianceSummaryInput {
    /// Consumes the builder and constructs an Operation<[`GetComplianceSummary`](crate::operation::get_compliance_summary::GetComplianceSummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_compliance_summary::GetComplianceSummary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_compliance_summary::GetComplianceSummaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_compliance_summary::ser_get_compliance_summary_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_compliance_summary::GetComplianceSummary::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetComplianceSummary", "resourcegroupstaggingapi"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetComplianceSummary {
                type Output = std::result::Result<crate::operation::get_compliance_summary::GetComplianceSummaryOutput, crate::operation::get_compliance_summary::GetComplianceSummaryError>;
