...
impl GetComplianceSummary {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_compliance_summary::GetComplianceSummaryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_compliance_summary::GetComplianceSummaryOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Resource Groups Tagging API.GetComplianceSummary",
            "rpc.service" = "Resource Groups Tagging API",
            "rpc.method" = "GetComplianceSummary",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetComplianceSummary {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetComplianceSummaryRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetComplianceSummaryResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetComplianceSummary")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetComplianceSummary")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetComplianceSummaryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetComplianceSummaryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetComplianceSummaryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetComplianceSummaryInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("PaginationToken") {
            if let ::std::option::Option::Some(value) = input.pagination_token.as_deref() {
                captured.insert("PaginationToken", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetComplianceSummaryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_compliance_summary::de_get_compliance_summary_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_compliance_summary::de_get_compliance_summary_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetComplianceSummaryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_compliance_summary::GetComplianceSummaryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_compliance_summary::GetComplianceSummaryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_compliance_summary::ser_get_compliance_summary_input(
            &input,
        )?);
