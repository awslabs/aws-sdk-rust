...
impl DescribeReportCreationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReportCreation`](crate::operation::describe_report_creation::DescribeReportCreation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_report_creation::DescribeReportCreation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_report_creation::DescribeReportCreationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_report_creation::ser_describe_report_creation_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_report_creation::DescribeReportCreation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeReportCreation", "resourcegroupstaggingapi"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReportCreation {
                type Output = std::result::Result<crate::operation::describe_report_creation::DescribeReportCreationOutput, crate::operation::describe_report_creation::DescribeReportCreationError>;
