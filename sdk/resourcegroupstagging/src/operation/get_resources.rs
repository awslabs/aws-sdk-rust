...
impl GetResourcesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_resources::ser_get_resources_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resources::GetResources::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetResources", "resourcegroupstaggingapi"));
