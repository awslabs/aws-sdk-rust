...
impl UntagResourcesInput {
    /// Consumes the builder and constructs an Operation<[`UntagResources`](crate::operation::untag_resources::UntagResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::untag_resources::UntagResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_resources::UntagResourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_resources::ser_untag_resources_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::untag_resources::UntagResources::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UntagResources", "resourcegroupstaggingapi"));
...
impl aws_smithy_http::response::ParseStrictResponse for UntagResources {
                type Output = std::result::Result<crate::operation::untag_resources::UntagResourcesOutput, crate::operation::untag_resources::UntagResourcesError>;
