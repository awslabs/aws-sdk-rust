...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UntagResourcesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_untag_resources::de_untag_resources_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_untag_resources::de_untag_resources_http_response(status, headers, body, _cfg)
        };
