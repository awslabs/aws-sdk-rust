...
impl UntagResources {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::untag_resources::UntagResourcesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::untag_resources::UntagResourcesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Resource Groups Tagging API.UntagResources",
            "rpc.service" = "Resource Groups Tagging API",
            "rpc.method" = "UntagResources",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UntagResources {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UntagResourcesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UntagResourcesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UntagResources")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UntagResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::untag_resources::UntagResourcesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::untag_resources::UntagResourcesInput,
