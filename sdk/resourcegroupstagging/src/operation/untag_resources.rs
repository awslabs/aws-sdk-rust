...
impl UntagResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::untag_resources::UntagResources, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_untag_resources::ser_untag_resources_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagResources {
    type Output =
        ::std::result::Result<crate::operation::untag_resources::UntagResourcesOutput, crate::operation::untag_resources::UntagResourcesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_resources::de_untag_resources_http_response_with_props(status, headers, body)
        }
    }
}
