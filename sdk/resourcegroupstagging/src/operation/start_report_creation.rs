...
impl StartReportCreationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_report_creation::StartReportCreation::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("StartReportCreation", "resourcegroupstaggingapi"),
            );
