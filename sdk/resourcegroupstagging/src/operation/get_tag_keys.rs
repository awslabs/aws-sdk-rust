...
impl GetTagKeys {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Resource Groups Tagging API.GetTagKeys",
            "rpc.service" = "Resource Groups Tagging API",
            "rpc.method" = "GetTagKeys",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTagKeys {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTagKeys")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetTagKeysTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetTagKeysTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTagKeysTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetTagKeysInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTagKeysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_tag_keys::de_get_tag_keys_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_tag_keys::de_get_tag_keys_http_response(status, headers, body, _cfg)
        };
