...
impl DescribeReportCreationFluentBuilder  {
    /// Creates a new `DescribeReportCreation`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_report_creation::DescribeReportCreationOutput, aws_smithy_http::result::SdkError<crate::operation::describe_report_creation::DescribeReportCreationError>>
                     {
