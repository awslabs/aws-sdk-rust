...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::get_tag_keys::GetTagKeysError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::get_tag_values::GetTagValuesError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
