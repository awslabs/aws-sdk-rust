...
impl super::Client {
    ...
    pub fn start_report_creation(
        &self,
    ) -> crate::operation::start_report_creation::builders::StartReportCreationFluentBuilder {
        crate::operation::start_report_creation::builders::StartReportCreationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
