...
pub fn ser_get_compliance_summary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetComplianceSummaryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
