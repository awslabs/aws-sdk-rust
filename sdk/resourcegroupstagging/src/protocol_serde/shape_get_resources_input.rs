...
pub fn ser_get_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetResourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
