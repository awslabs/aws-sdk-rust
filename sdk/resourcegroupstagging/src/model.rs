...
pub struct ResourceTagMapping  {
    ...
    #[doc(hidden)]pub compliance_details: std::option::Option<crate::model::ComplianceDetails>,
}
...
pub mod resource_tag_mapping {
    ...
    impl Builder {
        ...
        /// <p>Information that shows whether a resource is compliant with the effective tag policy, including details on any noncompliant tag keys.</p>
        pub fn set_compliance_details(mut self, input: std::option::Option<crate::model::ComplianceDetails>) -> Self {
...
pub struct ComplianceDetails  {
    ...
    #[doc(hidden)]pub noncompliant_keys: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub keys_with_noncompliant_values: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Whether a resource is compliant with the effective tag policy.</p>
    #[doc(hidden)]pub compliance_status: std::option::Option<bool>,
}
...
impl  std::fmt::Debug for ComplianceDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("keys_with_noncompliant_values", &self.keys_with_noncompliant_values);
...
pub struct Summary  {
    ...
    #[doc(hidden)]pub last_updated: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub target_id_type: std::option::Option<crate::model::TargetIdType>,
    ...
    #[doc(hidden)]pub non_compliant_resources: i64,
}
impl Summary {
    /// <p>The timestamp that shows when this summary was generated in this Region. </p>
...
pub mod summary {
    ...
    impl Builder {
        ...
        /// <p>Whether the target is an account, an OU, or the organization root.</p>
        pub fn set_target_id_type(mut self, input: std::option::Option<crate::model::TargetIdType>) -> Self {
