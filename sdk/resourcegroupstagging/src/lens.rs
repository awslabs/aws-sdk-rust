...
pub(crate) fn reflens_get_compliance_summary_output_pagination_token(
...
pub(crate) fn reflens_get_resources_output_pagination_token(
...
pub(crate) fn reflens_get_tag_keys_output_pagination_token(
...
pub(crate) fn reflens_get_tag_values_output_pagination_token(
...
pub(crate) fn lens_get_compliance_summary_output_summary_list(
    input: crate::operation::get_compliance_summary::GetComplianceSummaryOutput,
...
pub(crate) fn lens_get_resources_output_resource_tag_mapping_list(
    input: crate::operation::get_resources::GetResourcesOutput,
...
pub(crate) fn lens_get_tag_keys_output_tag_keys(
    input: crate::operation::get_tag_keys::GetTagKeysOutput,
...
pub(crate) fn lens_get_tag_values_output_tag_values(
    input: crate::operation::get_tag_values::GetTagValuesOutput,
) -> ::std::option::Option<::std::vec::Vec<::std::string::String>> {
