...
pub fn serialize_structure_crate_input_query_forecast_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QueryForecastInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_query_what_if_forecast_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QueryWhatIfForecastInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
