...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("forecastquery", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Forecast Query Service.
pub mod client;
