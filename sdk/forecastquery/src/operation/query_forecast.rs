...
impl QueryForecastInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::query_forecast::QueryForecast::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for QueryForecast {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_query_forecast::de_query_forecast_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_query_forecast::de_query_forecast_http_response_with_props(
                status, headers, body,
            )
        }
    }
