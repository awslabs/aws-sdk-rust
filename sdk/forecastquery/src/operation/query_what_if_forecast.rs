...
impl QueryWhatIfForecast {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::query_what_if_forecast::QueryWhatIfForecastOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::query_what_if_forecast::QueryWhatIfForecastError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::query_what_if_forecast::QueryWhatIfForecastError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::query_what_if_forecast::QueryWhatIfForecastOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for QueryWhatIfForecast {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("QueryWhatIfForecast");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(QueryWhatIfForecastRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(QueryWhatIfForecastResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("QueryWhatIfForecast")
...
.with_interceptor(QueryWhatIfForecastEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::query_what_if_forecast::QueryWhatIfForecastError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::query_what_if_forecast::QueryWhatIfForecastError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::query_what_if_forecast::QueryWhatIfForecastError>::new());
...
#[derive(Debug)]
            struct QueryWhatIfForecastResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for QueryWhatIfForecastResponseDeserializer {
...
#[derive(Debug)]
            struct QueryWhatIfForecastRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for QueryWhatIfForecastRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::query_what_if_forecast::QueryWhatIfForecastInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::query_what_if_forecast::QueryWhatIfForecastInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_query_what_if_forecast::ser_query_what_if_forecast_input(&input)?);
...
#[derive(Debug)]
            struct QueryWhatIfForecastEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for QueryWhatIfForecastEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "QueryWhatIfForecastEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<QueryWhatIfForecastInput>()
                        .ok_or("failed to downcast to QueryWhatIfForecastInput")?;
...
pub enum QueryWhatIfForecastError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-QueryWhatIfForecastError) for what information is available for the error.")]
...
impl QueryWhatIfForecastError {
    /// Creates the `QueryWhatIfForecastError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `QueryWhatIfForecastError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for QueryWhatIfForecastError {
...
impl ::aws_types::request_id::RequestId for crate::operation::query_what_if_forecast::QueryWhatIfForecastError {
