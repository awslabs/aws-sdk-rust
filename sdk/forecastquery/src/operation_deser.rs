...
#[allow(clippy::unnecessary_wraps)]pub fn parse_query_forecast_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::QueryForecastOutput, crate::error::QueryForecastError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_query_forecast_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::QueryForecastOutput, crate::error::QueryForecastError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::query_forecast_output::Builder::default();
        let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_query_what_if_forecast_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::QueryWhatIfForecastOutput, crate::error::QueryWhatIfForecastError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_query_what_if_forecast_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::QueryWhatIfForecastOutput, crate::error::QueryWhatIfForecastError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::query_what_if_forecast_output::Builder::default();
        let _ = response;
