...
impl super::Client {
    /// Constructs a fluent builder for the [`QueryWhatIfForecast`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`what_if_forecast_arn(impl ::std::convert::Into<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::what_if_forecast_arn) / [`set_what_if_forecast_arn(Option<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::set_what_if_forecast_arn): <p>The Amazon Resource Name (ARN) of the what-if forecast to query.</p>
    ///   - [`start_date(impl ::std::convert::Into<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::start_date) / [`set_start_date(Option<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::set_start_date): <p>The start date for the what-if forecast. Specify the date using this format: yyyy-MM-dd'T'HH:mm:ss (ISO 8601 format). For example, 2015-01-01T08:00:00.</p>
    ///   - [`end_date(impl ::std::convert::Into<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::end_date) / [`set_end_date(Option<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::set_end_date): <p>The end date for the what-if forecast. Specify the date using this format: yyyy-MM-dd'T'HH:mm:ss (ISO 8601 format). For example, 2015-01-01T20:00:00. </p>
    ///   - [`filters(HashMap<String, String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::filters) / [`set_filters(Option<HashMap<String, String>>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::set_filters): <p>The filtering criteria to apply when retrieving the forecast. For example, to get the forecast for <code>client_21</code> in the electricity usage dataset, specify the following:</p>  <p> <code>{"item_id" : "client_21"}</code> </p>  <p>To get the full what-if forecast, use the <a href="https://docs.aws.amazon.com/en_us/forecast/latest/dg/API_CreateWhatIfForecastExport.html">CreateForecastExportJob</a> operation.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::query_what_if_forecast::builders::QueryWhatIfForecastFluentBuilder::set_next_token): <p>If the result of the previous request was truncated, the response includes a <code>NextToken</code>. To retrieve the next set of results, use the token in the next request. Tokens expire after 24 hours.</p>
