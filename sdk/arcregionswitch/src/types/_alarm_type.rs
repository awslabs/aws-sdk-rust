...
impl ::std::convert::From<&str> for AlarmType {
    fn from(s: &str) -> Self {
        match s {
            "applicationHealth" => AlarmType::ApplicationHealth,
            "trigger" => AlarmType::Trigger,
...
impl AlarmType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AlarmType::ApplicationHealth => "applicationHealth",
            AlarmType::Trigger => "trigger",
            AlarmType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["applicationHealth", "trigger"]
    }
}
...
impl ::std::fmt::Display for AlarmType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AlarmType::ApplicationHealth => write!(f, "applicationHealth"),
            AlarmType::Trigger => write!(f, "trigger"),
