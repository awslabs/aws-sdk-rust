...
impl super::Client {
    ...
    ///   - [`mode(ExecutionMode)`](crate::operation::get_plan_execution::GetPlanExecutionOutput::mode): <p>The plan execution mode. Valid values are <code>graceful</code>, for graceful executions, or <code>ungraceful</code>, for ungraceful executions.</p>
    ...
    ///   - [`recovery_execution_id(Option<String>)`](crate::operation::get_plan_execution::GetPlanExecutionOutput::recovery_execution_id): <p>The unique identifier of the most recent recovery execution. Required when starting a post-recovery execution.</p>
