...
impl super::Client {
    ...
    ///   - [`action(ExecutionAction)`](crate::operation::start_plan_execution::builders::StartPlanExecutionFluentBuilder::action) / [`set_action(Option<ExecutionAction>)`](crate::operation::start_plan_execution::builders::StartPlanExecutionFluentBuilder::set_action):<br>required: **true**<br><p>The action to perform. Valid values are <code>activate</code> (to shift traffic to the target Region) or <code>deactivate</code> (to shift traffic away from the target Region).</p><br>
    ///   - [`mode(ExecutionMode)`](crate::operation::start_plan_execution::builders::StartPlanExecutionFluentBuilder::mode) / [`set_mode(Option<ExecutionMode>)`](crate::operation::start_plan_execution::builders::StartPlanExecutionFluentBuilder::set_mode):<br>required: **false**<br><p>The plan execution mode. Valid values are <code>graceful</code>, for starting the execution in graceful mode, or <code>ungraceful</code>, for starting the execution in ungraceful mode.</p><br>
