...
impl super::Client {
    ...
    ///   - [`report_configuration(ReportConfiguration)`](crate::operation::update_plan::builders::UpdatePlanFluentBuilder::report_configuration) / [`set_report_configuration(Option<ReportConfiguration>)`](crate::operation::update_plan::builders::UpdatePlanFluentBuilder::set_report_configuration):<br>required: **false**<br><p>The updated report configuration for the plan.</p><br>
