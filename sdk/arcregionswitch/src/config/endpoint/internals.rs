...
pub(super) fn resolve_endpoint(
    ...
    #[allow(unused_variables)]
    let use_control_plane_endpoint = &_params.use_control_plane_endpoint;
    #[allow(unused_variables)]
    if let Some(use_control_plane_endpoint) = use_control_plane_endpoint {
        if (*use_control_plane_endpoint) == (true) {
            #[allow(unused_variables)]
