...
//! offered by ARC - Region switch. The return value of each of these methods is a "fluent builder",
...
/// Client for calling ARC - Region switch.
...
/// For example, the [`ApprovePlanExecutionStep`](crate::operation::approve_plan_execution_step) operation has
/// a [`Client::approve_plan_execution_step`], function which returns a builder for that operation.
...
/// Configuration for ARC - Region switch.
pub mod config;
