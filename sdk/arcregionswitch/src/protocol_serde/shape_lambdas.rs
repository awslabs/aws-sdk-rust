...
pub fn ser_lambdas(
    ...
    #[allow(unused)] input: &crate::types::Lambdas,
...
pub(crate) fn de_lambdas(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<crate::types::Lambdas, ::aws_smithy_cbor::decode::DeserializeError> {
    #[allow(clippy::match_single_binding)]
    fn pair(
        mut builder: crate::types::builders::LambdasBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
    ) -> ::std::result::Result<crate::types::builders::LambdasBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    let mut builder = crate::types::builders::LambdasBuilder::default();
