...
pub fn ser_document_db_configuration(
    encoder: &mut ::aws_smithy_cbor::Encoder,
    #[allow(unused)] input: &crate::types::DocumentDbConfiguration,
    ...
    if let Some(var_3) = &input.ungraceful {
        ...
        crate::protocol_serde::shape_document_db_ungraceful::ser_document_db_ungraceful(encoder, var_3)?;
    }
    {
...
pub(crate) fn de_document_db_configuration(
    ...
    fn pair(
        ...
        builder = match decoder.str()?.as_ref() {
            ...
            "behavior" => builder.set_behavior(Some(decoder.string().map(|s| crate::types::DocumentDbDefaultBehavior::from(s.as_ref()))?)),
    ...
    let mut builder = crate::types::builders::DocumentDbConfigurationBuilder::default();
    ...
    {
        return Ok(crate::serde_util::document_db_configuration_correct_errors(builder)
            .build()
