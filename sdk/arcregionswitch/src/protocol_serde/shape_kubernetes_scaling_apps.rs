...
pub(crate) fn de_kubernetes_scaling_apps(
...
> {
    ...
    > {
        let value = match decoder.datatype()? {
            ...
            _ => crate::protocol_serde::shape_kubernetes_scaling_application::de_kubernetes_scaling_application(decoder, depth + 1)?,
        };
        list.push(value);
        Ok(list)
    }
