...
pub(crate) fn de_kubernetes_scaling_application(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<
    ::std::collections::HashMap<::std::string::String, ::std::collections::HashMap<::std::string::String, crate::types::KubernetesScalingResource>>,
...
> {
    ...
    > {
        ...
        let value = match decoder.datatype()? {
            ...
            _ => crate::protocol_serde::shape_regional_scaling_resource::de_regional_scaling_resource(decoder, depth + 1)?,
        };
