...
pub fn ser_rds_create_cross_region_replica_configuration(
    encoder: &mut ::aws_smithy_cbor::Encoder,
    #[allow(unused)] input: &crate::types::RdsCreateCrossRegionReplicaConfiguration,
...
pub(crate) fn de_rds_create_cross_region_replica_configuration(
    ...
    let mut builder = crate::types::builders::RdsCreateCrossRegionReplicaConfigurationBuilder::default();
    ...
    {
        return Ok(crate::serde_util::rds_create_cross_region_replica_configuration_correct_errors(builder)
            .build()
