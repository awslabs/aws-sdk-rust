...
pub fn ser_associated_alarm(
    encoder: &mut ::aws_smithy_cbor::Encoder,
    #[allow(unused)] input: &crate::types::AssociatedAlarm,
    ...
    {
        encoder.str("resourceIdentifier").str(input.resource_identifier.as_str());
    }
    {
        encoder.str("alarmType").str(input.alarm_type.as_str());
    }
    encoder.end();
    Ok(())
}

pub(crate) fn de_associated_alarm(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<crate::types::AssociatedAlarm, ::aws_smithy_cbor::decode::DeserializeError> {
    #[allow(clippy::match_single_binding)]
    fn pair(
        mut builder: crate::types::builders::AssociatedAlarmBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
    ) -> ::std::result::Result<crate::types::builders::AssociatedAlarmBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    let mut builder = crate::types::builders::AssociatedAlarmBuilder::default();
    ...
    {
        return Ok(crate::serde_util::associated_alarm_correct_errors(builder)
            .build()
