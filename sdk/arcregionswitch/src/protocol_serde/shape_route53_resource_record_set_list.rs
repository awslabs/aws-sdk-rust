...
pub(crate) fn de_route53_resource_record_set_list(
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::Route53ResourceRecordSet>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::Route53ResourceRecordSet>, ::aws_smithy_cbor::decode::DeserializeError> {
        let value = match decoder.datatype()? {
            ...
            _ => crate::protocol_serde::shape_route53_resource_record_set::de_route53_resource_record_set(decoder, depth + 1)?,
        };
        list.push(value);
        Ok(list)
    }
