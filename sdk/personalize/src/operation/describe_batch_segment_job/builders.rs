...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobOutput,
                    crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError,
                > for DescribeBatchSegmentJobFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeBatchSegmentJobFluentBuilder {
    ...
    /// Access the DescribeBatchSegmentJob as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_batch_segment_job::builders::DescribeBatchSegmentJobInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_batch_segment_job::DescribeBatchSegmentJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_batch_segment_job::DescribeBatchSegmentJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobOutput, crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError, Self> {
    ...
    pub fn get_batch_segment_job_arn(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_batch_segment_job_arn()
    }
}
