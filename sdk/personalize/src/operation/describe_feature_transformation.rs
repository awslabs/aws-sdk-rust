...
impl DescribeFeatureTransformationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_feature_transformation::DescribeFeatureTransformation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFeatureTransformation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_feature_transformation::de_describe_feature_transformation_http_response_with_props(
                status, headers, body,
            )
        }
    }
