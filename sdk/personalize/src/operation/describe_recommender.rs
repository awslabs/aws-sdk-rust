...
impl DescribeRecommenderInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_recommender::ser_describe_recommender_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRecommender {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_recommender::de_describe_recommender_http_response_with_props(status, headers, body)
        }
    }
}
