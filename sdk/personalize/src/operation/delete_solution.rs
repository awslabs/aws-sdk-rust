...
impl DeleteSolutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_solution::DeleteSolution,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_solution::DeleteSolution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSolution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_solution::de_delete_solution_http_error(
                status, headers, body,
            )
        } else {
