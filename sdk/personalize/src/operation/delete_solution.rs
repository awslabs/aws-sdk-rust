...
impl DeleteSolutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_solution::DeleteSolution, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_solution::ser_delete_solution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSolution {
    type Output =
        ::std::result::Result<crate::operation::delete_solution::DeleteSolutionOutput, crate::operation::delete_solution::DeleteSolutionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_solution::de_delete_solution_http_response_with_props(status, headers, body)
        }
    }
}
