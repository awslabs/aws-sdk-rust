...
impl ListRecipesFluentBuilder {
    ...
    /// Access the ListRecipes as a reference.
    pub fn as_input(&self) -> &crate::operation::list_recipes::builders::ListRecipesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_recipes::ListRecipesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recipes::ListRecipesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_recipes::ListRecipes::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_recipes::ListRecipesOutput, crate::operation::list_recipes::ListRecipesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_recipes::paginator::ListRecipesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    ...
    pub fn get_recipe_provider(&self) -> &::std::option::Option<crate::types::RecipeProvider> {
        self.inner.get_recipe_provider()
    }
