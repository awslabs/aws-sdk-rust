...
impl StopRecommenderFluentBuilder  {
    /// Creates a new `StopRecommender`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::stop_recommender::StopRecommenderOutput, aws_smithy_http::result::SdkError<crate::operation::stop_recommender::StopRecommenderError>>
                     {
