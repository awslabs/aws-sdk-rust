...
impl GetSolutionMetricsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_solution_metrics::ser_get_solution_metrics_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSolutionMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_solution_metrics::de_get_solution_metrics_http_response_with_props(status, headers, body)
        }
    }
}
