...
/// Orchestration and serialization glue logic for `GetSolutionMetrics`.
...
impl GetSolutionMetrics {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_solution_metrics::GetSolutionMetricsInput,
                    ) -> ::std::result::Result<crate::operation::get_solution_metrics::GetSolutionMetricsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_solution_metrics::GetSolutionMetricsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_solution_metrics::GetSolutionMetricsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_solution_metrics::GetSolutionMetricsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSolutionMetrics {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSolutionMetrics");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSolutionMetricsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSolutionMetricsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSolutionMetrics")
...
.with_interceptor(GetSolutionMetricsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_solution_metrics::GetSolutionMetricsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_solution_metrics::GetSolutionMetricsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_solution_metrics::GetSolutionMetricsError>::new());
...
#[derive(Debug)]
            struct GetSolutionMetricsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSolutionMetricsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_solution_metrics::de_get_solution_metrics_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_solution_metrics::de_get_solution_metrics_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetSolutionMetricsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSolutionMetricsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_solution_metrics::GetSolutionMetricsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_solution_metrics::GetSolutionMetricsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_solution_metrics::ser_get_solution_metrics_input(&input)?);
...
#[derive(Debug)]
            struct GetSolutionMetricsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSolutionMetricsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSolutionMetricsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSolutionMetricsInput>()
                        .ok_or("failed to downcast to GetSolutionMetricsInput")?;
...
pub enum GetSolutionMetricsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSolutionMetricsError) for what information is available for the error.")]
...
impl GetSolutionMetricsError {
    /// Creates the `GetSolutionMetricsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSolutionMetricsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSolutionMetricsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_solution_metrics::GetSolutionMetricsError {
...
mod _get_solution_metrics_output;
