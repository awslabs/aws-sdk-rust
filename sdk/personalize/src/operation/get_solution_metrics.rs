...
impl GetSolutionMetricsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_solution_metrics::GetSolutionMetrics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSolutionMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_solution_metrics::de_get_solution_metrics_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_solution_metrics::GetSolutionMetricsError
{
