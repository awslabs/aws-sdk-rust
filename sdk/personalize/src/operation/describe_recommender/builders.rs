...
impl DescribeRecommenderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_recommender::DescribeRecommenderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_recommender::DescribeRecommenderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_recommender::DescribeRecommenderOutput, crate::operation::describe_recommender::DescribeRecommenderError, Self> {
