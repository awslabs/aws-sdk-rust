...
impl DescribeFeatureTransformationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_feature_transformation::DescribeFeatureTransformationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_feature_transformation::DescribeFeatureTransformationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_feature_transformation::DescribeFeatureTransformationOutput, crate::operation::describe_feature_transformation::DescribeFeatureTransformationError, Self> {
