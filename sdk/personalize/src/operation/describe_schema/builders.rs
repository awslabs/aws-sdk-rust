...
pub use crate::operation::describe_schema::_describe_schema_output::DescribeSchemaOutputBuilder;
...
pub struct DescribeSchemaFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_schema::builders::DescribeSchemaInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_schema::DescribeSchemaOutput,
                    crate::operation::describe_schema::DescribeSchemaError,
                > for DescribeSchemaFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeSchemaFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_schema::DescribeSchemaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_schema::DescribeSchemaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_schema::DescribeSchema::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_schema::DescribeSchema::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_schema::DescribeSchemaOutput, crate::operation::describe_schema::DescribeSchemaError, Self> {
