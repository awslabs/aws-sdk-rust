...
impl CreateEventTrackerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_event_tracker::ser_create_event_tracker_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEventTracker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_event_tracker::de_create_event_tracker_http_response_with_props(status, headers, body)
        }
    }
}
