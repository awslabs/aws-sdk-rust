...
impl CreateEventTrackerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_event_tracker::CreateEventTracker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEventTracker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_event_tracker::de_create_event_tracker_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_event_tracker::CreateEventTrackerError
{
