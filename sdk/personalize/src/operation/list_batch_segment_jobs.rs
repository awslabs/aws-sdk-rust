...
impl ListBatchSegmentJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_batch_segment_jobs::ListBatchSegmentJobs,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBatchSegmentJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_batch_segment_jobs::de_list_batch_segment_jobs_http_response_with_props(status, headers, body)
        }
    }
}
