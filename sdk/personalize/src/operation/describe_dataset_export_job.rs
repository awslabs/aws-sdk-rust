...
impl DescribeDatasetExportJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_dataset_export_job::DescribeDatasetExportJob,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_dataset_export_job::DescribeDatasetExportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDatasetExportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_dataset_export_job::de_describe_dataset_export_job_http_response_with_props(status, headers, body)
        }
    }
}
