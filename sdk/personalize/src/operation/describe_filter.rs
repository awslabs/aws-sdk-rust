...
impl DescribeFilterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_filter::DescribeFilter, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_filter::ser_describe_filter_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFilter {
    type Output =
        ::std::result::Result<crate::operation::describe_filter::DescribeFilterOutput, crate::operation::describe_filter::DescribeFilterError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_filter::de_describe_filter_http_response_with_props(status, headers, body)
        }
    }
