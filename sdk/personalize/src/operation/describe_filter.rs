...
impl DescribeFilterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_filter::DescribeFilter,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_filter::DescribeFilter::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFilter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_filter::de_describe_filter_http_error(
                status, headers, body,
            )
        } else {
