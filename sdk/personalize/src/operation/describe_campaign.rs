...
impl DescribeCampaignInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_campaign::DescribeCampaign, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_campaign::ser_describe_campaign_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCampaign {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_campaign::de_describe_campaign_http_response_with_props(status, headers, body)
        }
    }
}
