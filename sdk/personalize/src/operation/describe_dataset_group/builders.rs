...
impl DescribeDatasetGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_dataset_group::DescribeDatasetGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_dataset_group::DescribeDatasetGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_dataset_group::DescribeDatasetGroupOutput, crate::operation::describe_dataset_group::DescribeDatasetGroupError, Self> {
