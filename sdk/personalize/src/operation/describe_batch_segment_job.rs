...
/// Orchestration and serialization glue logic for `DescribeBatchSegmentJob`.
...
impl DescribeBatchSegmentJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBatchSegmentJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeBatchSegmentJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeBatchSegmentJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeBatchSegmentJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBatchSegmentJob")
...
.with_interceptor(DescribeBatchSegmentJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError>::new());
...
#[derive(Debug)]
            struct DescribeBatchSegmentJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeBatchSegmentJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_batch_segment_job::de_describe_batch_segment_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeBatchSegmentJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeBatchSegmentJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_batch_segment_job::ser_describe_batch_segment_job_input(&input)?);
...
#[derive(Debug)]
            struct DescribeBatchSegmentJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeBatchSegmentJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeBatchSegmentJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeBatchSegmentJobInput>()
                        .ok_or("failed to downcast to DescribeBatchSegmentJobInput")?;
...
pub enum DescribeBatchSegmentJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeBatchSegmentJobError) for what information is available for the error.")]
...
impl DescribeBatchSegmentJobError {
    /// Creates the `DescribeBatchSegmentJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeBatchSegmentJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeBatchSegmentJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobError {
...
mod _describe_batch_segment_job_output;
