...
impl StopRecommenderInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::stop_recommender::StopRecommender,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_recommender::StopRecommender::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StopRecommender {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_recommender::de_stop_recommender_http_error(
                status, headers, body,
            )
        } else {
