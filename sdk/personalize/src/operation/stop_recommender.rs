...
impl StopRecommenderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_recommender::StopRecommender, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_recommender::ser_stop_recommender_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopRecommender {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_recommender::de_stop_recommender_http_response_with_props(status, headers, body)
        }
    }
}
