...
impl ListEventTrackersFluentBuilder  {
    /// Creates a new `ListEventTrackers`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_event_trackers::ListEventTrackersOutput, aws_smithy_http::result::SdkError<crate::operation::list_event_trackers::ListEventTrackersError>>
                     {
