...
impl DescribeAlgorithmInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_algorithm::ser_describe_algorithm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAlgorithm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_algorithm::de_describe_algorithm_http_response_with_props(status, headers, body)
        }
    }
}
