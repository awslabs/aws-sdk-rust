...
impl ListSolutionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_solutions::ListSolutions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_solutions::ser_list_solutions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSolutions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_solutions::de_list_solutions_http_response_with_props(status, headers, body)
        }
    }
}
