...
impl DescribeSchemaInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_schema::DescribeSchema, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_schema::ser_describe_schema_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSchema {
    type Output =
        ::std::result::Result<crate::operation::describe_schema::DescribeSchemaOutput, crate::operation::describe_schema::DescribeSchemaError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_schema::de_describe_schema_http_response_with_props(status, headers, body)
        }
    }
}
