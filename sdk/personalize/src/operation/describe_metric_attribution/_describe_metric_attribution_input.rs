...
impl DescribeMetricAttributionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_metric_attribution::DescribeMetricAttributionInput, ::aws_smithy_types::error::operation::BuildError> {
