...
impl CreateEventTrackerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_event_tracker::CreateEventTrackerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_event_tracker::CreateEventTrackerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_event_tracker::CreateEventTrackerOutput, crate::operation::create_event_tracker::CreateEventTrackerError, Self> {
