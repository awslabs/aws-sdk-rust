...
impl StopSolutionVersionCreationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_solution_version_creation::StopSolutionVersionCreationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_solution_version_creation::StopSolutionVersionCreationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_solution_version_creation::StopSolutionVersionCreationOutput, crate::operation::stop_solution_version_creation::StopSolutionVersionCreationError, Self> {
