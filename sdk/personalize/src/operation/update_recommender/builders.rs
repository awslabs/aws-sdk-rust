...
impl UpdateRecommenderFluentBuilder  {
    /// Creates a new `UpdateRecommender`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_recommender::UpdateRecommenderOutput, aws_smithy_http::result::SdkError<crate::operation::update_recommender::UpdateRecommenderError>>
                     {
