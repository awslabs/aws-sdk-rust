...
impl ListMetricAttributionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_metric_attributions::ListMetricAttributions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMetricAttributions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_metric_attributions::de_list_metric_attributions_http_response_with_props(status, headers, body)
        }
    }
}
