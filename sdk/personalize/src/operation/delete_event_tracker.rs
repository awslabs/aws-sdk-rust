...
impl DeleteEventTrackerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_event_tracker::DeleteEventTracker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEventTracker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_event_tracker::de_delete_event_tracker_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_event_tracker::DeleteEventTrackerError
{
