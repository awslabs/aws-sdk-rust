...
impl DeleteEventTrackerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_event_tracker::ser_delete_event_tracker_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEventTracker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_event_tracker::de_delete_event_tracker_http_response_with_props(status, headers, body)
        }
    }
}
