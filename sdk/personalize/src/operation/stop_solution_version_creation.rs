...
impl StopSolutionVersionCreationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_solution_version_creation::StopSolutionVersionCreation::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StopSolutionVersionCreationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_solution_version_creation::StopSolutionVersionCreationError
{
