...
impl CreateSolutionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_solution::CreateSolution::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSolution {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_solution::de_create_solution_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_solution::de_create_solution_http_response(
                status, headers, body,
            )
        }
    }
