...
impl CreateSolutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_solution::CreateSolution, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_solution::ser_create_solution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSolution {
    type Output =
        ::std::result::Result<crate::operation::create_solution::CreateSolutionOutput, crate::operation::create_solution::CreateSolutionError>;
