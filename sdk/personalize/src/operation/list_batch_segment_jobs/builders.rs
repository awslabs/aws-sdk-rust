...
pub use crate::operation::list_batch_segment_jobs::_list_batch_segment_jobs_output::ListBatchSegmentJobsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_batch_segment_jobs::ListBatchSegmentJobsOutput,
                    crate::operation::list_batch_segment_jobs::ListBatchSegmentJobsError,
                > for ListBatchSegmentJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListBatchSegmentJobsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_batch_segment_jobs::builders::ListBatchSegmentJobsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_batch_segment_jobs::ListBatchSegmentJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_batch_segment_jobs::ListBatchSegmentJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_batch_segment_jobs::ListBatchSegmentJobs::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_batch_segment_jobs::ListBatchSegmentJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_batch_segment_jobs::ListBatchSegmentJobsOutput, crate::operation::list_batch_segment_jobs::ListBatchSegmentJobsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_batch_segment_jobs::paginator::ListBatchSegmentJobsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
