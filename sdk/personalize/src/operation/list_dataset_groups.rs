...
impl ListDatasetGroupsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_dataset_groups::ListDatasetGroups::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListDatasetGroups {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_dataset_groups::de_list_dataset_groups_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_dataset_groups::ListDatasetGroupsError
{
