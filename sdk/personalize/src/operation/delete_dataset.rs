...
impl DeleteDatasetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_dataset::DeleteDataset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_dataset::ser_delete_dataset_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDataset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_dataset::de_delete_dataset_http_response_with_props(status, headers, body)
        }
    }
}
