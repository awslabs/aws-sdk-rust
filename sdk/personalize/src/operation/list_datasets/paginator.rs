...
/// Paginator for [`ListDatasets`](crate::operation::list_datasets::ListDatasets)
pub struct ListDatasetsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_datasets::builders::ListDatasetsInputBuilder,
...
impl ListDatasetsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_datasets::paginator::ListDatasetsPaginatorItems {
        crate::operation::list_datasets::paginator::ListDatasetsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_datasets::ListDatasets::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListDatasetsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_datasets_output_datasets(page).unwrap_or_default().into_iter())
    }
}
