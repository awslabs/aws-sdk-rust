...
impl DescribeMetricAttributionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_metric_attribution::DescribeMetricAttribution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMetricAttribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_metric_attribution::de_describe_metric_attribution_http_response_with_props(status, headers, body)
        }
    }
}
