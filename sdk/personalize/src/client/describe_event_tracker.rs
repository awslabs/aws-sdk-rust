...
impl super::Client {
    ...
    ///   - [`event_tracker_arn(impl Into<String>)`](crate::operation::describe_event_tracker::builders::DescribeEventTrackerFluentBuilder::event_tracker_arn) / [`set_event_tracker_arn(Option<String>)`](crate::operation::describe_event_tracker::builders::DescribeEventTrackerFluentBuilder::set_event_tracker_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the event tracker to describe.</p><br>
