...
impl super::Client {
    ...
    ///   - [`feature_transformation_arn(impl Into<String>)`](crate::operation::describe_feature_transformation::builders::DescribeFeatureTransformationFluentBuilder::feature_transformation_arn) / [`set_feature_transformation_arn(Option<String>)`](crate::operation::describe_feature_transformation::builders::DescribeFeatureTransformationFluentBuilder::set_feature_transformation_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the feature transformation to describe.</p><br>
    ...
    pub fn describe_feature_transformation(
        &self,
    ) -> crate::operation::describe_feature_transformation::builders::DescribeFeatureTransformationFluentBuilder {
