...
impl super::Client {
    ...
    ///   - [`job_name(impl ::std::convert::Into<String>)`](crate::operation::create_dataset_import_job::builders::CreateDatasetImportJobFluentBuilder::job_name) / [`set_job_name(Option<String>)`](crate::operation::create_dataset_import_job::builders::CreateDatasetImportJobFluentBuilder::set_job_name): <p>The name for the dataset import job.</p>
    ///   - [`dataset_arn(impl ::std::convert::Into<String>)`](crate::operation::create_dataset_import_job::builders::CreateDatasetImportJobFluentBuilder::dataset_arn) / [`set_dataset_arn(Option<String>)`](crate::operation::create_dataset_import_job::builders::CreateDatasetImportJobFluentBuilder::set_dataset_arn): <p>The ARN of the dataset that receives the imported data.</p>
