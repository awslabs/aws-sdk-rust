...
impl super::Client {
    ...
    ///   - [`solution_arn(impl Into<String>)`](crate::operation::describe_solution::builders::DescribeSolutionFluentBuilder::solution_arn) / [`set_solution_arn(Option<String>)`](crate::operation::describe_solution::builders::DescribeSolutionFluentBuilder::set_solution_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the solution to describe.</p><br>
