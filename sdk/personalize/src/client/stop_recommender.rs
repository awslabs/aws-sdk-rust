...
impl super::Client {
    ...
    ///   - [`recommender_arn(impl Into<String>)`](crate::operation::stop_recommender::builders::StopRecommenderFluentBuilder::recommender_arn) / [`set_recommender_arn(Option<String>)`](crate::operation::stop_recommender::builders::StopRecommenderFluentBuilder::set_recommender_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the recommender to stop.</p><br>
