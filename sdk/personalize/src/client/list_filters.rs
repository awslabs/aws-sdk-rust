...
impl super::Client {
    ...
    ///   - [`dataset_group_arn(impl ::std::convert::Into<String>)`](crate::operation::list_filters::builders::ListFiltersFluentBuilder::dataset_group_arn) / [`set_dataset_group_arn(Option<String>)`](crate::operation::list_filters::builders::ListFiltersFluentBuilder::set_dataset_group_arn): <p>The ARN of the dataset group that contains the filters.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_filters::builders::ListFiltersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_filters::builders::ListFiltersFluentBuilder::set_next_token): <p>A token returned from the previous call to <code>ListFilters</code> for getting the next set of filters (if they exist).</p>
