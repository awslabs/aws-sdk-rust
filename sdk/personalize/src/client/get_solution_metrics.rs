...
impl super::Client {
    ...
    ///   - [`solution_version_arn(impl Into<String>)`](crate::operation::get_solution_metrics::builders::GetSolutionMetricsFluentBuilder::solution_version_arn) / [`set_solution_version_arn(Option<String>)`](crate::operation::get_solution_metrics::builders::GetSolutionMetricsFluentBuilder::set_solution_version_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the solution version for which to get metrics.</p><br>
