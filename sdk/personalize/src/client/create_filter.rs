...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_filter::builders::CreateFilterFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_filter::builders::CreateFilterFluentBuilder::set_tags): <p>A list of <a href="https://docs.aws.amazon.com/personalize/latest/dg/tagging-resources.html">tags</a> to apply to the filter.</p>
