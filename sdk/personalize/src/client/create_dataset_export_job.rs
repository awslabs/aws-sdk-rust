...
impl super::Client {
    ...
    ///   - [`job_name(impl Into<String>)`](crate::operation::create_dataset_export_job::builders::CreateDatasetExportJobFluentBuilder::job_name) / [`set_job_name(Option<String>)`](crate::operation::create_dataset_export_job::builders::CreateDatasetExportJobFluentBuilder::set_job_name): <p>The name for the dataset export job.</p>
    ///   - [`dataset_arn(impl Into<String>)`](crate::operation::create_dataset_export_job::builders::CreateDatasetExportJobFluentBuilder::dataset_arn) / [`set_dataset_arn(Option<String>)`](crate::operation::create_dataset_export_job::builders::CreateDatasetExportJobFluentBuilder::set_dataset_arn): <p>The Amazon Resource Name (ARN) of the dataset that contains the data to export.</p>
