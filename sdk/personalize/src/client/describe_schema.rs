...
impl super::Client {
    ...
    ///   - [`schema_arn(impl Into<String>)`](crate::operation::describe_schema::builders::DescribeSchemaFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::describe_schema::builders::DescribeSchemaFluentBuilder::set_schema_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the schema to retrieve.</p><br>
