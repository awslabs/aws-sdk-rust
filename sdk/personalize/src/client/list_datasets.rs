...
impl super::Client {
    ...
    ///   - [`dataset_group_arn(impl Into<String>)`](crate::operation::list_datasets::builders::ListDatasetsFluentBuilder::dataset_group_arn) / [`set_dataset_group_arn(Option<String>)`](crate::operation::list_datasets::builders::ListDatasetsFluentBuilder::set_dataset_group_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the dataset group that contains the datasets to list.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_datasets::builders::ListDatasetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_datasets::builders::ListDatasetsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token returned from the previous call to <code>ListDatasets</code> for getting the next set of dataset import jobs (if they exist).</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_datasets::builders::ListDatasetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_datasets::builders::ListDatasetsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of datasets to return.</p><br>
