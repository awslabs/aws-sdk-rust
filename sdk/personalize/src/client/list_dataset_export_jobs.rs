...
impl super::Client {
    ...
    ///   - [`dataset_arn(impl ::std::convert::Into<String>)`](crate::operation::list_dataset_export_jobs::builders::ListDatasetExportJobsFluentBuilder::dataset_arn) / [`set_dataset_arn(Option<String>)`](crate::operation::list_dataset_export_jobs::builders::ListDatasetExportJobsFluentBuilder::set_dataset_arn): <p>The Amazon Resource Name (ARN) of the dataset to list the dataset export jobs for.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_dataset_export_jobs::builders::ListDatasetExportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_dataset_export_jobs::builders::ListDatasetExportJobsFluentBuilder::set_next_token): <p>A token returned from the previous call to <code>ListDatasetExportJobs</code> for getting the next set of dataset export jobs (if they exist).</p>
