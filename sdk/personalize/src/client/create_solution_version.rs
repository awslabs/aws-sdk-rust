...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_solution_version::builders::CreateSolutionVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_solution_version::builders::CreateSolutionVersionFluentBuilder::set_name): <p>The name of the solution version.</p>
    ///   - [`solution_arn(impl ::std::convert::Into<String>)`](crate::operation::create_solution_version::builders::CreateSolutionVersionFluentBuilder::solution_arn) / [`set_solution_arn(Option<String>)`](crate::operation::create_solution_version::builders::CreateSolutionVersionFluentBuilder::set_solution_arn): <p>The Amazon Resource Name (ARN) of the solution containing the training configuration information.</p>
    ...
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_solution_version::builders::CreateSolutionVersionFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_solution_version::builders::CreateSolutionVersionFluentBuilder::set_tags): <p>A list of <a href="https://docs.aws.amazon.com/personalize/latest/dev/tagging-resources.html">tags</a> to apply to the solution version.</p>
