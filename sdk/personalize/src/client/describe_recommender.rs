...
impl super::Client {
    ...
    ///   - [`recommender_arn(impl Into<String>)`](crate::operation::describe_recommender::builders::DescribeRecommenderFluentBuilder::recommender_arn) / [`set_recommender_arn(Option<String>)`](crate::operation::describe_recommender::builders::DescribeRecommenderFluentBuilder::set_recommender_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the recommender to describe.</p><br>
