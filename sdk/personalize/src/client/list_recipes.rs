...
impl super::Client {
    ...
    ///   - [`recipe_provider(RecipeProvider)`](crate::operation::list_recipes::builders::ListRecipesFluentBuilder::recipe_provider) / [`set_recipe_provider(Option<RecipeProvider>)`](crate::operation::list_recipes::builders::ListRecipesFluentBuilder::set_recipe_provider):<br>required: **false**<br><p>The default is <code>SERVICE</code>.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_recipes::builders::ListRecipesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_recipes::builders::ListRecipesFluentBuilder::set_next_token):<br>required: **false**<br><p>A token returned from the previous call to <code>ListRecipes</code> for getting the next set of recipes (if they exist).</p><br>
