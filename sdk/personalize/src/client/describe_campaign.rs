...
impl super::Client {
    ...
    ///   - [`campaign_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_campaign::builders::DescribeCampaignFluentBuilder::campaign_arn) / [`set_campaign_arn(Option<String>)`](crate::operation::describe_campaign::builders::DescribeCampaignFluentBuilder::set_campaign_arn): <p>The Amazon Resource Name (ARN) of the campaign.</p>
