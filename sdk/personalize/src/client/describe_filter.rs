...
impl super::Client {
    ...
    ///   - [`filter_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_filter::builders::DescribeFilterFluentBuilder::filter_arn) / [`set_filter_arn(Option<String>)`](crate::operation::describe_filter::builders::DescribeFilterFluentBuilder::set_filter_arn): <p>The ARN of the filter to describe.</p>
