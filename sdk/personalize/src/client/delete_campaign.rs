...
impl super::Client {
    ...
    ///   - [`campaign_arn(impl Into<String>)`](crate::operation::delete_campaign::builders::DeleteCampaignFluentBuilder::campaign_arn) / [`set_campaign_arn(Option<String>)`](crate::operation::delete_campaign::builders::DeleteCampaignFluentBuilder::set_campaign_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the campaign to delete.</p><br>
