...
impl super::Client {
    ...
    ///   - [`dataset_group_arn(impl Into<String>)`](crate::operation::describe_dataset_group::builders::DescribeDatasetGroupFluentBuilder::dataset_group_arn) / [`set_dataset_group_arn(Option<String>)`](crate::operation::describe_dataset_group::builders::DescribeDatasetGroupFluentBuilder::set_dataset_group_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the dataset group to describe.</p><br>
