...
impl super::Client {
    ...
    ///   - [`recipe_arn(impl Into<String>)`](crate::operation::describe_recipe::builders::DescribeRecipeFluentBuilder::recipe_arn) / [`set_recipe_arn(Option<String>)`](crate::operation::describe_recipe::builders::DescribeRecipeFluentBuilder::set_recipe_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the recipe to describe.</p><br>
