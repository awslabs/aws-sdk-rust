...
impl super::Client {
    ...
    ///   - [`solution_version_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_solution_version::builders::DescribeSolutionVersionFluentBuilder::solution_version_arn) / [`set_solution_version_arn(Option<String>)`](crate::operation::describe_solution_version::builders::DescribeSolutionVersionFluentBuilder::set_solution_version_arn): <p>The Amazon Resource Name (ARN) of the solution version.</p>
