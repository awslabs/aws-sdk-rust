...
impl super::Client {
    ...
    ///   - [`dataset_arn(impl Into<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::dataset_arn) / [`set_dataset_arn(Option<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::set_dataset_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the dataset to describe.</p><br>
