...
pub fn ser_list_event_trackers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEventTrackersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
