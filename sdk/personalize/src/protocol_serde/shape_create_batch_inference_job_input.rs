...
pub fn ser_create_batch_inference_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBatchInferenceJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
