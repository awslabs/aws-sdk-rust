...
pub(crate) fn de_batch_segment_job_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::BatchSegmentJobSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
