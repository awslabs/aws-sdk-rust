...
pub(crate) fn de_integer_hyper_parameter_range<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::IntegerHyperParameterRange>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
