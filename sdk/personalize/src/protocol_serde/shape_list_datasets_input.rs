...
pub fn ser_list_datasets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListDatasetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
