...
pub fn ser_update_recommender_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRecommenderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
