...
pub(crate) fn de_continuous_hyper_parameter_range<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ContinuousHyperParameterRange>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
