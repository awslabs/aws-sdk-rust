...
pub(crate) fn de_solution_versions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::SolutionVersionSummary>>, aws_smithy_json::deserialize::error::DeserializeError>
