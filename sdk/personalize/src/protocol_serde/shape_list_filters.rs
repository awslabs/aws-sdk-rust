...
> {
    ...
    Err(match error_code {
        "InvalidInputException" => {
            crate::operation::list_filters::ListFiltersError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_input_exception::de_invalid_input_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_filters::ListFiltersError::unhandled)?;
        ...
        "InvalidNextTokenException" => {
            crate::operation::list_filters::ListFiltersError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_filters::ListFiltersError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        match tokens.next().transpose()? {
            ...
            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "Filters" => {
                        builder = builder
                            .set_filters(crate::protocol_serde::shape_filters::de_filters(tokens)?);
                    }
                    "nextToken" => {
