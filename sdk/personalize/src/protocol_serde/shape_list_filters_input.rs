...
pub fn ser_list_filters_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFiltersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
