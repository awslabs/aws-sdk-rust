...
pub(crate) fn de_solution_version_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::SolutionVersionSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
