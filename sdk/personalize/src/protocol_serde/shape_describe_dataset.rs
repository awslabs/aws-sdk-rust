        ...
        "InvalidInputException" => {
            crate::operation::describe_dataset::DescribeDatasetError::InvalidInputException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_invalid_input_exception::de_invalid_input_exception_json_err(_response_body, output).map_err(crate::operation::describe_dataset::DescribeDatasetError::unhandled)?;
