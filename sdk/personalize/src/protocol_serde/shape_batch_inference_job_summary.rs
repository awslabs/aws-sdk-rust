...
pub(crate) fn de_batch_inference_job_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::BatchInferenceJobSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
