...
pub(crate) fn de_dataset_schema<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::DatasetSchema>, aws_smithy_json::deserialize::error::DeserializeError>
