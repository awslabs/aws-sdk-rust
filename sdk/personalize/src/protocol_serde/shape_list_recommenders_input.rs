...
pub fn ser_list_recommenders_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRecommendersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
