...
pub fn ser_list_recipes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRecipesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
