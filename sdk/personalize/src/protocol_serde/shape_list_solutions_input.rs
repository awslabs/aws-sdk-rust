...
pub fn ser_list_solutions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSolutionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
