...
pub(crate) fn de_recommender_update_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::RecommenderUpdateSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
