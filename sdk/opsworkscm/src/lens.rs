...
pub(crate) fn reflens_describe_servers_output_next_token(
...
pub(crate) fn lens_describe_backups_output_backups(
    input: crate::operation::describe_backups::DescribeBackupsOutput,
...
pub(crate) fn lens_describe_events_output_server_events(
    input: crate::operation::describe_events::DescribeEventsOutput,
...
pub(crate) fn lens_describe_servers_output_servers(
    input: crate::operation::describe_servers::DescribeServersOutput,
