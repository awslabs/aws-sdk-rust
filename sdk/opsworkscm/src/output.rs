...
pub struct UpdateServerEngineAttributesOutput  {
    ...
    #[doc(hidden)]pub server: std::option::Option<crate::model::Server>,
}
...
pub struct ExportServerEngineAttributeOutput  {
    ...
    #[doc(hidden)]pub engine_attribute: std::option::Option<crate::model::EngineAttribute>,
...
pub struct DescribeServersOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub servers: std::option::Option<std::vec::Vec<crate::model::Server>>,
...
pub struct DescribeNodeAssociationStatusOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub node_association_status: std::option::Option<crate::model::NodeAssociationStatus>,
...
pub struct DescribeEventsOutput  {
    ...
    #[doc(hidden)]pub server_events: std::option::Option<std::vec::Vec<crate::model::ServerEvent>>,
...
pub struct DescribeAccountAttributesOutput  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<std::vec::Vec<crate::model::AccountAttribute>>,
}
