    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AssociateNodeInput`](crate::input::AssociateNodeInput) with field(s):
    ///   - [`server_name(Option<String>)`](crate::input::AssociateNodeInput::server_name): <p>The name of the server with which to associate the node. </p>
    ///   - [`node_name(Option<String>)`](crate::input::AssociateNodeInput::node_name): <p>The name of the node. </p>
    ///   - [`engine_attributes(Option<Vec<EngineAttribute>>)`](crate::input::AssociateNodeInput::engine_attributes): <p>Engine attributes used for associating the node. </p>  <p class="title"> <b>Attributes accepted in a AssociateNode request for Chef</b> </p>  <ul>   <li> <p> <code>CHEF_ORGANIZATION</code>: The Chef organization with which the node is associated. By default only one organization named <code>default</code> can exist. </p> </li>   <li> <p> <code>CHEF_NODE_PUBLIC_KEY</code>: A PEM-formatted public key. This key is required for the <code>chef-client</code> agent to access the Chef API. </p> </li>  </ul>  <p class="title"> <b>Attributes accepted in a AssociateNode request for Puppet</b> </p>  <ul>   <li> <p> <code>PUPPET_NODE_CSR</code>: A PEM-formatted certificate-signing request (CSR) that is created by the node. </p> </li>  </ul>
    ...
    ///   - [`backup_id(Option<String>)`](crate::input::DeleteBackupInput::backup_id): <p>The ID of the backup to delete. Run the DescribeBackups command to get a list of backup IDs. Backup IDs are in the format <code>ServerName-yyyyMMddHHmmssSSS</code>. </p>
    ...
    ///   - [`server_name(Option<String>)`](crate::input::DeleteServerInput::server_name): <p>The ID of the server to delete.</p>
    ...
    ///
    /// - Takes [`DescribeBackupsInput`](crate::input::DescribeBackupsInput) with field(s):
    ///   - [`backup_id(Option<String>)`](crate::input::DescribeBackupsInput::backup_id): <p>Describes a single backup. </p>
    ///   - [`server_name(Option<String>)`](crate::input::DescribeBackupsInput::server_name): <p>Returns backups for the server with the specified ServerName. </p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeBackupsInput::next_token): <p>This is not currently implemented for <code>DescribeBackups</code> requests.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeBackupsInput::max_results): <p>This is not currently implemented for <code>DescribeBackups</code> requests.</p>
    ...
    ///   - [`server_name(Option<String>)`](crate::input::DescribeEventsInput::server_name): <p>The name of the server for which you want to view events.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeEventsInput::next_token): <p>NextToken is a string that is returned in some command responses. It indicates that not all entries have been returned, and that you must run at least one more request to get remaining items. To get remaining results, call <code>DescribeEvents</code> again, and assign the token from the previous results as the value of the <code>nextToken</code> parameter. If there are no more results, the response object's <code>nextToken</code> parameter value is <code>null</code>. Setting a <code>nextToken</code> value that was not returned in your previous results causes an <code>InvalidNextTokenException</code> to occur. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeEventsInput::max_results): <p>To receive a paginated response, use this parameter to specify the maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results. </p>
    ...
    ///
    /// - Takes [`DescribeNodeAssociationStatusInput`](crate::input::DescribeNodeAssociationStatusInput) with field(s):
    ///   - [`node_association_status_token(Option<String>)`](crate::input::DescribeNodeAssociationStatusInput::node_association_status_token): <p>The token returned in either the AssociateNodeResponse or the DisassociateNodeResponse. </p>
    ///   - [`server_name(Option<String>)`](crate::input::DescribeNodeAssociationStatusInput::server_name): <p>The name of the server from which to disassociate the node. </p>
    ...
    ///
    /// - Takes [`DescribeServersInput`](crate::input::DescribeServersInput) with field(s):
    ///   - [`server_name(Option<String>)`](crate::input::DescribeServersInput::server_name): <p>Describes the server with the specified ServerName.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeServersInput::next_token): <p>This is not currently implemented for <code>DescribeServers</code> requests. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeServersInput::max_results): <p>This is not currently implemented for <code>DescribeServers</code> requests. </p>
    ...
    ///
    /// - Takes [`DisassociateNodeInput`](crate::input::DisassociateNodeInput) with field(s):
    ///   - [`server_name(Option<String>)`](crate::input::DisassociateNodeInput::server_name): <p>The name of the server from which to disassociate the node. </p>
    ///   - [`node_name(Option<String>)`](crate::input::DisassociateNodeInput::node_name): <p>The name of the client node. </p>
    ///   - [`engine_attributes(Option<Vec<EngineAttribute>>)`](crate::input::DisassociateNodeInput::engine_attributes): <p>Engine attributes that are used for disassociating the node. No attributes are required for Puppet. </p>  <p class="title"> <b>Attributes required in a DisassociateNode request for Chef</b> </p>  <ul>   <li> <p> <code>CHEF_ORGANIZATION</code>: The Chef organization with which the node was associated. By default only one organization named <code>default</code> can exist. </p> </li>  </ul>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The Amazon Resource Number (ARN) of an AWS OpsWorks for Chef Automate or AWS OpsWorks for Puppet Enterprise server for which you want to show applied tags. For example, <code>arn:aws:opsworks-cm:us-west-2:123456789012:server/test-owcm-server/EXAMPLE-66b0-4196-8274-d1a2bEXAMPLE</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTagsForResourceInput::next_token): <p>NextToken is a string that is returned in some command responses. It indicates that not all entries have been returned, and that you must run at least one more request to get remaining items. To get remaining results, call <code>ListTagsForResource</code> again, and assign the token from the previous results as the value of the <code>nextToken</code> parameter. If there are no more results, the response object's <code>nextToken</code> parameter value is <code>null</code>. Setting a <code>nextToken</code> value that was not returned in your previous results causes an <code>InvalidNextTokenException</code> to occur.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTagsForResourceInput::max_results): <p>To receive a paginated response, use this parameter to specify the maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ...
    ///
    /// - Takes [`RestoreServerInput`](crate::input::RestoreServerInput) with field(s):
    ///   - [`backup_id(Option<String>)`](crate::input::RestoreServerInput::backup_id): <p> The ID of the backup that you want to use to restore a server. </p>
    ///   - [`server_name(Option<String>)`](crate::input::RestoreServerInput::server_name): <p> The name of the server that you want to restore. </p>
    ///   - [`instance_type(Option<String>)`](crate::input::RestoreServerInput::instance_type): <p> The type of instance to restore. Valid values must be specified in the following format: <code>^([cm][34]|t2).*</code> For example, <code>m5.large</code>. Valid values are <code>m5.large</code>, <code>r5.xlarge</code>, and <code>r5.2xlarge</code>. If you do not specify this parameter, RestoreServer uses the instance type from the specified backup. </p>
    ///   - [`key_pair(Option<String>)`](crate::input::RestoreServerInput::key_pair): <p> The name of the key pair to set on the new EC2 instance. This can be helpful if the administrator no longer has the SSH key. </p>
    ...
    ///
    /// - Takes [`StartMaintenanceInput`](crate::input::StartMaintenanceInput) with field(s):
    ///   - [`server_name(Option<String>)`](crate::input::StartMaintenanceInput::server_name): <p>The name of the server on which to run maintenance. </p>
    ///   - [`engine_attributes(Option<Vec<EngineAttribute>>)`](crate::input::StartMaintenanceInput::engine_attributes): <p>Engine attributes that are specific to the server on which you want to run maintenance.</p>  <p class="title"> <b>Attributes accepted in a StartMaintenance request for Chef</b> </p>  <ul>   <li> <p> <code>CHEF_MAJOR_UPGRADE</code>: If a Chef Automate server is eligible for upgrade to Chef Automate 2, add this engine attribute to a <code>StartMaintenance</code> request and set the value to <code>true</code> to upgrade the server to Chef Automate 2. For more information, see <a href="https://docs.aws.amazon.com/opsworks/latest/userguide/opscm-a2upgrade.html">Upgrade an AWS OpsWorks for Chef Automate Server to Chef Automate 2</a>. </p> </li>  </ul>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Number (ARN) of a resource to which you want to apply tags. For example, <code>arn:aws:opsworks-cm:us-west-2:123456789012:server/test-owcm-server/EXAMPLE-66b0-4196-8274-d1a2bEXAMPLE</code>.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The Amazon Resource Number (ARN) of a resource from which you want to remove tags. For example, <code>arn:aws:opsworks-cm:us-west-2:123456789012:server/test-owcm-server/EXAMPLE-66b0-4196-8274-d1a2bEXAMPLE</code>.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>The keys of tags that you want to remove.</p>
    ...
    ///   - [`disable_automated_backup(Option<bool>)`](crate::input::UpdateServerInput::disable_automated_backup): <p>Setting DisableAutomatedBackup to <code>true</code> disables automated or scheduled backups. Automated backups are enabled by default. </p>
    ///   - [`backup_retention_count(Option<i32>)`](crate::input::UpdateServerInput::backup_retention_count): <p>Sets the number of automated backups that you want to keep. </p>
    ///   - [`server_name(Option<String>)`](crate::input::UpdateServerInput::server_name): <p>The name of the server to update. </p>
    ///   - [`preferred_maintenance_window(Option<String>)`](crate::input::UpdateServerInput::preferred_maintenance_window): <p> <code>DDD:HH:MM</code> (weekly start time) or <code>HH:MM</code> (daily start time). </p>  <p> Time windows always use coordinated universal time (UTC). Valid strings for day of week (<code>DDD</code>) are: <code>Mon</code>, <code>Tue</code>, <code>Wed</code>, <code>Thr</code>, <code>Fri</code>, <code>Sat</code>, or <code>Sun</code>.</p>
    ///   - [`preferred_backup_window(Option<String>)`](crate::input::UpdateServerInput::preferred_backup_window): <p> <code>DDD:HH:MM</code> (weekly start time) or <code>HH:MM</code> (daily start time). </p>  <p> Time windows always use coordinated universal time (UTC). Valid strings for day of week (<code>DDD</code>) are: <code>Mon</code>, <code>Tue</code>, <code>Wed</code>, <code>Thr</code>, <code>Fri</code>, <code>Sat</code>, or <code>Sun</code>.</p>
    ...
    ///
    /// - Takes [`UpdateServerEngineAttributesInput`](crate::input::UpdateServerEngineAttributesInput) with field(s):
    ///   - [`server_name(Option<String>)`](crate::input::UpdateServerEngineAttributesInput::server_name): <p>The name of the server to update. </p>
    ///   - [`attribute_name(Option<String>)`](crate::input::UpdateServerEngineAttributesInput::attribute_name): <p>The name of the engine attribute to update. </p>
    ///   - [`attribute_value(Option<String>)`](crate::input::UpdateServerEngineAttributesInput::attribute_value): <p>The value to set for the attribute. </p>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeBackupsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeServersPaginator<C, M, R> {
