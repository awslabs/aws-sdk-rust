...
mod test {
    ...
    fn test_1() {
        ...
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.eu-central-1.api.aws");
        assert_eq!(
            endpoint,
    ...
    fn test_2() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.eu-central-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_3() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.eu-central-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_4() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm.eu-central-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_5() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm-fips.us-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_6() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.us-west-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_7() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_8() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-west-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_9() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm-fips.us-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_10() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.us-west-2.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_11() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_12() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-west-2.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_13() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm-fips.eu-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_14() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.eu-west-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_15() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.eu-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_16() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.eu-west-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_17() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.ap-northeast-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_18() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://opsworks-cm-fips.ap-northeast-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_19() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.ap-northeast-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_20() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm.ap-northeast-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_21() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.ap-southeast-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_22() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://opsworks-cm-fips.ap-southeast-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_23() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.ap-southeast-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_24() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm.ap-southeast-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_25() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.ap-southeast-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_26() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://opsworks-cm-fips.ap-southeast-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_27() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.ap-southeast-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_28() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm.ap-southeast-2.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_29() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm-fips.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_30() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.us-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_31() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_32() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_33() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm-fips.us-east-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_34() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://opsworks-cm-fips.us-east-2.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_35() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-east-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_36() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://opsworks-cm.us-east-2.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
