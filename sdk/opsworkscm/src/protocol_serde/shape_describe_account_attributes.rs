...
pub fn ser_describe_account_attributes_input(
    _input: &crate::operation::describe_account_attributes::DescribeAccountAttributesInput,
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_account_attributes::DescribeAccountAttributesError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::describe_account_attributes::DescribeAccountAttributesError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_account_attributes_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_account_attributes::de_describe_account_attributes(_response_body, output)
            .map_err(crate::operation::describe_account_attributes::DescribeAccountAttributesError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Attributes" => {
                    builder = builder.set_attributes(crate::protocol_serde::shape_account_attributes::de_account_attributes(tokens)?);
                }
