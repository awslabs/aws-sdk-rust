...
pub fn ser_describe_backups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeBackupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
