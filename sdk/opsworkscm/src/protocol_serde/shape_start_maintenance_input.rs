...
pub fn ser_start_maintenance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartMaintenanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
