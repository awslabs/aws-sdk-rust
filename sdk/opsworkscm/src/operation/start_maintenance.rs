...
impl StartMaintenanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_maintenance::StartMaintenance, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_maintenance::ser_start_maintenance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMaintenance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_maintenance::de_start_maintenance_http_response_with_props(status, headers, body)
        }
    }
