...
impl UpdateServerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_server::UpdateServer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_server::de_update_server_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_server::de_update_server_http_response_with_props(
                status, headers, body,
            )
        }
    }
