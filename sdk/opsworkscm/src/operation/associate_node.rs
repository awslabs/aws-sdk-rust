...
impl AssociateNodeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_node::AssociateNode, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_node::ser_associate_node_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_node::de_associate_node_http_response_with_props(status, headers, body)
        }
    }
}
