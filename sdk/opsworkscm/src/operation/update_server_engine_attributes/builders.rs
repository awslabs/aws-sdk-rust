...
impl UpdateServerEngineAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_server_engine_attributes::UpdateServerEngineAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_server_engine_attributes::UpdateServerEngineAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_server_engine_attributes::UpdateServerEngineAttributesOutput, crate::operation::update_server_engine_attributes::UpdateServerEngineAttributesError, Self> {
