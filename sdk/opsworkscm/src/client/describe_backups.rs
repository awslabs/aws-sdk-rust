...
impl super::Client {
    ...
    ///   - [`backup_id(impl Into<String>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::backup_id) / [`set_backup_id(Option<String>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::set_backup_id):<br>required: **false**<br><p>Describes a single backup.</p><br>
    ///   - [`server_name(impl Into<String>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::server_name) / [`set_server_name(Option<String>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::set_server_name):<br>required: **false**<br><p>Returns backups for the server with the specified ServerName.</p><br>
