...
impl super::Client {
    ...
    ///   - [`server_name(impl Into<String>)`](crate::operation::delete_server::builders::DeleteServerFluentBuilder::server_name) / [`set_server_name(Option<String>)`](crate::operation::delete_server::builders::DeleteServerFluentBuilder::set_server_name):<br>required: **true**<br><p>The ID of the server to delete.</p><br>
