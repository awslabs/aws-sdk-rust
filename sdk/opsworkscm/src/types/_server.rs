...
pub struct Server {
    ...
    /// <p>The response of a createServer() request returns the master credential to access the server in EngineAttributes. These credentials are not stored by OpsWorks CM; they are returned only as part of the result of createServer().</p>
    /// <p class="title"><b>Attributes returned in a createServer response for Chef</b></p>
    /// <ul>
    /// <li>
    /// <p><code>CHEF_AUTOMATE_PIVOTAL_KEY</code>: A base64-encoded RSA private key that is generated by OpsWorks for Chef Automate. This private key is required to access the Chef API.</p></li>
    /// <li>
