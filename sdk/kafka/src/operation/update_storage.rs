...
impl UpdateStorageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_storage::UpdateStorage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_storage::de_update_storage_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_storage::de_update_storage_http_response_with_props(
                status, headers, body,
            )
        }
    }
