...
impl UpdateConnectivityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_connectivity::UpdateConnectivity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectivity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_connectivity::de_update_connectivity_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_connectivity::UpdateConnectivityError
{
