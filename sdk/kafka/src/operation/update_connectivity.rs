...
impl UpdateConnectivityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_connectivity::UpdateConnectivity,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_connectivity::ser_update_connectivity_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectivity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_connectivity::de_update_connectivity_http_response_with_props(status, headers, body)
        }
    }
}
