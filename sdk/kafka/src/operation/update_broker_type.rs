...
impl UpdateBrokerTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_broker_type::UpdateBrokerType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBrokerType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_broker_type::de_update_broker_type_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_broker_type::UpdateBrokerTypeError
{
