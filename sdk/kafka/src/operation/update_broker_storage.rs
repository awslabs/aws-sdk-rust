...
impl UpdateBrokerStorageInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_broker_storage::ser_update_broker_storage_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_broker_storage::UpdateBrokerStorage::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBrokerStorage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_broker_storage::de_update_broker_storage_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::update_broker_storage::UpdateBrokerStorageError
{
