...
impl CreateVpcConnectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateVpcConnection`](crate::operation::create_vpc_connection::CreateVpcConnection)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpc_connection::CreateVpcConnection::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVpcConnection", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vpc_connection::de_create_vpc_connection_http_response_with_props(status, headers, body)
        }
    }
}
