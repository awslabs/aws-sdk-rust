...
impl ListScramSecretsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_scram_secrets::ListScramSecrets,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListScramSecrets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_scram_secrets::de_list_scram_secrets_http_response_with_props(status, headers, body)
        }
    }
}
