...
impl ListScramSecretsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_scram_secrets::ListScramSecrets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListScramSecrets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_scram_secrets::de_list_scram_secrets_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_scram_secrets::ListScramSecretsError
{
