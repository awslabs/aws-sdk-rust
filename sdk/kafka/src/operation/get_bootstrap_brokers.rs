...
impl GetBootstrapBrokersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bootstrap_brokers::GetBootstrapBrokers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBootstrapBrokers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_bootstrap_brokers::de_get_bootstrap_brokers_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_bootstrap_brokers::GetBootstrapBrokersError
{
