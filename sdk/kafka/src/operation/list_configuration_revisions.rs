...
impl ListConfigurationRevisionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_configuration_revisions::ListConfigurationRevisions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListConfigurationRevisions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_configuration_revisions::de_list_configuration_revisions_http_response_with_props(status, headers, body)
        }
    }
}
