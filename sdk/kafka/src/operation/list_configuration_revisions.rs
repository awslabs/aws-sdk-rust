    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/configurations/{Arn}/revisions", Arn = arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_configuration_revisions::ListConfigurationRevisions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_configuration_revisions::ListConfigurationRevisionsError
{
