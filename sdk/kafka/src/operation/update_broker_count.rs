...
impl UpdateBrokerCountInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_broker_count::UpdateBrokerCount::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBrokerCount {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_broker_count::de_update_broker_count_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_broker_count::de_update_broker_count_http_response(
                status, headers, body,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::update_broker_count::UpdateBrokerCountError
{
