...
impl CreateClusterV2Input {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_cluster_v2::CreateClusterV2::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClusterV2 {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_cluster_v2::de_create_cluster_v2_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_cluster_v2::CreateClusterV2Error
{
