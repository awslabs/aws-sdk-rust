...
impl CreateClusterV2Input {
    /// Consumes the builder and constructs an Operation<[`CreateClusterV2`](crate::operation::create_cluster_v2::CreateClusterV2)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_cluster_v2::CreateClusterV2, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_cluster_v2::ser_create_cluster_v2_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cluster_v2::CreateClusterV2::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateClusterV2", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClusterV2 {
    type Output =
        ::std::result::Result<crate::operation::create_cluster_v2::CreateClusterV2Output, crate::operation::create_cluster_v2::CreateClusterV2Error>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cluster_v2::de_create_cluster_v2_http_response_with_props(status, headers, body)
        }
    }
}
