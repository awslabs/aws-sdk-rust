    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_client_vpc_connections::ListClientVpcConnectionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_client_vpc_connections::ListClientVpcConnectionsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListClientVpcConnectionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListClientVpcConnectionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_client_vpc_connections::ListClientVpcConnectionsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListClientVpcConnectionsEndpointParamsInterceptor {
...
pub type ListClientVpcConnectionsErrorKind = ListClientVpcConnectionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListClientVpcConnectionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_client_vpc_connections::ListClientVpcConnectionsError {
...
impl ListClientVpcConnectionsError {
    ...
    /// Creates the `ListClientVpcConnectionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
