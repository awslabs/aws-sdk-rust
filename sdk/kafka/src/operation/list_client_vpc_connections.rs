...
impl ListClientVpcConnectionsInput {
    /// Consumes the builder and constructs an Operation<[`ListClientVpcConnections`](crate::operation::list_client_vpc_connections::ListClientVpcConnections)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_client_vpc_connections::ListClientVpcConnections::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("ListClientVpcConnections", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListClientVpcConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_client_vpc_connections::de_list_client_vpc_connections_http_response_with_props(status, headers, body)
        }
    }
}
