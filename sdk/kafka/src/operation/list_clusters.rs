...
impl ListClusters {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kafka", "ListClusters", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListClusters {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListClusters", "Kafka"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListClustersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ClusterNameFilter") {
            if let ::std::option::Option::Some(value) = input.cluster_name_filter.as_deref() {
                captured.insert("ClusterNameFilter", value);
            }
        }
