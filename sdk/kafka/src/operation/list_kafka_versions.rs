...
impl ListKafkaVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_kafka_versions::ListKafkaVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListKafkaVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_kafka_versions::de_list_kafka_versions_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_kafka_versions::ListKafkaVersionsError
{
