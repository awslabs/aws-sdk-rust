...
impl DescribeConfigurationRevisionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_configuration_revision::DescribeConfigurationRevision::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationRevision {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_revision::de_describe_configuration_revision_http_response_with_props(
                status, headers, body,
            )
        }
    }
