...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationRevision {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_revision::de_describe_configuration_revision_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeConfigurationRevisionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_configuration_revision::DescribeConfigurationRevisionError
{
