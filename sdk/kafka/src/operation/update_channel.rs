...
impl UpdateChannel {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kafka", "UpdateChannel", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateChannel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateChannel", "Kafka"));
...
impl UpdateChannelError {
    ...
    /// Returns `true` if the error kind is `UpdateChannelError::UnauthorizedException`.
