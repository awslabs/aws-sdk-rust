    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateReplicator")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreateReplicatorEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateReplicatorResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateReplicatorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_replicator::ser_create_replicator_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateReplicatorEndpointParamsInterceptor {
...
pub type CreateReplicatorErrorKind = CreateReplicatorError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateReplicatorError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_replicator::CreateReplicatorError {
...
impl CreateReplicatorError {
    ...
    /// Creates the `CreateReplicatorError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
