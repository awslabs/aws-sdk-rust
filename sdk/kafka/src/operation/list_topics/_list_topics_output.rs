...
pub struct ListTopicsOutput {
    ...
    pub topics: ::std::option::Option<::std::vec::Vec<crate::types::TopicInfo>>,
...
impl ListTopicsOutput {
    ...
    pub fn topics(&self) -> &[crate::types::TopicInfo] {
...
pub struct ListTopicsOutputBuilder {
    pub(crate) topics: ::std::option::Option<::std::vec::Vec<crate::types::TopicInfo>>,
...
impl ListTopicsOutputBuilder {
    ...
    ///
    /// <p>List containing topics info.</p>
    pub fn topics(mut self, input: crate::types::TopicInfo) -> Self {
    ...
    /// <p>List containing topics info.</p>
    pub fn set_topics(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::TopicInfo>>) -> Self {
        self.topics = input;
        self
    }
    /// <p>List containing topics info.</p>
    pub fn get_topics(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::TopicInfo>> {
        &self.topics
    }
    /// <p>The paginated results marker. When the result of a ListTopics operation is truncated, the call returns NextToken in the response. To get another batch of configurations, provide this token in your next request.</p>
