...
impl CreateChannel {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kafka", "CreateChannel", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateChannel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateChannel", "Kafka"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v1/clusters/{ClusterArn}/channels", ClusterArn = cluster_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl CreateChannelError {
    ...
    /// Returns `true` if the error kind is `CreateChannelError::UnauthorizedException`.
