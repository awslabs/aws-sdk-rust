...
impl DescribeClusterV2Input {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_cluster_v2::DescribeClusterV2,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterV2 {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cluster_v2::de_describe_cluster_v2_http_response_with_props(status, headers, body)
        }
    }
}
