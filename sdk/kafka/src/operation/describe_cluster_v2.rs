...
impl DescribeClusterV2Input {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cluster_v2::DescribeClusterV2::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterV2 {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_cluster_v2::de_describe_cluster_v2_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_cluster_v2::DescribeClusterV2Error
{
