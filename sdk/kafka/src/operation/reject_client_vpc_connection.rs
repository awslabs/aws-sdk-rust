...
impl RejectClientVpcConnectionInput {
    /// Consumes the builder and constructs an Operation<[`RejectClientVpcConnection`](crate::operation::reject_client_vpc_connection::RejectClientVpcConnection)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reject_client_vpc_connection::ser_reject_client_vpc_connection_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::reject_client_vpc_connection::RejectClientVpcConnection::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("RejectClientVpcConnection", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectClientVpcConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_client_vpc_connection::de_reject_client_vpc_connection_http_response_with_props(status, headers, body)
        }
    }
}
