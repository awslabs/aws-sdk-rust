    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reject_client_vpc_connection::RejectClientVpcConnectionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reject_client_vpc_connection::RejectClientVpcConnectionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectClientVpcConnection {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RejectClientVpcConnection", "kafka"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RejectClientVpcConnection")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RejectClientVpcConnectionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RejectClientVpcConnectionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reject_client_vpc_connection::RejectClientVpcConnectionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RejectClientVpcConnectionEndpointParamsInterceptor {
...
pub type RejectClientVpcConnectionErrorKind = RejectClientVpcConnectionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for RejectClientVpcConnectionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reject_client_vpc_connection::RejectClientVpcConnectionError {
...
impl RejectClientVpcConnectionError {
    ...
    /// Creates the `RejectClientVpcConnectionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
