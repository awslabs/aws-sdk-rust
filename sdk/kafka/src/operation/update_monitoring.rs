...
impl UpdateMonitoringInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_monitoring::UpdateMonitoring, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_monitoring::ser_update_monitoring_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMonitoring {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_monitoring::de_update_monitoring_http_response_with_props(status, headers, body)
        }
    }
}
