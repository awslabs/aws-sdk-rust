...
impl UpdateConfigurationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_configuration::ser_update_configuration_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_configuration::de_update_configuration_http_response_with_props(status, headers, body)
        }
    }
}
