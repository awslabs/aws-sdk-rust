...
impl UpdateSecurityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_security::UpdateSecurity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_security::ser_update_security_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSecurity {
    type Output =
        ::std::result::Result<crate::operation::update_security::UpdateSecurityOutput, crate::operation::update_security::UpdateSecurityError>;
