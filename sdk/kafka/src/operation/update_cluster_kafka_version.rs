...
impl UpdateClusterKafkaVersionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_cluster_kafka_version::UpdateClusterKafkaVersion::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_cluster_kafka_version::UpdateClusterKafkaVersionError
{
