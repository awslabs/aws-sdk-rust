    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_disassociate_scram_secret::BatchDisassociateScramSecretError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_disassociate_scram_secret::BatchDisassociateScramSecretOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDisassociateScramSecret {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("BatchDisassociateScramSecret", "kafka"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchDisassociateScramSecretResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchDisassociateScramSecretRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_disassociate_scram_secret::BatchDisassociateScramSecretInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchDisassociateScramSecretEndpointParamsInterceptor {
