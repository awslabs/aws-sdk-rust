...
impl CreateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kafka", "CreateCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateCluster", "Kafka"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("KafkaVersion") {
            if let ::std::option::Option::Some(value) = input.kafka_version.as_deref() {
                captured.insert("KafkaVersion", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v1/clusters").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
