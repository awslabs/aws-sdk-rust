...
impl UpdateClusterConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_cluster_configuration::UpdateClusterConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateClusterConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_cluster_configuration::de_update_cluster_configuration_http_response_with_props(status, headers, body)
        }
    }
}
