...
impl GetClusterPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetClusterPolicy`](crate::operation::get_cluster_policy::GetClusterPolicy)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cluster_policy::GetClusterPolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetClusterPolicy", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClusterPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cluster_policy::de_get_cluster_policy_http_response_with_props(status, headers, body)
        }
    }
}
