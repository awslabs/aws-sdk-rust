...
impl ListClusterOperationsV2FluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_cluster_operations_v2::ListClusterOperationsV2Error>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_cluster_operations_v2::paginator::ListClusterOperationsV2Paginator::send) which returns a `Stream`.
