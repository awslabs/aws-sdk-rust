...
impl DeleteClusterPolicyInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_cluster_policy::DeleteClusterPolicy::new(),
        )
...
/// `ParseStrictResponse` impl for `DeleteClusterPolicy`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteClusterPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_cluster_policy::de_delete_cluster_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_cluster_policy::DeleteClusterPolicyError
{
