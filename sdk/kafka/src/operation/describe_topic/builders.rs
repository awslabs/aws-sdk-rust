...
pub use crate::operation::describe_topic::_describe_topic_output::DescribeTopicOutputBuilder;

pub use crate::operation::describe_topic::_describe_topic_input::DescribeTopicInputBuilder;

impl crate::operation::describe_topic::builders::DescribeTopicInputBuilder {
...
pub struct DescribeTopicFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_topic::builders::DescribeTopicInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::describe_topic::DescribeTopicOutput,
        crate::operation::describe_topic::DescribeTopicError,
    > for DescribeTopicFluentBuilder
{
    fn send(
        self,
...
impl DescribeTopicFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::describe_topic::builders::DescribeTopicInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::describe_topic::DescribeTopic::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::describe_topic::DescribeTopic::orchestrate(&runtime_plugins, input).await
    }
