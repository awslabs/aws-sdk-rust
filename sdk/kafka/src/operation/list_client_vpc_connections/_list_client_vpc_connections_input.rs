...
impl ListClientVpcConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_client_vpc_connections::ListClientVpcConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
