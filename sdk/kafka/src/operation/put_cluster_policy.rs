...
impl PutClusterPolicy {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_cluster_policy::PutClusterPolicyError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_cluster_policy::PutClusterPolicyOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("kafka", "PutClusterPolicy", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutClusterPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutClusterPolicy", "kafka"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutClusterPolicy")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(PutClusterPolicyEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutClusterPolicyResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutClusterPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_cluster_policy::PutClusterPolicyInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_cluster_policy::ser_put_cluster_policy_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutClusterPolicyEndpointParamsInterceptor {
...
pub type PutClusterPolicyErrorKind = PutClusterPolicyError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for PutClusterPolicyError {
...
impl ::aws_http::request_id::RequestId for crate::operation::put_cluster_policy::PutClusterPolicyError {
...
impl PutClusterPolicyError {
    ...
    /// Creates the `PutClusterPolicyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
