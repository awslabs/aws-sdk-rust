...
impl PutClusterPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutClusterPolicy`](crate::operation::put_cluster_policy::PutClusterPolicy)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_cluster_policy::ser_put_cluster_policy_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_cluster_policy::PutClusterPolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutClusterPolicy", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutClusterPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_cluster_policy::de_put_cluster_policy_http_response_with_props(status, headers, body)
        }
    }
}
