...
) -> Result<Option<crate::types::ClusterInfo>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "loggingInfo" => {
                                builder = builder.set_logging_info(
                                    crate::protocol_serde::shape_logging_info::de_logging_info(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "storageMode" => {
                                builder = builder.set_storage_mode(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::StorageMode::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
