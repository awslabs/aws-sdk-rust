...
pub(crate) fn de_list_of_configuration_revision<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::ConfigurationRevision>>, ::aws_smithy_json::deserialize::error::DeserializeError>
