...
pub fn ser_ebs_storage_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EbsStorageInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_ebs_storage_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EbsStorageInfo>, aws_smithy_json::deserialize::error::DeserializeError>
