...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_configuration::de_delete_configuration(_response_body, output)
            .map_err(crate::operation::delete_configuration::DeleteConfigurationError::unhandled)?;
...
) -> Result<crate::operation::delete_configuration::builders::DeleteConfigurationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
