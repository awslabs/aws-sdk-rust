...
pub fn ser_provisioned_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ProvisionedRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
