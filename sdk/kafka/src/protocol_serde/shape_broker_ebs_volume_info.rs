...
pub fn ser_broker_ebs_volume_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BrokerEbsVolumeInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_broker_ebs_volume_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BrokerEbsVolumeInfo>, aws_smithy_json::deserialize::error::DeserializeError>
