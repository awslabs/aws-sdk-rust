...
pub(crate) fn de_cluster_operation_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ClusterOperationInfo>, aws_smithy_json::deserialize::error::DeserializeError>
