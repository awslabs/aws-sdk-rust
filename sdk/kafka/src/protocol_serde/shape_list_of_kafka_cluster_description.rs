...
pub(crate) fn de_list_of_kafka_cluster_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::KafkaClusterDescription>>, ::aws_smithy_json::deserialize::error::DeserializeError>
