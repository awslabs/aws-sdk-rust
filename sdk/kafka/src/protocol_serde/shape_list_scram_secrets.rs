...
pub fn de_list_scram_secrets_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_scram_secrets::ListScramSecretsOutput, crate::operation::list_scram_secrets::ListScramSecretsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_scram_secrets::ListScramSecretsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_scram_secrets_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_scram_secrets::ListScramSecretsOutput, crate::operation::list_scram_secrets::ListScramSecretsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_scram_secrets::builders::ListScramSecretsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_scram_secrets::de_list_scram_secrets(response.body().as_ref(), output).map_err(crate::operation::list_scram_secrets::ListScramSecretsError::unhandled)?;
