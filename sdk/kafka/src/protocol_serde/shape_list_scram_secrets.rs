...
pub fn de_list_scram_secrets_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_scram_secrets::ListScramSecretsOutput, crate::operation::list_scram_secrets::ListScramSecretsError> {
    #[allow(unused_mut)]
...
pub fn de_list_scram_secrets_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_list_scram_secrets::de_list_scram_secrets(_response_body, output)
            .map_err(crate::operation::list_scram_secrets::ListScramSecretsError::unhandled)?;
...
) -> Result<crate::operation::list_scram_secrets::builders::ListScramSecretsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
