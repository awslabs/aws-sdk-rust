            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "jmxExporter" => {
                            builder = builder.set_jmx_exporter(crate::protocol_serde::shape_jmx_exporter_info::de_jmx_exporter_info(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "nodeExporter" => {
                            builder = builder.set_node_exporter(crate::protocol_serde::shape_node_exporter_info::de_node_exporter_info(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
