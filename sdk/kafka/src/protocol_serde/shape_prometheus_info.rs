...
pub fn ser_prometheus_info(
    ...
    if let Some(var_1) = &input.jmx_exporter {
        ...
        crate::protocol_serde::shape_jmx_exporter_info::ser_jmx_exporter_info(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.node_exporter {
        ...
        crate::protocol_serde::shape_node_exporter_info::ser_node_exporter_info(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
...
pub(crate) fn de_prometheus_info<'a, I>(
    ...
    Option<crate::types::PrometheusInfo>,
