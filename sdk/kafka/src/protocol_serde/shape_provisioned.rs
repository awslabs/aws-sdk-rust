...
pub(crate) fn de_provisioned<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Provisioned>, aws_smithy_json::deserialize::error::DeserializeError>
