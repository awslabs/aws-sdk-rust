...
pub fn ser_broker_logs(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::BrokerLogs,
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "firehose" => {
                            builder = builder.set_firehose(crate::protocol_serde::shape_firehose::de_firehose(tokens, _value, depth + 1)?);
                        }
                        "s3" => {
                            builder = builder.set_s3(crate::protocol_serde::shape_s3::de_s3(tokens, _value, depth + 1)?);
                        }
