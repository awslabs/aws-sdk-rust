...
pub(crate) fn de_mutable_cluster_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MutableClusterInfo>, aws_smithy_json::deserialize::error::DeserializeError>
