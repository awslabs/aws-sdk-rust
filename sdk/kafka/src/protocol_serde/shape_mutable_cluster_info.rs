...
) -> Result<Option<crate::types::MutableClusterInfo>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "configurationInfo" => {
                            builder = builder.set_configuration_info(crate::protocol_serde::shape_configuration_info::de_configuration_info(tokens)?);
                        }
                        "numberOfBrokerNodes" => {
