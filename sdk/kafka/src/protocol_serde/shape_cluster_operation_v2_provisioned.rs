...
pub(crate) fn de_cluster_operation_v2_provisioned<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ClusterOperationV2Provisioned>, ::aws_smithy_json::deserialize::error::DeserializeError>
