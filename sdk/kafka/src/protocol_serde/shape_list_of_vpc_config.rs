...
pub(crate) fn de_list_of_vpc_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::VpcConfig>>, ::aws_smithy_json::deserialize::error::DeserializeError>
