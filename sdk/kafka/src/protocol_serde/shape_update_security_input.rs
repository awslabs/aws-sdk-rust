...
pub fn ser_update_security_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSecurityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
