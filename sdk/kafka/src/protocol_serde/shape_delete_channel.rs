...
pub fn de_delete_channel_http_error(
    ...
    Err(match error_code {
        ...
        "UnauthorizedException" => crate::operation::delete_channel::DeleteChannelError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_delete_channel_http_response(
    ...
    Ok({
        ...
        crate::serde_util::delete_channel_output_output_correct_errors(output).build()
    })
}
