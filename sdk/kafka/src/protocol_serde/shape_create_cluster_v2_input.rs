...
pub fn ser_create_cluster_v2_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateClusterV2Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
