...
impl ::std::convert::From<&str> for ChannelStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "SUSPENDING" => ChannelStatus::Suspending,
            "UPDATING" => ChannelStatus::Updating,
...
impl ChannelStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ChannelStatus::Suspending => "SUSPENDING",
...
impl ::std::fmt::Display for ChannelStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ChannelStatus::Suspending => write!(f, "SUSPENDING"),
            ChannelStatus::Updating => write!(f, "UPDATING"),
