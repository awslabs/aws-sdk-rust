...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::set_cluster_arn): <p>The Amazon Resource Name (ARN) that uniquely identifies the cluster.</p>
    ...
    ///   - [`current_version(impl ::std::convert::Into<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::set_current_version): <p>The version of the cluster that needs to be updated.</p>
