...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that uniquely identifies the cluster.</p><br>
    ...
    ///   - [`current_version(impl Into<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::update_cluster_configuration::builders::UpdateClusterConfigurationFluentBuilder::set_current_version):<br>required: **true**<br><p>The version of the cluster that needs to be updated.</p><br>
