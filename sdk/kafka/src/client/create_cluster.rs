...
impl super::Client {
    ...
    ///   - [`kafka_version(impl Into<String>)`](crate::operation::create_cluster::builders::CreateClusterFluentBuilder::kafka_version) / [`set_kafka_version(Option<String>)`](crate::operation::create_cluster::builders::CreateClusterFluentBuilder::set_kafka_version): <p>The version of Apache Kafka.</p>
    ...
    ///   - [`number_of_broker_nodes(i32)`](crate::operation::create_cluster::builders::CreateClusterFluentBuilder::number_of_broker_nodes) / [`set_number_of_broker_nodes(i32)`](crate::operation::create_cluster::builders::CreateClusterFluentBuilder::set_number_of_broker_nodes): <p>The number of broker nodes in the cluster.</p>
