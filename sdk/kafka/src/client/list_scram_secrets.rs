...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::list_scram_secrets::builders::ListScramSecretsFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::list_scram_secrets::builders::ListScramSecretsFluentBuilder::set_cluster_arn): <p>The arn of the cluster.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_scram_secrets::builders::ListScramSecretsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_scram_secrets::builders::ListScramSecretsFluentBuilder::set_next_token): <p>The nextToken of the query.</p>
