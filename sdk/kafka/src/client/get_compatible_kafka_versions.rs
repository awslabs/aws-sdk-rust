...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::get_compatible_kafka_versions::builders::GetCompatibleKafkaVersionsFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::get_compatible_kafka_versions::builders::GetCompatibleKafkaVersionsFluentBuilder::set_cluster_arn): <p>The Amazon Resource Name (ARN) of the cluster check.</p>
