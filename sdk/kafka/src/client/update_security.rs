...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::update_security::builders::UpdateSecurityFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::update_security::builders::UpdateSecurityFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that uniquely identifies the cluster.</p><br>
    ///   - [`current_version(impl Into<String>)`](crate::operation::update_security::builders::UpdateSecurityFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::update_security::builders::UpdateSecurityFluentBuilder::set_current_version):<br>required: **true**<br><p>The version of the MSK cluster to update. Cluster versions aren't simple numbers. You can describe an MSK cluster to find its version. When this update operation is successful, it generates a new cluster version.</p><br>
