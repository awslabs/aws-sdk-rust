...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::batch_associate_scram_secret::builders::BatchAssociateScramSecretFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::batch_associate_scram_secret::builders::BatchAssociateScramSecretFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the cluster to be updated.</p><br>
    ///   - [`secret_arn_list(impl Into<String>)`](crate::operation::batch_associate_scram_secret::builders::BatchAssociateScramSecretFluentBuilder::secret_arn_list) / [`set_secret_arn_list(Option<Vec::<String>>)`](crate::operation::batch_associate_scram_secret::builders::BatchAssociateScramSecretFluentBuilder::set_secret_arn_list):<br>required: **true**<br><p>List of AWS Secrets Manager secret ARNs.</p><br>
