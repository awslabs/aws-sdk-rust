...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::list_cluster_operations::builders::ListClusterOperationsFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::list_cluster_operations::builders::ListClusterOperationsFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that uniquely identifies the cluster.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_cluster_operations::builders::ListClusterOperationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_cluster_operations::builders::ListClusterOperationsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in the response. If there are more results, the response includes a NextToken parameter.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_cluster_operations::builders::ListClusterOperationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_cluster_operations::builders::ListClusterOperationsFluentBuilder::set_next_token):<br>required: **false**<br><p>The paginated results marker. When the result of the operation is truncated, the call returns NextToken in the response. To get the next batch, provide this token in your next request.</p><br>
