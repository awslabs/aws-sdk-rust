...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::list_cluster_operations_v2::builders::ListClusterOperationsV2FluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::list_cluster_operations_v2::builders::ListClusterOperationsV2FluentBuilder::set_cluster_arn): The arn of the cluster whose operations are being requested.
    ///   - [`max_results(i32)`](crate::operation::list_cluster_operations_v2::builders::ListClusterOperationsV2FluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_cluster_operations_v2::builders::ListClusterOperationsV2FluentBuilder::set_max_results): The maxResults of the query.
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_cluster_operations_v2::builders::ListClusterOperationsV2FluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_cluster_operations_v2::builders::ListClusterOperationsV2FluentBuilder::set_next_token): The nextToken of the query.
