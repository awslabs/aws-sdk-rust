...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::update_configuration::builders::UpdateConfigurationFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_configuration::builders::UpdateConfigurationFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the configuration.</p><br>
