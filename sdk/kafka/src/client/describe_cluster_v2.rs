...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::describe_cluster_v2::builders::DescribeClusterV2FluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::describe_cluster_v2::builders::DescribeClusterV2FluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that uniquely identifies the cluster.</p><br>
