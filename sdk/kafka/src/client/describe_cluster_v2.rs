...
impl super::Client {
    ...
    pub fn describe_cluster_v2(
        &self,
    ) -> crate::operation::describe_cluster_v2::builders::DescribeClusterV2FluentBuilder {
        crate::operation::describe_cluster_v2::builders::DescribeClusterV2FluentBuilder::new(
            self.handle.clone(),
        )
    }
}
