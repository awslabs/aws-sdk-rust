...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::reject_client_vpc_connection::builders::RejectClientVpcConnectionFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::reject_client_vpc_connection::builders::RejectClientVpcConnectionFluentBuilder::set_cluster_arn): <p>The Amazon Resource Name (ARN) of the cluster.</p>
