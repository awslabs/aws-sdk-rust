...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_kafka_versions::builders::ListKafkaVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_kafka_versions::builders::ListKafkaVersionsFluentBuilder::set_max_results): <p>The maximum number of results to return in the response. If there are more results, the response includes a NextToken parameter.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_kafka_versions::builders::ListKafkaVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_kafka_versions::builders::ListKafkaVersionsFluentBuilder::set_next_token): <p>The paginated results marker. When the result of the operation is truncated, the call returns NextToken in the response. To get the next batch, provide this token in your next request.</p>
