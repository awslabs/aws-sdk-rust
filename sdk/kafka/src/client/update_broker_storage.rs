...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::update_broker_storage::builders::UpdateBrokerStorageFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::update_broker_storage::builders::UpdateBrokerStorageFluentBuilder::set_cluster_arn): <p>The Amazon Resource Name (ARN) that uniquely identifies the cluster.</p>
    ///   - [`current_version(impl ::std::convert::Into<String>)`](crate::operation::update_broker_storage::builders::UpdateBrokerStorageFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::update_broker_storage::builders::UpdateBrokerStorageFluentBuilder::set_current_version): <p>The version of cluster to update from. A successful operation will then generate a new version.</p>
