...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_replicators::builders::ListReplicatorsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_replicators::builders::ListReplicatorsFluentBuilder::set_max_results): <p>The maximum number of results to return in the response. If there are more results, the response includes a NextToken parameter.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_replicators::builders::ListReplicatorsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_replicators::builders::ListReplicatorsFluentBuilder::set_next_token): <p>If the response of ListReplicators is truncated, it returns a NextToken in the response. This NextToken should be sent in the subsequent request to ListReplicators.</p>
    ///   - [`replicator_name_filter(impl Into<String>)`](crate::operation::list_replicators::builders::ListReplicatorsFluentBuilder::replicator_name_filter) / [`set_replicator_name_filter(Option<String>)`](crate::operation::list_replicators::builders::ListReplicatorsFluentBuilder::set_replicator_name_filter): <p>Returns replicators starting with given name.</p>
