...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_configuration::builders::CreateConfigurationFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_configuration::builders::CreateConfigurationFluentBuilder::set_description): <p>The description of the configuration.</p>
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_configuration::builders::CreateConfigurationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_configuration::builders::CreateConfigurationFluentBuilder::set_name): <p>The name of the configuration.</p>
