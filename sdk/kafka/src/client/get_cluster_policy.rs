...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::get_cluster_policy::builders::GetClusterPolicyFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::get_cluster_policy::builders::GetClusterPolicyFluentBuilder::set_cluster_arn): <p>The Amazon Resource Name (ARN) of the cluster.</p>
