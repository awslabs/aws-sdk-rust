...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::delete_vpc_connection::builders::DeleteVpcConnectionFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_vpc_connection::builders::DeleteVpcConnectionFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) that uniquely identifies an MSK VPC connection.</p>
