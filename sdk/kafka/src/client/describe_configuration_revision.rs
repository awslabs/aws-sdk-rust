...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) that uniquely identifies an MSK configuration and all of its revisions.</p>
