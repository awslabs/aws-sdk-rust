...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that uniquely identifies an MSK configuration and all of its revisions.</p><br>
    ///   - [`revision(i64)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::revision) / [`set_revision(Option<i64>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_revision):<br>required: **true**<br><p>A string that uniquely identifies a revision of an MSK configuration.</p><br>
