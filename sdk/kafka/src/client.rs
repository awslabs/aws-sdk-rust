...
impl Client {
    ...
    pub fn batch_associate_scram_secret(
        &self,
    ) -> crate::client::fluent_builders::BatchAssociateScramSecret {
    ...
    pub fn batch_disassociate_scram_secret(
        &self,
    ) -> crate::client::fluent_builders::BatchDisassociateScramSecret {
    ...
    pub fn describe_cluster_operation(
        &self,
    ) -> crate::client::fluent_builders::DescribeClusterOperation {
    ...
    pub fn get_compatible_kafka_versions(
        &self,
    ) -> crate::client::fluent_builders::GetCompatibleKafkaVersions {
    ...
    pub fn list_clusters_v2(&self) -> crate::client::fluent_builders::ListClustersV2 {
        crate::client::fluent_builders::ListClustersV2::new(self.handle.clone())
    }
