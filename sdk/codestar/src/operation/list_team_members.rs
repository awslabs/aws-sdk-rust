...
impl ListTeamMembersInput {
    /// Consumes the builder and constructs an Operation<[`ListTeamMembers`](crate::operation::list_team_members::ListTeamMembers)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_team_members::ListTeamMembers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_team_members::ser_list_team_members_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_team_members::ListTeamMembers::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTeamMembers", "codestar"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTeamMembers {
    type Output =
        ::std::result::Result<crate::operation::list_team_members::ListTeamMembersOutput, crate::operation::list_team_members::ListTeamMembersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_team_members::de_list_team_members_http_response_with_props(status, headers, body)
        }
    }
}
