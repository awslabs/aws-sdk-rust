...
impl ListTeamMembersInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_team_members::ListTeamMembers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_team_members::ListTeamMembersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_team_members::ser_list_team_members_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for ListTeamMembers {
                type Output = std::result::Result<crate::operation::list_team_members::ListTeamMembersOutput, crate::operation::list_team_members::ListTeamMembersError>;
