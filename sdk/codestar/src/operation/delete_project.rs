...
impl DeleteProjectInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_project::ser_delete_project_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_project::DeleteProject::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteProject", "codestar"));
