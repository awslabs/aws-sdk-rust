...
impl ListTagsForProjectInput {
    /// Consumes the builder and constructs an Operation<[`ListTagsForProject`](crate::operation::list_tags_for_project::ListTagsForProject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_tags_for_project::ListTagsForProject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_tags_for_project::ListTagsForProjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_tags_for_project::ser_list_tags_for_project_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_tags_for_project::ListTagsForProject::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTagsForProject", "codestar"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListTagsForProject {
                type Output = std::result::Result<crate::operation::list_tags_for_project::ListTagsForProjectOutput, crate::operation::list_tags_for_project::ListTagsForProjectError>;
