...
/// Orchestration and serialization glue logic for `ListTagsForProject`.
...
impl ListTagsForProject {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_tags_for_project::ListTagsForProjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_tags_for_project::ListTagsForProjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_tags_for_project::ListTagsForProjectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_tags_for_project::ListTagsForProjectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTagsForProject {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListTagsForProject");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListTagsForProjectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListTagsForProjectResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTagsForProject")
...
.with_interceptor(ListTagsForProjectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_tags_for_project::ListTagsForProjectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_tags_for_project::ListTagsForProjectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_tags_for_project::ListTagsForProjectError>::new());
...
#[derive(Debug)]
            struct ListTagsForProjectResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTagsForProjectResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_tags_for_project::de_list_tags_for_project_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_tags_for_project::de_list_tags_for_project_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListTagsForProjectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTagsForProjectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_tags_for_project::ListTagsForProjectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_tags_for_project::ListTagsForProjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_tags_for_project::ser_list_tags_for_project_input(&input)?);
...
#[derive(Debug)]
            struct ListTagsForProjectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTagsForProjectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListTagsForProjectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListTagsForProjectInput>()
                        .ok_or("failed to downcast to ListTagsForProjectInput")?;
...
pub enum ListTagsForProjectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListTagsForProjectError) for what information is available for the error.")]
...
impl ListTagsForProjectError {
    /// Creates the `ListTagsForProjectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListTagsForProjectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListTagsForProjectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_tags_for_project::ListTagsForProjectError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_tags_for_project::_list_tags_for_project_output::ListTagsForProjectOutput;

pub use crate::operation::list_tags_for_project::_list_tags_for_project_input::ListTagsForProjectInput;

mod _list_tags_for_project_input;

mod _list_tags_for_project_output;
