...
impl DescribeUserProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_user_profile::DescribeUserProfile,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUserProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_user_profile::de_describe_user_profile_http_response_with_props(status, headers, body)
        }
    }
