...
impl DescribeUserProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_user_profile::ser_describe_user_profile_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_user_profile::DescribeUserProfile::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_user_profile::DescribeUserProfileError
{
