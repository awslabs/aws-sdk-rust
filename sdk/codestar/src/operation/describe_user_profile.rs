...
impl DescribeUserProfileInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUserProfile`](crate::operation::describe_user_profile::DescribeUserProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_user_profile::DescribeUserProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_user_profile::DescribeUserProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_user_profile::ser_describe_user_profile_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_user_profile::DescribeUserProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeUserProfile", "codestar"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeUserProfile {
                type Output = std::result::Result<crate::operation::describe_user_profile::DescribeUserProfileOutput, crate::operation::describe_user_profile::DescribeUserProfileError>;
