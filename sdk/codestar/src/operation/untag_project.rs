...
impl UntagProjectInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_project::UntagProject::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagProject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_untag_project::de_untag_project_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_untag_project::de_untag_project_http_response_with_props(
                status, headers, body,
            )
        }
    }
