...
impl TagProjectInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::tag_project::TagProject::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagProject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_tag_project::de_tag_project_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_tag_project::de_tag_project_http_response_with_props(
                status, headers, body,
            )
        }
    }
