...
impl ListResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_resources::ListResources, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_resources::ser_list_resources_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resources::ListResources::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResources", "codestar"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resources::de_list_resources_http_response_with_props(status, headers, body)
        }
    }
}
