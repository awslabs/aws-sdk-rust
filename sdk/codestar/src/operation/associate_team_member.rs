...
impl AssociateTeamMemberInput {
    /// Consumes the builder and constructs an Operation<[`AssociateTeamMember`](crate::operation::associate_team_member::AssociateTeamMember)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_team_member::AssociateTeamMember, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_team_member::AssociateTeamMemberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_team_member::ser_associate_team_member_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_team_member::AssociateTeamMember::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateTeamMember", "codestar"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateTeamMember {
                type Output = std::result::Result<crate::operation::associate_team_member::AssociateTeamMemberOutput, crate::operation::associate_team_member::AssociateTeamMemberError>;
