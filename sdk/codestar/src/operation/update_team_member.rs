...
impl UpdateTeamMemberInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_team_member::UpdateTeamMember,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_team_member::ser_update_team_member_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTeamMember {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_team_member::de_update_team_member_http_response_with_props(status, headers, body)
        }
    }
}
