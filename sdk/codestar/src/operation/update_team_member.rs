...
impl UpdateTeamMemberInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTeamMember`](crate::operation::update_team_member::UpdateTeamMember)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_team_member::UpdateTeamMember, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_team_member::UpdateTeamMemberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_team_member::ser_update_team_member_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_team_member::UpdateTeamMember::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateTeamMember", "codestar"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTeamMember {
                type Output = std::result::Result<crate::operation::update_team_member::UpdateTeamMemberOutput, crate::operation::update_team_member::UpdateTeamMemberError>;
