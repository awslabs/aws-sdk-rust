...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_codestar::Error> {
/// # let client: aws_sdk_codestar::Client = unimplemented!();
...
mod disassociate_team_member;

mod list_projects;

mod list_resources;

mod list_tags_for_project;
