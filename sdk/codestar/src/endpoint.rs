...
mod test {
    ...
    fn test_18() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar-fips.cn-north-1.amazonaws.com.cn");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_19() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://codestar.cn-north-1.api.amazonwebservices.com.cn",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_20() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar.cn-north-1.amazonaws.com.cn");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_21() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://codestar-fips.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_22() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar-fips.us-gov-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_23() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://codestar.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_24() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar.us-gov-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_26() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar-fips.us-iso-east-1.c2s.ic.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_28() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://codestar.us-iso-east-1.c2s.ic.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_30() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar-fips.us-isob-east-1.sc2s.sgov.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_32() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://codestar.us-isob-east-1.sc2s.sgov.gov");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
