...
impl super::Client {
    ...
    ///   - [`user_arn(String)`](crate::operation::create_user_profile::CreateUserProfileOutput::user_arn): <p>The Amazon Resource Name (ARN) of the user in IAM.</p>
