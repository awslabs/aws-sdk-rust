...
impl super::Client {
    ...
    ///   - [`user_arn(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::user_arn) / [`set_user_arn(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_user_arn):<br>required: **true**<br><p>The name that will be displayed as the friendly name for the user in AWS CodeStar.</p><br>
    ///   - [`display_name(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_display_name):<br>required: **false**<br><p>The name that is displayed as the friendly name for the user in AWS CodeStar.</p><br>
    ///   - [`email_address(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::email_address) / [`set_email_address(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_email_address):<br>required: **false**<br><p>The email address that is displayed as part of the user's profile in AWS CodeStar.</p><br>
    ///   - [`ssh_public_key(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::ssh_public_key) / [`set_ssh_public_key(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_ssh_public_key):<br>required: **false**<br><p>The SSH public key associated with the user in AWS CodeStar. If a project owner allows the user remote access to project resources, this public key will be used along with the user's private key for SSH access.</p><br>
    ...
    ///   - [`user_arn(String)`](crate::operation::update_user_profile::UpdateUserProfileOutput::user_arn): <p>The Amazon Resource Name (ARN) of the user in IAM.</p>
