...
impl super::Client {
    ...
    ///   - [`user_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_user_profile::builders::DeleteUserProfileFluentBuilder::user_arn) / [`set_user_arn(Option<String>)`](crate::operation::delete_user_profile::builders::DeleteUserProfileFluentBuilder::set_user_arn): <p>The Amazon Resource Name (ARN) of the user to delete from AWS CodeStar.</p>
