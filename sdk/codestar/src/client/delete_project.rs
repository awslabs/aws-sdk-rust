...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the project to be deleted in AWS CodeStar.</p><br>
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_client_request_token):<br>required: **false**<br><p>A user- or system-generated token that identifies the entity that requested project deletion. This token can be used to repeat the request.</p><br>
    ///   - [`delete_stack(bool)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::delete_stack) / [`set_delete_stack(Option<bool>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_delete_stack):<br>required: **false**<br><p>Whether to send a delete request for the primary stack in AWS CloudFormation originally used to generate the project and its resources. This option will delete all AWS resources for the project (except for any buckets in Amazon S3) as well as deleting the project itself. Recommended for most use cases.</p><br>
