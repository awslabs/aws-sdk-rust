...
impl super::Client {
    ...
    ///   - [`delete_stack(bool)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::delete_stack) / [`set_delete_stack(Option<bool>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_delete_stack): <p>Whether to send a delete request for the primary stack in AWS CloudFormation originally used to generate the project and its resources. This option will delete all AWS resources for the project (except for any buckets in Amazon S3) as well as deleting the project itself. Recommended for most use cases.</p>
