...
impl super::Client {
    ...
    ///   - [`project_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_team_member::builders::DisassociateTeamMemberFluentBuilder::project_id) / [`set_project_id(Option<String>)`](crate::operation::disassociate_team_member::builders::DisassociateTeamMemberFluentBuilder::set_project_id): <p>The ID of the AWS CodeStar project from which you want to remove a team member.</p>
