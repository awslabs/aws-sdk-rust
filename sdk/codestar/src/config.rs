...
/// Configuration for a aws_sdk_codestar service client.
/// 
/// 
...
impl Builder {
    ...
    /// Sets the HTTP client to use when making requests.
                            ...
                            /// use aws_sdk_codestar::config::Config;
                            ...
                            /// # fn example() {
                            /// use std::time::Duration;
                            /// use aws_sdk_codestar::config::{Builder, Config};
                            /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
                            ///
                            ...
                            /// }
                            ///
                            /// let mut builder = aws_sdk_codestar::Config::builder();
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use aws_sdk_codestar::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = aws_sdk_codestar::Config::builder().endpoint_resolver(resolver).build();
    ...
    /// Set the retry_config for the builder
                            ...
                            /// ```no_run
                            /// use aws_sdk_codestar::config::Config;
                            /// use aws_sdk_codestar::config::retry::RetryConfig;
                            ///
    ...
    /// Set the sleep_impl for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use aws_sdk_codestar::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use aws_sdk_codestar::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Set the timeout_config for the builder
                            ...
                            /// # use std::time::Duration;
                            /// use aws_sdk_codestar::config::Config;
                            /// use aws_sdk_codestar::config::timeout::TimeoutConfig;
                            ///
    ...
    /// Set the identity cache for auth.
                            ...
                            /// ```no_run
                            /// use aws_sdk_codestar::config::IdentityCache;
                            ///
                            /// let config = aws_sdk_codestar::Config::builder()
    ...
    /// Sets the [`behavior major version`](crate::config::BehaviorVersion).
                    ...
                    /// ```no_run
                    /// use aws_sdk_codestar::config::BehaviorVersion;
                    ///
                    /// let config = aws_sdk_codestar::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("codestar"));
                                    layer.load::<::aws_types::region::Region>().cloned().map(|r| layer.store_put(::aws_types::region::SigningRegion::from(r)));
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("aws_sdk_codestar::config::Config").freeze(),
                                    cloneable: layer,
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_codestar::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
                    ...
                    let mut plugins = ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins::new()
                        ...
                        .with_client_plugins(::aws_smithy_runtime::client::defaults::default_plugins(
                            ::aws_smithy_runtime::client::defaults::DefaultPluginParams::new()
                                .with_retry_partition_name("codestar")
