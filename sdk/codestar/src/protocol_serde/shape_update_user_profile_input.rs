...
pub fn ser_update_user_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUserProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
