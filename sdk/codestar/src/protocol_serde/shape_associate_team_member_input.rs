...
pub fn ser_associate_team_member_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateTeamMemberInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
