...
pub(crate) fn de_resources_result<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Resource>>, aws_smithy_json::deserialize::error::DeserializeError>
