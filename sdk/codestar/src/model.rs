...
pub struct Toolchain  {
    ...
    #[doc(hidden)]pub source: std::option::Option<crate::model::ToolchainSource>,
    ...
    #[doc(hidden)]pub stack_parameters: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl Toolchain {
    /// <p>The Amazon S3 location where the toolchain template file provided with the project request is stored. AWS CodeStar retrieves the file during project creation.</p>
...
pub struct S3Location  {
    ...
    #[doc(hidden)]pub bucket_key: std::option::Option<std::string::String>,
}
impl S3Location {
    /// <p>The Amazon S3 bucket name where the source code files provided with the project request are stored.</p>
...
pub struct Code  {
    ...
    #[doc(hidden)]pub source: std::option::Option<crate::model::CodeSource>,
    ...
    #[doc(hidden)]pub destination: std::option::Option<crate::model::CodeDestination>,
}
impl Code {
    /// <p>The location where the source code files provided with the project request are stored. AWS CodeStar retrieves the files during project creation.</p>
...
pub struct CodeDestination  {
    ...
    #[doc(hidden)]pub code_commit: std::option::Option<crate::model::CodeCommitCodeDestination>,
    ...
    #[doc(hidden)]pub git_hub: std::option::Option<crate::model::GitHubCodeDestination>,
}
...
pub struct GitHubCodeDestination  {
    ...
    #[doc(hidden)]pub private_repository: bool,
    /// <p>Whether to enable issues for the GitHub repository.</p>
    #[doc(hidden)]pub issues_enabled: bool,
