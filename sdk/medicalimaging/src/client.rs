...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_medicalimaging::Error> {
/// # let client: aws_sdk_medicalimaging::Client = unimplemented!();
...
mod delete_image_set;

mod get_datastore;

mod get_dicom_import_job;

mod get_image_frame;

mod get_image_set;

mod get_image_set_metadata;

mod list_datastores;

mod list_dicom_import_jobs;

mod list_image_set_versions;

mod list_tags_for_resource;

mod search_image_sets;

mod start_dicom_import_job;

mod tag_resource;

mod untag_resource;

mod update_image_set_metadata;
