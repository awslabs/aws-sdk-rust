...
impl super::Client {
    ...
    ///   - [`datastore_status(DatastoreStatus)`](crate::operation::list_datastores::builders::ListDatastoresFluentBuilder::datastore_status) / [`set_datastore_status(Option<DatastoreStatus>)`](crate::operation::list_datastores::builders::ListDatastoresFluentBuilder::set_datastore_status): <p>The data store status.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_datastores::builders::ListDatastoresFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_datastores::builders::ListDatastoresFluentBuilder::set_next_token): <p>The pagination token used to request the list of data stores on the next page.</p>
    ///   - [`max_results(i32)`](crate::operation::list_datastores::builders::ListDatastoresFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_datastores::builders::ListDatastoresFluentBuilder::set_max_results): <p>Valid Range: Minimum value of 1. Maximum value of 50.</p>
