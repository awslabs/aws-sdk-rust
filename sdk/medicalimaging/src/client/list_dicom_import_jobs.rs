...
impl super::Client {
    ...
    ///   - [`datastore_id(impl Into<String>)`](crate::operation::list_dicom_import_jobs::builders::ListDICOMImportJobsFluentBuilder::datastore_id) / [`set_datastore_id(Option<String>)`](crate::operation::list_dicom_import_jobs::builders::ListDICOMImportJobsFluentBuilder::set_datastore_id): <p>The data store identifier.</p>
    ///   - [`job_status(JobStatus)`](crate::operation::list_dicom_import_jobs::builders::ListDICOMImportJobsFluentBuilder::job_status) / [`set_job_status(Option<JobStatus>)`](crate::operation::list_dicom_import_jobs::builders::ListDICOMImportJobsFluentBuilder::set_job_status): <p>The filters for listing import jobs based on status.</p>
    ...
    ///   - [`job_summaries(Option<Vec<DicomImportJobSummary>>)`](crate::operation::list_dicom_import_jobs::ListDicomImportJobsOutput::job_summaries): <p>A list of job summaries.</p>
