...
impl super::Client {
    ...
    ///   - [`datastore_id(impl Into<String>)`](crate::operation::get_image_frame::builders::GetImageFrameFluentBuilder::datastore_id) / [`set_datastore_id(Option<String>)`](crate::operation::get_image_frame::builders::GetImageFrameFluentBuilder::set_datastore_id): <p>The data store identifier.</p>
    ///   - [`image_set_id(impl Into<String>)`](crate::operation::get_image_frame::builders::GetImageFrameFluentBuilder::image_set_id) / [`set_image_set_id(Option<String>)`](crate::operation::get_image_frame::builders::GetImageFrameFluentBuilder::set_image_set_id): <p>The image set identifier.</p>
    ///   - [`image_frame_information(ImageFrameInformation)`](crate::operation::get_image_frame::builders::GetImageFrameFluentBuilder::image_frame_information) / [`set_image_frame_information(Option<ImageFrameInformation>)`](crate::operation::get_image_frame::builders::GetImageFrameFluentBuilder::set_image_frame_information): <p>Information about the image frame (pixel data) identifier.</p>
