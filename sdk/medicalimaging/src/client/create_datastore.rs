...
impl super::Client {
    ...
    ///   - [`lambda_authorizer_arn(impl Into<String>)`](crate::operation::create_datastore::builders::CreateDatastoreFluentBuilder::lambda_authorizer_arn) / [`set_lambda_authorizer_arn(Option<String>)`](crate::operation::create_datastore::builders::CreateDatastoreFluentBuilder::set_lambda_authorizer_arn):<br>required: **false**<br><p>The ARN of the authorizer's Lambda function.</p><br>
    ///   - [`lossless_storage_format(LosslessStorageFormat)`](crate::operation::create_datastore::builders::CreateDatastoreFluentBuilder::lossless_storage_format) / [`set_lossless_storage_format(Option<LosslessStorageFormat>)`](crate::operation::create_datastore::builders::CreateDatastoreFluentBuilder::set_lossless_storage_format):<br>required: **false**<br><p>The lossless storage format for the datastore.</p><br>
