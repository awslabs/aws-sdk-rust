...
/// match storagetier {
///     StorageTier::ArchiveInstantAccess => { /* ... */ },
///     StorageTier::FrequentAccess => { /* ... */ },
...
impl ::std::convert::From<&str> for StorageTier {
    fn from(s: &str) -> Self {
        match s {
            "ARCHIVE_INSTANT_ACCESS" => StorageTier::ArchiveInstantAccess,
            "FREQUENT_ACCESS" => StorageTier::FrequentAccess,
...
impl StorageTier {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            StorageTier::ArchiveInstantAccess => "ARCHIVE_INSTANT_ACCESS",
            StorageTier::FrequentAccess => "FREQUENT_ACCESS",
            StorageTier::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ARCHIVE_INSTANT_ACCESS", "FREQUENT_ACCESS"]
    }
}
...
impl ::std::fmt::Display for StorageTier {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            StorageTier::ArchiveInstantAccess => write!(f, "ARCHIVE_INSTANT_ACCESS"),
            StorageTier::FrequentAccess => write!(f, "FREQUENT_ACCESS"),
