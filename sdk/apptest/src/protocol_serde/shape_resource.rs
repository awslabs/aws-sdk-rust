...
pub fn ser_resource(
    ...
    if let Some(var_1) = &input.r#type {
        ...
        crate::protocol_serde::shape_resource_type::ser_resource_type(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "type" => {
                            builder = builder.set_type(crate::protocol_serde::shape_resource_type::de_resource_type(tokens)?);
                        }
