...
impl DeleteRegexMatchSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_regex_match_set::DeleteRegexMatchSetInput,
                    ) -> ::std::result::Result<crate::operation::delete_regex_match_set::DeleteRegexMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_regex_match_set::DeleteRegexMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_regex_match_set::DeleteRegexMatchSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_regex_match_set::DeleteRegexMatchSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRegexMatchSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteRegexMatchSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteRegexMatchSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteRegexMatchSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRegexMatchSet")
...
.with_interceptor(DeleteRegexMatchSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_regex_match_set::DeleteRegexMatchSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_regex_match_set::DeleteRegexMatchSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_regex_match_set::DeleteRegexMatchSetError>::new());
...
#[derive(Debug)]
            struct DeleteRegexMatchSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRegexMatchSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_regex_match_set::de_delete_regex_match_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_regex_match_set::de_delete_regex_match_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteRegexMatchSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRegexMatchSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_regex_match_set::DeleteRegexMatchSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_regex_match_set::DeleteRegexMatchSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_regex_match_set::ser_delete_regex_match_set_input(&input)?);
...
#[derive(Debug)]
            struct DeleteRegexMatchSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRegexMatchSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteRegexMatchSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteRegexMatchSetInput>()
                        .ok_or("failed to downcast to DeleteRegexMatchSetInput")?;
...
pub enum DeleteRegexMatchSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteRegexMatchSetError) for what information is available for the error.")]
...
impl DeleteRegexMatchSetError {
    /// Creates the `DeleteRegexMatchSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteRegexMatchSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteRegexMatchSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_regex_match_set::DeleteRegexMatchSetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_regex_match_set::_delete_regex_match_set_output::DeleteRegexMatchSetOutput;

pub use crate::operation::delete_regex_match_set::_delete_regex_match_set_input::DeleteRegexMatchSetInput;

mod _delete_regex_match_set_input;

mod _delete_regex_match_set_output;
