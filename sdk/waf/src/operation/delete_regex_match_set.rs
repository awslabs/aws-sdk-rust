...
impl DeleteRegexMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRegexMatchSet`](crate::operation::delete_regex_match_set::DeleteRegexMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_regex_match_set::DeleteRegexMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_regex_match_set::DeleteRegexMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_regex_match_set::ser_delete_regex_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_regex_match_set::DeleteRegexMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteRegexMatchSet", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRegexMatchSet {
                type Output = std::result::Result<crate::operation::delete_regex_match_set::DeleteRegexMatchSetOutput, crate::operation::delete_regex_match_set::DeleteRegexMatchSetError>;
