...
impl DeleteByteMatchSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_byte_match_set::DeleteByteMatchSet,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteByteMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_byte_match_set::de_delete_byte_match_set_http_response_with_props(status, headers, body)
        }
    }
}
