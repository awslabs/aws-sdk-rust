...
impl DeleteByteMatchSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_byte_match_set::ser_delete_byte_match_set_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_byte_match_set::DeleteByteMatchSet::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_byte_match_set::DeleteByteMatchSetError
{
