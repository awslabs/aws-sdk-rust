...
impl DeleteByteMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteByteMatchSet`](crate::operation::delete_byte_match_set::DeleteByteMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_byte_match_set::DeleteByteMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_byte_match_set::DeleteByteMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_byte_match_set::ser_delete_byte_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_byte_match_set::DeleteByteMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteByteMatchSet", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteByteMatchSet {
                type Output = std::result::Result<crate::operation::delete_byte_match_set::DeleteByteMatchSetOutput, crate::operation::delete_byte_match_set::DeleteByteMatchSetError>;
