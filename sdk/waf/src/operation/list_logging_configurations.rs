...
impl ListLoggingConfigurationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_logging_configurations::ListLoggingConfigurations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLoggingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_logging_configurations::de_list_logging_configurations_http_response_with_props(status, headers, body)
        }
    }
}
