...
impl DeleteSizeConstraintSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSizeConstraintSet`](crate::operation::delete_size_constraint_set::DeleteSizeConstraintSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_size_constraint_set::ser_delete_size_constraint_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_size_constraint_set::DeleteSizeConstraintSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteSizeConstraintSet", "waf"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteSizeConstraintSet`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSizeConstraintSet {
                type Output = std::result::Result<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetOutput, crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError>;
