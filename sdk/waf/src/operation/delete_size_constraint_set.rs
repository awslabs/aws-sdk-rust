...
/// Orchestration and serialization glue logic for `DeleteSizeConstraintSet`.
...
impl DeleteSizeConstraintSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetInput,
                    ) -> ::std::result::Result<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSizeConstraintSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSizeConstraintSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSizeConstraintSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSizeConstraintSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSizeConstraintSet")
...
.with_interceptor(DeleteSizeConstraintSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError>::new());
...
#[derive(Debug)]
            struct DeleteSizeConstraintSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSizeConstraintSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_size_constraint_set::de_delete_size_constraint_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_size_constraint_set::de_delete_size_constraint_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteSizeConstraintSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSizeConstraintSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_size_constraint_set::ser_delete_size_constraint_set_input(&input)?);
...
#[derive(Debug)]
            struct DeleteSizeConstraintSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSizeConstraintSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSizeConstraintSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSizeConstraintSetInput>()
                        .ok_or("failed to downcast to DeleteSizeConstraintSetInput")?;
...
pub enum DeleteSizeConstraintSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSizeConstraintSetError) for what information is available for the error.")]
...
impl DeleteSizeConstraintSetError {
    /// Creates the `DeleteSizeConstraintSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSizeConstraintSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::WafNonEmptyEntityException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSizeConstraintSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_size_constraint_set::DeleteSizeConstraintSetError {
...
mod _delete_size_constraint_set_output;
