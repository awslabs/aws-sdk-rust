...
impl DeleteSqlInjectionMatchSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_sql_injection_match_set::DeleteSqlInjectionMatchSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSqlInjectionMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_sql_injection_match_set::de_delete_sql_injection_match_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
