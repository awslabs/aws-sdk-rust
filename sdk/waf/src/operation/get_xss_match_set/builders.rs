...
impl GetXssMatchSetFluentBuilder  {
    /// Creates a new `GetXssMatchSet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_xss_match_set::GetXssMatchSetOutput, aws_smithy_http::result::SdkError<crate::operation::get_xss_match_set::GetXssMatchSetError>>
                     {
