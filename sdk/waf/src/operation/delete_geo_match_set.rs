...
impl DeleteGeoMatchSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_geo_match_set::ser_delete_geo_match_set_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_geo_match_set::DeleteGeoMatchSet::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_geo_match_set::DeleteGeoMatchSetError
{
