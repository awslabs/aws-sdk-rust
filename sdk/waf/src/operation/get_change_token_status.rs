...
impl GetChangeTokenStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetChangeTokenStatus`](crate::operation::get_change_token_status::GetChangeTokenStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_change_token_status::GetChangeTokenStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_change_token_status::GetChangeTokenStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_change_token_status::ser_get_change_token_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_change_token_status::GetChangeTokenStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetChangeTokenStatus", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetChangeTokenStatus {
                type Output = std::result::Result<crate::operation::get_change_token_status::GetChangeTokenStatusOutput, crate::operation::get_change_token_status::GetChangeTokenStatusError>;
