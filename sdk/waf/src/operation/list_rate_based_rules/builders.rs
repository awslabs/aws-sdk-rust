...
impl ListRateBasedRulesFluentBuilder  {
    /// Creates a new `ListRateBasedRules`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_rate_based_rules::ListRateBasedRulesOutput, aws_smithy_http::result::SdkError<crate::operation::list_rate_based_rules::ListRateBasedRulesError>>
                     {
