...
impl GetGeoMatchSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_geo_match_set::GetGeoMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_geo_match_set::GetGeoMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_geo_match_set::GetGeoMatchSetOutput, crate::operation::get_geo_match_set::GetGeoMatchSetError, Self> {
