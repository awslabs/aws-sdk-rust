...
impl UntagResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_resource::UntagResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_untag_resource::de_untag_resource_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_untag_resource::de_untag_resource_http_response_with_props(
                status, headers, body,
            )
        }
    }
