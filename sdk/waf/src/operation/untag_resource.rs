...
impl UntagResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::untag_resource::UntagResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_untag_resource::ser_untag_resource_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_resource::UntagResource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UntagResource", "waf"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_resource::de_untag_resource_http_response_with_props(status, headers, body)
        }
    }
}
