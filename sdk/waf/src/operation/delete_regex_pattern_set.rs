...
impl DeleteRegexPatternSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRegexPatternSet`](crate::operation::delete_regex_pattern_set::DeleteRegexPatternSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_regex_pattern_set::DeleteRegexPatternSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_regex_pattern_set::ser_delete_regex_pattern_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_regex_pattern_set::DeleteRegexPatternSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteRegexPatternSet", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRegexPatternSet {
                type Output = std::result::Result<crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetOutput, crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetError>;
