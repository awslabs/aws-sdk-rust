...
impl crate::operation::update_geo_match_set::builders::UpdateGeoMatchSetInputBuilder {
...
/// <ul>
/// <li>
/// <p>Whether to insert or delete the object from the array. If you want to change an <code>GeoMatchConstraint</code> object, you delete the existing object and add a new one.</p></li>
/// <li>
/// <p>The <code>Type</code>. The only valid value for <code>Type</code> is <code>Country</code>.</p></li>
/// <li>
/// <p>The <code>Value</code>, which is a two character code for the country to add to the <code>GeoMatchConstraint</code> object. Valid codes are listed in <code>GeoMatchConstraint$Value</code>.</p></li>
/// </ul>
...
/// <li>
/// <p>Submit an <code>UpdateGeoMatchSet</code> request to specify the country that you want AWS WAF to watch for.</p></li>
/// </ol>
...
impl UpdateGeoMatchSetFluentBuilder {
    /// Creates a new `UpdateGeoMatchSetFluentBuilder`.
