...
impl CreateByteMatchSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_byte_match_set::ser_create_byte_match_set_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_byte_match_set::CreateByteMatchSet::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_byte_match_set::CreateByteMatchSetError
{
