...
impl crate::operation::delete_regex_match_set::builders::DeleteRegexMatchSetInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.delete_regex_match_set();
...
/// <ol>
/// <li>
/// <p>Update the <code>RegexMatchSet</code> to remove filters, if any. For more information, see <code>UpdateRegexMatchSet</code>.</p></li>
/// <li>
/// <p>Use <code>GetChangeToken</code> to get the change token that you provide in the <code>ChangeToken</code> parameter of a <code>DeleteRegexMatchSet</code> request.</p></li>
/// <li>
/// <p>Submit a <code>DeleteRegexMatchSet</code> request.</p></li>
/// </ol>
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::delete_regex_match_set::DeleteRegexMatchSetOutput,
        crate::operation::delete_regex_match_set::DeleteRegexMatchSetError,
    > for DeleteRegexMatchSetFluentBuilder
{
    fn send(
        self,
...
impl DeleteRegexMatchSetFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_regex_match_set::DeleteRegexMatchSet::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_regex_match_set::DeleteRegexMatchSet::orchestrate(&runtime_plugins, input).await
    }
