...
/// Orchestration and serialization glue logic for `UpdateSizeConstraintSet`.
...
impl UpdateSizeConstraintSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_size_constraint_set::UpdateSizeConstraintSetInput,
                    ) -> ::std::result::Result<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSizeConstraintSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSizeConstraintSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateSizeConstraintSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateSizeConstraintSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSizeConstraintSet")
...
.with_interceptor(UpdateSizeConstraintSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError>::new());
...
#[derive(Debug)]
            struct UpdateSizeConstraintSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSizeConstraintSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_size_constraint_set::de_update_size_constraint_set_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateSizeConstraintSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSizeConstraintSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_size_constraint_set::UpdateSizeConstraintSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_size_constraint_set::UpdateSizeConstraintSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_size_constraint_set::ser_update_size_constraint_set_input(&input)?);
...
#[derive(Debug)]
            struct UpdateSizeConstraintSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSizeConstraintSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateSizeConstraintSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateSizeConstraintSetInput>()
                        .ok_or("failed to downcast to UpdateSizeConstraintSetInput")?;
...
pub enum UpdateSizeConstraintSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSizeConstraintSetError) for what information is available for the error.")]
...
impl UpdateSizeConstraintSetError {
    /// Creates the `UpdateSizeConstraintSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSizeConstraintSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSizeConstraintSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError {
...
mod _update_size_constraint_set_output;
