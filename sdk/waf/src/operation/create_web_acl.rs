...
impl CreateWebAclInput {
    /// Consumes the builder and constructs an Operation<[`CreateWebACL`](crate::operation::create_web_acl::CreateWebACL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_web_acl::CreateWebACL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_web_acl::CreateWebAclInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_web_acl::CreateWebACL::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateWebACL", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateWebACL {
                type Output = std::result::Result<crate::operation::create_web_acl::CreateWebAclOutput, crate::operation::create_web_acl::CreateWebACLError>;
