...
impl CreateWebAclInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_web_acl::CreateWebACL::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWebACL {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_web_acl::de_create_web_acl_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_web_acl::de_create_web_acl_http_response_with_props(
                status, headers, body,
            )
        }
    }
