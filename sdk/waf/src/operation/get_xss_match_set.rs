...
impl GetXssMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`GetXssMatchSet`](crate::operation::get_xss_match_set::GetXssMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_xss_match_set::GetXssMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_xss_match_set::GetXssMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_xss_match_set::ser_get_xss_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_xss_match_set::GetXssMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetXssMatchSet", "waf"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetXssMatchSet`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetXssMatchSet {
                type Output = std::result::Result<crate::operation::get_xss_match_set::GetXssMatchSetOutput, crate::operation::get_xss_match_set::GetXssMatchSetError>;
