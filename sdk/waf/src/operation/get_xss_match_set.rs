...
impl GetXssMatchSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_xss_match_set::GetXssMatchSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_xss_match_set::ser_get_xss_match_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetXssMatchSet {
    type Output =
        ::std::result::Result<crate::operation::get_xss_match_set::GetXssMatchSetOutput, crate::operation::get_xss_match_set::GetXssMatchSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_xss_match_set::de_get_xss_match_set_http_response_with_props(status, headers, body)
        }
    }
}
