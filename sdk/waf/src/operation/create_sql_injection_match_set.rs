...
impl CreateSqlInjectionMatchSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSqlInjectionMatchSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateSqlInjectionMatchSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateSqlInjectionMatchSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateSqlInjectionMatchSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSqlInjectionMatchSet")
...
.with_interceptor(CreateSqlInjectionMatchSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError>::new());
...
#[derive(Debug)]
            struct CreateSqlInjectionMatchSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSqlInjectionMatchSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_create_sql_injection_match_set::de_create_sql_injection_match_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateSqlInjectionMatchSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSqlInjectionMatchSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_sql_injection_match_set::ser_create_sql_injection_match_set_input(&input)?);
...
#[derive(Debug)]
            struct CreateSqlInjectionMatchSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateSqlInjectionMatchSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateSqlInjectionMatchSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateSqlInjectionMatchSetInput>()
                        .ok_or("failed to downcast to CreateSqlInjectionMatchSetInput")?;
...
pub enum CreateSqlInjectionMatchSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateSqlInjectionMatchSetError) for what information is available for the error.")]
...
impl CreateSqlInjectionMatchSetError {
    /// Creates the `CreateSqlInjectionMatchSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateSqlInjectionMatchSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateSqlInjectionMatchSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError {
