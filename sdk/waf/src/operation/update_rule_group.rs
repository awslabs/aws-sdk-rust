...
impl UpdateRuleGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_rule_group::UpdateRuleGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_rule_group::ser_update_rule_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRuleGroup {
    type Output =
        ::std::result::Result<crate::operation::update_rule_group::UpdateRuleGroupOutput, crate::operation::update_rule_group::UpdateRuleGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_rule_group::de_update_rule_group_http_response_with_props(status, headers, body)
        }
    }
}
