...
impl CreateRegexMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateRegexMatchSet`](crate::operation::create_regex_match_set::CreateRegexMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_regex_match_set::CreateRegexMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_regex_match_set::ser_create_regex_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_regex_match_set::CreateRegexMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateRegexMatchSet", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRegexMatchSet {
                type Output = std::result::Result<crate::operation::create_regex_match_set::CreateRegexMatchSetOutput, crate::operation::create_regex_match_set::CreateRegexMatchSetError>;
