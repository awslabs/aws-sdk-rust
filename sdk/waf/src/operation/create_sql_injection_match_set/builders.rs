...
impl CreateSqlInjectionMatchSetFluentBuilder  {
    /// Creates a new `CreateSqlInjectionMatchSet`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSet, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetOutput, aws_smithy_http::result::SdkError<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetError>>
                     {
