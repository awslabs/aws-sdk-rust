...
impl ListSubscribedRuleGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
