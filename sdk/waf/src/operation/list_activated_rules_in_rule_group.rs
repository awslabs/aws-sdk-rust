...
impl ListActivatedRulesInRuleGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_activated_rules_in_rule_group::ListActivatedRulesInRuleGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListActivatedRulesInRuleGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_activated_rules_in_rule_group::de_list_activated_rules_in_rule_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
