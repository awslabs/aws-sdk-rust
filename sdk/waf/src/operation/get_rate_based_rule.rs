...
impl GetRateBasedRuleInput {
    /// Consumes the builder and constructs an Operation<[`GetRateBasedRule`](crate::operation::get_rate_based_rule::GetRateBasedRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_rate_based_rule::GetRateBasedRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_rate_based_rule::GetRateBasedRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_rate_based_rule::ser_get_rate_based_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_rate_based_rule::GetRateBasedRule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRateBasedRule", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRateBasedRule {
                type Output = std::result::Result<crate::operation::get_rate_based_rule::GetRateBasedRuleOutput, crate::operation::get_rate_based_rule::GetRateBasedRuleError>;
