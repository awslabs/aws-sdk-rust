...
/// Orchestration and serialization glue logic for `GetRateBasedRule`.
...
impl GetRateBasedRule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_rate_based_rule::GetRateBasedRuleInput,
                    ) -> ::std::result::Result<crate::operation::get_rate_based_rule::GetRateBasedRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_rate_based_rule::GetRateBasedRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_rate_based_rule::GetRateBasedRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_rate_based_rule::GetRateBasedRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRateBasedRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRateBasedRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRateBasedRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRateBasedRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRateBasedRule")
...
.with_interceptor(GetRateBasedRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_rate_based_rule::GetRateBasedRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_rate_based_rule::GetRateBasedRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_rate_based_rule::GetRateBasedRuleError>::new());
...
#[derive(Debug)]
            struct GetRateBasedRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRateBasedRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_rate_based_rule::de_get_rate_based_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_rate_based_rule::de_get_rate_based_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRateBasedRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRateBasedRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_rate_based_rule::GetRateBasedRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_rate_based_rule::GetRateBasedRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_rate_based_rule::ser_get_rate_based_rule_input(&input)?);
...
#[derive(Debug)]
            struct GetRateBasedRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRateBasedRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRateBasedRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRateBasedRuleInput>()
                        .ok_or("failed to downcast to GetRateBasedRuleInput")?;
...
pub enum GetRateBasedRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRateBasedRuleError) for what information is available for the error.")]
...
impl GetRateBasedRuleError {
    /// Creates the `GetRateBasedRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRateBasedRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRateBasedRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_rate_based_rule::GetRateBasedRuleError {
...
mod _get_rate_based_rule_output;
