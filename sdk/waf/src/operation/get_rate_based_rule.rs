...
impl GetRateBasedRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_rate_based_rule::ser_get_rate_based_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRateBasedRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_rate_based_rule::de_get_rate_based_rule_http_response_with_props(status, headers, body)
        }
    }
}
