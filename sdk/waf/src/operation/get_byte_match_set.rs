...
impl GetByteMatchSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_byte_match_set::GetByteMatchSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_byte_match_set::ser_get_byte_match_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetByteMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_byte_match_set::de_get_byte_match_set_http_response_with_props(status, headers, body)
        }
    }
}
