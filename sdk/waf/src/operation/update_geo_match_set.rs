...
impl UpdateGeoMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGeoMatchSet`](crate::operation::update_geo_match_set::UpdateGeoMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_geo_match_set::UpdateGeoMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_geo_match_set::UpdateGeoMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_geo_match_set::ser_update_geo_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_geo_match_set::UpdateGeoMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateGeoMatchSet", "waf"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateGeoMatchSet`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGeoMatchSet {
                type Output = std::result::Result<crate::operation::update_geo_match_set::UpdateGeoMatchSetOutput, crate::operation::update_geo_match_set::UpdateGeoMatchSetError>;
