...
impl UpdateGeoMatchSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_geo_match_set::ser_update_geo_match_set_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_geo_match_set::UpdateGeoMatchSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGeoMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_geo_match_set::de_update_geo_match_set_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_geo_match_set::UpdateGeoMatchSetError
{
