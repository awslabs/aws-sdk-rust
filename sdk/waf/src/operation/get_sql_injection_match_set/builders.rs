...
impl GetSqlInjectionMatchSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_sql_injection_match_set::GetSqlInjectionMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sql_injection_match_set::GetSqlInjectionMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_sql_injection_match_set::GetSqlInjectionMatchSetOutput, crate::operation::get_sql_injection_match_set::GetSqlInjectionMatchSetError, Self> {
