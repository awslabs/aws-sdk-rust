...
impl GetRateBasedRuleManagedKeys {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRateBasedRuleManagedKeys {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRateBasedRuleManagedKeys");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRateBasedRuleManagedKeysRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRateBasedRuleManagedKeysResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRateBasedRuleManagedKeys")
...
.with_interceptor(GetRateBasedRuleManagedKeysEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError>::new());
...
#[derive(Debug)]
            struct GetRateBasedRuleManagedKeysResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRateBasedRuleManagedKeysResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_rate_based_rule_managed_keys::de_get_rate_based_rule_managed_keys_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRateBasedRuleManagedKeysRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRateBasedRuleManagedKeysRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_rate_based_rule_managed_keys::ser_get_rate_based_rule_managed_keys_input(&input)?);
...
#[derive(Debug)]
            struct GetRateBasedRuleManagedKeysEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRateBasedRuleManagedKeysEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRateBasedRuleManagedKeysEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRateBasedRuleManagedKeysInput>()
                        .ok_or("failed to downcast to GetRateBasedRuleManagedKeysInput")?;
...
pub enum GetRateBasedRuleManagedKeysError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRateBasedRuleManagedKeysError) for what information is available for the error.")]
...
impl GetRateBasedRuleManagedKeysError {
    /// Creates the `GetRateBasedRuleManagedKeysError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRateBasedRuleManagedKeysError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRateBasedRuleManagedKeysError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError {
