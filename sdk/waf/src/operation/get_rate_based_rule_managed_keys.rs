...
impl GetRateBasedRuleManagedKeys {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WAF", "GetRateBasedRuleManagedKeys", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WAF.GetRateBasedRuleManagedKeys",
                "rpc.service" = "WAF",
                "rpc.method" = "GetRateBasedRuleManagedKeys",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRateBasedRuleManagedKeys {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRateBasedRuleManagedKeysRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetRateBasedRuleManagedKeysResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetRateBasedRuleManagedKeys")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRateBasedRuleManagedKeys")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRateBasedRuleManagedKeysTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetRateBasedRuleManagedKeysTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRateBasedRuleManagedKeysTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetRateBasedRuleManagedKeysInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRateBasedRuleManagedKeysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_rate_based_rule_managed_keys::de_get_rate_based_rule_managed_keys_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_rate_based_rule_managed_keys::de_get_rate_based_rule_managed_keys_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRateBasedRuleManagedKeysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_rate_based_rule_managed_keys::ser_get_rate_based_rule_managed_keys_input(&input)?,
        );
