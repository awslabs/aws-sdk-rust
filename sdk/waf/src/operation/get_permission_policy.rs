...
impl GetPermissionPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetPermissionPolicy`](crate::operation::get_permission_policy::GetPermissionPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_permission_policy::GetPermissionPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_permission_policy::GetPermissionPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_permission_policy::ser_get_permission_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_permission_policy::GetPermissionPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPermissionPolicy", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPermissionPolicy {
                type Output = std::result::Result<crate::operation::get_permission_policy::GetPermissionPolicyOutput, crate::operation::get_permission_policy::GetPermissionPolicyError>;
