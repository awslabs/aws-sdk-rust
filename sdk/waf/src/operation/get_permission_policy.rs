...
impl GetPermissionPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_permission_policy::ser_get_permission_policy_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_permission_policy::GetPermissionPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPermissionPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_permission_policy::de_get_permission_policy_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_permission_policy::GetPermissionPolicyError
{
