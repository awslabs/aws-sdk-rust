...
impl GetChangeTokenStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_change_token_status::GetChangeTokenStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_change_token_status::GetChangeTokenStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_change_token_status::GetChangeTokenStatusOutput, crate::operation::get_change_token_status::GetChangeTokenStatusError, Self> {
