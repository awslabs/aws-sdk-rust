...
pub use crate::operation::delete_xss_match_set::_delete_xss_match_set_output::DeleteXssMatchSetOutputBuilder;

pub use crate::operation::delete_xss_match_set::_delete_xss_match_set_input::DeleteXssMatchSetInputBuilder;
...
impl DeleteXssMatchSetInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_xss_match_set();
...
pub struct DeleteXssMatchSetFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_xss_match_set::builders::DeleteXssMatchSetInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_xss_match_set::DeleteXssMatchSetOutput,
                    crate::operation::delete_xss_match_set::DeleteXssMatchSetError,
                > for DeleteXssMatchSetFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteXssMatchSetFluentBuilder {
    ...
    /// Access the DeleteXssMatchSet as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_xss_match_set::builders::DeleteXssMatchSetInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_xss_match_set::DeleteXssMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_xss_match_set::DeleteXssMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_xss_match_set::DeleteXssMatchSet::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_xss_match_set::DeleteXssMatchSet::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_xss_match_set::DeleteXssMatchSetOutput, crate::operation::delete_xss_match_set::DeleteXssMatchSetError, Self> {
