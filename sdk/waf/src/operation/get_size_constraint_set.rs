...
/// Orchestration and serialization glue logic for `GetSizeConstraintSet`.
...
impl GetSizeConstraintSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_size_constraint_set::GetSizeConstraintSetInput,
                    ) -> ::std::result::Result<crate::operation::get_size_constraint_set::GetSizeConstraintSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_size_constraint_set::GetSizeConstraintSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_size_constraint_set::GetSizeConstraintSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_size_constraint_set::GetSizeConstraintSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSizeConstraintSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSizeConstraintSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSizeConstraintSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSizeConstraintSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSizeConstraintSet")
...
.with_interceptor(GetSizeConstraintSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_size_constraint_set::GetSizeConstraintSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_size_constraint_set::GetSizeConstraintSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_size_constraint_set::GetSizeConstraintSetError>::new());
...
#[derive(Debug)]
            struct GetSizeConstraintSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSizeConstraintSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_size_constraint_set::de_get_size_constraint_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_size_constraint_set::de_get_size_constraint_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetSizeConstraintSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSizeConstraintSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_size_constraint_set::GetSizeConstraintSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_size_constraint_set::GetSizeConstraintSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_size_constraint_set::ser_get_size_constraint_set_input(&input)?);
...
#[derive(Debug)]
            struct GetSizeConstraintSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSizeConstraintSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSizeConstraintSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSizeConstraintSetInput>()
                        .ok_or("failed to downcast to GetSizeConstraintSetInput")?;
...
pub enum GetSizeConstraintSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSizeConstraintSetError) for what information is available for the error.")]
...
impl GetSizeConstraintSetError {
    /// Creates the `GetSizeConstraintSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSizeConstraintSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSizeConstraintSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_size_constraint_set::GetSizeConstraintSetError {
...
mod _get_size_constraint_set_output;
