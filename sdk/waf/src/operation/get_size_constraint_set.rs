...
impl GetSizeConstraintSetInput {
    /// Consumes the builder and constructs an Operation<[`GetSizeConstraintSet`](crate::operation::get_size_constraint_set::GetSizeConstraintSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_size_constraint_set::GetSizeConstraintSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_size_constraint_set::GetSizeConstraintSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_size_constraint_set::ser_get_size_constraint_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_size_constraint_set::GetSizeConstraintSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSizeConstraintSet", "waf"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetSizeConstraintSet {
                type Output = std::result::Result<crate::operation::get_size_constraint_set::GetSizeConstraintSetOutput, crate::operation::get_size_constraint_set::GetSizeConstraintSetError>;
