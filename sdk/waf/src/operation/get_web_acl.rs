...
impl GetWebAclInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_web_acl::GetWebACL,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_web_acl::GetWebACL::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWebACL {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_web_acl::de_get_web_acl_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_web_acl::de_get_web_acl_http_response_with_props(
                status, headers, body,
            )
        }
    }
