...
/// <ul>
/// <li>
/// <p><code>Action</code>: Whether to insert the object into or delete the object from the array. To change a <code>SqlInjectionMatchTuple</code>, you delete the existing object and add a new one.</p></li>
/// <li>
...
/// <li>
/// <p><code>TextTransformation</code>: Which text transformation, if any, to perform on the web request before inspecting the request for snippets of malicious SQL code.</p>
...
/// <li>
/// <p>Submit an <code>UpdateSqlInjectionMatchSet</code> request to specify the parts of web requests that you want AWS WAF to inspect for snippets of SQL code.</p></li>
/// </ol>
...
impl UpdateSqlInjectionMatchSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetOutput, crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetError, Self> {
