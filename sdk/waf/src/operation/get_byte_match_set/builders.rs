...
impl GetByteMatchSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_byte_match_set::GetByteMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_byte_match_set::GetByteMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_byte_match_set::GetByteMatchSetOutput, crate::operation::get_byte_match_set::GetByteMatchSetError, Self> {
