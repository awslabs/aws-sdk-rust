...
pub struct WafInvalidParameterException  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub field: std::option::Option<crate::model::ParameterExceptionField>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub parameter: std::option::Option<std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub reason: std::option::Option<crate::model::ParameterExceptionReason>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
}
...
pub struct WafEntityMigrationException  {
    ...
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub migration_error_type: std::option::Option<crate::model::MigrationErrorType>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub migration_error_reason: std::option::Option<std::string::String>,
}
