...
impl super::Client {
    ...
    ///   - [`size_constraint_set_id(impl ::std::convert::Into<String>)`](crate::operation::delete_size_constraint_set::builders::DeleteSizeConstraintSetFluentBuilder::size_constraint_set_id) / [`set_size_constraint_set_id(Option<String>)`](crate::operation::delete_size_constraint_set::builders::DeleteSizeConstraintSetFluentBuilder::set_size_constraint_set_id): <p>The <code>SizeConstraintSetId</code> of the <code>SizeConstraintSet</code> that you want to delete. <code>SizeConstraintSetId</code> is returned by <code>CreateSizeConstraintSet</code> and by <code>ListSizeConstraintSets</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::delete_size_constraint_set::builders::DeleteSizeConstraintSetFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::delete_size_constraint_set::builders::DeleteSizeConstraintSetFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
