...
impl super::Client {
    ...
    ///   - [`size_constraint_set_id(impl ::std::convert::Into<String>)`](crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetFluentBuilder::size_constraint_set_id) / [`set_size_constraint_set_id(Option<String>)`](crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetFluentBuilder::set_size_constraint_set_id): <p>The <code>SizeConstraintSetId</code> of the <code>SizeConstraintSet</code> that you want to update. <code>SizeConstraintSetId</code> is returned by <code>CreateSizeConstraintSet</code> and by <code>ListSizeConstraintSets</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
    ///   - [`updates(Vec<SizeConstraintSetUpdate>)`](crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetFluentBuilder::updates) / [`set_updates(Option<Vec<SizeConstraintSetUpdate>>)`](crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetFluentBuilder::set_updates): <p>An array of <code>SizeConstraintSetUpdate</code> objects that you want to insert into or delete from a <code>SizeConstraintSet</code>. For more information, see the applicable data types:</p>  <ul>   <li> <p> <code>SizeConstraintSetUpdate</code>: Contains <code>Action</code> and <code>SizeConstraint</code> </p> </li>   <li> <p> <code>SizeConstraint</code>: Contains <code>FieldToMatch</code>, <code>TextTransformation</code>, <code>ComparisonOperator</code>, and <code>Size</code> </p> </li>   <li> <p> <code>FieldToMatch</code>: Contains <code>Data</code> and <code>Type</code> </p> </li>  </ul>
