...
impl super::Client {
    ...
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::get_change_token_status::builders::GetChangeTokenStatusFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::get_change_token_status::builders::GetChangeTokenStatusFluentBuilder::set_change_token): <p>The change token for which you want to get the status. This change token was previously returned in the <code>GetChangeToken</code> response.</p>
