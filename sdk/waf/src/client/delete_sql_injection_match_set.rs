...
impl super::Client {
    ...
    ///   - [`sql_injection_match_set_id(impl ::std::convert::Into<String>)`](crate::operation::delete_sql_injection_match_set::builders::DeleteSqlInjectionMatchSetFluentBuilder::sql_injection_match_set_id) / [`set_sql_injection_match_set_id(Option<String>)`](crate::operation::delete_sql_injection_match_set::builders::DeleteSqlInjectionMatchSetFluentBuilder::set_sql_injection_match_set_id): <p>The <code>SqlInjectionMatchSetId</code> of the <code>SqlInjectionMatchSet</code> that you want to delete. <code>SqlInjectionMatchSetId</code> is returned by <code>CreateSqlInjectionMatchSet</code> and by <code>ListSqlInjectionMatchSets</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::delete_sql_injection_match_set::builders::DeleteSqlInjectionMatchSetFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::delete_sql_injection_match_set::builders::DeleteSqlInjectionMatchSetFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
