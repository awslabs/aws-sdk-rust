...
impl super::Client {
    ...
    ///   - [`rule_group_id(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::rule_group_id) / [`set_rule_group_id(Option<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::set_rule_group_id): <p>The <code>RuleGroupId</code> of the <code>RuleGroup</code> that you want to delete. <code>RuleGroupId</code> is returned by <code>CreateRuleGroup</code> and by <code>ListRuleGroups</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
