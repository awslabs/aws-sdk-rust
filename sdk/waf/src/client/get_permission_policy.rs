...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::get_permission_policy::builders::GetPermissionPolicyFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_permission_policy::builders::GetPermissionPolicyFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the RuleGroup for which you want to get the policy.</p>
