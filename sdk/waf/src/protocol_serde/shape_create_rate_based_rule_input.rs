...
pub fn ser_create_rate_based_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRateBasedRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
