...
pub fn ser_rule_group_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleGroupUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
