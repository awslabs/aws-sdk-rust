...
pub fn de_create_rule_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_rule::CreateRuleOutput, crate::operation::create_rule::CreateRuleError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "WAFBadRequestException" => crate::operation::create_rule::CreateRuleError::WafBadRequestException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_waf_bad_request_exception::de_waf_bad_request_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_rule::CreateRuleError::unhandled)?;
...
) -> Result<crate::operation::create_rule::builders::CreateRuleOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
