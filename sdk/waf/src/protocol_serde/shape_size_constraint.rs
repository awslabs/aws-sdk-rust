...
pub fn ser_size_constraint(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SizeConstraint) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_size_constraint<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SizeConstraint>, aws_smithy_json::deserialize::error::DeserializeError>
