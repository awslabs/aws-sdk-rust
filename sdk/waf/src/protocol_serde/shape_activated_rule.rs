...
pub(crate) fn de_activated_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ActivatedRule>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_activated_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActivatedRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
