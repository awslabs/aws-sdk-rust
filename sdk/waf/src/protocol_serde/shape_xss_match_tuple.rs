...
pub fn ser_xss_match_tuple(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::XssMatchTuple) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_xss_match_tuple<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::XssMatchTuple>, aws_smithy_json::deserialize::error::DeserializeError>
