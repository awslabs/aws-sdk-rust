...
pub fn de_delete_web_acl_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteWebAclOutput, crate::error::DeleteWebACLError> {
    ...
    Err(match error_code {
        ...
        "WAFInvalidAccountException" => crate::error::DeleteWebACLError::WafInvalidAccountException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "WAFNonEmptyEntityException" => crate::error::DeleteWebACLError::WafNonEmptyEntityException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "WAFReferencedItemException" => crate::error::DeleteWebACLError::WafReferencedItemException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
pub fn de_delete_web_acl_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteWebAclOutput, crate::error::DeleteWebACLError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_web_acl::de_delete_web_acl(response.body().as_ref(), output).map_err(crate::error::DeleteWebACLError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_web_acl(value: &[u8], mut builder: crate::output::delete_web_acl_output::Builder) -> Result<crate::output::delete_web_acl_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
