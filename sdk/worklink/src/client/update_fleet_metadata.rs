...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::update_fleet_metadata::builders::UpdateFleetMetadataFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::update_fleet_metadata::builders::UpdateFleetMetadataFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::update_fleet_metadata::builders::UpdateFleetMetadataFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_fleet_metadata::builders::UpdateFleetMetadataFluentBuilder::set_display_name): <p>The fleet name to display. The existing DisplayName is unset if null is passed.</p>
