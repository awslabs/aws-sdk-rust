...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::update_domain_metadata::builders::UpdateDomainMetadataFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::update_domain_metadata::builders::UpdateDomainMetadataFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::update_domain_metadata::builders::UpdateDomainMetadataFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::update_domain_metadata::builders::UpdateDomainMetadataFluentBuilder::set_domain_name): <p>The name of the domain.</p>
