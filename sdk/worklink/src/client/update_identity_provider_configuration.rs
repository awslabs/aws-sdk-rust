...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::update_identity_provider_configuration::builders::UpdateIdentityProviderConfigurationFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::update_identity_provider_configuration::builders::UpdateIdentityProviderConfigurationFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
