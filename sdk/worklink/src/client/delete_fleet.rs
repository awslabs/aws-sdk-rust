...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl Into<String>)`](crate::operation::delete_fleet::builders::DeleteFleetFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::delete_fleet::builders::DeleteFleetFluentBuilder::set_fleet_arn):<br>required: **true**<br><p>The ARN of the fleet.</p><br>
