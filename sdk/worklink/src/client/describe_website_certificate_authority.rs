...
impl super::Client  {
    ...
    pub fn describe_website_certificate_authority(&self) -> crate::client::fluent_builders::DescribeWebsiteCertificateAuthority {
                                crate::client::fluent_builders::DescribeWebsiteCertificateAuthority::new(self.handle.clone())
                            }
}
