...
impl super::Client  {
    ...
    pub fn disassociate_website_certificate_authority(&self) -> crate::client::fluent_builders::DisassociateWebsiteCertificateAuthority {
                                crate::client::fluent_builders::DisassociateWebsiteCertificateAuthority::new(self.handle.clone())
                            }
}
