...
impl super::Client  {
    ...
    pub fn describe_identity_provider_configuration(&self) -> crate::client::fluent_builders::DescribeIdentityProviderConfiguration {
                                crate::client::fluent_builders::DescribeIdentityProviderConfiguration::new(self.handle.clone())
                            }
}
