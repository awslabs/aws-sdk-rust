...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl Into<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::set_fleet_arn):<br>required: **true**<br><p>The ARN of the fleet.</p><br>
    ///   - [`authorization_provider_type(AuthorizationProviderType)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::authorization_provider_type) / [`set_authorization_provider_type(Option<AuthorizationProviderType>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::set_authorization_provider_type):<br>required: **true**<br><p>The authorization provider type.</p><br>
    ///   - [`domain_name(impl Into<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::set_domain_name):<br>required: **false**<br><p>The domain name of the authorization provider. This applies only to SAML-based authorization providers.</p><br>
