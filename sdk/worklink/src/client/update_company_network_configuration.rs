...
impl super::Client {
    ...
    ///   - [`security_group_ids(impl Into<String>)`](crate::operation::update_company_network_configuration::builders::UpdateCompanyNetworkConfigurationFluentBuilder::security_group_ids) / [`set_security_group_ids(Option<Vec<String>>)`](crate::operation::update_company_network_configuration::builders::UpdateCompanyNetworkConfigurationFluentBuilder::set_security_group_ids): <p>The security groups associated with access to the provided subnets.</p>
