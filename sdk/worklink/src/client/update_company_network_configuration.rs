...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::update_company_network_configuration::builders::UpdateCompanyNetworkConfigurationFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::update_company_network_configuration::builders::UpdateCompanyNetworkConfigurationFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
    ///   - [`vpc_id(impl ::std::convert::Into<String>)`](crate::operation::update_company_network_configuration::builders::UpdateCompanyNetworkConfigurationFluentBuilder::vpc_id) / [`set_vpc_id(Option<String>)`](crate::operation::update_company_network_configuration::builders::UpdateCompanyNetworkConfigurationFluentBuilder::set_vpc_id): <p>The VPC with connectivity to associated websites.</p>
