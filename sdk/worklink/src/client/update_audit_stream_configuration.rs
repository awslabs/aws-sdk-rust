...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::update_audit_stream_configuration::builders::UpdateAuditStreamConfigurationFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::update_audit_stream_configuration::builders::UpdateAuditStreamConfigurationFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
