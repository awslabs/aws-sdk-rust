...
impl super::Client {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_audit_stream_configuration::builders::DescribeAuditStreamConfigurationFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::describe_audit_stream_configuration::builders::DescribeAuditStreamConfigurationFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
