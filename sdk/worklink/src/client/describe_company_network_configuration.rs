...
impl super::Client  {
    ...
    pub fn describe_company_network_configuration(&self) -> crate::client::fluent_builders::DescribeCompanyNetworkConfiguration {
                                crate::client::fluent_builders::DescribeCompanyNetworkConfiguration::new(self.handle.clone())
                            }
}
