...
//! offered by Amazon WorkLink. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon WorkLink.
...
/// For example, the [`AssociateDomain`](crate::operation::associate_domain) operation has
/// a [`Client::associate_domain`], function which returns a builder for that operation.
...
/// Configuration for Amazon WorkLink.
pub mod config;
