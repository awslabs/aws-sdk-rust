...
pub fn serialize_structure_associate_domain_input(
    ...
    if let Some(var_2) = &input.display_name {
        object.key("DisplayName").string(var_2);
    }
...
pub fn serialize_structure_associate_website_authorization_provider_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_associate_website_certificate_authority_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_fleet_input(
    ...
    if let Some(var_12) = &input.fleet_name {
        object.key("FleetName").string(var_12);
    }
...
pub fn serialize_structure_describe_audit_stream_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_company_network_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_device_policy_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_fleet_metadata_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_identity_provider_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_website_certificate_authority_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_website_authorization_provider_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_website_certificate_authority_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_website_authorization_providers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_website_certificate_authorities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_restore_domain_access_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_revoke_domain_access_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_sign_out_user_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_audit_stream_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_company_network_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_device_policy_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_domain_metadata_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_fleet_metadata_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_76) = &input.fleet_arn {
        object.key("FleetArn").string(var_76);
    }
...
pub fn serialize_structure_update_identity_provider_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_79) = &input.identity_provider_saml_metadata {
        object.key("IdentityProviderSamlMetadata").string(var_79);
    }
