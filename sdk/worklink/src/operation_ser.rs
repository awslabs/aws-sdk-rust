...
pub fn serialize_operation_crate_operation_associate_website_authorization_provider(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_associate_website_authorization_provider_input(
        &mut object,
        input,
    );
    object.finish();
...
pub fn serialize_operation_crate_operation_describe_identity_provider_configuration(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_describe_identity_provider_configuration_input(
        &mut object,
        input,
    );
    object.finish();
