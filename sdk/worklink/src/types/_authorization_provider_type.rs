...
impl ::std::convert::From<&str> for AuthorizationProviderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthorizationProviderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthorizationProviderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthorizationProviderType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthorizationProviderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
