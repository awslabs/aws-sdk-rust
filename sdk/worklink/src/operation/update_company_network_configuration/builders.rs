...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationOutput,
                    crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError,
                > for UpdateCompanyNetworkConfigurationFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateCompanyNetworkConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfiguration::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfiguration::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationOutput, crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError, Self> {
