    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_website_authorization_provider::DisassociateWebsiteAuthorizationProvider, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/disassociateWebsiteAuthorizationProvider")
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateWebsiteAuthorizationProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_website_authorization_provider::de_disassociate_website_authorization_provider_http_response_with_props(status, headers, body)
        }
    }
}
