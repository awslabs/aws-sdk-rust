...
impl crate::operation::update_audit_stream_configuration::builders::UpdateAuditStreamConfigurationInputBuilder {
...
impl UpdateAuditStreamConfigurationFluentBuilder {
    /// Creates a new `UpdateAuditStreamConfigurationFluentBuilder`.
