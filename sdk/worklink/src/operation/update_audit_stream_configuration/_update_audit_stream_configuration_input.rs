...
impl UpdateAuditStreamConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
