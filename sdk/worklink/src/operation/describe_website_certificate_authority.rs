...
impl DescribeWebsiteCertificateAuthorityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_website_certificate_authority::DescribeWebsiteCertificateAuthority::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWebsiteCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_website_certificate_authority::de_describe_website_certificate_authority_http_response_with_props(
                status, headers, body,
            )
        }
    }
