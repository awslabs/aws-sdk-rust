    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_website_certificate_authority::DescribeWebsiteCertificateAuthority, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/describeWebsiteCertificateAuthority")
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWebsiteCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_website_certificate_authority::de_describe_website_certificate_authority_http_response_with_props(status, headers, body)
        }
    }
}
