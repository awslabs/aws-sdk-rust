    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListWebsiteCertificateAuthorities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListWebsiteCertificateAuthorities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListWebsiteCertificateAuthoritiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListWebsiteCertificateAuthoritiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWebsiteCertificateAuthorities")
...
.with_interceptor(ListWebsiteCertificateAuthoritiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError>::new());
...
#[derive(Debug)]
            struct ListWebsiteCertificateAuthoritiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListWebsiteCertificateAuthoritiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_website_certificate_authorities::de_list_website_certificate_authorities_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListWebsiteCertificateAuthoritiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListWebsiteCertificateAuthoritiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_website_certificate_authorities::ser_list_website_certificate_authorities_input(&input)?);
...
#[derive(Debug)]
            struct ListWebsiteCertificateAuthoritiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListWebsiteCertificateAuthoritiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListWebsiteCertificateAuthoritiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListWebsiteCertificateAuthoritiesInput>()
                        .ok_or("failed to downcast to ListWebsiteCertificateAuthoritiesInput")?;
...
pub enum ListWebsiteCertificateAuthoritiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListWebsiteCertificateAuthoritiesError) for what information is available for the error.")]
...
impl ListWebsiteCertificateAuthoritiesError {
    /// Creates the `ListWebsiteCertificateAuthoritiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListWebsiteCertificateAuthoritiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListWebsiteCertificateAuthoritiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError {
