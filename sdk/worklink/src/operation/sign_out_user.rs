...
impl SignOutUserInput {
    /// Consumes the builder and constructs an Operation<[`SignOutUser`](crate::operation::sign_out_user::SignOutUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::sign_out_user::SignOutUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::sign_out_user::SignOutUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_sign_out_user::ser_sign_out_user_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::sign_out_user::SignOutUser::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SignOutUser", "worklink"));
...
impl aws_smithy_http::response::ParseStrictResponse for SignOutUser {
                type Output = std::result::Result<crate::operation::sign_out_user::SignOutUserOutput, crate::operation::sign_out_user::SignOutUserError>;
