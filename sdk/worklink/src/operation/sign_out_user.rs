...
impl SignOutUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::sign_out_user::SignOutUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SignOutUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_sign_out_user::de_sign_out_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_sign_out_user::de_sign_out_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
