...
impl SignOutUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::sign_out_user::SignOutUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_sign_out_user::ser_sign_out_user_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SignOutUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_sign_out_user::de_sign_out_user_http_response_with_props(status, headers, body)
        }
    }
}
