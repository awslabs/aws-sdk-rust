...
impl DescribeDevicePolicyConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
