...
pub use crate::operation::list_website_certificate_authorities::_list_website_certificate_authorities_output::ListWebsiteCertificateAuthoritiesOutputBuilder;

pub use crate::operation::list_website_certificate_authorities::_list_website_certificate_authorities_input::ListWebsiteCertificateAuthoritiesInputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesOutput,
                    crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError,
                > for ListWebsiteCertificateAuthoritiesFluentBuilder
            {
                fn send(
                    self,
...
impl ListWebsiteCertificateAuthoritiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthorities::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthorities::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesOutput, crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_website_certificate_authorities::paginator::ListWebsiteCertificateAuthoritiesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
