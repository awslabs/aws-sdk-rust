...
impl ListWebsiteAuthorizationProvidersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersInput, ::aws_smithy_types::error::operation::BuildError> {
