...
impl CreateFleetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_fleet::CreateFleet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_fleet::ser_create_fleet_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_fleet::CreateFleet::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFleet", "worklink"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFleet {
    type Output = ::std::result::Result<crate::operation::create_fleet::CreateFleetOutput, crate::operation::create_fleet::CreateFleetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_fleet::de_create_fleet_http_response_with_props(status, headers, body)
        }
    }
}
