    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListWebsiteAuthorizationProviders {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListWebsiteAuthorizationProviders");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListWebsiteAuthorizationProvidersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListWebsiteAuthorizationProvidersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWebsiteAuthorizationProviders")
...
.with_interceptor(ListWebsiteAuthorizationProvidersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError>::new());
...
#[derive(Debug)]
            struct ListWebsiteAuthorizationProvidersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListWebsiteAuthorizationProvidersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_website_authorization_providers::de_list_website_authorization_providers_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListWebsiteAuthorizationProvidersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListWebsiteAuthorizationProvidersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_website_authorization_providers::ser_list_website_authorization_providers_input(&input)?);
...
#[derive(Debug)]
            struct ListWebsiteAuthorizationProvidersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListWebsiteAuthorizationProvidersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListWebsiteAuthorizationProvidersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListWebsiteAuthorizationProvidersInput>()
                        .ok_or("failed to downcast to ListWebsiteAuthorizationProvidersInput")?;
...
pub enum ListWebsiteAuthorizationProvidersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListWebsiteAuthorizationProvidersError) for what information is available for the error.")]
...
impl ListWebsiteAuthorizationProvidersError {
    /// Creates the `ListWebsiteAuthorizationProvidersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListWebsiteAuthorizationProvidersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListWebsiteAuthorizationProvidersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError {
