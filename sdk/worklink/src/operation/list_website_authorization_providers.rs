...
impl ListWebsiteAuthorizationProvidersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProviders::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWebsiteAuthorizationProviders {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_website_authorization_providers::de_list_website_authorization_providers_http_response_with_props(
                status, headers, body,
            )
        }
    }
