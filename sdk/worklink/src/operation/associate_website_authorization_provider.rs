    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_website_authorization_provider::AssociateWebsiteAuthorizationProviderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_website_authorization_provider::AssociateWebsiteAuthorizationProviderOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateWebsiteAuthorizationProvider {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateWebsiteAuthorizationProviderRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateWebsiteAuthorizationProviderResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateWebsiteAuthorizationProviderResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_website_authorization_provider::de_associate_website_authorization_provider_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_website_authorization_provider::de_associate_website_authorization_provider_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateWebsiteAuthorizationProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_website_authorization_provider::AssociateWebsiteAuthorizationProviderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::associate_website_authorization_provider::AssociateWebsiteAuthorizationProviderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_website_authorization_provider::ser_associate_website_authorization_provider_input(&input)?,
        );
