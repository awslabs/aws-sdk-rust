...
impl DescribeDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_device::DescribeDevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_device::ser_describe_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_device::de_describe_device_http_response_with_props(status, headers, body)
        }
    }
}
