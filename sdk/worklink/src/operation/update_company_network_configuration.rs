...
impl UpdateCompanyNetworkConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCompanyNetworkConfiguration`](crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/updateCompanyNetworkConfiguration").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_company_network_configuration::ser_update_company_network_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateCompanyNetworkConfiguration", "worklink"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateCompanyNetworkConfiguration {
                type Output = std::result::Result<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationOutput, crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError>;
