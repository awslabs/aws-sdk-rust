...
impl UpdateCompanyNetworkConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCompanyNetworkConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateCompanyNetworkConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateCompanyNetworkConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateCompanyNetworkConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateCompanyNetworkConfiguration")
...
.with_interceptor(UpdateCompanyNetworkConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError>::new());
...
#[derive(Debug)]
            struct UpdateCompanyNetworkConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateCompanyNetworkConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_company_network_configuration::de_update_company_network_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_company_network_configuration::de_update_company_network_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateCompanyNetworkConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateCompanyNetworkConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/updateCompanyNetworkConfiguration").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_company_network_configuration::ser_update_company_network_configuration_input(&input)?);
...
#[derive(Debug)]
            struct UpdateCompanyNetworkConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateCompanyNetworkConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateCompanyNetworkConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateCompanyNetworkConfigurationInput>()
                        .ok_or("failed to downcast to UpdateCompanyNetworkConfigurationInput")?;
...
pub enum UpdateCompanyNetworkConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateCompanyNetworkConfigurationError) for what information is available for the error.")]
...
impl UpdateCompanyNetworkConfigurationError {
    /// Creates the `UpdateCompanyNetworkConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateCompanyNetworkConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateCompanyNetworkConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateCompanyNetworkConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_company_network_configuration::UpdateCompanyNetworkConfigurationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_company_network_configuration::_update_company_network_configuration_output::UpdateCompanyNetworkConfigurationOutput;

pub use crate::operation::update_company_network_configuration::_update_company_network_configuration_input::UpdateCompanyNetworkConfigurationInput;

mod _update_company_network_configuration_input;

mod _update_company_network_configuration_output;
