...
impl RestoreDomainAccessInput {
    /// Consumes the builder and constructs an Operation<[`RestoreDomainAccess`](crate::operation::restore_domain_access::RestoreDomainAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_domain_access::RestoreDomainAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_domain_access::RestoreDomainAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_domain_access::RestoreDomainAccess::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreDomainAccess {
                type Output = std::result::Result<crate::operation::restore_domain_access::RestoreDomainAccessOutput, crate::operation::restore_domain_access::RestoreDomainAccessError>;
