...
impl RestoreDomainAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::restore_domain_access::RestoreDomainAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::restore_domain_access::RestoreDomainAccessOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("worklink", "RestoreDomainAccess", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreDomainAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RestoreDomainAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RestoreDomainAccessResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RestoreDomainAccess", "worklink"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreDomainAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::restore_domain_access::RestoreDomainAccessInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::restore_domain_access::RestoreDomainAccessInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_restore_domain_access::ser_restore_domain_access_input(
            &input,
        )?);
