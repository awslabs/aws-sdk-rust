...
impl UpdateAuditStreamConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAuditStreamConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_audit_stream_configuration::de_update_audit_stream_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
