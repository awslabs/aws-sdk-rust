...
impl AssociateDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_domain::AssociateDomain, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_domain::ser_associate_domain_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDomain {
    type Output =
        ::std::result::Result<crate::operation::associate_domain::AssociateDomainOutput, crate::operation::associate_domain::AssociateDomainError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_domain::de_associate_domain_http_response_with_props(status, headers, body)
        }
    }
}
