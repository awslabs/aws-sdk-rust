...
impl AssociateDomainInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDomain`](crate::operation::associate_domain::AssociateDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_domain::AssociateDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_domain::AssociateDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_domain::ser_associate_domain_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_domain::AssociateDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateDomain", "worklink"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateDomain {
                type Output = std::result::Result<crate::operation::associate_domain::AssociateDomainOutput, crate::operation::associate_domain::AssociateDomainError>;
