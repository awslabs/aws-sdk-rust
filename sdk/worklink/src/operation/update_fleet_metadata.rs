...
impl UpdateFleetMetadataInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFleetMetadata`](crate::operation::update_fleet_metadata::UpdateFleetMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_fleet_metadata::UpdateFleetMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_fleet_metadata::UpdateFleetMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_fleet_metadata::ser_update_fleet_metadata_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_fleet_metadata::UpdateFleetMetadata::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateFleetMetadata", "worklink"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFleetMetadata {
                type Output = std::result::Result<crate::operation::update_fleet_metadata::UpdateFleetMetadataOutput, crate::operation::update_fleet_metadata::UpdateFleetMetadataError>;
