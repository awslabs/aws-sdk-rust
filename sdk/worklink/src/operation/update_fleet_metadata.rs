...
impl UpdateFleetMetadataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_fleet_metadata::ser_update_fleet_metadata_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_fleet_metadata::UpdateFleetMetadata::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_fleet_metadata::UpdateFleetMetadataError
{
