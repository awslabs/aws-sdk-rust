...
impl UpdateFleetMetadata {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_fleet_metadata::UpdateFleetMetadataInput,
                    ) -> ::std::result::Result<crate::operation::update_fleet_metadata::UpdateFleetMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_fleet_metadata::UpdateFleetMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_fleet_metadata::UpdateFleetMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_fleet_metadata::UpdateFleetMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFleetMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateFleetMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateFleetMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateFleetMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateFleetMetadata")
...
.with_interceptor(UpdateFleetMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_fleet_metadata::UpdateFleetMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_fleet_metadata::UpdateFleetMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_fleet_metadata::UpdateFleetMetadataError>::new());
...
#[derive(Debug)]
            struct UpdateFleetMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFleetMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_fleet_metadata::de_update_fleet_metadata_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_fleet_metadata::de_update_fleet_metadata_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateFleetMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFleetMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_fleet_metadata::UpdateFleetMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_fleet_metadata::UpdateFleetMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/UpdateFleetMetadata").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_fleet_metadata::ser_update_fleet_metadata_input(&input)?);
...
#[derive(Debug)]
            struct UpdateFleetMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateFleetMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateFleetMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateFleetMetadataInput>()
                        .ok_or("failed to downcast to UpdateFleetMetadataInput")?;
...
pub enum UpdateFleetMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateFleetMetadataError) for what information is available for the error.")]
...
impl UpdateFleetMetadataError {
    /// Creates the `UpdateFleetMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateFleetMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateFleetMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_fleet_metadata::UpdateFleetMetadataError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_fleet_metadata::_update_fleet_metadata_output::UpdateFleetMetadataOutput;

pub use crate::operation::update_fleet_metadata::_update_fleet_metadata_input::UpdateFleetMetadataInput;

mod _update_fleet_metadata_input;

mod _update_fleet_metadata_output;
