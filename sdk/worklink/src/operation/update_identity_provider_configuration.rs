...
impl UpdateIdentityProviderConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_identity_provider_configuration::UpdateIdentityProviderConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIdentityProviderConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_identity_provider_configuration::de_update_identity_provider_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
