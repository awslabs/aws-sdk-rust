...
impl UpdateIdentityProviderConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateIdentityProviderConfiguration`](crate::operation::update_identity_provider_configuration::UpdateIdentityProviderConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_identity_provider_configuration::UpdateIdentityProviderConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/updateIdentityProviderConfiguration")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_identity_provider_configuration::UpdateIdentityProviderConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIdentityProviderConfiguration {
    type Output = ::std::result::Result<crate::operation::update_identity_provider_configuration::UpdateIdentityProviderConfigurationOutput, crate::operation::update_identity_provider_configuration::UpdateIdentityProviderConfigurationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_identity_provider_configuration::de_update_identity_provider_configuration_http_response_with_props(status, headers, body)
        }
    }
}
