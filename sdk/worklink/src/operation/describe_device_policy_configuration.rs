...
impl DescribeDevicePolicyConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDevicePolicyConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDevicePolicyConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDevicePolicyConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDevicePolicyConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDevicePolicyConfiguration")
...
.with_interceptor(DescribeDevicePolicyConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationError>::new());
...
#[derive(Debug)]
            struct DescribeDevicePolicyConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDevicePolicyConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_device_policy_configuration::de_describe_device_policy_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_device_policy_configuration::de_describe_device_policy_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDevicePolicyConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDevicePolicyConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/describeDevicePolicyConfiguration").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_device_policy_configuration::ser_describe_device_policy_configuration_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDevicePolicyConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDevicePolicyConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDevicePolicyConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDevicePolicyConfigurationInput>()
                        .ok_or("failed to downcast to DescribeDevicePolicyConfigurationInput")?;
...
pub enum DescribeDevicePolicyConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDevicePolicyConfigurationError) for what information is available for the error.")]
...
impl DescribeDevicePolicyConfigurationError {
    /// Creates the `DescribeDevicePolicyConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDevicePolicyConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDevicePolicyConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDevicePolicyConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_device_policy_configuration::DescribeDevicePolicyConfigurationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_device_policy_configuration::_describe_device_policy_configuration_output::DescribeDevicePolicyConfigurationOutput;

pub use crate::operation::describe_device_policy_configuration::_describe_device_policy_configuration_input::DescribeDevicePolicyConfigurationInput;

mod _describe_device_policy_configuration_input;

mod _describe_device_policy_configuration_output;
