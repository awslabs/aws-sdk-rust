...
/// Orchestration and serialization glue logic for `DisassociateWebsiteCertificateAuthority`.
...
impl DisassociateWebsiteCertificateAuthority {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateWebsiteCertificateAuthority {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateWebsiteCertificateAuthority");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateWebsiteCertificateAuthorityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateWebsiteCertificateAuthorityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateWebsiteCertificateAuthority")
...
.with_interceptor(DisassociateWebsiteCertificateAuthorityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityError>::new());
...
#[derive(Debug)]
            struct DisassociateWebsiteCertificateAuthorityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateWebsiteCertificateAuthorityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_website_certificate_authority::de_disassociate_website_certificate_authority_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_website_certificate_authority::de_disassociate_website_certificate_authority_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateWebsiteCertificateAuthorityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateWebsiteCertificateAuthorityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/disassociateWebsiteCertificateAuthority").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_website_certificate_authority::ser_disassociate_website_certificate_authority_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateWebsiteCertificateAuthorityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateWebsiteCertificateAuthorityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateWebsiteCertificateAuthorityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateWebsiteCertificateAuthorityInput>()
                        .ok_or("failed to downcast to DisassociateWebsiteCertificateAuthorityInput")?;
...
pub enum DisassociateWebsiteCertificateAuthorityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateWebsiteCertificateAuthorityError) for what information is available for the error.")]
...
impl DisassociateWebsiteCertificateAuthorityError {
    /// Creates the `DisassociateWebsiteCertificateAuthorityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateWebsiteCertificateAuthorityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateWebsiteCertificateAuthorityError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateWebsiteCertificateAuthorityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_website_certificate_authority::DisassociateWebsiteCertificateAuthorityError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::disassociate_website_certificate_authority::_disassociate_website_certificate_authority_output::DisassociateWebsiteCertificateAuthorityOutput;

pub use crate::operation::disassociate_website_certificate_authority::_disassociate_website_certificate_authority_input::DisassociateWebsiteCertificateAuthorityInput;

mod _disassociate_website_certificate_authority_input;

mod _disassociate_website_certificate_authority_output;
