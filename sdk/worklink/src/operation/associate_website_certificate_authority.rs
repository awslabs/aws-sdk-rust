...
impl AssociateWebsiteCertificateAuthorityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthority::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateWebsiteCertificateAuthority {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_website_certificate_authority::de_associate_website_certificate_authority_http_response_with_props(
                status, headers, body,
            )
        }
    }
