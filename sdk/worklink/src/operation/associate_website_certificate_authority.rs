...
/// Orchestration and serialization glue logic for `AssociateWebsiteCertificateAuthority`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateWebsiteCertificateAuthority {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateWebsiteCertificateAuthority");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateWebsiteCertificateAuthorityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateWebsiteCertificateAuthorityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateWebsiteCertificateAuthority")
...
.with_interceptor(AssociateWebsiteCertificateAuthorityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError>::new());
...
#[derive(Debug)]
            struct AssociateWebsiteCertificateAuthorityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateWebsiteCertificateAuthorityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_website_certificate_authority::de_associate_website_certificate_authority_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_website_certificate_authority::de_associate_website_certificate_authority_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateWebsiteCertificateAuthorityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateWebsiteCertificateAuthorityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/associateWebsiteCertificateAuthority").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_website_certificate_authority::ser_associate_website_certificate_authority_input(&input)?);
...
#[derive(Debug)]
            struct AssociateWebsiteCertificateAuthorityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateWebsiteCertificateAuthorityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateWebsiteCertificateAuthorityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateWebsiteCertificateAuthorityInput>()
                        .ok_or("failed to downcast to AssociateWebsiteCertificateAuthorityInput")?;
...
pub enum AssociateWebsiteCertificateAuthorityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateWebsiteCertificateAuthorityError) for what information is available for the error.")]
...
impl AssociateWebsiteCertificateAuthorityError {
    /// Creates the `AssociateWebsiteCertificateAuthorityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateWebsiteCertificateAuthorityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateWebsiteCertificateAuthorityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::associate_website_certificate_authority::_associate_website_certificate_authority_output::AssociateWebsiteCertificateAuthorityOutput;

pub use crate::operation::associate_website_certificate_authority::_associate_website_certificate_authority_input::AssociateWebsiteCertificateAuthorityInput;

mod _associate_website_certificate_authority_input;

mod _associate_website_certificate_authority_output;
