...
impl AssociateWebsiteCertificateAuthorityInput {
    /// Consumes the builder and constructs an Operation<[`AssociateWebsiteCertificateAuthority`](crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthority)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthority, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/associateWebsiteCertificateAuthority").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_website_certificate_authority::ser_associate_website_certificate_authority_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthority::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateWebsiteCertificateAuthority", "worklink"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateWebsiteCertificateAuthority {
                type Output = std::result::Result<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityOutput, crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError>;
