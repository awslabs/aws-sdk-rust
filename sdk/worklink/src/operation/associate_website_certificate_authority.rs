    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateWebsiteCertificateAuthority {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateWebsiteCertificateAuthorityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateWebsiteCertificateAuthorityResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateWebsiteCertificateAuthorityResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_website_certificate_authority::de_associate_website_certificate_authority_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_website_certificate_authority::de_associate_website_certificate_authority_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateWebsiteCertificateAuthorityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_website_certificate_authority::ser_associate_website_certificate_authority_input(&input)?,
        );
