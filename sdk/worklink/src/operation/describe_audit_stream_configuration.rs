...
impl DescribeAuditStreamConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_audit_stream_configuration::DescribeAuditStreamConfiguration,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/describeAuditStreamConfiguration")
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAuditStreamConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_audit_stream_configuration::de_describe_audit_stream_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_audit_stream_configuration::DescribeAuditStreamConfigurationError
{
