...
pub(crate) fn website_authorization_provider_summary_correct_errors(
    mut builder: crate::types::builders::WebsiteAuthorizationProviderSummaryBuilder,
) -> crate::types::builders::WebsiteAuthorizationProviderSummaryBuilder {
    if builder.authorization_provider_type.is_none() {
        builder.authorization_provider_type = "no value was set".parse::<crate::types::AuthorizationProviderType>().ok()
    }
    builder
}
