...
pub fn ser_associate_website_certificate_authority_input(
    ...
    crate::protocol_serde::shape_associate_website_certificate_authority_input::ser_associate_website_certificate_authority_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidRequestException" => {
            crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output =
                        crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(_response_body, output)
                            .map_err(
                                crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "UnauthorizedException" => {
            crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError::UnauthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_website_certificate_authority_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_associate_website_certificate_authority::de_associate_website_certificate_authority(_response_body, output)
                .map_err(crate::operation::associate_website_certificate_authority::AssociateWebsiteCertificateAuthorityError::unhandled)?;
...
pub(crate) fn de_associate_website_certificate_authority(
    value: &[u8],
    mut builder: crate::operation::associate_website_certificate_authority::builders::AssociateWebsiteCertificateAuthorityOutputBuilder,
) -> Result<
    crate::operation::associate_website_certificate_authority::builders::AssociateWebsiteCertificateAuthorityOutputBuilder,
