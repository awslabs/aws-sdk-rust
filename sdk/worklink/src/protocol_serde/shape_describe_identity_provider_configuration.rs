...
pub fn ser_describe_identity_provider_configuration_input(
    ...
    crate::protocol_serde::shape_describe_identity_provider_configuration_input::ser_describe_identity_provider_configuration_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        ...
        "UnauthorizedException" => {
            crate::operation::describe_identity_provider_configuration::DescribeIdentityProviderConfigurationError::UnauthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_identity_provider_configuration_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
