...
pub fn ser_update_domain_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDomainMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
