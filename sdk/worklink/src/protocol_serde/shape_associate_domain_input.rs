...
pub fn ser_associate_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
