...
impl Client  {
    ...
    #[deprecated(note = "Amazon WorkLink is no longer supported. This will be removed in a future version of the SDK.")]
    pub fn update_audit_stream_configuration(&self) -> crate::client::fluent_builders::UpdateAuditStreamConfiguration {
    ...
    #[deprecated(note = "Amazon WorkLink is no longer supported. This will be removed in a future version of the SDK.")]
    pub fn update_identity_provider_configuration(&self) -> crate::client::fluent_builders::UpdateIdentityProviderConfiguration {
                            crate::client::fluent_builders::UpdateIdentityProviderConfiguration::new(self.handle.clone())
                        }
}
