...
pub(crate) fn reflens_structure_crate_output_list_website_authorization_providers_output_next_token(
    input: &crate::output::ListWebsiteAuthorizationProvidersOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
...
pub(crate) fn reflens_structure_crate_output_list_website_certificate_authorities_output_next_token(
    input: &crate::output::ListWebsiteCertificateAuthoritiesOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
