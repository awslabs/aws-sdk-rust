    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutBandwidthRateLimitScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutBandwidthRateLimitScheduleRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutBandwidthRateLimitScheduleEndpointParamsInterceptor {
