...
impl PutBandwidthRateLimitScheduleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitSchedule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBandwidthRateLimitSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bandwidth_rate_limit_schedule::de_put_bandwidth_rate_limit_schedule_http_response_with_props(
                status, headers, body,
            )
        }
    }
