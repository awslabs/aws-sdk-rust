...
impl DisassociateGatewayFromServerInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_gateway_from_server::DisassociateGatewayFromServer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_gateway_from_server::DisassociateGatewayFromServerInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
