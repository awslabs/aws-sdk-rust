...
impl DisassociateGatewayFromServerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_gateway_from_server::DisassociateGatewayFromServer::new(
            ),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateGatewayFromServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_gateway_from_server::de_disassociate_gateway_from_server_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DisassociateGatewayFromServerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_gateway_from_server::DisassociateGatewayFromServerError
{
