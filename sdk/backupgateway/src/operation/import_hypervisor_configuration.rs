...
impl ImportHypervisorConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::import_hypervisor_configuration::ImportHypervisorConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_hypervisor_configuration::ImportHypervisorConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportHypervisorConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_hypervisor_configuration::de_import_hypervisor_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
