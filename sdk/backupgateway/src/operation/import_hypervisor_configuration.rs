...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportHypervisorConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_hypervisor_configuration::de_import_hypervisor_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ImportHypervisorConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::import_hypervisor_configuration::ImportHypervisorConfigurationError
{
