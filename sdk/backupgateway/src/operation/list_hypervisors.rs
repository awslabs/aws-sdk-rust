...
impl ListHypervisorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_hypervisors::ListHypervisors, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_hypervisors::ser_list_hypervisors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHypervisors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_hypervisors::de_list_hypervisors_http_response_with_props(status, headers, body)
        }
    }
}
