...
impl GetHypervisorPropertyMappingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_hypervisor_property_mappings::GetHypervisorPropertyMappingsInput, ::aws_smithy_types::error::operation::BuildError> {
