...
impl crate::operation::get_hypervisor_property_mappings::builders::GetHypervisorPropertyMappingsInputBuilder {
...
impl GetHypervisorPropertyMappingsFluentBuilder {
    /// Creates a new `GetHypervisorPropertyMappingsFluentBuilder`.
