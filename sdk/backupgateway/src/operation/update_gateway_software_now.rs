...
impl UpdateGatewaySoftwareNowInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNow::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGatewaySoftwareNow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_gateway_software_now::de_update_gateway_software_now_http_response_with_props(status, headers, body)
        }
    }
}
