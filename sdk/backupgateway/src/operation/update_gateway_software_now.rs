...
impl UpdateGatewaySoftwareNowInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGatewaySoftwareNow`](crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNow::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateGatewaySoftwareNow", "backupgateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGatewaySoftwareNow {
                type Output = std::result::Result<crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNowOutput, crate::operation::update_gateway_software_now::UpdateGatewaySoftwareNowError>;
