...
impl TagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Backup Gateway", "TagResource", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/BackupOnPremises_v20210101/operation/TagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
