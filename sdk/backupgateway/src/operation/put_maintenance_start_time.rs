...
impl PutMaintenanceStartTime {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutMaintenanceStartTime {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutMaintenanceStartTime");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutMaintenanceStartTimeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutMaintenanceStartTimeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutMaintenanceStartTime")
...
.with_interceptor(PutMaintenanceStartTimeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeError>::new());
...
#[derive(Debug)]
            struct PutMaintenanceStartTimeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutMaintenanceStartTimeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_maintenance_start_time::de_put_maintenance_start_time_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutMaintenanceStartTimeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutMaintenanceStartTimeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_maintenance_start_time::ser_put_maintenance_start_time_input(&input)?);
...
#[derive(Debug)]
            struct PutMaintenanceStartTimeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutMaintenanceStartTimeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutMaintenanceStartTimeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutMaintenanceStartTimeInput>()
                        .ok_or("failed to downcast to PutMaintenanceStartTimeInput")?;
...
pub enum PutMaintenanceStartTimeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutMaintenanceStartTimeError) for what information is available for the error.")]
...
impl PutMaintenanceStartTimeError {
    /// Creates the `PutMaintenanceStartTimeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutMaintenanceStartTimeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutMaintenanceStartTimeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_maintenance_start_time::PutMaintenanceStartTimeError {
...
mod _put_maintenance_start_time_output;
