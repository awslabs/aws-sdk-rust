...
impl TestHypervisorConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::test_hypervisor_configuration::TestHypervisorConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestHypervisorConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_test_hypervisor_configuration::de_test_hypervisor_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for TestHypervisorConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::test_hypervisor_configuration::TestHypervisorConfigurationError
{
