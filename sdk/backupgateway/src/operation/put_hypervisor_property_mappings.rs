...
impl PutHypervisorPropertyMappingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutHypervisorPropertyMappings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_hypervisor_property_mappings::de_put_hypervisor_property_mappings_http_response_with_props(
                status, headers, body,
            )
        }
    }
