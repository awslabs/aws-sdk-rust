...
impl GetVirtualMachineInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_virtual_machine::ser_get_virtual_machine_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVirtualMachine {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_virtual_machine::de_get_virtual_machine_http_response_with_props(status, headers, body)
        }
    }
}
