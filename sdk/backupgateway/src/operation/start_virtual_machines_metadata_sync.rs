...
impl StartVirtualMachinesMetadataSyncInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_virtual_machines_metadata_sync::StartVirtualMachinesMetadataSync,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_virtual_machines_metadata_sync::StartVirtualMachinesMetadataSync::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartVirtualMachinesMetadataSync {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_virtual_machines_metadata_sync::de_start_virtual_machines_metadata_sync_http_response_with_props(
                status, headers, body,
            )
        }
    }
