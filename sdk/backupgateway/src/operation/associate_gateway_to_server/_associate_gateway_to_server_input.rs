...
impl AssociateGatewayToServerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_gateway_to_server::AssociateGatewayToServerInput, ::aws_smithy_types::error::operation::BuildError> {
