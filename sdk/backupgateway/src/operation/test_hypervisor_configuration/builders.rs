...
impl crate::operation::test_hypervisor_configuration::builders::TestHypervisorConfigurationInputBuilder {
...
impl TestHypervisorConfigurationFluentBuilder {
    /// Creates a new `TestHypervisorConfigurationFluentBuilder`.
