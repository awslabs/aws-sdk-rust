...
impl super::Client {
    ...
    ///   - [`vmware_to_aws_tag_mappings(VmwareToAwsTagMapping)`](crate::operation::put_hypervisor_property_mappings::builders::PutHypervisorPropertyMappingsFluentBuilder::vmware_to_aws_tag_mappings) / [`set_vmware_to_aws_tag_mappings(Option<Vec::<VmwareToAwsTagMapping>>)`](crate::operation::put_hypervisor_property_mappings::builders::PutHypervisorPropertyMappingsFluentBuilder::set_vmware_to_aws_tag_mappings):<br>required: **true**<br><p>This action requests the mappings of VMware tags to the Amazon Web Services tags.</p><br>
