...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::get_gateway::builders::GetGatewayFluentBuilder::gateway_arn) / [`set_gateway_arn(impl Into<String>)`](crate::operation::get_gateway::builders::GetGatewayFluentBuilder::set_gateway_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the gateway.</p><br>
