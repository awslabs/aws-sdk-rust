...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::import_hypervisor_configuration::builders::ImportHypervisorConfigurationFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::import_hypervisor_configuration::builders::ImportHypervisorConfigurationFluentBuilder::set_name):<br>required: **true**<br><p>The name of the hypervisor.</p><br>
    ///   - [`host(impl Into<String>)`](crate::operation::import_hypervisor_configuration::builders::ImportHypervisorConfigurationFluentBuilder::host) / [`set_host(impl Into<String>)`](crate::operation::import_hypervisor_configuration::builders::ImportHypervisorConfigurationFluentBuilder::set_host):<br>required: **true**<br><p>The server host of the hypervisor. This can be either an IP address or a fully-qualified domain name (FQDN).</p><br>
