...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_gateway::builders::DeleteGatewayFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::delete_gateway::builders::DeleteGatewayFluentBuilder::set_gateway_arn): <p>The Amazon Resource Name (ARN) of the gateway to delete.</p>
