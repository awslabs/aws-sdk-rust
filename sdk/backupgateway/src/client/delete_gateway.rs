...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::delete_gateway::builders::DeleteGatewayFluentBuilder::gateway_arn) / [`set_gateway_arn(impl Into<String>)`](crate::operation::delete_gateway::builders::DeleteGatewayFluentBuilder::set_gateway_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the gateway to delete.</p><br>
