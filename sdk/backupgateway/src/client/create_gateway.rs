...
impl super::Client {
    ...
    ///   - [`activation_key(impl ::std::convert::Into<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::activation_key) / [`set_activation_key(Option<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_activation_key): <p>The activation key of the created gateway.</p>
    ///   - [`gateway_display_name(impl ::std::convert::Into<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::gateway_display_name) / [`set_gateway_display_name(Option<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_gateway_display_name): <p>The display name of the created gateway.</p>
