...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_tags): <p>A list of up to 50 tags to assign to the gateway. Each tag is a key-value pair.</p>
