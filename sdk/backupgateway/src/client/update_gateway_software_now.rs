...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::update_gateway_software_now::builders::UpdateGatewaySoftwareNowFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::update_gateway_software_now::builders::UpdateGatewaySoftwareNowFluentBuilder::set_gateway_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the gateway to be updated.</p><br>
