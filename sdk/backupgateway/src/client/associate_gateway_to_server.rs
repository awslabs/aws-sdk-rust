...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::associate_gateway_to_server::builders::AssociateGatewayToServerFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::associate_gateway_to_server::builders::AssociateGatewayToServerFluentBuilder::set_gateway_arn): <p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
    ///   - [`server_arn(impl ::std::convert::Into<String>)`](crate::operation::associate_gateway_to_server::builders::AssociateGatewayToServerFluentBuilder::server_arn) / [`set_server_arn(Option<String>)`](crate::operation::associate_gateway_to_server::builders::AssociateGatewayToServerFluentBuilder::set_server_arn): <p>The Amazon Resource Name (ARN) of the server that hosts your virtual machines.</p>
