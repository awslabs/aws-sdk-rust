...
impl super::Client {
    ...
    ///   - [`gateway_arn(impl Into<String>)`](crate::operation::update_gateway_information::builders::UpdateGatewayInformationFluentBuilder::gateway_arn) / [`set_gateway_arn(impl Into<String>)`](crate::operation::update_gateway_information::builders::UpdateGatewayInformationFluentBuilder::set_gateway_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the gateway to update.</p><br>
