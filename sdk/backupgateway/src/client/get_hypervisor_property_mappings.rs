...
impl super::Client {
    ...
    ///   - [`vmware_to_aws_tag_mappings(Option<Vec::<VmwareToAwsTagMapping>>)`](crate::operation::get_hypervisor_property_mappings::GetHypervisorPropertyMappingsOutput::vmware_to_aws_tag_mappings): <p>This is a display of the mappings of VMware tags to the Amazon Web Services tags.</p>
