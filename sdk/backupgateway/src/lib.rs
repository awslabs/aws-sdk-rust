...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("backupgateway", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Backup Gateway.
pub mod client;
