...
pub fn ser_list_gateways_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_gateways_input::ser_list_gateways_input_input(encoder, input)?;
    }
...
pub(crate) fn de_list_gateways(
...
) -> ::std::result::Result<crate::operation::list_gateways::builders::ListGatewaysOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    ) -> ::std::result::Result<crate::operation::list_gateways::builders::ListGatewaysOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
    {
        builder = match decoder.str()?.as_ref() {
            "Gateways" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_gateways(Some(crate::protocol_serde::shape_gateways::de_gateways(decoder, depth + 1)?)))
            })?,
            "NextToken" => {
