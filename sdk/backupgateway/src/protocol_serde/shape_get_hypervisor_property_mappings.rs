...
> {
    ...
    Err(match error_code {
        "ResourceNotFoundException" => {
            crate::operation::get_hypervisor_property_mappings::GetHypervisorPropertyMappingsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::get_hypervisor_property_mappings::GetHypervisorPropertyMappingsError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_hypervisor_property_mappings::de_get_hypervisor_property_mappings(_response_body, output)
            .map_err(crate::operation::get_hypervisor_property_mappings::GetHypervisorPropertyMappingsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "VmwareToAwsTagMappings" => {
                    builder = builder.set_vmware_to_aws_tag_mappings(
                        crate::protocol_serde::shape_vmware_to_aws_tag_mappings::de_vmware_to_aws_tag_mappings(tokens, _value)?,
                    );
                }
                "IamRoleArn" => {
