...
pub fn ser_create_gateway_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_create_gateway_input::ser_create_gateway_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::create_gateway::builders::CreateGatewayOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
