...
pub fn ser_put_hypervisor_property_mappings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutHypervisorPropertyMappingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
