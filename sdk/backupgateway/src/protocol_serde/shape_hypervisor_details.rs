...
pub(crate) fn de_hypervisor_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HypervisorDetails>, aws_smithy_json::deserialize::error::DeserializeError>
