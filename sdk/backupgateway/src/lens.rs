...
pub(crate) fn reflens_list_hypervisors_output_next_token(
...
pub(crate) fn reflens_list_virtual_machines_output_next_token(
...
pub(crate) fn lens_list_hypervisors_output_hypervisors(
    input: crate::operation::list_hypervisors::ListHypervisorsOutput,
...
pub(crate) fn lens_list_virtual_machines_output_virtual_machines(
    input: crate::operation::list_virtual_machines::ListVirtualMachinesOutput,
