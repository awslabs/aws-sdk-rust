...
pub struct VirtualMachine  {
    ...
    #[doc(hidden)]pub hypervisor_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_backup_date: std::option::Option<aws_smithy_types::DateTime>,
}
impl VirtualMachine {
    /// <p>The host name of the virtual machine.</p>
...
pub struct Hypervisor  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::HypervisorState>,
}
impl Hypervisor {
    /// <p>The server host of the hypervisor. This can be either an IP address or a fully-qualified domain name (FQDN).</p>
...
pub struct Gateway  {
    ...
    #[doc(hidden)]pub gateway_display_name: std::option::Option<std::string::String>,
    /// <p>The type of the gateway.</p>
    #[doc(hidden)]pub gateway_type: std::option::Option<crate::model::GatewayType>,
    ...
    #[doc(hidden)]pub last_seen_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl Gateway {
    /// <p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
...
pub struct GatewayDetails  {
    ...
    #[doc(hidden)]pub maintenance_start_time: std::option::Option<crate::model::MaintenanceStartTime>,
    /// <p>Details showing the next update availability time of the gateway.</p>
    #[doc(hidden)]pub next_update_availability_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The DNS name for the virtual private cloud (VPC) endpoint the gateway uses to connect to the cloud for backup gateway.</p>
    #[doc(hidden)]pub vpc_endpoint: std::option::Option<std::string::String>,
}
impl GatewayDetails {
    /// <p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
    pub fn gateway_arn(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for GatewayDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_update_availability_time", &self.next_update_availability_time);
...
pub struct MaintenanceStartTime  {
    ...
    #[doc(hidden)]pub day_of_month: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub day_of_week: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub hour_of_day: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub minute_of_hour: std::option::Option<i32>,
}
