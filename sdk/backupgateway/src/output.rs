...
pub struct ListVirtualMachinesOutput  {
    ...
    #[doc(hidden)]pub virtual_machines: std::option::Option<std::vec::Vec<crate::model::VirtualMachine>>,
...
pub struct GetVirtualMachineOutput  {
    ...
    #[doc(hidden)]pub virtual_machine: std::option::Option<crate::model::VirtualMachineDetails>,
}
...
pub struct ListHypervisorsOutput  {
    ...
    #[doc(hidden)]pub hypervisors: std::option::Option<std::vec::Vec<crate::model::Hypervisor>>,
    /// <p>The next item following a partial list of returned resources. For example, if a request is made to return <code>maxResults</code> number of resources, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ImportHypervisorConfigurationOutput  {
    ...
    #[doc(hidden)]pub hypervisor_arn: std::option::Option<std::string::String>,
}
...
pub struct ListGatewaysOutput  {
    ...
    #[doc(hidden)]pub gateways: std::option::Option<std::vec::Vec<crate::model::Gateway>>,
    /// <p>The next item following a partial list of returned resources. For example, if a request is made to return <code>maxResults</code> number of resources, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetGatewayOutput  {
    ...
    #[doc(hidden)]pub gateway: std::option::Option<crate::model::GatewayDetails>,
}
