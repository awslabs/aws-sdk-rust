...
pub struct ListSlackWorkspaceConfigurationsOutput  {
    ...
    #[doc(hidden)]pub slack_workspace_configurations: std::option::Option<std::vec::Vec<crate::model::SlackWorkspaceConfiguration>>,
}
...
impl  std::fmt::Debug for ListSlackWorkspaceConfigurationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("slack_workspace_configurations", &self.slack_workspace_configurations);
        formatter.finish()
    }
}
...
pub struct ListSlackChannelConfigurationsOutput  {
    ...
    #[doc(hidden)]pub slack_channel_configurations: std::option::Option<std::vec::Vec<crate::model::SlackChannelConfiguration>>,
}
...
impl  std::fmt::Debug for ListSlackChannelConfigurationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("slack_channel_configurations", &self.slack_channel_configurations);
        formatter.finish()
    }
}
