...
impl ListSlackChannelConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_slack_channel_configurations::ListSlackChannelConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
