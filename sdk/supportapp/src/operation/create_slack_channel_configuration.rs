...
impl CreateSlackChannelConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_slack_channel_configuration::CreateSlackChannelConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSlackChannelConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_slack_channel_configuration::de_create_slack_channel_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
