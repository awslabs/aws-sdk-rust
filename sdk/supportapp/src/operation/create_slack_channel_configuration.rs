    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/control/create-slack-channel-configuration")
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSlackChannelConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_slack_channel_configuration::de_create_slack_channel_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateSlackChannelConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_slack_channel_configuration::CreateSlackChannelConfigurationError
{
