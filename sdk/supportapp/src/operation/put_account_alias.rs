    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/control/put-account-alias")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_account_alias::PutAccountAlias::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_account_alias::PutAccountAliasError
{
