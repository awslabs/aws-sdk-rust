...
impl ListSlackWorkspaceConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_slack_workspace_configurations::ListSlackWorkspaceConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSlackWorkspaceConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_slack_workspace_configurations::de_list_slack_workspace_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
