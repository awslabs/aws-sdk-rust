...
impl ListSlackWorkspaceConfigurations {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_slack_workspace_configurations::ListSlackWorkspaceConfigurationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListSlackWorkspaceConfigurationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListSlackWorkspaceConfigurationsRequestSerializer {
