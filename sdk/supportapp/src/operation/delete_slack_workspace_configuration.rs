...
impl DeleteSlackWorkspaceConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_slack_workspace_configuration::DeleteSlackWorkspaceConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSlackWorkspaceConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_slack_workspace_configuration::de_delete_slack_workspace_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
