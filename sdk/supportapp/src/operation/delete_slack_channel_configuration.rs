...
impl DeleteSlackChannelConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSlackChannelConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_slack_channel_configuration::de_delete_slack_channel_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
