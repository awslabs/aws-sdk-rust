...
impl DeleteSlackChannelConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSlackChannelConfiguration`](crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSlackChannelConfiguration {
                type Output = std::result::Result<crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfigurationOutput, crate::operation::delete_slack_channel_configuration::DeleteSlackChannelConfigurationError>;
