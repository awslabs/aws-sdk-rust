...
impl ListSlackWorkspaceConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_slack_workspace_configurations::ListSlackWorkspaceConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
