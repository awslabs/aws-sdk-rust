...
pub fn serialize_structure_crate_input_create_slack_channel_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSlackChannelConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_slack_channel_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteSlackChannelConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_slack_workspace_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteSlackWorkspaceConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_slack_channel_configurations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSlackChannelConfigurationsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_slack_workspace_configurations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSlackWorkspaceConfigurationsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_account_alias_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAccountAliasInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_slack_channel_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSlackChannelConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_18) = &input.notify_on_add_correspondence_to_case {
        object.key("notifyOnAddCorrespondenceToCase").boolean(*var_18);
    }
