...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_entities_detection_v2_job::builders::StopEntitiesDetectionV2JobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_entities_detection_v2_job::builders::StopEntitiesDetectionV2JobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the medical entities job to stop.</p><br>
