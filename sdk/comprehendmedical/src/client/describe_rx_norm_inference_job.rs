...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_rx_norm_inference_job::builders::DescribeRxNormInferenceJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_rx_norm_inference_job::builders::DescribeRxNormInferenceJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier that Amazon Comprehend Medical generated for the job. The StartRxNormInferenceJob operation returns this identifier in its response.</p><br>
