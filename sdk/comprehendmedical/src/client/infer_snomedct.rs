...
impl super::Client {
    ...
    ///   - [`text(impl ::std::convert::Into<String>)`](crate::operation::infer_snomedct::builders::InferSNOMEDCTFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::infer_snomedct::builders::InferSNOMEDCTFluentBuilder::set_text): <p>The input text to be analyzed using InferSNOMEDCT.</p>
