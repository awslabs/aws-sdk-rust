...
impl super::Client {
    ...
    ///   - [`text(impl ::std::convert::Into<String>)`](crate::operation::infer_rx_norm::builders::InferRxNormFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::infer_rx_norm::builders::InferRxNormFluentBuilder::set_text): <p>The input text used for analysis. The input for InferRxNorm is a string from 1 to 10000 characters.</p>
