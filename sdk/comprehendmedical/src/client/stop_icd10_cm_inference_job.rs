...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::stop_icd10_cm_inference_job::builders::StopICD10CMInferenceJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_icd10_cm_inference_job::builders::StopICD10CMInferenceJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier of the job.</p><br>
