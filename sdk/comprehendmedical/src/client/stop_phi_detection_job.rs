...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::stop_phi_detection_job::builders::StopPHIDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::stop_phi_detection_job::builders::StopPHIDetectionJobFluentBuilder::set_job_id): <p>The identifier of the PHI detection job to stop.</p>
