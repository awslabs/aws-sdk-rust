...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_phi_detection_job::builders::DescribePHIDetectionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_phi_detection_job::builders::DescribePHIDetectionJobFluentBuilder::set_job_id): <p>The identifier that Comprehend Medical; generated for the job. The <code>StartPHIDetectionJob</code> operation returns this identifier in its response.</p>
