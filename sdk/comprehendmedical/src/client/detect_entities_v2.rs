...
impl super::Client {
    ...
    ///   - [`text(impl ::std::convert::Into<String>)`](crate::operation::detect_entities_v2::builders::DetectEntitiesV2FluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::detect_entities_v2::builders::DetectEntitiesV2FluentBuilder::set_text): <p>A UTF-8 string containing the clinical content being examined for entities. Each string must contain fewer than 20,000 bytes of characters.</p>
