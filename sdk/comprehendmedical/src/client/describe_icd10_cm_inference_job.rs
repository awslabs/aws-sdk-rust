...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_icd10_cm_inference_job::builders::DescribeICD10CMInferenceJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_icd10_cm_inference_job::builders::DescribeICD10CMInferenceJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The identifier that Amazon Comprehend Medical generated for the job. <code>The StartICD10CMInferenceJob</code> operation returns this identifier in its response.</p><br>
