...
impl ListRxNormInferenceJobsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_rx_norm_inference_jobs();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsOutput,
                    crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError,
                > for ListRxNormInferenceJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListRxNormInferenceJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobs::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsOutput, crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError, Self> {
