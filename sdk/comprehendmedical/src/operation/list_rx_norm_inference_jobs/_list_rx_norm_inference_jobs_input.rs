...
impl ListRxNormInferenceJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsInput, ::aws_smithy_types::error::operation::BuildError> {
