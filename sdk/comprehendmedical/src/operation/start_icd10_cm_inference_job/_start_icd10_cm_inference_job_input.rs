...
impl StartIcd10CmInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobInput, ::aws_smithy_types::error::operation::BuildError> {
