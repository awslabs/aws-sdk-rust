...
pub use crate::operation::start_icd10_cm_inference_job::_start_icd10_cm_inference_job_output::StartIcd10CmInferenceJobOutputBuilder;
...
impl StartICD10CMInferenceJobFluentBuilder {
    ...
    /// Access the StartICD10CMInferenceJob as a reference.
    pub fn as_input(&self) -> &crate::operation::start_icd10_cm_inference_job::builders::StartIcd10CmInferenceJobInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobOutput, crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError, Self> {
