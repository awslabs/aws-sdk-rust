...
impl ListPhiDetectionJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_phi_detection_jobs::ListPHIDetectionJobs,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPHIDetectionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_phi_detection_jobs::de_list_phi_detection_jobs_http_response_with_props(status, headers, body)
        }
    }
}
