...
impl StopEntitiesDetectionV2Job {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopEntitiesDetectionV2Job {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopEntitiesDetectionV2Job");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopEntitiesDetectionV2JobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopEntitiesDetectionV2JobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopEntitiesDetectionV2Job")
...
.with_interceptor(StopEntitiesDetectionV2JobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError>::new());
...
#[derive(Debug)]
            struct StopEntitiesDetectionV2JobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopEntitiesDetectionV2JobResponseDeserializer {
...
#[derive(Debug)]
            struct StopEntitiesDetectionV2JobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopEntitiesDetectionV2JobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_entities_detection_v2_job::ser_stop_entities_detection_v2_job_input(&input)?);
...
#[derive(Debug)]
            struct StopEntitiesDetectionV2JobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopEntitiesDetectionV2JobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopEntitiesDetectionV2JobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopEntitiesDetectionV2JobInput>()
                        .ok_or("failed to downcast to StopEntitiesDetectionV2JobInput")?;
...
pub enum StopEntitiesDetectionV2JobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopEntitiesDetectionV2JobError) for what information is available for the error.")]
...
impl StopEntitiesDetectionV2JobError {
    /// Creates the `StopEntitiesDetectionV2JobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopEntitiesDetectionV2JobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopEntitiesDetectionV2JobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError {
...
mod _stop_entities_detection_v2_job_output;
