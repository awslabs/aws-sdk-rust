...
impl StopEntitiesDetectionV2JobInput {
    /// Consumes the builder and constructs an Operation<[`StopEntitiesDetectionV2Job`](crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2Job)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2Job, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_entities_detection_v2_job::ser_stop_entities_detection_v2_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2Job::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopEntitiesDetectionV2Job {
                type Output = std::result::Result<crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobOutput, crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2JobError>;
