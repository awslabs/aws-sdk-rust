...
impl StopEntitiesDetectionV2JobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2Job,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_entities_detection_v2_job::StopEntitiesDetectionV2Job::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopEntitiesDetectionV2Job {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_entities_detection_v2_job::de_stop_entities_detection_v2_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
