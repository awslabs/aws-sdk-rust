...
impl  DetectEntitiesOutput  {
    ...
    pub fn model_version(&self) -> & str {
        use std::ops::Deref; self.model_version.deref()
    }
}
...
impl DetectEntitiesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::detect_entities::DetectEntitiesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::detect_entities::DetectEntitiesOutput {
                entities: self.entities
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("entities", "entities was not specified but it is required when building DetectEntitiesOutput")
                    )?
                ,
                ...
                model_version: self.model_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("model_version", "model_version was not specified but it is required when building DetectEntitiesOutput")
                    )?
                ,
