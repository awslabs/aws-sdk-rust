...
/// Orchestration and serialization glue logic for `ListRxNormInferenceJobs`.
...
impl ListRxNormInferenceJobs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRxNormInferenceJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRxNormInferenceJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRxNormInferenceJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRxNormInferenceJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRxNormInferenceJobs")
...
.with_interceptor(ListRxNormInferenceJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError>::new());
...
#[derive(Debug)]
            struct ListRxNormInferenceJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRxNormInferenceJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_rx_norm_inference_jobs::de_list_rx_norm_inference_jobs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListRxNormInferenceJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRxNormInferenceJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_rx_norm_inference_jobs::ser_list_rx_norm_inference_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListRxNormInferenceJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRxNormInferenceJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRxNormInferenceJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRxNormInferenceJobsInput>()
                        .ok_or("failed to downcast to ListRxNormInferenceJobsInput")?;
...
pub enum ListRxNormInferenceJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRxNormInferenceJobsError) for what information is available for the error.")]
...
impl ListRxNormInferenceJobsError {
    /// Creates the `ListRxNormInferenceJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRxNormInferenceJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRxNormInferenceJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_rx_norm_inference_jobs::ListRxNormInferenceJobsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_rx_norm_inference_jobs::_list_rx_norm_inference_jobs_output::ListRxNormInferenceJobsOutput;

pub use crate::operation::list_rx_norm_inference_jobs::_list_rx_norm_inference_jobs_input::ListRxNormInferenceJobsInput;

mod _list_rx_norm_inference_jobs_input;

mod _list_rx_norm_inference_jobs_output;
