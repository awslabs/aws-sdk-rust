...
impl InferSnomedctInput {
    /// Consumes the builder and constructs an Operation<[`InferSNOMEDCT`](crate::operation::infer_snomedct::InferSNOMEDCT)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::infer_snomedct::InferSNOMEDCT, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_infer_snomedct::ser_infer_snomedct_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::infer_snomedct::InferSNOMEDCT::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for InferSNOMEDCT {
    type Output = ::std::result::Result<crate::operation::infer_snomedct::InferSnomedctOutput, crate::operation::infer_snomedct::InferSNOMEDCTError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_infer_snomedct::de_infer_snomedct_http_response_with_props(status, headers, body)
        }
    }
}
