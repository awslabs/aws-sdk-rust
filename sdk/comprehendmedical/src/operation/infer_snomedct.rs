...
impl InferSnomedctInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::infer_snomedct::InferSNOMEDCT,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::infer_snomedct::InferSNOMEDCT::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InferSNOMEDCT {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_infer_snomedct::de_infer_snomedct_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_infer_snomedct::de_infer_snomedct_http_response_with_props(
                status, headers, body,
            )
        }
    }
