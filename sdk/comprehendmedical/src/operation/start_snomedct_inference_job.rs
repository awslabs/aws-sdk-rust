...
impl StartSnomedctInferenceJobInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJob::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJobError
{
