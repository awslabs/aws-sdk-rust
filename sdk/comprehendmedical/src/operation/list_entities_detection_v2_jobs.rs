...
impl ListEntitiesDetectionV2JobsInput {
    /// Consumes the builder and constructs an Operation<[`ListEntitiesDetectionV2Jobs`](crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2Jobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2Jobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_entities_detection_v2_jobs::ser_list_entities_detection_v2_jobs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2Jobs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListEntitiesDetectionV2Jobs {
                type Output = std::result::Result<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsOutput, crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError>;
