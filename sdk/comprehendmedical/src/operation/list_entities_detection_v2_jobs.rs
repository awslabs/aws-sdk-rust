...
impl ListEntitiesDetectionV2JobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2Jobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEntitiesDetectionV2Jobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_entities_detection_v2_jobs::de_list_entities_detection_v2_jobs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListEntitiesDetectionV2JobsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError
{
