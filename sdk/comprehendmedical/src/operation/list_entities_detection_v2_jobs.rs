...
impl ListEntitiesDetectionV2Jobs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEntitiesDetectionV2Jobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEntitiesDetectionV2Jobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEntitiesDetectionV2JobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEntitiesDetectionV2JobsResponseDeserializer));
...
.with_interceptor(ListEntitiesDetectionV2JobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError>::new());
...
#[derive(Debug)]
            struct ListEntitiesDetectionV2JobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEntitiesDetectionV2JobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_entities_detection_v2_jobs::de_list_entities_detection_v2_jobs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_entities_detection_v2_jobs::de_list_entities_detection_v2_jobs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListEntitiesDetectionV2JobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEntitiesDetectionV2JobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_entities_detection_v2_jobs::ser_list_entities_detection_v2_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListEntitiesDetectionV2JobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEntitiesDetectionV2JobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEntitiesDetectionV2JobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEntitiesDetectionV2JobsInput>()
                        .ok_or("failed to downcast to ListEntitiesDetectionV2JobsInput")?;
...
pub enum ListEntitiesDetectionV2JobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEntitiesDetectionV2JobsError) for what information is available for the error.")]
...
impl ListEntitiesDetectionV2JobsError {
    /// Creates the `ListEntitiesDetectionV2JobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEntitiesDetectionV2JobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEntitiesDetectionV2JobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsError {
...
mod _list_entities_detection_v2_jobs_output;
