...
impl InferRxNormInput {
    /// Consumes the builder and constructs an Operation<[`InferRxNorm`](crate::operation::infer_rx_norm::InferRxNorm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::infer_rx_norm::InferRxNorm, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::infer_rx_norm::InferRxNormInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_infer_rx_norm::ser_infer_rx_norm_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::infer_rx_norm::InferRxNorm::new())
...
impl aws_smithy_http::response::ParseStrictResponse for InferRxNorm {
                type Output = std::result::Result<crate::operation::infer_rx_norm::InferRxNormOutput, crate::operation::infer_rx_norm::InferRxNormError>;
