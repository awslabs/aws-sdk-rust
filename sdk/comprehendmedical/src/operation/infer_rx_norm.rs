...
impl InferRxNormInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::infer_rx_norm::InferRxNorm::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InferRxNorm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_infer_rx_norm::de_infer_rx_norm_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_infer_rx_norm::de_infer_rx_norm_http_response_with_props(
                status, headers, body,
            )
        }
    }
