...
impl InferRxNormInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::infer_rx_norm::InferRxNorm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_infer_rx_norm::ser_infer_rx_norm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for InferRxNorm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_infer_rx_norm::de_infer_rx_norm_http_response_with_props(status, headers, body)
        }
    }
}
