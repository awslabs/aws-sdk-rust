...
impl StartRxNormInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput, ::aws_smithy_types::error::operation::BuildError> {
