...
impl DescribeRxNormInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJobInput, ::aws_smithy_types::error::operation::BuildError> {
