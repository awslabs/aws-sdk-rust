...
impl crate::operation::list_entities_detection_v2_jobs::builders::ListEntitiesDetectionV2JobsInputBuilder {
...
impl ListEntitiesDetectionV2JobsFluentBuilder {
    /// Creates a new `ListEntitiesDetectionV2JobsFluentBuilder`.
