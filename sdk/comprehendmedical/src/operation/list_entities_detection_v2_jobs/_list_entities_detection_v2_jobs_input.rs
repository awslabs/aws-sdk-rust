...
impl ListEntitiesDetectionV2JobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_entities_detection_v2_jobs::ListEntitiesDetectionV2JobsInput, ::aws_smithy_types::error::operation::BuildError> {
