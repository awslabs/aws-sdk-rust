...
impl ListSnomedctInferenceJobsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSNOMEDCTInferenceJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_snomedct_inference_jobs::de_list_snomedct_inference_jobs_http_response_with_props(status, headers, body)
        }
    }
}
