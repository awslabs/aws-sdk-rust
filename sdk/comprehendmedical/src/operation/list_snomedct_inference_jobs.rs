...
/// Orchestration and serialization glue logic for `ListSNOMEDCTInferenceJobs`.
...
impl ListSNOMEDCTInferenceJobs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSNOMEDCTInferenceJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListSNOMEDCTInferenceJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListSNOMEDCTInferenceJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListSNOMEDCTInferenceJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSNOMEDCTInferenceJobs")
...
.with_interceptor(ListSNOMEDCTInferenceJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobsError>::new());
...
#[derive(Debug)]
            struct ListSNOMEDCTInferenceJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSNOMEDCTInferenceJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_snomedct_inference_jobs::de_list_snomedct_inference_jobs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_snomedct_inference_jobs::de_list_snomedct_inference_jobs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListSNOMEDCTInferenceJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSNOMEDCTInferenceJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_snomedct_inference_jobs::ser_list_snomedct_inference_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListSNOMEDCTInferenceJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSNOMEDCTInferenceJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListSNOMEDCTInferenceJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListSnomedctInferenceJobsInput>()
                        .ok_or("failed to downcast to ListSnomedctInferenceJobsInput")?;
...
pub enum ListSNOMEDCTInferenceJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSNOMEDCTInferenceJobsError) for what information is available for the error.")]
...
impl ListSNOMEDCTInferenceJobsError {
    /// Creates the `ListSNOMEDCTInferenceJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListSNOMEDCTInferenceJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSNOMEDCTInferenceJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_snomedct_inference_jobs::ListSNOMEDCTInferenceJobsError {
...
mod _list_snomedct_inference_jobs_output;
