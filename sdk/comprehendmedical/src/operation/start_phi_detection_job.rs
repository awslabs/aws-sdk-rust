...
impl StartPhiDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartPHIDetectionJob`](crate::operation::start_phi_detection_job::StartPHIDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_phi_detection_job::StartPHIDetectionJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_phi_detection_job::StartPhiDetectionJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_phi_detection_job::StartPHIDetectionJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartPHIDetectionJob {
                type Output = std::result::Result<crate::operation::start_phi_detection_job::StartPhiDetectionJobOutput, crate::operation::start_phi_detection_job::StartPHIDetectionJobError>;
