...
impl DetectPhiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detect_phi::DetectPHI, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_phi::ser_detect_phi_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectPHI {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_phi::de_detect_phi_http_response_with_props(status, headers, body)
        }
    }
}
