...
impl DetectPhiInput {
    /// Consumes the builder and constructs an Operation<[`DetectPHI`](crate::operation::detect_phi::DetectPHI)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detect_phi::DetectPHI, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_phi::DetectPhiInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detect_phi::ser_detect_phi_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detect_phi::DetectPHI::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DetectPHI {
                type Output = std::result::Result<crate::operation::detect_phi::DetectPhiOutput, crate::operation::detect_phi::DetectPHIError>;
