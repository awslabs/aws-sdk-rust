...
impl StartRxNormInferenceJob {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StartRxNormInferenceJob",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartRxNormInferenceJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartRxNormInferenceJobRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartRxNormInferenceJobResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartRxNormInferenceJob")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartRxNormInferenceJob")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartRxNormInferenceJobTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartRxNormInferenceJobTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartRxNormInferenceJobTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartRxNormInferenceJobInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartRxNormInferenceJobResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_rx_norm_inference_job::de_start_rx_norm_inference_job_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_rx_norm_inference_job::de_start_rx_norm_inference_job_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartRxNormInferenceJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/ComprehendMedical_20181030/operation/StartRxNormInferenceJob").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_rx_norm_inference_job::ser_start_rx_norm_inference_job_input(&input)?,
        );
