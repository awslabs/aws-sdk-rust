...
impl StartEntitiesDetectionV2JobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobOutput, crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobError, Self> {
