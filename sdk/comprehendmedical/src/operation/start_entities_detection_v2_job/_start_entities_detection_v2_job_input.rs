...
impl StartEntitiesDetectionV2JobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobInput, ::aws_smithy_types::error::operation::BuildError> {
