...
/// Orchestration and serialization glue logic for `StopICD10CMInferenceJob`.
...
impl StopICD10CMInferenceJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_icd10_cm_inference_job::StopIcd10CmInferenceJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_icd10_cm_inference_job::StopICD10CMInferenceJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_icd10_cm_inference_job::StopICD10CMInferenceJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_icd10_cm_inference_job::StopIcd10CmInferenceJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopICD10CMInferenceJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopICD10CMInferenceJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopICD10CMInferenceJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopICD10CMInferenceJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopICD10CMInferenceJob")
...
.with_interceptor(StopICD10CMInferenceJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_icd10_cm_inference_job::StopICD10CMInferenceJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_icd10_cm_inference_job::StopICD10CMInferenceJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_icd10_cm_inference_job::StopICD10CMInferenceJobError>::new());
...
#[derive(Debug)]
            struct StopICD10CMInferenceJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopICD10CMInferenceJobResponseDeserializer {
...
#[derive(Debug)]
            struct StopICD10CMInferenceJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopICD10CMInferenceJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_icd10_cm_inference_job::StopIcd10CmInferenceJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_icd10_cm_inference_job::StopIcd10CmInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_icd10_cm_inference_job::ser_stop_icd10_cm_inference_job_input(&input)?);
...
#[derive(Debug)]
            struct StopICD10CMInferenceJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopICD10CMInferenceJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopICD10CMInferenceJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopIcd10CmInferenceJobInput>()
                        .ok_or("failed to downcast to StopIcd10CmInferenceJobInput")?;
...
pub enum StopICD10CMInferenceJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopICD10CMInferenceJobError) for what information is available for the error.")]
...
impl StopICD10CMInferenceJobError {
    /// Creates the `StopICD10CMInferenceJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopICD10CMInferenceJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopICD10CMInferenceJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_icd10_cm_inference_job::StopICD10CMInferenceJobError {
...
mod _stop_icd10_cm_inference_job_output;
