...
impl StopPhiDetectionJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_phi_detection_job::StopPHIDetectionJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopPHIDetectionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_phi_detection_job::de_stop_phi_detection_job_http_response_with_props(status, headers, body)
        }
    }
}
