...
impl StopPhiDetectionJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_phi_detection_job::ser_stop_phi_detection_job_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_phi_detection_job::StopPHIDetectionJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_phi_detection_job::StopPHIDetectionJobError
{
