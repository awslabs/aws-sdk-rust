...
impl ListIcd10CmInferenceJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_icd10_cm_inference_jobs::ListIcd10CmInferenceJobsInput, ::aws_smithy_types::error::operation::BuildError> {
