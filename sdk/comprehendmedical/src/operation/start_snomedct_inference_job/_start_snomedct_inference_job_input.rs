...
impl StartSnomedctInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobInput, ::aws_smithy_types::error::operation::BuildError> {
