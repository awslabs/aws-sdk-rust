...
impl StartSnomedctInferenceJobInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.start_snomedct_inference_job();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobOutput,
                    crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJobError,
                > for StartSNOMEDCTInferenceJobFluentBuilder
            {
                fn send(
                    self,
...
impl StartSNOMEDCTInferenceJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobOutput, crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJobError, Self> {
