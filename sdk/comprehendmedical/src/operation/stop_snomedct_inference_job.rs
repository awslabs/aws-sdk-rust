...
impl StopSnomedctInferenceJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJob,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopSNOMEDCTInferenceJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_snomedct_inference_job::de_stop_snomedct_inference_job_http_response_with_props(status, headers, body)
        }
    }
}
