...
/// Orchestration and serialization glue logic for `StopSNOMEDCTInferenceJob`.
...
impl StopSNOMEDCTInferenceJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_snomedct_inference_job::StopSnomedctInferenceJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_snomedct_inference_job::StopSnomedctInferenceJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopSNOMEDCTInferenceJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopSNOMEDCTInferenceJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopSNOMEDCTInferenceJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopSNOMEDCTInferenceJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopSNOMEDCTInferenceJob")
...
.with_interceptor(StopSNOMEDCTInferenceJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError>::new());
...
#[derive(Debug)]
            struct StopSNOMEDCTInferenceJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopSNOMEDCTInferenceJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_snomedct_inference_job::de_stop_snomedct_inference_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_snomedct_inference_job::de_stop_snomedct_inference_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopSNOMEDCTInferenceJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopSNOMEDCTInferenceJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_snomedct_inference_job::StopSnomedctInferenceJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_snomedct_inference_job::StopSnomedctInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_snomedct_inference_job::ser_stop_snomedct_inference_job_input(&input)?);
...
#[derive(Debug)]
            struct StopSNOMEDCTInferenceJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopSNOMEDCTInferenceJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopSNOMEDCTInferenceJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopSnomedctInferenceJobInput>()
                        .ok_or("failed to downcast to StopSnomedctInferenceJobInput")?;
...
pub enum StopSNOMEDCTInferenceJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopSNOMEDCTInferenceJobError) for what information is available for the error.")]
...
impl StopSNOMEDCTInferenceJobError {
    /// Creates the `StopSNOMEDCTInferenceJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopSNOMEDCTInferenceJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopSNOMEDCTInferenceJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError {
...
mod _stop_snomedct_inference_job_output;
