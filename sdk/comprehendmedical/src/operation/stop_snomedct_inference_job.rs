...
impl StopSnomedctInferenceJobInput {
    /// Consumes the builder and constructs an Operation<[`StopSNOMEDCTInferenceJob`](crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_snomedct_inference_job::StopSnomedctInferenceJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_snomedct_inference_job::ser_stop_snomedct_inference_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopSNOMEDCTInferenceJob {
                type Output = std::result::Result<crate::operation::stop_snomedct_inference_job::StopSnomedctInferenceJobOutput, crate::operation::stop_snomedct_inference_job::StopSNOMEDCTInferenceJobError>;
