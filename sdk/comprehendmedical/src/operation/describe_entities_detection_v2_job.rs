...
impl DescribeEntitiesDetectionV2JobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_entities_detection_v2_job::DescribeEntitiesDetectionV2Job::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEntitiesDetectionV2Job {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_entities_detection_v2_job::de_describe_entities_detection_v2_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
