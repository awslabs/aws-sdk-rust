...
impl DescribeEntitiesDetectionV2JobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_entities_detection_v2_job::DescribeEntitiesDetectionV2Job,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEntitiesDetectionV2Job {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_entities_detection_v2_job::de_describe_entities_detection_v2_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeEntitiesDetectionV2JobError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_entities_detection_v2_job::DescribeEntitiesDetectionV2JobError
{
