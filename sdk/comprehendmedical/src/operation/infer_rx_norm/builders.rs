...
impl InferRxNormFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::infer_rx_norm::InferRxNormOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::infer_rx_norm::InferRxNormError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::infer_rx_norm::InferRxNormOutput, crate::operation::infer_rx_norm::InferRxNormError, Self> {
