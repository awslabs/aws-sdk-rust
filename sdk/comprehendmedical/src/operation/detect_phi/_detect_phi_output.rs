        ...
        ::std::result::Result::Ok(
            crate::operation::detect_phi::DetectPhiOutput {
                entities: self.entities
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("entities", "entities was not specified but it is required when building DetectPhiOutput")
                    )?
                ,
                ...
                model_version: self.model_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("model_version", "model_version was not specified but it is required when building DetectPhiOutput")
                    )?
                ,
