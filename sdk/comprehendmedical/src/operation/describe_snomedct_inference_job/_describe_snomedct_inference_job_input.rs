...
impl DescribeSnomedctInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_snomedct_inference_job::DescribeSnomedctInferenceJobInput, ::aws_smithy_types::error::operation::BuildError> {
