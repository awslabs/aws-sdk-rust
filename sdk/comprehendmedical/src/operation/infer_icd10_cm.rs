...
impl InferIcd10CmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::infer_icd10_cm::InferICD10CM,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::infer_icd10_cm::InferICD10CM::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InferICD10CM {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_infer_icd10_cm::de_infer_icd10_cm_http_error(
                status, headers, body,
            )
        } else {
