...
impl InferIcd10CmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::infer_icd10_cm::InferICD10CM, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_infer_icd10_cm::ser_infer_icd10_cm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for InferICD10CM {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_infer_icd10_cm::de_infer_icd10_cm_http_response_with_props(status, headers, body)
        }
    }
}
