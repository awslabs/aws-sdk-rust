...
impl StartIcd10CmInferenceJobInput {
    /// Consumes the builder and constructs an Operation<[`StartICD10CMInferenceJob`](crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_icd10_cm_inference_job::ser_start_icd10_cm_inference_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartICD10CMInferenceJob {
                type Output = std::result::Result<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobOutput, crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError>;
