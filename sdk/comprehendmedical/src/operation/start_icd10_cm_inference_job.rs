...
impl StartICD10CMInferenceJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartICD10CMInferenceJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartICD10CMInferenceJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartICD10CMInferenceJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartICD10CMInferenceJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartICD10CMInferenceJob")
...
.with_interceptor(StartICD10CMInferenceJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError>::new());
...
#[derive(Debug)]
            struct StartICD10CMInferenceJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartICD10CMInferenceJobResponseDeserializer {
...
#[derive(Debug)]
            struct StartICD10CMInferenceJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartICD10CMInferenceJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_icd10_cm_inference_job::StartIcd10CmInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_icd10_cm_inference_job::ser_start_icd10_cm_inference_job_input(&input)?);
...
#[derive(Debug)]
            struct StartICD10CMInferenceJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartICD10CMInferenceJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartICD10CMInferenceJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartIcd10CmInferenceJobInput>()
                        .ok_or("failed to downcast to StartIcd10CmInferenceJobInput")?;
...
pub enum StartICD10CMInferenceJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartICD10CMInferenceJobError) for what information is available for the error.")]
...
impl StartICD10CMInferenceJobError {
    /// Creates the `StartICD10CMInferenceJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartICD10CMInferenceJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartICD10CMInferenceJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_icd10_cm_inference_job::StartICD10CMInferenceJobError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::start_icd10_cm_inference_job::_start_icd10_cm_inference_job_output::StartIcd10CmInferenceJobOutput;

pub use crate::operation::start_icd10_cm_inference_job::_start_icd10_cm_inference_job_input::StartIcd10CmInferenceJobInput;

mod _start_icd10_cm_inference_job_input;

mod _start_icd10_cm_inference_job_output;
