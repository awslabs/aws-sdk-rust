...
impl ListSnomedctInferenceJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsInput, ::aws_smithy_types::error::operation::BuildError> {
