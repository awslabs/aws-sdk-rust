...
pub fn serialize_structure_describe_entities_detection_v2_job_input(
...
pub fn serialize_structure_describe_icd10_cm_inference_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_phi_detection_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_rx_norm_inference_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_detect_entities_v2_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_detect_phi_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_infer_icd10_cm_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_infer_rx_norm_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_entities_detection_v2_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_10) = &input.filter {
        ...
        crate::json_ser::serialize_structure_comprehend_medical_async_job_filter(
            &mut object_11,
            var_10,
        );
        object_11.finish();
...
pub fn serialize_structure_list_icd10_cm_inference_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_phi_detection_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_rx_norm_inference_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_entities_detection_v2_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_26) = &input.input_data_config {
        ...
        crate::json_ser::serialize_structure_input_data_config(&mut object_27, var_26);
        object_27.finish();
    }
    if let Some(var_28) = &input.output_data_config {
        let mut object_29 = object.key("OutputDataConfig").start_object();
        crate::json_ser::serialize_structure_output_data_config(&mut object_29, var_28);
        object_29.finish();
    }
...
pub fn serialize_structure_start_icd10_cm_inference_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_35) = &input.input_data_config {
        ...
        crate::json_ser::serialize_structure_input_data_config(&mut object_36, var_35);
        object_36.finish();
    }
    if let Some(var_37) = &input.output_data_config {
        let mut object_38 = object.key("OutputDataConfig").start_object();
        crate::json_ser::serialize_structure_output_data_config(&mut object_38, var_37);
        object_38.finish();
    }
...
pub fn serialize_structure_start_phi_detection_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_44) = &input.input_data_config {
        ...
        crate::json_ser::serialize_structure_input_data_config(&mut object_45, var_44);
        object_45.finish();
    }
    if let Some(var_46) = &input.output_data_config {
        let mut object_47 = object.key("OutputDataConfig").start_object();
        crate::json_ser::serialize_structure_output_data_config(&mut object_47, var_46);
        object_47.finish();
    }
...
pub fn serialize_structure_start_rx_norm_inference_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_53) = &input.input_data_config {
        ...
        crate::json_ser::serialize_structure_input_data_config(&mut object_54, var_53);
        object_54.finish();
    }
    if let Some(var_55) = &input.output_data_config {
        let mut object_56 = object.key("OutputDataConfig").start_object();
        crate::json_ser::serialize_structure_output_data_config(&mut object_56, var_55);
        object_56.finish();
    }
...
pub fn serialize_structure_stop_entities_detection_v2_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_icd10_cm_inference_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_phi_detection_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_rx_norm_inference_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_comprehend_medical_async_job_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
