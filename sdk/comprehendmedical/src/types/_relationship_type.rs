...
impl RelationshipType {
    ...
    RelationshipType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["ACUITY", "ADMINISTERED_VIA", "AMOUNT", "DIRECTION", "DOSAGE", "DURATION", "EVERY", "FOR", "FORM", "FREQUENCY", "NEGATIVE", "OVERLAP", "QUALITY", "RATE", "ROUTE_OR_MODE", "STRENGTH", "SYSTEM_ORGAN_SITE", "TEST_UNIT", "TEST_UNITS", "TEST_VALUE", "USAGE", "WITH_DOSAGE"]
                }
            }
