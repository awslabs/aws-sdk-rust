...
pub(crate) fn de_too_many_requests_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::TooManyRequestsExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::TooManyRequestsExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
