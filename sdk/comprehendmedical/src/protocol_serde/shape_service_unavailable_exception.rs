...
pub(crate) fn de_service_unavailable_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ServiceUnavailableExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::ServiceUnavailableExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
