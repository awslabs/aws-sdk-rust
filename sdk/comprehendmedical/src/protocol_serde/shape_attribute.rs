...
pub(crate) fn de_attribute(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<crate::types::Attribute, ::aws_smithy_cbor::decode::DeserializeError> {
    #[allow(clippy::match_single_binding)]
    fn pair(
        mut builder: crate::types::builders::AttributeBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
