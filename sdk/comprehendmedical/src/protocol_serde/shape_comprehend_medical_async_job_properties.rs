...
pub(crate) fn de_comprehend_medical_async_job_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComprehendMedicalAsyncJobProperties>, aws_smithy_json::deserialize::error::DeserializeError>
