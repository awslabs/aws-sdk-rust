...
pub(crate) fn de_invalid_request_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidRequestExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidRequestExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
