...
pub(crate) fn de_internal_server_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InternalServerExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InternalServerExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
