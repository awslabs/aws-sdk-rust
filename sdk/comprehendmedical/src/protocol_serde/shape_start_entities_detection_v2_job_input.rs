...
pub fn ser_start_entities_detection_v2_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartEntitiesDetectionV2JobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
