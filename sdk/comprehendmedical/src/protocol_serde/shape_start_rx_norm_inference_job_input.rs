...
pub fn ser_start_rx_norm_inference_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartRxNormInferenceJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
