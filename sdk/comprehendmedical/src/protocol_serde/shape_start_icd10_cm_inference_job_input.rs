...
pub fn ser_start_icd10_cm_inference_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartIcd10CmInferenceJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
