...
pub fn ser_start_snomedct_inference_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartSnomedctInferenceJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
