...
pub(crate) fn de_icd10_cm_trait(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::Icd10CmTrait, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        mut builder: crate::types::builders::Icd10CmTraitBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
