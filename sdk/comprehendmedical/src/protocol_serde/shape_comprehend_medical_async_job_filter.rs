...
pub fn ser_comprehend_medical_async_job_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ComprehendMedicalAsyncJobFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
