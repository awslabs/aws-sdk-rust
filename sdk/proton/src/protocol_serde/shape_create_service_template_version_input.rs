...
pub fn ser_create_service_template_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateServiceTemplateVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
