...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_service_pipeline_provisioned_resources::de_list_service_pipeline_provisioned_resources(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_service_pipeline_provisioned_resources_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesError::unhandled)?
    })
}
...
pub fn ser_list_service_pipeline_provisioned_resources_input(
    ...
    crate::protocol_serde::shape_list_service_pipeline_provisioned_resources_input::ser_list_service_pipeline_provisioned_resources_input_input(
        &mut object,
        input,
    )?;
    object.finish();
