...
pub(crate) fn de_environment_template_version<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EnvironmentTemplateVersion>, aws_smithy_json::deserialize::error::DeserializeError>
