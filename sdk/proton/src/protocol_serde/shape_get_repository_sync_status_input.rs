...
pub fn ser_get_repository_sync_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetRepositorySyncStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
