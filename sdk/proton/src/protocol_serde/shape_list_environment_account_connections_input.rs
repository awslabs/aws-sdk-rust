...
pub fn ser_list_environment_account_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_environment_account_connections::ListEnvironmentAccountConnectionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
