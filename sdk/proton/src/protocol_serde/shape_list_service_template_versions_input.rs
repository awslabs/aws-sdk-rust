...
pub fn ser_list_service_template_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_service_template_versions::ListServiceTemplateVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
