            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "initialState" => {
                            builder = builder.set_initial_state(crate::protocol_serde::shape_deployment_state::de_deployment_state(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "targetState" => {
                            builder = builder.set_target_state(crate::protocol_serde::shape_deployment_state::de_deployment_state(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
