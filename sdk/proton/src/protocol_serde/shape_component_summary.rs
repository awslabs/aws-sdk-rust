...
pub(crate) fn de_component_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComponentSummary>, aws_smithy_json::deserialize::error::DeserializeError>
