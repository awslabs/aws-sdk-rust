...
pub(crate) fn de_environment_template<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EnvironmentTemplate>, aws_smithy_json::deserialize::error::DeserializeError>
