...
pub(crate) fn de_service_instance<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServiceInstance>, aws_smithy_json::deserialize::error::DeserializeError>
