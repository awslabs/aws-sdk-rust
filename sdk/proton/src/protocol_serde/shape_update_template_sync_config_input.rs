...
pub fn ser_update_template_sync_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTemplateSyncConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
