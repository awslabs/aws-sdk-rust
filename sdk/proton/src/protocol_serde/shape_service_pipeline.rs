...
pub(crate) fn de_service_pipeline<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServicePipeline>, aws_smithy_json::deserialize::error::DeserializeError>
