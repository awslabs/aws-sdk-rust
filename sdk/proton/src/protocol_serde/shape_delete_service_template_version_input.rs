...
pub fn ser_delete_service_template_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteServiceTemplateVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
