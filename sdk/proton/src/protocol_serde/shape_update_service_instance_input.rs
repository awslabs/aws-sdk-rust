...
pub fn ser_update_service_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateServiceInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
