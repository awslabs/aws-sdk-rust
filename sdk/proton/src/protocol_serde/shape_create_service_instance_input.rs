...
pub fn ser_create_service_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_service_instance::CreateServiceInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
