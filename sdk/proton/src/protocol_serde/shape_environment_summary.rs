...
pub(crate) fn de_environment_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EnvironmentSummary>, aws_smithy_json::deserialize::error::DeserializeError>
