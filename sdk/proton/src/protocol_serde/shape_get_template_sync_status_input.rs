...
pub fn ser_get_template_sync_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTemplateSyncStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
