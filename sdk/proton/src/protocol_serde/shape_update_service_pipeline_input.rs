...
pub fn ser_update_service_pipeline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateServicePipelineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
