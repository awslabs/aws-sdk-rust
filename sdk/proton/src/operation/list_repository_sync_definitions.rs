...
impl ListRepositorySyncDefinitionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_repository_sync_definitions::ListRepositorySyncDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRepositorySyncDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_repository_sync_definitions::de_list_repository_sync_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
