...
impl ListServiceTemplateVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_service_template_versions::ListServiceTemplateVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServiceTemplateVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_service_template_versions::de_list_service_template_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
