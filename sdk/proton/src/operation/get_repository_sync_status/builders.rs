...
impl GetRepositorySyncStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_repository_sync_status::GetRepositorySyncStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_repository_sync_status::GetRepositorySyncStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_repository_sync_status::GetRepositorySyncStatusOutput, crate::operation::get_repository_sync_status::GetRepositorySyncStatusError, Self> {
