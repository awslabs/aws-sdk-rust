...
impl RejectEnvironmentAccountConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reject_environment_account_connection::RejectEnvironmentAccountConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectEnvironmentAccountConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_environment_account_connection::de_reject_environment_account_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
