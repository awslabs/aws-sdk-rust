...
impl GetEnvironmentAccountConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_environment_account_connection::GetEnvironmentAccountConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEnvironmentAccountConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_environment_account_connection::de_get_environment_account_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
