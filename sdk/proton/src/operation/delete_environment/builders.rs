...
impl DeleteEnvironmentFluentBuilder  {
    /// Creates a new `DeleteEnvironment`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_environment::DeleteEnvironmentOutput, aws_smithy_http::result::SdkError<crate::operation::delete_environment::DeleteEnvironmentError>>
                     {
