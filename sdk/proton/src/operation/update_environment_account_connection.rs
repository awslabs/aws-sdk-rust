...
impl UpdateEnvironmentAccountConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_environment_account_connection::UpdateEnvironmentAccountConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEnvironmentAccountConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_environment_account_connection::de_update_environment_account_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
