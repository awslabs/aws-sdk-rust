...
impl CreateEnvironmentTemplateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_environment_template::CreateEnvironmentTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEnvironmentTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_environment_template::de_create_environment_template_http_response_with_props(status, headers, body)
        }
    }
