...
impl CancelComponentDeploymentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_component_deployment::CancelComponentDeploymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_component_deployment::CancelComponentDeploymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_component_deployment::CancelComponentDeploymentOutput, crate::operation::cancel_component_deployment::CancelComponentDeploymentError, Self> {
