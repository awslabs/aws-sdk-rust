...
impl DeleteServiceTemplateVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_service_template_version::DeleteServiceTemplateVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteServiceTemplateVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_service_template_version::de_delete_service_template_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
