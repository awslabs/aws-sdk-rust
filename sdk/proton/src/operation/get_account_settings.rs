...
impl GetAccountSettingsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_account_settings::ser_get_account_settings_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_account_settings::GetAccountSettings::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_account_settings::GetAccountSettingsError
{
