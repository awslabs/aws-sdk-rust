...
impl GetAccountSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_account_settings::GetAccountSettings,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_account_settings::ser_get_account_settings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_account_settings::de_get_account_settings_http_response_with_props(status, headers, body)
        }
    }
}
