...
impl CreateEnvironmentTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_environment_template::CreateEnvironmentTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
