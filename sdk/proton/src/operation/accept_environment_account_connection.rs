...
impl AcceptEnvironmentAccountConnectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::accept_environment_account_connection::AcceptEnvironmentAccountConnection,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_environment_account_connection::AcceptEnvironmentAccountConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptEnvironmentAccountConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_environment_account_connection::de_accept_environment_account_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
