...
impl CancelEnvironmentDeploymentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_environment_deployment::CancelEnvironmentDeployment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelEnvironmentDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_environment_deployment::de_cancel_environment_deployment_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CancelEnvironmentDeploymentError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_environment_deployment::CancelEnvironmentDeploymentError
{
