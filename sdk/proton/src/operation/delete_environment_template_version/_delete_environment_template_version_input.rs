...
impl DeleteEnvironmentTemplateVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_environment_template_version::DeleteEnvironmentTemplateVersionInput, ::aws_smithy_types::error::operation::BuildError> {
