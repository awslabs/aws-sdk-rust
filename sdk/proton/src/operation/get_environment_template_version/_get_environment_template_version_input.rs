...
impl GetEnvironmentTemplateVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_environment_template_version::GetEnvironmentTemplateVersionInput, ::aws_smithy_types::error::operation::BuildError> {
