...
impl ListEnvironmentAccountConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_environment_account_connections::ListEnvironmentAccountConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
