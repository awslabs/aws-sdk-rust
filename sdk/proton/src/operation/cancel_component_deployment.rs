...
impl CancelComponentDeploymentInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_component_deployment::CancelComponentDeployment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelComponentDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_component_deployment::de_cancel_component_deployment_http_response_with_props(status, headers, body)
        }
    }
