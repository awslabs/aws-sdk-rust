...
impl CancelServicePipelineDeploymentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_service_pipeline_deployment::CancelServicePipelineDeploymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_service_pipeline_deployment::CancelServicePipelineDeploymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_service_pipeline_deployment::CancelServicePipelineDeploymentOutput, crate::operation::cancel_service_pipeline_deployment::CancelServicePipelineDeploymentError, Self> {
