...
impl DeleteDeploymentInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDeployment`](crate::operation::delete_deployment::DeleteDeployment)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_deployment::DeleteDeployment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_deployment::ser_delete_deployment_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_deployment::DeleteDeployment::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDeployment", "proton"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_deployment::de_delete_deployment_http_response_with_props(status, headers, body)
        }
    }
