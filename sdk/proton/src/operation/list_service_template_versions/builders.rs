...
impl ListServiceTemplateVersionsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_service_template_versions();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_service_template_versions::ListServiceTemplateVersionsOutput,
                    crate::operation::list_service_template_versions::ListServiceTemplateVersionsError,
                > for ListServiceTemplateVersionsFluentBuilder
            {
                fn send(
                    self,
...
impl ListServiceTemplateVersionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_service_template_versions::ListServiceTemplateVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_service_template_versions::ListServiceTemplateVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_service_template_versions::ListServiceTemplateVersions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_service_template_versions::ListServiceTemplateVersions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_service_template_versions::ListServiceTemplateVersionsOutput, crate::operation::list_service_template_versions::ListServiceTemplateVersionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_service_template_versions::paginator::ListServiceTemplateVersionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
