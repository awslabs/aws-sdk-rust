...
impl CreateTemplateSyncConfigInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_template_sync_config::CreateTemplateSyncConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTemplateSyncConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_template_sync_config::de_create_template_sync_config_http_response_with_props(status, headers, body)
        }
    }
}
