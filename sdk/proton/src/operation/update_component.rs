...
impl UpdateComponentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_component::UpdateComponent, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_component::ser_update_component_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateComponent {
    type Output =
        ::std::result::Result<crate::operation::update_component::UpdateComponentOutput, crate::operation::update_component::UpdateComponentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_component::de_update_component_http_response_with_props(status, headers, body)
        }
    }
