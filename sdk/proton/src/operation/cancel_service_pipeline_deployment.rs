...
impl CancelServicePipelineDeploymentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_service_pipeline_deployment::CancelServicePipelineDeployment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelServicePipelineDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_service_pipeline_deployment::de_cancel_service_pipeline_deployment_http_response_with_props(
                status, headers, body,
            )
        }
    }
