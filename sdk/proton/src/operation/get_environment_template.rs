...
impl GetEnvironmentTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_environment_template::GetEnvironmentTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEnvironmentTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_environment_template::de_get_environment_template_http_response_with_props(status, headers, body)
        }
    }
