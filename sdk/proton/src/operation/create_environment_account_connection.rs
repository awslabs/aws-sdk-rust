...
impl CreateEnvironmentAccountConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEnvironmentAccountConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_environment_account_connection::de_create_environment_account_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
