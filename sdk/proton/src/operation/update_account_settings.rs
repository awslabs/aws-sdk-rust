...
impl UpdateAccountSettings {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Proton", "UpdateAccountSettings", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAccountSettingsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("pipelineServiceRoleArn") {
            if let ::std::option::Option::Some(value) = input.pipeline_service_role_arn.as_deref() {
                captured.insert("pipelineServiceRoleArn", value);
            }
        }
        if requested.should_capture("pipelineCodebuildRoleArn") {
            if let ::std::option::Option::Some(value) = input.pipeline_codebuild_role_arn.as_deref() {
                captured.insert("pipelineCodebuildRoleArn", value);
            }
        }
