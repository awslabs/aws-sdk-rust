...
impl GetServiceTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_service_template::GetServiceTemplate,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_template::ser_get_service_template_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_template::de_get_service_template_http_response_with_props(status, headers, body)
        }
    }
