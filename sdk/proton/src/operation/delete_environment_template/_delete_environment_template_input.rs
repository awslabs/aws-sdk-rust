...
impl DeleteEnvironmentTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_environment_template::DeleteEnvironmentTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
