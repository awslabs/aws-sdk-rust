...
impl GetServiceInstanceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_instance::ser_get_service_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_instance::de_get_service_instance_http_response_with_props(status, headers, body)
        }
    }
