...
impl GetServiceInstanceSyncStatusInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_service_instance_sync_status::GetServiceInstanceSyncStatusInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
