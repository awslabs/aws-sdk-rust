...
impl ListEnvironmentProvisionedResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_environment_provisioned_resources::ListEnvironmentProvisionedResourcesInput, ::aws_smithy_types::error::operation::BuildError> {
