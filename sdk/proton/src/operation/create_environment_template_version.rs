...
impl CreateEnvironmentTemplateVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_environment_template_version::CreateEnvironmentTemplateVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEnvironmentTemplateVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_environment_template_version::de_create_environment_template_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
