...
impl ListRepositorySyncDefinitionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_repository_sync_definitions::ListRepositorySyncDefinitionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_repository_sync_definitions::ListRepositorySyncDefinitionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_repository_sync_definitions::ListRepositorySyncDefinitionsOutput, crate::operation::list_repository_sync_definitions::ListRepositorySyncDefinitionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_repository_sync_definitions::paginator::ListRepositorySyncDefinitionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
