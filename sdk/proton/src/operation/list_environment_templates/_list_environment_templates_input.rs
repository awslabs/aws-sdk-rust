...
impl ListEnvironmentTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_environment_templates::ListEnvironmentTemplatesInput, ::aws_smithy_types::error::operation::BuildError> {
