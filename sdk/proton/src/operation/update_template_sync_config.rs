...
impl UpdateTemplateSyncConfigInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_template_sync_config::UpdateTemplateSyncConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTemplateSyncConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_template_sync_config::de_update_template_sync_config_http_response_with_props(status, headers, body)
        }
    }
}
