...
impl GetDeploymentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_deployment::ser_get_deployment_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_deployment::GetDeployment::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDeployment", "proton"));
