...
impl ListServicePipelineProvisionedResourcesInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_service_pipeline_provisioned_resources::ListServicePipelineProvisionedResourcesInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
