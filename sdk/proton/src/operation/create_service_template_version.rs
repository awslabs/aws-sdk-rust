...
impl CreateServiceTemplateVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_service_template_version::CreateServiceTemplateVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateServiceTemplateVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_service_template_version::de_create_service_template_version_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateServiceTemplateVersionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_service_template_version::CreateServiceTemplateVersionError
{
