...
impl ListEnvironmentProvisionedResourcesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_environment_provisioned_resources::ListEnvironmentProvisionedResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEnvironmentProvisionedResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_environment_provisioned_resources::de_list_environment_provisioned_resources_http_response_with_props(
                status, headers, body,
            )
        }
    }
