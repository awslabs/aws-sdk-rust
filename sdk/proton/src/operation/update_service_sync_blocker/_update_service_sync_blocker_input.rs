...
impl UpdateServiceSyncBlockerInputBuilder {
    ...
    pub fn resolved_reason(mut self, input: impl Into<std::string::String>) -> Self {
        self.resolved_reason = Some(input.into());
        self
    }
    /// <p>The reason the service sync blocker was resolved.</p>
    ...
    pub fn build(self) -> Result<crate::operation::update_service_sync_blocker::UpdateServiceSyncBlockerInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
