...
impl UpdateServiceSyncBlockerFluentBuilder  {
    /// Creates a new `UpdateServiceSyncBlocker`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_service_sync_blocker::UpdateServiceSyncBlocker, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::update_service_sync_blocker::UpdateServiceSyncBlockerError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_service_sync_blocker::UpdateServiceSyncBlockerOutput, aws_smithy_http::result::SdkError<crate::operation::update_service_sync_blocker::UpdateServiceSyncBlockerError>>
                     {
