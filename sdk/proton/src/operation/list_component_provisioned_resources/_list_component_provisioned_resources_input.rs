...
impl ListComponentProvisionedResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_component_provisioned_resources::ListComponentProvisionedResourcesInput, ::aws_smithy_types::error::operation::BuildError> {
