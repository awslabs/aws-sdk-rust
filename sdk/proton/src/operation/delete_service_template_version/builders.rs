...
impl DeleteServiceTemplateVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_service_template_version::DeleteServiceTemplateVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_service_template_version::DeleteServiceTemplateVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_service_template_version::DeleteServiceTemplateVersionOutput, crate::operation::delete_service_template_version::DeleteServiceTemplateVersionError, Self> {
