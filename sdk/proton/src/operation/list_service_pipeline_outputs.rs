...
impl ListServicePipelineOutputsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_service_pipeline_outputs::ListServicePipelineOutputs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServicePipelineOutputs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_service_pipeline_outputs::de_list_service_pipeline_outputs_http_response_with_props(
                status, headers, body,
            )
        }
    }
