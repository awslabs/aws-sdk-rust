...
impl DeleteTemplateSyncConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_template_sync_config::DeleteTemplateSyncConfigInput, ::aws_smithy_types::error::operation::BuildError> {
