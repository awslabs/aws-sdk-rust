...
impl ListEnvironmentTemplateVersionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_environment_template_versions::ListEnvironmentTemplateVersions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_environment_template_versions::ListEnvironmentTemplateVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEnvironmentTemplateVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_environment_template_versions::de_list_environment_template_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
