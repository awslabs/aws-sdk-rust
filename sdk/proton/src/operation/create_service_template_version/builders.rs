...
impl CreateServiceTemplateVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_service_template_version::CreateServiceTemplateVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_service_template_version::CreateServiceTemplateVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_service_template_version::CreateServiceTemplateVersionOutput, crate::operation::create_service_template_version::CreateServiceTemplateVersionError, Self> {
