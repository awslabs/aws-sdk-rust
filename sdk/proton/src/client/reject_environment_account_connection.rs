...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::reject_environment_account_connection::builders::RejectEnvironmentAccountConnectionFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::reject_environment_account_connection::builders::RejectEnvironmentAccountConnectionFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the environment account connection to reject.</p><br>
