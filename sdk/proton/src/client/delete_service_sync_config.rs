...
impl super::Client {
    ...
    pub fn delete_service_sync_config(
        &self,
    ) -> crate::operation::delete_service_sync_config::builders::DeleteServiceSyncConfigFluentBuilder
    {
