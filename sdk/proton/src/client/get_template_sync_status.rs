...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::get_template_sync_status::builders::GetTemplateSyncStatusFluentBuilder::template_name) / [`set_template_name(impl Into<String>)`](crate::operation::get_template_sync_status::builders::GetTemplateSyncStatusFluentBuilder::set_template_name):<br>required: **true**<br><p>The template name.</p><br>
    ///   - [`template_type(TemplateType)`](crate::operation::get_template_sync_status::builders::GetTemplateSyncStatusFluentBuilder::template_type) / [`set_template_type(TemplateType)`](crate::operation::get_template_sync_status::builders::GetTemplateSyncStatusFluentBuilder::set_template_type):<br>required: **true**<br><p>The template type.</p><br>
    ///   - [`template_version(impl Into<String>)`](crate::operation::get_template_sync_status::builders::GetTemplateSyncStatusFluentBuilder::template_version) / [`set_template_version(impl Into<String>)`](crate::operation::get_template_sync_status::builders::GetTemplateSyncStatusFluentBuilder::set_template_version):<br>required: **true**<br><p>The template major version.</p><br>
