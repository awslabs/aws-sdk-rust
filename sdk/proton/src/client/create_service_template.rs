...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_service_template::builders::CreateServiceTemplateFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_service_template::builders::CreateServiceTemplateFluentBuilder::set_name): <p>The name of the service template.</p>
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_service_template::builders::CreateServiceTemplateFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_service_template::builders::CreateServiceTemplateFluentBuilder::set_description): <p>A description of the service template.</p>
