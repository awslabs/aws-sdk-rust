...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_service_sync_blocker::builders::UpdateServiceSyncBlockerFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::update_service_sync_blocker::builders::UpdateServiceSyncBlockerFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the service sync blocker.</p><br>
    ///   - [`resolved_reason(impl Into<String>)`](crate::operation::update_service_sync_blocker::builders::UpdateServiceSyncBlockerFluentBuilder::resolved_reason) / [`set_resolved_reason(impl Into<String>)`](crate::operation::update_service_sync_blocker::builders::UpdateServiceSyncBlockerFluentBuilder::set_resolved_reason):<br>required: **true**<br><p>The reason the service sync blocker was resolved.</p><br>
