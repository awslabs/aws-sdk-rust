...
impl super::Client  {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_service_sync_blocker::builders::UpdateServiceSyncBlockerFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_service_sync_blocker::builders::UpdateServiceSyncBlockerFluentBuilder::set_id): <p>The ID of the service sync blocker.</p>
