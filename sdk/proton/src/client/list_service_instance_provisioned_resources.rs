...
impl super::Client {
    ...
    ///   - [`service_name(impl Into<String>)`](crate::operation::list_service_instance_provisioned_resources::builders::ListServiceInstanceProvisionedResourcesFluentBuilder::service_name) / [`set_service_name(impl Into<String>)`](crate::operation::list_service_instance_provisioned_resources::builders::ListServiceInstanceProvisionedResourcesFluentBuilder::set_service_name):<br>required: **true**<br><p>The name of the service that <code>serviceInstanceName</code> is associated to.</p><br>
    ///   - [`service_instance_name(impl Into<String>)`](crate::operation::list_service_instance_provisioned_resources::builders::ListServiceInstanceProvisionedResourcesFluentBuilder::service_instance_name) / [`set_service_instance_name(impl Into<String>)`](crate::operation::list_service_instance_provisioned_resources::builders::ListServiceInstanceProvisionedResourcesFluentBuilder::set_service_instance_name):<br>required: **true**<br><p>The name of the service instance whose provisioned resources you want.</p><br>
