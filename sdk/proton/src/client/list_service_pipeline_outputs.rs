...
impl super::Client {
    ...
    ///   - [`service_name(impl ::std::convert::Into<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::set_service_name): <p>The name of the service whose pipeline's outputs you want.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::set_next_token): <p>A token that indicates the location of the next output in the array of outputs, after the list of outputs that was previously requested.</p>
    ///   - [`deployment_id(impl ::std::convert::Into<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::set_deployment_id): <p>The ID of the deployment you want the outputs for.</p>
