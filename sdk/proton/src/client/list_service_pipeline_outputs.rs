...
impl super::Client {
    ...
    ///   - [`service_name(impl Into<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::service_name) / [`set_service_name(impl Into<String>)`](crate::operation::list_service_pipeline_outputs::builders::ListServicePipelineOutputsFluentBuilder::set_service_name):<br>required: **true**<br><p>The name of the service whose pipeline's outputs you want.</p><br>
