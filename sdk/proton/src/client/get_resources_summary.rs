...
impl super::Client {
    ...
    pub fn get_resources_summary(
        &self,
    ) -> crate::operation::get_resources_summary::builders::GetResourcesSummaryFluentBuilder {
        crate::operation::get_resources_summary::builders::GetResourcesSummaryFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
