...
impl super::Client {
    ...
    pub fn get_service_sync_config(
        &self,
    ) -> crate::operation::get_service_sync_config::builders::GetServiceSyncConfigFluentBuilder
    {
        crate::operation::get_service_sync_config::builders::GetServiceSyncConfigFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
