...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_component::builders::GetComponentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_component::builders::GetComponentFluentBuilder::set_name):<br>required: **true**<br><p>The name of the component that you want to get the detailed data for.</p><br>
