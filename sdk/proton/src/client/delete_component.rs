...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_component::builders::DeleteComponentFluentBuilder::set_name):<br>required: **true**<br><p>The name of the component to delete.</p><br>
