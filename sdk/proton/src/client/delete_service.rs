...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::set_name): <p>The name of the service to delete.</p>
