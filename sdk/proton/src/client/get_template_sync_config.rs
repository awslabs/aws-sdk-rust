...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::get_template_sync_config::builders::GetTemplateSyncConfigFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::get_template_sync_config::builders::GetTemplateSyncConfigFluentBuilder::set_template_name):<br>required: **true**<br><p>The template name.</p><br>
    ///   - [`template_type(TemplateType)`](crate::operation::get_template_sync_config::builders::GetTemplateSyncConfigFluentBuilder::template_type) / [`set_template_type(Option<TemplateType>)`](crate::operation::get_template_sync_config::builders::GetTemplateSyncConfigFluentBuilder::set_template_type):<br>required: **true**<br><p>The template type.</p><br>
