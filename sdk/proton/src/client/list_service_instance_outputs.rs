...
impl super::Client {
    ...
    ///   - [`service_instance_name(impl Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::service_instance_name) / [`set_service_instance_name(impl Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::set_service_instance_name):<br>required: **true**<br><p>The name of the service instance whose outputs you want.</p><br>
    ///   - [`service_name(impl Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::service_name) / [`set_service_name(impl Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::set_service_name):<br>required: **true**<br><p>The name of the service that <code>serviceInstanceName</code> is associated to.</p><br>
