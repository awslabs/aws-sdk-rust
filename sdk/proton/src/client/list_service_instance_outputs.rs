...
impl super::Client {
    ...
    ///   - [`service_instance_name(impl ::std::convert::Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::service_instance_name) / [`set_service_instance_name(Option<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::set_service_instance_name): <p>The name of the service instance whose outputs you want.</p>
    ///   - [`service_name(impl ::std::convert::Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::set_service_name): <p>The name of the service that <code>serviceInstanceName</code> is associated to.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::set_next_token): <p>A token that indicates the location of the next output in the array of outputs, after the list of outputs that was previously requested.</p>
    ///   - [`deployment_id(impl ::std::convert::Into<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::list_service_instance_outputs::builders::ListServiceInstanceOutputsFluentBuilder::set_deployment_id): <p>The ID of the deployment whose outputs you want.</p>
