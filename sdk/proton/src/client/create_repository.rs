...
impl super::Client {
    ...
    ///   - [`provider(RepositoryProvider)`](crate::operation::create_repository::builders::CreateRepositoryFluentBuilder::provider) / [`set_provider(RepositoryProvider)`](crate::operation::create_repository::builders::CreateRepositoryFluentBuilder::set_provider):<br>required: **true**<br><p>The repository provider.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_repository::builders::CreateRepositoryFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_repository::builders::CreateRepositoryFluentBuilder::set_name):<br>required: **true**<br><p>The repository name (for example, <code>myrepos/myrepo</code>).</p><br>
    ///   - [`connection_arn(impl Into<String>)`](crate::operation::create_repository::builders::CreateRepositoryFluentBuilder::connection_arn) / [`set_connection_arn(impl Into<String>)`](crate::operation::create_repository::builders::CreateRepositoryFluentBuilder::set_connection_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of your AWS CodeStar connection that connects Proton to your repository provider account. For more information, see <a href="https://docs.aws.amazon.com/proton/latest/userguide/setting-up-for-service.html">Setting up for Proton</a> in the <i>Proton User Guide</i>.</p><br>
