...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_name):<br>required: **true**<br><p>The name of the service that you want to get the detailed data for.</p><br>
