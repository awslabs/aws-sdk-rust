...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_environment_template::builders::DeleteEnvironmentTemplateFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_environment_template::builders::DeleteEnvironmentTemplateFluentBuilder::set_name):<br>required: **true**<br><p>The name of the environment template to delete.</p><br>
