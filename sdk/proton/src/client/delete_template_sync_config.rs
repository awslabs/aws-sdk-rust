...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::delete_template_sync_config::builders::DeleteTemplateSyncConfigFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::delete_template_sync_config::builders::DeleteTemplateSyncConfigFluentBuilder::set_template_name):<br>required: **true**<br><p>The template name.</p><br>
