...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_service_template::builders::DeleteServiceTemplateFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::delete_service_template::builders::DeleteServiceTemplateFluentBuilder::set_name):<br>required: **true**<br><p>The name of the service template to delete.</p><br>
