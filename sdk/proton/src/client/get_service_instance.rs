...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_service_instance::builders::GetServiceInstanceFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::get_service_instance::builders::GetServiceInstanceFluentBuilder::set_name):<br>required: **true**<br><p>The name of a service instance that you want to get the detailed data for.</p><br>
    ///   - [`service_name(impl Into<String>)`](crate::operation::get_service_instance::builders::GetServiceInstanceFluentBuilder::service_name) / [`set_service_name(impl Into<String>)`](crate::operation::get_service_instance::builders::GetServiceInstanceFluentBuilder::set_service_name):<br>required: **true**<br><p>The name of the service that you want the service instance input for.</p><br>
