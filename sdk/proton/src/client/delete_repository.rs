...
impl super::Client {
    ...
    ///   - [`provider(RepositoryProvider)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::provider) / [`set_provider(RepositoryProvider)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::set_provider):<br>required: **true**<br><p>The repository provider.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::delete_repository::builders::DeleteRepositoryFluentBuilder::set_name):<br>required: **true**<br><p>The repository name.</p><br>
