...
impl super::Client {
    ...
    ///   - [`service_name(impl ::std::convert::Into<String>)`](crate::operation::get_service_instance_sync_status::builders::GetServiceInstanceSyncStatusFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::get_service_instance_sync_status::builders::GetServiceInstanceSyncStatusFluentBuilder::set_service_name): <p>The name of the service that the service instance belongs to.</p>
    ///   - [`service_instance_name(impl ::std::convert::Into<String>)`](crate::operation::get_service_instance_sync_status::builders::GetServiceInstanceSyncStatusFluentBuilder::service_instance_name) / [`set_service_instance_name(Option<String>)`](crate::operation::get_service_instance_sync_status::builders::GetServiceInstanceSyncStatusFluentBuilder::set_service_instance_name): <p>The name of the service instance that you want the sync status input for.</p>
