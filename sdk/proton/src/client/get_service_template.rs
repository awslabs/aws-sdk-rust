...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_service_template::builders::GetServiceTemplateFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::get_service_template::builders::GetServiceTemplateFluentBuilder::set_name):<br>required: **true**<br><p>The name of the service template that you want to get detailed data for.</p><br>
