...
impl super::Client {
    ...
    pub fn get_service_template(
        &self,
    ) -> crate::operation::get_service_template::builders::GetServiceTemplateFluentBuilder {
        crate::operation::get_service_template::builders::GetServiceTemplateFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
