...
impl EnvironmentTemplateVersionSummary {
    /// Creates a new builder-style object to manufacture [`EnvironmentTemplateVersionSummary`](crate::types::EnvironmentTemplateVersionSummary).
    pub fn builder() -> crate::types::builders::EnvironmentTemplateVersionSummaryBuilder {
        crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::default()
    }
}

/// A builder for [`EnvironmentTemplateVersionSummary`](crate::types::EnvironmentTemplateVersionSummary).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
pub struct EnvironmentTemplateVersionSummaryBuilder {
...
impl EnvironmentTemplateVersionSummaryBuilder {
    /// <p>The name of the environment template.</p>
    ...
    /// Consumes the builder and constructs a [`EnvironmentTemplateVersionSummary`](crate::types::EnvironmentTemplateVersionSummary).
    /// This method will fail if any of the following fields are not set:
    /// - [`template_name`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::template_name)
    /// - [`major_version`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::major_version)
    /// - [`minor_version`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::minor_version)
    /// - [`status`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::status)
    /// - [`arn`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::arn)
    /// - [`created_at`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::created_at)
    /// - [`last_modified_at`](crate::types::builders::EnvironmentTemplateVersionSummaryBuilder::last_modified_at)
    pub fn build(self) -> ::std::result::Result<crate::types::EnvironmentTemplateVersionSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::EnvironmentTemplateVersionSummary {
                template_name: self.template_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("template_name", "template_name was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
                major_version: self.major_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("major_version", "major_version was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
                minor_version: self.minor_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("minor_version", "minor_version was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
                ...
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
                last_modified_at: self.last_modified_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_at", "last_modified_at was not specified but it is required when building EnvironmentTemplateVersionSummary")
                    )?
                ,
            }
        )
...
impl ::std::fmt::Debug for EnvironmentTemplateVersionSummaryBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("EnvironmentTemplateVersionSummaryBuilder");
        formatter.field("template_name", &self.template_name);
        formatter.field("major_version", &self.major_version);
        formatter.field("minor_version", &self.minor_version);
        formatter.field("recommended_minor_version", &self.recommended_minor_version);
