...
pub fn serialize_structure_put_raw_message_content_input(
    ...
    if let Some(var_1) = &input.content {
        ...
        crate::json_ser::serialize_structure_raw_message_content(&mut object_2, var_1);
        object_2.finish();
    }
}

pub fn serialize_structure_raw_message_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_3) = &input.s3_reference {
        ...
        crate::json_ser::serialize_structure_s3_reference(&mut object_4, var_3);
        object_4.finish();
    }
}

pub fn serialize_structure_s3_reference(
    object: &mut smithy_json::serialize::JsonObjectWriter,
