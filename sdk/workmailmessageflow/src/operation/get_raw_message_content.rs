...
impl GetRawMessageContentInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_raw_message_content::GetRawMessageContent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_raw_message_content::GetRawMessageContentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseHttpResponse for GetRawMessageContent {
                ...
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    ...
                    Some(crate::protocol_serde::shape_get_raw_message_content::de_get_raw_message_content_http_response_(response))
                }
