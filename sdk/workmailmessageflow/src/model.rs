...
pub struct RawMessageContent  {
    ...
    #[doc(hidden)]pub s3_reference: std::option::Option<crate::model::S3Reference>,
}
...
pub mod raw_message_content {
    ...
    impl Builder {
        ...
        /// <p>The S3 reference of an email message.</p>
        pub fn set_s3_reference(mut self, input: std::option::Option<crate::model::S3Reference>) -> Self {
