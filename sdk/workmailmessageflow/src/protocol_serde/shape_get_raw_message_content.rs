...
pub fn de_get_raw_message_content_http_response_(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::operation::get_raw_message_content::GetRawMessageContentOutput, crate::operation::get_raw_message_content::GetRawMessageContentError> {
