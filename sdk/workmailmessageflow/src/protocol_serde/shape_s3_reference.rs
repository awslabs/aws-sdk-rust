...
pub fn ser_s3_reference(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3Reference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
