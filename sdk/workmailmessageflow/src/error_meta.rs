...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::get_raw_message_content::GetRawMessageContentError, R>> for Error
where
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::put_raw_message_content::PutRawMessageContentError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
