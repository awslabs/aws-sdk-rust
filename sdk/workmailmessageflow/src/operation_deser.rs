...
#[allow(clippy::unnecessary_wraps)]pub fn parse_get_raw_message_content(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::output::GetRawMessageContentOutput, crate::error::GetRawMessageContentError> {
    #[allow(unused_variables)]let (response, properties) = op_response.parts_mut();
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::get_raw_message_content_output::Builder::default();
        let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_get_raw_message_content_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRawMessageContentOutput, crate::error::GetRawMessageContentError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_put_raw_message_content_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutRawMessageContentOutput, crate::error::PutRawMessageContentError> {
    ...
    Err(match error_code {
        "InvalidContentLocation" => crate::error::PutRawMessageContentError { meta: generic, kind: crate::error::PutRawMessageContentErrorKind::InvalidContentLocation({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::invalid_content_location::Builder::default();
                    let _ = response;
        ...
        "MessageFrozen" => crate::error::PutRawMessageContentError { meta: generic, kind: crate::error::PutRawMessageContentErrorKind::MessageFrozen({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::message_frozen::Builder::default();
                    let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_put_raw_message_content_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutRawMessageContentOutput, crate::error::PutRawMessageContentError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::put_raw_message_content_output::Builder::default();
        let _ = response;
        output.build()
    })
}
