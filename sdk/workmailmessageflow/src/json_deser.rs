...
pub fn deser_structure_crate_error_invalid_content_location_json_err(value: &[u8], mut builder: crate::error::invalid_content_location::Builder) -> Result<crate::error::invalid_content_location::Builder, aws_smithy_json::deserialize::Error> {
    let mut tokens_owned = aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value)).peekable();
                        let tokens = &mut tokens_owned;
                        aws_smithy_json::deserialize::token::expect_start_object(tokens.next())?;
    loop {
...
pub fn deser_structure_crate_error_message_frozen_json_err(value: &[u8], mut builder: crate::error::message_frozen::Builder) -> Result<crate::error::message_frozen::Builder, aws_smithy_json::deserialize::Error> {
    let mut tokens_owned = aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value)).peekable();
                        let tokens = &mut tokens_owned;
                        aws_smithy_json::deserialize::token::expect_start_object(tokens.next())?;
    loop {
