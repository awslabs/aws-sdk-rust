...
impl Builder {
    ...
    /// rules for `aws_sdk_iotroborunner`.
    ///
    /// # Examples
    /// ```no_run
    /// use aws_smithy_http::endpoint;
    /// use aws_sdk_iotroborunner::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_iotroborunner::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    /// # Examples
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::Config;
    /// use aws_sdk_iotroborunner::config::retry::RetryConfig;
    ///
    ...
    /// # Examples
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::{Builder, Config};
    /// use aws_sdk_iotroborunner::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// use aws_sdk_iotroborunner::config::Config;
    /// use aws_sdk_iotroborunner::config::timeout::TimeoutConfig;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_iotroborunner::Config::builder();
    ...
    /// use aws_sdk_iotroborunner::config::{Builder, Config};
    ///
    /// let config = aws_sdk_iotroborunner::Config::builder()
