...
/// Configuration for a aws_sdk_iotroborunner service client.
///
///
...
impl Builder {
    ...
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_iotroborunner::Config::builder().endpoint_resolver(resolver).build();
    ...
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::IdentityCache;
    ///
    ...
    /// ```no_run
    /// use aws_sdk_iotroborunner::config::BehaviorMajorVersion;
    ///
    /// let config = aws_sdk_iotroborunner::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("iotroborunner"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_iotroborunner::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("IoTRoboRunner");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_iotroborunner::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
    ...
    let mut plugins = ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins::new()
                    ...
                    .with_client_plugins(::aws_smithy_runtime::client::defaults::default_plugins(
                        ::aws_smithy_runtime::client::defaults::DefaultPluginParams::new()
                            .with_retry_partition_name("iotroborunner")
