...
impl CreateSiteInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_site::CreateSite, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_site::ser_create_site_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSite {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_site::de_create_site_http_response_with_props(status, headers, body)
        }
    }
}
