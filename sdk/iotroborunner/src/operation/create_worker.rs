...
impl CreateWorkerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_worker::CreateWorker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_worker::de_create_worker_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_worker::de_create_worker_http_response_with_props(
                status, headers, body,
            )
        }
    }
