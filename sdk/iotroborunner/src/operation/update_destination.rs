...
impl UpdateDestinationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_destination::ser_update_destination_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_destination::de_update_destination_http_response_with_props(status, headers, body)
        }
    }
}
