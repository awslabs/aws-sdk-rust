...
impl WorkerBuilder {
    ...
    /// - [`arn`](crate::types::builders::WorkerBuilder::arn)
    /// - [`id`](crate::types::builders::WorkerBuilder::id)
    /// - [`fleet`](crate::types::builders::WorkerBuilder::fleet)
    /// - [`created_at`](crate::types::builders::WorkerBuilder::created_at)
