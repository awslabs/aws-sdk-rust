...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_site::builders::GetSiteFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::get_site::builders::GetSiteFluentBuilder::set_id):<br>required: **true**<br>Site ARN.<br>
