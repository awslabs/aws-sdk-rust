...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_destination::builders::GetDestinationFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::get_destination::builders::GetDestinationFluentBuilder::set_id):<br>required: **true**<br>Destination ARN.<br>
