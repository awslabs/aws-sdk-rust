...
impl super::Client {
    ...
    ///   - [`site(impl Into<String>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::site) / [`set_site(Option<String>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::set_site):<br>required: **true**<br>Site ARN.<br>
