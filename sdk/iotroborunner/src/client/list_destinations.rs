...
impl super::Client {
    ...
    ///   - [`site(impl Into<String>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::site) / [`set_site(impl Into<String>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::set_site):<br>required: **true**<br>Site ARN.<br>
    ///   - [`max_results(i32)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::set_max_results):<br>required: **false**<br>Maximum number of results to retrieve in a single call.<br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_destinations::builders::ListDestinationsFluentBuilder::set_next_token):<br>required: **false**<br>Pagination token returned when another page of data exists. Provide it in your next call to the API to receive the next page.<br>
