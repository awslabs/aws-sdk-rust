...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::set_id):<br>required: **true**<br>Site ARN.<br>
