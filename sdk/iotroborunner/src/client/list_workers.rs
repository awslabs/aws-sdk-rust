...
impl super::Client {
    ...
    ///   - [`site(impl ::std::convert::Into<String>)`](crate::operation::list_workers::builders::ListWorkersFluentBuilder::site) / [`set_site(Option<String>)`](crate::operation::list_workers::builders::ListWorkersFluentBuilder::set_site): Site ARN.
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_workers::builders::ListWorkersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_workers::builders::ListWorkersFluentBuilder::set_next_token): Pagination token returned when another page of data exists. Provide it in your next call to the API to receive the next page.
    ///   - [`fleet(impl ::std::convert::Into<String>)`](crate::operation::list_workers::builders::ListWorkersFluentBuilder::fleet) / [`set_fleet(Option<String>)`](crate::operation::list_workers::builders::ListWorkersFluentBuilder::set_fleet): Full ARN of the worker fleet.
