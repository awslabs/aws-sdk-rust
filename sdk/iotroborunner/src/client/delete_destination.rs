...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_destination::builders::DeleteDestinationFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::delete_destination::builders::DeleteDestinationFluentBuilder::set_id):<br>required: **true**<br>Destination ARN.<br>
