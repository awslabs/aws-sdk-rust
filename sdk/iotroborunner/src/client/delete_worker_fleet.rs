...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_worker_fleet::builders::DeleteWorkerFleetFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::delete_worker_fleet::builders::DeleteWorkerFleetFluentBuilder::set_id):<br>required: **true**<br>Full ARN of the worker fleet.<br>
