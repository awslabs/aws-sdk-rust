...
pub fn ser_create_worker_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
