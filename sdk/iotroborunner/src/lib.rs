...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("iotroborunner", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS IoT RoboRunner.
pub mod client;
