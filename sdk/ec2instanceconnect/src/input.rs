...
pub mod send_serial_console_ssh_public_key_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::SendSerialConsoleSshPublicKeyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl SendSerialConsoleSshPublicKeyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::SendSerialConsoleSSHPublicKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::SendSerialConsoleSshPublicKeyInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::SendSerialConsoleSSHPublicKey::new())
...
pub mod send_ssh_public_key_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::SendSshPublicKeyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl SendSshPublicKeyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::SendSSHPublicKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::SendSshPublicKeyInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::SendSSHPublicKey::new())
...
pub struct SendSshPublicKeyInput  {
    ...
    /// <p>The OS user on the EC2 instance for whom the key can be used to authenticate.</p>
    #[doc(hidden)]pub instance_os_user: std::option::Option<std::string::String>,
    /// <p>The public key material. To use the public key, you must have the matching private key.</p>
...
pub struct SendSerialConsoleSshPublicKeyInput  {
    ...
    /// <p>The serial port of the EC2 instance. Currently only port 0 is supported.</p> 
    /// <p>Default: 0</p>
    #[doc(hidden)]pub serial_port: i32,
    /// <p>The public key material. To use the public key, you must have the matching private key. For information about the supported key formats and lengths, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html#how-to-generate-your-own-key-and-import-it-to-aws">Requirements for key pairs</a> in the <i>Amazon EC2 User Guide</i>.</p>
    #[doc(hidden)]pub ssh_public_key: std::option::Option<std::string::String>,
}
impl SendSerialConsoleSshPublicKeyInput {
