...
impl SendSerialConsoleSshPublicKeyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_serial_console_ssh_public_key::SendSerialConsoleSSHPublicKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendSerialConsoleSSHPublicKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_serial_console_ssh_public_key::de_send_serial_console_ssh_public_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
