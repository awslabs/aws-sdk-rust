    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::send_ssh_public_key::SendSSHPublicKeyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::send_ssh_public_key::SendSshPublicKeyOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendSSHPublicKey {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendSSHPublicKey")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SendSSHPublicKeyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SendSSHPublicKeyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendSSHPublicKeyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SendSshPublicKeyInput>() else {
        ...
        if requested.should_capture("InstanceOSUser") {
            if let ::std::option::Option::Some(value) = input.instance_os_user.as_deref() {
                captured.insert("InstanceOSUser", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendSSHPublicKeyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_send_ssh_public_key::de_send_ssh_public_key_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_send_ssh_public_key::de_send_ssh_public_key_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendSSHPublicKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::send_ssh_public_key::SendSshPublicKeyInput>()
            .expect("correct type");
