...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::set_instance_id):<br>required: **true**<br><p>The ID of the EC2 instance.</p><br>
    ///   - [`instance_os_user(impl Into<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::instance_os_user) / [`set_instance_os_user(Option<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::set_instance_os_user):<br>required: **true**<br><p>The OS user on the EC2 instance for whom the key can be used to authenticate.</p><br>
    ///   - [`ssh_public_key(impl Into<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::ssh_public_key) / [`set_ssh_public_key(Option<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::set_ssh_public_key):<br>required: **true**<br><p>The public key material. To use the public key, you must have the matching private key.</p><br>
    ///   - [`availability_zone(impl Into<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::availability_zone) / [`set_availability_zone(Option<String>)`](crate::operation::send_ssh_public_key::builders::SendSSHPublicKeyFluentBuilder::set_availability_zone):<br>required: **false**<br><p>The Availability Zone in which the EC2 instance was launched.</p><br>
