...
#[allow(clippy::unnecessary_wraps)]pub fn parse_send_serial_console_ssh_public_key_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendSerialConsoleSshPublicKeyOutput, crate::error::SendSerialConsoleSSHPublicKeyError> {
    ...
    Err(match error_code {
        ...
        "EC2InstanceUnavailableException" => crate::error::SendSerialConsoleSSHPublicKeyError { meta: generic, kind: crate::error::SendSerialConsoleSSHPublicKeyErrorKind::Ec2InstanceUnavailableException({
            #[allow(unused_mut)]let mut tmp =
                 {
                    #[allow(unused_mut)]let mut output = crate::error::ec2_instance_unavailable_exception::Builder::default();
                    let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_send_serial_console_ssh_public_key_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendSerialConsoleSshPublicKeyOutput, crate::error::SendSerialConsoleSSHPublicKeyError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::send_serial_console_ssh_public_key_output::Builder::default();
        let _ = response;
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_send_ssh_public_key_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendSshPublicKeyOutput, crate::error::SendSSHPublicKeyError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_send_ssh_public_key_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SendSshPublicKeyOutput, crate::error::SendSSHPublicKeyError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::send_ssh_public_key_output::Builder::default();
        let _ = response;
