...
pub fn de_disassociate_default_view_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disassociate_default_view::DisassociateDefaultViewOutput, crate::operation::disassociate_default_view::DisassociateDefaultViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::disassociate_default_view::DisassociateDefaultViewError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_default_view_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disassociate_default_view::DisassociateDefaultViewOutput, crate::operation::disassociate_default_view::DisassociateDefaultViewError> {
    Ok({
        #[allow(unused_mut)]
