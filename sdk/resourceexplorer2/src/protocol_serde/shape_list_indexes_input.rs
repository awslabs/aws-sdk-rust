...
pub fn ser_list_indexes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListIndexesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
