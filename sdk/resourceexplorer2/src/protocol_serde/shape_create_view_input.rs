...
pub fn ser_create_view_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateViewInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
