...
impl super::Client {
    ...
    ///   - [`r#type(IndexType)`](crate::operation::list_indexes::builders::ListIndexesFluentBuilder::type) / [`set_type(Option<IndexType>)`](crate::operation::list_indexes::builders::ListIndexesFluentBuilder::set_type): <p>If specified, limits the output to only indexes of the specified Type, either <code>LOCAL</code> or <code>AGGREGATOR</code>.</p>  <p>Use this option to discover the aggregator index for your account.</p>
    ///   - [`regions(Vec<String>)`](crate::operation::list_indexes::builders::ListIndexesFluentBuilder::regions) / [`set_regions(Option<Vec<String>>)`](crate::operation::list_indexes::builders::ListIndexesFluentBuilder::set_regions): <p>If specified, limits the response to only information about the index in the specified list of Amazon Web Services Regions.</p>
    ...
    pub fn list_indexes(
        &self,
    ) -> crate::operation::list_indexes::builders::ListIndexesFluentBuilder {
