...
impl super::Client {
    ...
    ///   - [`view_arn(impl Into<String>)`](crate::operation::delete_view::builders::DeleteViewFluentBuilder::view_arn) / [`set_view_arn(impl Into<String>)`](crate::operation::delete_view::builders::DeleteViewFluentBuilder::set_view_arn):<br>required: **true**<br><p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon resource name (ARN)</a> of the view that you want to delete.</p><br>
