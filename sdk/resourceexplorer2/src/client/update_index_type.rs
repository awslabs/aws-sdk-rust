...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::update_index_type::builders::UpdateIndexTypeFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_index_type::builders::UpdateIndexTypeFluentBuilder::set_arn): <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon resource name (ARN)</a> of the index that you want to update.</p>
