...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::update_index_type::builders::UpdateIndexTypeFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::update_index_type::builders::UpdateIndexTypeFluentBuilder::set_arn):<br>required: **true**<br><p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon resource name (ARN)</a> of the index that you want to update.</p><br>
    ///   - [`r#type(IndexType)`](crate::operation::update_index_type::builders::UpdateIndexTypeFluentBuilder::type) / [`set_type(IndexType)`](crate::operation::update_index_type::builders::UpdateIndexTypeFluentBuilder::set_type):<br>required: **true**<br><p>The type of the index. To understand the difference between <code>LOCAL</code> and <code>AGGREGATOR</code>, see <a href="https://docs.aws.amazon.com/resource-explorer/latest/userguide/manage-aggregator-region.html">Turning on cross-Region search</a> in the <i>Amazon Web Services Resource Explorer User Guide</i>.</p><br>
