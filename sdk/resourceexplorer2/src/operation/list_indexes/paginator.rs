...
impl ListIndexesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Index, ::aws_smithy_http::result::SdkError<crate::operation::list_indexes::ListIndexesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_indexes_output_indexes(page).unwrap_or_default().into_iter())
    }
}
