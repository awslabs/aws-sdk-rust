...
impl GetViewInput {
    /// Consumes the builder and constructs an Operation<[`GetView`](crate::operation::get_view::GetView)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_view::GetView, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_view::ser_get_view_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_view::GetView::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetView {
    type Output = ::std::result::Result<crate::operation::get_view::GetViewOutput, crate::operation::get_view::GetViewError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_view::de_get_view_http_response_with_props(status, headers, body)
        }
    }
