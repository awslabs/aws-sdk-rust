...
impl ListSupportedResourceTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_supported_resource_types::ListSupportedResourceTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSupportedResourceTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_supported_resource_types::de_list_supported_resource_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
