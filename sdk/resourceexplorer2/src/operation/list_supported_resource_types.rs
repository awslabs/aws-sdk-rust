...
impl ListSupportedResourceTypesInput {
    /// Consumes the builder and constructs an Operation<[`ListSupportedResourceTypes`](crate::operation::list_supported_resource_types::ListSupportedResourceTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_supported_resource_types::ListSupportedResourceTypes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_supported_resource_types::ListSupportedResourceTypesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_supported_resource_types::ListSupportedResourceTypes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSupportedResourceTypes {
                type Output = std::result::Result<crate::operation::list_supported_resource_types::ListSupportedResourceTypesOutput, crate::operation::list_supported_resource_types::ListSupportedResourceTypesError>;
