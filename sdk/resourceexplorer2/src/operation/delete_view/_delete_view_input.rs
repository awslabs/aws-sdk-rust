...
impl DeleteViewInputBuilder {
    ...
    /// - [`view_arn`](crate::operation::delete_view::builders::DeleteViewInputBuilder::view_arn)
        ...
        ::std::result::Result::Ok(crate::operation::delete_view::DeleteViewInput {
            view_arn: self.view_arn.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "view_arn",
                    "view_arn was not specified but it is required when building DeleteViewInput",
                )
            })?,
        })
    }
