...
impl DeleteViewInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_view::DeleteView::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteView {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_view::de_delete_view_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_view::de_delete_view_http_response_with_props(
                status, headers, body,
            )
        }
    }
