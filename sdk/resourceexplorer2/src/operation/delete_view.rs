...
impl DeleteViewInput {
    /// Consumes the builder and constructs an Operation<[`DeleteView`](crate::operation::delete_view::DeleteView)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_view::DeleteView, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_view::ser_delete_view_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_view::DeleteView::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteView {
    type Output = ::std::result::Result<crate::operation::delete_view::DeleteViewOutput, crate::operation::delete_view::DeleteViewError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_view::de_delete_view_http_response_with_props(status, headers, body)
        }
    }
}
