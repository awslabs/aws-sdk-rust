...
impl ListIndexesInput {
    /// Consumes the builder and constructs an Operation<[`ListIndexes`](crate::operation::list_indexes::ListIndexes)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_indexes::ListIndexes, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_indexes::ser_list_indexes_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_indexes::ListIndexes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIndexes {
    type Output = ::std::result::Result<crate::operation::list_indexes::ListIndexesOutput, crate::operation::list_indexes::ListIndexesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_indexes::de_list_indexes_http_response_with_props(status, headers, body)
        }
    }
}
