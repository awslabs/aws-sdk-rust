...
impl ListSupportedResourceTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_supported_resource_types::ListSupportedResourceTypesInput, ::aws_smithy_types::error::operation::BuildError> {
