...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_supported_resource_types::ListSupportedResourceTypesOutput,
                    crate::operation::list_supported_resource_types::ListSupportedResourceTypesError,
                > for ListSupportedResourceTypesFluentBuilder
            {
                fn send(
                    self,
...
impl ListSupportedResourceTypesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_supported_resource_types::ListSupportedResourceTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_supported_resource_types::ListSupportedResourceTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_supported_resource_types::ListSupportedResourceTypes::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_supported_resource_types::ListSupportedResourceTypes::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_supported_resource_types::ListSupportedResourceTypesOutput, crate::operation::list_supported_resource_types::ListSupportedResourceTypesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_supported_resource_types::paginator::ListSupportedResourceTypesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
