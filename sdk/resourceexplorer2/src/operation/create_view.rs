...
impl CreateViewInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_view::CreateView,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_view::CreateView::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateView {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_view::de_create_view_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_view::de_create_view_http_response_with_props(
                status, headers, body,
            )
        }
    }
