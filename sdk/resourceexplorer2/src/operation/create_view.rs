...
impl CreateViewInput {
    /// Consumes the builder and constructs an Operation<[`CreateView`](crate::operation::create_view::CreateView)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_view::CreateView, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_view::ser_create_view_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_view::CreateView::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateView {
    type Output = ::std::result::Result<crate::operation::create_view::CreateViewOutput, crate::operation::create_view::CreateViewError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_view::de_create_view_http_response_with_props(status, headers, body)
        }
    }
