...
impl DisassociateDefaultView {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_default_view::DisassociateDefaultViewError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_default_view::DisassociateDefaultViewOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DisassociateDefaultView",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateDefaultView {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociateDefaultViewRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateDefaultViewResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociateDefaultView")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateDefaultViewResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_default_view::de_disassociate_default_view_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_disassociate_default_view::de_disassociate_default_view_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateDefaultViewRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_default_view::DisassociateDefaultViewInput>()
            .expect("correct type");
