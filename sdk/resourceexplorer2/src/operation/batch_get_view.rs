...
impl BatchGetViewInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetView`](crate::operation::batch_get_view::BatchGetView)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_get_view::BatchGetView, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_view::ser_batch_get_view_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_view::BatchGetView::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetView {
    type Output = ::std::result::Result<crate::operation::batch_get_view::BatchGetViewOutput, crate::operation::batch_get_view::BatchGetViewError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_view::de_batch_get_view_http_response_with_props(status, headers, body)
        }
    }
