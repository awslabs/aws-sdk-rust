...
impl GetIndexFluentBuilder  {
    /// Creates a new `GetIndex`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_index::GetIndex, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_index::GetIndexError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_index::GetIndexOutput, aws_smithy_http::result::SdkError<crate::operation::get_index::GetIndexError>>
                     {
