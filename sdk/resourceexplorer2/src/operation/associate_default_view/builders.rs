...
impl AssociateDefaultViewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_default_view::AssociateDefaultViewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_default_view::AssociateDefaultViewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_default_view::AssociateDefaultViewOutput, crate::operation::associate_default_view::AssociateDefaultViewError, Self> {
