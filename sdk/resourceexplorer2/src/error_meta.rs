...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::batch_get_view::BatchGetViewError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::list_indexes::ListIndexesError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
