...
pub fn parse_associate_default_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssociateDefaultViewOutput, crate::error::AssociateDefaultViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::AssociateDefaultViewError::unhandled)?;
...
pub fn parse_batch_get_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::BatchGetViewOutput, crate::error::BatchGetViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::BatchGetViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_create_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateViewOutput, crate::error::CreateViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::CreateViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_delete_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteViewOutput, crate::error::DeleteViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::DeleteViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_disassociate_default_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisassociateDefaultViewOutput, crate::error::DisassociateDefaultViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::DisassociateDefaultViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_get_default_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetDefaultViewOutput, crate::error::GetDefaultViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetDefaultViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_get_index_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetIndexOutput, crate::error::GetIndexError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetIndexError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_get_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetViewOutput, crate::error::GetViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_list_indexes_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListIndexesOutput, crate::error::ListIndexesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::ListIndexesError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_list_supported_resource_types_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSupportedResourceTypesOutput, crate::error::ListSupportedResourceTypesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::ListSupportedResourceTypesError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_list_views_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListViewsOutput, crate::error::ListViewsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::ListViewsError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_update_index_type_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateIndexTypeOutput, crate::error::UpdateIndexTypeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::UpdateIndexTypeError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_update_view_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateViewOutput, crate::error::UpdateViewError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::UpdateViewError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
