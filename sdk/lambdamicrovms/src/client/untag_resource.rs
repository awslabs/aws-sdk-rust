...
impl super::Client {
    ...
    ///   - [`resource(impl Into<String>)`](crate::operation::untag_resource::builders::UntagResourceFluentBuilder::resource) / [`set_resource(Option<String>)`](crate::operation::untag_resource::builders::UntagResourceFluentBuilder::set_resource):<br>required: **true**<br><p>The ARN of the resource to remove tags from.</p><br>
