...
impl CompleteAttachmentUploadFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::complete_attachment_upload::CompleteAttachmentUploadOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::complete_attachment_upload::CompleteAttachmentUploadError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::complete_attachment_upload::CompleteAttachmentUploadOutput, crate::operation::complete_attachment_upload::CompleteAttachmentUploadError, Self> {
