    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/participant/connection")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_participant_connection::CreateParticipantConnection::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateParticipantConnectionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_participant_connection::CreateParticipantConnectionError
{
