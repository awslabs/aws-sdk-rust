    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/participant/start-attachment-upload")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_attachment_upload::StartAttachmentUpload::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_attachment_upload::StartAttachmentUploadError
{
