...
impl StartAttachmentUpload {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_attachment_upload::StartAttachmentUploadOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_attachment_upload::StartAttachmentUploadError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_attachment_upload::StartAttachmentUploadError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_attachment_upload::StartAttachmentUploadOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::start_attachment_upload::StartAttachmentUploadInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartAttachmentUpload {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartAttachmentUpload");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartAttachmentUploadRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartAttachmentUploadResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartAttachmentUpload")
...
.with_interceptor(StartAttachmentUploadEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_attachment_upload::StartAttachmentUploadError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_attachment_upload::StartAttachmentUploadError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_attachment_upload::StartAttachmentUploadError>::new());
...
#[derive(Debug)]
            struct StartAttachmentUploadResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartAttachmentUploadResponseDeserializer {
...
#[derive(Debug)]
            struct StartAttachmentUploadRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartAttachmentUploadRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_attachment_upload::StartAttachmentUploadInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_attachment_upload::StartAttachmentUploadInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_attachment_upload::ser_start_attachment_upload_input(&input)?);
...
#[derive(Debug)]
            struct StartAttachmentUploadEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartAttachmentUploadEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartAttachmentUploadEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartAttachmentUploadInput>()
                        .ok_or("failed to downcast to StartAttachmentUploadInput")?;
...
pub enum StartAttachmentUploadError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartAttachmentUploadError) for what information is available for the error.")]
...
impl StartAttachmentUploadError {
    /// Creates the `StartAttachmentUploadError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartAttachmentUploadError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartAttachmentUploadError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_attachment_upload::StartAttachmentUploadError {
