...
impl GetAuthenticationUrl {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_authentication_url::GetAuthenticationUrlError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_authentication_url::GetAuthenticationUrlOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetAuthenticationUrl",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetAuthenticationUrl")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAuthenticationUrl")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetAuthenticationUrlTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetAuthenticationUrlTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAuthenticationUrlTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetAuthenticationUrlInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAuthenticationUrlResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_authentication_url::de_get_authentication_url_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_authentication_url::de_get_authentication_url_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAuthenticationUrlRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_authentication_url::GetAuthenticationUrlInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAuthenticationUrlEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetAuthenticationUrlInput>()
