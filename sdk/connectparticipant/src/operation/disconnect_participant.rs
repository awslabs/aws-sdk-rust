    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/participant/disconnect")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disconnect_participant::DisconnectParticipant::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disconnect_participant::DisconnectParticipantError
{
