...
impl super::Client {
    ...
    ///   - [`r#type(ConnectionType)`](crate::operation::create_participant_connection::builders::CreateParticipantConnectionFluentBuilder::type) / [`set_type(Option<Vec<ConnectionType>>)`](crate::operation::create_participant_connection::builders::CreateParticipantConnectionFluentBuilder::set_type): <p>Type of connection information required. If you need <code>CONNECTION_CREDENTIALS</code> along with marking participant as connected, pass <code>CONNECTION_CREDENTIALS</code> in <code>Type</code>.</p>
