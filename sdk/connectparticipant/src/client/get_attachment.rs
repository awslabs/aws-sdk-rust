...
impl super::Client {
    ...
    ///   - [`attachment_id(impl ::std::convert::Into<String>)`](crate::operation::get_attachment::builders::GetAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::get_attachment::builders::GetAttachmentFluentBuilder::set_attachment_id): <p>A unique identifier for the attachment.</p>
    ///   - [`connection_token(impl ::std::convert::Into<String>)`](crate::operation::get_attachment::builders::GetAttachmentFluentBuilder::connection_token) / [`set_connection_token(Option<String>)`](crate::operation::get_attachment::builders::GetAttachmentFluentBuilder::set_connection_token): <p>The authentication token associated with the participant's connection.</p>
