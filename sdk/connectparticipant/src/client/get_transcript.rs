...
impl super::Client {
    ...
    ///   - [`contact_id(impl ::std::convert::Into<String>)`](crate::operation::get_transcript::builders::GetTranscriptFluentBuilder::contact_id) / [`set_contact_id(Option<String>)`](crate::operation::get_transcript::builders::GetTranscriptFluentBuilder::set_contact_id): <p>The contactId from the current contact chain for which transcript is needed.</p>
