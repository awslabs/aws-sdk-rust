    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CompleteAttachmentUploadInput`](crate::input::CompleteAttachmentUploadInput) with field(s):
    ///   - [`attachment_ids(Option<Vec<String>>)`](crate::input::CompleteAttachmentUploadInput::attachment_ids): <p>A list of unique identifiers for the attachments.</p>
    ///   - [`client_token(Option<String>)`](crate::input::CompleteAttachmentUploadInput::client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::CompleteAttachmentUploadInput::connection_token): <p>The authentication token associated with the participant's connection.</p>
    ...
    ///
    /// - Takes [`DisconnectParticipantInput`](crate::input::DisconnectParticipantInput) with field(s):
    ///   - [`client_token(Option<String>)`](crate::input::DisconnectParticipantInput::client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::DisconnectParticipantInput::connection_token): <p>The authentication token associated with the participant's connection.</p>
    ...
    ///
    /// - Takes [`GetAttachmentInput`](crate::input::GetAttachmentInput) with field(s):
    ///   - [`attachment_id(Option<String>)`](crate::input::GetAttachmentInput::attachment_id): <p>A unique identifier for the attachment.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::GetAttachmentInput::connection_token): <p>The authentication token associated with the participant's connection.</p>
    ...
    ///
    /// - Takes [`GetTranscriptInput`](crate::input::GetTranscriptInput) with field(s):
    ///   - [`contact_id(Option<String>)`](crate::input::GetTranscriptInput::contact_id): <p>The contactId from the current contact chain for which transcript is needed.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetTranscriptInput::max_results): <p>The maximum number of results to return in the page. Default: 10. </p>
    ///   - [`next_token(Option<String>)`](crate::input::GetTranscriptInput::next_token): <p>The pagination token. Use the value returned previously in the next subsequent request to retrieve the next set of results.</p>
    ///   - [`scan_direction(Option<ScanDirection>)`](crate::input::GetTranscriptInput::scan_direction): <p>The direction from StartPosition from which to retrieve message. Default: BACKWARD when no StartPosition is provided, FORWARD with StartPosition. </p>
    ///   - [`sort_order(Option<SortKey>)`](crate::input::GetTranscriptInput::sort_order): <p>The sort order for the records. Default: DESCENDING.</p>
    ///   - [`start_position(Option<StartPosition>)`](crate::input::GetTranscriptInput::start_position): <p>A filtering option for where to start.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::GetTranscriptInput::connection_token): <p>The authentication token associated with the participant's connection.</p>
    ...
    ///   - [`content_type(Option<String>)`](crate::input::SendEventInput::content_type): <p>The content type of the request. Supported types are:</p>  <ul>   <li> <p>application/vnd.amazonaws.connect.event.typing</p> </li>   <li> <p>application/vnd.amazonaws.connect.event.connection.acknowledged</p> </li>  </ul>
    ///   - [`content(Option<String>)`](crate::input::SendEventInput::content): <p>The content of the event to be sent (for example, message text). This is not yet supported.</p>
    ///   - [`client_token(Option<String>)`](crate::input::SendEventInput::client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::SendEventInput::connection_token): <p>The authentication token associated with the participant's connection.</p>
    ...
    ///
    /// - Takes [`SendMessageInput`](crate::input::SendMessageInput) with field(s):
    ///   - [`content_type(Option<String>)`](crate::input::SendMessageInput::content_type): <p>The type of the content. Supported types are text/plain.</p>
    ///   - [`content(Option<String>)`](crate::input::SendMessageInput::content): <p>The content of the message.</p>
    ///   - [`client_token(Option<String>)`](crate::input::SendMessageInput::client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::SendMessageInput::connection_token): <p>The authentication token associated with the connection.</p>
    ...
    ///
    /// - Takes [`StartAttachmentUploadInput`](crate::input::StartAttachmentUploadInput) with field(s):
    ///   - [`content_type(Option<String>)`](crate::input::StartAttachmentUploadInput::content_type): <p>Describes the MIME file type of the attachment. For a list of supported file types, see <a href="https://docs.aws.amazon.com/connect/latest/adminguide/amazon-connect-service-limits.html#feature-limits">Feature specifications</a> in the <i>Amazon Connect Administrator Guide</i>.</p>
    ///   - [`attachment_size_in_bytes(i64)`](crate::input::StartAttachmentUploadInput::attachment_size_in_bytes): <p>The size of the attachment in bytes.</p>
    ///   - [`attachment_name(Option<String>)`](crate::input::StartAttachmentUploadInput::attachment_name): <p>A case-sensitive name of the attachment being uploaded.</p>
    ///   - [`client_token(Option<String>)`](crate::input::StartAttachmentUploadInput::client_token): <p>A unique case sensitive identifier to support idempotency of request.</p>
    ///   - [`connection_token(Option<String>)`](crate::input::StartAttachmentUploadInput::connection_token): <p>The authentication token associated with the participant's connection.</p>
