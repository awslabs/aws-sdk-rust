...
pub struct UploadMetadata  {
    ...
    #[doc(hidden)]pub url_expiry: std::option::Option<std::string::String>,
    /// <p>The headers to be provided while uploading the file to the URL.</p>
    #[doc(hidden)]pub headers_to_include: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl UploadMetadata {
    /// <p>This is the pre-signed URL that can be used for uploading the file to Amazon S3 when used in response to <a href="https://docs.aws.amazon.com/connect-participant/latest/APIReference/API_StartAttachmentUpload.html">StartAttachmentUpload</a>.</p>
...
pub struct Item  {
    ...
    #[doc(hidden)]pub absolute_time: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ChatItemType>,
    ...
    #[doc(hidden)]pub participant_role: std::option::Option<crate::model::ParticipantRole>,
    /// <p>Provides information about the attachments.</p>
    #[doc(hidden)]pub attachments: std::option::Option<std::vec::Vec<crate::model::AttachmentItem>>,
}
impl Item {
    /// <p>The time when the message or event was sent.</p> 
    /// <p>It's specified in ISO 8601 format: yyyy-MM-ddThh:mm:ss.SSSZ. For example, 2019-11-08T02:41:28.172Z.</p>
...
pub struct AttachmentItem  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ArtifactStatus>,
}
impl AttachmentItem {
    /// <p>Describes the MIME file type of the attachment. For a list of supported file types, see <a href="https://docs.aws.amazon.com/connect/latest/adminguide/amazon-connect-service-limits.html#feature-limits">Feature specifications</a> in the <i>Amazon Connect Administrator Guide</i>.</p>
    pub fn content_type(&self) -> std::option::Option<& str> {
...
impl ChatItemType {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "ATTACHMENT", "CHAT_ENDED", "CONNECTION_ACK", "EVENT", "MESSAGE", "PARTICIPANT_JOINED", "PARTICIPANT_LEFT", "TRANSFER_FAILED", "TRANSFER_SUCCEEDED", "TYPING"
        ]
    }
}
...
pub struct StartPosition  {
    ...
    #[doc(hidden)]pub most_recent: i32,
}
impl StartPosition {
    /// <p>The ID of the message or event where to start. </p>
    pub fn id(&self) -> std::option::Option<& str> {
...
pub struct ConnectionCredentials  {
    ...
    /// <p>It's specified in ISO 8601 format: yyyy-MM-ddThh:mm:ss.SSSZ. For example, 2019-11-08T02:41:28.172Z.</p>
    #[doc(hidden)]pub expiry: std::option::Option<std::string::String>,
}
...
pub struct Websocket  {
    ...
    /// <p>It's specified in ISO 8601 format: yyyy-MM-ddThh:mm:ss.SSSZ. For example, 2019-11-08T02:41:28.172Z.</p>
    #[doc(hidden)]pub connection_expiry: std::option::Option<std::string::String>,
}
impl Websocket {
    /// <p>The URL of the websocket.</p>
    pub fn url(&self) -> std::option::Option<& str> {
