...
impl CompleteAttachmentUploadInput {
    ...
    > {
        Ok({
            ...
            let body = crate::operation_ser::serialize_operation_complete_attachment_upload(&self)
                .map_err(|err| {
    ...
    fn add_headers(
        ...
        if let Some(inner_1) = &self.connection_token {
...
impl CreateParticipantConnectionInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_participant_connection(&self)
                    .map_err(|err| {
                        smithy_http::operation::BuildError::SerializationError(err.into())
                    })?;
            let request = Self::assemble(request, body);
    ...
    fn add_headers(
        ...
        if let Some(inner_3) = &self.participant_token {
...
impl DisconnectParticipantInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_disconnect_participant(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn add_headers(
        ...
        if let Some(inner_5) = &self.connection_token {
...
impl GetAttachmentInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_attachment(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn add_headers(
        ...
        if let Some(inner_7) = &self.connection_token {
...
impl GetTranscriptInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_transcript(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn add_headers(
        ...
        if let Some(inner_9) = &self.connection_token {
...
impl SendEventInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_send_event(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn add_headers(
        ...
        if let Some(inner_11) = &self.connection_token {
...
impl SendMessageInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_send_message(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn add_headers(
        ...
        if let Some(inner_13) = &self.connection_token {
...
impl StartAttachmentUploadInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_start_attachment_upload(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn add_headers(
        ...
        if let Some(inner_15) = &self.connection_token {
