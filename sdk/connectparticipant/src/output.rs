...
pub struct GetTranscriptOutput  {
    ...
    #[doc(hidden)]pub transcript: std::option::Option<std::vec::Vec<crate::model::Item>>,
...
pub struct CreateParticipantConnectionOutput  {
    ...
    #[doc(hidden)]pub websocket: std::option::Option<crate::model::Websocket>,
    ...
    #[doc(hidden)]pub connection_credentials: std::option::Option<crate::model::ConnectionCredentials>,
}
