...
pub fn ser_start_attachment_upload_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartAttachmentUploadInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
