...
pub(crate) fn de_item<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::Item>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ChatItemType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ParticipantId" => {
                        ...
                        "MessageMetadata" => {
                            builder = builder.set_message_metadata(crate::protocol_serde::shape_message_metadata::de_message_metadata(tokens)?);
                        }
                        "RelatedContactId" => {
