...
impl Builder {
    ...
    /// use aws_sdk_connectparticipant::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_connectparticipant::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
