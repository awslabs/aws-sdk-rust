...
pub(crate) fn reflens_query_vectors_output_output_next_token(
    input: &crate::operation::query_vectors::QueryVectorsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_query_vectors_output_output_vectors(
    input: crate::operation::query_vectors::QueryVectorsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::QueryOutputVector>> {
    let input = input.vectors;
    ::std::option::Option::Some(input)
}
