...
impl KmsNotFoundExceptionBuilder {
    ...
    /// - [`message`](crate::types::error::builders::KmsNotFoundExceptionBuilder::message)
    pub fn build(self) -> ::std::result::Result<crate::types::error::KmsNotFoundException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::KmsNotFoundException {
            message: self.message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "message",
                    "message was not specified but it is required when building KmsNotFoundException",
                )
            })?,
