...
impl NotFoundExceptionBuilder {
    ...
    /// - [`message`](crate::types::error::builders::NotFoundExceptionBuilder::message)
    pub fn build(self) -> ::std::result::Result<crate::types::error::NotFoundException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::NotFoundException {
            message: self.message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "message",
                    "message was not specified but it is required when building NotFoundException",
                )
            })?,
