...
pub fn de_create_index_http_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => crate::operation::create_index::CreateIndexError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::create_index::CreateIndexError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
