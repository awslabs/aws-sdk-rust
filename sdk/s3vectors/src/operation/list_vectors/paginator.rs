...
/// Paginator for [`ListVectors`](crate::operation::list_vectors::ListVectors)
pub struct ListVectorsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_vectors::builders::ListVectorsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListVectorsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `vectors`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_vectors::paginator::ListVectorsPaginatorItems {
        crate::operation::list_vectors::paginator::ListVectorsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_vectors::ListVectors::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_vectors_output_output_next_token(resp);
...
/// Flattened paginator for `ListVectorsPaginator`
///
/// This is created with [`.items()`](ListVectorsPaginator::items)
pub struct ListVectorsPaginatorItems(ListVectorsPaginator);

impl ListVectorsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_vectors_output_output_vectors(page).unwrap_or_default().into_iter())
    }
}
