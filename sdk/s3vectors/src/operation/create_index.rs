...
impl CreateIndex {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("S3Vectors", "CreateIndex", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateIndex {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateIndex", "S3Vectors"));
...
impl CreateIndexError {
    ...
    /// Returns `true` if the error kind is `CreateIndexError::NotFoundException`.
    ...
    /// Returns `true` if the error kind is `CreateIndexError::ServiceUnavailableException`.
    ...
    /// Returns `true` if the error kind is `CreateIndexError::RequestTimeoutException`.
    pub fn is_request_timeout_exception(&self) -> bool {
        matches!(self, Self::RequestTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CreateIndexError::TooManyRequestsException`.
