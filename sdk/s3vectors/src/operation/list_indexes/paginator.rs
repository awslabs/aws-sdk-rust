...
/// Paginator for [`ListIndexes`](crate::operation::list_indexes::ListIndexes)
pub struct ListIndexesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_indexes::builders::ListIndexesInputBuilder,
...
impl ListIndexesPaginator {
    ...
    pub fn items(self) -> crate::operation::list_indexes::paginator::ListIndexesPaginatorItems {
        crate::operation::list_indexes::paginator::ListIndexesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_indexes::ListIndexes::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_indexes_output_output_next_token(resp);
...
impl ListIndexesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_indexes_output_output_indexes(page).unwrap_or_default().into_iter())
    }
}
