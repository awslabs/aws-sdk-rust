...
/// Paginator for [`QueryVectors`](crate::operation::query_vectors::QueryVectors)
pub struct QueryVectorsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::query_vectors::builders::QueryVectorsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl QueryVectorsPaginator {
    ...
    pub fn items(self) -> crate::operation::query_vectors::paginator::QueryVectorsPaginatorItems {
        crate::operation::query_vectors::paginator::QueryVectorsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::query_vectors::QueryVectors::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_query_vectors_output_output_next_token(resp);
...
/// Flattened paginator for `QueryVectorsPaginator`
///
/// This is created with [`.items()`](QueryVectorsPaginator::items)
pub struct QueryVectorsPaginatorItems(QueryVectorsPaginator);

impl QueryVectorsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_query_vectors_output_output_vectors(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
