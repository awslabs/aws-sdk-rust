...
pub use crate::operation::create_vector_bucket::_create_vector_bucket_output::CreateVectorBucketOutputBuilder;

pub use crate::operation::create_vector_bucket::_create_vector_bucket_input::CreateVectorBucketInputBuilder;

impl crate::operation::create_vector_bucket::builders::CreateVectorBucketInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::create_vector_bucket::CreateVectorBucketError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.create_vector_bucket();
...
pub struct CreateVectorBucketFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::create_vector_bucket::builders::CreateVectorBucketInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_vector_bucket::CreateVectorBucketOutput,
        crate::operation::create_vector_bucket::CreateVectorBucketError,
    > for CreateVectorBucketFluentBuilder
{
    fn send(
        self,
...
impl CreateVectorBucketFluentBuilder {
    /// Creates a new `CreateVectorBucketFluentBuilder`.
    ...
    /// Access the CreateVectorBucket as a reference.
    pub fn as_input(&self) -> &crate::operation::create_vector_bucket::builders::CreateVectorBucketInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_vector_bucket::CreateVectorBucket::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_vector_bucket::CreateVectorBucket::orchestrate(&runtime_plugins, input).await
    }
