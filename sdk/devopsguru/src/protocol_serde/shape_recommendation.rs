                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RelatedEvents" => {
                            builder = builder.set_related_events(
                                crate::protocol_serde::shape_recommendation_related_events::de_recommendation_related_events(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "RelatedAnomalies" => {
                            builder = builder.set_related_anomalies(
                                crate::protocol_serde::shape_recommendation_related_anomalies::de_recommendation_related_anomalies(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
