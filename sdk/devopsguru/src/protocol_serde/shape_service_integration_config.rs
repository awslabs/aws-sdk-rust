...
) -> Result<Option<crate::types::ServiceIntegrationConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "OpsCenter" => {
                            builder = builder.set_ops_center(crate::protocol_serde::shape_ops_center_integration::de_ops_center_integration(tokens)?);
                        }
