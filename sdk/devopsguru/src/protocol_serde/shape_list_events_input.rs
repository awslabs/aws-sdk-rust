...
pub fn ser_list_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
