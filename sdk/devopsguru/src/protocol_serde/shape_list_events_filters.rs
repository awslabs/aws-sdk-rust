...
pub fn ser_list_events_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListEventsFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
