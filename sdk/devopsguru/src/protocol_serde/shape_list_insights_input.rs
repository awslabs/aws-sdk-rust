...
pub fn ser_list_insights_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_insights::ListInsightsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
