...
pub(crate) fn de_proactive_organization_insight_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ProactiveOrganizationInsightSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
