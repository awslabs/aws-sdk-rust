...
pub fn ser_notification_channel_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NotificationChannelConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_notification_channel_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NotificationChannelConfig>, aws_smithy_json::deserialize::error::DeserializeError>
