...
pub(crate) fn de_notification_channel_config<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::NotificationChannelConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Sns" => {
                            builder = builder.set_sns(crate::protocol_serde::shape_sns_channel_config::de_sns_channel_config(tokens, _value)?);
                        }
                        "Filters" => {
            ...
            Ok(Some(crate::serde_util::notification_channel_config_correct_errors(builder).build()))
        }
