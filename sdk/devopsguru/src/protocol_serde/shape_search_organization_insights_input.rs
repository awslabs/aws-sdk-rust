...
pub fn ser_search_organization_insights_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchOrganizationInsightsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
