...
pub fn ser_search_organization_insights_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SearchOrganizationInsightsFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
