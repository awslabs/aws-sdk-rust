...
pub fn ser_search_insights_filters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SearchInsightsFilters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
