...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_account_overview::DescribeAccountOverviewError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        crate::serde_util::describe_account_overview_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_account_overview::DescribeAccountOverviewError::unhandled)?
    })
}
