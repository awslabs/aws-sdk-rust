...
pub struct SearchOrganizationInsightsOutput  {
    ...
    #[doc(hidden)]
    pub proactive_insights: std::option::Option<std::vec::Vec<crate::model::ProactiveInsightSummary>>,
...
pub struct ListOrganizationInsightsOutput  {
    /// <p>An integer that specifies the number of open proactive insights in your Amazon Web Services account.</p>
    #[doc(hidden)]
    pub proactive_insights: std::option::Option<std::vec::Vec<crate::model::ProactiveOrganizationInsightSummary>>,
    /// <p>An integer that specifies the number of open reactive insights in your Amazon Web Services account.</p>
    #[doc(hidden)]
    pub reactive_insights: std::option::Option<std::vec::Vec<crate::model::ReactiveOrganizationInsightSummary>>,
    /// <p>The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.</p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListMonitoredResourcesOutput  {
    ...
    #[doc(hidden)]
    pub monitored_resource_identifiers: std::option::Option<std::vec::Vec<crate::model::MonitoredResourceIdentifier>>,
    /// <p>The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.</p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListAnomaliesForInsightOutput  {
    ...
    #[doc(hidden)]
    pub proactive_anomalies: std::option::Option<std::vec::Vec<crate::model::ProactiveAnomalySummary>>,
    /// <p> An array of <code>ReactiveAnomalySummary</code> objects that represent the requested anomalies </p>
    #[doc(hidden)]
    pub reactive_anomalies: std::option::Option<std::vec::Vec<crate::model::ReactiveAnomalySummary>>,
    /// <p>The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.</p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
}
