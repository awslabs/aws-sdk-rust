...
pub fn serialize_structure_add_notification_channel_input(
    ...
    if let Some(var_1) = &input.config {
        ...
        crate::json_ser::serialize_structure_notification_channel_config(&mut object_2, var_1);
        object_2.finish();
    }
}

pub fn serialize_structure_describe_account_overview_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_feedback_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_anomalies_for_insight_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_8) = &input.start_time_range {
        ...
        crate::json_ser::serialize_structure_start_time_range(&mut object_9, var_8);
        object_9.finish();
    }
}

pub fn serialize_structure_list_events_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::ListEventsInput,
) {
    if let Some(var_10) = &input.filters {
        let mut object_11 = object.key("Filters").start_object();
        crate::json_ser::serialize_structure_list_events_filters(&mut object_11, var_10);
        object_11.finish();
    }
...
pub fn serialize_structure_list_insights_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_16) = &input.status_filter {
        ...
        crate::json_ser::serialize_structure_list_insights_status_filter(&mut object_17, var_16);
        object_17.finish();
    }
}

pub fn serialize_structure_list_notification_channels_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_recommendations_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_feedback_input(
    ...
    if let Some(var_22) = &input.insight_feedback {
        ...
        crate::json_ser::serialize_structure_insight_feedback(&mut object_23, var_22);
        object_23.finish();
    }
}

pub fn serialize_structure_search_insights_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::SearchInsightsInput,
) {
    if let Some(var_24) = &input.filters {
        let mut object_25 = object.key("Filters").start_object();
        crate::json_ser::serialize_structure_search_insights_filters(&mut object_25, var_24);
        object_25.finish();
    }
    ...
    if let Some(var_28) = &input.start_time_range {
        ...
        crate::json_ser::serialize_structure_start_time_range(&mut object_29, var_28);
        object_29.finish();
    }
...
pub fn serialize_structure_start_cost_estimation_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_32) = &input.resource_collection {
        ...
        crate::json_ser::serialize_structure_cost_estimation_resource_collection_filter(
            &mut object_33,
            var_32,
        );
        object_33.finish();
...
pub fn serialize_structure_update_resource_collection_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_35) = &input.resource_collection {
        ...
        crate::json_ser::serialize_structure_update_resource_collection_filter(
            &mut object_36,
            var_35,
        );
        object_36.finish();
...
pub fn serialize_structure_update_service_integration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_37) = &input.service_integration {
        ...
        crate::json_ser::serialize_structure_update_service_integration_config(
            &mut object_38,
            var_37,
        );
        object_38.finish();
...
pub fn serialize_structure_notification_channel_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::NotificationChannelConfig,
) {
    if let Some(var_39) = &input.sns {
        let mut object_40 = object.key("Sns").start_object();
        crate::json_ser::serialize_structure_sns_channel_config(&mut object_40, var_39);
        object_40.finish();
    }
}

pub fn serialize_structure_start_time_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_events_filters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_44) = &input.event_time_range {
        ...
        crate::json_ser::serialize_structure_event_time_range(&mut object_45, var_44);
        object_45.finish();
    }
    ...
    if let Some(var_49) = &input.resource_collection {
        ...
        crate::json_ser::serialize_structure_resource_collection(&mut object_50, var_49);
        object_50.finish();
    }
}

pub fn serialize_structure_list_insights_status_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_51) = &input.ongoing {
        ...
        crate::json_ser::serialize_structure_list_insights_ongoing_status_filter(
            &mut object_52,
            var_51,
        );
        object_52.finish();
    ...
    if let Some(var_53) = &input.closed {
        ...
        crate::json_ser::serialize_structure_list_insights_closed_status_filter(
            &mut object_54,
            var_53,
        );
        object_54.finish();
    ...
    if let Some(var_55) = &input.any {
        ...
        crate::json_ser::serialize_structure_list_insights_any_status_filter(
            &mut object_56,
            var_55,
        );
        object_56.finish();
...
pub fn serialize_structure_insight_feedback(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_search_insights_filters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_65) = &input.resource_collection {
        ...
        crate::json_ser::serialize_structure_resource_collection(&mut object_66, var_65);
        object_66.finish();
    }
    if let Some(var_67) = &input.service_collection {
        let mut object_68 = object.key("ServiceCollection").start_object();
        crate::json_ser::serialize_structure_service_collection(&mut object_68, var_67);
        object_68.finish();
    }
}

pub fn serialize_structure_cost_estimation_resource_collection_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_69) = &input.cloud_formation {
        ...
        crate::json_ser::serialize_structure_cloud_formation_cost_estimation_resource_collection_filter(&mut object_70, var_69);
        object_70.finish();
    }
}

pub fn serialize_structure_update_resource_collection_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_71) = &input.cloud_formation {
        ...
        crate::json_ser::serialize_structure_update_cloud_formation_collection_filter(
            &mut object_72,
            var_71,
        );
        object_72.finish();
...
pub fn serialize_structure_update_service_integration_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_73) = &input.ops_center {
        ...
        crate::json_ser::serialize_structure_ops_center_integration_config(&mut object_74, var_73);
        object_74.finish();
    }
}

pub fn serialize_structure_sns_channel_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_event_time_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_resource_collection(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_78) = &input.cloud_formation {
        ...
        crate::json_ser::serialize_structure_cloud_formation_collection(&mut object_79, var_78);
        object_79.finish();
    }
}

pub fn serialize_structure_list_insights_ongoing_status_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_insights_closed_status_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_82) = &input.end_time_range {
        ...
        crate::json_ser::serialize_structure_end_time_range(&mut object_83, var_82);
        object_83.finish();
    }
}

pub fn serialize_structure_list_insights_any_status_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_85) = &input.start_time_range {
        ...
        crate::json_ser::serialize_structure_start_time_range(&mut object_86, var_85);
        object_86.finish();
    }
}

pub fn serialize_structure_service_collection(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cloud_formation_cost_estimation_resource_collection_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_cloud_formation_collection_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_ops_center_integration_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cloud_formation_collection(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_end_time_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
