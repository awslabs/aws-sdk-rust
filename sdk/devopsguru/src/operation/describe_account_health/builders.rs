...
impl DescribeAccountHealthFluentBuilder  {
    /// Creates a new `DescribeAccountHealth`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_account_health::DescribeAccountHealth, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_account_health::DescribeAccountHealthError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_account_health::DescribeAccountHealthOutput, aws_smithy_http::result::SdkError<crate::operation::describe_account_health::DescribeAccountHealthError>>
                     {
