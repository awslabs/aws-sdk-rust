...
impl DescribeResourceCollectionHealthInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_resource_collection_health::DescribeResourceCollectionHealthInput, ::aws_smithy_types::error::operation::BuildError> {
