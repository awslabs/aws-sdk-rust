...
impl DescribeResourceCollectionHealthInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_resource_collection_health::DescribeResourceCollectionHealth::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeResourceCollectionHealth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_resource_collection_health::de_describe_resource_collection_health_http_response_with_props(
                status, headers, body,
            )
        }
    }
