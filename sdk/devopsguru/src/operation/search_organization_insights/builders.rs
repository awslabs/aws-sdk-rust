...
impl SearchOrganizationInsightsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_organization_insights::SearchOrganizationInsightsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_organization_insights::SearchOrganizationInsightsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_organization_insights::SearchOrganizationInsightsOutput, crate::operation::search_organization_insights::SearchOrganizationInsightsError, Self> {
