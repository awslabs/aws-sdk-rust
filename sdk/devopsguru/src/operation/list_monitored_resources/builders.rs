...
impl ListMonitoredResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_monitored_resources::ListMonitoredResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_monitored_resources::ListMonitoredResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_monitored_resources::ListMonitoredResourcesOutput, crate::operation::list_monitored_resources::ListMonitoredResourcesError, Self> {
