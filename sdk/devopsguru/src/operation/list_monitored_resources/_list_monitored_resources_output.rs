...
impl  ListMonitoredResourcesOutput  {
    ...
    pub fn monitored_resource_identifiers(&self) -> & [crate::types::MonitoredResourceIdentifier] {
        use std::ops::Deref; self.monitored_resource_identifiers.deref()
    }
    /// <p>The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.</p>
...
impl ListMonitoredResourcesOutputBuilder {
    ...
    /// <p>Information about the resource that is being monitored, including the name of the resource, the type of resource, and whether or not permission is given to DevOps Guru to access that resource.</p>
    pub fn set_monitored_resource_identifiers(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::MonitoredResourceIdentifier>>) -> Self {
        self.monitored_resource_identifiers = input; self
    }
    /// <p>Information about the resource that is being monitored, including the name of the resource, the type of resource, and whether or not permission is given to DevOps Guru to access that resource.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_monitored_resources::ListMonitoredResourcesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_monitored_resources::ListMonitoredResourcesOutput {
                monitored_resource_identifiers: self.monitored_resource_identifiers
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("monitored_resource_identifiers", "monitored_resource_identifiers was not specified but it is required when building ListMonitoredResourcesOutput")
                    )?
                ,
