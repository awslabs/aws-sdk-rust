...
impl UpdateResourceCollectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_resource_collection::UpdateResourceCollectionInput, ::aws_smithy_types::error::operation::BuildError> {
