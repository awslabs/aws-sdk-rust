...
impl ListAnomalousLogGroupsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_anomalous_log_groups::paginator::ListAnomalousLogGroupsPaginator
    {
        crate::operation::list_anomalous_log_groups::paginator::ListAnomalousLogGroupsPaginator::new(
            self.handle,
            self.inner,
        )
    }
