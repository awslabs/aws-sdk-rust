...
impl DescribeServiceIntegrationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_service_integration::DescribeServiceIntegrationInput, ::aws_smithy_types::error::operation::BuildError> {
