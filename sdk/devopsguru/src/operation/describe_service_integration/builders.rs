...
impl DescribeServiceIntegrationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_service_integration::DescribeServiceIntegrationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_service_integration::DescribeServiceIntegrationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_service_integration::DescribeServiceIntegrationOutput, crate::operation::describe_service_integration::DescribeServiceIntegrationError, Self> {
