...
impl crate::operation::describe_organization_health::builders::DescribeOrganizationHealthInputBuilder {
...
impl DescribeOrganizationHealthFluentBuilder {
    /// Creates a new `DescribeOrganizationHealthFluentBuilder`.
