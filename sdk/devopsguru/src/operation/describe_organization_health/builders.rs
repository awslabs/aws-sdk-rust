...
impl DescribeOrganizationHealthFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_organization_health::DescribeOrganizationHealthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_organization_health::DescribeOrganizationHealthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_organization_health::DescribeOrganizationHealth::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_organization_health::DescribeOrganizationHealth::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_organization_health::DescribeOrganizationHealthOutput, crate::operation::describe_organization_health::DescribeOrganizationHealthError, Self> {
