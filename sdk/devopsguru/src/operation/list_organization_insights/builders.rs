...
impl ListOrganizationInsightsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_organization_insights::ListOrganizationInsightsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_organization_insights::ListOrganizationInsightsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_organization_insights::ListOrganizationInsightsOutput, crate::operation::list_organization_insights::ListOrganizationInsightsError, Self> {
