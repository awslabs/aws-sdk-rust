...
impl ListAnomaliesForInsightFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_anomalies_for_insight::ListAnomaliesForInsightOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_anomalies_for_insight::ListAnomaliesForInsightError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_anomalies_for_insight::ListAnomaliesForInsightOutput, crate::operation::list_anomalies_for_insight::ListAnomaliesForInsightError, Self> {
