...
impl UpdateServiceIntegrationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_service_integration::UpdateServiceIntegrationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_service_integration::UpdateServiceIntegrationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_service_integration::UpdateServiceIntegrationOutput, crate::operation::update_service_integration::UpdateServiceIntegrationError, Self> {
