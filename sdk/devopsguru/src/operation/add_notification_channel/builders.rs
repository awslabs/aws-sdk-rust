...
impl AddNotificationChannelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_notification_channel::AddNotificationChannelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_notification_channel::AddNotificationChannelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_notification_channel::AddNotificationChannelOutput, crate::operation::add_notification_channel::AddNotificationChannelError, Self> {
