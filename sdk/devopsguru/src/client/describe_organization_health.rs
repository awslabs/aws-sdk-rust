...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::describe_organization_health::builders::DescribeOrganizationHealthFluentBuilder::account_ids) / [`set_account_ids(Option<Vec<String>>)`](crate::operation::describe_organization_health::builders::DescribeOrganizationHealthFluentBuilder::set_account_ids): <p>The ID of the Amazon Web Services account.</p>
    ///   - [`organizational_unit_ids(impl Into<String>)`](crate::operation::describe_organization_health::builders::DescribeOrganizationHealthFluentBuilder::organizational_unit_ids) / [`set_organizational_unit_ids(Option<Vec<String>>)`](crate::operation::describe_organization_health::builders::DescribeOrganizationHealthFluentBuilder::set_organizational_unit_ids): <p>The ID of the organizational unit.</p>
