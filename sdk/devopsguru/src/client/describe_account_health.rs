...
impl super::Client {
    ...
    ///   - [`resource_hours(i64)`](crate::operation::describe_account_health::DescribeAccountHealthOutput::resource_hours): <p>The number of Amazon DevOps Guru resource analysis hours billed to the current Amazon Web Services account in the last hour.</p>
