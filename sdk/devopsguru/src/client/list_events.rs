...
impl super::Client {
    ...
    ///   - [`filters(ListEventsFilters)`](crate::operation::list_events::builders::ListEventsFluentBuilder::filters) / [`set_filters(Option<ListEventsFilters>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_filters):<br>required: **true**<br><p>A <code>ListEventsFilters</code> object used to specify which events to return.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_events::builders::ListEventsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p><br>
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_events::builders::ListEventsFluentBuilder::set_account_id):<br>required: **false**<br><p>The ID of the Amazon Web Services account.</p><br>
    /// - On success, responds with [`ListEventsOutput`](crate::operation::list_events::ListEventsOutput) with field(s):
    ///   - [`events(Vec::<Event>)`](crate::operation::list_events::ListEventsOutput::events): <p>A list of the requested events.</p>
