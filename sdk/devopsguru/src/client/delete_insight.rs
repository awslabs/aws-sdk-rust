...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_insight::builders::DeleteInsightFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_insight::builders::DeleteInsightFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the insight.</p><br>
