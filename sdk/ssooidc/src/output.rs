...
pub struct StartDeviceAuthorizationOutput  {
    ...
    #[doc(hidden)]pub user_code: std::option::Option<std::string::String>,
    /// <p>The URI of the verification page that takes the <code>userCode</code> to authorize the device.</p>
    #[doc(hidden)]pub verification_uri: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub verification_uri_complete: std::option::Option<std::string::String>,
    /// <p>Indicates the number of seconds in which the verification code will become invalid.</p>
    #[doc(hidden)]pub expires_in: i32,
...
pub struct CreateTokenOutput  {
    ...
    #[doc(hidden)]pub id_token: std::option::Option<std::string::String>,
}
