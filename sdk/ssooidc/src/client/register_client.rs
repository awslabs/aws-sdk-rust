...
impl super::Client {
    ...
    ///   - [`scopes(impl Into<String>)`](crate::operation::register_client::builders::RegisterClientFluentBuilder::scopes) / [`set_scopes(Option<Vec<String>>)`](crate::operation::register_client::builders::RegisterClientFluentBuilder::set_scopes): <p>The list of scopes that are defined by the client. Upon authorization, this list is used to restrict permissions when granting an access token.</p>
