...
impl super::Client {
    ...
    ///   - [`client_id(impl ::std::convert::Into<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::client_id) / [`set_client_id(Option<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::set_client_id): <p>The unique identifier string for the client that is registered with IAM Identity Center. This value should come from the persisted result of the <code>RegisterClient</code> API operation.</p>
    ///   - [`client_secret(impl ::std::convert::Into<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::client_secret) / [`set_client_secret(Option<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::set_client_secret): <p>A secret string that is generated for the client. This value should come from the persisted result of the <code>RegisterClient</code> API operation.</p>
    ///   - [`start_url(impl ::std::convert::Into<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::start_url) / [`set_start_url(Option<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::set_start_url): <p>The URL for the AWS access portal. For more information, see <a href="https://docs.aws.amazon.com/singlesignon/latest/userguide/using-the-portal.html">Using the AWS access portal</a> in the <i>IAM Identity Center User Guide</i>.</p>
