...
pub struct IpSetForwardedIpConfig {
    ...
    /// <ul>
    /// <li>
    /// <p>FIRST - Inspect the first IP address in the list of IP addresses in the header. This is usually the client's original IP.</p></li>
    /// <li>
    /// <p>LAST - Inspect the last IP address in the list of IP addresses in the header.</p></li>
    /// <li>
...
impl IpSetForwardedIpConfigBuilder {
    ...
    /// <p>ANY - Inspect all IP addresses in the header for a match. If the header contains more than 10 IP addresses, WAF inspects the last 10.</p></li>
    /// </ul>
    pub fn get_position(&self) -> &::std::option::Option<crate::types::ForwardedIpPosition> {
        &self.position
    }
