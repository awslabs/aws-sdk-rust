...
impl ParameterExceptionField {
    ...
    ParameterExceptionField::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["ACP_RULE_SET_RESPONSE_INSPECTION", "AND_STATEMENT", "ASSOCIABLE_RESOURCE", "ASSOCIATED_RESOURCE_TYPE", "ATP_RULE_SET_RESPONSE_INSPECTION", "BODY_PARSING_FALLBACK_BEHAVIOR", "BYTE_MATCH_STATEMENT", "CHALLENGE_CONFIG", "CHANGE_PROPAGATION_STATUS", "COOKIE_MATCH_PATTERN", "CUSTOM_KEYS", "CUSTOM_REQUEST_HANDLING", "CUSTOM_RESPONSE", "CUSTOM_RESPONSE_BODY", "DEFAULT_ACTION", "ENTITY_LIMIT", "EXCLUDED_RULE", "EXPIRE_TIMESTAMP", "FALLBACK_BEHAVIOR", "FIELD_TO_MATCH", "FILTER_CONDITION", "FIREWALL_MANAGER_STATEMENT", "FORWARDED_IP_CONFIG", "GEO_MATCH_STATEMENT", "HEADER_MATCH_PATTERN", "HEADER_NAME", "IP_ADDRESS", "IP_ADDRESS_VERSION", "IP_SET", "IP_SET_FORWARDED_IP_CONFIG", "IP_SET_REFERENCE_STATEMENT", "JSON_MATCH_PATTERN", "JSON_MATCH_SCOPE", "LABEL_MATCH_STATEMENT", "LOGGING_FILTER", "LOG_DESTINATION", "MANAGED_RULE_GROUP_CONFIG", "MANAGED_RULE_SET", "MANAGED_RULE_SET_STATEMENT", "MAP_MATCH_SCOPE", "METRIC_NAME", "NOT_STATEMENT", "OR_STATEMENT", "OVERRIDE_ACTION", "OVERSIZE_HANDLING", "PAYLOAD_TYPE", "POSITION", "RATE_BASED_STATEMENT", "REGEX_PATTERN_REFERENCE_STATEMENT", "REGEX_PATTERN_SET", "RESOURCE_ARN", "RESOURCE_TYPE", "RESPONSE_CONTENT_TYPE", "RULE", "RULE_ACTION", "RULE_GROUP", "RULE_GROUP_REFERENCE_STATEMENT", "SCOPE_DOWN", "SCOPE_VALUE", "SINGLE_HEADER", "SINGLE_QUERY_ARGUMENT", "SIZE_CONSTRAINT_STATEMENT", "SQLI_MATCH_STATEMENT", "STATEMENT", "TAGS", "TAG_KEYS", "TEXT_TRANSFORMATION", "TOKEN_DOMAIN", "WEB_ACL", "XSS_MATCH_STATEMENT"]
                }
            }
