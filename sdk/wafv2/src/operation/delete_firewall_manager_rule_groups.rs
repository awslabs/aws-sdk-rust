...
impl DeleteFirewallManagerRuleGroups {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroupsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteFirewallManagerRuleGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteFirewallManagerRuleGroupsRequestSerializer {
