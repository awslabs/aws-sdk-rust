...
impl DeleteFirewallManagerRuleGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFirewallManagerRuleGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_firewall_manager_rule_groups::de_delete_firewall_manager_rule_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
