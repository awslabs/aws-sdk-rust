...
impl DeleteFirewallManagerRuleGroups {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroupsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroupsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "WAFV2",
            "rpc.method" = "DeleteFirewallManagerRuleGroups",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFirewallManagerRuleGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteFirewallManagerRuleGroupsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteFirewallManagerRuleGroupsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteFirewallManagerRuleGroups")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFirewallManagerRuleGroups")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteFirewallManagerRuleGroupsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteFirewallManagerRuleGroupsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFirewallManagerRuleGroupsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteFirewallManagerRuleGroupsInput>() else {
        ...
        if requested.should_capture("WebACLLockToken") {
            if let ::std::option::Option::Some(value) = input.web_acl_lock_token.as_deref() {
                captured.insert("WebACLLockToken", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFirewallManagerRuleGroupsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_delete_firewall_manager_rule_groups::de_delete_firewall_manager_rule_groups_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFirewallManagerRuleGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroupsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroupsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_firewall_manager_rule_groups::ser_delete_firewall_manager_rule_groups_input(&input)?,
        );
