...
impl ListApiKeysInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_api_keys::ser_list_api_keys_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_api_keys::ListAPIKeys::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAPIKeys", "wafv2"));
