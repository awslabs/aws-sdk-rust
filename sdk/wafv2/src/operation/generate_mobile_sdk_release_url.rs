...
impl GenerateMobileSdkReleaseUrl {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WAFV2", "GenerateMobileSdkReleaseUrl", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WAFV2.GenerateMobileSdkReleaseUrl",
                "rpc.service" = "WAFV2",
                "rpc.method" = "GenerateMobileSdkReleaseUrl",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateMobileSdkReleaseUrl {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateMobileSdkReleaseUrlRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GenerateMobileSdkReleaseUrlResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GenerateMobileSdkReleaseUrl")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateMobileSdkReleaseUrl")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GenerateMobileSdkReleaseUrlTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GenerateMobileSdkReleaseUrlTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateMobileSdkReleaseUrlTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GenerateMobileSdkReleaseUrlInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateMobileSdkReleaseUrlResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_generate_mobile_sdk_release_url::de_generate_mobile_sdk_release_url_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_generate_mobile_sdk_release_url::de_generate_mobile_sdk_release_url_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateMobileSdkReleaseUrlRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_mobile_sdk_release_url::ser_generate_mobile_sdk_release_url_input(&input)?,
        );
