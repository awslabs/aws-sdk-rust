...
impl GetWebAclForResourceInput {
    /// Consumes the builder and constructs an Operation<[`GetWebACLForResource`](crate::operation::get_web_acl_for_resource::GetWebACLForResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_web_acl_for_resource::GetWebACLForResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_web_acl_for_resource::GetWebAclForResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_web_acl_for_resource::GetWebACLForResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetWebACLForResource {
                type Output = std::result::Result<crate::operation::get_web_acl_for_resource::GetWebAclForResourceOutput, crate::operation::get_web_acl_for_resource::GetWebACLForResourceError>;
