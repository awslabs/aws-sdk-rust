...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListWebACLsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListWebACLsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_web_acls::ser_list_web_acls_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListWebACLsEndpointParamsInterceptor {
