...
impl DeleteRegexPatternSet {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WAFV2", "DeleteRegexPatternSet", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRegexPatternSetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("LockToken") {
            if let ::std::option::Option::Some(value) = input.lock_token.as_deref() {
                captured.insert("LockToken", value);
            }
        }
