...
impl DescribeManagedProductsByVendorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_managed_products_by_vendor::DescribeManagedProductsByVendor::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeManagedProductsByVendor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_managed_products_by_vendor::de_describe_managed_products_by_vendor_http_response_with_props(
                status, headers, body,
            )
        }
    }
