...
impl DescribeManagedRuleGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_managed_rule_group::DescribeManagedRuleGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeManagedRuleGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_managed_rule_group::de_describe_managed_rule_group_http_response_with_props(status, headers, body)
        }
    }
}
