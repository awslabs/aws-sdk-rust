...
impl CheckCapacity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::check_capacity::CheckCapacityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::check_capacity::CheckCapacityOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WAFV2", "CheckCapacity", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WAFV2.CheckCapacity",
                "rpc.service" = "WAFV2",
                "rpc.method" = "CheckCapacity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CheckCapacity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CheckCapacityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CheckCapacityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CheckCapacity")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CheckCapacity", "WAFV2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CheckCapacityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_check_capacity::de_check_capacity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_check_capacity::de_check_capacity_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CheckCapacityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::check_capacity::CheckCapacityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::check_capacity::CheckCapacityInput,
