...
impl CheckCapacityInput {
    /// Consumes the builder and constructs an Operation<[`CheckCapacity`](crate::operation::check_capacity::CheckCapacity)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::check_capacity::CheckCapacity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_check_capacity::ser_check_capacity_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::check_capacity::CheckCapacity::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckCapacity {
    type Output = ::std::result::Result<crate::operation::check_capacity::CheckCapacityOutput, crate::operation::check_capacity::CheckCapacityError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_check_capacity::de_check_capacity_http_response_with_props(status, headers, body)
        }
    }
}
