...
impl CheckCapacityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::check_capacity::CheckCapacity,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::check_capacity::CheckCapacity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckCapacity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_check_capacity::de_check_capacity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_check_capacity::de_check_capacity_http_response_with_props(
                status, headers, body,
            )
        }
    }
