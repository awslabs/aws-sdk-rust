...
impl GetDecryptedApiKeyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_decrypted_api_key::ser_get_decrypted_api_key_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_decrypted_api_key::GetDecryptedAPIKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDecryptedAPIKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_decrypted_api_key::de_get_decrypted_api_key_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError
{
