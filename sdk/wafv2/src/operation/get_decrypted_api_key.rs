...
#[non_exhaustive]
pub struct GetDecryptedAPIKey;
impl GetDecryptedAPIKey {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDecryptedAPIKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDecryptedAPIKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDecryptedAPIKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDecryptedAPIKeyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDecryptedAPIKey")
...
.with_interceptor(GetDecryptedAPIKeyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError>::new());
...
#[derive(Debug)]
            struct GetDecryptedAPIKeyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDecryptedAPIKeyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_decrypted_api_key::de_get_decrypted_api_key_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDecryptedAPIKeyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDecryptedAPIKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_decrypted_api_key::GetDecryptedApiKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                        ...
                        "AWSWAF_20190729.GetDecryptedAPIKey"
                    );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_decrypted_api_key::ser_get_decrypted_api_key_input(&input)?);
...
#[derive(Debug)]
            struct GetDecryptedAPIKeyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDecryptedAPIKeyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDecryptedAPIKeyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDecryptedApiKeyInput>()
                        .ok_or("failed to downcast to GetDecryptedApiKeyInput")?;
...
/// Error type for the `GetDecryptedAPIKeyError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetDecryptedAPIKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDecryptedAPIKeyError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetDecryptedAPIKeyError {
    /// Creates the `GetDecryptedAPIKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDecryptedAPIKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetDecryptedAPIKeyError::WafInternalErrorException`.
    pub fn is_waf_internal_error_exception(&self) -> bool {
        matches!(self, Self::WafInternalErrorException(_))
    }
    /// Returns `true` if the error kind is `GetDecryptedAPIKeyError::WafInvalidOperationException`.
    pub fn is_waf_invalid_operation_exception(&self) -> bool {
        matches!(self, Self::WafInvalidOperationException(_))
    }
    /// Returns `true` if the error kind is `GetDecryptedAPIKeyError::WafInvalidParameterException`.
    pub fn is_waf_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::WafInvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `GetDecryptedAPIKeyError::WafInvalidResourceException`.
...
impl ::std::fmt::Display for GetDecryptedAPIKeyError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetDecryptedAPIKeyError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDecryptedAPIKeyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDecryptedAPIKeyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError {
...
mod _get_decrypted_api_key_output;
