...
impl GetDecryptedAPIKey {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("wafv2", "GetDecryptedAPIKey", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDecryptedAPIKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetDecryptedAPIKey", "wafv2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDecryptedAPIKey")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetDecryptedAPIKeyEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetDecryptedAPIKeyResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetDecryptedAPIKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_decrypted_api_key::ser_get_decrypted_api_key_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetDecryptedAPIKeyEndpointParamsInterceptor {
...
pub type GetDecryptedAPIKeyErrorKind = GetDecryptedAPIKeyError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetDecryptedAPIKeyError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError {
...
impl GetDecryptedAPIKeyError {
    ...
    /// Creates the `GetDecryptedAPIKeyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
