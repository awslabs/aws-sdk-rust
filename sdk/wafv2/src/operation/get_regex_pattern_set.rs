...
impl GetRegexPatternSet {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_regex_pattern_set::GetRegexPatternSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_regex_pattern_set::GetRegexPatternSetOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WAFV2", "GetRegexPatternSet", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WAFV2.GetRegexPatternSet",
                "rpc.service" = "WAFV2",
                "rpc.method" = "GetRegexPatternSet",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRegexPatternSet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRegexPatternSetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetRegexPatternSetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetRegexPatternSet")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRegexPatternSet")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRegexPatternSetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetRegexPatternSetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRegexPatternSetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetRegexPatternSetInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRegexPatternSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_regex_pattern_set::de_get_regex_pattern_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_regex_pattern_set::de_get_regex_pattern_set_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRegexPatternSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_regex_pattern_set::GetRegexPatternSetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_regex_pattern_set::GetRegexPatternSetInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_regex_pattern_set::ser_get_regex_pattern_set_input(
            &input,
        )?);
