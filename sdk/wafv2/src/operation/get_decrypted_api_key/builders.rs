...
impl GetDecryptedAPIKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError, Self> {
