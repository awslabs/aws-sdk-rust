...
impl GetDecryptedAPIKeyFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, aws_smithy_http::result::SdkError<crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError>>
                     {
