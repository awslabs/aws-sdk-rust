...
impl GetSampledRequestsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_sampled_requests::ser_get_sampled_requests_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSampledRequests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sampled_requests::de_get_sampled_requests_http_response_with_props(status, headers, body)
        }
    }
}
