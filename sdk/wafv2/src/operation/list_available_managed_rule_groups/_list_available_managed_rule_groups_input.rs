...
impl ListAvailableManagedRuleGroupsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
