...
impl ListAvailableManagedRuleGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
