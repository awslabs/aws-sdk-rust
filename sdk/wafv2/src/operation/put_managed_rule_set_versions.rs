...
impl PutManagedRuleSetVersionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_managed_rule_set_versions::PutManagedRuleSetVersions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutManagedRuleSetVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_managed_rule_set_versions::de_put_managed_rule_set_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
