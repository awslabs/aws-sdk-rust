...
impl GenerateMobileSdkReleaseUrlInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.generate_mobile_sdk_release_url();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput,
                    crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError,
                > for GenerateMobileSdkReleaseUrlFluentBuilder
            {
                fn send(
                    self,
...
impl GenerateMobileSdkReleaseUrlFluentBuilder {
    ...
    /// Access the GenerateMobileSdkReleaseUrl as a reference.
    pub fn as_input(&self) -> &crate::operation::generate_mobile_sdk_release_url::builders::GenerateMobileSdkReleaseUrlInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrl::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrl::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput, crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError, Self> {
