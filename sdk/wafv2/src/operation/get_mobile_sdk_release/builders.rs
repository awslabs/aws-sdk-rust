...
impl GetMobileSdkReleaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_mobile_sdk_release::GetMobileSdkReleaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_mobile_sdk_release::GetMobileSdkReleaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_mobile_sdk_release::GetMobileSdkReleaseOutput, crate::operation::get_mobile_sdk_release::GetMobileSdkReleaseError, Self> {
