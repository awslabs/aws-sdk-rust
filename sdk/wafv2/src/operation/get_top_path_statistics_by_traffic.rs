...
/// Orchestration and serialization glue logic for `GetTopPathStatisticsByTraffic`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetTopPathStatisticsByTraffic;
impl GetTopPathStatisticsByTraffic {
    /// Creates a new `GetTopPathStatisticsByTraffic`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_top_path_statistics_by_traffic::GetTopPathStatisticsByTrafficError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_top_path_statistics_by_traffic::GetTopPathStatisticsByTrafficOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "WAFV2",
            "rpc.method" = "GetTopPathStatisticsByTraffic",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTopPathStatisticsByTraffic {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTopPathStatisticsByTraffic");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetTopPathStatisticsByTrafficRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetTopPathStatisticsByTrafficResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetTopPathStatisticsByTraffic")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTopPathStatisticsByTraffic")
            ...
            .with_interceptor(GetTopPathStatisticsByTrafficEndpointParamsInterceptor)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTopPathStatisticsByTrafficResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_top_path_statistics_by_traffic::de_get_top_path_statistics_by_traffic_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_top_path_statistics_by_traffic::de_get_top_path_statistics_by_traffic_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct GetTopPathStatisticsByTrafficRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTopPathStatisticsByTrafficRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_top_path_statistics_by_traffic::GetTopPathStatisticsByTrafficInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_top_path_statistics_by_traffic::GetTopPathStatisticsByTrafficInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSWAF_20190729.GetTopPathStatisticsByTraffic",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_top_path_statistics_by_traffic::ser_get_top_path_statistics_by_traffic_input(&input)?,
        );
...
#[derive(Debug)]
struct GetTopPathStatisticsByTrafficEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTopPathStatisticsByTrafficEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetTopPathStatisticsByTrafficEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetTopPathStatisticsByTrafficInput>()
            .ok_or("failed to downcast to GetTopPathStatisticsByTrafficInput")?;
...
/// Error type for the `GetTopPathStatisticsByTrafficError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetTopPathStatisticsByTrafficError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTopPathStatisticsByTrafficError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetTopPathStatisticsByTrafficError {
    /// Creates the `GetTopPathStatisticsByTrafficError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetTopPathStatisticsByTrafficError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetTopPathStatisticsByTrafficError::WafFeatureNotIncludedInPricingPlanException`.
    ...
    /// Returns `true` if the error kind is `GetTopPathStatisticsByTrafficError::WafInternalErrorException`.
    pub fn is_waf_internal_error_exception(&self) -> bool {
        matches!(self, Self::WafInternalErrorException(_))
    }
    /// Returns `true` if the error kind is `GetTopPathStatisticsByTrafficError::WafInvalidOperationException`.
    pub fn is_waf_invalid_operation_exception(&self) -> bool {
        matches!(self, Self::WafInvalidOperationException(_))
    }
    /// Returns `true` if the error kind is `GetTopPathStatisticsByTrafficError::WafInvalidParameterException`.
    pub fn is_waf_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::WafInvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `GetTopPathStatisticsByTrafficError::WafNonexistentItemException`.
    pub fn is_waf_nonexistent_item_exception(&self) -> bool {
        matches!(self, Self::WafNonexistentItemException(_))
    }
}
impl ::std::error::Error for GetTopPathStatisticsByTrafficError {
...
impl ::std::fmt::Display for GetTopPathStatisticsByTrafficError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetTopPathStatisticsByTrafficError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTopPathStatisticsByTrafficError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTopPathStatisticsByTrafficError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_top_path_statistics_by_traffic::GetTopPathStatisticsByTrafficError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_top_path_statistics_by_traffic::_get_top_path_statistics_by_traffic_input::GetTopPathStatisticsByTrafficInput;

pub use crate::operation::get_top_path_statistics_by_traffic::_get_top_path_statistics_by_traffic_output::GetTopPathStatisticsByTrafficOutput;

mod _get_top_path_statistics_by_traffic_input;

mod _get_top_path_statistics_by_traffic_output;
