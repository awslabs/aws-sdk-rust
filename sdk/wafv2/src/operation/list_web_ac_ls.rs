    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_web_ac_ls::ListWebACLsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_web_ac_ls::ListWebAcLsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListWebACLsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_web_ac_ls::ListWebAcLsInput>()
            .expect("correct type");
