...
impl ListWebAcLsInput {
    /// Consumes the builder and constructs an Operation<[`ListWebACLs`](crate::operation::list_web_ac_ls::ListWebACLs)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_web_ac_ls::ListWebACLs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_web_ac_ls::ser_list_web_ac_ls_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_web_ac_ls::ListWebACLs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWebACLs {
    type Output = ::std::result::Result<crate::operation::list_web_ac_ls::ListWebAcLsOutput, crate::operation::list_web_ac_ls::ListWebACLsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_web_ac_ls::de_list_web_ac_ls_http_response_with_props(status, headers, body)
        }
    }
}
