    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_web_ac_ls::ListWebACLsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_web_ac_ls::ListWebAcLsOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWebACLs")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListWebACLsEndpointParamsInterceptor) as _),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListWebACLsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_list_web_ac_ls::de_list_web_ac_ls_http_error(status, headers, body)
        } else {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListWebACLsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_web_ac_ls::ListWebAcLsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_web_ac_ls::ListWebAcLsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_web_ac_ls::ser_list_web_ac_ls_input(&input)?);
...
impl ::aws_http::request_id::RequestId for crate::operation::list_web_ac_ls::ListWebACLsError {
...
pub use crate::operation::list_web_ac_ls::_list_web_ac_ls_output::ListWebAcLsOutput;

pub use crate::operation::list_web_ac_ls::_list_web_ac_ls_input::ListWebAcLsInput;

mod _list_web_ac_ls_input;

mod _list_web_ac_ls_output;
