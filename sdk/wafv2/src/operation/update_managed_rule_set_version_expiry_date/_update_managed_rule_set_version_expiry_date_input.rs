...
impl UpdateManagedRuleSetVersionExpiryDateInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
