...
impl GetRateBasedStatementManagedKeys {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_rate_based_statement_managed_keys::GetRateBasedStatementManagedKeysError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_rate_based_statement_managed_keys::GetRateBasedStatementManagedKeysOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "WAFV2",
            "rpc.method" = "GetRateBasedStatementManagedKeys",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRateBasedStatementManagedKeys {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRateBasedStatementManagedKeysRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetRateBasedStatementManagedKeysResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetRateBasedStatementManagedKeys")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRateBasedStatementManagedKeys")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRateBasedStatementManagedKeysTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetRateBasedStatementManagedKeysTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRateBasedStatementManagedKeysTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetRateBasedStatementManagedKeysInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("WebACLName") {
            if let ::std::option::Option::Some(value) = input.web_acl_name.as_deref() {
                captured.insert("WebACLName", value);
            }
        }
        ...
        if requested.should_capture("RuleGroupRuleName") {
            if let ::std::option::Option::Some(value) = input.rule_group_rule_name.as_deref() {
                captured.insert("RuleGroupRuleName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRateBasedStatementManagedKeysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_rate_based_statement_managed_keys::de_get_rate_based_statement_managed_keys_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_rate_based_statement_managed_keys::de_get_rate_based_statement_managed_keys_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRateBasedStatementManagedKeysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_rate_based_statement_managed_keys::GetRateBasedStatementManagedKeysInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_rate_based_statement_managed_keys::GetRateBasedStatementManagedKeysInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_rate_based_statement_managed_keys::ser_get_rate_based_statement_managed_keys_input(&input)?,
        );
...
impl ::std::error::Error for GetRateBasedStatementManagedKeysError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::WafUnsupportedAggregateKeyTypeException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetRateBasedStatementManagedKeysError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::WafUnsupportedAggregateKeyTypeException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
