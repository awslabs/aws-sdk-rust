...
impl GetRateBasedStatementManagedKeysInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_rate_based_statement_managed_keys::GetRateBasedStatementManagedKeys::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRateBasedStatementManagedKeys {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_rate_based_statement_managed_keys::de_get_rate_based_statement_managed_keys_http_response_with_props(
                status, headers, body,
            )
        }
    }
