...
impl CheckCapacityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::check_capacity::CheckCapacityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::check_capacity::CheckCapacityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::check_capacity::CheckCapacityOutput, crate::operation::check_capacity::CheckCapacityError, Self> {
