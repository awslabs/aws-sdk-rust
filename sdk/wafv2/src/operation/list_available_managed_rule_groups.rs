...
impl ListAvailableManagedRuleGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroups,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAvailableManagedRuleGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_available_managed_rule_groups::de_list_available_managed_rule_groups_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError
{
