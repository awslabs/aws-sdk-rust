...
impl ListAvailableManagedRuleGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListAvailableManagedRuleGroups`](crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_available_managed_rule_groups::ser_list_available_managed_rule_groups_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAvailableManagedRuleGroups", "wafv2"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListAvailableManagedRuleGroups`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListAvailableManagedRuleGroups {
                type Output = std::result::Result<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsOutput, crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError>;
