...
/// Orchestration and serialization glue logic for `ListAvailableManagedRuleGroups`.
...
impl ListAvailableManagedRuleGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsInput,
                    ) -> ::std::result::Result<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAvailableManagedRuleGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAvailableManagedRuleGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAvailableManagedRuleGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAvailableManagedRuleGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAvailableManagedRuleGroups")
...
.with_interceptor(ListAvailableManagedRuleGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError>::new());
...
#[derive(Debug)]
            struct ListAvailableManagedRuleGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAvailableManagedRuleGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_available_managed_rule_groups::de_list_available_managed_rule_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_available_managed_rule_groups::de_list_available_managed_rule_groups_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAvailableManagedRuleGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAvailableManagedRuleGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_available_managed_rule_groups::ser_list_available_managed_rule_groups_input(&input)?);
...
#[derive(Debug)]
            struct ListAvailableManagedRuleGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAvailableManagedRuleGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAvailableManagedRuleGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAvailableManagedRuleGroupsInput>()
                        .ok_or("failed to downcast to ListAvailableManagedRuleGroupsInput")?;
...
pub enum ListAvailableManagedRuleGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAvailableManagedRuleGroupsError) for what information is available for the error.")]
...
impl ListAvailableManagedRuleGroupsError {
    /// Creates the `ListAvailableManagedRuleGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAvailableManagedRuleGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAvailableManagedRuleGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_available_managed_rule_groups::ListAvailableManagedRuleGroupsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_available_managed_rule_groups::_list_available_managed_rule_groups_output::ListAvailableManagedRuleGroupsOutput;

pub use crate::operation::list_available_managed_rule_groups::_list_available_managed_rule_groups_input::ListAvailableManagedRuleGroupsInput;

mod _list_available_managed_rule_groups_input;

mod _list_available_managed_rule_groups_output;
