...
impl UpdateManagedRuleSetVersionExpiryDate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "WAFV2",
            "rpc.method" = "UpdateManagedRuleSetVersionExpiryDate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateManagedRuleSetVersionExpiryDate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateManagedRuleSetVersionExpiryDateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateManagedRuleSetVersionExpiryDateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateManagedRuleSetVersionExpiryDate")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateManagedRuleSetVersionExpiryDate")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateManagedRuleSetVersionExpiryDateTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateManagedRuleSetVersionExpiryDateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateManagedRuleSetVersionExpiryDateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateManagedRuleSetVersionExpiryDateInput>() else {
        ...
        if requested.should_capture("VersionToExpire") {
            if let ::std::option::Option::Some(value) = input.version_to_expire.as_deref() {
                captured.insert("VersionToExpire", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateManagedRuleSetVersionExpiryDateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::de_update_managed_rule_set_version_expiry_date_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::de_update_managed_rule_set_version_expiry_date_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateManagedRuleSetVersionExpiryDateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::ser_update_managed_rule_set_version_expiry_date_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError
{
