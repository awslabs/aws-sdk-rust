...
/// Orchestration and serialization glue logic for `UpdateManagedRuleSetVersionExpiryDate`.
...
impl UpdateManagedRuleSetVersionExpiryDate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateInput,
                    ) -> ::std::result::Result<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateManagedRuleSetVersionExpiryDate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateManagedRuleSetVersionExpiryDate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateManagedRuleSetVersionExpiryDateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateManagedRuleSetVersionExpiryDateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateManagedRuleSetVersionExpiryDate")
...
.with_interceptor(UpdateManagedRuleSetVersionExpiryDateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError>::new());
...
#[derive(Debug)]
            struct UpdateManagedRuleSetVersionExpiryDateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateManagedRuleSetVersionExpiryDateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::de_update_managed_rule_set_version_expiry_date_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::de_update_managed_rule_set_version_expiry_date_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateManagedRuleSetVersionExpiryDateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateManagedRuleSetVersionExpiryDateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::ser_update_managed_rule_set_version_expiry_date_input(&input)?);
...
#[derive(Debug)]
            struct UpdateManagedRuleSetVersionExpiryDateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateManagedRuleSetVersionExpiryDateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateManagedRuleSetVersionExpiryDateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateManagedRuleSetVersionExpiryDateInput>()
                        .ok_or("failed to downcast to UpdateManagedRuleSetVersionExpiryDateInput")?;
...
pub enum UpdateManagedRuleSetVersionExpiryDateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateManagedRuleSetVersionExpiryDateError) for what information is available for the error.")]
...
impl UpdateManagedRuleSetVersionExpiryDateError {
    /// Creates the `UpdateManagedRuleSetVersionExpiryDateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateManagedRuleSetVersionExpiryDateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateManagedRuleSetVersionExpiryDateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_managed_rule_set_version_expiry_date::UpdateManagedRuleSetVersionExpiryDateError {
...
mod _update_managed_rule_set_version_expiry_date_output;
