...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateManagedRuleSetVersionExpiryDate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_managed_rule_set_version_expiry_date::de_update_managed_rule_set_version_expiry_date_http_response_with_props(status, headers, body)
        }
    }
}
