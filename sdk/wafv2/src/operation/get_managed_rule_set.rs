...
impl GetManagedRuleSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_managed_rule_set::ser_get_managed_rule_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetManagedRuleSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_managed_rule_set::de_get_managed_rule_set_http_response_with_props(status, headers, body)
        }
    }
}
