...
impl PutPermissionPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_permission_policy::PutPermissionPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_permission_policy::PutPermissionPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_permission_policy::PutPermissionPolicyOutput, crate::operation::put_permission_policy::PutPermissionPolicyError, Self> {
