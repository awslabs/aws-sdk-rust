...
impl ::aws_types::request_id::RequestId for PutPermissionPolicyOutput {
...
impl PutPermissionPolicyOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutPermissionPolicyOutput`](crate::operation::put_permission_policy::PutPermissionPolicyOutput).
    pub fn build(self) -> crate::operation::put_permission_policy::PutPermissionPolicyOutput {
