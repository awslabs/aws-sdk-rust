...
impl CreateIpSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_ip_set::CreateIPSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIPSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_ip_set::de_create_ip_set_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_ip_set::de_create_ip_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
