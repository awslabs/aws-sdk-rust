...
impl ListMobileSdkReleasesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_mobile_sdk_releases::ListMobileSdkReleasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_mobile_sdk_releases::ListMobileSdkReleasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_mobile_sdk_releases::ListMobileSdkReleasesOutput, crate::operation::list_mobile_sdk_releases::ListMobileSdkReleasesError, Self> {
