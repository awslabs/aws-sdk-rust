...
impl AssociateWebAclInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_web_acl::AssociateWebACL, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_web_acl::ser_associate_web_acl_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateWebACL {
    type Output =
        ::std::result::Result<crate::operation::associate_web_acl::AssociateWebAclOutput, crate::operation::associate_web_acl::AssociateWebACLError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_web_acl::de_associate_web_acl_http_response_with_props(status, headers, body)
        }
    }
}
