...
impl AssociateWebAclInput {
    /// Consumes the builder and constructs an Operation<[`AssociateWebACL`](crate::operation::associate_web_acl::AssociateWebACL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_web_acl::AssociateWebACL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_web_acl::AssociateWebAclInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_web_acl::AssociateWebACL::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateWebACL {
                type Output = std::result::Result<crate::operation::associate_web_acl::AssociateWebAclOutput, crate::operation::associate_web_acl::AssociateWebACLError>;
