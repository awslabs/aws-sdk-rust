...
impl ListManagedRuleSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListManagedRuleSets`](crate::operation::list_managed_rule_sets::ListManagedRuleSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_managed_rule_sets::ListManagedRuleSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_managed_rule_sets::ListManagedRuleSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_managed_rule_sets::ser_list_managed_rule_sets_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_managed_rule_sets::ListManagedRuleSets::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListManagedRuleSets", "wafv2"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListManagedRuleSets`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListManagedRuleSets {
                type Output = std::result::Result<crate::operation::list_managed_rule_sets::ListManagedRuleSetsOutput, crate::operation::list_managed_rule_sets::ListManagedRuleSetsError>;
