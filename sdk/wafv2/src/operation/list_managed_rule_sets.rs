...
impl ListManagedRuleSetsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_managed_rule_sets::ser_list_managed_rule_sets_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_managed_rule_sets::ListManagedRuleSets::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_managed_rule_sets::ListManagedRuleSetsError
{
