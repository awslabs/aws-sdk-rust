...
impl ListAvailableManagedRuleGroupVersions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAvailableManagedRuleGroupVersions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAvailableManagedRuleGroupVersions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAvailableManagedRuleGroupVersionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAvailableManagedRuleGroupVersionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAvailableManagedRuleGroupVersions")
...
.with_interceptor(ListAvailableManagedRuleGroupVersionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsError>::new());
...
#[derive(Debug)]
            struct ListAvailableManagedRuleGroupVersionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAvailableManagedRuleGroupVersionsResponseDeserializer {
...
#[derive(Debug)]
            struct ListAvailableManagedRuleGroupVersionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAvailableManagedRuleGroupVersionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_available_managed_rule_group_versions::ser_list_available_managed_rule_group_versions_input(&input)?);
...
#[derive(Debug)]
            struct ListAvailableManagedRuleGroupVersionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAvailableManagedRuleGroupVersionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAvailableManagedRuleGroupVersionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAvailableManagedRuleGroupVersionsInput>()
                        .ok_or("failed to downcast to ListAvailableManagedRuleGroupVersionsInput")?;
...
pub enum ListAvailableManagedRuleGroupVersionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAvailableManagedRuleGroupVersionsError) for what information is available for the error.")]
...
impl ListAvailableManagedRuleGroupVersionsError {
    /// Creates the `ListAvailableManagedRuleGroupVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAvailableManagedRuleGroupVersionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAvailableManagedRuleGroupVersionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_available_managed_rule_group_versions::ListAvailableManagedRuleGroupVersionsError {
...
mod _list_available_managed_rule_group_versions_output;
