...
impl GetRuleGroupInput {
    /// Consumes the builder and constructs an Operation<[`GetRuleGroup`](crate::operation::get_rule_group::GetRuleGroup)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_rule_group::GetRuleGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_rule_group::ser_get_rule_group_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_rule_group::GetRuleGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRuleGroup {
    type Output = ::std::result::Result<crate::operation::get_rule_group::GetRuleGroupOutput, crate::operation::get_rule_group::GetRuleGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_rule_group::de_get_rule_group_http_response_with_props(status, headers, body)
        }
    }
}
