...
pub(crate) fn get_top_path_statistics_by_traffic_output_output_correct_errors(
    ...
    if builder.path_statistics.is_none() {
        builder.path_statistics = Some(Default::default())
    }
    if builder.total_request_count.is_none() {
        builder.total_request_count = Some(Default::default())
    }
    builder
}
...
pub(crate) fn path_statistics_correct_errors(
    mut builder: crate::types::builders::PathStatisticsBuilder,
) -> crate::types::builders::PathStatisticsBuilder {
...
pub(crate) fn bot_statistics_correct_errors(
    mut builder: crate::types::builders::BotStatisticsBuilder,
) -> crate::types::builders::BotStatisticsBuilder {
