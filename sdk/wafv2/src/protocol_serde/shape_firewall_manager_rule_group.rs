...
pub(crate) fn de_firewall_manager_rule_group<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::FirewallManagerRuleGroup>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "FirewallManagerStatement" => {
                            builder = builder.set_firewall_manager_statement(
                                crate::protocol_serde::shape_firewall_manager_statement::de_firewall_manager_statement(tokens, _value, depth + 1)?,
                            );
                        }
                        "OverrideAction" => {
            ...
            Ok(Some(
                crate::serde_util::firewall_manager_rule_group_correct_errors(builder)
                    .build()
