...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_logging_configurations::ListLoggingConfigurationsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "WAFInvalidOperationException" => {
            crate::operation::list_logging_configurations::ListLoggingConfigurationsError::WafInvalidOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "WAFInvalidParameterException" => {
            crate::operation::list_logging_configurations::ListLoggingConfigurationsError::WafInvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "LoggingConfigurations" => {
                    builder =
                        builder.set_logging_configurations(crate::protocol_serde::shape_logging_configurations::de_logging_configurations(tokens)?);
                }
                "NextMarker" => {
