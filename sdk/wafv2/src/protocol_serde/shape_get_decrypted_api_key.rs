...
pub fn de_get_decrypted_api_key_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_waf_nonexistent_item_exception::de_waf_nonexistent_item_exception_json_err(_response_body, output).map_err(crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_decrypted_api_key_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_get_decrypted_api_key_input(input: &crate::operation::get_decrypted_api_key::GetDecryptedApiKeyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_get_decrypted_api_key(value: &[u8], mut builder: crate::operation::get_decrypted_api_key::builders::GetDecryptedApiKeyOutputBuilder) -> Result<crate::operation::get_decrypted_api_key::builders::GetDecryptedApiKeyOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
