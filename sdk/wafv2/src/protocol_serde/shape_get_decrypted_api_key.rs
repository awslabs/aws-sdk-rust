...
pub fn ser_get_decrypted_api_key_input(
    ...
    crate::protocol_serde::shape_get_decrypted_api_key_input::ser_get_decrypted_api_key_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_decrypted_api_key::de_get_decrypted_api_key(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError::unhandled)?;
