...
pub fn ser_get_decrypted_api_key_input(
    ...
    crate::protocol_serde::shape_get_decrypted_api_key_input::ser_get_decrypted_api_key_input(&mut object, input)?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_decrypted_api_key_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
