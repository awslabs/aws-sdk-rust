...
pub fn ser_get_decrypted_api_key_input(input: &crate::operation::get_decrypted_api_key::GetDecryptedApiKeyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
