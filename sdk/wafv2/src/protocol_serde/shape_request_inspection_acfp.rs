...
pub(crate) fn de_request_inspection_acfp<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RequestInspectionAcfp>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "EmailField" => {
                                builder = builder.set_email_field(
                                    crate::protocol_serde::shape_email_field::de_email_field(tokens)?
                                );
                            }
                            "PhoneNumberFields" => {
                                builder = builder.set_phone_number_fields(
                                    crate::protocol_serde::shape_phone_number_fields::de_phone_number_fields(tokens)?
                                );
                            }
                            "AddressFields" => {
                                builder = builder.set_address_fields(
                                    crate::protocol_serde::shape_address_fields::de_address_fields(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::request_inspection_acfp_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
