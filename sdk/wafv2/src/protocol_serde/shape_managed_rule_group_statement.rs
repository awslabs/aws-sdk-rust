...
pub fn ser_managed_rule_group_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ManagedRuleGroupStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_managed_rule_group_statement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ManagedRuleGroupStatement>, aws_smithy_json::deserialize::error::DeserializeError>
