...
pub fn ser_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Rule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
