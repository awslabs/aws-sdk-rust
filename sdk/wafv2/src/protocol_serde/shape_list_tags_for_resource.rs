...
> {
    ...
    Err(match error_code {
        ...
        "WAFTagOperationInternalErrorException" => {
            crate::operation::list_tags_for_resource::ListTagsForResourceError::WafTagOperationInternalErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "TagInfoForResource" => {
                    builder = builder.set_tag_info_for_resource(crate::protocol_serde::shape_tag_info_for_resource::de_tag_info_for_resource(
                        tokens, _value,
                    )?);
                }
