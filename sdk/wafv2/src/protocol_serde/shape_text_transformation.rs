...
pub(crate) fn de_text_transformation<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TextTransformation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "Type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TextTransformationType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
