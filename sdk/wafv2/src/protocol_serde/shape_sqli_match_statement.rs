...
) -> Result<Option<crate::types::SqliMatchStatement>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "SensitivityLevel" => {
                            builder = builder.set_sensitivity_level(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::SensitivityLevel::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
