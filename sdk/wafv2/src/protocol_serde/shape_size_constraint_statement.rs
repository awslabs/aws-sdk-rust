...
pub fn ser_size_constraint_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SizeConstraintStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_size_constraint_statement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SizeConstraintStatement>, aws_smithy_json::deserialize::error::DeserializeError>
