...
pub fn ser_label(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Label) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
