...
pub fn ser_managed_rule_group_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ManagedRuleGroupConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_managed_rule_group_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ManagedRuleGroupConfig>, aws_smithy_json::deserialize::error::DeserializeError>
