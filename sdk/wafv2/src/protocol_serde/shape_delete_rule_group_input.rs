...
pub fn ser_delete_rule_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteRuleGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
