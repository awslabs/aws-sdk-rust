...
pub fn ser_json_body(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JsonBody) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_json_body<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JsonBody>, aws_smithy_json::deserialize::error::DeserializeError>
