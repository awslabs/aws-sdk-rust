...
pub fn ser_update_web_acl_input_input(
    ...
    if let Some(var_34) = &input.monetization_config {
        #[allow(unused_mut)]
        let mut object_35 = object.key("MonetizationConfig").start_object();
        crate::protocol_serde::shape_monetization_config::ser_monetization_config(&mut object_35, var_34)?;
        object_35.finish();
    }
    Ok(())
}
