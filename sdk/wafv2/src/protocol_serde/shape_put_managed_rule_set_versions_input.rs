...
pub fn ser_put_managed_rule_set_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutManagedRuleSetVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
