...
pub fn ser_xss_match_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::XssMatchStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
