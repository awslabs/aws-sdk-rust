...
pub fn ser_xss_match_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::XssMatchStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_xss_match_statement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::XssMatchStatement>, aws_smithy_json::deserialize::error::DeserializeError>
