...
pub fn ser_aws_managed_rules_atp_rule_set(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsManagedRulesAtpRuleSet) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
