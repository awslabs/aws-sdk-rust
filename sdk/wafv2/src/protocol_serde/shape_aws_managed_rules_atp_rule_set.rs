...
) -> Result<Option<crate::types::AwsManagedRulesAtpRuleSet>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RequestInspection" => {
                            builder = builder.set_request_inspection(crate::protocol_serde::shape_request_inspection::de_request_inspection(tokens)?);
                        }
                        "ResponseInspection" => {
                            builder =
