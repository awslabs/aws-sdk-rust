...
pub fn ser_rate_based_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RateBasedStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
...
pub(crate) fn de_rate_based_statement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RateBasedStatement>, aws_smithy_json::deserialize::error::DeserializeError>
