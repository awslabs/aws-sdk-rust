...
pub fn ser_delete_web_acl_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteWebAclInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
