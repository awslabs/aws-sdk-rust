...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_delete_web_acl_input::ser_delete_web_acl_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_web_acl::DeleteWebACLError::unhandled(generic))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_web_acl_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
