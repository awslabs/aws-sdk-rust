...
pub fn ser_rate_based_statement_custom_key(
    ...
    if let Some(var_1) = &input.header {
        ...
        crate::protocol_serde::shape_rate_limit_header::ser_rate_limit_header(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.cookie {
        ...
        crate::protocol_serde::shape_rate_limit_cookie::ser_rate_limit_cookie(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_5) = &input.query_argument {
        ...
        crate::protocol_serde::shape_rate_limit_query_argument::ser_rate_limit_query_argument(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
    ...
    if let Some(var_7) = &input.query_string {
        ...
        crate::protocol_serde::shape_rate_limit_query_string::ser_rate_limit_query_string(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
    ...
    if let Some(var_9) = &input.http_method {
        ...
        crate::protocol_serde::shape_rate_limit_http_method::ser_rate_limit_http_method(
            &mut object_10,
            var_9,
        )?;
        object_10.finish();
    ...
    if let Some(var_11) = &input.forwarded_ip {
        ...
        crate::protocol_serde::shape_rate_limit_forwarded_ip::ser_rate_limit_forwarded_ip(
            &mut object_12,
            var_11,
        )?;
        object_12.finish();
    ...
    if let Some(var_15) = &input.label_namespace {
        ...
        crate::protocol_serde::shape_rate_limit_label_namespace::ser_rate_limit_label_namespace(
            &mut object_16,
            var_15,
        )?;
        object_16.finish();
...
pub(crate) fn de_rate_based_statement_custom_key<'a, I>(
    ...
    Option<crate::types::RateBasedStatementCustomKey>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "Header" => {
                                builder = builder.set_header(
                                    crate::protocol_serde::shape_rate_limit_header::de_rate_limit_header(tokens)?
                                );
                            }
                            "Cookie" => {
                                builder = builder.set_cookie(
                                    crate::protocol_serde::shape_rate_limit_cookie::de_rate_limit_cookie(tokens)?
                                );
                            }
                            "QueryArgument" => {
                            ...
                            "QueryString" => {
                                builder = builder.set_query_string(
                                    crate::protocol_serde::shape_rate_limit_query_string::de_rate_limit_query_string(tokens)?
                                );
                            }
                            "HTTPMethod" => {
                                builder = builder.set_http_method(
                                    crate::protocol_serde::shape_rate_limit_http_method::de_rate_limit_http_method(tokens)?
                                );
                            }
                            "ForwardedIP" => {
                                builder = builder.set_forwarded_ip(
                                    crate::protocol_serde::shape_rate_limit_forwarded_ip::de_rate_limit_forwarded_ip(tokens)?
                                );
                            }
                            "IP" => {
                                builder = builder.set_ip(
                                    crate::protocol_serde::shape_rate_limit_ip::de_rate_limit_ip(
                                        tokens,
                                    )?,
                                );
                            }
