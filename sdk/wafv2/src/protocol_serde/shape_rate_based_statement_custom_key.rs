...
pub(crate) fn de_rate_based_statement_custom_key<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RateBasedStatementCustomKey>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "IP" => {
                                builder = builder.set_ip(
                                    crate::protocol_serde::shape_rate_limit_ip::de_rate_limit_ip(tokens)?
                                );
                            }
                            "LabelNamespace" => {
