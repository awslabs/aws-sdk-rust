...
pub fn ser_response_inspection_header(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ResponseInspectionHeader) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
