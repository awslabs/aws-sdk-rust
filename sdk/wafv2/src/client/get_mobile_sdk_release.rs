...
impl super::Client {
    ...
    ///   - [`platform(Platform)`](crate::operation::get_mobile_sdk_release::builders::GetMobileSdkReleaseFluentBuilder::platform) / [`set_platform(Option<Platform>)`](crate::operation::get_mobile_sdk_release::builders::GetMobileSdkReleaseFluentBuilder::set_platform):<br>required: **true**<br><p>The device platform.</p><br>
    ///   - [`release_version(impl Into<String>)`](crate::operation::get_mobile_sdk_release::builders::GetMobileSdkReleaseFluentBuilder::release_version) / [`set_release_version(Option<String>)`](crate::operation::get_mobile_sdk_release::builders::GetMobileSdkReleaseFluentBuilder::set_release_version):<br>required: **true**<br><p>The release version. For the latest available version, specify <code>LATEST</code>.</p><br>
