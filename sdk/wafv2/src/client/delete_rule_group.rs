...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::set_name): <p>The name of the rule group. You cannot change the name of a rule group after you create it.</p>
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::set_id): <p>A unique identifier for the rule group. This ID is returned in the responses to create and list commands. You provide it to operations like update and delete.</p>
