...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::set_name): <p>The name of the set. You cannot change the name after you create the set.</p>
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::set_id): <p>A unique identifier for the set. This ID is returned in the responses to create and list commands. You provide it to operations like update and delete.</p>
