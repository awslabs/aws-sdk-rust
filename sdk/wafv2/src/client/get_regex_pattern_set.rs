...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::set_name): <p>The name of the set. You cannot change the name after you create the set.</p>
    ///   - [`scope(Scope)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::scope) / [`set_scope(Option<Scope>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::set_scope): <p>Specifies whether this is for an Amazon CloudFront distribution or for a regional application. A regional application can be an Application Load Balancer (ALB), an Amazon API Gateway REST API, an AppSync GraphQL API, an Amazon Cognito user pool, an App Runner service, or an Amazon Web Services Verified Access instance. </p>  <p>To work with CloudFront, you must also specify the Region US East (N. Virginia) as follows: </p>  <ul>   <li> <p>CLI - Specify the Region when you use the CloudFront scope: <code>--scope=CLOUDFRONT --region=us-east-1</code>. </p> </li>   <li> <p>API and SDKs - For all calls, use the Region endpoint us-east-1. </p> </li>  </ul>
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::set_id): <p>A unique identifier for the set. This ID is returned in the responses to create and list commands. You provide it to operations like update and delete.</p>
