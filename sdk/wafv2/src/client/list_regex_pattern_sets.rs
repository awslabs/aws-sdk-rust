...
impl super::Client {
    ...
    ///   - [`next_marker(impl ::std::convert::Into<String>)`](crate::operation::list_regex_pattern_sets::builders::ListRegexPatternSetsFluentBuilder::next_marker) / [`set_next_marker(Option<String>)`](crate::operation::list_regex_pattern_sets::builders::ListRegexPatternSetsFluentBuilder::set_next_marker): <p>When you request a list of objects with a <code>Limit</code> setting, if the number of objects that are still available for retrieval exceeds the limit, WAF returns a <code>NextMarker</code> value in the response. To retrieve the next batch of objects, provide the marker from the prior call in your next request.</p>
