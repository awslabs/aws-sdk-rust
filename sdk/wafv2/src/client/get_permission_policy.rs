...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::get_permission_policy::builders::GetPermissionPolicyFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_permission_policy::builders::GetPermissionPolicyFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the rule group for which you want to get the policy.</p><br>
