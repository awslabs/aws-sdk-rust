...
impl super::Client {
    ...
    ///   - [`scope(Scope)`](crate::operation::list_ip_sets::builders::ListIPSetsFluentBuilder::scope) / [`set_scope(Option<Scope>)`](crate::operation::list_ip_sets::builders::ListIPSetsFluentBuilder::set_scope):<br>required: **true**<br><p>Specifies whether this is for a global resource type, such as a Amazon CloudFront distribution.</p> <p>To work with CloudFront, you must also specify the Region US East (N. Virginia) as follows:</p> <ul>  <li>   <p>CLI - Specify the Region when you use the CloudFront scope: <code>--scope=CLOUDFRONT --region=us-east-1</code>.</p></li>  <li>   <p>API and SDKs - For all calls, use the Region endpoint us-east-1.</p></li> </ul><br>
    ...
    ///   - [`limit(i32)`](crate::operation::list_ip_sets::builders::ListIPSetsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_ip_sets::builders::ListIPSetsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of objects that you want WAF to return for this request. If more objects are available, in the response, WAF provides a <code>NextMarker</code> value that you can use in a subsequent call to get the next batch of objects.</p><br>
    /// - On success, responds with [`ListIpSetsOutput`](crate::operation::list_ip_sets::ListIpSetsOutput) with field(s):
    ///   - [`next_marker(Option<String>)`](crate::operation::list_ip_sets::ListIpSetsOutput::next_marker): <p>When you request a list of objects with a <code>Limit</code> setting, if the number of objects that are still available for retrieval exceeds the limit, WAF returns a <code>NextMarker</code> value in the response. To retrieve the next batch of objects, provide the marker from the prior call in your next request.</p>
    ///   - [`ip_sets(Option<Vec::<IpSetSummary>>)`](crate::operation::list_ip_sets::ListIpSetsOutput::ip_sets): <p>Array of IPSets. If you specified a <code>Limit</code> in your request, this might not be the full list.</p>
