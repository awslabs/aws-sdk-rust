...
impl super::Client {
    ...
    ///   - [`ip_sets(Option<Vec<IpSetSummary>>)`](crate::operation::list_ip_sets::ListIpSetsOutput::ip_sets): <p>Array of IPSets. This may not be the full list of IPSets that you have defined. See the <code>Limit</code> specification for this request.</p>
