...
impl super::Client {
    ...
    ///   - [`api_key(impl Into<String>)`](crate::operation::get_decrypted_api_key::builders::GetDecryptedAPIKeyFluentBuilder::api_key) / [`set_api_key(Option<String>)`](crate::operation::get_decrypted_api_key::builders::GetDecryptedAPIKeyFluentBuilder::set_api_key): <p>The encrypted API key. </p>
