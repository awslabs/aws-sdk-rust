...
impl super::Client {
    ...
    ///   - [`scope(Scope)`](crate::operation::get_decrypted_api_key::builders::GetDecryptedAPIKeyFluentBuilder::scope) / [`set_scope(Option<Scope>)`](crate::operation::get_decrypted_api_key::builders::GetDecryptedAPIKeyFluentBuilder::set_scope): <p>Specifies whether this is for an Amazon CloudFront distribution or for a regional application. A regional application can be an Application Load Balancer (ALB), an Amazon API Gateway REST API, an AppSync GraphQL API, an Amazon Cognito user pool, an App Runner service, or an Amazon Web Services Verified Access instance. </p>  <p>To work with CloudFront, you must also specify the Region US East (N. Virginia) as follows: </p>  <ul>   <li> <p>CLI - Specify the Region when you use the CloudFront scope: <code>--scope=CLOUDFRONT --region=us-east-1</code>. </p> </li>   <li> <p>API and SDKs - For all calls, use the Region endpoint us-east-1. </p> </li>  </ul>
    ///   - [`api_key(impl ::std::convert::Into<String>)`](crate::operation::get_decrypted_api_key::builders::GetDecryptedAPIKeyFluentBuilder::api_key) / [`set_api_key(Option<String>)`](crate::operation::get_decrypted_api_key::builders::GetDecryptedAPIKeyFluentBuilder::set_api_key): <p>The encrypted API key. </p>
