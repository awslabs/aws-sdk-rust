...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_managed_rule_set::builders::GetManagedRuleSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_managed_rule_set::builders::GetManagedRuleSetFluentBuilder::set_name): <p>The name of the managed rule set. You use this, along with the rule set ID, to identify the rule set.</p>  <p>This name is assigned to the corresponding managed rule group, which your customers can access and use. </p>
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_managed_rule_set::builders::GetManagedRuleSetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_managed_rule_set::builders::GetManagedRuleSetFluentBuilder::set_id): <p>A unique identifier for the managed rule set. The ID is returned in the responses to commands like <code>list</code>. You provide it to operations like <code>get</code> and <code>update</code>.</p>
