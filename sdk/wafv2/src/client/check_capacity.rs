...
impl super::Client {
    ...
    ///   - [`rules(Rule)`](crate::operation::check_capacity::builders::CheckCapacityFluentBuilder::rules) / [`set_rules(Option<Vec<Rule>>)`](crate::operation::check_capacity::builders::CheckCapacityFluentBuilder::set_rules): <p>An array of <code>Rule</code> that you're configuring to use in a rule group or web ACL. </p>
