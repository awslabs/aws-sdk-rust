...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_regex_pattern_set::builders::DeleteRegexPatternSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_regex_pattern_set::builders::DeleteRegexPatternSetFluentBuilder::set_name): <p>The name of the set. You cannot change the name after you create the set.</p>
