...
impl Builder {
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("aws_sdk_applicationautoscaling::config::Config").freeze(),
                                    cloneable: layer,
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_applicationautoscaling::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
