...
pub fn serialize_structure_crate_input_delete_scaling_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteScalingPolicyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_scheduled_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteScheduledActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_deregister_scalable_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeregisterScalableTargetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_scalable_targets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeScalableTargetsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_scaling_activities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeScalingActivitiesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_scaling_policies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeScalingPoliciesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_scheduled_actions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeScheduledActionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_scaling_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutScalingPolicyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_45) = &input.step_scaling_policy_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_step_scaling_policy_configuration(&mut object_46, var_45)?;
        object_46.finish();
    }
    if let Some(var_47) = &input.target_tracking_scaling_policy_configuration {
        let mut object_48 = object.key("TargetTrackingScalingPolicyConfiguration").start_object();
...
pub fn serialize_structure_crate_input_put_scheduled_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutScheduledActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_57) = &input.scalable_target_action {
        ...
        crate::json_ser::serialize_structure_crate_model_scalable_target_action(&mut object_58, var_57)?;
        object_58.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_input_register_scalable_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterScalableTargetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_62) = &input.min_capacity {
        object.key("MinCapacity").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_62).into()));
    }
    if let Some(var_63) = &input.max_capacity {
        object.key("MaxCapacity").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_63).into()));
    }
...
pub fn serialize_structure_crate_model_step_scaling_policy_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StepScalingPolicyConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_70 in var_68 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_step_adjustment(&mut object_71, item_70)?;
                object_71.finish();
            }
        }
        array_69.finish();
    ...
    if let Some(var_72) = &input.min_adjustment_magnitude {
        object.key("MinAdjustmentMagnitude").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_72).into()));
    }
    if let Some(var_73) = &input.cooldown {
        object.key("Cooldown").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_73).into()));
    }
...
pub fn serialize_structure_crate_model_target_tracking_scaling_policy_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TargetTrackingScalingPolicyConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_75) = &input.target_value {
        object.key("TargetValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_75).into()));
    }
    if let Some(var_76) = &input.predefined_metric_specification {
        ...
        crate::json_ser::serialize_structure_crate_model_predefined_metric_specification(&mut object_77, var_76)?;
        object_77.finish();
    }
    if let Some(var_78) = &input.customized_metric_specification {
        ...
        crate::json_ser::serialize_structure_crate_model_customized_metric_specification(&mut object_79, var_78)?;
        object_79.finish();
    }
    if let Some(var_80) = &input.scale_out_cooldown {
        object.key("ScaleOutCooldown").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_80).into()));
    }
    if let Some(var_81) = &input.scale_in_cooldown {
        object.key("ScaleInCooldown").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_81).into()));
    }
...
pub fn serialize_structure_crate_model_scalable_target_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScalableTargetAction) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_83) = &input.min_capacity {
        object.key("MinCapacity").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_83).into()));
    }
    if let Some(var_84) = &input.max_capacity {
        object.key("MaxCapacity").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_84).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_suspended_state(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SuspendedState) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_step_adjustment(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StepAdjustment) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_88) = &input.metric_interval_lower_bound {
        object.key("MetricIntervalLowerBound").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_88).into()));
    }
    if let Some(var_89) = &input.metric_interval_upper_bound {
        object.key("MetricIntervalUpperBound").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_89).into()));
    }
    if let Some(var_90) = &input.scaling_adjustment {
        object.key("ScalingAdjustment").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_90).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_predefined_metric_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PredefinedMetricSpecification) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_customized_metric_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomizedMetricSpecification) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_97 in var_95 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_metric_dimension(&mut object_98, item_97)?;
                object_98.finish();
            }
        }
        array_96.finish();
...
pub fn serialize_structure_crate_model_metric_dimension(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricDimension) -> Result<(), aws_smithy_http::operation::SerializationError> {
