...
pub fn serialize_structure_delete_scaling_policy_input(
...
pub fn serialize_structure_delete_scheduled_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deregister_scalable_target_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_scalable_targets_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_scaling_activities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_scaling_policies_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_scheduled_actions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_scaling_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_45) = &input.step_scaling_policy_configuration {
        ...
        crate::json_ser::serialize_structure_step_scaling_policy_configuration(
            &mut object_46,
            var_45,
        );
        object_46.finish();
    ...
    if let Some(var_47) = &input.target_tracking_scaling_policy_configuration {
        let mut object_48 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_target_tracking_scaling_policy_configuration(
            &mut object_48,
            var_47,
        );
        object_48.finish();
...
pub fn serialize_structure_put_scheduled_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_56) = &input.end_time {
        object
            .key("EndTime")
            .instant(var_56, smithy_types::instant::Format::EpochSeconds);
    }
    if let Some(var_57) = &input.scalable_target_action {
        let mut object_58 = object.key("ScalableTargetAction").start_object();
        crate::json_ser::serialize_structure_scalable_target_action(&mut object_58, var_57);
        object_58.finish();
    }
}

pub fn serialize_structure_register_scalable_target_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_65) = &input.suspended_state {
        ...
        crate::json_ser::serialize_structure_suspended_state(&mut object_66, var_65);
        object_66.finish();
    }
}

pub fn serialize_structure_step_scaling_policy_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_70 in var_68 {
            {
                ...
                crate::json_ser::serialize_structure_step_adjustment(&mut object_71, item_70);
                object_71.finish();
            }
        }
        array_69.finish();
...
pub fn serialize_structure_target_tracking_scaling_policy_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_75) = &input.target_value {
        object.key("TargetValue").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_75).into()),
        );
    }
    if let Some(var_76) = &input.predefined_metric_specification {
        ...
        crate::json_ser::serialize_structure_predefined_metric_specification(
            &mut object_77,
            var_76,
        );
        object_77.finish();
    ...
    if let Some(var_78) = &input.customized_metric_specification {
        ...
        crate::json_ser::serialize_structure_customized_metric_specification(
            &mut object_79,
            var_78,
        );
        object_79.finish();
...
pub fn serialize_structure_scalable_target_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_suspended_state(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_step_adjustment(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_predefined_metric_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_customized_metric_specification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_97 in var_95 {
            {
                ...
                crate::json_ser::serialize_structure_metric_dimension(&mut object_98, item_97);
                object_98.finish();
            }
        }
        array_96.finish();
