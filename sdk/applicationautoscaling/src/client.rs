...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_applicationautoscaling::Error> {
/// # let client: aws_sdk_applicationautoscaling::Client = unimplemented!();
...
mod deregister_scalable_target;

mod describe_scalable_targets;
