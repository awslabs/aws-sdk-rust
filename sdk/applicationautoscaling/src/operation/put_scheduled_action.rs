...
impl aws_smithy_http::response::ParseStrictResponse for PutScheduledAction {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_scheduled_action::de_put_scheduled_action_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_scheduled_action::de_put_scheduled_action_http_response(response)
                     }
                }
            }
