...
impl PutScheduledActionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_scheduled_action::ser_put_scheduled_action_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_scheduled_action::PutScheduledAction::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("PutScheduledAction", "applicationautoscaling"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutScheduledAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_scheduled_action::de_put_scheduled_action_http_response_with_props(status, headers, body)
        }
    }
}
