...
impl DescribeScalableTargetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_scalable_targets::DescribeScalableTargetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_scalable_targets::DescribeScalableTargetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_scalable_targets::DescribeScalableTargetsOutput, crate::operation::describe_scalable_targets::DescribeScalableTargetsError, Self> {
