...
impl DeregisterScalableTargetInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterScalableTarget`](crate::operation::deregister_scalable_target::DeregisterScalableTarget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_scalable_target::DeregisterScalableTarget, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_scalable_target::DeregisterScalableTargetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_scalable_target::DeregisterScalableTarget::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterScalableTarget {
                type Output = std::result::Result<crate::operation::deregister_scalable_target::DeregisterScalableTargetOutput, crate::operation::deregister_scalable_target::DeregisterScalableTargetError>;
