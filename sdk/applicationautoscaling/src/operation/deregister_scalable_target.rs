...
/// Orchestration and serialization glue logic for `DeregisterScalableTarget`.
...
impl DeregisterScalableTarget {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::deregister_scalable_target::DeregisterScalableTargetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_scalable_target::DeregisterScalableTargetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deregister_scalable_target::DeregisterScalableTargetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deregister_scalable_target::DeregisterScalableTargetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterScalableTarget {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeregisterScalableTarget");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeregisterScalableTargetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeregisterScalableTargetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterScalableTarget")
...
.with_interceptor(DeregisterScalableTargetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deregister_scalable_target::DeregisterScalableTargetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deregister_scalable_target::DeregisterScalableTargetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deregister_scalable_target::DeregisterScalableTargetError>::new());
...
#[derive(Debug)]
            struct DeregisterScalableTargetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterScalableTargetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_deregister_scalable_target::de_deregister_scalable_target_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_deregister_scalable_target::de_deregister_scalable_target_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeregisterScalableTargetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterScalableTargetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deregister_scalable_target::DeregisterScalableTargetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deregister_scalable_target::DeregisterScalableTargetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deregister_scalable_target::ser_deregister_scalable_target_input(&input)?);
...
#[derive(Debug)]
            struct DeregisterScalableTargetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterScalableTargetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeregisterScalableTargetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeregisterScalableTargetInput>()
                        .ok_or("failed to downcast to DeregisterScalableTargetInput")?;
...
pub enum DeregisterScalableTargetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeregisterScalableTargetError) for what information is available for the error.")]
...
impl DeregisterScalableTargetError {
    /// Creates the `DeregisterScalableTargetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeregisterScalableTargetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeregisterScalableTargetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deregister_scalable_target::DeregisterScalableTargetError {
...
mod _deregister_scalable_target_output;
