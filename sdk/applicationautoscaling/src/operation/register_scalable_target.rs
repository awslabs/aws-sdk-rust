...
impl RegisterScalableTargetInput {
    /// Consumes the builder and constructs an Operation<[`RegisterScalableTarget`](crate::operation::register_scalable_target::RegisterScalableTarget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_scalable_target::RegisterScalableTarget, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_scalable_target::RegisterScalableTargetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_scalable_target::RegisterScalableTarget::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterScalableTarget {
                type Output = std::result::Result<crate::operation::register_scalable_target::RegisterScalableTargetOutput, crate::operation::register_scalable_target::RegisterScalableTargetError>;
