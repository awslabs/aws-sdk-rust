...
impl DeleteScalingPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_scaling_policy::DeleteScalingPolicy::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("DeleteScalingPolicy", "applicationautoscaling"),
            );
