...
pub fn ser_delete_scaling_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteScalingPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
