...
pub fn ser_register_scalable_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterScalableTargetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
