...
pub(crate) fn de_scaling_activity<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ScalingActivity>, aws_smithy_json::deserialize::error::DeserializeError>
