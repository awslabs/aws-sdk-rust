...
) -> ::std::result::Result<Option<crate::types::ScalingActivity>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "StatusCode" => {
                            builder = builder.set_status_code(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ScalingActivityStatusCode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "StatusMessage" => {
                        ...
                        "NotScaledReasons" => {
                            builder = builder.set_not_scaled_reasons(crate::protocol_serde::shape_not_scaled_reasons::de_not_scaled_reasons(tokens)?);
                        }
            ...
            Ok(Some(crate::serde_util::scaling_activity_correct_errors(builder).build().map_err(
