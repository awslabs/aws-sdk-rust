...
pub fn ser_deregister_scalable_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeregisterScalableTargetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
