...
pub fn ser_delete_scheduled_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteScheduledActionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
