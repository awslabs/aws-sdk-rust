...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_scalable_target_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::deregister_scalable_target::DeregisterScalableTargetOutput, crate::operation::deregister_scalable_target::DeregisterScalableTargetError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_deregister_scalable_target_input(input: &crate::operation::deregister_scalable_target::DeregisterScalableTargetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_deregister_scalable_target_input::ser_deregister_scalable_target_input_input(&mut object, input)?;
    object.finish();
