...
pub fn ser_describe_scalable_targets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeScalableTargetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
