...
pub(crate) fn de_scaling_policy<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ScalingPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "StepScalingPolicyConfiguration" => {
                            builder = builder.set_step_scaling_policy_configuration(
                                crate::protocol_serde::shape_step_scaling_policy_configuration::de_step_scaling_policy_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "Alarms" => {
                            builder = builder.set_alarms(crate::protocol_serde::shape_alarms::de_alarms(tokens, _value, depth + 1)?);
                        }
                        "CreationTime" => {
