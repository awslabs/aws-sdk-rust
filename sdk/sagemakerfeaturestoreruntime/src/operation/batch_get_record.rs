...
impl BatchGetRecordInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_get_record::BatchGetRecord, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_record::ser_batch_get_record_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_record::BatchGetRecord::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("BatchGetRecord", "sagemakerfeaturestoreruntime"),
        );
