    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_get_record::BatchGetRecordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_get_record::BatchGetRecordOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetRecord {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchGetRecordRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchGetRecordResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchGetRecord")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetRecordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_get_record::de_batch_get_record_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_get_record::de_batch_get_record_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetRecordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_get_record::BatchGetRecordInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_get_record::BatchGetRecordInput,
