...
impl DeleteRecord {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_record::DeleteRecordError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_record::DeleteRecordOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "SageMaker FeatureStore Runtime",
            "rpc.method" = "DeleteRecord",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRecord {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteRecordRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteRecordResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRecord")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteRecordTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteRecordTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRecordTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteRecordInput>() else {
        ...
        if requested.should_capture("RecordIdentifierValueAsString") {
            if let ::std::option::Option::Some(value) = input.record_identifier_value_as_string.as_deref() {
                captured.insert("RecordIdentifierValueAsString", value);
            }
        }
        if requested.should_capture("EventTime") {
            if let ::std::option::Option::Some(value) = input.event_time.as_deref() {
                captured.insert("EventTime", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRecordResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_record::de_delete_record_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_record::de_delete_record_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRecordRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_record::DeleteRecordInput>()
            .expect("correct type");
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteRecordError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AccessForbidden(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
