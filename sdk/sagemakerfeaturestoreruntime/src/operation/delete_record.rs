...
impl DeleteRecordInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_record::DeleteRecord, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_record::DeleteRecord::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DeleteRecord", "sagemakerfeaturestoreruntime"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRecord {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_record::de_delete_record_http_response_with_props(status, headers, body)
        }
    }
}
