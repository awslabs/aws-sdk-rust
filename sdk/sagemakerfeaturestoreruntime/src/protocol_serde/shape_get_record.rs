...
pub fn de_get_record_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_record::GetRecordOutput, crate::operation::get_record::GetRecordError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_record::GetRecordError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_record_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_record::GetRecordOutput, crate::operation::get_record::GetRecordError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_record::builders::GetRecordOutputBuilder::default();
        output = crate::protocol_serde::shape_get_record::de_get_record(_response_body, output).map_err(crate::operation::get_record::GetRecordError::unhandled)?;
