...
pub fn de_get_record_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_record::GetRecordOutput, crate::operation::get_record::GetRecordError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_record_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_record::GetRecordOutput, crate::operation::get_record::GetRecordError> {
    Ok({
        #[allow(unused_mut)]
