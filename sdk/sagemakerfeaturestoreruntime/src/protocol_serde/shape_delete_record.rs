...
pub fn de_delete_record_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_record::DeleteRecordOutput, crate::operation::delete_record::DeleteRecordError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_record_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_record::DeleteRecordOutput, crate::operation::delete_record::DeleteRecordError> {
    Ok({
        #[allow(unused_mut)]
