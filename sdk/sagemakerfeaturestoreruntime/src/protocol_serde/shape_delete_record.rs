...
pub fn de_delete_record_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_record::DeleteRecordOutput, crate::operation::delete_record::DeleteRecordError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_record::DeleteRecordError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_record_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_record::DeleteRecordOutput, crate::operation::delete_record::DeleteRecordError> {
    Ok({
        #[allow(unused_mut)]
