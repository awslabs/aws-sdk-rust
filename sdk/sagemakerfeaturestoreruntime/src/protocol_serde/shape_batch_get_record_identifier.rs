                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RecordIdentifiersValueAsString" => {
                            builder = builder.set_record_identifiers_value_as_string(
                                crate::protocol_serde::shape_record_identifiers::de_record_identifiers(tokens, _value, depth + 1)?,
                            );
                        }
                        "FeatureNames" => {
                            builder =
                                builder.set_feature_names(crate::protocol_serde::shape_feature_names::de_feature_names(tokens, _value, depth + 1)?);
                        }
