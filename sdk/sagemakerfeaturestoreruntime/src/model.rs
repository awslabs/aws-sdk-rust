...
pub struct FeatureValue  {
    ...
    #[doc(hidden)]pub value_as_string: std::option::Option<std::string::String>,
}
impl FeatureValue {
    /// <p>The name of a feature that a feature value corresponds to.</p>
...
pub struct BatchGetRecordIdentifier  {
    ...
    #[doc(hidden)]pub record_identifiers_value_as_string: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for BatchGetRecordIdentifier  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("record_identifiers_value_as_string", &self.record_identifiers_value_as_string);
