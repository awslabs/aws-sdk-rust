...
pub fn serialize_structure_batch_get_record_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_batch_get_record_identifier(
                    &mut object_4,
                    item_3,
                );
                object_4.finish();
        ...
        for item_7 in var_5 {
            {
                ...
                crate::json_ser::serialize_structure_feature_value(&mut object_8, item_7);
                object_8.finish();
            }
        }
        array_6.finish();
...
pub fn serialize_structure_batch_get_record_identifier(
    object: &mut smithy_json::serialize::JsonObjectWriter,
