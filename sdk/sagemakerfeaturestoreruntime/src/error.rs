...
impl std::fmt::Display for PutRecordError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutRecordErrorKind::AccessForbidden(_inner) =>
            _inner.fmt(f)
            ,
            PutRecordErrorKind::InternalFailure(_inner) =>
            _inner.fmt(f)
            ,
            PutRecordErrorKind::ServiceUnavailable(_inner) =>
            _inner.fmt(f)
            ,
            PutRecordErrorKind::ValidationError(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for GetRecordError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetRecordErrorKind::AccessForbidden(_inner) =>
            _inner.fmt(f)
            ,
            GetRecordErrorKind::InternalFailure(_inner) =>
            _inner.fmt(f)
            ,
            GetRecordErrorKind::ResourceNotFound(_inner) =>
            _inner.fmt(f)
            ,
            GetRecordErrorKind::ServiceUnavailable(_inner) =>
            _inner.fmt(f)
            ,
            GetRecordErrorKind::ValidationError(_inner) =>
            _inner.fmt(f)
            ,
            GetRecordErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteRecordError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteRecordErrorKind::AccessForbidden(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRecordErrorKind::InternalFailure(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRecordErrorKind::ServiceUnavailable(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRecordErrorKind::ValidationError(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRecordErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for BatchGetRecordError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            BatchGetRecordErrorKind::AccessForbidden(_inner) =>
            _inner.fmt(f)
            ,
            BatchGetRecordErrorKind::InternalFailure(_inner) =>
            _inner.fmt(f)
            ,
            BatchGetRecordErrorKind::ServiceUnavailable(_inner) =>
            _inner.fmt(f)
            ,
            BatchGetRecordErrorKind::ValidationError(_inner) =>
            _inner.fmt(f)
            ,
            BatchGetRecordErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
