...
pub fn parse_batch_get_record_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::BatchGetRecordOutput, crate::error::BatchGetRecordError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::BatchGetRecordError::unhandled)?;
...
pub fn parse_delete_record_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteRecordOutput, crate::error::DeleteRecordError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::DeleteRecordError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_get_record_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRecordOutput, crate::error::GetRecordError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetRecordError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                            ...
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "AccessForbidden" => crate::error::GetRecordError::AccessForbidden({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalFailure" => crate::error::GetRecordError::InternalFailure({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationError" => crate::error::GetRecordError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
pub fn parse_put_record_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutRecordOutput, crate::error::PutRecordError> {
    ...
    let error_code = match generic.code() {
                            ...
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "AccessForbidden" => crate::error::PutRecordError::AccessForbidden({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalFailure" => crate::error::PutRecordError::InternalFailure({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationError" => crate::error::PutRecordError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
