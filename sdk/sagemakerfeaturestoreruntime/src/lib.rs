...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("sagemakerfeaturestoreruntime", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon SageMaker Feature Store Runtime.
pub mod client;
