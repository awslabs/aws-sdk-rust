...
pub struct BatchGetRecordOutput  {
    ...
    #[doc(hidden)]pub records: std::option::Option<std::vec::Vec<crate::model::BatchGetRecordResultDetail>>,
    /// <p>A list of errors that have occured when retrieving a batch of Records.</p>
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::BatchGetRecordError>>,
    ...
    #[doc(hidden)]pub unprocessed_identifiers: std::option::Option<std::vec::Vec<crate::model::BatchGetRecordIdentifier>>,
}
