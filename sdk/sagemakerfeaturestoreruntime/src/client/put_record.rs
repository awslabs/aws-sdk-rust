...
impl super::Client {
    ...
    ///   - [`feature_group_name(impl Into<String>)`](crate::operation::put_record::builders::PutRecordFluentBuilder::feature_group_name) / [`set_feature_group_name(Option<String>)`](crate::operation::put_record::builders::PutRecordFluentBuilder::set_feature_group_name): <p>The name or Amazon Resource Name (ARN) of the feature group that you want to insert the record into.</p>
    ///   - [`record(FeatureValue)`](crate::operation::put_record::builders::PutRecordFluentBuilder::record) / [`set_record(Option<Vec<FeatureValue>>)`](crate::operation::put_record::builders::PutRecordFluentBuilder::set_record): <p>List of FeatureValues to be inserted. This will be a full over-write. If you only want to update few of the feature values, do the following:</p>  <ul>   <li> <p>Use <code>GetRecord</code> to retrieve the latest record.</p> </li>   <li> <p>Update the record returned from <code>GetRecord</code>. </p> </li>   <li> <p>Use <code>PutRecord</code> to update feature values.</p> </li>  </ul>
