...
impl super::Client {
    ...
    ///   - [`feature_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_record::builders::PutRecordFluentBuilder::feature_group_name) / [`set_feature_group_name(Option<String>)`](crate::operation::put_record::builders::PutRecordFluentBuilder::set_feature_group_name): <p>The name of the feature group that you want to insert the record into.</p>
