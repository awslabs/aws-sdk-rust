...
impl super::Client {
    ...
    ///   - [`feature_group_name(impl Into<String>)`](crate::operation::delete_record::builders::DeleteRecordFluentBuilder::feature_group_name) / [`set_feature_group_name(Option<String>)`](crate::operation::delete_record::builders::DeleteRecordFluentBuilder::set_feature_group_name): <p>The name or Amazon Resource Name (ARN) of the feature group to delete the record from. </p>
