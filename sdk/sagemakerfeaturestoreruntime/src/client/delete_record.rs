...
impl super::Client {
    ...
    ///   - [`feature_group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_record::builders::DeleteRecordFluentBuilder::feature_group_name) / [`set_feature_group_name(Option<String>)`](crate::operation::delete_record::builders::DeleteRecordFluentBuilder::set_feature_group_name): <p>The name of the feature group to delete the record from. </p>
