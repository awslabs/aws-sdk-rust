...
impl super::Client {
    ...
    ///   - [`identifiers(Vec<BatchGetRecordIdentifier>)`](crate::operation::batch_get_record::builders::BatchGetRecordFluentBuilder::identifiers) / [`set_identifiers(Option<Vec<BatchGetRecordIdentifier>>)`](crate::operation::batch_get_record::builders::BatchGetRecordFluentBuilder::set_identifiers): <p>A list containing the name or Amazon Resource Name (ARN) of the <code>FeatureGroup</code>, the list of names of <code>Feature</code>s to be retrieved, and the corresponding <code>RecordIdentifier</code> values as strings.</p>
    ///   - [`expiration_time_response(ExpirationTimeResponse)`](crate::operation::batch_get_record::builders::BatchGetRecordFluentBuilder::expiration_time_response) / [`set_expiration_time_response(Option<ExpirationTimeResponse>)`](crate::operation::batch_get_record::builders::BatchGetRecordFluentBuilder::set_expiration_time_response): <p>Parameter to request <code>ExpiresAt</code> in response. If <code>Enabled</code>, <code>BatchGetRecord</code> will return the value of <code>ExpiresAt</code>, if it is not null. If <code>Disabled</code> and null, <code>BatchGetRecord</code> will return null.</p>
