...
mod test {
    ...
    fn test_3() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://featurestore-runtime.sagemaker.us-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_7() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://featurestore-runtime.sagemaker.us-gov-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
