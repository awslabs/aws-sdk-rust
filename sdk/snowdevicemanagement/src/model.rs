...
pub struct InstanceSummary  {
    ...
    #[doc(hidden)]pub instance: std::option::Option<crate::model::Instance>,
...
pub struct Instance  {
    ...
    #[doc(hidden)]pub ami_launch_index: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::InstanceState>,
    ...
    #[doc(hidden)]pub public_ip_address: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub security_groups: std::option::Option<std::vec::Vec<crate::model::SecurityGroupIdentifier>>,
    /// <p>The CPU options for the instance.</p>
    #[doc(hidden)]pub cpu_options: std::option::Option<crate::model::CpuOptions>,
    /// <p>The device name of the root device volume (for example, <code>/dev/sda1</code>). </p>
    #[doc(hidden)]pub root_device_name: std::option::Option<std::string::String>,
}
impl Instance {
    /// <p>The ID of the AMI used to launch the instance.</p>
...
pub mod instance {
    ...
    pub struct Builder {
        ...
        pub(crate) security_groups: std::option::Option<std::vec::Vec<crate::model::SecurityGroupIdentifier>>,
    ...
    impl Builder {
        ...
        /// <p>The security groups for the instance.</p>
        pub fn set_security_groups(mut self, input: std::option::Option<std::vec::Vec<crate::model::SecurityGroupIdentifier>>) -> Self {
...
pub struct CpuOptions  {
    ...
    #[doc(hidden)]pub core_count: std::option::Option<i32>,
    /// <p>The number of threads per core in the CPU.</p>
    #[doc(hidden)]pub threads_per_core: std::option::Option<i32>,
}
impl CpuOptions {
    /// <p>The number of cores that the CPU can use.</p>
...
pub struct InstanceBlockDeviceMapping  {
    ...
    #[doc(hidden)]pub ebs: std::option::Option<crate::model::EbsInstanceBlockDevice>,
}
...
pub struct EbsInstanceBlockDevice  {
    ...
    #[doc(hidden)]pub attach_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::AttachmentStatus>,
...
pub struct InstanceState  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::InstanceStateName>,
}
impl InstanceState {
    /// <p>The state of the instance as a 16-bit unsigned integer. </p> 
    /// <p>The high byte is all of the bits between 2^8 and (2^16)-1, which equals decimal values between 256 and 65,535. These numerical values are used for internal purposes and should be ignored. </p> 
...
pub struct DeviceSummary  {
    ...
    #[doc(hidden)]pub managed_device_arn: std::option::Option<std::string::String>,
    /// <p>The ID of the job used to order the device.</p>
    #[doc(hidden)]pub associated_with_job: std::option::Option<std::string::String>,
    /// <p>Optional metadata that you assign to a resource. You can use tags to categorize a resource in different ways, such as by purpose, owner, or environment.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl DeviceSummary {
...
pub struct SoftwareInformation  {
    ...
    #[doc(hidden)]pub installed_version: std::option::Option<std::string::String>,
    /// <p>The version of the software being installed on the device.</p>
    #[doc(hidden)]pub installing_version: std::option::Option<std::string::String>,
    /// <p>The state of the software that is installed or that is being installed on the device.</p>
    #[doc(hidden)]pub install_state: std::option::Option<std::string::String>,
}
...
pub struct Capacity  {
    ...
    #[doc(hidden)]pub total: std::option::Option<i64>,
    /// <p>The amount of capacity used on the device.</p>
    #[doc(hidden)]pub used: std::option::Option<i64>,
    /// <p>The amount of capacity available for use on the device.</p>
    #[doc(hidden)]pub available: std::option::Option<i64>,
}
impl Capacity {
    /// <p>The name of the type of capacity, such as memory.</p>
...
pub struct PhysicalNetworkInterface  {
    ...
    #[doc(hidden)]pub physical_network_interface_id: std::option::Option<std::string::String>,
    /// <p>The physical connector type.</p>
    #[doc(hidden)]pub physical_connector_type: std::option::Option<crate::model::PhysicalConnectorType>,
    /// <p>A value that describes whether the IP address is dynamic or persistent.</p>
    #[doc(hidden)]pub ip_address_assignment: std::option::Option<crate::model::IpAddressAssignment>,
    ...
    #[doc(hidden)]pub netmask: std::option::Option<std::string::String>,
    /// <p>The default gateway of the device.</p>
    #[doc(hidden)]pub default_gateway: std::option::Option<std::string::String>,
...
impl PhysicalNetworkInterface {
    ...
    /// <p>The physical connector type.</p>
    pub fn physical_connector_type(&self) -> std::option::Option<& crate::model::PhysicalConnectorType> {
...
impl  std::fmt::Debug for PhysicalNetworkInterface  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("physical_network_interface_id", &self.physical_network_interface_id);
...
pub mod physical_network_interface {
    ...
    pub struct Builder {
        ...
        pub(crate) physical_connector_type: std::option::Option<crate::model::PhysicalConnectorType>,
    ...
    impl Builder {
        ...
        /// <p>The physical connector type.</p>
        pub fn physical_connector_type(mut self, input: crate::model::PhysicalConnectorType) -> Self {
            self.physical_connector_type = Some(input);
            self
        }
        /// <p>The physical connector type.</p>
        pub fn set_physical_connector_type(mut self, input: std::option::Option<crate::model::PhysicalConnectorType>) -> Self {
        ...
        /// <p>A value that describes whether the IP address is dynamic or persistent.</p>
        pub fn set_ip_address_assignment(mut self, input: std::option::Option<crate::model::IpAddressAssignment>) -> Self {
