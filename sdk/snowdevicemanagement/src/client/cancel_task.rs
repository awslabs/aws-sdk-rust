...
impl super::Client {
    ...
    ///   - [`task_id(impl Into<String>)`](crate::operation::cancel_task::builders::CancelTaskFluentBuilder::task_id) / [`set_task_id(Option<String>)`](crate::operation::cancel_task::builders::CancelTaskFluentBuilder::set_task_id):<br>required: **true**<br><p>The ID of the task that you are attempting to cancel. You can retrieve a task ID by using the <code>ListTasks</code> operation.</p><br>
