...
impl super::Client {
    ...
    ///   - [`managed_device_id(impl Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::managed_device_id) / [`set_managed_device_id(impl Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_managed_device_id):<br>required: **true**<br><p>The ID of the device that you are checking the information of.</p><br>
