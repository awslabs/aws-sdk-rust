...
impl super::Client {
    ...
    ///   - [`managed_device_id(impl Into<String>)`](crate::operation::list_device_resources::builders::ListDeviceResourcesFluentBuilder::managed_device_id) / [`set_managed_device_id(impl Into<String>)`](crate::operation::list_device_resources::builders::ListDeviceResourcesFluentBuilder::set_managed_device_id):<br>required: **true**<br><p>The ID of the managed device that you are listing the resources of.</p><br>
