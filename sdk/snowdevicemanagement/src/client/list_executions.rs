...
impl super::Client {
    ...
    ///   - [`task_id(impl ::std::convert::Into<String>)`](crate::operation::list_executions::builders::ListExecutionsFluentBuilder::task_id) / [`set_task_id(Option<String>)`](crate::operation::list_executions::builders::ListExecutionsFluentBuilder::set_task_id): <p>The ID of the task.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_executions::builders::ListExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_executions::builders::ListExecutionsFluentBuilder::set_next_token): <p>A pagination token to continue to the next page of tasks.</p>
