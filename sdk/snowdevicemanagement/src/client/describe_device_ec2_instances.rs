...
impl super::Client {
    ...
    ///   - [`managed_device_id(impl Into<String>)`](crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesFluentBuilder::managed_device_id) / [`set_managed_device_id(impl Into<String>)`](crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesFluentBuilder::set_managed_device_id):<br>required: **true**<br><p>The ID of the managed device.</p><br>
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesFluentBuilder::instance_ids) / [`set_instance_ids(Vec<String>)`](crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesFluentBuilder::set_instance_ids):<br>required: **true**<br><p>A list of instance IDs associated with the managed device.</p><br>
