...
impl Builder {
    ...
    /// use aws_sdk_snowdevicemanagement::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_snowdevicemanagement::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
