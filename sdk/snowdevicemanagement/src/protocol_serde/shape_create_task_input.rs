...
pub fn ser_create_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
