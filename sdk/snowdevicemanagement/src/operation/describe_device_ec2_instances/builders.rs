...
impl DescribeDeviceEc2InstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_device_ec2_instances::DescribeDeviceEc2InstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_device_ec2_instances::DescribeDeviceEc2InstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_device_ec2_instances::DescribeDeviceEc2InstancesOutput, crate::operation::describe_device_ec2_instances::DescribeDeviceEc2InstancesError, Self> {
