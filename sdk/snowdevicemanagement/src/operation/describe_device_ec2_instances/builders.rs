...
impl crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesInputBuilder {
...
impl DescribeDeviceEc2InstancesFluentBuilder {
    /// Creates a new `DescribeDeviceEc2InstancesFluentBuilder`.
