...
impl ListDevices {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("snowdevicemanagement", "ListDevices", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDevices {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListDevices", "snowdevicemanagement"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/managed-devices").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_devices::ListDevicesInput,
                ...
                if let ::std::option::Option::Some(inner_1) = &_input.job_id {
                    {
                        query.push_kv("jobId", &::aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
