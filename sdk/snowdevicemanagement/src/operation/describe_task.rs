...
impl DescribeTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_task::DescribeTask,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/task/{taskId}", taskId = task_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_task::DescribeTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_task::de_describe_task_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_task::de_describe_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
