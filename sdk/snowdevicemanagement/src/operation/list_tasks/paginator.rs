...
impl ListTasksPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::TaskSummary, ::aws_smithy_http::result::SdkError<crate::operation::list_tasks::ListTasksError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_tasks_output_tasks(page).unwrap_or_default().into_iter())
    }
}
