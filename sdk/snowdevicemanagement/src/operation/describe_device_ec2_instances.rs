...
impl DescribeDeviceEc2InstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_device_ec2_instances::DescribeDeviceEc2Instances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDeviceEc2Instances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_device_ec2_instances::de_describe_device_ec2_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
