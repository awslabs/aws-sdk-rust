...
impl<C, M, R> ListDeviceResourcesPaginator<C, M, R>
where
    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    pub fn items(self) -> crate::paginator::ListDeviceResourcesPaginatorItems<C, M, R> {
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_token = crate::lens::reflens_structure_crate_output_list_device_resources_output_next_token(resp).cloned();
...
pub struct ListDeviceResourcesPaginatorItems<
    C = aws_smithy_client::erase::DynConnector,
    M = crate::middleware::DefaultMiddleware,
    R = aws_smithy_client::retry::Standard,
>(ListDeviceResourcesPaginator<C, M, R>);

impl<C, M, R> ListDeviceResourcesPaginatorItems<C, M, R>
where
    C: aws_smithy_client::bounds::SmithyConnector,
    M: aws_smithy_client::bounds::SmithyMiddleware<C>,
    R: aws_smithy_client::retry::NewRequestPolicy,
