...
/// Paginator for [`ListDeviceResources`](crate::operation::ListDeviceResources)
            ...
            impl ListDeviceResourcesPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_device_resources_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListDeviceResourcesOutput, aws_smithy_http::result::SdkError<crate::error::ListDeviceResourcesError>>> + Unpin
                 {
...
/// Flattened paginator for `ListDeviceResourcesPaginator`
                ...
                impl  ListDeviceResourcesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ResourceSummary, aws_smithy_http::result::SdkError<crate::error::ListDeviceResourcesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_device_resources_output_resources(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListDevicesPaginator`
                ...
                impl  ListDevicesPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::DeviceSummary, aws_smithy_http::result::SdkError<crate::error::ListDevicesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_devices_output_devices(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListExecutionsPaginator`
                ...
                impl  ListExecutionsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::ExecutionSummary, aws_smithy_http::result::SdkError<crate::error::ListExecutionsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListTasksPaginator`
                ...
                impl  ListTasksPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::TaskSummary, aws_smithy_http::result::SdkError<crate::error::ListTasksError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_tasks_output_tasks(page).unwrap_or_default().into_iter())
                    }
                }
