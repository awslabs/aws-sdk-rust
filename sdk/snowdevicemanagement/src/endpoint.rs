...
mod test {
    ...
    fn test_1() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-south-1.api.aws",
        );
        assert_eq!(
            endpoint,
    ...
    fn test_2() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-south-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_3() {
        ...
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.ap-south-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_4() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-south-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_5() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-south-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_6() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-south-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_7() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.eu-south-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_8() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.eu-south-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_9() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-gov-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_11() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-gov-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_12() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-gov-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_13() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ca-central-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_15() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.ca-central-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_16() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ca-central-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_17() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-central-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_19() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.eu-central-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_20() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.eu-central-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_21() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-west-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_22() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_23() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.us-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_24() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_25() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-west-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_26() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_27() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.us-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_28() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_29() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.af-south-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_30() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.af-south-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_31() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.af-south-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_32() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.af-south-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_33() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-north-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_34() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-north-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_35() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.eu-north-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_36() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.eu-north-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_37() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-west-3.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_38() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-west-3.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_39() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.eu-west-3.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_40() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.eu-west-3.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_41() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-west-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_42() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_43() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.eu-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_44() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.eu-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_45() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-west-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_46() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.eu-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_47() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.eu-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_48() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.eu-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_49() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-northeast-3.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_51() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-northeast-3.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_52() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-northeast-3.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_53() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-northeast-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_55() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-northeast-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_56() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-northeast-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_57() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-northeast-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_59() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-northeast-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_60() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-northeast-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_61() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.sa-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_62() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.sa-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_63() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.sa-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_64() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.sa-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_65() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_66() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_67() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.ap-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_68() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_72() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.cn-north-1.amazonaws.com.cn",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_73() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-gov-west-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_75() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-gov-west-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_76() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-gov-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_77() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-southeast-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_79() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-southeast-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_80() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-southeast-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_81() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.ap-southeast-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_83() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-southeast-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_84() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.ap-southeast-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_85() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_86() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_87() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_88() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_89() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-east-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_90() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management-fips.us-east-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_91() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://snow-device-management.us-east-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_92() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://snow-device-management.us-east-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
