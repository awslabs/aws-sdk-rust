...
pub struct DescribeDeviceOutput {
    ...
    /// online.</p>
    pub last_reached_out_at: std::option::Option<smithy_types::Instant>,
...
pub mod describe_device_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug)]
    pub struct Builder {
        pub(crate) last_reached_out_at: std::option::Option<smithy_types::Instant>,
        pub(crate) last_updated_at: std::option::Option<smithy_types::Instant>,
        pub(crate) tags: std::option::Option<
            std::collections::HashMap<std::string::String, std::string::String>,
        >,
    ...
    impl Builder {
        /// <p>When the device last contacted the Amazon Web Services Cloud. Indicates that the device is
        /// online.</p>
        pub fn last_reached_out_at(mut self, input: smithy_types::Instant) -> Self {
