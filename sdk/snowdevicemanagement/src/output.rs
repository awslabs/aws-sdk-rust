...
pub struct ListTasksOutput  {
    ...
    #[doc(hidden)]pub tasks: std::option::Option<std::vec::Vec<crate::model::TaskSummary>>,
...
pub struct ListExecutionsOutput  {
    ...
    #[doc(hidden)]pub executions: std::option::Option<std::vec::Vec<crate::model::ExecutionSummary>>,
...
pub struct ListDeviceResourcesOutput  {
    ...
    #[doc(hidden)]pub resources: std::option::Option<std::vec::Vec<crate::model::ResourceSummary>>,
...
pub struct DescribeDeviceEc2InstancesOutput  {
    ...
    #[doc(hidden)]pub instances: std::option::Option<std::vec::Vec<crate::model::InstanceSummary>>,
}
...
pub struct DescribeDeviceOutput  {
    ...
    #[doc(hidden)]pub last_reached_out_at: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub device_state: std::option::Option<crate::model::UnlockState>,
    /// <p>The network interfaces available on the device.</p>
    #[doc(hidden)]pub physical_network_interfaces: std::option::Option<std::vec::Vec<crate::model::PhysicalNetworkInterface>>,
    /// <p>The hardware specifications of the device. </p>
    #[doc(hidden)]pub device_capacities: std::option::Option<std::vec::Vec<crate::model::Capacity>>,
    /// <p>The software installed on the device.</p>
    #[doc(hidden)]pub software: std::option::Option<crate::model::SoftwareInformation>,
}
...
impl  std::fmt::Debug for DescribeDeviceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("physical_network_interfaces", &self.physical_network_interfaces);
