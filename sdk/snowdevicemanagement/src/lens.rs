...
pub(crate) fn reflens_structure_crate_output_list_device_resources_output_next_token(
    input: &crate::output::ListDeviceResourcesOutput,
...
pub(crate) fn lens_structure_crate_output_list_device_resources_output_resources(
    input: crate::output::ListDeviceResourcesOutput,
) -> std::option::Option<std::vec::Vec<crate::model::ResourceSummary>> {
...
pub(crate) fn lens_structure_crate_output_list_executions_output_executions(
    input: crate::output::ListExecutionsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::ExecutionSummary>> {
...
pub(crate) fn lens_structure_crate_output_list_tasks_output_tasks(
    input: crate::output::ListTasksOutput,
) -> std::option::Option<std::vec::Vec<crate::model::TaskSummary>> {
