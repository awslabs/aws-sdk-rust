...
pub fn de_get_fleet_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_fleet::GetFleetOutput, crate::operation::get_fleet::GetFleetError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_fleet::GetFleetError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_fleet::GetFleetError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerErrorException" => crate::operation::get_fleet::GetFleetError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_error_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::get_fleet::GetFleetError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
        ...
        "ResourceNotFoundException" => crate::operation::get_fleet::GetFleetError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::get_fleet::GetFleetError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_fleet::GetFleetError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::get_fleet::GetFleetError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_fleet_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_fleet::GetFleetOutput, crate::operation::get_fleet::GetFleetError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_fleet::builders::GetFleetOutputBuilder::default();
...
) -> Result<crate::operation::get_fleet::builders::GetFleetOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "autoScalingStatus" => {
                    builder = builder.set_auto_scaling_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::AutoScalingStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "capabilities" => {
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::FleetStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "targetWorkerCount" => {
