...
pub fn de_list_jobs_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_jobs::ListJobsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerErrorException" => crate::operation::list_jobs::ListJobsError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_error_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_jobs::ListJobsError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "jobs" => {
                    builder = builder.set_jobs(crate::protocol_serde::shape_job_summaries::de_job_summaries(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
