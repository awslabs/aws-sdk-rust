...
pub fn de_get_session_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => crate::operation::get_session::GetSessionError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "lifecycleStatus" => {
                    builder = builder.set_lifecycle_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::SessionLifecycleStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "log" => {
                ...
                "workerLog" => {
                    builder = builder.set_worker_log(crate::protocol_serde::shape_log_configuration::de_log_configuration(tokens, _value)?);
                }
