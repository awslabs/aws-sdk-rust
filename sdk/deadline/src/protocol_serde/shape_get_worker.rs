...
pub fn de_get_worker_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => crate::operation::get_worker::GetWorkerError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_error_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::get_worker::GetWorkerError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
