...
pub fn de_create_queue_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => crate::operation::create_queue::CreateQueueError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_error_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::create_queue::CreateQueueError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
...
pub fn de_create_queue_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_queue_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_queue::CreateQueueError::unhandled)?
    })
}

pub fn ser_create_queue_headers(
