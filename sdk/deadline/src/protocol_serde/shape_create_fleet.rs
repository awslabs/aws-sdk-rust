...
pub fn de_create_fleet_http_error(
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_error_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::create_fleet::CreateFleetError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
        ...
        "ServiceQuotaExceededException" => crate::operation::create_fleet::CreateFleetError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_create_fleet_headers(
