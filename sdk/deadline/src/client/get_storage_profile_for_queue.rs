...
impl super::Client {
    ...
    ///   - [`display_name(String)`](crate::operation::get_storage_profile_for_queue::GetStorageProfileForQueueOutput::display_name): <p>The display name of the storage profile connected to a queue.</p>
