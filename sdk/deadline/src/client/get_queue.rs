...
impl super::Client {
    ...
    ///   - [`display_name(String)`](crate::operation::get_queue::GetQueueOutput::display_name): <p>The display name of the queue.</p>
    ///   - [`description(Option<String>)`](crate::operation::get_queue::GetQueueOutput::description): <p>The description of the queue.</p>
