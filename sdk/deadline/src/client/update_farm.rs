...
impl super::Client {
    ...
    ///   - [`cost_scale_factor(f32)`](crate::operation::update_farm::builders::UpdateFarmFluentBuilder::cost_scale_factor) / [`set_cost_scale_factor(Option<f32>)`](crate::operation::update_farm::builders::UpdateFarmFluentBuilder::set_cost_scale_factor):<br>required: **false**<br><p>The cost scale factor of the farm to update.</p><br>
