...
impl super::Client {
    ...
    ///   - [`identity_center_region(Option<String>)`](crate::operation::get_monitor::GetMonitorOutput::identity_center_region): <p>The Region where IAM Identity Center is enabled.</p>
