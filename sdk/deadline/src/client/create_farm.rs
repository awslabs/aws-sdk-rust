...
impl super::Client {
    ...
    ///   - [`cost_scale_factor(f32)`](crate::operation::create_farm::builders::CreateFarmFluentBuilder::cost_scale_factor) / [`set_cost_scale_factor(Option<f32>)`](crate::operation::create_farm::builders::CreateFarmFluentBuilder::set_cost_scale_factor):<br>required: **false**<br><p>The cost scale factor to apply on the farm.</p><br>
