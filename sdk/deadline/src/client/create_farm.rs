...
impl super::Client {
    ...
    ///   - [`display_name(impl Into<String>)`](crate::operation::create_farm::builders::CreateFarmFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::create_farm::builders::CreateFarmFluentBuilder::set_display_name):<br>required: **true**<br><p>The display name of the farm.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::create_farm::builders::CreateFarmFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_farm::builders::CreateFarmFluentBuilder::set_description):<br>required: **false**<br><p>The description of the farm.</p><br>
