...
impl super::Client {
    ...
    ///   - [`display_name(impl Into<String>)`](crate::operation::update_fleet::builders::UpdateFleetFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_fleet::builders::UpdateFleetFluentBuilder::set_display_name):<br>required: **false**<br><p>The display name of the fleet to update.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_fleet::builders::UpdateFleetFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_fleet::builders::UpdateFleetFluentBuilder::set_description):<br>required: **false**<br><p>The description of the fleet to update.</p><br>
