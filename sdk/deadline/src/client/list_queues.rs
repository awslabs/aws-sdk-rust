...
impl super::Client {
    ...
    ///   - [`principal_id(impl Into<String>)`](crate::operation::list_queues::builders::ListQueuesFluentBuilder::principal_id) / [`set_principal_id(Option<String>)`](crate::operation::list_queues::builders::ListQueuesFluentBuilder::set_principal_id):<br>required: **false**<br><p>The principal ID. This filter is only valid when using Nimble Studio credentials and should match the user ID in the credentials of the caller.</p><br>
