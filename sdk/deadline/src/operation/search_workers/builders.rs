...
pub use crate::operation::search_workers::_search_workers_input::SearchWorkersInputBuilder;

pub use crate::operation::search_workers::_search_workers_output::SearchWorkersOutputBuilder;

impl crate::operation::search_workers::builders::SearchWorkersInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.search_workers();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `SearchWorkers`.
///
/// <p>Searches for workers.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct SearchWorkersFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::search_workers::builders::SearchWorkersInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::search_workers::SearchWorkersOutput,
        crate::operation::search_workers::SearchWorkersError,
    > for SearchWorkersFluentBuilder
{
    fn send(
        self,
...
impl SearchWorkersFluentBuilder {
    /// Creates a new `SearchWorkersFluentBuilder`.
    ...
    /// Access the SearchWorkers as a reference.
    pub fn as_input(&self) -> &crate::operation::search_workers::builders::SearchWorkersInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::search_workers::SearchWorkers::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::search_workers::SearchWorkers::orchestrate(&runtime_plugins, input).await
    }
