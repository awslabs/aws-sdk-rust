...
pub use crate::operation::update_queue_environment::_update_queue_environment_output::UpdateQueueEnvironmentOutputBuilder;

pub use crate::operation::update_queue_environment::_update_queue_environment_input::UpdateQueueEnvironmentInputBuilder;

impl crate::operation::update_queue_environment::builders::UpdateQueueEnvironmentInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::update_queue_environment::UpdateQueueEnvironmentError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.update_queue_environment();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `UpdateQueueEnvironment`.
///
/// <p>Updates the queue environment.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct UpdateQueueEnvironmentFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::update_queue_environment::builders::UpdateQueueEnvironmentInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::update_queue_environment::UpdateQueueEnvironmentOutput,
        crate::operation::update_queue_environment::UpdateQueueEnvironmentError,
    > for UpdateQueueEnvironmentFluentBuilder
{
    fn send(
        self,
...
impl UpdateQueueEnvironmentFluentBuilder {
    /// Creates a new `UpdateQueueEnvironmentFluentBuilder`.
    ...
    /// Access the UpdateQueueEnvironment as a reference.
    pub fn as_input(&self) -> &crate::operation::update_queue_environment::builders::UpdateQueueEnvironmentInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_queue_environment::UpdateQueueEnvironment::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_queue_environment::UpdateQueueEnvironment::orchestrate(&runtime_plugins, input).await
    }
