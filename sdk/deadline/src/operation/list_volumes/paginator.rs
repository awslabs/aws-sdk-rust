...
/// Paginator for [`ListVolumes`](crate::operation::list_volumes::ListVolumes)
pub struct ListVolumesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_volumes::builders::ListVolumesInputBuilder,
...
impl ListVolumesPaginator {
    ...
    pub fn items(self) -> crate::operation::list_volumes::paginator::ListVolumesPaginatorItems {
        crate::operation::list_volumes::paginator::ListVolumesPaginatorItems(self)
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_volumes::ListVolumes::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_volumes::ListVolumes::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_volumes_output_output_next_token(resp);
...
impl ListVolumesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_volumes_output_output_volumes(page).unwrap_or_default().into_iter())
    }
}
