...
pub use crate::operation::associate_member_to_queue::_associate_member_to_queue_output::AssociateMemberToQueueOutputBuilder;

pub use crate::operation::associate_member_to_queue::_associate_member_to_queue_input::AssociateMemberToQueueInputBuilder;

impl crate::operation::associate_member_to_queue::builders::AssociateMemberToQueueInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.associate_member_to_queue();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `AssociateMemberToQueue`.
///
/// <p>Assigns a queue membership level to a member</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct AssociateMemberToQueueFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::associate_member_to_queue::builders::AssociateMemberToQueueInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::associate_member_to_queue::AssociateMemberToQueueOutput,
        crate::operation::associate_member_to_queue::AssociateMemberToQueueError,
    > for AssociateMemberToQueueFluentBuilder
{
    fn send(
        self,
...
impl AssociateMemberToQueueFluentBuilder {
    /// Creates a new `AssociateMemberToQueueFluentBuilder`.
    ...
    /// Access the AssociateMemberToQueue as a reference.
    pub fn as_input(&self) -> &crate::operation::associate_member_to_queue::builders::AssociateMemberToQueueInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::associate_member_to_queue::AssociateMemberToQueue::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::associate_member_to_queue::AssociateMemberToQueue::orchestrate(&runtime_plugins, input).await
    }
