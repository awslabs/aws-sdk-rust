...
pub use crate::operation::associate_member_to_fleet::_associate_member_to_fleet_output::AssociateMemberToFleetOutputBuilder;

pub use crate::operation::associate_member_to_fleet::_associate_member_to_fleet_input::AssociateMemberToFleetInputBuilder;

impl crate::operation::associate_member_to_fleet::builders::AssociateMemberToFleetInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.associate_member_to_fleet();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `AssociateMemberToFleet`.
///
/// <p>Assigns a fleet membership level to a member.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct AssociateMemberToFleetFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::associate_member_to_fleet::builders::AssociateMemberToFleetInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::associate_member_to_fleet::AssociateMemberToFleetOutput,
        crate::operation::associate_member_to_fleet::AssociateMemberToFleetError,
    > for AssociateMemberToFleetFluentBuilder
{
    fn send(
        self,
...
impl AssociateMemberToFleetFluentBuilder {
    /// Creates a new `AssociateMemberToFleetFluentBuilder`.
    ...
    /// Access the AssociateMemberToFleet as a reference.
    pub fn as_input(&self) -> &crate::operation::associate_member_to_fleet::builders::AssociateMemberToFleetInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::associate_member_to_fleet::AssociateMemberToFleet::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::associate_member_to_fleet::AssociateMemberToFleet::orchestrate(&runtime_plugins, input).await
    }
