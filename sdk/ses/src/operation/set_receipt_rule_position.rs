...
impl SetReceiptRulePositionInput {
    /// Consumes the builder and constructs an Operation<[`SetReceiptRulePosition`](crate::operation::set_receipt_rule_position::SetReceiptRulePosition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_receipt_rule_position::SetReceiptRulePosition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_receipt_rule_position::SetReceiptRulePositionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_receipt_rule_position::SetReceiptRulePosition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetReceiptRulePosition", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetReceiptRulePosition {
                type Output = std::result::Result<crate::operation::set_receipt_rule_position::SetReceiptRulePositionOutput, crate::operation::set_receipt_rule_position::SetReceiptRulePositionError>;
