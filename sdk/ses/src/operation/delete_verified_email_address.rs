...
impl DeleteVerifiedEmailAddressInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_verified_email_address::DeleteVerifiedEmailAddress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVerifiedEmailAddress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_verified_email_address::de_delete_verified_email_address_http_response_with_props(
                status, headers, body,
            )
        }
    }
