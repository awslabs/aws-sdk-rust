...
/// Orchestration and serialization glue logic for `DeleteReceiptFilter`.
...
impl DeleteReceiptFilter {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_receipt_filter::DeleteReceiptFilterInput,
                    ) -> ::std::result::Result<crate::operation::delete_receipt_filter::DeleteReceiptFilterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_receipt_filter::DeleteReceiptFilterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_receipt_filter::DeleteReceiptFilterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_receipt_filter::DeleteReceiptFilterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteReceiptFilter {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteReceiptFilter");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteReceiptFilterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteReceiptFilterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteReceiptFilter")
...
.with_interceptor(DeleteReceiptFilterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_receipt_filter::DeleteReceiptFilterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_receipt_filter::DeleteReceiptFilterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_receipt_filter::DeleteReceiptFilterError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteReceiptFilterResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_receipt_filter::de_delete_receipt_filter_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_receipt_filter::de_delete_receipt_filter_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteReceiptFilterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_receipt_filter::DeleteReceiptFilterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_receipt_filter::DeleteReceiptFilterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_receipt_filter_input::ser_delete_receipt_filter_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteReceiptFilterEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteReceiptFilterEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteReceiptFilterEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteReceiptFilterInput>()
                        .ok_or("failed to downcast to DeleteReceiptFilterInput")?;
...
pub enum DeleteReceiptFilterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteReceiptFilterError) for what information is available for the error.")]
...
impl DeleteReceiptFilterError {
    /// Creates the `DeleteReceiptFilterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteReceiptFilterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteReceiptFilterError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_receipt_filter::DeleteReceiptFilterError {
...
mod _delete_receipt_filter_output;
