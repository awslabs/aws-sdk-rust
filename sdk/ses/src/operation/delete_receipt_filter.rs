...
impl DeleteReceiptFilterInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReceiptFilter`](crate::operation::delete_receipt_filter::DeleteReceiptFilter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_receipt_filter::DeleteReceiptFilter, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_receipt_filter::DeleteReceiptFilterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_receipt_filter::DeleteReceiptFilter::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteReceiptFilter", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteReceiptFilter {
                type Output = std::result::Result<crate::operation::delete_receipt_filter::DeleteReceiptFilterOutput, crate::operation::delete_receipt_filter::DeleteReceiptFilterError>;
