...
impl SendTemplatedEmailInput {
    /// Consumes the builder and constructs an Operation<[`SendTemplatedEmail`](crate::operation::send_templated_email::SendTemplatedEmail)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_templated_email::SendTemplatedEmail, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_templated_email::SendTemplatedEmailInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_templated_email::SendTemplatedEmail::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SendTemplatedEmail", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for SendTemplatedEmail {
                type Output = std::result::Result<crate::operation::send_templated_email::SendTemplatedEmailOutput, crate::operation::send_templated_email::SendTemplatedEmailError>;
