...
impl SendTemplatedEmail {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::send_templated_email::SendTemplatedEmailError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::send_templated_email::SendTemplatedEmailOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SES", "SendTemplatedEmail", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SES.SendTemplatedEmail",
                "rpc.service" = "SES",
                "rpc.method" = "SendTemplatedEmail",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendTemplatedEmail {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SendTemplatedEmailRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SendTemplatedEmailResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("SendTemplatedEmail", "SES"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendTemplatedEmail")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SendTemplatedEmailTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SendTemplatedEmailTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendTemplatedEmailTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SendTemplatedEmailInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendTemplatedEmailResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_send_templated_email::de_send_templated_email_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_send_templated_email::de_send_templated_email_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendTemplatedEmailRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::send_templated_email::SendTemplatedEmailInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::send_templated_email::SendTemplatedEmailInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_send_templated_email_input::ser_send_templated_email_input_input_input(&input)?,
        );
