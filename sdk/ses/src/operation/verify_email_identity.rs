...
impl aws_smithy_http::response::ParseStrictResponse for VerifyEmailIdentity {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_verify_email_identity::de_verify_email_identity_http_error(response)
                     } else {
                        crate::protocol_serde::shape_verify_email_identity::de_verify_email_identity_http_response(response)
                     }
                }
            }
