...
impl VerifyEmailIdentityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::verify_email_identity::VerifyEmailIdentity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyEmailIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_verify_email_identity::de_verify_email_identity_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::verify_email_identity::VerifyEmailIdentityError
{
