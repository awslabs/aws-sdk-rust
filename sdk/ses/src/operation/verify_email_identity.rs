...
impl VerifyEmailIdentityInput {
    /// Consumes the builder and constructs an Operation<[`VerifyEmailIdentity`](crate::operation::verify_email_identity::VerifyEmailIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_email_identity::VerifyEmailIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_email_identity::VerifyEmailIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_email_identity::VerifyEmailIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifyEmailIdentity", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for VerifyEmailIdentity {
                type Output = std::result::Result<crate::operation::verify_email_identity::VerifyEmailIdentityOutput, crate::operation::verify_email_identity::VerifyEmailIdentityError>;
