...
impl GetIdentityDkimAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesOutput, crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesError, Self> {
