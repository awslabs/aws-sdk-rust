...
impl UpdateAccountSendingEnabledInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabled::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateAccountSendingEnabledError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledError
{
