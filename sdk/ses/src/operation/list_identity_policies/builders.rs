...
impl ListIdentityPoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_identity_policies::ListIdentityPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_identity_policies::ListIdentityPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_identity_policies::ListIdentityPoliciesOutput, crate::operation::list_identity_policies::ListIdentityPoliciesError, Self> {
