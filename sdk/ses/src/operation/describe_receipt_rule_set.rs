...
/// Orchestration and serialization glue logic for `DescribeReceiptRuleSet`.
...
impl DescribeReceiptRuleSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeReceiptRuleSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeReceiptRuleSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeReceiptRuleSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeReceiptRuleSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeReceiptRuleSet")
...
.with_interceptor(DescribeReceiptRuleSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeReceiptRuleSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_receipt_rule_set::de_describe_receipt_rule_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_receipt_rule_set::de_describe_receipt_rule_set_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeReceiptRuleSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_receipt_rule_set_input::ser_describe_receipt_rule_set_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeReceiptRuleSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeReceiptRuleSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeReceiptRuleSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeReceiptRuleSetInput>()
                        .ok_or("failed to downcast to DescribeReceiptRuleSetInput")?;
...
pub enum DescribeReceiptRuleSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeReceiptRuleSetError) for what information is available for the error.")]
...
impl DescribeReceiptRuleSetError {
    /// Creates the `DescribeReceiptRuleSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeReceiptRuleSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeReceiptRuleSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_receipt_rule_set::_describe_receipt_rule_set_output::DescribeReceiptRuleSetOutput;

pub use crate::operation::describe_receipt_rule_set::_describe_receipt_rule_set_input::DescribeReceiptRuleSetInput;

mod _describe_receipt_rule_set_input;

mod _describe_receipt_rule_set_output;
