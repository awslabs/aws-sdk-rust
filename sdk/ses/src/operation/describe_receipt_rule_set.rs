...
impl DescribeReceiptRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReceiptRuleSet`](crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeReceiptRuleSet", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReceiptRuleSet {
                type Output = std::result::Result<crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetOutput, crate::operation::describe_receipt_rule_set::DescribeReceiptRuleSetError>;
