...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteConfigurationSetEventDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_configuration_set_event_destination_input::ser_delete_configuration_set_event_destination_input_input_input(&input)?);
