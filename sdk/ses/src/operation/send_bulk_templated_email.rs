...
impl SendBulkTemplatedEmailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::send_bulk_templated_email::SendBulkTemplatedEmail,
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendBulkTemplatedEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_bulk_templated_email::de_send_bulk_templated_email_http_response_with_props(status, headers, body)
        }
    }
}
