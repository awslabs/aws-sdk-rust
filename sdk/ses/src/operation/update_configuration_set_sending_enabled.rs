...
impl aws_smithy_http::response::ParseStrictResponse for UpdateConfigurationSetSendingEnabled {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_configuration_set_sending_enabled::de_update_configuration_set_sending_enabled_http_response_with_props(status, headers, body)
        }
    }
}
