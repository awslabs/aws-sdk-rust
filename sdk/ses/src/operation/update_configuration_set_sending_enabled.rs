...
impl UpdateConfigurationSetSendingEnabled {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledInput,
                    ) -> ::std::result::Result<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateConfigurationSetSendingEnabled {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateConfigurationSetSendingEnabled");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateConfigurationSetSendingEnabledRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateConfigurationSetSendingEnabledResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateConfigurationSetSendingEnabled")
...
.with_interceptor(UpdateConfigurationSetSendingEnabledEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError>::new());
...
#[derive(Debug)]
            struct UpdateConfigurationSetSendingEnabledResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateConfigurationSetSendingEnabledResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_configuration_set_sending_enabled::de_update_configuration_set_sending_enabled_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_configuration_set_sending_enabled::de_update_configuration_set_sending_enabled_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateConfigurationSetSendingEnabledRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_configuration_set_sending_enabled_input::ser_update_configuration_set_sending_enabled_input_input_input(&input)?);
...
#[derive(Debug)]
            struct UpdateConfigurationSetSendingEnabledEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateConfigurationSetSendingEnabledEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateConfigurationSetSendingEnabledEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateConfigurationSetSendingEnabledInput>()
                        .ok_or("failed to downcast to UpdateConfigurationSetSendingEnabledInput")?;
...
pub enum UpdateConfigurationSetSendingEnabledError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateConfigurationSetSendingEnabledError) for what information is available for the error.")]
...
impl UpdateConfigurationSetSendingEnabledError {
    /// Creates the `UpdateConfigurationSetSendingEnabledError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateConfigurationSetSendingEnabledError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ConfigurationSetDoesNotExistException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateConfigurationSetSendingEnabledError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError {
...
mod _update_configuration_set_sending_enabled_output;
