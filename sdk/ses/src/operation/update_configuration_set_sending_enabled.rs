...
impl UpdateConfigurationSetSendingEnabledInput {
    /// Consumes the builder and constructs an Operation<[`UpdateConfigurationSetSendingEnabled`](crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabled)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabled, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabled::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateConfigurationSetSendingEnabled", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateConfigurationSetSendingEnabled {
                type Output = std::result::Result<crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledOutput, crate::operation::update_configuration_set_sending_enabled::UpdateConfigurationSetSendingEnabledError>;
