...
impl ListReceiptRuleSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListReceiptRuleSets`](crate::operation::list_receipt_rule_sets::ListReceiptRuleSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_receipt_rule_sets::ListReceiptRuleSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_receipt_rule_sets::ListReceiptRuleSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_receipt_rule_sets::ListReceiptRuleSets::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListReceiptRuleSets", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListReceiptRuleSets {
                type Output = std::result::Result<crate::operation::list_receipt_rule_sets::ListReceiptRuleSetsOutput, crate::operation::list_receipt_rule_sets::ListReceiptRuleSetsError>;
