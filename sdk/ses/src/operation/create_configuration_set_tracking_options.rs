...
/// Orchestration and serialization glue logic for `CreateConfigurationSetTrackingOptions`.
...
impl CreateConfigurationSetTrackingOptions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsInput,
                    ) -> ::std::result::Result<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateConfigurationSetTrackingOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateConfigurationSetTrackingOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateConfigurationSetTrackingOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateConfigurationSetTrackingOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateConfigurationSetTrackingOptions")
...
.with_interceptor(CreateConfigurationSetTrackingOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateConfigurationSetTrackingOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_configuration_set_tracking_options::de_create_configuration_set_tracking_options_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_configuration_set_tracking_options::de_create_configuration_set_tracking_options_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateConfigurationSetTrackingOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_configuration_set_tracking_options_input::ser_create_configuration_set_tracking_options_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateConfigurationSetTrackingOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateConfigurationSetTrackingOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateConfigurationSetTrackingOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateConfigurationSetTrackingOptionsInput>()
                        .ok_or("failed to downcast to CreateConfigurationSetTrackingOptionsInput")?;
...
pub enum CreateConfigurationSetTrackingOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateConfigurationSetTrackingOptionsError) for what information is available for the error.")]
...
impl CreateConfigurationSetTrackingOptionsError {
    /// Creates the `CreateConfigurationSetTrackingOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateConfigurationSetTrackingOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidTrackingOptionsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::TrackingOptionsAlreadyExistsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateConfigurationSetTrackingOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_configuration_set_tracking_options::CreateConfigurationSetTrackingOptionsError {
...
mod _create_configuration_set_tracking_options_output;
