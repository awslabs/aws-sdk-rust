...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConfigurationSetTrackingOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_configuration_set_tracking_options::de_create_configuration_set_tracking_options_http_response_with_props(status, headers, body)
        }
    }
}
