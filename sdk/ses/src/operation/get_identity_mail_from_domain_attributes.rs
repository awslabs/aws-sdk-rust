...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIdentityMailFromDomainAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_identity_mail_from_domain_attributes::de_get_identity_mail_from_domain_attributes_http_response_with_props(status, headers, body)
        }
    }
}
