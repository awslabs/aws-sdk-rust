...
impl GetIdentityMailFromDomainAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetIdentityMailFromDomainAttributes`](crate::operation::get_identity_mail_from_domain_attributes::GetIdentityMailFromDomainAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_identity_mail_from_domain_attributes::GetIdentityMailFromDomainAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_identity_mail_from_domain_attributes::GetIdentityMailFromDomainAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_identity_mail_from_domain_attributes::GetIdentityMailFromDomainAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetIdentityMailFromDomainAttributes", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetIdentityMailFromDomainAttributes {
                type Output = std::result::Result<crate::operation::get_identity_mail_from_domain_attributes::GetIdentityMailFromDomainAttributesOutput, crate::operation::get_identity_mail_from_domain_attributes::GetIdentityMailFromDomainAttributesError>;
