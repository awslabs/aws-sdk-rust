...
impl SetIdentityMailFromDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainOutput, crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainError, Self> {
