...
impl GetIdentityVerificationAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesOutput, crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesError, Self> {
