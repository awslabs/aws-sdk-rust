...
impl SetActiveReceiptRuleSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSetInput, ::aws_smithy_types::error::operation::BuildError> {
