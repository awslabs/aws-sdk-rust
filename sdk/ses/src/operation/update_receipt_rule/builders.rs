...
impl UpdateReceiptRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_receipt_rule::UpdateReceiptRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_receipt_rule::UpdateReceiptRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_receipt_rule::UpdateReceiptRuleOutput, crate::operation::update_receipt_rule::UpdateReceiptRuleError, Self> {
