...
impl TestRenderTemplateInput {
    /// Consumes the builder and constructs an Operation<[`TestRenderTemplate`](crate::operation::test_render_template::TestRenderTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::test_render_template::TestRenderTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_render_template::TestRenderTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::test_render_template::TestRenderTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TestRenderTemplate", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for TestRenderTemplate {
                type Output = std::result::Result<crate::operation::test_render_template::TestRenderTemplateOutput, crate::operation::test_render_template::TestRenderTemplateError>;
