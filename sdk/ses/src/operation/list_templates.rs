...
impl ListTemplatesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_templates_input::ser_list_templates_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_templates::ListTemplates::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTemplates", "ses"));
