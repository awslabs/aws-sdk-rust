...
impl DescribeConfigurationSetInput {
    /// Consumes the builder and constructs an Operation<[`DescribeConfigurationSet`](crate::operation::describe_configuration_set::DescribeConfigurationSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_configuration_set::DescribeConfigurationSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_configuration_set::DescribeConfigurationSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_configuration_set::DescribeConfigurationSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeConfigurationSet", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationSet {
                type Output = std::result::Result<crate::operation::describe_configuration_set::DescribeConfigurationSetOutput, crate::operation::describe_configuration_set::DescribeConfigurationSetError>;
