...
/// Orchestration and serialization glue logic for `CloneReceiptRuleSet`.
...
impl CloneReceiptRuleSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CloneReceiptRuleSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CloneReceiptRuleSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CloneReceiptRuleSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CloneReceiptRuleSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CloneReceiptRuleSet")
...
.with_interceptor(CloneReceiptRuleSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CloneReceiptRuleSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_clone_receipt_rule_set::de_clone_receipt_rule_set_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CloneReceiptRuleSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_clone_receipt_rule_set_input::ser_clone_receipt_rule_set_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CloneReceiptRuleSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CloneReceiptRuleSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CloneReceiptRuleSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CloneReceiptRuleSetInput>()
                        .ok_or("failed to downcast to CloneReceiptRuleSetInput")?;
...
pub enum CloneReceiptRuleSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CloneReceiptRuleSetError) for what information is available for the error.")]
...
impl CloneReceiptRuleSetError {
    /// Creates the `CloneReceiptRuleSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CloneReceiptRuleSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CloneReceiptRuleSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError {
...
mod _clone_receipt_rule_set_output;
