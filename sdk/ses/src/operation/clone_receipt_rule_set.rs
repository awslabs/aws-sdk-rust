...
impl CloneReceiptRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`CloneReceiptRuleSet`](crate::operation::clone_receipt_rule_set::CloneReceiptRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::clone_receipt_rule_set::CloneReceiptRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CloneReceiptRuleSet", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for CloneReceiptRuleSet {
                type Output = std::result::Result<crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetOutput, crate::operation::clone_receipt_rule_set::CloneReceiptRuleSetError>;
