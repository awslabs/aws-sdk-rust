...
impl SendEmailInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_email_input::ser_send_email_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_email::SendEmail::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SendEmail", "ses"));
