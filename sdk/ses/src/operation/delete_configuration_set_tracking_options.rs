...
/// Orchestration and serialization glue logic for `DeleteConfigurationSetTrackingOptions`.
...
impl DeleteConfigurationSetTrackingOptions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsInput,
                    ) -> ::std::result::Result<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteConfigurationSetTrackingOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteConfigurationSetTrackingOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteConfigurationSetTrackingOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteConfigurationSetTrackingOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteConfigurationSetTrackingOptions")
...
.with_interceptor(DeleteConfigurationSetTrackingOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteConfigurationSetTrackingOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_configuration_set_tracking_options::de_delete_configuration_set_tracking_options_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_configuration_set_tracking_options::de_delete_configuration_set_tracking_options_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteConfigurationSetTrackingOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_configuration_set_tracking_options_input::ser_delete_configuration_set_tracking_options_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteConfigurationSetTrackingOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteConfigurationSetTrackingOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteConfigurationSetTrackingOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteConfigurationSetTrackingOptionsInput>()
                        .ok_or("failed to downcast to DeleteConfigurationSetTrackingOptionsInput")?;
...
pub enum DeleteConfigurationSetTrackingOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteConfigurationSetTrackingOptionsError) for what information is available for the error.")]
...
impl DeleteConfigurationSetTrackingOptionsError {
    /// Creates the `DeleteConfigurationSetTrackingOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteConfigurationSetTrackingOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TrackingOptionsDoesNotExistException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteConfigurationSetTrackingOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_configuration_set_tracking_options::DeleteConfigurationSetTrackingOptionsError {
...
mod _delete_configuration_set_tracking_options_output;
