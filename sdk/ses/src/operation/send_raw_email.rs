...
impl SendRawEmailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_raw_email::SendRawEmail, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_raw_email_input::ser_send_raw_email_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendRawEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_raw_email::de_send_raw_email_http_response_with_props(status, headers, body)
        }
    }
}
