...
impl UpdateConfigurationSetTrackingOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsInput, ::aws_smithy_http::operation::error::BuildError>{
