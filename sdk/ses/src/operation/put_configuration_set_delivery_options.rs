...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_configuration_set_delivery_options_input::ser_put_configuration_set_delivery_options_input_input_input(&input)?);
