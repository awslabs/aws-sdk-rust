...
impl UpdateAccountSendingEnabledFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledOutput, crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledError, Self> {
