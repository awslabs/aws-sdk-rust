...
impl CreateReceiptFilterInput {
    /// Consumes the builder and constructs an Operation<[`CreateReceiptFilter`](crate::operation::create_receipt_filter::CreateReceiptFilter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_receipt_filter::CreateReceiptFilter, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_receipt_filter::CreateReceiptFilterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_receipt_filter::CreateReceiptFilter::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateReceiptFilter", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReceiptFilter {
                type Output = std::result::Result<crate::operation::create_receipt_filter::CreateReceiptFilterOutput, crate::operation::create_receipt_filter::CreateReceiptFilterError>;
