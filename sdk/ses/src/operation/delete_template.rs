...
impl DeleteTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_template::DeleteTemplate, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTemplate {
    type Output =
        ::std::result::Result<crate::operation::delete_template::DeleteTemplateOutput, crate::operation::delete_template::DeleteTemplateError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_template::de_delete_template_http_response_with_props(status, headers, body)
        }
    }
}
