...
impl ListIdentitiesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_identities::ListIdentities,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_identities::ListIdentities::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_identities::de_list_identities_http_error(
                status, headers, body,
            )
        } else {
