...
impl SetIdentityMailFromDomainInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomain::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityMailFromDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_identity_mail_from_domain::de_set_identity_mail_from_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
