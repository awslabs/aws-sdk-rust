...
impl GetIdentityVerificationAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetIdentityVerificationAttributes`](crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetIdentityVerificationAttributes", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetIdentityVerificationAttributes {
                type Output = std::result::Result<crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesOutput, crate::operation::get_identity_verification_attributes::GetIdentityVerificationAttributesError>;
