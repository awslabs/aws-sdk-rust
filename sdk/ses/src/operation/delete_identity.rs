...
impl DeleteIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_identity::DeleteIdentity, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIdentity {
    type Output =
        ::std::result::Result<crate::operation::delete_identity::DeleteIdentityOutput, crate::operation::delete_identity::DeleteIdentityError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_identity::de_delete_identity_http_response_with_props(status, headers, body)
        }
    }
}
