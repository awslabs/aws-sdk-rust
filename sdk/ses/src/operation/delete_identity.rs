...
impl DeleteIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_identity::DeleteIdentity,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_identity::DeleteIdentity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_identity::de_delete_identity_http_error(
                status, headers, body,
            )
        } else {
