...
impl ReorderReceiptRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`ReorderReceiptRuleSet`](crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ReorderReceiptRuleSet", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for ReorderReceiptRuleSet {
                type Output = std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError>;
