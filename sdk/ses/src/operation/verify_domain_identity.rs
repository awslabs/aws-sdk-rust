...
/// Orchestration and serialization glue logic for `VerifyDomainIdentity`.
...
impl VerifyDomainIdentity {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::verify_domain_identity::VerifyDomainIdentityInput,
                    ) -> ::std::result::Result<crate::operation::verify_domain_identity::VerifyDomainIdentityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::verify_domain_identity::VerifyDomainIdentityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::verify_domain_identity::VerifyDomainIdentityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::verify_domain_identity::VerifyDomainIdentityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for VerifyDomainIdentity {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("VerifyDomainIdentity");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(VerifyDomainIdentityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(VerifyDomainIdentityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("VerifyDomainIdentity")
...
.with_interceptor(VerifyDomainIdentityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::verify_domain_identity::VerifyDomainIdentityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::verify_domain_identity::VerifyDomainIdentityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::verify_domain_identity::VerifyDomainIdentityError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifyDomainIdentityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_verify_domain_identity::de_verify_domain_identity_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifyDomainIdentityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::verify_domain_identity::VerifyDomainIdentityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::verify_domain_identity::VerifyDomainIdentityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_verify_domain_identity_input::ser_verify_domain_identity_input_input_input(&input)?);
...
#[derive(Debug)]
            struct VerifyDomainIdentityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for VerifyDomainIdentityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "VerifyDomainIdentityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<VerifyDomainIdentityInput>()
                        .ok_or("failed to downcast to VerifyDomainIdentityInput")?;
...
pub enum VerifyDomainIdentityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-VerifyDomainIdentityError) for what information is available for the error.")]
...
impl VerifyDomainIdentityError {
    /// Creates the `VerifyDomainIdentityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `VerifyDomainIdentityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for VerifyDomainIdentityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::verify_domain_identity::VerifyDomainIdentityError {
...
mod _verify_domain_identity_output;
