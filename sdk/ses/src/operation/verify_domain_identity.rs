...
impl VerifyDomainIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::verify_domain_identity::VerifyDomainIdentity,
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyDomainIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_verify_domain_identity::de_verify_domain_identity_http_response_with_props(status, headers, body)
        }
    }
}
