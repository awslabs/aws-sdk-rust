...
impl VerifyDomainIdentityInput {
    /// Consumes the builder and constructs an Operation<[`VerifyDomainIdentity`](crate::operation::verify_domain_identity::VerifyDomainIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_domain_identity::VerifyDomainIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_domain_identity::VerifyDomainIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_domain_identity::VerifyDomainIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifyDomainIdentity", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for VerifyDomainIdentity {
                type Output = std::result::Result<crate::operation::verify_domain_identity::VerifyDomainIdentityOutput, crate::operation::verify_domain_identity::VerifyDomainIdentityError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_verify_domain_identity::de_verify_domain_identity_http_error(response)
                     } else {
                        crate::protocol_serde::shape_verify_domain_identity::de_verify_domain_identity_http_response(response)
                     }
                }
            }
