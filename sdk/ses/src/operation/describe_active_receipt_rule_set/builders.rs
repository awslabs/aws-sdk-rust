...
impl DescribeActiveReceiptRuleSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetOutput, crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetError, Self> {
