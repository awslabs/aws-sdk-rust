...
impl SetIdentityNotificationTopicInput {
    /// Consumes the builder and constructs an Operation<[`SetIdentityNotificationTopic`](crate::operation::set_identity_notification_topic::SetIdentityNotificationTopic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_identity_notification_topic::SetIdentityNotificationTopic, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_identity_notification_topic::SetIdentityNotificationTopicInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_identity_notification_topic::SetIdentityNotificationTopic::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetIdentityNotificationTopic", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetIdentityNotificationTopic {
                type Output = std::result::Result<crate::operation::set_identity_notification_topic::SetIdentityNotificationTopicOutput, crate::operation::set_identity_notification_topic::SetIdentityNotificationTopicError>;
