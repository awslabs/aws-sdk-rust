...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityNotificationTopic {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_identity_notification_topic::de_set_identity_notification_topic_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for SetIdentityNotificationTopicError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_identity_notification_topic::SetIdentityNotificationTopicError
{
