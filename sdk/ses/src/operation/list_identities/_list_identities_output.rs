...
impl  ListIdentitiesOutput  {
    ...
    pub fn identities(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.identities.deref()
    }
    /// <p>The token used for pagination.</p>
...
impl ListIdentitiesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_identities::ListIdentitiesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_identities::ListIdentitiesOutput {
                identities: self.identities
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("identities", "identities was not specified but it is required when building ListIdentitiesOutput")
                    )?
                ,
