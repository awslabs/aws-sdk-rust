...
impl SetActiveReceiptRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`SetActiveReceiptRuleSet`](crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetActiveReceiptRuleSet", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetActiveReceiptRuleSet {
                type Output = std::result::Result<crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSetOutput, crate::operation::set_active_receipt_rule_set::SetActiveReceiptRuleSetError>;
