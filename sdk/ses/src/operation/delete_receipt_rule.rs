...
/// Orchestration and serialization glue logic for `DeleteReceiptRule`.
...
impl DeleteReceiptRule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_receipt_rule::DeleteReceiptRuleInput,
                    ) -> ::std::result::Result<crate::operation::delete_receipt_rule::DeleteReceiptRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_receipt_rule::DeleteReceiptRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_receipt_rule::DeleteReceiptRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_receipt_rule::DeleteReceiptRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteReceiptRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteReceiptRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteReceiptRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteReceiptRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteReceiptRule")
...
.with_interceptor(DeleteReceiptRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_receipt_rule::DeleteReceiptRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_receipt_rule::DeleteReceiptRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_receipt_rule::DeleteReceiptRuleError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteReceiptRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_receipt_rule::de_delete_receipt_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_receipt_rule::de_delete_receipt_rule_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteReceiptRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_receipt_rule::DeleteReceiptRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_receipt_rule::DeleteReceiptRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_receipt_rule_input::ser_delete_receipt_rule_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteReceiptRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteReceiptRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteReceiptRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteReceiptRuleInput>()
                        .ok_or("failed to downcast to DeleteReceiptRuleInput")?;
...
pub enum DeleteReceiptRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteReceiptRuleError) for what information is available for the error.")]
...
impl DeleteReceiptRuleError {
    /// Creates the `DeleteReceiptRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteReceiptRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteReceiptRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_receipt_rule::DeleteReceiptRuleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_receipt_rule::_delete_receipt_rule_output::DeleteReceiptRuleOutput;

pub use crate::operation::delete_receipt_rule::_delete_receipt_rule_input::DeleteReceiptRuleInput;

mod _delete_receipt_rule_input;

mod _delete_receipt_rule_output;
