...
impl DeleteReceiptRuleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReceiptRule`](crate::operation::delete_receipt_rule::DeleteReceiptRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_receipt_rule::DeleteReceiptRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_receipt_rule::DeleteReceiptRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_receipt_rule::DeleteReceiptRule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteReceiptRule", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteReceiptRule {
                type Output = std::result::Result<crate::operation::delete_receipt_rule::DeleteReceiptRuleOutput, crate::operation::delete_receipt_rule::DeleteReceiptRuleError>;
