...
/// Orchestration and serialization glue logic for `VerifyEmailAddress`.
...
impl VerifyEmailAddress {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::verify_email_address::VerifyEmailAddressInput,
                    ) -> ::std::result::Result<crate::operation::verify_email_address::VerifyEmailAddressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::verify_email_address::VerifyEmailAddressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::verify_email_address::VerifyEmailAddressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::verify_email_address::VerifyEmailAddressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for VerifyEmailAddress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("VerifyEmailAddress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(VerifyEmailAddressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(VerifyEmailAddressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("VerifyEmailAddress")
...
.with_interceptor(VerifyEmailAddressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::verify_email_address::VerifyEmailAddressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::verify_email_address::VerifyEmailAddressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::verify_email_address::VerifyEmailAddressError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifyEmailAddressResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_verify_email_address::de_verify_email_address_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_verify_email_address::de_verify_email_address_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifyEmailAddressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::verify_email_address::VerifyEmailAddressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::verify_email_address::VerifyEmailAddressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_verify_email_address_input::ser_verify_email_address_input_input_input(&input)?);
...
#[derive(Debug)]
            struct VerifyEmailAddressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for VerifyEmailAddressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "VerifyEmailAddressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<VerifyEmailAddressInput>()
                        .ok_or("failed to downcast to VerifyEmailAddressInput")?;
...
pub enum VerifyEmailAddressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-VerifyEmailAddressError) for what information is available for the error.")]
...
impl VerifyEmailAddressError {
    /// Creates the `VerifyEmailAddressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `VerifyEmailAddressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for VerifyEmailAddressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::verify_email_address::VerifyEmailAddressError {
...
mod _verify_email_address_output;
