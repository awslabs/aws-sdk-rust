...
impl VerifyEmailAddressInput {
    /// Consumes the builder and constructs an Operation<[`VerifyEmailAddress`](crate::operation::verify_email_address::VerifyEmailAddress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_email_address::VerifyEmailAddress, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_email_address::VerifyEmailAddressInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_email_address::VerifyEmailAddress::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifyEmailAddress", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for VerifyEmailAddress {
                type Output = std::result::Result<crate::operation::verify_email_address::VerifyEmailAddressOutput, crate::operation::verify_email_address::VerifyEmailAddressError>;
