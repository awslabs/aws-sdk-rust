...
impl UpdateReceiptRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_receipt_rule::UpdateReceiptRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateReceiptRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_receipt_rule::de_update_receipt_rule_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_receipt_rule::UpdateReceiptRuleError
{
