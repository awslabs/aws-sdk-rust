...
impl DeleteIdentityPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_identity_policy::DeleteIdentityPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_identity_policy::DeleteIdentityPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_identity_policy::DeleteIdentityPolicyOutput, crate::operation::delete_identity_policy::DeleteIdentityPolicyError, Self> {
