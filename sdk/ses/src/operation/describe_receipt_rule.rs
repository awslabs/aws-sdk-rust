...
impl DescribeReceiptRuleInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReceiptRule`](crate::operation::describe_receipt_rule::DescribeReceiptRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_receipt_rule::DescribeReceiptRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_receipt_rule::DescribeReceiptRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_receipt_rule::DescribeReceiptRule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeReceiptRule", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReceiptRule {
                type Output = std::result::Result<crate::operation::describe_receipt_rule::DescribeReceiptRuleOutput, crate::operation::describe_receipt_rule::DescribeReceiptRuleError>;
