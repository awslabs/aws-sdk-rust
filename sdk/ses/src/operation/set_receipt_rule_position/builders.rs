...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::set_receipt_rule_position::SetReceiptRulePositionOutput,
                    crate::operation::set_receipt_rule_position::SetReceiptRulePositionError,
                > for SetReceiptRulePositionFluentBuilder
            {
                fn send(
                    self,
...
impl SetReceiptRulePositionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_receipt_rule_position::SetReceiptRulePositionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_receipt_rule_position::SetReceiptRulePositionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_receipt_rule_position::SetReceiptRulePositionOutput, crate::operation::set_receipt_rule_position::SetReceiptRulePositionError, Self> {
