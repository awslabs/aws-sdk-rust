...
impl CreateReceiptRuleInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_receipt_rule::CreateReceiptRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_receipt_rule::CreateReceiptRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_receipt_rule::CreateReceiptRule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateReceiptRule", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReceiptRule {
                type Output = std::result::Result<crate::operation::create_receipt_rule::CreateReceiptRuleOutput, crate::operation::create_receipt_rule::CreateReceiptRuleError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_receipt_rule::de_create_receipt_rule_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_receipt_rule::de_create_receipt_rule_http_response(response)
                     }
                }
            }
