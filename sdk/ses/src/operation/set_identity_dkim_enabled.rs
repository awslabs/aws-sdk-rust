...
impl SetIdentityDkimEnabled {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ses", "SetIdentityDkimEnabled", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetIdentityDkimEnabled {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("SetIdentityDkimEnabled", "ses"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SetIdentityDkimEnabledResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SetIdentityDkimEnabledRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_identity_dkim_enabled_input::ser_set_identity_dkim_enabled_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetIdentityDkimEnabledEndpointParamsInterceptor {
