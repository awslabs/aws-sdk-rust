    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIdentityNotificationAttributes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetIdentityNotificationAttributesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetIdentityNotificationAttributesResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetIdentityNotificationAttributes", "ses"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetIdentityNotificationAttributesResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_get_identity_notification_attributes::de_get_identity_notification_attributes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_identity_notification_attributes::de_get_identity_notification_attributes_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetIdentityNotificationAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_identity_notification_attributes_input::ser_get_identity_notification_attributes_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetIdentityNotificationAttributesEndpointParamsInterceptor {
