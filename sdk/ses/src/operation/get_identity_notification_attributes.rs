...
impl GetIdentityNotificationAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIdentityNotificationAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_identity_notification_attributes::de_get_identity_notification_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
