...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateConfigurationSetEventDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_configuration_set_event_destination_input::ser_create_configuration_set_event_destination_input_input(&input)?);
