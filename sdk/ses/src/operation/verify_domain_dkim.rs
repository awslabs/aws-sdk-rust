...
impl VerifyDomainDkimInput {
    /// Consumes the builder and constructs an Operation<[`VerifyDomainDkim`](crate::operation::verify_domain_dkim::VerifyDomainDkim)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_domain_dkim::VerifyDomainDkim, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_domain_dkim::VerifyDomainDkimInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_domain_dkim::VerifyDomainDkim::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifyDomainDkim", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for VerifyDomainDkim {
                type Output = std::result::Result<crate::operation::verify_domain_dkim::VerifyDomainDkimOutput, crate::operation::verify_domain_dkim::VerifyDomainDkimError>;
