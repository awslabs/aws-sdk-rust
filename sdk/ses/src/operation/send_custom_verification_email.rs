...
impl SendCustomVerificationEmailInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_custom_verification_email::SendCustomVerificationEmail::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendCustomVerificationEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_custom_verification_email::de_send_custom_verification_email_http_response_with_props(
                status, headers, body,
            )
        }
    }
