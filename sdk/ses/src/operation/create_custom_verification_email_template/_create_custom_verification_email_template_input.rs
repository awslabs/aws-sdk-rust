...
impl CreateCustomVerificationEmailTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_custom_verification_email_template::CreateCustomVerificationEmailTemplateInput, ::aws_smithy_http::operation::error::BuildError>{
