    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_identity_headers_in_notifications_enabled::SetIdentityHeadersInNotificationsEnabledError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_identity_headers_in_notifications_enabled::SetIdentityHeadersInNotificationsEnabledOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetIdentityHeadersInNotificationsEnabled {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetIdentityHeadersInNotificationsEnabledRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetIdentityHeadersInNotificationsEnabledResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for SetIdentityHeadersInNotificationsEnabledResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_set_identity_headers_in_notifications_enabled::de_set_identity_headers_in_notifications_enabled_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_set_identity_headers_in_notifications_enabled::de_set_identity_headers_in_notifications_enabled_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for SetIdentityHeadersInNotificationsEnabledRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_identity_headers_in_notifications_enabled::SetIdentityHeadersInNotificationsEnabledInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::set_identity_headers_in_notifications_enabled::SetIdentityHeadersInNotificationsEnabledInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_identity_headers_in_notifications_enabled_input::ser_set_identity_headers_in_notifications_enabled_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetIdentityHeadersInNotificationsEnabledEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_identity_headers_in_notifications_enabled::SetIdentityHeadersInNotificationsEnabledError
{
