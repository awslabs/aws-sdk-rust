...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeActiveReceiptRuleSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_active_receipt_rule_set::de_describe_active_receipt_rule_set_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeActiveReceiptRuleSetError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetError
{
