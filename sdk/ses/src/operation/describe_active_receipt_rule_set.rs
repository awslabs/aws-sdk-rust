...
impl DescribeActiveReceiptRuleSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSet,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeActiveReceiptRuleSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_active_receipt_rule_set::de_describe_active_receipt_rule_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
