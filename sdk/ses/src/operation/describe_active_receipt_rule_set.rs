...
impl DescribeActiveReceiptRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`DescribeActiveReceiptRuleSet`](crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeActiveReceiptRuleSet", "ses"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeActiveReceiptRuleSet {
                type Output = std::result::Result<crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetOutput, crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_active_receipt_rule_set::de_describe_active_receipt_rule_set_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_active_receipt_rule_set::de_describe_active_receipt_rule_set_http_response(response)
                     }
                }
            }
