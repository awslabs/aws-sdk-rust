...
impl super::Client {
    ...
    ///   - [`email_address(impl Into<String>)`](crate::operation::verify_email_identity::builders::VerifyEmailIdentityFluentBuilder::email_address) / [`set_email_address(Option<String>)`](crate::operation::verify_email_identity::builders::VerifyEmailIdentityFluentBuilder::set_email_address):<br>required: **true**<br><p>The email address to be verified.</p><br>
