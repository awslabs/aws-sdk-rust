...
impl super::Client {
    ...
    pub fn list_receipt_filters(
        &self,
    ) -> crate::operation::list_receipt_filters::builders::ListReceiptFiltersFluentBuilder {
        crate::operation::list_receipt_filters::builders::ListReceiptFiltersFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
