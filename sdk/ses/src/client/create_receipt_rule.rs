...
impl super::Client {
    ...
    ///   - [`rule_set_name(impl ::std::convert::Into<String>)`](crate::operation::create_receipt_rule::builders::CreateReceiptRuleFluentBuilder::rule_set_name) / [`set_rule_set_name(Option<String>)`](crate::operation::create_receipt_rule::builders::CreateReceiptRuleFluentBuilder::set_rule_set_name): <p>The name of the rule set that the receipt rule will be added to.</p>
    ///   - [`after(impl ::std::convert::Into<String>)`](crate::operation::create_receipt_rule::builders::CreateReceiptRuleFluentBuilder::after) / [`set_after(Option<String>)`](crate::operation::create_receipt_rule::builders::CreateReceiptRuleFluentBuilder::set_after): <p>The name of an existing rule after which the new rule will be placed. If this parameter is null, the new rule will be inserted at the beginning of the rule list.</p>
