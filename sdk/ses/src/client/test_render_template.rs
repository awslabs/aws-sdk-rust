...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::test_render_template::builders::TestRenderTemplateFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::test_render_template::builders::TestRenderTemplateFluentBuilder::set_template_name):<br>required: **true**<br><p>The name of the template to render.</p><br>
