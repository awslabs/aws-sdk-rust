...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::get_template::builders::GetTemplateFluentBuilder::set_template_name): <p>The name of the template to retrieve.</p>
