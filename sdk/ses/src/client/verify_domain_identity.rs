...
impl super::Client {
    ...
    pub fn verify_domain_identity(
        &self,
    ) -> crate::operation::verify_domain_identity::builders::VerifyDomainIdentityFluentBuilder {
        crate::operation::verify_domain_identity::builders::VerifyDomainIdentityFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
