...
impl super::Client {
    ...
    ///   - [`rule_set_name(impl ::std::convert::Into<String>)`](crate::operation::describe_receipt_rule_set::builders::DescribeReceiptRuleSetFluentBuilder::rule_set_name) / [`set_rule_set_name(Option<String>)`](crate::operation::describe_receipt_rule_set::builders::DescribeReceiptRuleSetFluentBuilder::set_rule_set_name): <p>The name of the receipt rule set to describe.</p>
    ...
    pub fn describe_receipt_rule_set(
        &self,
    ) -> crate::operation::describe_receipt_rule_set::builders::DescribeReceiptRuleSetFluentBuilder
    {
