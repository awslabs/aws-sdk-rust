...
impl super::Client {
    ...
    ///   - [`rule_set_name(impl Into<String>)`](crate::operation::set_active_receipt_rule_set::builders::SetActiveReceiptRuleSetFluentBuilder::rule_set_name) / [`set_rule_set_name(Option<String>)`](crate::operation::set_active_receipt_rule_set::builders::SetActiveReceiptRuleSetFluentBuilder::set_rule_set_name):<br>required: **false**<br><p>The name of the receipt rule set to make active. Setting this value to null disables all email receiving.</p><br>
