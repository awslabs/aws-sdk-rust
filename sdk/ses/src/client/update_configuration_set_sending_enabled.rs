...
impl super::Client {
    ...
    ///   - [`configuration_set_name(impl Into<String>)`](crate::operation::update_configuration_set_sending_enabled::builders::UpdateConfigurationSetSendingEnabledFluentBuilder::configuration_set_name) / [`set_configuration_set_name(Option<String>)`](crate::operation::update_configuration_set_sending_enabled::builders::UpdateConfigurationSetSendingEnabledFluentBuilder::set_configuration_set_name): <p>The name of the configuration set to update.</p>
    ///   - [`enabled(bool)`](crate::operation::update_configuration_set_sending_enabled::builders::UpdateConfigurationSetSendingEnabledFluentBuilder::enabled) / [`set_enabled(Option<bool>)`](crate::operation::update_configuration_set_sending_enabled::builders::UpdateConfigurationSetSendingEnabledFluentBuilder::set_enabled): <p>Describes whether email sending is enabled or disabled for the configuration set. </p>
