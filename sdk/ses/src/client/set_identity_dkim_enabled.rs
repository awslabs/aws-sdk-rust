...
impl super::Client {
    ...
    ///   - [`identity(impl Into<String>)`](crate::operation::set_identity_dkim_enabled::builders::SetIdentityDkimEnabledFluentBuilder::identity) / [`set_identity(Option<String>)`](crate::operation::set_identity_dkim_enabled::builders::SetIdentityDkimEnabledFluentBuilder::set_identity):<br>required: **true**<br><p>The identity for which DKIM signing should be enabled or disabled.</p><br>
    ///   - [`dkim_enabled(bool)`](crate::operation::set_identity_dkim_enabled::builders::SetIdentityDkimEnabledFluentBuilder::dkim_enabled) / [`set_dkim_enabled(Option<bool>)`](crate::operation::set_identity_dkim_enabled::builders::SetIdentityDkimEnabledFluentBuilder::set_dkim_enabled):<br>required: **true**<br><p>Sets whether DKIM signing is enabled for an identity. Set to <code>true</code> to enable DKIM signing for this identity; <code>false</code> to disable it.</p><br>
