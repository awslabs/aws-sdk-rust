...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::verify_domain_dkim::builders::VerifyDomainDkimFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::verify_domain_dkim::builders::VerifyDomainDkimFluentBuilder::set_domain): <p>The name of the domain to be verified for Easy DKIM signing.</p>
