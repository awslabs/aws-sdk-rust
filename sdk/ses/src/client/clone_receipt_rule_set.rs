...
impl super::Client {
    ...
    ///   - [`rule_set_name(impl ::std::convert::Into<String>)`](crate::operation::clone_receipt_rule_set::builders::CloneReceiptRuleSetFluentBuilder::rule_set_name) / [`set_rule_set_name(Option<String>)`](crate::operation::clone_receipt_rule_set::builders::CloneReceiptRuleSetFluentBuilder::set_rule_set_name): <p>The name of the rule set to create. The name must:</p>  <ul>   <li> <p>This value can only contain ASCII letters (a-z, A-Z), numbers (0-9), underscores (_), or dashes (-).</p> </li>   <li> <p>Start and end with a letter or number.</p> </li>   <li> <p>Contain less than 64 characters.</p> </li>  </ul>
