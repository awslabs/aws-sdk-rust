...
impl super::Client {
    ...
    pub fn delete_receipt_rule_set(
        &self,
    ) -> crate::operation::delete_receipt_rule_set::builders::DeleteReceiptRuleSetFluentBuilder
    {
        crate::operation::delete_receipt_rule_set::builders::DeleteReceiptRuleSetFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
