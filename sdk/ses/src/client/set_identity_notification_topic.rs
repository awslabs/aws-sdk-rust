...
impl super::Client {
    ...
    ///   - [`identity(impl ::std::convert::Into<String>)`](crate::operation::set_identity_notification_topic::builders::SetIdentityNotificationTopicFluentBuilder::identity) / [`set_identity(Option<String>)`](crate::operation::set_identity_notification_topic::builders::SetIdentityNotificationTopicFluentBuilder::set_identity): <p>The identity (email address or domain) that you want to set the Amazon SNS topic for.</p> <important>   <p>You can only specify a verified identity for this parameter.</p>  </important>  <p>You can specify an identity by using its name or by using its Amazon Resource Name (ARN). The following examples are all valid identities: <code>sender@example.com</code>, <code>example.com</code>, <code>arn:aws:ses:us-east-1:123456789012:identity/example.com</code>.</p>
