...
impl super::Client {
    ...
    ///   - [`identity(impl Into<String>)`](crate::operation::delete_identity::builders::DeleteIdentityFluentBuilder::identity) / [`set_identity(Option<String>)`](crate::operation::delete_identity::builders::DeleteIdentityFluentBuilder::set_identity): <p>The identity to be removed from the list of identities for the Amazon Web Services account.</p>
