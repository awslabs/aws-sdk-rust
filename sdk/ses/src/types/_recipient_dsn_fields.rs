    ...
    pub fn build(self) -> ::std::result::Result<crate::types::RecipientDsnFields, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::RecipientDsnFields {
                ...
                action: self.action
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("action", "action was not specified but it is required when building RecipientDsnFields")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building RecipientDsnFields")
                    )?
                ,
