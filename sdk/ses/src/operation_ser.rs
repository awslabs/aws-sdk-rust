...
pub fn serialize_operation_clone_receipt_rule_set(
...
pub fn serialize_operation_create_configuration_set(
    ...
    if let Some(var_6) = &input.configuration_set {
        crate::query_ser::serialize_structure_configuration_set(scope_5, var_6);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_create_configuration_set_event_destination(
    ...
    if let Some(var_10) = &input.event_destination {
        crate::query_ser::serialize_structure_event_destination(scope_9, var_10);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_create_configuration_set_tracking_options(
    ...
    if let Some(var_14) = &input.tracking_options {
        crate::query_ser::serialize_structure_tracking_options(scope_13, var_14);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_create_receipt_filter(
    ...
    if let Some(var_28) = &input.filter {
        crate::query_ser::serialize_structure_receipt_filter(scope_27, var_28);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_create_receipt_rule(
    ...
    if let Some(var_34) = &input.rule {
        crate::query_ser::serialize_structure_receipt_rule(scope_33, var_34);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_create_receipt_rule_set(
...
pub fn serialize_operation_create_template(
    ...
    if let Some(var_38) = &input.template {
        crate::query_ser::serialize_structure_template(scope_37, var_38);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_delete_configuration_set(
...
pub fn serialize_operation_delete_configuration_set_event_destination(
...
pub fn serialize_operation_delete_configuration_set_tracking_options(
...
pub fn serialize_operation_delete_custom_verification_email_template(
...
pub fn serialize_operation_delete_identity(
...
pub fn serialize_operation_delete_identity_policy(
...
pub fn serialize_operation_delete_receipt_filter(
...
pub fn serialize_operation_delete_receipt_rule(
...
pub fn serialize_operation_delete_receipt_rule_set(
...
pub fn serialize_operation_delete_template(
...
pub fn serialize_operation_delete_verified_email_address(
...
pub fn serialize_operation_describe_active_receipt_rule_set(
...
pub fn serialize_operation_describe_configuration_set(
...
pub fn serialize_operation_describe_receipt_rule(
...
pub fn serialize_operation_describe_receipt_rule_set(
...
pub fn serialize_operation_get_account_sending_enabled(
...
pub fn serialize_operation_get_custom_verification_email_template(
...
pub fn serialize_operation_get_identity_dkim_attributes(
...
pub fn serialize_operation_get_identity_mail_from_domain_attributes(
...
pub fn serialize_operation_get_identity_notification_attributes(
...
pub fn serialize_operation_get_identity_policies(
...
pub fn serialize_operation_get_identity_verification_attributes(
...
pub fn serialize_operation_get_send_quota(
...
pub fn serialize_operation_get_send_statistics(
...
pub fn serialize_operation_list_configuration_sets(
...
pub fn serialize_operation_list_custom_verification_email_templates(
...
pub fn serialize_operation_list_identity_policies(
...
pub fn serialize_operation_list_receipt_filters(
...
pub fn serialize_operation_list_receipt_rule_sets(
...
pub fn serialize_operation_list_templates(
...
pub fn serialize_operation_list_verified_email_addresses(
...
pub fn serialize_operation_put_configuration_set_delivery_options(
    ...
    if let Some(var_136) = &input.delivery_options {
        crate::query_ser::serialize_structure_delivery_options(scope_135, var_136);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_put_identity_policy(
...
pub fn serialize_operation_reorder_receipt_rule_set(
...
pub fn serialize_operation_send_bounce(
    ...
    if let Some(var_157) = &input.message_dsn {
        crate::query_ser::serialize_structure_message_dsn(scope_156, var_157);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_159) = &input.bounced_recipient_info_list {
        ...
        for item_160 in var_159 {
            ...
            crate::query_ser::serialize_structure_bounced_recipient_info(entry_162, item_160);
        }
        list_161.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_send_bulk_templated_email(
    ...
    if let Some(var_181) = &input.default_tags {
        ...
        for item_182 in var_181 {
            ...
            crate::query_ser::serialize_structure_message_tag(entry_184, item_182);
        }
        list_183.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_192) = &input.destinations {
        ...
        for item_193 in var_192 {
            ...
            crate::query_ser::serialize_structure_bulk_email_destination(entry_195, item_193);
        }
        list_194.finish();
    }
    writer.finish();
...
pub fn serialize_operation_send_email(
    ...
    if let Some(var_205) = &input.destination {
        crate::query_ser::serialize_structure_destination(scope_204, var_205);
    }
    #[allow(unused_mut)]
    let mut scope_206 = writer.prefix("Message");
    if let Some(var_207) = &input.message {
        crate::query_ser::serialize_structure_message(scope_206, var_207);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_220) = &input.tags {
        ...
        for item_221 in var_220 {
            ...
            crate::query_ser::serialize_structure_message_tag(entry_223, item_221);
        }
        list_222.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_send_raw_email(
    ...
    if let Some(var_234) = &input.raw_message {
        crate::query_ser::serialize_structure_raw_message(scope_233, var_234);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_242) = &input.tags {
        ...
        for item_243 in var_242 {
            ...
            crate::query_ser::serialize_structure_message_tag(entry_245, item_243);
        }
        list_244.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_send_templated_email(
    ...
    if let Some(var_251) = &input.destination {
        crate::query_ser::serialize_structure_destination(scope_250, var_251);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_264) = &input.tags {
        ...
        for item_265 in var_264 {
            ...
            crate::query_ser::serialize_structure_message_tag(entry_267, item_265);
        }
        list_266.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_set_active_receipt_rule_set(
...
pub fn serialize_operation_set_identity_dkim_enabled(
...
pub fn serialize_operation_set_identity_feedback_forwarding_enabled(
...
pub fn serialize_operation_set_identity_headers_in_notifications_enabled(
...
pub fn serialize_operation_set_identity_mail_from_domain(
...
pub fn serialize_operation_set_identity_notification_topic(
...
pub fn serialize_operation_set_receipt_rule_position(
...
pub fn serialize_operation_test_render_template(
...
pub fn serialize_operation_update_account_sending_enabled(
...
pub fn serialize_operation_update_configuration_set_event_destination(
    ...
    if let Some(var_315) = &input.event_destination {
        crate::query_ser::serialize_structure_event_destination(scope_314, var_315);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_update_configuration_set_reputation_metrics_enabled(
...
pub fn serialize_operation_update_configuration_set_sending_enabled(
...
pub fn serialize_operation_update_configuration_set_tracking_options(
    ...
    if let Some(var_325) = &input.tracking_options {
        crate::query_ser::serialize_structure_tracking_options(scope_324, var_325);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_update_receipt_rule(
    ...
    if let Some(var_341) = &input.rule {
        crate::query_ser::serialize_structure_receipt_rule(scope_340, var_341);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_update_template(
    ...
    if let Some(var_343) = &input.template {
        crate::query_ser::serialize_structure_template(scope_342, var_343);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_verify_domain_dkim(
...
pub fn serialize_operation_verify_domain_identity(
...
pub fn serialize_operation_verify_email_address(
...
pub fn serialize_operation_verify_email_identity(
