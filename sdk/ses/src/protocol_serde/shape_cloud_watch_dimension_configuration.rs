...
#[allow(unused_mut)]
pub fn ser_cloud_watch_dimension_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::CloudWatchDimensionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cloud_watch_dimension_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudWatchDimensionConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
