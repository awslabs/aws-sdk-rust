...
#[allow(unused_mut)]
pub fn ser_event_destination(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::EventDestination) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_event_destination(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EventDestination, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
