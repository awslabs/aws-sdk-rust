...
#[allow(unused_mut)]
pub fn de_invalid_policy_exception_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::InvalidPolicyExceptionBuilder,
) -> std::result::Result<crate::types::error::builders::InvalidPolicyExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
