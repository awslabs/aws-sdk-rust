...
pub fn de_send_email_http_response(
    ...
    Ok({
        ...
        crate::serde_util::send_email_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::send_email::SendEmailError::unhandled)?
    })
}
...
pub fn de_send_email(
...
) -> std::result::Result<crate::operation::send_email::builders::SendEmailOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("SendEmailResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected SendEmailResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("SendEmailResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected SendEmailResult got {start_el:?}"
            )));
        }
