...
pub fn ser_list_templates_input_input(input: &crate::input::ListTemplatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
