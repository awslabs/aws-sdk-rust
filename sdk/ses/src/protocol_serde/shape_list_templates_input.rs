...
pub fn ser_list_templates_input_input_input(input: &crate::operation::list_templates::ListTemplatesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
