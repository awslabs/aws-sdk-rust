...
pub fn ser_set_identity_headers_in_notifications_enabled_input_input_input(
    input: &crate::operation::set_identity_headers_in_notifications_enabled::SetIdentityHeadersInNotificationsEnabledInput,
