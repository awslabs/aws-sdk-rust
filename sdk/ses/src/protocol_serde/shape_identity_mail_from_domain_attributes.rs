...
pub fn de_identity_mail_from_domain_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IdentityMailFromDomainAttributes, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
