...
pub fn de_identity_mail_from_domain_attributes(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::IdentityMailFromDomainAttributes, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::identity_mail_from_domain_attributes_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
