...
pub fn de_identity_verification_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IdentityVerificationAttributes, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
