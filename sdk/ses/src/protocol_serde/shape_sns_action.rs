...
#[allow(unused_mut)]
pub fn ser_sns_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SnsAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_sns_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SnsAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
