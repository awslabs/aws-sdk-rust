...
pub fn de_get_account_sending_enabled_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_account_sending_enabled::GetAccountSendingEnabledError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::get_account_sending_enabled::GetAccountSendingEnabledError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_account_sending_enabled_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_account_sending_enabled::de_get_account_sending_enabled(_response_body, output)
            .map_err(crate::operation::get_account_sending_enabled::GetAccountSendingEnabledError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("GetAccountSendingEnabledResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetAccountSendingEnabledResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetAccountSendingEnabledResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetAccountSendingEnabledResult got {start_el:?}"
            )));
        }
