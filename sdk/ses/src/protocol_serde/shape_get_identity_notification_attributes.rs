...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_identity_notification_attributes::de_get_identity_notification_attributes(_response_body, output)
            .map_err(crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_identity_notification_attributes_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesError::unhandled)?
    })
}
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetIdentityNotificationAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetIdentityNotificationAttributesResult got {start_el:?}"
            )));
        }
