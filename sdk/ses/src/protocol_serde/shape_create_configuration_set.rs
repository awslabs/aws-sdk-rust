...
pub fn de_create_configuration_set_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateConfigurationSetOutput, crate::error::CreateConfigurationSetError> {
    ...
    Err(match error_code {
        "ConfigurationSetAlreadyExists" => crate::error::CreateConfigurationSetError::ConfigurationSetAlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidConfigurationSet" => crate::error::CreateConfigurationSetError::InvalidConfigurationSetException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
