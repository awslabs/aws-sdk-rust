...
pub fn ser_send_bounce_input_input_input(input: &crate::operation::send_bounce::SendBounceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
