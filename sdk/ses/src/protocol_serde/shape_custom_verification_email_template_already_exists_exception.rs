...
#[allow(unused_mut)]
pub fn de_custom_verification_email_template_already_exists_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::CustomVerificationEmailTemplateAlreadyExistsExceptionBuilder) -> Result<crate::types::error::builders::CustomVerificationEmailTemplateAlreadyExistsExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
