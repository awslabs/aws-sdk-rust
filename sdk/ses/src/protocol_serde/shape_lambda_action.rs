...
#[allow(unused_mut)]
pub fn ser_lambda_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LambdaAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_lambda_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LambdaAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
