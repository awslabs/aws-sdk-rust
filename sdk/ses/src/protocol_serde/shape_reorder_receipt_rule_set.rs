...
pub fn de_reorder_receipt_rule_set_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reorder_receipt_rule_set_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError> {
    Ok({
        #[allow(unused_mut)]
