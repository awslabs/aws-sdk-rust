...
pub fn de_reorder_receipt_rule_set_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reorder_receipt_rule_set_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError> {
    Ok({
        #[allow(unused_mut)]
