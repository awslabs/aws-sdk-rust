...
pub fn de_reorder_receipt_rule_set_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reorder_receipt_rule_set_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetOutput, crate::operation::reorder_receipt_rule_set::ReorderReceiptRuleSetError> {
    Ok({
        #[allow(unused_mut)]
