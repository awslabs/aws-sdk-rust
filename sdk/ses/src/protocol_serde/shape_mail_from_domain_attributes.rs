...
pub fn de_mail_from_domain_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::collections::HashMap<std::string::String, crate::model::IdentityMailFromDomainAttributes>, aws_smithy_xml::decode::XmlDecodeError> {
...
pub fn de_mail_from_domain_attributes_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder, out: &mut std::collections::HashMap<std::string::String, crate::model::IdentityMailFromDomainAttributes>) -> Result<(), aws_smithy_xml::decode::XmlDecodeError> {
