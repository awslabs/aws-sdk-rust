    ...
    Err(match error_code {
        "CannotDelete" => crate::operation::delete_receipt_rule_set::DeleteReceiptRuleSetError::CannotDeleteException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_cannot_delete_exception::de_cannot_delete_exception_xml_err(_response_body, output)
                    .map_err(crate::operation::delete_receipt_rule_set::DeleteReceiptRuleSetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_receipt_rule_set_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
