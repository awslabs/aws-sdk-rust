...
#[allow(unused_mut)]
pub fn ser_receipt_rule(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ReceiptRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_receipt_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReceiptRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
