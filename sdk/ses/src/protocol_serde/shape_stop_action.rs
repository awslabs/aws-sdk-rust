...
#[allow(unused_mut)]
pub fn ser_stop_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::StopAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_stop_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StopAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
