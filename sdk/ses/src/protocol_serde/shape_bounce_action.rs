...
#[allow(unused_mut)]
pub fn ser_bounce_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::BounceAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_bounce_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BounceAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
