...
#[allow(unused_mut)]
pub fn ser_delivery_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DeliveryOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
