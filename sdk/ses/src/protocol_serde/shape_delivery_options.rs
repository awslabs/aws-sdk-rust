...
#[allow(unused_mut)]
pub fn ser_delivery_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DeliveryOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_delivery_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeliveryOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
