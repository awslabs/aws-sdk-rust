...
#[allow(unused_mut)]
pub fn de_invalid_s3_configuration_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::InvalidS3ConfigurationExceptionBuilder) -> Result<crate::types::error::builders::InvalidS3ConfigurationExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
