...
> {
    ...
    Err(match error_code {
        ...
        "ConfigurationSetDoesNotExist" => {
            crate::operation::send_templated_email::SendTemplatedEmailError::ConfigurationSetDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ConfigurationSetSendingPausedException" => {
            crate::operation::send_templated_email::SendTemplatedEmailError::ConfigurationSetSendingPausedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MailFromDomainNotVerifiedException" => {
            crate::operation::send_templated_email::SendTemplatedEmailError::MailFromDomainNotVerifiedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::send_templated_email::builders::SendTemplatedEmailOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("SendTemplatedEmailResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected SendTemplatedEmailResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("SendTemplatedEmailResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected SendTemplatedEmailResult got {start_el:?}"
            )));
        }
