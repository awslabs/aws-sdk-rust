...
#[allow(unused_mut)]
pub fn ser_workmail_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::WorkmailAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_workmail_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::WorkmailAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
