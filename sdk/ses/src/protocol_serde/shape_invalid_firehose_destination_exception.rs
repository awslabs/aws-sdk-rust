...
#[allow(unused_mut)]
pub fn de_invalid_firehose_destination_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::InvalidFirehoseDestinationExceptionBuilder) -> Result<crate::types::error::builders::InvalidFirehoseDestinationExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
