...
#[allow(unused_mut)]
pub fn ser_template(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Template) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_template(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Template, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
