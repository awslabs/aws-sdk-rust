...
pub fn ser_create_custom_verification_email_template_input_input(input: &crate::input::CreateCustomVerificationEmailTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
