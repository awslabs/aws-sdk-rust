...
pub fn de_create_receipt_filter_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_receipt_filter::CreateReceiptFilterOutput, crate::operation::create_receipt_filter::CreateReceiptFilterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_receipt_filter::CreateReceiptFilterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_receipt_filter_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_receipt_filter::CreateReceiptFilterOutput, crate::operation::create_receipt_filter::CreateReceiptFilterError> {
    Ok({
        #[allow(unused_mut)]
