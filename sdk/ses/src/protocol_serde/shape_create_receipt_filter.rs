...
pub fn de_create_receipt_filter_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_receipt_filter::CreateReceiptFilterOutput, crate::operation::create_receipt_filter::CreateReceiptFilterError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_receipt_filter_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_receipt_filter::CreateReceiptFilterOutput, crate::operation::create_receipt_filter::CreateReceiptFilterError> {
    Ok({
        #[allow(unused_mut)]
