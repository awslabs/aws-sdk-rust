...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_send_quota_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_send_quota::GetSendQuotaOutput, crate::operation::get_send_quota::GetSendQuotaError> {
    Ok({
        #[allow(unused_mut)]
