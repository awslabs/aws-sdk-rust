...
pub fn de_get_send_quota_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_send_quota::GetSendQuotaOutput, crate::operation::get_send_quota::GetSendQuotaError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_send_quota_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_send_quota::GetSendQuotaOutput, crate::operation::get_send_quota::GetSendQuotaError> {
    Ok({
        #[allow(unused_mut)]
