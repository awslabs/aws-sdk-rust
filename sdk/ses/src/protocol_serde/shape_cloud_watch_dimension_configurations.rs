...
pub fn de_cloud_watch_dimension_configurations(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::CloudWatchDimensionConfiguration>, aws_smithy_xml::decode::XmlDecodeError> {
