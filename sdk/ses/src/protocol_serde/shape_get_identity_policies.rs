...
> {
    Ok({
        ...
        crate::serde_util::get_identity_policies_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_identity_policies::GetIdentityPoliciesError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_identity_policies::builders::GetIdentityPoliciesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
