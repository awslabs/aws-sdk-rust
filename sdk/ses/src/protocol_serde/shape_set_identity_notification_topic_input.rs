...
pub fn ser_set_identity_notification_topic_input_input_input(input: &crate::operation::set_identity_notification_topic::SetIdentityNotificationTopicInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
