...
pub fn ser_send_email_input_input(input: &crate::input::SendEmailInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
