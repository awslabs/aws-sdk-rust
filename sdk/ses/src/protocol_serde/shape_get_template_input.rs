...
pub fn ser_get_template_input_input(input: &crate::input::GetTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
