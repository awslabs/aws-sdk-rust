...
pub fn de_identity_dkim_attributes(
...
) -> ::std::result::Result<crate::types::IdentityDkimAttributes, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    Ok(crate::serde_util::identity_dkim_attributes_correct_errors(builder)
        .build()
