...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_identity_dkim_attributes_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_identity_dkim_attributes::de_get_identity_dkim_attributes(_response_body, output)
            .map_err(crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_identity_dkim_attributes_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesError::unhandled)?
    })
}
...
#[allow(unused_mut)]
pub fn de_get_identity_dkim_attributes(
    inp: &[u8],
    mut builder: crate::operation::get_identity_dkim_attributes::builders::GetIdentityDkimAttributesOutputBuilder,
) -> Result<crate::operation::get_identity_dkim_attributes::builders::GetIdentityDkimAttributesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
