...
pub fn de_send_raw_email_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::send_raw_email::SendRawEmailOutput, crate::operation::send_raw_email::SendRawEmailError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::send_raw_email::SendRawEmailError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_raw_email_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::send_raw_email::SendRawEmailOutput, crate::operation::send_raw_email::SendRawEmailError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::send_raw_email::builders::SendRawEmailOutputBuilder::default();
        output = crate::protocol_serde::shape_send_raw_email::de_send_raw_email(_response_body, output).map_err(crate::operation::send_raw_email::SendRawEmailError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::send_raw_email_output_output_correct_errors(output).build().map_err(crate::operation::send_raw_email::SendRawEmailError::unhandled)?
    })
}
