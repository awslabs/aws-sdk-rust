...
pub fn de_send_raw_email_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::send_raw_email::SendRawEmailOutput, crate::operation::send_raw_email::SendRawEmailError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_raw_email_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::send_raw_email::SendRawEmailOutput, crate::operation::send_raw_email::SendRawEmailError> {
    Ok({
        #[allow(unused_mut)]
