...
pub fn ser_update_configuration_set_event_destination_input_input(input: &crate::input::UpdateConfigurationSetEventDestinationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
