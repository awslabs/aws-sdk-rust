...
#[allow(unused_mut)]
pub fn de_rule_set_does_not_exist_exception_xml_err(inp: &[u8], mut builder: crate::error::rule_set_does_not_exist_exception::Builder) -> Result<crate::error::rule_set_does_not_exist_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
