...
#[allow(unused_mut)]
pub fn ser_kinesis_firehose_destination(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::KinesisFirehoseDestination) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_kinesis_firehose_destination(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::KinesisFirehoseDestination, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
