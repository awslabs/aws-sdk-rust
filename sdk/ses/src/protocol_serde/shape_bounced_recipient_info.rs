...
#[allow(unused_mut)]
pub fn ser_bounced_recipient_info(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::BouncedRecipientInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
