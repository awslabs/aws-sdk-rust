...
pub fn de_bulk_email_destination_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BulkEmailDestinationStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
