...
#[allow(unused_mut)]
pub fn de_invalid_lambda_function_exception_xml_err(inp: &[u8], mut builder: crate::error::invalid_lambda_function_exception::Builder) -> Result<crate::error::invalid_lambda_function_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
