...
pub fn de_custom_verification_email_template(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CustomVerificationEmailTemplate, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
