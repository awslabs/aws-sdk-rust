...
#[allow(unused_mut)]
pub fn de_already_exists_exception_xml_err(inp: &[u8], mut builder: crate::error::already_exists_exception::Builder) -> Result<crate::error::already_exists_exception::Builder, aws_smithy_xml::decode::XmlDecodeError> {
