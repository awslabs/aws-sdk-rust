...
#[allow(unused_mut)]
pub fn de_already_exists_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::AlreadyExistsExceptionBuilder) -> Result<crate::types::error::builders::AlreadyExistsExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
