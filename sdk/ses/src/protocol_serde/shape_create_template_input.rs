...
pub fn ser_create_template_input_input(input: &crate::input::CreateTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
