...
pub fn ser_create_template_input_input(input: &crate::operation::create_template::CreateTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
