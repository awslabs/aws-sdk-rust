...
pub fn ser_send_raw_email_input_input_input(input: &crate::operation::send_raw_email::SendRawEmailInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
