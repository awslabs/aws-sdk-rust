...
#[allow(unused_mut)]
pub fn ser_message_dsn(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MessageDsn) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
