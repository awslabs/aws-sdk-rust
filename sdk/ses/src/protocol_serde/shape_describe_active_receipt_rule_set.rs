...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_active_receipt_rule_set::de_describe_active_receipt_rule_set(_response_body, output)
            .map_err(crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeActiveReceiptRuleSetResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeActiveReceiptRuleSetResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeActiveReceiptRuleSetResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeActiveReceiptRuleSetResult got {start_el:?}"
            )));
        }
