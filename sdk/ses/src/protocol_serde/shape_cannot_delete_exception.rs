...
#[allow(unused_mut)]
pub fn de_cannot_delete_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::CannotDeleteExceptionBuilder) -> Result<crate::types::error::builders::CannotDeleteExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
