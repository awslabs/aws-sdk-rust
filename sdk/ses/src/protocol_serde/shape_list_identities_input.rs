...
pub fn ser_list_identities_input_input_input(input: &crate::operation::list_identities::ListIdentitiesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
