...
pub fn ser_list_identities_input_input(input: &crate::input::ListIdentitiesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
