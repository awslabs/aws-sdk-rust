...
#[allow(unused_mut)]
pub fn ser_recipient_dsn_fields(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::RecipientDsnFields) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
