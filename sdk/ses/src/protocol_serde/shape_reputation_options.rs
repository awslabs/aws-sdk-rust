...
pub fn de_reputation_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReputationOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
