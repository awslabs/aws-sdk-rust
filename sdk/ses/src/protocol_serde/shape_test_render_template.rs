...
pub fn de_test_render_template_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::test_render_template::TestRenderTemplateOutput, crate::operation::test_render_template::TestRenderTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::test_render_template::TestRenderTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_test_render_template_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::test_render_template::TestRenderTemplateOutput, crate::operation::test_render_template::TestRenderTemplateError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::test_render_template::builders::TestRenderTemplateOutputBuilder::default();
        output = crate::protocol_serde::shape_test_render_template::de_test_render_template(_response_body, output).map_err(crate::operation::test_render_template::TestRenderTemplateError::unhandled)?;
