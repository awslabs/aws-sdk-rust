...
pub fn de_test_render_template_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::test_render_template::TestRenderTemplateOutput, crate::operation::test_render_template::TestRenderTemplateError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_test_render_template_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::test_render_template::TestRenderTemplateOutput, crate::operation::test_render_template::TestRenderTemplateError> {
    Ok({
        #[allow(unused_mut)]
