...
#[allow(unused_mut)]
pub fn de_rule_does_not_exist_exception_xml_err(inp: &[u8], mut builder: crate::types::error::builders::RuleDoesNotExistExceptionBuilder) -> Result<crate::types::error::builders::RuleDoesNotExistExceptionBuilder, aws_smithy_xml::decode::XmlDecodeError> {
