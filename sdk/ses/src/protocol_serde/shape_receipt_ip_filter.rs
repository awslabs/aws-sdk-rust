...
#[allow(unused_mut)]
pub fn ser_receipt_ip_filter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ReceiptIpFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_receipt_ip_filter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReceiptIpFilter, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
