...
pub fn de_template_metadata(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TemplateMetadata, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::TemplateMetadata::builder();
