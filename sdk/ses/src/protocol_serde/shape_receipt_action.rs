...
#[allow(unused_mut)]
pub fn ser_receipt_action(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ReceiptAction) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
