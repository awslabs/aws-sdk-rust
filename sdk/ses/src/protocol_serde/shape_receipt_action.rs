...
#[allow(unused_mut)]
pub fn ser_receipt_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ReceiptAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_receipt_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReceiptAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
