...
pub fn ser_send_templated_email_input_input(input: &crate::input::SendTemplatedEmailInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
