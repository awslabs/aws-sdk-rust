...
pub fn ser_send_templated_email_input_input_input(input: &crate::operation::send_templated_email::SendTemplatedEmailInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
