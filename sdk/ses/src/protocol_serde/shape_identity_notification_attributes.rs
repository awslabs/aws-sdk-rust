...
pub fn de_identity_notification_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IdentityNotificationAttributes, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
