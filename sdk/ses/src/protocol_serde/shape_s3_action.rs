...
#[allow(unused_mut)]
pub fn ser_s3_action(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::S3Action) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_s3_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::S3Action, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
