...
#[allow(unused_mut)]
pub fn serialize_structure_configuration_set(
...
#[allow(unused_mut)]
pub fn serialize_structure_event_destination(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_12) = &input.kinesis_firehose_destination {
        crate::query_ser::serialize_structure_kinesis_firehose_destination(scope_11, var_12);
    }
    #[allow(unused_mut)]
    let mut scope_13 = writer.prefix("CloudWatchDestination");
    if let Some(var_14) = &input.cloud_watch_destination {
        crate::query_ser::serialize_structure_cloud_watch_destination(scope_13, var_14);
    }
    #[allow(unused_mut)]
    let mut scope_15 = writer.prefix("SNSDestination");
    if let Some(var_16) = &input.sns_destination {
        crate::query_ser::serialize_structure_sns_destination(scope_15, var_16);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_receipt_filter(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_22) = &input.ip_filter {
        crate::query_ser::serialize_structure_receipt_ip_filter(scope_21, var_22);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_receipt_rule(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_34) = &input.actions {
        ...
        for item_35 in var_34 {
            ...
            crate::query_ser::serialize_structure_receipt_action(entry_37, item_35);
        }
        list_36.finish();
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_message_dsn(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_52) = &input.arrival_date {
        scope_51.instant(var_52, smithy_types::instant::Format::DateTime);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_54) = &input.extension_fields {
        ...
        for item_55 in var_54 {
            ...
            crate::query_ser::serialize_structure_extension_field(entry_57, item_55);
        }
        list_56.finish();
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_bounced_recipient_info(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_65) = &input.recipient_dsn_fields {
        crate::query_ser::serialize_structure_recipient_dsn_fields(scope_64, var_65);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_bulk_email_destination(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_71) = &input.destination {
        crate::query_ser::serialize_structure_destination(scope_70, var_71);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_73) = &input.replacement_tags {
        ...
        for item_74 in var_73 {
            ...
            crate::query_ser::serialize_structure_message_tag(entry_76, item_74);
        }
        list_75.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_message(
    ...
    if let Some(var_95) = &input.subject {
        crate::query_ser::serialize_structure_content(scope_94, var_95);
    }
    #[allow(unused_mut)]
    let mut scope_96 = writer.prefix("Body");
    if let Some(var_97) = &input.body {
        crate::query_ser::serialize_structure_body(scope_96, var_97);
    }
}
...
pub fn serialize_structure_raw_message(
    ...
    if let Some(var_99) = &input.data {
        scope_98.string(&smithy_types::base64::encode(var_99));
    }
}
...
pub fn serialize_structure_cloud_watch_destination(
    ...
    if let Some(var_105) = &input.dimension_configurations {
        ...
        for item_106 in var_105 {
            ...
            crate::query_ser::serialize_structure_cloud_watch_dimension_configuration(
                entry_108, item_106,
            );
        }
        list_107.finish();
...
#[allow(unused_mut)]
pub fn serialize_structure_receipt_ip_filter(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_receipt_action(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_116) = &input.s3_action {
        crate::query_ser::serialize_structure_s3_action(scope_115, var_116);
    }
    #[allow(unused_mut)]
    let mut scope_117 = writer.prefix("BounceAction");
    if let Some(var_118) = &input.bounce_action {
        crate::query_ser::serialize_structure_bounce_action(scope_117, var_118);
    }
    #[allow(unused_mut)]
    let mut scope_119 = writer.prefix("WorkmailAction");
    if let Some(var_120) = &input.workmail_action {
        crate::query_ser::serialize_structure_workmail_action(scope_119, var_120);
    }
    #[allow(unused_mut)]
    let mut scope_121 = writer.prefix("LambdaAction");
    if let Some(var_122) = &input.lambda_action {
        crate::query_ser::serialize_structure_lambda_action(scope_121, var_122);
    }
    #[allow(unused_mut)]
    let mut scope_123 = writer.prefix("StopAction");
    if let Some(var_124) = &input.stop_action {
        crate::query_ser::serialize_structure_stop_action(scope_123, var_124);
    }
    #[allow(unused_mut)]
    let mut scope_125 = writer.prefix("AddHeaderAction");
    if let Some(var_126) = &input.add_header_action {
        crate::query_ser::serialize_structure_add_header_action(scope_125, var_126);
    }
    #[allow(unused_mut)]
    let mut scope_127 = writer.prefix("SNSAction");
    if let Some(var_128) = &input.sns_action {
        crate::query_ser::serialize_structure_sns_action(scope_127, var_128);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_extension_field(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_recipient_dsn_fields(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_144) = &input.last_attempt_date {
        scope_143.instant(var_144, smithy_types::instant::Format::DateTime);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_146) = &input.extension_fields {
        ...
        for item_147 in var_146 {
            ...
            crate::query_ser::serialize_structure_extension_field(entry_149, item_147);
        }
        list_148.finish();
    }
}
...
pub fn serialize_structure_body(
    ...
    if let Some(var_155) = &input.text {
        crate::query_ser::serialize_structure_content(scope_154, var_155);
    }
    #[allow(unused_mut)]
    let mut scope_156 = writer.prefix("Html");
    if let Some(var_157) = &input.html {
        crate::query_ser::serialize_structure_content(scope_156, var_157);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_bounce_action(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_workmail_action(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_stop_action(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_add_header_action(
    mut writer: smithy_query::QueryValueWriter,
