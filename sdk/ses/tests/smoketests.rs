...
//! ```
//!
use aws_sdk_ses::{config, Client};
/// Smoke tests for the `list_identities` operation
#[::tokio::test]
async fn test_list_identities_success() {
    ...
    let res = client.list_identities().send().await;
