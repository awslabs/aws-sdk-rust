...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::add_application_output::builders::AddApplicationOutputFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::add_application_output::builders::AddApplicationOutputFluentBuilder::set_application_name): <p>Name of the application to which you want to add the output configuration.</p>
