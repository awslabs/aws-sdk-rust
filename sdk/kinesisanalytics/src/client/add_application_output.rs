...
impl super::Client {
    ...
    ///   - [`application_name(impl Into<String>)`](crate::operation::add_application_output::builders::AddApplicationOutputFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::add_application_output::builders::AddApplicationOutputFluentBuilder::set_application_name):<br>required: **true**<br><p>Name of the application to which you want to add the output configuration.</p><br>
    ///   - [`current_application_version_id(i64)`](crate::operation::add_application_output::builders::AddApplicationOutputFluentBuilder::current_application_version_id) / [`set_current_application_version_id(Option<i64>)`](crate::operation::add_application_output::builders::AddApplicationOutputFluentBuilder::set_current_application_version_id):<br>required: **true**<br><p>Version of the application to which you want to add the output configuration. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to get the current application version. If the version specified is not the current version, the <code>ConcurrentModificationException</code> is returned.</p><br>
