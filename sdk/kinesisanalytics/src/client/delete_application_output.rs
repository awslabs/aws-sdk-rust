...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::delete_application_output::builders::DeleteApplicationOutputFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::delete_application_output::builders::DeleteApplicationOutputFluentBuilder::set_application_name): <p>Amazon Kinesis Analytics application name.</p>
