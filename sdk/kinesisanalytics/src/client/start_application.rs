...
impl super::Client {
    ...
    ///   - [`input_configurations(InputConfiguration)`](crate::operation::start_application::builders::StartApplicationFluentBuilder::input_configurations) / [`set_input_configurations(Option<Vec<InputConfiguration>>)`](crate::operation::start_application::builders::StartApplicationFluentBuilder::set_input_configurations): <p>Identifies the specific input, by ID, that the application starts consuming. Amazon Kinesis Analytics starts reading the streaming source associated with the input. You can also specify where in the streaming source you want Amazon Kinesis Analytics to start reading.</p>
