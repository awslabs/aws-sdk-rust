...
pub(crate) fn de_source_schema<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::SourceSchema>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "RecordFormat" => {
                                builder = builder.set_record_format(
                                    crate::protocol_serde::shape_record_format::de_record_format(tokens)?
                                );
                            }
                            "RecordEncoding" => {
                            ...
                            "RecordColumns" => {
                                builder = builder.set_record_columns(
                                    crate::protocol_serde::shape_record_columns::de_record_columns(tokens)?
                                );
                            }
