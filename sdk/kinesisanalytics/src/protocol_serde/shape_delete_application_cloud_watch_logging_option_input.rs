...
pub fn ser_delete_application_cloud_watch_logging_option_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteApplicationCloudWatchLoggingOptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
