...
pub fn ser_reference_data_source_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceDataSourceUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
