...
pub(crate) fn de_input_starting_position_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::InputStartingPositionConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_input_starting_position(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::InputStartingPosition::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
