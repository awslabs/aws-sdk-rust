...
pub fn ser_add_application_output_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddApplicationOutputInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
