...
pub fn ser_output_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutputUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
