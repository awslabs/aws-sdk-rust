...
pub fn ser_application_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ApplicationUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
