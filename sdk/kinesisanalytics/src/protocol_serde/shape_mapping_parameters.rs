...
pub(crate) fn de_mapping_parameters<'a, I>(
    ...
    Option<crate::types::MappingParameters>,
...
pub fn ser_mapping_parameters(
    ...
    if let Some(var_1) = &input.json_mapping_parameters {
        ...
        crate::protocol_serde::shape_json_mapping_parameters::ser_json_mapping_parameters(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.csv_mapping_parameters {
        ...
        crate::protocol_serde::shape_csv_mapping_parameters::ser_csv_mapping_parameters(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
