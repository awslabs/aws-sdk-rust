...
pub fn ser_s3_reference_data_source_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3ReferenceDataSourceUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
