...
pub fn ser_s3_reference_data_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3ReferenceDataSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
