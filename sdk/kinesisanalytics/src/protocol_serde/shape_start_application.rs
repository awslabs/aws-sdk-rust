...
pub fn ser_start_application_input(
    input: &crate::operation::start_application::StartApplicationInput,
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_unsupported_operation_exception::de_unsupported_operation_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::start_application::StartApplicationError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
