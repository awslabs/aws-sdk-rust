...
pub fn de_start_application_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::start_application::StartApplicationOutput, crate::operation::start_application::StartApplicationError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "InvalidApplicationConfigurationException" => {
            crate::operation::start_application::StartApplicationError::InvalidApplicationConfigurationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
