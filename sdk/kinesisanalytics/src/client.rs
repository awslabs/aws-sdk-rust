    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`application_name(Option<String>)`](crate::input::AddApplicationCloudWatchLoggingOptionInput::application_name): <p>The Kinesis Analytics application name.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::AddApplicationCloudWatchLoggingOptionInput::current_application_version_id): <p>The version ID of the Kinesis Analytics application.</p>
    ///   - [`cloud_watch_logging_option(Option<CloudWatchLoggingOption>)`](crate::input::AddApplicationCloudWatchLoggingOptionInput::cloud_watch_logging_option): <p>Provides the CloudWatch log stream Amazon Resource Name (ARN) and the IAM role ARN. Note: To write application messages to CloudWatch, the IAM role that is used must have the <code>PutLogEvents</code> policy action enabled.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::AddApplicationInputInput::application_name): <p>Name of your existing Amazon Kinesis Analytics application to which you want to add the streaming source.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::AddApplicationInputInput::current_application_version_id): <p>Current version of your Amazon Kinesis Analytics application. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to find the current application version.</p>
    ///   - [`input(Option<Input>)`](crate::input::AddApplicationInputInput::input): <p>The <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_Input.html">Input</a> to add.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::AddApplicationInputProcessingConfigurationInput::application_name): <p>Name of the application to which you want to add the input processing configuration.</p>
    ...
    ///   - [`input_id(Option<String>)`](crate::input::AddApplicationInputProcessingConfigurationInput::input_id): <p>The ID of the input configuration to add the input processing configuration to. You can get a list of the input IDs for an application using the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation.</p>
    ///   - [`input_processing_configuration(Option<InputProcessingConfiguration>)`](crate::input::AddApplicationInputProcessingConfigurationInput::input_processing_configuration): <p>The <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputProcessingConfiguration.html">InputProcessingConfiguration</a> to add to the application.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::AddApplicationOutputInput::application_name): <p>Name of the application to which you want to add the output configuration.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::AddApplicationOutputInput::current_application_version_id): <p>Version of the application to which you want to add the output configuration. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to get the current application version. If the version specified is not the current version, the <code>ConcurrentModificationException</code> is returned. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::AddApplicationReferenceDataSourceInput::application_name): <p>Name of an existing application.</p>
    ...
    ///   - [`reference_data_source(Option<ReferenceDataSource>)`](crate::input::AddApplicationReferenceDataSourceInput::reference_data_source): <p>The reference data source can be an object in your Amazon S3 bucket. Amazon Kinesis Analytics reads the object and copies the data into the in-application table that is created. You provide an S3 bucket, object key name, and the resulting in-application table that is created. You must also provide an IAM role with the necessary permissions that Amazon Kinesis Analytics can assume to read the object from your S3 bucket on your behalf.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DeleteApplicationInput::application_name): <p>Name of the Amazon Kinesis Analytics application to delete.</p>
    ///   - [`create_timestamp(Option<DateTime>)`](crate::input::DeleteApplicationInput::create_timestamp): <p> You can use the <code>DescribeApplication</code> operation to get this value. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DeleteApplicationCloudWatchLoggingOptionInput::application_name): <p>The Kinesis Analytics application name.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::DeleteApplicationCloudWatchLoggingOptionInput::current_application_version_id): <p>The version ID of the Kinesis Analytics application.</p>
    ///   - [`cloud_watch_logging_option_id(Option<String>)`](crate::input::DeleteApplicationCloudWatchLoggingOptionInput::cloud_watch_logging_option_id): <p>The <code>CloudWatchLoggingOptionId</code> of the CloudWatch logging option to delete. You can get the <code>CloudWatchLoggingOptionId</code> by using the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DeleteApplicationInputProcessingConfigurationInput::application_name): <p>The Kinesis Analytics application name.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::DeleteApplicationInputProcessingConfigurationInput::current_application_version_id): <p>The version ID of the Kinesis Analytics application.</p>
    ///   - [`input_id(Option<String>)`](crate::input::DeleteApplicationInputProcessingConfigurationInput::input_id): <p>The ID of the input configuration from which to delete the input processing configuration. You can get a list of the input IDs for an application by using the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DeleteApplicationOutputInput::application_name): <p>Amazon Kinesis Analytics application name.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::DeleteApplicationOutputInput::current_application_version_id): <p>Amazon Kinesis Analytics application version. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to get the current application version. If the version specified is not the current version, the <code>ConcurrentModificationException</code> is returned. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DeleteApplicationReferenceDataSourceInput::application_name): <p>Name of an existing application.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::DeleteApplicationReferenceDataSourceInput::current_application_version_id): <p>Version of the application. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to get the current application version. If the version specified is not the current version, the <code>ConcurrentModificationException</code> is returned.</p>
    ///   - [`reference_id(Option<String>)`](crate::input::DeleteApplicationReferenceDataSourceInput::reference_id): <p>ID of the reference data source. When you add a reference data source to your application using the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_AddApplicationReferenceDataSource.html">AddApplicationReferenceDataSource</a>, Amazon Kinesis Analytics assigns an ID. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to get the reference ID. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DescribeApplicationInput::application_name): <p>Name of the application.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::DiscoverInputSchemaInput::resource_arn): <p>Amazon Resource Name (ARN) of the streaming source.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::DiscoverInputSchemaInput::role_arn): <p>ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on your behalf.</p>
    ///   - [`input_starting_position_configuration(Option<InputStartingPositionConfiguration>)`](crate::input::DiscoverInputSchemaInput::input_starting_position_configuration): <p>Point at which you want Amazon Kinesis Analytics to start reading records from the specified streaming source discovery purposes.</p>
    ...
    ///   - [`input_processing_configuration(Option<InputProcessingConfiguration>)`](crate::input::DiscoverInputSchemaInput::input_processing_configuration): <p>The <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputProcessingConfiguration.html">InputProcessingConfiguration</a> to use to preprocess the records before discovering the schema of the records.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::StartApplicationInput::application_name): <p>Name of the application.</p>
    ///   - [`input_configurations(Option<Vec<InputConfiguration>>)`](crate::input::StartApplicationInput::input_configurations): <p>Identifies the specific input, by ID, that the application starts consuming. Amazon Kinesis Analytics starts reading the streaming source associated with the input. You can also specify where in the streaming source you want Amazon Kinesis Analytics to start reading.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::StopApplicationInput::application_name): <p>Name of the running application to stop.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The ARN of the Kinesis Analytics application from which to remove the tags.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::UpdateApplicationInput::application_name): <p>Name of the Amazon Kinesis Analytics application to update.</p>
    ///   - [`current_application_version_id(Option<i64>)`](crate::input::UpdateApplicationInput::current_application_version_id): <p>The current application version ID. You can use the <a href="https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html">DescribeApplication</a> operation to get this value.</p>
    ///   - [`application_update(Option<ApplicationUpdate>)`](crate::input::UpdateApplicationInput::application_update): <p>Describes application updates.</p>
