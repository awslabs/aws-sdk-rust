...
impl AddApplicationReferenceDataSourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::add_application_reference_data_source::AddApplicationReferenceDataSource,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_application_reference_data_source::AddApplicationReferenceDataSource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddApplicationReferenceDataSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_application_reference_data_source::de_add_application_reference_data_source_http_response_with_props(
                status, headers, body,
            )
        }
    }
