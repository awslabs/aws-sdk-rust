...
impl StartApplicationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_application::StartApplication, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_application::ser_start_application_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_application::de_start_application_http_response_with_props(status, headers, body)
        }
    }
}
