...
impl DescribeApplicationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_application::ser_describe_application_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_application::de_describe_application_http_response_with_props(status, headers, body)
        }
    }
}
