...
impl AddApplicationOutputFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_application_output::AddApplicationOutputOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_application_output::AddApplicationOutputError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_application_output::AddApplicationOutputOutput, crate::operation::add_application_output::AddApplicationOutputError, Self> {
