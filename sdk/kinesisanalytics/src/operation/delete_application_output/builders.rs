...
impl DeleteApplicationOutputFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_application_output::DeleteApplicationOutputOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_application_output::DeleteApplicationOutputError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_application_output::DeleteApplicationOutputOutput, crate::operation::delete_application_output::DeleteApplicationOutputError, Self> {
