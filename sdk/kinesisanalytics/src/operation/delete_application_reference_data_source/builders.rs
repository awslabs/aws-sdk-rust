...
impl DeleteApplicationReferenceDataSourceInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSourceOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSourceError, ::aws_smithy_http::operation::Response>>
