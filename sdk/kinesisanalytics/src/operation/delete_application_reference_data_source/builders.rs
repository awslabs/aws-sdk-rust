...
impl DeleteApplicationReferenceDataSourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSource::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSourceOutput, crate::operation::delete_application_reference_data_source::DeleteApplicationReferenceDataSourceError, Self> {
