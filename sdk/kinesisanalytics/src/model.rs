...
pub struct ApplicationUpdate  {
    ...
    #[doc(hidden)]pub application_code_update: std::option::Option<std::string::String>,
...
pub struct CloudWatchLoggingOptionUpdate  {
    ...
    #[doc(hidden)]pub role_arn_update: std::option::Option<std::string::String>,
}
...
pub struct S3ReferenceDataSourceUpdate  {
    ...
    #[doc(hidden)]pub reference_role_arn_update: std::option::Option<std::string::String>,
}
