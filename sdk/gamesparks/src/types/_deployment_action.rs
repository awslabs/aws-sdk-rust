...
impl ::std::convert::From<&str> for DeploymentAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeploymentAction::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeploymentAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
