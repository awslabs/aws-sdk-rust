...
impl ::std::convert::From<&str> for StageState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StageState::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StageState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StageState::from(s))
    }
}
impl StageState {
...
impl ::std::convert::AsRef<str> for StageState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
