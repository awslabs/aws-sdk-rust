...
impl ::std::convert::From<&str> for GameState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameState::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameState::from(s))
    }
}
impl GameState {
...
impl ::std::convert::AsRef<str> for GameState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
