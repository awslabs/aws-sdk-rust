...
impl ::std::convert::From<&str> for GeneratedCodeJobState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GeneratedCodeJobState::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GeneratedCodeJobState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GeneratedCodeJobState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GeneratedCodeJobState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
