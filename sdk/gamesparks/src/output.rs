...
pub struct UpdateStageOutput  {
    ...
    #[doc(hidden)]pub stage: std::option::Option<crate::model::StageDetails>,
}
...
pub struct UpdateSnapshotOutput  {
    ...
    #[doc(hidden)]pub snapshot: std::option::Option<crate::model::SnapshotDetails>,
}
...
pub mod update_snapshot_output {
    ...
    impl Builder {
        ...
        /// <p>Properties that provide details of the updated snapshot.</p>
        pub fn set_snapshot(mut self, input: std::option::Option<crate::model::SnapshotDetails>) -> Self {
...
pub struct UpdateGameConfigurationOutput  {
    ...
    #[doc(hidden)]pub game_configuration: std::option::Option<crate::model::GameConfigurationDetails>,
}
impl UpdateGameConfigurationOutput {
    /// <p>Details about the game configuration.</p>
    pub fn game_configuration(&self) -> std::option::Option<& crate::model::GameConfigurationDetails> {
...
pub mod update_game_configuration_output {
    ...
    impl Builder {
        ...
        /// <p>Details about the game configuration.</p>
        pub fn set_game_configuration(mut self, input: std::option::Option<crate::model::GameConfigurationDetails>) -> Self {
...
pub struct UpdateGameOutput  {
    ...
    #[doc(hidden)]pub game: std::option::Option<crate::model::GameDetails>,
}
...
pub struct StartStageDeploymentOutput  {
    ...
    #[doc(hidden)]pub stage_deployment: std::option::Option<crate::model::StageDeploymentDetails>,
}
...
pub mod start_stage_deployment_output {
    ...
    impl Builder {
        ...
        /// <p>Properties that describe the stage deployment.</p>
        pub fn set_stage_deployment(mut self, input: std::option::Option<crate::model::StageDeploymentDetails>) -> Self {
...
pub struct StartGeneratedCodeJobOutput  {
    ...
    #[doc(hidden)]pub generated_code_job_id: std::option::Option<std::string::String>,
}
...
pub struct ListStagesOutput  {
    ...
    #[doc(hidden)]pub stages: std::option::Option<std::vec::Vec<crate::model::StageSummary>>,
...
pub mod list_stages_output {
    ...
    impl Builder {
        ...
        /// <p> A list of stage summaries. You can use the stage names in the <code>UpdateStage</code> and <code>GetStage</code> actions. </p>
        pub fn set_stages(mut self, input: std::option::Option<std::vec::Vec<crate::model::StageSummary>>) -> Self {
...
pub struct ListStageDeploymentsOutput  {
    ...
    #[doc(hidden)]pub stage_deployments: std::option::Option<std::vec::Vec<crate::model::StageDeploymentSummary>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListStageDeploymentsOutput {
    /// <p> A list of stage deployment summaries. You can use the deployment IDs in the <code>UpdateStageDeployment</code> and <code>GetStageDeployment</code> actions. </p>
    pub fn stage_deployments(&self) -> std::option::Option<& [crate::model::StageDeploymentSummary]> {
...
pub mod list_stage_deployments_output {
    ...
    impl Builder {
        ...
        /// <p> A list of stage deployment summaries. You can use the deployment IDs in the <code>UpdateStageDeployment</code> and <code>GetStageDeployment</code> actions. </p>
        pub fn set_stage_deployments(mut self, input: std::option::Option<std::vec::Vec<crate::model::StageDeploymentSummary>>) -> Self {
...
pub struct ListSnapshotsOutput  {
    ...
    #[doc(hidden)]pub snapshots: std::option::Option<std::vec::Vec<crate::model::SnapshotSummary>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_snapshots_output {
    ...
    impl Builder {
        ...
        /// <p> A list of snapshot summaries. You can use the returned snapshot IDs in the <code>UpdateSnapshot</code> and <code>GetSnapshot</code> operations. </p>
        pub fn set_snapshots(mut self, input: std::option::Option<std::vec::Vec<crate::model::SnapshotSummary>>) -> Self {
...
pub struct ListGeneratedCodeJobsOutput  {
    ...
    #[doc(hidden)]pub generated_code_jobs: std::option::Option<std::vec::Vec<crate::model::GeneratedCodeJobDetails>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListGeneratedCodeJobsOutput {
    /// <p>The list of generated code jobs.</p>
    pub fn generated_code_jobs(&self) -> std::option::Option<& [crate::model::GeneratedCodeJobDetails]> {
...
pub mod list_generated_code_jobs_output {
    ...
    impl Builder {
        ...
        /// <p>The list of generated code jobs.</p>
        pub fn set_generated_code_jobs(mut self, input: std::option::Option<std::vec::Vec<crate::model::GeneratedCodeJobDetails>>) -> Self {
...
pub struct ListGamesOutput  {
    ...
    #[doc(hidden)]pub games: std::option::Option<std::vec::Vec<crate::model::GameSummary>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_games_output {
    ...
    impl Builder {
        ...
        /// <p>The list of games.</p>
        pub fn set_games(mut self, input: std::option::Option<std::vec::Vec<crate::model::GameSummary>>) -> Self {
...
pub struct ListExtensionVersionsOutput  {
    ...
    #[doc(hidden)]pub extension_versions: std::option::Option<std::vec::Vec<crate::model::ExtensionVersionDetails>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListExtensionVersionsOutput {
    /// <p>The list of extension versions.</p>
    pub fn extension_versions(&self) -> std::option::Option<& [crate::model::ExtensionVersionDetails]> {
...
pub mod list_extension_versions_output {
    ...
    impl Builder {
        ...
        /// <p>The list of extension versions.</p>
        pub fn set_extension_versions(mut self, input: std::option::Option<std::vec::Vec<crate::model::ExtensionVersionDetails>>) -> Self {
...
pub struct ListExtensionsOutput  {
    ...
    #[doc(hidden)]pub extensions: std::option::Option<std::vec::Vec<crate::model::ExtensionDetails>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_extensions_output {
    ...
    impl Builder {
        ...
        /// <p>The list of extensions.</p>
        pub fn set_extensions(mut self, input: std::option::Option<std::vec::Vec<crate::model::ExtensionDetails>>) -> Self {
...
pub struct GetGeneratedCodeJobOutput  {
    ...
    #[doc(hidden)]pub generated_code_job: std::option::Option<crate::model::GeneratedCodeJobDetails>,
}
impl GetGeneratedCodeJobOutput {
    /// <p>Details about the generated code job.</p>
    pub fn generated_code_job(&self) -> std::option::Option<& crate::model::GeneratedCodeJobDetails> {
...
pub mod get_generated_code_job_output {
    ...
    impl Builder {
        ...
        /// <p>Details about the generated code job.</p>
        pub fn set_generated_code_job(mut self, input: std::option::Option<crate::model::GeneratedCodeJobDetails>) -> Self {
...
pub struct GetExtensionVersionOutput  {
    ...
    #[doc(hidden)]pub extension_version: std::option::Option<crate::model::ExtensionVersionDetails>,
}
...
pub mod get_extension_version_output {
    ...
    impl Builder {
        ...
        /// <p>The version of the extension.</p>
        pub fn set_extension_version(mut self, input: std::option::Option<crate::model::ExtensionVersionDetails>) -> Self {
...
pub struct GetExtensionOutput  {
    ...
    #[doc(hidden)]pub extension: std::option::Option<crate::model::ExtensionDetails>,
}
...
pub mod get_extension_output {
    ...
    impl Builder {
        ...
        /// <p>Details about the extension.</p>
        pub fn set_extension(mut self, input: std::option::Option<crate::model::ExtensionDetails>) -> Self {
...
pub struct ExportSnapshotOutput  {
    ...
    #[doc(hidden)]pub s3_url: std::option::Option<std::string::String>,
}
...
pub struct DisconnectPlayerOutput  {
    ...
    #[doc(hidden)]pub disconnect_successes: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The list of the connection ids that could not be disconnected.</p>
    #[doc(hidden)]pub disconnect_failures: std::option::Option<std::vec::Vec<std::string::String>>,
}
