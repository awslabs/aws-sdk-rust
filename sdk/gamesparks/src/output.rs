...
pub struct ListGeneratedCodeJobsOutput  {
    ...
    #[doc(hidden)]
    pub generated_code_jobs: std::option::Option<std::vec::Vec<crate::model::GeneratedCodeJobDetails>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
...
pub struct ListExtensionVersionsOutput  {
    ...
    #[doc(hidden)]
    pub extension_versions: std::option::Option<std::vec::Vec<crate::model::ExtensionVersionDetails>>,
    /// <p>The token that indicates the start of the next sequential page of results.</p> 
    /// <p> Use this value when making the next call to this operation to continue where the last one finished. </p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
...
impl aws_http::request_id::RequestId for GetSnapshotOutput {
                                fn request_id(&self) -> Option<&str> {
                                    self._request_id.as_deref()
                                }
                            }
