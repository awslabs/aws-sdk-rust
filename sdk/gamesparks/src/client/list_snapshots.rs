...
impl super::Client {
    ...
    ///   - [`game_name(impl ::std::convert::Into<String>)`](crate::operation::list_snapshots::builders::ListSnapshotsFluentBuilder::game_name) / [`set_game_name(Option<String>)`](crate::operation::list_snapshots::builders::ListSnapshotsFluentBuilder::set_game_name): <p>The name of the game.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_snapshots::builders::ListSnapshotsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_snapshots::builders::ListSnapshotsFluentBuilder::set_next_token): <p>The token that indicates the start of the next sequential page of results.</p>  <p> Use the token that is returned with a previous call to this operation. To start at the beginning of the result set, do not specify a value. </p>
