...
impl super::Client {
    ...
    ///   - [`player_id(impl ::std::convert::Into<String>)`](crate::operation::disconnect_player::builders::DisconnectPlayerFluentBuilder::player_id) / [`set_player_id(Option<String>)`](crate::operation::disconnect_player::builders::DisconnectPlayerFluentBuilder::set_player_id): <p>The unique identifier representing a player.</p>
    ///   - [`game_name(impl ::std::convert::Into<String>)`](crate::operation::disconnect_player::builders::DisconnectPlayerFluentBuilder::game_name) / [`set_game_name(Option<String>)`](crate::operation::disconnect_player::builders::DisconnectPlayerFluentBuilder::set_game_name): <p>The name of the game.</p>
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::disconnect_player::builders::DisconnectPlayerFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::disconnect_player::builders::DisconnectPlayerFluentBuilder::set_stage_name): <p>The name of the stage.</p>
