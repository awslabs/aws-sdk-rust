...
impl super::Client {
    ...
    ///   - [`game_name(impl ::std::convert::Into<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::game_name) / [`set_game_name(Option<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::set_game_name): <p>The name of the game.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::set_description): <p>The description of the game.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::set_client_token): <p> A client-defined token. With an active client token in the request, this action is idempotent. </p>
