...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_game::builders::CreateGameFluentBuilder::set_tags): <p>The list of tags to apply to the game.</p>
