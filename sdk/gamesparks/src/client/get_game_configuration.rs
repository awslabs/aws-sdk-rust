...
impl super::Client {
    ...
    ///   - [`sections(impl Into<String>)`](crate::operation::get_game_configuration::builders::GetGameConfigurationFluentBuilder::sections) / [`set_sections(Option<Vec<String>>)`](crate::operation::get_game_configuration::builders::GetGameConfigurationFluentBuilder::set_sections): <p>The list of sections to return.</p>
