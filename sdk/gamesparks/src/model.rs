...
pub struct StageDetails  {
    ...
    #[doc(hidden)]pub game_key: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::StageState>,
...
pub struct SnapshotDetails  {
    ...
    #[doc(hidden)]pub sections: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Section>>,
...
pub struct Section  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<aws_smithy_types::Document>,
}
impl Section {
    /// <p>The name of the section.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct SectionModification  {
    ...
    #[doc(hidden)]pub section: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub value: std::option::Option<aws_smithy_types::Document>,
}
...
pub struct GameDetails  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::GameState>,
    /// <p>Determines if the game can be deleted.</p>
    #[doc(hidden)]pub enable_termination_protection: bool,
...
pub struct StageDeploymentDetails  {
    ...
    #[doc(hidden)]pub deployment_action: std::option::Option<crate::model::DeploymentAction>,
    /// <p>The state of the deployment.</p>
    #[doc(hidden)]pub deployment_state: std::option::Option<crate::model::DeploymentState>,
    ...
    #[doc(hidden)]pub deployment_result: std::option::Option<crate::model::DeploymentResult>,
}
...
pub struct DeploymentResult  {
    ...
    #[doc(hidden)]pub result_code: std::option::Option<crate::model::ResultCode>,
...
pub struct Generator  {
    ...
    #[doc(hidden)]pub target_platform: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub game_sdk_version: std::option::Option<std::string::String>,
}
impl Generator {
    /// <p>The platform that will be used to run the generated code.</p>
...
pub struct GeneratedCodeJobDetails  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::GeneratedCodeJobState>,
...
pub struct ImportGameConfigurationSource  {
    ...
    #[doc(hidden)]pub file: std::option::Option<aws_smithy_types::Blob>,
}
