    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::list_snapshots::ListSnapshots::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListSnapshotsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_snapshots_output_snapshots(page).unwrap_or_default().into_iter())
    }
}
