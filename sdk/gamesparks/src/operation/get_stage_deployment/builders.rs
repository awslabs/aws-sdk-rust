...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_stage_deployment::GetStageDeploymentOutput,
        crate::operation::get_stage_deployment::GetStageDeploymentError,
    > for GetStageDeploymentFluentBuilder
{
    fn send(
        self,
...
impl GetStageDeploymentFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_stage_deployment::GetStageDeployment::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_stage_deployment::GetStageDeployment::orchestrate(&runtime_plugins, input).await
    }
