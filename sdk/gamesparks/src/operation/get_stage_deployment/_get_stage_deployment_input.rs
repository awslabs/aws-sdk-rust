...
impl GetStageDeploymentInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_stage_deployment::GetStageDeploymentInput, ::aws_smithy_http::operation::error::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_stage_deployment::GetStageDeploymentInput {
