...
/// Orchestration and serialization glue logic for `ListStages`.
...
impl ListStages {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_stages::ListStagesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_stages::ListStagesOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("gamesparks", "ListStages", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListStages {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListStages");
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListStages", "gamesparks"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListStages")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListStagesEndpointParamsInterceptor) as _),
        )
    }
}

#[derive(Debug)]
struct ListStagesResponseDeserializer;
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListStagesResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_list_stages::de_list_stages_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_list_stages::de_list_stages_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ListStagesRequestSerializer;
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListStagesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_stages::ListStagesInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_stages::ListStagesInput,
                ...
                ::std::write!(output, "/game/{GameName}/stage", GameName = game_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_stages::ListStagesInput,
...
#[derive(Debug)]
struct ListStagesEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListStagesEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListStagesInput>()
            .ok_or("failed to downcast to ListStagesInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_stages::ListStagesError {
