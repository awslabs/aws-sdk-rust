...
impl ListExtensionsPaginator {
    ...
    > + ::std::marker::Unpin {
        ...
        let runtime_plugins = crate::operation::list_extensions::ListExtensions::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::list_extensions::ListExtensions::orchestrate(&runtime_plugins, input.clone()).await;
...
impl ListExtensionsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_extensions_output_extensions(page).unwrap_or_default().into_iter())
    }
}
