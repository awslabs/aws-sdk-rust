    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_snapshot::CreateSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_snapshot::CreateSnapshotOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_snapshot::CreateSnapshotInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateSnapshotEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateSnapshotEndpointParamsInterceptor"
    }
