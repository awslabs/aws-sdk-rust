...
impl CreateSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_snapshot::CreateSnapshotError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_snapshot::CreateSnapshotOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("gamesparks", "CreateSnapshot", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateSnapshot");
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            CreateSnapshotResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateSnapshot", "gamesparks"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSnapshot")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreateSnapshotEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateSnapshotResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_snapshot::de_create_snapshot_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_snapshot::CreateSnapshotInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_snapshot::CreateSnapshotInput,
                ...
                ::std::write!(output, "/game/{GameName}/snapshot", GameName = game_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_snapshot::ser_create_snapshot_input(&input)?);
...
#[derive(Debug)]
struct CreateSnapshotEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateSnapshotEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateSnapshotInput>()
            .ok_or("failed to downcast to CreateSnapshotInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_snapshot::CreateSnapshotError {
