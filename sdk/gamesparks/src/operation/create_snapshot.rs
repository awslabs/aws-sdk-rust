    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/game/{GameName}/snapshot", GameName = game_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_snapshot::CreateSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_snapshot::de_create_snapshot_http_error(
                status, headers, body,
            )
        } else {
