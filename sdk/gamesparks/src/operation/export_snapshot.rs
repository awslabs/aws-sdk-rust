...
impl ExportSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`ExportSnapshot`](crate::operation::export_snapshot::ExportSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::export_snapshot::ExportSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_snapshot::ExportSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::export_snapshot::ExportSnapshot::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExportSnapshot {
                type Output = std::result::Result<crate::operation::export_snapshot::ExportSnapshotOutput, crate::operation::export_snapshot::ExportSnapshotError>;
