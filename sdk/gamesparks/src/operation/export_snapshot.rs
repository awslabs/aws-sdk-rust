...
impl ExportSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::export_snapshot::ExportSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportSnapshot {
    type Output =
        ::std::result::Result<crate::operation::export_snapshot::ExportSnapshotOutput, crate::operation::export_snapshot::ExportSnapshotError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_snapshot::de_export_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
