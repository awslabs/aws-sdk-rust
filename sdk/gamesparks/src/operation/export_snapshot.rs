    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::export_snapshot::ExportSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::export_snapshot::ExportSnapshotOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ExportSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::export_snapshot::ExportSnapshotInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExportSnapshotEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ExportSnapshotEndpointParamsInterceptor"
    }
