...
/// Orchestration and serialization glue logic for `ExportSnapshot`.
...
impl ExportSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::export_snapshot::ExportSnapshotError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::export_snapshot::ExportSnapshotOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("gamesparks", "ExportSnapshot", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportSnapshot");
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ExportSnapshot", "gamesparks"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportSnapshot")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ExportSnapshotEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
#[derive(Debug)]
struct ExportSnapshotResponseDeserializer;
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ExportSnapshotResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_export_snapshot::de_export_snapshot_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_export_snapshot::de_export_snapshot_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ExportSnapshotRequestSerializer;
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ExportSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::export_snapshot::ExportSnapshotInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::export_snapshot::ExportSnapshotInput,
...
#[derive(Debug)]
struct ExportSnapshotEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExportSnapshotEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ExportSnapshotInput>()
            .ok_or("failed to downcast to ExportSnapshotInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::export_snapshot::ExportSnapshotError {
