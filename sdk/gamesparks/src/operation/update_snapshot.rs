...
impl UpdateSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_snapshot::UpdateSnapshot,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_snapshot::UpdateSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_snapshot::de_update_snapshot_http_error(
                status, headers, body,
            )
        } else {
