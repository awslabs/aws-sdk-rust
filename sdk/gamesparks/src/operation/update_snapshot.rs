    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_snapshot::UpdateSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_snapshot::UpdateSnapshotOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for UpdateSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_snapshot::UpdateSnapshotInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateSnapshotEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateSnapshotEndpointParamsInterceptor"
    }
