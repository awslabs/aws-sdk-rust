...
impl UpdateSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_snapshot::UpdateSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_snapshot::ser_update_snapshot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSnapshot {
    type Output =
        ::std::result::Result<crate::operation::update_snapshot::UpdateSnapshotOutput, crate::operation::update_snapshot::UpdateSnapshotError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_snapshot::de_update_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
