...
/// Orchestration and serialization glue logic for `UpdateSnapshot`.
...
impl UpdateSnapshot {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::update_snapshot::UpdateSnapshotInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_snapshot::UpdateSnapshotError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_snapshot::UpdateSnapshotOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("gamesparks", "UpdateSnapshot", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSnapshot");
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateSnapshot", "gamesparks"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSnapshot")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(UpdateSnapshotEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
#[derive(Debug)]
struct UpdateSnapshotResponseDeserializer;
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateSnapshotResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_update_snapshot::de_update_snapshot_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_update_snapshot::de_update_snapshot_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct UpdateSnapshotRequestSerializer;
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_snapshot::UpdateSnapshotInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::update_snapshot::UpdateSnapshotInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_snapshot::ser_update_snapshot_input(&input)?);
...
#[derive(Debug)]
struct UpdateSnapshotEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateSnapshotEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateSnapshotInput>()
            .ok_or("failed to downcast to UpdateSnapshotInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_snapshot::UpdateSnapshotError {
