...
impl ListExtensionsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_extensions::ListExtensions,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_extensions::ListExtensions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListExtensions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_extensions::de_list_extensions_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_extensions::de_list_extensions_http_response(
                status, headers, body,
            )
        }
    }
