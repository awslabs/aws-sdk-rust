...
pub struct CreateSnapshotOutput  {
    ...
    #[doc(hidden)]
    pub snapshot: std::option::Option<crate::types::SnapshotDetails>,
    _request_id: Option<String>,
}
impl CreateSnapshotOutput {
    /// <p>Properties that provide details of the created snapshot.</p>
    pub fn snapshot(&self) -> std::option::Option<& crate::types::SnapshotDetails> {
...
impl CreateSnapshotOutputBuilder {
    /// <p>Properties that provide details of the created snapshot.</p>
    pub fn snapshot(mut self, input: crate::types::SnapshotDetails) -> Self {
