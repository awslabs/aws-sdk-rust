...
impl DeleteGameFluentBuilder  {
    /// Creates a new `DeleteGame`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_game::DeleteGameOutput, aws_smithy_http::result::SdkError<crate::operation::delete_game::DeleteGameError>>
                     {
