...
impl ListStagesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::StageSummary, ::aws_smithy_http::result::SdkError<crate::operation::list_stages::ListStagesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_stages_output_stages(page).unwrap_or_default().into_iter())
    }
}
