...
/// Configuration for a aws_sdk_gamesparks service client.
///
///
...
impl Builder {
    ...
    /// use aws_sdk_gamesparks::config::Config;
    ///
    ...
    /// use aws_smithy_client::http_connector::ConnectorSettings;
    /// use aws_sdk_gamesparks::config::{Builder, Config};
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_gamesparks::Config::builder();
    ...
    /// rules for `aws_sdk_gamesparks`.
    ///
    /// # Examples
    /// ```no_run
    /// use aws_smithy_http::endpoint;
    /// use aws_sdk_gamesparks::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_gamesparks::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_gamesparks::config::Config;
    /// use aws_sdk_gamesparks::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_gamesparks::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_gamesparks::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_gamesparks::config::Config;
    /// use aws_sdk_gamesparks::config::timeout::TimeoutConfig;
    ///
    ...
    /// use aws_sdk_gamesparks::config::{Builder, Config};
    ///
    /// let config = aws_sdk_gamesparks::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("gamesparks"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("gamesparks"));
        layer
        ...
        Config {
            config: ::aws_smithy_types::config_bag::Layer::from(layer.clone())
                .with_name("aws_sdk_gamesparks::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_gamesparks::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
