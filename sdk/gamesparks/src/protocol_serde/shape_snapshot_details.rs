...
) -> Result<Option<crate::types::SnapshotDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Sections" => {
                            builder = builder.set_sections(crate::protocol_serde::shape_sections::de_sections(tokens)?);
                        }
                        "Created" => {
