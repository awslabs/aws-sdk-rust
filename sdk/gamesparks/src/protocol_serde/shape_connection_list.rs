...
pub(crate) fn de_connection_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Connection>>, aws_smithy_json::deserialize::error::DeserializeError>
