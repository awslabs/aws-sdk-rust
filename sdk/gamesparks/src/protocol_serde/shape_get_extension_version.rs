...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_extension_version::de_get_extension_version(_response_body, output)
            .map_err(crate::operation::get_extension_version::GetExtensionVersionError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ExtensionVersion" => {
                    builder = builder.set_extension_version(crate::protocol_serde::shape_extension_version_details::de_extension_version_details(
                        tokens,
                    )?);
                }
