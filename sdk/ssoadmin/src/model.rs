...
pub struct InstanceAccessControlAttributeConfiguration  {
    ...
    #[doc(hidden)]pub access_control_attributes: std::option::Option<std::vec::Vec<crate::model::AccessControlAttribute>>,
}
...
pub struct AccessControlAttribute  {
    ...
    #[doc(hidden)]pub value: std::option::Option<crate::model::AccessControlAttributeValue>,
}
...
pub struct AccessControlAttributeValue  {
    ...
    #[doc(hidden)]pub source: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct PermissionSetProvisioningStatus  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::StatusValues>,
