...
impl super::Client {
    ...
    ///   - [`instance_arn(impl ::std::convert::Into<String>)`](crate::operation::get_permissions_boundary_for_permission_set::builders::GetPermissionsBoundaryForPermissionSetFluentBuilder::instance_arn) / [`set_instance_arn(Option<String>)`](crate::operation::get_permissions_boundary_for_permission_set::builders::GetPermissionsBoundaryForPermissionSetFluentBuilder::set_instance_arn): <p>The ARN of the IAM Identity Center instance under which the operation will be executed. </p>
    ///   - [`permission_set_arn(impl ::std::convert::Into<String>)`](crate::operation::get_permissions_boundary_for_permission_set::builders::GetPermissionsBoundaryForPermissionSetFluentBuilder::permission_set_arn) / [`set_permission_set_arn(Option<String>)`](crate::operation::get_permissions_boundary_for_permission_set::builders::GetPermissionsBoundaryForPermissionSetFluentBuilder::set_permission_set_arn): <p>The ARN of the <code>PermissionSet</code>.</p>
