...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::set_next_token): <p>The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.</p>
