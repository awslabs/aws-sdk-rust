...
impl super::Client {
    ...
    ///   - [`instance_arn(impl ::std::convert::Into<String>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::instance_arn) / [`set_instance_arn(Option<String>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::set_instance_arn): <p>The ARN of the IAM Identity Center instance under which the operation will be executed. For more information about ARNs, see <a href="/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>
    ///   - [`max_results(i32)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::set_max_results): <p>The maximum number of results to display for the assignment.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_account_assignment_deletion_status::builders::ListAccountAssignmentDeletionStatusFluentBuilder::set_next_token): <p>The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.</p>
