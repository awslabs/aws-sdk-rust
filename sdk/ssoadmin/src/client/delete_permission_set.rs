...
impl super::Client {
    ...
    ///   - [`instance_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_permission_set::builders::DeletePermissionSetFluentBuilder::instance_arn) / [`set_instance_arn(Option<String>)`](crate::operation::delete_permission_set::builders::DeletePermissionSetFluentBuilder::set_instance_arn): <p>The ARN of the IAM Identity Center instance under which the operation will be executed. For more information about ARNs, see <a href="/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and AWS Service Namespaces</a> in the <i>AWS General Reference</i>.</p>
