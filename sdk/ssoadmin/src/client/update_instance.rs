...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_instance::builders::UpdateInstanceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_instance::builders::UpdateInstanceFluentBuilder::set_name):<br>required: **false**<br><p>Updates the instance name.</p><br>
