...
impl PutApplicationGrantFluentBuilder {
    /// Creates a new `PutApplicationGrant`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_application_grant::PutApplicationGrantOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_application_grant::PutApplicationGrantError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_application_grant::PutApplicationGrantOutput, crate::operation::put_application_grant::PutApplicationGrantError, Self> {
