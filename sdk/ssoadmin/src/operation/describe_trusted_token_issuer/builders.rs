...
impl DescribeTrustedTokenIssuerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_trusted_token_issuer::DescribeTrustedTokenIssuerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_trusted_token_issuer::DescribeTrustedTokenIssuerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_trusted_token_issuer::DescribeTrustedTokenIssuerOutput, crate::operation::describe_trusted_token_issuer::DescribeTrustedTokenIssuerError, Self> {
