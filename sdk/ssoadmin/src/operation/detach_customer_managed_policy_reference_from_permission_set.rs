    ...
    for DetachCustomerManagedPolicyReferenceFromPermissionSet
{
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_customer_managed_policy_reference_from_permission_set::de_detach_customer_managed_policy_reference_from_permission_set_http_response_with_props(status, headers, body)
        }
    }
}
