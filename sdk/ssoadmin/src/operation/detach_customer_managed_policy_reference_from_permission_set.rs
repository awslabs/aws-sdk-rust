...
impl DetachCustomerManagedPolicyReferenceFromPermissionSet {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::std::result::Result::Ok(output.downcast::<crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetOutput>().expect("correct output type"))
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachCustomerManagedPolicyReferenceFromPermissionSet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetachCustomerManagedPolicyReferenceFromPermissionSet");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DetachCustomerManagedPolicyReferenceFromPermissionSetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DetachCustomerManagedPolicyReferenceFromPermissionSetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DetachCustomerManagedPolicyReferenceFromPermissionSet")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachCustomerManagedPolicyReferenceFromPermissionSet")
                            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(DetachCustomerManagedPolicyReferenceFromPermissionSetTelemetryInputCaptureInterceptor))
...
.with_retry_classifier(::aws_runtime::service_clock_skew::ServiceClockSkewClassifier::<crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetError>::new());
...
#[derive(Debug)]
struct DetachCustomerManagedPolicyReferenceFromPermissionSetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DetachCustomerManagedPolicyReferenceFromPermissionSetTelemetryInputCaptureInterceptor
{
    fn name(&self) -> &'static str {
        "DetachCustomerManagedPolicyReferenceFromPermissionSetTelemetryInputCaptureInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context
            .input()
            .downcast_ref::<DetachCustomerManagedPolicyReferenceFromPermissionSetInput>()
        else {
        ...
        if requested.should_capture("PermissionSetArn") {
            if let ::std::option::Option::Some(value) = input.permission_set_arn.as_deref() {
                captured.insert("PermissionSetArn", value);
            }
        }
...
#[derive(Debug)]
struct DetachCustomerManagedPolicyReferenceFromPermissionSetResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachCustomerManagedPolicyReferenceFromPermissionSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_detach_customer_managed_policy_reference_from_permission_set::de_detach_customer_managed_policy_reference_from_permission_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_detach_customer_managed_policy_reference_from_permission_set::de_detach_customer_managed_policy_reference_from_permission_set_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct DetachCustomerManagedPolicyReferenceFromPermissionSetRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachCustomerManagedPolicyReferenceFromPermissionSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detach_customer_managed_policy_reference_from_permission_set::ser_detach_customer_managed_policy_reference_from_permission_set_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetachCustomerManagedPolicyReferenceFromPermissionSetEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DetachCustomerManagedPolicyReferenceFromPermissionSetInput>()
            .ok_or("failed to downcast to DetachCustomerManagedPolicyReferenceFromPermissionSetInput")?;
...
pub enum DetachCustomerManagedPolicyReferenceFromPermissionSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetachCustomerManagedPolicyReferenceFromPermissionSetError) for what information is available for the error.")]
...
impl DetachCustomerManagedPolicyReferenceFromPermissionSetError {
    ...
    /// Creates the `DetachCustomerManagedPolicyReferenceFromPermissionSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetachCustomerManagedPolicyReferenceFromPermissionSetError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetError
{
...
mod _detach_customer_managed_policy_reference_from_permission_set_output;
