...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachCustomerManagedPolicyReferenceFromPermissionSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_detach_customer_managed_policy_reference_from_permission_set::de_detach_customer_managed_policy_reference_from_permission_set_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_detach_customer_managed_policy_reference_from_permission_set::de_detach_customer_managed_policy_reference_from_permission_set_http_response(status, headers, body)
        };
