...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachCustomerManagedPolicyReferenceFromPermissionSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    ...
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetachCustomerManagedPolicyReferenceFromPermissionSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetachCustomerManagedPolicyReferenceFromPermissionSetResponseDeserializer));
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachCustomerManagedPolicyReferenceFromPermissionSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl ::aws_types::request_id::RequestId for crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetError {
