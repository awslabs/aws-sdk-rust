...
/// Orchestration and serialization glue logic for `DeleteInlinePolicyFromPermissionSet`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteInlinePolicyFromPermissionSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteInlinePolicyFromPermissionSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteInlinePolicyFromPermissionSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteInlinePolicyFromPermissionSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteInlinePolicyFromPermissionSet")
...
.with_interceptor(DeleteInlinePolicyFromPermissionSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetError>::new());
...
#[derive(Debug)]
            struct DeleteInlinePolicyFromPermissionSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteInlinePolicyFromPermissionSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_inline_policy_from_permission_set::de_delete_inline_policy_from_permission_set_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteInlinePolicyFromPermissionSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteInlinePolicyFromPermissionSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_inline_policy_from_permission_set::ser_delete_inline_policy_from_permission_set_input(&input)?);
...
#[derive(Debug)]
            struct DeleteInlinePolicyFromPermissionSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteInlinePolicyFromPermissionSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteInlinePolicyFromPermissionSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteInlinePolicyFromPermissionSetInput>()
                        .ok_or("failed to downcast to DeleteInlinePolicyFromPermissionSetInput")?;
...
pub enum DeleteInlinePolicyFromPermissionSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteInlinePolicyFromPermissionSetError) for what information is available for the error.")]
...
impl DeleteInlinePolicyFromPermissionSetError {
    /// Creates the `DeleteInlinePolicyFromPermissionSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteInlinePolicyFromPermissionSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteInlinePolicyFromPermissionSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetError {
...
mod _delete_inline_policy_from_permission_set_output;
