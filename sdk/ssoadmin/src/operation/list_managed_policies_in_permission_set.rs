...
impl ListManagedPoliciesInPermissionSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_managed_policies_in_permission_set::ListManagedPoliciesInPermissionSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListManagedPoliciesInPermissionSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_managed_policies_in_permission_set::de_list_managed_policies_in_permission_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
