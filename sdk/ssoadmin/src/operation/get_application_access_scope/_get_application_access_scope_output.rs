...
impl GetApplicationAccessScopeOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_application_access_scope::GetApplicationAccessScopeOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_application_access_scope::GetApplicationAccessScopeOutput {
                scope: self.scope
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("scope", "scope was not specified but it is required when building GetApplicationAccessScopeOutput")
                    )?
                ,
