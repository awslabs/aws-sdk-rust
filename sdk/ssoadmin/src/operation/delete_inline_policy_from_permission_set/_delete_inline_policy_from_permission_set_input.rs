...
impl DeleteInlinePolicyFromPermissionSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_inline_policy_from_permission_set::DeleteInlinePolicyFromPermissionSetInput, ::aws_smithy_types::error::operation::BuildError> {
