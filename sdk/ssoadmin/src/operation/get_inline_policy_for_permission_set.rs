...
impl GetInlinePolicyForPermissionSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_inline_policy_for_permission_set::GetInlinePolicyForPermissionSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInlinePolicyForPermissionSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_inline_policy_for_permission_set::de_get_inline_policy_for_permission_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
