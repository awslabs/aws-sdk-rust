...
impl DeleteApplicationAssignmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_application_assignment::DeleteApplicationAssignmentInput, ::aws_smithy_types::error::operation::BuildError> {
