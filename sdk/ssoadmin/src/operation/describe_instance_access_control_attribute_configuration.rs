    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_instance_access_control_attribute_configuration::DescribeInstanceAccessControlAttributeConfigurationError>::assume_from(err.into())
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeInstanceAccessControlAttributeConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeInstanceAccessControlAttributeConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_instance_access_control_attribute_configuration::ser_describe_instance_access_control_attribute_configuration_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeInstanceAccessControlAttributeConfigurationEndpointParamsInterceptor {
