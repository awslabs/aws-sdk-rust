...
impl DescribeApplicationProviderOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_application_provider::DescribeApplicationProviderOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_application_provider::DescribeApplicationProviderOutput {
                application_provider_arn: self.application_provider_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("application_provider_arn", "application_provider_arn was not specified but it is required when building DescribeApplicationProviderOutput")
                    )?
                ,
