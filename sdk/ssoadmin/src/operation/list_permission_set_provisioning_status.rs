...
impl ListPermissionSetProvisioningStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_permission_set_provisioning_status::ListPermissionSetProvisioningStatus,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_permission_set_provisioning_status::ListPermissionSetProvisioningStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPermissionSetProvisioningStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_permission_set_provisioning_status::de_list_permission_set_provisioning_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
