...
impl DescribeAccountAssignmentCreationStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusInput, ::aws_smithy_types::error::operation::BuildError> {
