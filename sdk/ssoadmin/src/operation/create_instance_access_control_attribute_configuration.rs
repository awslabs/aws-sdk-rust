...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateInstanceAccessControlAttributeConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateInstanceAccessControlAttributeConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_instance_access_control_attribute_configuration::ser_create_instance_access_control_attribute_configuration_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateInstanceAccessControlAttributeConfigurationEndpointParamsInterceptor {
