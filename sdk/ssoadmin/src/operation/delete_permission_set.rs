...
impl DeletePermissionSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_permission_set::DeletePermissionSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePermissionSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_permission_set::de_delete_permission_set_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_permission_set::DeletePermissionSetError
{
