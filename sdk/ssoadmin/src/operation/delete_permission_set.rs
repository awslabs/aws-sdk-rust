...
impl DeletePermissionSetInput {
    /// Consumes the builder and constructs an Operation<[`DeletePermissionSet`](crate::operation::delete_permission_set::DeletePermissionSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_permission_set::DeletePermissionSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_permission_set::DeletePermissionSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_permission_set::DeletePermissionSet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePermissionSet {
                type Output = std::result::Result<crate::operation::delete_permission_set::DeletePermissionSetOutput, crate::operation::delete_permission_set::DeletePermissionSetError>;
