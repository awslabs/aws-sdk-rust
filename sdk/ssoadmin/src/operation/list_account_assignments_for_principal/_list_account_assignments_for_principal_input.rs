...
impl ListAccountAssignmentsForPrincipalInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_account_assignments_for_principal::ListAccountAssignmentsForPrincipalInput, ::aws_smithy_types::error::operation::BuildError> {
