...
impl PutInlinePolicyToPermissionSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutInlinePolicyToPermissionSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_inline_policy_to_permission_set::de_put_inline_policy_to_permission_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
