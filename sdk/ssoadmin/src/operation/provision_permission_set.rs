...
impl ProvisionPermissionSetInput {
    /// Consumes the builder and constructs an Operation<[`ProvisionPermissionSet`](crate::operation::provision_permission_set::ProvisionPermissionSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::provision_permission_set::ProvisionPermissionSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::provision_permission_set::ProvisionPermissionSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::provision_permission_set::ProvisionPermissionSet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ProvisionPermissionSet {
                type Output = std::result::Result<crate::operation::provision_permission_set::ProvisionPermissionSetOutput, crate::operation::provision_permission_set::ProvisionPermissionSetError>;
