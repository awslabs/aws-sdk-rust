...
impl ListCustomerManagedPolicyReferencesInPermissionSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetInput, ::aws_smithy_types::error::operation::BuildError> {
