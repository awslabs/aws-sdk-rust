...
impl CreateTrustedTokenIssuerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_trusted_token_issuer::CreateTrustedTokenIssuerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_trusted_token_issuer::CreateTrustedTokenIssuerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_trusted_token_issuer::CreateTrustedTokenIssuerOutput, crate::operation::create_trusted_token_issuer::CreateTrustedTokenIssuerError, Self> {
