...
impl CreateTrustedTokenIssuerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_trusted_token_issuer::CreateTrustedTokenIssuerInput, ::aws_smithy_types::error::operation::BuildError> {
