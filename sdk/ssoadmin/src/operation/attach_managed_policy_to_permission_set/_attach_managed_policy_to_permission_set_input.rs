...
impl AttachManagedPolicyToPermissionSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::attach_managed_policy_to_permission_set::AttachManagedPolicyToPermissionSetInput, ::aws_smithy_types::error::operation::BuildError> {
