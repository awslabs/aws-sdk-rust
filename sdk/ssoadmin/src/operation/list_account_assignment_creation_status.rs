...
impl ListAccountAssignmentCreationStatusInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_account_assignment_creation_status::ListAccountAssignmentCreationStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_account_assignment_creation_status::ListAccountAssignmentCreationStatusInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
