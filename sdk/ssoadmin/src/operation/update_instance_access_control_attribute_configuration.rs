...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for UpdateInstanceAccessControlAttributeConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for UpdateInstanceAccessControlAttributeConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_instance_access_control_attribute_configuration::ser_update_instance_access_control_attribute_configuration_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateInstanceAccessControlAttributeConfigurationEndpointParamsInterceptor {
