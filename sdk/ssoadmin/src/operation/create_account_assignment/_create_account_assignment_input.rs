...
impl CreateAccountAssignmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_account_assignment::CreateAccountAssignmentInput, ::aws_smithy_types::error::operation::BuildError> {
