...
impl ::aws_smithy_http::response::ParseStrictResponse
    for DeletePermissionsBoundaryFromPermissionSet
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_permissions_boundary_from_permission_set::de_delete_permissions_boundary_from_permission_set_http_response_with_props(status, headers, body)
        }
    }
}
