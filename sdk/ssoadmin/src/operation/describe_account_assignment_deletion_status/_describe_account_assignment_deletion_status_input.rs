...
impl DescribeAccountAssignmentDeletionStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_account_assignment_deletion_status::DescribeAccountAssignmentDeletionStatusInput, ::aws_smithy_types::error::operation::BuildError> {
