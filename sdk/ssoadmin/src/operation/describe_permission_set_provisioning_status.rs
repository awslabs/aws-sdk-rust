...
impl DescribePermissionSetProvisioningStatusInput {
    /// Consumes the builder and constructs an Operation<[`DescribePermissionSetProvisioningStatus`](crate::operation::describe_permission_set_provisioning_status::DescribePermissionSetProvisioningStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_permission_set_provisioning_status::DescribePermissionSetProvisioningStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_permission_set_provisioning_status::DescribePermissionSetProvisioningStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePermissionSetProvisioningStatus {
    type Output = ::std::result::Result<crate::operation::describe_permission_set_provisioning_status::DescribePermissionSetProvisioningStatusOutput, crate::operation::describe_permission_set_provisioning_status::DescribePermissionSetProvisioningStatusError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_permission_set_provisioning_status::de_describe_permission_set_provisioning_status_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_permission_set_provisioning_status::DescribePermissionSetProvisioningStatusError {
