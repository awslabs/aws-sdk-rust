...
impl UpdateTrustedTokenIssuerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_trusted_token_issuer::UpdateTrustedTokenIssuerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_trusted_token_issuer::UpdateTrustedTokenIssuerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_trusted_token_issuer::UpdateTrustedTokenIssuerOutput, crate::operation::update_trusted_token_issuer::UpdateTrustedTokenIssuerError, Self> {
