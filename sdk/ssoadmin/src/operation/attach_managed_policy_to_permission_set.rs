...
impl AttachManagedPolicyToPermissionSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_managed_policy_to_permission_set::AttachManagedPolicyToPermissionSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachManagedPolicyToPermissionSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_managed_policy_to_permission_set::de_attach_managed_policy_to_permission_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
