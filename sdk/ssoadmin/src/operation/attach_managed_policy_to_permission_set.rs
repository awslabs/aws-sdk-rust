...
impl AttachManagedPolicyToPermissionSetInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_managed_policy_to_permission_set::AttachManagedPolicyToPermissionSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_managed_policy_to_permission_set::AttachManagedPolicyToPermissionSetInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
