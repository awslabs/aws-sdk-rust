    ...
    for ListCustomerManagedPolicyReferencesInPermissionSet
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_customer_managed_policy_references_in_permission_set::de_list_customer_managed_policy_references_in_permission_set_http_response_with_props(status, headers, body)
        }
    }
}
