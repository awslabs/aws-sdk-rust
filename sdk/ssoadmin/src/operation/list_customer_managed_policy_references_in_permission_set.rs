...
/// Orchestration and serialization glue logic for `ListCustomerManagedPolicyReferencesInPermissionSet`.
...
impl ListCustomerManagedPolicyReferencesInPermissionSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomerManagedPolicyReferencesInPermissionSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCustomerManagedPolicyReferencesInPermissionSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCustomerManagedPolicyReferencesInPermissionSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCustomerManagedPolicyReferencesInPermissionSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCustomerManagedPolicyReferencesInPermissionSet")
...
.with_interceptor(ListCustomerManagedPolicyReferencesInPermissionSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetError>::new());
...
#[derive(Debug)]
            struct ListCustomerManagedPolicyReferencesInPermissionSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCustomerManagedPolicyReferencesInPermissionSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_customer_managed_policy_references_in_permission_set::de_list_customer_managed_policy_references_in_permission_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_customer_managed_policy_references_in_permission_set::de_list_customer_managed_policy_references_in_permission_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListCustomerManagedPolicyReferencesInPermissionSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCustomerManagedPolicyReferencesInPermissionSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_customer_managed_policy_references_in_permission_set::ser_list_customer_managed_policy_references_in_permission_set_input(&input)?);
...
#[derive(Debug)]
            struct ListCustomerManagedPolicyReferencesInPermissionSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCustomerManagedPolicyReferencesInPermissionSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListCustomerManagedPolicyReferencesInPermissionSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCustomerManagedPolicyReferencesInPermissionSetInput>()
                        .ok_or("failed to downcast to ListCustomerManagedPolicyReferencesInPermissionSetInput")?;
...
pub enum ListCustomerManagedPolicyReferencesInPermissionSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCustomerManagedPolicyReferencesInPermissionSetError) for what information is available for the error.")]
...
impl ListCustomerManagedPolicyReferencesInPermissionSetError {
    /// Creates the `ListCustomerManagedPolicyReferencesInPermissionSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCustomerManagedPolicyReferencesInPermissionSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCustomerManagedPolicyReferencesInPermissionSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_customer_managed_policy_references_in_permission_set::ListCustomerManagedPolicyReferencesInPermissionSetError {
...
mod _list_customer_managed_policy_references_in_permission_set_output;
