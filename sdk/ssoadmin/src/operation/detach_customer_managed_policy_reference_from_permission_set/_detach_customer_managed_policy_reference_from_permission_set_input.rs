...
impl DetachCustomerManagedPolicyReferenceFromPermissionSetInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::detach_customer_managed_policy_reference_from_permission_set::DetachCustomerManagedPolicyReferenceFromPermissionSetInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
