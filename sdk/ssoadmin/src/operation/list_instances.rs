...
impl ListInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_instances::ListInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_instances::de_list_instances_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_instances::de_list_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
