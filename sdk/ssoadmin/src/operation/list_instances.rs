...
impl ListInstancesInput {
    /// Consumes the builder and constructs an Operation<[`ListInstances`](crate::operation::list_instances::ListInstances)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_instances::ListInstances, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_instances::ser_list_instances_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_instances::ListInstances::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInstances {
    type Output = ::std::result::Result<crate::operation::list_instances::ListInstancesOutput, crate::operation::list_instances::ListInstancesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_instances::de_list_instances_http_response_with_props(status, headers, body)
        }
    }
}
