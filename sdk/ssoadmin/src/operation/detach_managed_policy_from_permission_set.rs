    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachManagedPolicyFromPermissionSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetachManagedPolicyFromPermissionSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetachManagedPolicyFromPermissionSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetachManagedPolicyFromPermissionSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachManagedPolicyFromPermissionSet")
...
.with_interceptor(DetachManagedPolicyFromPermissionSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError>::new());
...
#[derive(Debug)]
            struct DetachManagedPolicyFromPermissionSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachManagedPolicyFromPermissionSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_detach_managed_policy_from_permission_set::de_detach_managed_policy_from_permission_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DetachManagedPolicyFromPermissionSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachManagedPolicyFromPermissionSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detach_managed_policy_from_permission_set::ser_detach_managed_policy_from_permission_set_input(&input)?);
...
#[derive(Debug)]
            struct DetachManagedPolicyFromPermissionSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetachManagedPolicyFromPermissionSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetachManagedPolicyFromPermissionSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetachManagedPolicyFromPermissionSetInput>()
                        .ok_or("failed to downcast to DetachManagedPolicyFromPermissionSetInput")?;
...
pub enum DetachManagedPolicyFromPermissionSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetachManagedPolicyFromPermissionSetError) for what information is available for the error.")]
...
impl DetachManagedPolicyFromPermissionSetError {
    /// Creates the `DetachManagedPolicyFromPermissionSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetachManagedPolicyFromPermissionSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetachManagedPolicyFromPermissionSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError {
