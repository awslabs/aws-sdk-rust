...
impl ListApplicationAssignmentsForPrincipalFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_application_assignments_for_principal::builders::ListApplicationAssignmentsForPrincipalInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipal::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipal::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipalOutput, crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipalError, Self> {
    ...
    /// Create a paginator for this request
                            ...
                            pub fn into_paginator(self) -> crate::operation::list_application_assignments_for_principal::paginator::ListApplicationAssignmentsForPrincipalPaginator {
                                crate::operation::list_application_assignments_for_principal::paginator::ListApplicationAssignmentsForPrincipalPaginator::new(self.handle, self.inner)
                            }
