...
///
/// <p>Lists all enabled Regions of an IAM Identity Center instance, including those that are being added or removed. This operation returns Regions with ACTIVE, ADDING, or REMOVING status.</p>
/// <p>The following actions are related to <code>ListRegions</code>:</p>
/// <ul>
/// <li>
/// <p><a href="https://docs.aws.amazon.com/singlesignon/latest/APIReference/API_AddRegion.html"> AddRegion</a></p></li>
/// <li>
