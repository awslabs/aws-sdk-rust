...
impl ListPermissionSetsProvisionedToAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_permission_sets_provisioned_to_account::ListPermissionSetsProvisionedToAccountInput, ::aws_smithy_types::error::operation::BuildError> {
