...
impl ListAccountAssignments {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_account_assignments::ListAccountAssignmentsInput,
                    ) -> ::std::result::Result<crate::operation::list_account_assignments::ListAccountAssignmentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_account_assignments::ListAccountAssignmentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_account_assignments::ListAccountAssignmentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_account_assignments::ListAccountAssignmentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAccountAssignments {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAccountAssignments");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAccountAssignmentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAccountAssignmentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAccountAssignments")
...
.with_interceptor(ListAccountAssignmentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_account_assignments::ListAccountAssignmentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_account_assignments::ListAccountAssignmentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_account_assignments::ListAccountAssignmentsError>::new());
...
#[derive(Debug)]
            struct ListAccountAssignmentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAccountAssignmentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_account_assignments::de_list_account_assignments_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_account_assignments::de_list_account_assignments_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAccountAssignmentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAccountAssignmentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_account_assignments::ListAccountAssignmentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_account_assignments::ListAccountAssignmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_account_assignments::ser_list_account_assignments_input(&input)?);
...
#[derive(Debug)]
            struct ListAccountAssignmentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAccountAssignmentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAccountAssignmentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAccountAssignmentsInput>()
                        .ok_or("failed to downcast to ListAccountAssignmentsInput")?;
...
pub enum ListAccountAssignmentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAccountAssignmentsError) for what information is available for the error.")]
...
impl ListAccountAssignmentsError {
    /// Creates the `ListAccountAssignmentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAccountAssignmentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAccountAssignmentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_account_assignments::ListAccountAssignmentsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_account_assignments::_list_account_assignments_output::ListAccountAssignmentsOutput;

pub use crate::operation::list_account_assignments::_list_account_assignments_input::ListAccountAssignmentsInput;

mod _list_account_assignments_input;

mod _list_account_assignments_output;
