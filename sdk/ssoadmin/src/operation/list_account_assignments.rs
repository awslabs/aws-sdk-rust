...
impl ListAccountAssignmentsInput {
    /// Consumes the builder and constructs an Operation<[`ListAccountAssignments`](crate::operation::list_account_assignments::ListAccountAssignments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_account_assignments::ListAccountAssignments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_account_assignments::ListAccountAssignmentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_account_assignments::ListAccountAssignments::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccountAssignments {
                type Output = std::result::Result<crate::operation::list_account_assignments::ListAccountAssignmentsOutput, crate::operation::list_account_assignments::ListAccountAssignmentsError>;
