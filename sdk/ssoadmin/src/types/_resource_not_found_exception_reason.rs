...
///     ResourceNotFoundExceptionReason::KmsNotFoundException => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceNotFoundExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "KMS_NotFoundException" => ResourceNotFoundExceptionReason::KmsNotFoundException,
...
impl ResourceNotFoundExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceNotFoundExceptionReason::KmsNotFoundException => "KMS_NotFoundException",
