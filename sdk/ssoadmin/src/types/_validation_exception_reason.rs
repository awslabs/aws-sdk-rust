...
///     ValidationExceptionReason::KmsDisabledException => { /* ... */ },
///     ValidationExceptionReason::KmsInvalidKeyUsageException => { /* ... */ },
///     ValidationExceptionReason::KmsInvalidStateException => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "KMS_DisabledException" => ValidationExceptionReason::KmsDisabledException,
            "KMS_InvalidKeyUsageException" => ValidationExceptionReason::KmsInvalidKeyUsageException,
            "KMS_InvalidStateException" => ValidationExceptionReason::KmsInvalidStateException,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ValidationExceptionReason::KmsDisabledException => "KMS_DisabledException",
            ValidationExceptionReason::KmsInvalidKeyUsageException => "KMS_InvalidKeyUsageException",
            ValidationExceptionReason::KmsInvalidStateException => "KMS_InvalidStateException",
            ValidationExceptionReason::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["KMS_DisabledException", "KMS_InvalidKeyUsageException", "KMS_InvalidStateException"]
    }
}
