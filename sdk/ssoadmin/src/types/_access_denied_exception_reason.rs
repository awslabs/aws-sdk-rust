...
///     AccessDeniedExceptionReason::KmsAccessDeniedException => { /* ... */ },
...
impl ::std::convert::From<&str> for AccessDeniedExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "KMS_AccessDeniedException" => AccessDeniedExceptionReason::KmsAccessDeniedException,
...
impl AccessDeniedExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AccessDeniedExceptionReason::KmsAccessDeniedException => "KMS_AccessDeniedException",
