...
///     ThrottlingExceptionReason::KmsThrottlingException => { /* ... */ },
...
impl ::std::convert::From<&str> for ThrottlingExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "KMS_ThrottlingException" => ThrottlingExceptionReason::KmsThrottlingException,
...
impl ThrottlingExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ThrottlingExceptionReason::KmsThrottlingException => "KMS_ThrottlingException",
