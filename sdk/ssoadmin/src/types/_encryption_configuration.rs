...
pub struct EncryptionConfiguration {
    ...
    pub key_type: crate::types::KmsKeyType,
...
impl EncryptionConfiguration {
    /// <p>The type of KMS key used for encryption.</p>
    pub fn key_type(&self) -> &crate::types::KmsKeyType {
        &self.key_type
    }
    /// <p>The ARN of the KMS key used to encrypt data. Required when KeyType is CUSTOMER_MANAGED_KEY. Cannot be specified when KeyType is AWS_OWNED_KMS_KEY.</p>
...
impl EncryptionConfigurationBuilder {
    ...
    /// - [`key_type`](crate::types::builders::EncryptionConfigurationBuilder::key_type)
        ...
        ::std::result::Result::Ok(crate::types::EncryptionConfiguration {
            key_type: self.key_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "key_type",
                    "key_type was not specified but it is required when building EncryptionConfiguration",
                )
            })?,
