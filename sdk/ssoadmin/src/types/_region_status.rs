...
impl ::std::convert::From<&str> for RegionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "ADDING" => RegionStatus::Adding,
            "REMOVING" => RegionStatus::Removing,
...
impl RegionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RegionStatus::Adding => "ADDING",
            RegionStatus::Removing => "REMOVING",
...
impl ::std::fmt::Display for RegionStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            RegionStatus::Adding => write!(f, "ADDING"),
            RegionStatus::Removing => write!(f, "REMOVING"),
