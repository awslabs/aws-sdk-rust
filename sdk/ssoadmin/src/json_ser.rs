...
pub fn serialize_structure_attach_managed_policy_to_permission_set_input(
...
pub fn serialize_structure_create_account_assignment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_instance_access_control_attribute_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_11) = &input.instance_access_control_attribute_configuration {
        let mut object_12 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_instance_access_control_attribute_configuration(
            &mut object_12,
            var_11,
        );
        object_12.finish();
...
pub fn serialize_structure_create_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_account_assignment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_inline_policy_from_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_instance_access_control_attribute_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_account_assignment_creation_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_account_assignment_deletion_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_instance_access_control_attribute_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_permission_set_provisioning_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_detach_managed_policy_from_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_inline_policy_for_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_account_assignment_creation_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_50) = &input.filter {
        ...
        crate::json_ser::serialize_structure_operation_status_filter(&mut object_51, var_50);
        object_51.finish();
    }
}

pub fn serialize_structure_list_account_assignment_deletion_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_55) = &input.filter {
        ...
        crate::json_ser::serialize_structure_operation_status_filter(&mut object_56, var_55);
        object_56.finish();
    }
}

pub fn serialize_structure_list_account_assignments_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_accounts_for_provisioned_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_managed_policies_in_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_permission_set_provisioning_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_76) = &input.filter {
        ...
        crate::json_ser::serialize_structure_operation_status_filter(&mut object_77, var_76);
        object_77.finish();
    }
}

pub fn serialize_structure_list_permission_sets_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_permission_sets_provisioned_to_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_provision_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_inline_policy_to_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_instance_access_control_attribute_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_permission_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_instance_access_control_attribute_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_117 in var_115 {
            {
                ...
                crate::json_ser::serialize_structure_access_control_attribute(
                    &mut object_118,
                    item_117,
                );
                object_118.finish();
...
pub fn serialize_structure_operation_status_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_access_control_attribute(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_123) = &input.value {
        ...
        crate::json_ser::serialize_structure_access_control_attribute_value(
            &mut object_124,
            var_123,
        );
        object_124.finish();
...
pub fn serialize_structure_access_control_attribute_value(
    object: &mut smithy_json::serialize::JsonObjectWriter,
