...
pub fn ser_list_permission_set_provisioning_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_permission_set_provisioning_status::ListPermissionSetProvisioningStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
