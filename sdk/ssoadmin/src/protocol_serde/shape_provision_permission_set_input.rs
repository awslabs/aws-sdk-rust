...
pub fn ser_provision_permission_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ProvisionPermissionSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
