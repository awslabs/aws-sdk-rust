...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_permission_set::de_describe_permission_set(_response_body, output)
            .map_err(crate::operation::describe_permission_set::DescribePermissionSetError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "PermissionSet" => {
                    builder = builder.set_permission_set(crate::protocol_serde::shape_permission_set::de_permission_set(tokens)?);
                }
