...
pub fn de_describe_permission_set_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_permission_set::DescribePermissionSetOutput, crate::operation::describe_permission_set::DescribePermissionSetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_permission_set::DescribePermissionSetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_permission_set_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_permission_set::DescribePermissionSetOutput, crate::operation::describe_permission_set::DescribePermissionSetError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_permission_set::builders::DescribePermissionSetOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_permission_set::de_describe_permission_set(response.body().as_ref(), output).map_err(crate::operation::describe_permission_set::DescribePermissionSetError::unhandled)?;
