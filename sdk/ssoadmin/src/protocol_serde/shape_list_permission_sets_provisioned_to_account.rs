...
pub fn ser_list_permission_sets_provisioned_to_account_input(
    ...
    crate::protocol_serde::shape_list_permission_sets_provisioned_to_account_input::ser_list_permission_sets_provisioned_to_account_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_permission_sets_provisioned_to_account_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
