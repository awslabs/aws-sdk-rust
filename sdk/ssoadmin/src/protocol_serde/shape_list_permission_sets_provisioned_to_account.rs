...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_permission_sets_provisioned_to_account::ListPermissionSetsProvisionedToAccountError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_permission_sets_provisioned_to_account::ListPermissionSetsProvisionedToAccountError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::list_permission_sets_provisioned_to_account::ListPermissionSetsProvisionedToAccountError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::list_permission_sets_provisioned_to_account::ListPermissionSetsProvisionedToAccountError::unhandled,
                        )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_permission_sets_provisioned_to_account::de_list_permission_sets_provisioned_to_account(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_permission_sets_provisioned_to_account::ListPermissionSetsProvisionedToAccountError::unhandled)?;
...
pub fn ser_list_permission_sets_provisioned_to_account_input(
    ...
    crate::protocol_serde::shape_list_permission_sets_provisioned_to_account_input::ser_list_permission_sets_provisioned_to_account_input_input(
        &mut object,
        input,
    )?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "PermissionSets" => {
                    builder = builder.set_permission_sets(crate::protocol_serde::shape_permission_set_list::de_permission_set_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
