...
pub fn ser_create_permission_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_permission_set::CreatePermissionSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
