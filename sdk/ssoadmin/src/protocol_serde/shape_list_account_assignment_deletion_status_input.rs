...
pub fn ser_list_account_assignment_deletion_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
