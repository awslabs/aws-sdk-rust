...
pub fn ser_list_account_assignment_creation_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAccountAssignmentCreationStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
