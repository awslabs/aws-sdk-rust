...
pub(crate) fn de_token_exchange_grant<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TokenExchangeGrant>, ::aws_smithy_json::deserialize::error::DeserializeError>
