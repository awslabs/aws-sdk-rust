...
pub use crate::operation::list_agreement_cancellation_requests::_list_agreement_cancellation_requests_input::ListAgreementCancellationRequestsInputBuilder;

pub use crate::operation::list_agreement_cancellation_requests::_list_agreement_cancellation_requests_output::ListAgreementCancellationRequestsOutputBuilder;

impl crate::operation::list_agreement_cancellation_requests::builders::ListAgreementCancellationRequestsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_agreement_cancellation_requests();
...
pub struct ListAgreementCancellationRequestsFluentBuilder {
    ...
    inner: crate::operation::list_agreement_cancellation_requests::builders::ListAgreementCancellationRequestsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_agreement_cancellation_requests::ListAgreementCancellationRequestsOutput,
        crate::operation::list_agreement_cancellation_requests::ListAgreementCancellationRequestsError,
    > for ListAgreementCancellationRequestsFluentBuilder
{
    fn send(
        self,
...
impl ListAgreementCancellationRequestsFluentBuilder {
    /// Creates a new `ListAgreementCancellationRequestsFluentBuilder`.
    ...
    /// Access the ListAgreementCancellationRequests as a reference.
    pub fn as_input(&self) -> &crate::operation::list_agreement_cancellation_requests::builders::ListAgreementCancellationRequestsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_agreement_cancellation_requests::ListAgreementCancellationRequests::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_agreement_cancellation_requests::ListAgreementCancellationRequests::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_agreement_cancellation_requests::paginator::ListAgreementCancellationRequestsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_agreement_cancellation_requests::paginator::ListAgreementCancellationRequestsPaginator {
        crate::operation::list_agreement_cancellation_requests::paginator::ListAgreementCancellationRequestsPaginator::new(self.handle, self.inner)
    }
