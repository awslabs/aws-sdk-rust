...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_agreement::DescribeAgreementError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_agreement_terms::GetAgreementTermsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::get_agreement_terms::GetAgreementTermsError> for Error {
    fn from(err: crate::operation::get_agreement_terms::GetAgreementTermsError) -> Self {
        match err {
            ...
            crate::operation::get_agreement_terms::GetAgreementTermsError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_agreements::SearchAgreementsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
