...
impl  ConfigurableUpfrontPricingTermConfiguration  {
    ...
    pub fn selector_value(&self) -> & str {
        use std::ops::Deref; self.selector_value.deref()
    }
    /// <p>Defines the dimensions that the acceptor has purchased from the overall set of dimensions presented in the rate card.</p>
...
impl ConfigurableUpfrontPricingTermConfigurationBuilder {
    ...
    pub fn set_selector_value(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.selector_value = input; self
    }
    /// <p>Defines the length of time for which the particular pricing/dimension is being purchased by the acceptor.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ConfigurableUpfrontPricingTermConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ConfigurableUpfrontPricingTermConfiguration {
                selector_value: self.selector_value
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("selector_value", "selector_value was not specified but it is required when building ConfigurableUpfrontPricingTermConfiguration")
                    )?
                ,
                dimensions: self.dimensions
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dimensions", "dimensions was not specified but it is required when building ConfigurableUpfrontPricingTermConfiguration")
                    )?
                ,
            }
        )
