...
pub mod create_sink_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::CreateSinkInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::CreateSinkInput {
                name: self.name,
                tags: self.tags,
            })
        }
...
impl CreateSinkInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::CreateSinkInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::CreateSink::new(),
        )
        .with_metadata(aws_smithy_http::operation::Metadata::new(
            "CreateSink",
            "oam",
...
pub mod delete_sink_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::DeleteSinkInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::DeleteSinkInput {
                identifier: self.identifier,
            })
        }
    }
...
impl DeleteSinkInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::DeleteSinkInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::DeleteSink::new(),
        )
        .with_metadata(aws_smithy_http::operation::Metadata::new(
            "DeleteSink",
            "oam",
...
pub mod get_link_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetLinkInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::GetLinkInput {
                identifier: self.identifier,
            })
        }
    }
...
impl GetLinkInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::GetLinkInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op =
            aws_smithy_http::operation::Operation::new(request, crate::operation::GetLink::new())
...
pub mod get_sink_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetSinkInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::GetSinkInput {
                identifier: self.identifier,
            })
        }
    }
...
impl GetSinkInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::GetSinkInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op =
            aws_smithy_http::operation::Operation::new(request, crate::operation::GetSink::new())
...
pub mod get_sink_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetSinkPolicyInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::GetSinkPolicyInput {
                sink_identifier: self.sink_identifier,
            })
        }
    }
...
impl GetSinkPolicyInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::GetSinkPolicyInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::GetSinkPolicy::new(),
        )
        .with_metadata(aws_smithy_http::operation::Metadata::new(
            "GetSinkPolicy",
            "oam",
...
pub mod list_attached_links_input {
    ...
    impl Builder {
        ...
        pub fn build(
            ...
            aws_smithy_http::operation::error::BuildError,
        > {
            Ok(crate::input::ListAttachedLinksInput {
...
impl ListAttachedLinksInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::ListAttachedLinksInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::ListAttachedLinks::new(),
        )
        .with_metadata(aws_smithy_http::operation::Metadata::new(
            "ListAttachedLinks",
            "oam",
...
pub mod list_links_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::ListLinksInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::ListLinksInput {
                max_results: self.max_results,
                next_token: self.next_token,
            })
        }
...
impl ListLinksInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::ListLinksInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op =
            aws_smithy_http::operation::Operation::new(request, crate::operation::ListLinks::new())
                .with_metadata(aws_smithy_http::operation::Metadata::new(
                    "ListLinks",
                    "oam",
                ));
...
pub mod list_sinks_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::ListSinksInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::ListSinksInput {
                max_results: self.max_results,
                next_token: self.next_token,
            })
        }
...
impl ListSinksInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::ListSinksInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op =
            aws_smithy_http::operation::Operation::new(request, crate::operation::ListSinks::new())
                .with_metadata(aws_smithy_http::operation::Metadata::new(
                    "ListSinks",
                    "oam",
                ));
...
pub mod put_sink_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::PutSinkPolicyInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::PutSinkPolicyInput {
                sink_identifier: self.sink_identifier,
                policy: self.policy,
            })
        }
...
impl PutSinkPolicyInput {
    ...
    > {
        let mut request = {
            fn uri_base(
                _input: &crate::input::PutSinkPolicyInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::PutSinkPolicy::new(),
        )
        .with_metadata(aws_smithy_http::operation::Metadata::new(
            "PutSinkPolicy",
            "oam",
