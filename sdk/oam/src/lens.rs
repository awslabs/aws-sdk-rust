...
pub(crate) fn reflens_list_attached_links_output_output_next_token(
...
pub(crate) fn reflens_list_sinks_output_output_next_token(
...
pub(crate) fn lens_list_attached_links_output_output_items(
    input: crate::operation::list_attached_links::ListAttachedLinksOutput,
...
pub(crate) fn lens_list_links_output_output_items(
    input: crate::operation::list_links::ListLinksOutput,
...
pub(crate) fn lens_list_sinks_output_output_items(
    input: crate::operation::list_sinks::ListSinksOutput,
