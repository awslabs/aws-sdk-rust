...
impl ListAttachedLinksFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_attached_links::ListAttachedLinksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_attached_links::ListAttachedLinksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_attached_links::ListAttachedLinksOutput, crate::operation::list_attached_links::ListAttachedLinksError, Self> {
