...
impl GetSinkPolicyFluentBuilder  {
    /// Creates a new `GetSinkPolicy`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_sink_policy::GetSinkPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_sink_policy::GetSinkPolicyError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_sink_policy::GetSinkPolicyOutput, aws_smithy_http::result::SdkError<crate::operation::get_sink_policy::GetSinkPolicyError>>
                     {
