...
impl GetSinkPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_sink_policy::GetSinkPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_sink_policy::ser_get_sink_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSinkPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sink_policy::de_get_sink_policy_http_response_with_props(status, headers, body)
        }
    }
}
