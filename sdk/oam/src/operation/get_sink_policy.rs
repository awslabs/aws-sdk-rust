...
impl GetSinkPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetSinkPolicy`](crate::operation::get_sink_policy::GetSinkPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_sink_policy::GetSinkPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_sink_policy::GetSinkPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_sink_policy::ser_get_sink_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_sink_policy::GetSinkPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetSinkPolicy {
                type Output = std::result::Result<crate::operation::get_sink_policy::GetSinkPolicyOutput, crate::operation::get_sink_policy::GetSinkPolicyError>;
