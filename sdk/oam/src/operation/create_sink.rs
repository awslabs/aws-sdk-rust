...
impl CreateSinkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_sink::CreateSink, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_sink::ser_create_sink_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_sink::de_create_sink_http_response_with_props(status, headers, body)
        }
    }
}
