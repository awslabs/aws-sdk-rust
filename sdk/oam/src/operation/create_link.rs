...
impl CreateLinkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_link::CreateLink, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_link::ser_create_link_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_link::de_create_link_http_response_with_props(status, headers, body)
        }
    }
}
