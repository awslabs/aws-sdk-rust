...
impl CreateLinkInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_link::CreateLink::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_link::de_create_link_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_link::de_create_link_http_response_with_props(
                status, headers, body,
            )
        }
    }
