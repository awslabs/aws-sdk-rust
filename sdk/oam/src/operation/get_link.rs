...
impl GetLinkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_link::GetLink, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_link::ser_get_link_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_link::de_get_link_http_response_with_props(status, headers, body)
        }
    }
}
