...
impl GetLinkInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_link::GetLink, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_link::GetLinkInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_link::GetLink::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLink {
                type Output = std::result::Result<crate::operation::get_link::GetLinkOutput, crate::operation::get_link::GetLinkError>;
