...
impl ListAttachedLinksInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_attached_links::ser_list_attached_links_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttachedLinks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_attached_links::de_list_attached_links_http_response_with_props(status, headers, body)
        }
    }
}
