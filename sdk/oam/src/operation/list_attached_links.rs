...
impl ListAttachedLinksInput {
    /// Consumes the builder and constructs an Operation<[`ListAttachedLinks`](crate::operation::list_attached_links::ListAttachedLinks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_attached_links::ListAttachedLinks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_attached_links::ListAttachedLinksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_attached_links::ser_list_attached_links_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_attached_links::ListAttachedLinks::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttachedLinks {
                type Output = std::result::Result<crate::operation::list_attached_links::ListAttachedLinksOutput, crate::operation::list_attached_links::ListAttachedLinksError>;
