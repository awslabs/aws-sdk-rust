...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_attached_links::builders::ListAttachedLinksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_attached_links::builders::ListAttachedLinksFluentBuilder::set_next_token): <p>The token for the next set of items to return. You received this token from a previous call.</p>
    ///   - [`sink_identifier(impl ::std::convert::Into<String>)`](crate::operation::list_attached_links::builders::ListAttachedLinksFluentBuilder::sink_identifier) / [`set_sink_identifier(Option<String>)`](crate::operation::list_attached_links::builders::ListAttachedLinksFluentBuilder::set_sink_identifier): <p>The ARN of the sink that you want to retrieve links for.</p>
