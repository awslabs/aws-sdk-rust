...
impl super::Client {
    ...
    ///   - [`sink_identifier(impl Into<String>)`](crate::operation::get_sink_policy::builders::GetSinkPolicyFluentBuilder::sink_identifier) / [`set_sink_identifier(Option<String>)`](crate::operation::get_sink_policy::builders::GetSinkPolicyFluentBuilder::set_sink_identifier):<br>required: **true**<br><p>The ARN of the sink to retrieve the policy of.</p><br>
