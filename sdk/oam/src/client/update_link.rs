...
impl super::Client {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::update_link::builders::UpdateLinkFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::update_link::builders::UpdateLinkFluentBuilder::set_identifier): <p>The ARN of the link that you want to update.</p>
