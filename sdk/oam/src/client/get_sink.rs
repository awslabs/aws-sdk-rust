...
impl super::Client {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::get_sink::builders::GetSinkFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_sink::builders::GetSinkFluentBuilder::set_identifier): <p>The ARN of the sink to retrieve information for.</p>
