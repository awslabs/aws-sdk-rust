...
> {
    ...
    Err(match error_code {
        "ConflictException" => crate::operation::create_link::CreateLinkError::ConflictException({
            ...
            let mut tmp = {
                ...
                output = output.set_amzn_error_type(
                    ...
                    .map_err(|_| {
                        crate::operation::create_link::CreateLinkError::unhandled(
        ...
        "InternalServiceFault" => {
            crate::operation::create_link::CreateLinkError::InternalServiceFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidParameterException" => {
            crate::operation::create_link::CreateLinkError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
