...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_link::DeleteLinkError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InternalServiceFault" => {
            crate::operation::delete_link::DeleteLinkError::InternalServiceFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidParameterException" => {
            crate::operation::delete_link::DeleteLinkError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "MissingRequiredParameterException" => {
            crate::operation::delete_link::DeleteLinkError::MissingRequiredParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::delete_link::DeleteLinkError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
