...
pub fn de_delete_link_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_link::DeleteLinkOutput, crate::operation::delete_link::DeleteLinkError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_link_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_link::DeleteLinkOutput, crate::operation::delete_link::DeleteLinkError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_delete_link_input(input: &crate::operation::delete_link::DeleteLinkInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
