...
pub(crate) fn reflens_describe_objects_output_marker(
...
pub(crate) fn reflens_list_pipelines_output_marker(
...
pub(crate) fn reflens_query_objects_output_marker(
...
pub(crate) fn lens_query_objects_output_ids(
    input: crate::output::QueryObjectsOutput,
