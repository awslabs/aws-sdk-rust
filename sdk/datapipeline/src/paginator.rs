            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_objects_output_marker(resp);
...
impl DescribeObjectsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_objects_output_pipeline_objects(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListPipelinesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_pipelines_output_pipeline_id_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl QueryObjectsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_query_objects_output_ids(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
