...
impl DeletePipelineInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_pipeline::ser_delete_pipeline_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_pipeline::DeletePipeline::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePipeline", "datapipeline"));
