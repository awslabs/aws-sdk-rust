...
impl DeactivatePipelineFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deactivate_pipeline::DeactivatePipelineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deactivate_pipeline::DeactivatePipelineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deactivate_pipeline::DeactivatePipelineOutput, crate::operation::deactivate_pipeline::DeactivatePipelineError, Self> {
