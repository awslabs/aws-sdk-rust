...
impl ReportTaskRunnerHeartbeatInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatInput, ::aws_smithy_types::error::operation::BuildError> {
