...
impl EvaluateExpressionInput {
    /// Consumes the builder and constructs an Operation<[`EvaluateExpression`](crate::operation::evaluate_expression::EvaluateExpression)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::evaluate_expression::EvaluateExpression, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::evaluate_expression::EvaluateExpressionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::evaluate_expression::EvaluateExpression::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EvaluateExpression {
                type Output = std::result::Result<crate::operation::evaluate_expression::EvaluateExpressionOutput, crate::operation::evaluate_expression::EvaluateExpressionError>;
