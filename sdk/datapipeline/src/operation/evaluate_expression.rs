...
impl EvaluateExpressionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_evaluate_expression::ser_evaluate_expression_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EvaluateExpression {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_evaluate_expression::de_evaluate_expression_http_response_with_props(status, headers, body)
        }
    }
}
