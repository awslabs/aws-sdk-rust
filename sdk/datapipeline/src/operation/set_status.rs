...
impl SetStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::set_status::SetStatus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_status::ser_set_status_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_status::de_set_status_http_response_with_props(status, headers, body)
        }
    }
}
