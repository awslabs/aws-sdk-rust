...
impl DeactivatePipelineInput {
    /// Consumes the builder and constructs an Operation<[`DeactivatePipeline`](crate::operation::deactivate_pipeline::DeactivatePipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deactivate_pipeline::DeactivatePipeline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deactivate_pipeline::DeactivatePipelineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deactivate_pipeline::ser_deactivate_pipeline_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deactivate_pipeline::DeactivatePipeline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeactivatePipeline", "datapipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeactivatePipeline {
                type Output = std::result::Result<crate::operation::deactivate_pipeline::DeactivatePipelineOutput, crate::operation::deactivate_pipeline::DeactivatePipelineError>;
