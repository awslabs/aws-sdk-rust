...
impl DeactivatePipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deactivate_pipeline::DeactivatePipeline,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_deactivate_pipeline::ser_deactivate_pipeline_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeactivatePipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deactivate_pipeline::de_deactivate_pipeline_http_response_with_props(status, headers, body)
        }
    }
}
