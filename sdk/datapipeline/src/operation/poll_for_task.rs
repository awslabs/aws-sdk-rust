...
impl PollForTaskInput {
    /// Consumes the builder and constructs an Operation<[`PollForTask`](crate::operation::poll_for_task::PollForTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::poll_for_task::PollForTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::poll_for_task::PollForTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::poll_for_task::PollForTask::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PollForTask {
                type Output = std::result::Result<crate::operation::poll_for_task::PollForTaskOutput, crate::operation::poll_for_task::PollForTaskError>;
