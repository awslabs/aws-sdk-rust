...
impl PollForTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::poll_for_task::PollForTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PollForTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_poll_for_task::de_poll_for_task_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_poll_for_task::de_poll_for_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
