...
impl PollForTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::poll_for_task::PollForTask, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_poll_for_task::ser_poll_for_task_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PollForTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_poll_for_task::de_poll_for_task_http_response_with_props(status, headers, body)
        }
    }
}
