...
impl DescribeObjectsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeObjects`](crate::operation::describe_objects::DescribeObjects)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_objects::DescribeObjects, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_objects::DescribeObjectsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_objects::DescribeObjects::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeObjects {
                type Output = std::result::Result<crate::operation::describe_objects::DescribeObjectsOutput, crate::operation::describe_objects::DescribeObjectsError>;
