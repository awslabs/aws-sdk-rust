...
impl DescribeObjectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_objects::DescribeObjects, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_objects::ser_describe_objects_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeObjects {
    type Output =
        ::std::result::Result<crate::operation::describe_objects::DescribeObjectsOutput, crate::operation::describe_objects::DescribeObjectsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_objects::de_describe_objects_http_response_with_props(status, headers, body)
        }
    }
}
