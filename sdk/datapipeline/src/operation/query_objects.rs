...
impl QueryObjectsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::query_objects::QueryObjects::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryObjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_query_objects::de_query_objects_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_query_objects::de_query_objects_http_response_with_props(
                status, headers, body,
            )
        }
    }
