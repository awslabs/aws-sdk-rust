...
impl SetTaskStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::set_task_status::SetTaskStatus,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_task_status::SetTaskStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetTaskStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_task_status::de_set_task_status_http_error(
                status, headers, body,
            )
        } else {
