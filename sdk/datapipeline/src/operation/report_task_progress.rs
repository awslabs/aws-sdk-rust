...
impl ReportTaskProgressInput {
    /// Consumes the builder and constructs an Operation<[`ReportTaskProgress`](crate::operation::report_task_progress::ReportTaskProgress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::report_task_progress::ReportTaskProgress, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::report_task_progress::ReportTaskProgressInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::report_task_progress::ReportTaskProgress::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ReportTaskProgress {
                type Output = std::result::Result<crate::operation::report_task_progress::ReportTaskProgressOutput, crate::operation::report_task_progress::ReportTaskProgressError>;
