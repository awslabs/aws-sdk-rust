...
impl ReportTaskProgressInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_report_task_progress::ser_report_task_progress_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReportTaskProgress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_report_task_progress::de_report_task_progress_http_response_with_props(status, headers, body)
        }
    }
}
