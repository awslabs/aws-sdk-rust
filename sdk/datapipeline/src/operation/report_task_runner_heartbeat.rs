...
impl ReportTaskRunnerHeartbeat {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReportTaskRunnerHeartbeat {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReportTaskRunnerHeartbeat");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReportTaskRunnerHeartbeatRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReportTaskRunnerHeartbeatResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReportTaskRunnerHeartbeat")
...
.with_interceptor(ReportTaskRunnerHeartbeatEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError>::new());
...
#[derive(Debug)]
            struct ReportTaskRunnerHeartbeatResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReportTaskRunnerHeartbeatResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_report_task_runner_heartbeat::de_report_task_runner_heartbeat_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ReportTaskRunnerHeartbeatRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReportTaskRunnerHeartbeatRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_report_task_runner_heartbeat::ser_report_task_runner_heartbeat_input(&input)?);
...
#[derive(Debug)]
            struct ReportTaskRunnerHeartbeatEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReportTaskRunnerHeartbeatEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReportTaskRunnerHeartbeatEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReportTaskRunnerHeartbeatInput>()
                        .ok_or("failed to downcast to ReportTaskRunnerHeartbeatInput")?;
...
pub enum ReportTaskRunnerHeartbeatError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReportTaskRunnerHeartbeatError) for what information is available for the error.")]
...
impl ReportTaskRunnerHeartbeatError {
    /// Creates the `ReportTaskRunnerHeartbeatError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReportTaskRunnerHeartbeatError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReportTaskRunnerHeartbeatError {
...
impl ::aws_types::request_id::RequestId for crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError {
