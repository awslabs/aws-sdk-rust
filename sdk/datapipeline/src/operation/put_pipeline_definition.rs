...
impl PutPipelineDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`PutPipelineDefinition`](crate::operation::put_pipeline_definition::PutPipelineDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_pipeline_definition::PutPipelineDefinition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_pipeline_definition::PutPipelineDefinitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_pipeline_definition::ser_put_pipeline_definition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_pipeline_definition::PutPipelineDefinition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutPipelineDefinition", "datapipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutPipelineDefinition {
                type Output = std::result::Result<crate::operation::put_pipeline_definition::PutPipelineDefinitionOutput, crate::operation::put_pipeline_definition::PutPipelineDefinitionError>;
