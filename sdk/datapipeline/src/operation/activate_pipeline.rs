...
impl ActivatePipelineInput {
    /// Consumes the builder and constructs an Operation<[`ActivatePipeline`](crate::operation::activate_pipeline::ActivatePipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::activate_pipeline::ActivatePipeline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::activate_pipeline::ActivatePipelineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_activate_pipeline::ser_activate_pipeline_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::activate_pipeline::ActivatePipeline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ActivatePipeline", "datapipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for ActivatePipeline {
                type Output = std::result::Result<crate::operation::activate_pipeline::ActivatePipelineOutput, crate::operation::activate_pipeline::ActivatePipelineError>;
