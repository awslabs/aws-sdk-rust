...
impl ActivatePipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::activate_pipeline::ActivatePipeline, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_activate_pipeline::ser_activate_pipeline_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ActivatePipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_activate_pipeline::de_activate_pipeline_http_response_with_props(status, headers, body)
        }
    }
}
