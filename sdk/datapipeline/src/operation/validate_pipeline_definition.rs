...
/// Orchestration and serialization glue logic for `ValidatePipelineDefinition`.
...
impl ValidatePipelineDefinition {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionInput,
                    ) -> ::std::result::Result<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ValidatePipelineDefinition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ValidatePipelineDefinition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ValidatePipelineDefinitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ValidatePipelineDefinitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ValidatePipelineDefinition")
...
.with_interceptor(ValidatePipelineDefinitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError>::new());
...
#[derive(Debug)]
            struct ValidatePipelineDefinitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ValidatePipelineDefinitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_validate_pipeline_definition::de_validate_pipeline_definition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_validate_pipeline_definition::de_validate_pipeline_definition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ValidatePipelineDefinitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ValidatePipelineDefinitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_validate_pipeline_definition::ser_validate_pipeline_definition_input(&input)?);
...
#[derive(Debug)]
            struct ValidatePipelineDefinitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ValidatePipelineDefinitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ValidatePipelineDefinitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ValidatePipelineDefinitionInput>()
                        .ok_or("failed to downcast to ValidatePipelineDefinitionInput")?;
...
pub enum ValidatePipelineDefinitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ValidatePipelineDefinitionError) for what information is available for the error.")]
...
impl ValidatePipelineDefinitionError {
    /// Creates the `ValidatePipelineDefinitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ValidatePipelineDefinitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ValidatePipelineDefinitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError {
...
mod _validate_pipeline_definition_output;
