...
impl ValidatePipelineDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::validate_pipeline_definition::ValidatePipelineDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidatePipelineDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_pipeline_definition::de_validate_pipeline_definition_http_response_with_props(status, headers, body)
        }
    }
}
