...
impl ValidatePipelineDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`ValidatePipelineDefinition`](crate::operation::validate_pipeline_definition::ValidatePipelineDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_pipeline_definition::ValidatePipelineDefinition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_validate_pipeline_definition::ser_validate_pipeline_definition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_pipeline_definition::ValidatePipelineDefinition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ValidatePipelineDefinition", "datapipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for ValidatePipelineDefinition {
                type Output = std::result::Result<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionOutput, crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionError>;
