...
impl QueryObjectsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<::std::string::String, ::aws_smithy_http::result::SdkError<crate::operation::query_objects::QueryObjectsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_query_objects_output_ids(page).unwrap_or_default().into_iter())
    }
}
