...
impl AddTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_tags::AddTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_tags::ser_add_tags_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_tags::de_add_tags_http_response_with_props(status, headers, body)
        }
    }
}
