...
impl super::Client {
    ...
    ///   - [`pipeline_id(impl ::std::convert::Into<String>)`](crate::operation::query_objects::builders::QueryObjectsFluentBuilder::pipeline_id) / [`set_pipeline_id(Option<String>)`](crate::operation::query_objects::builders::QueryObjectsFluentBuilder::set_pipeline_id): <p>The ID of the pipeline.</p>
    ...
    ///   - [`sphere(impl ::std::convert::Into<String>)`](crate::operation::query_objects::builders::QueryObjectsFluentBuilder::sphere) / [`set_sphere(Option<String>)`](crate::operation::query_objects::builders::QueryObjectsFluentBuilder::set_sphere): <p>Indicates whether the query applies to components or instances. The possible values are: <code>COMPONENT</code>, <code>INSTANCE</code>, and <code>ATTEMPT</code>.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::query_objects::builders::QueryObjectsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::query_objects::builders::QueryObjectsFluentBuilder::set_marker): <p>The starting point for the results to be returned. For the first call, this value should be empty. As long as there are more results, continue to call <code>QueryObjects</code> with the marker value from the previous call to retrieve the next set of results.</p>
