...
impl super::Client {
    ...
    ///   - [`fields(Field)`](crate::operation::report_task_progress::builders::ReportTaskProgressFluentBuilder::fields) / [`set_fields(Option<Vec<Field>>)`](crate::operation::report_task_progress::builders::ReportTaskProgressFluentBuilder::set_fields): <p>Key-value pairs that define the properties of the ReportTaskProgressInput object.</p>
