...
impl super::Client {
    ...
    ///   - [`task_id(impl Into<String>)`](crate::operation::report_task_progress::builders::ReportTaskProgressFluentBuilder::task_id) / [`set_task_id(Option<String>)`](crate::operation::report_task_progress::builders::ReportTaskProgressFluentBuilder::set_task_id):<br>required: **true**<br><p>The ID of the task assigned to the task runner. This value is provided in the response for <code>PollForTask</code>.</p><br>
    ///   - [`fields(Field)`](crate::operation::report_task_progress::builders::ReportTaskProgressFluentBuilder::fields) / [`set_fields(Option<Vec::<Field>>)`](crate::operation::report_task_progress::builders::ReportTaskProgressFluentBuilder::set_fields):<br>required: **false**<br><p>Key-value pairs that define the properties of the ReportTaskProgressInput object.</p><br>
