...
impl super::Client {
    ...
    ///   - [`evaluate_expressions(bool)`](crate::operation::describe_objects::builders::DescribeObjectsFluentBuilder::evaluate_expressions) / [`set_evaluate_expressions(Option<bool>)`](crate::operation::describe_objects::builders::DescribeObjectsFluentBuilder::set_evaluate_expressions): <p>Indicates whether any expressions in the object should be evaluated when the object descriptions are returned.</p>
