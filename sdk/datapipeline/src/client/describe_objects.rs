...
impl super::Client {
    ...
    ///   - [`pipeline_id(impl ::std::convert::Into<String>)`](crate::operation::describe_objects::builders::DescribeObjectsFluentBuilder::pipeline_id) / [`set_pipeline_id(Option<String>)`](crate::operation::describe_objects::builders::DescribeObjectsFluentBuilder::set_pipeline_id): <p>The ID of the pipeline that contains the object definitions.</p>
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_objects::builders::DescribeObjectsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_objects::builders::DescribeObjectsFluentBuilder::set_marker): <p>The starting point for the results to be returned. For the first call, this value should be empty. As long as there are more results, continue to call <code>DescribeObjects</code> with the marker value from the previous call to retrieve the next set of results.</p>
