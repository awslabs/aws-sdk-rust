...
impl super::Client {
    ...
    ///   - [`worker_group(impl ::std::convert::Into<String>)`](crate::operation::poll_for_task::builders::PollForTaskFluentBuilder::worker_group) / [`set_worker_group(Option<String>)`](crate::operation::poll_for_task::builders::PollForTaskFluentBuilder::set_worker_group): <p>The type of task the task runner is configured to accept and process. The worker group is set as a field on objects in the pipeline when they are created. You can only specify a single value for <code>workerGroup</code> in the call to <code>PollForTask</code>. There are no wildcard values permitted in <code>workerGroup</code>; the string must be an exact, case-sensitive, match.</p>
    ///   - [`hostname(impl ::std::convert::Into<String>)`](crate::operation::poll_for_task::builders::PollForTaskFluentBuilder::hostname) / [`set_hostname(Option<String>)`](crate::operation::poll_for_task::builders::PollForTaskFluentBuilder::set_hostname): <p>The public DNS name of the calling task runner.</p>
