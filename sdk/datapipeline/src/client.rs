...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_datapipeline::Error> {
/// # let client: aws_sdk_datapipeline::Client = unimplemented!();
...
mod deactivate_pipeline;

mod delete_pipeline;

mod describe_objects;

mod describe_pipelines;

mod evaluate_expression;

mod get_pipeline_definition;

mod list_pipelines;

mod poll_for_task;

mod put_pipeline_definition;

mod query_objects;

mod remove_tags;

mod report_task_progress;

mod report_task_runner_heartbeat;

mod set_status;

mod set_task_status;

mod validate_pipeline_definition;
