...
pub struct ParameterObject  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<std::vec::Vec<crate::model::ParameterAttribute>>,
}
...
pub struct Field  {
    ...
    #[doc(hidden)]pub ref_value: std::option::Option<std::string::String>,
}
impl Field {
    /// <p>The field identifier.</p>
    pub fn key(&self) -> std::option::Option<& str> {
...
pub struct Query  {
    ...
    #[doc(hidden)]pub selectors: std::option::Option<std::vec::Vec<crate::model::Selector>>,
}
impl Query {
    /// <p>List of selectors that define the query. An object must satisfy all of the selectors to match the query.</p>
...
pub struct Operator  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::OperatorType>,
...
pub struct TaskObject  {
    ...
    #[doc(hidden)]pub attempt_id: std::option::Option<std::string::String>,
    /// <p>Connection information for the location where the task runner will publish the output of the task.</p>
    #[doc(hidden)]pub objects: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PipelineObject>>,
}
impl TaskObject {
    /// <p>An internal identifier for the task. This ID is passed to the <code>SetTaskStatus</code> and <code>ReportTaskProgress</code> actions.</p>
