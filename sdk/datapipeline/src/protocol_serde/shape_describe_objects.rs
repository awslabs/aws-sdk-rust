...
pub fn ser_describe_objects_input(input: &crate::input::DescribeObjectsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_describe_objects_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeObjectsOutput, crate::error::DescribeObjectsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeObjectsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_objects_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeObjectsOutput, crate::error::DescribeObjectsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_objects_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_objects::de_describe_objects(response.body().as_ref(), output).map_err(crate::error::DescribeObjectsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_objects(value: &[u8], mut builder: crate::output::describe_objects_output::Builder) -> Result<crate::output::describe_objects_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
