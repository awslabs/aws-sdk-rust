...
pub fn ser_validate_pipeline_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
