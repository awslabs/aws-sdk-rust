...
pub fn ser_validate_pipeline_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ValidatePipelineDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
