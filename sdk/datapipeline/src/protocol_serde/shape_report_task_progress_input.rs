...
pub fn ser_report_task_progress_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ReportTaskProgressInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
