...
pub(crate) fn de_parameter_value<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ParameterValue>, aws_smithy_json::deserialize::error::DeserializeError>
