...
pub fn ser_query_objects_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QueryObjectsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
