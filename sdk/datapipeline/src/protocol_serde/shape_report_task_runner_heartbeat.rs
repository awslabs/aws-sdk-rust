...
pub fn de_report_task_runner_heartbeat_http_error(
...
> {
    ...
    .map_err(
        crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_report_task_runner_heartbeat_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
