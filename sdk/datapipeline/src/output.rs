...
pub struct ValidatePipelineDefinitionOutput  {
    ...
    #[doc(hidden)]pub validation_warnings: std::option::Option<std::vec::Vec<crate::model::ValidationWarning>>,
    /// <p>Indicates whether there were validation errors.</p>
    #[doc(hidden)]pub errored: bool,
}
...
pub struct QueryObjectsOutput  {
    ...
    #[doc(hidden)]pub has_more_results: bool,
}
...
pub struct PollForTaskOutput  {
    ...
    #[doc(hidden)]pub task_object: std::option::Option<crate::model::TaskObject>,
}
...
pub struct ListPipelinesOutput  {
    ...
    #[doc(hidden)]pub pipeline_id_list: std::option::Option<std::vec::Vec<crate::model::PipelineIdName>>,
...
pub struct GetPipelineDefinitionOutput  {
    ...
    #[doc(hidden)]pub pipeline_objects: std::option::Option<std::vec::Vec<crate::model::PipelineObject>>,
    /// <p>The parameter objects used in the pipeline definition.</p>
    #[doc(hidden)]pub parameter_objects: std::option::Option<std::vec::Vec<crate::model::ParameterObject>>,
    /// <p>The parameter values used in the pipeline definition.</p>
    #[doc(hidden)]pub parameter_values: std::option::Option<std::vec::Vec<crate::model::ParameterValue>>,
}
...
pub struct EvaluateExpressionOutput  {
    ...
    #[doc(hidden)]pub evaluated_expression: std::option::Option<std::string::String>,
}
...
pub struct DescribePipelinesOutput  {
    ...
    #[doc(hidden)]pub pipeline_description_list: std::option::Option<std::vec::Vec<crate::model::PipelineDescription>>,
}
...
pub struct CreatePipelineOutput  {
    ...
    #[doc(hidden)]pub pipeline_id: std::option::Option<std::string::String>,
}
