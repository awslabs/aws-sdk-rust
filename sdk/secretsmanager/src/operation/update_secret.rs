...
impl UpdateSecretInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_secret::UpdateSecret::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSecret {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_secret::de_update_secret_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_secret::de_update_secret_http_response_with_props(
                status, headers, body,
            )
        }
    }
