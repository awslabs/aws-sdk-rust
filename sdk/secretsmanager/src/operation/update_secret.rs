    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_secret::UpdateSecretError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_secret::UpdateSecretOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for UpdateSecretRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_secret::UpdateSecretInput>()
            .expect("correct type");
