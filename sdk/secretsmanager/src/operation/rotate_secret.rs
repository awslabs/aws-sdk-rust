...
impl RotateSecretInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rotate_secret::RotateSecret::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RotateSecret {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_rotate_secret::de_rotate_secret_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_rotate_secret::de_rotate_secret_http_response_with_props(
                status, headers, body,
            )
        }
    }
