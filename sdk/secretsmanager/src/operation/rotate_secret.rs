...
impl RotateSecret {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::rotate_secret::RotateSecretError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::rotate_secret::RotateSecretOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Secrets Manager", "RotateSecret", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Secrets Manager.RotateSecret",
                "rpc.service" = "Secrets Manager",
                "rpc.method" = "RotateSecret",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RotateSecret {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RotateSecretRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RotateSecretResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RotateSecret")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RotateSecret")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RotateSecretTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RotateSecretTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RotateSecretTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RotateSecretInput>() else {
        ...
        if requested.should_capture("RotationLambdaARN") {
            if let ::std::option::Option::Some(value) = input.rotation_lambda_arn.as_deref() {
                captured.insert("RotationLambdaARN", value);
            }
        }
        if requested.should_capture("ExternalSecretRotationRoleArn") {
            if let ::std::option::Option::Some(value) = input.external_secret_rotation_role_arn.as_deref() {
                captured.insert("ExternalSecretRotationRoleArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RotateSecretResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_rotate_secret::de_rotate_secret_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_rotate_secret::de_rotate_secret_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateSecretRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::rotate_secret::RotateSecretInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::rotate_secret::RotateSecretInput,
