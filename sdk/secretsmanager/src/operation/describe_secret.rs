...
impl DescribeSecretInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_secret::DescribeSecret::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSecret {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_secret::de_describe_secret_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_secret::de_describe_secret_http_response(
                status, headers, body,
            )
        }
    }
