    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_secrets::ListSecretsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_secrets::ListSecretsOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListSecretsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_secrets::ListSecretsInput>()
            .expect("correct type");
