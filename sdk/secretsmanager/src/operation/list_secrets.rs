...
impl ListSecretsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_secrets::ListSecrets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_secrets::ser_list_secrets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSecrets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_secrets::de_list_secrets_http_response_with_props(status, headers, body)
        }
    }
}
