...
impl ReplicateSecretToRegionsInput {
    /// Consumes the builder and constructs an Operation<[`ReplicateSecretToRegions`](crate::operation::replicate_secret_to_regions::ReplicateSecretToRegions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replicate_secret_to_regions::ser_replicate_secret_to_regions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::replicate_secret_to_regions::ReplicateSecretToRegions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ReplicateSecretToRegions {
                type Output = std::result::Result<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsOutput, crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError>;
