...
/// Orchestration and serialization glue logic for `ReplicateSecretToRegions`.
...
impl ReplicateSecretToRegions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplicateSecretToRegions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReplicateSecretToRegions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReplicateSecretToRegionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReplicateSecretToRegionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplicateSecretToRegions")
...
.with_interceptor(ReplicateSecretToRegionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError>::new());
...
#[derive(Debug)]
            struct ReplicateSecretToRegionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReplicateSecretToRegionsResponseDeserializer {
...
#[derive(Debug)]
            struct ReplicateSecretToRegionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplicateSecretToRegionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_replicate_secret_to_regions::ser_replicate_secret_to_regions_input(&input)?);
...
#[derive(Debug)]
            struct ReplicateSecretToRegionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplicateSecretToRegionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReplicateSecretToRegionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReplicateSecretToRegionsInput>()
                        .ok_or("failed to downcast to ReplicateSecretToRegionsInput")?;
...
pub enum ReplicateSecretToRegionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReplicateSecretToRegionsError) for what information is available for the error.")]
...
impl ReplicateSecretToRegionsError {
    /// Creates the `ReplicateSecretToRegionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplicateSecretToRegionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReplicateSecretToRegionsError {
...
mod _replicate_secret_to_regions_output;
