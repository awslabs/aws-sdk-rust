...
impl ReplicateSecretToRegionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::replicate_secret_to_regions::ReplicateSecretToRegions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplicateSecretToRegions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replicate_secret_to_regions::de_replicate_secret_to_regions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError
{
