...
impl ReplicateSecretToRegions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Secrets Manager.ReplicateSecretToRegions",
            "rpc.service" = "Secrets Manager",
            "rpc.method" = "ReplicateSecretToRegions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplicateSecretToRegions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ReplicateSecretToRegionsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ReplicateSecretToRegionsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ReplicateSecretToRegions")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplicateSecretToRegions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ReplicateSecretToRegionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ReplicateSecretToRegionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplicateSecretToRegionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ReplicateSecretToRegionsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReplicateSecretToRegionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_replicate_secret_to_regions::de_replicate_secret_to_regions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_replicate_secret_to_regions::de_replicate_secret_to_regions_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplicateSecretToRegionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsInput>()
            .expect("correct type");
