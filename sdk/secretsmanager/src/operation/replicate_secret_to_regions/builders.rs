...
impl ReplicateSecretToRegionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsOutput, crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsError, Self> {
