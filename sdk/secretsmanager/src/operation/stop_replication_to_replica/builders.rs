...
impl StopReplicationToReplicaFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_replication_to_replica::StopReplicationToReplicaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_replication_to_replica::StopReplicationToReplicaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_replication_to_replica::StopReplicationToReplicaOutput, crate::operation::stop_replication_to_replica::StopReplicationToReplicaError, Self> {
