...
impl ValidateResourcePolicyInput {
    /// Consumes the builder and constructs an Operation<[`ValidateResourcePolicy`](crate::operation::validate_resource_policy::ValidateResourcePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_resource_policy::ValidateResourcePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_resource_policy::ValidateResourcePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_validate_resource_policy::ser_validate_resource_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_resource_policy::ValidateResourcePolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ValidateResourcePolicy {
                type Output = std::result::Result<crate::operation::validate_resource_policy::ValidateResourcePolicyOutput, crate::operation::validate_resource_policy::ValidateResourcePolicyError>;
