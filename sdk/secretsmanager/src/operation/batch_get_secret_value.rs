...
impl BatchGetSecretValue {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Secrets Manager.BatchGetSecretValue",
            "rpc.service" = "Secrets Manager",
            "rpc.method" = "BatchGetSecretValue",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchGetSecretValue")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                BatchGetSecretValueTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchGetSecretValueTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchGetSecretValueTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BatchGetSecretValueInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetSecretValueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_get_secret_value::de_batch_get_secret_value_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_get_secret_value::de_batch_get_secret_value_http_response(status, headers, body, _cfg)
        };
