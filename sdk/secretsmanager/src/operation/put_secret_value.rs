...
/// Orchestration and serialization glue logic for `PutSecretValue`.
...
impl PutSecretValue {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_secret_value::PutSecretValueInput,
                    ) -> ::std::result::Result<crate::operation::put_secret_value::PutSecretValueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_secret_value::PutSecretValueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_secret_value::PutSecretValueError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_secret_value::PutSecretValueOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::put_secret_value::PutSecretValueInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutSecretValue {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutSecretValue");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutSecretValueRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutSecretValueResponseDeserializer));
...
.with_interceptor(PutSecretValueEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_secret_value::PutSecretValueError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_secret_value::PutSecretValueError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_secret_value::PutSecretValueError>::new());
...
#[derive(Debug)]
            struct PutSecretValueResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutSecretValueResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_secret_value::de_put_secret_value_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutSecretValueRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutSecretValueRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_secret_value::PutSecretValueInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_secret_value::PutSecretValueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_secret_value::ser_put_secret_value_input(&input)?);
...
#[derive(Debug)]
            struct PutSecretValueEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutSecretValueEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutSecretValueEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutSecretValueInput>()
                        .ok_or("failed to downcast to PutSecretValueInput")?;
...
pub enum PutSecretValueError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutSecretValueError) for what information is available for the error.")]
...
impl PutSecretValueError {
    /// Creates the `PutSecretValueError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutSecretValueError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutSecretValueError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_secret_value::PutSecretValueError {
