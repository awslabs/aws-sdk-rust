...
impl PutSecretValueInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_secret_value::PutSecretValue, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_secret_value::ser_put_secret_value_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSecretValue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_secret_value::de_put_secret_value_http_response_with_props(status, headers, body)
        }
    }
}
