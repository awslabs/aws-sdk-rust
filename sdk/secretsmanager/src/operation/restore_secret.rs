...
impl RestoreSecretInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::restore_secret::RestoreSecret, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_restore_secret::ser_restore_secret_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreSecret {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_secret::de_restore_secret_http_response_with_props(status, headers, body)
        }
    }
}
