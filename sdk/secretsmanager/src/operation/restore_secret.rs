...
impl RestoreSecretInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_secret::RestoreSecret::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreSecret {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_restore_secret::de_restore_secret_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_restore_secret::de_restore_secret_http_response_with_props(
                status, headers, body,
            )
        }
    }
