...
impl GetRandomPasswordInput {
    /// Consumes the builder and constructs an Operation<[`GetRandomPassword`](crate::operation::get_random_password::GetRandomPassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_random_password::GetRandomPassword, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_random_password::GetRandomPasswordInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_random_password::ser_get_random_password_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_random_password::GetRandomPassword::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRandomPassword {
                type Output = std::result::Result<crate::operation::get_random_password::GetRandomPasswordOutput, crate::operation::get_random_password::GetRandomPasswordError>;
