...
impl GetRandomPasswordInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_random_password::ser_get_random_password_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRandomPassword {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_random_password::de_get_random_password_http_response_with_props(status, headers, body)
        }
    }
