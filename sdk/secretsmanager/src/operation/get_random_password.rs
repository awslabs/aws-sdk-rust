...
/// Orchestration and serialization glue logic for `GetRandomPassword`.
...
impl GetRandomPassword {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_random_password::GetRandomPasswordInput,
                    ) -> ::std::result::Result<crate::operation::get_random_password::GetRandomPasswordOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_random_password::GetRandomPasswordError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_random_password::GetRandomPasswordError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_random_password::GetRandomPasswordOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRandomPassword {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRandomPassword");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRandomPasswordRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRandomPasswordResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRandomPassword")
...
.with_interceptor(GetRandomPasswordEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_random_password::GetRandomPasswordError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_random_password::GetRandomPasswordError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_random_password::GetRandomPasswordError>::new());
...
#[derive(Debug)]
            struct GetRandomPasswordResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRandomPasswordResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_random_password::de_get_random_password_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetRandomPasswordRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRandomPasswordRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_random_password::GetRandomPasswordInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_random_password::GetRandomPasswordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_random_password::ser_get_random_password_input(&input)?);
...
#[derive(Debug)]
            struct GetRandomPasswordEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRandomPasswordEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRandomPasswordEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRandomPasswordInput>()
                        .ok_or("failed to downcast to GetRandomPasswordInput")?;
...
pub enum GetRandomPasswordError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRandomPasswordError) for what information is available for the error.")]
...
impl GetRandomPasswordError {
    /// Creates the `GetRandomPasswordError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRandomPasswordError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRandomPasswordError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_random_password::GetRandomPasswordError {
...
mod _get_random_password_output;
