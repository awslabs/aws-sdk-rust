...
impl ListSecretVersionIdsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_secret_version_ids::ListSecretVersionIdsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_secret_version_ids::ListSecretVersionIdsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_secret_version_ids::ListSecretVersionIdsOutput, crate::operation::list_secret_version_ids::ListSecretVersionIdsError, Self> {
