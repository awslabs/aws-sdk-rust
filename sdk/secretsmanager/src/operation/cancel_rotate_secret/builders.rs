...
impl CancelRotateSecretFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_rotate_secret::CancelRotateSecretOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_rotate_secret::CancelRotateSecretError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_rotate_secret::CancelRotateSecretOutput, crate::operation::cancel_rotate_secret::CancelRotateSecretError, Self> {
