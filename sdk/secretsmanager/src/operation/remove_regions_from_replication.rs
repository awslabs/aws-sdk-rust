...
impl RemoveRegionsFromReplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_regions_from_replication::RemoveRegionsFromReplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveRegionsFromReplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_regions_from_replication::de_remove_regions_from_replication_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RemoveRegionsFromReplicationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_regions_from_replication::RemoveRegionsFromReplicationError
{
