...
impl RemoveRegionsFromReplication {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Secrets Manager.RemoveRegionsFromReplication",
            "rpc.service" = "Secrets Manager",
            "rpc.method" = "RemoveRegionsFromReplication",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RemoveRegionsFromReplication")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveRegionsFromReplication")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RemoveRegionsFromReplicationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RemoveRegionsFromReplicationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveRegionsFromReplicationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RemoveRegionsFromReplicationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveRegionsFromReplicationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_remove_regions_from_replication::de_remove_regions_from_replication_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_remove_regions_from_replication::de_remove_regions_from_replication_http_response(
