...
impl RemoveRegionsFromReplicationInput {
    /// Consumes the builder and constructs an Operation<[`RemoveRegionsFromReplication`](crate::operation::remove_regions_from_replication::RemoveRegionsFromReplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_regions_from_replication::RemoveRegionsFromReplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_regions_from_replication::RemoveRegionsFromReplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_remove_regions_from_replication::ser_remove_regions_from_replication_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_regions_from_replication::RemoveRegionsFromReplication::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveRegionsFromReplication {
                type Output = std::result::Result<crate::operation::remove_regions_from_replication::RemoveRegionsFromReplicationOutput, crate::operation::remove_regions_from_replication::RemoveRegionsFromReplicationError>;
...
impl aws_http::request_id::RequestId for crate::operation::remove_regions_from_replication::RemoveRegionsFromReplicationError {
