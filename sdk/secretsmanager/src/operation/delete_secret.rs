    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_secret::DeleteSecretError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_secret::DeleteSecretOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeleteSecretRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_secret::DeleteSecretInput>()
            .expect("correct type");
