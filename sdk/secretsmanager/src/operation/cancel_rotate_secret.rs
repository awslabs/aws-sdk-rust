...
impl CancelRotateSecretInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_rotate_secret::ser_cancel_rotate_secret_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_rotate_secret::CancelRotateSecret::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::cancel_rotate_secret::CancelRotateSecretError
{
