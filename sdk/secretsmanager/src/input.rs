...
pub mod cancel_rotate_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CancelRotateSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CancelRotateSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CancelRotateSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::CancelRotateSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod create_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.client_request_token.is_none() {
                                self.client_request_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::CreateSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod delete_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DeleteSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod describe_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_random_password_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetRandomPasswordInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetRandomPasswordInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetRandomPassword, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetRandomPasswordInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod get_secret_value_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetSecretValueInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetSecretValueInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetSecretValue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetSecretValueInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_secrets_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListSecretsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListSecretsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListSecrets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListSecretsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_secret_version_ids_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListSecretVersionIdsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListSecretVersionIdsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListSecretVersionIds, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListSecretVersionIdsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod put_secret_value_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutSecretValueInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutSecretValueInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutSecretValue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.client_request_token.is_none() {
                                self.client_request_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::PutSecretValueInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod remove_regions_from_replication_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RemoveRegionsFromReplicationInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl RemoveRegionsFromReplicationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RemoveRegionsFromReplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::RemoveRegionsFromReplicationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod replicate_secret_to_regions_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ReplicateSecretToRegionsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ReplicateSecretToRegionsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ReplicateSecretToRegions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ReplicateSecretToRegionsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod restore_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RestoreSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl RestoreSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RestoreSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::RestoreSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod rotate_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RotateSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl RotateSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RotateSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.client_request_token.is_none() {
                                self.client_request_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::RotateSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod stop_replication_to_replica_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StopReplicationToReplicaInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StopReplicationToReplicaInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StopReplicationToReplica, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::StopReplicationToReplicaInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_secret_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateSecretInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateSecretInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateSecret, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.client_request_token.is_none() {
                                self.client_request_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateSecretInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_secret_version_stage_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateSecretVersionStageInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateSecretVersionStageInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateSecretVersionStage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateSecretVersionStageInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod validate_resource_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ValidateResourcePolicyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ValidateResourcePolicyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ValidateResourcePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ValidateResourcePolicyInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub struct ValidateResourcePolicyInput  {
    /// <p>This field is reserved for internal use.</p>
    #[doc(hidden)]pub secret_id: std::option::Option<std::string::String>,
    /// <p>A JSON-formatted string that contains an Amazon Web Services resource-based policy. The policy in the string identifies who can access or manage this secret and its versions. For example policies, see <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html">Permissions policy examples</a>.</p>
...
pub struct UpdateSecretVersionStageInput  {
    ...
    #[doc(hidden)]pub secret_id: std::option::Option<std::string::String>,
    /// <p>The staging label to add to this version.</p>
    #[doc(hidden)]pub version_stage: std::option::Option<std::string::String>,
    /// <p>The ID of the version that the staging label is to be removed from. If the staging label you are trying to attach to one version is already attached to a different version, then you must include this parameter and specify the version that the label is to be removed from. If the label is attached and you either do not specify this parameter, or the version ID does not match, then the operation fails.</p>
    #[doc(hidden)]pub remove_from_version_id: std::option::Option<std::string::String>,
    /// <p>The ID of the version to add the staging label to. To remove a label from a version, then do not specify this parameter.</p> 
    /// <p>If the staging label is already attached to a different version of the secret, then you must also specify the <code>RemoveFromVersionId</code> parameter. </p>
    #[doc(hidden)]pub move_to_version_id: std::option::Option<std::string::String>,
}
impl UpdateSecretVersionStageInput {
    /// <p>The ARN or the name of the secret with the version and staging labelsto modify.</p> 
    /// <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN. See <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/troubleshoot.html#ARN_secretnamehyphen">Finding a secret from a partial ARN</a>.</p>
...
pub struct UpdateSecretInput  {
    ...
    /// <p>Either <code>SecretBinary</code> or <code>SecretString</code> must have a value, but not both.</p> 
    /// <p>You can't access this parameter in the Secrets Manager console.</p>
    #[doc(hidden)]pub secret_binary: std::option::Option<aws_smithy_types::Blob>,
    /// <p>The text data to encrypt and store in the new version of the secret. We recommend you use a JSON structure of key/value pairs for your secret value. </p> 
    /// <p>Either <code>SecretBinary</code> or <code>SecretString</code> must have a value, but not both. </p>
    #[doc(hidden)]pub secret_string: std::option::Option<std::string::String>,
}
impl UpdateSecretInput {
    /// <p>The ARN or name of the secret.</p> 
    /// <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN. See <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/troubleshoot.html#ARN_secretnamehyphen">Finding a secret from a partial ARN</a>.</p>
...
pub struct RotateSecretInput  {
    ...
    /// <p>If you don't immediately rotate the secret, Secrets Manager tests the rotation configuration by running the <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/rotate-secrets_how.html"> <code>testSecret</code> step</a> of the Lambda rotation function. The test creates an <code>AWSPENDING</code> version of the secret and then removes it.</p> 
    /// <p>If you don't specify this value, then by default, Secrets Manager rotates the secret immediately.</p>
    #[doc(hidden)]pub rotate_immediately: std::option::Option<bool>,
}
impl RotateSecretInput {
    /// <p>The ARN or name of the secret to rotate.</p> 
    /// <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN. See <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/troubleshoot.html#ARN_secretnamehyphen">Finding a secret from a partial ARN</a>.</p>
...
pub struct ReplicateSecretToRegionsInput  {
    ...
    #[doc(hidden)]pub secret_id: std::option::Option<std::string::String>,
    /// <p>A list of Regions in which to replicate the secret.</p>
    #[doc(hidden)]pub add_replica_regions: std::option::Option<std::vec::Vec<crate::model::ReplicaRegionType>>,
    /// <p>Specifies whether to overwrite a secret with the same name in the destination Region.</p>
    #[doc(hidden)]pub force_overwrite_replica_secret: bool,
}
impl ReplicateSecretToRegionsInput {
    /// <p>The ARN or name of the secret to replicate.</p>
    pub fn secret_id(&self) -> std::option::Option<& str> {
...
pub struct RemoveRegionsFromReplicationInput  {
    ...
    #[doc(hidden)]pub secret_id: std::option::Option<std::string::String>,
    /// <p>The Regions of the replicas to remove.</p>
    #[doc(hidden)]pub remove_replica_regions: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl RemoveRegionsFromReplicationInput {
    /// <p>The ARN or name of the secret.</p>
    pub fn secret_id(&self) -> std::option::Option<& str> {
...
pub struct PutResourcePolicyInput  {
    ...
    #[doc(hidden)]pub resource_policy: std::option::Option<std::string::String>,
    /// <p>Specifies whether to block resource-based policies that allow broad access to the secret, for example those that use a wildcard for the principal.</p>
    #[doc(hidden)]pub block_public_policy: std::option::Option<bool>,
}
impl PutResourcePolicyInput {
    /// <p>The ARN or name of the secret to attach the resource-based policy.</p> 
    /// <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN. See <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/troubleshoot.html#ARN_secretnamehyphen">Finding a secret from a partial ARN</a>.</p>
...
pub struct ListSecretsInput  {
    ...
    /// <p>Lists secrets in the requested order. </p>
    #[doc(hidden)]pub sort_order: std::option::Option<crate::model::SortOrderType>,
}
impl ListSecretsInput {
    /// <p>The number of results to include in the response.</p> 
    /// <p>If there are more results available, in the response, Secrets Manager includes <code>NextToken</code>. To get the next results, call <code>ListSecrets</code> again with the value from <code>NextToken</code>.</p>
...
pub struct GetRandomPasswordInput  {
    /// <p>The length of the password. If you don't include this parameter, the default length is 32 characters.</p>
    #[doc(hidden)]pub password_length: std::option::Option<i64>,
    /// <p>A string of the characters that you don't want in the password.</p>
    #[doc(hidden)]pub exclude_characters: std::option::Option<std::string::String>,
    /// <p>Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.</p>
    #[doc(hidden)]pub exclude_numbers: std::option::Option<bool>,
    /// <p>Specifies whether to exclude the following punctuation characters from the password: <code>! " # $ % &amp; ' ( ) * + , - . / : ; &lt; = &gt; ? @ [ \ ] ^ _ ` { | } ~</code>. If you don't include this switch, the password can contain punctuation.</p>
    #[doc(hidden)]pub exclude_punctuation: std::option::Option<bool>,
    /// <p>Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.</p>
    #[doc(hidden)]pub exclude_uppercase: std::option::Option<bool>,
    /// <p>Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.</p>
    #[doc(hidden)]pub exclude_lowercase: std::option::Option<bool>,
    /// <p>Specifies whether to include the space character. If you include this switch, the password can contain space characters.</p>
    #[doc(hidden)]pub include_space: std::option::Option<bool>,
    /// <p>Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.</p>
    #[doc(hidden)]pub require_each_included_type: std::option::Option<bool>,
}
impl GetRandomPasswordInput {
    /// <p>The length of the password. If you don't include this parameter, the default length is 32 characters.</p>
...
impl  std::fmt::Debug for GetRandomPasswordInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("require_each_included_type", &self.require_each_included_type);
        formatter.finish()
    }
}
...
pub struct DeleteSecretInput  {
    ...
    #[doc(hidden)]pub secret_id: std::option::Option<std::string::String>,
    /// <p>The number of days from 7 to 30 that Secrets Manager waits before permanently deleting the secret. You can't use both this parameter and <code>ForceDeleteWithoutRecovery</code> in the same call. If you don't use either, then Secrets Manager defaults to a 30 day recovery window.</p>
    #[doc(hidden)]pub recovery_window_in_days: std::option::Option<i64>,
    /// <p>Specifies whether to delete the secret without any recovery window. You can't use both this parameter and <code>RecoveryWindowInDays</code> in the same call. If you don't use either, then Secrets Manager defaults to a 30 day recovery window.</p> 
    /// <p>Secrets Manager performs the actual deletion with an asynchronous background process, so there might be a short delay before the secret is permanently deleted. If you delete a secret and then immediately create a secret with the same name, use appropriate back off and retry logic.</p> <important> 
    /// <p>Use this parameter with caution. This parameter causes the operation to skip the normal recovery window before the permanent deletion that Secrets Manager would normally impose with the <code>RecoveryWindowInDays</code> parameter. If you delete a secret with the <code>ForceDeleteWithouRecovery</code> parameter, then you have no opportunity to recover the secret. You lose the secret permanently.</p> 
    /// </important>
    #[doc(hidden)]pub force_delete_without_recovery: std::option::Option<bool>,
}
impl DeleteSecretInput {
    /// <p>The ARN or name of the secret to delete.</p> 
    /// <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN. See <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/troubleshoot.html#ARN_secretnamehyphen">Finding a secret from a partial ARN</a>.</p>
...
impl  std::fmt::Debug for DeleteSecretInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("force_delete_without_recovery", &self.force_delete_without_recovery);
        formatter.finish()
    }
}
