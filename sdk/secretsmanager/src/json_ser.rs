...
pub fn serialize_structure_create_secret_input(
    ...
    if let Some(var_6) = &input.secret_binary {
        object
            .key("SecretBinary")
            .string_unchecked(&smithy_types::base64::encode(var_6));
    }
        ...
        for item_14 in var_12 {
            {
                ...
                crate::json_ser::serialize_structure_replica_region_type(&mut object_15, item_14);
                object_15.finish();
            }
        }
        array_13.finish();
...
pub fn serialize_structure_delete_secret_input(
    ...
    if let Some(var_18) = &input.recovery_window_in_days {
        object.key("RecoveryWindowInDays").number(
            ...
            smithy_types::Number::NegInt((*var_18).into()),
        );
    }
        ...
        for item_37 in var_35 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_38, item_37);
                object_38.finish();
            }
        }
        array_36.finish();
...
pub fn serialize_structure_put_secret_value_input(
    ...
    if let Some(var_49) = &input.secret_binary {
        object
            .key("SecretBinary")
            .string_unchecked(&smithy_types::base64::encode(var_49));
    }
...
pub fn serialize_structure_remove_regions_from_replication_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_replicate_secret_to_regions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_61 in var_59 {
            {
                ...
                crate::json_ser::serialize_structure_replica_region_type(&mut object_62, item_61);
                object_62.finish();
            }
        }
        array_60.finish();
...
pub fn serialize_structure_rotate_secret_input(
    ...
    if let Some(var_67) = &input.rotation_rules {
        ...
        crate::json_ser::serialize_structure_rotation_rules_type(&mut object_68, var_67);
        object_68.finish();
    }
}

pub fn serialize_structure_stop_replication_to_replica_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_replica_region_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_filter(
    ...
    if let Some(var_95) = &input.key {
        object.key("Key").string(var_95.as_str());
    }
...
pub fn serialize_structure_rotation_rules_type(
    ...
    if let Some(var_99) = &input.automatically_after_days {
