...
impl super::Client {
    ...
    ///   - [`secret_id(impl ::std::convert::Into<String>)`](crate::operation::stop_replication_to_replica::builders::StopReplicationToReplicaFluentBuilder::secret_id) / [`set_secret_id(Option<String>)`](crate::operation::stop_replication_to_replica::builders::StopReplicationToReplicaFluentBuilder::set_secret_id): <p>The ARN of the primary secret. </p>
