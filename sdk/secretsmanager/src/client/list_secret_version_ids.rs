...
impl super::Client {
    ...
    ///   - [`secret_id(impl ::std::convert::Into<String>)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::secret_id) / [`set_secret_id(Option<String>)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::set_secret_id): <p>The ARN or name of the secret whose versions you want to list.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN. See <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/troubleshoot.html#ARN_secretnamehyphen">Finding a secret from a partial ARN</a>.</p>
    ///   - [`max_results(i32)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::set_max_results): <p>The number of results to include in the response.</p>  <p>If there are more results available, in the response, Secrets Manager includes <code>NextToken</code>. To get the next results, call <code>ListSecretVersionIds</code> again with the value from <code>NextToken</code>. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::set_next_token): <p>A token that indicates where the output should continue from, if a previous call did not show all results. To get the next results, call <code>ListSecretVersionIds</code> again with this value.</p>
    ///   - [`include_deprecated(bool)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::include_deprecated) / [`set_include_deprecated(Option<bool>)`](crate::operation::list_secret_version_ids::builders::ListSecretVersionIdsFluentBuilder::set_include_deprecated): <p>Specifies whether to include versions of secrets that don't have any staging labels attached to them. Versions without staging labels are considered deprecated and are subject to deletion by Secrets Manager. By default, versions without staging labels aren't included.</p>
