...
impl super::Client {
    ...
    ///   - [`secret_id(impl ::std::convert::Into<String>)`](crate::operation::validate_resource_policy::builders::ValidateResourcePolicyFluentBuilder::secret_id) / [`set_secret_id(Option<String>)`](crate::operation::validate_resource_policy::builders::ValidateResourcePolicyFluentBuilder::set_secret_id): <p>This field is reserved for internal use.</p>
    ///   - [`resource_policy(impl ::std::convert::Into<String>)`](crate::operation::validate_resource_policy::builders::ValidateResourcePolicyFluentBuilder::resource_policy) / [`set_resource_policy(Option<String>)`](crate::operation::validate_resource_policy::builders::ValidateResourcePolicyFluentBuilder::set_resource_policy): <p>A JSON-formatted string that contains an Amazon Web Services resource-based policy. The policy in the string identifies who can access or manage this secret and its versions. For example policies, see <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html">Permissions policy examples</a>.</p>
