...
impl super::Client {
    ...
    ///   - [`sort_by(SortByType)`](crate::operation::list_secrets::builders::ListSecretsFluentBuilder::sort_by) / [`set_sort_by(Option<SortByType>)`](crate::operation::list_secrets::builders::ListSecretsFluentBuilder::set_sort_by):<br>required: **false**<br><p>If not specified, secrets are listed by <code>CreatedDate</code>.</p><br>
