...
) -> Result<crate::output::cancel_rotate_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CancelRotateSecretOutputBody = if inp.is_empty() {
...
) -> Result<crate::output::create_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CreateSecretOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::delete_resource_policy_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DeleteResourcePolicyOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::delete_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DeleteSecretOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::describe_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeSecretOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::get_random_password_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GetRandomPasswordOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::get_resource_policy_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GetResourcePolicyOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::get_secret_value_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GetSecretValueOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::list_secrets_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListSecretsOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::list_secret_version_ids_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListSecretVersionIdsOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::put_resource_policy_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::PutResourcePolicyOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::put_secret_value_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::PutSecretValueOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::restore_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::RestoreSecretOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::rotate_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::RotateSecretOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::update_secret_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::UpdateSecretOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::update_secret_version_stage_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::UpdateSecretVersionStageOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> Result<crate::output::validate_resource_policy_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ValidateResourcePolicyOutputBody = if inp.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
