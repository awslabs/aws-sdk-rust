...
pub struct ValidateResourcePolicyOutput  {
    ...
    #[doc(hidden)]pub policy_validation_passed: bool,
    /// <p>Validation errors if your policy didn't pass validation.</p>
    #[doc(hidden)]pub validation_errors: std::option::Option<std::vec::Vec<crate::model::ValidationErrorsEntry>>,
}
...
pub struct ReplicateSecretToRegionsOutput  {
    ...
    #[doc(hidden)]pub replication_status: std::option::Option<std::vec::Vec<crate::model::ReplicationStatusType>>,
}
...
pub struct ListSecretVersionIdsOutput  {
    ...
    #[doc(hidden)]pub versions: std::option::Option<std::vec::Vec<crate::model::SecretVersionsListEntry>>,
...
pub struct ListSecretsOutput  {
    ...
    #[doc(hidden)]pub secret_list: std::option::Option<std::vec::Vec<crate::model::SecretListEntry>>,
...
pub struct GetRandomPasswordOutput  {
    ...
    #[doc(hidden)]pub random_password: std::option::Option<std::string::String>,
}
...
pub struct DescribeSecretOutput  {
    ...
    #[doc(hidden)]pub version_ids_to_stages: std::option::Option<std::collections::HashMap<std::string::String, std::vec::Vec<std::string::String>>>,
