...
pub fn ser_list_secrets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSecretsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
