...
pub fn ser_list_secrets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_secrets::ListSecretsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
