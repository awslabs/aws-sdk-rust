...
pub fn ser_rotate_secret_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RotateSecretInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
