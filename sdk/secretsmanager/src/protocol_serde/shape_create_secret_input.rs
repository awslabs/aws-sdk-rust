...
pub fn ser_create_secret_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSecretInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
