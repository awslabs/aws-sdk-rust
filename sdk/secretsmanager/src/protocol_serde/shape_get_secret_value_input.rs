...
pub fn ser_get_secret_value_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSecretValueInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
