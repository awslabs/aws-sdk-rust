    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CancelRotateSecretInput`](crate::input::CancelRotateSecretInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::CancelRotateSecretInput::secret_id): <p>The ARN or name of the secret.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ...
    ///   - [`secret_id(Option<String>)`](crate::input::DeleteResourcePolicyInput::secret_id): <p>The ARN or name of the secret to delete the attached resource-based policy for.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ...
    ///
    /// - Takes [`DeleteSecretInput`](crate::input::DeleteSecretInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::DeleteSecretInput::secret_id): <p>The ARN or name of the secret to delete.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`recovery_window_in_days(Option<i64>)`](crate::input::DeleteSecretInput::recovery_window_in_days): <p>The number of days from 7 to 30 that Secrets Manager waits before permanently deleting the secret. You can't use both this parameter and <code>ForceDeleteWithoutRecovery</code> in the same call. If you don't use either, then Secrets Manager defaults to a 30 day recovery window.</p>
    ///   - [`force_delete_without_recovery(Option<bool>)`](crate::input::DeleteSecretInput::force_delete_without_recovery): <p>Specifies whether to delete the secret without any recovery window. You can't use both this parameter and <code>RecoveryWindowInDays</code> in the same call. If you don't use either, then Secrets Manager defaults to a 30 day recovery window.</p>  <p>Secrets Manager performs the actual deletion with an asynchronous background process, so there might be a short delay before the secret is permanently deleted. If you delete a secret and then immediately create a secret with the same name, use appropriate back off and retry logic.</p> <important>   <p>Use this parameter with caution. This parameter causes the operation to skip the normal recovery window before the permanent deletion that Secrets Manager would normally impose with the <code>RecoveryWindowInDays</code> parameter. If you delete a secret with the <code>ForceDeleteWithouRecovery</code> parameter, then you have no opportunity to recover the secret. You lose the secret permanently.</p>  </important>
    ...
    ///
    /// - Takes [`DescribeSecretInput`](crate::input::DescribeSecretInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::DescribeSecretInput::secret_id): <p>The ARN or name of the secret. </p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ...
    ///
    /// - Takes [`GetRandomPasswordInput`](crate::input::GetRandomPasswordInput) with field(s):
    ///   - [`password_length(Option<i64>)`](crate::input::GetRandomPasswordInput::password_length): <p>The length of the password. If you don't include this parameter, the default length is 32 characters.</p>
    ///   - [`exclude_characters(Option<String>)`](crate::input::GetRandomPasswordInput::exclude_characters): <p>A string of the characters that you don't want in the password.</p>
    ///   - [`exclude_numbers(Option<bool>)`](crate::input::GetRandomPasswordInput::exclude_numbers): <p>Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.</p>
    ///   - [`exclude_punctuation(Option<bool>)`](crate::input::GetRandomPasswordInput::exclude_punctuation): <p>Specifies whether to exclude the following punctuation characters from the password: <code>! " # $ % &amp; ' ( ) * + , - . / : ; &lt; = &gt; ? @ [ \ ] ^ _ ` { | } ~</code>. If you don't include this switch, the password can contain punctuation.</p>
    ///   - [`exclude_uppercase(Option<bool>)`](crate::input::GetRandomPasswordInput::exclude_uppercase): <p>Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.</p>
    ///   - [`exclude_lowercase(Option<bool>)`](crate::input::GetRandomPasswordInput::exclude_lowercase): <p>Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.</p>
    ///   - [`include_space(Option<bool>)`](crate::input::GetRandomPasswordInput::include_space): <p>Specifies whether to include the space character. If you include this switch, the password can contain space characters.</p>
    ///   - [`require_each_included_type(Option<bool>)`](crate::input::GetRandomPasswordInput::require_each_included_type): <p>Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.</p>
    ...
    ///   - [`secret_id(Option<String>)`](crate::input::GetResourcePolicyInput::secret_id): <p>The ARN or name of the secret to retrieve the attached resource-based policy for.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ...
    ///
    /// - Takes [`GetSecretValueInput`](crate::input::GetSecretValueInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::GetSecretValueInput::secret_id): <p>The ARN or name of the secret to retrieve.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`version_id(Option<String>)`](crate::input::GetSecretValueInput::version_id): <p>The unique identifier of the version of the secret to retrieve. If you include both this parameter and <code>VersionStage</code>, the two parameters must refer to the same secret version. If you don't specify either a <code>VersionStage</code> or <code>VersionId</code>, then Secrets Manager returns the <code>AWSCURRENT</code> version.</p>  <p>This value is typically a <a href="https://wikipedia.org/wiki/Universally_unique_identifier">UUID-type</a> value with 32 hexadecimal digits.</p>
    ///   - [`version_stage(Option<String>)`](crate::input::GetSecretValueInput::version_stage): <p>The staging label of the version of the secret to retrieve. </p>  <p>Secrets Manager uses staging labels to keep track of different versions during the rotation process. If you include both this parameter and <code>VersionId</code>, the two parameters must refer to the same secret version. If you don't specify either a <code>VersionStage</code> or <code>VersionId</code>, Secrets Manager returns the <code>AWSCURRENT</code> version.</p>
    ...
    ///
    /// - Takes [`ListSecretsInput`](crate::input::ListSecretsInput) with field(s):
    ///   - [`max_results(Option<i32>)`](crate::input::ListSecretsInput::max_results): <p>The number of results to include in the response.</p>  <p>If there are more results available, in the response, Secrets Manager includes <code>NextToken</code>. To get the next results, call <code>ListSecrets</code> again with the value from <code>NextToken</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListSecretsInput::next_token): <p>A token that indicates where the output should continue from, if a previous call did not show all results. To get the next results, call <code>ListSecrets</code> again with this value.</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::ListSecretsInput::filters): <p>The filters to apply to the list of secrets.</p>
    ///   - [`sort_order(Option<SortOrderType>)`](crate::input::ListSecretsInput::sort_order): <p>Lists secrets in the requested order. </p>
    ...
    ///
    /// - Takes [`ListSecretVersionIdsInput`](crate::input::ListSecretVersionIdsInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::ListSecretVersionIdsInput::secret_id): <p>The ARN or name of the secret whose versions you want to list.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListSecretVersionIdsInput::max_results): <p>The number of results to include in the response.</p>  <p>If there are more results available, in the response, Secrets Manager includes <code>NextToken</code>. To get the next results, call <code>ListSecretVersionIds</code> again with the value from <code>NextToken</code>. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListSecretVersionIdsInput::next_token): <p>A token that indicates where the output should continue from, if a previous call did not show all results. To get the next results, call <code>ListSecretVersionIds</code> again with this value.</p>
    ///   - [`include_deprecated(Option<bool>)`](crate::input::ListSecretVersionIdsInput::include_deprecated): <p>Specifies whether to include versions of secrets that don't have any staging labels attached to them. Versions without staging labels are considered deprecated and are subject to deletion by Secrets Manager.</p>
    ...
    ///   - [`secret_id(Option<String>)`](crate::input::PutResourcePolicyInput::secret_id): <p>The ARN or name of the secret to attach the resource-based policy.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`resource_policy(Option<String>)`](crate::input::PutResourcePolicyInput::resource_policy): <p>A JSON-formatted string for an Amazon Web Services resource-based policy. For example policies, see <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html">Permissions policy examples</a>.</p>
    ///   - [`block_public_policy(Option<bool>)`](crate::input::PutResourcePolicyInput::block_public_policy): <p>Specifies whether to block resource-based policies that allow broad access to the secret. By default, Secrets Manager blocks policies that allow broad access, for example those that use a wildcard for the principal.</p>
    ...
    ///
    /// - Takes [`RemoveRegionsFromReplicationInput`](crate::input::RemoveRegionsFromReplicationInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::RemoveRegionsFromReplicationInput::secret_id): <p>The ARN or name of the secret.</p>
    ///   - [`remove_replica_regions(Option<Vec<String>>)`](crate::input::RemoveRegionsFromReplicationInput::remove_replica_regions): <p>The Regions of the replicas to remove.</p>
    ...
    ///
    /// - Takes [`ReplicateSecretToRegionsInput`](crate::input::ReplicateSecretToRegionsInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::ReplicateSecretToRegionsInput::secret_id): <p>The ARN or name of the secret to replicate.</p>
    ///   - [`add_replica_regions(Option<Vec<ReplicaRegionType>>)`](crate::input::ReplicateSecretToRegionsInput::add_replica_regions): <p>A list of Regions in which to replicate the secret.</p>
    ///   - [`force_overwrite_replica_secret(bool)`](crate::input::ReplicateSecretToRegionsInput::force_overwrite_replica_secret): <p>Specifies whether to overwrite a secret with the same name in the destination Region.</p>
    ...
    ///
    /// - Takes [`RestoreSecretInput`](crate::input::RestoreSecretInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::RestoreSecretInput::secret_id): <p>The ARN or name of the secret to restore.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ...
    ///
    /// - Takes [`RotateSecretInput`](crate::input::RotateSecretInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::RotateSecretInput::secret_id): <p>The ARN or name of the secret to rotate.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::RotateSecretInput::client_request_token): <p>A unique identifier for the new version of the secret that helps ensure idempotency. Secrets Manager uses this value to prevent the accidental creation of duplicate versions if there are failures and retries during rotation. This value becomes the <code>VersionId</code> of the new version.</p>  <p>If you use the Amazon Web Services CLI or one of the Amazon Web Services SDK to call this operation, then you can leave this parameter empty. The CLI or SDK generates a random UUID for you and includes that in the request for this parameter. If you don't use the SDK and instead generate a raw HTTP request to the Secrets Manager service endpoint, then you must generate a <code>ClientRequestToken</code> yourself for new versions and include that value in the request.</p>  <p>You only need to specify this value if you implement your own retry logic and you want to ensure that Secrets Manager doesn't attempt to create a secret version twice. We recommend that you generate a <a href="https://wikipedia.org/wiki/Universally_unique_identifier">UUID-type</a> value to ensure uniqueness within the specified secret. </p>
    ///   - [`rotation_lambda_arn(Option<String>)`](crate::input::RotateSecretInput::rotation_lambda_arn): <p>The ARN of the Lambda rotation function that can rotate the secret.</p>
    ///   - [`rotation_rules(Option<RotationRulesType>)`](crate::input::RotateSecretInput::rotation_rules): <p>A structure that defines the rotation configuration for this secret.</p>
    ...
    ///
    /// - Takes [`StopReplicationToReplicaInput`](crate::input::StopReplicationToReplicaInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::StopReplicationToReplicaInput::secret_id): <p>The ARN of the primary secret. </p>
    ...
    ///   - [`secret_id(Option<String>)`](crate::input::TagResourceInput::secret_id): <p>The identifier for the secret to attach tags to. You can specify either the Amazon Resource Name (ARN) or the friendly name of the secret.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p>The tags to attach to the secret as a JSON text string argument. Each element in the list consists of a <code>Key</code> and a <code>Value</code>.</p>  <p>For storing multiple values, we recommend that you use a JSON text string argument and specify key/value pairs. For more information, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-parameters.html">Specifying parameter values for the Amazon Web Services CLI</a> in the Amazon Web Services CLI User Guide.</p>
    ...
    ///   - [`secret_id(Option<String>)`](crate::input::UntagResourceInput::secret_id): <p>The ARN or name of the secret.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>A list of tag key names to remove from the secret. You don't specify the value. Both the key and its associated value are removed.</p>  <p>This parameter requires a JSON text string argument.</p>  <p>For storing multiple values, we recommend that you use a JSON text string argument and specify key/value pairs. For more information, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-parameters.html">Specifying parameter values for the Amazon Web Services CLI</a> in the Amazon Web Services CLI User Guide.</p>
    ...
    ///
    /// - Takes [`UpdateSecretVersionStageInput`](crate::input::UpdateSecretVersionStageInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::UpdateSecretVersionStageInput::secret_id): <p>The ARN or the name of the secret with the version and staging labelsto modify.</p>  <p>For an ARN, we recommend that you specify a complete ARN rather than a partial ARN.</p>
    ///   - [`version_stage(Option<String>)`](crate::input::UpdateSecretVersionStageInput::version_stage): <p>The staging label to add to this version.</p>
    ///   - [`remove_from_version_id(Option<String>)`](crate::input::UpdateSecretVersionStageInput::remove_from_version_id): <p>The ID of the version that the staging label is to be removed from. If the staging label you are trying to attach to one version is already attached to a different version, then you must include this parameter and specify the version that the label is to be removed from. If the label is attached and you either do not specify this parameter, or the version ID does not match, then the operation fails.</p>
    ///   - [`move_to_version_id(Option<String>)`](crate::input::UpdateSecretVersionStageInput::move_to_version_id): <p>The ID of the version to add the staging label to. To remove a label from a version, then do not specify this parameter.</p>  <p>If the staging label is already attached to a different version of the secret, then you must also specify the <code>RemoveFromVersionId</code> parameter. </p>
    ...
    ///
    /// - Takes [`ValidateResourcePolicyInput`](crate::input::ValidateResourcePolicyInput) with field(s):
    ///   - [`secret_id(Option<String>)`](crate::input::ValidateResourcePolicyInput::secret_id): <p>This field is reserved for internal use.</p>
    ///   - [`resource_policy(Option<String>)`](crate::input::ValidateResourcePolicyInput::resource_policy): <p>A JSON-formatted string that contains an Amazon Web Services resource-based policy. The policy in the string identifies who can access or manage this secret and its versions. For example policies, see <a href="https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html">Permissions policy examples</a>.</p>
