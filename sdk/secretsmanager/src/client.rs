...
/// For example, the [`CancelRotateSecret`](crate::operation) operation has
...
mod remove_regions_from_replication;

mod replicate_secret_to_regions;

mod restore_secret;

mod rotate_secret;

mod stop_replication_to_replica;
