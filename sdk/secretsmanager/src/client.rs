    ...
    C: aws_hyper::SmithyConnector,
{
    ...
    pub fn remove_regions_from_replication(
        &self,
    ) -> fluent_builders::RemoveRegionsFromReplication<C> {
        fluent_builders::RemoveRegionsFromReplication::new(self.handle.clone())
    }
    pub fn replicate_secret_to_regions(&self) -> fluent_builders::ReplicateSecretToRegions<C> {
    ...
    pub fn stop_replication_to_replica(&self) -> fluent_builders::StopReplicationToReplica<C> {
...
pub mod fluent_builders {
    ...
    #[derive(std::fmt::Debug)]
    pub struct RemoveRegionsFromReplication<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::remove_regions_from_replication_input::Builder,
    }
    impl<C> RemoveRegionsFromReplication<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ReplicateSecretToRegions<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::replicate_secret_to_regions_input::Builder,
    }
    impl<C> ReplicateSecretToRegions<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct StopReplicationToReplica<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::stop_replication_to_replica_input::Builder,
    }
    impl<C> StopReplicationToReplica<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
