...
pub fn de_get_connection_http_error(
    ...
    Err(match error_code {
        "ForbiddenException" => crate::operation::get_connection::GetConnectionError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalFailureException" => crate::operation::get_connection::GetConnectionError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::operation::get_connection::GetConnectionError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "connectedSince" => {
                    builder = builder.set_connected_since(
                ...
                "disconnectedSince" => {
                    builder = builder.set_disconnected_since(
                        ::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?
                            .map(i64::try_from)
                            .transpose()?,
                    );
