...
pub(crate) fn de_retained_message_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RetainedMessageSummary>, aws_smithy_json::deserialize::error::DeserializeError>
