...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_retained_messages::builders::ListRetainedMessagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_retained_messages::builders::ListRetainedMessagesFluentBuilder::set_next_token): <p>To retrieve the next set of results, the <code>nextToken</code> value from a previous response; otherwise <b>null</b> to receive the first set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_retained_messages::builders::ListRetainedMessagesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_retained_messages::builders::ListRetainedMessagesFluentBuilder::set_max_results): <p>The maximum number of results to return at one time.</p>
