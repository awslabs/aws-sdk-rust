...
impl super::Client {
    ...
    ///   - [`thing_name(impl Into<String>)`](crate::operation::get_thing_shadow::builders::GetThingShadowFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::get_thing_shadow::builders::GetThingShadowFluentBuilder::set_thing_name):<br>required: **true**<br><p>The name of the thing.</p><br>
    ///   - [`shadow_name(impl Into<String>)`](crate::operation::get_thing_shadow::builders::GetThingShadowFluentBuilder::shadow_name) / [`set_shadow_name(Option<String>)`](crate::operation::get_thing_shadow::builders::GetThingShadowFluentBuilder::set_shadow_name):<br>required: **false**<br><p>The name of the shadow.</p><br>
