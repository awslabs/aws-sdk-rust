...
impl ListRetainedMessagesInput {
    /// Consumes the builder and constructs an Operation<[`ListRetainedMessages`](crate::operation::list_retained_messages::ListRetainedMessages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_retained_messages::ListRetainedMessages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_retained_messages::ListRetainedMessagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/retainedMessage").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_retained_messages::ListRetainedMessagesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_retained_messages::ListRetainedMessages::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRetainedMessages {
                type Output = std::result::Result<crate::operation::list_retained_messages::ListRetainedMessagesOutput, crate::operation::list_retained_messages::ListRetainedMessagesError>;
