...
impl GetRetainedMessageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_retained_message::GetRetainedMessage,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRetainedMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_retained_message::de_get_retained_message_http_response_with_props(status, headers, body)
        }
    }
}
