...
/// Orchestration and serialization glue logic for `GetRetainedMessage`.
...
impl GetRetainedMessage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_retained_message::GetRetainedMessageInput,
                    ) -> ::std::result::Result<crate::operation::get_retained_message::GetRetainedMessageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_retained_message::GetRetainedMessageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_retained_message::GetRetainedMessageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_retained_message::GetRetainedMessageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRetainedMessage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRetainedMessage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRetainedMessageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRetainedMessageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRetainedMessage")
...
.with_interceptor(GetRetainedMessageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_retained_message::GetRetainedMessageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_retained_message::GetRetainedMessageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_retained_message::GetRetainedMessageError>::new());
...
#[derive(Debug)]
            struct GetRetainedMessageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRetainedMessageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_retained_message::de_get_retained_message_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetRetainedMessageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRetainedMessageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_retained_message::GetRetainedMessageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_retained_message::GetRetainedMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/retainedMessage/{topic}", topic = topic).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetRetainedMessageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRetainedMessageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRetainedMessageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRetainedMessageInput>()
                        .ok_or("failed to downcast to GetRetainedMessageInput")?;
...
pub enum GetRetainedMessageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRetainedMessageError) for what information is available for the error.")]
...
impl GetRetainedMessageError {
    /// Creates the `GetRetainedMessageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRetainedMessageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRetainedMessageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_retained_message::GetRetainedMessageError {
...
mod _get_retained_message_output;
