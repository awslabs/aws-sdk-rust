    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/retainedMessage/{topic}", topic = topic)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_retained_message::GetRetainedMessage::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_retained_message::GetRetainedMessageError
{
