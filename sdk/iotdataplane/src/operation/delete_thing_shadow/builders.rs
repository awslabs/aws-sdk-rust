...
impl DeleteThingShadowFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_thing_shadow::DeleteThingShadowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_thing_shadow::DeleteThingShadowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_thing_shadow::DeleteThingShadowOutput, crate::operation::delete_thing_shadow::DeleteThingShadowError, Self> {
