...
impl DeleteThingShadowInput {
    /// Consumes the builder and constructs an Operation<[`DeleteThingShadow`](crate::operation::delete_thing_shadow::DeleteThingShadow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_thing_shadow::DeleteThingShadow, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_thing_shadow::DeleteThingShadowInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_thing_shadow::DeleteThingShadowInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_thing_shadow::DeleteThingShadow::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteThingShadow {
                type Output = std::result::Result<crate::operation::delete_thing_shadow::DeleteThingShadowOutput, crate::operation::delete_thing_shadow::DeleteThingShadowError>;
