    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/things/{thingName}/shadow", thingName = thing_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_thing_shadow::DeleteThingShadow::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_thing_shadow::DeleteThingShadowError
{
