...
impl DeleteThingShadowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_thing_shadow::DeleteThingShadow,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteThingShadow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_thing_shadow::de_delete_thing_shadow_http_response_with_props(status, headers, body)
        }
    }
}
