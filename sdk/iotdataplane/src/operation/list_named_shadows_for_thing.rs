...
/// Orchestration and serialization glue logic for `ListNamedShadowsForThing`.
...
impl ListNamedShadowsForThing {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingInput,
                    ) -> ::std::result::Result<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListNamedShadowsForThing {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListNamedShadowsForThing");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListNamedShadowsForThingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListNamedShadowsForThingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListNamedShadowsForThing")
...
.with_interceptor(ListNamedShadowsForThingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_named_shadows_for_thing::de_list_named_shadows_for_thing_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_named_shadows_for_thing::de_list_named_shadows_for_thing_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListNamedShadowsForThingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/api/things/shadow/ListNamedShadowsForThing/{thingName}", thingName = thing_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListNamedShadowsForThingEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListNamedShadowsForThingInput>()
                        .ok_or("failed to downcast to ListNamedShadowsForThingInput")?;
...
pub enum ListNamedShadowsForThingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListNamedShadowsForThingError) for what information is available for the error.")]
...
impl ListNamedShadowsForThingError {
    /// Creates the `ListNamedShadowsForThingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListNamedShadowsForThingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListNamedShadowsForThingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError {
...
mod _list_named_shadows_for_thing_output;
