...
impl ListNamedShadowsForThingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThing,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThing::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNamedShadowsForThing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_named_shadows_for_thing::de_list_named_shadows_for_thing_http_response_with_props(status, headers, body)
        }
    }
}
