...
impl ListNamedShadowsForThing {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "IoT Data Plane.ListNamedShadowsForThing",
            "rpc.service" = "IoT Data Plane",
            "rpc.method" = "ListNamedShadowsForThing",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListNamedShadowsForThing {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListNamedShadowsForThingRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListNamedShadowsForThingResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListNamedShadowsForThing")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListNamedShadowsForThing")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListNamedShadowsForThingTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListNamedShadowsForThingTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListNamedShadowsForThingTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListNamedShadowsForThingInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListNamedShadowsForThingResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_named_shadows_for_thing::de_list_named_shadows_for_thing_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_named_shadows_for_thing::de_list_named_shadows_for_thing_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListNamedShadowsForThingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingInput,
                ...
                ::std::write!(output, "/api/things/shadow/ListNamedShadowsForThing/{thingName}", thingName = thing_name)
