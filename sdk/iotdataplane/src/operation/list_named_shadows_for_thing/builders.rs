...
impl ListNamedShadowsForThingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingOutput, crate::operation::list_named_shadows_for_thing::ListNamedShadowsForThingError, Self> {
