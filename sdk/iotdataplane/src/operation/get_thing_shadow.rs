...
impl GetThingShadow {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_thing_shadow::GetThingShadowError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_thing_shadow::GetThingShadowOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoT Data Plane", "GetThingShadow", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "IoT Data Plane.GetThingShadow",
                "rpc.service" = "IoT Data Plane",
                "rpc.method" = "GetThingShadow",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetThingShadow {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetThingShadow")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetThingShadowTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetThingShadowTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetThingShadowTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetThingShadowInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetThingShadowResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_thing_shadow::de_get_thing_shadow_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_thing_shadow::de_get_thing_shadow_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetThingShadowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_thing_shadow::GetThingShadowInput>()
            .expect("correct type");
