...
pub fn parse_delete_thing_shadow_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteThingShadowOutput, crate::error::DeleteThingShadowError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::DeleteThingShadowError::unhandled)?;
...
pub fn parse_get_retained_message_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetRetainedMessageOutput, crate::error::GetRetainedMessageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetRetainedMessageError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_get_thing_shadow_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetThingShadowOutput, crate::error::GetThingShadowError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::GetThingShadowError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_list_named_shadows_for_thing_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListNamedShadowsForThingOutput, crate::error::ListNamedShadowsForThingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::ListNamedShadowsForThingError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_list_retained_messages_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRetainedMessagesOutput, crate::error::ListRetainedMessagesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::ListRetainedMessagesError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                            ...
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "InternalFailureException" => crate::error::ListRetainedMessagesError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::error::ListRetainedMessagesError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "MethodNotAllowedException" => crate::error::ListRetainedMessagesError::MethodNotAllowedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::ListRetainedMessagesError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::error::ListRetainedMessagesError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedException" => crate::error::ListRetainedMessagesError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
pub fn parse_publish_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PublishOutput, crate::error::PublishError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::PublishError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_update_thing_shadow_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateThingShadowOutput, crate::error::UpdateThingShadowError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::UpdateThingShadowError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
