...
impl Builder {
    ...
    /// use aws_sdk_chimesdkmeetings::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_chimesdkmeetings::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
