...
impl super::Client {
    ...
    ///   - [`meeting_id(impl Into<String>)`](crate::operation::get_attendee::builders::GetAttendeeFluentBuilder::meeting_id) / [`set_meeting_id(Option<String>)`](crate::operation::get_attendee::builders::GetAttendeeFluentBuilder::set_meeting_id):<br>required: **true**<br><p>The Amazon Chime SDK meeting ID.</p><br>
    ///   - [`attendee_id(impl Into<String>)`](crate::operation::get_attendee::builders::GetAttendeeFluentBuilder::attendee_id) / [`set_attendee_id(Option<String>)`](crate::operation::get_attendee::builders::GetAttendeeFluentBuilder::set_attendee_id):<br>required: **true**<br><p>The Amazon Chime SDK attendee ID.</p><br>
