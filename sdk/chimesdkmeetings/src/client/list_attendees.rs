...
impl super::Client {
    ...
    ///   - [`meeting_id(impl ::std::convert::Into<String>)`](crate::operation::list_attendees::builders::ListAttendeesFluentBuilder::meeting_id) / [`set_meeting_id(Option<String>)`](crate::operation::list_attendees::builders::ListAttendeesFluentBuilder::set_meeting_id): <p>The Amazon Chime SDK meeting ID.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_attendees::builders::ListAttendeesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_attendees::builders::ListAttendeesFluentBuilder::set_next_token): <p>The token to use to retrieve the next page of results.</p>
