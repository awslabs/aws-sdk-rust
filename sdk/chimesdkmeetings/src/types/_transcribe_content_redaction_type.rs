...
impl ::std::convert::From<&str> for TranscribeContentRedactionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TranscribeContentRedactionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TranscribeContentRedactionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TranscribeContentRedactionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TranscribeContentRedactionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TranscribeContentRedactionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TranscribeContentRedactionType::Pii => write!(f, "PII"),
            TranscribeContentRedactionType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
