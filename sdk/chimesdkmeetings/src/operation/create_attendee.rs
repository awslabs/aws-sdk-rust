...
impl CreateAttendeeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_attendee::CreateAttendee, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_attendee::ser_create_attendee_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAttendee {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_attendee::de_create_attendee_http_response_with_props(status, headers, body)
        }
    }
