...
impl ListAttendeesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_attendees::ListAttendees,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_attendees::ListAttendees::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttendees {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_attendees::de_list_attendees_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_attendees::de_list_attendees_http_response_with_props(
                status, headers, body,
            )
        }
    }
