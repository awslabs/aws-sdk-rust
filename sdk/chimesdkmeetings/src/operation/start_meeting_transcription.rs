...
impl StartMeetingTranscription {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_meeting_transcription::StartMeetingTranscriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_meeting_transcription::StartMeetingTranscriptionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StartMeetingTranscription",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMeetingTranscription {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartMeetingTranscriptionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartMeetingTranscriptionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartMeetingTranscription")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartMeetingTranscription")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartMeetingTranscriptionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartMeetingTranscriptionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMeetingTranscriptionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartMeetingTranscriptionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartMeetingTranscriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_meeting_transcription::de_start_meeting_transcription_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_meeting_transcription::de_start_meeting_transcription_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartMeetingTranscriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_meeting_transcription::StartMeetingTranscriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_meeting_transcription::StartMeetingTranscriptionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_meeting_transcription::ser_start_meeting_transcription_input(&input)?,
        );
