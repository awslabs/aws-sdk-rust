...
impl StartMeetingTranscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_meeting_transcription::StartMeetingTranscription::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_meeting_transcription::StartMeetingTranscriptionError
{
