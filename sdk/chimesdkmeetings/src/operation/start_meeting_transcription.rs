...
impl StartMeetingTranscriptionInput {
    /// Consumes the builder and constructs an Operation<[`StartMeetingTranscription`](crate::operation::start_meeting_transcription::StartMeetingTranscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_meeting_transcription::StartMeetingTranscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_meeting_transcription::StartMeetingTranscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::start_meeting_transcription::StartMeetingTranscriptionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_meeting_transcription::ser_start_meeting_transcription_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_meeting_transcription::StartMeetingTranscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartMeetingTranscription {
                type Output = std::result::Result<crate::operation::start_meeting_transcription::StartMeetingTranscriptionOutput, crate::operation::start_meeting_transcription::StartMeetingTranscriptionError>;
