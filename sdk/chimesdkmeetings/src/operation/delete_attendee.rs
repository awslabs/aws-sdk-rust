...
impl DeleteAttendeeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_attendee::DeleteAttendee, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAttendee {
    type Output =
        ::std::result::Result<crate::operation::delete_attendee::DeleteAttendeeOutput, crate::operation::delete_attendee::DeleteAttendeeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_attendee::de_delete_attendee_http_response_with_props(status, headers, body)
        }
    }
}
