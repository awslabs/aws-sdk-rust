...
impl DeleteAttendeeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_attendee::DeleteAttendee,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_attendee::DeleteAttendee::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAttendee {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_attendee::de_delete_attendee_http_error(
                status, headers, body,
            )
        } else {
