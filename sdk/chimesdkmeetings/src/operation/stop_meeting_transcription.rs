...
impl StopMeetingTranscription {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput,
                    ) -> ::std::result::Result<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopMeetingTranscription {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopMeetingTranscription");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopMeetingTranscriptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopMeetingTranscriptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopMeetingTranscription")
...
.with_interceptor(StopMeetingTranscriptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError>::new());
...
#[derive(Debug)]
            struct StopMeetingTranscriptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopMeetingTranscriptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_meeting_transcription::de_stop_meeting_transcription_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_meeting_transcription::de_stop_meeting_transcription_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopMeetingTranscriptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopMeetingTranscriptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct StopMeetingTranscriptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopMeetingTranscriptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopMeetingTranscriptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopMeetingTranscriptionInput>()
                        .ok_or("failed to downcast to StopMeetingTranscriptionInput")?;
...
pub enum StopMeetingTranscriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopMeetingTranscriptionError) for what information is available for the error.")]
...
impl StopMeetingTranscriptionError {
    /// Creates the `StopMeetingTranscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopMeetingTranscriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopMeetingTranscriptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError {
...
mod _stop_meeting_transcription_output;
