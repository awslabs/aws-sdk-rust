...
impl StopMeetingTranscription {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StopMeetingTranscription",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopMeetingTranscription {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopMeetingTranscriptionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StopMeetingTranscriptionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StopMeetingTranscription")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopMeetingTranscription")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StopMeetingTranscriptionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StopMeetingTranscriptionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopMeetingTranscriptionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopMeetingTranscriptionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopMeetingTranscriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_meeting_transcription::de_stop_meeting_transcription_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_stop_meeting_transcription::de_stop_meeting_transcription_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopMeetingTranscriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput,
