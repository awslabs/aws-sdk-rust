...
impl StopMeetingTranscriptionInput {
    /// Consumes the builder and constructs an Operation<[`StopMeetingTranscription`](crate::operation::stop_meeting_transcription::StopMeetingTranscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_meeting_transcription::StopMeetingTranscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_meeting_transcription::StopMeetingTranscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopMeetingTranscription {
                type Output = std::result::Result<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionOutput, crate::operation::stop_meeting_transcription::StopMeetingTranscriptionError>;
