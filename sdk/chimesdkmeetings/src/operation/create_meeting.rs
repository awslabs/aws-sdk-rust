...
impl CreateMeetingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_meeting::CreateMeeting, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_meeting::ser_create_meeting_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMeeting {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_meeting::de_create_meeting_http_response_with_props(status, headers, body)
        }
    }
