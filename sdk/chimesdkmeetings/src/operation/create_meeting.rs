...
impl CreateMeetingInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::create_meeting::CreateMeeting,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_meeting::CreateMeeting::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateMeeting {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_meeting::de_create_meeting_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_meeting::de_create_meeting_http_response_with_props(
                status, headers, body,
            )
        }
    }
