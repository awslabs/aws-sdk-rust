...
impl UpdateAttendeeCapabilitiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_attendee_capabilities::UpdateAttendeeCapabilitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_attendee_capabilities::UpdateAttendeeCapabilitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_attendee_capabilities::UpdateAttendeeCapabilitiesOutput, crate::operation::update_attendee_capabilities::UpdateAttendeeCapabilitiesError, Self> {
