...
impl UpdateAttendeeCapabilitiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_attendee_capabilities::UpdateAttendeeCapabilitiesInput, ::aws_smithy_types::error::operation::BuildError> {
