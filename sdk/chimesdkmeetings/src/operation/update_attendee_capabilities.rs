...
impl UpdateAttendeeCapabilitiesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_attendee_capabilities::UpdateAttendeeCapabilities::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAttendeeCapabilities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_attendee_capabilities::de_update_attendee_capabilities_http_response_with_props(status, headers, body)
        }
    }
