...
impl StopMeetingTranscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_meeting_transcription::StopMeetingTranscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
