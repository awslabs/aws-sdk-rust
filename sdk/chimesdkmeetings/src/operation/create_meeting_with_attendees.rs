...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMeetingWithAttendees {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_meeting_with_attendees::de_create_meeting_with_attendees_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError
{
