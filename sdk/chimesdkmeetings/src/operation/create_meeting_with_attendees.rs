...
/// Orchestration and serialization glue logic for `CreateMeetingWithAttendees`.
...
impl CreateMeetingWithAttendees {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMeetingWithAttendees {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateMeetingWithAttendees");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateMeetingWithAttendeesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateMeetingWithAttendeesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateMeetingWithAttendees")
...
.with_interceptor(CreateMeetingWithAttendeesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError>::new());
...
#[derive(Debug)]
            struct CreateMeetingWithAttendeesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMeetingWithAttendeesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_meeting_with_attendees::de_create_meeting_with_attendees_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateMeetingWithAttendeesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMeetingWithAttendeesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/meetings").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_meeting_with_attendees::ser_create_meeting_with_attendees_input(&input)?);
...
#[derive(Debug)]
            struct CreateMeetingWithAttendeesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMeetingWithAttendeesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateMeetingWithAttendeesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateMeetingWithAttendeesInput>()
                        .ok_or("failed to downcast to CreateMeetingWithAttendeesInput")?;
...
pub enum CreateMeetingWithAttendeesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateMeetingWithAttendeesError) for what information is available for the error.")]
...
impl CreateMeetingWithAttendeesError {
    /// Creates the `CreateMeetingWithAttendeesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateMeetingWithAttendeesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateMeetingWithAttendeesError::ConflictException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateMeetingWithAttendeesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesError {
...
mod _create_meeting_with_attendees_output;
