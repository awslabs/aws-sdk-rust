...
pub fn ser_engine_transcribe_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EngineTranscribeSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
