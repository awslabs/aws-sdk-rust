...
pub(crate) fn de_meeting_features_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MeetingFeaturesConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "Audio" => {
                                builder = builder.set_audio(
                                    crate::protocol_serde::shape_audio_features::de_audio_features(tokens)?
                                );
                            }
                            "Video" => {
                                builder = builder.set_video(
                                    crate::protocol_serde::shape_video_features::de_video_features(tokens)?
                                );
                            }
                            "Content" => {
                                builder = builder.set_content(
                                    crate::protocol_serde::shape_content_features::de_content_features(tokens)?
                                );
                            }
                            "Attendee" => {
                                builder = builder.set_attendee(
                                    crate::protocol_serde::shape_attendee_features::de_attendee_features(tokens)?
                                );
                            }
