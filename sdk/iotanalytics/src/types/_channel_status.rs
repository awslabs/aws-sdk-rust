...
impl ::std::convert::From<&str> for ChannelStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelStatus::from(s))
    }
}
impl ChannelStatus {
...
impl ::std::convert::AsRef<str> for ChannelStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
