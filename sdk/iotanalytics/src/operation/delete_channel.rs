...
impl DeleteChannelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_channel::DeleteChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_channel::de_delete_channel_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_channel::de_delete_channel_http_response_with_props(
                status, headers, body,
            )
        }
    }
