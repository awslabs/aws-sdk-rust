    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartPipelineReprocessing {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            StartPipelineReprocessingRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            StartPipelineReprocessingResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartPipelineReprocessing", "iotanalytics"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartPipelineReprocessingResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartPipelineReprocessingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_pipeline_reprocessing::ser_start_pipeline_reprocessing_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartPipelineReprocessingEndpointParamsInterceptor {
