...
impl ListDatastoresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_datastores::ListDatastores, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDatastores {
    type Output =
        ::std::result::Result<crate::operation::list_datastores::ListDatastoresOutput, crate::operation::list_datastores::ListDatastoresError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_datastores::de_list_datastores_http_response_with_props(status, headers, body)
        }
    }
}
