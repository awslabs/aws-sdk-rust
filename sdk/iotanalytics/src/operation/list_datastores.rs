...
impl ListDatastoresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_datastores::ListDatastores,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_datastores::ListDatastores::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDatastores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_datastores::de_list_datastores_http_error(
                status, headers, body,
            )
        } else {
