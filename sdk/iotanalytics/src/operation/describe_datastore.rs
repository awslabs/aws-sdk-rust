...
impl DescribeDatastoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_datastore::DescribeDatastore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDatastore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_datastore::de_describe_datastore_http_response_with_props(status, headers, body)
        }
    }
}
