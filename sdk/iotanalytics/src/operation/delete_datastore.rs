...
impl DeleteDatastoreInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_datastore::DeleteDatastore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDatastore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_datastore::de_delete_datastore_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_datastore::DeleteDatastoreError
{
