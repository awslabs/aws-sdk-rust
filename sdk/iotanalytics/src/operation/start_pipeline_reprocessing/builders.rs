...
impl StartPipelineReprocessingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingOutput, crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingError, Self> {
