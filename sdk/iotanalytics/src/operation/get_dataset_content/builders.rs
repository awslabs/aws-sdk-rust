...
impl GetDatasetContentFluentBuilder  {
    /// Creates a new `GetDatasetContent`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_dataset_content::GetDatasetContentOutput, aws_smithy_http::result::SdkError<crate::operation::get_dataset_content::GetDatasetContentError>>
                     {
