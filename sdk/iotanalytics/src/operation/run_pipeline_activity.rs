    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/pipelineactivities/run")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::run_pipeline_activity::RunPipelineActivity::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::run_pipeline_activity::RunPipelineActivityError
{
