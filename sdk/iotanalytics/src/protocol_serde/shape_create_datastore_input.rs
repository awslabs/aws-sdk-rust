...
pub fn ser_create_datastore_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDatastoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
