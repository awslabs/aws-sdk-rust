...
pub(crate) fn de_iot_site_wise_customer_managed_datastore_s3_storage<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::IotSiteWiseCustomerManagedDatastoreS3Storage>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
