...
> {
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::delete_pipeline::DeletePipelineError::InternalFailureException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_pipeline::DeletePipelineError::unhandled)?;
        ...
        "ServiceUnavailableException" => {
            crate::operation::delete_pipeline::DeletePipelineError::ServiceUnavailableException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_pipeline::DeletePipelineError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "ThrottlingException" => {
            crate::operation::delete_pipeline::DeletePipelineError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_pipeline::DeletePipelineError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
