...
pub fn ser_run_pipeline_activity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RunPipelineActivityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
