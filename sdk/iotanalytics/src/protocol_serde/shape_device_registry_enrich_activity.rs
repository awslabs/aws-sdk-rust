...
pub(crate) fn de_device_registry_enrich_activity<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DeviceRegistryEnrichActivity>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
