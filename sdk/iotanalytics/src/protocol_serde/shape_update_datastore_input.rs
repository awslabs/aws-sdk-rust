...
pub fn ser_update_datastore_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDatastoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
