...
> {
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::describe_dataset::DescribeDatasetError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::describe_dataset::DescribeDatasetError::unhandled)?;
        ...
        "ServiceUnavailableException" => {
            crate::operation::describe_dataset::DescribeDatasetError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::describe_dataset::DescribeDatasetError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        match tokens.next().transpose()? {
            ...
            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "dataset" => {
                        builder = builder
                            .set_dataset(crate::protocol_serde::shape_dataset::de_dataset(tokens)?);
                    }
