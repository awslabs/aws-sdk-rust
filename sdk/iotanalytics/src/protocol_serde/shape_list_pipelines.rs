...
> {
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::list_pipelines::ListPipelinesError::InternalFailureException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_pipelines::ListPipelinesError::unhandled)?;
        ...
        "ServiceUnavailableException" => {
            crate::operation::list_pipelines::ListPipelinesError::ServiceUnavailableException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_pipelines::ListPipelinesError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "ThrottlingException" => {
            crate::operation::list_pipelines::ListPipelinesError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_pipelines::ListPipelinesError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "pipelineSummaries" => {
                        builder = builder.set_pipeline_summaries(
                            crate::protocol_serde::shape_pipeline_summaries::de_pipeline_summaries(
                                tokens,
                            )?,
                        );
                    }
