...
pub fn ser_datastore_storage(
    object_5: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::DatastoreStorage,
    ...
    match input {
        ...
        crate::types::DatastoreStorage::IotSiteWiseMultiLayerStorage(inner) => {
            ...
            crate::protocol_serde::shape_datastore_iot_site_wise_multi_layer_storage::ser_datastore_iot_site_wise_multi_layer_storage(
                &mut object_3,
                inner,
            )?;
            object_3.finish();
        }
        crate::types::DatastoreStorage::Unknown => {
...
) -> Result<Option<crate::types::DatastoreStorage>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
