...
pub fn ser_container_dataset_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContainerDatasetAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_container_dataset_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContainerDatasetAction>, aws_smithy_json::deserialize::error::DeserializeError>
