...
pub fn ser_pipeline_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipelineActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_pipeline_activity<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PipelineActivity>, aws_smithy_json::deserialize::error::DeserializeError>
