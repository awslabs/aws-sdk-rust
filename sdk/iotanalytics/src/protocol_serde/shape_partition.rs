...
pub fn ser_partition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Partition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
