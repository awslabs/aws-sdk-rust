...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl Into<String>)`](crate::operation::describe_pipeline::builders::DescribePipelineFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::describe_pipeline::builders::DescribePipelineFluentBuilder::set_pipeline_name):<br>required: **true**<br><p>The name of the pipeline whose information is retrieved.</p><br>
