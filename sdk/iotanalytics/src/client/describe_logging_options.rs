...
impl super::Client {
    ...
    ///   - [`logging_options(Option<LoggingOptions>)`](crate::operation::describe_logging_options::DescribeLoggingOptionsOutput::logging_options): <p>The current settings of the IoT Analytics logging options.</p>
    ...
    pub fn describe_logging_options(
        &self,
    ) -> crate::operation::describe_logging_options::builders::DescribeLoggingOptionsFluentBuilder
    {
