...
impl super::Client {
    ...
    ///   - [`channel_name(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_channel_name):<br>required: **true**<br><p>The name of the channel to be updated.</p><br>
    ///   - [`channel_storage(ChannelStorage)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::channel_storage) / [`set_channel_storage(Option<ChannelStorage>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_channel_storage):<br>required: **false**<br><p>Where channel data is stored. You can choose one of <code>serviceManagedS3</code> or <code>customerManagedS3</code> storage. If not specified, the default is <code>serviceManagedS3</code>. You can't change this storage option after the channel is created.</p><br>
