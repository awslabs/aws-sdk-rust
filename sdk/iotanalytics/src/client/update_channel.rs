...
impl super::Client {
    ...
    ///   - [`channel_name(impl ::std::convert::Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_channel_name): <p>The name of the channel to be updated.</p>
