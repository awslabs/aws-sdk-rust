...
impl super::Client {
    ...
    ///   - [`datastore_name(impl Into<String>)`](crate::operation::delete_datastore::builders::DeleteDatastoreFluentBuilder::datastore_name) / [`set_datastore_name(Option<String>)`](crate::operation::delete_datastore::builders::DeleteDatastoreFluentBuilder::set_datastore_name):<br>required: **true**<br><p>The name of the data store to delete.</p><br>
