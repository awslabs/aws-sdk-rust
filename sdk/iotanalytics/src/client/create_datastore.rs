...
impl super::Client {
    ...
    ///   - [`datastore_name(impl ::std::convert::Into<String>)`](crate::operation::create_datastore::builders::CreateDatastoreFluentBuilder::datastore_name) / [`set_datastore_name(Option<String>)`](crate::operation::create_datastore::builders::CreateDatastoreFluentBuilder::set_datastore_name): <p>The name of the data store.</p>
