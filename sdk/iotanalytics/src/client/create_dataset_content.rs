...
impl super::Client {
    ...
    ///   - [`dataset_name(impl ::std::convert::Into<String>)`](crate::operation::create_dataset_content::builders::CreateDatasetContentFluentBuilder::dataset_name) / [`set_dataset_name(Option<String>)`](crate::operation::create_dataset_content::builders::CreateDatasetContentFluentBuilder::set_dataset_name): <p>The name of the dataset.</p>
    ///   - [`version_id(impl ::std::convert::Into<String>)`](crate::operation::create_dataset_content::builders::CreateDatasetContentFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::create_dataset_content::builders::CreateDatasetContentFluentBuilder::set_version_id): <p>The version ID of the dataset content. To specify <code>versionId</code> for a dataset content, the dataset must use a <a href="https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_DeltaTime.html">DeltaTimer</a> filter.</p>
