...
impl super::Client {
    ...
    ///   - [`dataset_name(impl Into<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::dataset_name) / [`set_dataset_name(Option<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::set_dataset_name):<br>required: **true**<br><p>The name of the dataset to delete.</p><br>
