...
pub fn serialize_structure_crate_input_create_dataset_content_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDatasetContentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_create_datastore_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDatastoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_run_pipeline_activity_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RunPipelineActivityInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_start_pipeline_reprocessing_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartPipelineReprocessingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_datastore_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDatastoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_channel_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChannelStorage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dataset_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dataset_content_delivery_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetContentDeliveryRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_late_data_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LateDataRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dataset_trigger(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetTrigger) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_versioning_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VersioningConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.unlimited {
        object.key("unlimited").boolean(input.unlimited);
    }
...
pub fn serialize_structure_crate_model_datastore_partitions(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatastorePartitions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_union_crate_model_datastore_storage(object_45: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatastoreStorage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub fn serialize_structure_crate_model_file_format_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FileFormatConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_pipeline_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipelineActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_channel_messages(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChannelMessages) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_service_managed_channel_s3_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServiceManagedChannelS3Storage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    let (_, _) = (object, input);
    Ok(())
}

pub fn serialize_structure_crate_model_customer_managed_channel_s3_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomerManagedChannelS3Storage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_sql_query_dataset_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SqlQueryDatasetAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_container_dataset_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContainerDatasetAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dataset_content_delivery_destination(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetContentDeliveryDestination) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_late_data_rule_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LateDataRuleConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_triggering_dataset(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TriggeringDataset) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_datastore_partition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatastorePartition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_service_managed_datastore_s3_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServiceManagedDatastoreS3Storage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    let (_, _) = (object, input);
    Ok(())
}

pub fn serialize_structure_crate_model_customer_managed_datastore_s3_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomerManagedDatastoreS3Storage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_datastore_iot_site_wise_multi_layer_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatastoreIotSiteWiseMultiLayerStorage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_json_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JsonConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    let (_, _) = (object, input);
    Ok(())
}

pub fn serialize_structure_crate_model_parquet_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParquetConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_channel_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChannelActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_lambda_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_datastore_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatastoreActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_add_attributes_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AddAttributesActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_remove_attributes_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RemoveAttributesActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_select_attributes_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SelectAttributesActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_filter_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilterActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_math_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MathActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_device_registry_enrich_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeviceRegistryEnrichActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_device_shadow_enrich_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeviceShadowEnrichActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_resource_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_variable(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Variable) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_iot_events_destination_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IotEventsDestinationConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_delta_time_session_window_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeltaTimeSessionWindowConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_partition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Partition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_timestamp_partition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimestampPartition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_iot_site_wise_customer_managed_datastore_s3_storage(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IotSiteWiseCustomerManagedDatastoreS3Storage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_delta_time(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeltaTime) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dataset_content_version_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetContentVersionValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_output_file_uri_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutputFileUriValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_glue_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GlueConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
