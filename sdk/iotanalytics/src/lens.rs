...
pub(crate) fn reflens_list_dataset_contents_output_output_next_token(
    input: &crate::operation::list_dataset_contents::ListDatasetContentsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_datastores_output_output_next_token(
