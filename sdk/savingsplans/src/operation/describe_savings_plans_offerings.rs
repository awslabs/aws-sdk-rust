...
impl DescribeSavingsPlansOfferingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_savings_plans_offerings::DescribeSavingsPlansOfferings,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_savings_plans_offerings::DescribeSavingsPlansOfferings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSavingsPlansOfferings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_savings_plans_offerings::de_describe_savings_plans_offerings_http_response_with_props(
                status, headers, body,
            )
        }
    }
