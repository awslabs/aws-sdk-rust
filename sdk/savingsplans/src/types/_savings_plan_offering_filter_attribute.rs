...
impl ::std::convert::From<&str> for SavingsPlanOfferingFilterAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SavingsPlanOfferingFilterAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SavingsPlanOfferingFilterAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SavingsPlanOfferingFilterAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SavingsPlanOfferingFilterAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
