...
pub struct DescribeSavingsPlansOfferingsOutput  {
    ...
    #[doc(hidden)]pub search_results: std::option::Option<std::vec::Vec<crate::model::SavingsPlanOffering>>,
...
pub struct DescribeSavingsPlansOfferingRatesOutput  {
    ...
    #[doc(hidden)]pub search_results: std::option::Option<std::vec::Vec<crate::model::SavingsPlanOfferingRate>>,
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeSavingsPlansOutput  {
    ...
    #[doc(hidden)]pub savings_plans: std::option::Option<std::vec::Vec<crate::model::SavingsPlan>>,
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeSavingsPlanRatesOutput  {
    ...
    #[doc(hidden)]pub savings_plan_id: std::option::Option<std::string::String>,
    /// <p>Information about the Savings Plans rates.</p>
    #[doc(hidden)]pub search_results: std::option::Option<std::vec::Vec<crate::model::SavingsPlanRate>>,
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
