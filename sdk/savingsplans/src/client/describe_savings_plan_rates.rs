...
impl super::Client {
    ...
    ///   - [`filters(SavingsPlanRateFilter)`](crate::operation::describe_savings_plan_rates::builders::DescribeSavingsPlanRatesFluentBuilder::filters) / [`set_filters(Option<Vec<SavingsPlanRateFilter>>)`](crate::operation::describe_savings_plan_rates::builders::DescribeSavingsPlanRatesFluentBuilder::set_filters): <p>The filters.</p>
