...
pub struct SavingsPlanOffering  {
    ...
    #[doc(hidden)]pub product_types: std::option::Option<std::vec::Vec<crate::model::SavingsPlanProductType>>,
    /// <p>The plan type.</p>
    #[doc(hidden)]pub plan_type: std::option::Option<crate::model::SavingsPlanType>,
    /// <p>The description.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>The payment option.</p>
    #[doc(hidden)]pub payment_option: std::option::Option<crate::model::SavingsPlanPaymentOption>,
    /// <p>The duration, in seconds.</p>
    #[doc(hidden)]pub duration_seconds: i64,
    /// <p>The currency.</p>
    #[doc(hidden)]pub currency: std::option::Option<crate::model::CurrencyCode>,
    /// <p>The service.</p>
    ...
    /// <p>The properties.</p>
    #[doc(hidden)]pub properties: std::option::Option<std::vec::Vec<crate::model::SavingsPlanOfferingProperty>>,
}
...
pub struct SavingsPlanOfferingProperty  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::SavingsPlanOfferingPropertyKey>,
...
pub struct SavingsPlanOfferingFilterElement  {
    /// <p>The filter name.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::SavingsPlanOfferingFilterAttribute>,
...
pub struct SavingsPlanOfferingRate  {
    ...
    #[doc(hidden)]pub savings_plan_offering: std::option::Option<crate::model::ParentSavingsPlanOffering>,
    /// <p>The Savings Plan rate.</p>
    #[doc(hidden)]pub rate: std::option::Option<std::string::String>,
    /// <p>The unit.</p>
    #[doc(hidden)]pub unit: std::option::Option<crate::model::SavingsPlanRateUnit>,
    /// <p>The product type.</p>
    #[doc(hidden)]pub product_type: std::option::Option<crate::model::SavingsPlanProductType>,
    /// <p>The service.</p>
    #[doc(hidden)]pub service_code: std::option::Option<crate::model::SavingsPlanRateServiceCode>,
    /// <p>The usage details of the line item in the billing report.</p>
    #[doc(hidden)]pub usage_type: std::option::Option<std::string::String>,
    /// <p>The specific AWS operation for the line item in the billing report.</p>
    #[doc(hidden)]pub operation: std::option::Option<std::string::String>,
    /// <p>The properties.</p>
    #[doc(hidden)]pub properties: std::option::Option<std::vec::Vec<crate::model::SavingsPlanOfferingRateProperty>>,
}
...
pub struct ParentSavingsPlanOffering  {
    ...
    #[doc(hidden)]pub currency: std::option::Option<crate::model::CurrencyCode>,
    /// <p>The description.</p>
    #[doc(hidden)]pub plan_description: std::option::Option<std::string::String>,
}
...
pub struct SavingsPlanOfferingRateFilterElement  {
    /// <p>The filter name.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::SavingsPlanRateFilterAttribute>,
    /// <p>The filter values.</p>
    #[doc(hidden)]pub values: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct SavingsPlan  {
    ...
    /// <p>The state.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::SavingsPlanState>,
    /// <p>The AWS Region.</p>
    #[doc(hidden)]pub region: std::option::Option<std::string::String>,
    /// <p>The EC2 instance family.</p>
    #[doc(hidden)]pub ec2_instance_family: std::option::Option<std::string::String>,
    /// <p>The plan type.</p>
    #[doc(hidden)]pub savings_plan_type: std::option::Option<crate::model::SavingsPlanType>,
    /// <p>The payment option.</p>
    #[doc(hidden)]pub payment_option: std::option::Option<crate::model::SavingsPlanPaymentOption>,
    ...
    #[doc(hidden)]pub commitment: std::option::Option<std::string::String>,
    /// <p>The up-front payment amount.</p>
    #[doc(hidden)]pub upfront_payment_amount: std::option::Option<std::string::String>,
    /// <p>The recurring payment amount.</p>
    #[doc(hidden)]pub recurring_payment_amount: std::option::Option<std::string::String>,
    /// <p>The duration of the term, in seconds.</p>
    #[doc(hidden)]pub term_duration_in_seconds: i64,
...
pub struct SavingsPlanFilter  {
    /// <p>The filter name.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::SavingsPlansFilterName>,
...
pub struct SavingsPlanRate  {
    ...
    #[doc(hidden)]pub operation: std::option::Option<std::string::String>,
    /// <p>The properties.</p>
    #[doc(hidden)]pub properties: std::option::Option<std::vec::Vec<crate::model::SavingsPlanRateProperty>>,
}
...
pub struct SavingsPlanRateProperty  {
    /// <p>The property name.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::SavingsPlanRatePropertyKey>,
    /// <p>The property value.</p>
    #[doc(hidden)]pub value: std::option::Option<std::string::String>,
}
...
pub struct SavingsPlanRateFilter  {
    /// <p>The filter name.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::SavingsPlanRateFilterName>,
    /// <p>The filter values.</p>
    #[doc(hidden)]pub values: std::option::Option<std::vec::Vec<std::string::String>>,
}
