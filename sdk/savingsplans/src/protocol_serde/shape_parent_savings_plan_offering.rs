...
pub(crate) fn de_parent_savings_plan_offering<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ParentSavingsPlanOffering>, aws_smithy_json::deserialize::error::DeserializeError>
