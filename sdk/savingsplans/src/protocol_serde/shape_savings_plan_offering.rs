...
pub(crate) fn de_savings_plan_offering<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SavingsPlanOffering>, aws_smithy_json::deserialize::error::DeserializeError>
