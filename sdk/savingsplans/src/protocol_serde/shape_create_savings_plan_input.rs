...
pub fn ser_create_savings_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSavingsPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
