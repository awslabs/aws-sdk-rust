...
pub fn ser_describe_savings_plans_offerings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSavingsPlansOfferingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
