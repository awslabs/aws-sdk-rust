...
pub fn serialize_structure_create_savings_plan_input(
...
pub fn serialize_structure_delete_queued_savings_plan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_savings_plan_rates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_13 in var_11 {
            {
                ...
                crate::json_ser::serialize_structure_savings_plan_rate_filter(
                    &mut object_14,
                    item_13,
                );
                object_14.finish();
...
pub fn serialize_structure_describe_savings_plans_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_20 in var_18 {
            {
                ...
                crate::json_ser::serialize_structure_savings_plan_filter(&mut object_21, item_20);
                object_21.finish();
            }
        }
        array_19.finish();
...
pub fn serialize_structure_describe_savings_plans_offering_rates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_35 in var_33 {
            {
                ...
                crate::json_ser::serialize_structure_savings_plan_offering_rate_filter_element(
                    &mut object_36,
                    item_35,
                );
                object_36.finish();
...
pub fn serialize_structure_describe_savings_plans_offerings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_67 in var_65 {
            {
                array_66.value().number(
                    #[allow(clippy::useless_conversion)]
                    smithy_types::Number::NegInt((*item_67).into()),
                );
            }
        }
        array_66.finish();
        ...
        for item_70 in var_68 {
            {
                ...
                crate::json_ser::serialize_structure_savings_plan_offering_filter_element(
                    &mut object_71,
                    item_70,
                );
                object_71.finish();
...
pub fn serialize_structure_savings_plan_rate_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_savings_plan_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_savings_plan_offering_rate_filter_element(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_savings_plan_offering_filter_element(
    object: &mut smithy_json::serialize::JsonObjectWriter,
